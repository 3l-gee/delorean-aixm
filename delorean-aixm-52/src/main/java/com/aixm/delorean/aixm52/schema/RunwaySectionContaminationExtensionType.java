...
@Entity(name = "RunwaySectionContaminationExtensionType")
@Table(name = "runwaysectioncontamination_oe", schema = "airport_heliport")
public class RunwaySectionContaminationExtensionType implements Serializable, Equals, HashCode, ToString {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final RunwaySectionContaminationExtensionType that = ((RunwaySectionContaminationExtensionType) object);
        {
            ...
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator,
                    "abstractRunwaySectionContaminationExtension", lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator,
                    "abstractRunwaySectionContaminationExtension", rhsField);
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        }
        {
            ...
            ObjectLocator theFieldLocator = LocatorUtils.property(locator,
                    "abstractRunwaySectionContaminationExtension", theField);
            currentHashCode = strategy.hashCode(theFieldLocator, currentHashCode, theField, theFieldIsSet);
        }
        {
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        }
        {
            ...
            AbstractExtensionType theField;
            theField = this.getAbstractRunwaySectionContaminationExtension();
            strategy.appendField(locator, this, "abstractRunwaySectionContaminationExtension", buffer, theField,
                    theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetOwns();
