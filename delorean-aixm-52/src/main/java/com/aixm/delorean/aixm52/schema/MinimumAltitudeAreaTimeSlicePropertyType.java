...
public class MinimumAltitudeAreaTimeSlicePropertyType implements Serializable, Equals, HashCode, ToString {
    ...
    protected MinimumAltitudeAreaTimeSliceType minimumAltitudeAreaTimeSlice;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetMinimumAltitudeAreaTimeSlice();
            MinimumAltitudeAreaTimeSliceType theField;
            theField = this.getMinimumAltitudeAreaTimeSlice();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "minimumAltitudeAreaTimeSlice", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            MinimumAltitudeAreaTimeSliceType theField;
            theField = this.getMinimumAltitudeAreaTimeSlice();
            strategy.appendField(locator, this, "minimumAltitudeAreaTimeSlice", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetOwns();
            boolean theField;
