...
/**
 * <p>
 * Java class for InitialLegTimeSlicePropertyType complex type
 * </p>
 * .
 *
 * <p>
 ...
 *       <sequence>
 *         <element ref="{http://www.aixm.aero/schema/5.2}InitialLegTimeSlice"/>
 *       </sequence>
 *       <attGroup ref=
...
@XmlType(name = "InitialLegTimeSlicePropertyType", propOrder = {"initialLegTimeSlice"})
@FilterDef(name = "TPHjidFilter", parameters = {@ParamDef(name = "ids", type = Long.class)})
@Filter(name = "TPHjidFilter", condition = "hjid IN (:ids)")
@Entity(name = "InitialLegTimeSlicePropertyType")
@Table(name = "initialleg_tp", schema = "procedure")
public class InitialLegTimeSlicePropertyType implements Serializable, Equals, HashCode, ToString {
    ...
    /**
     * Gets the value of the initialLegTimeSlice property.
     *
     * @return possible object is {@link InitialLegTimeSliceType }
     *
     */
    @OneToOne(targetEntity = InitialLegTimeSliceType.class, cascade = {CascadeType.ALL}, fetch = FetchType.EAGER)
    @JoinColumn(name = "initiallegtimeslice_hjid", referencedColumnName = "hjid")
    public InitialLegTimeSliceType getInitialLegTimeSlice() {
        return initialLegTimeSlice;
    }

    /**
     * Sets the value of the initialLegTimeSlice property.
     *
     * @param value
     *            allowed object is {@link InitialLegTimeSliceType }
     *
     */
    ...
    @Transient
    public boolean isSetInitialLegTimeSlice() {
        return (this.initialLegTimeSlice != null);
    }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetInitialLegTimeSlice();
            InitialLegTimeSliceType theField;
            theField = this.getInitialLegTimeSlice();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "initialLegTimeSlice", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            InitialLegTimeSliceType theField;
            theField = this.getInitialLegTimeSlice();
            strategy.appendField(locator, this, "initialLegTimeSlice", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetOwns();
            boolean theField;
