...
/**
 * <p>
 * Java class for AltitudeIndicationPropertyType complex type
 * </p>
 * .
 *
 * <p>
...
@XmlType(name = "AltitudeIndicationPropertyType", propOrder = {"altitudeIndication"})
@Entity(name = "AltitudeIndicationPropertyType")
@Table(name = "altitudeindicationpropertytype", schema = "route")
public class AltitudeIndicationPropertyType extends AbstractAIXMPropertyType implements Serializable {
     ...
     *
     * @return possible object is {@link AltitudeIndicationType }
     *
     */
    @OneToOne(targetEntity = AltitudeIndicationType.class, cascade = {CascadeType.ALL}, fetch = FetchType.EAGER)
     ...
     *
     * @param value
     *            allowed object is {@link AltitudeIndicationType }
     *
     */
