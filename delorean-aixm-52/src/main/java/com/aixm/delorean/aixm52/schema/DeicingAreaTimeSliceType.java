 ...
 *                 <sequence>
 *                   <element ref=
"{http://www.aixm.aero/schema/5.2}AbstractDeicingAreaExtension"/>
 *                 </sequence>
 *                 <attGroup ref=
...
@XmlType(name = "DeicingAreaTimeSliceType", propOrder = {"associatedApron", "taxiwayLocation", "standLocation",
        "surfaceProperties", "extent", "annotation", "availability", "designator", "extension"})
...
public class DeicingAreaTimeSliceType extends AbstractAIXMTimeSliceType implements Serializable {
     ...
     *
     */
    @OneToMany(targetEntity = DeicingAreaExtensionType.class, cascade = {CascadeType.ALL}, fetch = FetchType.EAGER)
    @JoinColumn(name = "deicingareae_hjid", referencedColumnName = "hjid")
    ...
    public void setAssociatedApronItem(ApronPropertyType target) {
        setAssociatedApron(XmlAdapterUtils.marshallJAXBElement(ApronPropertyType.class,
                new QName("http://www.aixm.aero/schema/5.2", "associatedApron"), DeicingAreaTimeSliceType.class,
                target));
    }
    ...
    public void setTaxiwayLocationItem(TaxiwayPropertyType target) {
        setTaxiwayLocation(XmlAdapterUtils.marshallJAXBElement(TaxiwayPropertyType.class,
                new QName("http://www.aixm.aero/schema/5.2", "taxiwayLocation"), DeicingAreaTimeSliceType.class,
                target));
    }
    ...
    public void setStandLocationItem(AircraftStandPropertyType target) {
        setStandLocation(XmlAdapterUtils.marshallJAXBElement(AircraftStandPropertyType.class,
                new QName("http://www.aixm.aero/schema/5.2", "standLocation"), DeicingAreaTimeSliceType.class, target));
    }
    ...
    public void setSurfacePropertiesItem(SurfaceCharacteristicsPropertyType target) {
        setSurfaceProperties(XmlAdapterUtils.marshallJAXBElement(SurfaceCharacteristicsPropertyType.class,
                new QName("http://www.aixm.aero/schema/5.2", "surfaceProperties"), DeicingAreaTimeSliceType.class,
                target));
    }
    ...
    public void setExtentItem(AIXMElevatedSurfacePropertyType target) {
        setExtent(XmlAdapterUtils.marshallJAXBElement(AIXMElevatedSurfacePropertyType.class,
                new QName("http://www.aixm.aero/schema/5.2", "extent"), DeicingAreaTimeSliceType.class, target));
    }
    ...
    public void setDesignatorItem(TextDesignatorType target) {
        setDesignator(XmlAdapterUtils.marshallJAXBElement(TextDesignatorType.class,
                new QName("http://www.aixm.aero/schema/5.2", "designator"), DeicingAreaTimeSliceType.class, target));
    }
