...
/**
 * <p>
 * Java class for StandardLevelTableTimeSliceType complex type
 * </p>
 * .
 *
 * <p>
...
"{http://www.aixm.aero/schema/5.2}CodeLevelTableDesignatorType" minOccurs="0"/>
 *         <element name="standardICAO" type=
 ...
 *                 <sequence>
 *                   <element ref=
"{http://www.aixm.aero/schema/5.2}AbstractStandardLevelTableExtension"/>
 *                 </sequence>
 *                 <attGroup ref=
...
@XmlType(name = "StandardLevelTableTimeSliceType", propOrder = {"aixmName", "standardICAO", "annotation", "extension"})
@Entity(name = "StandardLevelTableTimeSliceType")
@Table(name = "standardleveltable_t", schema = "shared")
public class StandardLevelTableTimeSliceType extends AbstractAIXMTimeSliceType implements Serializable {
    ...
    @XmlElementRef(name = "standardICAO", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
     ...
     *         }{@code <}{@link CodeLevelTableDesignatorType }{@code >}
     *
     */
    @Transient
    ...
    @JoinTable(name = "stndrdlvltbltmslctp_annttn_link", schema = "shared", joinColumns = {
            @JoinColumn(name = "standardleveltable_t_hjid", referencedColumnName = "hjid")}, inverseJoinColumns = {
    ...
    public CodeLevelTableDesignatorType getAixmNameItem() {
        return XmlAdapterUtils.unmarshallSource(CodeLevelTableDesignatorType.class, this.getAixmName());
    }

    public void setAixmNameItem(CodeLevelTableDesignatorType target) {
        setAixmName(XmlAdapterUtils.marshallJAXBElement(CodeLevelTableDesignatorType.class,
                new QName("http://www.aixm.aero/schema/5.2", "name"), StandardLevelTableTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({@AttributeOverride(name = "value", column = @Column(name = "standardicao")),
            @AttributeOverride(name = "nilReason", column = @Column(name = "standardicaonilreason"))})
    public CodeYesNoType getStandardICAOItem() {
        return XmlAdapterUtils.unmarshallSource(CodeYesNoType.class, this.getStandardICAO());
    }

    public void setStandardICAOItem(CodeYesNoType target) {
        setStandardICAO(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class,
                new QName("http://www.aixm.aero/schema/5.2", "standardICAO"), StandardLevelTableTimeSliceType.class,
                target));
    }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = super.hashCode(locator, strategy);
        {
            ...
            JAXBElement<CodeLevelTableDesignatorType> theField;
            theField = this.getAixmName();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "aixmName", theField);
            currentHashCode = strategy.hashCode(theFieldLocator, currentHashCode, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetStandardICAO();
            JAXBElement<CodeYesNoType> theField;
            theField = this.getStandardICAO();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "standardICAO", theField);
            currentHashCode = strategy.hashCode(theFieldLocator, currentHashCode, theField, theFieldIsSet);
        }
        {
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        }
        {
            ...
            JAXBElement<CodeYesNoType> theField;
            theField = this.getStandardICAO();
            strategy.appendField(locator, this, "standardICAO", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetAnnotation();
            List<NotePropertyType> theField;
