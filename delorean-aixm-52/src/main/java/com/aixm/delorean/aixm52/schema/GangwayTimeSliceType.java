...
/**
 * <p>
 * Java class for GangwayTimeSliceType complex type
 * </p>
 * .
 *
 * <p>
...
"{http://www.aixm.aero/schema/5.2}CodeGangwayType" minOccurs="0"/>
 *         <element name="mobility" type=
...
@XmlType(name = "GangwayTimeSliceType", propOrder = {"width", "length", "type", "mobility", "annotation", "extension"})
@Entity(name = "GangwayTimeSliceType")
@Table(name = "gangway_t", schema = "airport_heliport")
public class GangwayTimeSliceType extends AbstractAIXMTimeSliceType implements Serializable {
     ...
     *
     * @return possible object is {@link JAXBElement
     *         }{@code <}{@link CodeGangwayType }{@code >}
     *
     */
    @Transient
    ...
    @JoinTable(name = "gngwtmslctp_annttn_link", schema = "airport_heliport", joinColumns = {
            @JoinColumn(name = "gangway_t_hjid", referencedColumnName = "hjid")}, inverseJoinColumns = {
    ...
    public void setWidthItem(ValDistanceType target) {
        setWidth(XmlAdapterUtils.marshallJAXBElement(ValDistanceType.class,
                new QName("http://www.aixm.aero/schema/5.2", "width"), GangwayTimeSliceType.class, target));
    }
    ...
    public void setLengthItem(ValDistanceType target) {
        setLength(XmlAdapterUtils.marshallJAXBElement(ValDistanceType.class,
                new QName("http://www.aixm.aero/schema/5.2", "length"), GangwayTimeSliceType.class, target));
    }
    ...
    public void setTypeItem(CodeGangwayType target) {
        setType(XmlAdapterUtils.marshallJAXBElement(CodeGangwayType.class,
                new QName("http://www.aixm.aero/schema/5.2", "type"), GangwayTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({@AttributeOverride(name = "value", column = @Column(name = "mobility")),
            @AttributeOverride(name = "nilReason", column = @Column(name = "mobilitynilreason"))})
    ...
    public void setMobilityItem(CodeYesNoType target) {
        setMobility(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class,
                new QName("http://www.aixm.aero/schema/5.2", "mobility"), GangwayTimeSliceType.class, target));
    }
