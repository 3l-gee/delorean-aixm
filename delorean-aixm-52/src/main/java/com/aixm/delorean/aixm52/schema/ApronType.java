...
"{http://www.aixm.aero/schema/5.2}ApronTimeSlicePropertyType" maxOccurs=
"unbounded"/>
 *       </sequence>
 *     </extension>
 *   </complexContent>
...
@Table(name = "apron_f", schema = "airport_heliport")
public class ApronType extends AbstractAIXMFeatureType implements Serializable {
    ...
    @OneToMany(targetEntity = ApronTimeSlicePropertyType.class, cascade = {CascadeType.ALL}, fetch = FetchType.EAGER)
