 ...
 *         <element name="clearingEquipment" type=
"{http://www.aixm.aero/schema/5.2}TextInstructionType" minOccurs="0"/>
 ...
 *                 <choice>
 *                   <element ref=
"{http://www.aixm.aero/schema/5.2}AbstractAirportClearanceServiceExtension"/>
 *                   <element ref=
...
@XmlType(name = "AirportClearanceServiceTimeSliceType", propOrder = {"flightOperations", "rank", "compliantICAO",
        ...
        "availability", "annotation", "airportHeliport", "snowPlan", "clearingEquipment", "extension"})
...
public class AirportClearanceServiceTimeSliceType extends AbstractAIXMTimeSliceType implements Serializable {
    ...
    protected List<AirportClearanceServiceExtensionType> extension;
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link AirportClearanceServiceExtensionType }
     *
     *
     */
    @OneToMany(targetEntity = AirportClearanceServiceExtensionType.class, cascade = {
            CascadeType.ALL}, fetch = FetchType.EAGER)
    @JoinColumn(name = "airportclearanceservicee_hjid", referencedColumnName = "hjid")
    public List<AirportClearanceServiceExtensionType> getExtension() {
        if (extension == null) {
     ...
     *
     */
    public void setExtension(List<AirportClearanceServiceExtensionType> extension) {
    ...
    public void setRankItem(CodeFacilityRankingType target) {
        setRank(XmlAdapterUtils.marshallJAXBElement(CodeFacilityRankingType.class,
                new QName("http://www.aixm.aero/schema/5.2", "rank"), AirportClearanceServiceTimeSliceType.class,
                target));
    }
    ...
    public void setAixmNameItem(TextNameType target) {
        setAixmName(XmlAdapterUtils.marshallJAXBElement(TextNameType.class,
                new QName("http://www.aixm.aero/schema/5.2", "name"), AirportClearanceServiceTimeSliceType.class,
                target));
    }
    ...
    public void setLocationItem(AIXMElevatedPointPropertyType target) {
        setLocation(XmlAdapterUtils.marshallJAXBElement(AIXMElevatedPointPropertyType.class,
                new QName("http://www.aixm.aero/schema/5.2", "location"), AirportClearanceServiceTimeSliceType.class,
                target));
    }
    ...
    public void setSnowPlanItem(TextInstructionType target) {
        setSnowPlan(XmlAdapterUtils.marshallJAXBElement(TextInstructionType.class,
                new QName("http://www.aixm.aero/schema/5.2", "snowPlan"), AirportClearanceServiceTimeSliceType.class,
                target));
    }

    @Embedded
    @AttributeOverrides({
            @AttributeOverride(name = "value", column = @Column(name = "clearingequipment", columnDefinition = "TEXT", length = 10000)),
            @AttributeOverride(name = "nilReason", column = @Column(name = "clearingequipmentnilreason"))})
    ...
    public void setClearingEquipmentItem(TextInstructionType target) {
        setClearingEquipment(XmlAdapterUtils.marshallJAXBElement(TextInstructionType.class,
                new QName("http://www.aixm.aero/schema/5.2", "clearingEquipment"),
                AirportClearanceServiceTimeSliceType.class, target));
    }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        }
        {
            ...
            List<AirportClearanceServiceExtensionType> lhsField;
            lhsField = (this.isSetExtension() ? this.getExtension() : null);
            List<AirportClearanceServiceExtensionType> rhsField;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        }
        {
            ...
            List<AirportClearanceServiceExtensionType> theField;
