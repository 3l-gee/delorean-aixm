 ...
 *                 <choice>
 *                   <element ref=
"{http://www.aixm.aero/schema/5.2}AbstractAuthorityForNavaidEquipmentExtension"/>
 *                 </choice>
 *                 <attGroup ref=
...
public class AuthorityForNavaidEquipmentType extends AbstractAIXMObjectType implements Serializable {
    ...
    public void setTypeItem(CodeAuthorityRoleType target) {
        setType(XmlAdapterUtils.marshallJAXBElement(CodeAuthorityRoleType.class,
                new QName("http://www.aixm.aero/schema/5.2", "type"), AuthorityForNavaidEquipmentType.class, target));
    }
    ...
    public void setTheOrganisationAuthorityItem(OrganisationAuthorityPropertyType target) {
        setTheOrganisationAuthority(XmlAdapterUtils.marshallJAXBElement(OrganisationAuthorityPropertyType.class,
                ...
                AuthorityForNavaidEquipmentType.class, target));
    }
