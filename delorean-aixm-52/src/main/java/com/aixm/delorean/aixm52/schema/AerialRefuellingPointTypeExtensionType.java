...
@XmlType(name = "", propOrder = {"abstractSegmentPointExtension", "abstractAerialRefuellingPointExtension"})
@Entity(name = "AerialRefuellingPointTypeExtensionType")
@Table(name = "aerialrefuellingpointe", schema = "aerial_refuelling")
public class AerialRefuellingPointTypeExtensionType implements Serializable, Equals, HashCode, ToString {
     ...
     */
    @OneToOne(targetEntity = AbstractExtensionType.class, cascade = {CascadeType.ALL}, fetch = FetchType.EAGER)
    @JoinColumn(name = "abstractaerialrefuellingpointextension_hjid", referencedColumnName = "hjid")
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final AerialRefuellingPointTypeExtensionType that = ((AerialRefuellingPointTypeExtensionType) object);
        {
            ...
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "abstractAerialRefuellingPointExtension",
                    lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "abstractAerialRefuellingPointExtension",
                    rhsField);
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetAbstractAerialRefuellingPointExtension();
            AbstractExtensionType theField;
            theField = this.getAbstractAerialRefuellingPointExtension();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "abstractAerialRefuellingPointExtension",
                    theField);
            currentHashCode = strategy.hashCode(theFieldLocator, currentHashCode, theField, theFieldIsSet);
        }
        {
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        }
        {
            ...
            AbstractExtensionType theField;
            theField = this.getAbstractAerialRefuellingPointExtension();
            strategy.appendField(locator, this, "abstractAerialRefuellingPointExtension", buffer, theField,
                    theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetOwns();
