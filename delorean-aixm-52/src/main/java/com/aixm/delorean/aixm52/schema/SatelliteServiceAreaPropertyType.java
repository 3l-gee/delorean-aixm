...
/**
 * <p>
 * Java class for SatelliteServiceAreaPropertyType complex type
 * </p>
 * .
 *
 * <p>
 ...
 *       <sequence>
 *         <element ref=
"{http://www.aixm.aero/schema/5.2}SatelliteServiceArea"/>
 *       </sequence>
 *     </extension>
 *   </complexContent>
 * </complexType>
...
@XmlType(name = "SatelliteServiceAreaPropertyType", propOrder = {"satelliteServiceArea"})
@Entity(name = "SatelliteServiceAreaPropertyType")
@Table(name = "satelliteserviceareapropertytype", schema = "navaids_point")
public class SatelliteServiceAreaPropertyType extends AbstractAIXMPropertyType implements Serializable {
     ...
     *
     * @return possible object is {@link SatelliteServiceAreaType }
     *
     */
    @OneToOne(targetEntity = SatelliteServiceAreaType.class, cascade = {CascadeType.ALL}, fetch = FetchType.EAGER)
     ...
     *
     * @param value
     *            allowed object is {@link SatelliteServiceAreaType }
     *
     */
