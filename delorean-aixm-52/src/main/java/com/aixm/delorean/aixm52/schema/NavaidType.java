...
"{http://www.aixm.aero/schema/5.2}NavaidTimeSlicePropertyType" maxOccurs=
"unbounded"/>
 *       </sequence>
 *     </extension>
 *   </complexContent>
...
@Table(name = "navaid_f", schema = "navaids_point")
public class NavaidType extends AbstractAIXMFeatureType implements Serializable {
    ...
    @OneToMany(targetEntity = NavaidTimeSlicePropertyType.class, cascade = {CascadeType.ALL}, fetch = FetchType.EAGER)
