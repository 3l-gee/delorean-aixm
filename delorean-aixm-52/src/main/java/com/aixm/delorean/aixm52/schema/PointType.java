...
@XmlType(name = "PointType", propOrder = {"horizontalAccuracy", "annotation", "extension"})
public class PointType extends com.aixm.delorean.core.org.gml.v_3_2.PointType implements Serializable {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        }
        {
            ...
            List<PointTypeExtension> lhsField;
            lhsField = (this.isSetExtension() ? this.getExtension() : null);
            List<PointTypeExtension> rhsField;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        }
        {
            ...
            List<PointTypeExtension> theField;
