...
"{http://www.aixm.aero/schema/5.2}CodeDistanceIndicationType" minOccurs="0"/>
 *         <choice>
 ...
 *                 <choice>
 *                   <element ref=
"{http://www.aixm.aero/schema/5.2}AbstractDistanceExtension"/>
 *                 </choice>
 *                 <attGroup ref=
...
@XmlType(name = "DistanceType", propOrder = {"distance", "minimumReceptionAltitude", "type",
        "pointChoiceFixDesignatedPoint", "pointChoiceNavaidSystem", "pointChoicePosition", "pointChoiceRunwayPoint",
        "pointChoiceAimingPoint", "pointChoiceAirportReferencePoint", "annotation", "extension"})
@Entity(name = "DistanceType")
@Table(name = "distance_o", schema = "navaids_point")
public class DistanceType extends AbstractAIXMObjectType implements Serializable {
    ...
    protected List<DistanceTypeExtensionType> extension;
     ...
     *
     * @return possible object is {@link JAXBElement
     *         }{@code <}{@link CodeDistanceIndicationType }{@code >}
     *
     */
    @Transient
    ...
    @JoinTable(name = "dstnctp_annttn_link", schema = "navaids_point", joinColumns = {
            @JoinColumn(name = "distance_o_hjid", referencedColumnName = "hjid")}, inverseJoinColumns = {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link DistanceTypeExtensionType }
     *
     *
     */
    @OneToMany(targetEntity = DistanceTypeExtensionType.class, cascade = {CascadeType.ALL}, fetch = FetchType.EAGER)
    @JoinColumn(name = "distancee_hjid", referencedColumnName = "hjid")
    public List<DistanceTypeExtensionType> getExtension() {
        if (extension == null) {
     ...
     *
     */
    public void setExtension(List<DistanceTypeExtensionType> extension) {
    ...
    public void setDistanceItem(ValDistanceType target) {
        setDistance(XmlAdapterUtils.marshallJAXBElement(ValDistanceType.class,
                new QName("http://www.aixm.aero/schema/5.2", "distance"), DistanceType.class, target));
    }
    ...
    public void setMinimumReceptionAltitudeItem(ValDistanceVerticalType target) {
        setMinimumReceptionAltitude(XmlAdapterUtils.marshallJAXBElement(ValDistanceVerticalType.class,
                new QName("http://www.aixm.aero/schema/5.2", "minimumReceptionAltitude"), DistanceType.class, target));
    }
    ...
    public void setTypeItem(CodeDistanceIndicationType target) {
        setType(XmlAdapterUtils.marshallJAXBElement(CodeDistanceIndicationType.class,
                new QName("http://www.aixm.aero/schema/5.2", "type"), DistanceType.class, target));
    }
    ...
    public void setPointChoiceFixDesignatedPointItem(DesignatedPointPropertyType target) {
        setPointChoiceFixDesignatedPoint(XmlAdapterUtils.marshallJAXBElement(DesignatedPointPropertyType.class,
                new QName("http://www.aixm.aero/schema/5.2", "pointChoice_fixDesignatedPoint"), DistanceType.class,
                target));
    }
    ...
    public void setPointChoiceNavaidSystemItem(NavaidPropertyType target) {
        setPointChoiceNavaidSystem(XmlAdapterUtils.marshallJAXBElement(NavaidPropertyType.class,
                new QName("http://www.aixm.aero/schema/5.2", "pointChoice_navaidSystem"), DistanceType.class, target));
    }
    ...
    public void setPointChoicePositionItem(AIXMPointPropertyType target) {
        setPointChoicePosition(XmlAdapterUtils.marshallJAXBElement(AIXMPointPropertyType.class,
                new QName("http://www.aixm.aero/schema/5.2", "pointChoice_position"), DistanceType.class, target));
    }
    ...
    public void setPointChoiceRunwayPointItem(RunwayCentrelinePointPropertyType target) {
        setPointChoiceRunwayPoint(XmlAdapterUtils.marshallJAXBElement(RunwayCentrelinePointPropertyType.class,
                new QName("http://www.aixm.aero/schema/5.2", "pointChoice_runwayPoint"), DistanceType.class, target));
    }
    ...
    public void setPointChoiceAimingPointItem(TouchDownLiftOffPropertyType target) {
        setPointChoiceAimingPoint(XmlAdapterUtils.marshallJAXBElement(TouchDownLiftOffPropertyType.class,
                new QName("http://www.aixm.aero/schema/5.2", "pointChoice_aimingPoint"), DistanceType.class, target));
    }
    ...
    public void setPointChoiceAirportReferencePointItem(AirportHeliportPropertyType target) {
        setPointChoiceAirportReferencePoint(XmlAdapterUtils.marshallJAXBElement(AirportHeliportPropertyType.class,
                new QName("http://www.aixm.aero/schema/5.2", "pointChoice_airportReferencePoint"), DistanceType.class,
                target));
    }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        }
        {
            ...
            List<DistanceTypeExtensionType> lhsField;
            lhsField = (this.isSetExtension() ? this.getExtension() : null);
            List<DistanceTypeExtensionType> rhsField;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        }
        {
            ...
            List<DistanceTypeExtensionType> theField;
