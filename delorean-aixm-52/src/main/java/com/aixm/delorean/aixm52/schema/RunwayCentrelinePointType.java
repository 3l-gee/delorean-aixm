...
"{http://www.aixm.aero/schema/5.2}RunwayCentrelinePointTimeSlicePropertyType" maxOccurs
="unbounded"/>
 *       </sequence>
 *     </extension>
 *   </complexContent>
...
@Table(name = "runwaycentrelinepoint_f", schema = "airport_heliport")
public class RunwayCentrelinePointType extends AbstractAIXMFeatureType implements Serializable {
    ...
    @OneToMany(targetEntity = RunwayCentrelinePointTimeSlicePropertyType.class, cascade = {
