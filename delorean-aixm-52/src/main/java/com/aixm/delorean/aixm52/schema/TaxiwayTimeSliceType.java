...
/**
 * <p>
 * Java class for TaxiwayTimeSliceType complex type
 * </p>
 * .
 *
 * <p>
...
"{http://www.aixm.aero/schema/5.2}CodeTaxiwayType" minOccurs="0"/>
...
"{http://www.aixm.aero/schema/5.2}TaxiwayContaminationPropertyType" maxOccurs=
 ...
 *                 <sequence>
 *                   <element ref=
"{http://www.aixm.aero/schema/5.2}AbstractTaxiwayExtension"/>
 *                 </sequence>
 *                 <attGroup ref=
...
@XmlType(name = "TaxiwayTimeSliceType", propOrder = {"designator", "type", "width", "widthShoulder", "length",
        "abandoned", "surfaceProperties", "associatedAirportHeliport", "contaminant", "annotation", "availability",
        "diameter", "depth", "extension"})
@Entity(name = "TaxiwayTimeSliceType")
@Table(name = "taxiway_t", schema = "airport_heliport")
public class TaxiwayTimeSliceType extends AbstractAIXMTimeSliceType implements Serializable {
     ...
     *
     * @return possible object is {@link JAXBElement
     *         }{@code <}{@link CodeTaxiwayType }{@code >}
     *
     */
    @Transient
    ...
    @JoinTable(name = "txwtmslctp_cntmnnt_link", schema = "airport_heliport", joinColumns = {
            @JoinColumn(name = "taxiway_t_hjid", referencedColumnName = "hjid")}, inverseJoinColumns = {
     ...
     *
     */
    @OneToMany(targetEntity = TaxiwayTimeSliceExtensionType.class, cascade = {CascadeType.ALL}, fetch = FetchType.EAGER)
    ...
    public void setDesignatorItem(TextDesignatorType target) {
        setDesignator(XmlAdapterUtils.marshallJAXBElement(TextDesignatorType.class,
                new QName("http://www.aixm.aero/schema/5.2", "designator"), TaxiwayTimeSliceType.class, target));
    }
    ...
    public void setTypeItem(CodeTaxiwayType target) {
        setType(XmlAdapterUtils.marshallJAXBElement(CodeTaxiwayType.class,
                new QName("http://www.aixm.aero/schema/5.2", "type"), TaxiwayTimeSliceType.class, target));
    }
    ...
    public void setWidthItem(ValDistanceType target) {
        setWidth(XmlAdapterUtils.marshallJAXBElement(ValDistanceType.class,
                new QName("http://www.aixm.aero/schema/5.2", "width"), TaxiwayTimeSliceType.class, target));
    }
    ...
    @AttributeOverrides({
            ...
            @AttributeOverride(name = "accuracy", column = @Column(name = "widthshoulderaccuracy")),
    ...
    public void setWidthShoulderItem(ValDistanceType target) {
        setWidthShoulder(XmlAdapterUtils.marshallJAXBElement(ValDistanceType.class,
                new QName("http://www.aixm.aero/schema/5.2", "widthShoulder"), TaxiwayTimeSliceType.class, target));
    }
    ...
    public void setLengthItem(ValDistanceType target) {
        setLength(XmlAdapterUtils.marshallJAXBElement(ValDistanceType.class,
                new QName("http://www.aixm.aero/schema/5.2", "length"), TaxiwayTimeSliceType.class, target));
    }
    ...
    public void setAbandonedItem(CodeYesNoType target) {
        setAbandoned(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class,
                new QName("http://www.aixm.aero/schema/5.2", "abandoned"), TaxiwayTimeSliceType.class, target));
    }
    ...
    public void setSurfacePropertiesItem(SurfaceCharacteristicsPropertyType target) {
        setSurfaceProperties(XmlAdapterUtils.marshallJAXBElement(SurfaceCharacteristicsPropertyType.class,
                new QName("http://www.aixm.aero/schema/5.2", "surfaceProperties"), TaxiwayTimeSliceType.class, target));
    }
    ...
    public void setAssociatedAirportHeliportItem(AirportHeliportPropertyType target) {
        setAssociatedAirportHeliport(XmlAdapterUtils.marshallJAXBElement(AirportHeliportPropertyType.class,
                new QName("http://www.aixm.aero/schema/5.2", "associatedAirportHeliport"), TaxiwayTimeSliceType.class,
                target));
    }

    @Embedded
    @AttributeOverrides({
            @AttributeOverride(name = "value", column = @Column(name = "diameter", columnDefinition = "NUMERIC")),
            @AttributeOverride(name = "uom", column = @Column(name = "diameteruom")),
            @AttributeOverride(name = "accuracy", column = @Column(name = "diameteraccuracy")),
            @AttributeOverride(name = "nilReason", column = @Column(name = "diameternilreason"))})
    ...
    public void setDiameterItem(ValDistanceType target) {
        setDiameter(XmlAdapterUtils.marshallJAXBElement(ValDistanceType.class,
                new QName("http://www.aixm.aero/schema/5.2", "diameter"), TaxiwayTimeSliceType.class, target));
    }
    ...
    public void setDepthItem(ValDistanceType target) {
        setDepth(XmlAdapterUtils.marshallJAXBElement(ValDistanceType.class,
                new QName("http://www.aixm.aero/schema/5.2", "depth"), TaxiwayTimeSliceType.class, target));
    }
