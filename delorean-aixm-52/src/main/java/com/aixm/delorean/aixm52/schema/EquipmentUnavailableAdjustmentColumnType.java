...
/**
 * <p>
 * Java class for EquipmentUnavailableAdjustmentColumnType complex type
 * </p>
 * .
 *
 * <p>
 ...
 *       <sequence>
 *         <element name="guidanceEquipment" type=
"{http://www.aixm.aero/schema/5.2}CodeApproachType" minOccurs="0"/>
 *         <element name="landingSystemLights" type=
"{http://www.aixm.aero/schema/5.2}CodeYesNoType" minOccurs="0"/>
 *         <element name="equipmentRVR" type=
"{http://www.aixm.aero/schema/5.2}CodeYesNoType" minOccurs="0"/>
 *         <element name="visibilityAdjustment" type=
 ...
 *                 <choice>
 *                   <element ref=
"{http://www.aixm.aero/schema/5.2}AbstractEquipmentUnavailableAdjustmentColumnExtension"/>
 *                 </choice>
 *                 <attGroup ref=
...
@XmlType(name = "EquipmentUnavailableAdjustmentColumnType", propOrder = {"guidanceEquipment", "landingSystemLights",
        "equipmentRVR", "visibilityAdjustment", "approachLightingInoperative", "annotation", "extension"})
@Entity(name = "EquipmentUnavailableAdjustmentColumnType")
@Table(name = "equipmentunavailableadjustmentcolumn_o", schema = "procedure")
public class EquipmentUnavailableAdjustmentColumnType extends AbstractAIXMObjectType implements Serializable {
    ...
    @JoinTable(name = "eqpmntunvlbladjstmntclmntp_annttn_link", schema = "procedure", joinColumns = {
            @JoinColumn(name = "equipmentunavailableadjustmentcolumn_o_hjid", referencedColumnName = "hjid")}, inverseJoinColumns = {
    ...
    @Embedded
    @AttributeOverrides({@AttributeOverride(name = "value", column = @Column(name = "guidanceequipment")),
            @AttributeOverride(name = "nilReason", column = @Column(name = "guidanceequipmentnilreason"))})
    ...
    public void setGuidanceEquipmentItem(CodeApproachType target) {
        setGuidanceEquipment(XmlAdapterUtils.marshallJAXBElement(CodeApproachType.class,
                new QName("http://www.aixm.aero/schema/5.2", "guidanceEquipment"),
                EquipmentUnavailableAdjustmentColumnType.class, target));
    }

    @Embedded
    @AttributeOverrides({@AttributeOverride(name = "value", column = @Column(name = "landingsystemlights")),
            @AttributeOverride(name = "nilReason", column = @Column(name = "landingsystemlightsnilreason"))})
    ...
    public void setLandingSystemLightsItem(CodeYesNoType target) {
        setLandingSystemLights(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class,
                new QName("http://www.aixm.aero/schema/5.2", "landingSystemLights"),
                EquipmentUnavailableAdjustmentColumnType.class, target));
    }

    @Embedded
    @AttributeOverrides({@AttributeOverride(name = "value", column = @Column(name = "equipmentrvr")),
            @AttributeOverride(name = "nilReason", column = @Column(name = "equipmentrvrnilreason"))})
    ...
    public void setEquipmentRVRItem(CodeYesNoType target) {
        setEquipmentRVR(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class,
                new QName("http://www.aixm.aero/schema/5.2", "equipmentRVR"),
                EquipmentUnavailableAdjustmentColumnType.class, target));
    }
    ...
    @AttributeOverrides({
            ...
            @AttributeOverride(name = "uom", column = @Column(name = "visibilityadjustmentuom")),
            @AttributeOverride(name = "accuracy", column = @Column(name = "visibilityadjustmentaccuracy")),
            @AttributeOverride(name = "nilReason", column = @Column(name = "visibilityadjustmentnilreason"))})
    ...
    public void setVisibilityAdjustmentItem(ValDistanceVerticalType target) {
        setVisibilityAdjustment(XmlAdapterUtils.marshallJAXBElement(ValDistanceVerticalType.class,
                new QName("http://www.aixm.aero/schema/5.2", "visibilityAdjustment"),
                EquipmentUnavailableAdjustmentColumnType.class, target));
    }
    ...
    public void setApproachLightingInoperativeItem(CodeYesNoType target) {
        setApproachLightingInoperative(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class,
                new QName("http://www.aixm.aero/schema/5.2", "approachLightingInoperative"),
                EquipmentUnavailableAdjustmentColumnType.class, target));
    }
