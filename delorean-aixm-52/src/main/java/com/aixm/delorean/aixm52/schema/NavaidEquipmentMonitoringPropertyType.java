...
/**
 * <p>
 * Java class for NavaidEquipmentMonitoringPropertyType complex type
 * </p>
 * .
 *
 * <p>
 ...
 *       <sequence>
 *         <element ref=
"{http://www.aixm.aero/schema/5.2}NavaidEquipmentMonitoring"/>
 *       </sequence>
 *     </extension>
 *   </complexContent>
 * </complexType>
...
@XmlType(name = "NavaidEquipmentMonitoringPropertyType", propOrder = {"navaidEquipmentMonitoring"})
@Entity(name = "NavaidEquipmentMonitoringPropertyType")
@Table(name = "navaidequipmentmonitoringpropertytype", schema = "navaids_point")
public class NavaidEquipmentMonitoringPropertyType extends AbstractAIXMPropertyType implements Serializable {
     ...
     *
     * @return possible object is {@link NavaidEquipmentMonitoringType }
     *
     */
    @OneToOne(targetEntity = NavaidEquipmentMonitoringType.class, cascade = {CascadeType.ALL}, fetch = FetchType.EAGER)
    @JoinColumn(name = "navaidequipmentmonitoring_hjid", referencedColumnName = "hjid")
     ...
     *
     * @param value
     *            allowed object is {@link NavaidEquipmentMonitoringType }
     *
     */
