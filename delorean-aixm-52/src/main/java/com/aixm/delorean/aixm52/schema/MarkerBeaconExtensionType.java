...
@XmlType(name = "", propOrder = {"abstractMarkerBeaconExtension", "abstractNavaidEquipmentExtension"})
@Entity(name = "MarkerBeaconExtensionType")
@Table(name = "markerbeacone", schema = "navaids_point")
public class MarkerBeaconExtensionType implements Serializable, Equals, HashCode, ToString {
    ...
    @JoinColumn(name = "abstractmarkerbeaconextension_hjid", referencedColumnName = "hjid")
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final MarkerBeaconExtensionType that = ((MarkerBeaconExtensionType) object);
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetAbstractMarkerBeaconExtension();
            AbstractExtensionType theField;
            theField = this.getAbstractMarkerBeaconExtension();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "abstractMarkerBeaconExtension", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            AbstractExtensionType theField;
            theField = this.getAbstractMarkerBeaconExtension();
            strategy.appendField(locator, this, "abstractMarkerBeaconExtension", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetAbstractNavaidEquipmentExtension();
            AbstractExtensionType theField;
