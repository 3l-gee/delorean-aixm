...
/**
 * <p>
 * Java class for AirportHotSpotType complex type
 * </p>
 * .
 *
 * <p>
...
"{http://www.aixm.aero/schema/5.2}AirportHotSpotTimeSlicePropertyType" maxOccurs
="unbounded"/>
 *       </sequence>
 *     </extension>
 *   </complexContent>
...
@XmlType(name = "AirportHotSpotType", propOrder = {"timeSlice"})
@Entity(name = "AirportHotSpotType")
@Table(name = "airporthotspot_f", schema = "airport_heliport")
public class AirportHotSpotType extends AbstractAIXMFeatureType implements Serializable {
    ...
    @OneToMany(targetEntity = AirportHotSpotTimeSlicePropertyType.class, cascade = {
     ...
     *
     */
    public void setTimeSlice(List<AirportHotSpotTimeSlicePropertyType> timeSlice) {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final AirportHotSpotType that = ((AirportHotSpotType) object);
        {
            boolean lhsFieldIsSet = this.isSetTimeSlice();
            boolean rhsFieldIsSet = that.isSetTimeSlice();
            List<AirportHotSpotTimeSlicePropertyType> lhsField;
            lhsField = (this.isSetTimeSlice() ? this.getTimeSlice() : null);
            List<AirportHotSpotTimeSlicePropertyType> rhsField;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = super.hashCode(locator, strategy);
        {
            ...
            List<AirportHotSpotTimeSlicePropertyType> theField;
