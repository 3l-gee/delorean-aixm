...
/**
 * <p>
 * Java class for FinalApproachSegmentDataType complex type
 * </p>
 * .
 *
 * <p>
...
"{http://www.aixm.aero/schema/5.2}ValHexType" minOccurs="0"/>
 *         <element name="horizontalAlarmLimit" type=
"{http://www.aixm.aero/schema/5.2}TextDecimalType" minOccurs="0"/>
...
"{http://www.aixm.aero/schema/5.2}CodeReferencePathIdentifierType" minOccurs=
"0"/>
 *         <element name="routeIndicator" type=
"{http://www.aixm.aero/schema/5.2}CodeRouteIndicatorType" minOccurs="0"/>
...
"{http://www.aixm.aero/schema/5.2}TextDecimalType" minOccurs="0"/>
 *         <element name="airportID" type=
"{http://www.aixm.aero/schema/5.2}CodeAirportHeliportDesignatorType" minOccurs=
"0"/>
 *         <element name="runwayNumber" type=
"{http://www.aixm.aero/schema/5.2}TextDesignatorType" minOccurs="0"/>
 *         <element name="runwayLetter" type=
"{http://www.aixm.aero/schema/5.2}TextDesignatorType" minOccurs="0"/>
 *         <element name="thresholdPointLatitude" type=
"{http://www.aixm.aero/schema/5.2}TextLatitudeDMSType" minOccurs="0"/>
 *         <element name="thresholdPointLongitude" type=
"{http://www.aixm.aero/schema/5.2}TextLongitudeDMSType" minOccurs="0"/>
 *         <element name="thresholdPointHeight" type=
"{http://www.aixm.aero/schema/5.2}TextDecimalType" minOccurs="0"/>
 *         <element name="finalPointLatitude" type=
"{http://www.aixm.aero/schema/5.2}TextLatitudeDMSType" minOccurs="0"/>
 *         <element name="finalPointLongitude" type=
"{http://www.aixm.aero/schema/5.2}TextLongitudeDMSType" minOccurs="0"/>
 *         <element name="deltaFinalPointLatitude" type=
"{http://www.aixm.aero/schema/5.2}TextDecimalType" minOccurs="0"/>
 *         <element name="deltaFinalPointLongitude" type=
"{http://www.aixm.aero/schema/5.2}TextDecimalType" minOccurs="0"/>
 *         <element name="thresholdCrossingHeight" type=
"{http://www.aixm.aero/schema/5.2}TextDecimalType" minOccurs="0"/>
 *         <element name="thresholdCrossingHeightUnits" type=
"{http://www.aixm.aero/schema/5.2}NoNumberType" minOccurs="0"/>
 *         <element name="glidepathAngle" type=
"{http://www.aixm.aero/schema/5.2}TextDecimalType" minOccurs="0"/>
 *         <element name="thresholdOrthoHeight" type=
"{http://www.aixm.aero/schema/5.2}TextDecimalType" minOccurs="0"/>
 *         <element name="finalPointOrthoHeight" type=
"{http://www.aixm.aero/schema/5.2}TextDecimalType" minOccurs="0"/>
 *         <element name="FASDataBlock" type=
"{http://www.aixm.aero/schema/5.2}ValHexType" minOccurs="0"/>
 ...
 *                 <choice>
 *                   <element ref=
"{http://www.aixm.aero/schema/5.2}AbstractFinalApproachSegmentDataExtension"/>
 *                 </choice>
 *                 <attGroup ref=
...
@XmlType(name = "FinalApproachSegmentDataType", propOrder = {"approachPerformanceDesignator", "codeICAO",
        "crcRemainder", "horizontalAlarmLimit", "lengthOffset", "operationType", "referencePathDataSelector",
        "referencePathIdentifier", "routeIndicator", "serviceProviderSBAS", "thresholdCourseWidth",
        "verticalAlarmLimit", "airportID", "runwayNumber", "runwayLetter", "thresholdPointLatitude",
        "thresholdPointLongitude", "thresholdPointHeight", "finalPointLatitude", "finalPointLongitude",
        "deltaFinalPointLatitude", "deltaFinalPointLongitude", "thresholdCrossingHeight",
        "thresholdCrossingHeightUnits", "glidepathAngle", "thresholdOrthoHeight", "finalPointOrthoHeight",
        "fasDataBlock", "annotation", "extension"})
@Entity(name = "FinalApproachSegmentDataType")
@Table(name = "finalapproachsegmentdata_o", schema = "procedure")
public class FinalApproachSegmentDataType extends AbstractAIXMObjectType implements Serializable {
    ...
    protected List<FinalApproachSegmentDataTypeExtensionType> extension;
     ...
     *
     * @return possible object is {@link JAXBElement
     *         }{@code <}{@link TextDecimalType }{@code >}
     *
     */
    @Transient
     ...
     *
     * @return possible object is {@link JAXBElement
     *         }{@code <}{@link TextLatitudeDMSType }{@code >}
     *
     */
    @Transient
     ...
     *
     * @return possible object is {@link JAXBElement
     *         }{@code <}{@link TextLongitudeDMSType }{@code >}
     *
     */
    @Transient
    ...
    @JoinTable(name = "fnlapprchsgmntdttp_annttn_link", schema = "procedure", joinColumns = {
            @JoinColumn(name = "finalapproachsegmentdata_o_hjid", referencedColumnName = "hjid")}, inverseJoinColumns = {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link FinalApproachSegmentDataTypeExtensionType }
     *
     *
     */
    @OneToMany(targetEntity = FinalApproachSegmentDataTypeExtensionType.class, cascade = {
            CascadeType.ALL}, fetch = FetchType.EAGER)
    @JoinColumn(name = "finalapproachsegmentdatae_hjid", referencedColumnName = "hjid")
    public List<FinalApproachSegmentDataTypeExtensionType> getExtension() {
        if (extension == null) {
     ...
     *
     */
    public void setExtension(List<FinalApproachSegmentDataTypeExtensionType> extension) {
    ...
    public void setApproachPerformanceDesignatorItem(NoNumberType target) {
        setApproachPerformanceDesignator(XmlAdapterUtils.marshallJAXBElement(NoNumberType.class,
                new QName("http://www.aixm.aero/schema/5.2", "approachPerformanceDesignator"),
                FinalApproachSegmentDataType.class, target));
    }

    @Embedded
    @AttributeOverrides({
            @AttributeOverride(name = "value", column = @Column(name = "codeicao", columnDefinition = "VARCHAR", length = 2)),
    ...
    public void setCodeICAOItem(CodeICAOCountryType target) {
        setCodeICAO(XmlAdapterUtils.marshallJAXBElement(CodeICAOCountryType.class,
                new QName("http://www.aixm.aero/schema/5.2", "codeICAO"), FinalApproachSegmentDataType.class, target));
    }
    ...
    public void setCRCRemainderItem(ValHexType target) {
        setCRCRemainder(XmlAdapterUtils.marshallJAXBElement(ValHexType.class,
                new QName("http://www.aixm.aero/schema/5.2", "CRCRemainder"), FinalApproachSegmentDataType.class,
                target));
    }

    @Embedded
    @AttributeOverrides({
            @AttributeOverride(name = "value", column = @Column(name = "horizontalalarmlimit", columnDefinition = "VARCHAR", length = 256)),
    ...
    public void setHorizontalAlarmLimitItem(TextDecimalType target) {
        setHorizontalAlarmLimit(XmlAdapterUtils.marshallJAXBElement(TextDecimalType.class,
                new QName("http://www.aixm.aero/schema/5.2", "horizontalAlarmLimit"),
                FinalApproachSegmentDataType.class, target));
    }

    @Embedded
    @AttributeOverrides({
            @AttributeOverride(name = "value", column = @Column(name = "lengthoffset", columnDefinition = "VARCHAR", length = 256)),
    ...
    public void setLengthOffsetItem(TextDecimalType target) {
        setLengthOffset(XmlAdapterUtils.marshallJAXBElement(TextDecimalType.class,
                new QName("http://www.aixm.aero/schema/5.2", "lengthOffset"), FinalApproachSegmentDataType.class,
                target));
    }
    ...
    public void setOperationTypeItem(NoNumberType target) {
        setOperationType(XmlAdapterUtils.marshallJAXBElement(NoNumberType.class,
                new QName("http://www.aixm.aero/schema/5.2", "operationType"), FinalApproachSegmentDataType.class,
                target));
    }
    ...
    public void setReferencePathDataSelectorItem(NoSequenceType target) {
        setReferencePathDataSelector(XmlAdapterUtils.marshallJAXBElement(NoSequenceType.class,
                new QName("http://www.aixm.aero/schema/5.2", "referencePathDataSelector"),
                FinalApproachSegmentDataType.class, target));
    }
    ...
    public void setReferencePathIdentifierItem(CodeReferencePathIdentifierType target) {
        setReferencePathIdentifier(XmlAdapterUtils.marshallJAXBElement(CodeReferencePathIdentifierType.class,
                new QName("http://www.aixm.aero/schema/5.2", "referencePathIdentifier"),
                FinalApproachSegmentDataType.class, target));
    }
    ...
    public void setRouteIndicatorItem(CodeRouteIndicatorType target) {
        setRouteIndicator(XmlAdapterUtils.marshallJAXBElement(CodeRouteIndicatorType.class,
                new QName("http://www.aixm.aero/schema/5.2", "routeIndicator"), FinalApproachSegmentDataType.class,
                target));
    }
    ...
    public void setServiceProviderSBASItem(NoNumberType target) {
        setServiceProviderSBAS(XmlAdapterUtils.marshallJAXBElement(NoNumberType.class,
                new QName("http://www.aixm.aero/schema/5.2", "serviceProviderSBAS"), FinalApproachSegmentDataType.class,
                target));
    }

    @Embedded
    @AttributeOverrides({
            @AttributeOverride(name = "value", column = @Column(name = "thresholdcoursewidth", columnDefinition = "VARCHAR", length = 256)),
    ...
    public void setThresholdCourseWidthItem(TextDecimalType target) {
        setThresholdCourseWidth(XmlAdapterUtils.marshallJAXBElement(TextDecimalType.class,
                new QName("http://www.aixm.aero/schema/5.2", "thresholdCourseWidth"),
                FinalApproachSegmentDataType.class, target));
    }

    @Embedded
    @AttributeOverrides({
            @AttributeOverride(name = "value", column = @Column(name = "verticalalarmlimit", columnDefinition = "VARCHAR", length = 256)),
    ...
    public void setVerticalAlarmLimitItem(TextDecimalType target) {
        setVerticalAlarmLimit(XmlAdapterUtils.marshallJAXBElement(TextDecimalType.class,
                new QName("http://www.aixm.aero/schema/5.2", "verticalAlarmLimit"), FinalApproachSegmentDataType.class,
                target));
    }

    @Embedded
    @AttributeOverrides({
            @AttributeOverride(name = "value", column = @Column(name = "airportid", columnDefinition = "VARCHAR", length = 6)),
            @AttributeOverride(name = "nilReason", column = @Column(name = "airportidnilreason"))})
    ...
    public void setAirportIDItem(CodeAirportHeliportDesignatorType target) {
        setAirportID(XmlAdapterUtils.marshallJAXBElement(CodeAirportHeliportDesignatorType.class,
                new QName("http://www.aixm.aero/schema/5.2", "airportID"), FinalApproachSegmentDataType.class, target));
    }

    @Embedded
    @AttributeOverrides({
            @AttributeOverride(name = "value", column = @Column(name = "runwaynumber", columnDefinition = "VARCHAR", length = 16)),
            @AttributeOverride(name = "nilReason", column = @Column(name = "runwaynumbernilreason"))})
    ...
    public void setRunwayNumberItem(TextDesignatorType target) {
        setRunwayNumber(XmlAdapterUtils.marshallJAXBElement(TextDesignatorType.class,
                new QName("http://www.aixm.aero/schema/5.2", "runwayNumber"), FinalApproachSegmentDataType.class,
                target));
    }

    @Embedded
    @AttributeOverrides({
            @AttributeOverride(name = "value", column = @Column(name = "runwayletter", columnDefinition = "VARCHAR", length = 16)),
            @AttributeOverride(name = "nilReason", column = @Column(name = "runwayletternilreason"))})
    ...
    public void setRunwayLetterItem(TextDesignatorType target) {
        setRunwayLetter(XmlAdapterUtils.marshallJAXBElement(TextDesignatorType.class,
                new QName("http://www.aixm.aero/schema/5.2", "runwayLetter"), FinalApproachSegmentDataType.class,
                target));
    }

    @Embedded
    @AttributeOverrides({
            @AttributeOverride(name = "value", column = @Column(name = "thresholdpointlatitude", columnDefinition = "VARCHAR", length = 256)),
            @AttributeOverride(name = "nilReason", column = @Column(name = "thresholdpointlatitudenilreason"))})
    ...
    public void setThresholdPointLatitudeItem(TextLatitudeDMSType target) {
        setThresholdPointLatitude(XmlAdapterUtils.marshallJAXBElement(TextLatitudeDMSType.class,
                new QName("http://www.aixm.aero/schema/5.2", "thresholdPointLatitude"),
                FinalApproachSegmentDataType.class, target));
    }

    @Embedded
    @AttributeOverrides({
            @AttributeOverride(name = "value", column = @Column(name = "thresholdpointlongitude", columnDefinition = "VARCHAR", length = 256)),
            @AttributeOverride(name = "nilReason", column = @Column(name = "thresholdpointlongitudenilreason"))})
    ...
    public void setThresholdPointLongitudeItem(TextLongitudeDMSType target) {
        setThresholdPointLongitude(XmlAdapterUtils.marshallJAXBElement(TextLongitudeDMSType.class,
                new QName("http://www.aixm.aero/schema/5.2", "thresholdPointLongitude"),
                FinalApproachSegmentDataType.class, target));
    }

    @Embedded
    @AttributeOverrides({
            @AttributeOverride(name = "value", column = @Column(name = "thresholdpointheight", columnDefinition = "VARCHAR", length = 256)),
            @AttributeOverride(name = "nilReason", column = @Column(name = "thresholdpointheightnilreason"))})
    ...
    public void setThresholdPointHeightItem(TextDecimalType target) {
        setThresholdPointHeight(XmlAdapterUtils.marshallJAXBElement(TextDecimalType.class,
                new QName("http://www.aixm.aero/schema/5.2", "thresholdPointHeight"),
                FinalApproachSegmentDataType.class, target));
    }

    @Embedded
    @AttributeOverrides({
            @AttributeOverride(name = "value", column = @Column(name = "finalpointlatitude", columnDefinition = "VARCHAR", length = 256)),
            @AttributeOverride(name = "nilReason", column = @Column(name = "finalpointlatitudenilreason"))})
    ...
    public void setFinalPointLatitudeItem(TextLatitudeDMSType target) {
        setFinalPointLatitude(XmlAdapterUtils.marshallJAXBElement(TextLatitudeDMSType.class,
                new QName("http://www.aixm.aero/schema/5.2", "finalPointLatitude"), FinalApproachSegmentDataType.class,
                target));
    }

    @Embedded
    @AttributeOverrides({
            @AttributeOverride(name = "value", column = @Column(name = "finalpointlongitude", columnDefinition = "VARCHAR", length = 256)),
            @AttributeOverride(name = "nilReason", column = @Column(name = "finalpointlongitudenilreason"))})
    ...
    public void setFinalPointLongitudeItem(TextLongitudeDMSType target) {
        setFinalPointLongitude(XmlAdapterUtils.marshallJAXBElement(TextLongitudeDMSType.class,
                new QName("http://www.aixm.aero/schema/5.2", "finalPointLongitude"), FinalApproachSegmentDataType.class,
                target));
    }

    @Embedded
    @AttributeOverrides({
            @AttributeOverride(name = "value", column = @Column(name = "deltafinalpointlatitude", columnDefinition = "VARCHAR", length = 256)),
            @AttributeOverride(name = "nilReason", column = @Column(name = "deltafinalpointlatitudenilreason"))})
    ...
    public void setDeltaFinalPointLatitudeItem(TextDecimalType target) {
        setDeltaFinalPointLatitude(XmlAdapterUtils.marshallJAXBElement(TextDecimalType.class,
                new QName("http://www.aixm.aero/schema/5.2", "deltaFinalPointLatitude"),
                FinalApproachSegmentDataType.class, target));
    }

    @Embedded
    @AttributeOverrides({
            @AttributeOverride(name = "value", column = @Column(name = "deltafinalpointlongitude", columnDefinition = "VARCHAR", length = 256)),
            @AttributeOverride(name = "nilReason", column = @Column(name = "deltafinalpointlongitudenilreason"))})
    ...
    public void setDeltaFinalPointLongitudeItem(TextDecimalType target) {
        setDeltaFinalPointLongitude(XmlAdapterUtils.marshallJAXBElement(TextDecimalType.class,
                new QName("http://www.aixm.aero/schema/5.2", "deltaFinalPointLongitude"),
                FinalApproachSegmentDataType.class, target));
    }

    @Embedded
    @AttributeOverrides({
            @AttributeOverride(name = "value", column = @Column(name = "thresholdcrossingheight", columnDefinition = "VARCHAR", length = 256)),
            @AttributeOverride(name = "nilReason", column = @Column(name = "thresholdcrossingheightnilreason"))})
    ...
    public void setThresholdCrossingHeightItem(TextDecimalType target) {
        setThresholdCrossingHeight(XmlAdapterUtils.marshallJAXBElement(TextDecimalType.class,
                new QName("http://www.aixm.aero/schema/5.2", "thresholdCrossingHeight"),
                FinalApproachSegmentDataType.class, target));
    }

    @Embedded
    @AttributeOverrides({@AttributeOverride(name = "value", column = @Column(name = "thresholdcrossingheightunits")),
            @AttributeOverride(name = "nilReason", column = @Column(name = "thresholdcrossingheightunitsnilreason"))})
    ...
    public void setThresholdCrossingHeightUnitsItem(NoNumberType target) {
        setThresholdCrossingHeightUnits(XmlAdapterUtils.marshallJAXBElement(NoNumberType.class,
                new QName("http://www.aixm.aero/schema/5.2", "thresholdCrossingHeightUnits"),
                FinalApproachSegmentDataType.class, target));
    }

    @Embedded
    @AttributeOverrides({
            @AttributeOverride(name = "value", column = @Column(name = "glidepathangle", columnDefinition = "VARCHAR", length = 256)),
            @AttributeOverride(name = "nilReason", column = @Column(name = "glidepathanglenilreason"))})
    ...
    public void setGlidepathAngleItem(TextDecimalType target) {
        setGlidepathAngle(XmlAdapterUtils.marshallJAXBElement(TextDecimalType.class,
                new QName("http://www.aixm.aero/schema/5.2", "glidepathAngle"), FinalApproachSegmentDataType.class,
                target));
    }

    @Embedded
    @AttributeOverrides({
            @AttributeOverride(name = "value", column = @Column(name = "thresholdorthoheight", columnDefinition = "VARCHAR", length = 256)),
            @AttributeOverride(name = "nilReason", column = @Column(name = "thresholdorthoheightnilreason"))})
    ...
    public void setThresholdOrthoHeightItem(TextDecimalType target) {
        setThresholdOrthoHeight(XmlAdapterUtils.marshallJAXBElement(TextDecimalType.class,
                new QName("http://www.aixm.aero/schema/5.2", "thresholdOrthoHeight"),
                FinalApproachSegmentDataType.class, target));
    }

    @Embedded
    @AttributeOverrides({
            @AttributeOverride(name = "value", column = @Column(name = "finalpointorthoheight", columnDefinition = "VARCHAR", length = 256)),
            @AttributeOverride(name = "nilReason", column = @Column(name = "finalpointorthoheightnilreason"))})
    ...
    public void setFinalPointOrthoHeightItem(TextDecimalType target) {
        setFinalPointOrthoHeight(XmlAdapterUtils.marshallJAXBElement(TextDecimalType.class,
                new QName("http://www.aixm.aero/schema/5.2", "finalPointOrthoHeight"),
                FinalApproachSegmentDataType.class, target));
    }

    @Embedded
    @AttributeOverrides({
            @AttributeOverride(name = "value", column = @Column(name = "fasdatablock", columnDefinition = "VARCHAR", length = 256)),
            @AttributeOverride(name = "nilReason", column = @Column(name = "fasdatablocknilreason"))})
    ...
    public void setFASDataBlockItem(ValHexType target) {
        setFASDataBlock(XmlAdapterUtils.marshallJAXBElement(ValHexType.class,
                new QName("http://www.aixm.aero/schema/5.2", "FASDataBlock"), FinalApproachSegmentDataType.class,
                target));
    }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        }
        {
            ...
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "thresholdCrossingHeightUnits",
                    lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "thresholdCrossingHeightUnits",
                    rhsField);
            if (!strategy.equals(lhsFieldLocator, rhsFieldLocator, lhsField, rhsField, lhsFieldIsSet, rhsFieldIsSet)) {
                return false;
            }
        ...
        }
        {
            ...
            List<FinalApproachSegmentDataTypeExtensionType> lhsField;
            lhsField = (this.isSetExtension() ? this.getExtension() : null);
            List<FinalApproachSegmentDataTypeExtensionType> rhsField;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        }
        {
            ...
            List<FinalApproachSegmentDataTypeExtensionType> theField;
