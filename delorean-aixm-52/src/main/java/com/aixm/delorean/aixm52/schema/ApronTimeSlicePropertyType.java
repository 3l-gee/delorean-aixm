...
/**
 * <p>
 * Java class for ApronTimeSlicePropertyType complex type
 * </p>
 * .
 *
 * <p>
 ...
 *       <sequence>
 *         <element ref="{http://www.aixm.aero/schema/5.2}ApronTimeSlice"/>
 *       </sequence>
 *       <attGroup ref=
...
@Table(name = "apron_tp", schema = "airport_heliport")
public class ApronTimeSlicePropertyType implements Serializable, Equals, HashCode, ToString {
     ...
     *
     * @return possible object is {@link ApronTimeSliceType }
     *
     */
    @OneToOne(targetEntity = ApronTimeSliceType.class, cascade = {CascadeType.ALL}, fetch = FetchType.EAGER)
    @JoinColumn(name = "aprontimeslice_hjid", referencedColumnName = "hjid")
     ...
     *
     * @param value
     *            allowed object is {@link ApronTimeSliceType }
     *
     */
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final ApronTimeSlicePropertyType that = ((ApronTimeSlicePropertyType) object);
        {
            ...
            lhsField = this.getApronTimeSlice();
            ApronTimeSliceType rhsField;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetApronTimeSlice();
            ApronTimeSliceType theField;
            theField = this.getApronTimeSlice();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "apronTimeSlice", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            ApronTimeSliceType theField;
            theField = this.getApronTimeSlice();
            strategy.appendField(locator, this, "apronTimeSlice", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetOwns();
            boolean theField;
