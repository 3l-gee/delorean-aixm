...
/**
 * <p>
 * Java class for AircraftStandContaminationPropertyType complex type
 * </p>
 * .
 *
 * <p>
 ...
 *       <sequence>
 *         <element ref=
"{http://www.aixm.aero/schema/5.2}AircraftStandContamination"/>
 *       </sequence>
 *     </extension>
 *   </complexContent>
 * </complexType>
...
@XmlType(name = "AircraftStandContaminationPropertyType", propOrder = {"aircraftStandContamination"})
@Entity(name = "AircraftStandContaminationPropertyType")
@Table(name = "aircraftstandcontaminationpropertytype", schema = "airport_heliport")
public class AircraftStandContaminationPropertyType extends AbstractAIXMPropertyType implements Serializable {
     ...
     *
     * @return possible object is {@link AircraftStandContaminationType }
     *
     */
    @OneToOne(targetEntity = AircraftStandContaminationType.class, cascade = {CascadeType.ALL}, fetch = FetchType.EAGER)
    @JoinColumn(name = "aircraftstandcontamination_hjid", referencedColumnName = "hjid")
     ...
     *
     * @param value
     *            allowed object is {@link AircraftStandContaminationType }
     *
     */
