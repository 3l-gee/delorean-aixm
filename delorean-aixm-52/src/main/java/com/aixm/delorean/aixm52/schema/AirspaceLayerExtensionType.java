...
@XmlType(name = "", propOrder = {"abstractAirspaceLayerExtension"})
@Entity(name = "AirspaceLayerExtensionType")
@Table(name = "airspacelayer_oe", schema = "shared")
public class AirspaceLayerExtensionType implements Serializable, Equals, HashCode, ToString {
    ...
    @JoinColumn(name = "abstractairspacelayerextension_hjid", referencedColumnName = "hjid")
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final AirspaceLayerExtensionType that = ((AirspaceLayerExtensionType) object);
        {
        ...
        }
        {
            ...
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "abstractAirspaceLayerExtension",
                    lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "abstractAirspaceLayerExtension",
                    rhsField);
            if (!strategy.equals(lhsFieldLocator, rhsFieldLocator, lhsField, rhsField, lhsFieldIsSet, rhsFieldIsSet)) {
                return false;
            }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetAbstractAirspaceLayerExtension();
            AbstractExtensionType theField;
            theField = this.getAbstractAirspaceLayerExtension();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "abstractAirspaceLayerExtension", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            AbstractExtensionType theField;
            theField = this.getAbstractAirspaceLayerExtension();
            strategy.appendField(locator, this, "abstractAirspaceLayerExtension", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetOwns();
            boolean theField;
