...
@Entity(name = "AltimeterCheckpointExtensionType")
@Table(name = "altimetercheckpointe", schema = "navaids_point")
public class AltimeterCheckpointExtensionType implements Serializable, Equals, HashCode, ToString {

    private static final long serialVersionUID = 20251104L;
    @XmlElement(name = "AbstractAltimeterCheckpointExtension")
    protected AbstractExtensionType abstractAltimeterCheckpointExtension;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final AltimeterCheckpointExtensionType that = ((AltimeterCheckpointExtensionType) object);
        {
