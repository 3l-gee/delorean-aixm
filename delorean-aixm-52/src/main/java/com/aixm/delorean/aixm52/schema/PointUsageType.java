...
/**
 * <p>
 * Java class for PointUsageType complex type
 * </p>
 * .
 *
 * <p>
...
"{http://www.aixm.aero/schema/5.2}CodePointUsageType" minOccurs="0"/>
...
"unbounded" minOccurs="0"/>
 *         <element name="referenceAirportHeliport" type=
 ...
 *                   <element ref=
"{http://www.aixm.aero/schema/5.2}AbstractPointUsageExtension"/>
 *                 </choice>
 *                 <attGroup ref=
...
@XmlType(name = "PointUsageType", propOrder = {"timeInterval", "annotation", "specialDateAuthority", "role",
        "reportingATC", "cardinalDirection", "levels", "referenceAirportHeliport", "extension"})
@Entity(name = "PointUsageType")
@Table(name = "pointusage_o", schema = "navaids_point")
public class PointUsageType extends AbstractPropertiesWithScheduleType implements Serializable {
    ...
    protected List<PointUsageTypeExtensionType> extension;
    ...
    @JoinTable(name = "pntusgtp_tmintrvl_link", schema = "navaids_point", joinColumns = {
            @JoinColumn(name = "pointusage_o_hjid", referencedColumnName = "hjid")}, inverseJoinColumns = {
    ...
    @JoinTable(name = "pntusgtp_annttn_link", schema = "navaids_point", joinColumns = {
            @JoinColumn(name = "pointusage_o_hjid", referencedColumnName = "hjid")}, inverseJoinColumns = {
    ...
    @JoinTable(name = "pntusgtp_spcldtathrt_link", schema = "navaids_point", joinColumns = {
            @JoinColumn(name = "pointusage_o_hjid", referencedColumnName = "hjid")}, inverseJoinColumns = {
     ...
     *         }{@code <}{@link CodePointUsageType }{@code >}
     *
     */
    @Transient
    ...
    @JoinTable(name = "pntusgtp_lvls_link", schema = "navaids_point", joinColumns = {
            @JoinColumn(name = "pointusage_o_hjid", referencedColumnName = "hjid")}, inverseJoinColumns = {
     ...
     * Therefore any modification you make to the returned list will be present
     * inside the JAXB object. This is why there is not a <CODE>set</CODE> method
     * for the referenceAirportHeliport property.
     *
     * <p>
     * For example, to add a new item, do as follows:
     *
    ...
    @JoinTable(name = "pntusgtp_rfrncarprthlprt_link", schema = "navaids_point", joinColumns = {
            @JoinColumn(name = "pointusage_o_hjid", referencedColumnName = "hjid")}, inverseJoinColumns = {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link PointUsageTypeExtensionType }
     *
     *
     */
    @OneToMany(targetEntity = PointUsageTypeExtensionType.class, cascade = {CascadeType.ALL}, fetch = FetchType.EAGER)
    @JoinColumn(name = "pointusagee_hjid", referencedColumnName = "hjid")
    public List<PointUsageTypeExtensionType> getExtension() {
        if (extension == null) {
     ...
     *
     */
    public void setExtension(List<PointUsageTypeExtensionType> extension) {
    ...
    public void setRoleItem(CodePointUsageType target) {
        setRole(XmlAdapterUtils.marshallJAXBElement(CodePointUsageType.class,
                new QName("http://www.aixm.aero/schema/5.2", "role"), PointUsageType.class, target));
    }
    ...
    public void setReportingATCItem(CodeATCReportingType target) {
        setReportingATC(XmlAdapterUtils.marshallJAXBElement(CodeATCReportingType.class,
                new QName("http://www.aixm.aero/schema/5.2", "reportingATC"), PointUsageType.class, target));
    }
    ...
    public void setCardinalDirectionItem(CodeCardinalDirectionType target) {
        setCardinalDirection(XmlAdapterUtils.marshallJAXBElement(CodeCardinalDirectionType.class,
                new QName("http://www.aixm.aero/schema/5.2", "cardinalDirection"), PointUsageType.class, target));
    }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        }
        {
            ...
            List<PointUsageTypeExtensionType> lhsField;
            lhsField = (this.isSetExtension() ? this.getExtension() : null);
            List<PointUsageTypeExtensionType> rhsField;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        }
        {
            ...
            List<PointUsageTypeExtensionType> theField;
