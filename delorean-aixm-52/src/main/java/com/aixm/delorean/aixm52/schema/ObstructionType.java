...
public class ObstructionType extends AbstractAIXMObjectType implements Serializable {
    ...
    @XmlElementRef(name = "minimumAltitude", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<ValDistanceVerticalType> minimumAltitude;
    @XmlElementRef(name = "surfacePenetration", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<CodeYesNoType> surfacePenetration;
    @XmlElementRef(name = "slopePenetration", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<ValAngleType> slopePenetration;
    @XmlElementRef(name = "controlling", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<CodeYesNoType> controlling;
    @XmlElementRef(name = "closeIn", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<CodeYesNoType> closeIn;
    @XmlElementRef(name = "theVerticalStructure", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
