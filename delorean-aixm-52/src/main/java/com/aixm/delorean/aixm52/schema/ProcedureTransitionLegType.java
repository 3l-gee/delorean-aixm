...
/**
 * <p>
 * Java class for ProcedureTransitionLegType complex type
 * </p>
 * .
 *
 * <p>
 ...
 *       <sequence>
 *         <element name="seqNumberARINC" type=
"{http://www.aixm.aero/schema/5.2}NoSequenceType" minOccurs="0"/>
 *         <element name="annotation" type=
"{http://www.aixm.aero/schema/5.2}NotePropertyType" maxOccurs=
"unbounded" minOccurs="0"/>
 *         <element name="theSegmentLeg" type=
"{http://www.aixm.aero/schema/5.2}SegmentLegPropertyType" minOccurs="0"/>
 ...
 *                 <choice>
 *                   <element ref=
"{http://www.aixm.aero/schema/5.2}AbstractProcedureTransitionLegExtension"/>
 *                 </choice>
 *                 <attGroup ref=
...
@XmlType(name = "ProcedureTransitionLegType", propOrder = {"seqNumberARINC", "annotation", "theSegmentLeg",
        "extension"})
@Entity(name = "ProcedureTransitionLegType")
@Table(name = "proceduretransitionleg_o", schema = "procedure")
public class ProcedureTransitionLegType extends AbstractAIXMObjectType implements Serializable {

    private static final long serialVersionUID = 20251104L;
    @XmlElementRef(name = "seqNumberARINC", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<NoSequenceType> seqNumberARINC;
    @XmlElement(nillable = true)
    protected List<NotePropertyType> annotation;
    @XmlElementRef(name = "theSegmentLeg", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<SegmentLegPropertyType> theSegmentLeg;
    ...
    @JoinTable(name = "prcdrtrnstnlgtp_annttn_link", schema = "procedure", joinColumns = {
            @JoinColumn(name = "proceduretransitionleg_o_hjid", referencedColumnName = "hjid")}, inverseJoinColumns = {
     ...
     *         }{@code <}{@link SegmentLegPropertyType }{@code >}
     *
     */
    @Transient
    public JAXBElement<SegmentLegPropertyType> getTheSegmentLeg() {
     ...
     *
     */
    public void setTheSegmentLeg(JAXBElement<SegmentLegPropertyType> value) {
    ...
    @Embedded
    @AttributeOverrides({@AttributeOverride(name = "value", column = @Column(name = "seqnumberarinc")),
            @AttributeOverride(name = "nilReason", column = @Column(name = "seqnumberarincnilreason"))})
    public NoSequenceType getSeqNumberARINCItem() {
        return XmlAdapterUtils.unmarshallSource(NoSequenceType.class, this.getSeqNumberARINC());
    }

    public void setSeqNumberARINCItem(NoSequenceType target) {
        setSeqNumberARINC(XmlAdapterUtils.marshallJAXBElement(NoSequenceType.class,
                new QName("http://www.aixm.aero/schema/5.2", "seqNumberARINC"), ProcedureTransitionLegType.class,
                target));
    }

    @OneToOne(targetEntity = SegmentLegPropertyType.class, cascade = {CascadeType.ALL}, fetch = FetchType.EAGER)
    ...
    public SegmentLegPropertyType getTheSegmentLegItem() {
        return XmlAdapterUtils.unmarshallSource(SegmentLegPropertyType.class, this.getTheSegmentLeg());
    }

    public void setTheSegmentLegItem(SegmentLegPropertyType target) {
        setTheSegmentLeg(XmlAdapterUtils.marshallJAXBElement(SegmentLegPropertyType.class,
                new QName("http://www.aixm.aero/schema/5.2", "theSegmentLeg"), ProcedureTransitionLegType.class,
                target));
    }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetSeqNumberARINC();
            JAXBElement<NoSequenceType> theField;
            theField = this.getSeqNumberARINC();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "seqNumberARINC", theField);
        ...
        {
            boolean theFieldIsSet = this.isSetTheSegmentLeg();
            JAXBElement<SegmentLegPropertyType> theField;
            theField = this.getTheSegmentLeg();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "theSegmentLeg", theField);
            currentHashCode = strategy.hashCode(theFieldLocator, currentHashCode, theField, theFieldIsSet);
        }
        {
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        super.appendFields(locator, buffer, strategy);
        {
            ...
            JAXBElement<NoSequenceType> theField;
            theField = this.getSeqNumberARINC();
            strategy.appendField(locator, this, "seqNumberARINC", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetAnnotation();
            List<NotePropertyType> theField;
        ...
        }
        {
            ...
            JAXBElement<SegmentLegPropertyType> theField;
            theField = this.getTheSegmentLeg();
            strategy.appendField(locator, this, "theSegmentLeg", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetExtension();
            List<ProcedureTransitionLegExtensionType> theField;
