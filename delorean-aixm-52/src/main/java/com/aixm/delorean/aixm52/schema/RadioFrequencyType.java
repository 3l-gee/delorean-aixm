...
/**
 * <p>
 * Java class for RadioFrequencyType complex type
 * </p>
 * .
 *
 * <p>
...
@XmlType(name = "RadioFrequencyType", propOrder = {"frequency", "annotation", "extension"})
@Entity(name = "RadioFrequencyType")
@Table(name = "radiofrequency_o", schema = "navaids_point")
public class RadioFrequencyType extends AbstractAIXMObjectType implements Serializable {
    ...
    @JoinTable(name = "rdfrqnctp_annttn_link", schema = "navaids_point", joinColumns = {
            @JoinColumn(name = "radiofrequency_o_hjid", referencedColumnName = "hjid")}, inverseJoinColumns = {
    ...
    public void setFrequencyItem(ValFrequencyType target) {
        setFrequency(XmlAdapterUtils.marshallJAXBElement(ValFrequencyType.class,
                new QName("http://www.aixm.aero/schema/5.2", "frequency"), RadioFrequencyType.class, target));
    }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final RadioFrequencyType that = ((RadioFrequencyType) object);
        {
