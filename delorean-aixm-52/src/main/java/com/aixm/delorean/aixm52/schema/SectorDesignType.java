 ...
 *                 <choice>
 *                   <element ref=
"{http://www.aixm.aero/schema/5.2}AbstractSectorDesignExtension"/>
 *                 </choice>
 *                 <attGroup ref=
...
public class SectorDesignType extends AbstractAIXMObjectType implements Serializable {
    ...
    @JoinTable(name = "sctrdsgntp_annttn_link", schema = "procedure", joinColumns = {
            @JoinColumn(name = "sectordesign_o_hjid", referencedColumnName = "hjid")}, inverseJoinColumns = {
    ...
    public void setTurnDirectionItem(CodeDirectionTurnType target) {
        setTurnDirection(XmlAdapterUtils.marshallJAXBElement(CodeDirectionTurnType.class,
                new QName("http://www.aixm.aero/schema/5.2", "turnDirection"), SectorDesignType.class, target));
    }

    @Embedded
    @AttributeOverrides({
            @AttributeOverride(name = "value", column = @Column(name = "designgradient", columnDefinition = "NUMERIC")),
            @AttributeOverride(name = "nilReason", column = @Column(name = "designgradientnilreason")),
            @AttributeOverride(name = "accuracy", column = @Column(name = "designgradientaccuracy"))})
    ...
    public void setDesignGradientItem(ValSlopeType target) {
        setDesignGradient(XmlAdapterUtils.marshallJAXBElement(ValSlopeType.class,
                new QName("http://www.aixm.aero/schema/5.2", "designGradient"), SectorDesignType.class, target));
    }

    @Embedded
    @AttributeOverrides({
            @AttributeOverride(name = "value", column = @Column(name = "terminationaltitude", columnDefinition = "VARCHAR", length = 256)),
            @AttributeOverride(name = "uom", column = @Column(name = "terminationaltitudeuom")),
            @AttributeOverride(name = "accuracy", column = @Column(name = "terminationaltitudeaccuracy")),
            @AttributeOverride(name = "nilReason", column = @Column(name = "terminationaltitudenilreason"))})
    ...
    public void setTerminationAltitudeItem(ValDistanceVerticalType target) {
        setTerminationAltitude(XmlAdapterUtils.marshallJAXBElement(ValDistanceVerticalType.class,
                new QName("http://www.aixm.aero/schema/5.2", "terminationAltitude"), SectorDesignType.class, target));
    }

    @Embedded
    @AttributeOverrides({@AttributeOverride(name = "value", column = @Column(name = "turnpermitted")),
            @AttributeOverride(name = "nilReason", column = @Column(name = "turnpermittednilreason"))})
    ...
    public void setTurnPermittedItem(CodeYesNoType target) {
        setTurnPermitted(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class,
                new QName("http://www.aixm.aero/schema/5.2", "turnPermitted"), SectorDesignType.class, target));
    }
