...
/**
 * <p>
 * Java class for RunwayTimeSlicePropertyType complex type
 * </p>
 * .
 *
 * <p>
 ...
 *       <sequence>
 *         <element ref="{http://www.aixm.aero/schema/5.2}RunwayTimeSlice"/>
 *       </sequence>
 *       <attGroup ref=
...
@Table(name = "runway_tp", schema = "airport_heliport")
public class RunwayTimeSlicePropertyType implements Serializable, Equals, HashCode, ToString {
     ...
     *
     * @return possible object is {@link RunwayTimeSliceType }
     *
     */
    @OneToOne(targetEntity = RunwayTimeSliceType.class, cascade = {CascadeType.ALL}, fetch = FetchType.EAGER)
    @JoinColumn(name = "runwaytimeslice_hjid", referencedColumnName = "hjid")
     ...
     *
     * @param value
     *            allowed object is {@link RunwayTimeSliceType }
     *
     */
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetRunwayTimeSlice();
            RunwayTimeSliceType theField;
            theField = this.getRunwayTimeSlice();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "runwayTimeSlice", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            RunwayTimeSliceType theField;
            theField = this.getRunwayTimeSlice();
            strategy.appendField(locator, this, "runwayTimeSlice", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetOwns();
            boolean theField;
