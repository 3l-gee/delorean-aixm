...
/**
 * <p>
 * Java class for FloatingDockSiteType complex type
 * </p>
 * .
 *
 * <p>
...
"{http://www.aixm.aero/schema/5.2}FloatingDockSiteTimeSlicePropertyType" maxOccurs
="unbounded"/>
 *       </sequence>
 *     </extension>
 *   </complexContent>
...
@XmlType(name = "FloatingDockSiteType", propOrder = {"timeSlice"})
@Entity(name = "FloatingDockSiteType")
@Table(name = "floatingdocksite_f", schema = "airport_heliport")
public class FloatingDockSiteType extends AbstractAIXMFeatureType implements Serializable {
     ...
     *
     */
    public void setTimeSlice(List<FloatingDockSiteTimeSlicePropertyType> timeSlice) {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final FloatingDockSiteType that = ((FloatingDockSiteType) object);
        {
            boolean lhsFieldIsSet = this.isSetTimeSlice();
            boolean rhsFieldIsSet = that.isSetTimeSlice();
            List<FloatingDockSiteTimeSlicePropertyType> lhsField;
            lhsField = (this.isSetTimeSlice() ? this.getTimeSlice() : null);
            List<FloatingDockSiteTimeSlicePropertyType> rhsField;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = super.hashCode(locator, strategy);
        {
            ...
            List<FloatingDockSiteTimeSlicePropertyType> theField;
