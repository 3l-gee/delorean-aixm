...
@XmlType(name = "", propOrder = {"abstractLocalizerExtension", "abstractNavaidEquipmentExtension"})
@Entity(name = "LocalizerTimeSliceExtensionType")
@Table(name = "localizer_te", schema = "navaids_point")
public class LocalizerTimeSliceExtensionType implements Serializable, Equals, HashCode, ToString {
    ...
    @JoinColumn(name = "abstractlocalizerextension_hjid", referencedColumnName = "hjid")
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final LocalizerTimeSliceExtensionType that = ((LocalizerTimeSliceExtensionType) object);
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetAbstractLocalizerExtension();
            AbstractExtensionType theField;
            theField = this.getAbstractLocalizerExtension();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "abstractLocalizerExtension", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            AbstractExtensionType theField;
            theField = this.getAbstractLocalizerExtension();
            strategy.appendField(locator, this, "abstractLocalizerExtension", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetAbstractNavaidEquipmentExtension();
            AbstractExtensionType theField;
