...
/**
 * <p>
 * Java class for NonMovementAreaTimeSliceType complex type
 * </p>
 * .
 *
 * <p>
 ...
 *                 <sequence>
 *                   <element ref=
"{http://www.aixm.aero/schema/5.2}AbstractNonMovementAreaExtension"/>
 *                 </sequence>
 *                 <attGroup ref=
...
@XmlType(name = "NonMovementAreaTimeSliceType", propOrder = {"associatedAirportHeliport", "extent", "annotation",
        "extension"})
@Entity(name = "NonMovementAreaTimeSliceType")
@Table(name = "nonmovementarea_t", schema = "airport_heliport")
public class NonMovementAreaTimeSliceType extends AbstractAIXMTimeSliceType implements Serializable {
    ...
    @JoinTable(name = "nnmvmntartmslctp_annttn_link", schema = "airport_heliport", joinColumns = {
            @JoinColumn(name = "nonmovementarea_t_hjid", referencedColumnName = "hjid")}, inverseJoinColumns = {
    ...
    public void setAssociatedAirportHeliportItem(AirportHeliportPropertyType target) {
        setAssociatedAirportHeliport(XmlAdapterUtils.marshallJAXBElement(AirportHeliportPropertyType.class,
                ...
                NonMovementAreaTimeSliceType.class, target));
    }
    ...
    public void setExtentItem(AIXMElevatedSurfacePropertyType target) {
        setExtent(XmlAdapterUtils.marshallJAXBElement(AIXMElevatedSurfacePropertyType.class,
                new QName("http://www.aixm.aero/schema/5.2", "extent"), NonMovementAreaTimeSliceType.class, target));
    }
