...
@XmlType(name = "CurveType", propOrder = {"horizontalAccuracy", "annotation", "extension"})
public class CurveType extends com.aixm.delorean.core.org.gml.v_3_2.CurveType implements Serializable {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        }
        {
            ...
            List<CurveTypeExtension> lhsField;
            lhsField = (this.isSetExtension() ? this.getExtension() : null);
            List<CurveTypeExtension> rhsField;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        }
        {
            ...
            List<CurveTypeExtension> theField;
