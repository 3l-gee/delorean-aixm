...
/**
 * <p>
 * Java class for StandardLevelType complex type
 * </p>
 * .
 *
 * <p>
 ...
 *       <sequence>
 *         <element name="verticalDistance" type=
 ...
 *                 <choice>
 *                   <element ref=
"{http://www.aixm.aero/schema/5.2}AbstractStandardLevelExtension"/>
 *                 </choice>
 *                 <attGroup ref=
...
@XmlType(name = "StandardLevelType", propOrder = {"verticalDistance", "annotation", "extension"})
@Entity(name = "StandardLevelType")
@Table(name = "standardlevel_o", schema = "shared")
public class StandardLevelType extends AbstractAIXMObjectType implements Serializable {
    ...
    @JoinTable(name = "stndrdlvltp_annttn_link", schema = "shared", joinColumns = {
            @JoinColumn(name = "standardlevel_o_hjid", referencedColumnName = "hjid")}, inverseJoinColumns = {
    ...
    @Embedded
    @AttributeOverrides({
            @AttributeOverride(name = "value", column = @Column(name = "verticaldistance", columnDefinition = "VARCHAR", length = 256)),
            @AttributeOverride(name = "uom", column = @Column(name = "verticaldistanceuom")),
            @AttributeOverride(name = "accuracy", column = @Column(name = "verticaldistanceaccuracy")),
            @AttributeOverride(name = "nilReason", column = @Column(name = "verticaldistancenilreason"))})
    ...
    public void setVerticalDistanceItem(ValDistanceVerticalType target) {
        setVerticalDistance(XmlAdapterUtils.marshallJAXBElement(ValDistanceVerticalType.class,
                new QName("http://www.aixm.aero/schema/5.2", "verticalDistance"), StandardLevelType.class, target));
    }
