...
/**
 * <p>
 * Java class for AirportHeliportUsageType complex type
 * </p>
 * .
 *
 * <p>
 ...
 *   <complexContent>
 *     <extension base=
"{http://www.aixm.aero/schema/5.2}AbstractUsageConditionType">
 *       <sequence>
 *         <element name="type" type=
"{http://www.aixm.aero/schema/5.2}CodeUsageLimitationType" minOccurs="0"/>
 *         <element name="priorPermission" type=
...
"{http://www.aixm.aero/schema/5.2}ConditionCombinationPropertyType" minOccurs=
"0"/>
 *         <element name="annotation" type=
"{http://www.aixm.aero/schema/5.2}NotePropertyType" maxOccurs=
"unbounded" minOccurs="0"/>
 *         <element name="operation" type=
"{http://www.aixm.aero/schema/5.2}CodeOperationAirportHeliportType" minOccurs=
"0"/>
 ...
 *                 <choice>
 *                   <element ref=
"{http://www.aixm.aero/schema/5.2}AbstractUsageConditionExtension"/>
 *                   <element ref=
"{http://www.aixm.aero/schema/5.2}AbstractAirportHeliportUsageExtension"/>
 *                 </choice>
 *                 <attGroup ref=
...
@XmlType(name = "AirportHeliportUsageType", propOrder = {"type", "priorPermission", "contact", "selection",
        "annotation", "operation", "extension"})
@Entity(name = "AirportHeliportUsageType")
@Table(name = "airportheliportusage_o", schema = "airport_heliport")
public class AirportHeliportUsageType extends AbstractUsageConditionType implements Serializable {
     ...
     *         }{@code <}{@link CodeUsageLimitationType }{@code >}
     *
     */
    @Transient
    ...
    @JoinTable(name = "arprthlprtusgtp_cntct_link", schema = "airport_heliport", joinColumns = {
            @JoinColumn(name = "airportheliportusage_o_hjid", referencedColumnName = "hjid")}, inverseJoinColumns = {
     ...
     *
     * @return possible object is {@link JAXBElement
     *         }{@code <}{@link ConditionCombinationPropertyType }{@code >}
     *
     */
    @Transient
     ...
     *
     * @return possible object is {@link JAXBElement
     *         }{@code <}{@link CodeOperationAirportHeliportType }{@code >}
     *
     */
    @Transient
    ...
    public void setTypeItem(CodeUsageLimitationType target) {
        setType(XmlAdapterUtils.marshallJAXBElement(CodeUsageLimitationType.class,
                new QName("http://www.aixm.aero/schema/5.2", "type"), AirportHeliportUsageType.class, target));
    }

    @Embedded
    @AttributeOverrides({
            @AttributeOverride(name = "value", column = @Column(name = "priorpermission", columnDefinition = "NUMERIC")),
            @AttributeOverride(name = "uom", column = @Column(name = "priorpermissionuom")),
            @AttributeOverride(name = "nilReason", column = @Column(name = "priorpermissionnilreason"))})
    ...
    public void setPriorPermissionItem(ValDurationType target) {
        setPriorPermission(XmlAdapterUtils.marshallJAXBElement(ValDurationType.class,
                new QName("http://www.aixm.aero/schema/5.2", "priorPermission"), AirportHeliportUsageType.class,
                target));
    }
    ...
    public void setSelectionItem(ConditionCombinationPropertyType target) {
        setSelection(XmlAdapterUtils.marshallJAXBElement(ConditionCombinationPropertyType.class,
                new QName("http://www.aixm.aero/schema/5.2", "selection"), AirportHeliportUsageType.class, target));
    }

    @Embedded
    @AttributeOverrides({@AttributeOverride(name = "value", column = @Column(name = "operation")),
            @AttributeOverride(name = "nilReason", column = @Column(name = "operationnilreason"))})
    ...
    public void setOperationItem(CodeOperationAirportHeliportType target) {
        setOperation(XmlAdapterUtils.marshallJAXBElement(CodeOperationAirportHeliportType.class,
                new QName("http://www.aixm.aero/schema/5.2", "operation"), AirportHeliportUsageType.class, target));
    }
