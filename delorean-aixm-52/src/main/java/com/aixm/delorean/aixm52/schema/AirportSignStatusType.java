...
/**
 * <p>
 * Java class for AirportSignStatusType complex type
 * </p>
 * .
 *
 * <p>
 ...
 *
 * <pre>{@code
 * <complexType name="AirportSignStatusType">
 *   <complexContent>
 *     <extension base=
...
@XmlType(name = "AirportSignStatusType", propOrder = {"timeInterval", "annotation", "specialDateAuthority", "status",
        "extension"})
@Entity(name = "AirportSignStatusType")
@Table(name = "airportsignstatus_o", schema = "airport_heliport")
public class AirportSignStatusType extends AbstractPropertiesWithScheduleType implements Serializable {
    ...
    protected List<AirportSignStatusTypeExtensionType> extension;
    ...
    @JoinTable(name = "arprtsgnsttstp_tmintrvl_link", schema = "airport_heliport", joinColumns = {
            @JoinColumn(name = "airportsignstatus_o_hjid", referencedColumnName = "hjid")}, inverseJoinColumns = {
    ...
    @JoinTable(name = "arprtsgnsttstp_annttn_link", schema = "airport_heliport", joinColumns = {
            @JoinColumn(name = "airportsignstatus_o_hjid", referencedColumnName = "hjid")}, inverseJoinColumns = {
    ...
    @JoinTable(name = "arprtsgnsttstp_spcldtathrt_link", schema = "airport_heliport", joinColumns = {
            @JoinColumn(name = "airportsignstatus_o_hjid", referencedColumnName = "hjid")}, inverseJoinColumns = {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link AirportSignStatusTypeExtensionType }
     *
     *
     */
    @OneToMany(targetEntity = AirportSignStatusTypeExtensionType.class, cascade = {
            CascadeType.ALL}, fetch = FetchType.EAGER)
    @JoinColumn(name = "airportsignstatuse_hjid", referencedColumnName = "hjid")
    public List<AirportSignStatusTypeExtensionType> getExtension() {
        if (extension == null) {
     ...
     *
     */
    public void setExtension(List<AirportSignStatusTypeExtensionType> extension) {
    ...
    public void setStatusItem(CodeStatusOperationsType target) {
        setStatus(XmlAdapterUtils.marshallJAXBElement(CodeStatusOperationsType.class,
                new QName("http://www.aixm.aero/schema/5.2", "status"), AirportSignStatusType.class, target));
    }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final AirportSignStatusType that = ((AirportSignStatusType) object);
        {
        ...
        }
        {
            ...
            List<AirportSignStatusTypeExtensionType> lhsField;
            lhsField = (this.isSetExtension() ? this.getExtension() : null);
            List<AirportSignStatusTypeExtensionType> rhsField;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        }
        {
            ...
            List<AirportSignStatusTypeExtensionType> theField;
