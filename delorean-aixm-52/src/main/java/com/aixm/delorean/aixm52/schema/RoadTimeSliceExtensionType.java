...
@XmlType(name = "", propOrder = {"abstractRoadExtension"})
@Entity(name = "RoadTimeSliceExtensionType")
@Table(name = "road_te", schema = "airport_heliport")
public class RoadTimeSliceExtensionType implements Serializable, Equals, HashCode, ToString {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final RoadTimeSliceExtensionType that = ((RoadTimeSliceExtensionType) object);
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetAbstractRoadExtension();
            AbstractExtensionType theField;
            theField = this.getAbstractRoadExtension();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "abstractRoadExtension", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            AbstractExtensionType theField;
            theField = this.getAbstractRoadExtension();
            strategy.appendField(locator, this, "abstractRoadExtension", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetOwns();
            boolean theField;
