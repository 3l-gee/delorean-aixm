...
"{http://www.aixm.aero/schema/5.2}CodeLogicalOperatorType" minOccurs="0"/>
 *         <element name="weather" type=
"{http://www.aixm.aero/schema/5.2}MeteorologyPropertyType" maxOccurs=
"unbounded" minOccurs="0"/>
...
"{http://www.aixm.aero/schema/5.2}FlightCharacteristicPropertyType" maxOccurs=
"unbounded" minOccurs="0"/>
 *         <element name="subCondition" type=
"{http://www.aixm.aero/schema/5.2}ConditionCombinationPropertyType" maxOccurs=
"unbounded" minOccurs="0"/>
 ...
 *                   <element ref=
"{http://www.aixm.aero/schema/5.2}AbstractConditionCombinationExtension"/>
 *                 </choice>
 *                 <attGroup ref=
...
public class ConditionCombinationType extends AbstractPropertiesWithScheduleType implements Serializable {
    ...
    public void setLogicalOperatorItem(CodeLogicalOperatorType target) {
        setLogicalOperator(XmlAdapterUtils.marshallJAXBElement(CodeLogicalOperatorType.class,
                new QName("http://www.aixm.aero/schema/5.2", "logicalOperator"), ConditionCombinationType.class,
                target));
    }
