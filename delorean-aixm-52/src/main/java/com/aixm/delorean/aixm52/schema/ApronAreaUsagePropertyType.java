...
/**
 * <p>
 * Java class for ApronAreaUsagePropertyType complex type
 * </p>
 * .
 *
 * <p>
 ...
 *       <sequence>
 *         <element ref="{http://www.aixm.aero/schema/5.2}ApronAreaUsage"/>
 *       </sequence>
 *     </extension>
 *   </complexContent>
 * </complexType>
...
@XmlType(name = "ApronAreaUsagePropertyType", propOrder = {"apronAreaUsage"})
@Entity(name = "ApronAreaUsagePropertyType")
@Table(name = "apronareausagepropertytype", schema = "airport_heliport")
public class ApronAreaUsagePropertyType extends AbstractAIXMPropertyType implements Serializable {
     ...
     *
     * @return possible object is {@link ApronAreaUsageType }
     *
     */
    @OneToOne(targetEntity = ApronAreaUsageType.class, cascade = {CascadeType.ALL}, fetch = FetchType.EAGER)
     ...
     *
     * @param value
     *            allowed object is {@link ApronAreaUsageType }
     *
     */
