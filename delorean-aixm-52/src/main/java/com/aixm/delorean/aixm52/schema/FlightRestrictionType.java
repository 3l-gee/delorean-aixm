...
/**
 * <p>
 * Java class for FlightRestrictionType complex type
 * </p>
 * .
 *
 * <p>
...
"{http://www.aixm.aero/schema/5.2}FlightRestrictionTimeSlicePropertyType" maxOccurs
="unbounded"/>
 *       </sequence>
 *     </extension>
 *   </complexContent>
...
@XmlType(name = "FlightRestrictionType", propOrder = {"timeSlice"})
@Entity(name = "FlightRestrictionType")
@Table(name = "flightrestriction_f", schema = "route")
public class FlightRestrictionType extends AbstractAIXMFeatureType implements Serializable {
    ...
    @OneToMany(targetEntity = FlightRestrictionTimeSlicePropertyType.class, cascade = {
     ...
     *
     */
    public void setTimeSlice(List<FlightRestrictionTimeSlicePropertyType> timeSlice) {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final FlightRestrictionType that = ((FlightRestrictionType) object);
        {
            boolean lhsFieldIsSet = this.isSetTimeSlice();
            boolean rhsFieldIsSet = that.isSetTimeSlice();
            List<FlightRestrictionTimeSlicePropertyType> lhsField;
            lhsField = (this.isSetTimeSlice() ? this.getTimeSlice() : null);
            List<FlightRestrictionTimeSlicePropertyType> rhsField;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = super.hashCode(locator, strategy);
        {
            ...
            List<FlightRestrictionTimeSlicePropertyType> theField;
