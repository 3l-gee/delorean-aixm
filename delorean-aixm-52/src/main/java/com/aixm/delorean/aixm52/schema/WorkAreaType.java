...
/**
 * <p>
 * Java class for WorkAreaType complex type
 * </p>
 * .
 *
 * <p>
...
"{http://www.aixm.aero/schema/5.2}WorkAreaTimeSlicePropertyType" maxOccurs=
"unbounded"/>
 *       </sequence>
 *     </extension>
 *   </complexContent>
...
@XmlType(name = "WorkAreaType", propOrder = {"timeSlice"})
@Entity(name = "WorkAreaType")
@Table(name = "workarea_f", schema = "airport_heliport")
public class WorkAreaType extends AbstractAIXMFeatureType implements Serializable {
    ...
    @OneToMany(targetEntity = WorkAreaTimeSlicePropertyType.class, cascade = {CascadeType.ALL}, fetch = FetchType.EAGER)
