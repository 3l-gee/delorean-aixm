...
@Entity(name = "PointUsageExtensionType")
@Table(name = "pointusage_oe", schema = "navaids_point")
public class PointUsageExtensionType implements Serializable, Equals, HashCode, ToString {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final PointUsageExtensionType that = ((PointUsageExtensionType) object);
        {
