...
/**
 * <p>
 * Java class for InformationServiceTimeSliceType complex type
 * </p>
 * .
 *
 * <p>
...
"{http://www.aixm.aero/schema/5.2}CodeServiceInformationType" minOccurs="0"/>
 *         <element name="voice" type=
"{http://www.aixm.aero/schema/5.2}CodeYesNoType" minOccurs="0"/>
 *         <element name="dataLink" type=
"{http://www.aixm.aero/schema/5.2}CodeYesNoType" minOccurs="0"/>
 *         <element name="recorded" type=
"{http://www.aixm.aero/schema/5.2}CodeYesNoType" minOccurs="0"/>
 *         <element name="navaidBroadcast" type=
"{http://www.aixm.aero/schema/5.2}VORPropertyType" maxOccurs=
"unbounded" minOccurs="0"/>
...
"{http://www.aixm.aero/schema/5.2}WeatherSourcePropertyType" maxOccurs=
"unbounded" minOccurs="0"/>
 ...
 *                 <choice>
 *                   <element ref=
"{http://www.aixm.aero/schema/5.2}AbstractInformationServiceExtension"/>
 *                   <element ref=
...
@XmlType(name = "InformationServiceTimeSliceType", propOrder = {"flightOperations", "rank", "compliantICAO", "aixmName",
        "location", "serviceProvider", "callSign", "radioCommunication", "groundCommunication", "availability",
        "annotation", "type", "voice", "dataLink", "recorded", "navaidBroadcast", "clientAirspace", "clientAirport",
        "clientRoute", "clientProcedure", "clientHolding", "clientAerialRefuelling", "clientSegment", "aixmDataSource",
        "extension"})
@Entity(name = "InformationServiceTimeSliceType")
@Table(name = "informationservice_t", schema = "service")
public class InformationServiceTimeSliceType extends AbstractAIXMTimeSliceType implements Serializable {
    ...
    @JoinTable(name = "infrmtnsrvctmslctp_cll-sgn_link", schema = "service", joinColumns = {
            @JoinColumn(name = "informationservice_t_hjid", referencedColumnName = "hjid")}, inverseJoinColumns = {
     ...
     *
     * @return possible object is {@link JAXBElement
     *         }{@code <}{@link CodeServiceInformationType }{@code >}
     *
     */
    @Transient
     ...
     * Therefore any modification you make to the returned list will be present
     * inside the JAXB object. This is why there is not a <CODE>set</CODE> method
     * for the navaidBroadcast property.
     *
     * <p>
     * For example, to add a new item, do as follows:
     *
     ...
     *
     */
    @OneToMany(targetEntity = VORPropertyType.class, cascade = {CascadeType.ALL}, fetch = FetchType.EAGER)
     ...
     * Therefore any modification you make to the returned list will be present
     * inside the JAXB object. This is why there is not a <CODE>set</CODE> method
     * for the aixmDataSource property.
     *
     * <p>
     * For example, to add a new item, do as follows:
     *
     ...
     *
     */
    @OneToMany(targetEntity = WeatherSourcePropertyType.class, cascade = {CascadeType.ALL}, fetch = FetchType.EAGER)
    ...
    public void setFlightOperationsItem(CodeFlightDestinationType target) {
        setFlightOperations(XmlAdapterUtils.marshallJAXBElement(CodeFlightDestinationType.class,
                new QName("http://www.aixm.aero/schema/5.2", "flightOperations"), InformationServiceTimeSliceType.class,
                target));
    }
    ...
    public void setRankItem(CodeFacilityRankingType target) {
        setRank(XmlAdapterUtils.marshallJAXBElement(CodeFacilityRankingType.class,
                new QName("http://www.aixm.aero/schema/5.2", "rank"), InformationServiceTimeSliceType.class, target));
    }
    ...
    public void setCompliantICAOItem(CodeYesNoType target) {
        setCompliantICAO(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class,
                new QName("http://www.aixm.aero/schema/5.2", "compliantICAO"), InformationServiceTimeSliceType.class,
                target));
    }
    ...
    public void setAixmNameItem(TextNameType target) {
        setAixmName(XmlAdapterUtils.marshallJAXBElement(TextNameType.class,
                new QName("http://www.aixm.aero/schema/5.2", "name"), InformationServiceTimeSliceType.class, target));
    }
    ...
    public void setLocationItem(AIXMElevatedPointPropertyType target) {
        setLocation(XmlAdapterUtils.marshallJAXBElement(AIXMElevatedPointPropertyType.class,
                new QName("http://www.aixm.aero/schema/5.2", "location"), InformationServiceTimeSliceType.class,
                target));
    }
    ...
    public void setServiceProviderItem(UnitPropertyType target) {
        setServiceProvider(XmlAdapterUtils.marshallJAXBElement(UnitPropertyType.class,
                new QName("http://www.aixm.aero/schema/5.2", "serviceProvider"), InformationServiceTimeSliceType.class,
                target));
    }
    ...
    public void setTypeItem(CodeServiceInformationType target) {
        setType(XmlAdapterUtils.marshallJAXBElement(CodeServiceInformationType.class,
                new QName("http://www.aixm.aero/schema/5.2", "type"), InformationServiceTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({@AttributeOverride(name = "value", column = @Column(name = "voice")),
            @AttributeOverride(name = "nilReason", column = @Column(name = "voicenilreason"))})
    ...
    public void setVoiceItem(CodeYesNoType target) {
        setVoice(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class,
                new QName("http://www.aixm.aero/schema/5.2", "voice"), InformationServiceTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({@AttributeOverride(name = "value", column = @Column(name = "datalink")),
            @AttributeOverride(name = "nilReason", column = @Column(name = "datalinknilreason"))})
    ...
    public void setDataLinkItem(CodeYesNoType target) {
        setDataLink(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class,
                new QName("http://www.aixm.aero/schema/5.2", "dataLink"), InformationServiceTimeSliceType.class,
                target));
    }

    @Embedded
    @AttributeOverrides({@AttributeOverride(name = "value", column = @Column(name = "recorded")),
            @AttributeOverride(name = "nilReason", column = @Column(name = "recordednilreason"))})
    ...
    public void setRecordedItem(CodeYesNoType target) {
        setRecorded(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class,
                new QName("http://www.aixm.aero/schema/5.2", "recorded"), InformationServiceTimeSliceType.class,
                target));
    }
