...
"{http://www.aixm.aero/schema/5.2}ValSlopeType" minOccurs="0"/>
...
"{http://www.aixm.aero/schema/5.2}CodeRunwayMarkingType" minOccurs="0"/>
...
"{http://www.aixm.aero/schema/5.2}CodeLightingJARType" minOccurs="0"/>
 *         <element name="usedRunway" type=
"{http://www.aixm.aero/schema/5.2}RunwayPropertyType" minOccurs="0"/>
 *         <element name="startingElement" type=
"{http://www.aixm.aero/schema/5.2}RunwayElementPropertyType" minOccurs="0"/>
 *         <element name="annotation" type=
"{http://www.aixm.aero/schema/5.2}NotePropertyType" maxOccurs=
"unbounded" minOccurs="0"/>
 *         <element name="availability" type=
"{http://www.aixm.aero/schema/5.2}ManoeuvringAreaAvailabilityPropertyType" maxOccurs
="unbounded" minOccurs="0"/>
 *         <element name="slope" type=
"{http://www.aixm.aero/schema/5.2}ValSlopeType" minOccurs="0"/>
 *         <element name="approachGuidance" type=
"{http://www.aixm.aero/schema/5.2}CodeRunwayApproachGuidanceType" minOccurs=
"0"/>
 ...
 *                 <sequence>
 *                   <element ref=
"{http://www.aixm.aero/schema/5.2}AbstractRunwayDirectionExtension"/>
 *                 </sequence>
 *                 <attGroup ref=
...
@XmlType(name = "RunwayDirectionTimeSliceType", propOrder = {"designator", "trueBearing", "magneticBearing",
        "patternVFR", "slopeTDZ", "elevationTDZ", "approachMarkingType", "approachMarkingCondition", "classLightingJAR",
        "usedRunway", "startingElement", "annotation", "availability", "slope", "approachGuidance", "extension"})
...
public class RunwayDirectionTimeSliceType extends AbstractAIXMTimeSliceType implements Serializable {
     ...
     *
     * @return possible object is {@link JAXBElement
     *         }{@code <}{@link CodeRunwayApproachGuidanceType }{@code >}
     *
     */
    @Transient
    ...
    public void setDesignatorItem(TextDesignatorType target) {
        setDesignator(XmlAdapterUtils.marshallJAXBElement(TextDesignatorType.class,
                new QName("http://www.aixm.aero/schema/5.2", "designator"), RunwayDirectionTimeSliceType.class,
                target));
    }
    ...
    public void setTrueBearingItem(ValBearingType target) {
        setTrueBearing(XmlAdapterUtils.marshallJAXBElement(ValBearingType.class,
                new QName("http://www.aixm.aero/schema/5.2", "trueBearing"), RunwayDirectionTimeSliceType.class,
                target));
    }
    ...
    public void setMagneticBearingItem(ValBearingType target) {
        setMagneticBearing(XmlAdapterUtils.marshallJAXBElement(ValBearingType.class,
                new QName("http://www.aixm.aero/schema/5.2", "magneticBearing"), RunwayDirectionTimeSliceType.class,
                target));
    }
    ...
    public void setPatternVFRItem(CodeDirectionTurnType target) {
        setPatternVFR(XmlAdapterUtils.marshallJAXBElement(CodeDirectionTurnType.class,
                new QName("http://www.aixm.aero/schema/5.2", "patternVFR"), RunwayDirectionTimeSliceType.class,
                target));
    }
    ...
    @AttributeOverrides({
            ...
            @AttributeOverride(name = "accuracy", column = @Column(name = "slopetdzaccuracy"))})
    ...
    public void setSlopeTDZItem(ValSlopeType target) {
        setSlopeTDZ(XmlAdapterUtils.marshallJAXBElement(ValSlopeType.class,
                new QName("http://www.aixm.aero/schema/5.2", "slopeTDZ"), RunwayDirectionTimeSliceType.class, target));
    }
    ...
    @AttributeOverrides({
            ...
            @AttributeOverride(name = "accuracy", column = @Column(name = "elevationtdzaccuracy")),
    ...
    public void setElevationTDZItem(ValDistanceVerticalType target) {
        setElevationTDZ(XmlAdapterUtils.marshallJAXBElement(ValDistanceVerticalType.class,
                new QName("http://www.aixm.aero/schema/5.2", "elevationTDZ"), RunwayDirectionTimeSliceType.class,
                target));
    }
    ...
    public void setApproachMarkingTypeItem(CodeRunwayMarkingType target) {
        setApproachMarkingType(XmlAdapterUtils.marshallJAXBElement(CodeRunwayMarkingType.class,
                new QName("http://www.aixm.aero/schema/5.2", "approachMarkingType"), RunwayDirectionTimeSliceType.class,
                target));
    }
    ...
    public void setApproachMarkingConditionItem(CodeMarkingConditionType target) {
        setApproachMarkingCondition(XmlAdapterUtils.marshallJAXBElement(CodeMarkingConditionType.class,
                new QName("http://www.aixm.aero/schema/5.2", "approachMarkingCondition"),
    ...
    public void setClassLightingJARItem(CodeLightingJARType target) {
        setClassLightingJAR(XmlAdapterUtils.marshallJAXBElement(CodeLightingJARType.class,
                new QName("http://www.aixm.aero/schema/5.2", "classLightingJAR"), RunwayDirectionTimeSliceType.class,
                target));
    }
    ...
    public void setUsedRunwayItem(RunwayPropertyType target) {
        setUsedRunway(XmlAdapterUtils.marshallJAXBElement(RunwayPropertyType.class,
                new QName("http://www.aixm.aero/schema/5.2", "usedRunway"), RunwayDirectionTimeSliceType.class,
                target));
    }
    ...
    public void setStartingElementItem(RunwayElementPropertyType target) {
        setStartingElement(XmlAdapterUtils.marshallJAXBElement(RunwayElementPropertyType.class,
                new QName("http://www.aixm.aero/schema/5.2", "startingElement"), RunwayDirectionTimeSliceType.class,
                target));
    }
    ...
    @AttributeOverrides({
            ...
            @AttributeOverride(name = "accuracy", column = @Column(name = "slopeaccuracy"))})
    ...
    public void setSlopeItem(ValSlopeType target) {
        setSlope(XmlAdapterUtils.marshallJAXBElement(ValSlopeType.class,
                new QName("http://www.aixm.aero/schema/5.2", "slope"), RunwayDirectionTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({@AttributeOverride(name = "value", column = @Column(name = "approachguidance")),
            @AttributeOverride(name = "nilReason", column = @Column(name = "approachguidancenilreason"))})
    ...
    public void setApproachGuidanceItem(CodeRunwayApproachGuidanceType target) {
        setApproachGuidance(XmlAdapterUtils.marshallJAXBElement(CodeRunwayApproachGuidanceType.class,
                new QName("http://www.aixm.aero/schema/5.2", "approachGuidance"), RunwayDirectionTimeSliceType.class,
                target));
    }
