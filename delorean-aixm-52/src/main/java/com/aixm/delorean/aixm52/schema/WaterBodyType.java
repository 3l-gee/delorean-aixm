...
"{http://www.aixm.aero/schema/5.2}WaterBodyTimeSlicePropertyType" maxOccurs=
"unbounded"/>
 *       </sequence>
 *     </extension>
 *   </complexContent>
...
@XmlType(name = "WaterBodyType", propOrder = {"timeSlice"})
@Entity(name = "WaterBodyType")
@Table(name = "waterbody_f", schema = "airport_heliport")
public class WaterBodyType extends AbstractAIXMFeatureType implements Serializable {

    private static final long serialVersionUID = 20251104L;
    @XmlElement(required = true)
    protected List<WaterBodyTimeSlicePropertyType> timeSlice;
     ...
     * {@link WaterBodyTimeSlicePropertyType }
     *
     *
     */
    @Filter(name = "TPHjidFilter", condition = "hjid IN (:ids)")
    @OneToMany(targetEntity = WaterBodyTimeSlicePropertyType.class, cascade = {
            CascadeType.ALL}, fetch = FetchType.EAGER)
    @JoinColumn(name = "timeslice_hjid", referencedColumnName = "hjid")
    public List<WaterBodyTimeSlicePropertyType> getTimeSlice() {
        if (timeSlice == null) {
     ...
     *
     */
    public void setTimeSlice(List<WaterBodyTimeSlicePropertyType> timeSlice) {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final WaterBodyType that = ((WaterBodyType) object);
        {
            ...
            List<WaterBodyTimeSlicePropertyType> lhsField;
            lhsField = (this.isSetTimeSlice() ? this.getTimeSlice() : null);
            List<WaterBodyTimeSlicePropertyType> rhsField;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = super.hashCode(locator, strategy);
        {
            ...
            List<WaterBodyTimeSlicePropertyType> theField;
