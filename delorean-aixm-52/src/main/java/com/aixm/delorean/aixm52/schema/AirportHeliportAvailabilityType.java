...
"{http://www.aixm.aero/schema/5.2}CodeStatusAirportType" minOccurs="0"/>
 *         <element name="warning" type=
"{http://www.aixm.aero/schema/5.2}CodeAirportWarningType" minOccurs="0"/>
 *         <element name="usage" type=
"{http://www.aixm.aero/schema/5.2}AirportHeliportUsagePropertyType" maxOccurs=
"unbounded" minOccurs="0"/>
 ...
 *                   <element ref=
"{http://www.aixm.aero/schema/5.2}AbstractAirportHeliportAvailabilityExtension"/>
 *                 </choice>
 *                 <attGroup ref=
...
public class AirportHeliportAvailabilityType extends AbstractPropertiesWithScheduleType implements Serializable {
    ...
    @XmlElementRef(name = "warning", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    ...
    public void setOperationalStatusItem(CodeStatusAirportType target) {
        setOperationalStatus(XmlAdapterUtils.marshallJAXBElement(CodeStatusAirportType.class,
                new QName("http://www.aixm.aero/schema/5.2", "operationalStatus"),
    ...
    public void setWarningItem(CodeAirportWarningType target) {
        setWarning(XmlAdapterUtils.marshallJAXBElement(CodeAirportWarningType.class,
                new QName("http://www.aixm.aero/schema/5.2", "warning"), AirportHeliportAvailabilityType.class,
                target));
    }
