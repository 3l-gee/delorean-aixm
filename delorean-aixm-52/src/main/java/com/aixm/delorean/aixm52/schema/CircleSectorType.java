...
public class CircleSectorType extends AbstractAIXMObjectType implements Serializable {
    ...
    @XmlElementRef(name = "fromAngle", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<ValBearingType> fromAngle;
    @XmlElementRef(name = "toAngle", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "angleDirectionReference", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<CodeDirectionReferenceType> angleDirectionReference;
    @XmlElementRef(name = "innerDistance", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<ValDistanceType> innerDistance;
    @XmlElementRef(name = "outerDistance", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "zeroAxisRotation", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<ValBearingType> zeroAxisRotation;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetZeroAxisRotation();
            JAXBElement<ValBearingType> theField;
            theField = this.getZeroAxisRotation();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "zeroAxisRotation", theField);
            currentHashCode = strategy.hashCode(theFieldLocator, currentHashCode, theField, theFieldIsSet);
        }
        {
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        }
        {
            ...
            JAXBElement<ValBearingType> theField;
            theField = this.getZeroAxisRotation();
            strategy.appendField(locator, this, "zeroAxisRotation", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetExtension();
            List<CircleSectorTypeExtensionType> theField;
