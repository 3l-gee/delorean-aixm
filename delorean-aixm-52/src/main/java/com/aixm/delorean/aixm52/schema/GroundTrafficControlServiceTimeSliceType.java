...
/**
 * <p>
 * Java class for GroundTrafficControlServiceTimeSliceType complex type
 * </p>
 * .
 *
 * <p>
...
"{http://www.aixm.aero/schema/5.2}CodeServiceGroundControlType" minOccurs="0"/>
 ...
 *                 <choice>
 *                   <element ref=
"{http://www.aixm.aero/schema/5.2}AbstractGroundTrafficControlServiceExtension"/>
 *                   <element ref=
...
@XmlType(name = "GroundTrafficControlServiceTimeSliceType", propOrder = {"flightOperations", "rank", "compliantICAO",
        ...
        "clientAirport", "extension"})
@Entity(name = "GroundTrafficControlServiceTimeSliceType")
@Table(name = "groundtrafficcontrolservice_t", schema = "service")
public class GroundTrafficControlServiceTimeSliceType extends AbstractAIXMTimeSliceType implements Serializable {
    ...
    @JoinTable(name = "grndtrffccntrlsrvctmslctp_cll-sgn_link", schema = "service", joinColumns = {
            @JoinColumn(name = "groundtrafficcontrolservice_t_hjid", referencedColumnName = "hjid")}, inverseJoinColumns = {
     ...
     *
     * @return possible object is {@link JAXBElement
     *         }{@code <}{@link CodeServiceGroundControlType }{@code >}
     *
     */
    @Transient
    ...
    public void setFlightOperationsItem(CodeFlightDestinationType target) {
        setFlightOperations(XmlAdapterUtils.marshallJAXBElement(CodeFlightDestinationType.class,
                ...
                GroundTrafficControlServiceTimeSliceType.class, target));
    }
    ...
    public void setRankItem(CodeFacilityRankingType target) {
        setRank(XmlAdapterUtils.marshallJAXBElement(CodeFacilityRankingType.class,
                new QName("http://www.aixm.aero/schema/5.2", "rank"), GroundTrafficControlServiceTimeSliceType.class,
                target));
    }
    ...
    public void setAixmNameItem(TextNameType target) {
        setAixmName(XmlAdapterUtils.marshallJAXBElement(TextNameType.class,
                new QName("http://www.aixm.aero/schema/5.2", "name"), GroundTrafficControlServiceTimeSliceType.class,
                target));
    }
    ...
    public void setLocationItem(AIXMElevatedPointPropertyType target) {
        setLocation(XmlAdapterUtils.marshallJAXBElement(AIXMElevatedPointPropertyType.class,
                new QName("http://www.aixm.aero/schema/5.2", "location"),
                GroundTrafficControlServiceTimeSliceType.class, target));
    }
    ...
    public void setTypeItem(CodeServiceGroundControlType target) {
        setType(XmlAdapterUtils.marshallJAXBElement(CodeServiceGroundControlType.class,
                new QName("http://www.aixm.aero/schema/5.2", "type"), GroundTrafficControlServiceTimeSliceType.class,
                target));
    }
    ...
    public void setClientAirportItem(AirportHeliportPropertyType target) {
        setClientAirport(XmlAdapterUtils.marshallJAXBElement(AirportHeliportPropertyType.class,
                new QName("http://www.aixm.aero/schema/5.2", "clientAirport"),
                GroundTrafficControlServiceTimeSliceType.class, target));
    }
