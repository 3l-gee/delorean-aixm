...
/**
 * <p>
 * Java class for StandardLevelColumnType complex type
 * </p>
 * .
 *
 * <p>
 ...
 *
 * <pre>{@code
 * <complexType name="StandardLevelColumnType">
 *   <complexContent>
 *     <extension base=
"{http://www.aixm.aero/schema/5.2}AbstractAIXMFeatureType">
 *       <sequence>
 *         <element name="timeSlice" type=
"{http://www.aixm.aero/schema/5.2}StandardLevelColumnTimeSlicePropertyType" maxOccurs
="unbounded"/>
 *       </sequence>
 *     </extension>
 *   </complexContent>
...
@XmlType(name = "StandardLevelColumnType", propOrder = {"timeSlice"})
@Entity(name = "StandardLevelColumnType")
@Table(name = "standardlevelcolumn_f", schema = "shared")
public class StandardLevelColumnType extends AbstractAIXMFeatureType implements Serializable {
     ...
     * {@link StandardLevelColumnTimeSlicePropertyType }
     *
     *
     */
     ...
     *
     */
    public void setTimeSlice(List<StandardLevelColumnTimeSlicePropertyType> timeSlice) {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final StandardLevelColumnType that = ((StandardLevelColumnType) object);
        {
            boolean lhsFieldIsSet = this.isSetTimeSlice();
            boolean rhsFieldIsSet = that.isSetTimeSlice();
            List<StandardLevelColumnTimeSlicePropertyType> lhsField;
            lhsField = (this.isSetTimeSlice() ? this.getTimeSlice() : null);
            List<StandardLevelColumnTimeSlicePropertyType> rhsField;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = super.hashCode(locator, strategy);
        {
            ...
            List<StandardLevelColumnTimeSlicePropertyType> theField;
