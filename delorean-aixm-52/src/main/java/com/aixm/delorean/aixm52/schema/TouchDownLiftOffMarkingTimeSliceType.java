...
/**
 * <p>
 * Java class for TouchDownLiftOffMarkingTimeSliceType complex type
 * </p>
 * .
 *
 * <p>
 ...
 *         <element name="markedTouchDownLiftOff" type=
 ...
 *                 <choice>
 *                   <element ref=
"{http://www.aixm.aero/schema/5.2}AbstractTouchDownLiftOffMarkingExtension"/>
 *                   <element ref=
...
@XmlType(name = "TouchDownLiftOffMarkingTimeSliceType", propOrder = {"markingICAOStandard", "condition", "element",
        "annotation", "markingLocation", "markedTouchDownLiftOff", "extension"})
@Entity(name = "TouchDownLiftOffMarkingTimeSliceType")
@Table(name = "touchdownliftoffmarking_t", schema = "airport_heliport")
public class TouchDownLiftOffMarkingTimeSliceType extends AbstractAIXMTimeSliceType implements Serializable {
    ...
    @JoinTable(name = "tchdwnlftoffmrkngtmslctp_elmnt_link", schema = "airport_heliport", joinColumns = {
            @JoinColumn(name = "touchdownliftoffmarking_t_hjid", referencedColumnName = "hjid")}, inverseJoinColumns = {
    ...
    public void setMarkingICAOStandardItem(CodeYesNoType target) {
        setMarkingICAOStandard(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class,
                ...
                TouchDownLiftOffMarkingTimeSliceType.class, target));
    }
    ...
    public void setConditionItem(CodeMarkingConditionType target) {
        setCondition(XmlAdapterUtils.marshallJAXBElement(CodeMarkingConditionType.class,
                new QName("http://www.aixm.aero/schema/5.2", "condition"), TouchDownLiftOffMarkingTimeSliceType.class,
                target));
    }
    ...
    public void setMarkingLocationItem(CodeTLOFSectionType target) {
        setMarkingLocation(XmlAdapterUtils.marshallJAXBElement(CodeTLOFSectionType.class,
    ...
    public void setMarkedTouchDownLiftOffItem(TouchDownLiftOffPropertyType target) {
        setMarkedTouchDownLiftOff(XmlAdapterUtils.marshallJAXBElement(TouchDownLiftOffPropertyType.class,
                new QName("http://www.aixm.aero/schema/5.2", "markedTouchDownLiftOff"),
                TouchDownLiftOffMarkingTimeSliceType.class, target));
    }
