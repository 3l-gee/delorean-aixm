 ...
 *                 <choice>
 *                   <element ref=
"{http://www.aixm.aero/schema/5.2}AbstractNavaidEquipmentDistanceExtension"/>
 *                 </choice>
 *                 <attGroup ref=
...
@XmlType(name = "NavaidEquipmentDistanceType", propOrder = {"distance", "annotation", "theNavaidEquipment",
        "extension"})
...
public class NavaidEquipmentDistanceType extends AbstractAIXMObjectType implements Serializable {
    ...
    public void setDistanceItem(ValDistanceType target) {
        setDistance(XmlAdapterUtils.marshallJAXBElement(ValDistanceType.class,
                new QName("http://www.aixm.aero/schema/5.2", "distance"), NavaidEquipmentDistanceType.class, target));
    }
