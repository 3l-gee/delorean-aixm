...
/**
 * <p>
 * Java class for ValDistanceSignedType complex type
 * </p>
 * .
 *
 * <p>
 ...
 *
 * <pre>{@code
 * <complexType name="ValDistanceSignedType">
 *   <simpleContent>
 *     <extension base=
"<http://www.aixm.aero/schema/5.2>ValDistanceSignedBaseType">
 *       <attribute name="uom" type=
"{http://www.aixm.aero/schema/5.2}UomDistanceType" />
...
@XmlType(name = "ValDistanceSignedType", propOrder = {"value"})
@Embeddable
public class ValDistanceSignedType implements Serializable, Equals, HashCode, ToString {
