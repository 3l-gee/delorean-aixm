...
"{http://www.aixm.aero/schema/5.2}CodeAirspaceActivityType" minOccurs="0"/>
 *         <element name="status" type=
"{http://www.aixm.aero/schema/5.2}CodeStatusAirspaceType" minOccurs="0"/>
 ...
 *                   <element ref=
"{http://www.aixm.aero/schema/5.2}AbstractAirspaceActivationExtension"/>
 *                 </choice>
 *                 <attGroup ref=
...
public class AirspaceActivationType extends AbstractPropertiesWithScheduleType implements Serializable {
    ...
    @XmlElementRef(name = "activity", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    ...
    public void setActivityItem(CodeAirspaceActivityType target) {
        setActivity(XmlAdapterUtils.marshallJAXBElement(CodeAirspaceActivityType.class,
                new QName("http://www.aixm.aero/schema/5.2", "activity"), AirspaceActivationType.class, target));
    }
    ...
    public void setStatusItem(CodeStatusAirspaceType target) {
        setStatus(XmlAdapterUtils.marshallJAXBElement(CodeStatusAirspaceType.class,
                new QName("http://www.aixm.aero/schema/5.2", "status"), AirspaceActivationType.class, target));
    }
