...
@Entity(name = "ObstaclePlacementTypeExtensionType")
@Table(name = "obstacleplacemente", schema = "shared")
public class ObstaclePlacementTypeExtensionType implements Serializable, Equals, HashCode, ToString {
