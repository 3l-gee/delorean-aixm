...
public class AirportHeliportTimeSliceType extends AbstractAIXMTimeSliceType implements Serializable {
    ...
    @XmlElementRef(name = "locationIndicatorICAO", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<CodeICAOType> locationIndicatorICAO;
    @XmlElementRef(name = "designatorIATA", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "certifiedICAO", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<CodeYesNoType> certifiedICAO;
    @XmlElementRef(name = "privateUse", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<CodeYesNoType> privateUse;
    @XmlElementRef(name = "controlType", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<CodeMilitaryOperationsType> controlType;
    @XmlElementRef(name = "fieldElevation", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "magneticVariationChange", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<ValMagneticVariationChangeType> magneticVariationChange;
    @XmlElementRef(name = "referenceTemperature", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<ValTemperatureType> referenceTemperature;
    @XmlElementRef(name = "altimeterCheckLocation", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<CodeYesNoType> altimeterCheckLocation;
    @XmlElementRef(name = "secondaryPowerSupply", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<CodeYesNoType> secondaryPowerSupply;
    @XmlElementRef(name = "windDirectionIndicator", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<CodeYesNoType> windDirectionIndicator;
    @XmlElementRef(name = "landingDirectionIndicator", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<CodeYesNoType> landingDirectionIndicator;
    @XmlElementRef(name = "transitionAltitude", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<ValDistanceVerticalType> transitionAltitude;
    @XmlElementRef(name = "transitionLevel", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "certificationDate", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<DateType> certificationDate;
    @XmlElementRef(name = "certificationExpirationDate", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    ...
    @XmlElement(nillable = true)
    protected List<AirportHeliportResponsibilityOrganisationPropertyType> responsibleOrganisation;
    @XmlElementRef(name = "ARP", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<AIXMElevatedPointPropertyType> arp;
    @XmlElementRef(name = "aviationBoundary", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "timeZone", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<CodeTimeReferenceType> timeZone;
    @XmlElementRef(name = "segmentedCircleMarker", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<CodeSegmentedCircleType> segmentedCircleMarker;
    ...
    public List<AirportHeliportResponsibilityOrganisationPropertyType> getResponsibleOrganisation() {
        ...
        return this.responsibleOrganisation;
    }
    ...
    public void unsetResponsibleOrganisation() {
        this.responsibleOrganisation = null;
    }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetTimeZone();
            JAXBElement<CodeTimeReferenceType> theField;
            theField = this.getTimeZone();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "timeZone", theField);
            currentHashCode = strategy.hashCode(theFieldLocator, currentHashCode, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetSegmentedCircleMarker();
            JAXBElement<CodeSegmentedCircleType> theField;
            theField = this.getSegmentedCircleMarker();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "segmentedCircleMarker", theField);
            currentHashCode = strategy.hashCode(theFieldLocator, currentHashCode, theField, theFieldIsSet);
        }
        {
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        }
        {
            ...
            JAXBElement<CodeTimeReferenceType> theField;
            theField = this.getTimeZone();
            strategy.appendField(locator, this, "timeZone", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetSegmentedCircleMarker();
            JAXBElement<CodeSegmentedCircleType> theField;
            theField = this.getSegmentedCircleMarker();
            strategy.appendField(locator, this, "segmentedCircleMarker", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetExtension();
            List<AirportHeliportExtensionType> theField;
