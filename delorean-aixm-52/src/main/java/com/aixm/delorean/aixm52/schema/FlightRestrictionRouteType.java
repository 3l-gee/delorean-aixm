...
/**
 * <p>
 * Java class for FlightRestrictionRouteType complex type
 * </p>
 * .
 *
 * <p>
 ...
 *         <element name="routeElement" type=
"{http://www.aixm.aero/schema/5.2}FlightRoutingElementPropertyType" maxOccurs=
 ...
 *                 <choice>
 *                   <element ref=
"{http://www.aixm.aero/schema/5.2}AbstractFlightRestrictionRouteExtension"/>
 *                 </choice>
 *                 <attGroup ref=
...
@XmlType(name = "FlightRestrictionRouteType", propOrder = {"priorPermission", "routeElement", "contact", "annotation",
        "extension"})
@Entity(name = "FlightRestrictionRouteType")
@Table(name = "flightrestrictionroute_o", schema = "route")
public class FlightRestrictionRouteType extends AbstractAIXMObjectType implements Serializable {
    ...
    protected List<FlightRestrictionRouteExtensionType> extension;
    ...
    @JoinTable(name = "flghtrstrctnrttp_rtelmnt_link", schema = "route", joinColumns = {
            @JoinColumn(name = "flightrestrictionroute_o_hjid", referencedColumnName = "hjid")}, inverseJoinColumns = {
                    @JoinColumn(name = "routeelement_hjid", referencedColumnName = "hjid")})
    ...
    @OneToMany(targetEntity = ContactInformationPropertyType.class, cascade = {
            CascadeType.ALL}, fetch = FetchType.EAGER)
    @JoinTable(name = "flghtrstrctnrttp_cntct_link", schema = "route", joinColumns = {
            @JoinColumn(name = "flightrestrictionroute_o_hjid", referencedColumnName = "hjid")}, inverseJoinColumns = {
    ...
    @JoinTable(name = "flghtrstrctnrttp_annttn_link", schema = "route", joinColumns = {
            @JoinColumn(name = "flightrestrictionroute_o_hjid", referencedColumnName = "hjid")}, inverseJoinColumns = {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link FlightRestrictionRouteExtensionType }
     *
     *
     */
    @OneToMany(targetEntity = FlightRestrictionRouteExtensionType.class, cascade = {
            CascadeType.ALL}, fetch = FetchType.EAGER)
    @JoinColumn(name = "flightrestrictionroute_oe_hjid", referencedColumnName = "hjid")
    public List<FlightRestrictionRouteExtensionType> getExtension() {
        if (extension == null) {
     ...
     *
     */
    public void setExtension(List<FlightRestrictionRouteExtensionType> extension) {
    ...
    @Embedded
    @AttributeOverrides({@AttributeOverride(name = "value", column = @Column(name = "priorpermission")),
    ...
    public void setPriorPermissionItem(CodeYesNoType target) {
        setPriorPermission(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class,
                new QName("http://www.aixm.aero/schema/5.2", "priorPermission"), FlightRestrictionRouteType.class,
                target));
    }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final FlightRestrictionRouteType that = ((FlightRestrictionRouteType) object);
        {
            ...
            List<FlightRestrictionRouteExtensionType> lhsField;
            lhsField = (this.isSetExtension() ? this.getExtension() : null);
            List<FlightRestrictionRouteExtensionType> rhsField;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        }
        {
            ...
            List<FlightRestrictionRouteExtensionType> theField;
