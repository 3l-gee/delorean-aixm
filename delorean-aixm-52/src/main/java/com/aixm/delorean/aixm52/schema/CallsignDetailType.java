...
"{http://www.aixm.aero/schema/5.2}CodeLanguageType" minOccurs="0"/>
 ...
 *                 <choice>
 *                   <element ref=
"{http://www.aixm.aero/schema/5.2}AbstractCallsignDetailExtension"/>
 *                 </choice>
 *                 <attGroup ref=
...
public class CallsignDetailType extends AbstractAIXMObjectType implements Serializable {
    ...
    @XmlElementRef(name = "callSign", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<TextNameType> callSign;
    @XmlElementRef(name = "language", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    ...
    public void setCallSignItem(TextNameType target) {
        setCallSign(XmlAdapterUtils.marshallJAXBElement(TextNameType.class,
                new QName("http://www.aixm.aero/schema/5.2", "callSign"), CallsignDetailType.class, target));
    }
    ...
    public void setLanguageItem(CodeLanguageType target) {
        setLanguage(XmlAdapterUtils.marshallJAXBElement(CodeLanguageType.class,
                new QName("http://www.aixm.aero/schema/5.2", "language"), CallsignDetailType.class, target));
    }
