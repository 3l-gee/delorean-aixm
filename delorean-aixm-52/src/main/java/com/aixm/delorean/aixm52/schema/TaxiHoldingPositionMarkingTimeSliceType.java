...
"{http://www.aixm.aero/schema/5.2}TaxiHoldingPositionPropertyType" minOccurs=
"0"/>
 ...
 *                 <choice>
 *                   <element ref=
"{http://www.aixm.aero/schema/5.2}AbstractTaxiHoldingPositionMarkingExtension"/>
 *                   <element ref=
...
public class TaxiHoldingPositionMarkingTimeSliceType extends AbstractAIXMTimeSliceType implements Serializable {
    ...
    @XmlElementRef(name = "condition", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<CodeMarkingConditionType> condition;
    @XmlElement(nillable = true)
    protected List<MarkingElementPropertyType> element;
    @XmlElement(nillable = true)
    protected List<NotePropertyType> annotation;
    @XmlElementRef(name = "markedTaxiHold", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    ...
    public void setConditionItem(CodeMarkingConditionType target) {
        setCondition(XmlAdapterUtils.marshallJAXBElement(CodeMarkingConditionType.class,
                new QName("http://www.aixm.aero/schema/5.2", "condition"),
                TaxiHoldingPositionMarkingTimeSliceType.class, target));
    }
    ...
    public void setMarkedTaxiHoldItem(TaxiHoldingPositionPropertyType target) {
        setMarkedTaxiHold(XmlAdapterUtils.marshallJAXBElement(TaxiHoldingPositionPropertyType.class,
                new QName("http://www.aixm.aero/schema/5.2", "markedTaxiHold"),
                TaxiHoldingPositionMarkingTimeSliceType.class, target));
    }
