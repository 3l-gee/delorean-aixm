 ...
 *       <sequence>
 *         <element name="altitudeAdjustmentType" type=
"{http://www.aixm.aero/schema/5.2}CodeAltitudeAdjustmentType" minOccurs="0"/>
 *         <element name="primaryAlternateMinimum" type=
"{http://www.aixm.aero/schema/5.2}CodeYesNoType" minOccurs="0"/>
 *         <element name="altitudeAdjustment" type=
"{http://www.aixm.aero/schema/5.2}ValDistanceVerticalType" minOccurs="0"/>
 *         <element name="localRemoteCode" type=
"{http://www.aixm.aero/schema/5.2}CodeYesNoType" minOccurs="0"/>
 ...
 *                 <choice>
 *                   <element ref=
"{http://www.aixm.aero/schema/5.2}AbstractAltitudeAdjustmentExtension"/>
 *                 </choice>
 *                 <attGroup ref=
...
public class AltitudeAdjustmentType extends AbstractAIXMObjectType implements Serializable {
    ...
    @JoinTable(name = "alttdadjstmnttp_annttn_link", schema = "shared", joinColumns = {
            @JoinColumn(name = "altitudeadjustment_o_hjid", referencedColumnName = "hjid")}, inverseJoinColumns = {
    ...
    @AttributeOverrides({@AttributeOverride(name = "value", column = @Column(name = "altitudeadjustmenttype")),
            @AttributeOverride(name = "nilReason", column = @Column(name = "altitudeadjustmenttypenilreason"))})
    ...
    public void setAltitudeAdjustmentTypeItem(CodeAltitudeAdjustmentType target) {
        setAltitudeAdjustmentType(XmlAdapterUtils.marshallJAXBElement(CodeAltitudeAdjustmentType.class,
                new QName("http://www.aixm.aero/schema/5.2", "altitudeAdjustmentType"), AltitudeAdjustmentType.class,
                target));
    }

    @Embedded
    @AttributeOverrides({@AttributeOverride(name = "value", column = @Column(name = "primaryalternateminimum")),
            @AttributeOverride(name = "nilReason", column = @Column(name = "primaryalternateminimumnilreason"))})
    ...
    public void setPrimaryAlternateMinimumItem(CodeYesNoType target) {
        setPrimaryAlternateMinimum(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class,
                new QName("http://www.aixm.aero/schema/5.2", "primaryAlternateMinimum"), AltitudeAdjustmentType.class,
                target));
    }
    ...
    @AttributeOverrides({
            ...
            @AttributeOverride(name = "uom", column = @Column(name = "altitudeadjustmentuom")),
            @AttributeOverride(name = "accuracy", column = @Column(name = "altitudeadjustmentaccuracy")),
            @AttributeOverride(name = "nilReason", column = @Column(name = "altitudeadjustmentnilreason"))})
    ...
    public void setAltitudeAdjustmentItem(ValDistanceVerticalType target) {
        setAltitudeAdjustment(XmlAdapterUtils.marshallJAXBElement(ValDistanceVerticalType.class,
                new QName("http://www.aixm.aero/schema/5.2", "altitudeAdjustment"), AltitudeAdjustmentType.class,
                target));
    }

    @Embedded
    @AttributeOverrides({@AttributeOverride(name = "value", column = @Column(name = "localremotecode")),
            @AttributeOverride(name = "nilReason", column = @Column(name = "localremotecodenilreason"))})
    ...
    public void setLocalRemoteCodeItem(CodeYesNoType target) {
        setLocalRemoteCode(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class,
                new QName("http://www.aixm.aero/schema/5.2", "localRemoteCode"), AltitudeAdjustmentType.class, target));
    }
