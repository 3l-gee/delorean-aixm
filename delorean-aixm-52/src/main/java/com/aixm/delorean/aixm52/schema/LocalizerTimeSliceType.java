...
/**
 * <p>
 * Java class for LocalizerTimeSliceType complex type
 * </p>
 * .
 *
 * <p>
...
"{http://www.aixm.aero/schema/5.2}CodeNavaidDesignatorType" minOccurs="0"/>
 *         <element name="name" type=
"{http://www.aixm.aero/schema/5.2}TextNameType" minOccurs="0"/>
 *         <element name="emissionClass" type=
"{http://www.aixm.aero/schema/5.2}CodeRadioEmissionType" minOccurs="0"/>
...
"{http://www.aixm.aero/schema/5.2}AuthorityForNavaidEquipmentPropertyType" maxOccurs
="unbounded" minOccurs="0"/>
 *         <element name="monitoring" type=
"{http://www.aixm.aero/schema/5.2}NavaidEquipmentMonitoringPropertyType" maxOccurs
="unbounded" minOccurs="0"/>
...
"{http://www.aixm.aero/schema/5.2}ValMagneticVariationType" minOccurs="0"/>
 *         <element name="widthCourse" type=
"{http://www.aixm.aero/schema/5.2}ValAngleType" minOccurs="0"/>
 *         <element name="backCourseUsable" type=
"{http://www.aixm.aero/schema/5.2}CodeILSBackCourseType" minOccurs="0"/>
 *         <element name="signalPerformance" type=
"{http://www.aixm.aero/schema/5.2}CodeSignalPerformanceILSType" minOccurs="0"/>
 *         <element name="courseQuality" type=
"{http://www.aixm.aero/schema/5.2}CodeCourseQualityILSType" minOccurs="0"/>
 *         <element name="integrityLevel" type=
"{http://www.aixm.aero/schema/5.2}CodeIntegrityLevelILSType" minOccurs="0"/>
 ...
 *                 <choice>
 *                   <element ref=
"{http://www.aixm.aero/schema/5.2}AbstractLocalizerExtension"/>
 *                   <element ref=
"{http://www.aixm.aero/schema/5.2}AbstractNavaidEquipmentExtension"/>
 *                 </choice>
 *                 <attGroup ref=
...
@XmlType(name = "LocalizerTimeSliceType", propOrder = {"designator", "aixmName", "emissionClass", "mobile",
        "magneticVariation", "dateMagneticVariation", "flightChecked", "location", "authority", "monitoring",
        "availability", "annotation", "frequency", "magneticBearing", "trueBearing", "declination", "widthCourse",
        "backCourseUsable", "signalPerformance", "courseQuality", "integrityLevel", "extension"})
@Entity(name = "LocalizerTimeSliceType")
@Table(name = "localizer_t", schema = "navaids_point")
public class LocalizerTimeSliceType extends AbstractAIXMTimeSliceType implements Serializable {
    ...
    @JoinTable(name = "lclzrtmslctp_athrt_link", schema = "navaids_point", joinColumns = {
            @JoinColumn(name = "localizer_t_hjid", referencedColumnName = "hjid")}, inverseJoinColumns = {
     ...
     *
     * @return possible object is {@link JAXBElement
     *         }{@code <}{@link CodeILSBackCourseType }{@code >}
     *
     */
    @Transient
     ...
     *
     * @return possible object is {@link JAXBElement
     *         }{@code <}{@link CodeSignalPerformanceILSType }{@code >}
     *
     */
    @Transient
     ...
     *
     * @return possible object is {@link JAXBElement
     *         }{@code <}{@link CodeCourseQualityILSType }{@code >}
     *
     */
    @Transient
     ...
     *
     * @return possible object is {@link JAXBElement
     *         }{@code <}{@link CodeIntegrityLevelILSType }{@code >}
     *
     */
    @Transient
    ...
    public void setDesignatorItem(CodeNavaidDesignatorType target) {
        setDesignator(XmlAdapterUtils.marshallJAXBElement(CodeNavaidDesignatorType.class,
                new QName("http://www.aixm.aero/schema/5.2", "designator"), LocalizerTimeSliceType.class, target));
    }
    ...
    public void setAixmNameItem(TextNameType target) {
        setAixmName(XmlAdapterUtils.marshallJAXBElement(TextNameType.class,
                new QName("http://www.aixm.aero/schema/5.2", "name"), LocalizerTimeSliceType.class, target));
    }
    ...
    public void setEmissionClassItem(CodeRadioEmissionType target) {
        setEmissionClass(XmlAdapterUtils.marshallJAXBElement(CodeRadioEmissionType.class,
                new QName("http://www.aixm.aero/schema/5.2", "emissionClass"), LocalizerTimeSliceType.class, target));
    }
    ...
    public void setMobileItem(CodeYesNoType target) {
        setMobile(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class,
                new QName("http://www.aixm.aero/schema/5.2", "mobile"), LocalizerTimeSliceType.class, target));
    }
    ...
    public void setMagneticVariationItem(ValMagneticVariationType target) {
        setMagneticVariation(XmlAdapterUtils.marshallJAXBElement(ValMagneticVariationType.class,
                new QName("http://www.aixm.aero/schema/5.2", "magneticVariation"), LocalizerTimeSliceType.class,
                target));
    }
    ...
    public void setDateMagneticVariationItem(DateYearType target) {
        setDateMagneticVariation(XmlAdapterUtils.marshallJAXBElement(DateYearType.class,
                new QName("http://www.aixm.aero/schema/5.2", "dateMagneticVariation"), LocalizerTimeSliceType.class,
                target));
    }
    ...
    public void setFlightCheckedItem(CodeYesNoType target) {
        setFlightChecked(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class,
                new QName("http://www.aixm.aero/schema/5.2", "flightChecked"), LocalizerTimeSliceType.class, target));
    }
    ...
    public void setLocationItem(AIXMElevatedPointPropertyType target) {
        setLocation(XmlAdapterUtils.marshallJAXBElement(AIXMElevatedPointPropertyType.class,
                new QName("http://www.aixm.aero/schema/5.2", "location"), LocalizerTimeSliceType.class, target));
    }
    ...
    public void setFrequencyItem(ValFrequencyType target) {
        setFrequency(XmlAdapterUtils.marshallJAXBElement(ValFrequencyType.class,
                new QName("http://www.aixm.aero/schema/5.2", "frequency"), LocalizerTimeSliceType.class, target));
    }
    ...
    @AttributeOverrides({
            ...
            @AttributeOverride(name = "accuracy", column = @Column(name = "magneticbearingaccuracy"))})
    ...
    public void setMagneticBearingItem(ValBearingType target) {
        setMagneticBearing(XmlAdapterUtils.marshallJAXBElement(ValBearingType.class,
                new QName("http://www.aixm.aero/schema/5.2", "magneticBearing"), LocalizerTimeSliceType.class, target));
    }
    ...
    @AttributeOverrides({
            ...
            @AttributeOverride(name = "accuracy", column = @Column(name = "truebearingaccuracy"))})
    ...
    public void setTrueBearingItem(ValBearingType target) {
        setTrueBearing(XmlAdapterUtils.marshallJAXBElement(ValBearingType.class,
                new QName("http://www.aixm.aero/schema/5.2", "trueBearing"), LocalizerTimeSliceType.class, target));
    }
    ...
    @AttributeOverrides({
            ...
            @AttributeOverride(name = "accuracy", column = @Column(name = "declinationaccuracy"))})
    ...
    public void setDeclinationItem(ValMagneticVariationType target) {
        setDeclination(XmlAdapterUtils.marshallJAXBElement(ValMagneticVariationType.class,
                new QName("http://www.aixm.aero/schema/5.2", "declination"), LocalizerTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
            @AttributeOverride(name = "value", column = @Column(name = "widthcourse", columnDefinition = "NUMERIC")),
            @AttributeOverride(name = "nilReason", column = @Column(name = "widthcoursenilreason")),
            @AttributeOverride(name = "accuracy", column = @Column(name = "widthcourseaccuracy"))})
    ...
    public void setWidthCourseItem(ValAngleType target) {
        setWidthCourse(XmlAdapterUtils.marshallJAXBElement(ValAngleType.class,
                new QName("http://www.aixm.aero/schema/5.2", "widthCourse"), LocalizerTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({@AttributeOverride(name = "value", column = @Column(name = "backcourseusable")),
            @AttributeOverride(name = "nilReason", column = @Column(name = "backcourseusablenilreason"))})
    ...
    public void setBackCourseUsableItem(CodeILSBackCourseType target) {
        setBackCourseUsable(XmlAdapterUtils.marshallJAXBElement(CodeILSBackCourseType.class,
                new QName("http://www.aixm.aero/schema/5.2", "backCourseUsable"), LocalizerTimeSliceType.class,
                target));
    }

    @Embedded
    @AttributeOverrides({@AttributeOverride(name = "value", column = @Column(name = "signalperformance")),
            @AttributeOverride(name = "nilReason", column = @Column(name = "signalperformancenilreason"))})
    ...
    public void setSignalPerformanceItem(CodeSignalPerformanceILSType target) {
        setSignalPerformance(XmlAdapterUtils.marshallJAXBElement(CodeSignalPerformanceILSType.class,
                new QName("http://www.aixm.aero/schema/5.2", "signalPerformance"), LocalizerTimeSliceType.class,
                target));
    }

    @Embedded
    @AttributeOverrides({@AttributeOverride(name = "value", column = @Column(name = "coursequality")),
            @AttributeOverride(name = "nilReason", column = @Column(name = "coursequalitynilreason"))})
    ...
    public void setCourseQualityItem(CodeCourseQualityILSType target) {
        setCourseQuality(XmlAdapterUtils.marshallJAXBElement(CodeCourseQualityILSType.class,
                new QName("http://www.aixm.aero/schema/5.2", "courseQuality"), LocalizerTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({@AttributeOverride(name = "value", column = @Column(name = "integritylevel")),
            @AttributeOverride(name = "nilReason", column = @Column(name = "integritylevelnilreason"))})
    ...
    public void setIntegrityLevelItem(CodeIntegrityLevelILSType target) {
        setIntegrityLevel(XmlAdapterUtils.marshallJAXBElement(CodeIntegrityLevelILSType.class,
                new QName("http://www.aixm.aero/schema/5.2", "integrityLevel"), LocalizerTimeSliceType.class, target));
    }
