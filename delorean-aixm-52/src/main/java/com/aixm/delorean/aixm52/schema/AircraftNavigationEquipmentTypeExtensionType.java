...
@Entity(name = "AircraftNavigationEquipmentTypeExtensionType")
@Table(name = "aircraftnavigationequipmente", schema = "shared")
public class AircraftNavigationEquipmentTypeExtensionType implements Serializable, Equals, HashCode, ToString {

    private static final long serialVersionUID = 20251104L;
    @XmlElement(name = "AbstractAircraftNavigationEquipmentExtension")
    protected AbstractExtensionType abstractAircraftNavigationEquipmentExtension;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final AircraftNavigationEquipmentTypeExtensionType that = ((AircraftNavigationEquipmentTypeExtensionType) object);
        {
