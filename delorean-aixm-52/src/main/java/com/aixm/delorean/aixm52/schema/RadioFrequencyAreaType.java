...
"{http://www.aixm.aero/schema/5.2}RadioFrequencyAreaTimeSlicePropertyType" maxOccurs
="unbounded"/>
 *       </sequence>
 *     </extension>
 *   </complexContent>
...
@Table(name = "radiofrequencyarea_f", schema = "shared")
public class RadioFrequencyAreaType extends AbstractAIXMFeatureType implements Serializable {
    ...
    @OneToMany(targetEntity = RadioFrequencyAreaTimeSlicePropertyType.class, cascade = {
