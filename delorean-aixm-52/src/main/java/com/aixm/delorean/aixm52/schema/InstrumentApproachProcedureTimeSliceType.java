...
public class InstrumentApproachProcedureTimeSliceType extends AbstractAIXMTimeSliceType implements Serializable {
    ...
    @XmlElementRef(name = "approachPrefix", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<CodeApproachPrefixType> approachPrefix;
    @XmlElementRef(name = "approachType", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<CodeApproachType> approachType;
    @XmlElementRef(name = "multipleIdentification", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<CodeUpperAlphanumericType> multipleIdentification;
    @XmlElementRef(name = "copterTrack", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<ValBearingType> copterTrack;
    @XmlElementRef(name = "courseReversalInstruction", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<TextInstructionType> courseReversalInstruction;
    @XmlElementRef(name = "channelGNSS", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<ValChannelNumberType> channelGNSS;
    @XmlElementRef(name = "landing", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "circlingOnly", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<CodeYesNoType> circlingOnly;
    @XmlElementRef(name = "closeParallelApproach", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<CodeYesNoType> closeParallelApproach;
    @XmlElement(nillable = true)
    protected List<FinalApproachProfilePropertyType> descentProfile;
    @XmlElement(nillable = true)
    protected List<FinalApproachControlAltitudePropertyType> controlAltitude;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        }
        {
            ...
            JAXBElement<CodeUpperAlphanumericType> lhsField;
            lhsField = this.getMultipleIdentification();
            JAXBElement<CodeUpperAlphanumericType> rhsField;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        }
        {
            ...
            JAXBElement<CodeUpperAlphanumericType> theField;
        ...
        {
            boolean theFieldIsSet = this.isSetCirclingOnly();
            JAXBElement<CodeYesNoType> theField;
            theField = this.getCirclingOnly();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "circlingOnly", theField);
            currentHashCode = strategy.hashCode(theFieldLocator, currentHashCode, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetCloseParallelApproach();
            JAXBElement<CodeYesNoType> theField;
            theField = this.getCloseParallelApproach();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "closeParallelApproach", theField);
            currentHashCode = strategy.hashCode(theFieldLocator, currentHashCode, theField, theFieldIsSet);
        }
        {
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        }
        {
            ...
            JAXBElement<CodeYesNoType> theField;
            theField = this.getCirclingOnly();
            strategy.appendField(locator, this, "circlingOnly", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetCloseParallelApproach();
            JAXBElement<CodeYesNoType> theField;
            theField = this.getCloseParallelApproach();
            strategy.appendField(locator, this, "closeParallelApproach", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetDescentProfile();
            List<FinalApproachProfilePropertyType> theField;
