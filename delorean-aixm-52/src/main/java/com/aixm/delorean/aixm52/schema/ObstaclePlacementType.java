 ...
 *                 <choice>
 *                   <element ref=
"{http://www.aixm.aero/schema/5.2}AbstractObstaclePlacementExtension"/>
 *                 </choice>
 *                 <attGroup ref=
...
public class ObstaclePlacementType extends AbstractAIXMObjectType implements Serializable {
    ...
    @AttributeOverrides({
            ...
            @AttributeOverride(name = "accuracy", column = @Column(name = "obstaclebearingaccuracy"))})
    ...
    public void setObstacleBearingItem(ValBearingType target) {
        setObstacleBearing(XmlAdapterUtils.marshallJAXBElement(ValBearingType.class,
                new QName("http://www.aixm.aero/schema/5.2", "obstacleBearing"), ObstaclePlacementType.class, target));
    }
    ...
    @AttributeOverrides({
            ...
            @AttributeOverride(name = "accuracy", column = @Column(name = "obstacledistanceaccuracy")),
    ...
    public void setObstacleDistanceItem(ValDistanceType target) {
        setObstacleDistance(XmlAdapterUtils.marshallJAXBElement(ValDistanceType.class,
                new QName("http://www.aixm.aero/schema/5.2", "obstacleDistance"), ObstaclePlacementType.class, target));
    }
    ...
    public void setPointTypeItem(TextNameType target) {
        setPointType(XmlAdapterUtils.marshallJAXBElement(TextNameType.class,
                new QName("http://www.aixm.aero/schema/5.2", "pointType"), ObstaclePlacementType.class, target));
    }
    ...
    public void setObstaclePlacementItem(CodeSideType target) {
        setObstaclePlacement(XmlAdapterUtils.marshallJAXBElement(CodeSideType.class,
                new QName("http://www.aixm.aero/schema/5.2", "obstaclePlacement"), ObstaclePlacementType.class,
                target));
    }
