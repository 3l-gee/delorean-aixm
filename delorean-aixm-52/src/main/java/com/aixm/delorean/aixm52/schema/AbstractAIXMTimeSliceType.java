...
import com.aixm.delorean.aixm52.time.adapter.TimePrimitivePropertyTypeAdapter;
 ...
 *   <complexContent>
 *     <extension base=
"{http://www.aixm.aero/schema/5.2}AbstractAIXMTimeSliceBaseType">
 *       <sequence>
 *         <element ref="{http://www.aixm.aero/schema/5.2}interpretation"/>
 *         <element ref=
"{http://www.aixm.aero/schema/5.2}sequenceNumber" minOccurs="0"/>
 *         <element ref=
"{http://www.aixm.aero/schema/5.2}correctionNumber" minOccurs="0"/>
 *         <element name="timeSliceMetadata" type=
"{http://www.aixm.aero/schema/5.2}FeatureTimeSliceMetadataPropertyType" minOccurs
="0"/>
...
@XmlSeeAlso({AerialRefuellingTimeSliceType.class, AirportHeliportTimeSliceType.class,
        ...
        NonMovementAreaTimeSliceType.class, SurveyControlPointTimeSliceType.class, WaterBodyTimeSliceType.class,
        WeatherSourceTimeSliceType.class, WorkAreaTimeSliceType.class, AircraftStandTimeSliceType.class,
        ApronTimeSliceType.class, ApronElementTimeSliceType.class, DeicingAreaTimeSliceType.class,
        PassengerLoadingBridgeTimeSliceType.class, RoadTimeSliceType.class, TouchDownLiftOffTimeSliceType.class,
        TouchDownLiftOffSafeAreaTimeSliceType.class, ApproachLightingSystemTimeSliceType.class,
        ApronLightSystemTimeSliceType.class, GuidanceLineLightSystemTimeSliceType.class,
        RunwayDirectionLightSystemTimeSliceType.class, RunwayProtectAreaLightSystemTimeSliceType.class,
        TaxiHoldingPositionLightSystemTimeSliceType.class, TaxiwayLightSystemTimeSliceType.class,
        TouchDownLiftOffLightSystemTimeSliceType.class, AirportProtectionAreaMarkingTimeSliceType.class,
        ApronMarkingTimeSliceType.class, DeicingAreaMarkingTimeSliceType.class, GuidanceLineMarkingTimeSliceType.class,
        RunwayMarkingTimeSliceType.class, StandMarkingTimeSliceType.class,
        TaxiHoldingPositionMarkingTimeSliceType.class, TaxiwayMarkingTimeSliceType.class,
        TouchDownLiftOffMarkingTimeSliceType.class, AirportSignTimeSliceType.class, ArrestingGearTimeSliceType.class,
        ...
        RunwayVisualRangeEquipmentTimeSliceType.class, VisualGlideSlopeIndicatorTimeSliceType.class,
        FloatingDockSiteTimeSliceType.class, GangwayTimeSliceType.class, MarkingBuoyTimeSliceType.class,
        SeaplaneLandingAreaTimeSliceType.class, SeaplaneRampSiteTimeSliceType.class, GuidanceLineTimeSliceType.class,
        TaxiHoldingPositionTimeSliceType.class, TaxiwayTimeSliceType.class, TaxiwayElementTimeSliceType.class,
        AirspaceTimeSliceType.class, AuthorityForAirspaceTimeSliceType.class, GeoBorderTimeSliceType.class,
        HoldingPatternTimeSliceType.class, UnplannedHoldingTimeSliceType.class, AltimeterCheckpointTimeSliceType.class,
        AzimuthTimeSliceType.class, CheckpointINSTimeSliceType.class, CheckpointVORTimeSliceType.class,
        DirectionFinderTimeSliceType.class, DMETimeSliceType.class, ElevationTimeSliceType.class,
        GlidepathTimeSliceType.class, LocalizerTimeSliceType.class, MarkerBeaconTimeSliceType.class,
        NavaidTimeSliceType.class, NDBTimeSliceType.class, SDFTimeSliceType.class,
        SpecialNavigationStationTimeSliceType.class, SpecialNavigationSystemTimeSliceType.class,
        TACANTimeSliceType.class, VORTimeSliceType.class, DesignatedPointTimeSliceType.class,
        SignificantPointInAirspaceTimeSliceType.class, GBASTimeSliceType.class, GBASServiceTimeSliceType.class,
        SatelliteServiceTimeSliceType.class, SatelliteSystemTimeSliceType.class,
        AeronauticalGroundLightTimeSliceType.class, ObstacleAreaTimeSliceType.class,
        VerticalStructureTimeSliceType.class, OrganisationAuthorityTimeSliceType.class, UnitTimeSliceType.class,
        InstrumentApproachProcedureTimeSliceType.class, TerminalArrivalAreaTimeSliceType.class,
        ...
        MinimumAltitudeAreaTimeSliceType.class, ArrivalFeederLegTimeSliceType.class, ArrivalLegTimeSliceType.class,
        ...
        RouteSegmentTimeSliceType.class, FlightRestrictionTimeSliceType.class, RulesProceduresTimeSliceType.class,
        ...
        AirTrafficFlowManagementServiceTimeSliceType.class, FireFightingServiceTimeSliceType.class,
