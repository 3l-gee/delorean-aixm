...
@XmlType(name = "", propOrder = {"abstractPropertiesWithScheduleExtension", "abstractPointUsageExtension"})
@Entity(name = "PointUsageTypeExtensionType")
@Table(name = "pointusagee", schema = "navaids_point")
public class PointUsageTypeExtensionType implements Serializable, Equals, HashCode, ToString {

    private static final long serialVersionUID = 20251104L;
    @XmlElement(name = "AbstractPropertiesWithScheduleExtension")
    protected AbstractExtensionType abstractPropertiesWithScheduleExtension;
    @XmlElement(name = "AbstractPointUsageExtension")
    protected AbstractExtensionType abstractPointUsageExtension;
    ...
    /**
     * Gets the value of the abstractPointUsageExtension property.
     *
     * @return possible object is {@link AbstractExtensionType }
     *
     */
    @OneToOne(targetEntity = AbstractExtensionType.class, cascade = {CascadeType.ALL}, fetch = FetchType.EAGER)
    @JoinColumn(name = "abstractpointusageextension_hjid", referencedColumnName = "hjid")
    public AbstractExtensionType getAbstractPointUsageExtension() {
        return abstractPointUsageExtension;
    }

    /**
     * Sets the value of the abstractPointUsageExtension property.
     *
     * @param value
     *            allowed object is {@link AbstractExtensionType }
     *
     */
    public void setAbstractPointUsageExtension(AbstractExtensionType value) {
        this.abstractPointUsageExtension = value;
    }

    @Transient
    public boolean isSetAbstractPointUsageExtension() {
        return (this.abstractPointUsageExtension != null);
    }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final PointUsageTypeExtensionType that = ((PointUsageTypeExtensionType) object);
        {
        ...
        {
            boolean lhsFieldIsSet = this.isSetAbstractPointUsageExtension();
            boolean rhsFieldIsSet = that.isSetAbstractPointUsageExtension();
            AbstractExtensionType lhsField;
            lhsField = this.getAbstractPointUsageExtension();
            AbstractExtensionType rhsField;
            rhsField = that.getAbstractPointUsageExtension();
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "abstractPointUsageExtension", lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "abstractPointUsageExtension", rhsField);
            if (!strategy.equals(lhsFieldLocator, rhsFieldLocator, lhsField, rhsField, lhsFieldIsSet, rhsFieldIsSet)) {
                return false;
            }
        }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetAbstractPointUsageExtension();
            AbstractExtensionType theField;
            theField = this.getAbstractPointUsageExtension();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "abstractPointUsageExtension", theField);
            currentHashCode = strategy.hashCode(theFieldLocator, currentHashCode, theField, theFieldIsSet);
        }
        {
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        }
        {
            ...
            AbstractExtensionType theField;
            theField = this.getAbstractPointUsageExtension();
            strategy.appendField(locator, this, "abstractPointUsageExtension", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetOwns();
            boolean theField;
