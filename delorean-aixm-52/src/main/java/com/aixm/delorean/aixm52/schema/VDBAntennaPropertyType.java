...
/**
 * <p>
 * Java class for VDBAntennaPropertyType complex type
 * </p>
 * .
 *
 * <p>
...
@XmlType(name = "VDBAntennaPropertyType", propOrder = {"vdbAntenna"})
@Entity(name = "VDBAntennaPropertyType")
@Table(name = "vdbantennapropertytype", schema = "navaids_point")
public class VDBAntennaPropertyType extends AbstractAIXMPropertyType implements Serializable {
     ...
     *
     * @return possible object is {@link VDBAntennaType }
     *
     */
    @OneToOne(targetEntity = VDBAntennaType.class, cascade = {CascadeType.ALL}, fetch = FetchType.EAGER)
     ...
     *
     * @param value
     *            allowed object is {@link VDBAntennaType }
     *
     */
