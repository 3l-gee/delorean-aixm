...
/**
 * <p>
 * Java class for SatelliteApproachOperationType complex type
 * </p>
 * .
 *
 * <p>
 ...
 *         <element name="theAirportHeliport" type=
 ...
 *                   <element ref=
"{http://www.aixm.aero/schema/5.2}AbstractSatelliteApproachOperationExtension"/>
 *                 </choice>
 *                 <attGroup ref=
...
@XmlType(name = "SatelliteApproachOperationType", propOrder = {"timeInterval", "annotation", "specialDateAuthority",
        "satelliteApproachType", "operationalStatus", "theAirportHeliport", "extension"})
@Entity(name = "SatelliteApproachOperationType")
@Table(name = "satelliteapproachoperation_o", schema = "navaids_point")
public class SatelliteApproachOperationType extends AbstractPropertiesWithScheduleType implements Serializable {
    ...
    @JoinTable(name = "stlltapprchoprtntp_tmintrvl_link", schema = "navaids_point", joinColumns = {
            @JoinColumn(name = "satelliteapproachoperation_o_hjid", referencedColumnName = "hjid")}, inverseJoinColumns = {
    ...
    public void setSatelliteApproachTypeItem(CodeSatelliteApproachType target) {
        setSatelliteApproachType(XmlAdapterUtils.marshallJAXBElement(CodeSatelliteApproachType.class,
                new QName("http://www.aixm.aero/schema/5.2", "satelliteApproachType"),
                SatelliteApproachOperationType.class, target));
    }
    ...
    public void setOperationalStatusItem(CodeStatusNavaidType target) {
        setOperationalStatus(XmlAdapterUtils.marshallJAXBElement(CodeStatusNavaidType.class,
                new QName("http://www.aixm.aero/schema/5.2", "operationalStatus"), SatelliteApproachOperationType.class,
                target));
    }
    ...
    public void setTheAirportHeliportItem(AirportHeliportPropertyType target) {
        setTheAirportHeliport(XmlAdapterUtils.marshallJAXBElement(AirportHeliportPropertyType.class,
                new QName("http://www.aixm.aero/schema/5.2", "theAirportHeliport"),
                SatelliteApproachOperationType.class, target));
    }
