...
/**
 * <p>
 * Java class for MarkingBuoyTimeSliceType complex type
 * </p>
 * .
 *
 * <p>
...
"{http://www.aixm.aero/schema/5.2}CodeBuoyDesignatorType" minOccurs="0"/>
 *         <element name="type" type=
"{http://www.aixm.aero/schema/5.2}CodeBuoyType" minOccurs="0"/>
 *         <element name="colour" type=
"{http://www.aixm.aero/schema/5.2}CodeColourType" minOccurs="0"/>
 *         <element name="theSeaplaneLandingArea" type=
"{http://www.aixm.aero/schema/5.2}SeaplaneLandingAreaPropertyType" minOccurs=
"0"/>
 ...
 *                 <sequence>
 *                   <element ref=
"{http://www.aixm.aero/schema/5.2}AbstractMarkingBuoyExtension"/>
 *                 </sequence>
 *                 <attGroup ref=
...
@XmlType(name = "MarkingBuoyTimeSliceType", propOrder = {"designator", "type", "colour", "theSeaplaneLandingArea",
        "location", "annotation", "extension"})
@Entity(name = "MarkingBuoyTimeSliceType")
@Table(name = "markingbuoy_t", schema = "airport_heliport")
public class MarkingBuoyTimeSliceType extends AbstractAIXMTimeSliceType implements Serializable {
    ...
    @XmlElementRef(name = "theSeaplaneLandingArea", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
     ...
     *         }{@code <}{@link CodeBuoyDesignatorType }{@code >}
     *
     */
    @Transient
     ...
     *
     * @return possible object is {@link JAXBElement }{@code <}{@link CodeBuoyType
     *         }{@code >}
     *
     */
    @Transient
     ...
     *
     * @param value
     *            allowed object is {@link JAXBElement }{@code <}{@link CodeBuoyType
     *            }{@code >}
     *
     */
     ...
     *
     * @return possible object is {@link JAXBElement
     *         }{@code <}{@link SeaplaneLandingAreaPropertyType }{@code >}
     *
     */
    @Transient
    ...
    @JoinTable(name = "mrkngbtmslctp_annttn_link", schema = "airport_heliport", joinColumns = {
            @JoinColumn(name = "markingbuoy_t_hjid", referencedColumnName = "hjid")}, inverseJoinColumns = {
    ...
    @Embedded
    @AttributeOverrides({
            @AttributeOverride(name = "value", column = @Column(name = "designator", columnDefinition = "VARCHAR", length = 256)),
    ...
    public void setDesignatorItem(CodeBuoyDesignatorType target) {
        setDesignator(XmlAdapterUtils.marshallJAXBElement(CodeBuoyDesignatorType.class,
                new QName("http://www.aixm.aero/schema/5.2", "designator"), MarkingBuoyTimeSliceType.class, target));
    }
    ...
    public void setTypeItem(CodeBuoyType target) {
        setType(XmlAdapterUtils.marshallJAXBElement(CodeBuoyType.class,
                new QName("http://www.aixm.aero/schema/5.2", "type"), MarkingBuoyTimeSliceType.class, target));
    }
    ...
    public void setColourItem(CodeColourType target) {
        setColour(XmlAdapterUtils.marshallJAXBElement(CodeColourType.class,
                new QName("http://www.aixm.aero/schema/5.2", "colour"), MarkingBuoyTimeSliceType.class, target));
    }
    ...
    public SeaplaneLandingAreaPropertyType getTheSeaplaneLandingAreaItem() {
        return XmlAdapterUtils.unmarshallSource(SeaplaneLandingAreaPropertyType.class,
                this.getTheSeaplaneLandingArea());
    }

    public void setTheSeaplaneLandingAreaItem(SeaplaneLandingAreaPropertyType target) {
        setTheSeaplaneLandingArea(XmlAdapterUtils.marshallJAXBElement(SeaplaneLandingAreaPropertyType.class,
                new QName("http://www.aixm.aero/schema/5.2", "theSeaplaneLandingArea"), MarkingBuoyTimeSliceType.class,
                target));
    }
    ...
    public void setLocationItem(AIXMElevatedPointPropertyType target) {
        setLocation(XmlAdapterUtils.marshallJAXBElement(AIXMElevatedPointPropertyType.class,
                new QName("http://www.aixm.aero/schema/5.2", "location"), MarkingBuoyTimeSliceType.class, target));
    }
