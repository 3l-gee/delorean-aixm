...
"{http://www.aixm.aero/schema/5.2}SurveyControlPointTimeSlicePropertyType" maxOccurs
="unbounded"/>
 *       </sequence>
 *     </extension>
 *   </complexContent>
...
@Table(name = "surveycontrolpoint_f", schema = "airport_heliport")
public class SurveyControlPointType extends AbstractAIXMFeatureType implements Serializable {
    ...
    @OneToMany(targetEntity = SurveyControlPointTimeSlicePropertyType.class, cascade = {
