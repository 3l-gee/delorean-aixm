...
import com.aixm.delorean.aixm52.filter.Aixm52FilterConfig;
...
public class Aixm52Engine extends com.aixm.delorean.core.engine.AbstractEngine<AIXMBasicMessageType, BasicMessageMemberAIXMPropertyType, AbstractAIXMFeatureType, AbstractAIXMTimeSliceType, AbstractAIXMObjectType, Aixm52FilterConfig> {
    ...
    public AIXMBasicMessageType filter(AIXMBasicMessageType message, AbstractFilterConfig filterExpression) {
        ...
        members.removeIf(member -> {
            ...
            // 2 TimeSlice Check
            List<AbstractAIXMTimeSliceType> timeSlices = Aixm52TimeSliceEngine.invokeTimeSlice(feature);
    ...
    private <FTYPE extends AbstractAIXMFeatureType> FTYPE integrateAixmFeature(Class<FTYPE> featureType, AbstractAIXMFeatureType currentFeature, AbstractAIXMFeatureType newPartialFeature) {
        ...
        for (AbstractAIXMTimeSliceType newTimeSlice: listNewPartialTimeSlice) {
            ...
            Aixm52TimeSliceEngine.injectTimeSlice((AbstractAIXMFeatureType) outputFeature, newCompletedTimeSlice);
        }
    ...
    public <FTYPE extends AbstractAIXMFeatureType> FTYPE diffAixmFeature(Class<FTYPE> featureType, AbstractAIXMFeatureType feature) {
        ...
        List<AbstractAIXMTimeSliceType> listFullTimeSlice = Aixm52TimeSliceEngine.invokeTimeSlice(feature);
        ...
        for (int i = 1; i < listFullTimeSlice.size(); i++) {
            ...
            Aixm52TimeSliceEngine.injectTimeSlice((AbstractAIXMFeatureType) diffFeature, diffTimeSlice);
        }
