...
public class AltimeterCheckpointTimeSliceType extends AbstractAIXMTimeSliceType implements Serializable {
    ...
    protected List<AltimeterCheckpointExtensionType> extension;
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link AltimeterCheckpointExtensionType }
     *
     *
     */
    @OneToMany(targetEntity = AltimeterCheckpointExtensionType.class, cascade = {
            CascadeType.ALL}, fetch = FetchType.EAGER)
    @JoinColumn(name = "altimetercheckpointe_hjid", referencedColumnName = "hjid")
    public List<AltimeterCheckpointExtensionType> getExtension() {
        if (extension == null) {
     ...
     *
     */
    public void setExtension(List<AltimeterCheckpointExtensionType> extension) {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        }
        {
            ...
            List<AltimeterCheckpointExtensionType> lhsField;
            lhsField = (this.isSetExtension() ? this.getExtension() : null);
            List<AltimeterCheckpointExtensionType> rhsField;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        }
        {
            ...
            List<AltimeterCheckpointExtensionType> theField;
