...
"{http://www.aixm.aero/schema/5.2}RoadTimeSlicePropertyType" maxOccurs=
"unbounded"/>
 *       </sequence>
 *     </extension>
 *   </complexContent>
...
@Table(name = "road_f", schema = "airport_heliport")
public class RoadType extends AbstractAIXMFeatureType implements Serializable {
    ...
    @OneToMany(targetEntity = RoadTimeSlicePropertyType.class, cascade = {CascadeType.ALL}, fetch = FetchType.EAGER)
