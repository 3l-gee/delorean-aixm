...
"{http://www.aixm.aero/schema/5.2}CodeNavigationAreaRestrictionType" minOccurs=
"0"/>
 *         <element name="procedure" type=
...
public class NavigationAreaRestrictionTimeSliceType extends AbstractAIXMTimeSliceType implements Serializable {
    ...
    @JoinTable(name = "nvgtnarrstrctntmslctp_prcdr_link", schema = "procedure", joinColumns = {
            @JoinColumn(name = "navigationarearestriction_t_hjid", referencedColumnName = "hjid")}, inverseJoinColumns = {
    ...
    public void setTypeItem(CodeNavigationAreaRestrictionType target) {
        setType(XmlAdapterUtils.marshallJAXBElement(CodeNavigationAreaRestrictionType.class,
                new QName("http://www.aixm.aero/schema/5.2", "type"), NavigationAreaRestrictionTimeSliceType.class,
                target));
    }
    ...
    public void setDesignSurfaceItem(ObstacleAssessmentSurfacePropertyType target) {
        setDesignSurface(XmlAdapterUtils.marshallJAXBElement(ObstacleAssessmentSurfacePropertyType.class,
                new QName("http://www.aixm.aero/schema/5.2", "designSurface"),
    ...
    public void setSectorDefinitionItem(CircleSectorPropertyType target) {
        setSectorDefinition(XmlAdapterUtils.marshallJAXBElement(CircleSectorPropertyType.class,
                new QName("http://www.aixm.aero/schema/5.2", "sectorDefinition"),
                NavigationAreaRestrictionTimeSliceType.class, target));
    }
