...
@Entity(name = "AirTrafficFlowManagementServiceExtensionType")
@Table(name = "airtrafficflowmanagementservicee", schema = "service")
public class AirTrafficFlowManagementServiceExtensionType implements Serializable, Equals, HashCode, ToString {

    private static final long serialVersionUID = 20251104L;
    @XmlElement(name = "AbstractAirTrafficFlowManagementServiceExtension")
    protected AbstractExtensionType abstractAirTrafficFlowManagementServiceExtension;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final AirTrafficFlowManagementServiceExtensionType that = ((AirTrafficFlowManagementServiceExtensionType) object);
        {
        ...
        {
            boolean lhsFieldIsSet = this.isSetAbstractAirTrafficFlowManagementServiceExtension();
            boolean rhsFieldIsSet = that.isSetAbstractAirTrafficFlowManagementServiceExtension();
            AbstractExtensionType lhsField;
