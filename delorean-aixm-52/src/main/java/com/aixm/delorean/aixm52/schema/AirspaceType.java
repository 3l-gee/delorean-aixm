...
"{http://www.aixm.aero/schema/5.2}AirspaceTimeSlicePropertyType" maxOccurs=
"unbounded"/>
 *       </sequence>
 *     </extension>
 *   </complexContent>
...
@Table(name = "airspace_f", schema = "airspace")
public class AirspaceType extends AbstractAIXMFeatureType implements Serializable {
    ...
    @OneToMany(targetEntity = AirspaceTimeSlicePropertyType.class, cascade = {CascadeType.ALL}, fetch = FetchType.EAGER)
