...
/**
 * <p>
 * Java class for TouchDownLiftOffType complex type
 * </p>
 * .
 *
 * <p>
...
"{http://www.aixm.aero/schema/5.2}TouchDownLiftOffTimeSlicePropertyType" maxOccurs
="unbounded"/>
 *       </sequence>
 *     </extension>
 *   </complexContent>
...
@XmlType(name = "TouchDownLiftOffType", propOrder = {"timeSlice"})
@Entity(name = "TouchDownLiftOffType")
@Table(name = "touchdownliftoff_f", schema = "airport_heliport")
public class TouchDownLiftOffType extends AbstractAIXMFeatureType implements Serializable {
     ...
     * {@link TouchDownLiftOffTimeSlicePropertyType }
     *
     *
     */
    @Filter(name = "TPHjidFilter", condition = "hjid IN (:ids)")
    @OneToMany(targetEntity = TouchDownLiftOffTimeSlicePropertyType.class, cascade = {
            CascadeType.ALL}, fetch = FetchType.EAGER)
    @JoinColumn(name = "timeslice_hjid", referencedColumnName = "hjid")
    public List<TouchDownLiftOffTimeSlicePropertyType> getTimeSlice() {
        if (timeSlice == null) {
     ...
     *
     */
    public void setTimeSlice(List<TouchDownLiftOffTimeSlicePropertyType> timeSlice) {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final TouchDownLiftOffType that = ((TouchDownLiftOffType) object);
        {
            boolean lhsFieldIsSet = this.isSetTimeSlice();
            boolean rhsFieldIsSet = that.isSetTimeSlice();
            List<TouchDownLiftOffTimeSlicePropertyType> lhsField;
            lhsField = (this.isSetTimeSlice() ? this.getTimeSlice() : null);
            List<TouchDownLiftOffTimeSlicePropertyType> rhsField;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = super.hashCode(locator, strategy);
        {
            ...
            List<TouchDownLiftOffTimeSlicePropertyType> theField;
