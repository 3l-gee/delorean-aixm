...
@Entity(name = "StandardLevelColumnExtensionType")
@Table(name = "standardlevelcolumne", schema = "shared")
public class StandardLevelColumnExtensionType implements Serializable, Equals, HashCode, ToString {
