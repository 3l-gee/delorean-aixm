...
/**
 * <p>
 * Java class for AuthorityForAerialRefuellingType complex type
 * </p>
 * .
 *
 * <p>
 ...
 *                 <choice>
 *                   <element ref=
"{http://www.aixm.aero/schema/5.2}AbstractAuthorityForAerialRefuellingExtension"/>
 *                 </choice>
 *                 <attGroup ref=
...
@XmlType(name = "AuthorityForAerialRefuellingType", propOrder = {"type", "annotation", "theOrganisationAuthority",
        "extension"})
@Entity(name = "AuthorityForAerialRefuellingType")
@Table(name = "authorityforaerialrefuelling_o", schema = "aerial_refuelling")
public class AuthorityForAerialRefuellingType extends AbstractAIXMObjectType implements Serializable {
    ...
    @JoinTable(name = "athrtfrarlrfllngtp_annttn_link", schema = "aerial_refuelling", joinColumns = {
            @JoinColumn(name = "authorityforaerialrefuelling_o_hjid", referencedColumnName = "hjid")}, inverseJoinColumns = {
    ...
    public void setTypeItem(CodeAuthorityType target) {
        setType(XmlAdapterUtils.marshallJAXBElement(CodeAuthorityType.class,
                new QName("http://www.aixm.aero/schema/5.2", "type"), AuthorityForAerialRefuellingType.class, target));
    }
    ...
    public void setTheOrganisationAuthorityItem(OrganisationAuthorityPropertyType target) {
        setTheOrganisationAuthority(XmlAdapterUtils.marshallJAXBElement(OrganisationAuthorityPropertyType.class,
                ...
                AuthorityForAerialRefuellingType.class, target));
    }
