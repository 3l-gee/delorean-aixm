...
/**
 * <p>
 * Java class for RulesProceduresTimeSliceType complex type
 * </p>
 * .
 *
 * <p>
...
"{http://www.aixm.aero/schema/5.2}CodeRuleProcedureType" minOccurs="0"/>
 *         <element name="title" type=
"{http://www.aixm.aero/schema/5.2}CodeRuleProcedureTitleType" minOccurs="0"/>
 *         <element name="content" type=
"{http://www.aixm.aero/schema/5.2}XHTMLType" minOccurs="0"/>
 *         <element name="affectedLocation" type=
"{http://www.aixm.aero/schema/5.2}AirportHeliportPropertyType" maxOccurs=
"unbounded" minOccurs="0"/>
 *         <element name="affectedArea" type=
 ...
 *                 <sequence>
 *                   <element ref=
"{http://www.aixm.aero/schema/5.2}AbstractRulesProceduresExtension"/>
 *                 </sequence>
 *                 <attGroup ref=
...
@XmlType(name = "RulesProceduresTimeSliceType", propOrder = {"category", "title", "content", "affectedLocation",
        "affectedArea", "annotation", "extension"})
@Entity(name = "RulesProceduresTimeSliceType")
@Table(name = "rulesprocedures_t", schema = "rules_procedure")
public class RulesProceduresTimeSliceType extends AbstractAIXMTimeSliceType implements Serializable {
    ...
    @XmlElementRef(name = "title", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<CodeRuleProcedureTitleType> title;
    @XmlElementRef(name = "content", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
     ...
     *         }{@code <}{@link CodeRuleProcedureType }{@code >}
     *
     */
    @Transient
     ...
     *
     * @return possible object is {@link JAXBElement
     *         }{@code <}{@link CodeRuleProcedureTitleType }{@code >}
     *
     */
    @Transient
     ...
     *
     * @return possible object is {@link JAXBElement }{@code <}{@link XHTMLType
     *         }{@code >}
     *
     */
    @Transient
     ...
     *
     * @param value
     *            allowed object is {@link JAXBElement }{@code <}{@link XHTMLType
     *            }{@code >}
     *
     */
     ...
     * for the affectedLocation property.
     *
     * <p>
    ...
    @JoinTable(name = "rlsprcdrstmslctp_affctdlctn_link", schema = "rules_procedure", joinColumns = {
            @JoinColumn(name = "rulesprocedures_t_hjid", referencedColumnName = "hjid")}, inverseJoinColumns = {
                    @JoinColumn(name = "affectedlocation_hjid", referencedColumnName = "hjid")})
    ...
    @JoinTable(name = "rlsprcdrstmslctp_affctdar_link", schema = "rules_procedure", joinColumns = {
            @JoinColumn(name = "rulesprocedures_t_hjid", referencedColumnName = "hjid")}, inverseJoinColumns = {
                    @JoinColumn(name = "affectedarea_hjid", referencedColumnName = "hjid")})
    ...
    @JoinTable(name = "rlsprcdrstmslctp_annttn_link", schema = "rules_procedure", joinColumns = {
            @JoinColumn(name = "rulesprocedures_t_hjid", referencedColumnName = "hjid")}, inverseJoinColumns = {
    ...
    public void setCategoryItem(CodeRuleProcedureType target) {
        setCategory(XmlAdapterUtils.marshallJAXBElement(CodeRuleProcedureType.class,
                new QName("http://www.aixm.aero/schema/5.2", "category"), RulesProceduresTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({@AttributeOverride(name = "value", column = @Column(name = "title")),
            @AttributeOverride(name = "nilReason", column = @Column(name = "titlenilreason"))})
    ...
    public void setTitleItem(CodeRuleProcedureTitleType target) {
        setTitle(XmlAdapterUtils.marshallJAXBElement(CodeRuleProcedureTitleType.class,
                new QName("http://www.aixm.aero/schema/5.2", "title"), RulesProceduresTimeSliceType.class, target));
    }
    ...
    public void setContentItem(XHTMLType target) {
        setContent(XmlAdapterUtils.marshallJAXBElement(XHTMLType.class,
                new QName("http://www.aixm.aero/schema/5.2", "content"), RulesProceduresTimeSliceType.class, target));
    }
