...
"{http://www.aixm.aero/schema/5.2}CodeMinimaFinalApproachPathType" minOccurs=
"0"/>
 *         <element name="climbGradient" type=
"{http://www.aixm.aero/schema/5.2}ValSlopeType" minOccurs="0"/>
 *         <element name="minimumSet" type=
"{http://www.aixm.aero/schema/5.2}MinimaPropertyType" maxOccurs=
"unbounded" minOccurs="0"/>
 *         <element name="circlingRestriction" type=
"{http://www.aixm.aero/schema/5.2}CirclingRestrictionPropertyType" maxOccurs=
"unbounded" minOccurs="0"/>
 *         <element name="landingArea" type=
"{http://www.aixm.aero/schema/5.2}LandingTakeoffAreaCollectionPropertyType" maxOccurs
="unbounded" minOccurs="0"/>
 *         <element name="altimeter" type=
"{http://www.aixm.aero/schema/5.2}AltimeterSourcePropertyType" minOccurs="0"/>
 ...
 *         <element name="landingPrecisionCategory" type=
"{http://www.aixm.aero/schema/5.2}CodeApproachPrecisionCategoryType" minOccurs=
"0"/>
 *         <element name="satelliteApproachType" type=
"{http://www.aixm.aero/schema/5.2}CodeSatelliteApproachType" minOccurs="0"/>
 *         <element name="specialAuthorisation" type=
"{http://www.aixm.aero/schema/5.2}CodeYesNoType" minOccurs="0"/>
 *         <element name="minBaroVNAVTemperature" type=
"{http://www.aixm.aero/schema/5.2}ValTemperatureType" minOccurs="0"/>
 *         <element name="maxBaroVNAVTemperature" type=
"{http://www.aixm.aero/schema/5.2}ValTemperatureType" minOccurs="0"/>
 *         <element name="stepdownFix" type=
"{http://www.aixm.aero/schema/5.2}TerminalSegmentPointPropertyType" maxOccurs=
"unbounded" minOccurs="0"/>
 ...
 *                 <choice>
 *                   <element ref=
"{http://www.aixm.aero/schema/5.2}AbstractApproachConditionExtension"/>
 *                 </choice>
 *                 <attGroup ref=
...
@XmlType(name = "ApproachConditionType", propOrder = {"finalApproachPath", "climbGradient", "minimumSet",
        "circlingRestriction", "landingArea", "altimeter", "designSurface", "annotation", "navigationAccuracy",
        "landingPrecisionCategory", "satelliteApproachType", "specialAuthorisation", "minBaroVNAVTemperature",
        "maxBaroVNAVTemperature", "stepdownFix", "extension"})
...
public class ApproachConditionType extends AbstractAIXMObjectType implements Serializable {
     ...
     *
     */
    @OneToMany(targetEntity = MinimaPropertyType.class, cascade = {CascadeType.ALL}, fetch = FetchType.EAGER)
     ...
     *
     * @return possible object is {@link JAXBElement
     *         }{@code <}{@link CodeApproachPrecisionCategoryType }{@code >}
     *
     */
    @Transient
     ...
     *
     * @return possible object is {@link JAXBElement
     *         }{@code <}{@link CodeSatelliteApproachType }{@code >}
     *
     */
    @Transient
    ...
    @OneToMany(targetEntity = ApproachConditionTypeExtensionType.class, cascade = {
            CascadeType.ALL}, fetch = FetchType.EAGER)
    @JoinColumn(name = "approachconditione_hjid", referencedColumnName = "hjid")
    ...
    public void setFinalApproachPathItem(CodeMinimaFinalApproachPathType target) {
        setFinalApproachPath(XmlAdapterUtils.marshallJAXBElement(CodeMinimaFinalApproachPathType.class,
                new QName("http://www.aixm.aero/schema/5.2", "finalApproachPath"), ApproachConditionType.class,
                target));
    }
    ...
    @AttributeOverrides({
            ...
            @AttributeOverride(name = "accuracy", column = @Column(name = "climbgradientaccuracy"))})
    ...
    public void setClimbGradientItem(ValSlopeType target) {
        setClimbGradient(XmlAdapterUtils.marshallJAXBElement(ValSlopeType.class,
                new QName("http://www.aixm.aero/schema/5.2", "climbGradient"), ApproachConditionType.class, target));
    }
    ...
    public void setAltimeterItem(AltimeterSourcePropertyType target) {
        setAltimeter(XmlAdapterUtils.marshallJAXBElement(AltimeterSourcePropertyType.class,
                new QName("http://www.aixm.aero/schema/5.2", "altimeter"), ApproachConditionType.class, target));
    }
    ...
    public void setNavigationAccuracyItem(ValNavigationAccuracyType target) {
        setNavigationAccuracy(XmlAdapterUtils.marshallJAXBElement(ValNavigationAccuracyType.class,
                new QName("http://www.aixm.aero/schema/5.2", "navigationAccuracy"), ApproachConditionType.class,
                target));
    }

    @Embedded
    @AttributeOverrides({@AttributeOverride(name = "value", column = @Column(name = "landingprecisioncategory")),
            @AttributeOverride(name = "nilReason", column = @Column(name = "landingprecisioncategorynilreason"))})
    public CodeApproachPrecisionCategoryType getLandingPrecisionCategoryItem() {
        return XmlAdapterUtils.unmarshallSource(CodeApproachPrecisionCategoryType.class,
                this.getLandingPrecisionCategory());
    }

    public void setLandingPrecisionCategoryItem(CodeApproachPrecisionCategoryType target) {
        setLandingPrecisionCategory(XmlAdapterUtils.marshallJAXBElement(CodeApproachPrecisionCategoryType.class,
                new QName("http://www.aixm.aero/schema/5.2", "landingPrecisionCategory"), ApproachConditionType.class,
                target));
    }

    @Embedded
    @AttributeOverrides({@AttributeOverride(name = "value", column = @Column(name = "satelliteapproachtype")),
            @AttributeOverride(name = "nilReason", column = @Column(name = "satelliteapproachtypenilreason"))})
    ...
    public void setSatelliteApproachTypeItem(CodeSatelliteApproachType target) {
        setSatelliteApproachType(XmlAdapterUtils.marshallJAXBElement(CodeSatelliteApproachType.class,
                new QName("http://www.aixm.aero/schema/5.2", "satelliteApproachType"), ApproachConditionType.class,
                target));
    }
    ...
    public void setSpecialAuthorisationItem(CodeYesNoType target) {
        setSpecialAuthorisation(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class,
                new QName("http://www.aixm.aero/schema/5.2", "specialAuthorisation"), ApproachConditionType.class,
                target));
    }

    @Embedded
    @AttributeOverrides({
            @AttributeOverride(name = "value", column = @Column(name = "minbarovnavtemperature", columnDefinition = "NUMERIC")),
            @AttributeOverride(name = "uom", column = @Column(name = "minbarovnavtemperatureuom")),
            @AttributeOverride(name = "accuracy", column = @Column(name = "minbarovnavtemperatureaccuracy")),
            @AttributeOverride(name = "nilReason", column = @Column(name = "minbarovnavtemperaturenilreason"))})
    ...
    public void setMinBaroVNAVTemperatureItem(ValTemperatureType target) {
        setMinBaroVNAVTemperature(XmlAdapterUtils.marshallJAXBElement(ValTemperatureType.class,
                new QName("http://www.aixm.aero/schema/5.2", "minBaroVNAVTemperature"), ApproachConditionType.class,
                target));
    }

    @Embedded
    @AttributeOverrides({
            @AttributeOverride(name = "value", column = @Column(name = "maxbarovnavtemperature", columnDefinition = "NUMERIC")),
            @AttributeOverride(name = "uom", column = @Column(name = "maxbarovnavtemperatureuom")),
            @AttributeOverride(name = "accuracy", column = @Column(name = "maxbarovnavtemperatureaccuracy")),
            @AttributeOverride(name = "nilReason", column = @Column(name = "maxbarovnavtemperaturenilreason"))})
    ...
    public void setMaxBaroVNAVTemperatureItem(ValTemperatureType target) {
        setMaxBaroVNAVTemperature(XmlAdapterUtils.marshallJAXBElement(ValTemperatureType.class,
                new QName("http://www.aixm.aero/schema/5.2", "maxBaroVNAVTemperature"), ApproachConditionType.class,
                target));
    }
