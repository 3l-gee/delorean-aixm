...
"{http://www.aixm.aero/schema/5.2}UnitTimeSlicePropertyType" maxOccurs=
"unbounded"/>
 *       </sequence>
 *     </extension>
 *   </complexContent>
...
@Table(name = "unit_f", schema = "organisation")
public class UnitType extends AbstractAIXMFeatureType implements Serializable {
    ...
    @OneToMany(targetEntity = UnitTimeSlicePropertyType.class, cascade = {CascadeType.ALL}, fetch = FetchType.EAGER)
