...
"{http://www.aixm.aero/schema/5.2}ApronElementTimeSlicePropertyType" maxOccurs=
"unbounded"/>
 *       </sequence>
 *     </extension>
 *   </complexContent>
...
@Table(name = "apronelement_f", schema = "airport_heliport")
public class ApronElementType extends AbstractAIXMFeatureType implements Serializable {
    ...
    @OneToMany(targetEntity = ApronElementTimeSlicePropertyType.class, cascade = {
