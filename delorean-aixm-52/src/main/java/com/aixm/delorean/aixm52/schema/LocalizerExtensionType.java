...
@Entity(name = "LocalizerExtensionType")
@Table(name = "localizere", schema = "navaids_point")
public class LocalizerExtensionType implements Serializable, Equals, HashCode, ToString {
