...
"{http://www.aixm.aero/schema/5.2}SeaplaneRampSitePropertyType" maxOccurs=
"unbounded" minOccurs="0"/>
 *         <element name="dockSite" type=
"{http://www.aixm.aero/schema/5.2}FloatingDockSitePropertyType" maxOccurs=
"unbounded" minOccurs="0"/>
...
="unbounded" minOccurs="0"/>
 *         <element name="assignedGangway" type=
"{http://www.aixm.aero/schema/5.2}GangwayPropertyType" maxOccurs=
"unbounded" minOccurs="0"/>
 ...
 *                 <sequence>
 *                   <element ref=
"{http://www.aixm.aero/schema/5.2}AbstractSeaplaneLandingAreaExtension"/>
 *                 </sequence>
 *                 <attGroup ref=
...
@XmlType(name = "SeaplaneLandingAreaTimeSliceType", propOrder = {"rampSite", "dockSite", "extent", "annotation",
        "availability", "assignedGangway", "associatedAirportHeliport", "extension"})
...
public class SeaplaneLandingAreaTimeSliceType extends AbstractAIXMTimeSliceType implements Serializable {
     ...
     * Therefore any modification you make to the returned list will be present
     * inside the JAXB object. This is why there is not a <CODE>set</CODE> method
     * for the assignedGangway property.
     *
     * <p>
     * For example, to add a new item, do as follows:
     *
     ...
     *
     */
    @OneToMany(targetEntity = GangwayPropertyType.class, cascade = {CascadeType.ALL}, fetch = FetchType.EAGER)
    ...
    @OneToMany(targetEntity = SeaplaneLandingAreaExtensionType.class, cascade = {
            CascadeType.ALL}, fetch = FetchType.EAGER)
    @JoinColumn(name = "seaplanelandingareae_hjid", referencedColumnName = "hjid")
    ...
    public void setExtentItem(AIXMElevatedSurfacePropertyType target) {
        setExtent(XmlAdapterUtils.marshallJAXBElement(AIXMElevatedSurfacePropertyType.class,
                new QName("http://www.aixm.aero/schema/5.2", "extent"), SeaplaneLandingAreaTimeSliceType.class,
                target));
    }
    ...
    public void setAssociatedAirportHeliportItem(AirportHeliportPropertyType target) {
        setAssociatedAirportHeliport(XmlAdapterUtils.marshallJAXBElement(AirportHeliportPropertyType.class,
                ...
                SeaplaneLandingAreaTimeSliceType.class, target));
    }
