...
public class TaxiHoldingPositionTimeSliceType extends AbstractAIXMTimeSliceType implements Serializable {
    ...
    @XmlElementRef(name = "associatedGuidanceLine", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    ...
    protected JAXBElement<CodeTaxiHoldingPositionType> type;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final TaxiHoldingPositionTimeSliceType that = ((TaxiHoldingPositionTimeSliceType) object);
        {
            ...
            JAXBElement<CodeTaxiHoldingPositionType> lhsField;
            lhsField = this.getType();
            JAXBElement<CodeTaxiHoldingPositionType> rhsField;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        }
        {
            ...
            JAXBElement<CodeTaxiHoldingPositionType> theField;
