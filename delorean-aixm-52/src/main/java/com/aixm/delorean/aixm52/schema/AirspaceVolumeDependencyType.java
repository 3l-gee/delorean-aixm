...
/**
 * <p>
 * Java class for AirspaceVolumeDependencyType complex type
 * </p>
 * .
 *
 * <p>
 ...
 *       <sequence>
 *         <element name="dependency" type=
"{http://www.aixm.aero/schema/5.2}CodeAirspaceDependencyType" minOccurs="0"/>
 *         <element name="annotation" type=
"{http://www.aixm.aero/schema/5.2}NotePropertyType" maxOccurs=
"unbounded" minOccurs="0"/>
 *         <element name="theAirspace" type=
 ...
 *                 <choice>
 *                   <element ref=
"{http://www.aixm.aero/schema/5.2}AbstractAirspaceVolumeDependencyExtension"/>
 *                 </choice>
 *                 <attGroup ref=
...
@XmlType(name = "AirspaceVolumeDependencyType", propOrder = {"dependency", "annotation", "theAirspace", "extension"})
@Entity(name = "AirspaceVolumeDependencyType")
@Table(name = "airspacevolumedependency_o", schema = "airspace")
public class AirspaceVolumeDependencyType extends AbstractAIXMObjectType implements Serializable {

    private static final long serialVersionUID = 20251104L;
    @XmlElementRef(name = "dependency", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<CodeAirspaceDependencyType> dependency;
    @XmlElement(nillable = true)
    protected List<NotePropertyType> annotation;
    @XmlElementRef(name = "theAirspace", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<AirspacePropertyType> theAirspace;
     ...
     *         }{@code <}{@link CodeAirspaceDependencyType }{@code >}
     *
     */
    @Transient
    ...
    @JoinTable(name = "arspcvlmdpndnctp_annttn_link", schema = "airspace", joinColumns = {
            @JoinColumn(name = "airspacevolumedependency_o_hjid", referencedColumnName = "hjid")}, inverseJoinColumns = {
     ...
     */
    @Transient
    public JAXBElement<AirspacePropertyType> getTheAirspace() {
        return theAirspace;
    }
     ...
     *
     */
    public void setTheAirspace(JAXBElement<AirspacePropertyType> value) {
    ...
    @Embedded
    @AttributeOverrides({@AttributeOverride(name = "value", column = @Column(name = "dependency")),
            @AttributeOverride(name = "nilReason", column = @Column(name = "dependencynilreason"))})
    ...
    public void setDependencyItem(CodeAirspaceDependencyType target) {
        setDependency(XmlAdapterUtils.marshallJAXBElement(CodeAirspaceDependencyType.class,
                new QName("http://www.aixm.aero/schema/5.2", "dependency"), AirspaceVolumeDependencyType.class,
                target));
    }

    @OneToOne(targetEntity = AirspacePropertyType.class, cascade = {CascadeType.ALL}, fetch = FetchType.EAGER)
    @JoinTable(name = "arspcvlmdpndnctp_tharspc_link", schema = "airspace", joinColumns = {
            @JoinColumn(name = "airspacevolumedependency_o_hjid", referencedColumnName = "hjid")}, inverseJoinColumns = {
                    @JoinColumn(name = "theairspace_hjid", referencedColumnName = "hjid")})
    public AirspacePropertyType getTheAirspaceItem() {
        return XmlAdapterUtils.unmarshallSource(AirspacePropertyType.class, this.getTheAirspace());
    }

    public void setTheAirspaceItem(AirspacePropertyType target) {
        setTheAirspace(XmlAdapterUtils.marshallJAXBElement(AirspacePropertyType.class,
                new QName("http://www.aixm.aero/schema/5.2", "theAirspace"), AirspaceVolumeDependencyType.class,
                target));
    }
