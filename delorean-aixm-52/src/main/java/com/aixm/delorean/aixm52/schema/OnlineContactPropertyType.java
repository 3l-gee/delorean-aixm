...
/**
 * <p>
 * Java class for OnlineContactPropertyType complex type
 * </p>
 * .
 *
 * <p>
 ...
 *       <sequence>
 *         <element ref="{http://www.aixm.aero/schema/5.2}OnlineContact"/>
 *       </sequence>
 *     </extension>
 *   </complexContent>
 * </complexType>
...
@XmlType(name = "OnlineContactPropertyType", propOrder = {"onlineContact"})
@Entity(name = "OnlineContactPropertyType")
@Table(name = "onlinecontactpropertytype", schema = "shared")
public class OnlineContactPropertyType extends AbstractAIXMPropertyType implements Serializable {
     ...
     *
     * @return possible object is {@link OnlineContactType }
     *
     */
    @OneToOne(targetEntity = OnlineContactType.class, cascade = {CascadeType.ALL}, fetch = FetchType.EAGER)
     ...
     *
     * @param value
     *            allowed object is {@link OnlineContactType }
     *
     */
