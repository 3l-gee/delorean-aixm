...
/**
 * <p>
 * Java class for FlightRestrictionLevelType complex type
 * </p>
 * .
 *
 * <p>
 ...
 *                 <choice>
 *                   <element ref=
"{http://www.aixm.aero/schema/5.2}AbstractFlightRestrictionLevelExtension"/>
 *                 </choice>
 *                 <attGroup ref=
...
@XmlType(name = "FlightRestrictionLevelType", propOrder = {"upperLevel", "upperLevelReference", "lowerLevel",
        "lowerLevelReference", "annotation", "extension"})
@Entity(name = "FlightRestrictionLevelType")
@Table(name = "flightrestrictionlevel_o", schema = "route")
public class FlightRestrictionLevelType extends AbstractAIXMObjectType implements Serializable {
    ...
    @JoinTable(name = "flghtrstrctnlvltp_annttn_link", schema = "route", joinColumns = {
            @JoinColumn(name = "flightrestrictionlevel_o_hjid", referencedColumnName = "hjid")}, inverseJoinColumns = {
    ...
    @Embedded
    @AttributeOverrides({
            @AttributeOverride(name = "value", column = @Column(name = "upperlevel", columnDefinition = "VARCHAR", length = 256)),
            @AttributeOverride(name = "uom", column = @Column(name = "upperleveluom")),
            @AttributeOverride(name = "accuracy", column = @Column(name = "upperlevelaccuracy")),
            @AttributeOverride(name = "nilReason", column = @Column(name = "upperlevelnilreason"))})
    ...
    public void setUpperLevelItem(ValDistanceVerticalType target) {
        setUpperLevel(XmlAdapterUtils.marshallJAXBElement(ValDistanceVerticalType.class,
                new QName("http://www.aixm.aero/schema/5.2", "upperLevel"), FlightRestrictionLevelType.class, target));
    }

    @Embedded
    @AttributeOverrides({@AttributeOverride(name = "value", column = @Column(name = "upperlevelreference")),
            @AttributeOverride(name = "nilReason", column = @Column(name = "upperlevelreferencenilreason"))})
    ...
    public void setUpperLevelReferenceItem(CodeVerticalReferenceType target) {
        setUpperLevelReference(XmlAdapterUtils.marshallJAXBElement(CodeVerticalReferenceType.class,
                new QName("http://www.aixm.aero/schema/5.2", "upperLevelReference"), FlightRestrictionLevelType.class,
                target));
    }

    @Embedded
    @AttributeOverrides({
            @AttributeOverride(name = "value", column = @Column(name = "lowerlevel", columnDefinition = "VARCHAR", length = 256)),
            @AttributeOverride(name = "uom", column = @Column(name = "lowerleveluom")),
            @AttributeOverride(name = "accuracy", column = @Column(name = "lowerlevelaccuracy")),
            @AttributeOverride(name = "nilReason", column = @Column(name = "lowerlevelnilreason"))})
    ...
    public void setLowerLevelItem(ValDistanceVerticalType target) {
        setLowerLevel(XmlAdapterUtils.marshallJAXBElement(ValDistanceVerticalType.class,
                new QName("http://www.aixm.aero/schema/5.2", "lowerLevel"), FlightRestrictionLevelType.class, target));
    }

    @Embedded
    @AttributeOverrides({@AttributeOverride(name = "value", column = @Column(name = "lowerlevelreference")),
            @AttributeOverride(name = "nilReason", column = @Column(name = "lowerlevelreferencenilreason"))})
    ...
    public void setLowerLevelReferenceItem(CodeVerticalReferenceType target) {
        setLowerLevelReference(XmlAdapterUtils.marshallJAXBElement(CodeVerticalReferenceType.class,
                new QName("http://www.aixm.aero/schema/5.2", "lowerLevelReference"), FlightRestrictionLevelType.class,
                target));
    }
