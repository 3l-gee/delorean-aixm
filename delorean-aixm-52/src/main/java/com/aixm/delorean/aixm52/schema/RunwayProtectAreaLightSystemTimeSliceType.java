...
"{http://www.aixm.aero/schema/5.2}RunwayProtectAreaPropertyType" minOccurs="0"/>
 ...
 *                 <choice>
 *                   <element ref=
"{http://www.aixm.aero/schema/5.2}AbstractRunwayProtectAreaLightSystemExtension"/>
 *                   <element ref=
...
@XmlType(name = "RunwayProtectAreaLightSystemTimeSliceType", propOrder = {"emergencyLighting", "intensityLevel",
        "colour", "element", "availability", "annotation", "position", "lightedArea", "length", "extension"})
...
public class RunwayProtectAreaLightSystemTimeSliceType extends AbstractAIXMTimeSliceType implements Serializable {
    ...
    public void setColourItem(CodeColourType target) {
        setColour(XmlAdapterUtils.marshallJAXBElement(CodeColourType.class,
                new QName("http://www.aixm.aero/schema/5.2", "colour"), RunwayProtectAreaLightSystemTimeSliceType.class,
                target));
    }
    ...
    public void setLightedAreaItem(RunwayProtectAreaPropertyType target) {
        setLightedArea(XmlAdapterUtils.marshallJAXBElement(RunwayProtectAreaPropertyType.class,
                new QName("http://www.aixm.aero/schema/5.2", "lightedArea"),
                RunwayProtectAreaLightSystemTimeSliceType.class, target));
    }
    ...
    public void setLengthItem(ValDistanceType target) {
        setLength(XmlAdapterUtils.marshallJAXBElement(ValDistanceType.class,
                new QName("http://www.aixm.aero/schema/5.2", "length"), RunwayProtectAreaLightSystemTimeSliceType.class,
                target));
    }
