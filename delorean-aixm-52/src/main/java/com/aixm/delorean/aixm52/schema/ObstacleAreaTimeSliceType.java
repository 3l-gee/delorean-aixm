...
"{http://www.aixm.aero/schema/5.2}VerticalStructurePropertyType" maxOccurs=
 ...
 *                 <sequence>
 *                   <element ref=
"{http://www.aixm.aero/schema/5.2}AbstractObstacleAreaExtension"/>
 *                 </sequence>
 *                 <attGroup ref=
...
@XmlType(name = "ObstacleAreaTimeSliceType", propOrder = {"type", "referenceOwnerOrganisation",
        "referenceOwnerRunwayDirection", "referenceOwnerRunway", "referenceOwnerAirport", "surfaceExtent", "obstacle",
...
public class ObstacleAreaTimeSliceType extends AbstractAIXMTimeSliceType implements Serializable {
    ...
    public void setTypeItem(CodeObstacleAreaType target) {
        setType(XmlAdapterUtils.marshallJAXBElement(CodeObstacleAreaType.class,
                new QName("http://www.aixm.aero/schema/5.2", "type"), ObstacleAreaTimeSliceType.class, target));
    }
    ...
    public void setReferenceOwnerOrganisationItem(OrganisationAuthorityPropertyType target) {
        setReferenceOwnerOrganisation(XmlAdapterUtils.marshallJAXBElement(OrganisationAuthorityPropertyType.class,
                new QName("http://www.aixm.aero/schema/5.2", "reference_ownerOrganisation"),
    ...
    @JoinTable(name = "obstclartmslctp_rfrncownrrnwdrctn_link", schema = "obstacle", joinColumns = {
            @JoinColumn(name = "obstaclearea_t_hjid", referencedColumnName = "hjid")}, inverseJoinColumns = {
    ...
    public RunwayDirectionPropertyType getReferenceOwnerRunwayDirectionItem() {
        return XmlAdapterUtils.unmarshallSource(RunwayDirectionPropertyType.class,
                this.getReferenceOwnerRunwayDirection());
    }

    public void setReferenceOwnerRunwayDirectionItem(RunwayDirectionPropertyType target) {
        setReferenceOwnerRunwayDirection(XmlAdapterUtils.marshallJAXBElement(RunwayDirectionPropertyType.class,
                new QName("http://www.aixm.aero/schema/5.2", "reference_ownerRunwayDirection"),
                ObstacleAreaTimeSliceType.class, target));
    }
    ...
    public void setReferenceOwnerRunwayItem(RunwayPropertyType target) {
        setReferenceOwnerRunway(XmlAdapterUtils.marshallJAXBElement(RunwayPropertyType.class,
                new QName("http://www.aixm.aero/schema/5.2", "reference_ownerRunway"), ObstacleAreaTimeSliceType.class,
                target));
    }
    ...
    public void setReferenceOwnerAirportItem(AirportHeliportPropertyType target) {
        setReferenceOwnerAirport(XmlAdapterUtils.marshallJAXBElement(AirportHeliportPropertyType.class,
                new QName("http://www.aixm.aero/schema/5.2", "reference_ownerAirport"), ObstacleAreaTimeSliceType.class,
                target));
    }
    ...
    public void setSurfaceExtentItem(AIXMSurfacePropertyType target) {
        setSurfaceExtent(XmlAdapterUtils.marshallJAXBElement(AIXMSurfacePropertyType.class,
                new QName("http://www.aixm.aero/schema/5.2", "surfaceExtent"), ObstacleAreaTimeSliceType.class,
                target));
    }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        }
        {
            ...
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "referenceOwnerRunwayDirection",
                    lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "referenceOwnerRunwayDirection",
                    rhsField);
            if (!strategy.equals(lhsFieldLocator, rhsFieldLocator, lhsField, rhsField, lhsFieldIsSet, rhsFieldIsSet)) {
                return false;
            }
