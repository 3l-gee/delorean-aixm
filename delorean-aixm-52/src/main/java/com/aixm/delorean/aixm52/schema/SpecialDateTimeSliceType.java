...
public class SpecialDateTimeSliceType extends AbstractAIXMTimeSliceType implements Serializable {
    ...
    @XmlElementRef(name = "dateDay", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<DateMonthDayType> dateDay;
    @XmlElementRef(name = "dateYear", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "authority", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<OrganisationAuthorityPropertyType> authority;
    @XmlElementRef(name = "weekDay", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<CodeWeekDayType> weekDay;
     ...
     *
     */
    @OneToMany(targetEntity = SpecialDateExtensionType.class, cascade = {CascadeType.ALL}, fetch = FetchType.EAGER)
    @JoinColumn(name = "specialdatee_hjid", referencedColumnName = "hjid")
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        {
            boolean lhsFieldIsSet = this.isSetWeekDay();
            boolean rhsFieldIsSet = that.isSetWeekDay();
            JAXBElement<CodeWeekDayType> lhsField;
            lhsField = this.getWeekDay();
            JAXBElement<CodeWeekDayType> rhsField;
            rhsField = that.getWeekDay();
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "weekDay", lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "weekDay", rhsField);
            if (!strategy.equals(lhsFieldLocator, rhsFieldLocator, lhsField, rhsField, lhsFieldIsSet, rhsFieldIsSet)) {
                return false;
            }
        }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetWeekDay();
            JAXBElement<CodeWeekDayType> theField;
            theField = this.getWeekDay();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "weekDay", theField);
            currentHashCode = strategy.hashCode(theFieldLocator, currentHashCode, theField, theFieldIsSet);
        }
        {
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        }
        {
            ...
            JAXBElement<CodeWeekDayType> theField;
            theField = this.getWeekDay();
            strategy.appendField(locator, this, "weekDay", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetExtension();
            List<SpecialDateExtensionType> theField;
