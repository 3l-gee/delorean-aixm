...
/**
 * <p>
 * Java class for ProcedureDMETimeSliceType complex type
 * </p>
 * .
 *
 * <p>
...
"{http://www.aixm.aero/schema/5.2}CodeYesNoType" minOccurs="0"/>
 *         <element name="DME" type=
"{http://www.aixm.aero/schema/5.2}DMEPropertyType" minOccurs="0"/>
 *         <element name="segmentLeg" type=
 ...
 *                 <sequence>
 *                   <element ref=
"{http://www.aixm.aero/schema/5.2}AbstractProcedureDMEExtension"/>
 *                 </sequence>
 *                 <attGroup ref=
...
@XmlType(name = "ProcedureDMETimeSliceType", propOrder = {"criticalDME", "satisfactory", "dme", "segmentLeg",
        "annotation", "extension"})
@Entity(name = "ProcedureDMETimeSliceType")
@Table(name = "proceduredme_t", schema = "procedure")
public class ProcedureDMETimeSliceType extends AbstractAIXMTimeSliceType implements Serializable {

    private static final long serialVersionUID = 20251104L;
    @XmlElementRef(name = "criticalDME", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<CodeYesNoType> criticalDME;
    @XmlElementRef(name = "satisfactory", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<CodeYesNoType> satisfactory;
    @XmlElementRef(name = "DME", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<DMEPropertyType> dme;
    @XmlElementRef(name = "segmentLeg", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    ...
    @JoinTable(name = "prcdrdmetmslctp_annttn_link", schema = "procedure", joinColumns = {
            @JoinColumn(name = "proceduredme_t_hjid", referencedColumnName = "hjid")}, inverseJoinColumns = {
    ...
    public void setCriticalDMEItem(CodeYesNoType target) {
        setCriticalDME(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class,
                new QName("http://www.aixm.aero/schema/5.2", "criticalDME"), ProcedureDMETimeSliceType.class, target));
    }
    ...
    public void setSatisfactoryItem(CodeYesNoType target) {
        setSatisfactory(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class,
                new QName("http://www.aixm.aero/schema/5.2", "satisfactory"), ProcedureDMETimeSliceType.class, target));
    }

    @OneToOne(targetEntity = DMEPropertyType.class, cascade = {CascadeType.ALL}, fetch = FetchType.EAGER)
    @JoinTable(name = "prcdrdmetmslctp_dme_link", schema = "procedure", joinColumns = {
            @JoinColumn(name = "proceduredme_t_hjid", referencedColumnName = "hjid")}, inverseJoinColumns = {
    ...
    public void setDMEItem(DMEPropertyType target) {
        setDME(XmlAdapterUtils.marshallJAXBElement(DMEPropertyType.class,
                new QName("http://www.aixm.aero/schema/5.2", "DME"), ProcedureDMETimeSliceType.class, target));
    }

    @OneToOne(targetEntity = SegmentLegPropertyType.class, cascade = {CascadeType.ALL}, fetch = FetchType.EAGER)
    @JoinTable(name = "prcdrdmetmslctp_sgmntlg_link", schema = "procedure", joinColumns = {
            @JoinColumn(name = "proceduredme_t_hjid", referencedColumnName = "hjid")}, inverseJoinColumns = {
    ...
    public void setSegmentLegItem(SegmentLegPropertyType target) {
        setSegmentLeg(XmlAdapterUtils.marshallJAXBElement(SegmentLegPropertyType.class,
                new QName("http://www.aixm.aero/schema/5.2", "segmentLeg"), ProcedureDMETimeSliceType.class, target));
    }
