...
@XmlType(name = "", propOrder = {"abstractVORExtension", "abstractNavaidEquipmentExtension"})
@Entity(name = "VORTimeSliceExtensionType")
@Table(name = "vor_te", schema = "navaids_point")
public class VORTimeSliceExtensionType implements Serializable, Equals, HashCode, ToString {
    ...
    @JoinColumn(name = "abstractvorextension_hjid", referencedColumnName = "hjid")
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetAbstractVORExtension();
            AbstractExtensionType theField;
            theField = this.getAbstractVORExtension();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "abstractVORExtension", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            AbstractExtensionType theField;
            theField = this.getAbstractVORExtension();
            strategy.appendField(locator, this, "abstractVORExtension", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetAbstractNavaidEquipmentExtension();
            AbstractExtensionType theField;
