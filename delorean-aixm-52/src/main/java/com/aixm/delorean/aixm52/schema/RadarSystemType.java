...
/**
 * <p>
 * Java class for RadarSystemType complex type
 * </p>
 * .
 *
 * <p>
...
"{http://www.aixm.aero/schema/5.2}RadarSystemTimeSlicePropertyType" maxOccurs=
"unbounded"/>
 *       </sequence>
 *     </extension>
 *   </complexContent>
...
@XmlType(name = "RadarSystemType", propOrder = {"timeSlice"})
@Entity(name = "RadarSystemType")
@Table(name = "radarsystem_f", schema = "surveillance")
public class RadarSystemType extends AbstractAIXMFeatureType implements Serializable {
     ...
     * {@link RadarSystemTimeSlicePropertyType }
     *
     *
     */
    @Filter(name = "TPHjidFilter", condition = "hjid IN (:ids)")
    @OneToMany(targetEntity = RadarSystemTimeSlicePropertyType.class, cascade = {
            CascadeType.ALL}, fetch = FetchType.EAGER)
    @JoinColumn(name = "timeslice_hjid", referencedColumnName = "hjid")
    public List<RadarSystemTimeSlicePropertyType> getTimeSlice() {
        if (timeSlice == null) {
     ...
     *
     */
    public void setTimeSlice(List<RadarSystemTimeSlicePropertyType> timeSlice) {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final RadarSystemType that = ((RadarSystemType) object);
        {
            boolean lhsFieldIsSet = this.isSetTimeSlice();
            boolean rhsFieldIsSet = that.isSetTimeSlice();
            List<RadarSystemTimeSlicePropertyType> lhsField;
            lhsField = (this.isSetTimeSlice() ? this.getTimeSlice() : null);
            List<RadarSystemTimeSlicePropertyType> rhsField;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = super.hashCode(locator, strategy);
        {
            ...
            List<RadarSystemTimeSlicePropertyType> theField;
