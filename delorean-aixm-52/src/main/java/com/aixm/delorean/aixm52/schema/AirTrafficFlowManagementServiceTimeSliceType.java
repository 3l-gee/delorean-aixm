...
public class AirTrafficFlowManagementServiceTimeSliceType extends AbstractAIXMTimeSliceType implements Serializable {
    ...
    protected List<AirTrafficFlowManagementServiceExtensionType> extension;
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link AirTrafficFlowManagementServiceExtensionType }
     *
     *
     */
    @OneToMany(targetEntity = AirTrafficFlowManagementServiceExtensionType.class, cascade = {
            CascadeType.ALL}, fetch = FetchType.EAGER)
    @JoinColumn(name = "airtrafficflowmanagementservicee_hjid", referencedColumnName = "hjid")
    public List<AirTrafficFlowManagementServiceExtensionType> getExtension() {
        if (extension == null) {
     ...
     *
     */
    public void setExtension(List<AirTrafficFlowManagementServiceExtensionType> extension) {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        }
        {
            ...
            List<AirTrafficFlowManagementServiceExtensionType> lhsField;
            lhsField = (this.isSetExtension() ? this.getExtension() : null);
            List<AirTrafficFlowManagementServiceExtensionType> rhsField;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        }
        {
            ...
            List<AirTrafficFlowManagementServiceExtensionType> theField;
