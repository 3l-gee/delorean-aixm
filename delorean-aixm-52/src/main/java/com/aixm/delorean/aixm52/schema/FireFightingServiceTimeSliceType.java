...
public class FireFightingServiceTimeSliceType extends AbstractAIXMTimeSliceType implements Serializable {
    ...
    protected List<FireFightingServiceExtensionType> extension;
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link FireFightingServiceExtensionType }
     *
     *
     */
    @OneToMany(targetEntity = FireFightingServiceExtensionType.class, cascade = {
            CascadeType.ALL}, fetch = FetchType.EAGER)
    @JoinColumn(name = "firefightingservicee_hjid", referencedColumnName = "hjid")
    public List<FireFightingServiceExtensionType> getExtension() {
        if (extension == null) {
     ...
     *
     */
    public void setExtension(List<FireFightingServiceExtensionType> extension) {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        }
        {
            ...
            List<FireFightingServiceExtensionType> lhsField;
            lhsField = (this.isSetExtension() ? this.getExtension() : null);
            List<FireFightingServiceExtensionType> rhsField;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        }
        {
            ...
            List<FireFightingServiceExtensionType> theField;
