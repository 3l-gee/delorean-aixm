...
/**
 * <p>
 * Java class for FireFightingServiceTimeSliceType complex type
 * </p>
 * .
 *
 * <p>
...
"{http://www.aixm.aero/schema/5.2}CodeFireFightingType" minOccurs="0"/>
 *         <element name="standard" type=
"{http://www.aixm.aero/schema/5.2}CodeAviationStandardsType" minOccurs="0"/>
 ...
 *                 <choice>
 *                   <element ref=
"{http://www.aixm.aero/schema/5.2}AbstractFireFightingServiceExtension"/>
 *                   <element ref=
"{http://www.aixm.aero/schema/5.2}AbstractAirportGroundServiceExtension"/>
 *                   <element ref=
...
@XmlType(name = "FireFightingServiceTimeSliceType", propOrder = {"flightOperations", "rank", "compliantICAO",
        "aixmName", "location", "serviceProvider", "callSign", "radioCommunication", "groundCommunication",
        "availability", "annotation", "airportHeliport", "category", "standard", "extension"})
@Entity(name = "FireFightingServiceTimeSliceType")
@Table(name = "firefightingservice_t", schema = "service")
public class FireFightingServiceTimeSliceType extends AbstractAIXMTimeSliceType implements Serializable {
    ...
    @JoinTable(name = "frfghtngsrvctmslctp_cll-sgn_link", schema = "service", joinColumns = {
            @JoinColumn(name = "firefightingservice_t_hjid", referencedColumnName = "hjid")}, inverseJoinColumns = {
     ...
     *
     * @return possible object is {@link JAXBElement
     *         }{@code <}{@link CodeFireFightingType }{@code >}
     *
     */
    @Transient
     ...
     *
     * @return possible object is {@link JAXBElement
     *         }{@code <}{@link CodeAviationStandardsType }{@code >}
     *
     */
    @Transient
    ...
    public void setFlightOperationsItem(CodeFlightDestinationType target) {
        setFlightOperations(XmlAdapterUtils.marshallJAXBElement(CodeFlightDestinationType.class,
                ...
                FireFightingServiceTimeSliceType.class, target));
    }
    ...
    public void setRankItem(CodeFacilityRankingType target) {
        setRank(XmlAdapterUtils.marshallJAXBElement(CodeFacilityRankingType.class,
                new QName("http://www.aixm.aero/schema/5.2", "rank"), FireFightingServiceTimeSliceType.class, target));
    }
    ...
    public void setCompliantICAOItem(CodeYesNoType target) {
        setCompliantICAO(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class,
                new QName("http://www.aixm.aero/schema/5.2", "compliantICAO"), FireFightingServiceTimeSliceType.class,
                target));
    }
    ...
    public void setAixmNameItem(TextNameType target) {
        setAixmName(XmlAdapterUtils.marshallJAXBElement(TextNameType.class,
                new QName("http://www.aixm.aero/schema/5.2", "name"), FireFightingServiceTimeSliceType.class, target));
    }
    ...
    public void setLocationItem(AIXMElevatedPointPropertyType target) {
        setLocation(XmlAdapterUtils.marshallJAXBElement(AIXMElevatedPointPropertyType.class,
                new QName("http://www.aixm.aero/schema/5.2", "location"), FireFightingServiceTimeSliceType.class,
                target));
    }
    ...
    public void setServiceProviderItem(UnitPropertyType target) {
        setServiceProvider(XmlAdapterUtils.marshallJAXBElement(UnitPropertyType.class,
                new QName("http://www.aixm.aero/schema/5.2", "serviceProvider"), FireFightingServiceTimeSliceType.class,
                target));
    }
    ...
    public void setCategoryItem(CodeFireFightingType target) {
        setCategory(XmlAdapterUtils.marshallJAXBElement(CodeFireFightingType.class,
                new QName("http://www.aixm.aero/schema/5.2", "category"), FireFightingServiceTimeSliceType.class,
                target));
    }

    @Embedded
    @AttributeOverrides({@AttributeOverride(name = "value", column = @Column(name = "standard")),
            @AttributeOverride(name = "nilReason", column = @Column(name = "standardnilreason"))})
    ...
    public void setStandardItem(CodeAviationStandardsType target) {
        setStandard(XmlAdapterUtils.marshallJAXBElement(CodeAviationStandardsType.class,
                new QName("http://www.aixm.aero/schema/5.2", "standard"), FireFightingServiceTimeSliceType.class,
                target));
    }
