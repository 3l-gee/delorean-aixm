...
/**
 * <p>
 * Java class for TimesheetPropertyType complex type
 * </p>
 * .
 *
 * <p>
 ...
 *       <sequence>
 *         <element ref="{http://www.aixm.aero/schema/5.2}Timesheet"/>
 *       </sequence>
 *     </extension>
 *   </complexContent>
 * </complexType>
...
@XmlType(name = "TimesheetPropertyType", propOrder = {"timesheet"})
@Entity(name = "TimesheetPropertyType")
@Table(name = "timesheetpropertytype", schema = "shared")
public class TimesheetPropertyType extends AbstractAIXMPropertyType implements Serializable {
     ...
     *
     * @return possible object is {@link TimesheetType }
     *
     */
    @OneToOne(targetEntity = TimesheetType.class, cascade = {CascadeType.ALL}, fetch = FetchType.EAGER)
     ...
     *
     * @param value
     *            allowed object is {@link TimesheetType }
     *
     */
