...
/**
 * <p>
 * Java class for AircraftNavigationEquipmentType complex type
 * </p>
 * .
 *
 * <p>
...
@XmlType(name = "AircraftNavigationEquipmentType", propOrder = {"navigationEquipment", "annotation", "extension"})
@Entity(name = "AircraftNavigationEquipmentType")
@Table(name = "aircraftnavigationequipment_o", schema = "shared")
public class AircraftNavigationEquipmentType extends AbstractAIXMObjectType implements Serializable {
    ...
    @JoinTable(name = "arcrftnvgtneqpmnttp_annttn_link", schema = "shared", joinColumns = {
            @JoinColumn(name = "aircraftnavigationequipment_o_hjid", referencedColumnName = "hjid")}, inverseJoinColumns = {
    ...
    public void setNavigationEquipmentItem(CodeNavigationEquipmentType target) {
        setNavigationEquipment(XmlAdapterUtils.marshallJAXBElement(CodeNavigationEquipmentType.class,
                new QName("http://www.aixm.aero/schema/5.2", "navigationEquipment"),
                AircraftNavigationEquipmentType.class, target));
    }
