...
/**
 * <p>
 * Java class for NavigationAreaTimeSliceType complex type
 * </p>
 * .
 *
 * <p>
 ...
 *       <sequence>
 *         <element name="navigationAreaType" type=
"{http://www.aixm.aero/schema/5.2}CodeNavigationAreaType" minOccurs="0"/>
 *         <element name="minimumCeiling" type=
"{http://www.aixm.aero/schema/5.2}ValDistanceVerticalType" minOccurs="0"/>
 *         <element name="minimumVisibility" type=
...
"{http://www.aixm.aero/schema/5.2}NavigationAreaSectorPropertyType" maxOccurs=
 ...
 *                 <sequence>
 *                   <element ref=
"{http://www.aixm.aero/schema/5.2}AbstractNavigationAreaExtension"/>
 *                 </sequence>
 *                 <attGroup ref=
...
@XmlType(name = "NavigationAreaTimeSliceType", propOrder = {"navigationAreaType", "minimumCeiling", "minimumVisibility",
        "departure", "sector", "centrePointFixDesignatedPoint", "centrePointNavaidSystem", "centrePointPosition",
        "centrePointRunwayPoint", "centrePointAimingPoint", "centrePointAirportReferencePoint", "annotation",
        "extension"})
@Entity(name = "NavigationAreaTimeSliceType")
@Table(name = "navigationarea_t", schema = "procedure")
public class NavigationAreaTimeSliceType extends AbstractAIXMTimeSliceType implements Serializable {
     ...
     *         }{@code <}{@link CodeNavigationAreaType }{@code >}
     *
     */
    @Transient
    ...
    @JoinTable(name = "nvgtnartmslctp_sctr_link", schema = "procedure", joinColumns = {
            @JoinColumn(name = "navigationarea_t_hjid", referencedColumnName = "hjid")}, inverseJoinColumns = {
    ...
    @Embedded
    @AttributeOverrides({@AttributeOverride(name = "value", column = @Column(name = "navigationareatype")),
            @AttributeOverride(name = "nilReason", column = @Column(name = "navigationareatypenilreason"))})
    ...
    public void setNavigationAreaTypeItem(CodeNavigationAreaType target) {
        setNavigationAreaType(XmlAdapterUtils.marshallJAXBElement(CodeNavigationAreaType.class,
                new QName("http://www.aixm.aero/schema/5.2", "navigationAreaType"), NavigationAreaTimeSliceType.class,
                target));
    }

    @Embedded
    @AttributeOverrides({
            @AttributeOverride(name = "value", column = @Column(name = "minimumceiling", columnDefinition = "VARCHAR", length = 256)),
            @AttributeOverride(name = "uom", column = @Column(name = "minimumceilinguom")),
            @AttributeOverride(name = "accuracy", column = @Column(name = "minimumceilingaccuracy")),
            @AttributeOverride(name = "nilReason", column = @Column(name = "minimumceilingnilreason"))})
    ...
    public void setMinimumCeilingItem(ValDistanceVerticalType target) {
        setMinimumCeiling(XmlAdapterUtils.marshallJAXBElement(ValDistanceVerticalType.class,
                new QName("http://www.aixm.aero/schema/5.2", "minimumCeiling"), NavigationAreaTimeSliceType.class,
                target));
    }

    @Embedded
    @AttributeOverrides({
            @AttributeOverride(name = "value", column = @Column(name = "minimumvisibility", columnDefinition = "NUMERIC")),
            @AttributeOverride(name = "uom", column = @Column(name = "minimumvisibilityuom")),
            @AttributeOverride(name = "accuracy", column = @Column(name = "minimumvisibilityaccuracy")),
            @AttributeOverride(name = "nilReason", column = @Column(name = "minimumvisibilitynilreason"))})
    ...
    public void setMinimumVisibilityItem(ValDistanceType target) {
        setMinimumVisibility(XmlAdapterUtils.marshallJAXBElement(ValDistanceType.class,
                new QName("http://www.aixm.aero/schema/5.2", "minimumVisibility"), NavigationAreaTimeSliceType.class,
                target));
    }
    ...
    public void setDepartureItem(StandardInstrumentDeparturePropertyType target) {
        setDeparture(XmlAdapterUtils.marshallJAXBElement(StandardInstrumentDeparturePropertyType.class,
                new QName("http://www.aixm.aero/schema/5.2", "departure"), NavigationAreaTimeSliceType.class, target));
    }
    ...
    public void setCentrePointFixDesignatedPointItem(DesignatedPointPropertyType target) {
        setCentrePointFixDesignatedPoint(XmlAdapterUtils.marshallJAXBElement(DesignatedPointPropertyType.class,
                ...
                NavigationAreaTimeSliceType.class, target));
    }
    ...
    public void setCentrePointPositionItem(AIXMPointPropertyType target) {
        setCentrePointPosition(XmlAdapterUtils.marshallJAXBElement(AIXMPointPropertyType.class,
                new QName("http://www.aixm.aero/schema/5.2", "centrePoint_position"), NavigationAreaTimeSliceType.class,
                target));
    }
