...
public class MarkingElementType extends AbstractAIXMObjectType implements Serializable {
    ...
    @XmlElementRef(name = "style", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "extent_location", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
