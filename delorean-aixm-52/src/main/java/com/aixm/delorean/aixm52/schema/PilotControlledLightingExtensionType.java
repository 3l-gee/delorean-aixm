...
@Entity(name = "PilotControlledLightingExtensionType")
@Table(name = "pilotcontrolledlightinge", schema = "service")
public class PilotControlledLightingExtensionType implements Serializable, Equals, HashCode, ToString {
