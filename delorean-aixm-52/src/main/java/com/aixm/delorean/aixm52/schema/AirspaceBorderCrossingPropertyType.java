...
/**
 * <p>
 * Java class for AirspaceBorderCrossingPropertyType complex type
 * </p>
 * .
 *
 * <p>
 ...
 *       <sequence>
 *         <element ref=
"{http://www.aixm.aero/schema/5.2}AirspaceBorderCrossing"/>
 *       </sequence>
 *     </extension>
 *   </complexContent>
 * </complexType>
...
@XmlType(name = "AirspaceBorderCrossingPropertyType", propOrder = {"airspaceBorderCrossing"})
@Entity(name = "AirspaceBorderCrossingPropertyType")
@Table(name = "airspacebordercrossingpropertytype", schema = "route")
public class AirspaceBorderCrossingPropertyType extends AbstractAIXMPropertyType implements Serializable {
     ...
     *
     * @return possible object is {@link AirspaceBorderCrossingType }
     *
     */
    @OneToOne(targetEntity = AirspaceBorderCrossingType.class, cascade = {CascadeType.ALL}, fetch = FetchType.EAGER)
     ...
     *
     * @param value
     *            allowed object is {@link AirspaceBorderCrossingType }
     *
     */
