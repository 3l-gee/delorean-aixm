 ...
 *                 <choice>
 *                   <element ref=
"{http://www.aixm.aero/schema/5.2}AbstractAngleUseExtension"/>
 *                 </choice>
 *                 <attGroup ref=
...
@XmlType(name = "AngleUseType", propOrder = {"alongCourseGuidance", "annotation", "theAngle", "extension"})
...
public class AngleUseType extends AbstractAIXMObjectType implements Serializable {
    ...
    public void setAlongCourseGuidanceItem(CodeYesNoType target) {
        setAlongCourseGuidance(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class,
                new QName("http://www.aixm.aero/schema/5.2", "alongCourseGuidance"), AngleUseType.class, target));
    }

    @OneToOne(targetEntity = AnglePropertyType.class, cascade = {CascadeType.ALL}, fetch = FetchType.EAGER)
    @JoinTable(name = "anglustp_thangl_link", schema = "navaids_point", joinColumns = {
            @JoinColumn(name = "angleuse_o_hjid", referencedColumnName = "hjid")}, inverseJoinColumns = {
    ...
    public void setTheAngleItem(AnglePropertyType target) {
        setTheAngle(XmlAdapterUtils.marshallJAXBElement(AnglePropertyType.class,
                new QName("http://www.aixm.aero/schema/5.2", "theAngle"), AngleUseType.class, target));
    }
