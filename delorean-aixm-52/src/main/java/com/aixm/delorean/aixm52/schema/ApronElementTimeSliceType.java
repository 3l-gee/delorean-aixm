...
/**
 * <p>
 * Java class for ApronElementTimeSliceType complex type
 * </p>
 * .
 *
 * <p>
...
"{http://www.aixm.aero/schema/5.2}CodeApronElementType" minOccurs="0"/>
 *         <element name="jetwayAvailability" type=
"{http://www.aixm.aero/schema/5.2}CodeYesNoType" minOccurs="0"/>
 *         <element name="towingAvailability" type=
"{http://www.aixm.aero/schema/5.2}CodeYesNoType" minOccurs="0"/>
 *         <element name="dockingAvailability" type=
"{http://www.aixm.aero/schema/5.2}CodeYesNoType" minOccurs="0"/>
 *         <element name="groundPowerAvailability" type=
"{http://www.aixm.aero/schema/5.2}CodeYesNoType" minOccurs="0"/>
 ...
 *         <element name="supplyService" type=
"{http://www.aixm.aero/schema/5.2}AirportSuppliesServicePropertyType" maxOccurs=
"unbounded" minOccurs="0"/>
 *         <element name="annotation" type=
"{http://www.aixm.aero/schema/5.2}NotePropertyType" maxOccurs=
"unbounded" minOccurs="0"/>
 *         <element name="availability" type=
"{http://www.aixm.aero/schema/5.2}ApronAreaAvailabilityPropertyType" maxOccurs=
"unbounded" minOccurs="0"/>
 ...
 *                 <sequence>
 *                   <element ref=
"{http://www.aixm.aero/schema/5.2}AbstractApronElementExtension"/>
 *                 </sequence>
 *                 <attGroup ref=
...
@XmlType(name = "ApronElementTimeSliceType", propOrder = {"type", "jetwayAvailability", "towingAvailability",
        "dockingAvailability", "groundPowerAvailability", "length", "width", "associatedApron", "surfaceProperties",
        "extent", "supplyService", "annotation", "availability", "extension"})
@Entity(name = "ApronElementTimeSliceType")
@Table(name = "apronelement_t", schema = "airport_heliport")
public class ApronElementTimeSliceType extends AbstractAIXMTimeSliceType implements Serializable {
     ...
     *         }{@code <}{@link CodeApronElementType }{@code >}
     *
     */
    @Transient
     ...
     * for the supplyService property.
     *
     * <p>
    ...
    @JoinTable(name = "aprnelmnttmslctp_spplsrvc_link", schema = "airport_heliport", joinColumns = {
            @JoinColumn(name = "apronelement_t_hjid", referencedColumnName = "hjid")}, inverseJoinColumns = {
    ...
    public void setTypeItem(CodeApronElementType target) {
        setType(XmlAdapterUtils.marshallJAXBElement(CodeApronElementType.class,
                new QName("http://www.aixm.aero/schema/5.2", "type"), ApronElementTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({@AttributeOverride(name = "value", column = @Column(name = "jetwayavailability")),
            @AttributeOverride(name = "nilReason", column = @Column(name = "jetwayavailabilitynilreason"))})
    ...
    public void setJetwayAvailabilityItem(CodeYesNoType target) {
        setJetwayAvailability(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class,
                new QName("http://www.aixm.aero/schema/5.2", "jetwayAvailability"), ApronElementTimeSliceType.class,
                target));
    }

    @Embedded
    @AttributeOverrides({@AttributeOverride(name = "value", column = @Column(name = "towingavailability")),
            @AttributeOverride(name = "nilReason", column = @Column(name = "towingavailabilitynilreason"))})
    ...
    public void setTowingAvailabilityItem(CodeYesNoType target) {
        setTowingAvailability(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class,
                new QName("http://www.aixm.aero/schema/5.2", "towingAvailability"), ApronElementTimeSliceType.class,
                target));
    }

    @Embedded
    @AttributeOverrides({@AttributeOverride(name = "value", column = @Column(name = "dockingavailability")),
            @AttributeOverride(name = "nilReason", column = @Column(name = "dockingavailabilitynilreason"))})
    ...
    public void setDockingAvailabilityItem(CodeYesNoType target) {
        setDockingAvailability(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class,
                new QName("http://www.aixm.aero/schema/5.2", "dockingAvailability"), ApronElementTimeSliceType.class,
                target));
    }

    @Embedded
    @AttributeOverrides({@AttributeOverride(name = "value", column = @Column(name = "groundpoweravailability")),
            @AttributeOverride(name = "nilReason", column = @Column(name = "groundpoweravailabilitynilreason"))})
    ...
    public void setGroundPowerAvailabilityItem(CodeYesNoType target) {
        setGroundPowerAvailability(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class,
                new QName("http://www.aixm.aero/schema/5.2", "groundPowerAvailability"),
                ApronElementTimeSliceType.class, target));
    }
    ...
    public void setLengthItem(ValDistanceType target) {
        setLength(XmlAdapterUtils.marshallJAXBElement(ValDistanceType.class,
                new QName("http://www.aixm.aero/schema/5.2", "length"), ApronElementTimeSliceType.class, target));
    }
    ...
    public void setWidthItem(ValDistanceType target) {
        setWidth(XmlAdapterUtils.marshallJAXBElement(ValDistanceType.class,
                new QName("http://www.aixm.aero/schema/5.2", "width"), ApronElementTimeSliceType.class, target));
    }
    ...
    public void setAssociatedApronItem(ApronPropertyType target) {
        setAssociatedApron(XmlAdapterUtils.marshallJAXBElement(ApronPropertyType.class,
                new QName("http://www.aixm.aero/schema/5.2", "associatedApron"), ApronElementTimeSliceType.class,
                target));
    }
    ...
    public void setSurfacePropertiesItem(SurfaceCharacteristicsPropertyType target) {
        setSurfaceProperties(XmlAdapterUtils.marshallJAXBElement(SurfaceCharacteristicsPropertyType.class,
                new QName("http://www.aixm.aero/schema/5.2", "surfaceProperties"), ApronElementTimeSliceType.class,
                target));
    }
    ...
    public void setExtentItem(AIXMElevatedSurfacePropertyType target) {
        setExtent(XmlAdapterUtils.marshallJAXBElement(AIXMElevatedSurfacePropertyType.class,
                new QName("http://www.aixm.aero/schema/5.2", "extent"), ApronElementTimeSliceType.class, target));
    }
