...
@XmlSeeAlso({AzimuthType.class, DirectionFinderType.class, DMEType.class, ElevationType.class, GlidepathType.class,
        LocalizerType.class, MarkerBeaconType.class, NDBType.class, SDFType.class, TACANType.class, VORType.class})
