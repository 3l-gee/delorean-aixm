...
@Entity(name = "AirspaceLayerTypeExtensionType")
@Table(name = "airspacelayere", schema = "shared")
public class AirspaceLayerTypeExtensionType implements Serializable, Equals, HashCode, ToString {
