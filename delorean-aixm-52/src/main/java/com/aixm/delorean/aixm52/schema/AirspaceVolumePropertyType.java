...
/**
 * <p>
 * Java class for AirspaceVolumePropertyType complex type
 * </p>
 * .
 *
 * <p>
 ...
 *       <sequence>
 *         <element ref="{http://www.aixm.aero/schema/5.2}AirspaceVolume"/>
 *       </sequence>
 *     </extension>
 *   </complexContent>
 * </complexType>
...
@XmlType(name = "AirspaceVolumePropertyType", propOrder = {"airspaceVolume"})
@Entity(name = "AirspaceVolumePropertyType")
@Table(name = "airspacevolumepropertytype", schema = "airspace")
public class AirspaceVolumePropertyType extends AbstractAIXMPropertyType implements Serializable {
     ...
     *
     * @return possible object is {@link AirspaceVolumeType }
     *
     */
    @OneToOne(targetEntity = AirspaceVolumeType.class, cascade = {CascadeType.ALL}, fetch = FetchType.EAGER)
     ...
     *
     * @param value
     *            allowed object is {@link AirspaceVolumeType }
     *
     */
