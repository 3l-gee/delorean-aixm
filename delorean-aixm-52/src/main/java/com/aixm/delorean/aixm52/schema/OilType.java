...
"{http://www.aixm.aero/schema/5.2}CodeOilType" minOccurs="0"/>
 ...
 *                 <choice>
 *                   <element ref=
"{http://www.aixm.aero/schema/5.2}AbstractOilExtension"/>
 *                 </choice>
 *                 <attGroup ref=
...
public class OilType extends AbstractAIXMObjectType implements Serializable {
    ...
    public void setCategoryItem(CodeOilType target) {
        setCategory(XmlAdapterUtils.marshallJAXBElement(CodeOilType.class,
                new QName("http://www.aixm.aero/schema/5.2", "category"), OilType.class, target));
    }
