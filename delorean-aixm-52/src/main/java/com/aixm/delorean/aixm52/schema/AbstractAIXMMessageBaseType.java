...
/**
 * <p>
 * Java class for AbstractAIXMMessageBaseType complex type
 * </p>
 * .
 *
 * <p>
 ...
 *         <element name="messageMetadata" type=
"{http://www.aixm.aero/schema/5.2}MessageMetadataPropertyType" minOccurs="0"/>
 *       </sequence>
 *     </extension>
 *   </complexContent>
 * </complexType>
...
@XmlType(name = "AbstractAIXMMessageBaseType", propOrder = {"sequenceNumber", "messageMetadata"})
@XmlSeeAlso({AbstractAIXMMessageType.class})
@MappedSuperclass
public abstract class AbstractAIXMMessageBaseType extends AbstractAIXMFeatureBaseType implements Serializable {
     ...
     *
     * @return possible object is {@link MessageMetadataPropertyType }
     *
     */
    @OneToOne(targetEntity = MessageMetadataPropertyType.class, cascade = {CascadeType.ALL}, fetch = FetchType.EAGER)
     ...
     *
     * @param value
     *            allowed object is {@link MessageMetadataPropertyType }
     *
     */
