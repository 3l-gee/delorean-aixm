...
"{http://www.aixm.aero/schema/5.2}RunwayDirectionTimeSlicePropertyType" maxOccurs
="unbounded"/>
 *       </sequence>
 *     </extension>
 *   </complexContent>
...
@Table(name = "runwaydirection_f", schema = "airport_heliport")
public class RunwayDirectionType extends AbstractAIXMFeatureType implements Serializable {
    ...
    @OneToMany(targetEntity = RunwayDirectionTimeSlicePropertyType.class, cascade = {
