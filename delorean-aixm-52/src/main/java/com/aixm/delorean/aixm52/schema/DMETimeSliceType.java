...
"{http://www.aixm.aero/schema/5.2}CodeDMEType" minOccurs="0"/>
 *         <element name="channel" type=
"{http://www.aixm.aero/schema/5.2}CodeDMEChannelType" minOccurs="0"/>
 *         <element name="displace" type=
"{http://www.aixm.aero/schema/5.2}ValDistanceType" minOccurs="0"/>
 *         <element name="tuningFrequencyVHF" type=
 ...
 *                 <choice>
 *                   <element ref=
"{http://www.aixm.aero/schema/5.2}AbstractDMEExtension"/>
 *                   <element ref=
...
@XmlType(name = "DMETimeSliceType", propOrder = {"designator", "aixmName", "emissionClass", "mobile",
        ...
        "availability", "annotation", "type", "channel", "displace", "tuningFrequencyVHF", "extension"})
...
public class DMETimeSliceType extends AbstractAIXMTimeSliceType implements Serializable {
    ...
    public void setDesignatorItem(CodeNavaidDesignatorType target) {
        setDesignator(XmlAdapterUtils.marshallJAXBElement(CodeNavaidDesignatorType.class,
                new QName("http://www.aixm.aero/schema/5.2", "designator"), DMETimeSliceType.class, target));
    }
    ...
    public void setAixmNameItem(TextNameType target) {
        setAixmName(XmlAdapterUtils.marshallJAXBElement(TextNameType.class,
                new QName("http://www.aixm.aero/schema/5.2", "name"), DMETimeSliceType.class, target));
    }
    ...
    public void setEmissionClassItem(CodeRadioEmissionType target) {
        setEmissionClass(XmlAdapterUtils.marshallJAXBElement(CodeRadioEmissionType.class,
                new QName("http://www.aixm.aero/schema/5.2", "emissionClass"), DMETimeSliceType.class, target));
    }
    ...
    public void setMobileItem(CodeYesNoType target) {
        setMobile(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class,
                new QName("http://www.aixm.aero/schema/5.2", "mobile"), DMETimeSliceType.class, target));
    }
    ...
    public void setMagneticVariationItem(ValMagneticVariationType target) {
        setMagneticVariation(XmlAdapterUtils.marshallJAXBElement(ValMagneticVariationType.class,
                new QName("http://www.aixm.aero/schema/5.2", "magneticVariation"), DMETimeSliceType.class, target));
    }
    ...
    public void setDateMagneticVariationItem(DateYearType target) {
        setDateMagneticVariation(XmlAdapterUtils.marshallJAXBElement(DateYearType.class,
                new QName("http://www.aixm.aero/schema/5.2", "dateMagneticVariation"), DMETimeSliceType.class, target));
    }
    ...
    public void setFlightCheckedItem(CodeYesNoType target) {
        setFlightChecked(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class,
                new QName("http://www.aixm.aero/schema/5.2", "flightChecked"), DMETimeSliceType.class, target));
    }
    ...
    public void setLocationItem(AIXMElevatedPointPropertyType target) {
        setLocation(XmlAdapterUtils.marshallJAXBElement(AIXMElevatedPointPropertyType.class,
                new QName("http://www.aixm.aero/schema/5.2", "location"), DMETimeSliceType.class, target));
    }
    ...
    public void setTypeItem(CodeDMEType target) {
        setType(XmlAdapterUtils.marshallJAXBElement(CodeDMEType.class,
                new QName("http://www.aixm.aero/schema/5.2", "type"), DMETimeSliceType.class, target));
    }
    ...
    public void setChannelItem(CodeDMEChannelType target) {
        setChannel(XmlAdapterUtils.marshallJAXBElement(CodeDMEChannelType.class,
                new QName("http://www.aixm.aero/schema/5.2", "channel"), DMETimeSliceType.class, target));
    }
    ...
    @AttributeOverrides({
            ...
            @AttributeOverride(name = "accuracy", column = @Column(name = "displaceaccuracy")),
    ...
    public void setDisplaceItem(ValDistanceType target) {
        setDisplace(XmlAdapterUtils.marshallJAXBElement(ValDistanceType.class,
                new QName("http://www.aixm.aero/schema/5.2", "displace"), DMETimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
            @AttributeOverride(name = "value", column = @Column(name = "tuningfrequencyvhf", columnDefinition = "NUMERIC")),
            @AttributeOverride(name = "uom", column = @Column(name = "tuningfrequencyvhfuom")),
            @AttributeOverride(name = "nilReason", column = @Column(name = "tuningfrequencyvhfnilreason"))})
    ...
    public void setTuningFrequencyVHFItem(ValFrequencyType target) {
        setTuningFrequencyVHF(XmlAdapterUtils.marshallJAXBElement(ValFrequencyType.class,
                new QName("http://www.aixm.aero/schema/5.2", "tuningFrequencyVHF"), DMETimeSliceType.class, target));
    }
