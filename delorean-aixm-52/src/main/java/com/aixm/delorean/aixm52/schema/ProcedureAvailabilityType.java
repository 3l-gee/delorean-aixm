...
"{http://www.aixm.aero/schema/5.2}CodeProcedureAvailabilityType" minOccurs="0"/>
...
public class ProcedureAvailabilityType extends AbstractPropertiesWithScheduleType implements Serializable {
    ...
    public void setStatusItem(CodeProcedureAvailabilityType target) {
        setStatus(XmlAdapterUtils.marshallJAXBElement(CodeProcedureAvailabilityType.class,
                new QName("http://www.aixm.aero/schema/5.2", "status"), ProcedureAvailabilityType.class, target));
    }
