...
public class RunwayElementTimeSliceType extends AbstractAIXMTimeSliceType implements Serializable {
     ...
     *
     */
    @OneToMany(targetEntity = RunwayElementExtensionType.class, cascade = {CascadeType.ALL}, fetch = FetchType.EAGER)
    @JoinColumn(name = "runwayelemente_hjid", referencedColumnName = "hjid")
