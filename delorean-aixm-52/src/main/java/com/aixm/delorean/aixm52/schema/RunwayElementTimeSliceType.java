...
/**
 * <p>
 * Java class for RunwayElementTimeSliceType complex type
 * </p>
 * .
 *
 * <p>
...
"{http://www.aixm.aero/schema/5.2}CodeRunwayElementType" minOccurs="0"/>
...
"0"/>
 *         <element name="associatedRunway" type=
 ...
 *                 <sequence>
 *                   <element ref=
"{http://www.aixm.aero/schema/5.2}AbstractRunwayElementExtension"/>
 *                 </sequence>
 *                 <attGroup ref=
...
@XmlType(name = "RunwayElementTimeSliceType", propOrder = {"type", "length", "width", "gradeSeparation",
        "surfaceProperties", "associatedRunway", "extent", "annotation", "availability", "extension"})
@Entity(name = "RunwayElementTimeSliceType")
@Table(name = "runwayelement_t", schema = "airport_heliport")
public class RunwayElementTimeSliceType extends AbstractAIXMTimeSliceType implements Serializable {
     ...
     *         }{@code <}{@link CodeRunwayElementType }{@code >}
     *
     */
    @Transient
     ...
     * for the associatedRunway property.
     *
     * <p>
    ...
    @JoinTable(name = "rnwelmnttmslctp_assctdrnw_link", schema = "airport_heliport", joinColumns = {
            @JoinColumn(name = "runwayelement_t_hjid", referencedColumnName = "hjid")}, inverseJoinColumns = {
    ...
    public void setTypeItem(CodeRunwayElementType target) {
        setType(XmlAdapterUtils.marshallJAXBElement(CodeRunwayElementType.class,
                new QName("http://www.aixm.aero/schema/5.2", "type"), RunwayElementTimeSliceType.class, target));
    }
    ...
    public void setLengthItem(ValDistanceType target) {
        setLength(XmlAdapterUtils.marshallJAXBElement(ValDistanceType.class,
                new QName("http://www.aixm.aero/schema/5.2", "length"), RunwayElementTimeSliceType.class, target));
    }
    ...
    public void setWidthItem(ValDistanceType target) {
        setWidth(XmlAdapterUtils.marshallJAXBElement(ValDistanceType.class,
                new QName("http://www.aixm.aero/schema/5.2", "width"), RunwayElementTimeSliceType.class, target));
    }
    ...
    public void setGradeSeparationItem(CodeGradeSeparationType target) {
        setGradeSeparation(XmlAdapterUtils.marshallJAXBElement(CodeGradeSeparationType.class,
                new QName("http://www.aixm.aero/schema/5.2", "gradeSeparation"), RunwayElementTimeSliceType.class,
                target));
    }
    ...
    public void setSurfacePropertiesItem(SurfaceCharacteristicsPropertyType target) {
        setSurfaceProperties(XmlAdapterUtils.marshallJAXBElement(SurfaceCharacteristicsPropertyType.class,
                new QName("http://www.aixm.aero/schema/5.2", "surfaceProperties"), RunwayElementTimeSliceType.class,
                target));
    }
    ...
    public void setExtentItem(AIXMElevatedSurfacePropertyType target) {
        setExtent(XmlAdapterUtils.marshallJAXBElement(AIXMElevatedSurfacePropertyType.class,
                new QName("http://www.aixm.aero/schema/5.2", "extent"), RunwayElementTimeSliceType.class, target));
    }
