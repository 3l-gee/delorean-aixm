...
"{http://www.aixm.aero/schema/5.2}CodeRunwayType" minOccurs="0"/>
...
"{http://www.aixm.aero/schema/5.2}RunwayContaminationPropertyType" maxOccurs=
"unbounded" minOccurs="0"/>
 *         <element name="annotation" type=
"{http://www.aixm.aero/schema/5.2}NotePropertyType" maxOccurs=
"unbounded" minOccurs="0"/>
 *         <element name="areaContaminant" type=
"{http://www.aixm.aero/schema/5.2}RunwaySectionContaminationPropertyType" maxOccurs
="unbounded" minOccurs="0"/>
 *         <element name="referenceCodeFieldLength" type=
"{http://www.aixm.aero/schema/5.2}CodeAircraftFieldLengthType" minOccurs="0"/>
 *         <element name="referenceCodeWingspan" type=
 ...
 *                 <sequence>
 *                   <element ref=
"{http://www.aixm.aero/schema/5.2}AbstractRunwayExtension"/>
 *                 </sequence>
 *                 <attGroup ref=
...
@XmlType(name = "RunwayTimeSliceType", propOrder = {"designator", "type", "nominalLength", "nominalWidth",
        "widthShoulder", "lengthStrip", "widthStrip", "lengthOffset", "widthOffset", "abandoned", "surfaceProperties",
        "associatedAirportHeliport", "overallContaminant", "annotation", "areaContaminant", "referenceCodeFieldLength",
        "referenceCodeWingspan", "depth", "extension"})
...
public class RunwayTimeSliceType extends AbstractAIXMTimeSliceType implements Serializable {
     ...
     *
     * @return possible object is {@link JAXBElement
     *         }{@code <}{@link CodeAircraftFieldLengthType }{@code >}
     *
     */
    @Transient
     ...
     *
     */
    @OneToMany(targetEntity = RunwayExtensionType.class, cascade = {CascadeType.ALL}, fetch = FetchType.EAGER)
    @JoinColumn(name = "runwaye_hjid", referencedColumnName = "hjid")
    ...
    public void setDesignatorItem(TextDesignatorType target) {
        setDesignator(XmlAdapterUtils.marshallJAXBElement(TextDesignatorType.class,
                new QName("http://www.aixm.aero/schema/5.2", "designator"), RunwayTimeSliceType.class, target));
    }
    ...
    public void setTypeItem(CodeRunwayType target) {
        setType(XmlAdapterUtils.marshallJAXBElement(CodeRunwayType.class,
                new QName("http://www.aixm.aero/schema/5.2", "type"), RunwayTimeSliceType.class, target));
    }
    ...
    @AttributeOverrides({
            ...
            @AttributeOverride(name = "accuracy", column = @Column(name = "nominallengthaccuracy")),
    ...
    public void setNominalLengthItem(ValDistanceType target) {
        setNominalLength(XmlAdapterUtils.marshallJAXBElement(ValDistanceType.class,
                new QName("http://www.aixm.aero/schema/5.2", "nominalLength"), RunwayTimeSliceType.class, target));
    }
    ...
    @AttributeOverrides({
            ...
            @AttributeOverride(name = "accuracy", column = @Column(name = "nominalwidthaccuracy")),
    ...
    public void setNominalWidthItem(ValDistanceType target) {
        setNominalWidth(XmlAdapterUtils.marshallJAXBElement(ValDistanceType.class,
                new QName("http://www.aixm.aero/schema/5.2", "nominalWidth"), RunwayTimeSliceType.class, target));
    }
    ...
    public void setWidthShoulderItem(ValDistanceType target) {
        setWidthShoulder(XmlAdapterUtils.marshallJAXBElement(ValDistanceType.class,
                new QName("http://www.aixm.aero/schema/5.2", "widthShoulder"), RunwayTimeSliceType.class, target));
    }
    ...
    @AttributeOverrides({
            ...
            @AttributeOverride(name = "accuracy", column = @Column(name = "lengthstripaccuracy")),
    ...
    public void setLengthStripItem(ValDistanceType target) {
        setLengthStrip(XmlAdapterUtils.marshallJAXBElement(ValDistanceType.class,
                new QName("http://www.aixm.aero/schema/5.2", "lengthStrip"), RunwayTimeSliceType.class, target));
    }
    ...
    @AttributeOverrides({
            ...
            @AttributeOverride(name = "accuracy", column = @Column(name = "widthstripaccuracy")),
    ...
    public void setWidthStripItem(ValDistanceType target) {
        setWidthStrip(XmlAdapterUtils.marshallJAXBElement(ValDistanceType.class,
                new QName("http://www.aixm.aero/schema/5.2", "widthStrip"), RunwayTimeSliceType.class, target));
    }
    ...
    @AttributeOverrides({
            ...
            @AttributeOverride(name = "accuracy", column = @Column(name = "lengthoffsetaccuracy")),
    ...
    public void setLengthOffsetItem(ValDistanceSignedType target) {
        setLengthOffset(XmlAdapterUtils.marshallJAXBElement(ValDistanceSignedType.class,
                new QName("http://www.aixm.aero/schema/5.2", "lengthOffset"), RunwayTimeSliceType.class, target));
    }
    ...
    @AttributeOverrides({
            ...
            @AttributeOverride(name = "accuracy", column = @Column(name = "widthoffsetaccuracy")),
    ...
    public void setWidthOffsetItem(ValDistanceSignedType target) {
        setWidthOffset(XmlAdapterUtils.marshallJAXBElement(ValDistanceSignedType.class,
                new QName("http://www.aixm.aero/schema/5.2", "widthOffset"), RunwayTimeSliceType.class, target));
    }
    ...
    public void setAbandonedItem(CodeYesNoType target) {
        setAbandoned(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class,
                new QName("http://www.aixm.aero/schema/5.2", "abandoned"), RunwayTimeSliceType.class, target));
    }
    ...
    public void setSurfacePropertiesItem(SurfaceCharacteristicsPropertyType target) {
        setSurfaceProperties(XmlAdapterUtils.marshallJAXBElement(SurfaceCharacteristicsPropertyType.class,
                new QName("http://www.aixm.aero/schema/5.2", "surfaceProperties"), RunwayTimeSliceType.class, target));
    }
    ...
    public void setAssociatedAirportHeliportItem(AirportHeliportPropertyType target) {
        setAssociatedAirportHeliport(XmlAdapterUtils.marshallJAXBElement(AirportHeliportPropertyType.class,
                new QName("http://www.aixm.aero/schema/5.2", "associatedAirportHeliport"), RunwayTimeSliceType.class,
                target));
    }

    @Embedded
    @AttributeOverrides({@AttributeOverride(name = "value", column = @Column(name = "referencecodefieldlength")),
            @AttributeOverride(name = "nilReason", column = @Column(name = "referencecodefieldlengthnilreason"))})
    ...
    public void setReferenceCodeFieldLengthItem(CodeAircraftFieldLengthType target) {
        setReferenceCodeFieldLength(XmlAdapterUtils.marshallJAXBElement(CodeAircraftFieldLengthType.class,
                new QName("http://www.aixm.aero/schema/5.2", "referenceCodeFieldLength"), RunwayTimeSliceType.class,
                target));
    }

    @Embedded
    @AttributeOverrides({@AttributeOverride(name = "value", column = @Column(name = "referencecodewingspan")),
            @AttributeOverride(name = "nilReason", column = @Column(name = "referencecodewingspannilreason"))})
    ...
    public void setReferenceCodeWingspanItem(CodeAircraftWingspanClassType target) {
        setReferenceCodeWingspan(XmlAdapterUtils.marshallJAXBElement(CodeAircraftWingspanClassType.class,
                new QName("http://www.aixm.aero/schema/5.2", "referenceCodeWingspan"), RunwayTimeSliceType.class,
                target));
    }
    ...
    public void setDepthItem(ValDistanceType target) {
        setDepth(XmlAdapterUtils.marshallJAXBElement(ValDistanceType.class,
                new QName("http://www.aixm.aero/schema/5.2", "depth"), RunwayTimeSliceType.class, target));
    }
