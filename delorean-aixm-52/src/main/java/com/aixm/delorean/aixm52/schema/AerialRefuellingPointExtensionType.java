...
@Entity(name = "AerialRefuellingPointExtensionType")
@Table(name = "aerialrefuellingpoint_oe", schema = "aerial_refuelling")
public class AerialRefuellingPointExtensionType implements Serializable, Equals, HashCode, ToString {
