...
"{http://www.aixm.aero/schema/5.2}VisualGlideSlopeIndicatorTimeSlicePropertyType" maxOccurs
="unbounded"/>
 *       </sequence>
 *     </extension>
 *   </complexContent>
...
@Table(name = "visualglideslopeindicator_f", schema = "airport_heliport")
public class VisualGlideSlopeIndicatorType extends AbstractGroundLightSystemType implements Serializable {
    ...
    @OneToMany(targetEntity = VisualGlideSlopeIndicatorTimeSlicePropertyType.class, cascade = {
