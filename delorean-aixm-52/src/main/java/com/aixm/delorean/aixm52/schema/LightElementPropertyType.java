...
/**
 * <p>
 * Java class for LightElementPropertyType complex type
 * </p>
 * .
 *
 * <p>
 ...
 *       <sequence>
 *         <element ref="{http://www.aixm.aero/schema/5.2}LightElement"/>
 *       </sequence>
 *     </extension>
 *   </complexContent>
 * </complexType>
...
@XmlType(name = "LightElementPropertyType", propOrder = {"lightElement"})
@Entity(name = "LightElementPropertyType")
@Table(name = "lightelementpropertytype", schema = "shared")
public class LightElementPropertyType extends AbstractAIXMPropertyType implements Serializable {
     ...
     *
     * @return possible object is {@link LightElementType }
     *
     */
    @OneToOne(targetEntity = LightElementType.class, cascade = {CascadeType.ALL}, fetch = FetchType.EAGER)
    @JoinColumn(name = "lightelement_hjid", referencedColumnName = "hjid")
     ...
     *
     * @param value
     *            allowed object is {@link LightElementType }
     *
     */
