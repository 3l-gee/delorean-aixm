...
/**
 * <p>
 * Java class for OxygenPropertyType complex type
 * </p>
 * .
 *
 * <p>
 ...
 *       <sequence>
 *         <element ref="{http://www.aixm.aero/schema/5.2}Oxygen"/>
 *       </sequence>
 *     </extension>
 *   </complexContent>
 * </complexType>
...
@XmlType(name = "OxygenPropertyType", propOrder = {"oxygen"})
@Entity(name = "OxygenPropertyType")
@Table(name = "oxygenpropertytype", schema = "service")
public class OxygenPropertyType extends AbstractAIXMPropertyType implements Serializable {
     ...
     *
     * @return possible object is {@link OxygenType }
     *
     */
    @OneToOne(targetEntity = OxygenType.class, cascade = {CascadeType.ALL}, fetch = FetchType.EAGER)
     ...
     *
     * @param value
     *            allowed object is {@link OxygenType }
     *
     */
