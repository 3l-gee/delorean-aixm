...
"{http://www.aixm.aero/schema/5.2}CodeLightHoldingPositionType" minOccurs="0"/>
 ...
 *                 <choice>
 *                   <element ref=
"{http://www.aixm.aero/schema/5.2}AbstractTaxiHoldingPositionLightSystemExtension"/>
 *                   <element ref=
...
public class TaxiHoldingPositionLightSystemTimeSliceType extends AbstractAIXMTimeSliceType implements Serializable {
    ...
    public void setColourItem(CodeColourType target) {
        setColour(XmlAdapterUtils.marshallJAXBElement(CodeColourType.class,
                new QName("http://www.aixm.aero/schema/5.2", "colour"),
                TaxiHoldingPositionLightSystemTimeSliceType.class, target));
    }
    ...
    public void setTypeItem(CodeLightHoldingPositionType target) {
        setType(XmlAdapterUtils.marshallJAXBElement(CodeLightHoldingPositionType.class,
                new QName("http://www.aixm.aero/schema/5.2", "type"), TaxiHoldingPositionLightSystemTimeSliceType.class,
                target));
    }
    ...
    public void setTaxiHoldingItem(TaxiHoldingPositionPropertyType target) {
        setTaxiHolding(XmlAdapterUtils.marshallJAXBElement(TaxiHoldingPositionPropertyType.class,
                new QName("http://www.aixm.aero/schema/5.2", "taxiHolding"),
                TaxiHoldingPositionLightSystemTimeSliceType.class, target));
    }
