 ...
 *         <element name="sequence" type="{http://www.aixm.aero/schema/5.2}NoSequenceType" minOccurs="0"/>
 *         <element name="usageType" type="{http://www.aixm.aero/schema/5.2}CodeAerialRefuellingPointType" minOccurs="0"/>
 ...
 *                   <element ref="{http://www.aixm.aero/schema/5.2}AbstractAerialRefuellingPointExtension"/>
 *                 </choice>
...
@Table(name = "aerialrefuellingpoint_o", schema = "aerial_refuelling")
    ...
    implements Serializable
{
    ...
    @XmlElementRef(name = "sequence", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<NoSequenceType> sequence;
    @XmlElementRef(name = "usageType", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<CodeAerialRefuellingPointType> usageType;
    protected List<AerialRefuellingPointExtensionType> extension;
    ...
    @JoinTable(name = "arlrfllngpnttp_fcltmkp_link", schema = "aerial_refuelling", joinColumns = {
        @JoinColumn(name = "aerialrefuellingpoint_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "arlrfllngpnttp_annttn_link", schema = "aerial_refuelling", joinColumns = {
        @JoinColumn(name = "aerialrefuellingpoint_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link AerialRefuellingPointExtensionType }
     * 
     * 
     */
    @OneToMany(targetEntity = AerialRefuellingPointExtensionType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinColumn(name = "aerialrefuellingpoint_oe_hjid", referencedColumnName = "hjid")
    public List<AerialRefuellingPointExtensionType> getExtension() {
        if (extension == null) {
     ...
     * 
     */
    public void setExtension(List<AerialRefuellingPointExtensionType> extension) {
    ...
    public void setReportingATCItem(CodeATCReportingType target) {
        setReportingATC(XmlAdapterUtils.marshallJAXBElement(CodeATCReportingType.class, new QName("http://www.aixm.aero/schema/5.2", "reportingATC"), AerialRefuellingPointType.class, target));
    }
    ...
    public void setFlyOverItem(CodeYesNoType target) {
        setFlyOver(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.2", "flyOver"), AerialRefuellingPointType.class, target));
    }
    ...
    public void setWaypointItem(CodeYesNoType target) {
        setWaypoint(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.2", "waypoint"), AerialRefuellingPointType.class, target));
    }
    ...
    public void setRadarGuidanceItem(CodeYesNoType target) {
        setRadarGuidance(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.2", "radarGuidance"), AerialRefuellingPointType.class, target));
    }

    @OneToOne(targetEntity = DesignatedPointPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "arlrfllngpnttp_pntchcfxdsgntdpnt_link", schema = "aerial_refuelling", joinColumns = {
        @JoinColumn(name = "aerialrefuellingpoint_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setPointChoiceFixDesignatedPointItem(DesignatedPointPropertyType target) {
        setPointChoiceFixDesignatedPoint(XmlAdapterUtils.marshallJAXBElement(DesignatedPointPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "pointChoice_fixDesignatedPoint"), AerialRefuellingPointType.class, target));
    }

    @OneToOne(targetEntity = NavaidPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "arlrfllngpnttp_pntchcnvdsstm_link", schema = "aerial_refuelling", joinColumns = {
        @JoinColumn(name = "aerialrefuellingpoint_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setPointChoiceNavaidSystemItem(NavaidPropertyType target) {
        setPointChoiceNavaidSystem(XmlAdapterUtils.marshallJAXBElement(NavaidPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "pointChoice_navaidSystem"), AerialRefuellingPointType.class, target));
    }

    @OneToOne(targetEntity = AIXMPointPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "arlrfllngpnttp_pntchcpstn_link", schema = "aerial_refuelling", joinColumns = {
        @JoinColumn(name = "aerialrefuellingpoint_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setPointChoicePositionItem(AIXMPointPropertyType target) {
        setPointChoicePosition(XmlAdapterUtils.marshallJAXBElement(AIXMPointPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "pointChoice_position"), AerialRefuellingPointType.class, target));
    }

    @OneToOne(targetEntity = RunwayCentrelinePointPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "arlrfllngpnttp_pntchcrnwpnt_link", schema = "aerial_refuelling", joinColumns = {
        @JoinColumn(name = "aerialrefuellingpoint_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setPointChoiceRunwayPointItem(RunwayCentrelinePointPropertyType target) {
        setPointChoiceRunwayPoint(XmlAdapterUtils.marshallJAXBElement(RunwayCentrelinePointPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "pointChoice_runwayPoint"), AerialRefuellingPointType.class, target));
    }

    @OneToOne(targetEntity = TouchDownLiftOffPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "arlrfllngpnttp_pntchcamngpnt_link", schema = "aerial_refuelling", joinColumns = {
        @JoinColumn(name = "aerialrefuellingpoint_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setPointChoiceAimingPointItem(TouchDownLiftOffPropertyType target) {
        setPointChoiceAimingPoint(XmlAdapterUtils.marshallJAXBElement(TouchDownLiftOffPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "pointChoice_aimingPoint"), AerialRefuellingPointType.class, target));
    }

    @OneToOne(targetEntity = AirportHeliportPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "arlrfllngpnttp_pntchcarprtrfrncpnt_link", schema = "aerial_refuelling", joinColumns = {
        @JoinColumn(name = "aerialrefuellingpoint_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setPointChoiceAirportReferencePointItem(AirportHeliportPropertyType target) {
        setPointChoiceAirportReferencePoint(XmlAdapterUtils.marshallJAXBElement(AirportHeliportPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "pointChoice_airportReferencePoint"), AerialRefuellingPointType.class, target));
    }

    @OneToOne(targetEntity = RadioFrequencyAreaPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "arlrfllngpnttp_extnddsrvcvlm_link", schema = "aerial_refuelling", joinColumns = {
        @JoinColumn(name = "aerialrefuellingpoint_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setExtendedServiceVolumeItem(RadioFrequencyAreaPropertyType target) {
        setExtendedServiceVolume(XmlAdapterUtils.marshallJAXBElement(RadioFrequencyAreaPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "extendedServiceVolume"), AerialRefuellingPointType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "sequence", columnDefinition = "nosequencebase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "sequencenilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setSequenceItem(NoSequenceType target) {
        setSequence(XmlAdapterUtils.marshallJAXBElement(NoSequenceType.class, new QName("http://www.aixm.aero/schema/5.2", "sequence"), AerialRefuellingPointType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "usagetype", columnDefinition = "codeaerialrefuellingpointbase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "usagetypenilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setUsageTypeItem(CodeAerialRefuellingPointType target) {
        setUsageType(XmlAdapterUtils.marshallJAXBElement(CodeAerialRefuellingPointType.class, new QName("http://www.aixm.aero/schema/5.2", "usageType"), AerialRefuellingPointType.class, target));
    }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        }
        {
            ...
            List<AerialRefuellingPointExtensionType> lhsField;
            lhsField = (this.isSetExtension()?this.getExtension():null);
            List<AerialRefuellingPointExtensionType> rhsField;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        }
        {
            ...
            List<AerialRefuellingPointExtensionType> theField;
