...
/**
 * <p>
 * Java class for DesignStandardType complex type
 * </p>
 * .
 *
 * <p>
...
"{http://www.aixm.aero/schema/5.2}CodeDesignStandardType" minOccurs="0"/>
...
@XmlType(name = "DesignStandardType", propOrder = {"aixmName", "version", "annotation", "extension"})
@Entity(name = "DesignStandardType")
@Table(name = "designstandard_o", schema = "shared")
public class DesignStandardType extends AbstractAIXMObjectType implements Serializable {
    ...
    @JoinTable(name = "dsgnstndrdtp_annttn_link", schema = "shared", joinColumns = {
            @JoinColumn(name = "designstandard_o_hjid", referencedColumnName = "hjid")}, inverseJoinColumns = {
    ...
    public void setAixmNameItem(CodeDesignStandardType target) {
        setAixmName(XmlAdapterUtils.marshallJAXBElement(CodeDesignStandardType.class,
                new QName("http://www.aixm.aero/schema/5.2", "name"), DesignStandardType.class, target));
    }

    @Embedded
    @AttributeOverrides({
            @AttributeOverride(name = "value", column = @Column(name = "version", columnDefinition = "VARCHAR", length = 60)),
            @AttributeOverride(name = "nilReason", column = @Column(name = "versionnilreason"))})
    ...
    public void setVersionItem(TextNameType target) {
        setVersion(XmlAdapterUtils.marshallJAXBElement(TextNameType.class,
                new QName("http://www.aixm.aero/schema/5.2", "version"), DesignStandardType.class, target));
    }
