 ...
 *   <complexContent>
 *     <extension base="{http://www.aixm.aero/schema/5.2}AbstractDirectFlightType">
 *       <sequence>
 ...
 *                 <choice>
 *                   <element ref="{http://www.aixm.aero/schema/5.2}AbstractDirectFlightExtension"/>
 *                   <element ref="{http://www.aixm.aero/schema/5.2}AbstractDirectFlightSegmentExtension"/>
 *                 </choice>
    ...
    implements Serializable
{
    ...
    @JoinTable(name = "drctflghtsgmnttp_annttn_l", schema = "route", joinColumns = {
        @JoinColumn(name = "directflightsegment_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "drctflghtsgmnttp_endfxdsgntdpnt_l", schema = "route", joinColumns = {
        @JoinColumn(name = "directflightsegment_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setEndFixDesignatedPointItem(DesignatedPointPropertyType target) {
        setEndFixDesignatedPoint(XmlAdapterUtils.marshallJAXBElement(DesignatedPointPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "end_fixDesignatedPoint"), DirectFlightSegmentType.class, target));
    }

    @OneToOne(targetEntity = NavaidPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "drctflghtsgmnttp_endnvdsstm_l", schema = "route", joinColumns = {
        @JoinColumn(name = "directflightsegment_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setEndNavaidSystemItem(NavaidPropertyType target) {
        setEndNavaidSystem(XmlAdapterUtils.marshallJAXBElement(NavaidPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "end_navaidSystem"), DirectFlightSegmentType.class, target));
    }

    @OneToOne(targetEntity = AIXMPointPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "drctflghtsgmnttp_endpstn_l", schema = "route", joinColumns = {
        @JoinColumn(name = "directflightsegment_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setEndPositionItem(AIXMPointPropertyType target) {
        setEndPosition(XmlAdapterUtils.marshallJAXBElement(AIXMPointPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "end_position"), DirectFlightSegmentType.class, target));
    }

    @OneToOne(targetEntity = RunwayCentrelinePointPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "drctflghtsgmnttp_endrnwpnt_l", schema = "route", joinColumns = {
        @JoinColumn(name = "directflightsegment_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setEndRunwayPointItem(RunwayCentrelinePointPropertyType target) {
        setEndRunwayPoint(XmlAdapterUtils.marshallJAXBElement(RunwayCentrelinePointPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "end_runwayPoint"), DirectFlightSegmentType.class, target));
    }

    @OneToOne(targetEntity = TouchDownLiftOffPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "drctflghtsgmnttp_endamngpnt_l", schema = "route", joinColumns = {
        @JoinColumn(name = "directflightsegment_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setEndAimingPointItem(TouchDownLiftOffPropertyType target) {
        setEndAimingPoint(XmlAdapterUtils.marshallJAXBElement(TouchDownLiftOffPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "end_aimingPoint"), DirectFlightSegmentType.class, target));
    }

    @OneToOne(targetEntity = AirportHeliportPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "drctflghtsgmnttp_endarprtrfrncpnt_l", schema = "route", joinColumns = {
        @JoinColumn(name = "directflightsegment_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setEndAirportReferencePointItem(AirportHeliportPropertyType target) {
        setEndAirportReferencePoint(XmlAdapterUtils.marshallJAXBElement(AirportHeliportPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "end_airportReferencePoint"), DirectFlightSegmentType.class, target));
    }

    @OneToOne(targetEntity = DesignatedPointPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "drctflghtsgmnttp_strtfxdsgntdpnt_l", schema = "route", joinColumns = {
        @JoinColumn(name = "directflightsegment_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setStartFixDesignatedPointItem(DesignatedPointPropertyType target) {
        setStartFixDesignatedPoint(XmlAdapterUtils.marshallJAXBElement(DesignatedPointPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "start_fixDesignatedPoint"), DirectFlightSegmentType.class, target));
    }

    @OneToOne(targetEntity = NavaidPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "drctflghtsgmnttp_strtnvdsstm_l", schema = "route", joinColumns = {
        @JoinColumn(name = "directflightsegment_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setStartNavaidSystemItem(NavaidPropertyType target) {
        setStartNavaidSystem(XmlAdapterUtils.marshallJAXBElement(NavaidPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "start_navaidSystem"), DirectFlightSegmentType.class, target));
    }

    @OneToOne(targetEntity = AIXMPointPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "drctflghtsgmnttp_strtpstn_l", schema = "route", joinColumns = {
        @JoinColumn(name = "directflightsegment_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setStartPositionItem(AIXMPointPropertyType target) {
        setStartPosition(XmlAdapterUtils.marshallJAXBElement(AIXMPointPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "start_position"), DirectFlightSegmentType.class, target));
    }

    @OneToOne(targetEntity = RunwayCentrelinePointPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "drctflghtsgmnttp_strtrnwpnt_l", schema = "route", joinColumns = {
        @JoinColumn(name = "directflightsegment_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setStartRunwayPointItem(RunwayCentrelinePointPropertyType target) {
        setStartRunwayPoint(XmlAdapterUtils.marshallJAXBElement(RunwayCentrelinePointPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "start_runwayPoint"), DirectFlightSegmentType.class, target));
    }

    @OneToOne(targetEntity = TouchDownLiftOffPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "drctflghtsgmnttp_strtamngpnt_l", schema = "route", joinColumns = {
        @JoinColumn(name = "directflightsegment_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setStartAimingPointItem(TouchDownLiftOffPropertyType target) {
        setStartAimingPoint(XmlAdapterUtils.marshallJAXBElement(TouchDownLiftOffPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "start_aimingPoint"), DirectFlightSegmentType.class, target));
    }

    @OneToOne(targetEntity = AirportHeliportPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "drctflghtsgmnttp_strtarprtrfrncpnt_l", schema = "route", joinColumns = {
        @JoinColumn(name = "directflightsegment_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setStartAirportReferencePointItem(AirportHeliportPropertyType target) {
        setStartAirportReferencePoint(XmlAdapterUtils.marshallJAXBElement(AirportHeliportPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "start_airportReferencePoint"), DirectFlightSegmentType.class, target));
    }
