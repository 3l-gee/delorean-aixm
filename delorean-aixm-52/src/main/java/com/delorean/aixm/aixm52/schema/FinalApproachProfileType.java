...
/**
 * <p>Java class for FinalApproachProfileType complex type</p>.
 * 
 ...
 *       <sequence>
 *         <element name="startPoint" type="{http://www.aixm.aero/schema/5.2}CodeFinalSegmentPointType" minOccurs="0"/>
 *         <element name="endPoint" type="{http://www.aixm.aero/schema/5.2}CodeFinalSegmentPointType" minOccurs="0"/>
 *         <element name="time" type="{http://www.aixm.aero/schema/5.2}ValDurationType" minOccurs="0"/>
 ...
 *         <element name="rateOfDescent" type="{http://www.aixm.aero/schema/5.2}ValSpeedType" minOccurs="0"/>
 ...
 *                 <choice>
 *                   <element ref="{http://www.aixm.aero/schema/5.2}AbstractFinalApproachProfileExtension"/>
 *                 </choice>
...
@XmlType(name = "FinalApproachProfileType", propOrder = {
    "startPoint",
    "endPoint",
    "time",
    "distance",
...
public class FinalApproachProfileType
    ...
    implements Serializable
{
    ...
    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "startpoint", columnDefinition = "codefinalsegmentpointbase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "startpointnilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setStartPointItem(CodeFinalSegmentPointType target) {
        setStartPoint(XmlAdapterUtils.marshallJAXBElement(CodeFinalSegmentPointType.class, new QName("http://www.aixm.aero/schema/5.2", "startPoint"), FinalApproachProfileType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "endpoint", columnDefinition = "codefinalsegmentpointbase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "endpointnilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setEndPointItem(CodeFinalSegmentPointType target) {
        setEndPoint(XmlAdapterUtils.marshallJAXBElement(CodeFinalSegmentPointType.class, new QName("http://www.aixm.aero/schema/5.2", "endPoint"), FinalApproachProfileType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "time", columnDefinition = "valdurationbase")),
        @AttributeOverride(name = "uom", column = @Column(name = "timeuom", columnDefinition = "uomduration")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "timenilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setTimeItem(ValDurationType target) {
        setTime(XmlAdapterUtils.marshallJAXBElement(ValDurationType.class, new QName("http://www.aixm.aero/schema/5.2", "time"), FinalApproachProfileType.class, target));
    }
    ...
    public void setDistanceItem(ValDistanceType target) {
        setDistance(XmlAdapterUtils.marshallJAXBElement(ValDistanceType.class, new QName("http://www.aixm.aero/schema/5.2", "distance"), FinalApproachProfileType.class, target));
    }
    ...
    public void setSpeedItem(ValSpeedType target) {
        setSpeed(XmlAdapterUtils.marshallJAXBElement(ValSpeedType.class, new QName("http://www.aixm.aero/schema/5.2", "speed"), FinalApproachProfileType.class, target));
    }
    ...
    public void setSpeedReferenceItem(CodeSpeedReferenceType target) {
        setSpeedReference(XmlAdapterUtils.marshallJAXBElement(CodeSpeedReferenceType.class, new QName("http://www.aixm.aero/schema/5.2", "speedReference"), FinalApproachProfileType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "rateofdescent", columnDefinition = "valspeedbase")),
        @AttributeOverride(name = "uom", column = @Column(name = "rateofdescentuom", columnDefinition = "uomspeed")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "rateofdescentnilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setRateOfDescentItem(ValSpeedType target) {
        setRateOfDescent(XmlAdapterUtils.marshallJAXBElement(ValSpeedType.class, new QName("http://www.aixm.aero/schema/5.2", "rateOfDescent"), FinalApproachProfileType.class, target));
    }
