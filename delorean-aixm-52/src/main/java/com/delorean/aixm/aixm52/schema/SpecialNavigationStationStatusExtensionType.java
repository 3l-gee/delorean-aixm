 ...
 *         <element ref="{http://www.aixm.aero/schema/5.2}AbstractSpecialNavigationStationStatusExtension"/>
 *       </choice>
...
@Entity(name = "SpecialNavigationStationStatusExtensionType")
@Table(name = "specialnavigationstationstatus_oe", schema = "navaids_point")
public class SpecialNavigationStationStatusExtensionType implements Serializable, Equals, HashCode, ToString
{
