...
/**
 * <p>Java class for GBASTimeSliceType complex type</p>.
 * 
 ...
 *       <sequence>
 *         <element name="designator" type="{http://www.aixm.aero/schema/5.2}CodeICAOType" minOccurs="0"/>
 *         <element name="name" type="{http://www.aixm.aero/schema/5.2}TextNameType" minOccurs="0"/>
 *         <element name="maximumUseDistance" type="{http://www.aixm.aero/schema/5.2}ValDistanceType" minOccurs="0"/>
 ...
 *         <element name="antenna" type="{http://www.aixm.aero/schema/5.2}VDBAntennaPropertyType" maxOccurs="unbounded" minOccurs="0"/>
 ...
 *         <element name="referencePoint" type="{http://www.aixm.aero/schema/5.2}ElevatedPointPropertyType" minOccurs="0"/>
 ...
 *                 <sequence>
 *                   <element ref="{http://www.aixm.aero/schema/5.2}AbstractGBASExtension"/>
 *                 </sequence>
...
@XmlType(name = "GBASTimeSliceType", propOrder = {
    "designator",
    "aixmName",
    "maximumUseDistance",
    "flightChecked",
...
public class GBASTimeSliceType
    ...
    implements Serializable
{
    ...
    protected List<GBASTimeSliceExtensionType> extension;
    ...
    @JoinTable(name = "gbastmslctp_agmntdsstm_l", schema = "navaids_point", joinColumns = {
        @JoinColumn(name = "gbas_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the antenna property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     ...
     * 
     */
    @OneToMany(targetEntity = VDBAntennaPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "gbastmslctp_antnn_l", schema = "navaids_point", joinColumns = {
        @JoinColumn(name = "gbas_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "gbastmslctp_avlblt_l", schema = "navaids_point", joinColumns = {
        @JoinColumn(name = "gbas_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "gbastmslctp_srvdarprt_l", schema = "navaids_point", joinColumns = {
        @JoinColumn(name = "gbas_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "gbastmslctp_annttn_l", schema = "navaids_point", joinColumns = {
        @JoinColumn(name = "gbas_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link GBASTimeSliceExtensionType }
     * 
     * 
     */
    @OneToMany(targetEntity = GBASTimeSliceExtensionType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinColumn(name = "gbas_te_hjid", referencedColumnName = "hjid")
    public List<GBASTimeSliceExtensionType> getExtension() {
        if (extension == null) {
     ...
     * 
     */
    public void setExtension(List<GBASTimeSliceExtensionType> extension) {
    ...
    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "designator", columnDefinition = "alpha")),
    ...
    public void setDesignatorItem(CodeICAOType target) {
        setDesignator(XmlAdapterUtils.marshallJAXBElement(CodeICAOType.class, new QName("http://www.aixm.aero/schema/5.2", "designator"), GBASTimeSliceType.class, target));
    }
    ...
    public void setAixmNameItem(TextNameType target) {
        setAixmName(XmlAdapterUtils.marshallJAXBElement(TextNameType.class, new QName("http://www.aixm.aero/schema/5.2", "name"), GBASTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "maximumusedistance", columnDefinition = "valdistancebase")),
        @AttributeOverride(name = "uom", column = @Column(name = "maximumusedistanceuom", columnDefinition = "uomdistance")),
        @AttributeOverride(name = "accuracy", column = @Column(name = "maximumusedistanceaccuracy", columnDefinition = "numericalwithnilreason")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "maximumusedistancenilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setMaximumUseDistanceItem(ValDistanceType target) {
        setMaximumUseDistance(XmlAdapterUtils.marshallJAXBElement(ValDistanceType.class, new QName("http://www.aixm.aero/schema/5.2", "maximumUseDistance"), GBASTimeSliceType.class, target));
    }
    ...
    public void setFlightCheckedItem(CodeYesNoType target) {
        setFlightChecked(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.2", "flightChecked"), GBASTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = OrganisationAuthorityPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "gbastmslctp_oprtr_l", schema = "navaids_point", joinColumns = {
        @JoinColumn(name = "gbas_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setOperatorItem(OrganisationAuthorityPropertyType target) {
        setOperator(XmlAdapterUtils.marshallJAXBElement(OrganisationAuthorityPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "operator"), GBASTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = AIXMElevatedPointPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "gbastmslctp_rfrncpnt_l", schema = "navaids_point", joinColumns = {
        @JoinColumn(name = "gbas_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setReferencePointItem(AIXMElevatedPointPropertyType target) {
        setReferencePoint(XmlAdapterUtils.marshallJAXBElement(AIXMElevatedPointPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "referencePoint"), GBASTimeSliceType.class, target));
    }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        }
        {
            ...
            List<GBASTimeSliceExtensionType> lhsField;
            lhsField = (this.isSetExtension()?this.getExtension():null);
            List<GBASTimeSliceExtensionType> rhsField;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        }
        {
            ...
            List<GBASTimeSliceExtensionType> theField;
