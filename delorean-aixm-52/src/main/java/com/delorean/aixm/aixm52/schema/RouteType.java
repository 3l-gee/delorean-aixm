...
"{http://www.aixm.aero/schema/5.2}RouteTimeSlicePropertyType" maxOccurs=
"unbounded"/>
 *       </sequence>
 *     </extension>
 *   </complexContent>
...
@Table(name = "route_f", schema = "route")
public class RouteType extends AbstractAIXMFeatureType implements Serializable {
    ...
    @OneToMany(targetEntity = RouteTimeSlicePropertyType.class, cascade = {CascadeType.ALL}, fetch = FetchType.EAGER)
