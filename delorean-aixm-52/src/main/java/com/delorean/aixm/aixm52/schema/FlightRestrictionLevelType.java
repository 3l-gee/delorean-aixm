 ...
 *       <sequence>
 *         <element name="upperLevel" type="{http://www.aixm.aero/schema/5.2}ValDistanceVerticalType" minOccurs="0"/>
 *         <element name="upperLevelReference" type="{http://www.aixm.aero/schema/5.2}CodeVerticalReferenceType" minOccurs="0"/>
 *         <element name="lowerLevel" type="{http://www.aixm.aero/schema/5.2}ValDistanceVerticalType" minOccurs="0"/>
 *         <element name="lowerLevelReference" type="{http://www.aixm.aero/schema/5.2}CodeVerticalReferenceType" minOccurs="0"/>
 ...
 *                 <choice>
 *                   <element ref="{http://www.aixm.aero/schema/5.2}AbstractFlightRestrictionLevelExtension"/>
 *                 </choice>
...
@Table(name = "flightrestrictionlevel_o", schema = "route")
    ...
    implements Serializable
{
    ...
    @XmlElementRef(name = "upperLevel", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<ValDistanceVerticalType> upperLevel;
    @XmlElementRef(name = "upperLevelReference", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<CodeVerticalReferenceType> upperLevelReference;
    @XmlElementRef(name = "lowerLevel", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<ValDistanceVerticalType> lowerLevel;
    @XmlElementRef(name = "lowerLevelReference", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<CodeVerticalReferenceType> lowerLevelReference;
    @XmlElement(nillable = true)
    protected List<NotePropertyType> annotation;
    protected List<FlightRestrictionLevelExtensionType> extension;
    ...
    @JoinTable(name = "flghtrstrctnlvltp_annttn_link", schema = "route", joinColumns = {
        @JoinColumn(name = "flightrestrictionlevel_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link FlightRestrictionLevelExtensionType }
     * 
     * 
     */
    @OneToMany(targetEntity = FlightRestrictionLevelExtensionType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinColumn(name = "flightrestrictionlevel_oe_hjid", referencedColumnName = "hjid")
    public List<FlightRestrictionLevelExtensionType> getExtension() {
        if (extension == null) {
     ...
     * 
     */
    public void setExtension(List<FlightRestrictionLevelExtensionType> extension) {
    ...
    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "upperlevel", columnDefinition = "valdistanceverticalbase")),
        @AttributeOverride(name = "uom", column = @Column(name = "upperleveluom", columnDefinition = "uomdistancevertical")),
        @AttributeOverride(name = "accuracy", column = @Column(name = "upperlevelaccuracy", columnDefinition = "numericalwithnilreason")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "upperlevelnilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setUpperLevelItem(ValDistanceVerticalType target) {
        setUpperLevel(XmlAdapterUtils.marshallJAXBElement(ValDistanceVerticalType.class, new QName("http://www.aixm.aero/schema/5.2", "upperLevel"), FlightRestrictionLevelType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "upperlevelreference", columnDefinition = "codeverticalreferencebase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "upperlevelreferencenilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setUpperLevelReferenceItem(CodeVerticalReferenceType target) {
        setUpperLevelReference(XmlAdapterUtils.marshallJAXBElement(CodeVerticalReferenceType.class, new QName("http://www.aixm.aero/schema/5.2", "upperLevelReference"), FlightRestrictionLevelType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "lowerlevel", columnDefinition = "valdistanceverticalbase")),
        @AttributeOverride(name = "uom", column = @Column(name = "lowerleveluom", columnDefinition = "uomdistancevertical")),
        @AttributeOverride(name = "accuracy", column = @Column(name = "lowerlevelaccuracy", columnDefinition = "numericalwithnilreason")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "lowerlevelnilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setLowerLevelItem(ValDistanceVerticalType target) {
        setLowerLevel(XmlAdapterUtils.marshallJAXBElement(ValDistanceVerticalType.class, new QName("http://www.aixm.aero/schema/5.2", "lowerLevel"), FlightRestrictionLevelType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "lowerlevelreference", columnDefinition = "codeverticalreferencebase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "lowerlevelreferencenilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setLowerLevelReferenceItem(CodeVerticalReferenceType target) {
        setLowerLevelReference(XmlAdapterUtils.marshallJAXBElement(CodeVerticalReferenceType.class, new QName("http://www.aixm.aero/schema/5.2", "lowerLevelReference"), FlightRestrictionLevelType.class, target));
    }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        final FlightRestrictionLevelType that = ((FlightRestrictionLevelType) object);
        {
            ...
            List<FlightRestrictionLevelExtensionType> lhsField;
            lhsField = (this.isSetExtension()?this.getExtension():null);
            List<FlightRestrictionLevelExtensionType> rhsField;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        }
        {
            ...
            List<FlightRestrictionLevelExtensionType> theField;
