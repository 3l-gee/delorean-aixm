...
/**
 * <p>
 * Java class for CirclingRestrictionPropertyType complex type
 * </p>
 * .
 *
 * <p>
 ...
 *       <sequence>
 *         <element ref="{http://www.aixm.aero/schema/5.2}CirclingRestriction"/>
 *       </sequence>
 *     </extension>
 *   </complexContent>
 * </complexType>
...
@XmlType(name = "CirclingRestrictionPropertyType", propOrder = {"circlingRestriction"})
@Entity(name = "CirclingRestrictionPropertyType")
@Table(name = "circlingrestrictionpropertytype", schema = "procedure")
public class CirclingRestrictionPropertyType extends AbstractAIXMPropertyType implements Serializable {
     ...
     *
     * @return possible object is {@link CirclingRestrictionType }
     *
     */
    @OneToOne(targetEntity = CirclingRestrictionType.class, cascade = {CascadeType.ALL}, fetch = FetchType.EAGER)
     ...
     *
     * @param value
     *            allowed object is {@link CirclingRestrictionType }
     *
     */
