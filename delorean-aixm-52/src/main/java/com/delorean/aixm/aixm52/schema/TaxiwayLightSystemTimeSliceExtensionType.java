...
@Entity(name = "TaxiwayLightSystemTimeSliceExtensionType")
@Table(name = "taxiwaylightsystem_te", schema = "airport_heliport")
public class TaxiwayLightSystemTimeSliceExtensionType implements Serializable, Equals, HashCode, ToString
{
    ...
    @JoinColumn(name = "abstracttaxiwaylightsystemextension_hjid", referencedColumnName = "hjid")
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        final TaxiwayLightSystemTimeSliceExtensionType that = ((TaxiwayLightSystemTimeSliceExtensionType) object);
        {
            ...
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "abstractTaxiwayLightSystemExtension", lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "abstractTaxiwayLightSystemExtension", rhsField);
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetAbstractTaxiwayLightSystemExtension();
            AbstractExtensionType theField;
            theField = this.getAbstractTaxiwayLightSystemExtension();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "abstractTaxiwayLightSystemExtension", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            AbstractExtensionType theField;
            theField = this.getAbstractTaxiwayLightSystemExtension();
            strategy.appendField(locator, this, "abstractTaxiwayLightSystemExtension", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetAbstractGroundLightSystemExtension();
            AbstractExtensionType theField;
