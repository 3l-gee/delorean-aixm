 ...
 *         <element name="aircraftCategory" type="{http://www.aixm.aero/schema/5.2}AircraftCharacteristicPropertyType" minOccurs="0"/>
 ...
 *                 <sequence>
 *                   <element ref="{http://www.aixm.aero/schema/5.2}AbstractCirclingAreaExtension"/>
 *                 </sequence>
    ...
    implements Serializable
{
    ...
    @XmlElementRef(name = "aircraftCategory", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    ...
    @JoinTable(name = "crclngartmslctp_cndtn_l", schema = "procedure", joinColumns = {
        @JoinColumn(name = "circlingarea_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "crclngartmslctp_dsgnsrfc_l", schema = "procedure", joinColumns = {
        @JoinColumn(name = "circlingarea_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "crclngartmslctp_annttn_l", schema = "procedure", joinColumns = {
        @JoinColumn(name = "circlingarea_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "crclngartmslctp_extnt_l", schema = "procedure", joinColumns = {
        @JoinColumn(name = "circlingarea_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setExtentItem(AIXMSurfacePropertyType target) {
        setExtent(XmlAdapterUtils.marshallJAXBElement(AIXMSurfacePropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "extent"), CirclingAreaTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = InstrumentApproachProcedurePropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "crclngartmslctp_apprch_l", schema = "procedure", joinColumns = {
        @JoinColumn(name = "circlingarea_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setApproachItem(InstrumentApproachProcedurePropertyType target) {
        setApproach(XmlAdapterUtils.marshallJAXBElement(InstrumentApproachProcedurePropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "approach"), CirclingAreaTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = AircraftCharacteristicPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "crclngartmslctp_arcrftctgr_l", schema = "procedure", joinColumns = {
        @JoinColumn(name = "circlingarea_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setAircraftCategoryItem(AircraftCharacteristicPropertyType target) {
        setAircraftCategory(XmlAdapterUtils.marshallJAXBElement(AircraftCharacteristicPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "aircraftCategory"), CirclingAreaTimeSliceType.class, target));
    }
