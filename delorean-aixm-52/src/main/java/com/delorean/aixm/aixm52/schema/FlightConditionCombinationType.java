 ...
 *         <element name="logicalOperator" type="{http://www.aixm.aero/schema/5.2}CodeFlowConditionOperationType" minOccurs="0"/>
 *         <element name="element" type="{http://www.aixm.aero/schema/5.2}FlightConditionElementPropertyType" maxOccurs="unbounded" minOccurs="0"/>
 ...
 *                   <element ref="{http://www.aixm.aero/schema/5.2}AbstractFlightConditionCombinationExtension"/>
 *                 </choice>
    ...
    implements Serializable
{
    ...
    public void setLogicalOperatorItem(CodeFlowConditionOperationType target) {
        setLogicalOperator(XmlAdapterUtils.marshallJAXBElement(CodeFlowConditionOperationType.class, new QName("http://www.aixm.aero/schema/5.2", "logicalOperator"), FlightConditionCombinationType.class, target));
    }
