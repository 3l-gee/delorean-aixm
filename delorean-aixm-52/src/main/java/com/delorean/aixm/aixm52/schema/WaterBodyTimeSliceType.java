...
/**
 * <p>Java class for WaterBodyTimeSliceType complex type</p>.
 * 
...
@XmlType(name = "WaterBodyTimeSliceType", propOrder = {
    "extent",
    "location",
    "annotation",
    "extension"
...
public class WaterBodyTimeSliceType
    ...
    implements Serializable
{
    ...
    @JoinTable(name = "wtrbdtmslctp_lctn_l", schema = "airport_heliport", joinColumns = {
        @JoinColumn(name = "waterbody_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "wtrbdtmslctp_annttn_l", schema = "airport_heliport", joinColumns = {
        @JoinColumn(name = "waterbody_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "wtrbdtmslctp_extnt_l", schema = "airport_heliport", joinColumns = {
        @JoinColumn(name = "waterbody_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setExtentItem(AIXMSurfacePropertyType target) {
        setExtent(XmlAdapterUtils.marshallJAXBElement(AIXMSurfacePropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "extent"), WaterBodyTimeSliceType.class, target));
    }
