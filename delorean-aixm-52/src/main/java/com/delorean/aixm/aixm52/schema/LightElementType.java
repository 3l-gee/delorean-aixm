 ...
 *         <element name="type" type="{http://www.aixm.aero/schema/5.2}CodeLightSourceType" minOccurs="0"/>
 ...
 *         <element name="availability" type="{http://www.aixm.aero/schema/5.2}LightElementStatusPropertyType" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="direction" type="{http://www.aixm.aero/schema/5.2}CodeLightDirectionType" minOccurs="0"/>
 *         <element name="lightingTechnology" type="{http://www.aixm.aero/schema/5.2}CodeLightingTechnologyType" minOccurs="0"/>
 *         <element name="extension" maxOccurs="unbounded" minOccurs="0">
 *           <complexType>
 *             <complexContent>
 *               <restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 <choice>
 *                   <element ref="{http://www.aixm.aero/schema/5.2}AbstractLightElementExtension"/>
 *                 </choice>
    ...
    implements Serializable
{
    ...
    @JoinTable(name = "lghtelmnttp_annttn_l", schema = "shared", joinColumns = {
        @JoinColumn(name = "lightelement_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "lghtelmnttp_avlblt_l", schema = "shared", joinColumns = {
        @JoinColumn(name = "lightelement_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link CodeLightDirectionType }{@code >}
     *     
     */
    @Transient
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link CodeLightingTechnologyType }{@code >}
     *     
     */
    @Transient
     ...
     * 
     */
    @OneToMany(targetEntity = LightElementExtensionType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    ...
    public void setColourItem(CodeColourType target) {
        setColour(XmlAdapterUtils.marshallJAXBElement(CodeColourType.class, new QName("http://www.aixm.aero/schema/5.2", "colour"), LightElementType.class, target));
    }
    ...
    public void setIntensityLevelItem(CodeLightIntensityType target) {
        setIntensityLevel(XmlAdapterUtils.marshallJAXBElement(CodeLightIntensityType.class, new QName("http://www.aixm.aero/schema/5.2", "intensityLevel"), LightElementType.class, target));
    }
    ...
    public void setIntensityItem(ValLightIntensityType target) {
        setIntensity(XmlAdapterUtils.marshallJAXBElement(ValLightIntensityType.class, new QName("http://www.aixm.aero/schema/5.2", "intensity"), LightElementType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "type", columnDefinition = "codelightsourcebase")),
    ...
    public void setTypeItem(CodeLightSourceType target) {
        setType(XmlAdapterUtils.marshallJAXBElement(CodeLightSourceType.class, new QName("http://www.aixm.aero/schema/5.2", "type"), LightElementType.class, target));
    }

    @OneToOne(targetEntity = AIXMElevatedPointPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "lghtelmnttp_lctn_l", schema = "shared", joinColumns = {
        @JoinColumn(name = "lightelement_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setLocationItem(AIXMElevatedPointPropertyType target) {
        setLocation(XmlAdapterUtils.marshallJAXBElement(AIXMElevatedPointPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "location"), LightElementType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "direction", columnDefinition = "codelightdirectionbase")),
    ...
    public void setDirectionItem(CodeLightDirectionType target) {
        setDirection(XmlAdapterUtils.marshallJAXBElement(CodeLightDirectionType.class, new QName("http://www.aixm.aero/schema/5.2", "direction"), LightElementType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "lightingtechnology", columnDefinition = "codelightingtechnologybase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "lightingtechnologynilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setLightingTechnologyItem(CodeLightingTechnologyType target) {
        setLightingTechnology(XmlAdapterUtils.marshallJAXBElement(CodeLightingTechnologyType.class, new QName("http://www.aixm.aero/schema/5.2", "lightingTechnology"), LightElementType.class, target));
    }
