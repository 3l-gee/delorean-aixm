 ...
 *       <sequence>
 *         <element name="dependency" type="{http://www.aixm.aero/schema/5.2}CodeAirspaceDependencyType" minOccurs="0"/>
 *         <element name="annotation" type="{http://www.aixm.aero/schema/5.2}NotePropertyType" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="theAirspace" type="{http://www.aixm.aero/schema/5.2}AirspacePropertyType" minOccurs="0"/>
 *         <element name="extension" maxOccurs="unbounded" minOccurs="0">
 *           <complexType>
 *             <complexContent>
 *               <restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 <choice>
 *                   <element ref="{http://www.aixm.aero/schema/5.2}AbstractAirspaceVolumeDependencyExtension"/>
 *                 </choice>
    ...
    implements Serializable
{
    ...
    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "dependency", columnDefinition = "codeairspacedependencybase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "dependencynilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setDependencyItem(CodeAirspaceDependencyType target) {
        setDependency(XmlAdapterUtils.marshallJAXBElement(CodeAirspaceDependencyType.class, new QName("http://www.aixm.aero/schema/5.2", "dependency"), AirspaceVolumeDependencyType.class, target));
    }
    ...
    public void setTheAirspaceItem(AirspacePropertyType target) {
        setTheAirspace(XmlAdapterUtils.marshallJAXBElement(AirspacePropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "theAirspace"), AirspaceVolumeDependencyType.class, target));
    }
