...
/**
 * <p>
 * Java class for TerminalArrivalAreaType complex type
 * </p>
 * .
 *
 * <p>
 ...
 *
 * <pre>{@code
 * <complexType name="TerminalArrivalAreaType">
 *   <complexContent>
 *     <extension base=
"{http://www.aixm.aero/schema/5.2}AbstractAIXMFeatureType">
 *       <sequence>
 *         <element name="timeSlice" type=
"{http://www.aixm.aero/schema/5.2}TerminalArrivalAreaTimeSlicePropertyType" maxOccurs
="unbounded"/>
 *       </sequence>
 *     </extension>
 *   </complexContent>
...
@XmlType(name = "TerminalArrivalAreaType", propOrder = {"timeSlice"})
@Entity(name = "TerminalArrivalAreaType")
@Table(name = "terminalarrivalarea_f", schema = "procedure")
public class TerminalArrivalAreaType extends AbstractAIXMFeatureType implements Serializable {
     ...
     * {@link TerminalArrivalAreaTimeSlicePropertyType }
     *
     *
     */
     ...
     *
     */
    public void setTimeSlice(List<TerminalArrivalAreaTimeSlicePropertyType> timeSlice) {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final TerminalArrivalAreaType that = ((TerminalArrivalAreaType) object);
        {
            boolean lhsFieldIsSet = this.isSetTimeSlice();
            boolean rhsFieldIsSet = that.isSetTimeSlice();
            List<TerminalArrivalAreaTimeSlicePropertyType> lhsField;
            lhsField = (this.isSetTimeSlice() ? this.getTimeSlice() : null);
            List<TerminalArrivalAreaTimeSlicePropertyType> rhsField;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = super.hashCode(locator, strategy);
        {
            ...
            List<TerminalArrivalAreaTimeSlicePropertyType> theField;
