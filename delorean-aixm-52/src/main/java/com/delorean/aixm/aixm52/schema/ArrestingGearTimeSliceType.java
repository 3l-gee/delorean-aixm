 ...
 *         <element name="engageDevice" type="{http://www.aixm.aero/schema/5.2}CodeArrestingGearEngageDeviceType" minOccurs="0"/>
 *         <element name="absorbType" type="{http://www.aixm.aero/schema/5.2}CodeArrestingGearEnergyAbsorbType" minOccurs="0"/>
 *         <element name="bidirectional" type="{http://www.aixm.aero/schema/5.2}CodeYesNoType" minOccurs="0"/>
 *         <element name="location" type="{http://www.aixm.aero/schema/5.2}ValDistanceType" minOccurs="0"/>
 ...
 *           <element name="extent_pointExtent" type="{http://www.aixm.aero/schema/5.2}ElevatedPointPropertyType" minOccurs="0"/>
 *         </choice>
 ...
 *                 <sequence>
 *                   <element ref="{http://www.aixm.aero/schema/5.2}AbstractArrestingGearExtension"/>
 *                 </sequence>
    ...
    implements Serializable
{
    ...
    @XmlElementRef(name = "engageDevice", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<CodeArrestingGearEngageDeviceType> engageDevice;
    @XmlElementRef(name = "absorbType", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<CodeArrestingGearEnergyAbsorbType> absorbType;
    @XmlElementRef(name = "bidirectional", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "extent_surfaceExtent", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<AIXMElevatedSurfacePropertyType> extentSurfaceExtent;
    @XmlElementRef(name = "extent_curveExtent", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<AIXMElevatedCurvePropertyType> extentCurveExtent;
    @XmlElementRef(name = "extent_pointExtent", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<AIXMElevatedPointPropertyType> extentPointExtent;
    @XmlElement(nillable = true)
    protected List<NotePropertyType> annotation;
    protected List<ArrestingGearTimeSliceExtensionType> extension;
    ...
    @JoinTable(name = "arrstnggrtmslctp_rnwdrctn_link", schema = "airport_heliport", joinColumns = {
    ...
    @JoinTable(name = "arrstnggrtmslctp_annttn_link", schema = "airport_heliport", joinColumns = {
        @JoinColumn(name = "arrestinggear_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link ArrestingGearTimeSliceExtensionType }
     * 
     * 
     */
    @OneToMany(targetEntity = ArrestingGearTimeSliceExtensionType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinColumn(name = "arrestinggear_te_hjid", referencedColumnName = "hjid")
    public List<ArrestingGearTimeSliceExtensionType> getExtension() {
        if (extension == null) {
     ...
     * 
     */
    public void setExtension(List<ArrestingGearTimeSliceExtensionType> extension) {
    ...
    public void setStatusItem(CodeStatusOperationsType target) {
        setStatus(XmlAdapterUtils.marshallJAXBElement(CodeStatusOperationsType.class, new QName("http://www.aixm.aero/schema/5.2", "status"), ArrestingGearTimeSliceType.class, target));
    }
    ...
    public void setLengthItem(ValDistanceType target) {
        setLength(XmlAdapterUtils.marshallJAXBElement(ValDistanceType.class, new QName("http://www.aixm.aero/schema/5.2", "length"), ArrestingGearTimeSliceType.class, target));
    }
    ...
    public void setWidthItem(ValDistanceType target) {
        setWidth(XmlAdapterUtils.marshallJAXBElement(ValDistanceType.class, new QName("http://www.aixm.aero/schema/5.2", "width"), ArrestingGearTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "engagedevice", columnDefinition = "codearrestinggearengagedevicebase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "engagedevicenilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setEngageDeviceItem(CodeArrestingGearEngageDeviceType target) {
        setEngageDevice(XmlAdapterUtils.marshallJAXBElement(CodeArrestingGearEngageDeviceType.class, new QName("http://www.aixm.aero/schema/5.2", "engageDevice"), ArrestingGearTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "absorbtype", columnDefinition = "codearrestinggearenergyabsorbbase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "absorbtypenilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setAbsorbTypeItem(CodeArrestingGearEnergyAbsorbType target) {
        setAbsorbType(XmlAdapterUtils.marshallJAXBElement(CodeArrestingGearEnergyAbsorbType.class, new QName("http://www.aixm.aero/schema/5.2", "absorbType"), ArrestingGearTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "bidirectional", columnDefinition = "codeyesnobase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "bidirectionalnilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setBidirectionalItem(CodeYesNoType target) {
        setBidirectional(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.2", "bidirectional"), ArrestingGearTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "location", columnDefinition = "valdistancebase")),
        @AttributeOverride(name = "uom", column = @Column(name = "locationuom", columnDefinition = "uomdistance")),
        @AttributeOverride(name = "accuracy", column = @Column(name = "locationaccuracy", columnDefinition = "numericalwithnilreason")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "locationnilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setLocationItem(ValDistanceType target) {
        setLocation(XmlAdapterUtils.marshallJAXBElement(ValDistanceType.class, new QName("http://www.aixm.aero/schema/5.2", "location"), ArrestingGearTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = SurfaceCharacteristicsPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "arrstnggrtmslctp_srfcprprts_link", schema = "airport_heliport", joinColumns = {
        @JoinColumn(name = "arrestinggear_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setSurfacePropertiesItem(SurfaceCharacteristicsPropertyType target) {
        setSurfaceProperties(XmlAdapterUtils.marshallJAXBElement(SurfaceCharacteristicsPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "surfaceProperties"), ArrestingGearTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = AIXMElevatedSurfacePropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "arrstnggrtmslctp_extntsrfcextnt_link", schema = "airport_heliport", joinColumns = {
        @JoinColumn(name = "arrestinggear_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setExtentSurfaceExtentItem(AIXMElevatedSurfacePropertyType target) {
        setExtentSurfaceExtent(XmlAdapterUtils.marshallJAXBElement(AIXMElevatedSurfacePropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "extent_surfaceExtent"), ArrestingGearTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = AIXMElevatedCurvePropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "arrstnggrtmslctp_extntcrvextnt_link", schema = "airport_heliport", joinColumns = {
        @JoinColumn(name = "arrestinggear_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setExtentCurveExtentItem(AIXMElevatedCurvePropertyType target) {
        setExtentCurveExtent(XmlAdapterUtils.marshallJAXBElement(AIXMElevatedCurvePropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "extent_curveExtent"), ArrestingGearTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = AIXMElevatedPointPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "arrstnggrtmslctp_extntpntextnt_link", schema = "airport_heliport", joinColumns = {
        @JoinColumn(name = "arrestinggear_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
        @JoinColumn(name = "extentpointextent_hjid", referencedColumnName = "hjid")
    })
    ...
    public void setExtentPointExtentItem(AIXMElevatedPointPropertyType target) {
        setExtentPointExtent(XmlAdapterUtils.marshallJAXBElement(AIXMElevatedPointPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "extent_pointExtent"), ArrestingGearTimeSliceType.class, target));
    }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        final ArrestingGearTimeSliceType that = ((ArrestingGearTimeSliceType) object);
        {
            ...
            List<ArrestingGearTimeSliceExtensionType> lhsField;
            lhsField = (this.isSetExtension()?this.getExtension():null);
            List<ArrestingGearTimeSliceExtensionType> rhsField;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        }
        {
            ...
            List<ArrestingGearTimeSliceExtensionType> theField;
