 ...
 *         <element name="taxiwayLocation" type="{http://www.aixm.aero/schema/5.2}TaxiwayPropertyType" minOccurs="0"/>
 *         <element name="standLocation" type="{http://www.aixm.aero/schema/5.2}AircraftStandPropertyType" minOccurs="0"/>
 ...
 *                 <sequence>
 *                   <element ref="{http://www.aixm.aero/schema/5.2}AbstractDeicingAreaExtension"/>
 *                 </sequence>
    ...
    implements Serializable
{
    ...
    @XmlElementRef(name = "taxiwayLocation", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<TaxiwayPropertyType> taxiwayLocation;
    @XmlElementRef(name = "standLocation", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    ...
    public void setAssociatedApronItem(ApronPropertyType target) {
        setAssociatedApron(XmlAdapterUtils.marshallJAXBElement(ApronPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "associatedApron"), DeicingAreaTimeSliceType.class, target));
    }
    ...
    public void setTaxiwayLocationItem(TaxiwayPropertyType target) {
        setTaxiwayLocation(XmlAdapterUtils.marshallJAXBElement(TaxiwayPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "taxiwayLocation"), DeicingAreaTimeSliceType.class, target));
    }
    ...
    public void setStandLocationItem(AircraftStandPropertyType target) {
        setStandLocation(XmlAdapterUtils.marshallJAXBElement(AircraftStandPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "standLocation"), DeicingAreaTimeSliceType.class, target));
    }
    ...
    public void setSurfacePropertiesItem(SurfaceCharacteristicsPropertyType target) {
        setSurfaceProperties(XmlAdapterUtils.marshallJAXBElement(SurfaceCharacteristicsPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "surfaceProperties"), DeicingAreaTimeSliceType.class, target));
    }
    ...
    public void setExtentItem(AIXMElevatedSurfacePropertyType target) {
        setExtent(XmlAdapterUtils.marshallJAXBElement(AIXMElevatedSurfacePropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "extent"), DeicingAreaTimeSliceType.class, target));
    }
    ...
    public void setDesignatorItem(TextDesignatorType target) {
        setDesignator(XmlAdapterUtils.marshallJAXBElement(TextDesignatorType.class, new QName("http://www.aixm.aero/schema/5.2", "designator"), DeicingAreaTimeSliceType.class, target));
    }
