...
/**
 * <p>Java class for WaterBodyPropertyType complex type</p>.
 * 
...
@XmlType(name = "WaterBodyPropertyType")
@Entity(name = "WaterBodyPropertyType")
@Table(name = "waterbody_p", schema = "airport_heliport")
public class WaterBodyPropertyType implements Serializable, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        final WaterBodyPropertyType that = ((WaterBodyPropertyType) object);
        {
