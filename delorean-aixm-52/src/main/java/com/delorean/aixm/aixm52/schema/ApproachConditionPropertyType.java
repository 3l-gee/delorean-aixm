...
/**
 * <p>
 * Java class for ApproachConditionPropertyType complex type
 * </p>
 * .
 *
 * <p>
 ...
 *       <sequence>
 *         <element ref="{http://www.aixm.aero/schema/5.2}ApproachCondition"/>
 *       </sequence>
 *     </extension>
 *   </complexContent>
 * </complexType>
...
@XmlType(name = "ApproachConditionPropertyType", propOrder = {"approachCondition"})
@Entity(name = "ApproachConditionPropertyType")
@Table(name = "approachconditionpropertytype", schema = "procedure")
public class ApproachConditionPropertyType extends AbstractAIXMPropertyType implements Serializable {
     ...
     *
     * @return possible object is {@link ApproachConditionType }
     *
     */
    @OneToOne(targetEntity = ApproachConditionType.class, cascade = {CascadeType.ALL}, fetch = FetchType.EAGER)
     ...
     *
     * @param value
     *            allowed object is {@link ApproachConditionType }
     *
     */
