...
/**
 * <p>Java class for AuthorityForNavaidEquipmentType complex type</p>.
 * 
 ...
 *                 <choice>
 *                   <element ref="{http://www.aixm.aero/schema/5.2}AbstractAuthorityForNavaidEquipmentExtension"/>
 *                 </choice>
    ...
    implements Serializable
{
    ...
    @JoinTable(name = "athrtfrnvdeqpmnttp_annttn_link", schema = "navaids_point", joinColumns = {
    ...
    public void setTypeItem(CodeAuthorityRoleType target) {
        setType(XmlAdapterUtils.marshallJAXBElement(CodeAuthorityRoleType.class, new QName("http://www.aixm.aero/schema/5.2", "type"), AuthorityForNavaidEquipmentType.class, target));
    }

    @OneToOne(targetEntity = OrganisationAuthorityPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "athrtfrnvdeqpmnttp_thorgnstnathrt_link", schema = "navaids_point", joinColumns = {
        @JoinColumn(name = "authorityfornavaidequipment_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setTheOrganisationAuthorityItem(OrganisationAuthorityPropertyType target) {
        setTheOrganisationAuthority(XmlAdapterUtils.marshallJAXBElement(OrganisationAuthorityPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "theOrganisationAuthority"), AuthorityForNavaidEquipmentType.class, target));
    }
