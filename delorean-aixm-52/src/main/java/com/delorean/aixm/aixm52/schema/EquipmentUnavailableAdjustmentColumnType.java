 ...
 *       <sequence>
 *         <element name="guidanceEquipment" type="{http://www.aixm.aero/schema/5.2}CodeApproachType" minOccurs="0"/>
 *         <element name="landingSystemLights" type="{http://www.aixm.aero/schema/5.2}CodeYesNoType" minOccurs="0"/>
 *         <element name="equipmentRVR" type="{http://www.aixm.aero/schema/5.2}CodeYesNoType" minOccurs="0"/>
 *         <element name="visibilityAdjustment" type="{http://www.aixm.aero/schema/5.2}ValDistanceVerticalType" minOccurs="0"/>
 *         <element name="approachLightingInoperative" type="{http://www.aixm.aero/schema/5.2}CodeYesNoType" minOccurs="0"/>
 ...
 *                 <choice>
 *                   <element ref="{http://www.aixm.aero/schema/5.2}AbstractEquipmentUnavailableAdjustmentColumnExtension"/>
 *                 </choice>
    ...
    implements Serializable
{
    ...
    @XmlElementRef(name = "guidanceEquipment", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<CodeApproachType> guidanceEquipment;
    @XmlElementRef(name = "landingSystemLights", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<CodeYesNoType> landingSystemLights;
    @XmlElementRef(name = "equipmentRVR", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<CodeYesNoType> equipmentRVR;
    @XmlElementRef(name = "visibilityAdjustment", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<ValDistanceVerticalType> visibilityAdjustment;
    @XmlElementRef(name = "approachLightingInoperative", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    ...
    @JoinTable(name = "eqpmntunvlbladjstmntclmntp_annttn_link", schema = "procedure", joinColumns = {
    ...
    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "guidanceequipment", columnDefinition = "codeapproachbase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "guidanceequipmentnilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setGuidanceEquipmentItem(CodeApproachType target) {
        setGuidanceEquipment(XmlAdapterUtils.marshallJAXBElement(CodeApproachType.class, new QName("http://www.aixm.aero/schema/5.2", "guidanceEquipment"), EquipmentUnavailableAdjustmentColumnType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "landingsystemlights", columnDefinition = "codeyesnobase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "landingsystemlightsnilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setLandingSystemLightsItem(CodeYesNoType target) {
        setLandingSystemLights(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.2", "landingSystemLights"), EquipmentUnavailableAdjustmentColumnType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "equipmentrvr", columnDefinition = "codeyesnobase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "equipmentrvrnilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setEquipmentRVRItem(CodeYesNoType target) {
        setEquipmentRVR(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.2", "equipmentRVR"), EquipmentUnavailableAdjustmentColumnType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "visibilityadjustment", columnDefinition = "valdistanceverticalbase")),
        @AttributeOverride(name = "uom", column = @Column(name = "visibilityadjustmentuom", columnDefinition = "uomdistancevertical")),
        @AttributeOverride(name = "accuracy", column = @Column(name = "visibilityadjustmentaccuracy", columnDefinition = "numericalwithnilreason")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "visibilityadjustmentnilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setVisibilityAdjustmentItem(ValDistanceVerticalType target) {
        setVisibilityAdjustment(XmlAdapterUtils.marshallJAXBElement(ValDistanceVerticalType.class, new QName("http://www.aixm.aero/schema/5.2", "visibilityAdjustment"), EquipmentUnavailableAdjustmentColumnType.class, target));
    }
    ...
    public void setApproachLightingInoperativeItem(CodeYesNoType target) {
        setApproachLightingInoperative(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.2", "approachLightingInoperative"), EquipmentUnavailableAdjustmentColumnType.class, target));
    }
