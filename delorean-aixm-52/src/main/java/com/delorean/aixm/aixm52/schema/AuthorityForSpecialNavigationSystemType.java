...
/**
 * <p>Java class for AuthorityForSpecialNavigationSystemType complex type</p>.
 * 
 ...
 *       <sequence>
 *         <element name="type" type="{http://www.aixm.aero/schema/5.2}CodeAuthorityRoleType" minOccurs="0"/>
 *         <element name="annotation" type="{http://www.aixm.aero/schema/5.2}NotePropertyType" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="theOrganisationAuthority" type="{http://www.aixm.aero/schema/5.2}OrganisationAuthorityPropertyType" minOccurs="0"/>
 *         <element name="extension" maxOccurs="unbounded" minOccurs="0">
 *           <complexType>
 *             <complexContent>
 *               <restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 <choice>
 *                   <element ref="{http://www.aixm.aero/schema/5.2}AbstractAuthorityForSpecialNavigationSystemExtension"/>
 *                 </choice>
...
@Entity(name = "AuthorityForSpecialNavigationSystemType")
@Table(name = "authorityforspecialnavigationsystem_o", schema = "navaids_point")
    ...
    implements Serializable
{
    ...
    @JoinTable(name = "athrtfrspclnvgtnsstmtp_annttn_link", schema = "navaids_point", joinColumns = {
        @JoinColumn(name = "authorityforspecialnavigationsystem_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "type", columnDefinition = "codeauthorityrolebase")),
    ...
    public void setTypeItem(CodeAuthorityRoleType target) {
        setType(XmlAdapterUtils.marshallJAXBElement(CodeAuthorityRoleType.class, new QName("http://www.aixm.aero/schema/5.2", "type"), AuthorityForSpecialNavigationSystemType.class, target));
    }

    @OneToOne(targetEntity = OrganisationAuthorityPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "athrtfrspclnvgtnsstmtp_thorgnstnathrt_link", schema = "navaids_point", joinColumns = {
        @JoinColumn(name = "authorityforspecialnavigationsystem_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public OrganisationAuthorityPropertyType getTheOrganisationAuthorityItem() {
        return XmlAdapterUtils.unmarshallSource(OrganisationAuthorityPropertyType.class, this.getTheOrganisationAuthority());
    }

    public void setTheOrganisationAuthorityItem(OrganisationAuthorityPropertyType target) {
        setTheOrganisationAuthority(XmlAdapterUtils.marshallJAXBElement(OrganisationAuthorityPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "theOrganisationAuthority"), AuthorityForSpecialNavigationSystemType.class, target));
    }
