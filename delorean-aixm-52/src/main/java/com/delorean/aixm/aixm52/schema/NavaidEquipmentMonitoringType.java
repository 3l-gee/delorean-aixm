 ...
 *         <element name="monitored" type="{http://www.aixm.aero/schema/5.2}CodeYesNoType" minOccurs="0"/>
    ...
    implements Serializable
{
    ...
    public void setMonitoredItem(CodeYesNoType target) {
        setMonitored(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.2", "monitored"), NavaidEquipmentMonitoringType.class, target));
    }
