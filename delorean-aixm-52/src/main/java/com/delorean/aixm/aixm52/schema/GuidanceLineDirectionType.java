...
/**
 * <p>Java class for GuidanceLineDirectionType complex type</p>.
 * 
 ...
 *       <sequence>
 *         <element name="direction" type="{http://www.aixm.aero/schema/5.2}CodeDirectionType" minOccurs="0"/>
 *         <element name="cardinalDirection" type="{http://www.aixm.aero/schema/5.2}CodeCardinalDirectionType" minOccurs="0"/>
 *         <element name="theManoeuvringAreaAvailability" type="{http://www.aixm.aero/schema/5.2}ManoeuvringAreaAvailabilityPropertyType" minOccurs="0"/>
...
@XmlType(name = "GuidanceLineDirectionType", propOrder = {
    "direction",
    "cardinalDirection",
    "theManoeuvringAreaAvailability",
    "annotation",
    "extension"
})
@Entity(name = "GuidanceLineDirectionType")
@Table(name = "guidancelinedirection_o", schema = "airport_heliport")
public class GuidanceLineDirectionType
    ...
    implements Serializable
{
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link ManoeuvringAreaAvailabilityPropertyType }{@code >}
     *     
     */
    @Transient
    ...
    public void setDirectionItem(CodeDirectionType target) {
        setDirection(XmlAdapterUtils.marshallJAXBElement(CodeDirectionType.class, new QName("http://www.aixm.aero/schema/5.2", "direction"), GuidanceLineDirectionType.class, target));
    }
    ...
    public void setCardinalDirectionItem(CodeCardinalDirectionType target) {
        setCardinalDirection(XmlAdapterUtils.marshallJAXBElement(CodeCardinalDirectionType.class, new QName("http://www.aixm.aero/schema/5.2", "cardinalDirection"), GuidanceLineDirectionType.class, target));
    }
    ...
    public ManoeuvringAreaAvailabilityPropertyType getTheManoeuvringAreaAvailabilityItem() {
        return XmlAdapterUtils.unmarshallSource(ManoeuvringAreaAvailabilityPropertyType.class, this.getTheManoeuvringAreaAvailability());
    }

    public void setTheManoeuvringAreaAvailabilityItem(ManoeuvringAreaAvailabilityPropertyType target) {
        setTheManoeuvringAreaAvailability(XmlAdapterUtils.marshallJAXBElement(ManoeuvringAreaAvailabilityPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "theManoeuvringAreaAvailability"), GuidanceLineDirectionType.class, target));
    }
