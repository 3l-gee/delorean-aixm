...
/**
 * <p>Java class for SatelliteServiceAreaType complex type</p>.
 * 
 ...
 *         <element name="country" type="{http://www.aixm.aero/schema/5.2}OrganisationAuthorityPropertyType" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "SatelliteServiceAreaType", propOrder = {
    "timeInterval",
    "annotation",
...
public class SatelliteServiceAreaType
    ...
    implements Serializable
{
    ...
    public void setOperationalStatusItem(CodeStatusNavaidType target) {
        setOperationalStatus(XmlAdapterUtils.marshallJAXBElement(CodeStatusNavaidType.class, new QName("http://www.aixm.aero/schema/5.2", "operationalStatus"), SatelliteServiceAreaType.class, target));
    }
