...
"{http://www.aixm.aero/schema/5.2}NavigationAreaTimeSlicePropertyType" maxOccurs
="unbounded"/>
 *       </sequence>
 *     </extension>
 *   </complexContent>
...
@Table(name = "navigationarea_f", schema = "procedure")
public class NavigationAreaType extends AbstractAIXMFeatureType implements Serializable {
    ...
    @OneToMany(targetEntity = NavigationAreaTimeSlicePropertyType.class, cascade = {
