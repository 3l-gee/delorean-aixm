 ...
 *         <element name="sectorDescription" type="{http://www.aixm.aero/schema/5.2}CircleSectorPropertyType" minOccurs="0"/>
 *         <element name="restrictionArea" type="{http://www.aixm.aero/schema/5.2}SurfacePropertyType" minOccurs="0"/>
 ...
 *                   <element ref="{http://www.aixm.aero/schema/5.2}AbstractCirclingRestrictionExtension"/>
 *                 </choice>
    ...
    implements Serializable
{
    ...
    @XmlElementRef(name = "sectorDescription", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    ...
    public void setSectorDescriptionItem(CircleSectorPropertyType target) {
        setSectorDescription(XmlAdapterUtils.marshallJAXBElement(CircleSectorPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "sectorDescription"), CirclingRestrictionType.class, target));
    }
    ...
    public void setRestrictionAreaItem(AIXMSurfacePropertyType target) {
        setRestrictionArea(XmlAdapterUtils.marshallJAXBElement(AIXMSurfacePropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "restrictionArea"), CirclingRestrictionType.class, target));
    }
