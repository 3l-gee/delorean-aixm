 ...
 *         <element name="referencedDME" type="{http://www.aixm.aero/schema/5.2}DMEPropertyType" minOccurs="0"/>
 ...
 *                 <sequence>
 *                   <element ref="{http://www.aixm.aero/schema/5.2}AbstractRouteDMEExtension"/>
 *                 </sequence>
    ...
    implements Serializable
{
    ...
    @XmlElementRef(name = "referencedDME", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    ...
    public void setCriticalDMEItem(CodeYesNoType target) {
        setCriticalDME(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.2", "criticalDME"), RouteDMETimeSliceType.class, target));
    }
    ...
    public void setSatisfactoryItem(CodeYesNoType target) {
        setSatisfactory(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.2", "satisfactory"), RouteDMETimeSliceType.class, target));
    }
    ...
    public void setReferencedDMEItem(DMEPropertyType target) {
        setReferencedDME(XmlAdapterUtils.marshallJAXBElement(DMEPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "referencedDME"), RouteDMETimeSliceType.class, target));
    }
    ...
    public void setApplicableRoutePortionItem(RoutePortionPropertyType target) {
        setApplicableRoutePortion(XmlAdapterUtils.marshallJAXBElement(RoutePortionPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "applicableRoutePortion"), RouteDMETimeSliceType.class, target));
    }
