 ...
 *       <sequence>
 *         <element ref="{http://www.aixm.aero/schema/5.2}StandardInstrumentArrivalTimeSlice"/>
 *       </sequence>
...
public class StandardInstrumentArrivalTimeSlicePropertyType implements Serializable, Equals, HashCode, ToString
{
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = 1;
        {
            ...
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "standardInstrumentArrivalTimeSlice", theField);
