 ...
 *         <element name="network" type="{http://www.aixm.aero/schema/5.2}CodeTelecomNetworkType" minOccurs="0"/>
 *         <element name="linkage" type="{http://www.aixm.aero/schema/5.2}TextAddressType" minOccurs="0"/>
 *         <element name="protocol" type="{http://www.aixm.aero/schema/5.2}TextNameType" minOccurs="0"/>
 *         <element name="eMail" type="{http://www.aixm.aero/schema/5.2}TextAddressType" minOccurs="0"/>
 ...
 *                   <element ref="{http://www.aixm.aero/schema/5.2}AbstractOnlineContactExtension"/>
 *                 </choice>
    ...
    implements Serializable
{
    ...
    @XmlElementRef(name = "network", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<CodeTelecomNetworkType> network;
    @XmlElementRef(name = "linkage", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<TextAddressType> linkage;
    @XmlElementRef(name = "protocol", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<TextNameType> protocol;
    @XmlElementRef(name = "eMail", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    ...
    public void setNetworkItem(CodeTelecomNetworkType target) {
        setNetwork(XmlAdapterUtils.marshallJAXBElement(CodeTelecomNetworkType.class, new QName("http://www.aixm.aero/schema/5.2", "network"), OnlineContactType.class, target));
    }
    ...
    public void setLinkageItem(TextAddressType target) {
        setLinkage(XmlAdapterUtils.marshallJAXBElement(TextAddressType.class, new QName("http://www.aixm.aero/schema/5.2", "linkage"), OnlineContactType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "protocol", columnDefinition = "character2")),
    ...
    public void setProtocolItem(TextNameType target) {
        setProtocol(XmlAdapterUtils.marshallJAXBElement(TextNameType.class, new QName("http://www.aixm.aero/schema/5.2", "protocol"), OnlineContactType.class, target));
    }
    ...
    public void setEMailItem(TextAddressType target) {
        setEMail(XmlAdapterUtils.marshallJAXBElement(TextAddressType.class, new QName("http://www.aixm.aero/schema/5.2", "eMail"), OnlineContactType.class, target));
    }
