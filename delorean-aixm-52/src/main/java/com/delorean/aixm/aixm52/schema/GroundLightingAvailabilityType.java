 ...
 *         <element name="operationalStatus" type="{http://www.aixm.aero/schema/5.2}CodeStatusOperationsType" minOccurs="0"/>
 ...
 *                   <element ref="{http://www.aixm.aero/schema/5.2}AbstractGroundLightingAvailabilityExtension"/>
 *                 </choice>
    ...
    implements Serializable
{
    ...
    public void setOperationalStatusItem(CodeStatusOperationsType target) {
        setOperationalStatus(XmlAdapterUtils.marshallJAXBElement(CodeStatusOperationsType.class, new QName("http://www.aixm.aero/schema/5.2", "operationalStatus"), GroundLightingAvailabilityType.class, target));
    }
