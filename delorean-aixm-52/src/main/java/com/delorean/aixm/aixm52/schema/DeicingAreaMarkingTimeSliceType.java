 ...
 *         <element name="markedDeicingArea" type="{http://www.aixm.aero/schema/5.2}DeicingAreaPropertyType" minOccurs="0"/>
 *         <element name="extension" maxOccurs="unbounded" minOccurs="0">
 *           <complexType>
 *             <complexContent>
 *               <restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 <choice>
 *                   <element ref="{http://www.aixm.aero/schema/5.2}AbstractDeicingAreaMarkingExtension"/>
    ...
    implements Serializable
{
    ...
    public void setMarkingICAOStandardItem(CodeYesNoType target) {
        setMarkingICAOStandard(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.2", "markingICAOStandard"), DeicingAreaMarkingTimeSliceType.class, target));
    }
    ...
    public void setConditionItem(CodeMarkingConditionType target) {
        setCondition(XmlAdapterUtils.marshallJAXBElement(CodeMarkingConditionType.class, new QName("http://www.aixm.aero/schema/5.2", "condition"), DeicingAreaMarkingTimeSliceType.class, target));
    }
    ...
    public void setMarkedDeicingAreaItem(DeicingAreaPropertyType target) {
        setMarkedDeicingArea(XmlAdapterUtils.marshallJAXBElement(DeicingAreaPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "markedDeicingArea"), DeicingAreaMarkingTimeSliceType.class, target));
    }
