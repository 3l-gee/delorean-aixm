 ...
 *         <element name="category" type="{http://www.aixm.aero/schema/5.2}CodeFireFightingType" minOccurs="0"/>
 *         <element name="standard" type="{http://www.aixm.aero/schema/5.2}CodeAviationStandardsType" minOccurs="0"/>
 *         <element name="extension" maxOccurs="unbounded" minOccurs="0">
 *           <complexType>
 *             <complexContent>
 *               <restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 <choice>
 *                   <element ref="{http://www.aixm.aero/schema/5.2}AbstractFireFightingServiceExtension"/>
 *                   <element ref="{http://www.aixm.aero/schema/5.2}AbstractAirportGroundServiceExtension"/>
...
@Entity(name = "FireFightingServiceTimeSliceType")
@Table(name = "firefightingservice_t", schema = "service")
    ...
    implements Serializable
{
    ...
    @XmlElementRef(name = "standard", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<CodeAviationStandardsType> standard;
    protected List<FireFightingServiceTimeSliceExtensionType> extension;
    ...
    @JoinTable(name = "frfghtngsrvctmslctp_cll-sgn_link", schema = "service", joinColumns = {
        @JoinColumn(name = "firefightingservice_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "frfghtngsrvctmslctp_rdcmmnctn_link", schema = "service", joinColumns = {
        @JoinColumn(name = "firefightingservice_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "frfghtngsrvctmslctp_grndcmmnctn_link", schema = "service", joinColumns = {
        @JoinColumn(name = "firefightingservice_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "frfghtngsrvctmslctp_avlblt_link", schema = "service", joinColumns = {
        @JoinColumn(name = "firefightingservice_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "frfghtngsrvctmslctp_annttn_link", schema = "service", joinColumns = {
        @JoinColumn(name = "firefightingservice_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "frfghtngsrvctmslctp_arprthlprt_link", schema = "service", joinColumns = {
        @JoinColumn(name = "firefightingservice_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link FireFightingServiceTimeSliceExtensionType }
     * 
     * 
     */
    @OneToMany(targetEntity = FireFightingServiceTimeSliceExtensionType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinColumn(name = "firefightingservice_te_hjid", referencedColumnName = "hjid")
    public List<FireFightingServiceTimeSliceExtensionType> getExtension() {
        if (extension == null) {
     ...
     * 
     */
    public void setExtension(List<FireFightingServiceTimeSliceExtensionType> extension) {
    ...
    public void setFlightOperationsItem(CodeFlightDestinationType target) {
        setFlightOperations(XmlAdapterUtils.marshallJAXBElement(CodeFlightDestinationType.class, new QName("http://www.aixm.aero/schema/5.2", "flightOperations"), FireFightingServiceTimeSliceType.class, target));
    }
    ...
    public void setRankItem(CodeFacilityRankingType target) {
        setRank(XmlAdapterUtils.marshallJAXBElement(CodeFacilityRankingType.class, new QName("http://www.aixm.aero/schema/5.2", "rank"), FireFightingServiceTimeSliceType.class, target));
    }
    ...
    public void setCompliantICAOItem(CodeYesNoType target) {
        setCompliantICAO(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.2", "compliantICAO"), FireFightingServiceTimeSliceType.class, target));
    }
    ...
    public void setAixmNameItem(TextNameType target) {
        setAixmName(XmlAdapterUtils.marshallJAXBElement(TextNameType.class, new QName("http://www.aixm.aero/schema/5.2", "name"), FireFightingServiceTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = AIXMElevatedPointPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "frfghtngsrvctmslctp_lctn_link", schema = "service", joinColumns = {
        @JoinColumn(name = "firefightingservice_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setLocationItem(AIXMElevatedPointPropertyType target) {
        setLocation(XmlAdapterUtils.marshallJAXBElement(AIXMElevatedPointPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "location"), FireFightingServiceTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = UnitPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "frfghtngsrvctmslctp_srvcprvdr_link", schema = "service", joinColumns = {
        @JoinColumn(name = "firefightingservice_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setServiceProviderItem(UnitPropertyType target) {
        setServiceProvider(XmlAdapterUtils.marshallJAXBElement(UnitPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "serviceProvider"), FireFightingServiceTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "category", columnDefinition = "codefirefightingbase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "categorynilreason", columnDefinition = "nilreason"))
    })
    public CodeFireFightingType getCategoryItem() {
        return XmlAdapterUtils.unmarshallSource(CodeFireFightingType.class, this.getCategory());
    }

    public void setCategoryItem(CodeFireFightingType target) {
        setCategory(XmlAdapterUtils.marshallJAXBElement(CodeFireFightingType.class, new QName("http://www.aixm.aero/schema/5.2", "category"), FireFightingServiceTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "standard", columnDefinition = "codeaviationstandardsbase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "standardnilreason", columnDefinition = "nilreason"))
    })
    public CodeAviationStandardsType getStandardItem() {
        return XmlAdapterUtils.unmarshallSource(CodeAviationStandardsType.class, this.getStandard());
    }

    public void setStandardItem(CodeAviationStandardsType target) {
        setStandard(XmlAdapterUtils.marshallJAXBElement(CodeAviationStandardsType.class, new QName("http://www.aixm.aero/schema/5.2", "standard"), FireFightingServiceTimeSliceType.class, target));
    }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        final FireFightingServiceTimeSliceType that = ((FireFightingServiceTimeSliceType) object);
        {
        ...
        }
        {
            ...
            List<FireFightingServiceTimeSliceExtensionType> lhsField;
            lhsField = (this.isSetExtension()?this.getExtension():null);
            List<FireFightingServiceTimeSliceExtensionType> rhsField;
        ...
        }
        {
            ...
            JAXBElement<CodeFireFightingType> lhsField;
            lhsField = this.getCategory();
            JAXBElement<CodeFireFightingType> rhsField;
        ...
        {
            boolean lhsFieldIsSet = this.isSetStandard();
            boolean rhsFieldIsSet = that.isSetStandard();
            JAXBElement<CodeAviationStandardsType> lhsField;
            lhsField = this.getStandard();
            JAXBElement<CodeAviationStandardsType> rhsField;
            rhsField = that.getStandard();
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "standard", lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "standard", rhsField);
            if (!strategy.equals(lhsFieldLocator, rhsFieldLocator, lhsField, rhsField, lhsFieldIsSet, rhsFieldIsSet)) {
                return false;
            }
        }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        }
        {
            ...
            JAXBElement<CodeFireFightingType> theField;
            theField = this.getCategory();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "category", theField);
            currentHashCode = strategy.hashCode(theFieldLocator, currentHashCode, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetStandard();
            JAXBElement<CodeAviationStandardsType> theField;
            theField = this.getStandard();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "standard", theField);
            currentHashCode = strategy.hashCode(theFieldLocator, currentHashCode, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetExtension();
            List<FireFightingServiceTimeSliceExtensionType> theField;
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        }
        {
            ...
            JAXBElement<CodeAviationStandardsType> theField;
            theField = this.getStandard();
            strategy.appendField(locator, this, "standard", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetExtension();
            List<FireFightingServiceTimeSliceExtensionType> theField;
