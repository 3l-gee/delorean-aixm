 ...
 *         <element name="title" type="{http://www.aixm.aero/schema/5.2}TextNameType" minOccurs="0"/>
 *         <element name="address" type="{http://www.aixm.aero/schema/5.2}PostalAddressPropertyType" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="networkNode" type="{http://www.aixm.aero/schema/5.2}OnlineContactPropertyType" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="phoneFax" type="{http://www.aixm.aero/schema/5.2}TelephoneContactPropertyType" maxOccurs="unbounded" minOccurs="0"/>
 ...
 *                 <choice>
 *                   <element ref="{http://www.aixm.aero/schema/5.2}AbstractContactInformationExtension"/>
 *                 </choice>
    ...
    implements Serializable
{
    ...
    public void setAixmNameItem(TextNameType target) {
        setAixmName(XmlAdapterUtils.marshallJAXBElement(TextNameType.class, new QName("http://www.aixm.aero/schema/5.2", "name"), ContactInformationType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "title", columnDefinition = "character2")),
    ...
    public void setTitleItem(TextNameType target) {
        setTitle(XmlAdapterUtils.marshallJAXBElement(TextNameType.class, new QName("http://www.aixm.aero/schema/5.2", "title"), ContactInformationType.class, target));
    }
