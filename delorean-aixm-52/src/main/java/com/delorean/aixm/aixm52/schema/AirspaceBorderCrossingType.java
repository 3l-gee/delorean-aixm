...
/**
 * <p>Java class for AirspaceBorderCrossingType complex type</p>.
 * 
 ...
 *       <sequence>
 *         <element name="exitedAirspace" type="{http://www.aixm.aero/schema/5.2}AirspacePropertyType" minOccurs="0"/>
 *         <element name="enteredAirspace" type="{http://www.aixm.aero/schema/5.2}AirspacePropertyType" minOccurs="0"/>
 ...
 *                 <choice>
 *                   <element ref="{http://www.aixm.aero/schema/5.2}AbstractAirspaceBorderCrossingExtension"/>
 *                 </choice>
    ...
    implements Serializable
{
    ...
    @JoinColumn(name = "airspacebordercrossing_oe_hjid", referencedColumnName = "hjid")
    ...
    public void setExitedAirspaceItem(AirspacePropertyType target) {
        setExitedAirspace(XmlAdapterUtils.marshallJAXBElement(AirspacePropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "exitedAirspace"), AirspaceBorderCrossingType.class, target));
    }
    ...
    public void setEnteredAirspaceItem(AirspacePropertyType target) {
        setEnteredAirspace(XmlAdapterUtils.marshallJAXBElement(AirspacePropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "enteredAirspace"), AirspaceBorderCrossingType.class, target));
    }
