...
/**
 * <p>
 * Java class for AerialRefuellingType complex type
 * </p>
 * .
 *
 * <p>
...
"{http://www.aixm.aero/schema/5.2}AerialRefuellingTimeSlicePropertyType" maxOccurs
="unbounded"/>
 *       </sequence>
 *     </extension>
 *   </complexContent>
...
@XmlType(name = "AerialRefuellingType", propOrder = {"timeSlice"})
@Entity(name = "AerialRefuellingType")
@Table(name = "aerialrefuelling_f", schema = "aerial_refuelling")
public class AerialRefuellingType extends AbstractAIXMFeatureType implements Serializable {
    ...
    @OneToMany(targetEntity = AerialRefuellingTimeSlicePropertyType.class, cascade = {
