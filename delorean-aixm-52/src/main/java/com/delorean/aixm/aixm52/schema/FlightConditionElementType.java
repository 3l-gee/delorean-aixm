 ...
 *       <sequence>
 *         <element name="index" type="{http://www.aixm.aero/schema/5.2}NoSequenceType" minOccurs="0"/>
 *         <choice>
 *           <element name="flightCondition_weather" type="{http://www.aixm.aero/schema/5.2}MeteorologyPropertyType" minOccurs="0"/>
 *           <element name="flightCondition_aircraft" type="{http://www.aixm.aero/schema/5.2}AircraftCharacteristicPropertyType" minOccurs="0"/>
 *           <element name="flightCondition_flight" type="{http://www.aixm.aero/schema/5.2}FlightCharacteristicPropertyType" minOccurs="0"/>
 *           <element name="flightCondition_operand" type="{http://www.aixm.aero/schema/5.2}FlightConditionCombinationPropertyType" minOccurs="0"/>
 *           <element name="flightCondition_directFlightCondition" type="{http://www.aixm.aero/schema/5.2}DirectFlightPropertyType" minOccurs="0"/>
 *           <element name="flightCondition_borderCrossingCondition" type="{http://www.aixm.aero/schema/5.2}AirspaceBorderCrossingPropertyType" minOccurs="0"/>
 *           <element name="flightCondition_routePortionCondition" type="{http://www.aixm.aero/schema/5.2}RoutePortionPropertyType" minOccurs="0"/>
 *           <element name="flightCondition_standardInstrumentDepartureCondition" type="{http://www.aixm.aero/schema/5.2}StandardInstrumentDeparturePropertyType" minOccurs="0"/>
 *           <element name="flightCondition_standardInstrumentArrivalCondition" type="{http://www.aixm.aero/schema/5.2}StandardInstrumentArrivalPropertyType" minOccurs="0"/>
 *           <element name="flightCondition_organisationCondition" type="{http://www.aixm.aero/schema/5.2}OrganisationAuthorityPropertyType" minOccurs="0"/>
 *           <choice>
 *             <element name="significantPointCondition_fixDesignatedPoint" type="{http://www.aixm.aero/schema/5.2}DesignatedPointPropertyType" minOccurs="0"/>
 *             <element name="significantPointCondition_navaidSystem" type="{http://www.aixm.aero/schema/5.2}NavaidPropertyType" minOccurs="0"/>
 *             <element name="significantPointCondition_position" type="{http://www.aixm.aero/schema/5.2}PointPropertyType" minOccurs="0"/>
 *             <element name="significantPointCondition_runwayPoint" type="{http://www.aixm.aero/schema/5.2}RunwayCentrelinePointPropertyType" minOccurs="0"/>
 *             <element name="significantPointCondition_aimingPoint" type="{http://www.aixm.aero/schema/5.2}TouchDownLiftOffPropertyType" minOccurs="0"/>
 *             <element name="significantPointCondition_airportReferencePoint" type="{http://www.aixm.aero/schema/5.2}AirportHeliportPropertyType" minOccurs="0"/>
 *           </choice>
 *           <element name="flightCondition_airspaceCondition" type="{http://www.aixm.aero/schema/5.2}AirspacePropertyType" minOccurs="0"/>
 *           <element name="flightCondition_airportHeliportCondition" type="{http://www.aixm.aero/schema/5.2}AirportHeliportPropertyType" minOccurs="0"/>
 *           <element name="flightCondition_aerialRefuellingCondition" type="{http://www.aixm.aero/schema/5.2}AerialRefuellingPropertyType" minOccurs="0"/>
 *         </choice>
 *         <element name="operationalCondition" type="{http://www.aixm.aero/schema/5.2}FlightConditionCircumstancePropertyType" minOccurs="0"/>
 ...
 *                 <choice>
 *                   <element ref="{http://www.aixm.aero/schema/5.2}AbstractFlightConditionElementExtension"/>
 *                 </choice>
    ...
    implements Serializable
{
    ...
    @XmlElementRef(name = "index", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<NoSequenceType> index;
    @XmlElementRef(name = "flightCondition_weather", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<MeteorologyPropertyType> flightConditionWeather;
    @XmlElementRef(name = "flightCondition_aircraft", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<AircraftCharacteristicPropertyType> flightConditionAircraft;
    @XmlElementRef(name = "flightCondition_flight", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<FlightCharacteristicPropertyType> flightConditionFlight;
    @XmlElementRef(name = "flightCondition_operand", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<FlightConditionCombinationPropertyType> flightConditionOperand;
    @XmlElementRef(name = "flightCondition_directFlightCondition", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<DirectFlightPropertyType> flightConditionDirectFlightCondition;
    @XmlElementRef(name = "flightCondition_borderCrossingCondition", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<AirspaceBorderCrossingPropertyType> flightConditionBorderCrossingCondition;
    @XmlElementRef(name = "flightCondition_routePortionCondition", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<RoutePortionPropertyType> flightConditionRoutePortionCondition;
    @XmlElementRef(name = "flightCondition_standardInstrumentDepartureCondition", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<StandardInstrumentDeparturePropertyType> flightConditionStandardInstrumentDepartureCondition;
    @XmlElementRef(name = "flightCondition_standardInstrumentArrivalCondition", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<StandardInstrumentArrivalPropertyType> flightConditionStandardInstrumentArrivalCondition;
    @XmlElementRef(name = "flightCondition_organisationCondition", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<OrganisationAuthorityPropertyType> flightConditionOrganisationCondition;
    @XmlElementRef(name = "significantPointCondition_fixDesignatedPoint", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<DesignatedPointPropertyType> significantPointConditionFixDesignatedPoint;
    @XmlElementRef(name = "significantPointCondition_navaidSystem", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<NavaidPropertyType> significantPointConditionNavaidSystem;
    @XmlElementRef(name = "significantPointCondition_position", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<AIXMPointPropertyType> significantPointConditionPosition;
    @XmlElementRef(name = "significantPointCondition_runwayPoint", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<RunwayCentrelinePointPropertyType> significantPointConditionRunwayPoint;
    @XmlElementRef(name = "significantPointCondition_aimingPoint", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<TouchDownLiftOffPropertyType> significantPointConditionAimingPoint;
    @XmlElementRef(name = "significantPointCondition_airportReferencePoint", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<AirportHeliportPropertyType> significantPointConditionAirportReferencePoint;
    @XmlElementRef(name = "flightCondition_airspaceCondition", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<AirspacePropertyType> flightConditionAirspaceCondition;
    @XmlElementRef(name = "flightCondition_airportHeliportCondition", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<AirportHeliportPropertyType> flightConditionAirportHeliportCondition;
    @XmlElementRef(name = "flightCondition_aerialRefuellingCondition", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<AerialRefuellingPropertyType> flightConditionAerialRefuellingCondition;
    @XmlElementRef(name = "operationalCondition", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    ...
    protected List<FlightConditionElementExtensionType> extension;
    ...
    public void setIndexItem(NoSequenceType target) {
        setIndex(XmlAdapterUtils.marshallJAXBElement(NoSequenceType.class, new QName("http://www.aixm.aero/schema/5.2", "index"), FlightConditionElementType.class, target));
    }
    ...
    public void setFlightConditionWeatherItem(MeteorologyPropertyType target) {
        setFlightConditionWeather(XmlAdapterUtils.marshallJAXBElement(MeteorologyPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "flightCondition_weather"), FlightConditionElementType.class, target));
    }
    ...
    public void setFlightConditionAircraftItem(AircraftCharacteristicPropertyType target) {
        setFlightConditionAircraft(XmlAdapterUtils.marshallJAXBElement(AircraftCharacteristicPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "flightCondition_aircraft"), FlightConditionElementType.class, target));
    }
    ...
    public void setFlightConditionFlightItem(FlightCharacteristicPropertyType target) {
        setFlightConditionFlight(XmlAdapterUtils.marshallJAXBElement(FlightCharacteristicPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "flightCondition_flight"), FlightConditionElementType.class, target));
    }
    ...
    public void setFlightConditionOperandItem(FlightConditionCombinationPropertyType target) {
        setFlightConditionOperand(XmlAdapterUtils.marshallJAXBElement(FlightConditionCombinationPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "flightCondition_operand"), FlightConditionElementType.class, target));
    }
    ...
    public void setFlightConditionDirectFlightConditionItem(DirectFlightPropertyType target) {
        setFlightConditionDirectFlightCondition(XmlAdapterUtils.marshallJAXBElement(DirectFlightPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "flightCondition_directFlightCondition"), FlightConditionElementType.class, target));
    }
    ...
    public void setFlightConditionBorderCrossingConditionItem(AirspaceBorderCrossingPropertyType target) {
        setFlightConditionBorderCrossingCondition(XmlAdapterUtils.marshallJAXBElement(AirspaceBorderCrossingPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "flightCondition_borderCrossingCondition"), FlightConditionElementType.class, target));
    }
    ...
    public void setFlightConditionRoutePortionConditionItem(RoutePortionPropertyType target) {
        setFlightConditionRoutePortionCondition(XmlAdapterUtils.marshallJAXBElement(RoutePortionPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "flightCondition_routePortionCondition"), FlightConditionElementType.class, target));
    }
    ...
    public void setFlightConditionStandardInstrumentDepartureConditionItem(StandardInstrumentDeparturePropertyType target) {
        setFlightConditionStandardInstrumentDepartureCondition(XmlAdapterUtils.marshallJAXBElement(StandardInstrumentDeparturePropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "flightCondition_standardInstrumentDepartureCondition"), FlightConditionElementType.class, target));
    }
    ...
    public void setFlightConditionStandardInstrumentArrivalConditionItem(StandardInstrumentArrivalPropertyType target) {
        setFlightConditionStandardInstrumentArrivalCondition(XmlAdapterUtils.marshallJAXBElement(StandardInstrumentArrivalPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "flightCondition_standardInstrumentArrivalCondition"), FlightConditionElementType.class, target));
    }
    ...
    public void setFlightConditionOrganisationConditionItem(OrganisationAuthorityPropertyType target) {
        setFlightConditionOrganisationCondition(XmlAdapterUtils.marshallJAXBElement(OrganisationAuthorityPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "flightCondition_organisationCondition"), FlightConditionElementType.class, target));
    }
    ...
    public void setSignificantPointConditionFixDesignatedPointItem(DesignatedPointPropertyType target) {
        setSignificantPointConditionFixDesignatedPoint(XmlAdapterUtils.marshallJAXBElement(DesignatedPointPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "significantPointCondition_fixDesignatedPoint"), FlightConditionElementType.class, target));
    }
    ...
    public void setSignificantPointConditionNavaidSystemItem(NavaidPropertyType target) {
        setSignificantPointConditionNavaidSystem(XmlAdapterUtils.marshallJAXBElement(NavaidPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "significantPointCondition_navaidSystem"), FlightConditionElementType.class, target));
    }
    ...
    public void setSignificantPointConditionPositionItem(AIXMPointPropertyType target) {
        setSignificantPointConditionPosition(XmlAdapterUtils.marshallJAXBElement(AIXMPointPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "significantPointCondition_position"), FlightConditionElementType.class, target));
    }
    ...
    public void setSignificantPointConditionRunwayPointItem(RunwayCentrelinePointPropertyType target) {
        setSignificantPointConditionRunwayPoint(XmlAdapterUtils.marshallJAXBElement(RunwayCentrelinePointPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "significantPointCondition_runwayPoint"), FlightConditionElementType.class, target));
    }
    ...
    public void setSignificantPointConditionAimingPointItem(TouchDownLiftOffPropertyType target) {
        setSignificantPointConditionAimingPoint(XmlAdapterUtils.marshallJAXBElement(TouchDownLiftOffPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "significantPointCondition_aimingPoint"), FlightConditionElementType.class, target));
    }
    ...
    public void setSignificantPointConditionAirportReferencePointItem(AirportHeliportPropertyType target) {
        setSignificantPointConditionAirportReferencePoint(XmlAdapterUtils.marshallJAXBElement(AirportHeliportPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "significantPointCondition_airportReferencePoint"), FlightConditionElementType.class, target));
    }
    ...
    public void setFlightConditionAirspaceConditionItem(AirspacePropertyType target) {
        setFlightConditionAirspaceCondition(XmlAdapterUtils.marshallJAXBElement(AirspacePropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "flightCondition_airspaceCondition"), FlightConditionElementType.class, target));
    }
    ...
    public void setFlightConditionAirportHeliportConditionItem(AirportHeliportPropertyType target) {
        setFlightConditionAirportHeliportCondition(XmlAdapterUtils.marshallJAXBElement(AirportHeliportPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "flightCondition_airportHeliportCondition"), FlightConditionElementType.class, target));
    }
    ...
    public void setFlightConditionAerialRefuellingConditionItem(AerialRefuellingPropertyType target) {
        setFlightConditionAerialRefuellingCondition(XmlAdapterUtils.marshallJAXBElement(AerialRefuellingPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "flightCondition_aerialRefuellingCondition"), FlightConditionElementType.class, target));
    }
    ...
    public void setOperationalConditionItem(FlightConditionCircumstancePropertyType target) {
        setOperationalCondition(XmlAdapterUtils.marshallJAXBElement(FlightConditionCircumstancePropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "operationalCondition"), FlightConditionElementType.class, target));
    }
