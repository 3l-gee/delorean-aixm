...
public class RadioFrequencyAreaTimeSliceExtensionType implements Serializable, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        final RadioFrequencyAreaTimeSliceExtensionType that = ((RadioFrequencyAreaTimeSliceExtensionType) object);
        {
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            AbstractExtensionType theField;
            theField = this.getAbstractRadioFrequencyAreaExtension();
            strategy.appendField(locator, this, "abstractRadioFrequencyAreaExtension", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetOwns();
            boolean theField;
