 ...
 *         <element name="type" type="{http://www.aixm.aero/schema/5.2}CodeTaxiwayType" minOccurs="0"/>
 ...
 *         <element name="contaminant" type="{http://www.aixm.aero/schema/5.2}TaxiwayContaminationPropertyType" maxOccurs="unbounded" minOccurs="0"/>
 ...
 *         <element name="diameter" type="{http://www.aixm.aero/schema/5.2}ValDistanceType" minOccurs="0"/>
 ...
 *                 <sequence>
 *                   <element ref="{http://www.aixm.aero/schema/5.2}AbstractTaxiwayExtension"/>
 *                 </sequence>
...
@Table(name = "taxiway_t", schema = "airport_heliport")
    ...
    implements Serializable
{
    ...
    @XmlElementRef(name = "diameter", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<ValDistanceType> diameter;
    ...
    protected List<TaxiwayTimeSliceExtensionType> extension;
    ...
    @JoinTable(name = "txwtmslctp_cntmnnt_link", schema = "airport_heliport", joinColumns = {
        @JoinColumn(name = "taxiway_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "txwtmslctp_annttn_link", schema = "airport_heliport", joinColumns = {
        @JoinColumn(name = "taxiway_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "txwtmslctp_avlblt_link", schema = "airport_heliport", joinColumns = {
        @JoinColumn(name = "taxiway_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
     ...
     */
    @Transient
    public JAXBElement<ValDistanceType> getDiameter() {
        return diameter;
    }
     ...
     *     
     */
    public void setDiameter(JAXBElement<ValDistanceType> value) {
        this.diameter = value;
    }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link TaxiwayTimeSliceExtensionType }
     * 
     * 
     */
    @OneToMany(targetEntity = TaxiwayTimeSliceExtensionType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinColumn(name = "taxiway_te_hjid", referencedColumnName = "hjid")
    public List<TaxiwayTimeSliceExtensionType> getExtension() {
        if (extension == null) {
     ...
     * 
     */
    public void setExtension(List<TaxiwayTimeSliceExtensionType> extension) {
    ...
    public void setDesignatorItem(TextDesignatorType target) {
        setDesignator(XmlAdapterUtils.marshallJAXBElement(TextDesignatorType.class, new QName("http://www.aixm.aero/schema/5.2", "designator"), TaxiwayTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "type", columnDefinition = "codetaxiwaybase")),
    ...
    public void setTypeItem(CodeTaxiwayType target) {
        setType(XmlAdapterUtils.marshallJAXBElement(CodeTaxiwayType.class, new QName("http://www.aixm.aero/schema/5.2", "type"), TaxiwayTimeSliceType.class, target));
    }
    ...
    public void setWidthItem(ValDistanceType target) {
        setWidth(XmlAdapterUtils.marshallJAXBElement(ValDistanceType.class, new QName("http://www.aixm.aero/schema/5.2", "width"), TaxiwayTimeSliceType.class, target));
    }
    ...
    public void setWidthShoulderItem(ValDistanceType target) {
        setWidthShoulder(XmlAdapterUtils.marshallJAXBElement(ValDistanceType.class, new QName("http://www.aixm.aero/schema/5.2", "widthShoulder"), TaxiwayTimeSliceType.class, target));
    }
    ...
    public void setLengthItem(ValDistanceType target) {
        setLength(XmlAdapterUtils.marshallJAXBElement(ValDistanceType.class, new QName("http://www.aixm.aero/schema/5.2", "length"), TaxiwayTimeSliceType.class, target));
    }
    ...
    public void setAbandonedItem(CodeYesNoType target) {
        setAbandoned(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.2", "abandoned"), TaxiwayTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = SurfaceCharacteristicsPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "txwtmslctp_srfcprprts_link", schema = "airport_heliport", joinColumns = {
        @JoinColumn(name = "taxiway_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setSurfacePropertiesItem(SurfaceCharacteristicsPropertyType target) {
        setSurfaceProperties(XmlAdapterUtils.marshallJAXBElement(SurfaceCharacteristicsPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "surfaceProperties"), TaxiwayTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = AirportHeliportPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "txwtmslctp_assctdarprthlprt_link", schema = "airport_heliport", joinColumns = {
        @JoinColumn(name = "taxiway_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setAssociatedAirportHeliportItem(AirportHeliportPropertyType target) {
        setAssociatedAirportHeliport(XmlAdapterUtils.marshallJAXBElement(AirportHeliportPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "associatedAirportHeliport"), TaxiwayTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "diameter", columnDefinition = "valdistancebase")),
        @AttributeOverride(name = "uom", column = @Column(name = "diameteruom", columnDefinition = "uomdistance")),
        @AttributeOverride(name = "accuracy", column = @Column(name = "diameteraccuracy", columnDefinition = "numericalwithnilreason")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "diameternilreason", columnDefinition = "nilreason"))
    })
    public ValDistanceType getDiameterItem() {
        return XmlAdapterUtils.unmarshallSource(ValDistanceType.class, this.getDiameter());
    }

    public void setDiameterItem(ValDistanceType target) {
        setDiameter(XmlAdapterUtils.marshallJAXBElement(ValDistanceType.class, new QName("http://www.aixm.aero/schema/5.2", "diameter"), TaxiwayTimeSliceType.class, target));
    }
    ...
    public void setDepthItem(ValDistanceType target) {
        setDepth(XmlAdapterUtils.marshallJAXBElement(ValDistanceType.class, new QName("http://www.aixm.aero/schema/5.2", "depth"), TaxiwayTimeSliceType.class, target));
    }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        }
        {
            ...
            List<TaxiwayTimeSliceExtensionType> lhsField;
            lhsField = (this.isSetExtension()?this.getExtension():null);
            List<TaxiwayTimeSliceExtensionType> rhsField;
        ...
        {
            boolean lhsFieldIsSet = this.isSetDiameter();
            boolean rhsFieldIsSet = that.isSetDiameter();
            JAXBElement<ValDistanceType> lhsField;
            lhsField = this.getDiameter();
            JAXBElement<ValDistanceType> rhsField;
            rhsField = that.getDiameter();
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "diameter", lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "diameter", rhsField);
            if (!strategy.equals(lhsFieldLocator, rhsFieldLocator, lhsField, rhsField, lhsFieldIsSet, rhsFieldIsSet)) {
                return false;
            }
        }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetDiameter();
            JAXBElement<ValDistanceType> theField;
            theField = this.getDiameter();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "diameter", theField);
            currentHashCode = strategy.hashCode(theFieldLocator, currentHashCode, theField, theFieldIsSet);
        }
        {
        ...
        }
        {
            ...
            List<TaxiwayTimeSliceExtensionType> theField;
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        }
        {
            ...
            JAXBElement<ValDistanceType> theField;
            theField = this.getDiameter();
            strategy.appendField(locator, this, "diameter", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetDepth();
            JAXBElement<ValDistanceType> theField;
