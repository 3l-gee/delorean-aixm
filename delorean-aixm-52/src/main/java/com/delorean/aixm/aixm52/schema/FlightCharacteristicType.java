 ...
 *       <sequence>
 *         <element name="type" type="{http://www.aixm.aero/schema/5.2}CodeFlightType" minOccurs="0"/>
 *         <element name="rule" type="{http://www.aixm.aero/schema/5.2}CodeFlightRuleType" minOccurs="0"/>
 *         <element name="status" type="{http://www.aixm.aero/schema/5.2}CodeFlightStatusType" minOccurs="0"/>
 *         <element name="military" type="{http://www.aixm.aero/schema/5.2}CodeMilitaryStatusType" minOccurs="0"/>
 *         <element name="origin" type="{http://www.aixm.aero/schema/5.2}CodeFlightOriginType" minOccurs="0"/>
 *         <element name="purpose" type="{http://www.aixm.aero/schema/5.2}CodeFlightPurposeType" minOccurs="0"/>
 ...
 *                 <choice>
 *                   <element ref="{http://www.aixm.aero/schema/5.2}AbstractFlightCharacteristicExtension"/>
 *                 </choice>
    ...
    implements Serializable
{
    ...
    @XmlElementRef(name = "rule", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "origin", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    ...
    protected List<FlightCharacteristicExtensionType> extension;
    ...
    @JoinTable(name = "flghtchrctrstctp_annttn_link", schema = "shared", joinColumns = {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link FlightCharacteristicExtensionType }
     * 
     * 
     */
    @OneToMany(targetEntity = FlightCharacteristicExtensionType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinColumn(name = "flightcharacteristic_oe_hjid", referencedColumnName = "hjid")
    public List<FlightCharacteristicExtensionType> getExtension() {
        if (extension == null) {
     ...
     * 
     */
    public void setExtension(List<FlightCharacteristicExtensionType> extension) {
    ...
    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "type", columnDefinition = "codeflightbase")),
    ...
    public void setTypeItem(CodeFlightType target) {
        setType(XmlAdapterUtils.marshallJAXBElement(CodeFlightType.class, new QName("http://www.aixm.aero/schema/5.2", "type"), FlightCharacteristicType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "rule", columnDefinition = "codeflightrulebase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "rulenilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setRuleItem(CodeFlightRuleType target) {
        setRule(XmlAdapterUtils.marshallJAXBElement(CodeFlightRuleType.class, new QName("http://www.aixm.aero/schema/5.2", "rule"), FlightCharacteristicType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "status", columnDefinition = "codeflightstatusbase")),
    ...
    public void setStatusItem(CodeFlightStatusType target) {
        setStatus(XmlAdapterUtils.marshallJAXBElement(CodeFlightStatusType.class, new QName("http://www.aixm.aero/schema/5.2", "status"), FlightCharacteristicType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "military", columnDefinition = "codemilitarystatusbase")),
    ...
    public void setMilitaryItem(CodeMilitaryStatusType target) {
        setMilitary(XmlAdapterUtils.marshallJAXBElement(CodeMilitaryStatusType.class, new QName("http://www.aixm.aero/schema/5.2", "military"), FlightCharacteristicType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "origin", columnDefinition = "codeflightoriginbase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "originnilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setOriginItem(CodeFlightOriginType target) {
        setOrigin(XmlAdapterUtils.marshallJAXBElement(CodeFlightOriginType.class, new QName("http://www.aixm.aero/schema/5.2", "origin"), FlightCharacteristicType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "purpose", columnDefinition = "codeflightpurposebase")),
    ...
    public void setPurposeItem(CodeFlightPurposeType target) {
        setPurpose(XmlAdapterUtils.marshallJAXBElement(CodeFlightPurposeType.class, new QName("http://www.aixm.aero/schema/5.2", "purpose"), FlightCharacteristicType.class, target));
    }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        }
        {
            ...
            List<FlightCharacteristicExtensionType> lhsField;
            lhsField = (this.isSetExtension()?this.getExtension():null);
            List<FlightCharacteristicExtensionType> rhsField;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        }
        {
            ...
            List<FlightCharacteristicExtensionType> theField;
