...
@Entity(name = "InitialLegTimeSliceExtensionType")
@Table(name = "initialleg_te", schema = "procedure")
public class InitialLegTimeSliceExtensionType implements Serializable, Equals, HashCode, ToString
{
    ...
    @JoinColumn(name = "abstractinitiallegextension_hjid", referencedColumnName = "hjid")
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        final InitialLegTimeSliceExtensionType that = ((InitialLegTimeSliceExtensionType) object);
        {
