 ...
 *                 <choice>
 *                   <element ref="{http://www.aixm.aero/schema/5.2}AbstractArrivalFeederLegExtension"/>
...
@Entity(name = "ArrivalFeederLegTimeSliceType")
@Table(name = "arrivalfeederleg_t", schema = "procedure")
    ...
    implements Serializable
{
    ...
    protected List<ArrivalFeederLegTimeSliceExtensionType> extension;
    ...
    @JoinTable(name = "arrvlfdrlgtmslctp_dsgnsrfc_link", schema = "procedure", joinColumns = {
        @JoinColumn(name = "arrivalfeederleg_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "arrvlfdrlgtmslctp_annttn_link", schema = "procedure", joinColumns = {
        @JoinColumn(name = "arrivalfeederleg_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "arrvlfdrlgtmslctp_arcrftcpblt_link", schema = "procedure", joinColumns = {
        @JoinColumn(name = "arrivalfeederleg_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "arrvlfdrlgtmslctp_sgmntcrs_link", schema = "procedure", joinColumns = {
        @JoinColumn(name = "arrivalfeederleg_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "arrvlfdrlgtmslctp_alttdcndtn_link", schema = "procedure", joinColumns = {
        @JoinColumn(name = "arrivalfeederleg_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link ArrivalFeederLegTimeSliceExtensionType }
     * 
     * 
     */
    @OneToMany(targetEntity = ArrivalFeederLegTimeSliceExtensionType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinColumn(name = "arrivalfeederleg_te_hjid", referencedColumnName = "hjid")
    public List<ArrivalFeederLegTimeSliceExtensionType> getExtension() {
        if (extension == null) {
     ...
     * 
     */
    public void setExtension(List<ArrivalFeederLegTimeSliceExtensionType> extension) {
    ...
    public void setEndConditionDesignatorItem(CodeSegmentTerminationType target) {
        setEndConditionDesignator(XmlAdapterUtils.marshallJAXBElement(CodeSegmentTerminationType.class, new QName("http://www.aixm.aero/schema/5.2", "endConditionDesignator"), ArrivalFeederLegTimeSliceType.class, target));
    }
    ...
    public void setLegPathItem(CodeTrajectoryType target) {
        setLegPath(XmlAdapterUtils.marshallJAXBElement(CodeTrajectoryType.class, new QName("http://www.aixm.aero/schema/5.2", "legPath"), ArrivalFeederLegTimeSliceType.class, target));
    }
    ...
    public void setLegTypeARINCItem(CodeSegmentPathType target) {
        setLegTypeARINC(XmlAdapterUtils.marshallJAXBElement(CodeSegmentPathType.class, new QName("http://www.aixm.aero/schema/5.2", "legTypeARINC"), ArrivalFeederLegTimeSliceType.class, target));
    }
    ...
    public void setTurnDirectionItem(CodeDirectionTurnType target) {
        setTurnDirection(XmlAdapterUtils.marshallJAXBElement(CodeDirectionTurnType.class, new QName("http://www.aixm.aero/schema/5.2", "turnDirection"), ArrivalFeederLegTimeSliceType.class, target));
    }
    ...
    public void setSpeedLimitItem(ValSpeedType target) {
        setSpeedLimit(XmlAdapterUtils.marshallJAXBElement(ValSpeedType.class, new QName("http://www.aixm.aero/schema/5.2", "speedLimit"), ArrivalFeederLegTimeSliceType.class, target));
    }
    ...
    public void setSpeedReferenceItem(CodeSpeedReferenceType target) {
        setSpeedReference(XmlAdapterUtils.marshallJAXBElement(CodeSpeedReferenceType.class, new QName("http://www.aixm.aero/schema/5.2", "speedReference"), ArrivalFeederLegTimeSliceType.class, target));
    }
    ...
    public void setSpeedInterpretationItem(CodeSpeedInterpretationUseType target) {
        setSpeedInterpretation(XmlAdapterUtils.marshallJAXBElement(CodeSpeedInterpretationUseType.class, new QName("http://www.aixm.aero/schema/5.2", "speedInterpretation"), ArrivalFeederLegTimeSliceType.class, target));
    }
    ...
    public void setBankAngleItem(ValAngleType target) {
        setBankAngle(XmlAdapterUtils.marshallJAXBElement(ValAngleType.class, new QName("http://www.aixm.aero/schema/5.2", "bankAngle"), ArrivalFeederLegTimeSliceType.class, target));
    }
    ...
    public void setLengthItem(ValDistanceType target) {
        setLength(XmlAdapterUtils.marshallJAXBElement(ValDistanceType.class, new QName("http://www.aixm.aero/schema/5.2", "length"), ArrivalFeederLegTimeSliceType.class, target));
    }
    ...
    public void setDurationItem(ValDurationType target) {
        setDuration(XmlAdapterUtils.marshallJAXBElement(ValDurationType.class, new QName("http://www.aixm.aero/schema/5.2", "duration"), ArrivalFeederLegTimeSliceType.class, target));
    }
    ...
    public void setProcedureTurnRequiredItem(CodeYesNoType target) {
        setProcedureTurnRequired(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.2", "procedureTurnRequired"), ArrivalFeederLegTimeSliceType.class, target));
    }
    ...
    public void setUpperLimitReferenceItem(CodeVerticalReferenceType target) {
        setUpperLimitReference(XmlAdapterUtils.marshallJAXBElement(CodeVerticalReferenceType.class, new QName("http://www.aixm.aero/schema/5.2", "upperLimitReference"), ArrivalFeederLegTimeSliceType.class, target));
    }
    ...
    public void setLowerLimitReferenceItem(CodeVerticalReferenceType target) {
        setLowerLimitReference(XmlAdapterUtils.marshallJAXBElement(CodeVerticalReferenceType.class, new QName("http://www.aixm.aero/schema/5.2", "lowerLimitReference"), ArrivalFeederLegTimeSliceType.class, target));
    }
    ...
    public void setAltitudeOverrideATCItem(ValDistanceVerticalType target) {
        setAltitudeOverrideATC(XmlAdapterUtils.marshallJAXBElement(ValDistanceVerticalType.class, new QName("http://www.aixm.aero/schema/5.2", "altitudeOverrideATC"), ArrivalFeederLegTimeSliceType.class, target));
    }
    ...
    public void setAltitudeOverrideReferenceItem(CodeVerticalReferenceType target) {
        setAltitudeOverrideReference(XmlAdapterUtils.marshallJAXBElement(CodeVerticalReferenceType.class, new QName("http://www.aixm.aero/schema/5.2", "altitudeOverrideReference"), ArrivalFeederLegTimeSliceType.class, target));
    }
    ...
    public void setVerticalAngleItem(ValAngleType target) {
        setVerticalAngle(XmlAdapterUtils.marshallJAXBElement(ValAngleType.class, new QName("http://www.aixm.aero/schema/5.2", "verticalAngle"), ArrivalFeederLegTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = TerminalSegmentPointPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "arrvlfdrlgtmslctp_strtpnt_link", schema = "procedure", joinColumns = {
        @JoinColumn(name = "arrivalfeederleg_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setStartPointItem(TerminalSegmentPointPropertyType target) {
        setStartPoint(XmlAdapterUtils.marshallJAXBElement(TerminalSegmentPointPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "startPoint"), ArrivalFeederLegTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = TerminalSegmentPointPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "arrvlfdrlgtmslctp_endpnt_link", schema = "procedure", joinColumns = {
        @JoinColumn(name = "arrivalfeederleg_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setEndPointItem(TerminalSegmentPointPropertyType target) {
        setEndPoint(XmlAdapterUtils.marshallJAXBElement(TerminalSegmentPointPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "endPoint"), ArrivalFeederLegTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = AIXMCurvePropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "arrvlfdrlgtmslctp_trjctr_link", schema = "procedure", joinColumns = {
        @JoinColumn(name = "arrivalfeederleg_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setTrajectoryItem(AIXMCurvePropertyType target) {
        setTrajectory(XmlAdapterUtils.marshallJAXBElement(AIXMCurvePropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "trajectory"), ArrivalFeederLegTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = TerminalSegmentPointPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "arrvlfdrlgtmslctp_arccntr_link", schema = "procedure", joinColumns = {
        @JoinColumn(name = "arrivalfeederleg_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setArcCentreItem(TerminalSegmentPointPropertyType target) {
        setArcCentre(XmlAdapterUtils.marshallJAXBElement(TerminalSegmentPointPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "arcCentre"), ArrivalFeederLegTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = HoldingUsePropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "arrvlfdrlgtmslctp_hldng_link", schema = "procedure", joinColumns = {
        @JoinColumn(name = "arrivalfeederleg_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setHoldingItem(HoldingUsePropertyType target) {
        setHolding(XmlAdapterUtils.marshallJAXBElement(HoldingUsePropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "holding"), ArrivalFeederLegTimeSliceType.class, target));
    }
    ...
    public void setUpperLimitItem(ValDistanceVerticalType target) {
        setUpperLimit(XmlAdapterUtils.marshallJAXBElement(ValDistanceVerticalType.class, new QName("http://www.aixm.aero/schema/5.2", "upperLimit"), ArrivalFeederLegTimeSliceType.class, target));
    }
    ...
    public void setLowerLimitItem(ValDistanceVerticalType target) {
        setLowerLimit(XmlAdapterUtils.marshallJAXBElement(ValDistanceVerticalType.class, new QName("http://www.aixm.aero/schema/5.2", "lowerLimit"), ArrivalFeederLegTimeSliceType.class, target));
    }
    ...
    public void setVerticalLimitsInterpretationItem(CodeAltitudeUseType target) {
        setVerticalLimitsInterpretation(XmlAdapterUtils.marshallJAXBElement(CodeAltitudeUseType.class, new QName("http://www.aixm.aero/schema/5.2", "verticalLimitsInterpretation"), ArrivalFeederLegTimeSliceType.class, target));
    }
    ...
    public void setRadiusItem(ValDistanceType target) {
        setRadius(XmlAdapterUtils.marshallJAXBElement(ValDistanceType.class, new QName("http://www.aixm.aero/schema/5.2", "radius"), ArrivalFeederLegTimeSliceType.class, target));
    }
    ...
    public void setAdditionalEquipmentItem(CodeAdditionalEquipmentType target) {
        setAdditionalEquipment(XmlAdapterUtils.marshallJAXBElement(CodeAdditionalEquipmentType.class, new QName("http://www.aixm.aero/schema/5.2", "additionalEquipment"), ArrivalFeederLegTimeSliceType.class, target));
    }
    ...
    public void setMinimumObstacleClearanceAltitudeItem(ValDistanceVerticalType target) {
        setMinimumObstacleClearanceAltitude(XmlAdapterUtils.marshallJAXBElement(ValDistanceVerticalType.class, new QName("http://www.aixm.aero/schema/5.2", "minimumObstacleClearanceAltitude"), ArrivalFeederLegTimeSliceType.class, target));
    }
    ...
    public void setMinimumObstacleClearanceHeightItem(ValDistanceVerticalType target) {
        setMinimumObstacleClearanceHeight(XmlAdapterUtils.marshallJAXBElement(ValDistanceVerticalType.class, new QName("http://www.aixm.aero/schema/5.2", "minimumObstacleClearanceHeight"), ArrivalFeederLegTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = DistancePropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "arrvlfdrlgtmslctp_lmtngdstnc_link", schema = "procedure", joinColumns = {
        @JoinColumn(name = "arrivalfeederleg_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setLimitingDistanceItem(DistancePropertyType target) {
        setLimitingDistance(XmlAdapterUtils.marshallJAXBElement(DistancePropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "limitingDistance"), ArrivalFeederLegTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = AnglePropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "arrvlfdrlgtmslctp_lmtngangl_link", schema = "procedure", joinColumns = {
        @JoinColumn(name = "arrivalfeederleg_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setLimitingAngleItem(AnglePropertyType target) {
        setLimitingAngle(XmlAdapterUtils.marshallJAXBElement(AnglePropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "limitingAngle"), ArrivalFeederLegTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = InstrumentApproachProcedurePropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "arrvlfdrlgtmslctp_apprch_link", schema = "procedure", joinColumns = {
        @JoinColumn(name = "arrivalfeederleg_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setApproachItem(InstrumentApproachProcedurePropertyType target) {
        setApproach(XmlAdapterUtils.marshallJAXBElement(InstrumentApproachProcedurePropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "approach"), ArrivalFeederLegTimeSliceType.class, target));
    }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        final ArrivalFeederLegTimeSliceType that = ((ArrivalFeederLegTimeSliceType) object);
        {
        ...
        }
        {
            ...
            List<ArrivalFeederLegTimeSliceExtensionType> lhsField;
            lhsField = (this.isSetExtension()?this.getExtension():null);
            List<ArrivalFeederLegTimeSliceExtensionType> rhsField;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        }
        {
            ...
            List<ArrivalFeederLegTimeSliceExtensionType> theField;
