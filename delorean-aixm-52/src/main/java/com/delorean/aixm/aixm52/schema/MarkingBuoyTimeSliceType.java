 ...
 *       <sequence>
 *         <element name="designator" type="{http://www.aixm.aero/schema/5.2}CodeBuoyDesignatorType" minOccurs="0"/>
 *         <element name="type" type="{http://www.aixm.aero/schema/5.2}CodeBuoyType" minOccurs="0"/>
 *         <element name="colour" type="{http://www.aixm.aero/schema/5.2}CodeColourType" minOccurs="0"/>
 *         <element name="theSeaplaneLandingArea" type="{http://www.aixm.aero/schema/5.2}SeaplaneLandingAreaPropertyType" minOccurs="0"/>
 ...
 *                 <sequence>
 *                   <element ref="{http://www.aixm.aero/schema/5.2}AbstractMarkingBuoyExtension"/>
 *                 </sequence>
    ...
    implements Serializable
{
    ...
    public void setDesignatorItem(CodeBuoyDesignatorType target) {
        setDesignator(XmlAdapterUtils.marshallJAXBElement(CodeBuoyDesignatorType.class, new QName("http://www.aixm.aero/schema/5.2", "designator"), MarkingBuoyTimeSliceType.class, target));
    }
    ...
    public void setTypeItem(CodeBuoyType target) {
        setType(XmlAdapterUtils.marshallJAXBElement(CodeBuoyType.class, new QName("http://www.aixm.aero/schema/5.2", "type"), MarkingBuoyTimeSliceType.class, target));
    }
    ...
    public void setColourItem(CodeColourType target) {
        setColour(XmlAdapterUtils.marshallJAXBElement(CodeColourType.class, new QName("http://www.aixm.aero/schema/5.2", "colour"), MarkingBuoyTimeSliceType.class, target));
    }
    ...
    public void setTheSeaplaneLandingAreaItem(SeaplaneLandingAreaPropertyType target) {
        setTheSeaplaneLandingArea(XmlAdapterUtils.marshallJAXBElement(SeaplaneLandingAreaPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "theSeaplaneLandingArea"), MarkingBuoyTimeSliceType.class, target));
    }
    ...
    public void setLocationItem(AIXMElevatedPointPropertyType target) {
        setLocation(XmlAdapterUtils.marshallJAXBElement(AIXMElevatedPointPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "location"), MarkingBuoyTimeSliceType.class, target));
    }
