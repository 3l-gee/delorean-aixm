...
@Entity(name = "AuthorityForSpecialNavigationStationExtensionType")
@Table(name = "authorityforspecialnavigationstation_oe", schema = "navaids_point")
public class AuthorityForSpecialNavigationStationExtensionType implements Serializable, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        final AuthorityForSpecialNavigationStationExtensionType that = ((AuthorityForSpecialNavigationStationExtensionType) object);
        {
