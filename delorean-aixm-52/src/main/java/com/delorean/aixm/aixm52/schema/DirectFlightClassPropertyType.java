...
/**
 * <p>
 * Java class for DirectFlightClassPropertyType complex type
 * </p>
 * .
 *
 * <p>
 ...
 *       <sequence>
 *         <element ref="{http://www.aixm.aero/schema/5.2}DirectFlightClass"/>
 *       </sequence>
 *     </extension>
 *   </complexContent>
 * </complexType>
...
@XmlType(name = "DirectFlightClassPropertyType", propOrder = {"directFlightClass"})
@Entity(name = "DirectFlightClassPropertyType")
@Table(name = "directflightclasspropertytype", schema = "route")
public class DirectFlightClassPropertyType extends AbstractAIXMPropertyType implements Serializable {
     ...
     *
     * @return possible object is {@link DirectFlightClassType }
     *
     */
    @OneToOne(targetEntity = DirectFlightClassType.class, cascade = {CascadeType.ALL}, fetch = FetchType.EAGER)
     ...
     *
     * @param value
     *            allowed object is {@link DirectFlightClassType }
     *
     */
