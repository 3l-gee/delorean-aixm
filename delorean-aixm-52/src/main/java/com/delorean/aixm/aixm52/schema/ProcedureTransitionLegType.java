...
/**
 * <p>Java class for ProcedureTransitionLegType complex type</p>.
 * 
 ...
 *       <sequence>
 *         <element name="seqNumberARINC" type="{http://www.aixm.aero/schema/5.2}NoSequenceType" minOccurs="0"/>
 *         <element name="annotation" type="{http://www.aixm.aero/schema/5.2}NotePropertyType" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="theSegmentLeg" type="{http://www.aixm.aero/schema/5.2}SegmentLegPropertyType" minOccurs="0"/>
 *         <element name="extension" maxOccurs="unbounded" minOccurs="0">
 *           <complexType>
 *             <complexContent>
 *               <restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 <choice>
 *                   <element ref="{http://www.aixm.aero/schema/5.2}AbstractProcedureTransitionLegExtension"/>
 *                 </choice>
    ...
    implements Serializable
{
    ...
    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "seqnumberarinc", columnDefinition = "nosequencebase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "seqnumberarincnilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setSeqNumberARINCItem(NoSequenceType target) {
        setSeqNumberARINC(XmlAdapterUtils.marshallJAXBElement(NoSequenceType.class, new QName("http://www.aixm.aero/schema/5.2", "seqNumberARINC"), ProcedureTransitionLegType.class, target));
    }
    ...
    public void setTheSegmentLegItem(SegmentLegPropertyType target) {
        setTheSegmentLeg(XmlAdapterUtils.marshallJAXBElement(SegmentLegPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "theSegmentLeg"), ProcedureTransitionLegType.class, target));
    }
