 ...
 *       <sequence>
 *         <element name="callSign" type="{http://www.aixm.aero/schema/5.2}TextNameType" minOccurs="0"/>
 *         <element name="language" type="{http://www.aixm.aero/schema/5.2}CodeLanguageType" minOccurs="0"/>
 ...
 *                 <choice>
 *                   <element ref="{http://www.aixm.aero/schema/5.2}AbstractCallsignDetailExtension"/>
 *                 </choice>
    ...
    implements Serializable
{
     ...
     * 
     */
    @OneToMany(targetEntity = CallsignDetailExtensionType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    ...
    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "callsign", columnDefinition = "character2")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "callsignnilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setCallSignItem(TextNameType target) {
        setCallSign(XmlAdapterUtils.marshallJAXBElement(TextNameType.class, new QName("http://www.aixm.aero/schema/5.2", "callSign"), CallsignDetailType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "language", columnDefinition = "codelanguagebase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "languagenilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setLanguageItem(CodeLanguageType target) {
        setLanguage(XmlAdapterUtils.marshallJAXBElement(CodeLanguageType.class, new QName("http://www.aixm.aero/schema/5.2", "language"), CallsignDetailType.class, target));
    }
