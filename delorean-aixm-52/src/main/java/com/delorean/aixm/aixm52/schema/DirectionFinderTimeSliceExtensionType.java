...
@XmlType(name = "", propOrder = {"abstractDirectionFinderExtension", "abstractNavaidEquipmentExtension"})
@Entity(name = "DirectionFinderTimeSliceExtensionType")
@Table(name = "directionfinder_te", schema = "navaids_point")
public class DirectionFinderTimeSliceExtensionType implements Serializable, Equals, HashCode, ToString {
    ...
    @JoinColumn(name = "abstractdirectionfinderextension_hjid", referencedColumnName = "hjid")
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final DirectionFinderTimeSliceExtensionType that = ((DirectionFinderTimeSliceExtensionType) object);
        {
            ...
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "abstractDirectionFinderExtension",
                    lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "abstractDirectionFinderExtension",
                    rhsField);
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetAbstractDirectionFinderExtension();
            AbstractExtensionType theField;
            theField = this.getAbstractDirectionFinderExtension();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "abstractDirectionFinderExtension",
                    theField);
        ...
        }
        {
            ...
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "abstractNavaidEquipmentExtension",
                    theField);
            currentHashCode = strategy.hashCode(theFieldLocator, currentHashCode, theField, theFieldIsSet);
        }
        {
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            AbstractExtensionType theField;
            theField = this.getAbstractDirectionFinderExtension();
            strategy.appendField(locator, this, "abstractDirectionFinderExtension", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetAbstractNavaidEquipmentExtension();
            AbstractExtensionType theField;
