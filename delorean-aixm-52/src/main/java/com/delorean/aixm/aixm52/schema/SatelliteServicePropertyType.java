...
/**
 * <p>Java class for SatelliteServicePropertyType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="SatelliteServicePropertyType">
 *   <complexContent>
...
@XmlType(name = "SatelliteServicePropertyType")
@Entity(name = "SatelliteServicePropertyType")
@Table(name = "satelliteservice_p", schema = "navaids_point")
public class SatelliteServicePropertyType implements Serializable, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        final SatelliteServicePropertyType that = ((SatelliteServicePropertyType) object);
        {
