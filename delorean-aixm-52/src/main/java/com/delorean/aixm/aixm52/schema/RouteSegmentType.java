...
"{http://www.aixm.aero/schema/5.2}RouteSegmentTimeSlicePropertyType" maxOccurs=
"unbounded"/>
 *       </sequence>
 *     </extension>
 *   </complexContent>
...
@XmlType(name = "RouteSegmentType", propOrder = {"timeSlice"})
@Entity(name = "RouteSegmentType")
@Table(name = "routesegment_f", schema = "route")
public class RouteSegmentType extends AbstractAIXMFeatureType implements Serializable {
     ...
     * {@link RouteSegmentTimeSlicePropertyType }
     *
     *
     */
    @Filter(name = "TPHjidFilter", condition = "hjid IN (:ids)")
    @OneToMany(targetEntity = RouteSegmentTimeSlicePropertyType.class, cascade = {
            CascadeType.ALL}, fetch = FetchType.EAGER)
    @JoinColumn(name = "timeslice_hjid", referencedColumnName = "hjid")
    public List<RouteSegmentTimeSlicePropertyType> getTimeSlice() {
        if (timeSlice == null) {
     ...
     *
     */
    public void setTimeSlice(List<RouteSegmentTimeSlicePropertyType> timeSlice) {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final RouteSegmentType that = ((RouteSegmentType) object);
        {
            ...
            List<RouteSegmentTimeSlicePropertyType> lhsField;
            lhsField = (this.isSetTimeSlice() ? this.getTimeSlice() : null);
            List<RouteSegmentTimeSlicePropertyType> rhsField;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = super.hashCode(locator, strategy);
        {
            ...
            List<RouteSegmentTimeSlicePropertyType> theField;
