...
/**
 * <p>Java class for DistanceType complex type</p>.
 * 
 ...
 *         <element name="type" type="{http://www.aixm.aero/schema/5.2}CodeDistanceIndicationType" minOccurs="0"/>
 *         <choice>
 ...
 *                 <choice>
 *                   <element ref="{http://www.aixm.aero/schema/5.2}AbstractDistanceExtension"/>
 *                 </choice>
...
@Table(name = "distance_o", schema = "navaids_point")
    ...
    implements Serializable
{
    ...
    protected List<DistanceExtensionType> extension;
    ...
    @JoinTable(name = "dstnctp_annttn_link", schema = "navaids_point", joinColumns = {
        @JoinColumn(name = "distance_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link DistanceExtensionType }
     * 
     * 
     */
    @OneToMany(targetEntity = DistanceExtensionType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinColumn(name = "distance_oe_hjid", referencedColumnName = "hjid")
    public List<DistanceExtensionType> getExtension() {
        if (extension == null) {
     ...
     * 
     */
    public void setExtension(List<DistanceExtensionType> extension) {
    ...
    public void setDistanceItem(ValDistanceType target) {
        setDistance(XmlAdapterUtils.marshallJAXBElement(ValDistanceType.class, new QName("http://www.aixm.aero/schema/5.2", "distance"), DistanceType.class, target));
    }
    ...
    public void setMinimumReceptionAltitudeItem(ValDistanceVerticalType target) {
        setMinimumReceptionAltitude(XmlAdapterUtils.marshallJAXBElement(ValDistanceVerticalType.class, new QName("http://www.aixm.aero/schema/5.2", "minimumReceptionAltitude"), DistanceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "type", columnDefinition = "codedistanceindicationbase")),
    ...
    public void setTypeItem(CodeDistanceIndicationType target) {
        setType(XmlAdapterUtils.marshallJAXBElement(CodeDistanceIndicationType.class, new QName("http://www.aixm.aero/schema/5.2", "type"), DistanceType.class, target));
    }

    @OneToOne(targetEntity = DesignatedPointPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "dstnctp_pntchcfxdsgntdpnt_link", schema = "navaids_point", joinColumns = {
        @JoinColumn(name = "distance_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setPointChoiceFixDesignatedPointItem(DesignatedPointPropertyType target) {
        setPointChoiceFixDesignatedPoint(XmlAdapterUtils.marshallJAXBElement(DesignatedPointPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "pointChoice_fixDesignatedPoint"), DistanceType.class, target));
    }

    @OneToOne(targetEntity = NavaidPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "dstnctp_pntchcnvdsstm_link", schema = "navaids_point", joinColumns = {
        @JoinColumn(name = "distance_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setPointChoiceNavaidSystemItem(NavaidPropertyType target) {
        setPointChoiceNavaidSystem(XmlAdapterUtils.marshallJAXBElement(NavaidPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "pointChoice_navaidSystem"), DistanceType.class, target));
    }

    @OneToOne(targetEntity = AIXMPointPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "dstnctp_pntchcpstn_link", schema = "navaids_point", joinColumns = {
        @JoinColumn(name = "distance_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setPointChoicePositionItem(AIXMPointPropertyType target) {
        setPointChoicePosition(XmlAdapterUtils.marshallJAXBElement(AIXMPointPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "pointChoice_position"), DistanceType.class, target));
    }

    @OneToOne(targetEntity = RunwayCentrelinePointPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "dstnctp_pntchcrnwpnt_link", schema = "navaids_point", joinColumns = {
        @JoinColumn(name = "distance_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setPointChoiceRunwayPointItem(RunwayCentrelinePointPropertyType target) {
        setPointChoiceRunwayPoint(XmlAdapterUtils.marshallJAXBElement(RunwayCentrelinePointPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "pointChoice_runwayPoint"), DistanceType.class, target));
    }

    @OneToOne(targetEntity = TouchDownLiftOffPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "dstnctp_pntchcamngpnt_link", schema = "navaids_point", joinColumns = {
        @JoinColumn(name = "distance_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setPointChoiceAimingPointItem(TouchDownLiftOffPropertyType target) {
        setPointChoiceAimingPoint(XmlAdapterUtils.marshallJAXBElement(TouchDownLiftOffPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "pointChoice_aimingPoint"), DistanceType.class, target));
    }

    @OneToOne(targetEntity = AirportHeliportPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "dstnctp_pntchcarprtrfrncpnt_link", schema = "navaids_point", joinColumns = {
        @JoinColumn(name = "distance_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setPointChoiceAirportReferencePointItem(AirportHeliportPropertyType target) {
        setPointChoiceAirportReferencePoint(XmlAdapterUtils.marshallJAXBElement(AirportHeliportPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "pointChoice_airportReferencePoint"), DistanceType.class, target));
    }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        }
        {
            ...
            List<DistanceExtensionType> lhsField;
            lhsField = (this.isSetExtension()?this.getExtension():null);
            List<DistanceExtensionType> rhsField;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        }
        {
            ...
            List<DistanceExtensionType> theField;
