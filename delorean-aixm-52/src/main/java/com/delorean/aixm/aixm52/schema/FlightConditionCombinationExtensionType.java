...
@Entity(name = "FlightConditionCombinationExtensionType")
@Table(name = "flightconditioncombination_oe", schema = "route")
public class FlightConditionCombinationExtensionType implements Serializable, Equals, HashCode, ToString
{
    ...
    @JoinColumn(name = "abstractflightconditioncombinationextension_hjid", referencedColumnName = "hjid")
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        final FlightConditionCombinationExtensionType that = ((FlightConditionCombinationExtensionType) object);
        {
