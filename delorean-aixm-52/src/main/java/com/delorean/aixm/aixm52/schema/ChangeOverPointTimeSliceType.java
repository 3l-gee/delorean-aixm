 ...
 *         </choice>
 *         <element name="applicableRoutePortion" type="{http://www.aixm.aero/schema/5.2}RoutePortionPropertyType" minOccurs="0"/>
 ...
 *                 <sequence>
 *                   <element ref="{http://www.aixm.aero/schema/5.2}AbstractChangeOverPointExtension"/>
 *                 </sequence>
...
@Table(name = "changeoverpoint_t", schema = "route")
    ...
    implements Serializable
{
    ...
    @XmlElementRef(name = "applicableRoutePortion", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<RoutePortionPropertyType> applicableRoutePortion;
    @XmlElement(nillable = true)
    protected List<NotePropertyType> annotation;
    protected List<ChangeOverPointTimeSliceExtensionType> extension;
    ...
    @JoinTable(name = "chngovrpnttmslctp_annttn_link", schema = "route", joinColumns = {
        @JoinColumn(name = "changeoverpoint_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link ChangeOverPointTimeSliceExtensionType }
     * 
     * 
     */
    @OneToMany(targetEntity = ChangeOverPointTimeSliceExtensionType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinColumn(name = "changeoverpoint_te_hjid", referencedColumnName = "hjid")
    public List<ChangeOverPointTimeSliceExtensionType> getExtension() {
        if (extension == null) {
     ...
     * 
     */
    public void setExtension(List<ChangeOverPointTimeSliceExtensionType> extension) {
    ...
    public void setDistanceItem(ValDistanceType target) {
        setDistance(XmlAdapterUtils.marshallJAXBElement(ValDistanceType.class, new QName("http://www.aixm.aero/schema/5.2", "distance"), ChangeOverPointTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = DesignatedPointPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "chngovrpnttmslctp_lctnfxdsgntdpnt_link", schema = "route", joinColumns = {
        @JoinColumn(name = "changeoverpoint_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setLocationFixDesignatedPointItem(DesignatedPointPropertyType target) {
        setLocationFixDesignatedPoint(XmlAdapterUtils.marshallJAXBElement(DesignatedPointPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "location_fixDesignatedPoint"), ChangeOverPointTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = NavaidPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "chngovrpnttmslctp_lctnnvdsstm_link", schema = "route", joinColumns = {
        @JoinColumn(name = "changeoverpoint_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setLocationNavaidSystemItem(NavaidPropertyType target) {
        setLocationNavaidSystem(XmlAdapterUtils.marshallJAXBElement(NavaidPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "location_navaidSystem"), ChangeOverPointTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = AIXMPointPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "chngovrpnttmslctp_lctnpstn_link", schema = "route", joinColumns = {
        @JoinColumn(name = "changeoverpoint_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setLocationPositionItem(AIXMPointPropertyType target) {
        setLocationPosition(XmlAdapterUtils.marshallJAXBElement(AIXMPointPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "location_position"), ChangeOverPointTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = RunwayCentrelinePointPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "chngovrpnttmslctp_lctnrnwpnt_link", schema = "route", joinColumns = {
        @JoinColumn(name = "changeoverpoint_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setLocationRunwayPointItem(RunwayCentrelinePointPropertyType target) {
        setLocationRunwayPoint(XmlAdapterUtils.marshallJAXBElement(RunwayCentrelinePointPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "location_runwayPoint"), ChangeOverPointTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = TouchDownLiftOffPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "chngovrpnttmslctp_lctnamngpnt_link", schema = "route", joinColumns = {
        @JoinColumn(name = "changeoverpoint_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setLocationAimingPointItem(TouchDownLiftOffPropertyType target) {
        setLocationAimingPoint(XmlAdapterUtils.marshallJAXBElement(TouchDownLiftOffPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "location_aimingPoint"), ChangeOverPointTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = AirportHeliportPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "chngovrpnttmslctp_lctnarprtrfrncpnt_link", schema = "route", joinColumns = {
        @JoinColumn(name = "changeoverpoint_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setLocationAirportReferencePointItem(AirportHeliportPropertyType target) {
        setLocationAirportReferencePoint(XmlAdapterUtils.marshallJAXBElement(AirportHeliportPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "location_airportReferencePoint"), ChangeOverPointTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = RoutePortionPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "chngovrpnttmslctp_applcblrtprtn_link", schema = "route", joinColumns = {
        @JoinColumn(name = "changeoverpoint_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setApplicableRoutePortionItem(RoutePortionPropertyType target) {
        setApplicableRoutePortion(XmlAdapterUtils.marshallJAXBElement(RoutePortionPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "applicableRoutePortion"), ChangeOverPointTimeSliceType.class, target));
    }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        }
        {
            ...
            List<ChangeOverPointTimeSliceExtensionType> lhsField;
            lhsField = (this.isSetExtension()?this.getExtension():null);
            List<ChangeOverPointTimeSliceExtensionType> rhsField;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        }
        {
            ...
            List<ChangeOverPointTimeSliceExtensionType> theField;
