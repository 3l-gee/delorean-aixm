...
/**
 * <p>Java class for RadioFrequencyType complex type</p>.
 * 
    ...
    implements Serializable
{
    ...
    @JoinTable(name = "rdfrqnctp_annttn_link", schema = "navaids_point", joinColumns = {
        @JoinColumn(name = "radiofrequency_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
     ...
     * 
     */
    @OneToMany(targetEntity = RadioFrequencyExtensionType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    ...
    public void setFrequencyItem(ValFrequencyType target) {
        setFrequency(XmlAdapterUtils.marshallJAXBElement(ValFrequencyType.class, new QName("http://www.aixm.aero/schema/5.2", "frequency"), RadioFrequencyType.class, target));
    }
