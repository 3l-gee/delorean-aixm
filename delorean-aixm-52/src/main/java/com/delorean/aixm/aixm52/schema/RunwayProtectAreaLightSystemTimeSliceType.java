 ...
 *         <element name="position" type="{http://www.aixm.aero/schema/5.2}CodeProtectAreaSectionType" minOccurs="0"/>
 *         <element name="lightedArea" type="{http://www.aixm.aero/schema/5.2}RunwayProtectAreaPropertyType" minOccurs="0"/>
 ...
 *                 <choice>
 *                   <element ref="{http://www.aixm.aero/schema/5.2}AbstractRunwayProtectAreaLightSystemExtension"/>
    ...
    implements Serializable
{
    ...
    @XmlElementRef(name = "lightedArea", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    ...
    public void setEmergencyLightingItem(CodeYesNoType target) {
        setEmergencyLighting(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.2", "emergencyLighting"), RunwayProtectAreaLightSystemTimeSliceType.class, target));
    }
    ...
    public void setIntensityLevelItem(CodeLightIntensityType target) {
        setIntensityLevel(XmlAdapterUtils.marshallJAXBElement(CodeLightIntensityType.class, new QName("http://www.aixm.aero/schema/5.2", "intensityLevel"), RunwayProtectAreaLightSystemTimeSliceType.class, target));
    }
    ...
    public void setColourItem(CodeColourType target) {
        setColour(XmlAdapterUtils.marshallJAXBElement(CodeColourType.class, new QName("http://www.aixm.aero/schema/5.2", "colour"), RunwayProtectAreaLightSystemTimeSliceType.class, target));
    }
    ...
    public void setPositionItem(CodeProtectAreaSectionType target) {
        setPosition(XmlAdapterUtils.marshallJAXBElement(CodeProtectAreaSectionType.class, new QName("http://www.aixm.aero/schema/5.2", "position"), RunwayProtectAreaLightSystemTimeSliceType.class, target));
    }
    ...
    public void setLightedAreaItem(RunwayProtectAreaPropertyType target) {
        setLightedArea(XmlAdapterUtils.marshallJAXBElement(RunwayProtectAreaPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "lightedArea"), RunwayProtectAreaLightSystemTimeSliceType.class, target));
    }
    ...
    public void setLengthItem(ValDistanceType target) {
        setLength(XmlAdapterUtils.marshallJAXBElement(ValDistanceType.class, new QName("http://www.aixm.aero/schema/5.2", "length"), RunwayProtectAreaLightSystemTimeSliceType.class, target));
    }
