...
@Entity(name = "SearchRescueServiceTimeSliceExtensionType")
@Table(name = "searchrescueservice_te", schema = "service")
public class SearchRescueServiceTimeSliceExtensionType implements Serializable, Equals, HashCode, ToString
{
