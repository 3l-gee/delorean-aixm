 ...
 *         <element name="legSeparation" type="{http://www.aixm.aero/schema/5.2}ValDistanceType" minOccurs="0"/>
 *         <element name="legLength" type="{http://www.aixm.aero/schema/5.2}ValDistanceType" minOccurs="0"/>
 *         <element name="refuellingBaseLevel" type="{http://www.aixm.aero/schema/5.2}ValDistanceVerticalType" minOccurs="0"/>
 *         <element name="refuellingBaseLevelReference" type="{http://www.aixm.aero/schema/5.2}CodeVerticalReferenceType" minOccurs="0"/>
 *         <element name="extent" type="{http://www.aixm.aero/schema/5.2}SurfacePropertyType" minOccurs="0"/>
 *         <element name="verticalExtent" type="{http://www.aixm.aero/schema/5.2}AirspaceLayerPropertyType" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="point" type="{http://www.aixm.aero/schema/5.2}AerialRefuellingPointPropertyType" maxOccurs="unbounded" minOccurs="0"/>
 ...
 *                 <choice>
 *                   <element ref="{http://www.aixm.aero/schema/5.2}AbstractAerialRefuellingAnchorExtension"/>
 *                 </choice>
    ...
    implements Serializable
{
    ...
    @JoinTable(name = "arlrfllnganchrtp_otbndcrs_l", schema = "aerial_refuelling", joinColumns = {
    ...
    @JoinTable(name = "arlrfllnganchrtp_inbndcrs_l", schema = "aerial_refuelling", joinColumns = {
        @JoinColumn(name = "aerialrefuellinganchor_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setTurnDirectionItem(CodeDirectionTurnType target) {
        setTurnDirection(XmlAdapterUtils.marshallJAXBElement(CodeDirectionTurnType.class, new QName("http://www.aixm.aero/schema/5.2", "turnDirection"), AerialRefuellingAnchorType.class, target));
    }
    ...
    public void setSpeedLimitItem(ValSpeedType target) {
        setSpeedLimit(XmlAdapterUtils.marshallJAXBElement(ValSpeedType.class, new QName("http://www.aixm.aero/schema/5.2", "speedLimit"), AerialRefuellingAnchorType.class, target));
    }
    ...
    @AttributeOverrides({
        ...
        @AttributeOverride(name = "accuracy", column = @Column(name = "legseparationaccuracy", columnDefinition = "numericalwithnilreason")),
    ...
    public void setLegSeparationItem(ValDistanceType target) {
        setLegSeparation(XmlAdapterUtils.marshallJAXBElement(ValDistanceType.class, new QName("http://www.aixm.aero/schema/5.2", "legSeparation"), AerialRefuellingAnchorType.class, target));
    }
    ...
    @AttributeOverrides({
        ...
        @AttributeOverride(name = "accuracy", column = @Column(name = "leglengthaccuracy", columnDefinition = "numericalwithnilreason")),
    ...
    public void setLegLengthItem(ValDistanceType target) {
        setLegLength(XmlAdapterUtils.marshallJAXBElement(ValDistanceType.class, new QName("http://www.aixm.aero/schema/5.2", "legLength"), AerialRefuellingAnchorType.class, target));
    }
    ...
    @AttributeOverrides({
        ...
        @AttributeOverride(name = "accuracy", column = @Column(name = "refuellingbaselevelaccuracy", columnDefinition = "numericalwithnilreason")),
    ...
    public void setRefuellingBaseLevelItem(ValDistanceVerticalType target) {
        setRefuellingBaseLevel(XmlAdapterUtils.marshallJAXBElement(ValDistanceVerticalType.class, new QName("http://www.aixm.aero/schema/5.2", "refuellingBaseLevel"), AerialRefuellingAnchorType.class, target));
    }
    ...
    public void setRefuellingBaseLevelReferenceItem(CodeVerticalReferenceType target) {
        setRefuellingBaseLevelReference(XmlAdapterUtils.marshallJAXBElement(CodeVerticalReferenceType.class, new QName("http://www.aixm.aero/schema/5.2", "refuellingBaseLevelReference"), AerialRefuellingAnchorType.class, target));
    }
    ...
    public void setExtentItem(AIXMSurfacePropertyType target) {
        setExtent(XmlAdapterUtils.marshallJAXBElement(AIXMSurfacePropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "extent"), AerialRefuellingAnchorType.class, target));
    }
