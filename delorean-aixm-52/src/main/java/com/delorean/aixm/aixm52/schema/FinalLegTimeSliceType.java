 ...
 *       <sequence>
 *         <element name="endConditionDesignator" type="{http://www.aixm.aero/schema/5.2}CodeSegmentTerminationType" minOccurs="0"/>
 *         <element name="legPath" type="{http://www.aixm.aero/schema/5.2}CodeTrajectoryType" minOccurs="0"/>
 *         <element name="legTypeARINC" type="{http://www.aixm.aero/schema/5.2}CodeSegmentPathType" minOccurs="0"/>
 ...
 *         <element name="speedReference" type="{http://www.aixm.aero/schema/5.2}CodeSpeedReferenceType" minOccurs="0"/>
 *         <element name="speedInterpretation" type="{http://www.aixm.aero/schema/5.2}CodeSpeedInterpretationUseType" minOccurs="0"/>
 *         <element name="bankAngle" type="{http://www.aixm.aero/schema/5.2}ValAngleType" minOccurs="0"/>
 *         <element name="length" type="{http://www.aixm.aero/schema/5.2}ValDistanceType" minOccurs="0"/>
 *         <element name="duration" type="{http://www.aixm.aero/schema/5.2}ValDurationType" minOccurs="0"/>
 *         <element name="procedureTurnRequired" type="{http://www.aixm.aero/schema/5.2}CodeYesNoType" minOccurs="0"/>
 ...
 *         <element name="altitudeOverrideATC" type="{http://www.aixm.aero/schema/5.2}ValDistanceVerticalType" minOccurs="0"/>
 *         <element name="altitudeOverrideReference" type="{http://www.aixm.aero/schema/5.2}CodeVerticalReferenceType" minOccurs="0"/>
 *         <element name="verticalAngle" type="{http://www.aixm.aero/schema/5.2}ValAngleType" minOccurs="0"/>
 *         <element name="startPoint" type="{http://www.aixm.aero/schema/5.2}TerminalSegmentPointPropertyType" minOccurs="0"/>
 *         <element name="endPoint" type="{http://www.aixm.aero/schema/5.2}TerminalSegmentPointPropertyType" minOccurs="0"/>
 *         <element name="trajectory" type="{http://www.aixm.aero/schema/5.2}CurvePropertyType" minOccurs="0"/>
 *         <element name="arcCentre" type="{http://www.aixm.aero/schema/5.2}TerminalSegmentPointPropertyType" minOccurs="0"/>
 *         <element name="holding" type="{http://www.aixm.aero/schema/5.2}HoldingUsePropertyType" minOccurs="0"/>
 ...
 *         <element name="verticalLimitsInterpretation" type="{http://www.aixm.aero/schema/5.2}CodeAltitudeUseType" minOccurs="0"/>
 ...
 *         <element name="minimumObstacleClearanceAltitude" type="{http://www.aixm.aero/schema/5.2}ValDistanceVerticalType" minOccurs="0"/>
 *         <element name="minimumObstacleClearanceHeight" type="{http://www.aixm.aero/schema/5.2}ValDistanceVerticalType" minOccurs="0"/>
 ...
 *         <element name="segmentCourse" type="{http://www.aixm.aero/schema/5.2}CourseGroupPropertyType" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="altitudeCondition" type="{http://www.aixm.aero/schema/5.2}SegmentLegAltitudeConditionPropertyType" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="limitingDistance" type="{http://www.aixm.aero/schema/5.2}DistancePropertyType" minOccurs="0"/>
 *         <element name="limitingAngle" type="{http://www.aixm.aero/schema/5.2}AnglePropertyType" minOccurs="0"/>
 *         <element name="approach" type="{http://www.aixm.aero/schema/5.2}InstrumentApproachProcedurePropertyType" minOccurs="0"/>
 *         <element name="courseOffsetAngle" type="{http://www.aixm.aero/schema/5.2}ValBearingType" minOccurs="0"/>
 *         <element name="courseOffsetSide" type="{http://www.aixm.aero/schema/5.2}CodeSideType" minOccurs="0"/>
 *         <element name="courseCentrelineDistance" type="{http://www.aixm.aero/schema/5.2}ValDistanceType" minOccurs="0"/>
 *         <element name="courseOffsetDistance" type="{http://www.aixm.aero/schema/5.2}ValDistanceType" minOccurs="0"/>
 *         <element name="courseCentrelineIntersect" type="{http://www.aixm.aero/schema/5.2}CodeRelativePositionType" minOccurs="0"/>
 *         <element name="condition" type="{http://www.aixm.aero/schema/5.2}ApproachConditionPropertyType" maxOccurs="unbounded" minOccurs="0"/>
 *         <choice>
 *           <element name="finalPathAlignmentPoint_fixDesignatedPoint" type="{http://www.aixm.aero/schema/5.2}DesignatedPointPropertyType" minOccurs="0"/>
 *           <element name="finalPathAlignmentPoint_navaidSystem" type="{http://www.aixm.aero/schema/5.2}NavaidPropertyType" minOccurs="0"/>
 *           <element name="finalPathAlignmentPoint_position" type="{http://www.aixm.aero/schema/5.2}PointPropertyType" minOccurs="0"/>
 *           <element name="finalPathAlignmentPoint_runwayPoint" type="{http://www.aixm.aero/schema/5.2}RunwayCentrelinePointPropertyType" minOccurs="0"/>
 *           <element name="finalPathAlignmentPoint_aimingPoint" type="{http://www.aixm.aero/schema/5.2}TouchDownLiftOffPropertyType" minOccurs="0"/>
 *           <element name="finalPathAlignmentPoint_airportReferencePoint" type="{http://www.aixm.aero/schema/5.2}AirportHeliportPropertyType" minOccurs="0"/>
 *         </choice>
 *         <element name="visualDescentPoint" type="{http://www.aixm.aero/schema/5.2}TerminalSegmentPointPropertyType" minOccurs="0"/>
 *         <element name="FASData" type="{http://www.aixm.aero/schema/5.2}FinalApproachSegmentDataPropertyType" minOccurs="0"/>
 *         <element name="extension" maxOccurs="unbounded" minOccurs="0">
 *           <complexType>
 *             <complexContent>
 *               <restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 <choice>
 *                   <element ref="{http://www.aixm.aero/schema/5.2}AbstractFinalLegExtension"/>
 *                   <element ref="{http://www.aixm.aero/schema/5.2}AbstractApproachLegExtension"/>
 *                   <element ref="{http://www.aixm.aero/schema/5.2}AbstractSegmentLegExtension"/>
 *                 </choice>
...
@XmlType(name = "FinalLegTimeSliceType", propOrder = {
    ...
    "minimumObstacleClearanceHeight",
    "aircraftCapability",
    "segmentCourse",
    "altitudeCondition",
    "limitingDistance",
...
@Table(name = "finalleg_t", schema = "procedure")
    ...
    implements Serializable
{
    ...
    @XmlElementRef(name = "courseOffsetAngle", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<ValBearingType> courseOffsetAngle;
    @XmlElementRef(name = "courseOffsetSide", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<CodeSideType> courseOffsetSide;
    @XmlElementRef(name = "courseCentrelineDistance", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<ValDistanceType> courseCentrelineDistance;
    @XmlElementRef(name = "courseOffsetDistance", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<ValDistanceType> courseOffsetDistance;
    @XmlElementRef(name = "courseCentrelineIntersect", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "finalPathAlignmentPoint_fixDesignatedPoint", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<DesignatedPointPropertyType> finalPathAlignmentPointFixDesignatedPoint;
    @XmlElementRef(name = "finalPathAlignmentPoint_navaidSystem", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<NavaidPropertyType> finalPathAlignmentPointNavaidSystem;
    @XmlElementRef(name = "finalPathAlignmentPoint_position", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<AIXMPointPropertyType> finalPathAlignmentPointPosition;
    @XmlElementRef(name = "finalPathAlignmentPoint_runwayPoint", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<RunwayCentrelinePointPropertyType> finalPathAlignmentPointRunwayPoint;
    @XmlElementRef(name = "finalPathAlignmentPoint_aimingPoint", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<TouchDownLiftOffPropertyType> finalPathAlignmentPointAimingPoint;
    @XmlElementRef(name = "finalPathAlignmentPoint_airportReferencePoint", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<AirportHeliportPropertyType> finalPathAlignmentPointAirportReferencePoint;
    @XmlElementRef(name = "visualDescentPoint", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<TerminalSegmentPointPropertyType> visualDescentPoint;
    @XmlElementRef(name = "FASData", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<FinalApproachSegmentDataPropertyType> fasData;
    protected List<FinalLegTimeSliceExtensionType> extension;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link CodeSpeedInterpretationUseType }{@code >}
     *     
     */
    @Transient
    ...
    @JoinTable(name = "fnllgtmslctp_dsgnsrfc_link", schema = "procedure", joinColumns = {
        @JoinColumn(name = "finalleg_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "fnllgtmslctp_annttn_link", schema = "procedure", joinColumns = {
        @JoinColumn(name = "finalleg_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "fnllgtmslctp_arcrftcpblt_link", schema = "procedure", joinColumns = {
        @JoinColumn(name = "finalleg_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the segmentCourse property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
    ...
    @JoinTable(name = "fnllgtmslctp_sgmntcrs_link", schema = "procedure", joinColumns = {
        @JoinColumn(name = "finalleg_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the altitudeCondition property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
    ...
    @JoinTable(name = "fnllgtmslctp_alttdcndtn_link", schema = "procedure", joinColumns = {
        @JoinColumn(name = "finalleg_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link DistancePropertyType }{@code >}
     *     
     */
    @Transient
    ...
    @JoinTable(name = "fnllgtmslctp_cndtn_link", schema = "procedure", joinColumns = {
        @JoinColumn(name = "finalleg_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link FinalApproachSegmentDataPropertyType }{@code >}
     *     
     */
    @Transient
    public JAXBElement<FinalApproachSegmentDataPropertyType> getFASData() {
        return fasData;
    }
     ...
     *     
     */
    public void setFASData(JAXBElement<FinalApproachSegmentDataPropertyType> value) {
        this.fasData = value;
    }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link FinalLegTimeSliceExtensionType }
     * 
     * 
     */
    @OneToMany(targetEntity = FinalLegTimeSliceExtensionType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinColumn(name = "finalleg_te_hjid", referencedColumnName = "hjid")
    public List<FinalLegTimeSliceExtensionType> getExtension() {
        if (extension == null) {
     ...
     * 
     */
    public void setExtension(List<FinalLegTimeSliceExtensionType> extension) {
    ...
    public void setEndConditionDesignatorItem(CodeSegmentTerminationType target) {
        setEndConditionDesignator(XmlAdapterUtils.marshallJAXBElement(CodeSegmentTerminationType.class, new QName("http://www.aixm.aero/schema/5.2", "endConditionDesignator"), FinalLegTimeSliceType.class, target));
    }
    ...
    public void setLegPathItem(CodeTrajectoryType target) {
        setLegPath(XmlAdapterUtils.marshallJAXBElement(CodeTrajectoryType.class, new QName("http://www.aixm.aero/schema/5.2", "legPath"), FinalLegTimeSliceType.class, target));
    }
    ...
    public void setLegTypeARINCItem(CodeSegmentPathType target) {
        setLegTypeARINC(XmlAdapterUtils.marshallJAXBElement(CodeSegmentPathType.class, new QName("http://www.aixm.aero/schema/5.2", "legTypeARINC"), FinalLegTimeSliceType.class, target));
    }
    ...
    public void setTurnDirectionItem(CodeDirectionTurnType target) {
        setTurnDirection(XmlAdapterUtils.marshallJAXBElement(CodeDirectionTurnType.class, new QName("http://www.aixm.aero/schema/5.2", "turnDirection"), FinalLegTimeSliceType.class, target));
    }
    ...
    public void setSpeedLimitItem(ValSpeedType target) {
        setSpeedLimit(XmlAdapterUtils.marshallJAXBElement(ValSpeedType.class, new QName("http://www.aixm.aero/schema/5.2", "speedLimit"), FinalLegTimeSliceType.class, target));
    }
    ...
    public void setSpeedReferenceItem(CodeSpeedReferenceType target) {
        setSpeedReference(XmlAdapterUtils.marshallJAXBElement(CodeSpeedReferenceType.class, new QName("http://www.aixm.aero/schema/5.2", "speedReference"), FinalLegTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "speedinterpretation", columnDefinition = "codespeedinterpretationusebase")),
    ...
    public void setSpeedInterpretationItem(CodeSpeedInterpretationUseType target) {
        setSpeedInterpretation(XmlAdapterUtils.marshallJAXBElement(CodeSpeedInterpretationUseType.class, new QName("http://www.aixm.aero/schema/5.2", "speedInterpretation"), FinalLegTimeSliceType.class, target));
    }
    ...
    @AttributeOverrides({
        ...
        @AttributeOverride(name = "accuracy", column = @Column(name = "bankangleaccuracy", columnDefinition = "numericalwithnilreason"))
    })
    ...
    public void setBankAngleItem(ValAngleType target) {
        setBankAngle(XmlAdapterUtils.marshallJAXBElement(ValAngleType.class, new QName("http://www.aixm.aero/schema/5.2", "bankAngle"), FinalLegTimeSliceType.class, target));
    }
    ...
    public void setLengthItem(ValDistanceType target) {
        setLength(XmlAdapterUtils.marshallJAXBElement(ValDistanceType.class, new QName("http://www.aixm.aero/schema/5.2", "length"), FinalLegTimeSliceType.class, target));
    }
    ...
    public void setDurationItem(ValDurationType target) {
        setDuration(XmlAdapterUtils.marshallJAXBElement(ValDurationType.class, new QName("http://www.aixm.aero/schema/5.2", "duration"), FinalLegTimeSliceType.class, target));
    }
    ...
    public void setProcedureTurnRequiredItem(CodeYesNoType target) {
        setProcedureTurnRequired(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.2", "procedureTurnRequired"), FinalLegTimeSliceType.class, target));
    }
    ...
    public void setUpperLimitReferenceItem(CodeVerticalReferenceType target) {
        setUpperLimitReference(XmlAdapterUtils.marshallJAXBElement(CodeVerticalReferenceType.class, new QName("http://www.aixm.aero/schema/5.2", "upperLimitReference"), FinalLegTimeSliceType.class, target));
    }
    ...
    public void setLowerLimitReferenceItem(CodeVerticalReferenceType target) {
        setLowerLimitReference(XmlAdapterUtils.marshallJAXBElement(CodeVerticalReferenceType.class, new QName("http://www.aixm.aero/schema/5.2", "lowerLimitReference"), FinalLegTimeSliceType.class, target));
    }
    ...
    @AttributeOverrides({
        ...
        @AttributeOverride(name = "accuracy", column = @Column(name = "altitudeoverrideatcaccuracy", columnDefinition = "numericalwithnilreason")),
    ...
    public void setAltitudeOverrideATCItem(ValDistanceVerticalType target) {
        setAltitudeOverrideATC(XmlAdapterUtils.marshallJAXBElement(ValDistanceVerticalType.class, new QName("http://www.aixm.aero/schema/5.2", "altitudeOverrideATC"), FinalLegTimeSliceType.class, target));
    }
    ...
    public void setAltitudeOverrideReferenceItem(CodeVerticalReferenceType target) {
        setAltitudeOverrideReference(XmlAdapterUtils.marshallJAXBElement(CodeVerticalReferenceType.class, new QName("http://www.aixm.aero/schema/5.2", "altitudeOverrideReference"), FinalLegTimeSliceType.class, target));
    }
    ...
    @AttributeOverrides({
        ...
        @AttributeOverride(name = "accuracy", column = @Column(name = "verticalangleaccuracy", columnDefinition = "numericalwithnilreason"))
    })
    ...
    public void setVerticalAngleItem(ValAngleType target) {
        setVerticalAngle(XmlAdapterUtils.marshallJAXBElement(ValAngleType.class, new QName("http://www.aixm.aero/schema/5.2", "verticalAngle"), FinalLegTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = TerminalSegmentPointPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "fnllgtmslctp_strtpnt_link", schema = "procedure", joinColumns = {
        @JoinColumn(name = "finalleg_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setStartPointItem(TerminalSegmentPointPropertyType target) {
        setStartPoint(XmlAdapterUtils.marshallJAXBElement(TerminalSegmentPointPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "startPoint"), FinalLegTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = TerminalSegmentPointPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "fnllgtmslctp_endpnt_link", schema = "procedure", joinColumns = {
        @JoinColumn(name = "finalleg_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setEndPointItem(TerminalSegmentPointPropertyType target) {
        setEndPoint(XmlAdapterUtils.marshallJAXBElement(TerminalSegmentPointPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "endPoint"), FinalLegTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = AIXMCurvePropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "fnllgtmslctp_trjctr_link", schema = "procedure", joinColumns = {
        @JoinColumn(name = "finalleg_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setTrajectoryItem(AIXMCurvePropertyType target) {
        setTrajectory(XmlAdapterUtils.marshallJAXBElement(AIXMCurvePropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "trajectory"), FinalLegTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = TerminalSegmentPointPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "fnllgtmslctp_arccntr_link", schema = "procedure", joinColumns = {
        @JoinColumn(name = "finalleg_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setArcCentreItem(TerminalSegmentPointPropertyType target) {
        setArcCentre(XmlAdapterUtils.marshallJAXBElement(TerminalSegmentPointPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "arcCentre"), FinalLegTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = HoldingUsePropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "fnllgtmslctp_hldng_link", schema = "procedure", joinColumns = {
        @JoinColumn(name = "finalleg_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setHoldingItem(HoldingUsePropertyType target) {
        setHolding(XmlAdapterUtils.marshallJAXBElement(HoldingUsePropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "holding"), FinalLegTimeSliceType.class, target));
    }
    ...
    public void setUpperLimitItem(ValDistanceVerticalType target) {
        setUpperLimit(XmlAdapterUtils.marshallJAXBElement(ValDistanceVerticalType.class, new QName("http://www.aixm.aero/schema/5.2", "upperLimit"), FinalLegTimeSliceType.class, target));
    }
    ...
    public void setLowerLimitItem(ValDistanceVerticalType target) {
        setLowerLimit(XmlAdapterUtils.marshallJAXBElement(ValDistanceVerticalType.class, new QName("http://www.aixm.aero/schema/5.2", "lowerLimit"), FinalLegTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "verticallimitsinterpretation", columnDefinition = "codealtitudeusebase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "verticallimitsinterpretationnilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setVerticalLimitsInterpretationItem(CodeAltitudeUseType target) {
        setVerticalLimitsInterpretation(XmlAdapterUtils.marshallJAXBElement(CodeAltitudeUseType.class, new QName("http://www.aixm.aero/schema/5.2", "verticalLimitsInterpretation"), FinalLegTimeSliceType.class, target));
    }
    ...
    public void setRadiusItem(ValDistanceType target) {
        setRadius(XmlAdapterUtils.marshallJAXBElement(ValDistanceType.class, new QName("http://www.aixm.aero/schema/5.2", "radius"), FinalLegTimeSliceType.class, target));
    }
    ...
    public void setAdditionalEquipmentItem(CodeAdditionalEquipmentType target) {
        setAdditionalEquipment(XmlAdapterUtils.marshallJAXBElement(CodeAdditionalEquipmentType.class, new QName("http://www.aixm.aero/schema/5.2", "additionalEquipment"), FinalLegTimeSliceType.class, target));
    }
    ...
    @AttributeOverrides({
        ...
        @AttributeOverride(name = "accuracy", column = @Column(name = "minimumobstacleclearancealtitudeaccuracy", columnDefinition = "numericalwithnilreason")),
    ...
    public void setMinimumObstacleClearanceAltitudeItem(ValDistanceVerticalType target) {
        setMinimumObstacleClearanceAltitude(XmlAdapterUtils.marshallJAXBElement(ValDistanceVerticalType.class, new QName("http://www.aixm.aero/schema/5.2", "minimumObstacleClearanceAltitude"), FinalLegTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "minimumobstacleclearanceheight", columnDefinition = "valdistanceverticalbase")),
        @AttributeOverride(name = "uom", column = @Column(name = "minimumobstacleclearanceheightuom", columnDefinition = "uomdistancevertical")),
        @AttributeOverride(name = "accuracy", column = @Column(name = "minimumobstacleclearanceheightaccuracy", columnDefinition = "numericalwithnilreason")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "minimumobstacleclearanceheightnilreason", columnDefinition = "nilreason"))
    })
    public ValDistanceVerticalType getMinimumObstacleClearanceHeightItem() {
        return XmlAdapterUtils.unmarshallSource(ValDistanceVerticalType.class, this.getMinimumObstacleClearanceHeight());
    }

    public void setMinimumObstacleClearanceHeightItem(ValDistanceVerticalType target) {
        setMinimumObstacleClearanceHeight(XmlAdapterUtils.marshallJAXBElement(ValDistanceVerticalType.class, new QName("http://www.aixm.aero/schema/5.2", "minimumObstacleClearanceHeight"), FinalLegTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = DistancePropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "fnllgtmslctp_lmtngdstnc_link", schema = "procedure", joinColumns = {
        @JoinColumn(name = "finalleg_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setLimitingDistanceItem(DistancePropertyType target) {
        setLimitingDistance(XmlAdapterUtils.marshallJAXBElement(DistancePropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "limitingDistance"), FinalLegTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = AnglePropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "fnllgtmslctp_lmtngangl_link", schema = "procedure", joinColumns = {
        @JoinColumn(name = "finalleg_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setLimitingAngleItem(AnglePropertyType target) {
        setLimitingAngle(XmlAdapterUtils.marshallJAXBElement(AnglePropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "limitingAngle"), FinalLegTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = InstrumentApproachProcedurePropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "fnllgtmslctp_apprch_link", schema = "procedure", joinColumns = {
        @JoinColumn(name = "finalleg_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setApproachItem(InstrumentApproachProcedurePropertyType target) {
        setApproach(XmlAdapterUtils.marshallJAXBElement(InstrumentApproachProcedurePropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "approach"), FinalLegTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "courseoffsetangle", columnDefinition = "valbearingbase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "courseoffsetanglenilreason", columnDefinition = "nilreason")),
        @AttributeOverride(name = "accuracy", column = @Column(name = "courseoffsetangleaccuracy", columnDefinition = "numericalwithnilreason"))
    })
    ...
    public void setCourseOffsetAngleItem(ValBearingType target) {
        setCourseOffsetAngle(XmlAdapterUtils.marshallJAXBElement(ValBearingType.class, new QName("http://www.aixm.aero/schema/5.2", "courseOffsetAngle"), FinalLegTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "courseoffsetside", columnDefinition = "codesidebase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "courseoffsetsidenilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setCourseOffsetSideItem(CodeSideType target) {
        setCourseOffsetSide(XmlAdapterUtils.marshallJAXBElement(CodeSideType.class, new QName("http://www.aixm.aero/schema/5.2", "courseOffsetSide"), FinalLegTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "coursecentrelinedistance", columnDefinition = "valdistancebase")),
        @AttributeOverride(name = "uom", column = @Column(name = "coursecentrelinedistanceuom", columnDefinition = "uomdistance")),
        @AttributeOverride(name = "accuracy", column = @Column(name = "coursecentrelinedistanceaccuracy", columnDefinition = "numericalwithnilreason")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "coursecentrelinedistancenilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setCourseCentrelineDistanceItem(ValDistanceType target) {
        setCourseCentrelineDistance(XmlAdapterUtils.marshallJAXBElement(ValDistanceType.class, new QName("http://www.aixm.aero/schema/5.2", "courseCentrelineDistance"), FinalLegTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "courseoffsetdistance", columnDefinition = "valdistancebase")),
        @AttributeOverride(name = "uom", column = @Column(name = "courseoffsetdistanceuom", columnDefinition = "uomdistance")),
        @AttributeOverride(name = "accuracy", column = @Column(name = "courseoffsetdistanceaccuracy", columnDefinition = "numericalwithnilreason")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "courseoffsetdistancenilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setCourseOffsetDistanceItem(ValDistanceType target) {
        setCourseOffsetDistance(XmlAdapterUtils.marshallJAXBElement(ValDistanceType.class, new QName("http://www.aixm.aero/schema/5.2", "courseOffsetDistance"), FinalLegTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "coursecentrelineintersect", columnDefinition = "coderelativepositionbase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "coursecentrelineintersectnilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setCourseCentrelineIntersectItem(CodeRelativePositionType target) {
        setCourseCentrelineIntersect(XmlAdapterUtils.marshallJAXBElement(CodeRelativePositionType.class, new QName("http://www.aixm.aero/schema/5.2", "courseCentrelineIntersect"), FinalLegTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = DesignatedPointPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "fnllgtmslctp_fnlpthalgnmntpntfxdsgntdpnt_link", schema = "procedure", joinColumns = {
        @JoinColumn(name = "finalleg_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
        @JoinColumn(name = "finalpathalignmentpointfixdesignatedpoint_hjid", referencedColumnName = "hjid")
    })
    ...
    public void setFinalPathAlignmentPointFixDesignatedPointItem(DesignatedPointPropertyType target) {
        setFinalPathAlignmentPointFixDesignatedPoint(XmlAdapterUtils.marshallJAXBElement(DesignatedPointPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "finalPathAlignmentPoint_fixDesignatedPoint"), FinalLegTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = NavaidPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "fnllgtmslctp_fnlpthalgnmntpntnvdsstm_link", schema = "procedure", joinColumns = {
        @JoinColumn(name = "finalleg_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
        @JoinColumn(name = "finalpathalignmentpointnavaidsystem_hjid", referencedColumnName = "hjid")
    })
    ...
    public void setFinalPathAlignmentPointNavaidSystemItem(NavaidPropertyType target) {
        setFinalPathAlignmentPointNavaidSystem(XmlAdapterUtils.marshallJAXBElement(NavaidPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "finalPathAlignmentPoint_navaidSystem"), FinalLegTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = AIXMPointPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "fnllgtmslctp_fnlpthalgnmntpntpstn_link", schema = "procedure", joinColumns = {
        @JoinColumn(name = "finalleg_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
        @JoinColumn(name = "finalpathalignmentpointposition_hjid", referencedColumnName = "hjid")
    })
    ...
    public void setFinalPathAlignmentPointPositionItem(AIXMPointPropertyType target) {
        setFinalPathAlignmentPointPosition(XmlAdapterUtils.marshallJAXBElement(AIXMPointPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "finalPathAlignmentPoint_position"), FinalLegTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = RunwayCentrelinePointPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "fnllgtmslctp_fnlpthalgnmntpntrnwpnt_link", schema = "procedure", joinColumns = {
        @JoinColumn(name = "finalleg_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
        @JoinColumn(name = "finalpathalignmentpointrunwaypoint_hjid", referencedColumnName = "hjid")
    })
    ...
    public void setFinalPathAlignmentPointRunwayPointItem(RunwayCentrelinePointPropertyType target) {
        setFinalPathAlignmentPointRunwayPoint(XmlAdapterUtils.marshallJAXBElement(RunwayCentrelinePointPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "finalPathAlignmentPoint_runwayPoint"), FinalLegTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = TouchDownLiftOffPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "fnllgtmslctp_fnlpthalgnmntpntamngpnt_link", schema = "procedure", joinColumns = {
        @JoinColumn(name = "finalleg_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
        @JoinColumn(name = "finalpathalignmentpointaimingpoint_hjid", referencedColumnName = "hjid")
    })
    ...
    public void setFinalPathAlignmentPointAimingPointItem(TouchDownLiftOffPropertyType target) {
        setFinalPathAlignmentPointAimingPoint(XmlAdapterUtils.marshallJAXBElement(TouchDownLiftOffPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "finalPathAlignmentPoint_aimingPoint"), FinalLegTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = AirportHeliportPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "fnllgtmslctp_fnlpthalgnmntpntarprtrfrncpnt_link", schema = "procedure", joinColumns = {
        @JoinColumn(name = "finalleg_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
        @JoinColumn(name = "finalpathalignmentpointairportreferencepoint_hjid", referencedColumnName = "hjid")
    })
    ...
    public void setFinalPathAlignmentPointAirportReferencePointItem(AirportHeliportPropertyType target) {
        setFinalPathAlignmentPointAirportReferencePoint(XmlAdapterUtils.marshallJAXBElement(AirportHeliportPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "finalPathAlignmentPoint_airportReferencePoint"), FinalLegTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = TerminalSegmentPointPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "fnllgtmslctp_vsldscntpnt_link", schema = "procedure", joinColumns = {
        @JoinColumn(name = "finalleg_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
        @JoinColumn(name = "visualdescentpoint_hjid", referencedColumnName = "hjid")
    })
    ...
    public void setVisualDescentPointItem(TerminalSegmentPointPropertyType target) {
        setVisualDescentPoint(XmlAdapterUtils.marshallJAXBElement(TerminalSegmentPointPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "visualDescentPoint"), FinalLegTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = FinalApproachSegmentDataPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "fnllgtmslctp_fasdt_link", schema = "procedure", joinColumns = {
        @JoinColumn(name = "finalleg_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
        @JoinColumn(name = "fasdata_hjid", referencedColumnName = "hjid")
    })
    public FinalApproachSegmentDataPropertyType getFASDataItem() {
        return XmlAdapterUtils.unmarshallSource(FinalApproachSegmentDataPropertyType.class, this.getFASData());
    }

    public void setFASDataItem(FinalApproachSegmentDataPropertyType target) {
        setFASData(XmlAdapterUtils.marshallJAXBElement(FinalApproachSegmentDataPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "FASData"), FinalLegTimeSliceType.class, target));
    }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        final FinalLegTimeSliceType that = ((FinalLegTimeSliceType) object);
        {
            ...
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "verticalLimitsInterpretation", lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "verticalLimitsInterpretation", rhsField);
        ...
        }
        {
            ...
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "minimumObstacleClearanceHeight", lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "minimumObstacleClearanceHeight", rhsField);
            if (!strategy.equals(lhsFieldLocator, rhsFieldLocator, lhsField, rhsField, lhsFieldIsSet, rhsFieldIsSet)) {
                return false;
            }
        }
        ...
        }
        {
            ...
            List<FinalLegTimeSliceExtensionType> lhsField;
            lhsField = (this.isSetExtension()?this.getExtension():null);
            List<FinalLegTimeSliceExtensionType> rhsField;
        ...
        }
        {
            ...
            JAXBElement<FinalApproachSegmentDataPropertyType> lhsField;
            lhsField = this.getFASData();
            JAXBElement<FinalApproachSegmentDataPropertyType> rhsField;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        }
        {
            ...
            JAXBElement<FinalApproachSegmentDataPropertyType> theField;
        ...
        }
        {
            ...
            List<FinalLegTimeSliceExtensionType> theField;
