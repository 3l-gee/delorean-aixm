...
public class RunwayProtectAreaLightSystemTimeSliceExtensionType implements Serializable, Equals, HashCode, ToString
{
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = 1;
        {
            ...
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "abstractRunwayProtectAreaLightSystemExtension", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            AbstractExtensionType theField;
            theField = this.getAbstractRunwayProtectAreaLightSystemExtension();
            strategy.appendField(locator, this, "abstractRunwayProtectAreaLightSystemExtension", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetAbstractGroundLightSystemExtension();
            AbstractExtensionType theField;
