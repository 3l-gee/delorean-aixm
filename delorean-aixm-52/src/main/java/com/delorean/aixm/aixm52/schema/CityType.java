    ...
    implements Serializable
{
     ...
     * 
     */
    @OneToMany(targetEntity = CityExtensionType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    ...
    public void setAixmNameItem(TextNameType target) {
        setAixmName(XmlAdapterUtils.marshallJAXBElement(TextNameType.class, new QName("http://www.aixm.aero/schema/5.2", "name"), CityType.class, target));
    }
