 ...
 *         <element name="position" type="{http://www.aixm.aero/schema/5.2}CodeTaxiwaySectionType" minOccurs="0"/>
 *         <element name="lightedTaxiway" type="{http://www.aixm.aero/schema/5.2}TaxiwayPropertyType" minOccurs="0"/>
 *         <element name="extension" maxOccurs="unbounded" minOccurs="0">
 *           <complexType>
 *             <complexContent>
 *               <restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 <choice>
 *                   <element ref="{http://www.aixm.aero/schema/5.2}AbstractTaxiwayLightSystemExtension"/>
    ...
    implements Serializable
{
    ...
    @XmlElementRef(name = "lightedTaxiway", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    ...
    public void setEmergencyLightingItem(CodeYesNoType target) {
        setEmergencyLighting(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.2", "emergencyLighting"), TaxiwayLightSystemTimeSliceType.class, target));
    }
    ...
    public void setIntensityLevelItem(CodeLightIntensityType target) {
        setIntensityLevel(XmlAdapterUtils.marshallJAXBElement(CodeLightIntensityType.class, new QName("http://www.aixm.aero/schema/5.2", "intensityLevel"), TaxiwayLightSystemTimeSliceType.class, target));
    }
    ...
    public void setColourItem(CodeColourType target) {
        setColour(XmlAdapterUtils.marshallJAXBElement(CodeColourType.class, new QName("http://www.aixm.aero/schema/5.2", "colour"), TaxiwayLightSystemTimeSliceType.class, target));
    }
    ...
    public void setPositionItem(CodeTaxiwaySectionType target) {
        setPosition(XmlAdapterUtils.marshallJAXBElement(CodeTaxiwaySectionType.class, new QName("http://www.aixm.aero/schema/5.2", "position"), TaxiwayLightSystemTimeSliceType.class, target));
    }
    ...
    public void setLightedTaxiwayItem(TaxiwayPropertyType target) {
        setLightedTaxiway(XmlAdapterUtils.marshallJAXBElement(TaxiwayPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "lightedTaxiway"), TaxiwayLightSystemTimeSliceType.class, target));
    }
