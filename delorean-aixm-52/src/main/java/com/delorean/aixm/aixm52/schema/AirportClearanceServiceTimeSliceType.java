 ...
 *         <element name="snowPlan" type="{http://www.aixm.aero/schema/5.2}TextInstructionType" minOccurs="0"/>
 *         <element name="clearingEquipment" type="{http://www.aixm.aero/schema/5.2}TextInstructionType" minOccurs="0"/>
 *         <element name="extension" maxOccurs="unbounded" minOccurs="0">
 *           <complexType>
 *             <complexContent>
 *               <restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 <choice>
 *                   <element ref="{http://www.aixm.aero/schema/5.2}AbstractAirportClearanceServiceExtension"/>
    ...
    implements Serializable
{
    ...
    @XmlElementRef(name = "snowPlan", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<TextInstructionType> snowPlan;
    @XmlElementRef(name = "clearingEquipment", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<TextInstructionType> clearingEquipment;
    protected List<AirportClearanceServiceTimeSliceExtensionType> extension;
    ...
    /**
     * Gets the value of the clearingEquipment property.
     * 
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link TextInstructionType }{@code >}
     ...
     */
    @Transient
    public JAXBElement<TextInstructionType> getClearingEquipment() {
        return clearingEquipment;
    }

    /**
     * Sets the value of the clearingEquipment property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link TextInstructionType }{@code >}
     *     
     */
    public void setClearingEquipment(JAXBElement<TextInstructionType> value) {
        this.clearingEquipment = value;
    }

    @Transient
    public boolean isSetClearingEquipment() {
        return (this.clearingEquipment!= null);
    }
    ...
    public void setFlightOperationsItem(CodeFlightDestinationType target) {
        setFlightOperations(XmlAdapterUtils.marshallJAXBElement(CodeFlightDestinationType.class, new QName("http://www.aixm.aero/schema/5.2", "flightOperations"), AirportClearanceServiceTimeSliceType.class, target));
    }
    ...
    public void setRankItem(CodeFacilityRankingType target) {
        setRank(XmlAdapterUtils.marshallJAXBElement(CodeFacilityRankingType.class, new QName("http://www.aixm.aero/schema/5.2", "rank"), AirportClearanceServiceTimeSliceType.class, target));
    }
    ...
    public void setCompliantICAOItem(CodeYesNoType target) {
        setCompliantICAO(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.2", "compliantICAO"), AirportClearanceServiceTimeSliceType.class, target));
    }
    ...
    public void setAixmNameItem(TextNameType target) {
        setAixmName(XmlAdapterUtils.marshallJAXBElement(TextNameType.class, new QName("http://www.aixm.aero/schema/5.2", "name"), AirportClearanceServiceTimeSliceType.class, target));
    }
    ...
    public void setLocationItem(AIXMElevatedPointPropertyType target) {
        setLocation(XmlAdapterUtils.marshallJAXBElement(AIXMElevatedPointPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "location"), AirportClearanceServiceTimeSliceType.class, target));
    }
    ...
    public void setServiceProviderItem(UnitPropertyType target) {
        setServiceProvider(XmlAdapterUtils.marshallJAXBElement(UnitPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "serviceProvider"), AirportClearanceServiceTimeSliceType.class, target));
    }
    ...
    public void setSnowPlanItem(TextInstructionType target) {
        setSnowPlan(XmlAdapterUtils.marshallJAXBElement(TextInstructionType.class, new QName("http://www.aixm.aero/schema/5.2", "snowPlan"), AirportClearanceServiceTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "clearingequipment", columnDefinition = "character2")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "clearingequipmentnilreason", columnDefinition = "nilreason"))
    })
    public TextInstructionType getClearingEquipmentItem() {
        return XmlAdapterUtils.unmarshallSource(TextInstructionType.class, this.getClearingEquipment());
    }

    public void setClearingEquipmentItem(TextInstructionType target) {
        setClearingEquipment(XmlAdapterUtils.marshallJAXBElement(TextInstructionType.class, new QName("http://www.aixm.aero/schema/5.2", "clearingEquipment"), AirportClearanceServiceTimeSliceType.class, target));
    }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        {
            boolean lhsFieldIsSet = this.isSetClearingEquipment();
            boolean rhsFieldIsSet = that.isSetClearingEquipment();
            JAXBElement<TextInstructionType> lhsField;
            lhsField = this.getClearingEquipment();
            JAXBElement<TextInstructionType> rhsField;
            rhsField = that.getClearingEquipment();
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "clearingEquipment", lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "clearingEquipment", rhsField);
            if (!strategy.equals(lhsFieldLocator, rhsFieldLocator, lhsField, rhsField, lhsFieldIsSet, rhsFieldIsSet)) {
                return false;
            }
        }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetSnowPlan();
            JAXBElement<TextInstructionType> theField;
            theField = this.getSnowPlan();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "snowPlan", theField);
            currentHashCode = strategy.hashCode(theFieldLocator, currentHashCode, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetClearingEquipment();
            JAXBElement<TextInstructionType> theField;
            theField = this.getClearingEquipment();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "clearingEquipment", theField);
            currentHashCode = strategy.hashCode(theFieldLocator, currentHashCode, theField, theFieldIsSet);
        }
        {
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        }
        {
            ...
            JAXBElement<TextInstructionType> theField;
            theField = this.getSnowPlan();
            strategy.appendField(locator, this, "snowPlan", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetClearingEquipment();
            JAXBElement<TextInstructionType> theField;
            theField = this.getClearingEquipment();
            strategy.appendField(locator, this, "clearingEquipment", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetExtension();
            List<AirportClearanceServiceTimeSliceExtensionType> theField;
