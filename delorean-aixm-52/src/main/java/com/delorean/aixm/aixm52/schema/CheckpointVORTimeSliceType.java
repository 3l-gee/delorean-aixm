 ...
 *       <sequence>
 *         <element name="category" type="{http://www.aixm.aero/schema/5.2}CodeCheckpointCategoryType" minOccurs="0"/>
 ...
 *         <element name="altitudeInterpretation" type="{http://www.aixm.aero/schema/5.2}CodeAltitudeUseType" minOccurs="0"/>
 ...
 *         <element name="airportHeliport" type="{http://www.aixm.aero/schema/5.2}AirportHeliportPropertyType" minOccurs="0"/>
 *         <element name="annotation" type="{http://www.aixm.aero/schema/5.2}NotePropertyType" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="checkPointFacility" type="{http://www.aixm.aero/schema/5.2}VORPropertyType" minOccurs="0"/>
 *         <element name="extension" maxOccurs="unbounded" minOccurs="0">
 *           <complexType>
 *             <complexContent>
 *               <restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 <choice>
 *                   <element ref="{http://www.aixm.aero/schema/5.2}AbstractCheckpointVORExtension"/>
...
@Table(name = "checkpointvor_t", schema = "navaids_point")
    ...
    implements Serializable
{
    ...
    @XmlElementRef(name = "checkPointFacility", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<VORPropertyType> checkPointFacility;
    protected List<CheckpointVORTimeSliceExtensionType> extension;
    ...
    @JoinTable(name = "chckpntvortmslctp_annttn_link", schema = "navaids_point", joinColumns = {
        @JoinColumn(name = "checkpointvor_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link CheckpointVORTimeSliceExtensionType }
     * 
     * 
     */
    @OneToMany(targetEntity = CheckpointVORTimeSliceExtensionType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinColumn(name = "checkpointvor_te_hjid", referencedColumnName = "hjid")
    public List<CheckpointVORTimeSliceExtensionType> getExtension() {
        if (extension == null) {
     ...
     * 
     */
    public void setExtension(List<CheckpointVORTimeSliceExtensionType> extension) {
    ...
    public void setCategoryItem(CodeCheckpointCategoryType target) {
        setCategory(XmlAdapterUtils.marshallJAXBElement(CodeCheckpointCategoryType.class, new QName("http://www.aixm.aero/schema/5.2", "category"), CheckpointVORTimeSliceType.class, target));
    }
    ...
    public void setUpperLimitItem(ValDistanceVerticalType target) {
        setUpperLimit(XmlAdapterUtils.marshallJAXBElement(ValDistanceVerticalType.class, new QName("http://www.aixm.aero/schema/5.2", "upperLimit"), CheckpointVORTimeSliceType.class, target));
    }
    ...
    public void setUpperLimitReferenceItem(CodeVerticalReferenceType target) {
        setUpperLimitReference(XmlAdapterUtils.marshallJAXBElement(CodeVerticalReferenceType.class, new QName("http://www.aixm.aero/schema/5.2", "upperLimitReference"), CheckpointVORTimeSliceType.class, target));
    }
    ...
    public void setLowerLimitItem(ValDistanceVerticalType target) {
        setLowerLimit(XmlAdapterUtils.marshallJAXBElement(ValDistanceVerticalType.class, new QName("http://www.aixm.aero/schema/5.2", "lowerLimit"), CheckpointVORTimeSliceType.class, target));
    }
    ...
    public void setLowerLimitReferenceItem(CodeVerticalReferenceType target) {
        setLowerLimitReference(XmlAdapterUtils.marshallJAXBElement(CodeVerticalReferenceType.class, new QName("http://www.aixm.aero/schema/5.2", "lowerLimitReference"), CheckpointVORTimeSliceType.class, target));
    }
    ...
    public void setAltitudeInterpretationItem(CodeAltitudeUseType target) {
        setAltitudeInterpretation(XmlAdapterUtils.marshallJAXBElement(CodeAltitudeUseType.class, new QName("http://www.aixm.aero/schema/5.2", "altitudeInterpretation"), CheckpointVORTimeSliceType.class, target));
    }
    ...
    public void setDistanceItem(ValDistanceType target) {
        setDistance(XmlAdapterUtils.marshallJAXBElement(ValDistanceType.class, new QName("http://www.aixm.aero/schema/5.2", "distance"), CheckpointVORTimeSliceType.class, target));
    }
    ...
    public void setAngleItem(ValBearingType target) {
        setAngle(XmlAdapterUtils.marshallJAXBElement(ValBearingType.class, new QName("http://www.aixm.aero/schema/5.2", "angle"), CheckpointVORTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = AIXMElevatedPointPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "chckpntvortmslctp_pstn_link", schema = "navaids_point", joinColumns = {
        @JoinColumn(name = "checkpointvor_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setPositionItem(AIXMElevatedPointPropertyType target) {
        setPosition(XmlAdapterUtils.marshallJAXBElement(AIXMElevatedPointPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "position"), CheckpointVORTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = AirportHeliportPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "chckpntvortmslctp_arprthlprt_link", schema = "navaids_point", joinColumns = {
        @JoinColumn(name = "checkpointvor_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setAirportHeliportItem(AirportHeliportPropertyType target) {
        setAirportHeliport(XmlAdapterUtils.marshallJAXBElement(AirportHeliportPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "airportHeliport"), CheckpointVORTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = VORPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "chckpntvortmslctp_chckpntfclt_link", schema = "navaids_point", joinColumns = {
        @JoinColumn(name = "checkpointvor_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
        @JoinColumn(name = "checkpointfacility_hjid", referencedColumnName = "hjid")
    })
    ...
    public void setCheckPointFacilityItem(VORPropertyType target) {
        setCheckPointFacility(XmlAdapterUtils.marshallJAXBElement(VORPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "checkPointFacility"), CheckpointVORTimeSliceType.class, target));
    }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        }
        {
            ...
            List<CheckpointVORTimeSliceExtensionType> lhsField;
            lhsField = (this.isSetExtension()?this.getExtension():null);
            List<CheckpointVORTimeSliceExtensionType> rhsField;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetCheckPointFacility();
            JAXBElement<VORPropertyType> theField;
            theField = this.getCheckPointFacility();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "checkPointFacility", theField);
            currentHashCode = strategy.hashCode(theFieldLocator, currentHashCode, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetExtension();
            List<CheckpointVORTimeSliceExtensionType> theField;
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        }
        {
            ...
            JAXBElement<VORPropertyType> theField;
            theField = this.getCheckPointFacility();
            strategy.appendField(locator, this, "checkPointFacility", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetExtension();
            List<CheckpointVORTimeSliceExtensionType> theField;
