...
/**
 * <p>
 * Java class for AirspaceTimeSlicePropertyType complex type
 * </p>
 * .
 *
 * <p>
 ...
 *       <sequence>
 *         <element ref="{http://www.aixm.aero/schema/5.2}AirspaceTimeSlice"/>
 *       </sequence>
 *       <attGroup ref=
...
@XmlType(name = "AirspaceTimeSlicePropertyType", propOrder = {"airspaceTimeSlice"})
@FilterDef(name = "TPHjidFilter", parameters = {@ParamDef(name = "ids", type = Long.class)})
@Filter(name = "TPHjidFilter", condition = "hjid IN (:ids)")
@Entity(name = "AirspaceTimeSlicePropertyType")
@Table(name = "airspace_tp", schema = "airspace")
public class AirspaceTimeSlicePropertyType implements Serializable, Equals, HashCode, ToString {
     ...
     *
     * @return possible object is {@link AirspaceTimeSliceType }
     *
     */
    @OneToOne(targetEntity = AirspaceTimeSliceType.class, cascade = {CascadeType.ALL}, fetch = FetchType.EAGER)
    @JoinColumn(name = "airspacetimeslice_hjid", referencedColumnName = "hjid")
     ...
     *
     * @param value
     *            allowed object is {@link AirspaceTimeSliceType }
     *
     */
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetAirspaceTimeSlice();
            AirspaceTimeSliceType theField;
            theField = this.getAirspaceTimeSlice();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "airspaceTimeSlice", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            AirspaceTimeSliceType theField;
            theField = this.getAirspaceTimeSlice();
            strategy.appendField(locator, this, "airspaceTimeSlice", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetOwns();
            boolean theField;
