 ...
 *       <sequence>
 *         <element name="series" type="{http://www.aixm.aero/schema/5.2}CodeLevelSeriesType" minOccurs="0"/>
 *         <element name="unitOfMeasurement" type="{http://www.aixm.aero/schema/5.2}CodeDistanceVerticalUomType" minOccurs="0"/>
 *         <element name="separation" type="{http://www.aixm.aero/schema/5.2}CodeRVSMType" minOccurs="0"/>
 *         <element name="level" type="{http://www.aixm.aero/schema/5.2}StandardLevelPropertyType" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="levelTable" type="{http://www.aixm.aero/schema/5.2}StandardLevelTablePropertyType" minOccurs="0"/>
 ...
 *                 <sequence>
 *                   <element ref="{http://www.aixm.aero/schema/5.2}AbstractStandardLevelColumnExtension"/>
 *                 </sequence>
...
@Table(name = "standardlevelcolumn_t", schema = "shared")
    ...
    implements Serializable
{
    ...
    @XmlElementRef(name = "series", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<CodeLevelSeriesType> series;
    @XmlElementRef(name = "unitOfMeasurement", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<CodeDistanceVerticalUomType> unitOfMeasurement;
    @XmlElementRef(name = "separation", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<CodeRVSMType> separation;
    @XmlElement(nillable = true)
    protected List<StandardLevelPropertyType> level;
    @XmlElementRef(name = "levelTable", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
     ...
     * 
     */
    @OneToMany(targetEntity = StandardLevelPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "stndrdlvlclmntmslctp_lvl_link", schema = "shared", joinColumns = {
        @JoinColumn(name = "standardlevelcolumn_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
        @JoinColumn(name = "level_hjid", referencedColumnName = "hjid")
    })
    ...
    @JoinTable(name = "stndrdlvlclmntmslctp_annttn_link", schema = "shared", joinColumns = {
        @JoinColumn(name = "standardlevelcolumn_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "series", columnDefinition = "codelevelseriesbase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "seriesnilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setSeriesItem(CodeLevelSeriesType target) {
        setSeries(XmlAdapterUtils.marshallJAXBElement(CodeLevelSeriesType.class, new QName("http://www.aixm.aero/schema/5.2", "series"), StandardLevelColumnTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "unitofmeasurement", columnDefinition = "codedistanceverticaluombase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "unitofmeasurementnilreason", columnDefinition = "nilreason"))
    })
    public CodeDistanceVerticalUomType getUnitOfMeasurementItem() {
        return XmlAdapterUtils.unmarshallSource(CodeDistanceVerticalUomType.class, this.getUnitOfMeasurement());
    }

    public void setUnitOfMeasurementItem(CodeDistanceVerticalUomType target) {
        setUnitOfMeasurement(XmlAdapterUtils.marshallJAXBElement(CodeDistanceVerticalUomType.class, new QName("http://www.aixm.aero/schema/5.2", "unitOfMeasurement"), StandardLevelColumnTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "separation", columnDefinition = "codervsmbase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "separationnilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setSeparationItem(CodeRVSMType target) {
        setSeparation(XmlAdapterUtils.marshallJAXBElement(CodeRVSMType.class, new QName("http://www.aixm.aero/schema/5.2", "separation"), StandardLevelColumnTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = StandardLevelTablePropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "stndrdlvlclmntmslctp_lvltbl_link", schema = "shared", joinColumns = {
        @JoinColumn(name = "standardlevelcolumn_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
        @JoinColumn(name = "leveltable_hjid", referencedColumnName = "hjid")
    })
    ...
    public void setLevelTableItem(StandardLevelTablePropertyType target) {
        setLevelTable(XmlAdapterUtils.marshallJAXBElement(StandardLevelTablePropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "levelTable"), StandardLevelColumnTimeSliceType.class, target));
    }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        }
        {
            ...
            JAXBElement<CodeDistanceVerticalUomType> theField;
