 ...
 *       <sequence>
 *         <element name="type" type="{http://www.aixm.aero/schema/5.2}CodePilotControlledLightingType" minOccurs="0"/>
 *         <element name="duration" type="{http://www.aixm.aero/schema/5.2}ValDurationType" minOccurs="0"/>
 *         <element name="intensitySteps" type="{http://www.aixm.aero/schema/5.2}NoNumberType" minOccurs="0"/>
 *         <element name="standByIntensity" type="{http://www.aixm.aero/schema/5.2}CodeIntensityStandByType" minOccurs="0"/>
 *         <element name="radioFrequency" type="{http://www.aixm.aero/schema/5.2}ValFrequencyType" minOccurs="0"/>
 *         <element name="activationInstruction" type="{http://www.aixm.aero/schema/5.2}TextInstructionType" minOccurs="0"/>
 *         <element name="controlledLightIntensity" type="{http://www.aixm.aero/schema/5.2}LightActivationPropertyType" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="activatedGroundLighting" type="{http://www.aixm.aero/schema/5.2}GroundLightSystemPropertyType" maxOccurs="unbounded" minOccurs="0"/>
 ...
 *                 <sequence>
 *                   <element ref="{http://www.aixm.aero/schema/5.2}AbstractPilotControlledLightingExtension"/>
 *                 </sequence>
    ...
    implements Serializable
{
    ...
    @XmlElementRef(name = "intensitySteps", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<NoNumberType> intensitySteps;
    @XmlElementRef(name = "standByIntensity", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<CodeIntensityStandByType> standByIntensity;
    @XmlElementRef(name = "radioFrequency", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<ValFrequencyType> radioFrequency;
    @XmlElementRef(name = "activationInstruction", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    ...
    protected List<PilotControlledLightingTimeSliceExtensionType> extension;
    ...
    @JoinTable(name = "pltcntrlldlghtngtmslctp_cntrlldlghtintnst_link", schema = "service", joinColumns = {
    ...
    @JoinTable(name = "pltcntrlldlghtngtmslctp_actvtdgrndlghtng_link", schema = "service", joinColumns = {
        @JoinColumn(name = "pilotcontrolledlighting_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "pltcntrlldlghtngtmslctp_annttn_link", schema = "service", joinColumns = {
        @JoinColumn(name = "pilotcontrolledlighting_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
     ...
     * 
     */
    @OneToMany(targetEntity = PilotControlledLightingTimeSliceExtensionType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinColumn(name = "pilotcontrolledlighting_te_hjid", referencedColumnName = "hjid")
    public List<PilotControlledLightingTimeSliceExtensionType> getExtension() {
        if (extension == null) {
     ...
     * 
     */
    public void setExtension(List<PilotControlledLightingTimeSliceExtensionType> extension) {
    ...
    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "type", columnDefinition = "codepilotcontrolledlightingbase")),
    ...
    public void setTypeItem(CodePilotControlledLightingType target) {
        setType(XmlAdapterUtils.marshallJAXBElement(CodePilotControlledLightingType.class, new QName("http://www.aixm.aero/schema/5.2", "type"), PilotControlledLightingTimeSliceType.class, target));
    }
    ...
    public void setDurationItem(ValDurationType target) {
        setDuration(XmlAdapterUtils.marshallJAXBElement(ValDurationType.class, new QName("http://www.aixm.aero/schema/5.2", "duration"), PilotControlledLightingTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "intensitysteps", columnDefinition = "nonumberbase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "intensitystepsnilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setIntensityStepsItem(NoNumberType target) {
        setIntensitySteps(XmlAdapterUtils.marshallJAXBElement(NoNumberType.class, new QName("http://www.aixm.aero/schema/5.2", "intensitySteps"), PilotControlledLightingTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "standbyintensity", columnDefinition = "codeintensitystandbybase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "standbyintensitynilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setStandByIntensityItem(CodeIntensityStandByType target) {
        setStandByIntensity(XmlAdapterUtils.marshallJAXBElement(CodeIntensityStandByType.class, new QName("http://www.aixm.aero/schema/5.2", "standByIntensity"), PilotControlledLightingTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "radiofrequency", columnDefinition = "valfrequencybase")),
        @AttributeOverride(name = "uom", column = @Column(name = "radiofrequencyuom", columnDefinition = "uomfrequency")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "radiofrequencynilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setRadioFrequencyItem(ValFrequencyType target) {
        setRadioFrequency(XmlAdapterUtils.marshallJAXBElement(ValFrequencyType.class, new QName("http://www.aixm.aero/schema/5.2", "radioFrequency"), PilotControlledLightingTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "activationinstruction", columnDefinition = "character2")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "activationinstructionnilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setActivationInstructionItem(TextInstructionType target) {
        setActivationInstruction(XmlAdapterUtils.marshallJAXBElement(TextInstructionType.class, new QName("http://www.aixm.aero/schema/5.2", "activationInstruction"), PilotControlledLightingTimeSliceType.class, target));
    }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        }
        {
            ...
            List<PilotControlledLightingTimeSliceExtensionType> lhsField;
            lhsField = (this.isSetExtension()?this.getExtension():null);
            List<PilotControlledLightingTimeSliceExtensionType> rhsField;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        }
        {
            ...
            List<PilotControlledLightingTimeSliceExtensionType> theField;
