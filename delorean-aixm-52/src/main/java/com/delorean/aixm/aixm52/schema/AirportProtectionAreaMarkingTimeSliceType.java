...
/**
 * <p>Java class for AirportProtectionAreaMarkingTimeSliceType complex type</p>.
 * 
 ...
 *         <element name="markingLocation" type="{http://www.aixm.aero/schema/5.2}CodeProtectAreaSectionType" minOccurs="0"/>
 *         <element name="markedProtectionArea" type="{http://www.aixm.aero/schema/5.2}AirportHeliportProtectionAreaPropertyType" minOccurs="0"/>
 *         <element name="extension" maxOccurs="unbounded" minOccurs="0">
 *           <complexType>
 *             <complexContent>
 *               <restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 <choice>
 *                   <element ref="{http://www.aixm.aero/schema/5.2}AbstractAirportProtectionAreaMarkingExtension"/>
...
@Entity(name = "AirportProtectionAreaMarkingTimeSliceType")
@Table(name = "airportprotectionareamarking_t", schema = "airport_heliport")
    ...
    implements Serializable
{
    ...
    @XmlElementRef(name = "markingLocation", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<CodeProtectAreaSectionType> markingLocation;
    @XmlElementRef(name = "markedProtectionArea", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    ...
    @Transient
    public boolean isSetMarkedProtectionArea() {
        return (this.markedProtectionArea!= null);
    }
    ...
    public void setMarkingICAOStandardItem(CodeYesNoType target) {
        setMarkingICAOStandard(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.2", "markingICAOStandard"), AirportProtectionAreaMarkingTimeSliceType.class, target));
    }
    ...
    public void setConditionItem(CodeMarkingConditionType target) {
        setCondition(XmlAdapterUtils.marshallJAXBElement(CodeMarkingConditionType.class, new QName("http://www.aixm.aero/schema/5.2", "condition"), AirportProtectionAreaMarkingTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "markinglocation", columnDefinition = "codeprotectareasectionbase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "markinglocationnilreason", columnDefinition = "nilreason"))
    })
    public CodeProtectAreaSectionType getMarkingLocationItem() {
        return XmlAdapterUtils.unmarshallSource(CodeProtectAreaSectionType.class, this.getMarkingLocation());
    }

    public void setMarkingLocationItem(CodeProtectAreaSectionType target) {
        setMarkingLocation(XmlAdapterUtils.marshallJAXBElement(CodeProtectAreaSectionType.class, new QName("http://www.aixm.aero/schema/5.2", "markingLocation"), AirportProtectionAreaMarkingTimeSliceType.class, target));
    }
    ...
    public AirportHeliportProtectionAreaPropertyType getMarkedProtectionAreaItem() {
        return XmlAdapterUtils.unmarshallSource(AirportHeliportProtectionAreaPropertyType.class, this.getMarkedProtectionArea());
    }

    public void setMarkedProtectionAreaItem(AirportHeliportProtectionAreaPropertyType target) {
        setMarkedProtectionArea(XmlAdapterUtils.marshallJAXBElement(AirportHeliportProtectionAreaPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "markedProtectionArea"), AirportProtectionAreaMarkingTimeSliceType.class, target));
    }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetMarkedProtectionArea();
            JAXBElement<AirportHeliportProtectionAreaPropertyType> theField;
            theField = this.getMarkedProtectionArea();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "markedProtectionArea", theField);
            currentHashCode = strategy.hashCode(theFieldLocator, currentHashCode, theField, theFieldIsSet);
        }
        {
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        }
        {
            ...
            JAXBElement<AirportHeliportProtectionAreaPropertyType> theField;
            theField = this.getMarkedProtectionArea();
            strategy.appendField(locator, this, "markedProtectionArea", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetExtension();
            List<AirportProtectionAreaMarkingTimeSliceExtensionType> theField;
