 ...
 *       <sequence>
 *         <element name="category" type="{http://www.aixm.aero/schema/5.2}CodeOilType" minOccurs="0"/>
    ...
    implements Serializable
{
    ...
    @JoinTable(name = "oltp_annttn_link", schema = "service", joinColumns = {
        @JoinColumn(name = "oil_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
     ...
     * 
     */
    @OneToMany(targetEntity = OilExtensionType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    ...
    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "category", columnDefinition = "codeoilbase")),
    ...
    public void setCategoryItem(CodeOilType target) {
        setCategory(XmlAdapterUtils.marshallJAXBElement(CodeOilType.class, new QName("http://www.aixm.aero/schema/5.2", "category"), OilType.class, target));
    }
