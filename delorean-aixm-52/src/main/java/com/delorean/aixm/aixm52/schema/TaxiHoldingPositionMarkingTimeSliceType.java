 ...
 *         <element name="markedTaxiHold" type="{http://www.aixm.aero/schema/5.2}TaxiHoldingPositionPropertyType" minOccurs="0"/>
 *         <element name="extension" maxOccurs="unbounded" minOccurs="0">
 *           <complexType>
 *             <complexContent>
 *               <restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 <choice>
 *                   <element ref="{http://www.aixm.aero/schema/5.2}AbstractTaxiHoldingPositionMarkingExtension"/>
    ...
    implements Serializable
{
    ...
    @JoinTable(name = "txhldngpstnmrkngtmslctp_elmnt_link", schema = "airport_heliport", joinColumns = {
        @JoinColumn(name = "taxiholdingpositionmarking_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setMarkingICAOStandardItem(CodeYesNoType target) {
        setMarkingICAOStandard(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.2", "markingICAOStandard"), TaxiHoldingPositionMarkingTimeSliceType.class, target));
    }
    ...
    public void setConditionItem(CodeMarkingConditionType target) {
        setCondition(XmlAdapterUtils.marshallJAXBElement(CodeMarkingConditionType.class, new QName("http://www.aixm.aero/schema/5.2", "condition"), TaxiHoldingPositionMarkingTimeSliceType.class, target));
    }
    ...
    public void setMarkedTaxiHoldItem(TaxiHoldingPositionPropertyType target) {
        setMarkedTaxiHold(XmlAdapterUtils.marshallJAXBElement(TaxiHoldingPositionPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "markedTaxiHold"), TaxiHoldingPositionMarkingTimeSliceType.class, target));
    }
