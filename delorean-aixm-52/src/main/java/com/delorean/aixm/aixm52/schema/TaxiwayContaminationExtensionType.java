...
@Entity(name = "TaxiwayContaminationExtensionType")
@Table(name = "taxiwaycontamination_oe", schema = "airport_heliport")
public class TaxiwayContaminationExtensionType implements Serializable, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        final TaxiwayContaminationExtensionType that = ((TaxiwayContaminationExtensionType) object);
        {
