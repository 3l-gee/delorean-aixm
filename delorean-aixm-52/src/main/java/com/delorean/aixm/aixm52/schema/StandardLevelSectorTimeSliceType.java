 ...
 *         <element name="fromTrack" type="{http://www.aixm.aero/schema/5.2}ValBearingType" minOccurs="0"/>
 *         <element name="toTrack" type="{http://www.aixm.aero/schema/5.2}ValBearingType" minOccurs="0"/>
 *         <element name="angleType" type="{http://www.aixm.aero/schema/5.2}CodeNorthReferenceType" minOccurs="0"/>
 *         <element name="applicableAirspace" type="{http://www.aixm.aero/schema/5.2}AirspacePropertyType" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="applicableLevelColumn" type="{http://www.aixm.aero/schema/5.2}StandardLevelColumnPropertyType" minOccurs="0"/>
 ...
 *                 <sequence>
 *                   <element ref="{http://www.aixm.aero/schema/5.2}AbstractStandardLevelSectorExtension"/>
 *                 </sequence>
...
@Table(name = "standardlevelsector_t", schema = "shared")
    ...
    implements Serializable
{
    ...
    @XmlElementRef(name = "fromTrack", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<ValBearingType> fromTrack;
    @XmlElementRef(name = "toTrack", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "applicableLevelColumn", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<StandardLevelColumnPropertyType> applicableLevelColumn;
    @XmlElement(nillable = true)
    protected List<NotePropertyType> annotation;
    protected List<StandardLevelSectorTimeSliceExtensionType> extension;
    ...
    @JoinTable(name = "stndrdlvlsctrtmslctp_applcblarspc_link", schema = "shared", joinColumns = {
        @JoinColumn(name = "standardlevelsector_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
        @JoinColumn(name = "applicableairspace_hjid", referencedColumnName = "hjid")
    })
    ...
    @JoinTable(name = "stndrdlvlsctrtmslctp_annttn_link", schema = "shared", joinColumns = {
        @JoinColumn(name = "standardlevelsector_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link StandardLevelSectorTimeSliceExtensionType }
     * 
     * 
     */
    @OneToMany(targetEntity = StandardLevelSectorTimeSliceExtensionType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinColumn(name = "standardlevelsector_te_hjid", referencedColumnName = "hjid")
    public List<StandardLevelSectorTimeSliceExtensionType> getExtension() {
        if (extension == null) {
     ...
     * 
     */
    public void setExtension(List<StandardLevelSectorTimeSliceExtensionType> extension) {
    ...
    public void setFlightRuleItem(CodeFlightRuleType target) {
        setFlightRule(XmlAdapterUtils.marshallJAXBElement(CodeFlightRuleType.class, new QName("http://www.aixm.aero/schema/5.2", "flightRule"), StandardLevelSectorTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "fromtrack", columnDefinition = "valbearingbase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "fromtracknilreason", columnDefinition = "nilreason")),
        @AttributeOverride(name = "accuracy", column = @Column(name = "fromtrackaccuracy", columnDefinition = "numericalwithnilreason"))
    })
    ...
    public void setFromTrackItem(ValBearingType target) {
        setFromTrack(XmlAdapterUtils.marshallJAXBElement(ValBearingType.class, new QName("http://www.aixm.aero/schema/5.2", "fromTrack"), StandardLevelSectorTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "totrack", columnDefinition = "valbearingbase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "totracknilreason", columnDefinition = "nilreason")),
        @AttributeOverride(name = "accuracy", column = @Column(name = "totrackaccuracy", columnDefinition = "numericalwithnilreason"))
    })
    ...
    public void setToTrackItem(ValBearingType target) {
        setToTrack(XmlAdapterUtils.marshallJAXBElement(ValBearingType.class, new QName("http://www.aixm.aero/schema/5.2", "toTrack"), StandardLevelSectorTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "angletype", columnDefinition = "codenorthreferencebase")),
    ...
    public void setAngleTypeItem(CodeNorthReferenceType target) {
        setAngleType(XmlAdapterUtils.marshallJAXBElement(CodeNorthReferenceType.class, new QName("http://www.aixm.aero/schema/5.2", "angleType"), StandardLevelSectorTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = StandardLevelColumnPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "stndrdlvlsctrtmslctp_applcbllvlclmn_link", schema = "shared", joinColumns = {
        @JoinColumn(name = "standardlevelsector_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
        @JoinColumn(name = "applicablelevelcolumn_hjid", referencedColumnName = "hjid")
    })
    ...
    public void setApplicableLevelColumnItem(StandardLevelColumnPropertyType target) {
        setApplicableLevelColumn(XmlAdapterUtils.marshallJAXBElement(StandardLevelColumnPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "applicableLevelColumn"), StandardLevelSectorTimeSliceType.class, target));
    }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        }
        {
            ...
            List<StandardLevelSectorTimeSliceExtensionType> lhsField;
            lhsField = (this.isSetExtension()?this.getExtension():null);
            List<StandardLevelSectorTimeSliceExtensionType> rhsField;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        }
        {
            ...
            List<StandardLevelSectorTimeSliceExtensionType> theField;
