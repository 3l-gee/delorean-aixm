 ...
 *         <element name="type" type="{http://www.aixm.aero/schema/5.2}CodeSpecialNavigationStationType" minOccurs="0"/>
 *         <element name="frequency" type="{http://www.aixm.aero/schema/5.2}ValFrequencyType" minOccurs="0"/>
 *         <element name="emission" type="{http://www.aixm.aero/schema/5.2}CodeRadioEmissionType" minOccurs="0"/>
 *         <element name="systemChain" type="{http://www.aixm.aero/schema/5.2}SpecialNavigationSystemPropertyType" minOccurs="0"/>
 *         <element name="responsibleOrganisation" type="{http://www.aixm.aero/schema/5.2}AuthorityForSpecialNavigationStationPropertyType" minOccurs="0"/>
 *         <element name="position" type="{http://www.aixm.aero/schema/5.2}ElevatedPointPropertyType" minOccurs="0"/>
 *         <element name="availability" type="{http://www.aixm.aero/schema/5.2}SpecialNavigationStationStatusPropertyType" maxOccurs="unbounded" minOccurs="0"/>
 ...
 *                 <sequence>
 *                   <element ref="{http://www.aixm.aero/schema/5.2}AbstractSpecialNavigationStationExtension"/>
 *                 </sequence>
...
@Table(name = "specialnavigationstation_t", schema = "navaids_point")
    ...
    implements Serializable
{
    ...
    @XmlElementRef(name = "emission", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<CodeRadioEmissionType> emission;
    @XmlElementRef(name = "systemChain", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<SpecialNavigationSystemPropertyType> systemChain;
    @XmlElementRef(name = "responsibleOrganisation", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
     ...
     * 
     */
    @OneToMany(targetEntity = SpecialNavigationStationStatusPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "spclnvgtnsttntmslctp_avlblt_link", schema = "navaids_point", joinColumns = {
        @JoinColumn(name = "specialnavigationstation_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "spclnvgtnsttntmslctp_annttn_link", schema = "navaids_point", joinColumns = {
        @JoinColumn(name = "specialnavigationstation_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setAixmNameItem(TextNameType target) {
        setAixmName(XmlAdapterUtils.marshallJAXBElement(TextNameType.class, new QName("http://www.aixm.aero/schema/5.2", "name"), SpecialNavigationStationTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "type", columnDefinition = "codespecialnavigationstationbase")),
    ...
    public void setTypeItem(CodeSpecialNavigationStationType target) {
        setType(XmlAdapterUtils.marshallJAXBElement(CodeSpecialNavigationStationType.class, new QName("http://www.aixm.aero/schema/5.2", "type"), SpecialNavigationStationTimeSliceType.class, target));
    }
    ...
    public void setFrequencyItem(ValFrequencyType target) {
        setFrequency(XmlAdapterUtils.marshallJAXBElement(ValFrequencyType.class, new QName("http://www.aixm.aero/schema/5.2", "frequency"), SpecialNavigationStationTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "emission", columnDefinition = "coderadioemissionbase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "emissionnilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setEmissionItem(CodeRadioEmissionType target) {
        setEmission(XmlAdapterUtils.marshallJAXBElement(CodeRadioEmissionType.class, new QName("http://www.aixm.aero/schema/5.2", "emission"), SpecialNavigationStationTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = SpecialNavigationSystemPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "spclnvgtnsttntmslctp_sstmchn_link", schema = "navaids_point", joinColumns = {
        @JoinColumn(name = "specialnavigationstation_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
        @JoinColumn(name = "systemchain_hjid", referencedColumnName = "hjid")
    })
    ...
    public void setSystemChainItem(SpecialNavigationSystemPropertyType target) {
        setSystemChain(XmlAdapterUtils.marshallJAXBElement(SpecialNavigationSystemPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "systemChain"), SpecialNavigationStationTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = AuthorityForSpecialNavigationStationPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "spclnvgtnsttntmslctp_rspnsblorgnstn_link", schema = "navaids_point", joinColumns = {
        @JoinColumn(name = "specialnavigationstation_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setResponsibleOrganisationItem(AuthorityForSpecialNavigationStationPropertyType target) {
        setResponsibleOrganisation(XmlAdapterUtils.marshallJAXBElement(AuthorityForSpecialNavigationStationPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "responsibleOrganisation"), SpecialNavigationStationTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = AIXMElevatedPointPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "spclnvgtnsttntmslctp_pstn_link", schema = "navaids_point", joinColumns = {
        @JoinColumn(name = "specialnavigationstation_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setPositionItem(AIXMElevatedPointPropertyType target) {
        setPosition(XmlAdapterUtils.marshallJAXBElement(AIXMElevatedPointPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "position"), SpecialNavigationStationTimeSliceType.class, target));
    }
