 ...
 *       <sequence>
 *         <element ref="{http://www.aixm.aero/schema/5.2}AirportHeliportResponsibilityOrganisation"/>
 *       </sequence>
 *     </extension>
 *   </complexContent>
 * </complexType>
...
@Table(name = "airportheliportresponsibilityorganisation_p", schema = "airport_heliport")
    ...
    implements Serializable
{
    ...
    @JoinColumn(name = "airportheliportresponsibilityorganisation_hjid", referencedColumnName = "hjid")
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        final AirportHeliportResponsibilityOrganisationPropertyType that = ((AirportHeliportResponsibilityOrganisationPropertyType) object);
        {
            boolean lhsFieldIsSet = this.isSetAirportHeliportResponsibilityOrganisation();
            boolean rhsFieldIsSet = that.isSetAirportHeliportResponsibilityOrganisation();
            AirportHeliportResponsibilityOrganisationType lhsField;
