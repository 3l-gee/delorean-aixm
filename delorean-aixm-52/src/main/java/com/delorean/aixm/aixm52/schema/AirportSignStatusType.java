...
/**
 * <p>Java class for AirportSignStatusType complex type</p>.
 * 
...
@XmlType(name = "AirportSignStatusType", propOrder = {
    "timeInterval",
    "annotation",
...
public class AirportSignStatusType
    ...
    implements Serializable
{
    ...
    @JoinTable(name = "arprtsgnsttstp_tmintrvl_link", schema = "airport_heliport", joinColumns = {
        @JoinColumn(name = "airportsignstatus_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setStatusItem(CodeStatusOperationsType target) {
        setStatus(XmlAdapterUtils.marshallJAXBElement(CodeStatusOperationsType.class, new QName("http://www.aixm.aero/schema/5.2", "status"), AirportSignStatusType.class, target));
    }
