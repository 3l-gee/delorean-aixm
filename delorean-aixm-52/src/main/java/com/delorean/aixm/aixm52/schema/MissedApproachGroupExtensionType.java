...
@Entity(name = "MissedApproachGroupExtensionType")
@Table(name = "missedapproachgroup_oe", schema = "procedure")
public class MissedApproachGroupExtensionType implements Serializable, Equals, HashCode, ToString
{
    ...
    @JoinColumn(name = "abstractmissedapproachgroupextension_hjid", referencedColumnName = "hjid")
