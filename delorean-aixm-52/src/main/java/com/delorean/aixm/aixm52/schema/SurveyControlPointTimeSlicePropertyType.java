 ...
 *       <sequence>
 *         <element ref="{http://www.aixm.aero/schema/5.2}SurveyControlPointTimeSlice"/>
 *       </sequence>
...
public class SurveyControlPointTimeSlicePropertyType implements Serializable, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        }
        {
            ...
            SurveyControlPointTimeSliceType lhsField;
            lhsField = this.getSurveyControlPointTimeSlice();
            SurveyControlPointTimeSliceType rhsField;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetSurveyControlPointTimeSlice();
            SurveyControlPointTimeSliceType theField;
            theField = this.getSurveyControlPointTimeSlice();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "surveyControlPointTimeSlice", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            SurveyControlPointTimeSliceType theField;
            theField = this.getSurveyControlPointTimeSlice();
            strategy.appendField(locator, this, "surveyControlPointTimeSlice", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetOwns();
            boolean theField;
