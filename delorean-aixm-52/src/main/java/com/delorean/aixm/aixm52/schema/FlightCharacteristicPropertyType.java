...
/**
 * <p>
 * Java class for FlightCharacteristicPropertyType complex type
 * </p>
 * .
 *
 * <p>
 ...
 *       <sequence>
 *         <element ref=
"{http://www.aixm.aero/schema/5.2}FlightCharacteristic"/>
 *       </sequence>
 *     </extension>
 *   </complexContent>
 * </complexType>
...
@XmlType(name = "FlightCharacteristicPropertyType", propOrder = {"flightCharacteristic"})
@Entity(name = "FlightCharacteristicPropertyType")
@Table(name = "flightcharacteristicpropertytype", schema = "shared")
public class FlightCharacteristicPropertyType extends AbstractAIXMPropertyType implements Serializable {
     ...
     *
     * @return possible object is {@link FlightCharacteristicType }
     *
     */
    @OneToOne(targetEntity = FlightCharacteristicType.class, cascade = {CascadeType.ALL}, fetch = FetchType.EAGER)
     ...
     *
     * @param value
     *            allowed object is {@link FlightCharacteristicType }
     *
     */
