 ...
 *         <element name="type" type="{http://www.aixm.aero/schema/5.2}CodeDMEType" minOccurs="0"/>
 *         <element name="channel" type="{http://www.aixm.aero/schema/5.2}CodeDMEChannelType" minOccurs="0"/>
 *         <element name="displace" type="{http://www.aixm.aero/schema/5.2}ValDistanceType" minOccurs="0"/>
    ...
    implements Serializable
{
    ...
    @AttributeOverrides({
        ...
        @AttributeOverride(name = "accuracy", column = @Column(name = "displaceaccuracy", columnDefinition = "numericalwithnilreason")),
