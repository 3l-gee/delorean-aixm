...
/**
 * <p>Java class for MinimumAltitudeAreaTimeSliceType complex type</p>.
 * 
 ...
 *       <sequence>
 *         <element name="type" type="{http://www.aixm.aero/schema/5.2}CodeAreaAltitudeType" minOccurs="0"/>
 ...
 *         <element name="sector" type="{http://www.aixm.aero/schema/5.2}MinimumAltitudeAreaSectorPropertyType" maxOccurs="unbounded" minOccurs="0"/>
 *         <choice>
 ...
 *         </choice>
 *         <element name="concernedAirspace" type="{http://www.aixm.aero/schema/5.2}AirspacePropertyType" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="location" type="{http://www.aixm.aero/schema/5.2}AirportHeliportPropertyType" maxOccurs="unbounded" minOccurs="0"/>
 ...
 *                 <sequence>
 *                   <element ref="{http://www.aixm.aero/schema/5.2}AbstractMinimumAltitudeAreaExtension"/>
 *                 </sequence>
...
@XmlType(name = "MinimumAltitudeAreaTimeSliceType", propOrder = {
    "type",
    "lowestTemperature",
    "designCriteria",
    "sector",
...
public class MinimumAltitudeAreaTimeSliceType
    ...
    implements Serializable
{
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link CodeAreaAltitudeType }{@code >}
     *     
     */
    @Transient
    ...
    @JoinTable(name = "mnmmalttdartmslctp_dsgncrtr_l", schema = "procedure", joinColumns = {
        @JoinColumn(name = "minimumaltitudearea_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "mnmmalttdartmslctp_sctr_l", schema = "procedure", joinColumns = {
        @JoinColumn(name = "minimumaltitudearea_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the concernedAirspace property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
    ...
    @JoinTable(name = "mnmmalttdartmslctp_cncrndarspc_l", schema = "procedure", joinColumns = {
        @JoinColumn(name = "minimumaltitudearea_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "mnmmalttdartmslctp_lctn_l", schema = "procedure", joinColumns = {
        @JoinColumn(name = "minimumaltitudearea_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "mnmmalttdartmslctp_annttn_l", schema = "procedure", joinColumns = {
        @JoinColumn(name = "minimumaltitudearea_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "type", columnDefinition = "codeareaaltitudebase")),
    ...
    public void setTypeItem(CodeAreaAltitudeType target) {
        setType(XmlAdapterUtils.marshallJAXBElement(CodeAreaAltitudeType.class, new QName("http://www.aixm.aero/schema/5.2", "type"), MinimumAltitudeAreaTimeSliceType.class, target));
    }
    ...
    public void setLowestTemperatureItem(ValTemperatureType target) {
        setLowestTemperature(XmlAdapterUtils.marshallJAXBElement(ValTemperatureType.class, new QName("http://www.aixm.aero/schema/5.2", "lowestTemperature"), MinimumAltitudeAreaTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = DesignatedPointPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "mnmmalttdartmslctp_cntrpntfxdsgntdpnt_l", schema = "procedure", joinColumns = {
        @JoinColumn(name = "minimumaltitudearea_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setCentrePointFixDesignatedPointItem(DesignatedPointPropertyType target) {
        setCentrePointFixDesignatedPoint(XmlAdapterUtils.marshallJAXBElement(DesignatedPointPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "centrePoint_fixDesignatedPoint"), MinimumAltitudeAreaTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = NavaidPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "mnmmalttdartmslctp_cntrpntnvdsstm_l", schema = "procedure", joinColumns = {
        @JoinColumn(name = "minimumaltitudearea_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setCentrePointNavaidSystemItem(NavaidPropertyType target) {
        setCentrePointNavaidSystem(XmlAdapterUtils.marshallJAXBElement(NavaidPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "centrePoint_navaidSystem"), MinimumAltitudeAreaTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = AIXMPointPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "mnmmalttdartmslctp_cntrpntpstn_l", schema = "procedure", joinColumns = {
        @JoinColumn(name = "minimumaltitudearea_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setCentrePointPositionItem(AIXMPointPropertyType target) {
        setCentrePointPosition(XmlAdapterUtils.marshallJAXBElement(AIXMPointPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "centrePoint_position"), MinimumAltitudeAreaTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = RunwayCentrelinePointPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "mnmmalttdartmslctp_cntrpntrnwpnt_l", schema = "procedure", joinColumns = {
        @JoinColumn(name = "minimumaltitudearea_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setCentrePointRunwayPointItem(RunwayCentrelinePointPropertyType target) {
        setCentrePointRunwayPoint(XmlAdapterUtils.marshallJAXBElement(RunwayCentrelinePointPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "centrePoint_runwayPoint"), MinimumAltitudeAreaTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = TouchDownLiftOffPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "mnmmalttdartmslctp_cntrpntamngpnt_l", schema = "procedure", joinColumns = {
        @JoinColumn(name = "minimumaltitudearea_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setCentrePointAimingPointItem(TouchDownLiftOffPropertyType target) {
        setCentrePointAimingPoint(XmlAdapterUtils.marshallJAXBElement(TouchDownLiftOffPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "centrePoint_aimingPoint"), MinimumAltitudeAreaTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = AirportHeliportPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "mnmmalttdartmslctp_cntrpntarprtrfrncpnt_l", schema = "procedure", joinColumns = {
        @JoinColumn(name = "minimumaltitudearea_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setCentrePointAirportReferencePointItem(AirportHeliportPropertyType target) {
        setCentrePointAirportReferencePoint(XmlAdapterUtils.marshallJAXBElement(AirportHeliportPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "centrePoint_airportReferencePoint"), MinimumAltitudeAreaTimeSliceType.class, target));
    }
