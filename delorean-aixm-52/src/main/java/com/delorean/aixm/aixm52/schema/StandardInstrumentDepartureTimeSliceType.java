 ...
 *         <element name="contingencyRoute" type="{http://www.aixm.aero/schema/5.2}CodeYesNoType" minOccurs="0"/>
 *         <element name="takeoff" type="{http://www.aixm.aero/schema/5.2}LandingTakeoffAreaCollectionPropertyType" minOccurs="0"/>
 *         <element name="extension" maxOccurs="unbounded" minOccurs="0">
 *           <complexType>
 *             <complexContent>
 *               <restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 <choice>
 *                   <element ref="{http://www.aixm.aero/schema/5.2}AbstractStandardInstrumentDepartureExtension"/>
    ...
    implements Serializable
{
    ...
    @JoinTable(name = "stndrdinstrmntdprtrtmslctp_dsgncrtr_l", schema = "procedure", joinColumns = {
    ...
    @JoinTable(name = "stndrdinstrmntdprtrtmslctp_arcrftcpblt_l", schema = "procedure", joinColumns = {
        @JoinColumn(name = "standardinstrumentdeparture_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setCommunicationFailureInstructionItem(TextInstructionType target) {
        setCommunicationFailureInstruction(XmlAdapterUtils.marshallJAXBElement(TextInstructionType.class, new QName("http://www.aixm.aero/schema/5.2", "communicationFailureInstruction"), StandardInstrumentDepartureTimeSliceType.class, target));
    }
    ...
    public void setInstructionItem(TextInstructionType target) {
        setInstruction(XmlAdapterUtils.marshallJAXBElement(TextInstructionType.class, new QName("http://www.aixm.aero/schema/5.2", "instruction"), StandardInstrumentDepartureTimeSliceType.class, target));
    }
    ...
    public void setCodingStandardItem(CodeProcedureCodingStandardType target) {
        setCodingStandard(XmlAdapterUtils.marshallJAXBElement(CodeProcedureCodingStandardType.class, new QName("http://www.aixm.aero/schema/5.2", "codingStandard"), StandardInstrumentDepartureTimeSliceType.class, target));
    }
    ...
    public void setFlightCheckedItem(CodeYesNoType target) {
        setFlightChecked(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.2", "flightChecked"), StandardInstrumentDepartureTimeSliceType.class, target));
    }
    ...
    public void setAixmNameItem(TextNameType target) {
        setAixmName(XmlAdapterUtils.marshallJAXBElement(TextNameType.class, new QName("http://www.aixm.aero/schema/5.2", "name"), StandardInstrumentDepartureTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = GBASPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "stndrdinstrmntdprtrtmslctp_gdncfcltgrndagmntdgnss_l", schema = "procedure", joinColumns = {
        @JoinColumn(name = "standardinstrumentdeparture_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setGuidanceFacilityGroundAugmentedGNSSItem(GBASPropertyType target) {
        setGuidanceFacilityGroundAugmentedGNSS(XmlAdapterUtils.marshallJAXBElement(GBASPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "guidanceFacility_groundAugmentedGNSS"), StandardInstrumentDepartureTimeSliceType.class, target));
    }
    ...
    public void setGuidanceFacilitySpecialNavigationSystemItem(SpecialNavigationSystemPropertyType target) {
        setGuidanceFacilitySpecialNavigationSystem(XmlAdapterUtils.marshallJAXBElement(SpecialNavigationSystemPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "guidanceFacility_specialNavigationSystem"), StandardInstrumentDepartureTimeSliceType.class, target));
    }
    ...
    public void setGuidanceFacilityRadarItem(RadarSystemPropertyType target) {
        setGuidanceFacilityRadar(XmlAdapterUtils.marshallJAXBElement(RadarSystemPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "guidanceFacility_radar"), StandardInstrumentDepartureTimeSliceType.class, target));
    }
    ...
    public void setGuidanceFacilityNavaidItem(NavaidPropertyType target) {
        setGuidanceFacilityNavaid(XmlAdapterUtils.marshallJAXBElement(NavaidPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "guidanceFacility_navaid"), StandardInstrumentDepartureTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = SatelliteSystemPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "stndrdinstrmntdprtrtmslctp_gdncfcltstlltsrvc_l", schema = "procedure", joinColumns = {
        @JoinColumn(name = "standardinstrumentdeparture_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setGuidanceFacilitySatelliteServiceItem(SatelliteSystemPropertyType target) {
        setGuidanceFacilitySatelliteService(XmlAdapterUtils.marshallJAXBElement(SatelliteSystemPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "guidanceFacility_satelliteService"), StandardInstrumentDepartureTimeSliceType.class, target));
    }
    ...
    public void setMagneticVariationItem(ValMagneticVariationType target) {
        setMagneticVariation(XmlAdapterUtils.marshallJAXBElement(ValMagneticVariationType.class, new QName("http://www.aixm.aero/schema/5.2", "magneticVariation"), StandardInstrumentDepartureTimeSliceType.class, target));
    }
    ...
    public void setDateMagneticVariationItem(DateYearType target) {
        setDateMagneticVariation(XmlAdapterUtils.marshallJAXBElement(DateYearType.class, new QName("http://www.aixm.aero/schema/5.2", "dateMagneticVariation"), StandardInstrumentDepartureTimeSliceType.class, target));
    }
    ...
    public void setAdditionalEquipmentItem(CodeAdditionalEquipmentType target) {
        setAdditionalEquipment(XmlAdapterUtils.marshallJAXBElement(CodeAdditionalEquipmentType.class, new QName("http://www.aixm.aero/schema/5.2", "additionalEquipment"), StandardInstrumentDepartureTimeSliceType.class, target));
    }
    ...
    public void setSpecialAuthorisationItem(CodeYesNoType target) {
        setSpecialAuthorisation(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.2", "specialAuthorisation"), StandardInstrumentDepartureTimeSliceType.class, target));
    }
    ...
    public void setDesignatorItem(TextSIDSTARDesignatorType target) {
        setDesignator(XmlAdapterUtils.marshallJAXBElement(TextSIDSTARDesignatorType.class, new QName("http://www.aixm.aero/schema/5.2", "designator"), StandardInstrumentDepartureTimeSliceType.class, target));
    }
    ...
    public void setContingencyRouteItem(CodeYesNoType target) {
        setContingencyRoute(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.2", "contingencyRoute"), StandardInstrumentDepartureTimeSliceType.class, target));
    }
    ...
    public void setTakeoffItem(LandingTakeoffAreaCollectionPropertyType target) {
        setTakeoff(XmlAdapterUtils.marshallJAXBElement(LandingTakeoffAreaCollectionPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "takeoff"), StandardInstrumentDepartureTimeSliceType.class, target));
    }
