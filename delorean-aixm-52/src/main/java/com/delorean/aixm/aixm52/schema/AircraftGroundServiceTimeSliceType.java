...
/**
 * <p>
 * Java class for AircraftGroundServiceTimeSliceType complex type
 * </p>
 * .
 *
 * <p>
...
"{http://www.aixm.aero/schema/5.2}CodeAircraftGroundServiceType" minOccurs="0"/>
 ...
 *                 <choice>
 *                   <element ref=
"{http://www.aixm.aero/schema/5.2}AbstractAircraftGroundServiceExtension"/>
 *                   <element ref=
...
@XmlType(name = "AircraftGroundServiceTimeSliceType", propOrder = {"flightOperations", "rank", "compliantICAO",
        "aixmName", "location", "serviceProvider", "callSign", "radioCommunication", "groundCommunication",
        "availability", "annotation", "airportHeliport", "type", "extension"})
@Entity(name = "AircraftGroundServiceTimeSliceType")
@Table(name = "aircraftgroundservice_t", schema = "service")
public class AircraftGroundServiceTimeSliceType extends AbstractAIXMTimeSliceType implements Serializable {
    ...
    @JoinTable(name = "arcrftgrndsrvctmslctp_cll-sgn_link", schema = "service", joinColumns = {
            @JoinColumn(name = "aircraftgroundservice_t_hjid", referencedColumnName = "hjid")}, inverseJoinColumns = {
     ...
     *
     * @return possible object is {@link JAXBElement
     *         }{@code <}{@link CodeAircraftGroundServiceType }{@code >}
     *
     */
    @Transient
    ...
    public void setFlightOperationsItem(CodeFlightDestinationType target) {
        setFlightOperations(XmlAdapterUtils.marshallJAXBElement(CodeFlightDestinationType.class,
                ...
                AircraftGroundServiceTimeSliceType.class, target));
    }
    ...
    public void setRankItem(CodeFacilityRankingType target) {
        setRank(XmlAdapterUtils.marshallJAXBElement(CodeFacilityRankingType.class,
                new QName("http://www.aixm.aero/schema/5.2", "rank"), AircraftGroundServiceTimeSliceType.class,
                target));
    }
    ...
    public void setCompliantICAOItem(CodeYesNoType target) {
        setCompliantICAO(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class,
                new QName("http://www.aixm.aero/schema/5.2", "compliantICAO"), AircraftGroundServiceTimeSliceType.class,
                target));
    }
    ...
    public void setAixmNameItem(TextNameType target) {
        setAixmName(XmlAdapterUtils.marshallJAXBElement(TextNameType.class,
                new QName("http://www.aixm.aero/schema/5.2", "name"), AircraftGroundServiceTimeSliceType.class,
                target));
    }
    ...
    public void setLocationItem(AIXMElevatedPointPropertyType target) {
        setLocation(XmlAdapterUtils.marshallJAXBElement(AIXMElevatedPointPropertyType.class,
                new QName("http://www.aixm.aero/schema/5.2", "location"), AircraftGroundServiceTimeSliceType.class,
                target));
    }
    ...
    public void setTypeItem(CodeAircraftGroundServiceType target) {
        setType(XmlAdapterUtils.marshallJAXBElement(CodeAircraftGroundServiceType.class,
                new QName("http://www.aixm.aero/schema/5.2", "type"), AircraftGroundServiceTimeSliceType.class,
                target));
    }
