 ...
 *         <element name="type" type="{http://www.aixm.aero/schema/5.2}CodeAircraftGroundServiceType" minOccurs="0"/>
 *         <element name="extension" maxOccurs="unbounded" minOccurs="0">
 *           <complexType>
 *             <complexContent>
 *               <restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 <choice>
 *                   <element ref="{http://www.aixm.aero/schema/5.2}AbstractAircraftGroundServiceExtension"/>
...
@Entity(name = "AircraftGroundServiceTimeSliceType")
@Table(name = "aircraftgroundservice_t", schema = "service")
    ...
    implements Serializable
{
    ...
    protected List<AircraftGroundServiceTimeSliceExtensionType> extension;
    ...
    @JoinTable(name = "arcrftgrndsrvctmslctp_cll-sgn_link", schema = "service", joinColumns = {
        @JoinColumn(name = "aircraftgroundservice_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "arcrftgrndsrvctmslctp_rdcmmnctn_link", schema = "service", joinColumns = {
        @JoinColumn(name = "aircraftgroundservice_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "arcrftgrndsrvctmslctp_grndcmmnctn_link", schema = "service", joinColumns = {
        @JoinColumn(name = "aircraftgroundservice_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "arcrftgrndsrvctmslctp_avlblt_link", schema = "service", joinColumns = {
        @JoinColumn(name = "aircraftgroundservice_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "arcrftgrndsrvctmslctp_annttn_link", schema = "service", joinColumns = {
        @JoinColumn(name = "aircraftgroundservice_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "arcrftgrndsrvctmslctp_arprthlprt_link", schema = "service", joinColumns = {
        @JoinColumn(name = "aircraftgroundservice_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
     ...
     * 
     */
    @OneToMany(targetEntity = AircraftGroundServiceTimeSliceExtensionType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinColumn(name = "aircraftgroundservice_te_hjid", referencedColumnName = "hjid")
    public List<AircraftGroundServiceTimeSliceExtensionType> getExtension() {
        if (extension == null) {
     ...
     * 
     */
    public void setExtension(List<AircraftGroundServiceTimeSliceExtensionType> extension) {
    ...
    public void setFlightOperationsItem(CodeFlightDestinationType target) {
        setFlightOperations(XmlAdapterUtils.marshallJAXBElement(CodeFlightDestinationType.class, new QName("http://www.aixm.aero/schema/5.2", "flightOperations"), AircraftGroundServiceTimeSliceType.class, target));
    }
    ...
    public void setRankItem(CodeFacilityRankingType target) {
        setRank(XmlAdapterUtils.marshallJAXBElement(CodeFacilityRankingType.class, new QName("http://www.aixm.aero/schema/5.2", "rank"), AircraftGroundServiceTimeSliceType.class, target));
    }
    ...
    public void setCompliantICAOItem(CodeYesNoType target) {
        setCompliantICAO(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.2", "compliantICAO"), AircraftGroundServiceTimeSliceType.class, target));
    }
    ...
    public void setAixmNameItem(TextNameType target) {
        setAixmName(XmlAdapterUtils.marshallJAXBElement(TextNameType.class, new QName("http://www.aixm.aero/schema/5.2", "name"), AircraftGroundServiceTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = AIXMElevatedPointPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "arcrftgrndsrvctmslctp_lctn_link", schema = "service", joinColumns = {
        @JoinColumn(name = "aircraftgroundservice_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setLocationItem(AIXMElevatedPointPropertyType target) {
        setLocation(XmlAdapterUtils.marshallJAXBElement(AIXMElevatedPointPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "location"), AircraftGroundServiceTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = UnitPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "arcrftgrndsrvctmslctp_srvcprvdr_link", schema = "service", joinColumns = {
        @JoinColumn(name = "aircraftgroundservice_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setServiceProviderItem(UnitPropertyType target) {
        setServiceProvider(XmlAdapterUtils.marshallJAXBElement(UnitPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "serviceProvider"), AircraftGroundServiceTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "type", columnDefinition = "codeaircraftgroundservicebase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "typenilreason", columnDefinition = "nilreason"))
    })
    public CodeAircraftGroundServiceType getTypeItem() {
        return XmlAdapterUtils.unmarshallSource(CodeAircraftGroundServiceType.class, this.getType());
    }

    public void setTypeItem(CodeAircraftGroundServiceType target) {
        setType(XmlAdapterUtils.marshallJAXBElement(CodeAircraftGroundServiceType.class, new QName("http://www.aixm.aero/schema/5.2", "type"), AircraftGroundServiceTimeSliceType.class, target));
    }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        final AircraftGroundServiceTimeSliceType that = ((AircraftGroundServiceTimeSliceType) object);
        {
        ...
        }
        {
            ...
            JAXBElement<CodeAircraftGroundServiceType> lhsField;
            lhsField = this.getType();
            JAXBElement<CodeAircraftGroundServiceType> rhsField;
        ...
        }
        {
            ...
            List<AircraftGroundServiceTimeSliceExtensionType> lhsField;
            lhsField = (this.isSetExtension()?this.getExtension():null);
            List<AircraftGroundServiceTimeSliceExtensionType> rhsField;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        }
        {
            ...
            JAXBElement<CodeAircraftGroundServiceType> theField;
        ...
        }
        {
            ...
            List<AircraftGroundServiceTimeSliceExtensionType> theField;
