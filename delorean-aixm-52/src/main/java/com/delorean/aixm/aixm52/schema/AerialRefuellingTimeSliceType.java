 ...
 *       <sequence>
 *         <element name="designatorPrefix" type="{http://www.aixm.aero/schema/5.2}CodeAerialRefuellingPrefixType" minOccurs="0"/>
 *         <element name="designatorNumber" type="{http://www.aixm.aero/schema/5.2}NoNumberType" minOccurs="0"/>
 *         <element name="designatorSuffix" type="{http://www.aixm.aero/schema/5.2}TextDesignatorType" minOccurs="0"/>
 *         <element name="designatorDirection" type="{http://www.aixm.aero/schema/5.2}CodeCardinalDirectionType" minOccurs="0"/>
 *         <element name="name" type="{http://www.aixm.aero/schema/5.2}TextNameType" minOccurs="0"/>
 *         <element name="type" type="{http://www.aixm.aero/schema/5.2}CodeAerialRefuellingType" minOccurs="0"/>
 *         <element name="radarBeaconSetting" type="{http://www.aixm.aero/schema/5.2}NoNumberType" minOccurs="0"/>
 *         <element name="xbandRadarSetting" type="{http://www.aixm.aero/schema/5.2}NoNumberType" minOccurs="0"/>
 *         <element name="tankerChannel" type="{http://www.aixm.aero/schema/5.2}CodeTACANChannelType" minOccurs="0"/>
 *         <element name="receiverChannel" type="{http://www.aixm.aero/schema/5.2}CodeTACANChannelType" minOccurs="0"/>
 *         <element name="helicopterRoute" type="{http://www.aixm.aero/schema/5.2}CodeYesNoType" minOccurs="0"/>
 *         <element name="specialRefuelling" type="{http://www.aixm.aero/schema/5.2}CodeYesNoType" minOccurs="0"/>
 *         <element name="bidirectionalUse" type="{http://www.aixm.aero/schema/5.2}CodeYesNoType" minOccurs="0"/>
 *         <element name="reverseDirectionTurn" type="{http://www.aixm.aero/schema/5.2}CodeDirectionTurnType" minOccurs="0"/>
 ...
 *         <element name="protectingAirspace" type="{http://www.aixm.aero/schema/5.2}AirspacePropertyType" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="track" type="{http://www.aixm.aero/schema/5.2}AerialRefuellingTrackPropertyType" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="anchor" type="{http://www.aixm.aero/schema/5.2}AerialRefuellingAnchorPropertyType" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="oppositeTrack" type="{http://www.aixm.aero/schema/5.2}AerialRefuellingPropertyType" minOccurs="0"/>
 *         <element name="managingOrganisation" type="{http://www.aixm.aero/schema/5.2}AuthorityForAerialRefuellingPropertyType" maxOccurs="unbounded" minOccurs="0"/>
 ...
 *                 <sequence>
 *                   <element ref="{http://www.aixm.aero/schema/5.2}AbstractAerialRefuellingExtension"/>
 *                 </sequence>
...
@Table(name = "aerialrefuelling_t", schema = "aerial_refuelling")
    ...
    implements Serializable
{
    ...
    @XmlElementRef(name = "designatorPrefix", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<CodeAerialRefuellingPrefixType> designatorPrefix;
    @XmlElementRef(name = "designatorNumber", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "designatorDirection", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "radarBeaconSetting", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<NoNumberType> radarBeaconSetting;
    @XmlElementRef(name = "xbandRadarSetting", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<NoNumberType> xbandRadarSetting;
    @XmlElementRef(name = "tankerChannel", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<CodeTACANChannelType> tankerChannel;
    @XmlElementRef(name = "receiverChannel", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<CodeTACANChannelType> receiverChannel;
    @XmlElementRef(name = "helicopterRoute", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<CodeYesNoType> helicopterRoute;
    @XmlElementRef(name = "specialRefuelling", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<CodeYesNoType> specialRefuelling;
    @XmlElementRef(name = "bidirectionalUse", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<CodeYesNoType> bidirectionalUse;
    @XmlElementRef(name = "reverseDirectionTurn", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "oppositeTrack", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    ...
    protected List<AerialRefuellingTimeSliceExtensionType> extension;
    ...
    @JoinTable(name = "arlrfllngtmslctp_avlblt_link", schema = "aerial_refuelling", joinColumns = {
        @JoinColumn(name = "aerialrefuelling_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "arlrfllngtmslctp_prtctngarspc_link", schema = "aerial_refuelling", joinColumns = {
        @JoinColumn(name = "aerialrefuelling_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
        @JoinColumn(name = "protectingairspace_hjid", referencedColumnName = "hjid")
    })
     ...
     * 
     */
    @OneToMany(targetEntity = AerialRefuellingTrackPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "arlrfllngtmslctp_trck_link", schema = "aerial_refuelling", joinColumns = {
        @JoinColumn(name = "aerialrefuelling_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
        @JoinColumn(name = "track_hjid", referencedColumnName = "hjid")
    })
     ...
     * 
     */
    @OneToMany(targetEntity = AerialRefuellingAnchorPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "arlrfllngtmslctp_anchr_link", schema = "aerial_refuelling", joinColumns = {
        @JoinColumn(name = "aerialrefuelling_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
        @JoinColumn(name = "anchor_hjid", referencedColumnName = "hjid")
    })
     ...
     * 
     */
    @OneToMany(targetEntity = AuthorityForAerialRefuellingPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "arlrfllngtmslctp_mngngorgnstn_link", schema = "aerial_refuelling", joinColumns = {
        @JoinColumn(name = "aerialrefuelling_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
        @JoinColumn(name = "managingorganisation_hjid", referencedColumnName = "hjid")
    })
    ...
    @JoinTable(name = "arlrfllngtmslctp_annttn_link", schema = "aerial_refuelling", joinColumns = {
        @JoinColumn(name = "aerialrefuelling_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link AerialRefuellingTimeSliceExtensionType }
     * 
     * 
     */
    @OneToMany(targetEntity = AerialRefuellingTimeSliceExtensionType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinColumn(name = "aerialrefuelling_te_hjid", referencedColumnName = "hjid")
    public List<AerialRefuellingTimeSliceExtensionType> getExtension() {
        if (extension == null) {
     ...
     * 
     */
    public void setExtension(List<AerialRefuellingTimeSliceExtensionType> extension) {
    ...
    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "designatorprefix", columnDefinition = "codeaerialrefuellingprefixbase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "designatorprefixnilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setDesignatorPrefixItem(CodeAerialRefuellingPrefixType target) {
        setDesignatorPrefix(XmlAdapterUtils.marshallJAXBElement(CodeAerialRefuellingPrefixType.class, new QName("http://www.aixm.aero/schema/5.2", "designatorPrefix"), AerialRefuellingTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "designatornumber", columnDefinition = "nonumberbase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "designatornumbernilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setDesignatorNumberItem(NoNumberType target) {
        setDesignatorNumber(XmlAdapterUtils.marshallJAXBElement(NoNumberType.class, new QName("http://www.aixm.aero/schema/5.2", "designatorNumber"), AerialRefuellingTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "designatorsuffix", columnDefinition = "character3")),
    ...
    public void setDesignatorSuffixItem(TextDesignatorType target) {
        setDesignatorSuffix(XmlAdapterUtils.marshallJAXBElement(TextDesignatorType.class, new QName("http://www.aixm.aero/schema/5.2", "designatorSuffix"), AerialRefuellingTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "designatordirection", columnDefinition = "codecardinaldirectionbase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "designatordirectionnilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setDesignatorDirectionItem(CodeCardinalDirectionType target) {
        setDesignatorDirection(XmlAdapterUtils.marshallJAXBElement(CodeCardinalDirectionType.class, new QName("http://www.aixm.aero/schema/5.2", "designatorDirection"), AerialRefuellingTimeSliceType.class, target));
    }
    ...
    public void setAixmNameItem(TextNameType target) {
        setAixmName(XmlAdapterUtils.marshallJAXBElement(TextNameType.class, new QName("http://www.aixm.aero/schema/5.2", "name"), AerialRefuellingTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "type", columnDefinition = "codeaerialrefuellingbase")),
    ...
    public void setTypeItem(CodeAerialRefuellingType target) {
        setType(XmlAdapterUtils.marshallJAXBElement(CodeAerialRefuellingType.class, new QName("http://www.aixm.aero/schema/5.2", "type"), AerialRefuellingTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "radarbeaconsetting", columnDefinition = "nonumberbase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "radarbeaconsettingnilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setRadarBeaconSettingItem(NoNumberType target) {
        setRadarBeaconSetting(XmlAdapterUtils.marshallJAXBElement(NoNumberType.class, new QName("http://www.aixm.aero/schema/5.2", "radarBeaconSetting"), AerialRefuellingTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "xbandradarsetting", columnDefinition = "nonumberbase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "xbandradarsettingnilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setXbandRadarSettingItem(NoNumberType target) {
        setXbandRadarSetting(XmlAdapterUtils.marshallJAXBElement(NoNumberType.class, new QName("http://www.aixm.aero/schema/5.2", "xbandRadarSetting"), AerialRefuellingTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "tankerchannel", columnDefinition = "codetacanchannelbase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "tankerchannelnilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setTankerChannelItem(CodeTACANChannelType target) {
        setTankerChannel(XmlAdapterUtils.marshallJAXBElement(CodeTACANChannelType.class, new QName("http://www.aixm.aero/schema/5.2", "tankerChannel"), AerialRefuellingTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "receiverchannel", columnDefinition = "codetacanchannelbase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "receiverchannelnilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setReceiverChannelItem(CodeTACANChannelType target) {
        setReceiverChannel(XmlAdapterUtils.marshallJAXBElement(CodeTACANChannelType.class, new QName("http://www.aixm.aero/schema/5.2", "receiverChannel"), AerialRefuellingTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "helicopterroute", columnDefinition = "codeyesnobase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "helicopterroutenilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setHelicopterRouteItem(CodeYesNoType target) {
        setHelicopterRoute(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.2", "helicopterRoute"), AerialRefuellingTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "specialrefuelling", columnDefinition = "codeyesnobase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "specialrefuellingnilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setSpecialRefuellingItem(CodeYesNoType target) {
        setSpecialRefuelling(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.2", "specialRefuelling"), AerialRefuellingTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "bidirectionaluse", columnDefinition = "codeyesnobase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "bidirectionalusenilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setBidirectionalUseItem(CodeYesNoType target) {
        setBidirectionalUse(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.2", "bidirectionalUse"), AerialRefuellingTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "reversedirectionturn", columnDefinition = "codedirectionturnbase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "reversedirectionturnnilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setReverseDirectionTurnItem(CodeDirectionTurnType target) {
        setReverseDirectionTurn(XmlAdapterUtils.marshallJAXBElement(CodeDirectionTurnType.class, new QName("http://www.aixm.aero/schema/5.2", "reverseDirectionTurn"), AerialRefuellingTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = AerialRefuellingPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "arlrfllngtmslctp_oppsttrck_link", schema = "aerial_refuelling", joinColumns = {
        @JoinColumn(name = "aerialrefuelling_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
        @JoinColumn(name = "oppositetrack_hjid", referencedColumnName = "hjid")
    })
    ...
    public void setOppositeTrackItem(AerialRefuellingPropertyType target) {
        setOppositeTrack(XmlAdapterUtils.marshallJAXBElement(AerialRefuellingPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "oppositeTrack"), AerialRefuellingTimeSliceType.class, target));
    }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        }
        {
            ...
            List<AerialRefuellingTimeSliceExtensionType> lhsField;
            lhsField = (this.isSetExtension()?this.getExtension():null);
            List<AerialRefuellingTimeSliceExtensionType> rhsField;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        }
        {
            ...
            List<AerialRefuellingTimeSliceExtensionType> theField;
