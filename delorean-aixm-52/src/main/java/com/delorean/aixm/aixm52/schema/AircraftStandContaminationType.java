...
/**
 * <p>Java class for AircraftStandContaminationType complex type</p>.
 * 
 ...
 *                   <element ref="{http://www.aixm.aero/schema/5.2}AbstractAircraftStandContaminationExtension"/>
 *                 </choice>
...
@Entity(name = "AircraftStandContaminationType")
@Table(name = "aircraftstandcontamination_o", schema = "airport_heliport")
    ...
    implements Serializable
{
    ...
    protected List<AircraftStandContaminationExtensionType> extension;
    ...
    @JoinTable(name = "arcrftstndcntmntntp_crtclrdg_link", schema = "airport_heliport", joinColumns = {
        @JoinColumn(name = "aircraftstandcontamination_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "arcrftstndcntmntntp_lr_link", schema = "airport_heliport", joinColumns = {
        @JoinColumn(name = "aircraftstandcontamination_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "arcrftstndcntmntntp_annttn_link", schema = "airport_heliport", joinColumns = {
        @JoinColumn(name = "aircraftstandcontamination_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link AircraftStandContaminationExtensionType }
     * 
     * 
     */
    @OneToMany(targetEntity = AircraftStandContaminationExtensionType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinColumn(name = "aircraftstandcontamination_oe_hjid", referencedColumnName = "hjid")
    public List<AircraftStandContaminationExtensionType> getExtension() {
        if (extension == null) {
     ...
     * 
     */
    public void setExtension(List<AircraftStandContaminationExtensionType> extension) {
    ...
    public void setObservationTimeItem(DateTimeType target) {
        setObservationTime(XmlAdapterUtils.marshallJAXBElement(DateTimeType.class, new QName("http://www.aixm.aero/schema/5.2", "observationTime"), AircraftStandContaminationType.class, target));
    }
    ...
    public void setDepthItem(ValDepthType target) {
        setDepth(XmlAdapterUtils.marshallJAXBElement(ValDepthType.class, new QName("http://www.aixm.aero/schema/5.2", "depth"), AircraftStandContaminationType.class, target));
    }
    ...
    public void setFrictionCoefficientItem(ValFrictionType target) {
        setFrictionCoefficient(XmlAdapterUtils.marshallJAXBElement(ValFrictionType.class, new QName("http://www.aixm.aero/schema/5.2", "frictionCoefficient"), AircraftStandContaminationType.class, target));
    }
    ...
    public void setFrictionEstimationItem(CodeFrictionEstimateType target) {
        setFrictionEstimation(XmlAdapterUtils.marshallJAXBElement(CodeFrictionEstimateType.class, new QName("http://www.aixm.aero/schema/5.2", "frictionEstimation"), AircraftStandContaminationType.class, target));
    }
    ...
    public void setFrictionDeviceItem(CodeFrictionDeviceType target) {
        setFrictionDevice(XmlAdapterUtils.marshallJAXBElement(CodeFrictionDeviceType.class, new QName("http://www.aixm.aero/schema/5.2", "frictionDevice"), AircraftStandContaminationType.class, target));
    }
    ...
    public void setObscuredLightsItem(CodeYesNoType target) {
        setObscuredLights(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.2", "obscuredLights"), AircraftStandContaminationType.class, target));
    }
    ...
    public void setFurtherClearanceTimeItem(TimeType target) {
        setFurtherClearanceTime(XmlAdapterUtils.marshallJAXBElement(TimeType.class, new QName("http://www.aixm.aero/schema/5.2", "furtherClearanceTime"), AircraftStandContaminationType.class, target));
    }
    ...
    public void setFurtherTotalClearanceItem(CodeYesNoType target) {
        setFurtherTotalClearance(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.2", "furtherTotalClearance"), AircraftStandContaminationType.class, target));
    }
    ...
    public void setNextObservationTimeItem(DateTimeType target) {
        setNextObservationTime(XmlAdapterUtils.marshallJAXBElement(DateTimeType.class, new QName("http://www.aixm.aero/schema/5.2", "nextObservationTime"), AircraftStandContaminationType.class, target));
    }
    ...
    public void setProportionItem(ValPercentType target) {
        setProportion(XmlAdapterUtils.marshallJAXBElement(ValPercentType.class, new QName("http://www.aixm.aero/schema/5.2", "proportion"), AircraftStandContaminationType.class, target));
    }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        final AircraftStandContaminationType that = ((AircraftStandContaminationType) object);
        {
        ...
        }
        {
            ...
            List<AircraftStandContaminationExtensionType> lhsField;
            lhsField = (this.isSetExtension()?this.getExtension():null);
            List<AircraftStandContaminationExtensionType> rhsField;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        }
        {
            ...
            List<AircraftStandContaminationExtensionType> theField;
