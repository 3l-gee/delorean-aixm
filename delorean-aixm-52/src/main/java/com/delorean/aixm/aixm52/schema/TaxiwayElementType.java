...
"{http://www.aixm.aero/schema/5.2}TaxiwayElementTimeSlicePropertyType" maxOccurs
="unbounded"/>
 *       </sequence>
 *     </extension>
 *   </complexContent>
...
@Table(name = "taxiwayelement_f", schema = "airport_heliport")
public class TaxiwayElementType extends AbstractAIXMFeatureType implements Serializable {
    ...
    @OneToMany(targetEntity = TaxiwayElementTimeSlicePropertyType.class, cascade = {
