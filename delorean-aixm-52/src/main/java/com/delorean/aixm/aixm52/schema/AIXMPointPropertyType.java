...
import com.delorean.aixm.aixm52.gis.adapter.PointTypeAdapter;
import com.delorean.aixm.aixm52.gis.type.AixmPointType;
...
public class AIXMPointPropertyType extends AbstractAIXMPropertyType implements Serializable {
    ...
    @jakarta.persistence.JoinColumn(name = "point_hjid", referencedColumnName = "hjid")
