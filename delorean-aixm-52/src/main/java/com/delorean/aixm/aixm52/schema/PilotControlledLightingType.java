 ...
 *       <sequence>
 *         <element name="timeSlice" type="{http://www.aixm.aero/schema/5.2}PilotControlledLightingTimeSlicePropertyType" maxOccurs="unbounded"/>
 *       </sequence>
 *     </extension>
 *   </complexContent>
 * </complexType>
...
@Table(name = "pilotcontrolledlighting_f", schema = "service")
    ...
    implements Serializable
{
    ...
    @OneToMany(targetEntity = PilotControlledLightingTimeSlicePropertyType.class, cascade = {
        CascadeType.ALL
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        final PilotControlledLightingType that = ((PilotControlledLightingType) object);
        {
