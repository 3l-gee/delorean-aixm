 ...
 *         <element name="markedStand" type="{http://www.aixm.aero/schema/5.2}AircraftStandPropertyType" minOccurs="0"/>
 *         <element name="extension" maxOccurs="unbounded" minOccurs="0">
 *           <complexType>
 *             <complexContent>
 *               <restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 <choice>
 *                   <element ref="{http://www.aixm.aero/schema/5.2}AbstractStandMarkingExtension"/>
    ...
    implements Serializable
{
    ...
    @XmlElementRef(name = "markedStand", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    ...
    public void setMarkingICAOStandardItem(CodeYesNoType target) {
        setMarkingICAOStandard(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.2", "markingICAOStandard"), StandMarkingTimeSliceType.class, target));
    }
    ...
    public void setConditionItem(CodeMarkingConditionType target) {
        setCondition(XmlAdapterUtils.marshallJAXBElement(CodeMarkingConditionType.class, new QName("http://www.aixm.aero/schema/5.2", "condition"), StandMarkingTimeSliceType.class, target));
    }
    ...
    public void setMarkedStandItem(AircraftStandPropertyType target) {
        setMarkedStand(XmlAdapterUtils.marshallJAXBElement(AircraftStandPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "markedStand"), StandMarkingTimeSliceType.class, target));
    }
