 ...
 *       <sequence>
 *         <element name="priorPermission" type="{http://www.aixm.aero/schema/5.2}CodeYesNoType" minOccurs="0"/>
 *         <element name="routeElement" type="{http://www.aixm.aero/schema/5.2}FlightRoutingElementPropertyType" maxOccurs="unbounded" minOccurs="0"/>
 ...
 *                 <choice>
 *                   <element ref="{http://www.aixm.aero/schema/5.2}AbstractFlightRestrictionRouteExtension"/>
 *                 </choice>
    ...
    implements Serializable
{
    ...
    @JoinTable(name = "flghtrstrctnrttp_rtelmnt_link", schema = "route", joinColumns = {
        @JoinColumn(name = "flightrestrictionroute_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "priorpermission", columnDefinition = "codeyesnobase")),
    ...
    public void setPriorPermissionItem(CodeYesNoType target) {
        setPriorPermission(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.2", "priorPermission"), FlightRestrictionRouteType.class, target));
    }
