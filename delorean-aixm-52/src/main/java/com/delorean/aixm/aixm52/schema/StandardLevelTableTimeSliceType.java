 ...
 *       <sequence>
 *         <element name="name" type="{http://www.aixm.aero/schema/5.2}CodeLevelTableDesignatorType" minOccurs="0"/>
 *         <element name="standardICAO" type="{http://www.aixm.aero/schema/5.2}CodeYesNoType" minOccurs="0"/>
 ...
 *                 <sequence>
 *                   <element ref="{http://www.aixm.aero/schema/5.2}AbstractStandardLevelTableExtension"/>
 *                 </sequence>
    ...
    implements Serializable
{
    ...
    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "name", columnDefinition = "codeleveltabledesignatorbase")),
    ...
    public void setAixmNameItem(CodeLevelTableDesignatorType target) {
        setAixmName(XmlAdapterUtils.marshallJAXBElement(CodeLevelTableDesignatorType.class, new QName("http://www.aixm.aero/schema/5.2", "name"), StandardLevelTableTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "standardicao", columnDefinition = "codeyesnobase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "standardicaonilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setStandardICAOItem(CodeYesNoType target) {
        setStandardICAO(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.2", "standardICAO"), StandardLevelTableTimeSliceType.class, target));
    }
