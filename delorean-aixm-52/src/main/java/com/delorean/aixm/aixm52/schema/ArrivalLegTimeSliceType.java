...
/**
 * <p>Java class for ArrivalLegTimeSliceType complex type</p>.
 * 
 ...
 *         <element name="arrival" type="{http://www.aixm.aero/schema/5.2}StandardInstrumentArrivalPropertyType" minOccurs="0"/>
 *         <element name="extension" maxOccurs="unbounded" minOccurs="0">
 *           <complexType>
 *             <complexContent>
 *               <restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 <choice>
 *                   <element ref="{http://www.aixm.aero/schema/5.2}AbstractArrivalLegExtension"/>
...
@Entity(name = "ArrivalLegTimeSliceType")
@Table(name = "arrivalleg_t", schema = "procedure")
    ...
    implements Serializable
{
    ...
    @XmlElementRef(name = "arrival", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<StandardInstrumentArrivalPropertyType> arrival;
    protected List<ArrivalLegTimeSliceExtensionType> extension;
    ...
    @JoinTable(name = "arrvllgtmslctp_dsgnsrfc_link", schema = "procedure", joinColumns = {
        @JoinColumn(name = "arrivalleg_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "arrvllgtmslctp_annttn_link", schema = "procedure", joinColumns = {
        @JoinColumn(name = "arrivalleg_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "arrvllgtmslctp_arcrftcpblt_link", schema = "procedure", joinColumns = {
        @JoinColumn(name = "arrivalleg_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "arrvllgtmslctp_sgmntcrs_link", schema = "procedure", joinColumns = {
        @JoinColumn(name = "arrivalleg_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "arrvllgtmslctp_alttdcndtn_link", schema = "procedure", joinColumns = {
        @JoinColumn(name = "arrivalleg_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link ArrivalLegTimeSliceExtensionType }
     * 
     * 
     */
    @OneToMany(targetEntity = ArrivalLegTimeSliceExtensionType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinColumn(name = "arrivalleg_te_hjid", referencedColumnName = "hjid")
    public List<ArrivalLegTimeSliceExtensionType> getExtension() {
        if (extension == null) {
     ...
     * 
     */
    public void setExtension(List<ArrivalLegTimeSliceExtensionType> extension) {
    ...
    public void setEndConditionDesignatorItem(CodeSegmentTerminationType target) {
        setEndConditionDesignator(XmlAdapterUtils.marshallJAXBElement(CodeSegmentTerminationType.class, new QName("http://www.aixm.aero/schema/5.2", "endConditionDesignator"), ArrivalLegTimeSliceType.class, target));
    }
    ...
    public void setLegPathItem(CodeTrajectoryType target) {
        setLegPath(XmlAdapterUtils.marshallJAXBElement(CodeTrajectoryType.class, new QName("http://www.aixm.aero/schema/5.2", "legPath"), ArrivalLegTimeSliceType.class, target));
    }
    ...
    public void setLegTypeARINCItem(CodeSegmentPathType target) {
        setLegTypeARINC(XmlAdapterUtils.marshallJAXBElement(CodeSegmentPathType.class, new QName("http://www.aixm.aero/schema/5.2", "legTypeARINC"), ArrivalLegTimeSliceType.class, target));
    }
    ...
    public void setTurnDirectionItem(CodeDirectionTurnType target) {
        setTurnDirection(XmlAdapterUtils.marshallJAXBElement(CodeDirectionTurnType.class, new QName("http://www.aixm.aero/schema/5.2", "turnDirection"), ArrivalLegTimeSliceType.class, target));
    }
    ...
    public void setSpeedLimitItem(ValSpeedType target) {
        setSpeedLimit(XmlAdapterUtils.marshallJAXBElement(ValSpeedType.class, new QName("http://www.aixm.aero/schema/5.2", "speedLimit"), ArrivalLegTimeSliceType.class, target));
    }
    ...
    public void setSpeedReferenceItem(CodeSpeedReferenceType target) {
        setSpeedReference(XmlAdapterUtils.marshallJAXBElement(CodeSpeedReferenceType.class, new QName("http://www.aixm.aero/schema/5.2", "speedReference"), ArrivalLegTimeSliceType.class, target));
    }
    ...
    public void setSpeedInterpretationItem(CodeSpeedInterpretationUseType target) {
        setSpeedInterpretation(XmlAdapterUtils.marshallJAXBElement(CodeSpeedInterpretationUseType.class, new QName("http://www.aixm.aero/schema/5.2", "speedInterpretation"), ArrivalLegTimeSliceType.class, target));
    }
    ...
    public void setBankAngleItem(ValAngleType target) {
        setBankAngle(XmlAdapterUtils.marshallJAXBElement(ValAngleType.class, new QName("http://www.aixm.aero/schema/5.2", "bankAngle"), ArrivalLegTimeSliceType.class, target));
    }
    ...
    public void setLengthItem(ValDistanceType target) {
        setLength(XmlAdapterUtils.marshallJAXBElement(ValDistanceType.class, new QName("http://www.aixm.aero/schema/5.2", "length"), ArrivalLegTimeSliceType.class, target));
    }
    ...
    public void setDurationItem(ValDurationType target) {
        setDuration(XmlAdapterUtils.marshallJAXBElement(ValDurationType.class, new QName("http://www.aixm.aero/schema/5.2", "duration"), ArrivalLegTimeSliceType.class, target));
    }
    ...
    public void setProcedureTurnRequiredItem(CodeYesNoType target) {
        setProcedureTurnRequired(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.2", "procedureTurnRequired"), ArrivalLegTimeSliceType.class, target));
    }
    ...
    public void setUpperLimitReferenceItem(CodeVerticalReferenceType target) {
        setUpperLimitReference(XmlAdapterUtils.marshallJAXBElement(CodeVerticalReferenceType.class, new QName("http://www.aixm.aero/schema/5.2", "upperLimitReference"), ArrivalLegTimeSliceType.class, target));
    }
    ...
    public void setLowerLimitReferenceItem(CodeVerticalReferenceType target) {
        setLowerLimitReference(XmlAdapterUtils.marshallJAXBElement(CodeVerticalReferenceType.class, new QName("http://www.aixm.aero/schema/5.2", "lowerLimitReference"), ArrivalLegTimeSliceType.class, target));
    }
    ...
    public void setAltitudeOverrideATCItem(ValDistanceVerticalType target) {
        setAltitudeOverrideATC(XmlAdapterUtils.marshallJAXBElement(ValDistanceVerticalType.class, new QName("http://www.aixm.aero/schema/5.2", "altitudeOverrideATC"), ArrivalLegTimeSliceType.class, target));
    }
    ...
    public void setAltitudeOverrideReferenceItem(CodeVerticalReferenceType target) {
        setAltitudeOverrideReference(XmlAdapterUtils.marshallJAXBElement(CodeVerticalReferenceType.class, new QName("http://www.aixm.aero/schema/5.2", "altitudeOverrideReference"), ArrivalLegTimeSliceType.class, target));
    }
    ...
    public void setVerticalAngleItem(ValAngleType target) {
        setVerticalAngle(XmlAdapterUtils.marshallJAXBElement(ValAngleType.class, new QName("http://www.aixm.aero/schema/5.2", "verticalAngle"), ArrivalLegTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = TerminalSegmentPointPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "arrvllgtmslctp_strtpnt_link", schema = "procedure", joinColumns = {
        @JoinColumn(name = "arrivalleg_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setStartPointItem(TerminalSegmentPointPropertyType target) {
        setStartPoint(XmlAdapterUtils.marshallJAXBElement(TerminalSegmentPointPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "startPoint"), ArrivalLegTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = TerminalSegmentPointPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "arrvllgtmslctp_endpnt_link", schema = "procedure", joinColumns = {
        @JoinColumn(name = "arrivalleg_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setEndPointItem(TerminalSegmentPointPropertyType target) {
        setEndPoint(XmlAdapterUtils.marshallJAXBElement(TerminalSegmentPointPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "endPoint"), ArrivalLegTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = AIXMCurvePropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "arrvllgtmslctp_trjctr_link", schema = "procedure", joinColumns = {
        @JoinColumn(name = "arrivalleg_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setTrajectoryItem(AIXMCurvePropertyType target) {
        setTrajectory(XmlAdapterUtils.marshallJAXBElement(AIXMCurvePropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "trajectory"), ArrivalLegTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = TerminalSegmentPointPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "arrvllgtmslctp_arccntr_link", schema = "procedure", joinColumns = {
        @JoinColumn(name = "arrivalleg_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setArcCentreItem(TerminalSegmentPointPropertyType target) {
        setArcCentre(XmlAdapterUtils.marshallJAXBElement(TerminalSegmentPointPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "arcCentre"), ArrivalLegTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = HoldingUsePropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "arrvllgtmslctp_hldng_link", schema = "procedure", joinColumns = {
        @JoinColumn(name = "arrivalleg_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setHoldingItem(HoldingUsePropertyType target) {
        setHolding(XmlAdapterUtils.marshallJAXBElement(HoldingUsePropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "holding"), ArrivalLegTimeSliceType.class, target));
    }
    ...
    public void setUpperLimitItem(ValDistanceVerticalType target) {
        setUpperLimit(XmlAdapterUtils.marshallJAXBElement(ValDistanceVerticalType.class, new QName("http://www.aixm.aero/schema/5.2", "upperLimit"), ArrivalLegTimeSliceType.class, target));
    }
    ...
    public void setLowerLimitItem(ValDistanceVerticalType target) {
        setLowerLimit(XmlAdapterUtils.marshallJAXBElement(ValDistanceVerticalType.class, new QName("http://www.aixm.aero/schema/5.2", "lowerLimit"), ArrivalLegTimeSliceType.class, target));
    }
    ...
    public void setVerticalLimitsInterpretationItem(CodeAltitudeUseType target) {
        setVerticalLimitsInterpretation(XmlAdapterUtils.marshallJAXBElement(CodeAltitudeUseType.class, new QName("http://www.aixm.aero/schema/5.2", "verticalLimitsInterpretation"), ArrivalLegTimeSliceType.class, target));
    }
    ...
    public void setRadiusItem(ValDistanceType target) {
        setRadius(XmlAdapterUtils.marshallJAXBElement(ValDistanceType.class, new QName("http://www.aixm.aero/schema/5.2", "radius"), ArrivalLegTimeSliceType.class, target));
    }
    ...
    public void setAdditionalEquipmentItem(CodeAdditionalEquipmentType target) {
        setAdditionalEquipment(XmlAdapterUtils.marshallJAXBElement(CodeAdditionalEquipmentType.class, new QName("http://www.aixm.aero/schema/5.2", "additionalEquipment"), ArrivalLegTimeSliceType.class, target));
    }
    ...
    public void setMinimumObstacleClearanceAltitudeItem(ValDistanceVerticalType target) {
        setMinimumObstacleClearanceAltitude(XmlAdapterUtils.marshallJAXBElement(ValDistanceVerticalType.class, new QName("http://www.aixm.aero/schema/5.2", "minimumObstacleClearanceAltitude"), ArrivalLegTimeSliceType.class, target));
    }
    ...
    public void setMinimumObstacleClearanceHeightItem(ValDistanceVerticalType target) {
        setMinimumObstacleClearanceHeight(XmlAdapterUtils.marshallJAXBElement(ValDistanceVerticalType.class, new QName("http://www.aixm.aero/schema/5.2", "minimumObstacleClearanceHeight"), ArrivalLegTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = DistancePropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "arrvllgtmslctp_lmtngdstnc_link", schema = "procedure", joinColumns = {
        @JoinColumn(name = "arrivalleg_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setLimitingDistanceItem(DistancePropertyType target) {
        setLimitingDistance(XmlAdapterUtils.marshallJAXBElement(DistancePropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "limitingDistance"), ArrivalLegTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = AnglePropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "arrvllgtmslctp_lmtngangl_link", schema = "procedure", joinColumns = {
        @JoinColumn(name = "arrivalleg_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setLimitingAngleItem(AnglePropertyType target) {
        setLimitingAngle(XmlAdapterUtils.marshallJAXBElement(AnglePropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "limitingAngle"), ArrivalLegTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = StandardInstrumentArrivalPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "arrvllgtmslctp_arrvl_link", schema = "procedure", joinColumns = {
        @JoinColumn(name = "arrivalleg_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
        @JoinColumn(name = "arrival_hjid", referencedColumnName = "hjid")
    })
    public StandardInstrumentArrivalPropertyType getArrivalItem() {
        return XmlAdapterUtils.unmarshallSource(StandardInstrumentArrivalPropertyType.class, this.getArrival());
    }

    public void setArrivalItem(StandardInstrumentArrivalPropertyType target) {
        setArrival(XmlAdapterUtils.marshallJAXBElement(StandardInstrumentArrivalPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "arrival"), ArrivalLegTimeSliceType.class, target));
    }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        final ArrivalLegTimeSliceType that = ((ArrivalLegTimeSliceType) object);
        {
        ...
        }
        {
            ...
            List<ArrivalLegTimeSliceExtensionType> lhsField;
            lhsField = (this.isSetExtension()?this.getExtension():null);
            List<ArrivalLegTimeSliceExtensionType> rhsField;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetArrival();
            JAXBElement<StandardInstrumentArrivalPropertyType> theField;
            theField = this.getArrival();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "arrival", theField);
            currentHashCode = strategy.hashCode(theFieldLocator, currentHashCode, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetExtension();
            List<ArrivalLegTimeSliceExtensionType> theField;
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        }
        {
            ...
            JAXBElement<StandardInstrumentArrivalPropertyType> theField;
            theField = this.getArrival();
            strategy.appendField(locator, this, "arrival", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetExtension();
            List<ArrivalLegTimeSliceExtensionType> theField;
