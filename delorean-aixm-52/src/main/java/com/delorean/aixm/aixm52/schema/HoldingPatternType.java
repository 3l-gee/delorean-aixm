...
"{http://www.aixm.aero/schema/5.2}HoldingPatternTimeSlicePropertyType" maxOccurs
="unbounded"/>
 *       </sequence>
 *     </extension>
 *   </complexContent>
...
@Table(name = "holdingpattern_f", schema = "holding")
public class HoldingPatternType extends AbstractAIXMFeatureType implements Serializable {
    ...
    @OneToMany(targetEntity = HoldingPatternTimeSlicePropertyType.class, cascade = {
