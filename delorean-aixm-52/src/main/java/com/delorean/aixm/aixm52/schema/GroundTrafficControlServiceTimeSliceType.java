 ...
 *         <element name="type" type="{http://www.aixm.aero/schema/5.2}CodeServiceGroundControlType" minOccurs="0"/>
 *         <element name="clientAirport" type="{http://www.aixm.aero/schema/5.2}AirportHeliportPropertyType" minOccurs="0"/>
 *         <element name="extension" maxOccurs="unbounded" minOccurs="0">
 *           <complexType>
 *             <complexContent>
 *               <restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 <choice>
 *                   <element ref="{http://www.aixm.aero/schema/5.2}AbstractGroundTrafficControlServiceExtension"/>
...
@Entity(name = "GroundTrafficControlServiceTimeSliceType")
@Table(name = "groundtrafficcontrolservice_t", schema = "service")
    ...
    implements Serializable
{
    ...
    @XmlElementRef(name = "clientAirport", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<AirportHeliportPropertyType> clientAirport;
    protected List<GroundTrafficControlServiceTimeSliceExtensionType> extension;
    ...
    @JoinTable(name = "grndtrffccntrlsrvctmslctp_cll-sgn_link", schema = "service", joinColumns = {
        @JoinColumn(name = "groundtrafficcontrolservice_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "grndtrffccntrlsrvctmslctp_rdcmmnctn_link", schema = "service", joinColumns = {
        @JoinColumn(name = "groundtrafficcontrolservice_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "grndtrffccntrlsrvctmslctp_grndcmmnctn_link", schema = "service", joinColumns = {
        @JoinColumn(name = "groundtrafficcontrolservice_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "grndtrffccntrlsrvctmslctp_avlblt_link", schema = "service", joinColumns = {
        @JoinColumn(name = "groundtrafficcontrolservice_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "grndtrffccntrlsrvctmslctp_annttn_link", schema = "service", joinColumns = {
        @JoinColumn(name = "groundtrafficcontrolservice_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
     ...
     * 
     */
    @OneToMany(targetEntity = GroundTrafficControlServiceTimeSliceExtensionType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinColumn(name = "groundtrafficcontrolservice_te_hjid", referencedColumnName = "hjid")
    public List<GroundTrafficControlServiceTimeSliceExtensionType> getExtension() {
        if (extension == null) {
     ...
     * 
     */
    public void setExtension(List<GroundTrafficControlServiceTimeSliceExtensionType> extension) {
    ...
    public void setFlightOperationsItem(CodeFlightDestinationType target) {
        setFlightOperations(XmlAdapterUtils.marshallJAXBElement(CodeFlightDestinationType.class, new QName("http://www.aixm.aero/schema/5.2", "flightOperations"), GroundTrafficControlServiceTimeSliceType.class, target));
    }
    ...
    public void setRankItem(CodeFacilityRankingType target) {
        setRank(XmlAdapterUtils.marshallJAXBElement(CodeFacilityRankingType.class, new QName("http://www.aixm.aero/schema/5.2", "rank"), GroundTrafficControlServiceTimeSliceType.class, target));
    }
    ...
    public void setCompliantICAOItem(CodeYesNoType target) {
        setCompliantICAO(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.2", "compliantICAO"), GroundTrafficControlServiceTimeSliceType.class, target));
    }
    ...
    public void setAixmNameItem(TextNameType target) {
        setAixmName(XmlAdapterUtils.marshallJAXBElement(TextNameType.class, new QName("http://www.aixm.aero/schema/5.2", "name"), GroundTrafficControlServiceTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = AIXMElevatedPointPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "grndtrffccntrlsrvctmslctp_lctn_link", schema = "service", joinColumns = {
        @JoinColumn(name = "groundtrafficcontrolservice_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setLocationItem(AIXMElevatedPointPropertyType target) {
        setLocation(XmlAdapterUtils.marshallJAXBElement(AIXMElevatedPointPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "location"), GroundTrafficControlServiceTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = UnitPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "grndtrffccntrlsrvctmslctp_srvcprvdr_link", schema = "service", joinColumns = {
        @JoinColumn(name = "groundtrafficcontrolservice_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setServiceProviderItem(UnitPropertyType target) {
        setServiceProvider(XmlAdapterUtils.marshallJAXBElement(UnitPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "serviceProvider"), GroundTrafficControlServiceTimeSliceType.class, target));
    }
    ...
    public void setRadarAssistedItem(CodeYesNoType target) {
        setRadarAssisted(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.2", "radarAssisted"), GroundTrafficControlServiceTimeSliceType.class, target));
    }
    ...
    public void setDataLinkEnabledItem(CodeYesNoType target) {
        setDataLinkEnabled(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.2", "dataLinkEnabled"), GroundTrafficControlServiceTimeSliceType.class, target));
    }
    ...
    public void setDataLinkChannelItem(CodeCommunicationChannelType target) {
        setDataLinkChannel(XmlAdapterUtils.marshallJAXBElement(CodeCommunicationChannelType.class, new QName("http://www.aixm.aero/schema/5.2", "dataLinkChannel"), GroundTrafficControlServiceTimeSliceType.class, target));
    }
    ...
    public void setDataLinkStandardItem(CodeDataLinkStandardType target) {
        setDataLinkStandard(XmlAdapterUtils.marshallJAXBElement(CodeDataLinkStandardType.class, new QName("http://www.aixm.aero/schema/5.2", "dataLinkStandard"), GroundTrafficControlServiceTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "type", columnDefinition = "codeservicegroundcontrolbase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "typenilreason", columnDefinition = "nilreason"))
    })
    public CodeServiceGroundControlType getTypeItem() {
        return XmlAdapterUtils.unmarshallSource(CodeServiceGroundControlType.class, this.getType());
    }

    public void setTypeItem(CodeServiceGroundControlType target) {
        setType(XmlAdapterUtils.marshallJAXBElement(CodeServiceGroundControlType.class, new QName("http://www.aixm.aero/schema/5.2", "type"), GroundTrafficControlServiceTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = AirportHeliportPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "grndtrffccntrlsrvctmslctp_clntarprt_link", schema = "service", joinColumns = {
        @JoinColumn(name = "groundtrafficcontrolservice_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
        @JoinColumn(name = "clientairport_hjid", referencedColumnName = "hjid")
    })
    public AirportHeliportPropertyType getClientAirportItem() {
        return XmlAdapterUtils.unmarshallSource(AirportHeliportPropertyType.class, this.getClientAirport());
    }

    public void setClientAirportItem(AirportHeliportPropertyType target) {
        setClientAirport(XmlAdapterUtils.marshallJAXBElement(AirportHeliportPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "clientAirport"), GroundTrafficControlServiceTimeSliceType.class, target));
    }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        final GroundTrafficControlServiceTimeSliceType that = ((GroundTrafficControlServiceTimeSliceType) object);
        {
        ...
        }
        {
            ...
            List<GroundTrafficControlServiceTimeSliceExtensionType> lhsField;
            lhsField = (this.isSetExtension()?this.getExtension():null);
            List<GroundTrafficControlServiceTimeSliceExtensionType> rhsField;
        ...
        }
        {
            ...
            JAXBElement<CodeServiceGroundControlType> lhsField;
            lhsField = this.getType();
            JAXBElement<CodeServiceGroundControlType> rhsField;
        ...
        }
        {
            ...
            lhsField = this.getClientAirport();
            JAXBElement<AirportHeliportPropertyType> rhsField;
            rhsField = that.getClientAirport();
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        }
        {
            ...
            JAXBElement<CodeServiceGroundControlType> theField;
        ...
        }
        {
            ...
            theField = this.getClientAirport();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "clientAirport", theField);
            currentHashCode = strategy.hashCode(theFieldLocator, currentHashCode, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetExtension();
            List<GroundTrafficControlServiceTimeSliceExtensionType> theField;
