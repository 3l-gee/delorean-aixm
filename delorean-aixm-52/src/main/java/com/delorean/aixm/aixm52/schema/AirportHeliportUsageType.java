 ...
 *   <complexContent>
 *     <extension base="{http://www.aixm.aero/schema/5.2}AbstractUsageConditionType">
 *       <sequence>
 *         <element name="type" type="{http://www.aixm.aero/schema/5.2}CodeUsageLimitationType" minOccurs="0"/>
 *         <element name="priorPermission" type="{http://www.aixm.aero/schema/5.2}ValDurationType" minOccurs="0"/>
 *         <element name="contact" type="{http://www.aixm.aero/schema/5.2}ContactInformationPropertyType" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="selection" type="{http://www.aixm.aero/schema/5.2}ConditionCombinationPropertyType" minOccurs="0"/>
 *         <element name="annotation" type="{http://www.aixm.aero/schema/5.2}NotePropertyType" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="operation" type="{http://www.aixm.aero/schema/5.2}CodeOperationAirportHeliportType" minOccurs="0"/>
 *         <element name="extension" maxOccurs="unbounded" minOccurs="0">
 *           <complexType>
 *             <complexContent>
 *               <restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 <choice>
 *                   <element ref="{http://www.aixm.aero/schema/5.2}AbstractUsageConditionExtension"/>
 *                   <element ref="{http://www.aixm.aero/schema/5.2}AbstractAirportHeliportUsageExtension"/>
 *                 </choice>
...
@Table(name = "airportheliportusage_o", schema = "airport_heliport")
    ...
    implements Serializable
{
    ...
    @XmlElementRef(name = "priorPermission", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<ValDurationType> priorPermission;
    @XmlElement(nillable = true)
    protected List<ContactInformationPropertyType> contact;
    @XmlElementRef(name = "selection", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    ...
    protected List<AirportHeliportUsageExtensionType> extension;
    ...
    @JoinTable(name = "arprthlprtusgtp_cntct_link", schema = "airport_heliport", joinColumns = {
        @JoinColumn(name = "airportheliportusage_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "arprthlprtusgtp_annttn_link", schema = "airport_heliport", joinColumns = {
        @JoinColumn(name = "airportheliportusage_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link AirportHeliportUsageExtensionType }
     * 
     * 
     */
    @OneToMany(targetEntity = AirportHeliportUsageExtensionType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinColumn(name = "airportheliportusage_oe_hjid", referencedColumnName = "hjid")
    public List<AirportHeliportUsageExtensionType> getExtension() {
        if (extension == null) {
     ...
     * 
     */
    public void setExtension(List<AirportHeliportUsageExtensionType> extension) {
    ...
    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "type", columnDefinition = "codeusagelimitationbase")),
    ...
    public void setTypeItem(CodeUsageLimitationType target) {
        setType(XmlAdapterUtils.marshallJAXBElement(CodeUsageLimitationType.class, new QName("http://www.aixm.aero/schema/5.2", "type"), AirportHeliportUsageType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "priorpermission", columnDefinition = "valdurationbase")),
        @AttributeOverride(name = "uom", column = @Column(name = "priorpermissionuom", columnDefinition = "uomduration")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "priorpermissionnilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setPriorPermissionItem(ValDurationType target) {
        setPriorPermission(XmlAdapterUtils.marshallJAXBElement(ValDurationType.class, new QName("http://www.aixm.aero/schema/5.2", "priorPermission"), AirportHeliportUsageType.class, target));
    }

    @OneToOne(targetEntity = ConditionCombinationPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "arprthlprtusgtp_slctn_link", schema = "airport_heliport", joinColumns = {
        @JoinColumn(name = "airportheliportusage_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setSelectionItem(ConditionCombinationPropertyType target) {
        setSelection(XmlAdapterUtils.marshallJAXBElement(ConditionCombinationPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "selection"), AirportHeliportUsageType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "operation", columnDefinition = "codeoperationairportheliportbase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "operationnilreason", columnDefinition = "nilreason"))
    })
    public CodeOperationAirportHeliportType getOperationItem() {
        return XmlAdapterUtils.unmarshallSource(CodeOperationAirportHeliportType.class, this.getOperation());
    }

    public void setOperationItem(CodeOperationAirportHeliportType target) {
        setOperation(XmlAdapterUtils.marshallJAXBElement(CodeOperationAirportHeliportType.class, new QName("http://www.aixm.aero/schema/5.2", "operation"), AirportHeliportUsageType.class, target));
    }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        }
        {
            ...
            List<AirportHeliportUsageExtensionType> lhsField;
            lhsField = (this.isSetExtension()?this.getExtension():null);
            List<AirportHeliportUsageExtensionType> rhsField;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        }
        {
            ...
            JAXBElement<CodeOperationAirportHeliportType> theField;
        ...
        }
        {
            ...
            List<AirportHeliportUsageExtensionType> theField;
