 ...
 *                 <choice>
 *                   <element ref="{http://www.aixm.aero/schema/5.2}AbstractAuthorityForAerialRefuellingExtension"/>
 *                 </choice>
    ...
    implements Serializable
{
    ...
    @JoinTable(name = "athrtfrarlrfllngtp_annttn_link", schema = "aerial_refuelling", joinColumns = {
    ...
    public void setTypeItem(CodeAuthorityType target) {
        setType(XmlAdapterUtils.marshallJAXBElement(CodeAuthorityType.class, new QName("http://www.aixm.aero/schema/5.2", "type"), AuthorityForAerialRefuellingType.class, target));
    }

    @OneToOne(targetEntity = OrganisationAuthorityPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "athrtfrarlrfllngtp_thorgnstnathrt_link", schema = "aerial_refuelling", joinColumns = {
        @JoinColumn(name = "authorityforaerialrefuelling_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setTheOrganisationAuthorityItem(OrganisationAuthorityPropertyType target) {
        setTheOrganisationAuthority(XmlAdapterUtils.marshallJAXBElement(OrganisationAuthorityPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "theOrganisationAuthority"), AuthorityForAerialRefuellingType.class, target));
    }
