 ...
 *         <element name="type" type="{http://www.aixm.aero/schema/5.2}CodeAircraftStandType" minOccurs="0"/>
 *         <element name="visualDockingSystem" type="{http://www.aixm.aero/schema/5.2}CodeVisualDockingGuidanceType" minOccurs="0"/>
 ...
 *         <element name="apronLocation" type="{http://www.aixm.aero/schema/5.2}ApronElementPropertyType" minOccurs="0"/>
 *         <element name="extent" type="{http://www.aixm.aero/schema/5.2}ElevatedSurfacePropertyType" minOccurs="0"/>
 *         <element name="contaminant" type="{http://www.aixm.aero/schema/5.2}AircraftStandContaminationPropertyType" maxOccurs="unbounded" minOccurs="0"/>
 ...
 *                 <sequence>
 *                   <element ref="{http://www.aixm.aero/schema/5.2}AbstractAircraftStandExtension"/>
 *                 </sequence>
    ...
    implements Serializable
{
    ...
    @XmlElementRef(name = "visualDockingSystem", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "apronLocation", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    ...
    protected List<AircraftStandTimeSliceExtensionType> extension;
    ...
    @JoinTable(name = "arcrftstndtmslctp_cntmnnt_link", schema = "airport_heliport", joinColumns = {
    ...
    @JoinTable(name = "arcrftstndtmslctp_annttn_link", schema = "airport_heliport", joinColumns = {
        @JoinColumn(name = "aircraftstand_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "arcrftstndtmslctp_avlblt_link", schema = "airport_heliport", joinColumns = {
        @JoinColumn(name = "aircraftstand_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link AircraftStandTimeSliceExtensionType }
     * 
     * 
     */
    @OneToMany(targetEntity = AircraftStandTimeSliceExtensionType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinColumn(name = "aircraftstand_te_hjid", referencedColumnName = "hjid")
    public List<AircraftStandTimeSliceExtensionType> getExtension() {
        if (extension == null) {
     ...
     * 
     */
    public void setExtension(List<AircraftStandTimeSliceExtensionType> extension) {
    ...
    public void setDesignatorItem(TextDesignatorType target) {
        setDesignator(XmlAdapterUtils.marshallJAXBElement(TextDesignatorType.class, new QName("http://www.aixm.aero/schema/5.2", "designator"), AircraftStandTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "type", columnDefinition = "codeaircraftstandbase")),
    ...
    public void setTypeItem(CodeAircraftStandType target) {
        setType(XmlAdapterUtils.marshallJAXBElement(CodeAircraftStandType.class, new QName("http://www.aixm.aero/schema/5.2", "type"), AircraftStandTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "visualdockingsystem", columnDefinition = "codevisualdockingguidancebase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "visualdockingsystemnilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setVisualDockingSystemItem(CodeVisualDockingGuidanceType target) {
        setVisualDockingSystem(XmlAdapterUtils.marshallJAXBElement(CodeVisualDockingGuidanceType.class, new QName("http://www.aixm.aero/schema/5.2", "visualDockingSystem"), AircraftStandTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = SurfaceCharacteristicsPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "arcrftstndtmslctp_srfcprprts_link", schema = "airport_heliport", joinColumns = {
        @JoinColumn(name = "aircraftstand_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setSurfacePropertiesItem(SurfaceCharacteristicsPropertyType target) {
        setSurfaceProperties(XmlAdapterUtils.marshallJAXBElement(SurfaceCharacteristicsPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "surfaceProperties"), AircraftStandTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = AIXMElevatedPointPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "arcrftstndtmslctp_lctn_link", schema = "airport_heliport", joinColumns = {
        @JoinColumn(name = "aircraftstand_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setLocationItem(AIXMElevatedPointPropertyType target) {
        setLocation(XmlAdapterUtils.marshallJAXBElement(AIXMElevatedPointPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "location"), AircraftStandTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = ApronElementPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "arcrftstndtmslctp_aprnlctn_link", schema = "airport_heliport", joinColumns = {
        @JoinColumn(name = "aircraftstand_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setApronLocationItem(ApronElementPropertyType target) {
        setApronLocation(XmlAdapterUtils.marshallJAXBElement(ApronElementPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "apronLocation"), AircraftStandTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = AIXMElevatedSurfacePropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "arcrftstndtmslctp_extnt_link", schema = "airport_heliport", joinColumns = {
        @JoinColumn(name = "aircraftstand_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setExtentItem(AIXMElevatedSurfacePropertyType target) {
        setExtent(XmlAdapterUtils.marshallJAXBElement(AIXMElevatedSurfacePropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "extent"), AircraftStandTimeSliceType.class, target));
    }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        }
        {
            ...
            List<AircraftStandTimeSliceExtensionType> lhsField;
            lhsField = (this.isSetExtension()?this.getExtension():null);
            List<AircraftStandTimeSliceExtensionType> rhsField;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        }
        {
            ...
            List<AircraftStandTimeSliceExtensionType> theField;
