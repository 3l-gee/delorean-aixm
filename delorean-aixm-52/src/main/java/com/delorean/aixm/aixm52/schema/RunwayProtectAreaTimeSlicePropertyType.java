 ...
 *       <sequence>
 *         <element ref="{http://www.aixm.aero/schema/5.2}RunwayProtectAreaTimeSlice"/>
 *       </sequence>
...
public class RunwayProtectAreaTimeSlicePropertyType implements Serializable, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        final RunwayProtectAreaTimeSlicePropertyType that = ((RunwayProtectAreaTimeSlicePropertyType) object);
        {
            ...
            RunwayProtectAreaTimeSliceType lhsField;
            lhsField = this.getRunwayProtectAreaTimeSlice();
            RunwayProtectAreaTimeSliceType rhsField;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetRunwayProtectAreaTimeSlice();
            RunwayProtectAreaTimeSliceType theField;
            theField = this.getRunwayProtectAreaTimeSlice();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "runwayProtectAreaTimeSlice", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            RunwayProtectAreaTimeSliceType theField;
            theField = this.getRunwayProtectAreaTimeSlice();
            strategy.appendField(locator, this, "runwayProtectAreaTimeSlice", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetOwns();
            boolean theField;
