...
/**
 * <p>
 * Java class for DirectFlightSegmentPropertyType complex type
 * </p>
 * .
 *
 * <p>
 ...
 *       <sequence>
 *         <element ref="{http://www.aixm.aero/schema/5.2}DirectFlightSegment"/>
 *       </sequence>
 *     </extension>
 *   </complexContent>
 * </complexType>
...
@XmlType(name = "DirectFlightSegmentPropertyType", propOrder = {"directFlightSegment"})
@Entity(name = "DirectFlightSegmentPropertyType")
@Table(name = "directflightsegmentpropertytype", schema = "route")
public class DirectFlightSegmentPropertyType extends AbstractAIXMPropertyType implements Serializable {
     ...
     *
     * @return possible object is {@link DirectFlightSegmentType }
     *
     */
    @OneToOne(targetEntity = DirectFlightSegmentType.class, cascade = {CascadeType.ALL}, fetch = FetchType.EAGER)
     ...
     *
     * @param value
     *            allowed object is {@link DirectFlightSegmentType }
     *
     */
