 ...
 *         <element name="type" type="{http://www.aixm.aero/schema/5.2}CodeOrganisationType" minOccurs="0"/>
 ...
 *         <element name="relatedOrganisationAuthority" type="{http://www.aixm.aero/schema/5.2}OrganisationAuthorityAssociationPropertyType" maxOccurs="unbounded" minOccurs="0"/>
 ...
 *                 <sequence>
 *                   <element ref="{http://www.aixm.aero/schema/5.2}AbstractOrganisationAuthorityExtension"/>
 *                 </sequence>
    ...
    implements Serializable
{
    ...
    public void setAixmNameItem(TextNameType target) {
        setAixmName(XmlAdapterUtils.marshallJAXBElement(TextNameType.class, new QName("http://www.aixm.aero/schema/5.2", "name"), OrganisationAuthorityTimeSliceType.class, target));
    }
    ...
    public void setDesignatorItem(CodeOrganisationDesignatorType target) {
        setDesignator(XmlAdapterUtils.marshallJAXBElement(CodeOrganisationDesignatorType.class, new QName("http://www.aixm.aero/schema/5.2", "designator"), OrganisationAuthorityTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "type", columnDefinition = "codeorganisationbase")),
    ...
    public void setTypeItem(CodeOrganisationType target) {
        setType(XmlAdapterUtils.marshallJAXBElement(CodeOrganisationType.class, new QName("http://www.aixm.aero/schema/5.2", "type"), OrganisationAuthorityTimeSliceType.class, target));
    }
    ...
    public void setMilitaryItem(CodeMilitaryOperationsType target) {
        setMilitary(XmlAdapterUtils.marshallJAXBElement(CodeMilitaryOperationsType.class, new QName("http://www.aixm.aero/schema/5.2", "military"), OrganisationAuthorityTimeSliceType.class, target));
    }
