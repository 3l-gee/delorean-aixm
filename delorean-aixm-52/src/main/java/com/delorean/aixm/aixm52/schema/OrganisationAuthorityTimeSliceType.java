    ...
    implements Serializable
{
    ...
    @JoinTable(name = "orgnstnathrttmslctp_cntct_l", schema = "organisation", joinColumns = {
    ...
    @JoinTable(name = "orgnstnathrttmslctp_rltdorgnstnathrt_l", schema = "organisation", joinColumns = {
        @JoinColumn(name = "organisationauthority_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "orgnstnathrttmslctp_annttn_l", schema = "organisation", joinColumns = {
        @JoinColumn(name = "organisationauthority_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
