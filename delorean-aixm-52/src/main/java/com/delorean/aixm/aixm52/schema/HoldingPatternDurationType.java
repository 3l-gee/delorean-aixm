    ...
    implements Serializable
{
    ...
    @JoinTable(name = "hldngpttrndrtntp_annttn_link", schema = "holding", joinColumns = {
        @JoinColumn(name = "holdingpatternduration_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setDurationItem(ValDurationType target) {
        setDuration(XmlAdapterUtils.marshallJAXBElement(ValDurationType.class, new QName("http://www.aixm.aero/schema/5.2", "duration"), HoldingPatternDurationType.class, target));
    }
