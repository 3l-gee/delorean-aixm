 ...
 *         <element name="markerPosition" type="{http://www.aixm.aero/schema/5.2}CodePositionInILSType" minOccurs="0"/>
 *         <element name="providesNavigableLocation" type="{http://www.aixm.aero/schema/5.2}CodeYesNoType" minOccurs="0"/>
 ...
 *                 <choice>
 *                   <element ref="{http://www.aixm.aero/schema/5.2}AbstractNavaidComponentExtension"/>
 *                 </choice>
    ...
    implements Serializable
{
     ...
     * 
     */
    @OneToMany(targetEntity = NavaidComponentExtensionType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    ...
    public void setCollocationGroupItem(NoSequenceType target) {
        setCollocationGroup(XmlAdapterUtils.marshallJAXBElement(NoSequenceType.class, new QName("http://www.aixm.aero/schema/5.2", "collocationGroup"), NavaidComponentType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "markerposition", columnDefinition = "codepositioninilsbase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "markerpositionnilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setMarkerPositionItem(CodePositionInILSType target) {
        setMarkerPosition(XmlAdapterUtils.marshallJAXBElement(CodePositionInILSType.class, new QName("http://www.aixm.aero/schema/5.2", "markerPosition"), NavaidComponentType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "providesnavigablelocation", columnDefinition = "codeyesnobase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "providesnavigablelocationnilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setProvidesNavigableLocationItem(CodeYesNoType target) {
        setProvidesNavigableLocation(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.2", "providesNavigableLocation"), NavaidComponentType.class, target));
    }
    ...
    public void setTheNavaidEquipmentItem(NavaidEquipmentPropertyType target) {
        setTheNavaidEquipment(XmlAdapterUtils.marshallJAXBElement(NavaidEquipmentPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "theNavaidEquipment"), NavaidComponentType.class, target));
    }
