 ...
 *       <sequence>
 *         <element name="designatorPrefix" type="{http://www.aixm.aero/schema/5.2}CodeRouteDesignatorPrefixType" minOccurs="0"/>
 *         <element name="designatorSecondLetter" type="{http://www.aixm.aero/schema/5.2}CodeRouteDesignatorLetterType" minOccurs="0"/>
 *         <element name="designatorNumber" type="{http://www.aixm.aero/schema/5.2}NoNumberType" minOccurs="0"/>
 *         <element name="multipleIdentifier" type="{http://www.aixm.aero/schema/5.2}CodeUpperAlphaType" minOccurs="0"/>
 *         <element name="locationDesignator" type="{http://www.aixm.aero/schema/5.2}TextDesignatorType" minOccurs="0"/>
 *         <element name="name" type="{http://www.aixm.aero/schema/5.2}TextNameType" minOccurs="0"/>
 *         <element name="type" type="{http://www.aixm.aero/schema/5.2}CodeRouteType" minOccurs="0"/>
 *         <element name="flightRule" type="{http://www.aixm.aero/schema/5.2}CodeFlightRuleType" minOccurs="0"/>
 *         <element name="internationalUse" type="{http://www.aixm.aero/schema/5.2}CodeRouteOriginType" minOccurs="0"/>
 *         <element name="militaryUse" type="{http://www.aixm.aero/schema/5.2}CodeMilitaryStatusType" minOccurs="0"/>
 *         <element name="militaryTrainingType" type="{http://www.aixm.aero/schema/5.2}CodeMilitaryTrainingType" minOccurs="0"/>
 *         <element name="userOrganisation" type="{http://www.aixm.aero/schema/5.2}OrganisationAuthorityPropertyType" minOccurs="0"/>
 ...
 *                 <sequence>
 *                   <element ref="{http://www.aixm.aero/schema/5.2}AbstractRouteExtension"/>
 *                 </sequence>
...
@Table(name = "route_t", schema = "route")
    ...
    implements Serializable
{
    ...
    @XmlElementRef(name = "designatorSecondLetter", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "multipleIdentifier", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<CodeUpperAlphaType> multipleIdentifier;
    @XmlElementRef(name = "locationDesignator", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "flightRule", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<CodeFlightRuleType> flightRule;
    @XmlElementRef(name = "internationalUse", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<CodeRouteOriginType> internationalUse;
    @XmlElementRef(name = "militaryUse", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<CodeMilitaryStatusType> militaryUse;
    @XmlElementRef(name = "militaryTrainingType", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<CodeMilitaryTrainingType> militaryTrainingType;
    @XmlElementRef(name = "userOrganisation", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    ...
    protected List<RouteTimeSliceExtensionType> extension;
    ...
    @JoinTable(name = "rttmslctp_annttn_link", schema = "route", joinColumns = {
        @JoinColumn(name = "route_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "rttmslctp_dsgncrtr_link", schema = "route", joinColumns = {
        @JoinColumn(name = "route_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "rttmslctp_avlblt_link", schema = "route", joinColumns = {
        @JoinColumn(name = "route_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "rttmslctp_arcrftcpblt_link", schema = "route", joinColumns = {
        @JoinColumn(name = "route_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link RouteTimeSliceExtensionType }
     * 
     * 
     */
    @OneToMany(targetEntity = RouteTimeSliceExtensionType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinColumn(name = "route_te_hjid", referencedColumnName = "hjid")
    public List<RouteTimeSliceExtensionType> getExtension() {
        if (extension == null) {
     ...
     * 
     */
    public void setExtension(List<RouteTimeSliceExtensionType> extension) {
    ...
    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "designatorprefix", columnDefinition = "coderoutedesignatorprefixbase")),
    ...
    public void setDesignatorPrefixItem(CodeRouteDesignatorPrefixType target) {
        setDesignatorPrefix(XmlAdapterUtils.marshallJAXBElement(CodeRouteDesignatorPrefixType.class, new QName("http://www.aixm.aero/schema/5.2", "designatorPrefix"), RouteTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "designatorsecondletter", columnDefinition = "coderoutedesignatorletterbase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "designatorsecondletternilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setDesignatorSecondLetterItem(CodeRouteDesignatorLetterType target) {
        setDesignatorSecondLetter(XmlAdapterUtils.marshallJAXBElement(CodeRouteDesignatorLetterType.class, new QName("http://www.aixm.aero/schema/5.2", "designatorSecondLetter"), RouteTimeSliceType.class, target));
    }
    ...
    public void setDesignatorNumberItem(NoNumberType target) {
        setDesignatorNumber(XmlAdapterUtils.marshallJAXBElement(NoNumberType.class, new QName("http://www.aixm.aero/schema/5.2", "designatorNumber"), RouteTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "multipleidentifier", columnDefinition = "codeupperalphabase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "multipleidentifiernilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setMultipleIdentifierItem(CodeUpperAlphaType target) {
        setMultipleIdentifier(XmlAdapterUtils.marshallJAXBElement(CodeUpperAlphaType.class, new QName("http://www.aixm.aero/schema/5.2", "multipleIdentifier"), RouteTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "locationdesignator", columnDefinition = "character3")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "locationdesignatornilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setLocationDesignatorItem(TextDesignatorType target) {
        setLocationDesignator(XmlAdapterUtils.marshallJAXBElement(TextDesignatorType.class, new QName("http://www.aixm.aero/schema/5.2", "locationDesignator"), RouteTimeSliceType.class, target));
    }
    ...
    public void setAixmNameItem(TextNameType target) {
        setAixmName(XmlAdapterUtils.marshallJAXBElement(TextNameType.class, new QName("http://www.aixm.aero/schema/5.2", "name"), RouteTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "type", columnDefinition = "coderoutebase")),
    ...
    public void setTypeItem(CodeRouteType target) {
        setType(XmlAdapterUtils.marshallJAXBElement(CodeRouteType.class, new QName("http://www.aixm.aero/schema/5.2", "type"), RouteTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "flightrule", columnDefinition = "codeflightrulebase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "flightrulenilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setFlightRuleItem(CodeFlightRuleType target) {
        setFlightRule(XmlAdapterUtils.marshallJAXBElement(CodeFlightRuleType.class, new QName("http://www.aixm.aero/schema/5.2", "flightRule"), RouteTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "internationaluse", columnDefinition = "coderouteoriginbase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "internationalusenilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setInternationalUseItem(CodeRouteOriginType target) {
        setInternationalUse(XmlAdapterUtils.marshallJAXBElement(CodeRouteOriginType.class, new QName("http://www.aixm.aero/schema/5.2", "internationalUse"), RouteTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "militaryuse", columnDefinition = "codemilitarystatusbase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "militaryusenilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setMilitaryUseItem(CodeMilitaryStatusType target) {
        setMilitaryUse(XmlAdapterUtils.marshallJAXBElement(CodeMilitaryStatusType.class, new QName("http://www.aixm.aero/schema/5.2", "militaryUse"), RouteTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "militarytrainingtype", columnDefinition = "codemilitarytrainingbase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "militarytrainingtypenilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setMilitaryTrainingTypeItem(CodeMilitaryTrainingType target) {
        setMilitaryTrainingType(XmlAdapterUtils.marshallJAXBElement(CodeMilitaryTrainingType.class, new QName("http://www.aixm.aero/schema/5.2", "militaryTrainingType"), RouteTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = OrganisationAuthorityPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "rttmslctp_usrorgnstn_link", schema = "route", joinColumns = {
        @JoinColumn(name = "route_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
        @JoinColumn(name = "userorganisation_hjid", referencedColumnName = "hjid")
    })
    ...
    public void setUserOrganisationItem(OrganisationAuthorityPropertyType target) {
        setUserOrganisation(XmlAdapterUtils.marshallJAXBElement(OrganisationAuthorityPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "userOrganisation"), RouteTimeSliceType.class, target));
    }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        }
        {
            ...
            List<RouteTimeSliceExtensionType> lhsField;
            lhsField = (this.isSetExtension()?this.getExtension():null);
            List<RouteTimeSliceExtensionType> rhsField;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        }
        {
            ...
            List<RouteTimeSliceExtensionType> theField;
