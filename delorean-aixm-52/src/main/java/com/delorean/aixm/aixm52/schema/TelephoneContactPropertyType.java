...
/**
 * <p>
 * Java class for TelephoneContactPropertyType complex type
 * </p>
 * .
 *
 * <p>
 ...
 *       <sequence>
 *         <element ref="{http://www.aixm.aero/schema/5.2}TelephoneContact"/>
 *       </sequence>
 *     </extension>
 *   </complexContent>
 * </complexType>
...
@XmlType(name = "TelephoneContactPropertyType", propOrder = {"telephoneContact"})
@Entity(name = "TelephoneContactPropertyType")
@Table(name = "telephonecontactpropertytype", schema = "shared")
public class TelephoneContactPropertyType extends AbstractAIXMPropertyType implements Serializable {
     ...
     *
     * @return possible object is {@link TelephoneContactType }
     *
     */
    @OneToOne(targetEntity = TelephoneContactType.class, cascade = {CascadeType.ALL}, fetch = FetchType.EAGER)
    @JoinColumn(name = "telephonecontact_hjid", referencedColumnName = "hjid")
     ...
     *
     * @param value
     *            allowed object is {@link TelephoneContactType }
     *
     */
