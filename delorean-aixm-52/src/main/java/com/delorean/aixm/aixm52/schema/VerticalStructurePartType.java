 ...
 *         <element name="verticalExtent" type="{http://www.aixm.aero/schema/5.2}ValDistanceType" minOccurs="0"/>
 *         <element name="type" type="{http://www.aixm.aero/schema/5.2}CodeVerticalStructureType" minOccurs="0"/>
 *         <element name="constructionStatus" type="{http://www.aixm.aero/schema/5.2}CodeStatusConstructionType" minOccurs="0"/>
 *         <element name="markingPattern" type="{http://www.aixm.aero/schema/5.2}CodeVerticalStructureMarkingType" minOccurs="0"/>
 *         <element name="markingFirstColour" type="{http://www.aixm.aero/schema/5.2}CodeColourType" minOccurs="0"/>
 *         <element name="markingSecondColour" type="{http://www.aixm.aero/schema/5.2}CodeColourType" minOccurs="0"/>
 *         <element name="mobile" type="{http://www.aixm.aero/schema/5.2}CodeYesNoType" minOccurs="0"/>
 *         <element name="frangible" type="{http://www.aixm.aero/schema/5.2}CodeYesNoType" minOccurs="0"/>
 *         <element name="visibleMaterial" type="{http://www.aixm.aero/schema/5.2}CodeVerticalStructureMaterialType" minOccurs="0"/>
 *         <element name="designator" type="{http://www.aixm.aero/schema/5.2}TextDesignatorLongType" minOccurs="0"/>
 *         <choice>
 *           <element name="horizontalProjection_surfaceExtent" type="{http://www.aixm.aero/schema/5.2}ElevatedSurfacePropertyType" minOccurs="0"/>
 *           <element name="horizontalProjection_location" type="{http://www.aixm.aero/schema/5.2}ElevatedPointPropertyType" minOccurs="0"/>
 *           <element name="horizontalProjection_linearExtent" type="{http://www.aixm.aero/schema/5.2}ElevatedCurvePropertyType" minOccurs="0"/>
 *         </choice>
 *         <element name="lighting" type="{http://www.aixm.aero/schema/5.2}LightElementPropertyType" maxOccurs="unbounded" minOccurs="0"/>
 ...
 *                   <element ref="{http://www.aixm.aero/schema/5.2}AbstractVerticalStructurePartExtension"/>
 *                 </choice>
    ...
    implements Serializable
{
    ...
    @JoinTable(name = "vrtclstrctrprttp_tmintrvl_link", schema = "obstacle", joinColumns = {
        @JoinColumn(name = "verticalstructurepart_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "verticalextent", columnDefinition = "valdistancebase")),
        @AttributeOverride(name = "uom", column = @Column(name = "verticalextentuom", columnDefinition = "uomdistance")),
        @AttributeOverride(name = "accuracy", column = @Column(name = "verticalextentaccuracy", columnDefinition = "numericalwithnilreason")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "verticalextentnilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setVerticalExtentItem(ValDistanceType target) {
        setVerticalExtent(XmlAdapterUtils.marshallJAXBElement(ValDistanceType.class, new QName("http://www.aixm.aero/schema/5.2", "verticalExtent"), VerticalStructurePartType.class, target));
    }
    ...
    public void setTypeItem(CodeVerticalStructureType target) {
        setType(XmlAdapterUtils.marshallJAXBElement(CodeVerticalStructureType.class, new QName("http://www.aixm.aero/schema/5.2", "type"), VerticalStructurePartType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "constructionstatus", columnDefinition = "codestatusconstructionbase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "constructionstatusnilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setConstructionStatusItem(CodeStatusConstructionType target) {
        setConstructionStatus(XmlAdapterUtils.marshallJAXBElement(CodeStatusConstructionType.class, new QName("http://www.aixm.aero/schema/5.2", "constructionStatus"), VerticalStructurePartType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "markingpattern", columnDefinition = "codeverticalstructuremarkingbase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "markingpatternnilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setMarkingPatternItem(CodeVerticalStructureMarkingType target) {
        setMarkingPattern(XmlAdapterUtils.marshallJAXBElement(CodeVerticalStructureMarkingType.class, new QName("http://www.aixm.aero/schema/5.2", "markingPattern"), VerticalStructurePartType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "markingfirstcolour", columnDefinition = "codecolourbase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "markingfirstcolournilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setMarkingFirstColourItem(CodeColourType target) {
        setMarkingFirstColour(XmlAdapterUtils.marshallJAXBElement(CodeColourType.class, new QName("http://www.aixm.aero/schema/5.2", "markingFirstColour"), VerticalStructurePartType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "markingsecondcolour", columnDefinition = "codecolourbase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "markingsecondcolournilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setMarkingSecondColourItem(CodeColourType target) {
        setMarkingSecondColour(XmlAdapterUtils.marshallJAXBElement(CodeColourType.class, new QName("http://www.aixm.aero/schema/5.2", "markingSecondColour"), VerticalStructurePartType.class, target));
    }
    ...
    public void setMobileItem(CodeYesNoType target) {
        setMobile(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.2", "mobile"), VerticalStructurePartType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "frangible", columnDefinition = "codeyesnobase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "frangiblenilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setFrangibleItem(CodeYesNoType target) {
        setFrangible(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.2", "frangible"), VerticalStructurePartType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "visiblematerial", columnDefinition = "codeverticalstructurematerialbase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "visiblematerialnilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setVisibleMaterialItem(CodeVerticalStructureMaterialType target) {
        setVisibleMaterial(XmlAdapterUtils.marshallJAXBElement(CodeVerticalStructureMaterialType.class, new QName("http://www.aixm.aero/schema/5.2", "visibleMaterial"), VerticalStructurePartType.class, target));
    }
    ...
    public void setDesignatorItem(TextDesignatorLongType target) {
        setDesignator(XmlAdapterUtils.marshallJAXBElement(TextDesignatorLongType.class, new QName("http://www.aixm.aero/schema/5.2", "designator"), VerticalStructurePartType.class, target));
    }
    ...
    public void setHorizontalProjectionSurfaceExtentItem(AIXMElevatedSurfacePropertyType target) {
        setHorizontalProjectionSurfaceExtent(XmlAdapterUtils.marshallJAXBElement(AIXMElevatedSurfacePropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "horizontalProjection_surfaceExtent"), VerticalStructurePartType.class, target));
    }
    ...
    public void setHorizontalProjectionLocationItem(AIXMElevatedPointPropertyType target) {
        setHorizontalProjectionLocation(XmlAdapterUtils.marshallJAXBElement(AIXMElevatedPointPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "horizontalProjection_location"), VerticalStructurePartType.class, target));
    }
    ...
    public void setHorizontalProjectionLinearExtentItem(AIXMElevatedCurvePropertyType target) {
        setHorizontalProjectionLinearExtent(XmlAdapterUtils.marshallJAXBElement(AIXMElevatedCurvePropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "horizontalProjection_linearExtent"), VerticalStructurePartType.class, target));
    }
    ...
    public void setHeightItem(ValDistanceType target) {
        setHeight(XmlAdapterUtils.marshallJAXBElement(ValDistanceType.class, new QName("http://www.aixm.aero/schema/5.2", "height"), VerticalStructurePartType.class, target));
    }
