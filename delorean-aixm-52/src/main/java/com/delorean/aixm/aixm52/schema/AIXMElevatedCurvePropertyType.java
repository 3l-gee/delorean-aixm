...
import com.delorean.aixm.aixm52.gis.adapter.ElevatedCurveTypeAdapter;
import com.delorean.aixm.aixm52.gis.type.AixmElevatedCurveType;
...
/**
 * <p>
 * Java class for ElevatedCurvePropertyType complex type
 * </p>
 * .
 *
 * <p>
 ...
 *       <sequence>
 *         <element name="ElevatedCurve" type=
...
@XmlType(name = "ElevatedCurvePropertyType", propOrder = {"elevatedCurve"})
@Entity(name = "AIXMElevatedCurvePropertyType")
@Table(name = "aixm_elevatedcurve_pt", schema = "gml")
public class AIXMElevatedCurvePropertyType extends AbstractAIXMPropertyType implements Serializable {
    ...
    @jakarta.persistence.JoinColumn(name = "elevated_curve_hjid", referencedColumnName = "hjid")
