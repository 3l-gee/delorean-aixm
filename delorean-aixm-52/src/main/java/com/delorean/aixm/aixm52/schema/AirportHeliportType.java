...
/**
 * <p>
 * Java class for AirportHeliportType complex type
 * </p>
 * .
 *
 * <p>
...
"{http://www.aixm.aero/schema/5.2}AirportHeliportTimeSlicePropertyType" maxOccurs
="unbounded"/>
 *       </sequence>
 *     </extension>
 *   </complexContent>
...
@XmlType(name = "AirportHeliportType", propOrder = {"timeSlice"})
@Entity(name = "AirportHeliportType")
@Table(name = "airportheliport_f", schema = "airport_heliport")
public class AirportHeliportType extends AbstractAIXMFeatureType implements Serializable {
    ...
    @OneToMany(targetEntity = AirportHeliportTimeSlicePropertyType.class, cascade = {
     ...
     *
     */
    public void setTimeSlice(List<AirportHeliportTimeSlicePropertyType> timeSlice) {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final AirportHeliportType that = ((AirportHeliportType) object);
        {
            boolean lhsFieldIsSet = this.isSetTimeSlice();
            boolean rhsFieldIsSet = that.isSetTimeSlice();
            List<AirportHeliportTimeSlicePropertyType> lhsField;
            lhsField = (this.isSetTimeSlice() ? this.getTimeSlice() : null);
            List<AirportHeliportTimeSlicePropertyType> rhsField;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = super.hashCode(locator, strategy);
        {
            ...
            List<AirportHeliportTimeSlicePropertyType> theField;
