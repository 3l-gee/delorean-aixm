...
"{http://www.aixm.aero/schema/5.2}CodePARType" minOccurs="0"/>
 *         <element name="slope" type=
"{http://www.aixm.aero/schema/5.2}ValAngleType" minOccurs="0"/>
 *         <element name="reflector" type=
"{http://www.aixm.aero/schema/5.2}ReflectorPropertyType" maxOccurs=
"unbounded" minOccurs="0"/>
...
@XmlType(name = "PrecisionApproachRadarTimeSliceType", propOrder = {"aixmName", "serialNumber", "range", "dualChannel",
        "movingTargetIndicator", "standbyPower", "digital", "militaryUseOnly", "specialUseOnly", "specialAircraftOnly",
        "magneticVariation", "dateMagneticVariation", "contact", "location", "annotation", "precisionApproachRadarType",
        "slope", "reflector", "extension"})
...
public class PrecisionApproachRadarTimeSliceType extends AbstractAIXMTimeSliceType implements Serializable {
    ...
    public void setAixmNameItem(TextNameType target) {
        setAixmName(XmlAdapterUtils.marshallJAXBElement(TextNameType.class,
                new QName("http://www.aixm.aero/schema/5.2", "name"), PrecisionApproachRadarTimeSliceType.class,
                target));
    }
    ...
    public void setSerialNumberItem(TextDesignatorType target) {
        setSerialNumber(XmlAdapterUtils.marshallJAXBElement(TextDesignatorType.class,
                new QName("http://www.aixm.aero/schema/5.2", "serialNumber"), PrecisionApproachRadarTimeSliceType.class,
                target));
    }
    ...
    public void setRangeItem(ValDistanceType target) {
        setRange(XmlAdapterUtils.marshallJAXBElement(ValDistanceType.class,
                new QName("http://www.aixm.aero/schema/5.2", "range"), PrecisionApproachRadarTimeSliceType.class,
                target));
    }
    ...
    public void setDualChannelItem(CodeYesNoType target) {
        setDualChannel(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class,
                new QName("http://www.aixm.aero/schema/5.2", "dualChannel"), PrecisionApproachRadarTimeSliceType.class,
                target));
    }
    ...
    public void setStandbyPowerItem(CodeStandbyPowerType target) {
        setStandbyPower(XmlAdapterUtils.marshallJAXBElement(CodeStandbyPowerType.class,
                new QName("http://www.aixm.aero/schema/5.2", "standbyPower"), PrecisionApproachRadarTimeSliceType.class,
                target));
    }
    ...
    public void setDigitalItem(CodeYesNoType target) {
        setDigital(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class,
                new QName("http://www.aixm.aero/schema/5.2", "digital"), PrecisionApproachRadarTimeSliceType.class,
                target));
    }
    ...
    public void setLocationItem(AIXMElevatedPointPropertyType target) {
        setLocation(XmlAdapterUtils.marshallJAXBElement(AIXMElevatedPointPropertyType.class,
                new QName("http://www.aixm.aero/schema/5.2", "location"), PrecisionApproachRadarTimeSliceType.class,
                target));
    }
    ...
    public void setPrecisionApproachRadarTypeItem(CodePARType target) {
        setPrecisionApproachRadarType(XmlAdapterUtils.marshallJAXBElement(CodePARType.class,
                new QName("http://www.aixm.aero/schema/5.2", "precisionApproachRadarType"),
                PrecisionApproachRadarTimeSliceType.class, target));
    }
    ...
    public void setSlopeItem(ValAngleType target) {
        setSlope(XmlAdapterUtils.marshallJAXBElement(ValAngleType.class,
                new QName("http://www.aixm.aero/schema/5.2", "slope"), PrecisionApproachRadarTimeSliceType.class,
                target));
    }
