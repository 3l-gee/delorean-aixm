...
@Entity(name = "AirportHeliportContaminationExtensionType")
@Table(name = "airportheliportcontamination_oe", schema = "airport_heliport")
public class AirportHeliportContaminationExtensionType implements Serializable, Equals, HashCode, ToString
{
