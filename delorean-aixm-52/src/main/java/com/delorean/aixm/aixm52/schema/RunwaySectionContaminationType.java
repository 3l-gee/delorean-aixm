 ...
 *         <element name="section" type="{http://www.aixm.aero/schema/5.2}CodeRunwaySectionType" minOccurs="0"/>
 ...
 *                   <element ref="{http://www.aixm.aero/schema/5.2}AbstractRunwaySectionContaminationExtension"/>
 *                 </choice>
...
@Table(name = "runwaysectioncontamination_o", schema = "airport_heliport")
    ...
    implements Serializable
{
    ...
    @XmlElementRef(name = "section", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<CodeRunwaySectionType> section;
    protected List<RunwaySectionContaminationExtensionType> extension;
    ...
    @JoinTable(name = "rnwsctncntmntntp_crtclrdg_link", schema = "airport_heliport", joinColumns = {
        @JoinColumn(name = "runwaysectioncontamination_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "rnwsctncntmntntp_lr_link", schema = "airport_heliport", joinColumns = {
        @JoinColumn(name = "runwaysectioncontamination_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "rnwsctncntmntntp_annttn_link", schema = "airport_heliport", joinColumns = {
        @JoinColumn(name = "runwaysectioncontamination_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link RunwaySectionContaminationExtensionType }
     * 
     * 
     */
    @OneToMany(targetEntity = RunwaySectionContaminationExtensionType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinColumn(name = "runwaysectioncontamination_oe_hjid", referencedColumnName = "hjid")
    public List<RunwaySectionContaminationExtensionType> getExtension() {
        if (extension == null) {
     ...
     * 
     */
    public void setExtension(List<RunwaySectionContaminationExtensionType> extension) {
    ...
    public void setObservationTimeItem(DateTimeType target) {
        setObservationTime(XmlAdapterUtils.marshallJAXBElement(DateTimeType.class, new QName("http://www.aixm.aero/schema/5.2", "observationTime"), RunwaySectionContaminationType.class, target));
    }
    ...
    public void setDepthItem(ValDepthType target) {
        setDepth(XmlAdapterUtils.marshallJAXBElement(ValDepthType.class, new QName("http://www.aixm.aero/schema/5.2", "depth"), RunwaySectionContaminationType.class, target));
    }
    ...
    public void setFrictionCoefficientItem(ValFrictionType target) {
        setFrictionCoefficient(XmlAdapterUtils.marshallJAXBElement(ValFrictionType.class, new QName("http://www.aixm.aero/schema/5.2", "frictionCoefficient"), RunwaySectionContaminationType.class, target));
    }
    ...
    public void setFrictionEstimationItem(CodeFrictionEstimateType target) {
        setFrictionEstimation(XmlAdapterUtils.marshallJAXBElement(CodeFrictionEstimateType.class, new QName("http://www.aixm.aero/schema/5.2", "frictionEstimation"), RunwaySectionContaminationType.class, target));
    }
    ...
    public void setFrictionDeviceItem(CodeFrictionDeviceType target) {
        setFrictionDevice(XmlAdapterUtils.marshallJAXBElement(CodeFrictionDeviceType.class, new QName("http://www.aixm.aero/schema/5.2", "frictionDevice"), RunwaySectionContaminationType.class, target));
    }
    ...
    public void setObscuredLightsItem(CodeYesNoType target) {
        setObscuredLights(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.2", "obscuredLights"), RunwaySectionContaminationType.class, target));
    }
    ...
    public void setFurtherClearanceTimeItem(TimeType target) {
        setFurtherClearanceTime(XmlAdapterUtils.marshallJAXBElement(TimeType.class, new QName("http://www.aixm.aero/schema/5.2", "furtherClearanceTime"), RunwaySectionContaminationType.class, target));
    }
    ...
    public void setFurtherTotalClearanceItem(CodeYesNoType target) {
        setFurtherTotalClearance(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.2", "furtherTotalClearance"), RunwaySectionContaminationType.class, target));
    }
    ...
    public void setNextObservationTimeItem(DateTimeType target) {
        setNextObservationTime(XmlAdapterUtils.marshallJAXBElement(DateTimeType.class, new QName("http://www.aixm.aero/schema/5.2", "nextObservationTime"), RunwaySectionContaminationType.class, target));
    }
    ...
    public void setProportionItem(ValPercentType target) {
        setProportion(XmlAdapterUtils.marshallJAXBElement(ValPercentType.class, new QName("http://www.aixm.aero/schema/5.2", "proportion"), RunwaySectionContaminationType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "section", columnDefinition = "coderunwaysectionbase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "sectionnilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setSectionItem(CodeRunwaySectionType target) {
        setSection(XmlAdapterUtils.marshallJAXBElement(CodeRunwaySectionType.class, new QName("http://www.aixm.aero/schema/5.2", "section"), RunwaySectionContaminationType.class, target));
    }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        }
        {
            ...
            List<RunwaySectionContaminationExtensionType> lhsField;
            lhsField = (this.isSetExtension()?this.getExtension():null);
            List<RunwaySectionContaminationExtensionType> rhsField;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        }
        {
            ...
            List<RunwaySectionContaminationExtensionType> theField;
