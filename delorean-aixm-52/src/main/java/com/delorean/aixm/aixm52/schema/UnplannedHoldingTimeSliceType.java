 ...
 *       <sequence>
 *         <element name="unplannedHolding" type="{http://www.aixm.aero/schema/5.2}CodeApprovalType" minOccurs="0"/>
 *         <element name="authorizedAltitude" type="{http://www.aixm.aero/schema/5.2}ValDistanceVerticalType" minOccurs="0"/>
 *         <element name="altitudeReference" type="{http://www.aixm.aero/schema/5.2}CodeVerticalReferenceType" minOccurs="0"/>
 *         <element name="controlledAirspace" type="{http://www.aixm.aero/schema/5.2}CodeYesNoType" minOccurs="0"/>
 ...
 *                 <sequence>
 *                   <element ref="{http://www.aixm.aero/schema/5.2}AbstractUnplannedHoldingExtension"/>
 *                 </sequence>
    ...
    implements Serializable
{
    ...
    @XmlElementRef(name = "authorizedAltitude", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "controlledAirspace", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    ...
    protected List<UnplannedHoldingTimeSliceExtensionType> extension;
    ...
    @JoinTable(name = "unplnndhldngtmslctp_annttn_link", schema = "holding", joinColumns = {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link UnplannedHoldingTimeSliceExtensionType }
     * 
     * 
     */
    @OneToMany(targetEntity = UnplannedHoldingTimeSliceExtensionType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinColumn(name = "unplannedholding_te_hjid", referencedColumnName = "hjid")
    public List<UnplannedHoldingTimeSliceExtensionType> getExtension() {
        if (extension == null) {
     ...
     * 
     */
    public void setExtension(List<UnplannedHoldingTimeSliceExtensionType> extension) {
    ...
    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "unplannedholding", columnDefinition = "codeapprovalbase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "unplannedholdingnilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setUnplannedHoldingItem(CodeApprovalType target) {
        setUnplannedHolding(XmlAdapterUtils.marshallJAXBElement(CodeApprovalType.class, new QName("http://www.aixm.aero/schema/5.2", "unplannedHolding"), UnplannedHoldingTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "authorizedaltitude", columnDefinition = "valdistanceverticalbase")),
        @AttributeOverride(name = "uom", column = @Column(name = "authorizedaltitudeuom", columnDefinition = "uomdistancevertical")),
        @AttributeOverride(name = "accuracy", column = @Column(name = "authorizedaltitudeaccuracy", columnDefinition = "numericalwithnilreason")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "authorizedaltitudenilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setAuthorizedAltitudeItem(ValDistanceVerticalType target) {
        setAuthorizedAltitude(XmlAdapterUtils.marshallJAXBElement(ValDistanceVerticalType.class, new QName("http://www.aixm.aero/schema/5.2", "authorizedAltitude"), UnplannedHoldingTimeSliceType.class, target));
    }
    ...
    public void setAltitudeReferenceItem(CodeVerticalReferenceType target) {
        setAltitudeReference(XmlAdapterUtils.marshallJAXBElement(CodeVerticalReferenceType.class, new QName("http://www.aixm.aero/schema/5.2", "altitudeReference"), UnplannedHoldingTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "controlledairspace", columnDefinition = "codeyesnobase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "controlledairspacenilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setControlledAirspaceItem(CodeYesNoType target) {
        setControlledAirspace(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.2", "controlledAirspace"), UnplannedHoldingTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = SegmentPointPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "unplnndhldngtmslctp_hldngpnt_link", schema = "holding", joinColumns = {
        @JoinColumn(name = "unplannedholding_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setHoldingPointItem(SegmentPointPropertyType target) {
        setHoldingPoint(XmlAdapterUtils.marshallJAXBElement(SegmentPointPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "holdingPoint"), UnplannedHoldingTimeSliceType.class, target));
    }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        }
        {
            ...
            List<UnplannedHoldingTimeSliceExtensionType> lhsField;
            lhsField = (this.isSetExtension()?this.getExtension():null);
            List<UnplannedHoldingTimeSliceExtensionType> rhsField;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        }
        {
            ...
            List<UnplannedHoldingTimeSliceExtensionType> theField;
