...
/**
 * <p>Java class for GangwayPropertyType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="GangwayPropertyType">
 *   <complexContent>
...
@XmlType(name = "GangwayPropertyType")
@Entity(name = "GangwayPropertyType")
@Table(name = "gangway_p", schema = "airport_heliport")
public class GangwayPropertyType implements Serializable, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        final GangwayPropertyType that = ((GangwayPropertyType) object);
        {
