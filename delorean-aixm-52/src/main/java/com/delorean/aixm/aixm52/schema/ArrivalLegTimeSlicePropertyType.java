...
/**
 * <p>
 * Java class for ArrivalLegTimeSlicePropertyType complex type
 * </p>
 * .
 *
 * <p>
 ...
 *       <sequence>
 *         <element ref="{http://www.aixm.aero/schema/5.2}ArrivalLegTimeSlice"/>
 *       </sequence>
 *       <attGroup ref=
...
@Table(name = "arrivalleg_tp", schema = "procedure")
public class ArrivalLegTimeSlicePropertyType implements Serializable, Equals, HashCode, ToString {
     ...
     *
     * @return possible object is {@link ArrivalLegTimeSliceType }
     *
     */
    @OneToOne(targetEntity = ArrivalLegTimeSliceType.class, cascade = {CascadeType.ALL}, fetch = FetchType.EAGER)
    @JoinColumn(name = "arrivallegtimeslice_hjid", referencedColumnName = "hjid")
     ...
     *
     * @param value
     *            allowed object is {@link ArrivalLegTimeSliceType }
     *
     */
    ...
    @Transient
    public boolean isSetArrivalLegTimeSlice() {
        return (this.arrivalLegTimeSlice != null);
    }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetArrivalLegTimeSlice();
            ArrivalLegTimeSliceType theField;
            theField = this.getArrivalLegTimeSlice();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "arrivalLegTimeSlice", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            ArrivalLegTimeSliceType theField;
            theField = this.getArrivalLegTimeSlice();
            strategy.appendField(locator, this, "arrivalLegTimeSlice", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetOwns();
            boolean theField;
