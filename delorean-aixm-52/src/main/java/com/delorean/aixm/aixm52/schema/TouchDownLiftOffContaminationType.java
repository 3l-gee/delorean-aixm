    ...
    implements Serializable
{
    ...
    @JoinTable(name = "tchdwnlftoffcntmntntp_crtclrdg_l", schema = "airport_heliport", joinColumns = {
    ...
    @JoinTable(name = "tchdwnlftoffcntmntntp_lr_l", schema = "airport_heliport", joinColumns = {
        @JoinColumn(name = "touchdownliftoffcontamination_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "tchdwnlftoffcntmntntp_annttn_l", schema = "airport_heliport", joinColumns = {
        @JoinColumn(name = "touchdownliftoffcontamination_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
