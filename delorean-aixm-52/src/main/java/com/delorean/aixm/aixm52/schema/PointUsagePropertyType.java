...
/**
 * <p>
 * Java class for PointUsagePropertyType complex type
 * </p>
 * .
 *
 * <p>
...
@XmlType(name = "PointUsagePropertyType", propOrder = {"pointUsage"})
@Entity(name = "PointUsagePropertyType")
@Table(name = "pointusagepropertytype", schema = "navaids_point")
public class PointUsagePropertyType extends AbstractAIXMPropertyType implements Serializable {
     ...
     *
     * @return possible object is {@link PointUsageType }
     *
     */
    @OneToOne(targetEntity = PointUsageType.class, cascade = {CascadeType.ALL}, fetch = FetchType.EAGER)
     ...
     *
     * @param value
     *            allowed object is {@link PointUsageType }
     *
     */
