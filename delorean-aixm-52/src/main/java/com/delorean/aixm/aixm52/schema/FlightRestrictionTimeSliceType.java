 ...
 *       <sequence>
 *         <element name="designator" type="{http://www.aixm.aero/schema/5.2}CodeFlightRestrictionDesignatorType" minOccurs="0"/>
 *         <element name="type" type="{http://www.aixm.aero/schema/5.2}CodeFlightRestrictionType" minOccurs="0"/>
 *         <element name="instruction" type="{http://www.aixm.aero/schema/5.2}TextInstructionType" minOccurs="0"/>
 *         <element name="flight" type="{http://www.aixm.aero/schema/5.2}FlightConditionCombinationPropertyType" minOccurs="0"/>
 *         <element name="regulatedRoute" type="{http://www.aixm.aero/schema/5.2}FlightRestrictionRoutePropertyType" maxOccurs="unbounded" minOccurs="0"/>
 ...
 *                 <sequence>
 *                   <element ref="{http://www.aixm.aero/schema/5.2}AbstractFlightRestrictionExtension"/>
 *                 </sequence>
    ...
    implements Serializable
{
    ...
    @XmlElementRef(name = "flight", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    ...
    public void setDesignatorItem(CodeFlightRestrictionDesignatorType target) {
        setDesignator(XmlAdapterUtils.marshallJAXBElement(CodeFlightRestrictionDesignatorType.class, new QName("http://www.aixm.aero/schema/5.2", "designator"), FlightRestrictionTimeSliceType.class, target));
    }
    ...
    public void setTypeItem(CodeFlightRestrictionType target) {
        setType(XmlAdapterUtils.marshallJAXBElement(CodeFlightRestrictionType.class, new QName("http://www.aixm.aero/schema/5.2", "type"), FlightRestrictionTimeSliceType.class, target));
    }
    ...
    public void setInstructionItem(TextInstructionType target) {
        setInstruction(XmlAdapterUtils.marshallJAXBElement(TextInstructionType.class, new QName("http://www.aixm.aero/schema/5.2", "instruction"), FlightRestrictionTimeSliceType.class, target));
    }
    ...
    public void setFlightItem(FlightConditionCombinationPropertyType target) {
        setFlight(XmlAdapterUtils.marshallJAXBElement(FlightConditionCombinationPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "flight"), FlightRestrictionTimeSliceType.class, target));
    }
