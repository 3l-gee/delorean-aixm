 ...
 *       <sequence>
 *         <element ref="{http://www.aixm.aero/schema/5.2}SearchRescueServiceTimeSlice"/>
 *       </sequence>
...
public class SearchRescueServiceTimeSlicePropertyType implements Serializable, Equals, HashCode, ToString
{
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetSearchRescueServiceTimeSlice();
            SearchRescueServiceTimeSliceType theField;
            theField = this.getSearchRescueServiceTimeSlice();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "searchRescueServiceTimeSlice", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            SearchRescueServiceTimeSliceType theField;
            theField = this.getSearchRescueServiceTimeSlice();
            strategy.appendField(locator, this, "searchRescueServiceTimeSlice", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetOwns();
            boolean theField;
