 ...
 *       <sequence>
 *         <element name="type" type="{http://www.aixm.aero/schema/5.2}CodeSpecialNavigationSystemType" minOccurs="0"/>
 *         <element name="designator" type="{http://www.aixm.aero/schema/5.2}CodeSpecialNavigationChainDesignatorType" minOccurs="0"/>
 *         <element name="name" type="{http://www.aixm.aero/schema/5.2}TextNameType" minOccurs="0"/>
 *         <element name="responsibleOrganisation" type="{http://www.aixm.aero/schema/5.2}AuthorityForSpecialNavigationSystemPropertyType" minOccurs="0"/>
 ...
 *                 <sequence>
 *                   <element ref="{http://www.aixm.aero/schema/5.2}AbstractSpecialNavigationSystemExtension"/>
 *                 </sequence>
    ...
    implements Serializable
{
    ...
    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "type", columnDefinition = "codespecialnavigationsystembase")),
    ...
    public void setTypeItem(CodeSpecialNavigationSystemType target) {
        setType(XmlAdapterUtils.marshallJAXBElement(CodeSpecialNavigationSystemType.class, new QName("http://www.aixm.aero/schema/5.2", "type"), SpecialNavigationSystemTimeSliceType.class, target));
    }
    ...
    public void setDesignatorItem(CodeSpecialNavigationChainDesignatorType target) {
        setDesignator(XmlAdapterUtils.marshallJAXBElement(CodeSpecialNavigationChainDesignatorType.class, new QName("http://www.aixm.aero/schema/5.2", "designator"), SpecialNavigationSystemTimeSliceType.class, target));
    }
    ...
    public void setAixmNameItem(TextNameType target) {
        setAixmName(XmlAdapterUtils.marshallJAXBElement(TextNameType.class, new QName("http://www.aixm.aero/schema/5.2", "name"), SpecialNavigationSystemTimeSliceType.class, target));
    }
    ...
    public void setResponsibleOrganisationItem(AuthorityForSpecialNavigationSystemPropertyType target) {
        setResponsibleOrganisation(XmlAdapterUtils.marshallJAXBElement(AuthorityForSpecialNavigationSystemPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "responsibleOrganisation"), SpecialNavigationSystemTimeSliceType.class, target));
    }
