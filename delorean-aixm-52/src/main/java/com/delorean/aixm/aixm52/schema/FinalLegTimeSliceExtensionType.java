...
@Entity(name = "FinalLegTimeSliceExtensionType")
@Table(name = "finalleg_te", schema = "procedure")
public class FinalLegTimeSliceExtensionType implements Serializable, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        final FinalLegTimeSliceExtensionType that = ((FinalLegTimeSliceExtensionType) object);
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetAbstractFinalLegExtension();
            AbstractExtensionType theField;
            theField = this.getAbstractFinalLegExtension();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "abstractFinalLegExtension", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            AbstractExtensionType theField;
            theField = this.getAbstractFinalLegExtension();
            strategy.appendField(locator, this, "abstractFinalLegExtension", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetAbstractApproachLegExtension();
            AbstractExtensionType theField;
