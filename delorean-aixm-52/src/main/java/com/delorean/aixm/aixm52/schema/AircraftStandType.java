...
/**
 * <p>
 * Java class for AircraftStandType complex type
 * </p>
 * .
 *
 * <p>
...
"{http://www.aixm.aero/schema/5.2}AircraftStandTimeSlicePropertyType" maxOccurs=
"unbounded"/>
 *       </sequence>
 *     </extension>
 *   </complexContent>
...
@XmlType(name = "AircraftStandType", propOrder = {"timeSlice"})
@Entity(name = "AircraftStandType")
@Table(name = "aircraftstand_f", schema = "airport_heliport")
public class AircraftStandType extends AbstractAIXMFeatureType implements Serializable {
    ...
    @OneToMany(targetEntity = AircraftStandTimeSlicePropertyType.class, cascade = {
     ...
     *
     */
    public void setTimeSlice(List<AircraftStandTimeSlicePropertyType> timeSlice) {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final AircraftStandType that = ((AircraftStandType) object);
        {
            boolean lhsFieldIsSet = this.isSetTimeSlice();
            boolean rhsFieldIsSet = that.isSetTimeSlice();
            List<AircraftStandTimeSlicePropertyType> lhsField;
            lhsField = (this.isSetTimeSlice() ? this.getTimeSlice() : null);
            List<AircraftStandTimeSlicePropertyType> rhsField;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = super.hashCode(locator, strategy);
        {
            ...
            List<AircraftStandTimeSlicePropertyType> theField;
