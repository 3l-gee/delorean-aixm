...
/**
 * <p>Java class for FinalApproachProfilePropertyType complex type</p>.
 * 
 ...
 *       <sequence>
 *         <element ref="{http://www.aixm.aero/schema/5.2}FinalApproachProfile"/>
 *       </sequence>
 *     </extension>
 *   </complexContent>
 * </complexType>
...
@XmlType(name = "FinalApproachProfilePropertyType", propOrder = {
    ...
    implements Serializable
{
     ...
     * @return
     *     possible object is
     *     {@link FinalApproachProfileType }
     *     
     */
    @OneToOne(targetEntity = FinalApproachProfileType.class, cascade = {
        CascadeType.ALL
