...
/**
 * <p>Java class for AltimeterCheckpointTimeSliceType complex type</p>.
 * 
 ...
 *         <element name="locationOnRunway" type="{http://www.aixm.aero/schema/5.2}RunwayCentrelinePointPropertyType" minOccurs="0"/>
 *         <element name="locationOnApron" type="{http://www.aixm.aero/schema/5.2}ApronPropertyType" minOccurs="0"/>
 *         <element name="locationOnStand" type="{http://www.aixm.aero/schema/5.2}AircraftStandPropertyType" minOccurs="0"/>
...
@XmlType(name = "AltimeterCheckpointTimeSliceType", propOrder = {
    "category",
    "upperLimit",
    "upperLimitReference",
    "lowerLimit",
...
public class AltimeterCheckpointTimeSliceType
    ...
    implements Serializable
{
    ...
    @JoinTable(name = "altmtrchckpnttmslctp_annttn_l", schema = "navaids_point", joinColumns = {
        @JoinColumn(name = "altimetercheckpoint_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setCategoryItem(CodeCheckpointCategoryType target) {
        setCategory(XmlAdapterUtils.marshallJAXBElement(CodeCheckpointCategoryType.class, new QName("http://www.aixm.aero/schema/5.2", "category"), AltimeterCheckpointTimeSliceType.class, target));
    }
    ...
    public void setUpperLimitItem(ValDistanceVerticalType target) {
        setUpperLimit(XmlAdapterUtils.marshallJAXBElement(ValDistanceVerticalType.class, new QName("http://www.aixm.aero/schema/5.2", "upperLimit"), AltimeterCheckpointTimeSliceType.class, target));
    }
    ...
    public void setUpperLimitReferenceItem(CodeVerticalReferenceType target) {
        setUpperLimitReference(XmlAdapterUtils.marshallJAXBElement(CodeVerticalReferenceType.class, new QName("http://www.aixm.aero/schema/5.2", "upperLimitReference"), AltimeterCheckpointTimeSliceType.class, target));
    }
    ...
    public void setLowerLimitItem(ValDistanceVerticalType target) {
        setLowerLimit(XmlAdapterUtils.marshallJAXBElement(ValDistanceVerticalType.class, new QName("http://www.aixm.aero/schema/5.2", "lowerLimit"), AltimeterCheckpointTimeSliceType.class, target));
    }
    ...
    public void setLowerLimitReferenceItem(CodeVerticalReferenceType target) {
        setLowerLimitReference(XmlAdapterUtils.marshallJAXBElement(CodeVerticalReferenceType.class, new QName("http://www.aixm.aero/schema/5.2", "lowerLimitReference"), AltimeterCheckpointTimeSliceType.class, target));
    }
    ...
    public void setAltitudeInterpretationItem(CodeAltitudeUseType target) {
        setAltitudeInterpretation(XmlAdapterUtils.marshallJAXBElement(CodeAltitudeUseType.class, new QName("http://www.aixm.aero/schema/5.2", "altitudeInterpretation"), AltimeterCheckpointTimeSliceType.class, target));
    }
    ...
    public void setDistanceItem(ValDistanceType target) {
        setDistance(XmlAdapterUtils.marshallJAXBElement(ValDistanceType.class, new QName("http://www.aixm.aero/schema/5.2", "distance"), AltimeterCheckpointTimeSliceType.class, target));
    }
    ...
    public void setAngleItem(ValBearingType target) {
        setAngle(XmlAdapterUtils.marshallJAXBElement(ValBearingType.class, new QName("http://www.aixm.aero/schema/5.2", "angle"), AltimeterCheckpointTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = AIXMElevatedPointPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "altmtrchckpnttmslctp_pstn_l", schema = "navaids_point", joinColumns = {
        @JoinColumn(name = "altimetercheckpoint_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setPositionItem(AIXMElevatedPointPropertyType target) {
        setPosition(XmlAdapterUtils.marshallJAXBElement(AIXMElevatedPointPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "position"), AltimeterCheckpointTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = AirportHeliportPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "altmtrchckpnttmslctp_arprthlprt_l", schema = "navaids_point", joinColumns = {
        @JoinColumn(name = "altimetercheckpoint_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setAirportHeliportItem(AirportHeliportPropertyType target) {
        setAirportHeliport(XmlAdapterUtils.marshallJAXBElement(AirportHeliportPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "airportHeliport"), AltimeterCheckpointTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = RunwayCentrelinePointPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "altmtrchckpnttmslctp_lctnonrnw_l", schema = "navaids_point", joinColumns = {
        @JoinColumn(name = "altimetercheckpoint_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setLocationOnRunwayItem(RunwayCentrelinePointPropertyType target) {
        setLocationOnRunway(XmlAdapterUtils.marshallJAXBElement(RunwayCentrelinePointPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "locationOnRunway"), AltimeterCheckpointTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = ApronPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "altmtrchckpnttmslctp_lctnonaprn_l", schema = "navaids_point", joinColumns = {
        @JoinColumn(name = "altimetercheckpoint_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setLocationOnApronItem(ApronPropertyType target) {
        setLocationOnApron(XmlAdapterUtils.marshallJAXBElement(ApronPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "locationOnApron"), AltimeterCheckpointTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = AircraftStandPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "altmtrchckpnttmslctp_lctnonstnd_l", schema = "navaids_point", joinColumns = {
        @JoinColumn(name = "altimetercheckpoint_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setLocationOnStandItem(AircraftStandPropertyType target) {
        setLocationOnStand(XmlAdapterUtils.marshallJAXBElement(AircraftStandPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "locationOnStand"), AltimeterCheckpointTimeSliceType.class, target));
    }
