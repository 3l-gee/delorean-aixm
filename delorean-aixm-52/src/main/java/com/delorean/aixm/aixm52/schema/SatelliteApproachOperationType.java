...
/**
 * <p>Java class for SatelliteApproachOperationType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="SatelliteApproachOperationType">
 *   <complexContent>
 ...
 *         <element name="operationalStatus" type="{http://www.aixm.aero/schema/5.2}CodeStatusNavaidType" minOccurs="0"/>
 *         <element name="theAirportHeliport" type="{http://www.aixm.aero/schema/5.2}AirportHeliportPropertyType" minOccurs="0"/>
 ...
 *                   <element ref="{http://www.aixm.aero/schema/5.2}AbstractSatelliteApproachOperationExtension"/>
 *                 </choice>
...
@XmlType(name = "SatelliteApproachOperationType", propOrder = {
    "timeInterval",
    "annotation",
...
@Entity(name = "SatelliteApproachOperationType")
@Table(name = "satelliteapproachoperation_o", schema = "navaids_point")
public class SatelliteApproachOperationType
    ...
    implements Serializable
{
    ...
    @JoinTable(name = "stlltapprchoprtntp_tmintrvl_link", schema = "navaids_point", joinColumns = {
        @JoinColumn(name = "satelliteapproachoperation_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "stlltapprchoprtntp_annttn_link", schema = "navaids_point", joinColumns = {
        @JoinColumn(name = "satelliteapproachoperation_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "stlltapprchoprtntp_spcldtathrt_link", schema = "navaids_point", joinColumns = {
        @JoinColumn(name = "satelliteapproachoperation_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    /**
     * Gets the value of the theAirportHeliport property.
     * 
     * @return
     *     possible object is
     ...
     */
    @Transient
    public JAXBElement<AirportHeliportPropertyType> getTheAirportHeliport() {
        return theAirportHeliport;
    }

    /**
     * Sets the value of the theAirportHeliport property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link AirportHeliportPropertyType }{@code >}
     *     
     */
    public void setTheAirportHeliport(JAXBElement<AirportHeliportPropertyType> value) {
        this.theAirportHeliport = value;
    }

    @Transient
    public boolean isSetTheAirportHeliport() {
        return (this.theAirportHeliport!= null);
    }
    ...
    public void setSatelliteApproachTypeItem(CodeSatelliteApproachType target) {
        setSatelliteApproachType(XmlAdapterUtils.marshallJAXBElement(CodeSatelliteApproachType.class, new QName("http://www.aixm.aero/schema/5.2", "satelliteApproachType"), SatelliteApproachOperationType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "operationalstatus", columnDefinition = "codestatusnavaidbase")),
    ...
    public void setOperationalStatusItem(CodeStatusNavaidType target) {
        setOperationalStatus(XmlAdapterUtils.marshallJAXBElement(CodeStatusNavaidType.class, new QName("http://www.aixm.aero/schema/5.2", "operationalStatus"), SatelliteApproachOperationType.class, target));
    }

    @OneToOne(targetEntity = AirportHeliportPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "stlltapprchoprtntp_tharprthlprt_link", schema = "navaids_point", joinColumns = {
        @JoinColumn(name = "satelliteapproachoperation_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
        @JoinColumn(name = "theairportheliport_hjid", referencedColumnName = "hjid")
    })
    public AirportHeliportPropertyType getTheAirportHeliportItem() {
        return XmlAdapterUtils.unmarshallSource(AirportHeliportPropertyType.class, this.getTheAirportHeliport());
    }

    public void setTheAirportHeliportItem(AirportHeliportPropertyType target) {
        setTheAirportHeliport(XmlAdapterUtils.marshallJAXBElement(AirportHeliportPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "theAirportHeliport"), SatelliteApproachOperationType.class, target));
    }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetTheAirportHeliport();
            JAXBElement<AirportHeliportPropertyType> theField;
            theField = this.getTheAirportHeliport();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "theAirportHeliport", theField);
            currentHashCode = strategy.hashCode(theFieldLocator, currentHashCode, theField, theFieldIsSet);
        }
        {
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        }
        {
            ...
            JAXBElement<AirportHeliportPropertyType> theField;
            theField = this.getTheAirportHeliport();
            strategy.appendField(locator, this, "theAirportHeliport", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetExtension();
            List<SatelliteApproachOperationExtensionType> theField;
