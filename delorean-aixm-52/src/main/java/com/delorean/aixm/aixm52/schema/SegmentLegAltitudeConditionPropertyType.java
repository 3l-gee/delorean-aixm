...
/**
 * <p>
 * Java class for SegmentLegAltitudeConditionPropertyType complex type
 * </p>
 * .
 *
 * <p>
 ...
 *       <sequence>
 *         <element ref=
"{http://www.aixm.aero/schema/5.2}SegmentLegAltitudeCondition"/>
 *       </sequence>
 *     </extension>
 *   </complexContent>
 * </complexType>
...
@XmlType(name = "SegmentLegAltitudeConditionPropertyType", propOrder = {"segmentLegAltitudeCondition"})
@Entity(name = "SegmentLegAltitudeConditionPropertyType")
@Table(name = "segmentlegaltitudeconditionpropertytype", schema = "procedure")
public class SegmentLegAltitudeConditionPropertyType extends AbstractAIXMPropertyType implements Serializable {
     ...
     *
     * @return possible object is {@link SegmentLegAltitudeConditionType }
     *
     */
     ...
     *
     * @param value
     *            allowed object is {@link SegmentLegAltitudeConditionType }
     *
     */
