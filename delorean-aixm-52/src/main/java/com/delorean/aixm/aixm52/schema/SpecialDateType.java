...
"{http://www.aixm.aero/schema/5.2}SpecialDateTimeSlicePropertyType" maxOccurs=
"unbounded"/>
 *       </sequence>
 *     </extension>
 *   </complexContent>
...
@Table(name = "specialdate_f", schema = "shared")
public class SpecialDateType extends AbstractAIXMFeatureType implements Serializable {
    ...
    @OneToMany(targetEntity = SpecialDateTimeSlicePropertyType.class, cascade = {
