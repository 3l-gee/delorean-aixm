...
"{http://www.aixm.aero/schema/5.2}GeoBorderTimeSlicePropertyType" maxOccurs=
"unbounded"/>
 *       </sequence>
 *     </extension>
 *   </complexContent>
...
@Table(name = "geoborder_f", schema = "airspace")
public class GeoBorderType extends AbstractAIXMFeatureType implements Serializable {
    ...
    @OneToMany(targetEntity = GeoBorderTimeSlicePropertyType.class, cascade = {
