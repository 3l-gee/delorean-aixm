 ...
 *       <sequence>
 *         <element name="type" type="{http://www.aixm.aero/schema/5.2}CodeRunwayElementType" minOccurs="0"/>
 ...
 *         <element name="associatedRunway" type="{http://www.aixm.aero/schema/5.2}RunwayPropertyType" maxOccurs="unbounded" minOccurs="0"/>
 ...
 *                 <sequence>
 *                   <element ref="{http://www.aixm.aero/schema/5.2}AbstractRunwayElementExtension"/>
 *                 </sequence>
    ...
    implements Serializable
{
    ...
    public void setTypeItem(CodeRunwayElementType target) {
        setType(XmlAdapterUtils.marshallJAXBElement(CodeRunwayElementType.class, new QName("http://www.aixm.aero/schema/5.2", "type"), RunwayElementTimeSliceType.class, target));
    }
    ...
    public void setLengthItem(ValDistanceType target) {
        setLength(XmlAdapterUtils.marshallJAXBElement(ValDistanceType.class, new QName("http://www.aixm.aero/schema/5.2", "length"), RunwayElementTimeSliceType.class, target));
    }
    ...
    public void setWidthItem(ValDistanceType target) {
        setWidth(XmlAdapterUtils.marshallJAXBElement(ValDistanceType.class, new QName("http://www.aixm.aero/schema/5.2", "width"), RunwayElementTimeSliceType.class, target));
    }
    ...
    public void setGradeSeparationItem(CodeGradeSeparationType target) {
        setGradeSeparation(XmlAdapterUtils.marshallJAXBElement(CodeGradeSeparationType.class, new QName("http://www.aixm.aero/schema/5.2", "gradeSeparation"), RunwayElementTimeSliceType.class, target));
    }
    ...
    public void setSurfacePropertiesItem(SurfaceCharacteristicsPropertyType target) {
        setSurfaceProperties(XmlAdapterUtils.marshallJAXBElement(SurfaceCharacteristicsPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "surfaceProperties"), RunwayElementTimeSliceType.class, target));
    }
    ...
    public void setExtentItem(AIXMElevatedSurfacePropertyType target) {
        setExtent(XmlAdapterUtils.marshallJAXBElement(AIXMElevatedSurfacePropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "extent"), RunwayElementTimeSliceType.class, target));
    }
