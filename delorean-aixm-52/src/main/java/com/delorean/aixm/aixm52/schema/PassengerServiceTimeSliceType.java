 ...
 *         <element name="type" type="{http://www.aixm.aero/schema/5.2}CodePassengerServiceType" minOccurs="0"/>
 *         <element name="extension" maxOccurs="unbounded" minOccurs="0">
 *           <complexType>
 *             <complexContent>
 *               <restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 <choice>
 *                   <element ref="{http://www.aixm.aero/schema/5.2}AbstractPassengerServiceExtension"/>
...
@Entity(name = "PassengerServiceTimeSliceType")
@Table(name = "passengerservice_t", schema = "service")
    ...
    implements Serializable
{
    ...
    protected List<PassengerServiceTimeSliceExtensionType> extension;
    ...
    @JoinTable(name = "pssngrsrvctmslctp_cll-sgn_link", schema = "service", joinColumns = {
        @JoinColumn(name = "passengerservice_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "pssngrsrvctmslctp_rdcmmnctn_link", schema = "service", joinColumns = {
        @JoinColumn(name = "passengerservice_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "pssngrsrvctmslctp_grndcmmnctn_link", schema = "service", joinColumns = {
        @JoinColumn(name = "passengerservice_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "pssngrsrvctmslctp_avlblt_link", schema = "service", joinColumns = {
        @JoinColumn(name = "passengerservice_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "pssngrsrvctmslctp_annttn_link", schema = "service", joinColumns = {
        @JoinColumn(name = "passengerservice_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "pssngrsrvctmslctp_arprthlprt_link", schema = "service", joinColumns = {
        @JoinColumn(name = "passengerservice_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link PassengerServiceTimeSliceExtensionType }
     * 
     * 
     */
    @OneToMany(targetEntity = PassengerServiceTimeSliceExtensionType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinColumn(name = "passengerservice_te_hjid", referencedColumnName = "hjid")
    public List<PassengerServiceTimeSliceExtensionType> getExtension() {
        if (extension == null) {
     ...
     * 
     */
    public void setExtension(List<PassengerServiceTimeSliceExtensionType> extension) {
    ...
    public void setFlightOperationsItem(CodeFlightDestinationType target) {
        setFlightOperations(XmlAdapterUtils.marshallJAXBElement(CodeFlightDestinationType.class, new QName("http://www.aixm.aero/schema/5.2", "flightOperations"), PassengerServiceTimeSliceType.class, target));
    }
    ...
    public void setRankItem(CodeFacilityRankingType target) {
        setRank(XmlAdapterUtils.marshallJAXBElement(CodeFacilityRankingType.class, new QName("http://www.aixm.aero/schema/5.2", "rank"), PassengerServiceTimeSliceType.class, target));
    }
    ...
    public void setCompliantICAOItem(CodeYesNoType target) {
        setCompliantICAO(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.2", "compliantICAO"), PassengerServiceTimeSliceType.class, target));
    }
    ...
    public void setAixmNameItem(TextNameType target) {
        setAixmName(XmlAdapterUtils.marshallJAXBElement(TextNameType.class, new QName("http://www.aixm.aero/schema/5.2", "name"), PassengerServiceTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = AIXMElevatedPointPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "pssngrsrvctmslctp_lctn_link", schema = "service", joinColumns = {
        @JoinColumn(name = "passengerservice_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setLocationItem(AIXMElevatedPointPropertyType target) {
        setLocation(XmlAdapterUtils.marshallJAXBElement(AIXMElevatedPointPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "location"), PassengerServiceTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = UnitPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "pssngrsrvctmslctp_srvcprvdr_link", schema = "service", joinColumns = {
        @JoinColumn(name = "passengerservice_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setServiceProviderItem(UnitPropertyType target) {
        setServiceProvider(XmlAdapterUtils.marshallJAXBElement(UnitPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "serviceProvider"), PassengerServiceTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "type", columnDefinition = "codepassengerservicebase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "typenilreason", columnDefinition = "nilreason"))
    })
    public CodePassengerServiceType getTypeItem() {
        return XmlAdapterUtils.unmarshallSource(CodePassengerServiceType.class, this.getType());
    }

    public void setTypeItem(CodePassengerServiceType target) {
        setType(XmlAdapterUtils.marshallJAXBElement(CodePassengerServiceType.class, new QName("http://www.aixm.aero/schema/5.2", "type"), PassengerServiceTimeSliceType.class, target));
    }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        final PassengerServiceTimeSliceType that = ((PassengerServiceTimeSliceType) object);
        {
        ...
        }
        {
            ...
            JAXBElement<CodePassengerServiceType> lhsField;
            lhsField = this.getType();
            JAXBElement<CodePassengerServiceType> rhsField;
        ...
        }
        {
            ...
            List<PassengerServiceTimeSliceExtensionType> lhsField;
            lhsField = (this.isSetExtension()?this.getExtension():null);
            List<PassengerServiceTimeSliceExtensionType> rhsField;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        }
        {
            ...
            JAXBElement<CodePassengerServiceType> theField;
        ...
        }
        {
            ...
            List<PassengerServiceTimeSliceExtensionType> theField;
