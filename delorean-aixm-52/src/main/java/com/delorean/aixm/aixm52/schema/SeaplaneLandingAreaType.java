...
/**
 * <p>
 * Java class for SeaplaneLandingAreaType complex type
 * </p>
 * .
 *
 * <p>
...
"{http://www.aixm.aero/schema/5.2}SeaplaneLandingAreaTimeSlicePropertyType" maxOccurs
="unbounded"/>
 *       </sequence>
 *     </extension>
 *   </complexContent>
...
@XmlType(name = "SeaplaneLandingAreaType", propOrder = {"timeSlice"})
@Entity(name = "SeaplaneLandingAreaType")
@Table(name = "seaplanelandingarea_f", schema = "airport_heliport")
public class SeaplaneLandingAreaType extends AbstractAIXMFeatureType implements Serializable {
    ...
    @OneToMany(targetEntity = SeaplaneLandingAreaTimeSlicePropertyType.class, cascade = {
     ...
     *
     */
    public void setTimeSlice(List<SeaplaneLandingAreaTimeSlicePropertyType> timeSlice) {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final SeaplaneLandingAreaType that = ((SeaplaneLandingAreaType) object);
        {
            boolean lhsFieldIsSet = this.isSetTimeSlice();
            boolean rhsFieldIsSet = that.isSetTimeSlice();
            List<SeaplaneLandingAreaTimeSlicePropertyType> lhsField;
            lhsField = (this.isSetTimeSlice() ? this.getTimeSlice() : null);
            List<SeaplaneLandingAreaTimeSlicePropertyType> rhsField;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = super.hashCode(locator, strategy);
        {
            ...
            List<SeaplaneLandingAreaTimeSlicePropertyType> theField;
