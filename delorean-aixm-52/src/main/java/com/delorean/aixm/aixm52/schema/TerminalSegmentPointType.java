...
/**
 * <p>
 * Java class for TerminalSegmentPointType complex type
 * </p>
 * .
 *
 * <p>
...
"{http://www.aixm.aero/schema/5.2}CodeProcedureFixRoleType" minOccurs="0"/>
 *         <element name="leadRadial" type=
"{http://www.aixm.aero/schema/5.2}ValBearingType" minOccurs="0"/>
 *         <element name="leadDME" type=
"{http://www.aixm.aero/schema/5.2}ValDistanceType" minOccurs="0"/>
 *         <element name="indicatorFACF" type=
"{http://www.aixm.aero/schema/5.2}CodeYesNoType" minOccurs="0"/>
 ...
 *                   <element ref=
"{http://www.aixm.aero/schema/5.2}AbstractTerminalSegmentPointExtension"/>
 *                 </choice>
 *                 <attGroup ref=
...
@XmlType(name = "TerminalSegmentPointType", propOrder = {"reportingATC", "flyOver", "waypoint", "radarGuidance",
        ...
        "annotation", "role", "leadRadial", "leadDME", "indicatorFACF", "extension"})
@Entity(name = "TerminalSegmentPointType")
@Table(name = "terminalsegmentpoint_o", schema = "navaids_point")
public class TerminalSegmentPointType extends AbstractSegmentPointType implements Serializable {
    ...
    @JoinTable(name = "trmnlsgmntpnttp_fcltmkp_link", schema = "navaids_point", joinColumns = {
            @JoinColumn(name = "terminalsegmentpoint_o_hjid", referencedColumnName = "hjid")}, inverseJoinColumns = {
     ...
     *
     * @return possible object is {@link JAXBElement
     *         }{@code <}{@link CodeProcedureFixRoleType }{@code >}
     *
     */
    @Transient
    ...
    public void setReportingATCItem(CodeATCReportingType target) {
        setReportingATC(XmlAdapterUtils.marshallJAXBElement(CodeATCReportingType.class,
                new QName("http://www.aixm.aero/schema/5.2", "reportingATC"), TerminalSegmentPointType.class, target));
    }
    ...
    public void setFlyOverItem(CodeYesNoType target) {
        setFlyOver(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class,
                new QName("http://www.aixm.aero/schema/5.2", "flyOver"), TerminalSegmentPointType.class, target));
    }
    ...
    public void setWaypointItem(CodeYesNoType target) {
        setWaypoint(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class,
                new QName("http://www.aixm.aero/schema/5.2", "waypoint"), TerminalSegmentPointType.class, target));
    }
    ...
    public void setRadarGuidanceItem(CodeYesNoType target) {
        setRadarGuidance(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class,
                new QName("http://www.aixm.aero/schema/5.2", "radarGuidance"), TerminalSegmentPointType.class, target));
    }
    ...
    public void setPointChoiceFixDesignatedPointItem(DesignatedPointPropertyType target) {
        setPointChoiceFixDesignatedPoint(XmlAdapterUtils.marshallJAXBElement(DesignatedPointPropertyType.class,
                ...
                TerminalSegmentPointType.class, target));
    }
    ...
    public void setPointChoiceNavaidSystemItem(NavaidPropertyType target) {
        setPointChoiceNavaidSystem(XmlAdapterUtils.marshallJAXBElement(NavaidPropertyType.class,
                new QName("http://www.aixm.aero/schema/5.2", "pointChoice_navaidSystem"),
                TerminalSegmentPointType.class, target));
    }
    ...
    public void setPointChoicePositionItem(AIXMPointPropertyType target) {
        setPointChoicePosition(XmlAdapterUtils.marshallJAXBElement(AIXMPointPropertyType.class,
                new QName("http://www.aixm.aero/schema/5.2", "pointChoice_position"), TerminalSegmentPointType.class,
                target));
    }
    ...
    public void setPointChoiceRunwayPointItem(RunwayCentrelinePointPropertyType target) {
        setPointChoiceRunwayPoint(XmlAdapterUtils.marshallJAXBElement(RunwayCentrelinePointPropertyType.class,
                new QName("http://www.aixm.aero/schema/5.2", "pointChoice_runwayPoint"), TerminalSegmentPointType.class,
                target));
    }
    ...
    public void setPointChoiceAimingPointItem(TouchDownLiftOffPropertyType target) {
        setPointChoiceAimingPoint(XmlAdapterUtils.marshallJAXBElement(TouchDownLiftOffPropertyType.class,
                new QName("http://www.aixm.aero/schema/5.2", "pointChoice_aimingPoint"), TerminalSegmentPointType.class,
                target));
    }
    ...
    public void setExtendedServiceVolumeItem(RadioFrequencyAreaPropertyType target) {
        setExtendedServiceVolume(XmlAdapterUtils.marshallJAXBElement(RadioFrequencyAreaPropertyType.class,
                new QName("http://www.aixm.aero/schema/5.2", "extendedServiceVolume"), TerminalSegmentPointType.class,
                target));
    }
    ...
    public void setRoleItem(CodeProcedureFixRoleType target) {
        setRole(XmlAdapterUtils.marshallJAXBElement(CodeProcedureFixRoleType.class,
                new QName("http://www.aixm.aero/schema/5.2", "role"), TerminalSegmentPointType.class, target));
    }

    @Embedded
    @AttributeOverrides({
            @AttributeOverride(name = "value", column = @Column(name = "leadradial", columnDefinition = "NUMERIC")),
            @AttributeOverride(name = "nilReason", column = @Column(name = "leadradialnilreason")),
            @AttributeOverride(name = "accuracy", column = @Column(name = "leadradialaccuracy"))})
    ...
    public void setLeadRadialItem(ValBearingType target) {
        setLeadRadial(XmlAdapterUtils.marshallJAXBElement(ValBearingType.class,
                new QName("http://www.aixm.aero/schema/5.2", "leadRadial"), TerminalSegmentPointType.class, target));
    }

    @Embedded
    @AttributeOverrides({
            @AttributeOverride(name = "value", column = @Column(name = "leaddme", columnDefinition = "NUMERIC")),
            @AttributeOverride(name = "uom", column = @Column(name = "leaddmeuom")),
            @AttributeOverride(name = "accuracy", column = @Column(name = "leaddmeaccuracy")),
            @AttributeOverride(name = "nilReason", column = @Column(name = "leaddmenilreason"))})
    ...
    public void setLeadDMEItem(ValDistanceType target) {
        setLeadDME(XmlAdapterUtils.marshallJAXBElement(ValDistanceType.class,
                new QName("http://www.aixm.aero/schema/5.2", "leadDME"), TerminalSegmentPointType.class, target));
    }

    @Embedded
    @AttributeOverrides({@AttributeOverride(name = "value", column = @Column(name = "indicatorfacf")),
            @AttributeOverride(name = "nilReason", column = @Column(name = "indicatorfacfnilreason"))})
    ...
    public void setIndicatorFACFItem(CodeYesNoType target) {
        setIndicatorFACF(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class,
                new QName("http://www.aixm.aero/schema/5.2", "indicatorFACF"), TerminalSegmentPointType.class, target));
    }
