 ...
 *         <element name="role" type="{http://www.aixm.aero/schema/5.2}CodeProcedureFixRoleType" minOccurs="0"/>
 *         <element name="leadRadial" type="{http://www.aixm.aero/schema/5.2}ValBearingType" minOccurs="0"/>
 *         <element name="leadDME" type="{http://www.aixm.aero/schema/5.2}ValDistanceType" minOccurs="0"/>
 *         <element name="indicatorFACF" type="{http://www.aixm.aero/schema/5.2}CodeYesNoType" minOccurs="0"/>
 ...
 *                   <element ref="{http://www.aixm.aero/schema/5.2}AbstractTerminalSegmentPointExtension"/>
 *                 </choice>
...
@Table(name = "terminalsegmentpoint_o", schema = "navaids_point")
    ...
    implements Serializable
{
    ...
    @XmlElementRef(name = "leadRadial", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<ValBearingType> leadRadial;
    @XmlElementRef(name = "leadDME", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<ValDistanceType> leadDME;
    @XmlElementRef(name = "indicatorFACF", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<CodeYesNoType> indicatorFACF;
    protected List<TerminalSegmentPointExtensionType> extension;
    ...
    @JoinTable(name = "trmnlsgmntpnttp_fcltmkp_link", schema = "navaids_point", joinColumns = {
        @JoinColumn(name = "terminalsegmentpoint_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "trmnlsgmntpnttp_annttn_link", schema = "navaids_point", joinColumns = {
        @JoinColumn(name = "terminalsegmentpoint_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link TerminalSegmentPointExtensionType }
     * 
     * 
     */
    @OneToMany(targetEntity = TerminalSegmentPointExtensionType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinColumn(name = "terminalsegmentpoint_oe_hjid", referencedColumnName = "hjid")
    public List<TerminalSegmentPointExtensionType> getExtension() {
        if (extension == null) {
     ...
     * 
     */
    public void setExtension(List<TerminalSegmentPointExtensionType> extension) {
    ...
    public void setReportingATCItem(CodeATCReportingType target) {
        setReportingATC(XmlAdapterUtils.marshallJAXBElement(CodeATCReportingType.class, new QName("http://www.aixm.aero/schema/5.2", "reportingATC"), TerminalSegmentPointType.class, target));
    }
    ...
    public void setFlyOverItem(CodeYesNoType target) {
        setFlyOver(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.2", "flyOver"), TerminalSegmentPointType.class, target));
    }
    ...
    public void setWaypointItem(CodeYesNoType target) {
        setWaypoint(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.2", "waypoint"), TerminalSegmentPointType.class, target));
    }
    ...
    public void setRadarGuidanceItem(CodeYesNoType target) {
        setRadarGuidance(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.2", "radarGuidance"), TerminalSegmentPointType.class, target));
    }

    @OneToOne(targetEntity = DesignatedPointPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "trmnlsgmntpnttp_pntchcfxdsgntdpnt_link", schema = "navaids_point", joinColumns = {
        @JoinColumn(name = "terminalsegmentpoint_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setPointChoiceFixDesignatedPointItem(DesignatedPointPropertyType target) {
        setPointChoiceFixDesignatedPoint(XmlAdapterUtils.marshallJAXBElement(DesignatedPointPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "pointChoice_fixDesignatedPoint"), TerminalSegmentPointType.class, target));
    }

    @OneToOne(targetEntity = NavaidPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "trmnlsgmntpnttp_pntchcnvdsstm_link", schema = "navaids_point", joinColumns = {
        @JoinColumn(name = "terminalsegmentpoint_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setPointChoiceNavaidSystemItem(NavaidPropertyType target) {
        setPointChoiceNavaidSystem(XmlAdapterUtils.marshallJAXBElement(NavaidPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "pointChoice_navaidSystem"), TerminalSegmentPointType.class, target));
    }

    @OneToOne(targetEntity = AIXMPointPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "trmnlsgmntpnttp_pntchcpstn_link", schema = "navaids_point", joinColumns = {
        @JoinColumn(name = "terminalsegmentpoint_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setPointChoicePositionItem(AIXMPointPropertyType target) {
        setPointChoicePosition(XmlAdapterUtils.marshallJAXBElement(AIXMPointPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "pointChoice_position"), TerminalSegmentPointType.class, target));
    }

    @OneToOne(targetEntity = RunwayCentrelinePointPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "trmnlsgmntpnttp_pntchcrnwpnt_link", schema = "navaids_point", joinColumns = {
        @JoinColumn(name = "terminalsegmentpoint_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setPointChoiceRunwayPointItem(RunwayCentrelinePointPropertyType target) {
        setPointChoiceRunwayPoint(XmlAdapterUtils.marshallJAXBElement(RunwayCentrelinePointPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "pointChoice_runwayPoint"), TerminalSegmentPointType.class, target));
    }

    @OneToOne(targetEntity = TouchDownLiftOffPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "trmnlsgmntpnttp_pntchcamngpnt_link", schema = "navaids_point", joinColumns = {
        @JoinColumn(name = "terminalsegmentpoint_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setPointChoiceAimingPointItem(TouchDownLiftOffPropertyType target) {
        setPointChoiceAimingPoint(XmlAdapterUtils.marshallJAXBElement(TouchDownLiftOffPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "pointChoice_aimingPoint"), TerminalSegmentPointType.class, target));
    }

    @OneToOne(targetEntity = AirportHeliportPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "trmnlsgmntpnttp_pntchcarprtrfrncpnt_link", schema = "navaids_point", joinColumns = {
        @JoinColumn(name = "terminalsegmentpoint_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setPointChoiceAirportReferencePointItem(AirportHeliportPropertyType target) {
        setPointChoiceAirportReferencePoint(XmlAdapterUtils.marshallJAXBElement(AirportHeliportPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "pointChoice_airportReferencePoint"), TerminalSegmentPointType.class, target));
    }

    @OneToOne(targetEntity = RadioFrequencyAreaPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "trmnlsgmntpnttp_extnddsrvcvlm_link", schema = "navaids_point", joinColumns = {
        @JoinColumn(name = "terminalsegmentpoint_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setExtendedServiceVolumeItem(RadioFrequencyAreaPropertyType target) {
        setExtendedServiceVolume(XmlAdapterUtils.marshallJAXBElement(RadioFrequencyAreaPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "extendedServiceVolume"), TerminalSegmentPointType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "role", columnDefinition = "codeprocedurefixrolebase")),
    ...
    public void setRoleItem(CodeProcedureFixRoleType target) {
        setRole(XmlAdapterUtils.marshallJAXBElement(CodeProcedureFixRoleType.class, new QName("http://www.aixm.aero/schema/5.2", "role"), TerminalSegmentPointType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "leadradial", columnDefinition = "valbearingbase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "leadradialnilreason", columnDefinition = "nilreason")),
        @AttributeOverride(name = "accuracy", column = @Column(name = "leadradialaccuracy", columnDefinition = "numericalwithnilreason"))
    })
    ...
    public void setLeadRadialItem(ValBearingType target) {
        setLeadRadial(XmlAdapterUtils.marshallJAXBElement(ValBearingType.class, new QName("http://www.aixm.aero/schema/5.2", "leadRadial"), TerminalSegmentPointType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "leaddme", columnDefinition = "valdistancebase")),
        @AttributeOverride(name = "uom", column = @Column(name = "leaddmeuom", columnDefinition = "uomdistance")),
        @AttributeOverride(name = "accuracy", column = @Column(name = "leaddmeaccuracy", columnDefinition = "numericalwithnilreason")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "leaddmenilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setLeadDMEItem(ValDistanceType target) {
        setLeadDME(XmlAdapterUtils.marshallJAXBElement(ValDistanceType.class, new QName("http://www.aixm.aero/schema/5.2", "leadDME"), TerminalSegmentPointType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "indicatorfacf", columnDefinition = "codeyesnobase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "indicatorfacfnilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setIndicatorFACFItem(CodeYesNoType target) {
        setIndicatorFACF(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.2", "indicatorFACF"), TerminalSegmentPointType.class, target));
    }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        }
        {
            ...
            List<TerminalSegmentPointExtensionType> lhsField;
            lhsField = (this.isSetExtension()?this.getExtension():null);
            List<TerminalSegmentPointExtensionType> rhsField;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        }
        {
            ...
            List<TerminalSegmentPointExtensionType> theField;
