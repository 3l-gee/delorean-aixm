 ...
 *         <element name="alternateClimbInstruction" type="{http://www.aixm.aero/schema/5.2}TextInstructionType" minOccurs="0"/>
 *         <element name="alternateClimbAltitude" type="{http://www.aixm.aero/schema/5.2}ValDistanceVerticalType" minOccurs="0"/>
 ...
 *                 <choice>
 *                   <element ref="{http://www.aixm.aero/schema/5.2}AbstractMissedApproachGroupExtension"/>
 *                 </choice>
    ...
    implements Serializable
{
    ...
    @XmlElementRef(name = "alternateClimbInstruction", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<TextInstructionType> alternateClimbInstruction;
    @XmlElementRef(name = "alternateClimbAltitude", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    ...
    public void setInstructionItem(TextInstructionType target) {
        setInstruction(XmlAdapterUtils.marshallJAXBElement(TextInstructionType.class, new QName("http://www.aixm.aero/schema/5.2", "instruction"), MissedApproachGroupType.class, target));
    }
    ...
    public void setAlternateClimbInstructionItem(TextInstructionType target) {
        setAlternateClimbInstruction(XmlAdapterUtils.marshallJAXBElement(TextInstructionType.class, new QName("http://www.aixm.aero/schema/5.2", "alternateClimbInstruction"), MissedApproachGroupType.class, target));
    }
    ...
    @AttributeOverrides({
        ...
        @AttributeOverride(name = "accuracy", column = @Column(name = "alternateclimbaltitudeaccuracy", columnDefinition = "numericalwithnilreason")),
    ...
    public void setAlternateClimbAltitudeItem(ValDistanceVerticalType target) {
        setAlternateClimbAltitude(XmlAdapterUtils.marshallJAXBElement(ValDistanceVerticalType.class, new QName("http://www.aixm.aero/schema/5.2", "alternateClimbAltitude"), MissedApproachGroupType.class, target));
    }
