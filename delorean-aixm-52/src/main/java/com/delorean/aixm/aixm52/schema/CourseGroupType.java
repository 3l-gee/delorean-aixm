...
/**
 * <p>Java class for CourseGroupType complex type</p>.
 * 
 ...
 *       <sequence>
 *         <element name="course" type="{http://www.aixm.aero/schema/5.2}ValBearingType" minOccurs="0"/>
 *         <element name="courseType" type="{http://www.aixm.aero/schema/5.2}CodeCourseType" minOccurs="0"/>
 *         <element name="courseDirection" type="{http://www.aixm.aero/schema/5.2}CodeDirectionReferenceType" minOccurs="0"/>
...
@XmlType(name = "CourseGroupType", propOrder = {
    "course",
    "courseType",
    "courseDirection",
    "annotation",
    ...
    implements Serializable
{
    ...
    @JoinTable(name = "crsgrptp_annttn_l", schema = "procedure", joinColumns = {
        @JoinColumn(name = "coursegroup_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
     ...
     * 
     */
    @OneToMany(targetEntity = CourseGroupExtensionType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    ...
    @AttributeOverrides({
        ...
        @AttributeOverride(name = "accuracy", column = @Column(name = "courseaccuracy", columnDefinition = "numericalwithnilreason"))
    })
    ...
    public void setCourseItem(ValBearingType target) {
        setCourse(XmlAdapterUtils.marshallJAXBElement(ValBearingType.class, new QName("http://www.aixm.aero/schema/5.2", "course"), CourseGroupType.class, target));
    }
    ...
    public void setCourseTypeItem(CodeCourseType target) {
        setCourseType(XmlAdapterUtils.marshallJAXBElement(CodeCourseType.class, new QName("http://www.aixm.aero/schema/5.2", "courseType"), CourseGroupType.class, target));
    }
    ...
    public void setCourseDirectionItem(CodeDirectionReferenceType target) {
        setCourseDirection(XmlAdapterUtils.marshallJAXBElement(CodeDirectionReferenceType.class, new QName("http://www.aixm.aero/schema/5.2", "courseDirection"), CourseGroupType.class, target));
    }
