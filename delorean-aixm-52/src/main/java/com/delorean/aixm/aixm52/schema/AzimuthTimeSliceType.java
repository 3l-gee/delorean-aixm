 ...
 *         <element name="type" type="{http://www.aixm.aero/schema/5.2}CodeMLSAzimuthType" minOccurs="0"/>
 ...
 *         <element name="angleProportionalLeft" type="{http://www.aixm.aero/schema/5.2}ValAngleType" minOccurs="0"/>
 *         <element name="angleProportionalRight" type="{http://www.aixm.aero/schema/5.2}ValAngleType" minOccurs="0"/>
 *         <element name="angleCoverLeft" type="{http://www.aixm.aero/schema/5.2}ValAngleType" minOccurs="0"/>
 *         <element name="angleCoverRight" type="{http://www.aixm.aero/schema/5.2}ValAngleType" minOccurs="0"/>
 *         <element name="channel" type="{http://www.aixm.aero/schema/5.2}CodeMLSChannelType" minOccurs="0"/>
 *         <element name="extension" maxOccurs="unbounded" minOccurs="0">
 *           <complexType>
 *             <complexContent>
 *               <restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 <choice>
 *                   <element ref="{http://www.aixm.aero/schema/5.2}AbstractAzimuthExtension"/>
    ...
    implements Serializable
{
    ...
    @XmlElementRef(name = "angleProportionalLeft", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<ValAngleType> angleProportionalLeft;
    @XmlElementRef(name = "angleProportionalRight", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<ValAngleType> angleProportionalRight;
    @XmlElementRef(name = "angleCoverLeft", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<ValAngleType> angleCoverLeft;
    @XmlElementRef(name = "angleCoverRight", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    ...
    public void setDesignatorItem(CodeNavaidDesignatorType target) {
        setDesignator(XmlAdapterUtils.marshallJAXBElement(CodeNavaidDesignatorType.class, new QName("http://www.aixm.aero/schema/5.2", "designator"), AzimuthTimeSliceType.class, target));
    }
    ...
    public void setAixmNameItem(TextNameType target) {
        setAixmName(XmlAdapterUtils.marshallJAXBElement(TextNameType.class, new QName("http://www.aixm.aero/schema/5.2", "name"), AzimuthTimeSliceType.class, target));
    }
    ...
    public void setEmissionClassItem(CodeRadioEmissionType target) {
        setEmissionClass(XmlAdapterUtils.marshallJAXBElement(CodeRadioEmissionType.class, new QName("http://www.aixm.aero/schema/5.2", "emissionClass"), AzimuthTimeSliceType.class, target));
    }
    ...
    public void setMobileItem(CodeYesNoType target) {
        setMobile(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.2", "mobile"), AzimuthTimeSliceType.class, target));
    }
    ...
    public void setMagneticVariationItem(ValMagneticVariationType target) {
        setMagneticVariation(XmlAdapterUtils.marshallJAXBElement(ValMagneticVariationType.class, new QName("http://www.aixm.aero/schema/5.2", "magneticVariation"), AzimuthTimeSliceType.class, target));
    }
    ...
    public void setDateMagneticVariationItem(DateYearType target) {
        setDateMagneticVariation(XmlAdapterUtils.marshallJAXBElement(DateYearType.class, new QName("http://www.aixm.aero/schema/5.2", "dateMagneticVariation"), AzimuthTimeSliceType.class, target));
    }
    ...
    public void setFlightCheckedItem(CodeYesNoType target) {
        setFlightChecked(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.2", "flightChecked"), AzimuthTimeSliceType.class, target));
    }
    ...
    public void setLocationItem(AIXMElevatedPointPropertyType target) {
        setLocation(XmlAdapterUtils.marshallJAXBElement(AIXMElevatedPointPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "location"), AzimuthTimeSliceType.class, target));
    }
    ...
    public void setTypeItem(CodeMLSAzimuthType target) {
        setType(XmlAdapterUtils.marshallJAXBElement(CodeMLSAzimuthType.class, new QName("http://www.aixm.aero/schema/5.2", "type"), AzimuthTimeSliceType.class, target));
    }
    ...
    public void setTrueBearingItem(ValBearingType target) {
        setTrueBearing(XmlAdapterUtils.marshallJAXBElement(ValBearingType.class, new QName("http://www.aixm.aero/schema/5.2", "trueBearing"), AzimuthTimeSliceType.class, target));
    }
    ...
    public void setMagneticBearingItem(ValBearingType target) {
        setMagneticBearing(XmlAdapterUtils.marshallJAXBElement(ValBearingType.class, new QName("http://www.aixm.aero/schema/5.2", "magneticBearing"), AzimuthTimeSliceType.class, target));
    }
    ...
    @AttributeOverrides({
        ...
        @AttributeOverride(name = "accuracy", column = @Column(name = "angleproportionalleftaccuracy", columnDefinition = "numericalwithnilreason"))
    })
    ...
    public void setAngleProportionalLeftItem(ValAngleType target) {
        setAngleProportionalLeft(XmlAdapterUtils.marshallJAXBElement(ValAngleType.class, new QName("http://www.aixm.aero/schema/5.2", "angleProportionalLeft"), AzimuthTimeSliceType.class, target));
    }
    ...
    @AttributeOverrides({
        ...
        @AttributeOverride(name = "accuracy", column = @Column(name = "angleproportionalrightaccuracy", columnDefinition = "numericalwithnilreason"))
    })
    ...
    public void setAngleProportionalRightItem(ValAngleType target) {
        setAngleProportionalRight(XmlAdapterUtils.marshallJAXBElement(ValAngleType.class, new QName("http://www.aixm.aero/schema/5.2", "angleProportionalRight"), AzimuthTimeSliceType.class, target));
    }
    ...
    @AttributeOverrides({
        ...
        @AttributeOverride(name = "accuracy", column = @Column(name = "anglecoverleftaccuracy", columnDefinition = "numericalwithnilreason"))
    })
    ...
    public void setAngleCoverLeftItem(ValAngleType target) {
        setAngleCoverLeft(XmlAdapterUtils.marshallJAXBElement(ValAngleType.class, new QName("http://www.aixm.aero/schema/5.2", "angleCoverLeft"), AzimuthTimeSliceType.class, target));
    }
    ...
    @AttributeOverrides({
        ...
        @AttributeOverride(name = "accuracy", column = @Column(name = "anglecoverrightaccuracy", columnDefinition = "numericalwithnilreason"))
    })
    ...
    public void setAngleCoverRightItem(ValAngleType target) {
        setAngleCoverRight(XmlAdapterUtils.marshallJAXBElement(ValAngleType.class, new QName("http://www.aixm.aero/schema/5.2", "angleCoverRight"), AzimuthTimeSliceType.class, target));
    }
    ...
    public void setChannelItem(CodeMLSChannelType target) {
        setChannel(XmlAdapterUtils.marshallJAXBElement(CodeMLSChannelType.class, new QName("http://www.aixm.aero/schema/5.2", "channel"), AzimuthTimeSliceType.class, target));
    }
