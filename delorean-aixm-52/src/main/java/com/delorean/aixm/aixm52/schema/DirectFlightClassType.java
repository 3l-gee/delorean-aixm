...
/**
 * <p>Java class for DirectFlightClassType complex type</p>.
 * 
 ...
 *         <element name="exceedLength" type="{http://www.aixm.aero/schema/5.2}ValDistanceType" minOccurs="0"/>
 ...
 *                   <element ref="{http://www.aixm.aero/schema/5.2}AbstractDirectFlightClassExtension"/>
 *                 </choice>
    ...
    implements Serializable
{
    ...
    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "exceedlength", columnDefinition = "valdistancebase")),
        @AttributeOverride(name = "uom", column = @Column(name = "exceedlengthuom", columnDefinition = "uomdistance")),
        @AttributeOverride(name = "accuracy", column = @Column(name = "exceedlengthaccuracy", columnDefinition = "numericalwithnilreason")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "exceedlengthnilreason", columnDefinition = "nilreason"))
    })
    public ValDistanceType getExceedLengthItem() {
        return XmlAdapterUtils.unmarshallSource(ValDistanceType.class, this.getExceedLength());
    }

    public void setExceedLengthItem(ValDistanceType target) {
        setExceedLength(XmlAdapterUtils.marshallJAXBElement(ValDistanceType.class, new QName("http://www.aixm.aero/schema/5.2", "exceedLength"), DirectFlightClassType.class, target));
    }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetExceedLength();
            JAXBElement<ValDistanceType> theField;
            theField = this.getExceedLength();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "exceedLength", theField);
            currentHashCode = strategy.hashCode(theFieldLocator, currentHashCode, theField, theFieldIsSet);
        }
        {
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        }
        {
            ...
            JAXBElement<ValDistanceType> theField;
            theField = this.getExceedLength();
            strategy.appendField(locator, this, "exceedLength", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetExtension();
            List<DirectFlightClassExtensionType> theField;
