...
/**
 * <p>
 * Java class for DirectFlightClassType complex type
 * </p>
 * .
 *
 * <p>
 ...
 *         <element name="exceedLength" type=
 ...
 *                   <element ref=
"{http://www.aixm.aero/schema/5.2}AbstractDirectFlightClassExtension"/>
 *                 </choice>
 *                 <attGroup ref=
...
public class DirectFlightClassType extends AbstractDirectFlightType implements Serializable {
    ...
    @Embedded
    @AttributeOverrides({
            @AttributeOverride(name = "value", column = @Column(name = "exceedlength", columnDefinition = "NUMERIC")),
            @AttributeOverride(name = "uom", column = @Column(name = "exceedlengthuom")),
            @AttributeOverride(name = "accuracy", column = @Column(name = "exceedlengthaccuracy")),
            @AttributeOverride(name = "nilReason", column = @Column(name = "exceedlengthnilreason"))})
    ...
    public void setExceedLengthItem(ValDistanceType target) {
        setExceedLength(XmlAdapterUtils.marshallJAXBElement(ValDistanceType.class,
                new QName("http://www.aixm.aero/schema/5.2", "exceedLength"), DirectFlightClassType.class, target));
    }
