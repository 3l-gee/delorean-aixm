...
/**
 * <p>Java class for AirportSignPropertyType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="AirportSignPropertyType">
 *   <complexContent>
...
@XmlType(name = "AirportSignPropertyType")
@Entity(name = "AirportSignPropertyType")
@Table(name = "airportsign_p", schema = "airport_heliport")
public class AirportSignPropertyType implements Serializable, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        final AirportSignPropertyType that = ((AirportSignPropertyType) object);
        {
