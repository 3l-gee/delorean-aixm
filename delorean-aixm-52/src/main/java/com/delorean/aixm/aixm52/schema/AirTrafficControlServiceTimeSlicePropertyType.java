 ...
 *       <sequence>
 *         <element ref="{http://www.aixm.aero/schema/5.2}AirTrafficControlServiceTimeSlice"/>
 *       </sequence>
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            AirTrafficControlServiceTimeSliceType theField;
            theField = this.getAirTrafficControlServiceTimeSlice();
            strategy.appendField(locator, this, "airTrafficControlServiceTimeSlice", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetOwns();
            boolean theField;
