 ...
 *       <sequence>
 *         <element name="referenceLocation" type="{http://www.aixm.aero/schema/5.2}CodeYesNoType" minOccurs="0"/>
 *         <element name="relationWithLocation" type="{http://www.aixm.aero/schema/5.2}CodeLocationQualifierType" minOccurs="0"/>
 ...
 *                 <choice>
 *                   <element ref="{http://www.aixm.aero/schema/5.2}AbstractFlightConditionCircumstanceExtension"/>
 *                 </choice>
    ...
    implements Serializable
{
    ...
    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "referencelocation", columnDefinition = "codeyesnobase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "referencelocationnilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setReferenceLocationItem(CodeYesNoType target) {
        setReferenceLocation(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.2", "referenceLocation"), FlightConditionCircumstanceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "relationwithlocation", columnDefinition = "codelocationqualifierbase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "relationwithlocationnilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setRelationWithLocationItem(CodeLocationQualifierType target) {
        setRelationWithLocation(XmlAdapterUtils.marshallJAXBElement(CodeLocationQualifierType.class, new QName("http://www.aixm.aero/schema/5.2", "relationWithLocation"), FlightConditionCircumstanceType.class, target));
    }
