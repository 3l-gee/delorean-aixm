...
/**
 * <p>
 * Java class for ChangeOverPointType complex type
 * </p>
 * .
 *
 * <p>
...
"{http://www.aixm.aero/schema/5.2}ChangeOverPointTimeSlicePropertyType" maxOccurs
="unbounded"/>
 *       </sequence>
 *     </extension>
 *   </complexContent>
...
@XmlType(name = "ChangeOverPointType", propOrder = {"timeSlice"})
@Entity(name = "ChangeOverPointType")
@Table(name = "changeoverpoint_f", schema = "route")
public class ChangeOverPointType extends AbstractAIXMFeatureType implements Serializable {
    ...
    @OneToMany(targetEntity = ChangeOverPointTimeSlicePropertyType.class, cascade = {
     ...
     *
     */
    public void setTimeSlice(List<ChangeOverPointTimeSlicePropertyType> timeSlice) {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final ChangeOverPointType that = ((ChangeOverPointType) object);
        {
            boolean lhsFieldIsSet = this.isSetTimeSlice();
            boolean rhsFieldIsSet = that.isSetTimeSlice();
            List<ChangeOverPointTimeSlicePropertyType> lhsField;
            lhsField = (this.isSetTimeSlice() ? this.getTimeSlice() : null);
            List<ChangeOverPointTimeSlicePropertyType> rhsField;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = super.hashCode(locator, strategy);
        {
            ...
            List<ChangeOverPointTimeSlicePropertyType> theField;
