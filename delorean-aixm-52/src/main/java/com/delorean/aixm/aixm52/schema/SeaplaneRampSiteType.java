...
"{http://www.aixm.aero/schema/5.2}SeaplaneRampSiteTimeSlicePropertyType" maxOccurs
="unbounded"/>
 *       </sequence>
 *     </extension>
 *   </complexContent>
...
@Table(name = "seaplanerampsite_f", schema = "airport_heliport")
public class SeaplaneRampSiteType extends AbstractAIXMFeatureType implements Serializable {
    ...
    @OneToMany(targetEntity = SeaplaneRampSiteTimeSlicePropertyType.class, cascade = {
