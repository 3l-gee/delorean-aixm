 ...
 *       <sequence>
 *         <element name="type" type="{http://www.aixm.aero/schema/5.2}CodeNavaidServiceType" minOccurs="0"/>
 ...
 *         <element name="purpose" type="{http://www.aixm.aero/schema/5.2}CodeNavaidPurposeType" minOccurs="0"/>
 ...
 *         <element name="touchDownLiftOff" type="{http://www.aixm.aero/schema/5.2}TouchDownLiftOffPropertyType" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="navaidEquipment" type="{http://www.aixm.aero/schema/5.2}NavaidComponentPropertyType" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="location" type="{http://www.aixm.aero/schema/5.2}ElevatedPointPropertyType" minOccurs="0"/>
 *         <element name="runwayDirection" type="{http://www.aixm.aero/schema/5.2}RunwayDirectionPropertyType" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="servedAirport" type="{http://www.aixm.aero/schema/5.2}AirportHeliportPropertyType" maxOccurs="unbounded" minOccurs="0"/>
 ...
 *         <element name="codeICAOCountry" type="{http://www.aixm.aero/schema/5.2}CodeICAOCountryType" minOccurs="0"/>
 *         <element name="extension" maxOccurs="unbounded" minOccurs="0">
 *           <complexType>
 *             <complexContent>
 *               <restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 <sequence>
 *                   <element ref="{http://www.aixm.aero/schema/5.2}AbstractNavaidExtension"/>
 *                 </sequence>
    ...
    implements Serializable
{
    ...
    @XmlElementRef(name = "purpose", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    ...
    protected List<NavaidTimeSliceExtensionType> extension;
    ...
    @JoinTable(name = "nvdtmslctp_tchdwnlftoff_link", schema = "navaids_point", joinColumns = {
    ...
    @JoinTable(name = "nvdtmslctp_nvdeqpmnt_link", schema = "navaids_point", joinColumns = {
        @JoinColumn(name = "navaid_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "nvdtmslctp_rnwdrctn_link", schema = "navaids_point", joinColumns = {
        @JoinColumn(name = "navaid_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "nvdtmslctp_srvdarprt_link", schema = "navaids_point", joinColumns = {
        @JoinColumn(name = "navaid_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "nvdtmslctp_avlblt_link", schema = "navaids_point", joinColumns = {
        @JoinColumn(name = "navaid_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "nvdtmslctp_annttn_link", schema = "navaids_point", joinColumns = {
        @JoinColumn(name = "navaid_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link NavaidTimeSliceExtensionType }
     * 
     * 
     */
    @OneToMany(targetEntity = NavaidTimeSliceExtensionType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinColumn(name = "navaid_te_hjid", referencedColumnName = "hjid")
    public List<NavaidTimeSliceExtensionType> getExtension() {
        if (extension == null) {
     ...
     * 
     */
    public void setExtension(List<NavaidTimeSliceExtensionType> extension) {
    ...
    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "type", columnDefinition = "codenavaidservicebase")),
    ...
    public void setTypeItem(CodeNavaidServiceType target) {
        setType(XmlAdapterUtils.marshallJAXBElement(CodeNavaidServiceType.class, new QName("http://www.aixm.aero/schema/5.2", "type"), NavaidTimeSliceType.class, target));
    }
    ...
    public void setDesignatorItem(CodeNavaidDesignatorType target) {
        setDesignator(XmlAdapterUtils.marshallJAXBElement(CodeNavaidDesignatorType.class, new QName("http://www.aixm.aero/schema/5.2", "designator"), NavaidTimeSliceType.class, target));
    }
    ...
    public void setAixmNameItem(TextNameType target) {
        setAixmName(XmlAdapterUtils.marshallJAXBElement(TextNameType.class, new QName("http://www.aixm.aero/schema/5.2", "name"), NavaidTimeSliceType.class, target));
    }
    ...
    public void setFlightCheckedItem(CodeYesNoType target) {
        setFlightChecked(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.2", "flightChecked"), NavaidTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "purpose", columnDefinition = "codenavaidpurposebase")),
    ...
    public void setPurposeItem(CodeNavaidPurposeType target) {
        setPurpose(XmlAdapterUtils.marshallJAXBElement(CodeNavaidPurposeType.class, new QName("http://www.aixm.aero/schema/5.2", "purpose"), NavaidTimeSliceType.class, target));
    }
    ...
    public void setSignalPerformanceItem(CodeSignalPerformanceILSType target) {
        setSignalPerformance(XmlAdapterUtils.marshallJAXBElement(CodeSignalPerformanceILSType.class, new QName("http://www.aixm.aero/schema/5.2", "signalPerformance"), NavaidTimeSliceType.class, target));
    }
    ...
    public void setCourseQualityItem(CodeCourseQualityILSType target) {
        setCourseQuality(XmlAdapterUtils.marshallJAXBElement(CodeCourseQualityILSType.class, new QName("http://www.aixm.aero/schema/5.2", "courseQuality"), NavaidTimeSliceType.class, target));
    }
    ...
    public void setIntegrityLevelItem(CodeIntegrityLevelILSType target) {
        setIntegrityLevel(XmlAdapterUtils.marshallJAXBElement(CodeIntegrityLevelILSType.class, new QName("http://www.aixm.aero/schema/5.2", "integrityLevel"), NavaidTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = AIXMElevatedPointPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "nvdtmslctp_lctn_link", schema = "navaids_point", joinColumns = {
        @JoinColumn(name = "navaid_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setLocationItem(AIXMElevatedPointPropertyType target) {
        setLocation(XmlAdapterUtils.marshallJAXBElement(AIXMElevatedPointPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "location"), NavaidTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "codeicaocountry", columnDefinition = "alphanumeric")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "codeicaocountrynilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setCodeICAOCountryItem(CodeICAOCountryType target) {
        setCodeICAOCountry(XmlAdapterUtils.marshallJAXBElement(CodeICAOCountryType.class, new QName("http://www.aixm.aero/schema/5.2", "codeICAOCountry"), NavaidTimeSliceType.class, target));
    }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        }
        {
            ...
            List<NavaidTimeSliceExtensionType> lhsField;
            lhsField = (this.isSetExtension()?this.getExtension():null);
            List<NavaidTimeSliceExtensionType> rhsField;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        }
        {
            ...
            List<NavaidTimeSliceExtensionType> theField;
