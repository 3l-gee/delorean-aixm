...
@Entity(name = "InformationServiceTimeSliceExtensionType")
@Table(name = "informationservice_te", schema = "service")
public class InformationServiceTimeSliceExtensionType implements Serializable, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        final InformationServiceTimeSliceExtensionType that = ((InformationServiceTimeSliceExtensionType) object);
        {
        ...
        }
        {
            ...
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "abstractInformationServiceExtension", lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "abstractInformationServiceExtension", rhsField);
            if (!strategy.equals(lhsFieldLocator, rhsFieldLocator, lhsField, rhsField, lhsFieldIsSet, rhsFieldIsSet)) {
                return false;
            }
        }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetAbstractInformationServiceExtension();
            AbstractExtensionType theField;
            theField = this.getAbstractInformationServiceExtension();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "abstractInformationServiceExtension", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            AbstractExtensionType theField;
            theField = this.getAbstractInformationServiceExtension();
            strategy.appendField(locator, this, "abstractInformationServiceExtension", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetAbstractServiceExtension();
            AbstractExtensionType theField;
