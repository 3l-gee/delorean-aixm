...
/**
 * <p>Java class for FinalApproachSegmentDataPropertyType complex type</p>.
 * 
 ...
 *       <sequence>
 *         <element ref="{http://www.aixm.aero/schema/5.2}FinalApproachSegmentData"/>
 *       </sequence>
 *     </extension>
 *   </complexContent>
 * </complexType>
...
@XmlType(name = "FinalApproachSegmentDataPropertyType", propOrder = {
    ...
    implements Serializable
{
     ...
     * @return
     *     possible object is
     *     {@link FinalApproachSegmentDataType }
     *     
     */
    @OneToOne(targetEntity = FinalApproachSegmentDataType.class, cascade = {
        CascadeType.ALL
