 ...
 *         <element name="markingLocation" type="{http://www.aixm.aero/schema/5.2}CodeRunwaySectionType" minOccurs="0"/>
 *         <element name="markedRunway" type="{http://www.aixm.aero/schema/5.2}RunwayPropertyType" minOccurs="0"/>
 *         <element name="extension" maxOccurs="unbounded" minOccurs="0">
 *           <complexType>
 *             <complexContent>
 *               <restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 <choice>
 *                   <element ref="{http://www.aixm.aero/schema/5.2}AbstractRunwayMarkingExtension"/>
...
@Table(name = "runwaymarking_t", schema = "airport_heliport")
    ...
    implements Serializable
{
    ...
    @XmlElementRef(name = "markedRunway", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    ...
    @JoinTable(name = "rnwmrkngtmslctp_elmnt_link", schema = "airport_heliport", joinColumns = {
        @JoinColumn(name = "runwaymarking_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "rnwmrkngtmslctp_annttn_link", schema = "airport_heliport", joinColumns = {
        @JoinColumn(name = "runwaymarking_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setMarkingICAOStandardItem(CodeYesNoType target) {
        setMarkingICAOStandard(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.2", "markingICAOStandard"), RunwayMarkingTimeSliceType.class, target));
    }
    ...
    public void setConditionItem(CodeMarkingConditionType target) {
        setCondition(XmlAdapterUtils.marshallJAXBElement(CodeMarkingConditionType.class, new QName("http://www.aixm.aero/schema/5.2", "condition"), RunwayMarkingTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "markinglocation", columnDefinition = "coderunwaysectionbase")),
    ...
    public void setMarkingLocationItem(CodeRunwaySectionType target) {
        setMarkingLocation(XmlAdapterUtils.marshallJAXBElement(CodeRunwaySectionType.class, new QName("http://www.aixm.aero/schema/5.2", "markingLocation"), RunwayMarkingTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = RunwayPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "rnwmrkngtmslctp_mrkdrnw_link", schema = "airport_heliport", joinColumns = {
        @JoinColumn(name = "runwaymarking_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
        @JoinColumn(name = "markedrunway_hjid", referencedColumnName = "hjid")
    })
    ...
    public void setMarkedRunwayItem(RunwayPropertyType target) {
        setMarkedRunway(XmlAdapterUtils.marshallJAXBElement(RunwayPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "markedRunway"), RunwayMarkingTimeSliceType.class, target));
    }
