...
"{http://www.aixm.aero/schema/5.2}PassengerLoadingBridgeTimeSlicePropertyType" maxOccurs
="unbounded"/>
 *       </sequence>
 *     </extension>
 *   </complexContent>
...
@Table(name = "passengerloadingbridge_f", schema = "airport_heliport")
public class PassengerLoadingBridgeType extends AbstractAIXMFeatureType implements Serializable {
    ...
    @OneToMany(targetEntity = PassengerLoadingBridgeTimeSlicePropertyType.class, cascade = {
