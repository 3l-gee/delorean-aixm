 ...
 *   <complexContent>
 *     <extension base="{http://www.aixm.aero/schema/5.2}AbstractSurfaceContaminationType">
 *       <sequence>
 *         <element name="observationTime" type="{http://www.aixm.aero/schema/5.2}DateTimeType" minOccurs="0"/>
 *         <element name="depth" type="{http://www.aixm.aero/schema/5.2}ValDepthType" minOccurs="0"/>
 *         <element name="frictionCoefficient" type="{http://www.aixm.aero/schema/5.2}ValFrictionType" minOccurs="0"/>
 *         <element name="frictionEstimation" type="{http://www.aixm.aero/schema/5.2}CodeFrictionEstimateType" minOccurs="0"/>
 *         <element name="frictionDevice" type="{http://www.aixm.aero/schema/5.2}CodeFrictionDeviceType" minOccurs="0"/>
 *         <element name="obscuredLights" type="{http://www.aixm.aero/schema/5.2}CodeYesNoType" minOccurs="0"/>
 *         <element name="furtherClearanceTime" type="{http://www.aixm.aero/schema/5.2}TimeType" minOccurs="0"/>
 *         <element name="furtherTotalClearance" type="{http://www.aixm.aero/schema/5.2}CodeYesNoType" minOccurs="0"/>
 *         <element name="nextObservationTime" type="{http://www.aixm.aero/schema/5.2}DateTimeType" minOccurs="0"/>
 *         <element name="proportion" type="{http://www.aixm.aero/schema/5.2}ValPercentType" minOccurs="0"/>
 *         <element name="criticalRidge" type="{http://www.aixm.aero/schema/5.2}RidgePropertyType" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="layer" type="{http://www.aixm.aero/schema/5.2}SurfaceContaminationLayerPropertyType" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="annotation" type="{http://www.aixm.aero/schema/5.2}NotePropertyType" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="clearedLength" type="{http://www.aixm.aero/schema/5.2}ValDistanceType" minOccurs="0"/>
 *         <element name="clearedWidth" type="{http://www.aixm.aero/schema/5.2}ValDistanceType" minOccurs="0"/>
 *         <element name="clearedSide" type="{http://www.aixm.aero/schema/5.2}CodeSideType" minOccurs="0"/>
 *         <element name="furtherClearanceLength" type="{http://www.aixm.aero/schema/5.2}ValDistanceType" minOccurs="0"/>
 *         <element name="furtherClearanceWidth" type="{http://www.aixm.aero/schema/5.2}ValDistanceType" minOccurs="0"/>
 *         <element name="obscuredLightsSide" type="{http://www.aixm.aero/schema/5.2}CodeSideType" minOccurs="0"/>
 *         <element name="clearedLengthBegin" type="{http://www.aixm.aero/schema/5.2}ValDistanceType" minOccurs="0"/>
 *         <element name="taxiwayAvailable" type="{http://www.aixm.aero/schema/5.2}CodeYesNoType" minOccurs="0"/>
 *         <element name="apronAvailable" type="{http://www.aixm.aero/schema/5.2}CodeYesNoType" minOccurs="0"/>
 *         <element name="extension" maxOccurs="unbounded" minOccurs="0">
 *           <complexType>
 *             <complexContent>
 *               <restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 <choice>
 *                   <element ref="{http://www.aixm.aero/schema/5.2}AbstractSurfaceContaminationExtension"/>
 *                   <element ref="{http://www.aixm.aero/schema/5.2}AbstractRunwayContaminationExtension"/>
 *                 </choice>
...
@Table(name = "runwaycontamination_o", schema = "airport_heliport")
    ...
    implements Serializable
{
    ...
    @XmlElementRef(name = "observationTime", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "frictionCoefficient", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<ValFrictionType> frictionCoefficient;
    @XmlElementRef(name = "frictionEstimation", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<CodeFrictionEstimateType> frictionEstimation;
    @XmlElementRef(name = "frictionDevice", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<CodeFrictionDeviceType> frictionDevice;
    @XmlElementRef(name = "obscuredLights", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<CodeYesNoType> obscuredLights;
    @XmlElementRef(name = "furtherClearanceTime", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<TimeType> furtherClearanceTime;
    @XmlElementRef(name = "furtherTotalClearance", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<CodeYesNoType> furtherTotalClearance;
    @XmlElementRef(name = "nextObservationTime", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<DateTimeType> nextObservationTime;
    @XmlElementRef(name = "proportion", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "clearedLength", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<ValDistanceType> clearedLength;
    @XmlElementRef(name = "clearedWidth", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<ValDistanceType> clearedWidth;
    @XmlElementRef(name = "clearedSide", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<CodeSideType> clearedSide;
    @XmlElementRef(name = "furtherClearanceLength", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<ValDistanceType> furtherClearanceLength;
    @XmlElementRef(name = "furtherClearanceWidth", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<ValDistanceType> furtherClearanceWidth;
    @XmlElementRef(name = "obscuredLightsSide", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<CodeSideType> obscuredLightsSide;
    @XmlElementRef(name = "clearedLengthBegin", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<ValDistanceType> clearedLengthBegin;
    @XmlElementRef(name = "taxiwayAvailable", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<CodeYesNoType> taxiwayAvailable;
    @XmlElementRef(name = "apronAvailable", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<CodeYesNoType> apronAvailable;
    protected List<RunwayContaminationExtensionType> extension;
    ...
    @JoinTable(name = "rnwcntmntntp_crtclrdg_link", schema = "airport_heliport", joinColumns = {
        @JoinColumn(name = "runwaycontamination_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "rnwcntmntntp_lr_link", schema = "airport_heliport", joinColumns = {
        @JoinColumn(name = "runwaycontamination_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "rnwcntmntntp_annttn_link", schema = "airport_heliport", joinColumns = {
        @JoinColumn(name = "runwaycontamination_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link RunwayContaminationExtensionType }
     * 
     * 
     */
    @OneToMany(targetEntity = RunwayContaminationExtensionType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinColumn(name = "runwaycontamination_oe_hjid", referencedColumnName = "hjid")
    public List<RunwayContaminationExtensionType> getExtension() {
        if (extension == null) {
     ...
     * 
     */
    public void setExtension(List<RunwayContaminationExtensionType> extension) {
    ...
    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "observationtime", columnDefinition = "datetimebase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "observationtimenilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setObservationTimeItem(DateTimeType target) {
        setObservationTime(XmlAdapterUtils.marshallJAXBElement(DateTimeType.class, new QName("http://www.aixm.aero/schema/5.2", "observationTime"), RunwayContaminationType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "depth", columnDefinition = "valdepthbase")),
        @AttributeOverride(name = "uom", column = @Column(name = "depthuom", columnDefinition = "uomdepth")),
    ...
    public void setDepthItem(ValDepthType target) {
        setDepth(XmlAdapterUtils.marshallJAXBElement(ValDepthType.class, new QName("http://www.aixm.aero/schema/5.2", "depth"), RunwayContaminationType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "frictioncoefficient", columnDefinition = "valfrictionbase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "frictioncoefficientnilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setFrictionCoefficientItem(ValFrictionType target) {
        setFrictionCoefficient(XmlAdapterUtils.marshallJAXBElement(ValFrictionType.class, new QName("http://www.aixm.aero/schema/5.2", "frictionCoefficient"), RunwayContaminationType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "frictionestimation", columnDefinition = "codefrictionestimatebase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "frictionestimationnilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setFrictionEstimationItem(CodeFrictionEstimateType target) {
        setFrictionEstimation(XmlAdapterUtils.marshallJAXBElement(CodeFrictionEstimateType.class, new QName("http://www.aixm.aero/schema/5.2", "frictionEstimation"), RunwayContaminationType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "frictiondevice", columnDefinition = "codefrictiondevicebase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "frictiondevicenilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setFrictionDeviceItem(CodeFrictionDeviceType target) {
        setFrictionDevice(XmlAdapterUtils.marshallJAXBElement(CodeFrictionDeviceType.class, new QName("http://www.aixm.aero/schema/5.2", "frictionDevice"), RunwayContaminationType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "obscuredlights", columnDefinition = "codeyesnobase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "obscuredlightsnilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setObscuredLightsItem(CodeYesNoType target) {
        setObscuredLights(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.2", "obscuredLights"), RunwayContaminationType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "furtherclearancetime", columnDefinition = "timebase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "furtherclearancetimenilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setFurtherClearanceTimeItem(TimeType target) {
        setFurtherClearanceTime(XmlAdapterUtils.marshallJAXBElement(TimeType.class, new QName("http://www.aixm.aero/schema/5.2", "furtherClearanceTime"), RunwayContaminationType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "furthertotalclearance", columnDefinition = "codeyesnobase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "furthertotalclearancenilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setFurtherTotalClearanceItem(CodeYesNoType target) {
        setFurtherTotalClearance(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.2", "furtherTotalClearance"), RunwayContaminationType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "nextobservationtime", columnDefinition = "datetimebase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "nextobservationtimenilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setNextObservationTimeItem(DateTimeType target) {
        setNextObservationTime(XmlAdapterUtils.marshallJAXBElement(DateTimeType.class, new QName("http://www.aixm.aero/schema/5.2", "nextObservationTime"), RunwayContaminationType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "proportion", columnDefinition = "valpercentbase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "proportionnilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setProportionItem(ValPercentType target) {
        setProportion(XmlAdapterUtils.marshallJAXBElement(ValPercentType.class, new QName("http://www.aixm.aero/schema/5.2", "proportion"), RunwayContaminationType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "clearedlength", columnDefinition = "valdistancebase")),
        @AttributeOverride(name = "uom", column = @Column(name = "clearedlengthuom", columnDefinition = "uomdistance")),
        @AttributeOverride(name = "accuracy", column = @Column(name = "clearedlengthaccuracy", columnDefinition = "numericalwithnilreason")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "clearedlengthnilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setClearedLengthItem(ValDistanceType target) {
        setClearedLength(XmlAdapterUtils.marshallJAXBElement(ValDistanceType.class, new QName("http://www.aixm.aero/schema/5.2", "clearedLength"), RunwayContaminationType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "clearedwidth", columnDefinition = "valdistancebase")),
        @AttributeOverride(name = "uom", column = @Column(name = "clearedwidthuom", columnDefinition = "uomdistance")),
        @AttributeOverride(name = "accuracy", column = @Column(name = "clearedwidthaccuracy", columnDefinition = "numericalwithnilreason")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "clearedwidthnilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setClearedWidthItem(ValDistanceType target) {
        setClearedWidth(XmlAdapterUtils.marshallJAXBElement(ValDistanceType.class, new QName("http://www.aixm.aero/schema/5.2", "clearedWidth"), RunwayContaminationType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "clearedside", columnDefinition = "codesidebase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "clearedsidenilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setClearedSideItem(CodeSideType target) {
        setClearedSide(XmlAdapterUtils.marshallJAXBElement(CodeSideType.class, new QName("http://www.aixm.aero/schema/5.2", "clearedSide"), RunwayContaminationType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "furtherclearancelength", columnDefinition = "valdistancebase")),
        @AttributeOverride(name = "uom", column = @Column(name = "furtherclearancelengthuom", columnDefinition = "uomdistance")),
        @AttributeOverride(name = "accuracy", column = @Column(name = "furtherclearancelengthaccuracy", columnDefinition = "numericalwithnilreason")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "furtherclearancelengthnilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setFurtherClearanceLengthItem(ValDistanceType target) {
        setFurtherClearanceLength(XmlAdapterUtils.marshallJAXBElement(ValDistanceType.class, new QName("http://www.aixm.aero/schema/5.2", "furtherClearanceLength"), RunwayContaminationType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "furtherclearancewidth", columnDefinition = "valdistancebase")),
        @AttributeOverride(name = "uom", column = @Column(name = "furtherclearancewidthuom", columnDefinition = "uomdistance")),
        @AttributeOverride(name = "accuracy", column = @Column(name = "furtherclearancewidthaccuracy", columnDefinition = "numericalwithnilreason")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "furtherclearancewidthnilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setFurtherClearanceWidthItem(ValDistanceType target) {
        setFurtherClearanceWidth(XmlAdapterUtils.marshallJAXBElement(ValDistanceType.class, new QName("http://www.aixm.aero/schema/5.2", "furtherClearanceWidth"), RunwayContaminationType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "obscuredlightsside", columnDefinition = "codesidebase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "obscuredlightssidenilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setObscuredLightsSideItem(CodeSideType target) {
        setObscuredLightsSide(XmlAdapterUtils.marshallJAXBElement(CodeSideType.class, new QName("http://www.aixm.aero/schema/5.2", "obscuredLightsSide"), RunwayContaminationType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "clearedlengthbegin", columnDefinition = "valdistancebase")),
        @AttributeOverride(name = "uom", column = @Column(name = "clearedlengthbeginuom", columnDefinition = "uomdistance")),
        @AttributeOverride(name = "accuracy", column = @Column(name = "clearedlengthbeginaccuracy", columnDefinition = "numericalwithnilreason")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "clearedlengthbeginnilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setClearedLengthBeginItem(ValDistanceType target) {
        setClearedLengthBegin(XmlAdapterUtils.marshallJAXBElement(ValDistanceType.class, new QName("http://www.aixm.aero/schema/5.2", "clearedLengthBegin"), RunwayContaminationType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "taxiwayavailable", columnDefinition = "codeyesnobase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "taxiwayavailablenilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setTaxiwayAvailableItem(CodeYesNoType target) {
        setTaxiwayAvailable(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.2", "taxiwayAvailable"), RunwayContaminationType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "apronavailable", columnDefinition = "codeyesnobase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "apronavailablenilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setApronAvailableItem(CodeYesNoType target) {
        setApronAvailable(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.2", "apronAvailable"), RunwayContaminationType.class, target));
    }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        }
        {
            ...
            List<RunwayContaminationExtensionType> lhsField;
            lhsField = (this.isSetExtension()?this.getExtension():null);
            List<RunwayContaminationExtensionType> rhsField;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        }
        {
            ...
            List<RunwayContaminationExtensionType> theField;
