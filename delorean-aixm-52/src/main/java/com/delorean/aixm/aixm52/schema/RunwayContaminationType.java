...
/**
 * <p>
 * Java class for RunwayContaminationType complex type
 * </p>
 * .
 *
 * <p>
 ...
 *   <complexContent>
 *     <extension base=
"{http://www.aixm.aero/schema/5.2}AbstractSurfaceContaminationType">
 *       <sequence>
 *         <element name="observationTime" type=
"{http://www.aixm.aero/schema/5.2}DateTimeType" minOccurs="0"/>
 *         <element name="depth" type=
"{http://www.aixm.aero/schema/5.2}ValDepthType" minOccurs="0"/>
 *         <element name="frictionCoefficient" type=
"{http://www.aixm.aero/schema/5.2}ValFrictionType" minOccurs="0"/>
 *         <element name="frictionEstimation" type=
"{http://www.aixm.aero/schema/5.2}CodeFrictionEstimateType" minOccurs="0"/>
 *         <element name="frictionDevice" type=
"{http://www.aixm.aero/schema/5.2}CodeFrictionDeviceType" minOccurs="0"/>
...
"{http://www.aixm.aero/schema/5.2}TimeType" minOccurs="0"/>
 *         <element name="furtherTotalClearance" type=
"{http://www.aixm.aero/schema/5.2}CodeYesNoType" minOccurs="0"/>
 *         <element name="nextObservationTime" type=
"{http://www.aixm.aero/schema/5.2}DateTimeType" minOccurs="0"/>
 *         <element name="proportion" type=
"{http://www.aixm.aero/schema/5.2}ValPercentType" minOccurs="0"/>
 *         <element name="criticalRidge" type=
"{http://www.aixm.aero/schema/5.2}RidgePropertyType" maxOccurs=
"unbounded" minOccurs="0"/>
 *         <element name="layer" type=
"{http://www.aixm.aero/schema/5.2}SurfaceContaminationLayerPropertyType" maxOccurs
="unbounded" minOccurs="0"/>
 *         <element name="annotation" type=
"{http://www.aixm.aero/schema/5.2}NotePropertyType" maxOccurs=
"unbounded" minOccurs="0"/>
 *         <element name="clearedLength" type=
"{http://www.aixm.aero/schema/5.2}ValDistanceType" minOccurs="0"/>
 *         <element name="clearedWidth" type=
"{http://www.aixm.aero/schema/5.2}ValDistanceType" minOccurs="0"/>
 *         <element name="clearedSide" type=
"{http://www.aixm.aero/schema/5.2}CodeSideType" minOccurs="0"/>
 *         <element name="furtherClearanceLength" type=
"{http://www.aixm.aero/schema/5.2}ValDistanceType" minOccurs="0"/>
 *         <element name="furtherClearanceWidth" type=
"{http://www.aixm.aero/schema/5.2}ValDistanceType" minOccurs="0"/>
 *         <element name="obscuredLightsSide" type=
"{http://www.aixm.aero/schema/5.2}CodeSideType" minOccurs="0"/>
 *         <element name="clearedLengthBegin" type=
"{http://www.aixm.aero/schema/5.2}ValDistanceType" minOccurs="0"/>
 *         <element name="taxiwayAvailable" type=
"{http://www.aixm.aero/schema/5.2}CodeYesNoType" minOccurs="0"/>
 *         <element name="apronAvailable" type=
"{http://www.aixm.aero/schema/5.2}CodeYesNoType" minOccurs="0"/>
 ...
 *                 <choice>
 *                   <element ref=
"{http://www.aixm.aero/schema/5.2}AbstractSurfaceContaminationExtension"/>
 *                   <element ref=
"{http://www.aixm.aero/schema/5.2}AbstractRunwayContaminationExtension"/>
 *                 </choice>
 *                 <attGroup ref=
...
@XmlType(name = "RunwayContaminationType", propOrder = {"observationTime", "depth", "frictionCoefficient",
        "frictionEstimation", "frictionDevice", "obscuredLights", "furtherClearanceTime", "furtherTotalClearance",
        "nextObservationTime", "proportion", "criticalRidge", "layer", "annotation", "clearedLength", "clearedWidth",
        "clearedSide", "furtherClearanceLength", "furtherClearanceWidth", "obscuredLightsSide", "clearedLengthBegin",
        "taxiwayAvailable", "apronAvailable", "extension"})
@Entity(name = "RunwayContaminationType")
@Table(name = "runwaycontamination_o", schema = "airport_heliport")
public class RunwayContaminationType extends AbstractSurfaceContaminationType implements Serializable {
     ...
     *
     */
    @OneToMany(targetEntity = RidgePropertyType.class, cascade = {CascadeType.ALL}, fetch = FetchType.EAGER)
    @JoinTable(name = "rnwcntmntntp_crtclrdg_link", schema = "airport_heliport", joinColumns = {
            @JoinColumn(name = "runwaycontamination_o_hjid", referencedColumnName = "hjid")}, inverseJoinColumns = {
    ...
    @AttributeOverrides({@AttributeOverride(name = "value", column = @Column(name = "observationtime")),
            @AttributeOverride(name = "nilReason", column = @Column(name = "observationtimenilreason"))})
    ...
    public void setObservationTimeItem(DateTimeType target) {
        setObservationTime(XmlAdapterUtils.marshallJAXBElement(DateTimeType.class,
                new QName("http://www.aixm.aero/schema/5.2", "observationTime"), RunwayContaminationType.class,
                target));
    }
    ...
    public void setDepthItem(ValDepthType target) {
        setDepth(XmlAdapterUtils.marshallJAXBElement(ValDepthType.class,
                new QName("http://www.aixm.aero/schema/5.2", "depth"), RunwayContaminationType.class, target));
    }

    @Embedded
    @AttributeOverrides({
            @AttributeOverride(name = "value", column = @Column(name = "frictioncoefficient", columnDefinition = "NUMERIC")),
            @AttributeOverride(name = "nilReason", column = @Column(name = "frictioncoefficientnilreason"))})
    ...
    public void setFrictionCoefficientItem(ValFrictionType target) {
        setFrictionCoefficient(XmlAdapterUtils.marshallJAXBElement(ValFrictionType.class,
                new QName("http://www.aixm.aero/schema/5.2", "frictionCoefficient"), RunwayContaminationType.class,
                target));
    }

    @Embedded
    @AttributeOverrides({@AttributeOverride(name = "value", column = @Column(name = "frictionestimation")),
            @AttributeOverride(name = "nilReason", column = @Column(name = "frictionestimationnilreason"))})
    ...
    public void setFrictionEstimationItem(CodeFrictionEstimateType target) {
        setFrictionEstimation(XmlAdapterUtils.marshallJAXBElement(CodeFrictionEstimateType.class,
                new QName("http://www.aixm.aero/schema/5.2", "frictionEstimation"), RunwayContaminationType.class,
                target));
    }

    @Embedded
    @AttributeOverrides({@AttributeOverride(name = "value", column = @Column(name = "frictiondevice")),
            @AttributeOverride(name = "nilReason", column = @Column(name = "frictiondevicenilreason"))})
    ...
    public void setFrictionDeviceItem(CodeFrictionDeviceType target) {
        setFrictionDevice(XmlAdapterUtils.marshallJAXBElement(CodeFrictionDeviceType.class,
                new QName("http://www.aixm.aero/schema/5.2", "frictionDevice"), RunwayContaminationType.class, target));
    }

    @Embedded
    @AttributeOverrides({@AttributeOverride(name = "value", column = @Column(name = "obscuredlights")),
            @AttributeOverride(name = "nilReason", column = @Column(name = "obscuredlightsnilreason"))})
    ...
    public void setObscuredLightsItem(CodeYesNoType target) {
        setObscuredLights(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class,
                new QName("http://www.aixm.aero/schema/5.2", "obscuredLights"), RunwayContaminationType.class, target));
    }

    @Embedded
    @AttributeOverrides({
            @AttributeOverride(name = "value", column = @Column(name = "furtherclearancetime", columnDefinition = "VARCHAR", length = 256)),
            @AttributeOverride(name = "nilReason", column = @Column(name = "furtherclearancetimenilreason"))})
    ...
    public void setFurtherClearanceTimeItem(TimeType target) {
        setFurtherClearanceTime(XmlAdapterUtils.marshallJAXBElement(TimeType.class,
                new QName("http://www.aixm.aero/schema/5.2", "furtherClearanceTime"), RunwayContaminationType.class,
                target));
    }

    @Embedded
    @AttributeOverrides({@AttributeOverride(name = "value", column = @Column(name = "furthertotalclearance")),
            @AttributeOverride(name = "nilReason", column = @Column(name = "furthertotalclearancenilreason"))})
    ...
    public void setFurtherTotalClearanceItem(CodeYesNoType target) {
        setFurtherTotalClearance(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class,
                new QName("http://www.aixm.aero/schema/5.2", "furtherTotalClearance"), RunwayContaminationType.class,
                target));
    }

    @Embedded
    @AttributeOverrides({@AttributeOverride(name = "value", column = @Column(name = "nextobservationtime")),
            @AttributeOverride(name = "nilReason", column = @Column(name = "nextobservationtimenilreason"))})
    ...
    public void setNextObservationTimeItem(DateTimeType target) {
        setNextObservationTime(XmlAdapterUtils.marshallJAXBElement(DateTimeType.class,
                new QName("http://www.aixm.aero/schema/5.2", "nextObservationTime"), RunwayContaminationType.class,
                target));
    }
    ...
    @AttributeOverrides({
            ...
            @AttributeOverride(name = "nilReason", column = @Column(name = "proportionnilreason"))})
    ...
    public void setProportionItem(ValPercentType target) {
        setProportion(XmlAdapterUtils.marshallJAXBElement(ValPercentType.class,
                new QName("http://www.aixm.aero/schema/5.2", "proportion"), RunwayContaminationType.class, target));
    }

    @Embedded
    @AttributeOverrides({
            @AttributeOverride(name = "value", column = @Column(name = "clearedlength", columnDefinition = "NUMERIC")),
            @AttributeOverride(name = "uom", column = @Column(name = "clearedlengthuom")),
            @AttributeOverride(name = "accuracy", column = @Column(name = "clearedlengthaccuracy")),
            @AttributeOverride(name = "nilReason", column = @Column(name = "clearedlengthnilreason"))})
    ...
    public void setClearedLengthItem(ValDistanceType target) {
        setClearedLength(XmlAdapterUtils.marshallJAXBElement(ValDistanceType.class,
                new QName("http://www.aixm.aero/schema/5.2", "clearedLength"), RunwayContaminationType.class, target));
    }

    @Embedded
    @AttributeOverrides({
            @AttributeOverride(name = "value", column = @Column(name = "clearedwidth", columnDefinition = "NUMERIC")),
            @AttributeOverride(name = "uom", column = @Column(name = "clearedwidthuom")),
            @AttributeOverride(name = "accuracy", column = @Column(name = "clearedwidthaccuracy")),
            @AttributeOverride(name = "nilReason", column = @Column(name = "clearedwidthnilreason"))})
    ...
    public void setClearedWidthItem(ValDistanceType target) {
        setClearedWidth(XmlAdapterUtils.marshallJAXBElement(ValDistanceType.class,
                new QName("http://www.aixm.aero/schema/5.2", "clearedWidth"), RunwayContaminationType.class, target));
    }

    @Embedded
    @AttributeOverrides({@AttributeOverride(name = "value", column = @Column(name = "clearedside")),
            @AttributeOverride(name = "nilReason", column = @Column(name = "clearedsidenilreason"))})
    ...
    public void setClearedSideItem(CodeSideType target) {
        setClearedSide(XmlAdapterUtils.marshallJAXBElement(CodeSideType.class,
                new QName("http://www.aixm.aero/schema/5.2", "clearedSide"), RunwayContaminationType.class, target));
    }

    @Embedded
    @AttributeOverrides({
            @AttributeOverride(name = "value", column = @Column(name = "furtherclearancelength", columnDefinition = "NUMERIC")),
            @AttributeOverride(name = "uom", column = @Column(name = "furtherclearancelengthuom")),
            @AttributeOverride(name = "accuracy", column = @Column(name = "furtherclearancelengthaccuracy")),
            @AttributeOverride(name = "nilReason", column = @Column(name = "furtherclearancelengthnilreason"))})
    ...
    public void setFurtherClearanceLengthItem(ValDistanceType target) {
        setFurtherClearanceLength(XmlAdapterUtils.marshallJAXBElement(ValDistanceType.class,
                new QName("http://www.aixm.aero/schema/5.2", "furtherClearanceLength"), RunwayContaminationType.class,
                target));
    }

    @Embedded
    @AttributeOverrides({
            @AttributeOverride(name = "value", column = @Column(name = "furtherclearancewidth", columnDefinition = "NUMERIC")),
            @AttributeOverride(name = "uom", column = @Column(name = "furtherclearancewidthuom")),
            @AttributeOverride(name = "accuracy", column = @Column(name = "furtherclearancewidthaccuracy")),
            @AttributeOverride(name = "nilReason", column = @Column(name = "furtherclearancewidthnilreason"))})
    ...
    public void setFurtherClearanceWidthItem(ValDistanceType target) {
        setFurtherClearanceWidth(XmlAdapterUtils.marshallJAXBElement(ValDistanceType.class,
                new QName("http://www.aixm.aero/schema/5.2", "furtherClearanceWidth"), RunwayContaminationType.class,
                target));
    }

    @Embedded
    @AttributeOverrides({@AttributeOverride(name = "value", column = @Column(name = "obscuredlightsside")),
            @AttributeOverride(name = "nilReason", column = @Column(name = "obscuredlightssidenilreason"))})
    ...
    public void setObscuredLightsSideItem(CodeSideType target) {
        setObscuredLightsSide(XmlAdapterUtils.marshallJAXBElement(CodeSideType.class,
                new QName("http://www.aixm.aero/schema/5.2", "obscuredLightsSide"), RunwayContaminationType.class,
                target));
    }

    @Embedded
    @AttributeOverrides({
            @AttributeOverride(name = "value", column = @Column(name = "clearedlengthbegin", columnDefinition = "NUMERIC")),
            @AttributeOverride(name = "uom", column = @Column(name = "clearedlengthbeginuom")),
            @AttributeOverride(name = "accuracy", column = @Column(name = "clearedlengthbeginaccuracy")),
            @AttributeOverride(name = "nilReason", column = @Column(name = "clearedlengthbeginnilreason"))})
    ...
    public void setClearedLengthBeginItem(ValDistanceType target) {
        setClearedLengthBegin(XmlAdapterUtils.marshallJAXBElement(ValDistanceType.class,
                new QName("http://www.aixm.aero/schema/5.2", "clearedLengthBegin"), RunwayContaminationType.class,
                target));
    }

    @Embedded
    @AttributeOverrides({@AttributeOverride(name = "value", column = @Column(name = "taxiwayavailable")),
            @AttributeOverride(name = "nilReason", column = @Column(name = "taxiwayavailablenilreason"))})
    ...
    public void setTaxiwayAvailableItem(CodeYesNoType target) {
        setTaxiwayAvailable(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class,
                new QName("http://www.aixm.aero/schema/5.2", "taxiwayAvailable"), RunwayContaminationType.class,
                target));
    }

    @Embedded
    @AttributeOverrides({@AttributeOverride(name = "value", column = @Column(name = "apronavailable")),
            @AttributeOverride(name = "nilReason", column = @Column(name = "apronavailablenilreason"))})
    ...
    public void setApronAvailableItem(CodeYesNoType target) {
        setApronAvailable(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class,
                new QName("http://www.aixm.aero/schema/5.2", "apronAvailable"), RunwayContaminationType.class, target));
    }
