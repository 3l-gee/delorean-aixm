 ...
 *       <sequence>
 *         <element name="type" type="{http://www.aixm.aero/schema/5.2}CodeNavigationAreaRestrictionType" minOccurs="0"/>
 *         <element name="procedure" type="{http://www.aixm.aero/schema/5.2}ProcedurePropertyType" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="designSurface" type="{http://www.aixm.aero/schema/5.2}ObstacleAssessmentSurfacePropertyType" minOccurs="0"/>
...
@Table(name = "navigationarearestriction_t", schema = "procedure")
    ...
    implements Serializable
{
    ...
    @XmlElementRef(name = "designSurface", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<ObstacleAssessmentSurfacePropertyType> designSurface;
    ...
    @JoinTable(name = "nvgtnarrstrctntmslctp_prcdr_link", schema = "procedure", joinColumns = {
        @JoinColumn(name = "navigationarearestriction_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
        @JoinColumn(name = "procedure_hjid", referencedColumnName = "hjid")
    })
     ...
     */
    @Transient
    public JAXBElement<ObstacleAssessmentSurfacePropertyType> getDesignSurface() {
     ...
     *     
     */
    public void setDesignSurface(JAXBElement<ObstacleAssessmentSurfacePropertyType> value) {
    ...
    @JoinTable(name = "nvgtnarrstrctntmslctp_annttn_link", schema = "procedure", joinColumns = {
        @JoinColumn(name = "navigationarearestriction_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "type", columnDefinition = "codenavigationarearestrictionbase")),
    ...
    public void setTypeItem(CodeNavigationAreaRestrictionType target) {
        setType(XmlAdapterUtils.marshallJAXBElement(CodeNavigationAreaRestrictionType.class, new QName("http://www.aixm.aero/schema/5.2", "type"), NavigationAreaRestrictionTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = ObstacleAssessmentSurfacePropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "nvgtnarrstrctntmslctp_dsgnsrfc_link", schema = "procedure", joinColumns = {
        @JoinColumn(name = "navigationarearestriction_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
        @JoinColumn(name = "designsurface_hjid", referencedColumnName = "hjid")
    })
    public ObstacleAssessmentSurfacePropertyType getDesignSurfaceItem() {
        return XmlAdapterUtils.unmarshallSource(ObstacleAssessmentSurfacePropertyType.class, this.getDesignSurface());
    }

    public void setDesignSurfaceItem(ObstacleAssessmentSurfacePropertyType target) {
        setDesignSurface(XmlAdapterUtils.marshallJAXBElement(ObstacleAssessmentSurfacePropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "designSurface"), NavigationAreaRestrictionTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = CircleSectorPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "nvgtnarrstrctntmslctp_sctrdfntn_link", schema = "procedure", joinColumns = {
        @JoinColumn(name = "navigationarearestriction_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setSectorDefinitionItem(CircleSectorPropertyType target) {
        setSectorDefinition(XmlAdapterUtils.marshallJAXBElement(CircleSectorPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "sectorDefinition"), NavigationAreaRestrictionTimeSliceType.class, target));
    }
