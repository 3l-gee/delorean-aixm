 ...
 *       <sequence>
 *         <element ref="{http://www.aixm.aero/schema/5.2}AerialRefuellingTimeSlice"/>
 *       </sequence>
...
public class AerialRefuellingTimeSlicePropertyType implements Serializable, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        }
        {
            ...
            AerialRefuellingTimeSliceType lhsField;
            lhsField = this.getAerialRefuellingTimeSlice();
            AerialRefuellingTimeSliceType rhsField;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetAerialRefuellingTimeSlice();
            AerialRefuellingTimeSliceType theField;
            theField = this.getAerialRefuellingTimeSlice();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "aerialRefuellingTimeSlice", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            AerialRefuellingTimeSliceType theField;
            theField = this.getAerialRefuellingTimeSlice();
            strategy.appendField(locator, this, "aerialRefuellingTimeSlice", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetOwns();
            boolean theField;
