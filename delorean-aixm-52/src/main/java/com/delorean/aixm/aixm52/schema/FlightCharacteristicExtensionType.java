...
public class FlightCharacteristicExtensionType implements Serializable, Equals, HashCode, ToString
{
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = 1;
        {
            ...
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "abstractFlightCharacteristicExtension", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            AbstractExtensionType theField;
            theField = this.getAbstractFlightCharacteristicExtension();
            strategy.appendField(locator, this, "abstractFlightCharacteristicExtension", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetOwns();
            boolean theField;
