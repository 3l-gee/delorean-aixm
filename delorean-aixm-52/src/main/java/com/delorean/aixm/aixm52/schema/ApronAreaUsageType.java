 ...
 *                   <element ref="{http://www.aixm.aero/schema/5.2}AbstractApronAreaUsageExtension"/>
 *                 </choice>
    ...
    implements Serializable
{
    ...
    @JoinTable(name = "aprnarusgtp_cntct_l", schema = "airport_heliport", joinColumns = {
        @JoinColumn(name = "apronareausage_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "aprnarusgtp_annttn_l", schema = "airport_heliport", joinColumns = {
        @JoinColumn(name = "apronareausage_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
     ...
     * 
     */
    @OneToMany(targetEntity = ApronAreaUsageExtensionType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    ...
    public void setTypeItem(CodeUsageLimitationType target) {
        setType(XmlAdapterUtils.marshallJAXBElement(CodeUsageLimitationType.class, new QName("http://www.aixm.aero/schema/5.2", "type"), ApronAreaUsageType.class, target));
    }
    ...
    public void setPriorPermissionItem(ValDurationType target) {
        setPriorPermission(XmlAdapterUtils.marshallJAXBElement(ValDurationType.class, new QName("http://www.aixm.aero/schema/5.2", "priorPermission"), ApronAreaUsageType.class, target));
    }

    @OneToOne(targetEntity = ConditionCombinationPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "aprnarusgtp_slctn_l", schema = "airport_heliport", joinColumns = {
        @JoinColumn(name = "apronareausage_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setSelectionItem(ConditionCombinationPropertyType target) {
        setSelection(XmlAdapterUtils.marshallJAXBElement(ConditionCombinationPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "selection"), ApronAreaUsageType.class, target));
    }
