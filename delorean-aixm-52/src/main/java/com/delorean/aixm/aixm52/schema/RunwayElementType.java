...
"{http://www.aixm.aero/schema/5.2}RunwayElementTimeSlicePropertyType" maxOccurs=
"unbounded"/>
 *       </sequence>
 *     </extension>
 *   </complexContent>
...
@Table(name = "runwayelement_f", schema = "airport_heliport")
public class RunwayElementType extends AbstractAIXMFeatureType implements Serializable {
    ...
    @OneToMany(targetEntity = RunwayElementTimeSlicePropertyType.class, cascade = {
