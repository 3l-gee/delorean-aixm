 ...
 *       <sequence>
 *         <element name="clicks" type="{http://www.aixm.aero/schema/5.2}NoNumberType" minOccurs="0"/>
 *         <element name="intensityLevel" type="{http://www.aixm.aero/schema/5.2}CodeLightIntensityType" minOccurs="0"/>
 *         <element name="activation" type="{http://www.aixm.aero/schema/5.2}CodeSystemActivationType" minOccurs="0"/>
 ...
 *                 <choice>
 *                   <element ref="{http://www.aixm.aero/schema/5.2}AbstractLightActivationExtension"/>
 *                 </choice>
    ...
    implements Serializable
{
    ...
    @XmlElementRef(name = "clicks", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "activation", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    ...
    public void setClicksItem(NoNumberType target) {
        setClicks(XmlAdapterUtils.marshallJAXBElement(NoNumberType.class, new QName("http://www.aixm.aero/schema/5.2", "clicks"), LightActivationType.class, target));
    }
    ...
    public void setIntensityLevelItem(CodeLightIntensityType target) {
        setIntensityLevel(XmlAdapterUtils.marshallJAXBElement(CodeLightIntensityType.class, new QName("http://www.aixm.aero/schema/5.2", "intensityLevel"), LightActivationType.class, target));
    }
    ...
    public void setActivationItem(CodeSystemActivationType target) {
        setActivation(XmlAdapterUtils.marshallJAXBElement(CodeSystemActivationType.class, new QName("http://www.aixm.aero/schema/5.2", "activation"), LightActivationType.class, target));
    }
