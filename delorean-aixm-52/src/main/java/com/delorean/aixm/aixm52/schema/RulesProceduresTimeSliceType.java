 ...
 *       <sequence>
 *         <element name="category" type="{http://www.aixm.aero/schema/5.2}CodeRuleProcedureType" minOccurs="0"/>
 *         <element name="title" type="{http://www.aixm.aero/schema/5.2}CodeRuleProcedureTitleType" minOccurs="0"/>
 *         <element name="content" type="{http://www.aixm.aero/schema/5.2}XHTMLType" minOccurs="0"/>
 *         <element name="affectedLocation" type="{http://www.aixm.aero/schema/5.2}AirportHeliportPropertyType" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="affectedArea" type="{http://www.aixm.aero/schema/5.2}AirspacePropertyType" maxOccurs="unbounded" minOccurs="0"/>
 ...
 *                 <sequence>
 *                   <element ref="{http://www.aixm.aero/schema/5.2}AbstractRulesProceduresExtension"/>
 *                 </sequence>
    ...
    implements Serializable
{
    ...
    @JoinTable(name = "rlsprcdrstmslctp_affctdlctn_link", schema = "rules_procedure", joinColumns = {
        @JoinColumn(name = "rulesprocedures_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "category", columnDefinition = "coderuleprocedurebase")),
    ...
    public void setCategoryItem(CodeRuleProcedureType target) {
        setCategory(XmlAdapterUtils.marshallJAXBElement(CodeRuleProcedureType.class, new QName("http://www.aixm.aero/schema/5.2", "category"), RulesProceduresTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "title", columnDefinition = "coderuleproceduretitlebase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "titlenilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setTitleItem(CodeRuleProcedureTitleType target) {
        setTitle(XmlAdapterUtils.marshallJAXBElement(CodeRuleProcedureTitleType.class, new QName("http://www.aixm.aero/schema/5.2", "title"), RulesProceduresTimeSliceType.class, target));
    }
    ...
    public void setContentItem(XHTMLType target) {
        setContent(XmlAdapterUtils.marshallJAXBElement(XHTMLType.class, new QName("http://www.aixm.aero/schema/5.2", "content"), RulesProceduresTimeSliceType.class, target));
    }
