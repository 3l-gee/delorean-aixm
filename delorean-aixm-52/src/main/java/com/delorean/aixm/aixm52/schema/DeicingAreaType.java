...
"{http://www.aixm.aero/schema/5.2}DeicingAreaTimeSlicePropertyType" maxOccurs=
"unbounded"/>
 *       </sequence>
 *     </extension>
 *   </complexContent>
...
@Table(name = "deicingarea_f", schema = "airport_heliport")
public class DeicingAreaType extends AbstractAIXMFeatureType implements Serializable {
    ...
    @OneToMany(targetEntity = DeicingAreaTimeSlicePropertyType.class, cascade = {
