 ...
 *         <element name="type" type="{http://www.aixm.aero/schema/5.2}CodeLightHoldingPositionType" minOccurs="0"/>
 *         <element name="taxiHolding" type="{http://www.aixm.aero/schema/5.2}TaxiHoldingPositionPropertyType" minOccurs="0"/>
 *         <element name="extension" maxOccurs="unbounded" minOccurs="0">
 *           <complexType>
 *             <complexContent>
 *               <restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 <choice>
 *                   <element ref="{http://www.aixm.aero/schema/5.2}AbstractTaxiHoldingPositionLightSystemExtension"/>
    ...
    implements Serializable
{
    ...
    public void setEmergencyLightingItem(CodeYesNoType target) {
        setEmergencyLighting(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.2", "emergencyLighting"), TaxiHoldingPositionLightSystemTimeSliceType.class, target));
    }
    ...
    public void setIntensityLevelItem(CodeLightIntensityType target) {
        setIntensityLevel(XmlAdapterUtils.marshallJAXBElement(CodeLightIntensityType.class, new QName("http://www.aixm.aero/schema/5.2", "intensityLevel"), TaxiHoldingPositionLightSystemTimeSliceType.class, target));
    }
    ...
    public void setColourItem(CodeColourType target) {
        setColour(XmlAdapterUtils.marshallJAXBElement(CodeColourType.class, new QName("http://www.aixm.aero/schema/5.2", "colour"), TaxiHoldingPositionLightSystemTimeSliceType.class, target));
    }
    ...
    public void setTypeItem(CodeLightHoldingPositionType target) {
        setType(XmlAdapterUtils.marshallJAXBElement(CodeLightHoldingPositionType.class, new QName("http://www.aixm.aero/schema/5.2", "type"), TaxiHoldingPositionLightSystemTimeSliceType.class, target));
    }
    ...
    public void setTaxiHoldingItem(TaxiHoldingPositionPropertyType target) {
        setTaxiHolding(XmlAdapterUtils.marshallJAXBElement(TaxiHoldingPositionPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "taxiHolding"), TaxiHoldingPositionLightSystemTimeSliceType.class, target));
    }
