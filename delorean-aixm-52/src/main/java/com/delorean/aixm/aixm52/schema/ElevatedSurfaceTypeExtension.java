 ...
 *       <choice>
 *         <element ref="{http://www.aixm.aero/schema/5.2}AbstractElevatedSurfaceExtension"/>
 *       </choice>
...
public class ElevatedSurfaceTypeExtension implements Serializable, Equals, HashCode, ToString
{
    ...
    @JoinTable(name = "elevatedsurface_e_extension_link", schema = "gml", joinColumns = {
        @JoinColumn(name = "elevatedsurface_e_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = 1;
        {
            ...
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "abstractElevatedSurfaceExtension", theField);
