 ...
 *       <choice>
 *         <element ref=
"{http://www.aixm.aero/schema/5.2}AbstractElevatedSurfaceExtension"/>
 *       </choice>
 *       <attGroup ref=
...
@XmlType(name = "", propOrder = {"abstractElevatedSurfaceExtension"})
@Entity(name = "ElevatedSurfaceTypeExtension")
@Table(name = "elevatedsurface_e", schema = "gml")
public class ElevatedSurfaceTypeExtension implements Serializable, Equals, HashCode, ToString {
    ...
    @JoinTable(name = "elevatedsurface_e_extension_link", schema = "gml", joinColumns = {
            @JoinColumn(name = "elevatedsurface_e_hjid", referencedColumnName = "hjid")}, inverseJoinColumns = {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        }
        {
            ...
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "abstractElevatedSurfaceExtension",
                    lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "abstractElevatedSurfaceExtension",
                    rhsField);
            if (!strategy.equals(lhsFieldLocator, rhsFieldLocator, lhsField, rhsField, lhsFieldIsSet, rhsFieldIsSet)) {
                return false;
            }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetAbstractElevatedSurfaceExtension();
            AbstractExtensionType theField;
            theField = this.getAbstractElevatedSurfaceExtension();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "abstractElevatedSurfaceExtension",
                    theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            AbstractExtensionType theField;
            theField = this.getAbstractElevatedSurfaceExtension();
            strategy.appendField(locator, this, "abstractElevatedSurfaceExtension", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetOwns();
            boolean theField;
