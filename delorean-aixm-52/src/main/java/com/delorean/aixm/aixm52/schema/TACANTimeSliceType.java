 ...
 *         <element name="channel" type="{http://www.aixm.aero/schema/5.2}CodeTACANChannelType" minOccurs="0"/>
 *         <element name="declination" type="{http://www.aixm.aero/schema/5.2}ValMagneticVariationType" minOccurs="0"/>
 *         <element name="tuningFrequencyVHF" type="{http://www.aixm.aero/schema/5.2}ValFrequencyType" minOccurs="0"/>
 *         <element name="extension" maxOccurs="unbounded" minOccurs="0">
 *           <complexType>
 *             <complexContent>
 *               <restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 <choice>
 *                   <element ref="{http://www.aixm.aero/schema/5.2}AbstractTACANExtension"/>
    ...
    implements Serializable
{
    ...
    protected List<TACANTimeSliceExtensionType> extension;
    ...
    @JoinTable(name = "tacantmslctp_athrt_l", schema = "navaids_point", joinColumns = {
    ...
    @JoinTable(name = "tacantmslctp_mntrng_l", schema = "navaids_point", joinColumns = {
        @JoinColumn(name = "tacan_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "tacantmslctp_avlblt_l", schema = "navaids_point", joinColumns = {
        @JoinColumn(name = "tacan_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "tacantmslctp_annttn_l", schema = "navaids_point", joinColumns = {
        @JoinColumn(name = "tacan_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link TACANTimeSliceExtensionType }
     * 
     * 
     */
    @OneToMany(targetEntity = TACANTimeSliceExtensionType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinColumn(name = "tacan_te_hjid", referencedColumnName = "hjid")
    public List<TACANTimeSliceExtensionType> getExtension() {
        if (extension == null) {
     ...
     * 
     */
    public void setExtension(List<TACANTimeSliceExtensionType> extension) {
    ...
    public void setDesignatorItem(CodeNavaidDesignatorType target) {
        setDesignator(XmlAdapterUtils.marshallJAXBElement(CodeNavaidDesignatorType.class, new QName("http://www.aixm.aero/schema/5.2", "designator"), TACANTimeSliceType.class, target));
    }
    ...
    public void setAixmNameItem(TextNameType target) {
        setAixmName(XmlAdapterUtils.marshallJAXBElement(TextNameType.class, new QName("http://www.aixm.aero/schema/5.2", "name"), TACANTimeSliceType.class, target));
    }
    ...
    public void setEmissionClassItem(CodeRadioEmissionType target) {
        setEmissionClass(XmlAdapterUtils.marshallJAXBElement(CodeRadioEmissionType.class, new QName("http://www.aixm.aero/schema/5.2", "emissionClass"), TACANTimeSliceType.class, target));
    }
    ...
    public void setMobileItem(CodeYesNoType target) {
        setMobile(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.2", "mobile"), TACANTimeSliceType.class, target));
    }
    ...
    public void setMagneticVariationItem(ValMagneticVariationType target) {
        setMagneticVariation(XmlAdapterUtils.marshallJAXBElement(ValMagneticVariationType.class, new QName("http://www.aixm.aero/schema/5.2", "magneticVariation"), TACANTimeSliceType.class, target));
    }
    ...
    public void setDateMagneticVariationItem(DateYearType target) {
        setDateMagneticVariation(XmlAdapterUtils.marshallJAXBElement(DateYearType.class, new QName("http://www.aixm.aero/schema/5.2", "dateMagneticVariation"), TACANTimeSliceType.class, target));
    }
    ...
    public void setFlightCheckedItem(CodeYesNoType target) {
        setFlightChecked(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.2", "flightChecked"), TACANTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = AIXMElevatedPointPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "tacantmslctp_lctn_l", schema = "navaids_point", joinColumns = {
        @JoinColumn(name = "tacan_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setLocationItem(AIXMElevatedPointPropertyType target) {
        setLocation(XmlAdapterUtils.marshallJAXBElement(AIXMElevatedPointPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "location"), TACANTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "channel", columnDefinition = "codetacanchannelbase")),
    ...
    public void setChannelItem(CodeTACANChannelType target) {
        setChannel(XmlAdapterUtils.marshallJAXBElement(CodeTACANChannelType.class, new QName("http://www.aixm.aero/schema/5.2", "channel"), TACANTimeSliceType.class, target));
    }
    ...
    public void setDeclinationItem(ValMagneticVariationType target) {
        setDeclination(XmlAdapterUtils.marshallJAXBElement(ValMagneticVariationType.class, new QName("http://www.aixm.aero/schema/5.2", "declination"), TACANTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "tuningfrequencyvhf", columnDefinition = "valfrequencybase")),
        @AttributeOverride(name = "uom", column = @Column(name = "tuningfrequencyvhfuom", columnDefinition = "uomfrequency")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "tuningfrequencyvhfnilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setTuningFrequencyVHFItem(ValFrequencyType target) {
        setTuningFrequencyVHF(XmlAdapterUtils.marshallJAXBElement(ValFrequencyType.class, new QName("http://www.aixm.aero/schema/5.2", "tuningFrequencyVHF"), TACANTimeSliceType.class, target));
    }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        }
        {
            ...
            List<TACANTimeSliceExtensionType> lhsField;
            lhsField = (this.isSetExtension()?this.getExtension():null);
            List<TACANTimeSliceExtensionType> rhsField;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        }
        {
            ...
            List<TACANTimeSliceExtensionType> theField;
