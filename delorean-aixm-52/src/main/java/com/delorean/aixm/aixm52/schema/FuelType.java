...
/**
 * <p>Java class for FuelType complex type</p>.
 * 
 ...
 *       <sequence>
 *         <element name="category" type="{http://www.aixm.aero/schema/5.2}CodeFuelType" minOccurs="0"/>
    ...
    implements Serializable
{
     ...
     * 
     */
    @OneToMany(targetEntity = FuelExtensionType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    ...
    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "category", columnDefinition = "codefuelbase")),
    ...
    public void setCategoryItem(CodeFuelType target) {
        setCategory(XmlAdapterUtils.marshallJAXBElement(CodeFuelType.class, new QName("http://www.aixm.aero/schema/5.2", "category"), FuelType.class, target));
    }
