 ...
 *         <element name="designGradient" type="{http://www.aixm.aero/schema/5.2}ValSlopeType" minOccurs="0"/>
 *         <element name="terminationAltitude" type="{http://www.aixm.aero/schema/5.2}ValDistanceVerticalType" minOccurs="0"/>
 *         <element name="turnPermitted" type="{http://www.aixm.aero/schema/5.2}CodeYesNoType" minOccurs="0"/>
 ...
 *                 <choice>
 *                   <element ref="{http://www.aixm.aero/schema/5.2}AbstractSectorDesignExtension"/>
 *                 </choice>
    ...
    implements Serializable
{
    ...
    @XmlElementRef(name = "designGradient", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<ValSlopeType> designGradient;
    @XmlElementRef(name = "terminationAltitude", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<ValDistanceVerticalType> terminationAltitude;
    @XmlElementRef(name = "turnPermitted", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
     ...
     * 
     */
    @OneToMany(targetEntity = SectorDesignExtensionType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    ...
    public void setTurnDirectionItem(CodeDirectionTurnType target) {
        setTurnDirection(XmlAdapterUtils.marshallJAXBElement(CodeDirectionTurnType.class, new QName("http://www.aixm.aero/schema/5.2", "turnDirection"), SectorDesignType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "designgradient", columnDefinition = "valslopebase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "designgradientnilreason", columnDefinition = "nilreason")),
        @AttributeOverride(name = "accuracy", column = @Column(name = "designgradientaccuracy", columnDefinition = "numericalwithnilreason"))
    })
    ...
    public void setDesignGradientItem(ValSlopeType target) {
        setDesignGradient(XmlAdapterUtils.marshallJAXBElement(ValSlopeType.class, new QName("http://www.aixm.aero/schema/5.2", "designGradient"), SectorDesignType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "terminationaltitude", columnDefinition = "valdistanceverticalbase")),
        @AttributeOverride(name = "uom", column = @Column(name = "terminationaltitudeuom", columnDefinition = "uomdistancevertical")),
        @AttributeOverride(name = "accuracy", column = @Column(name = "terminationaltitudeaccuracy", columnDefinition = "numericalwithnilreason")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "terminationaltitudenilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setTerminationAltitudeItem(ValDistanceVerticalType target) {
        setTerminationAltitude(XmlAdapterUtils.marshallJAXBElement(ValDistanceVerticalType.class, new QName("http://www.aixm.aero/schema/5.2", "terminationAltitude"), SectorDesignType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "turnpermitted", columnDefinition = "codeyesnobase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "turnpermittednilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setTurnPermittedItem(CodeYesNoType target) {
        setTurnPermitted(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.2", "turnPermitted"), SectorDesignType.class, target));
    }
