 ...
 *       <sequence>
 *         <element ref="{http://www.aixm.aero/schema/5.2}AircraftGroundServiceTimeSlice"/>
 *       </sequence>
...
public class AircraftGroundServiceTimeSlicePropertyType implements Serializable, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        final AircraftGroundServiceTimeSlicePropertyType that = ((AircraftGroundServiceTimeSlicePropertyType) object);
        {
            boolean lhsFieldIsSet = this.isSetAircraftGroundServiceTimeSlice();
            boolean rhsFieldIsSet = that.isSetAircraftGroundServiceTimeSlice();
            AircraftGroundServiceTimeSliceType lhsField;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetAircraftGroundServiceTimeSlice();
            AircraftGroundServiceTimeSliceType theField;
            theField = this.getAircraftGroundServiceTimeSlice();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "aircraftGroundServiceTimeSlice", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            AircraftGroundServiceTimeSliceType theField;
            theField = this.getAircraftGroundServiceTimeSlice();
            strategy.appendField(locator, this, "aircraftGroundServiceTimeSlice", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetOwns();
            boolean theField;
