 ...
 *         <element name="markingLocation" type="{http://www.aixm.aero/schema/5.2}CodeTLOFSectionType" minOccurs="0"/>
 *         <element name="markedTouchDownLiftOff" type="{http://www.aixm.aero/schema/5.2}TouchDownLiftOffPropertyType" minOccurs="0"/>
 *         <element name="extension" maxOccurs="unbounded" minOccurs="0">
 *           <complexType>
 *             <complexContent>
 *               <restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 <choice>
 *                   <element ref="{http://www.aixm.aero/schema/5.2}AbstractTouchDownLiftOffMarkingExtension"/>
...
@Table(name = "touchdownliftoffmarking_t", schema = "airport_heliport")
    ...
    implements Serializable
{
    ...
    @XmlElementRef(name = "markedTouchDownLiftOff", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<TouchDownLiftOffPropertyType> markedTouchDownLiftOff;
    protected List<TouchDownLiftOffMarkingTimeSliceExtensionType> extension;
    ...
    @JoinTable(name = "tchdwnlftoffmrkngtmslctp_elmnt_link", schema = "airport_heliport", joinColumns = {
        @JoinColumn(name = "touchdownliftoffmarking_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "tchdwnlftoffmrkngtmslctp_annttn_link", schema = "airport_heliport", joinColumns = {
        @JoinColumn(name = "touchdownliftoffmarking_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
     ...
     * 
     */
    @OneToMany(targetEntity = TouchDownLiftOffMarkingTimeSliceExtensionType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinColumn(name = "touchdownliftoffmarking_te_hjid", referencedColumnName = "hjid")
    public List<TouchDownLiftOffMarkingTimeSliceExtensionType> getExtension() {
        if (extension == null) {
     ...
     * 
     */
    public void setExtension(List<TouchDownLiftOffMarkingTimeSliceExtensionType> extension) {
    ...
    public void setMarkingICAOStandardItem(CodeYesNoType target) {
        setMarkingICAOStandard(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.2", "markingICAOStandard"), TouchDownLiftOffMarkingTimeSliceType.class, target));
    }
    ...
    public void setConditionItem(CodeMarkingConditionType target) {
        setCondition(XmlAdapterUtils.marshallJAXBElement(CodeMarkingConditionType.class, new QName("http://www.aixm.aero/schema/5.2", "condition"), TouchDownLiftOffMarkingTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "markinglocation", columnDefinition = "codetlofsectionbase")),
    ...
    public void setMarkingLocationItem(CodeTLOFSectionType target) {
        setMarkingLocation(XmlAdapterUtils.marshallJAXBElement(CodeTLOFSectionType.class, new QName("http://www.aixm.aero/schema/5.2", "markingLocation"), TouchDownLiftOffMarkingTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = TouchDownLiftOffPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "tchdwnlftoffmrkngtmslctp_mrkdtchdwnlftoff_link", schema = "airport_heliport", joinColumns = {
        @JoinColumn(name = "touchdownliftoffmarking_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
        @JoinColumn(name = "markedtouchdownliftoff_hjid", referencedColumnName = "hjid")
    })
    ...
    public void setMarkedTouchDownLiftOffItem(TouchDownLiftOffPropertyType target) {
        setMarkedTouchDownLiftOff(XmlAdapterUtils.marshallJAXBElement(TouchDownLiftOffPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "markedTouchDownLiftOff"), TouchDownLiftOffMarkingTimeSliceType.class, target));
    }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        }
        {
            ...
            List<TouchDownLiftOffMarkingTimeSliceExtensionType> lhsField;
            lhsField = (this.isSetExtension()?this.getExtension():null);
            List<TouchDownLiftOffMarkingTimeSliceExtensionType> rhsField;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        }
        {
            ...
            List<TouchDownLiftOffMarkingTimeSliceExtensionType> theField;
