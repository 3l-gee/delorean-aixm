...
/**
 * <p>Java class for RunwayVisualRangeEquipmentTimeSliceType complex type</p>.
 * 
 ...
 *       <sequence>
 *         <element name="readingPosition" type="{http://www.aixm.aero/schema/5.2}CodeRVRReadingType" minOccurs="0"/>
 *         <element name="location" type="{http://www.aixm.aero/schema/5.2}ElevatedPointPropertyType" minOccurs="0"/>
 *         <element name="associatedRunwayDirection" type="{http://www.aixm.aero/schema/5.2}RunwayDirectionPropertyType" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "RunwayVisualRangeEquipmentTimeSliceType", propOrder = {
    "readingPosition",
    "location",
...
public class RunwayVisualRangeEquipmentTimeSliceType
    ...
    implements Serializable
{
    ...
    @JoinTable(name = "rnwvslrngeqpmnttmslctp_assctdrnwdrctn_l", schema = "airport_heliport", joinColumns = {
        @JoinColumn(name = "runwayvisualrangeequipment_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "rnwvslrngeqpmnttmslctp_annttn_l", schema = "airport_heliport", joinColumns = {
        @JoinColumn(name = "runwayvisualrangeequipment_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setReadingPositionItem(CodeRVRReadingType target) {
        setReadingPosition(XmlAdapterUtils.marshallJAXBElement(CodeRVRReadingType.class, new QName("http://www.aixm.aero/schema/5.2", "readingPosition"), RunwayVisualRangeEquipmentTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = AIXMElevatedPointPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "rnwvslrngeqpmnttmslctp_lctn_l", schema = "airport_heliport", joinColumns = {
        @JoinColumn(name = "runwayvisualrangeequipment_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setLocationItem(AIXMElevatedPointPropertyType target) {
        setLocation(XmlAdapterUtils.marshallJAXBElement(AIXMElevatedPointPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "location"), RunwayVisualRangeEquipmentTimeSliceType.class, target));
    }
