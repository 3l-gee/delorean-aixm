...
/**
 * <p>
 * Java class for AltitudeAdjustmentPropertyType complex type
 * </p>
 * .
 *
 * <p>
 ...
 *       <sequence>
 *         <element ref="{http://www.aixm.aero/schema/5.2}AltitudeAdjustment"/>
 *       </sequence>
 *     </extension>
 *   </complexContent>
 * </complexType>
...
@XmlType(name = "AltitudeAdjustmentPropertyType", propOrder = {"altitudeAdjustment"})
@Entity(name = "AltitudeAdjustmentPropertyType")
@Table(name = "altitudeadjustmentpropertytype", schema = "shared")
public class AltitudeAdjustmentPropertyType extends AbstractAIXMPropertyType implements Serializable {
     ...
     *
     * @return possible object is {@link AltitudeAdjustmentType }
     *
     */
    @OneToOne(targetEntity = AltitudeAdjustmentType.class, cascade = {CascadeType.ALL}, fetch = FetchType.EAGER)
     ...
     *
     * @param value
     *            allowed object is {@link AltitudeAdjustmentType }
     *
     */
