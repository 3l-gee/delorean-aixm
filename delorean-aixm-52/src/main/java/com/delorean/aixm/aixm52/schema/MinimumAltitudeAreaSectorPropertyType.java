...
/**
 * <p>
 * Java class for MinimumAltitudeAreaSectorPropertyType complex type
 * </p>
 * .
 *
 * <p>
 ...
 *       <sequence>
 *         <element ref=
"{http://www.aixm.aero/schema/5.2}MinimumAltitudeAreaSector"/>
 *       </sequence>
 *     </extension>
 *   </complexContent>
 * </complexType>
...
@XmlType(name = "MinimumAltitudeAreaSectorPropertyType", propOrder = {"minimumAltitudeAreaSector"})
@Entity(name = "MinimumAltitudeAreaSectorPropertyType")
@Table(name = "minimumaltitudeareasectorpropertytype", schema = "procedure")
public class MinimumAltitudeAreaSectorPropertyType extends AbstractAIXMPropertyType implements Serializable {
     ...
     *
     * @return possible object is {@link MinimumAltitudeAreaSectorType }
     *
     */
    @OneToOne(targetEntity = MinimumAltitudeAreaSectorType.class, cascade = {CascadeType.ALL}, fetch = FetchType.EAGER)
     ...
     *
     * @param value
     *            allowed object is {@link MinimumAltitudeAreaSectorType }
     *
     */
