 ...
 *         <element name="usage" type="{http://www.aixm.aero/schema/5.2}ManoeuvringAreaUsagePropertyType" maxOccurs="unbounded" minOccurs="0"/>
 ...
 *                   <element ref="{http://www.aixm.aero/schema/5.2}AbstractManoeuvringAreaAvailabilityExtension"/>
 *                 </choice>
    ...
    implements Serializable
{
    ...
    public void setOperationalStatusItem(CodeStatusAirportType target) {
        setOperationalStatus(XmlAdapterUtils.marshallJAXBElement(CodeStatusAirportType.class, new QName("http://www.aixm.aero/schema/5.2", "operationalStatus"), ManoeuvringAreaAvailabilityType.class, target));
    }
    ...
    public void setWarningItem(CodeAirportWarningType target) {
        setWarning(XmlAdapterUtils.marshallJAXBElement(CodeAirportWarningType.class, new QName("http://www.aixm.aero/schema/5.2", "warning"), ManoeuvringAreaAvailabilityType.class, target));
    }
