...
"{http://www.aixm.aero/schema/5.2}ManoeuvringAreaUsagePropertyType" maxOccurs=
"unbounded" minOccurs="0"/>
 ...
 *                   <element ref=
"{http://www.aixm.aero/schema/5.2}AbstractManoeuvringAreaAvailabilityExtension"/>
 *                 </choice>
 *                 <attGroup ref=
...
public class ManoeuvringAreaAvailabilityType extends AbstractPropertiesWithScheduleType implements Serializable {
    ...
    public void setWarningItem(CodeAirportWarningType target) {
        setWarning(XmlAdapterUtils.marshallJAXBElement(CodeAirportWarningType.class,
                new QName("http://www.aixm.aero/schema/5.2", "warning"), ManoeuvringAreaAvailabilityType.class,
                target));
    }
