 ...
 *       <sequence>
 *         <element ref="{http://www.aixm.aero/schema/5.2}PrimarySurveillanceRadarTimeSlice"/>
 *       </sequence>
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            PrimarySurveillanceRadarTimeSliceType theField;
            theField = this.getPrimarySurveillanceRadarTimeSlice();
            strategy.appendField(locator, this, "primarySurveillanceRadarTimeSlice", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetOwns();
            boolean theField;
