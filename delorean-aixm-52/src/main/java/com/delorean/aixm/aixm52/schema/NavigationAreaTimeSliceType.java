 ...
 *       <sequence>
 *         <element name="navigationAreaType" type="{http://www.aixm.aero/schema/5.2}CodeNavigationAreaType" minOccurs="0"/>
 *         <element name="minimumCeiling" type="{http://www.aixm.aero/schema/5.2}ValDistanceVerticalType" minOccurs="0"/>
 *         <element name="minimumVisibility" type="{http://www.aixm.aero/schema/5.2}ValDistanceType" minOccurs="0"/>
 *         <element name="departure" type="{http://www.aixm.aero/schema/5.2}StandardInstrumentDeparturePropertyType" minOccurs="0"/>
 *         <element name="sector" type="{http://www.aixm.aero/schema/5.2}NavigationAreaSectorPropertyType" maxOccurs="unbounded" minOccurs="0"/>
 *         <choice>
 *           <element name="centrePoint_fixDesignatedPoint" type="{http://www.aixm.aero/schema/5.2}DesignatedPointPropertyType" minOccurs="0"/>
 *           <element name="centrePoint_navaidSystem" type="{http://www.aixm.aero/schema/5.2}NavaidPropertyType" minOccurs="0"/>
 *           <element name="centrePoint_position" type="{http://www.aixm.aero/schema/5.2}PointPropertyType" minOccurs="0"/>
 *           <element name="centrePoint_runwayPoint" type="{http://www.aixm.aero/schema/5.2}RunwayCentrelinePointPropertyType" minOccurs="0"/>
 *           <element name="centrePoint_aimingPoint" type="{http://www.aixm.aero/schema/5.2}TouchDownLiftOffPropertyType" minOccurs="0"/>
 *           <element name="centrePoint_airportReferencePoint" type="{http://www.aixm.aero/schema/5.2}AirportHeliportPropertyType" minOccurs="0"/>
 *         </choice>
 ...
 *                 <sequence>
 *                   <element ref="{http://www.aixm.aero/schema/5.2}AbstractNavigationAreaExtension"/>
 *                 </sequence>
...
@Table(name = "navigationarea_t", schema = "procedure")
    ...
    implements Serializable
{
    ...
    @XmlElementRef(name = "navigationAreaType", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<CodeNavigationAreaType> navigationAreaType;
    @XmlElementRef(name = "minimumCeiling", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<ValDistanceVerticalType> minimumCeiling;
    @XmlElementRef(name = "minimumVisibility", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    ...
    protected List<NavigationAreaTimeSliceExtensionType> extension;
     ...
     * 
     */
    @OneToMany(targetEntity = NavigationAreaSectorPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "nvgtnartmslctp_sctr_link", schema = "procedure", joinColumns = {
        @JoinColumn(name = "navigationarea_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "nvgtnartmslctp_annttn_link", schema = "procedure", joinColumns = {
        @JoinColumn(name = "navigationarea_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link NavigationAreaTimeSliceExtensionType }
     * 
     * 
     */
    @OneToMany(targetEntity = NavigationAreaTimeSliceExtensionType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinColumn(name = "navigationarea_te_hjid", referencedColumnName = "hjid")
    public List<NavigationAreaTimeSliceExtensionType> getExtension() {
        if (extension == null) {
     ...
     * 
     */
    public void setExtension(List<NavigationAreaTimeSliceExtensionType> extension) {
    ...
    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "navigationareatype", columnDefinition = "codenavigationareabase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "navigationareatypenilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setNavigationAreaTypeItem(CodeNavigationAreaType target) {
        setNavigationAreaType(XmlAdapterUtils.marshallJAXBElement(CodeNavigationAreaType.class, new QName("http://www.aixm.aero/schema/5.2", "navigationAreaType"), NavigationAreaTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "minimumceiling", columnDefinition = "valdistanceverticalbase")),
        @AttributeOverride(name = "uom", column = @Column(name = "minimumceilinguom", columnDefinition = "uomdistancevertical")),
        @AttributeOverride(name = "accuracy", column = @Column(name = "minimumceilingaccuracy", columnDefinition = "numericalwithnilreason")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "minimumceilingnilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setMinimumCeilingItem(ValDistanceVerticalType target) {
        setMinimumCeiling(XmlAdapterUtils.marshallJAXBElement(ValDistanceVerticalType.class, new QName("http://www.aixm.aero/schema/5.2", "minimumCeiling"), NavigationAreaTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "minimumvisibility", columnDefinition = "valdistancebase")),
        @AttributeOverride(name = "uom", column = @Column(name = "minimumvisibilityuom", columnDefinition = "uomdistance")),
        @AttributeOverride(name = "accuracy", column = @Column(name = "minimumvisibilityaccuracy", columnDefinition = "numericalwithnilreason")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "minimumvisibilitynilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setMinimumVisibilityItem(ValDistanceType target) {
        setMinimumVisibility(XmlAdapterUtils.marshallJAXBElement(ValDistanceType.class, new QName("http://www.aixm.aero/schema/5.2", "minimumVisibility"), NavigationAreaTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = StandardInstrumentDeparturePropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "nvgtnartmslctp_dprtr_link", schema = "procedure", joinColumns = {
        @JoinColumn(name = "navigationarea_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setDepartureItem(StandardInstrumentDeparturePropertyType target) {
        setDeparture(XmlAdapterUtils.marshallJAXBElement(StandardInstrumentDeparturePropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "departure"), NavigationAreaTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = DesignatedPointPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "nvgtnartmslctp_cntrpntfxdsgntdpnt_link", schema = "procedure", joinColumns = {
        @JoinColumn(name = "navigationarea_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setCentrePointFixDesignatedPointItem(DesignatedPointPropertyType target) {
        setCentrePointFixDesignatedPoint(XmlAdapterUtils.marshallJAXBElement(DesignatedPointPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "centrePoint_fixDesignatedPoint"), NavigationAreaTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = NavaidPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "nvgtnartmslctp_cntrpntnvdsstm_link", schema = "procedure", joinColumns = {
        @JoinColumn(name = "navigationarea_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setCentrePointNavaidSystemItem(NavaidPropertyType target) {
        setCentrePointNavaidSystem(XmlAdapterUtils.marshallJAXBElement(NavaidPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "centrePoint_navaidSystem"), NavigationAreaTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = AIXMPointPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "nvgtnartmslctp_cntrpntpstn_link", schema = "procedure", joinColumns = {
        @JoinColumn(name = "navigationarea_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setCentrePointPositionItem(AIXMPointPropertyType target) {
        setCentrePointPosition(XmlAdapterUtils.marshallJAXBElement(AIXMPointPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "centrePoint_position"), NavigationAreaTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = RunwayCentrelinePointPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "nvgtnartmslctp_cntrpntrnwpnt_link", schema = "procedure", joinColumns = {
        @JoinColumn(name = "navigationarea_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setCentrePointRunwayPointItem(RunwayCentrelinePointPropertyType target) {
        setCentrePointRunwayPoint(XmlAdapterUtils.marshallJAXBElement(RunwayCentrelinePointPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "centrePoint_runwayPoint"), NavigationAreaTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = TouchDownLiftOffPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "nvgtnartmslctp_cntrpntamngpnt_link", schema = "procedure", joinColumns = {
        @JoinColumn(name = "navigationarea_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setCentrePointAimingPointItem(TouchDownLiftOffPropertyType target) {
        setCentrePointAimingPoint(XmlAdapterUtils.marshallJAXBElement(TouchDownLiftOffPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "centrePoint_aimingPoint"), NavigationAreaTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = AirportHeliportPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "nvgtnartmslctp_cntrpntarprtrfrncpnt_link", schema = "procedure", joinColumns = {
        @JoinColumn(name = "navigationarea_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setCentrePointAirportReferencePointItem(AirportHeliportPropertyType target) {
        setCentrePointAirportReferencePoint(XmlAdapterUtils.marshallJAXBElement(AirportHeliportPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "centrePoint_airportReferencePoint"), NavigationAreaTimeSliceType.class, target));
    }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        }
        {
            ...
            List<NavigationAreaTimeSliceExtensionType> lhsField;
            lhsField = (this.isSetExtension()?this.getExtension():null);
            List<NavigationAreaTimeSliceExtensionType> rhsField;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        }
        {
            ...
            List<NavigationAreaTimeSliceExtensionType> theField;
