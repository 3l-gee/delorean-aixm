...
/**
 * <p>Java class for WeatherSourcePropertyType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="WeatherSourcePropertyType">
 *   <complexContent>
...
@XmlType(name = "WeatherSourcePropertyType")
@Entity(name = "WeatherSourcePropertyType")
@Table(name = "weathersource_p", schema = "airport_heliport")
public class WeatherSourcePropertyType implements Serializable, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        final WeatherSourcePropertyType that = ((WeatherSourcePropertyType) object);
        {
