 ...
 *         <element name="direction" type="{http://www.aixm.aero/schema/5.2}CodeRouteDirectionType" minOccurs="0"/>
 *         <element name="cardinalDirection" type="{http://www.aixm.aero/schema/5.2}CodeCardinalDirectionType" minOccurs="0"/>
 *         <element name="status" type="{http://www.aixm.aero/schema/5.2}CodeRouteAvailabilityType" minOccurs="0"/>
 ...
 *                   <element ref="{http://www.aixm.aero/schema/5.2}AbstractRouteAvailabilityExtension"/>
 *                 </choice>
    ...
    implements Serializable
{
    ...
    protected JAXBElement<CodeRouteDirectionType> direction;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link CodeRouteDirectionType }{@code >}
     *     
     */
    @Transient
    public JAXBElement<CodeRouteDirectionType> getDirection() {
        return direction;
    }
     ...
     *     
     */
    public void setDirection(JAXBElement<CodeRouteDirectionType> value) {
    ...
    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "direction", columnDefinition = "coderoutedirectionbase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "directionnilreason", columnDefinition = "nilreason"))
    })
    public CodeRouteDirectionType getDirectionItem() {
        return XmlAdapterUtils.unmarshallSource(CodeRouteDirectionType.class, this.getDirection());
    }

    public void setDirectionItem(CodeRouteDirectionType target) {
        setDirection(XmlAdapterUtils.marshallJAXBElement(CodeRouteDirectionType.class, new QName("http://www.aixm.aero/schema/5.2", "direction"), RouteAvailabilityType.class, target));
    }
    ...
    public void setCardinalDirectionItem(CodeCardinalDirectionType target) {
        setCardinalDirection(XmlAdapterUtils.marshallJAXBElement(CodeCardinalDirectionType.class, new QName("http://www.aixm.aero/schema/5.2", "cardinalDirection"), RouteAvailabilityType.class, target));
    }
    ...
    public void setStatusItem(CodeRouteAvailabilityType target) {
        setStatus(XmlAdapterUtils.marshallJAXBElement(CodeRouteAvailabilityType.class, new QName("http://www.aixm.aero/schema/5.2", "status"), RouteAvailabilityType.class, target));
    }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        }
        {
            ...
            JAXBElement<CodeRouteDirectionType> theField;
