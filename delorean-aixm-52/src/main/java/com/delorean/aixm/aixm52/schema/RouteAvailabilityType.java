...
"{http://www.aixm.aero/schema/5.2}CodeRouteDirectionType" minOccurs="0"/>
...
"{http://www.aixm.aero/schema/5.2}CodeRouteAvailabilityType" minOccurs="0"/>
 ...
 *                   <element ref=
"{http://www.aixm.aero/schema/5.2}AbstractRouteAvailabilityExtension"/>
 *                 </choice>
 *                 <attGroup ref=
...
public class RouteAvailabilityType extends AbstractPropertiesWithScheduleType implements Serializable {
     ...
     *         }{@code <}{@link CodeRouteDirectionType }{@code >}
     *
     */
    @Transient
    ...
    public void setDirectionItem(CodeRouteDirectionType target) {
        setDirection(XmlAdapterUtils.marshallJAXBElement(CodeRouteDirectionType.class,
                new QName("http://www.aixm.aero/schema/5.2", "direction"), RouteAvailabilityType.class, target));
    }
    ...
    public void setCardinalDirectionItem(CodeCardinalDirectionType target) {
        setCardinalDirection(XmlAdapterUtils.marshallJAXBElement(CodeCardinalDirectionType.class,
                new QName("http://www.aixm.aero/schema/5.2", "cardinalDirection"), RouteAvailabilityType.class,
                target));
    }
    ...
    public void setStatusItem(CodeRouteAvailabilityType target) {
        setStatus(XmlAdapterUtils.marshallJAXBElement(CodeRouteAvailabilityType.class,
                new QName("http://www.aixm.aero/schema/5.2", "status"), RouteAvailabilityType.class, target));
    }
