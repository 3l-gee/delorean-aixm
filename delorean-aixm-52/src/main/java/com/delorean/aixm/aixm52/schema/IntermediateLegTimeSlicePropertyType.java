 ...
 *       <sequence>
 *         <element ref="{http://www.aixm.aero/schema/5.2}IntermediateLegTimeSlice"/>
 *       </sequence>
...
public class IntermediateLegTimeSlicePropertyType implements Serializable, Equals, HashCode, ToString
{
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetIntermediateLegTimeSlice();
            IntermediateLegTimeSliceType theField;
            theField = this.getIntermediateLegTimeSlice();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "intermediateLegTimeSlice", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            IntermediateLegTimeSliceType theField;
            theField = this.getIntermediateLegTimeSlice();
            strategy.appendField(locator, this, "intermediateLegTimeSlice", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetOwns();
            boolean theField;
