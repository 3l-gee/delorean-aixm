...
/**
 * <p>
 * Java class for GangwayType complex type
 * </p>
 * .
 *
 * <p>
 ...
 *
 * <pre>{@code
 * <complexType name="GangwayType">
 *   <complexContent>
 *     <extension base=
"{http://www.aixm.aero/schema/5.2}AbstractAIXMFeatureType">
 *       <sequence>
 *         <element name="timeSlice" type=
"{http://www.aixm.aero/schema/5.2}GangwayTimeSlicePropertyType" maxOccurs=
"unbounded"/>
 *       </sequence>
 *     </extension>
 *   </complexContent>
...
@XmlType(name = "GangwayType", propOrder = {"timeSlice"})
@Entity(name = "GangwayType")
@Table(name = "gangway_f", schema = "airport_heliport")
public class GangwayType extends AbstractAIXMFeatureType implements Serializable {

    private static final long serialVersionUID = 20251104L;
    @XmlElement(required = true)
    protected List<GangwayTimeSlicePropertyType> timeSlice;
     ...
     * {@link GangwayTimeSlicePropertyType }
     *
     *
     */
    @Filter(name = "TPHjidFilter", condition = "hjid IN (:ids)")
    @OneToMany(targetEntity = GangwayTimeSlicePropertyType.class, cascade = {CascadeType.ALL}, fetch = FetchType.EAGER)
    @JoinColumn(name = "timeslice_hjid", referencedColumnName = "hjid")
    public List<GangwayTimeSlicePropertyType> getTimeSlice() {
        if (timeSlice == null) {
     ...
     *
     */
    public void setTimeSlice(List<GangwayTimeSlicePropertyType> timeSlice) {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = super.hashCode(locator, strategy);
        {
            ...
            List<GangwayTimeSlicePropertyType> theField;
