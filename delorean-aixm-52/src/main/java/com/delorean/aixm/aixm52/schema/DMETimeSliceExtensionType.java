...
@XmlType(name = "", propOrder = {"abstractDMEExtension", "abstractNavaidEquipmentExtension"})
@Entity(name = "DMETimeSliceExtensionType")
@Table(name = "dme_te", schema = "navaids_point")
public class DMETimeSliceExtensionType implements Serializable, Equals, HashCode, ToString {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetAbstractDMEExtension();
            AbstractExtensionType theField;
            theField = this.getAbstractDMEExtension();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "abstractDMEExtension", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            AbstractExtensionType theField;
            theField = this.getAbstractDMEExtension();
            strategy.appendField(locator, this, "abstractDMEExtension", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetAbstractNavaidEquipmentExtension();
            AbstractExtensionType theField;
