 ...
 *         <element name="location" type="{http://www.aixm.aero/schema/5.2}AircraftStandPropertyType" minOccurs="0"/>
 *         <element name="extension" maxOccurs="unbounded" minOccurs="0">
 *           <complexType>
 *             <complexContent>
 *               <restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 <choice>
 *                   <element ref="{http://www.aixm.aero/schema/5.2}AbstractCheckpointINSExtension"/>
    ...
    implements Serializable
{
    ...
    protected JAXBElement<AircraftStandPropertyType> location;
    ...
    @JoinTable(name = "chckpntinstmslctp_annttn_l", schema = "navaids_point", joinColumns = {
     ...
     */
    @Transient
    public JAXBElement<AircraftStandPropertyType> getLocation() {
        return location;
    }
     ...
     *     
     */
    public void setLocation(JAXBElement<AircraftStandPropertyType> value) {
        this.location = value;
    }
    ...
    public void setCategoryItem(CodeCheckpointCategoryType target) {
        setCategory(XmlAdapterUtils.marshallJAXBElement(CodeCheckpointCategoryType.class, new QName("http://www.aixm.aero/schema/5.2", "category"), CheckpointINSTimeSliceType.class, target));
    }
    ...
    public void setUpperLimitItem(ValDistanceVerticalType target) {
        setUpperLimit(XmlAdapterUtils.marshallJAXBElement(ValDistanceVerticalType.class, new QName("http://www.aixm.aero/schema/5.2", "upperLimit"), CheckpointINSTimeSliceType.class, target));
    }
    ...
    public void setUpperLimitReferenceItem(CodeVerticalReferenceType target) {
        setUpperLimitReference(XmlAdapterUtils.marshallJAXBElement(CodeVerticalReferenceType.class, new QName("http://www.aixm.aero/schema/5.2", "upperLimitReference"), CheckpointINSTimeSliceType.class, target));
    }
    ...
    public void setLowerLimitItem(ValDistanceVerticalType target) {
        setLowerLimit(XmlAdapterUtils.marshallJAXBElement(ValDistanceVerticalType.class, new QName("http://www.aixm.aero/schema/5.2", "lowerLimit"), CheckpointINSTimeSliceType.class, target));
    }
    ...
    public void setLowerLimitReferenceItem(CodeVerticalReferenceType target) {
        setLowerLimitReference(XmlAdapterUtils.marshallJAXBElement(CodeVerticalReferenceType.class, new QName("http://www.aixm.aero/schema/5.2", "lowerLimitReference"), CheckpointINSTimeSliceType.class, target));
    }
    ...
    public void setAltitudeInterpretationItem(CodeAltitudeUseType target) {
        setAltitudeInterpretation(XmlAdapterUtils.marshallJAXBElement(CodeAltitudeUseType.class, new QName("http://www.aixm.aero/schema/5.2", "altitudeInterpretation"), CheckpointINSTimeSliceType.class, target));
    }
    ...
    public void setDistanceItem(ValDistanceType target) {
        setDistance(XmlAdapterUtils.marshallJAXBElement(ValDistanceType.class, new QName("http://www.aixm.aero/schema/5.2", "distance"), CheckpointINSTimeSliceType.class, target));
    }
    ...
    public void setAngleItem(ValBearingType target) {
        setAngle(XmlAdapterUtils.marshallJAXBElement(ValBearingType.class, new QName("http://www.aixm.aero/schema/5.2", "angle"), CheckpointINSTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = AIXMElevatedPointPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "chckpntinstmslctp_pstn_l", schema = "navaids_point", joinColumns = {
        @JoinColumn(name = "checkpointins_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setPositionItem(AIXMElevatedPointPropertyType target) {
        setPosition(XmlAdapterUtils.marshallJAXBElement(AIXMElevatedPointPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "position"), CheckpointINSTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = AirportHeliportPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "chckpntinstmslctp_arprthlprt_l", schema = "navaids_point", joinColumns = {
        @JoinColumn(name = "checkpointins_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setAirportHeliportItem(AirportHeliportPropertyType target) {
        setAirportHeliport(XmlAdapterUtils.marshallJAXBElement(AirportHeliportPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "airportHeliport"), CheckpointINSTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = AircraftStandPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "chckpntinstmslctp_lctn_l", schema = "navaids_point", joinColumns = {
        @JoinColumn(name = "checkpointins_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
        @JoinColumn(name = "location_hjid", referencedColumnName = "hjid")
    })
    public AircraftStandPropertyType getLocationItem() {
        return XmlAdapterUtils.unmarshallSource(AircraftStandPropertyType.class, this.getLocation());
    }

    public void setLocationItem(AircraftStandPropertyType target) {
        setLocation(XmlAdapterUtils.marshallJAXBElement(AircraftStandPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "location"), CheckpointINSTimeSliceType.class, target));
    }
