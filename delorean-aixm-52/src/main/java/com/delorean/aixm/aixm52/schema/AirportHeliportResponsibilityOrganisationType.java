 ...
 *         <element name="role" type="{http://www.aixm.aero/schema/5.2}CodeAuthorityRoleType" minOccurs="0"/>
 ...
 *                   <element ref="{http://www.aixm.aero/schema/5.2}AbstractAirportHeliportResponsibilityOrganisationExtension"/>
 *                 </choice>
    ...
    implements Serializable
{
    ...
    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "role", columnDefinition = "codeauthorityrolebase")),
    ...
    public void setRoleItem(CodeAuthorityRoleType target) {
        setRole(XmlAdapterUtils.marshallJAXBElement(CodeAuthorityRoleType.class, new QName("http://www.aixm.aero/schema/5.2", "role"), AirportHeliportResponsibilityOrganisationType.class, target));
    }
    ...
    public void setTheOrganisationAuthorityItem(OrganisationAuthorityPropertyType target) {
        setTheOrganisationAuthority(XmlAdapterUtils.marshallJAXBElement(OrganisationAuthorityPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "theOrganisationAuthority"), AirportHeliportResponsibilityOrganisationType.class, target));
    }
