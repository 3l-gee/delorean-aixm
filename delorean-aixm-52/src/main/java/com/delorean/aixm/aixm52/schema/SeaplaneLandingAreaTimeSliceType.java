 ...
 *       <sequence>
 *         <element name="rampSite" type="{http://www.aixm.aero/schema/5.2}SeaplaneRampSitePropertyType" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="dockSite" type="{http://www.aixm.aero/schema/5.2}FloatingDockSitePropertyType" maxOccurs="unbounded" minOccurs="0"/>
 ...
 *         <element name="assignedGangway" type="{http://www.aixm.aero/schema/5.2}GangwayPropertyType" maxOccurs="unbounded" minOccurs="0"/>
 ...
 *                 <sequence>
 *                   <element ref="{http://www.aixm.aero/schema/5.2}AbstractSeaplaneLandingAreaExtension"/>
 *                 </sequence>
    ...
    implements Serializable
{
    ...
    @XmlElement(nillable = true)
    protected List<GangwayPropertyType> assignedGangway;
    ...
    protected List<SeaplaneLandingAreaTimeSliceExtensionType> extension;
    ...
    /**
     * Gets the value of the assignedGangway property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the assignedGangway property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getAssignedGangway().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link GangwayPropertyType }
     * 
     * 
     */
    ...
    public List<GangwayPropertyType> getAssignedGangway() {
        if (assignedGangway == null) {
            assignedGangway = new ArrayList<>();
        }
        return this.assignedGangway;
    }
     ...
     * 
     */
    public void setAssignedGangway(List<GangwayPropertyType> assignedGangway) {
        this.assignedGangway = assignedGangway;
    }

    @Transient
    public boolean isSetAssignedGangway() {
        return ((this.assignedGangway!= null)&&(!this.assignedGangway.isEmpty()));
    }

    public void unsetAssignedGangway() {
        this.assignedGangway = null;
    }
    ...
    public void setExtentItem(AIXMElevatedSurfacePropertyType target) {
        setExtent(XmlAdapterUtils.marshallJAXBElement(AIXMElevatedSurfacePropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "extent"), SeaplaneLandingAreaTimeSliceType.class, target));
    }
    ...
    public void setAssociatedAirportHeliportItem(AirportHeliportPropertyType target) {
        setAssociatedAirportHeliport(XmlAdapterUtils.marshallJAXBElement(AirportHeliportPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "associatedAirportHeliport"), SeaplaneLandingAreaTimeSliceType.class, target));
    }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetAssignedGangway();
            List<GangwayPropertyType> theField;
            theField = (this.isSetAssignedGangway()?this.getAssignedGangway():null);
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "assignedGangway", theField);
            currentHashCode = strategy.hashCode(theFieldLocator, currentHashCode, theField, theFieldIsSet);
        }
        {
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        }
        {
            ...
            List<GangwayPropertyType> theField;
            theField = (this.isSetAssignedGangway()?this.getAssignedGangway():null);
            strategy.appendField(locator, this, "assignedGangway", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetAssociatedAirportHeliport();
            JAXBElement<AirportHeliportPropertyType> theField;
