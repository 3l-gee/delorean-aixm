...
@Entity(name = "AircraftGroundServiceTimeSliceExtensionType")
@Table(name = "aircraftgroundservice_te", schema = "service")
public class AircraftGroundServiceTimeSliceExtensionType implements Serializable, Equals, HashCode, ToString
{
    ...
    @JoinColumn(name = "abstractaircraftgroundserviceextension_hjid", referencedColumnName = "hjid")
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        final AircraftGroundServiceTimeSliceExtensionType that = ((AircraftGroundServiceTimeSliceExtensionType) object);
        {
