...
/**
 * <p>
 * Java class for RunwayType complex type
 * </p>
 * .
 *
 * <p>
...
"{http://www.aixm.aero/schema/5.2}RunwayTimeSlicePropertyType" maxOccurs=
"unbounded"/>
 *       </sequence>
 *     </extension>
 *   </complexContent>
...
@XmlType(name = "RunwayType", propOrder = {"timeSlice"})
@Entity(name = "RunwayType")
@Table(name = "runway_f", schema = "airport_heliport")
public class RunwayType extends AbstractAIXMFeatureType implements Serializable {
    ...
    @OneToMany(targetEntity = RunwayTimeSlicePropertyType.class, cascade = {CascadeType.ALL}, fetch = FetchType.EAGER)
     ...
     *
     */
    public void setTimeSlice(List<RunwayTimeSlicePropertyType> timeSlice) {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = super.hashCode(locator, strategy);
        {
            ...
            List<RunwayTimeSlicePropertyType> theField;
