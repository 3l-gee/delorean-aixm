...
/**
 * <p>Java class for WeatherSourceAvailabilityType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="WeatherSourceAvailabilityType">
 *   <complexContent>
...
@XmlType(name = "WeatherSourceAvailabilityType", propOrder = {
    "timeInterval",
    "annotation",
...
@Entity(name = "WeatherSourceAvailabilityType")
@Table(name = "weathersourceavailability_o", schema = "airport_heliport")
public class WeatherSourceAvailabilityType
    ...
    implements Serializable
{
    ...
    @JoinTable(name = "wthrsrcavlblttp_tmintrvl_link", schema = "airport_heliport", joinColumns = {
        @JoinColumn(name = "weathersourceavailability_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "wthrsrcavlblttp_annttn_link", schema = "airport_heliport", joinColumns = {
        @JoinColumn(name = "weathersourceavailability_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "wthrsrcavlblttp_spcldtathrt_link", schema = "airport_heliport", joinColumns = {
        @JoinColumn(name = "weathersourceavailability_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setOperationalStatusItem(CodeStatusServiceType target) {
        setOperationalStatus(XmlAdapterUtils.marshallJAXBElement(CodeStatusServiceType.class, new QName("http://www.aixm.aero/schema/5.2", "operationalStatus"), WeatherSourceAvailabilityType.class, target));
    }
