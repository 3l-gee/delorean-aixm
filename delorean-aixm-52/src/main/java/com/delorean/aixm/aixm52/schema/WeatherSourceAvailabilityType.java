...
/**
 * <p>
 * Java class for WeatherSourceAvailabilityType complex type
 * </p>
 * .
 *
 * <p>
...
@XmlType(name = "WeatherSourceAvailabilityType", propOrder = {"timeInterval", "annotation", "specialDateAuthority",
...
public class WeatherSourceAvailabilityType extends AbstractPropertiesWithScheduleType implements Serializable {
    ...
    @JoinTable(name = "wthrsrcavlblttp_tmintrvl_link", schema = "airport_heliport", joinColumns = {
            @JoinColumn(name = "weathersourceavailability_o_hjid", referencedColumnName = "hjid")}, inverseJoinColumns = {
    ...
    public void setOperationalStatusItem(CodeStatusServiceType target) {
        setOperationalStatus(XmlAdapterUtils.marshallJAXBElement(CodeStatusServiceType.class,
                new QName("http://www.aixm.aero/schema/5.2", "operationalStatus"), WeatherSourceAvailabilityType.class,
                target));
    }
