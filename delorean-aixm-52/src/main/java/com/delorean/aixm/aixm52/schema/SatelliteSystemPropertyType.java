...
/**
 * <p>Java class for SatelliteSystemPropertyType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="SatelliteSystemPropertyType">
 *   <complexContent>
...
@XmlType(name = "SatelliteSystemPropertyType")
@Entity(name = "SatelliteSystemPropertyType")
@Table(name = "satellitesystem_p", schema = "navaids_point")
public class SatelliteSystemPropertyType implements Serializable, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        final SatelliteSystemPropertyType that = ((SatelliteSystemPropertyType) object);
        {
