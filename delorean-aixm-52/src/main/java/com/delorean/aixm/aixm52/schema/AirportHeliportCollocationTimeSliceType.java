 ...
 *       <sequence>
 *         <element name="type" type="{http://www.aixm.aero/schema/5.2}CodeAirportHeliportCollocationType" minOccurs="0"/>
 *         <element name="hostAirport" type="{http://www.aixm.aero/schema/5.2}AirportHeliportPropertyType" minOccurs="0"/>
 *         <element name="dependentAirport" type="{http://www.aixm.aero/schema/5.2}AirportHeliportPropertyType" minOccurs="0"/>
 ...
 *                 <sequence>
 *                   <element ref="{http://www.aixm.aero/schema/5.2}AbstractAirportHeliportCollocationExtension"/>
 *                 </sequence>
    ...
    implements Serializable
{
    ...
    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "type", columnDefinition = "codeairportheliportcollocationbase")),
    ...
    public void setTypeItem(CodeAirportHeliportCollocationType target) {
        setType(XmlAdapterUtils.marshallJAXBElement(CodeAirportHeliportCollocationType.class, new QName("http://www.aixm.aero/schema/5.2", "type"), AirportHeliportCollocationTimeSliceType.class, target));
    }
    ...
    public void setHostAirportItem(AirportHeliportPropertyType target) {
        setHostAirport(XmlAdapterUtils.marshallJAXBElement(AirportHeliportPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "hostAirport"), AirportHeliportCollocationTimeSliceType.class, target));
    }
    ...
    public void setDependentAirportItem(AirportHeliportPropertyType target) {
        setDependentAirport(XmlAdapterUtils.marshallJAXBElement(AirportHeliportPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "dependentAirport"), AirportHeliportCollocationTimeSliceType.class, target));
    }
