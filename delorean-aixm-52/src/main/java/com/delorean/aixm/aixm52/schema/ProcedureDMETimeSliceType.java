 ...
 *       <sequence>
 *         <element name="criticalDME" type="{http://www.aixm.aero/schema/5.2}CodeYesNoType" minOccurs="0"/>
 *         <element name="satisfactory" type="{http://www.aixm.aero/schema/5.2}CodeYesNoType" minOccurs="0"/>
 *         <element name="DME" type="{http://www.aixm.aero/schema/5.2}DMEPropertyType" minOccurs="0"/>
 *         <element name="segmentLeg" type="{http://www.aixm.aero/schema/5.2}SegmentLegPropertyType" minOccurs="0"/>
 ...
 *                 <sequence>
 *                   <element ref="{http://www.aixm.aero/schema/5.2}AbstractProcedureDMEExtension"/>
 *                 </sequence>
    ...
    implements Serializable
{
    ...
    public void setCriticalDMEItem(CodeYesNoType target) {
        setCriticalDME(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.2", "criticalDME"), ProcedureDMETimeSliceType.class, target));
    }
    ...
    public void setSatisfactoryItem(CodeYesNoType target) {
        setSatisfactory(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.2", "satisfactory"), ProcedureDMETimeSliceType.class, target));
    }
    ...
    public void setDMEItem(DMEPropertyType target) {
        setDME(XmlAdapterUtils.marshallJAXBElement(DMEPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "DME"), ProcedureDMETimeSliceType.class, target));
    }
    ...
    public void setSegmentLegItem(SegmentLegPropertyType target) {
        setSegmentLeg(XmlAdapterUtils.marshallJAXBElement(SegmentLegPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "segmentLeg"), ProcedureDMETimeSliceType.class, target));
    }
