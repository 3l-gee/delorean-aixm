 ...
 *         <element name="discreteLevelSeries" type="{http://www.aixm.aero/schema/5.2}StandardLevelColumnPropertyType" minOccurs="0"/>
 ...
 *                 <choice>
 *                   <element ref="{http://www.aixm.aero/schema/5.2}AbstractAirspaceLayerExtension"/>
 *                 </choice>
    ...
    implements Serializable
{
    ...
    @XmlElementRef(name = "discreteLevelSeries", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<StandardLevelColumnPropertyType> discreteLevelSeries;
    @XmlElement(nillable = true)
    protected List<NotePropertyType> annotation;
    protected List<AirspaceLayerExtensionType> extension;
    ...
    @JoinTable(name = "arspclrtp_annttn_link", schema = "shared", joinColumns = {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link AirspaceLayerExtensionType }
     * 
     * 
     */
    @OneToMany(targetEntity = AirspaceLayerExtensionType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinColumn(name = "airspacelayer_oe_hjid", referencedColumnName = "hjid")
    public List<AirspaceLayerExtensionType> getExtension() {
        if (extension == null) {
     ...
     * 
     */
    public void setExtension(List<AirspaceLayerExtensionType> extension) {
    ...
    public void setUpperLimitItem(ValDistanceVerticalType target) {
        setUpperLimit(XmlAdapterUtils.marshallJAXBElement(ValDistanceVerticalType.class, new QName("http://www.aixm.aero/schema/5.2", "upperLimit"), AirspaceLayerType.class, target));
    }
    ...
    public void setUpperLimitReferenceItem(CodeVerticalReferenceType target) {
        setUpperLimitReference(XmlAdapterUtils.marshallJAXBElement(CodeVerticalReferenceType.class, new QName("http://www.aixm.aero/schema/5.2", "upperLimitReference"), AirspaceLayerType.class, target));
    }
    ...
    public void setLowerLimitItem(ValDistanceVerticalType target) {
        setLowerLimit(XmlAdapterUtils.marshallJAXBElement(ValDistanceVerticalType.class, new QName("http://www.aixm.aero/schema/5.2", "lowerLimit"), AirspaceLayerType.class, target));
    }
    ...
    public void setLowerLimitReferenceItem(CodeVerticalReferenceType target) {
        setLowerLimitReference(XmlAdapterUtils.marshallJAXBElement(CodeVerticalReferenceType.class, new QName("http://www.aixm.aero/schema/5.2", "lowerLimitReference"), AirspaceLayerType.class, target));
    }
    ...
    public void setAltitudeInterpretationItem(CodeAltitudeUseType target) {
        setAltitudeInterpretation(XmlAdapterUtils.marshallJAXBElement(CodeAltitudeUseType.class, new QName("http://www.aixm.aero/schema/5.2", "altitudeInterpretation"), AirspaceLayerType.class, target));
    }

    @OneToOne(targetEntity = StandardLevelColumnPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "arspclrtp_dscrtlvlsrs_link", schema = "shared", joinColumns = {
        @JoinColumn(name = "airspacelayer_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setDiscreteLevelSeriesItem(StandardLevelColumnPropertyType target) {
        setDiscreteLevelSeries(XmlAdapterUtils.marshallJAXBElement(StandardLevelColumnPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "discreteLevelSeries"), AirspaceLayerType.class, target));
    }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        }
        {
            ...
            List<AirspaceLayerExtensionType> lhsField;
            lhsField = (this.isSetExtension()?this.getExtension():null);
            List<AirspaceLayerExtensionType> rhsField;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        }
        {
            ...
            List<AirspaceLayerExtensionType> theField;
