...
/**
 * <p>Java class for RunwayDirectionLightSystemTimeSliceType complex type</p>.
 * 
 ...
 *         <element name="position" type="{http://www.aixm.aero/schema/5.2}CodeRunwaySectionType" minOccurs="0"/>
 *         <element name="associatedRunwayDirection" type="{http://www.aixm.aero/schema/5.2}RunwayDirectionPropertyType" minOccurs="0"/>
 *         <element name="type" type="{http://www.aixm.aero/schema/5.2}CodeRunwayLightType" minOccurs="0"/>
 *         <element name="length" type="{http://www.aixm.aero/schema/5.2}ValDistanceType" minOccurs="0"/>
 *         <element name="spacing" type="{http://www.aixm.aero/schema/5.2}ValDistanceType" minOccurs="0"/>
 *         <element name="group" type="{http://www.aixm.aero/schema/5.2}LightGroupPropertyType" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="extension" maxOccurs="unbounded" minOccurs="0">
 *           <complexType>
 *             <complexContent>
 *               <restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 <choice>
 *                   <element ref="{http://www.aixm.aero/schema/5.2}AbstractRunwayDirectionLightSystemExtension"/>
    ...
    implements Serializable
{
    ...
    @JoinTable(name = "rnwdrctnlghtsstmtmslctp_elmnt_l", schema = "airport_heliport", joinColumns = {
    ...
    @JoinTable(name = "rnwdrctnlghtsstmtmslctp_avlblt_l", schema = "airport_heliport", joinColumns = {
        @JoinColumn(name = "runwaydirectionlightsystem_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "rnwdrctnlghtsstmtmslctp_annttn_l", schema = "airport_heliport", joinColumns = {
        @JoinColumn(name = "runwaydirectionlightsystem_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link CodeRunwayLightType }{@code >}
     *     
     */
    @Transient
     ...
     * 
     */
    @OneToMany(targetEntity = LightGroupPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "rnwdrctnlghtsstmtmslctp_grp_l", schema = "airport_heliport", joinColumns = {
        @JoinColumn(name = "runwaydirectionlightsystem_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setEmergencyLightingItem(CodeYesNoType target) {
        setEmergencyLighting(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.2", "emergencyLighting"), RunwayDirectionLightSystemTimeSliceType.class, target));
    }
    ...
    public void setIntensityLevelItem(CodeLightIntensityType target) {
        setIntensityLevel(XmlAdapterUtils.marshallJAXBElement(CodeLightIntensityType.class, new QName("http://www.aixm.aero/schema/5.2", "intensityLevel"), RunwayDirectionLightSystemTimeSliceType.class, target));
    }
    ...
    public void setColourItem(CodeColourType target) {
        setColour(XmlAdapterUtils.marshallJAXBElement(CodeColourType.class, new QName("http://www.aixm.aero/schema/5.2", "colour"), RunwayDirectionLightSystemTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "position", columnDefinition = "coderunwaysectionbase")),
    ...
    public void setPositionItem(CodeRunwaySectionType target) {
        setPosition(XmlAdapterUtils.marshallJAXBElement(CodeRunwaySectionType.class, new QName("http://www.aixm.aero/schema/5.2", "position"), RunwayDirectionLightSystemTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = RunwayDirectionPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "rnwdrctnlghtsstmtmslctp_assctdrnwdrctn_l", schema = "airport_heliport", joinColumns = {
        @JoinColumn(name = "runwaydirectionlightsystem_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setAssociatedRunwayDirectionItem(RunwayDirectionPropertyType target) {
        setAssociatedRunwayDirection(XmlAdapterUtils.marshallJAXBElement(RunwayDirectionPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "associatedRunwayDirection"), RunwayDirectionLightSystemTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "type", columnDefinition = "coderunwaylightbase")),
    ...
    public void setTypeItem(CodeRunwayLightType target) {
        setType(XmlAdapterUtils.marshallJAXBElement(CodeRunwayLightType.class, new QName("http://www.aixm.aero/schema/5.2", "type"), RunwayDirectionLightSystemTimeSliceType.class, target));
    }
    ...
    public void setLengthItem(ValDistanceType target) {
        setLength(XmlAdapterUtils.marshallJAXBElement(ValDistanceType.class, new QName("http://www.aixm.aero/schema/5.2", "length"), RunwayDirectionLightSystemTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "spacing", columnDefinition = "valdistancebase")),
        @AttributeOverride(name = "uom", column = @Column(name = "spacinguom", columnDefinition = "uomdistance")),
        @AttributeOverride(name = "accuracy", column = @Column(name = "spacingaccuracy", columnDefinition = "numericalwithnilreason")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "spacingnilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setSpacingItem(ValDistanceType target) {
        setSpacing(XmlAdapterUtils.marshallJAXBElement(ValDistanceType.class, new QName("http://www.aixm.aero/schema/5.2", "spacing"), RunwayDirectionLightSystemTimeSliceType.class, target));
    }
