 ...
 *       <sequence>
 *         <element name="type" type="{http://www.aixm.aero/schema/5.2}CodeNitrogenType" minOccurs="0"/>
    ...
    implements Serializable
{
    ...
    public void setTypeItem(CodeNitrogenType target) {
        setType(XmlAdapterUtils.marshallJAXBElement(CodeNitrogenType.class, new QName("http://www.aixm.aero/schema/5.2", "type"), NitrogenType.class, target));
    }
