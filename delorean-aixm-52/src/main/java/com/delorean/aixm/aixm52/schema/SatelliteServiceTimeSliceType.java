...
/**
 * <p>Java class for SatelliteServiceTimeSliceType complex type</p>.
 * 
 ...
 *       <sequence>
 *         <element name="serviceType" type="{http://www.aixm.aero/schema/5.2}CodeSatelliteNavigationServiceType" minOccurs="0"/>
 *         <element name="satelliteSystem" type="{http://www.aixm.aero/schema/5.2}SatelliteSystemPropertyType" minOccurs="0"/>
 *         <element name="serviceArea" type="{http://www.aixm.aero/schema/5.2}SatelliteServiceAreaPropertyType" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="approachLocation" type="{http://www.aixm.aero/schema/5.2}SatelliteApproachOperationPropertyType" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "SatelliteServiceTimeSliceType", propOrder = {
    "serviceType",
    "satelliteSystem",
    "serviceArea",
    "approachLocation",
...
public class SatelliteServiceTimeSliceType
    ...
    implements Serializable
{
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link CodeSatelliteNavigationServiceType }{@code >}
     *     
     */
    @Transient
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the approachLocation property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
    ...
    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "servicetype", columnDefinition = "codesatellitenavigationservicebase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "servicetypenilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setServiceTypeItem(CodeSatelliteNavigationServiceType target) {
        setServiceType(XmlAdapterUtils.marshallJAXBElement(CodeSatelliteNavigationServiceType.class, new QName("http://www.aixm.aero/schema/5.2", "serviceType"), SatelliteServiceTimeSliceType.class, target));
    }
    ...
    public void setSatelliteSystemItem(SatelliteSystemPropertyType target) {
        setSatelliteSystem(XmlAdapterUtils.marshallJAXBElement(SatelliteSystemPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "satelliteSystem"), SatelliteServiceTimeSliceType.class, target));
    }
