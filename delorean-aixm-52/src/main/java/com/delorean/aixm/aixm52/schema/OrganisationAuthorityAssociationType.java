 ...
 *       <sequence>
 *         <element name="type" type="{http://www.aixm.aero/schema/5.2}CodeOrganisationHierarchyType" minOccurs="0"/>
 ...
 *                 <choice>
 *                   <element ref="{http://www.aixm.aero/schema/5.2}AbstractOrganisationAuthorityAssociationExtension"/>
 *                 </choice>
    ...
    implements Serializable
{
    ...
    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "type", columnDefinition = "codeorganisationhierarchybase")),
    ...
    public void setTypeItem(CodeOrganisationHierarchyType target) {
        setType(XmlAdapterUtils.marshallJAXBElement(CodeOrganisationHierarchyType.class, new QName("http://www.aixm.aero/schema/5.2", "type"), OrganisationAuthorityAssociationType.class, target));
    }
    ...
    public void setTheOrganisationAuthorityItem(OrganisationAuthorityPropertyType target) {
        setTheOrganisationAuthority(XmlAdapterUtils.marshallJAXBElement(OrganisationAuthorityPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "theOrganisationAuthority"), OrganisationAuthorityAssociationType.class, target));
    }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        }
        {
            ...
            JAXBElement<CodeOrganisationHierarchyType> lhsField;
            lhsField = this.getType();
            JAXBElement<CodeOrganisationHierarchyType> rhsField;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = super.hashCode(locator, strategy);
        {
            ...
            JAXBElement<CodeOrganisationHierarchyType> theField;
