...
"{http://www.aixm.aero/schema/5.2}CodeOrganisationHierarchyType" minOccurs="0"/>
 ...
 *                 <choice>
 *                   <element ref=
"{http://www.aixm.aero/schema/5.2}AbstractOrganisationAuthorityAssociationExtension"/>
 *                 </choice>
 *                 <attGroup ref=
...
public class OrganisationAuthorityAssociationType extends AbstractAIXMObjectType implements Serializable {
    ...
    public void setTypeItem(CodeOrganisationHierarchyType target) {
        setType(XmlAdapterUtils.marshallJAXBElement(CodeOrganisationHierarchyType.class,
                new QName("http://www.aixm.aero/schema/5.2", "type"), OrganisationAuthorityAssociationType.class,
                target));
    }
    ...
    public void setTheOrganisationAuthorityItem(OrganisationAuthorityPropertyType target) {
        setTheOrganisationAuthority(XmlAdapterUtils.marshallJAXBElement(OrganisationAuthorityPropertyType.class,
                ...
                OrganisationAuthorityAssociationType.class, target));
    }
