...
@XmlType(name = "", propOrder = {"abstractAirportSuppliesServiceExtension", "abstractAirportGroundServiceExtension",
...
public class AirportSuppliesServiceTimeSliceExtensionType implements Serializable, Equals, HashCode, ToString {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = 1;
        {
            ...
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "abstractAirportSuppliesServiceExtension",
                    theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            AbstractExtensionType theField;
            theField = this.getAbstractAirportSuppliesServiceExtension();
            strategy.appendField(locator, this, "abstractAirportSuppliesServiceExtension", buffer, theField,
                    theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetAbstractAirportGroundServiceExtension();
