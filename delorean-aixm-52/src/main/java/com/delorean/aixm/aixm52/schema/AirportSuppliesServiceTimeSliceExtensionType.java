...
@Entity(name = "AirportSuppliesServiceTimeSliceExtensionType")
@Table(name = "airportsuppliesservice_te", schema = "service")
public class AirportSuppliesServiceTimeSliceExtensionType implements Serializable, Equals, HashCode, ToString
{
    ...
    @JoinColumn(name = "abstractairportsuppliesserviceextension_hjid", referencedColumnName = "hjid")
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        final AirportSuppliesServiceTimeSliceExtensionType that = ((AirportSuppliesServiceTimeSliceExtensionType) object);
        {
        ...
        }
        {
            ...
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "abstractAirportSuppliesServiceExtension", lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "abstractAirportSuppliesServiceExtension", rhsField);
            if (!strategy.equals(lhsFieldLocator, rhsFieldLocator, lhsField, rhsField, lhsFieldIsSet, rhsFieldIsSet)) {
                return false;
            }
        }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetAbstractAirportSuppliesServiceExtension();
            AbstractExtensionType theField;
            theField = this.getAbstractAirportSuppliesServiceExtension();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "abstractAirportSuppliesServiceExtension", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            AbstractExtensionType theField;
            theField = this.getAbstractAirportSuppliesServiceExtension();
            strategy.appendField(locator, this, "abstractAirportSuppliesServiceExtension", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetAbstractAirportGroundServiceExtension();
            AbstractExtensionType theField;
