...
@XmlSeeAlso({
    ...
    PointUsageType.class,
    SatelliteApproachOperationType.class,
    SatelliteServiceAreaType.class,
...
public abstract class AbstractPropertiesWithScheduleType
