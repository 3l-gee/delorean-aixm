 ...
 *       <sequence>
 *         <element name="type" type="{http://www.aixm.aero/schema/5.2}CodeRadarServiceType" minOccurs="0"/>
 *         <element name="model" type="{http://www.aixm.aero/schema/5.2}TextNameType" minOccurs="0"/>
 *         <element name="generalTerrainMonitor" type="{http://www.aixm.aero/schema/5.2}CodeYesNoType" minOccurs="0"/>
 *         <element name="broadcastIdentifier" type="{http://www.aixm.aero/schema/5.2}TextDesignatorType" minOccurs="0"/>
 *         <element name="radarEquipment" type="{http://www.aixm.aero/schema/5.2}RadarComponentPropertyType" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="office" type="{http://www.aixm.aero/schema/5.2}OrganisationAuthorityPropertyType" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="airportHeliport" type="{http://www.aixm.aero/schema/5.2}AirportHeliportPropertyType" minOccurs="0"/>
 *         <element name="PARRunway" type="{http://www.aixm.aero/schema/5.2}RunwayPropertyType" maxOccurs="unbounded" minOccurs="0"/>
 ...
 *                 <sequence>
 *                   <element ref="{http://www.aixm.aero/schema/5.2}AbstractRadarSystemExtension"/>
 *                 </sequence>
    ...
    implements Serializable
{
    ...
    @XmlElementRef(name = "model", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<TextNameType> model;
    @XmlElementRef(name = "generalTerrainMonitor", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<CodeYesNoType> generalTerrainMonitor;
    @XmlElementRef(name = "broadcastIdentifier", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    ...
    protected List<RadarSystemTimeSliceExtensionType> extension;
    ...
    @JoinTable(name = "rdrsstmtmslctp_rdreqpmnt_l", schema = "surveillance", joinColumns = {
    ...
    @JoinTable(name = "rdrsstmtmslctp_offc_l", schema = "surveillance", joinColumns = {
        @JoinColumn(name = "radarsystem_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "rdrsstmtmslctp_parrnw_l", schema = "surveillance", joinColumns = {
        @JoinColumn(name = "radarsystem_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "rdrsstmtmslctp_annttn_l", schema = "surveillance", joinColumns = {
        @JoinColumn(name = "radarsystem_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link RadarSystemTimeSliceExtensionType }
     * 
     * 
     */
    @OneToMany(targetEntity = RadarSystemTimeSliceExtensionType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinColumn(name = "radarsystem_te_hjid", referencedColumnName = "hjid")
    public List<RadarSystemTimeSliceExtensionType> getExtension() {
        if (extension == null) {
     ...
     * 
     */
    public void setExtension(List<RadarSystemTimeSliceExtensionType> extension) {
    ...
    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "type", columnDefinition = "coderadarservicebase")),
    ...
    public void setTypeItem(CodeRadarServiceType target) {
        setType(XmlAdapterUtils.marshallJAXBElement(CodeRadarServiceType.class, new QName("http://www.aixm.aero/schema/5.2", "type"), RadarSystemTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "model", columnDefinition = "character2")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "modelnilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setModelItem(TextNameType target) {
        setModel(XmlAdapterUtils.marshallJAXBElement(TextNameType.class, new QName("http://www.aixm.aero/schema/5.2", "model"), RadarSystemTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "generalterrainmonitor", columnDefinition = "codeyesnobase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "generalterrainmonitornilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setGeneralTerrainMonitorItem(CodeYesNoType target) {
        setGeneralTerrainMonitor(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.2", "generalTerrainMonitor"), RadarSystemTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "broadcastidentifier", columnDefinition = "character3")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "broadcastidentifiernilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setBroadcastIdentifierItem(TextDesignatorType target) {
        setBroadcastIdentifier(XmlAdapterUtils.marshallJAXBElement(TextDesignatorType.class, new QName("http://www.aixm.aero/schema/5.2", "broadcastIdentifier"), RadarSystemTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = AirportHeliportPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "rdrsstmtmslctp_arprthlprt_l", schema = "surveillance", joinColumns = {
        @JoinColumn(name = "radarsystem_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setAirportHeliportItem(AirportHeliportPropertyType target) {
        setAirportHeliport(XmlAdapterUtils.marshallJAXBElement(AirportHeliportPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "airportHeliport"), RadarSystemTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = AIXMElevatedPointPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "rdrsstmtmslctp_lctn_l", schema = "surveillance", joinColumns = {
        @JoinColumn(name = "radarsystem_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setLocationItem(AIXMElevatedPointPropertyType target) {
        setLocation(XmlAdapterUtils.marshallJAXBElement(AIXMElevatedPointPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "location"), RadarSystemTimeSliceType.class, target));
    }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        }
        {
            ...
            List<RadarSystemTimeSliceExtensionType> lhsField;
            lhsField = (this.isSetExtension()?this.getExtension():null);
            List<RadarSystemTimeSliceExtensionType> rhsField;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        }
        {
            ...
            List<RadarSystemTimeSliceExtensionType> theField;
