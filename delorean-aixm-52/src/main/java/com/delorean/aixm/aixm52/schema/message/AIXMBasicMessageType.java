...
import com.delorean.aixm.aixm52.schema.AbstractAIXMMessageType;
...
/**
 * <p>
 * Java class for AIXMBasicMessageType complex type
 * </p>
 * .
 *
 * <p>
 ...
 *   <complexContent>
 *     <extension base=
"{http://www.aixm.aero/schema/5.2}AbstractAIXMMessageType">
 *       <sequence>
 *         <group ref=
"{http://www.aixm.aero/schema/5.2/message}AIXMBasicMessagePropertyGroup"/>
 *       </sequence>
 *     </extension>
 *   </complexContent>
 * </complexType>
...
@XmlType(name = "AIXMBasicMessageType", propOrder = {"hasMember"})
@XmlRootElement
@Entity(name = "AIXMBasicMessageType")
@Table(name = "aixm_message", schema = "aixm")
public class AIXMBasicMessageType extends AbstractAIXMMessageType implements Serializable {
    ...
    @JoinTable(name = "message_member_link", schema = "aixm", joinColumns = {
            @JoinColumn(name = "message_hjid", referencedColumnName = "hjid")}, inverseJoinColumns = {
