...
/**
 * <p>
 * Java class for ProcedureDMEType complex type
 * </p>
 * .
 *
 * <p>
...
"{http://www.aixm.aero/schema/5.2}ProcedureDMETimeSlicePropertyType" maxOccurs=
"unbounded"/>
 *       </sequence>
 *     </extension>
 *   </complexContent>
...
@XmlType(name = "ProcedureDMEType", propOrder = {"timeSlice"})
@Entity(name = "ProcedureDMEType")
@Table(name = "proceduredme_f", schema = "procedure")
public class ProcedureDMEType extends AbstractAIXMFeatureType implements Serializable {
    ...
    @OneToMany(targetEntity = ProcedureDMETimeSlicePropertyType.class, cascade = {
     ...
     *
     */
    public void setTimeSlice(List<ProcedureDMETimeSlicePropertyType> timeSlice) {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final ProcedureDMEType that = ((ProcedureDMEType) object);
        {
            boolean lhsFieldIsSet = this.isSetTimeSlice();
            boolean rhsFieldIsSet = that.isSetTimeSlice();
            List<ProcedureDMETimeSlicePropertyType> lhsField;
            lhsField = (this.isSetTimeSlice() ? this.getTimeSlice() : null);
            List<ProcedureDMETimeSlicePropertyType> rhsField;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = super.hashCode(locator, strategy);
        {
            ...
            List<ProcedureDMETimeSlicePropertyType> theField;
