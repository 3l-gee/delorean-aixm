...
"{http://www.aixm.aero/schema/5.2}CodeUnitDependencyType" minOccurs="0"/>
 ...
 *                 <choice>
 *                   <element ref=
"{http://www.aixm.aero/schema/5.2}AbstractUnitDependencyExtension"/>
 *                 </choice>
 *                 <attGroup ref=
...
public class UnitDependencyType extends AbstractAIXMObjectType implements Serializable {
    ...
    public void setTypeItem(CodeUnitDependencyType target) {
        setType(XmlAdapterUtils.marshallJAXBElement(CodeUnitDependencyType.class,
                new QName("http://www.aixm.aero/schema/5.2", "type"), UnitDependencyType.class, target));
    }
    ...
    public void setTheUnitItem(UnitPropertyType target) {
        setTheUnit(XmlAdapterUtils.marshallJAXBElement(UnitPropertyType.class,
                new QName("http://www.aixm.aero/schema/5.2", "theUnit"), UnitDependencyType.class, target));
    }
