 ...
 *       <sequence>
 *         <element name="type" type="{http://www.aixm.aero/schema/5.2}CodeUnitDependencyType" minOccurs="0"/>
 ...
 *                 <choice>
 *                   <element ref="{http://www.aixm.aero/schema/5.2}AbstractUnitDependencyExtension"/>
 *                 </choice>
    ...
    implements Serializable
{
    ...
    @JoinTable(name = "untdpndnctp_annttn_link", schema = "organisation", joinColumns = {
        @JoinColumn(name = "unitdependency_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
     ...
     * 
     */
    @OneToMany(targetEntity = UnitDependencyExtensionType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    ...
    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "type", columnDefinition = "codeunitdependencybase")),
    ...
    public void setTypeItem(CodeUnitDependencyType target) {
        setType(XmlAdapterUtils.marshallJAXBElement(CodeUnitDependencyType.class, new QName("http://www.aixm.aero/schema/5.2", "type"), UnitDependencyType.class, target));
    }
    ...
    public void setTheUnitItem(UnitPropertyType target) {
        setTheUnit(XmlAdapterUtils.marshallJAXBElement(UnitPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "theUnit"), UnitDependencyType.class, target));
    }
