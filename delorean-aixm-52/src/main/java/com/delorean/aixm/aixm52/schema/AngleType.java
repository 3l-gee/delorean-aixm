 ...
 *       <sequence>
 *         <element name="angle" type="{http://www.aixm.aero/schema/5.2}ValBearingType" minOccurs="0"/>
 *         <element name="angleType" type="{http://www.aixm.aero/schema/5.2}CodeBearingType" minOccurs="0"/>
 *         <element name="indicationDirection" type="{http://www.aixm.aero/schema/5.2}CodeDirectionReferenceType" minOccurs="0"/>
 *         <element name="trueAngle" type="{http://www.aixm.aero/schema/5.2}ValBearingType" minOccurs="0"/>
 *         <element name="cardinalDirection" type="{http://www.aixm.aero/schema/5.2}CodeCardinalDirectionType" minOccurs="0"/>
 *         <element name="minimumReceptionAltitude" type="{http://www.aixm.aero/schema/5.2}ValDistanceVerticalType" minOccurs="0"/>
 *         <choice>
 ...
 *                 <choice>
 *                   <element ref="{http://www.aixm.aero/schema/5.2}AbstractAngleExtension"/>
 *                 </choice>
...
@Entity(name = "AngleType")
@Table(name = "angle_o", schema = "navaids_point")
    ...
    implements Serializable
{
    ...
    @XmlElementRef(name = "angleType", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<CodeBearingType> angleType;
    @XmlElementRef(name = "indicationDirection", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<CodeDirectionReferenceType> indicationDirection;
    @XmlElementRef(name = "trueAngle", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "minimumReceptionAltitude", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    ...
    protected List<AngleExtensionType> extension;
    ...
    @JoinTable(name = "angltp_annttn_link", schema = "navaids_point", joinColumns = {
        @JoinColumn(name = "angle_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link AngleExtensionType }
     * 
     * 
     */
    @OneToMany(targetEntity = AngleExtensionType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinColumn(name = "angle_oe_hjid", referencedColumnName = "hjid")
    public List<AngleExtensionType> getExtension() {
        if (extension == null) {
     ...
     * 
     */
    public void setExtension(List<AngleExtensionType> extension) {
    ...
    @AttributeOverrides({
        ...
        @AttributeOverride(name = "accuracy", column = @Column(name = "angleaccuracy", columnDefinition = "numericalwithnilreason"))
    })
    ...
    public void setAngleItem(ValBearingType target) {
        setAngle(XmlAdapterUtils.marshallJAXBElement(ValBearingType.class, new QName("http://www.aixm.aero/schema/5.2", "angle"), AngleType.class, target));
    }
    ...
    public void setAngleTypeItem(CodeBearingType target) {
        setAngleType(XmlAdapterUtils.marshallJAXBElement(CodeBearingType.class, new QName("http://www.aixm.aero/schema/5.2", "angleType"), AngleType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "indicationdirection", columnDefinition = "codedirectionreferencebase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "indicationdirectionnilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setIndicationDirectionItem(CodeDirectionReferenceType target) {
        setIndicationDirection(XmlAdapterUtils.marshallJAXBElement(CodeDirectionReferenceType.class, new QName("http://www.aixm.aero/schema/5.2", "indicationDirection"), AngleType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "trueangle", columnDefinition = "valbearingbase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "trueanglenilreason", columnDefinition = "nilreason")),
        @AttributeOverride(name = "accuracy", column = @Column(name = "trueangleaccuracy", columnDefinition = "numericalwithnilreason"))
    })
    ...
    public void setTrueAngleItem(ValBearingType target) {
        setTrueAngle(XmlAdapterUtils.marshallJAXBElement(ValBearingType.class, new QName("http://www.aixm.aero/schema/5.2", "trueAngle"), AngleType.class, target));
    }
    ...
    public void setCardinalDirectionItem(CodeCardinalDirectionType target) {
        setCardinalDirection(XmlAdapterUtils.marshallJAXBElement(CodeCardinalDirectionType.class, new QName("http://www.aixm.aero/schema/5.2", "cardinalDirection"), AngleType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "minimumreceptionaltitude", columnDefinition = "valdistanceverticalbase")),
        @AttributeOverride(name = "uom", column = @Column(name = "minimumreceptionaltitudeuom", columnDefinition = "uomdistancevertical")),
        @AttributeOverride(name = "accuracy", column = @Column(name = "minimumreceptionaltitudeaccuracy", columnDefinition = "numericalwithnilreason")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "minimumreceptionaltitudenilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setMinimumReceptionAltitudeItem(ValDistanceVerticalType target) {
        setMinimumReceptionAltitude(XmlAdapterUtils.marshallJAXBElement(ValDistanceVerticalType.class, new QName("http://www.aixm.aero/schema/5.2", "minimumReceptionAltitude"), AngleType.class, target));
    }

    @OneToOne(targetEntity = DesignatedPointPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "angltp_pntchcfxdsgntdpnt_link", schema = "navaids_point", joinColumns = {
        @JoinColumn(name = "angle_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setPointChoiceFixDesignatedPointItem(DesignatedPointPropertyType target) {
        setPointChoiceFixDesignatedPoint(XmlAdapterUtils.marshallJAXBElement(DesignatedPointPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "pointChoice_fixDesignatedPoint"), AngleType.class, target));
    }

    @OneToOne(targetEntity = NavaidPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "angltp_pntchcnvdsstm_link", schema = "navaids_point", joinColumns = {
        @JoinColumn(name = "angle_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setPointChoiceNavaidSystemItem(NavaidPropertyType target) {
        setPointChoiceNavaidSystem(XmlAdapterUtils.marshallJAXBElement(NavaidPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "pointChoice_navaidSystem"), AngleType.class, target));
    }

    @OneToOne(targetEntity = AIXMPointPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "angltp_pntchcpstn_link", schema = "navaids_point", joinColumns = {
        @JoinColumn(name = "angle_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setPointChoicePositionItem(AIXMPointPropertyType target) {
        setPointChoicePosition(XmlAdapterUtils.marshallJAXBElement(AIXMPointPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "pointChoice_position"), AngleType.class, target));
    }

    @OneToOne(targetEntity = RunwayCentrelinePointPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "angltp_pntchcrnwpnt_link", schema = "navaids_point", joinColumns = {
        @JoinColumn(name = "angle_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setPointChoiceRunwayPointItem(RunwayCentrelinePointPropertyType target) {
        setPointChoiceRunwayPoint(XmlAdapterUtils.marshallJAXBElement(RunwayCentrelinePointPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "pointChoice_runwayPoint"), AngleType.class, target));
    }

    @OneToOne(targetEntity = TouchDownLiftOffPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "angltp_pntchcamngpnt_link", schema = "navaids_point", joinColumns = {
        @JoinColumn(name = "angle_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setPointChoiceAimingPointItem(TouchDownLiftOffPropertyType target) {
        setPointChoiceAimingPoint(XmlAdapterUtils.marshallJAXBElement(TouchDownLiftOffPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "pointChoice_aimingPoint"), AngleType.class, target));
    }

    @OneToOne(targetEntity = AirportHeliportPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "angltp_pntchcarprtrfrncpnt_link", schema = "navaids_point", joinColumns = {
        @JoinColumn(name = "angle_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setPointChoiceAirportReferencePointItem(AirportHeliportPropertyType target) {
        setPointChoiceAirportReferencePoint(XmlAdapterUtils.marshallJAXBElement(AirportHeliportPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "pointChoice_airportReferencePoint"), AngleType.class, target));
    }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        final AngleType that = ((AngleType) object);
        {
        ...
        }
        {
            ...
            List<AngleExtensionType> lhsField;
            lhsField = (this.isSetExtension()?this.getExtension():null);
            List<AngleExtensionType> rhsField;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        }
        {
            ...
            List<AngleExtensionType> theField;
