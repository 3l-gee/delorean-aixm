 ...
 *         <element name="protectedTouchDownLiftOff" type="{http://www.aixm.aero/schema/5.2}TouchDownLiftOffPropertyType" minOccurs="0"/>
 *         <element name="extension" maxOccurs="unbounded" minOccurs="0">
 *           <complexType>
 *             <complexContent>
 *               <restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 <choice>
 *                   <element ref="{http://www.aixm.aero/schema/5.2}AbstractTouchDownLiftOffSafeAreaExtension"/>
    ...
    implements Serializable
{
    ...
    @XmlElementRef(name = "lighting", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<CodeYesNoType> lighting;
    @XmlElementRef(name = "obstacleFree", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "protectedTouchDownLiftOff", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    ...
    public void setWidthItem(ValDistanceType target) {
        setWidth(XmlAdapterUtils.marshallJAXBElement(ValDistanceType.class, new QName("http://www.aixm.aero/schema/5.2", "width"), TouchDownLiftOffSafeAreaTimeSliceType.class, target));
    }
    ...
    public void setLengthItem(ValDistanceType target) {
        setLength(XmlAdapterUtils.marshallJAXBElement(ValDistanceType.class, new QName("http://www.aixm.aero/schema/5.2", "length"), TouchDownLiftOffSafeAreaTimeSliceType.class, target));
    }
    ...
    public void setLightingItem(CodeYesNoType target) {
        setLighting(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.2", "lighting"), TouchDownLiftOffSafeAreaTimeSliceType.class, target));
    }
    ...
    public void setObstacleFreeItem(CodeYesNoType target) {
        setObstacleFree(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.2", "obstacleFree"), TouchDownLiftOffSafeAreaTimeSliceType.class, target));
    }
    ...
    public void setSurfacePropertiesItem(SurfaceCharacteristicsPropertyType target) {
        setSurfaceProperties(XmlAdapterUtils.marshallJAXBElement(SurfaceCharacteristicsPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "surfaceProperties"), TouchDownLiftOffSafeAreaTimeSliceType.class, target));
    }
    ...
    public void setExtentItem(AIXMElevatedSurfacePropertyType target) {
        setExtent(XmlAdapterUtils.marshallJAXBElement(AIXMElevatedSurfacePropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "extent"), TouchDownLiftOffSafeAreaTimeSliceType.class, target));
    }
    ...
    public void setProtectedTouchDownLiftOffItem(TouchDownLiftOffPropertyType target) {
        setProtectedTouchDownLiftOff(XmlAdapterUtils.marshallJAXBElement(TouchDownLiftOffPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "protectedTouchDownLiftOff"), TouchDownLiftOffSafeAreaTimeSliceType.class, target));
    }
