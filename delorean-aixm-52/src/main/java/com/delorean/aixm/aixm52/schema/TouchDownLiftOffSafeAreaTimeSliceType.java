...
/**
 * <p>
 * Java class for TouchDownLiftOffSafeAreaTimeSliceType complex type
 * </p>
 * .
 *
 * <p>
 ...
 *         <element name="protectedTouchDownLiftOff" type=
 ...
 *                 <choice>
 *                   <element ref=
"{http://www.aixm.aero/schema/5.2}AbstractTouchDownLiftOffSafeAreaExtension"/>
 *                   <element ref=
...
@XmlType(name = "TouchDownLiftOffSafeAreaTimeSliceType", propOrder = {"width", "length", "lighting", "obstacleFree",
        "surfaceProperties", "extent", "annotation", "protectedTouchDownLiftOff", "extension"})
@Entity(name = "TouchDownLiftOffSafeAreaTimeSliceType")
@Table(name = "touchdownliftoffsafearea_t", schema = "airport_heliport")
public class TouchDownLiftOffSafeAreaTimeSliceType extends AbstractAIXMTimeSliceType implements Serializable {
    ...
    @JoinTable(name = "tchdwnlftoffsfartmslctp_annttn_link", schema = "airport_heliport", joinColumns = {
            @JoinColumn(name = "touchdownliftoffsafearea_t_hjid", referencedColumnName = "hjid")}, inverseJoinColumns = {
    ...
    public void setWidthItem(ValDistanceType target) {
        setWidth(XmlAdapterUtils.marshallJAXBElement(ValDistanceType.class,
                new QName("http://www.aixm.aero/schema/5.2", "width"), TouchDownLiftOffSafeAreaTimeSliceType.class,
                target));
    }
    ...
    public void setLengthItem(ValDistanceType target) {
        setLength(XmlAdapterUtils.marshallJAXBElement(ValDistanceType.class,
                new QName("http://www.aixm.aero/schema/5.2", "length"), TouchDownLiftOffSafeAreaTimeSliceType.class,
                target));
    }
    ...
    public void setLightingItem(CodeYesNoType target) {
        setLighting(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class,
                new QName("http://www.aixm.aero/schema/5.2", "lighting"), TouchDownLiftOffSafeAreaTimeSliceType.class,
                target));
    }
    ...
    public void setObstacleFreeItem(CodeYesNoType target) {
        setObstacleFree(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class,
                new QName("http://www.aixm.aero/schema/5.2", "obstacleFree"),
                TouchDownLiftOffSafeAreaTimeSliceType.class, target));
    }
    ...
    public void setSurfacePropertiesItem(SurfaceCharacteristicsPropertyType target) {
        setSurfaceProperties(XmlAdapterUtils.marshallJAXBElement(SurfaceCharacteristicsPropertyType.class,
                new QName("http://www.aixm.aero/schema/5.2", "surfaceProperties"),
                TouchDownLiftOffSafeAreaTimeSliceType.class, target));
    }
    ...
    public void setExtentItem(AIXMElevatedSurfacePropertyType target) {
        setExtent(XmlAdapterUtils.marshallJAXBElement(AIXMElevatedSurfacePropertyType.class,
                new QName("http://www.aixm.aero/schema/5.2", "extent"), TouchDownLiftOffSafeAreaTimeSliceType.class,
                target));
    }
    ...
    public TouchDownLiftOffPropertyType getProtectedTouchDownLiftOffItem() {
        return XmlAdapterUtils.unmarshallSource(TouchDownLiftOffPropertyType.class,
                this.getProtectedTouchDownLiftOff());
    }

    public void setProtectedTouchDownLiftOffItem(TouchDownLiftOffPropertyType target) {
        setProtectedTouchDownLiftOff(XmlAdapterUtils.marshallJAXBElement(TouchDownLiftOffPropertyType.class,
                new QName("http://www.aixm.aero/schema/5.2", "protectedTouchDownLiftOff"),
                TouchDownLiftOffSafeAreaTimeSliceType.class, target));
    }
