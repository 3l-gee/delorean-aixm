...
/**
 * <p>Java class for MissedApproachLegTimeSliceType complex type</p>.
 * 
 ...
 *         <element name="type" type="{http://www.aixm.aero/schema/5.2}CodeMissedApproachType" minOccurs="0"/>
 *         <element name="thresholdAfterMAPT" type="{http://www.aixm.aero/schema/5.2}CodeYesNoType" minOccurs="0"/>
 *         <element name="heightMAPT" type="{http://www.aixm.aero/schema/5.2}ValDistanceVerticalType" minOccurs="0"/>
 ...
 *                 <choice>
 *                   <element ref="{http://www.aixm.aero/schema/5.2}AbstractMissedApproachLegExtension"/>
...
@Entity(name = "MissedApproachLegTimeSliceType")
@Table(name = "missedapproachleg_t", schema = "procedure")
    ...
    implements Serializable
{
    ...
    @XmlElementRef(name = "thresholdAfterMAPT", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<CodeYesNoType> thresholdAfterMAPT;
    @XmlElementRef(name = "heightMAPT", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<ValDistanceVerticalType> heightMAPT;
    @XmlElement(nillable = true)
    protected List<ApproachConditionPropertyType> condition;
    protected List<MissedApproachLegTimeSliceExtensionType> extension;
    ...
    @JoinTable(name = "mssdapprchlgtmslctp_dsgnsrfc_link", schema = "procedure", joinColumns = {
        @JoinColumn(name = "missedapproachleg_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "mssdapprchlgtmslctp_annttn_link", schema = "procedure", joinColumns = {
        @JoinColumn(name = "missedapproachleg_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "mssdapprchlgtmslctp_arcrftcpblt_link", schema = "procedure", joinColumns = {
        @JoinColumn(name = "missedapproachleg_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "mssdapprchlgtmslctp_sgmntcrs_link", schema = "procedure", joinColumns = {
        @JoinColumn(name = "missedapproachleg_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "mssdapprchlgtmslctp_alttdcndtn_link", schema = "procedure", joinColumns = {
        @JoinColumn(name = "missedapproachleg_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "mssdapprchlgtmslctp_cndtn_link", schema = "procedure", joinColumns = {
        @JoinColumn(name = "missedapproachleg_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link MissedApproachLegTimeSliceExtensionType }
     * 
     * 
     */
    @OneToMany(targetEntity = MissedApproachLegTimeSliceExtensionType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinColumn(name = "missedapproachleg_te_hjid", referencedColumnName = "hjid")
    public List<MissedApproachLegTimeSliceExtensionType> getExtension() {
        if (extension == null) {
     ...
     * 
     */
    public void setExtension(List<MissedApproachLegTimeSliceExtensionType> extension) {
    ...
    public void setEndConditionDesignatorItem(CodeSegmentTerminationType target) {
        setEndConditionDesignator(XmlAdapterUtils.marshallJAXBElement(CodeSegmentTerminationType.class, new QName("http://www.aixm.aero/schema/5.2", "endConditionDesignator"), MissedApproachLegTimeSliceType.class, target));
    }
    ...
    public void setLegPathItem(CodeTrajectoryType target) {
        setLegPath(XmlAdapterUtils.marshallJAXBElement(CodeTrajectoryType.class, new QName("http://www.aixm.aero/schema/5.2", "legPath"), MissedApproachLegTimeSliceType.class, target));
    }
    ...
    public void setLegTypeARINCItem(CodeSegmentPathType target) {
        setLegTypeARINC(XmlAdapterUtils.marshallJAXBElement(CodeSegmentPathType.class, new QName("http://www.aixm.aero/schema/5.2", "legTypeARINC"), MissedApproachLegTimeSliceType.class, target));
    }
    ...
    public void setTurnDirectionItem(CodeDirectionTurnType target) {
        setTurnDirection(XmlAdapterUtils.marshallJAXBElement(CodeDirectionTurnType.class, new QName("http://www.aixm.aero/schema/5.2", "turnDirection"), MissedApproachLegTimeSliceType.class, target));
    }
    ...
    public void setSpeedLimitItem(ValSpeedType target) {
        setSpeedLimit(XmlAdapterUtils.marshallJAXBElement(ValSpeedType.class, new QName("http://www.aixm.aero/schema/5.2", "speedLimit"), MissedApproachLegTimeSliceType.class, target));
    }
    ...
    public void setSpeedReferenceItem(CodeSpeedReferenceType target) {
        setSpeedReference(XmlAdapterUtils.marshallJAXBElement(CodeSpeedReferenceType.class, new QName("http://www.aixm.aero/schema/5.2", "speedReference"), MissedApproachLegTimeSliceType.class, target));
    }
    ...
    public void setSpeedInterpretationItem(CodeSpeedInterpretationUseType target) {
        setSpeedInterpretation(XmlAdapterUtils.marshallJAXBElement(CodeSpeedInterpretationUseType.class, new QName("http://www.aixm.aero/schema/5.2", "speedInterpretation"), MissedApproachLegTimeSliceType.class, target));
    }
    ...
    public void setBankAngleItem(ValAngleType target) {
        setBankAngle(XmlAdapterUtils.marshallJAXBElement(ValAngleType.class, new QName("http://www.aixm.aero/schema/5.2", "bankAngle"), MissedApproachLegTimeSliceType.class, target));
    }
    ...
    public void setLengthItem(ValDistanceType target) {
        setLength(XmlAdapterUtils.marshallJAXBElement(ValDistanceType.class, new QName("http://www.aixm.aero/schema/5.2", "length"), MissedApproachLegTimeSliceType.class, target));
    }
    ...
    public void setDurationItem(ValDurationType target) {
        setDuration(XmlAdapterUtils.marshallJAXBElement(ValDurationType.class, new QName("http://www.aixm.aero/schema/5.2", "duration"), MissedApproachLegTimeSliceType.class, target));
    }
    ...
    public void setProcedureTurnRequiredItem(CodeYesNoType target) {
        setProcedureTurnRequired(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.2", "procedureTurnRequired"), MissedApproachLegTimeSliceType.class, target));
    }
    ...
    public void setUpperLimitReferenceItem(CodeVerticalReferenceType target) {
        setUpperLimitReference(XmlAdapterUtils.marshallJAXBElement(CodeVerticalReferenceType.class, new QName("http://www.aixm.aero/schema/5.2", "upperLimitReference"), MissedApproachLegTimeSliceType.class, target));
    }
    ...
    public void setLowerLimitReferenceItem(CodeVerticalReferenceType target) {
        setLowerLimitReference(XmlAdapterUtils.marshallJAXBElement(CodeVerticalReferenceType.class, new QName("http://www.aixm.aero/schema/5.2", "lowerLimitReference"), MissedApproachLegTimeSliceType.class, target));
    }
    ...
    public void setAltitudeOverrideATCItem(ValDistanceVerticalType target) {
        setAltitudeOverrideATC(XmlAdapterUtils.marshallJAXBElement(ValDistanceVerticalType.class, new QName("http://www.aixm.aero/schema/5.2", "altitudeOverrideATC"), MissedApproachLegTimeSliceType.class, target));
    }
    ...
    public void setAltitudeOverrideReferenceItem(CodeVerticalReferenceType target) {
        setAltitudeOverrideReference(XmlAdapterUtils.marshallJAXBElement(CodeVerticalReferenceType.class, new QName("http://www.aixm.aero/schema/5.2", "altitudeOverrideReference"), MissedApproachLegTimeSliceType.class, target));
    }
    ...
    public void setVerticalAngleItem(ValAngleType target) {
        setVerticalAngle(XmlAdapterUtils.marshallJAXBElement(ValAngleType.class, new QName("http://www.aixm.aero/schema/5.2", "verticalAngle"), MissedApproachLegTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = TerminalSegmentPointPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "mssdapprchlgtmslctp_strtpnt_link", schema = "procedure", joinColumns = {
        @JoinColumn(name = "missedapproachleg_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setStartPointItem(TerminalSegmentPointPropertyType target) {
        setStartPoint(XmlAdapterUtils.marshallJAXBElement(TerminalSegmentPointPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "startPoint"), MissedApproachLegTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = TerminalSegmentPointPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "mssdapprchlgtmslctp_endpnt_link", schema = "procedure", joinColumns = {
        @JoinColumn(name = "missedapproachleg_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setEndPointItem(TerminalSegmentPointPropertyType target) {
        setEndPoint(XmlAdapterUtils.marshallJAXBElement(TerminalSegmentPointPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "endPoint"), MissedApproachLegTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = AIXMCurvePropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "mssdapprchlgtmslctp_trjctr_link", schema = "procedure", joinColumns = {
        @JoinColumn(name = "missedapproachleg_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setTrajectoryItem(AIXMCurvePropertyType target) {
        setTrajectory(XmlAdapterUtils.marshallJAXBElement(AIXMCurvePropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "trajectory"), MissedApproachLegTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = TerminalSegmentPointPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "mssdapprchlgtmslctp_arccntr_link", schema = "procedure", joinColumns = {
        @JoinColumn(name = "missedapproachleg_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setArcCentreItem(TerminalSegmentPointPropertyType target) {
        setArcCentre(XmlAdapterUtils.marshallJAXBElement(TerminalSegmentPointPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "arcCentre"), MissedApproachLegTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = HoldingUsePropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "mssdapprchlgtmslctp_hldng_link", schema = "procedure", joinColumns = {
        @JoinColumn(name = "missedapproachleg_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setHoldingItem(HoldingUsePropertyType target) {
        setHolding(XmlAdapterUtils.marshallJAXBElement(HoldingUsePropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "holding"), MissedApproachLegTimeSliceType.class, target));
    }
    ...
    public void setUpperLimitItem(ValDistanceVerticalType target) {
        setUpperLimit(XmlAdapterUtils.marshallJAXBElement(ValDistanceVerticalType.class, new QName("http://www.aixm.aero/schema/5.2", "upperLimit"), MissedApproachLegTimeSliceType.class, target));
    }
    ...
    public void setLowerLimitItem(ValDistanceVerticalType target) {
        setLowerLimit(XmlAdapterUtils.marshallJAXBElement(ValDistanceVerticalType.class, new QName("http://www.aixm.aero/schema/5.2", "lowerLimit"), MissedApproachLegTimeSliceType.class, target));
    }
    ...
    public void setVerticalLimitsInterpretationItem(CodeAltitudeUseType target) {
        setVerticalLimitsInterpretation(XmlAdapterUtils.marshallJAXBElement(CodeAltitudeUseType.class, new QName("http://www.aixm.aero/schema/5.2", "verticalLimitsInterpretation"), MissedApproachLegTimeSliceType.class, target));
    }
    ...
    public void setRadiusItem(ValDistanceType target) {
        setRadius(XmlAdapterUtils.marshallJAXBElement(ValDistanceType.class, new QName("http://www.aixm.aero/schema/5.2", "radius"), MissedApproachLegTimeSliceType.class, target));
    }
    ...
    public void setAdditionalEquipmentItem(CodeAdditionalEquipmentType target) {
        setAdditionalEquipment(XmlAdapterUtils.marshallJAXBElement(CodeAdditionalEquipmentType.class, new QName("http://www.aixm.aero/schema/5.2", "additionalEquipment"), MissedApproachLegTimeSliceType.class, target));
    }
    ...
    public void setMinimumObstacleClearanceAltitudeItem(ValDistanceVerticalType target) {
        setMinimumObstacleClearanceAltitude(XmlAdapterUtils.marshallJAXBElement(ValDistanceVerticalType.class, new QName("http://www.aixm.aero/schema/5.2", "minimumObstacleClearanceAltitude"), MissedApproachLegTimeSliceType.class, target));
    }
    ...
    public void setMinimumObstacleClearanceHeightItem(ValDistanceVerticalType target) {
        setMinimumObstacleClearanceHeight(XmlAdapterUtils.marshallJAXBElement(ValDistanceVerticalType.class, new QName("http://www.aixm.aero/schema/5.2", "minimumObstacleClearanceHeight"), MissedApproachLegTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = DistancePropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "mssdapprchlgtmslctp_lmtngdstnc_link", schema = "procedure", joinColumns = {
        @JoinColumn(name = "missedapproachleg_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setLimitingDistanceItem(DistancePropertyType target) {
        setLimitingDistance(XmlAdapterUtils.marshallJAXBElement(DistancePropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "limitingDistance"), MissedApproachLegTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = AnglePropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "mssdapprchlgtmslctp_lmtngangl_link", schema = "procedure", joinColumns = {
        @JoinColumn(name = "missedapproachleg_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setLimitingAngleItem(AnglePropertyType target) {
        setLimitingAngle(XmlAdapterUtils.marshallJAXBElement(AnglePropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "limitingAngle"), MissedApproachLegTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = InstrumentApproachProcedurePropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "mssdapprchlgtmslctp_apprch_link", schema = "procedure", joinColumns = {
        @JoinColumn(name = "missedapproachleg_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setApproachItem(InstrumentApproachProcedurePropertyType target) {
        setApproach(XmlAdapterUtils.marshallJAXBElement(InstrumentApproachProcedurePropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "approach"), MissedApproachLegTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "type", columnDefinition = "codemissedapproachbase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "typenilreason", columnDefinition = "nilreason"))
    })
    public CodeMissedApproachType getTypeItem() {
        return XmlAdapterUtils.unmarshallSource(CodeMissedApproachType.class, this.getType());
    }

    public void setTypeItem(CodeMissedApproachType target) {
        setType(XmlAdapterUtils.marshallJAXBElement(CodeMissedApproachType.class, new QName("http://www.aixm.aero/schema/5.2", "type"), MissedApproachLegTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "thresholdaftermapt", columnDefinition = "codeyesnobase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "thresholdaftermaptnilreason", columnDefinition = "nilreason"))
    })
    public CodeYesNoType getThresholdAfterMAPTItem() {
        return XmlAdapterUtils.unmarshallSource(CodeYesNoType.class, this.getThresholdAfterMAPT());
    }

    public void setThresholdAfterMAPTItem(CodeYesNoType target) {
        setThresholdAfterMAPT(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.2", "thresholdAfterMAPT"), MissedApproachLegTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "heightmapt", columnDefinition = "valdistanceverticalbase")),
        @AttributeOverride(name = "uom", column = @Column(name = "heightmaptuom", columnDefinition = "uomdistancevertical")),
        @AttributeOverride(name = "accuracy", column = @Column(name = "heightmaptaccuracy", columnDefinition = "numericalwithnilreason")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "heightmaptnilreason", columnDefinition = "nilreason"))
    })
    public ValDistanceVerticalType getHeightMAPTItem() {
        return XmlAdapterUtils.unmarshallSource(ValDistanceVerticalType.class, this.getHeightMAPT());
    }

    public void setHeightMAPTItem(ValDistanceVerticalType target) {
        setHeightMAPT(XmlAdapterUtils.marshallJAXBElement(ValDistanceVerticalType.class, new QName("http://www.aixm.aero/schema/5.2", "heightMAPT"), MissedApproachLegTimeSliceType.class, target));
    }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        final MissedApproachLegTimeSliceType that = ((MissedApproachLegTimeSliceType) object);
        {
        ...
        {
            boolean lhsFieldIsSet = this.isSetHeightMAPT();
            boolean rhsFieldIsSet = that.isSetHeightMAPT();
            JAXBElement<ValDistanceVerticalType> lhsField;
            lhsField = this.getHeightMAPT();
            JAXBElement<ValDistanceVerticalType> rhsField;
            rhsField = that.getHeightMAPT();
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "heightMAPT", lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "heightMAPT", rhsField);
            if (!strategy.equals(lhsFieldLocator, rhsFieldLocator, lhsField, rhsField, lhsFieldIsSet, rhsFieldIsSet)) {
                return false;
            }
        }
        ...
        }
        {
            ...
            List<MissedApproachLegTimeSliceExtensionType> lhsField;
            lhsField = (this.isSetExtension()?this.getExtension():null);
            List<MissedApproachLegTimeSliceExtensionType> rhsField;
        ...
        }
        {
            ...
            JAXBElement<CodeMissedApproachType> lhsField;
            lhsField = this.getType();
            JAXBElement<CodeMissedApproachType> rhsField;
        ...
        {
            boolean lhsFieldIsSet = this.isSetThresholdAfterMAPT();
            boolean rhsFieldIsSet = that.isSetThresholdAfterMAPT();
            JAXBElement<CodeYesNoType> lhsField;
            lhsField = this.getThresholdAfterMAPT();
            JAXBElement<CodeYesNoType> rhsField;
            rhsField = that.getThresholdAfterMAPT();
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "thresholdAfterMAPT", lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "thresholdAfterMAPT", rhsField);
            if (!strategy.equals(lhsFieldLocator, rhsFieldLocator, lhsField, rhsField, lhsFieldIsSet, rhsFieldIsSet)) {
                return false;
            }
        }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        }
        {
            ...
            JAXBElement<CodeMissedApproachType> theField;
            theField = this.getType();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "type", theField);
            currentHashCode = strategy.hashCode(theFieldLocator, currentHashCode, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetThresholdAfterMAPT();
            JAXBElement<CodeYesNoType> theField;
            theField = this.getThresholdAfterMAPT();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "thresholdAfterMAPT", theField);
            currentHashCode = strategy.hashCode(theFieldLocator, currentHashCode, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetHeightMAPT();
            JAXBElement<ValDistanceVerticalType> theField;
            theField = this.getHeightMAPT();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "heightMAPT", theField);
            currentHashCode = strategy.hashCode(theFieldLocator, currentHashCode, theField, theFieldIsSet);
        }
        {
        ...
        }
        {
            ...
            List<MissedApproachLegTimeSliceExtensionType> theField;
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        }
        {
            ...
            JAXBElement<CodeYesNoType> theField;
            theField = this.getThresholdAfterMAPT();
            strategy.appendField(locator, this, "thresholdAfterMAPT", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetHeightMAPT();
            JAXBElement<ValDistanceVerticalType> theField;
            theField = this.getHeightMAPT();
            strategy.appendField(locator, this, "heightMAPT", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetCondition();
            List<ApproachConditionPropertyType> theField;
