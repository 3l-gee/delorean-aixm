...
"{http://www.aixm.aero/schema/5.2}MarkingBuoyTimeSlicePropertyType" maxOccurs=
"unbounded"/>
 *       </sequence>
 *     </extension>
 *   </complexContent>
...
@Table(name = "markingbuoy_f", schema = "airport_heliport")
public class MarkingBuoyType extends AbstractAIXMFeatureType implements Serializable {
    ...
    @OneToMany(targetEntity = MarkingBuoyTimeSlicePropertyType.class, cascade = {
