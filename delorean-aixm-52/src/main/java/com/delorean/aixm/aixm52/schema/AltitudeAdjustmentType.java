 ...
 *       <sequence>
 *         <element name="altitudeAdjustmentType" type="{http://www.aixm.aero/schema/5.2}CodeAltitudeAdjustmentType" minOccurs="0"/>
 *         <element name="primaryAlternateMinimum" type="{http://www.aixm.aero/schema/5.2}CodeYesNoType" minOccurs="0"/>
 *         <element name="altitudeAdjustment" type="{http://www.aixm.aero/schema/5.2}ValDistanceVerticalType" minOccurs="0"/>
 *         <element name="localRemoteCode" type="{http://www.aixm.aero/schema/5.2}CodeYesNoType" minOccurs="0"/>
 ...
 *                 <choice>
 *                   <element ref="{http://www.aixm.aero/schema/5.2}AbstractAltitudeAdjustmentExtension"/>
 *                 </choice>
    ...
    implements Serializable
{
    ...
    @XmlElementRef(name = "altitudeAdjustmentType", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<CodeAltitudeAdjustmentType> altitudeAdjustmentType;
    @XmlElementRef(name = "primaryAlternateMinimum", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<CodeYesNoType> primaryAlternateMinimum;
    @XmlElementRef(name = "altitudeAdjustment", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<ValDistanceVerticalType> altitudeAdjustment;
    @XmlElementRef(name = "localRemoteCode", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<CodeYesNoType> localRemoteCode;
    @XmlElement(nillable = true)
    protected List<NotePropertyType> annotation;
    protected List<AltitudeAdjustmentExtensionType> extension;
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link AltitudeAdjustmentExtensionType }
     * 
     * 
     */
    @OneToMany(targetEntity = AltitudeAdjustmentExtensionType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinColumn(name = "altitudeadjustment_oe_hjid", referencedColumnName = "hjid")
    public List<AltitudeAdjustmentExtensionType> getExtension() {
        if (extension == null) {
     ...
     * 
     */
    public void setExtension(List<AltitudeAdjustmentExtensionType> extension) {
    ...
    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "altitudeadjustmenttype", columnDefinition = "codealtitudeadjustmentbase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "altitudeadjustmenttypenilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setAltitudeAdjustmentTypeItem(CodeAltitudeAdjustmentType target) {
        setAltitudeAdjustmentType(XmlAdapterUtils.marshallJAXBElement(CodeAltitudeAdjustmentType.class, new QName("http://www.aixm.aero/schema/5.2", "altitudeAdjustmentType"), AltitudeAdjustmentType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "primaryalternateminimum", columnDefinition = "codeyesnobase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "primaryalternateminimumnilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setPrimaryAlternateMinimumItem(CodeYesNoType target) {
        setPrimaryAlternateMinimum(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.2", "primaryAlternateMinimum"), AltitudeAdjustmentType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "altitudeadjustment", columnDefinition = "valdistanceverticalbase")),
        @AttributeOverride(name = "uom", column = @Column(name = "altitudeadjustmentuom", columnDefinition = "uomdistancevertical")),
        @AttributeOverride(name = "accuracy", column = @Column(name = "altitudeadjustmentaccuracy", columnDefinition = "numericalwithnilreason")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "altitudeadjustmentnilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setAltitudeAdjustmentItem(ValDistanceVerticalType target) {
        setAltitudeAdjustment(XmlAdapterUtils.marshallJAXBElement(ValDistanceVerticalType.class, new QName("http://www.aixm.aero/schema/5.2", "altitudeAdjustment"), AltitudeAdjustmentType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "localremotecode", columnDefinition = "codeyesnobase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "localremotecodenilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setLocalRemoteCodeItem(CodeYesNoType target) {
        setLocalRemoteCode(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.2", "localRemoteCode"), AltitudeAdjustmentType.class, target));
    }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        }
        {
            ...
            List<AltitudeAdjustmentExtensionType> theField;
