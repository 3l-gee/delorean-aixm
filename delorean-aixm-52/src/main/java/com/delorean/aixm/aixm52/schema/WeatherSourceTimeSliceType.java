...
/**
 * <p>Java class for WeatherSourceTimeSliceType complex type</p>.
 * 
 ...
 *         <element name="sensorType" type="{http://www.aixm.aero/schema/5.2}CodeWeatherSourceType" minOccurs="0"/>
 *         <element name="position" type="{http://www.aixm.aero/schema/5.2}ElevatedPointPropertyType" minOccurs="0"/>
 *         <element name="availability" type="{http://www.aixm.aero/schema/5.2}WeatherSourceAvailabilityPropertyType" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "WeatherSourceTimeSliceType", propOrder = {
    "designator",
    "sensorType",
    "position",
    "availability",
...
public class WeatherSourceTimeSliceType
    ...
    implements Serializable
{
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link CodeWeatherSourceType }{@code >}
     *     
     */
    @Transient
    ...
    @JoinTable(name = "wthrsrctmslctp_avlblt_l", schema = "airport_heliport", joinColumns = {
        @JoinColumn(name = "weathersource_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "wthrsrctmslctp_annttn_l", schema = "airport_heliport", joinColumns = {
        @JoinColumn(name = "weathersource_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setDesignatorItem(TextDesignatorType target) {
        setDesignator(XmlAdapterUtils.marshallJAXBElement(TextDesignatorType.class, new QName("http://www.aixm.aero/schema/5.2", "designator"), WeatherSourceTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "sensortype", columnDefinition = "codeweathersourcebase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "sensortypenilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setSensorTypeItem(CodeWeatherSourceType target) {
        setSensorType(XmlAdapterUtils.marshallJAXBElement(CodeWeatherSourceType.class, new QName("http://www.aixm.aero/schema/5.2", "sensorType"), WeatherSourceTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = AIXMElevatedPointPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "wthrsrctmslctp_pstn_l", schema = "airport_heliport", joinColumns = {
        @JoinColumn(name = "weathersource_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setPositionItem(AIXMElevatedPointPropertyType target) {
        setPosition(XmlAdapterUtils.marshallJAXBElement(AIXMElevatedPointPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "position"), WeatherSourceTimeSliceType.class, target));
    }
