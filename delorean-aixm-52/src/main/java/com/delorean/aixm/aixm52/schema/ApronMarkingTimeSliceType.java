 ...
 *         <element name="markingLocation" type="{http://www.aixm.aero/schema/5.2}CodeApronSectionType" minOccurs="0"/>
 *         <element name="markedApron" type="{http://www.aixm.aero/schema/5.2}ApronPropertyType" minOccurs="0"/>
 *         <element name="extension" maxOccurs="unbounded" minOccurs="0">
 *           <complexType>
 *             <complexContent>
 *               <restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 <choice>
 *                   <element ref="{http://www.aixm.aero/schema/5.2}AbstractApronMarkingExtension"/>
    ...
    implements Serializable
{
    ...
    @XmlElementRef(name = "markedApron", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    ...
    public void setMarkingICAOStandardItem(CodeYesNoType target) {
        setMarkingICAOStandard(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.2", "markingICAOStandard"), ApronMarkingTimeSliceType.class, target));
    }
    ...
    public void setConditionItem(CodeMarkingConditionType target) {
        setCondition(XmlAdapterUtils.marshallJAXBElement(CodeMarkingConditionType.class, new QName("http://www.aixm.aero/schema/5.2", "condition"), ApronMarkingTimeSliceType.class, target));
    }
    ...
    public void setMarkingLocationItem(CodeApronSectionType target) {
        setMarkingLocation(XmlAdapterUtils.marshallJAXBElement(CodeApronSectionType.class, new QName("http://www.aixm.aero/schema/5.2", "markingLocation"), ApronMarkingTimeSliceType.class, target));
    }
    ...
    public void setMarkedApronItem(ApronPropertyType target) {
        setMarkedApron(XmlAdapterUtils.marshallJAXBElement(ApronPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "markedApron"), ApronMarkingTimeSliceType.class, target));
    }
