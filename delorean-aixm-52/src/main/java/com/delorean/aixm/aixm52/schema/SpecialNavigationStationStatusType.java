    ...
    implements Serializable
{
    ...
    public void setOperationalStatusItem(CodeStatusNavaidType target) {
        setOperationalStatus(XmlAdapterUtils.marshallJAXBElement(CodeStatusNavaidType.class, new QName("http://www.aixm.aero/schema/5.2", "operationalStatus"), SpecialNavigationStationStatusType.class, target));
    }
