 ...
 *                   <element ref="{http://www.aixm.aero/schema/5.2}AbstractRadioCommunicationOperationalStatusExtension"/>
 *                 </choice>
    ...
    implements Serializable
{
    ...
    public void setOperationalStatusItem(CodeStatusServiceType target) {
        setOperationalStatus(XmlAdapterUtils.marshallJAXBElement(CodeStatusServiceType.class, new QName("http://www.aixm.aero/schema/5.2", "operationalStatus"), RadioCommunicationOperationalStatusType.class, target));
    }
