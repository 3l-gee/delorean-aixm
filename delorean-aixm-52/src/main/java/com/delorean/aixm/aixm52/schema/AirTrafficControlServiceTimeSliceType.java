 ...
 *       <sequence>
 *         <element name="flightOperations" type="{http://www.aixm.aero/schema/5.2}CodeFlightDestinationType" minOccurs="0"/>
 *         <element name="rank" type="{http://www.aixm.aero/schema/5.2}CodeFacilityRankingType" minOccurs="0"/>
 *         <element name="compliantICAO" type="{http://www.aixm.aero/schema/5.2}CodeYesNoType" minOccurs="0"/>
 ...
 *         <element name="serviceProvider" type="{http://www.aixm.aero/schema/5.2}UnitPropertyType" minOccurs="0"/>
 *         <element name="call-sign" type="{http://www.aixm.aero/schema/5.2}CallsignDetailPropertyType" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="radioCommunication" type="{http://www.aixm.aero/schema/5.2}RadioCommunicationChannelPropertyType" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="groundCommunication" type="{http://www.aixm.aero/schema/5.2}ContactInformationPropertyType" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="availability" type="{http://www.aixm.aero/schema/5.2}ServiceOperationalStatusPropertyType" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="annotation" type="{http://www.aixm.aero/schema/5.2}NotePropertyType" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="radarAssisted" type="{http://www.aixm.aero/schema/5.2}CodeYesNoType" minOccurs="0"/>
 *         <element name="dataLinkEnabled" type="{http://www.aixm.aero/schema/5.2}CodeYesNoType" minOccurs="0"/>
 *         <element name="dataLinkChannel" type="{http://www.aixm.aero/schema/5.2}CodeCommunicationChannelType" minOccurs="0"/>
 *         <element name="dataLinkStandard" type="{http://www.aixm.aero/schema/5.2}CodeDataLinkStandardType" minOccurs="0"/>
 *         <element name="type" type="{http://www.aixm.aero/schema/5.2}CodeServiceATCType" minOccurs="0"/>
 *         <element name="clientAirport" type="{http://www.aixm.aero/schema/5.2}AirportHeliportPropertyType" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="clientAirspace" type="{http://www.aixm.aero/schema/5.2}AirspacePropertyType" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="clientRoute" type="{http://www.aixm.aero/schema/5.2}RoutePortionPropertyType" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="clientProcedure" type="{http://www.aixm.aero/schema/5.2}ProcedurePropertyType" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="clientHolding" type="{http://www.aixm.aero/schema/5.2}HoldingPatternPropertyType" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="clientAerialRefuelling" type="{http://www.aixm.aero/schema/5.2}AerialRefuellingPropertyType" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="aircraftLocator" type="{http://www.aixm.aero/schema/5.2}DirectionFinderPropertyType" minOccurs="0"/>
 *         <element name="clientSegment" type="{http://www.aixm.aero/schema/5.2}RouteSegmentPropertyType" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="extension" maxOccurs="unbounded" minOccurs="0">
 *           <complexType>
 *             <complexContent>
 *               <restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 <choice>
 *                   <element ref="{http://www.aixm.aero/schema/5.2}AbstractAirTrafficControlServiceExtension"/>
 *                   <element ref="{http://www.aixm.aero/schema/5.2}AbstractTrafficSeparationServiceExtension"/>
...
@Entity(name = "AirTrafficControlServiceTimeSliceType")
@Table(name = "airtrafficcontrolservice_t", schema = "service")
    ...
    implements Serializable
{
    ...
    @XmlElementRef(name = "flightOperations", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "compliantICAO", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "serviceProvider", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "radarAssisted", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<CodeYesNoType> radarAssisted;
    @XmlElementRef(name = "dataLinkEnabled", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<CodeYesNoType> dataLinkEnabled;
    @XmlElementRef(name = "dataLinkChannel", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<CodeCommunicationChannelType> dataLinkChannel;
    @XmlElementRef(name = "dataLinkStandard", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<CodeDataLinkStandardType> dataLinkStandard;
    ...
    @XmlElementRef(name = "aircraftLocator", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<DirectionFinderPropertyType> aircraftLocator;
    @XmlElement(nillable = true)
    protected List<RouteSegmentPropertyType> clientSegment;
    protected List<AirTrafficControlServiceTimeSliceExtensionType> extension;
    ...
    @JoinTable(name = "artrffccntrlsrvctmslctp_cll-sgn_link", schema = "service", joinColumns = {
        @JoinColumn(name = "airtrafficcontrolservice_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "artrffccntrlsrvctmslctp_rdcmmnctn_link", schema = "service", joinColumns = {
        @JoinColumn(name = "airtrafficcontrolservice_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "artrffccntrlsrvctmslctp_grndcmmnctn_link", schema = "service", joinColumns = {
        @JoinColumn(name = "airtrafficcontrolservice_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "artrffccntrlsrvctmslctp_avlblt_link", schema = "service", joinColumns = {
        @JoinColumn(name = "airtrafficcontrolservice_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "artrffccntrlsrvctmslctp_annttn_link", schema = "service", joinColumns = {
        @JoinColumn(name = "airtrafficcontrolservice_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    /**
     * Gets the value of the dataLinkStandard property.
     * 
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link CodeDataLinkStandardType }{@code >}
     *     
     */
    @Transient
    public JAXBElement<CodeDataLinkStandardType> getDataLinkStandard() {
        return dataLinkStandard;
    }

    /**
     * Sets the value of the dataLinkStandard property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link CodeDataLinkStandardType }{@code >}
     *     
     */
    public void setDataLinkStandard(JAXBElement<CodeDataLinkStandardType> value) {
        this.dataLinkStandard = value;
    }

    @Transient
    public boolean isSetDataLinkStandard() {
        return (this.dataLinkStandard!= null);
    }
    ...
    @JoinTable(name = "artrffccntrlsrvctmslctp_clntarprt_link", schema = "service", joinColumns = {
        @JoinColumn(name = "airtrafficcontrolservice_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
        @JoinColumn(name = "clientairport_hjid", referencedColumnName = "hjid")
    })
    ...
    @JoinTable(name = "artrffccntrlsrvctmslctp_clntarspc_link", schema = "service", joinColumns = {
        @JoinColumn(name = "airtrafficcontrolservice_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
        @JoinColumn(name = "clientairspace_hjid", referencedColumnName = "hjid")
    })
     ...
     * 
     */
    @OneToMany(targetEntity = RoutePortionPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "artrffccntrlsrvctmslctp_clntrt_link", schema = "service", joinColumns = {
        @JoinColumn(name = "airtrafficcontrolservice_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
        @JoinColumn(name = "clientroute_hjid", referencedColumnName = "hjid")
    })
     ...
     * 
     */
    @OneToMany(targetEntity = ProcedurePropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "artrffccntrlsrvctmslctp_clntprcdr_link", schema = "service", joinColumns = {
        @JoinColumn(name = "airtrafficcontrolservice_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
        @JoinColumn(name = "clientprocedure_hjid", referencedColumnName = "hjid")
    })
     ...
     * 
     */
    @OneToMany(targetEntity = HoldingPatternPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "artrffccntrlsrvctmslctp_clnthldng_link", schema = "service", joinColumns = {
        @JoinColumn(name = "airtrafficcontrolservice_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
        @JoinColumn(name = "clientholding_hjid", referencedColumnName = "hjid")
    })
     ...
     * 
     */
    @OneToMany(targetEntity = AerialRefuellingPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "artrffccntrlsrvctmslctp_clntarlrfllng_link", schema = "service", joinColumns = {
        @JoinColumn(name = "airtrafficcontrolservice_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
        @JoinColumn(name = "clientaerialrefuelling_hjid", referencedColumnName = "hjid")
    })
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the clientSegment property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getClientSegment().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link RouteSegmentPropertyType }
     * 
     * 
     */
    @OneToMany(targetEntity = RouteSegmentPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "artrffccntrlsrvctmslctp_clntsgmnt_link", schema = "service", joinColumns = {
        @JoinColumn(name = "airtrafficcontrolservice_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
        @JoinColumn(name = "clientsegment_hjid", referencedColumnName = "hjid")
    })
    public List<RouteSegmentPropertyType> getClientSegment() {
        if (clientSegment == null) {
            clientSegment = new ArrayList<>();
        }
     ...
     * 
     */
    public void setClientSegment(List<RouteSegmentPropertyType> clientSegment) {
        this.clientSegment = clientSegment;
    }

    @Transient
    public boolean isSetClientSegment() {
        return ((this.clientSegment!= null)&&(!this.clientSegment.isEmpty()));
    }

    public void unsetClientSegment() {
     ...
     * 
     */
    @OneToMany(targetEntity = AirTrafficControlServiceTimeSliceExtensionType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinColumn(name = "airtrafficcontrolservice_te_hjid", referencedColumnName = "hjid")
    public List<AirTrafficControlServiceTimeSliceExtensionType> getExtension() {
        if (extension == null) {
     ...
     * 
     */
    public void setExtension(List<AirTrafficControlServiceTimeSliceExtensionType> extension) {
    ...
    public void setFlightOperationsItem(CodeFlightDestinationType target) {
        setFlightOperations(XmlAdapterUtils.marshallJAXBElement(CodeFlightDestinationType.class, new QName("http://www.aixm.aero/schema/5.2", "flightOperations"), AirTrafficControlServiceTimeSliceType.class, target));
    }
    ...
    public void setRankItem(CodeFacilityRankingType target) {
        setRank(XmlAdapterUtils.marshallJAXBElement(CodeFacilityRankingType.class, new QName("http://www.aixm.aero/schema/5.2", "rank"), AirTrafficControlServiceTimeSliceType.class, target));
    }
    ...
    public void setCompliantICAOItem(CodeYesNoType target) {
        setCompliantICAO(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.2", "compliantICAO"), AirTrafficControlServiceTimeSliceType.class, target));
    }
    ...
    public void setAixmNameItem(TextNameType target) {
        setAixmName(XmlAdapterUtils.marshallJAXBElement(TextNameType.class, new QName("http://www.aixm.aero/schema/5.2", "name"), AirTrafficControlServiceTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = AIXMElevatedPointPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "artrffccntrlsrvctmslctp_lctn_link", schema = "service", joinColumns = {
        @JoinColumn(name = "airtrafficcontrolservice_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setLocationItem(AIXMElevatedPointPropertyType target) {
        setLocation(XmlAdapterUtils.marshallJAXBElement(AIXMElevatedPointPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "location"), AirTrafficControlServiceTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = UnitPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "artrffccntrlsrvctmslctp_srvcprvdr_link", schema = "service", joinColumns = {
        @JoinColumn(name = "airtrafficcontrolservice_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setServiceProviderItem(UnitPropertyType target) {
        setServiceProvider(XmlAdapterUtils.marshallJAXBElement(UnitPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "serviceProvider"), AirTrafficControlServiceTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "radarassisted", columnDefinition = "codeyesnobase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "radarassistednilreason", columnDefinition = "nilreason"))
    })
    public CodeYesNoType getRadarAssistedItem() {
        return XmlAdapterUtils.unmarshallSource(CodeYesNoType.class, this.getRadarAssisted());
    }

    public void setRadarAssistedItem(CodeYesNoType target) {
        setRadarAssisted(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.2", "radarAssisted"), AirTrafficControlServiceTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "datalinkenabled", columnDefinition = "codeyesnobase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "datalinkenablednilreason", columnDefinition = "nilreason"))
    })
    public CodeYesNoType getDataLinkEnabledItem() {
        return XmlAdapterUtils.unmarshallSource(CodeYesNoType.class, this.getDataLinkEnabled());
    }

    public void setDataLinkEnabledItem(CodeYesNoType target) {
        setDataLinkEnabled(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.2", "dataLinkEnabled"), AirTrafficControlServiceTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "datalinkchannel", columnDefinition = "character3")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "datalinkchannelnilreason", columnDefinition = "nilreason"))
    })
    public CodeCommunicationChannelType getDataLinkChannelItem() {
        return XmlAdapterUtils.unmarshallSource(CodeCommunicationChannelType.class, this.getDataLinkChannel());
    }

    public void setDataLinkChannelItem(CodeCommunicationChannelType target) {
        setDataLinkChannel(XmlAdapterUtils.marshallJAXBElement(CodeCommunicationChannelType.class, new QName("http://www.aixm.aero/schema/5.2", "dataLinkChannel"), AirTrafficControlServiceTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "datalinkstandard", columnDefinition = "codedatalinkstandardbase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "datalinkstandardnilreason", columnDefinition = "nilreason"))
    })
    public CodeDataLinkStandardType getDataLinkStandardItem() {
        return XmlAdapterUtils.unmarshallSource(CodeDataLinkStandardType.class, this.getDataLinkStandard());
    }

    public void setDataLinkStandardItem(CodeDataLinkStandardType target) {
        setDataLinkStandard(XmlAdapterUtils.marshallJAXBElement(CodeDataLinkStandardType.class, new QName("http://www.aixm.aero/schema/5.2", "dataLinkStandard"), AirTrafficControlServiceTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "type", columnDefinition = "codeserviceatcbase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "typenilreason", columnDefinition = "nilreason"))
    })
    public CodeServiceATCType getTypeItem() {
        return XmlAdapterUtils.unmarshallSource(CodeServiceATCType.class, this.getType());
    }

    public void setTypeItem(CodeServiceATCType target) {
        setType(XmlAdapterUtils.marshallJAXBElement(CodeServiceATCType.class, new QName("http://www.aixm.aero/schema/5.2", "type"), AirTrafficControlServiceTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = DirectionFinderPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "artrffccntrlsrvctmslctp_arcrftlctr_link", schema = "service", joinColumns = {
        @JoinColumn(name = "airtrafficcontrolservice_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
        @JoinColumn(name = "aircraftlocator_hjid", referencedColumnName = "hjid")
    })
    public DirectionFinderPropertyType getAircraftLocatorItem() {
        return XmlAdapterUtils.unmarshallSource(DirectionFinderPropertyType.class, this.getAircraftLocator());
    }

    public void setAircraftLocatorItem(DirectionFinderPropertyType target) {
        setAircraftLocator(XmlAdapterUtils.marshallJAXBElement(DirectionFinderPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "aircraftLocator"), AirTrafficControlServiceTimeSliceType.class, target));
    }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        }
        {
            ...
            List<AirTrafficControlServiceTimeSliceExtensionType> lhsField;
            lhsField = (this.isSetExtension()?this.getExtension():null);
            List<AirTrafficControlServiceTimeSliceExtensionType> rhsField;
        ...
        {
            boolean lhsFieldIsSet = this.isSetDataLinkStandard();
            boolean rhsFieldIsSet = that.isSetDataLinkStandard();
            JAXBElement<CodeDataLinkStandardType> lhsField;
            lhsField = this.getDataLinkStandard();
            JAXBElement<CodeDataLinkStandardType> rhsField;
            rhsField = that.getDataLinkStandard();
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "dataLinkStandard", lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "dataLinkStandard", rhsField);
            if (!strategy.equals(lhsFieldLocator, rhsFieldLocator, lhsField, rhsField, lhsFieldIsSet, rhsFieldIsSet)) {
                return false;
            }
        }
        ...
        {
            boolean lhsFieldIsSet = this.isSetClientSegment();
            boolean rhsFieldIsSet = that.isSetClientSegment();
            List<RouteSegmentPropertyType> lhsField;
            lhsField = (this.isSetClientSegment()?this.getClientSegment():null);
            List<RouteSegmentPropertyType> rhsField;
            rhsField = (that.isSetClientSegment()?that.getClientSegment():null);
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "clientSegment", lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "clientSegment", rhsField);
            if (!strategy.equals(lhsFieldLocator, rhsFieldLocator, lhsField, rhsField, lhsFieldIsSet, rhsFieldIsSet)) {
                return false;
            }
        }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetRadarAssisted();
            JAXBElement<CodeYesNoType> theField;
            theField = this.getRadarAssisted();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "radarAssisted", theField);
            currentHashCode = strategy.hashCode(theFieldLocator, currentHashCode, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetDataLinkEnabled();
            JAXBElement<CodeYesNoType> theField;
            theField = this.getDataLinkEnabled();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "dataLinkEnabled", theField);
            currentHashCode = strategy.hashCode(theFieldLocator, currentHashCode, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetDataLinkChannel();
            JAXBElement<CodeCommunicationChannelType> theField;
            theField = this.getDataLinkChannel();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "dataLinkChannel", theField);
            currentHashCode = strategy.hashCode(theFieldLocator, currentHashCode, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetDataLinkStandard();
            JAXBElement<CodeDataLinkStandardType> theField;
            theField = this.getDataLinkStandard();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "dataLinkStandard", theField);
            currentHashCode = strategy.hashCode(theFieldLocator, currentHashCode, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetType();
            JAXBElement<CodeServiceATCType> theField;
        ...
        {
            boolean theFieldIsSet = this.isSetAircraftLocator();
            JAXBElement<DirectionFinderPropertyType> theField;
            theField = this.getAircraftLocator();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "aircraftLocator", theField);
            currentHashCode = strategy.hashCode(theFieldLocator, currentHashCode, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetClientSegment();
            List<RouteSegmentPropertyType> theField;
            theField = (this.isSetClientSegment()?this.getClientSegment():null);
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "clientSegment", theField);
            currentHashCode = strategy.hashCode(theFieldLocator, currentHashCode, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetExtension();
            List<AirTrafficControlServiceTimeSliceExtensionType> theField;
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        }
        {
            ...
            JAXBElement<CodeYesNoType> theField;
            theField = this.getRadarAssisted();
            strategy.appendField(locator, this, "radarAssisted", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetDataLinkEnabled();
            JAXBElement<CodeYesNoType> theField;
            theField = this.getDataLinkEnabled();
            strategy.appendField(locator, this, "dataLinkEnabled", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetDataLinkChannel();
            JAXBElement<CodeCommunicationChannelType> theField;
            theField = this.getDataLinkChannel();
            strategy.appendField(locator, this, "dataLinkChannel", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetDataLinkStandard();
            JAXBElement<CodeDataLinkStandardType> theField;
            theField = this.getDataLinkStandard();
            strategy.appendField(locator, this, "dataLinkStandard", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetType();
            JAXBElement<CodeServiceATCType> theField;
        ...
        }
        {
            ...
            JAXBElement<DirectionFinderPropertyType> theField;
            theField = this.getAircraftLocator();
            strategy.appendField(locator, this, "aircraftLocator", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetClientSegment();
            List<RouteSegmentPropertyType> theField;
            theField = (this.isSetClientSegment()?this.getClientSegment():null);
            strategy.appendField(locator, this, "clientSegment", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetExtension();
            List<AirTrafficControlServiceTimeSliceExtensionType> theField;
