 ...
 *                   <element ref="{http://www.aixm.aero/schema/5.2}AbstractUnitAvailabilityExtension"/>
 *                 </choice>
    ...
    implements Serializable
{
    ...
    public void setOperationalStatusItem(CodeStatusOperationsType target) {
        setOperationalStatus(XmlAdapterUtils.marshallJAXBElement(CodeStatusOperationsType.class, new QName("http://www.aixm.aero/schema/5.2", "operationalStatus"), UnitAvailabilityType.class, target));
    }
