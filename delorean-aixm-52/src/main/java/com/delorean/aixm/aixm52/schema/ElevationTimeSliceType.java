 ...
 *         <element name="angleNominal" type="{http://www.aixm.aero/schema/5.2}ValAngleType" minOccurs="0"/>
 *         <element name="angleMinimum" type="{http://www.aixm.aero/schema/5.2}ValAngleType" minOccurs="0"/>
 *         <element name="angleSpan" type="{http://www.aixm.aero/schema/5.2}ValAngleType" minOccurs="0"/>
 *         <element name="extension" maxOccurs="unbounded" minOccurs="0">
 *           <complexType>
 *             <complexContent>
 *               <restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 <choice>
 *                   <element ref="{http://www.aixm.aero/schema/5.2}AbstractElevationExtension"/>
    ...
    implements Serializable
{
    ...
    @XmlElementRef(name = "angleNominal", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<ValAngleType> angleNominal;
    @XmlElementRef(name = "angleMinimum", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<ValAngleType> angleMinimum;
    @XmlElementRef(name = "angleSpan", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    ...
    public void setDesignatorItem(CodeNavaidDesignatorType target) {
        setDesignator(XmlAdapterUtils.marshallJAXBElement(CodeNavaidDesignatorType.class, new QName("http://www.aixm.aero/schema/5.2", "designator"), ElevationTimeSliceType.class, target));
    }
    ...
    public void setAixmNameItem(TextNameType target) {
        setAixmName(XmlAdapterUtils.marshallJAXBElement(TextNameType.class, new QName("http://www.aixm.aero/schema/5.2", "name"), ElevationTimeSliceType.class, target));
    }
    ...
    public void setEmissionClassItem(CodeRadioEmissionType target) {
        setEmissionClass(XmlAdapterUtils.marshallJAXBElement(CodeRadioEmissionType.class, new QName("http://www.aixm.aero/schema/5.2", "emissionClass"), ElevationTimeSliceType.class, target));
    }
    ...
    public void setMobileItem(CodeYesNoType target) {
        setMobile(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.2", "mobile"), ElevationTimeSliceType.class, target));
    }
    ...
    public void setMagneticVariationItem(ValMagneticVariationType target) {
        setMagneticVariation(XmlAdapterUtils.marshallJAXBElement(ValMagneticVariationType.class, new QName("http://www.aixm.aero/schema/5.2", "magneticVariation"), ElevationTimeSliceType.class, target));
    }
    ...
    public void setDateMagneticVariationItem(DateYearType target) {
        setDateMagneticVariation(XmlAdapterUtils.marshallJAXBElement(DateYearType.class, new QName("http://www.aixm.aero/schema/5.2", "dateMagneticVariation"), ElevationTimeSliceType.class, target));
    }
    ...
    public void setFlightCheckedItem(CodeYesNoType target) {
        setFlightChecked(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.2", "flightChecked"), ElevationTimeSliceType.class, target));
    }
    ...
    public void setLocationItem(AIXMElevatedPointPropertyType target) {
        setLocation(XmlAdapterUtils.marshallJAXBElement(AIXMElevatedPointPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "location"), ElevationTimeSliceType.class, target));
    }
    ...
    @AttributeOverrides({
        ...
        @AttributeOverride(name = "accuracy", column = @Column(name = "anglenominalaccuracy", columnDefinition = "numericalwithnilreason"))
    })
    ...
    public void setAngleNominalItem(ValAngleType target) {
        setAngleNominal(XmlAdapterUtils.marshallJAXBElement(ValAngleType.class, new QName("http://www.aixm.aero/schema/5.2", "angleNominal"), ElevationTimeSliceType.class, target));
    }
    ...
    @AttributeOverrides({
        ...
        @AttributeOverride(name = "accuracy", column = @Column(name = "angleminimumaccuracy", columnDefinition = "numericalwithnilreason"))
    })
    ...
    public void setAngleMinimumItem(ValAngleType target) {
        setAngleMinimum(XmlAdapterUtils.marshallJAXBElement(ValAngleType.class, new QName("http://www.aixm.aero/schema/5.2", "angleMinimum"), ElevationTimeSliceType.class, target));
    }
    ...
    @AttributeOverrides({
        ...
        @AttributeOverride(name = "accuracy", column = @Column(name = "anglespanaccuracy", columnDefinition = "numericalwithnilreason"))
    })
    ...
    public void setAngleSpanItem(ValAngleType target) {
        setAngleSpan(XmlAdapterUtils.marshallJAXBElement(ValAngleType.class, new QName("http://www.aixm.aero/schema/5.2", "angleSpan"), ElevationTimeSliceType.class, target));
    }
