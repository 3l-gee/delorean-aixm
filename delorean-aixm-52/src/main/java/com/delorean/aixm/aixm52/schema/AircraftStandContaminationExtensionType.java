...
@Entity(name = "AircraftStandContaminationExtensionType")
@Table(name = "aircraftstandcontamination_oe", schema = "airport_heliport")
public class AircraftStandContaminationExtensionType implements Serializable, Equals, HashCode, ToString
{
    ...
    @JoinColumn(name = "abstractaircraftstandcontaminationextension_hjid", referencedColumnName = "hjid")
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        final AircraftStandContaminationExtensionType that = ((AircraftStandContaminationExtensionType) object);
        {
