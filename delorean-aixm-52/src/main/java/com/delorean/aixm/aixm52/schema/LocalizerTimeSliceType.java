 ...
 *       <sequence>
 *         <element name="designator" type="{http://www.aixm.aero/schema/5.2}CodeNavaidDesignatorType" minOccurs="0"/>
 *         <element name="name" type="{http://www.aixm.aero/schema/5.2}TextNameType" minOccurs="0"/>
 *         <element name="emissionClass" type="{http://www.aixm.aero/schema/5.2}CodeRadioEmissionType" minOccurs="0"/>
 *         <element name="mobile" type="{http://www.aixm.aero/schema/5.2}CodeYesNoType" minOccurs="0"/>
 ...
 *         <element name="authority" type="{http://www.aixm.aero/schema/5.2}AuthorityForNavaidEquipmentPropertyType" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="monitoring" type="{http://www.aixm.aero/schema/5.2}NavaidEquipmentMonitoringPropertyType" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="availability" type="{http://www.aixm.aero/schema/5.2}NavaidOperationalStatusPropertyType" maxOccurs="unbounded" minOccurs="0"/>
 ...
 *         <element name="declination" type="{http://www.aixm.aero/schema/5.2}ValMagneticVariationType" minOccurs="0"/>
 *         <element name="widthCourse" type="{http://www.aixm.aero/schema/5.2}ValAngleType" minOccurs="0"/>
 *         <element name="backCourseUsable" type="{http://www.aixm.aero/schema/5.2}CodeILSBackCourseType" minOccurs="0"/>
 *         <element name="signalPerformance" type="{http://www.aixm.aero/schema/5.2}CodeSignalPerformanceILSType" minOccurs="0"/>
 *         <element name="courseQuality" type="{http://www.aixm.aero/schema/5.2}CodeCourseQualityILSType" minOccurs="0"/>
 *         <element name="integrityLevel" type="{http://www.aixm.aero/schema/5.2}CodeIntegrityLevelILSType" minOccurs="0"/>
 *         <element name="extension" maxOccurs="unbounded" minOccurs="0">
 *           <complexType>
 *             <complexContent>
 *               <restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 <choice>
 *                   <element ref="{http://www.aixm.aero/schema/5.2}AbstractLocalizerExtension"/>
    ...
    implements Serializable
{
    ...
    @XmlElementRef(name = "declination", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<ValMagneticVariationType> declination;
    @XmlElementRef(name = "widthCourse", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<ValAngleType> widthCourse;
    @XmlElementRef(name = "backCourseUsable", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<CodeILSBackCourseType> backCourseUsable;
    @XmlElementRef(name = "signalPerformance", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<CodeSignalPerformanceILSType> signalPerformance;
    @XmlElementRef(name = "courseQuality", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<CodeCourseQualityILSType> courseQuality;
    @XmlElementRef(name = "integrityLevel", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    ...
    public void setDesignatorItem(CodeNavaidDesignatorType target) {
        setDesignator(XmlAdapterUtils.marshallJAXBElement(CodeNavaidDesignatorType.class, new QName("http://www.aixm.aero/schema/5.2", "designator"), LocalizerTimeSliceType.class, target));
    }
    ...
    public void setAixmNameItem(TextNameType target) {
        setAixmName(XmlAdapterUtils.marshallJAXBElement(TextNameType.class, new QName("http://www.aixm.aero/schema/5.2", "name"), LocalizerTimeSliceType.class, target));
    }
    ...
    public void setEmissionClassItem(CodeRadioEmissionType target) {
        setEmissionClass(XmlAdapterUtils.marshallJAXBElement(CodeRadioEmissionType.class, new QName("http://www.aixm.aero/schema/5.2", "emissionClass"), LocalizerTimeSliceType.class, target));
    }
    ...
    public void setMobileItem(CodeYesNoType target) {
        setMobile(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.2", "mobile"), LocalizerTimeSliceType.class, target));
    }
    ...
    public void setMagneticVariationItem(ValMagneticVariationType target) {
        setMagneticVariation(XmlAdapterUtils.marshallJAXBElement(ValMagneticVariationType.class, new QName("http://www.aixm.aero/schema/5.2", "magneticVariation"), LocalizerTimeSliceType.class, target));
    }
    ...
    public void setDateMagneticVariationItem(DateYearType target) {
        setDateMagneticVariation(XmlAdapterUtils.marshallJAXBElement(DateYearType.class, new QName("http://www.aixm.aero/schema/5.2", "dateMagneticVariation"), LocalizerTimeSliceType.class, target));
    }
    ...
    public void setFlightCheckedItem(CodeYesNoType target) {
        setFlightChecked(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.2", "flightChecked"), LocalizerTimeSliceType.class, target));
    }
    ...
    public void setLocationItem(AIXMElevatedPointPropertyType target) {
        setLocation(XmlAdapterUtils.marshallJAXBElement(AIXMElevatedPointPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "location"), LocalizerTimeSliceType.class, target));
    }
    ...
    public void setFrequencyItem(ValFrequencyType target) {
        setFrequency(XmlAdapterUtils.marshallJAXBElement(ValFrequencyType.class, new QName("http://www.aixm.aero/schema/5.2", "frequency"), LocalizerTimeSliceType.class, target));
    }
    ...
    public void setMagneticBearingItem(ValBearingType target) {
        setMagneticBearing(XmlAdapterUtils.marshallJAXBElement(ValBearingType.class, new QName("http://www.aixm.aero/schema/5.2", "magneticBearing"), LocalizerTimeSliceType.class, target));
    }
    ...
    public void setTrueBearingItem(ValBearingType target) {
        setTrueBearing(XmlAdapterUtils.marshallJAXBElement(ValBearingType.class, new QName("http://www.aixm.aero/schema/5.2", "trueBearing"), LocalizerTimeSliceType.class, target));
    }
    ...
    @AttributeOverrides({
        ...
        @AttributeOverride(name = "accuracy", column = @Column(name = "declinationaccuracy", columnDefinition = "numericalwithnilreason"))
    })
    ...
    public void setDeclinationItem(ValMagneticVariationType target) {
        setDeclination(XmlAdapterUtils.marshallJAXBElement(ValMagneticVariationType.class, new QName("http://www.aixm.aero/schema/5.2", "declination"), LocalizerTimeSliceType.class, target));
    }
    ...
    @AttributeOverrides({
        ...
        @AttributeOverride(name = "accuracy", column = @Column(name = "widthcourseaccuracy", columnDefinition = "numericalwithnilreason"))
    })
    ...
    public void setWidthCourseItem(ValAngleType target) {
        setWidthCourse(XmlAdapterUtils.marshallJAXBElement(ValAngleType.class, new QName("http://www.aixm.aero/schema/5.2", "widthCourse"), LocalizerTimeSliceType.class, target));
    }
    ...
    public void setBackCourseUsableItem(CodeILSBackCourseType target) {
        setBackCourseUsable(XmlAdapterUtils.marshallJAXBElement(CodeILSBackCourseType.class, new QName("http://www.aixm.aero/schema/5.2", "backCourseUsable"), LocalizerTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "signalperformance", columnDefinition = "codesignalperformanceilsbase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "signalperformancenilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setSignalPerformanceItem(CodeSignalPerformanceILSType target) {
        setSignalPerformance(XmlAdapterUtils.marshallJAXBElement(CodeSignalPerformanceILSType.class, new QName("http://www.aixm.aero/schema/5.2", "signalPerformance"), LocalizerTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "coursequality", columnDefinition = "codecoursequalityilsbase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "coursequalitynilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setCourseQualityItem(CodeCourseQualityILSType target) {
        setCourseQuality(XmlAdapterUtils.marshallJAXBElement(CodeCourseQualityILSType.class, new QName("http://www.aixm.aero/schema/5.2", "courseQuality"), LocalizerTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "integritylevel", columnDefinition = "codeintegritylevelilsbase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "integritylevelnilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setIntegrityLevelItem(CodeIntegrityLevelILSType target) {
        setIntegrityLevel(XmlAdapterUtils.marshallJAXBElement(CodeIntegrityLevelILSType.class, new QName("http://www.aixm.aero/schema/5.2", "integrityLevel"), LocalizerTimeSliceType.class, target));
    }
