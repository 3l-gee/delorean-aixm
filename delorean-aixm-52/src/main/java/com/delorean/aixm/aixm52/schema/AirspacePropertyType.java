...
/**
 * <p>Java class for AirspacePropertyType complex type</p>.
 * 
...
@XmlType(name = "AirspacePropertyType")
@Entity(name = "AirspacePropertyType")
@Table(name = "airspacepropertytype", schema = "airspace")
public class AirspacePropertyType implements Serializable, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        final AirspacePropertyType that = ((AirspacePropertyType) object);
        {
