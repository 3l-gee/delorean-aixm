...
/**
 * <p>Java class for WeatherSourceAvailabilityPropertyType complex type</p>.
 * 
 ...
 *       <sequence>
 *         <element ref="{http://www.aixm.aero/schema/5.2}WeatherSourceAvailability"/>
 *       </sequence>
 *     </extension>
 *   </complexContent>
 * </complexType>
...
@XmlType(name = "WeatherSourceAvailabilityPropertyType", propOrder = {
    ...
    implements Serializable
{
     ...
     * @return
     *     possible object is
     *     {@link WeatherSourceAvailabilityType }
     *     
     */
    @OneToOne(targetEntity = WeatherSourceAvailabilityType.class, cascade = {
        CascadeType.ALL
