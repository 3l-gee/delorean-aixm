 ...
 *         <element name="classification" type="{http://www.aixm.aero/schema/5.2}CodeAirspaceClassificationType" minOccurs="0"/>
 *         <element name="associatedLevels" type="{http://www.aixm.aero/schema/5.2}AirspaceLayerPropertyType" maxOccurs="unbounded" minOccurs="0"/>
 ...
 *                   <element ref="{http://www.aixm.aero/schema/5.2}AbstractAirspaceLayerClassExtension"/>
 *                 </choice>
    ...
    implements Serializable
{
    ...
    @XmlElementRef(name = "classification", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    ...
    public void setClassificationItem(CodeAirspaceClassificationType target) {
        setClassification(XmlAdapterUtils.marshallJAXBElement(CodeAirspaceClassificationType.class, new QName("http://www.aixm.aero/schema/5.2", "classification"), AirspaceLayerClassType.class, target));
    }
