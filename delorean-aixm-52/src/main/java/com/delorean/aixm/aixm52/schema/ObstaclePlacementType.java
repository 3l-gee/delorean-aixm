 ...
 *       <sequence>
 *         <element name="obstacleBearing" type="{http://www.aixm.aero/schema/5.2}ValBearingType" minOccurs="0"/>
 *         <element name="obstacleDistance" type="{http://www.aixm.aero/schema/5.2}ValDistanceType" minOccurs="0"/>
 *         <element name="pointType" type="{http://www.aixm.aero/schema/5.2}TextNameType" minOccurs="0"/>
 *         <element name="obstaclePlacement" type="{http://www.aixm.aero/schema/5.2}CodeSideType" minOccurs="0"/>
 ...
 *                 <choice>
 *                   <element ref="{http://www.aixm.aero/schema/5.2}AbstractObstaclePlacementExtension"/>
 *                 </choice>
    ...
    implements Serializable
{
    ...
    @XmlElementRef(name = "obstacleBearing", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<ValBearingType> obstacleBearing;
    @XmlElementRef(name = "obstacleDistance", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<ValDistanceType> obstacleDistance;
    @XmlElementRef(name = "pointType", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<TextNameType> pointType;
    @XmlElementRef(name = "obstaclePlacement", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    ...
    @JoinTable(name = "obstclplcmnttp_annttn_l", schema = "shared", joinColumns = {
    ...
    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "obstaclebearing", columnDefinition = "valbearingbase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "obstaclebearingnilreason", columnDefinition = "nilreason")),
        @AttributeOverride(name = "accuracy", column = @Column(name = "obstaclebearingaccuracy", columnDefinition = "numericalwithnilreason"))
    })
    ...
    public void setObstacleBearingItem(ValBearingType target) {
        setObstacleBearing(XmlAdapterUtils.marshallJAXBElement(ValBearingType.class, new QName("http://www.aixm.aero/schema/5.2", "obstacleBearing"), ObstaclePlacementType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "obstacledistance", columnDefinition = "valdistancebase")),
        @AttributeOverride(name = "uom", column = @Column(name = "obstacledistanceuom", columnDefinition = "uomdistance")),
        @AttributeOverride(name = "accuracy", column = @Column(name = "obstacledistanceaccuracy", columnDefinition = "numericalwithnilreason")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "obstacledistancenilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setObstacleDistanceItem(ValDistanceType target) {
        setObstacleDistance(XmlAdapterUtils.marshallJAXBElement(ValDistanceType.class, new QName("http://www.aixm.aero/schema/5.2", "obstacleDistance"), ObstaclePlacementType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "pointtype", columnDefinition = "character2")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "pointtypenilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setPointTypeItem(TextNameType target) {
        setPointType(XmlAdapterUtils.marshallJAXBElement(TextNameType.class, new QName("http://www.aixm.aero/schema/5.2", "pointType"), ObstaclePlacementType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "obstacleplacement", columnDefinition = "codesidebase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "obstacleplacementnilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setObstaclePlacementItem(CodeSideType target) {
        setObstaclePlacement(XmlAdapterUtils.marshallJAXBElement(CodeSideType.class, new QName("http://www.aixm.aero/schema/5.2", "obstaclePlacement"), ObstaclePlacementType.class, target));
    }
