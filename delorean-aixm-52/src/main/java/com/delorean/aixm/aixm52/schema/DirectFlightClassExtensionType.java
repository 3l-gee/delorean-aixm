...
@Entity(name = "DirectFlightClassExtensionType")
@Table(name = "directflightclass_oe", schema = "route")
public class DirectFlightClassExtensionType implements Serializable, Equals, HashCode, ToString
{
    ...
    @JoinColumn(name = "abstractdirectflightclassextension_hjid", referencedColumnName = "hjid")
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        final DirectFlightClassExtensionType that = ((DirectFlightClassExtensionType) object);
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetAbstractDirectFlightExtension();
            AbstractExtensionType theField;
            theField = this.getAbstractDirectFlightExtension();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "abstractDirectFlightExtension", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            AbstractExtensionType theField;
            theField = this.getAbstractDirectFlightExtension();
            strategy.appendField(locator, this, "abstractDirectFlightExtension", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetAbstractDirectFlightClassExtension();
            AbstractExtensionType theField;
            theField = this.getAbstractDirectFlightClassExtension();
            strategy.appendField(locator, this, "abstractDirectFlightClassExtension", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetOwns();
            boolean theField;
