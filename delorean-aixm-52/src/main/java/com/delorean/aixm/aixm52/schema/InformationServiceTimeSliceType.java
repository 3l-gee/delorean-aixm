 ...
 *         <element name="type" type="{http://www.aixm.aero/schema/5.2}CodeServiceInformationType" minOccurs="0"/>
 *         <element name="voice" type="{http://www.aixm.aero/schema/5.2}CodeYesNoType" minOccurs="0"/>
 *         <element name="dataLink" type="{http://www.aixm.aero/schema/5.2}CodeYesNoType" minOccurs="0"/>
 *         <element name="recorded" type="{http://www.aixm.aero/schema/5.2}CodeYesNoType" minOccurs="0"/>
 *         <element name="navaidBroadcast" type="{http://www.aixm.aero/schema/5.2}VORPropertyType" maxOccurs="unbounded" minOccurs="0"/>
 ...
 *         <element name="dataSource" type="{http://www.aixm.aero/schema/5.2}WeatherSourcePropertyType" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="extension" maxOccurs="unbounded" minOccurs="0">
 *           <complexType>
 *             <complexContent>
 *               <restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 <choice>
 *                   <element ref="{http://www.aixm.aero/schema/5.2}AbstractInformationServiceExtension"/>
...
@Table(name = "informationservice_t", schema = "service")
    ...
    implements Serializable
{
    ...
    @XmlElementRef(name = "voice", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<CodeYesNoType> voice;
    @XmlElementRef(name = "dataLink", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    protected JAXBElement<CodeYesNoType> dataLink;
    @XmlElementRef(name = "recorded", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    ...
    protected List<WeatherSourcePropertyType> aixmDataSource;
    protected List<InformationServiceTimeSliceExtensionType> extension;
    ...
    @JoinTable(name = "infrmtnsrvctmslctp_cll-sgn_link", schema = "service", joinColumns = {
        @JoinColumn(name = "informationservice_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "infrmtnsrvctmslctp_rdcmmnctn_link", schema = "service", joinColumns = {
        @JoinColumn(name = "informationservice_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "infrmtnsrvctmslctp_grndcmmnctn_link", schema = "service", joinColumns = {
        @JoinColumn(name = "informationservice_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "infrmtnsrvctmslctp_avlblt_link", schema = "service", joinColumns = {
        @JoinColumn(name = "informationservice_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "infrmtnsrvctmslctp_annttn_link", schema = "service", joinColumns = {
        @JoinColumn(name = "informationservice_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
     ...
     * 
     */
    @OneToMany(targetEntity = VORPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "infrmtnsrvctmslctp_nvdbrdcst_link", schema = "service", joinColumns = {
        @JoinColumn(name = "informationservice_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
        @JoinColumn(name = "navaidbroadcast_hjid", referencedColumnName = "hjid")
    })
    ...
    @JoinTable(name = "infrmtnsrvctmslctp_clntarspc_link", schema = "service", joinColumns = {
        @JoinColumn(name = "informationservice_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "infrmtnsrvctmslctp_clntarprt_link", schema = "service", joinColumns = {
        @JoinColumn(name = "informationservice_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "infrmtnsrvctmslctp_clntrt_link", schema = "service", joinColumns = {
        @JoinColumn(name = "informationservice_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "infrmtnsrvctmslctp_clntprcdr_link", schema = "service", joinColumns = {
        @JoinColumn(name = "informationservice_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "infrmtnsrvctmslctp_clnthldng_link", schema = "service", joinColumns = {
        @JoinColumn(name = "informationservice_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "infrmtnsrvctmslctp_clntarlrfllng_link", schema = "service", joinColumns = {
        @JoinColumn(name = "informationservice_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "infrmtnsrvctmslctp_clntsgmnt_link", schema = "service", joinColumns = {
        @JoinColumn(name = "informationservice_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    /**
     * Gets the value of the aixmDataSource property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the aixmDataSource property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getAixmDataSource().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link WeatherSourcePropertyType }
     * 
     * 
     */
    @OneToMany(targetEntity = WeatherSourcePropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "infrmtnsrvctmslctp_dtsrc_link", schema = "service", joinColumns = {
        @JoinColumn(name = "informationservice_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
        @JoinColumn(name = "datasource_hjid", referencedColumnName = "hjid")
    })
    public List<WeatherSourcePropertyType> getAixmDataSource() {
        if (aixmDataSource == null) {
            aixmDataSource = new ArrayList<>();
        }
        return this.aixmDataSource;
    }
     ...
     * 
     */
    public void setAixmDataSource(List<WeatherSourcePropertyType> aixmDataSource) {
        this.aixmDataSource = aixmDataSource;
    }

    @Transient
    public boolean isSetAixmDataSource() {
        return ((this.aixmDataSource!= null)&&(!this.aixmDataSource.isEmpty()));
    }

    public void unsetAixmDataSource() {
        this.aixmDataSource = null;
    }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link InformationServiceTimeSliceExtensionType }
     * 
     * 
     */
    @OneToMany(targetEntity = InformationServiceTimeSliceExtensionType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinColumn(name = "informationservice_te_hjid", referencedColumnName = "hjid")
    public List<InformationServiceTimeSliceExtensionType> getExtension() {
        if (extension == null) {
     ...
     * 
     */
    public void setExtension(List<InformationServiceTimeSliceExtensionType> extension) {
    ...
    public void setFlightOperationsItem(CodeFlightDestinationType target) {
        setFlightOperations(XmlAdapterUtils.marshallJAXBElement(CodeFlightDestinationType.class, new QName("http://www.aixm.aero/schema/5.2", "flightOperations"), InformationServiceTimeSliceType.class, target));
    }
    ...
    public void setRankItem(CodeFacilityRankingType target) {
        setRank(XmlAdapterUtils.marshallJAXBElement(CodeFacilityRankingType.class, new QName("http://www.aixm.aero/schema/5.2", "rank"), InformationServiceTimeSliceType.class, target));
    }
    ...
    public void setCompliantICAOItem(CodeYesNoType target) {
        setCompliantICAO(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.2", "compliantICAO"), InformationServiceTimeSliceType.class, target));
    }
    ...
    public void setAixmNameItem(TextNameType target) {
        setAixmName(XmlAdapterUtils.marshallJAXBElement(TextNameType.class, new QName("http://www.aixm.aero/schema/5.2", "name"), InformationServiceTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = AIXMElevatedPointPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "infrmtnsrvctmslctp_lctn_link", schema = "service", joinColumns = {
        @JoinColumn(name = "informationservice_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setLocationItem(AIXMElevatedPointPropertyType target) {
        setLocation(XmlAdapterUtils.marshallJAXBElement(AIXMElevatedPointPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "location"), InformationServiceTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = UnitPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "infrmtnsrvctmslctp_srvcprvdr_link", schema = "service", joinColumns = {
        @JoinColumn(name = "informationservice_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setServiceProviderItem(UnitPropertyType target) {
        setServiceProvider(XmlAdapterUtils.marshallJAXBElement(UnitPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "serviceProvider"), InformationServiceTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "type", columnDefinition = "codeserviceinformationbase")),
    ...
    public void setTypeItem(CodeServiceInformationType target) {
        setType(XmlAdapterUtils.marshallJAXBElement(CodeServiceInformationType.class, new QName("http://www.aixm.aero/schema/5.2", "type"), InformationServiceTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "voice", columnDefinition = "codeyesnobase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "voicenilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setVoiceItem(CodeYesNoType target) {
        setVoice(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.2", "voice"), InformationServiceTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "datalink", columnDefinition = "codeyesnobase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "datalinknilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setDataLinkItem(CodeYesNoType target) {
        setDataLink(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.2", "dataLink"), InformationServiceTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "recorded", columnDefinition = "codeyesnobase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "recordednilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setRecordedItem(CodeYesNoType target) {
        setRecorded(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.2", "recorded"), InformationServiceTimeSliceType.class, target));
    }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        }
        {
            ...
            List<InformationServiceTimeSliceExtensionType> lhsField;
            lhsField = (this.isSetExtension()?this.getExtension():null);
            List<InformationServiceTimeSliceExtensionType> rhsField;
        ...
        {
            boolean lhsFieldIsSet = this.isSetAixmDataSource();
            boolean rhsFieldIsSet = that.isSetAixmDataSource();
            List<WeatherSourcePropertyType> lhsField;
            lhsField = (this.isSetAixmDataSource()?this.getAixmDataSource():null);
            List<WeatherSourcePropertyType> rhsField;
            rhsField = (that.isSetAixmDataSource()?that.getAixmDataSource():null);
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "aixmDataSource", lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "aixmDataSource", rhsField);
            if (!strategy.equals(lhsFieldLocator, rhsFieldLocator, lhsField, rhsField, lhsFieldIsSet, rhsFieldIsSet)) {
                return false;
            }
        }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetAixmDataSource();
            List<WeatherSourcePropertyType> theField;
            theField = (this.isSetAixmDataSource()?this.getAixmDataSource():null);
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "aixmDataSource", theField);
            currentHashCode = strategy.hashCode(theFieldLocator, currentHashCode, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetExtension();
            List<InformationServiceTimeSliceExtensionType> theField;
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        }
        {
            ...
            List<WeatherSourcePropertyType> theField;
            theField = (this.isSetAixmDataSource()?this.getAixmDataSource():null);
            strategy.appendField(locator, this, "aixmDataSource", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetExtension();
            List<InformationServiceTimeSliceExtensionType> theField;
