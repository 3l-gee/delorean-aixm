...
@Entity(name = "ApronAreaAvailabilityExtensionType")
@Table(name = "apronareaavailability_oe", schema = "airport_heliport")
public class ApronAreaAvailabilityExtensionType implements Serializable, Equals, HashCode, ToString
{
    ...
    @JoinColumn(name = "abstractapronareaavailabilityextension_hjid", referencedColumnName = "hjid")
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        final ApronAreaAvailabilityExtensionType that = ((ApronAreaAvailabilityExtensionType) object);
        {
            ...
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "abstractApronAreaAvailabilityExtension", lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "abstractApronAreaAvailabilityExtension", rhsField);
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetAbstractApronAreaAvailabilityExtension();
            AbstractExtensionType theField;
            theField = this.getAbstractApronAreaAvailabilityExtension();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "abstractApronAreaAvailabilityExtension", theField);
            currentHashCode = strategy.hashCode(theFieldLocator, currentHashCode, theField, theFieldIsSet);
        }
        {
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        }
        {
            ...
            AbstractExtensionType theField;
            theField = this.getAbstractApronAreaAvailabilityExtension();
            strategy.appendField(locator, this, "abstractApronAreaAvailabilityExtension", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetOwns();
            boolean theField;
