 ...
 *       <sequence>
 *         <element name="type" type="{http://www.aixm.aero/schema/5.2}CodeEquipmentUnavailableType" minOccurs="0"/>
 *         <element name="approachLightingInoperative" type="{http://www.aixm.aero/schema/5.2}CodeYesNoType" minOccurs="0"/>
 *         <element name="adjustmentINOPCol" type="{http://www.aixm.aero/schema/5.2}EquipmentUnavailableAdjustmentColumnPropertyType" maxOccurs="unbounded" minOccurs="0"/>
 ...
 *                 <choice>
 *                   <element ref="{http://www.aixm.aero/schema/5.2}AbstractEquipmentUnavailableAdjustmentExtension"/>
 *                 </choice>
    ...
    implements Serializable
{
    ...
    public void setTypeItem(CodeEquipmentUnavailableType target) {
        setType(XmlAdapterUtils.marshallJAXBElement(CodeEquipmentUnavailableType.class, new QName("http://www.aixm.aero/schema/5.2", "type"), EquipmentUnavailableAdjustmentType.class, target));
    }
    ...
    public void setApproachLightingInoperativeItem(CodeYesNoType target) {
        setApproachLightingInoperative(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.2", "approachLightingInoperative"), EquipmentUnavailableAdjustmentType.class, target));
    }
