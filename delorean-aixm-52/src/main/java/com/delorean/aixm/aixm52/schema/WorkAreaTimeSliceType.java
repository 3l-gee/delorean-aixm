...
/**
 * <p>
 * Java class for WorkAreaTimeSliceType complex type
 * </p>
 * .
 *
 * <p>
...
"{http://www.aixm.aero/schema/5.2}CodeWorkAreaType" minOccurs="0"/>
 *         <element name="plannedOperational" type=
...
"{http://www.aixm.aero/schema/5.2}WorkareaActivityPropertyType" maxOccurs=
 ...
 *                 <sequence>
 *                   <element ref=
"{http://www.aixm.aero/schema/5.2}AbstractWorkAreaExtension"/>
 *                 </sequence>
 *                 <attGroup ref=
...
@XmlType(name = "WorkAreaTimeSliceType", propOrder = {"type", "plannedOperational", "associatedAirportHeliport",
        "extent", "activation", "annotation", "extension"})
@Entity(name = "WorkAreaTimeSliceType")
@Table(name = "workarea_t", schema = "airport_heliport")
public class WorkAreaTimeSliceType extends AbstractAIXMTimeSliceType implements Serializable {
    ...
    @XmlElementRef(name = "plannedOperational", namespace = "http://www.aixm.aero/schema/5.2", type = JAXBElement.class, required = false)
    ...
    protected List<WorkAreaTimeSliceExtensionType> extension;

    /**
     * Gets the value of the type property.
     *
     * @return possible object is {@link JAXBElement
     *         }{@code <}{@link CodeWorkAreaType }{@code >}
     *
     */
    @Transient
     ...
     *
     */
    @OneToMany(targetEntity = WorkareaActivityPropertyType.class, cascade = {CascadeType.ALL}, fetch = FetchType.EAGER)
    @JoinTable(name = "wrkartmslctp_actvtn_link", schema = "airport_heliport", joinColumns = {
            @JoinColumn(name = "workarea_t_hjid", referencedColumnName = "hjid")}, inverseJoinColumns = {
    ...
    @JoinTable(name = "wrkartmslctp_annttn_link", schema = "airport_heliport", joinColumns = {
            @JoinColumn(name = "workarea_t_hjid", referencedColumnName = "hjid")}, inverseJoinColumns = {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link WorkAreaTimeSliceExtensionType }
     *
     *
     */
    @OneToMany(targetEntity = WorkAreaTimeSliceExtensionType.class, cascade = {
            CascadeType.ALL}, fetch = FetchType.EAGER)
    @JoinColumn(name = "workarea_te_hjid", referencedColumnName = "hjid")
    public List<WorkAreaTimeSliceExtensionType> getExtension() {
        if (extension == null) {
     ...
     *
     */
    public void setExtension(List<WorkAreaTimeSliceExtensionType> extension) {
    ...
    public void setTypeItem(CodeWorkAreaType target) {
        setType(XmlAdapterUtils.marshallJAXBElement(CodeWorkAreaType.class,
                new QName("http://www.aixm.aero/schema/5.2", "type"), WorkAreaTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({@AttributeOverride(name = "value", column = @Column(name = "plannedoperational")),
            @AttributeOverride(name = "nilReason", column = @Column(name = "plannedoperationalnilreason"))})
    ...
    public void setPlannedOperationalItem(DateType target) {
        setPlannedOperational(XmlAdapterUtils.marshallJAXBElement(DateType.class,
                new QName("http://www.aixm.aero/schema/5.2", "plannedOperational"), WorkAreaTimeSliceType.class,
                target));
    }

    @OneToOne(targetEntity = AirportHeliportPropertyType.class, cascade = {CascadeType.ALL}, fetch = FetchType.EAGER)
    @JoinTable(name = "wrkartmslctp_assctdarprthlprt_link", schema = "airport_heliport", joinColumns = {
            @JoinColumn(name = "workarea_t_hjid", referencedColumnName = "hjid")}, inverseJoinColumns = {
    ...
    public void setAssociatedAirportHeliportItem(AirportHeliportPropertyType target) {
        setAssociatedAirportHeliport(XmlAdapterUtils.marshallJAXBElement(AirportHeliportPropertyType.class,
                new QName("http://www.aixm.aero/schema/5.2", "associatedAirportHeliport"), WorkAreaTimeSliceType.class,
                target));
    }

    @OneToOne(targetEntity = AIXMElevatedSurfacePropertyType.class, cascade = {
            CascadeType.ALL}, fetch = FetchType.EAGER)
    @JoinTable(name = "wrkartmslctp_extnt_link", schema = "airport_heliport", joinColumns = {
            @JoinColumn(name = "workarea_t_hjid", referencedColumnName = "hjid")}, inverseJoinColumns = {
    ...
    public void setExtentItem(AIXMElevatedSurfacePropertyType target) {
        setExtent(XmlAdapterUtils.marshallJAXBElement(AIXMElevatedSurfacePropertyType.class,
                new QName("http://www.aixm.aero/schema/5.2", "extent"), WorkAreaTimeSliceType.class, target));
    }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final WorkAreaTimeSliceType that = ((WorkAreaTimeSliceType) object);
        {
            ...
            List<WorkAreaTimeSliceExtensionType> lhsField;
            lhsField = (this.isSetExtension() ? this.getExtension() : null);
            List<WorkAreaTimeSliceExtensionType> rhsField;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        }
        {
            ...
            List<WorkAreaTimeSliceExtensionType> theField;
