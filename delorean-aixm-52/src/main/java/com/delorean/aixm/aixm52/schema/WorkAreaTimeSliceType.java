 ...
 *       <sequence>
 *         <element name="type" type="{http://www.aixm.aero/schema/5.2}CodeWorkAreaType" minOccurs="0"/>
 *         <element name="plannedOperational" type="{http://www.aixm.aero/schema/5.2}DateType" minOccurs="0"/>
 ...
 *         <element name="activation" type="{http://www.aixm.aero/schema/5.2}WorkareaActivityPropertyType" maxOccurs="unbounded" minOccurs="0"/>
 ...
 *                 <sequence>
 *                   <element ref="{http://www.aixm.aero/schema/5.2}AbstractWorkAreaExtension"/>
 *                 </sequence>
    ...
    implements Serializable
{
    ...
    public void setTypeItem(CodeWorkAreaType target) {
        setType(XmlAdapterUtils.marshallJAXBElement(CodeWorkAreaType.class, new QName("http://www.aixm.aero/schema/5.2", "type"), WorkAreaTimeSliceType.class, target));
    }
    ...
    public void setPlannedOperationalItem(DateType target) {
        setPlannedOperational(XmlAdapterUtils.marshallJAXBElement(DateType.class, new QName("http://www.aixm.aero/schema/5.2", "plannedOperational"), WorkAreaTimeSliceType.class, target));
    }
    ...
    public void setAssociatedAirportHeliportItem(AirportHeliportPropertyType target) {
        setAssociatedAirportHeliport(XmlAdapterUtils.marshallJAXBElement(AirportHeliportPropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "associatedAirportHeliport"), WorkAreaTimeSliceType.class, target));
    }
    ...
    public void setExtentItem(AIXMElevatedSurfacePropertyType target) {
        setExtent(XmlAdapterUtils.marshallJAXBElement(AIXMElevatedSurfacePropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "extent"), WorkAreaTimeSliceType.class, target));
    }
