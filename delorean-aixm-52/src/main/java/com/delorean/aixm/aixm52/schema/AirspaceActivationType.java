 ...
 *         <element name="activity" type="{http://www.aixm.aero/schema/5.2}CodeAirspaceActivityType" minOccurs="0"/>
 *         <element name="status" type="{http://www.aixm.aero/schema/5.2}CodeStatusAirspaceType" minOccurs="0"/>
 *         <element name="levels" type="{http://www.aixm.aero/schema/5.2}AirspaceLayerPropertyType" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="user" type="{http://www.aixm.aero/schema/5.2}OrganisationAuthorityPropertyType" maxOccurs="unbounded" minOccurs="0"/>
 ...
 *                   <element ref="{http://www.aixm.aero/schema/5.2}AbstractAirspaceActivationExtension"/>
 *                 </choice>
    ...
    implements Serializable
{
    ...
    public void setActivityItem(CodeAirspaceActivityType target) {
        setActivity(XmlAdapterUtils.marshallJAXBElement(CodeAirspaceActivityType.class, new QName("http://www.aixm.aero/schema/5.2", "activity"), AirspaceActivationType.class, target));
    }
    ...
    public void setStatusItem(CodeStatusAirspaceType target) {
        setStatus(XmlAdapterUtils.marshallJAXBElement(CodeStatusAirspaceType.class, new QName("http://www.aixm.aero/schema/5.2", "status"), AirspaceActivationType.class, target));
    }
