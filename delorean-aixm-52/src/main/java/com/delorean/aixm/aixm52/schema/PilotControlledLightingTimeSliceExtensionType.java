...
@XmlType(name = "", propOrder = {"abstractPilotControlledLightingExtension"})
@Entity(name = "PilotControlledLightingTimeSliceExtensionType")
@Table(name = "pilotcontrolledlighting_te", schema = "service")
public class PilotControlledLightingTimeSliceExtensionType implements Serializable, Equals, HashCode, ToString {
    ...
    @JoinColumn(name = "abstractpilotcontrolledlightingextension_hjid", referencedColumnName = "hjid")
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final PilotControlledLightingTimeSliceExtensionType that = ((PilotControlledLightingTimeSliceExtensionType) object);
        {
        ...
        }
        {
            ...
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator,
                    "abstractPilotControlledLightingExtension", lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator,
                    "abstractPilotControlledLightingExtension", rhsField);
            if (!strategy.equals(lhsFieldLocator, rhsFieldLocator, lhsField, rhsField, lhsFieldIsSet, rhsFieldIsSet)) {
                return false;
            }
        }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetAbstractPilotControlledLightingExtension();
            AbstractExtensionType theField;
            theField = this.getAbstractPilotControlledLightingExtension();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "abstractPilotControlledLightingExtension",
                    theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            AbstractExtensionType theField;
            theField = this.getAbstractPilotControlledLightingExtension();
            strategy.appendField(locator, this, "abstractPilotControlledLightingExtension", buffer, theField,
                    theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetOwns();
