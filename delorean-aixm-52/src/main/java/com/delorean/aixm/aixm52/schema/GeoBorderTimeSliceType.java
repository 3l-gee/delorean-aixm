 ...
 *         <element name="type" type="{http://www.aixm.aero/schema/5.2}CodeGeoBorderType" minOccurs="0"/>
 *         <element name="border" type="{http://www.aixm.aero/schema/5.2}CurvePropertyType" minOccurs="0"/>
 ...
 *                 <sequence>
 *                   <element ref="{http://www.aixm.aero/schema/5.2}AbstractGeoBorderExtension"/>
 *                 </sequence>
    ...
    implements Serializable
{
    ...
    public void setAixmNameItem(TextNameType target) {
        setAixmName(XmlAdapterUtils.marshallJAXBElement(TextNameType.class, new QName("http://www.aixm.aero/schema/5.2", "name"), GeoBorderTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "type", columnDefinition = "codegeoborderbase")),
    ...
    public void setTypeItem(CodeGeoBorderType target) {
        setType(XmlAdapterUtils.marshallJAXBElement(CodeGeoBorderType.class, new QName("http://www.aixm.aero/schema/5.2", "type"), GeoBorderTimeSliceType.class, target));
    }
    ...
    public void setBorderItem(AIXMCurvePropertyType target) {
        setBorder(XmlAdapterUtils.marshallJAXBElement(AIXMCurvePropertyType.class, new QName("http://www.aixm.aero/schema/5.2", "border"), GeoBorderTimeSliceType.class, target));
    }
