package com.delorean.aixm.aixm52.unit;
...
public class ContainerAIXM52Test {
    ...
    void configDeloreanCore() {
        ...
        // given
        firstContainer = deloreanAIXM52.createNewContainer();

        // container is successfully created
        assertThat(firstContainer).isNotNull();

        // container is correctly configured
        assertThat(firstContainer.getRootClass()).isEqualTo(com.delorean.aixm.aixm52.schema.message.AIXMBasicMessageType.class);
        assertThat(firstContainer.getFeatureClass()).isEqualTo(com.delorean.aixm.aixm52.schema.AbstractAIXMFeatureType.class);
        assertThat(firstContainer.getTimeSliceClass()).isEqualTo(com.delorean.aixm.aixm52.schema.AbstractAIXMTimeSliceType.class);
        assertThat(firstContainer.getObjectClass()).isEqualTo(com.delorean.aixm.aixm52.schema.AbstractAIXMObjectType.class);
    ...
    void addNewContainer() {
        ...
        secondContainer = deloreanAIXM52.createNewContainer();

        // container is successfully created
        assertThat(secondContainer).isNotNull();

        // container is correctly configured
        assertThat(secondContainer.getRootClass()).isEqualTo(com.delorean.aixm.aixm52.schema.message.AIXMBasicMessageType.class);
        assertThat(secondContainer.getFeatureClass()).isEqualTo(com.delorean.aixm.aixm52.schema.AbstractAIXMFeatureType.class);
        assertThat(secondContainer.getTimeSliceClass()).isEqualTo(com.delorean.aixm.aixm52.schema.AbstractAIXMTimeSliceType.class);
        assertThat(secondContainer.getObjectClass()).isEqualTo(com.delorean.aixm.aixm52.schema.AbstractAIXMObjectType.class);
