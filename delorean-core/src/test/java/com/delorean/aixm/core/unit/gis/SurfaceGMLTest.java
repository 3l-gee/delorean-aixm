package com.delorean.aixm.core.unit.gis;
                    ...
                    GisUtil.polygon(0L,
                        GisUtil.ring(null,
                            GisUtil.GMLCurve("e1", 0L, GeometricType.GML, null,
                                GisUtil.line(0L,
                                    GisUtil.posList("4326", "LINESTRING(13.377717264214601 52.51630693440871, -77.03654820204511 38.89763528280979, -70.1916580926402 -24.589287528217096, 18.411155413722216 -33.9034433595103, 13.377717264214601 52.51630693440871)")
                                )
                            )
                        )
                    )
                    ...
                    GisUtil.polygon(0L,
                        ...
                        GisUtil.ring(0L,
                            GisUtil.GMLCurve("i1", 0L, GeometricType.GML, null,
                                GisUtil.line(0L,
                                    GisUtil.posList("4326", "LINESTRING(8.500405759632237 47.457661694315526, 8.5869315810565 47.44362506469117, 8.564957389137748 47.38261839625727, 8.564957389137748 47.38261839625727, 8.500405759632237 47.457661694315526)")
                                )
                            )
                        ),
                        GisUtil.ring(1L,
                            GisUtil.GMLCurve("i2", 0L, GeometricType.GML, null,
                                GisUtil.line(0L,
                                    GisUtil.posList("4326", "LINESTRING(8.383867948906243 47.56581942557537, 8.415345303858395 47.5709303379544, 8.394814759365808 47.576918419662654, 8.383867948906243 47.56581942557537)")
                                )
                            )
                        )
                    )
