...
/**
 * <p>
 * Java class for MemberName_PropertyType complex type
 * </p>
 * .
 *
 * <p>
...
@XmlType(name = "MemberName_PropertyType", propOrder = {"memberName"})
public class MemberNamePropertyType implements Serializable, Equals, HashCode, ToString {
     ...
     *
     * @return possible object is {@link MemberNameType }
     *
     */
     ...
     *
     * @param value
     *            allowed object is {@link MemberNameType }
     *
     */
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final MemberNamePropertyType that = ((MemberNamePropertyType) object);
        {
        ...
        {
            boolean lhsFieldIsSet = this.isSetMemberName();
            boolean rhsFieldIsSet = that.isSetMemberName();
            MemberNameType lhsField;
            lhsField = this.getMemberName();
            MemberNameType rhsField;
            rhsField = that.getMemberName();
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "memberName", lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "memberName", rhsField);
            if (!strategy.equals(lhsFieldLocator, rhsFieldLocator, lhsField, rhsField, lhsFieldIsSet, rhsFieldIsSet)) {
                return false;
            }
        }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetMemberName();
            MemberNameType theField;
            theField = this.getMemberName();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "memberName", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            MemberNameType theField;
            theField = this.getMemberName();
            strategy.appendField(locator, this, "memberName", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetNilReason();
            String theField;
