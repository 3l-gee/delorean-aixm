...
@XmlType(name = "MetaDataPropertyType", propOrder = {"abstractMetaData"})
public class MetaDataPropertyType implements Serializable, Equals, HashCode, ToString {
     ...
     *         }{@code <}{@link AbstractMetaDataType }{@code >} {@link JAXBElement
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        {
            boolean lhsFieldIsSet = this.isSetAbout();
            boolean rhsFieldIsSet = that.isSetAbout();
            String lhsField;
            lhsField = this.getAbout();
            String rhsField;
            rhsField = that.getAbout();
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "about", lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "about", rhsField);
        ...
        {
            boolean lhsFieldIsSet = this.isSetAbstractMetaData();
            boolean rhsFieldIsSet = that.isSetAbstractMetaData();
            JAXBElement<? extends AbstractMetaDataType> lhsField;
            lhsField = this.getAbstractMetaData();
            JAXBElement<? extends AbstractMetaDataType> rhsField;
            rhsField = that.getAbstractMetaData();
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "abstractMetaData", lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "abstractMetaData", rhsField);
            if (!strategy.equals(lhsFieldLocator, rhsFieldLocator, lhsField, rhsField, lhsFieldIsSet, rhsFieldIsSet)) {
                return false;
            }
        }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetAbstractMetaData();
            JAXBElement<? extends AbstractMetaDataType> theField;
            theField = this.getAbstractMetaData();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "abstractMetaData", theField);
            currentHashCode = strategy.hashCode(theFieldLocator, currentHashCode, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetAbout();
            String theField;
            theField = this.getAbout();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "about", theField);
            currentHashCode = strategy.hashCode(theFieldLocator, currentHashCode, theField, theFieldIsSet);
        }
        {
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            JAXBElement<? extends AbstractMetaDataType> theField;
            theField = this.getAbstractMetaData();
            strategy.appendField(locator, this, "abstractMetaData", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetAbout();
            String theField;
            theField = this.getAbout();
            strategy.appendField(locator, this, "about", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetNilReason();
            String theField;
