...
/**
 * <p>
 * Java class for MD_ApplicationSchemaInformation_PropertyType complex type
 * </p>
 * .
 *
 * <p>
 ...
 *         <element ref=
"{http://www.isotc211.org/2005/gmd}MD_ApplicationSchemaInformation"/>
 *       </sequence>
...
@XmlType(name = "MD_ApplicationSchemaInformation_PropertyType", propOrder = {"mdApplicationSchemaInformation"})
public class MDApplicationSchemaInformationPropertyType implements Serializable, Equals, HashCode, ToString {
     ...
     *
     * @return possible object is {@link MDApplicationSchemaInformationType }
     *
     */
     ...
     *
     * @param value
     *            allowed object is {@link MDApplicationSchemaInformationType }
     *
     */
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final MDApplicationSchemaInformationPropertyType that = ((MDApplicationSchemaInformationPropertyType) object);
        {
        ...
        {
            boolean lhsFieldIsSet = this.isSetMDApplicationSchemaInformation();
            boolean rhsFieldIsSet = that.isSetMDApplicationSchemaInformation();
            MDApplicationSchemaInformationType lhsField;
            lhsField = this.getMDApplicationSchemaInformation();
            MDApplicationSchemaInformationType rhsField;
            rhsField = that.getMDApplicationSchemaInformation();
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "mdApplicationSchemaInformation",
                    lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "mdApplicationSchemaInformation",
                    rhsField);
            if (!strategy.equals(lhsFieldLocator, rhsFieldLocator, lhsField, rhsField, lhsFieldIsSet, rhsFieldIsSet)) {
                return false;
            }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetMDApplicationSchemaInformation();
            MDApplicationSchemaInformationType theField;
            theField = this.getMDApplicationSchemaInformation();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "mdApplicationSchemaInformation", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            MDApplicationSchemaInformationType theField;
            theField = this.getMDApplicationSchemaInformation();
            strategy.appendField(locator, this, "mdApplicationSchemaInformation", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetNilReason();
            String theField;
