...
/**
 * <p>Java class for MD_Metadata_PropertyType complex type</p>.
 * 
...
public class MDMetadataPropertyType implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        {
            boolean lhsFieldIsSet = (this.mdMetadata!= null);
            boolean rhsFieldIsSet = (that.mdMetadata!= null);
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = (this.mdMetadata!= null);
