...
/**
 * <p>
 * Java class for MD_Distribution_PropertyType complex type
 * </p>
 * .
 *
 * <p>
...
@XmlType(name = "MD_Distribution_PropertyType", propOrder = {"mdDistribution"})
public class MDDistributionPropertyType implements Serializable, Equals, HashCode, ToString {
     ...
     *
     * @return possible object is {@link MDDistributionType }
     *
     */
     ...
     *
     * @param value
     *            allowed object is {@link MDDistributionType }
     *
     */
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final MDDistributionPropertyType that = ((MDDistributionPropertyType) object);
        {
        ...
        {
            boolean lhsFieldIsSet = this.isSetMDDistribution();
            boolean rhsFieldIsSet = that.isSetMDDistribution();
            MDDistributionType lhsField;
            lhsField = this.getMDDistribution();
            MDDistributionType rhsField;
            rhsField = that.getMDDistribution();
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "mdDistribution", lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "mdDistribution", rhsField);
            if (!strategy.equals(lhsFieldLocator, rhsFieldLocator, lhsField, rhsField, lhsFieldIsSet, rhsFieldIsSet)) {
                return false;
            }
        }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetMDDistribution();
            MDDistributionType theField;
            theField = this.getMDDistribution();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "mdDistribution", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            MDDistributionType theField;
            theField = this.getMDDistribution();
            strategy.appendField(locator, this, "mdDistribution", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetNilReason();
            String theField;
