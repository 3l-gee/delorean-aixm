...
/**
 * <p>
 * Java class for MD_CharacterSetCode_PropertyType complex type
 * </p>
 * .
 *
 * <p>
...
@XmlType(name = "MD_CharacterSetCode_PropertyType", propOrder = {"mdCharacterSetCode"})
public class MDCharacterSetCodePropertyType implements Serializable, Equals, HashCode, ToString {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        {
            boolean lhsFieldIsSet = this.isSetMDCharacterSetCode();
            boolean rhsFieldIsSet = that.isSetMDCharacterSetCode();
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetMDCharacterSetCode();
            CodeListValueType theField;
            theField = this.getMDCharacterSetCode();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "mdCharacterSetCode", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            CodeListValueType theField;
            theField = this.getMDCharacterSetCode();
            strategy.appendField(locator, this, "mdCharacterSetCode", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetNilReason();
            String theField;
