...
/**
 * <p>
 * Java class for LI_Source_PropertyType complex type
 * </p>
 * .
 *
 * <p>
...
@XmlType(name = "LI_Source_PropertyType", propOrder = {"liSource"})
public class LISourcePropertyType implements Serializable, Equals, HashCode, ToString {
     ...
     *
     * @return possible object is {@link LISourceType }
     *
     */
     ...
     *
     * @param value
     *            allowed object is {@link LISourceType }
     *
     */
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final LISourcePropertyType that = ((LISourcePropertyType) object);
        {
        ...
        {
            boolean lhsFieldIsSet = this.isSetLISource();
            boolean rhsFieldIsSet = that.isSetLISource();
            LISourceType lhsField;
            lhsField = this.getLISource();
            LISourceType rhsField;
            rhsField = that.getLISource();
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "liSource", lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "liSource", rhsField);
            if (!strategy.equals(lhsFieldLocator, rhsFieldLocator, lhsField, rhsField, lhsFieldIsSet, rhsFieldIsSet)) {
                return false;
            }
        }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetLISource();
            LISourceType theField;
            theField = this.getLISource();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "liSource", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            LISourceType theField;
            theField = this.getLISource();
            strategy.appendField(locator, this, "liSource", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetNilReason();
            String theField;
