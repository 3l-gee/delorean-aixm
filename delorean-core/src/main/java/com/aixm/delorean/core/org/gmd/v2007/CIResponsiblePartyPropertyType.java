...
/**
 * <p>
 * Java class for CI_ResponsibleParty_PropertyType complex type
 * </p>
 * .
 *
 * <p>
...
@XmlType(name = "CI_ResponsibleParty_PropertyType", propOrder = {"ciResponsibleParty"})
public class CIResponsiblePartyPropertyType implements Serializable, Equals, HashCode, ToString {
     ...
     *
     * @return possible object is {@link CIResponsiblePartyType }
     *
     */
     ...
     *
     * @param value
     *            allowed object is {@link CIResponsiblePartyType }
     *
     */
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final CIResponsiblePartyPropertyType that = ((CIResponsiblePartyPropertyType) object);
        {
        ...
        {
            boolean lhsFieldIsSet = this.isSetCIResponsibleParty();
            boolean rhsFieldIsSet = that.isSetCIResponsibleParty();
            CIResponsiblePartyType lhsField;
            lhsField = this.getCIResponsibleParty();
            CIResponsiblePartyType rhsField;
            rhsField = that.getCIResponsibleParty();
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "ciResponsibleParty", lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "ciResponsibleParty", rhsField);
            if (!strategy.equals(lhsFieldLocator, rhsFieldLocator, lhsField, rhsField, lhsFieldIsSet, rhsFieldIsSet)) {
                return false;
            }
        }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetCIResponsibleParty();
            CIResponsiblePartyType theField;
            theField = this.getCIResponsibleParty();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "ciResponsibleParty", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            CIResponsiblePartyType theField;
            theField = this.getCIResponsibleParty();
            strategy.appendField(locator, this, "ciResponsibleParty", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetNilReason();
            String theField;
