 ...
 *
 * <p>
 * Java class for TimeEdgePropertyType complex type
 * </p>
 * .
 *
 * <p>
...
@XmlType(name = "TimeEdgePropertyType", propOrder = {"timeEdge"})
public class TimeEdgePropertyType implements Serializable, Equals, HashCode, ToString {

    private static final long serialVersionUID = 20251104L;
    /**
     * A time edge is a one-dimensional topological primitive. It is an open
     * interval that starts and ends at a node. The edge may be realised as a
     * geometry whose value is a time period.
     *
     */
     ...
     * geometry whose value is a time period.
     *
     * @return possible object is {@link TimeEdgeType }
     *
     */
     ...
     *
     * @param value
     *            allowed object is {@link TimeEdgeType }
     *
     * @see #getTimeEdge()
     */
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        {
            boolean lhsFieldIsSet = this.isSetTimeEdge();
            boolean rhsFieldIsSet = that.isSetTimeEdge();
            TimeEdgeType lhsField;
            lhsField = this.getTimeEdge();
            TimeEdgeType rhsField;
            rhsField = that.getTimeEdge();
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "timeEdge", lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "timeEdge", rhsField);
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetTimeEdge();
            TimeEdgeType theField;
            theField = this.getTimeEdge();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "timeEdge", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            TimeEdgeType theField;
            theField = this.getTimeEdge();
            strategy.appendField(locator, this, "timeEdge", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetNilReason();
            String theField;
