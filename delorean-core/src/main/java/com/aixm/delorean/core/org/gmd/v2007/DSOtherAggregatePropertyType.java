...
/**
 * <p>
 * Java class for DS_OtherAggregate_PropertyType complex type
 * </p>
 * .
 *
 * <p>
...
@XmlType(name = "DS_OtherAggregate_PropertyType", propOrder = {"dsOtherAggregate"})
public class DSOtherAggregatePropertyType implements Serializable, Equals, HashCode, ToString {
     ...
     *         }{@code <}{@link DSOtherAggregateType }{@code >} {@link JAXBElement
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final DSOtherAggregatePropertyType that = ((DSOtherAggregatePropertyType) object);
        {
            boolean lhsFieldIsSet = this.isSetDSOtherAggregate();
            boolean rhsFieldIsSet = that.isSetDSOtherAggregate();
            JAXBElement<? extends DSOtherAggregateType> lhsField;
            lhsField = this.getDSOtherAggregate();
            JAXBElement<? extends DSOtherAggregateType> rhsField;
            rhsField = that.getDSOtherAggregate();
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "dsOtherAggregate", lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "dsOtherAggregate", rhsField);
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetDSOtherAggregate();
            JAXBElement<? extends DSOtherAggregateType> theField;
            theField = this.getDSOtherAggregate();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "dsOtherAggregate", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            JAXBElement<? extends DSOtherAggregateType> theField;
            theField = this.getDSOtherAggregate();
            strategy.appendField(locator, this, "dsOtherAggregate", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetNilReason();
            String theField;
