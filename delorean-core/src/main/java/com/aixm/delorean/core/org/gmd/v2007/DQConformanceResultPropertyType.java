...
/**
 * <p>
 * Java class for DQ_ConformanceResult_PropertyType complex type
 * </p>
 * .
 *
 * <p>
...
@XmlType(name = "DQ_ConformanceResult_PropertyType", propOrder = {"dqConformanceResult"})
public class DQConformanceResultPropertyType implements Serializable, Equals, HashCode, ToString {
     ...
     *
     * @return possible object is {@link DQConformanceResultType }
     *
     */
     ...
     *
     * @param value
     *            allowed object is {@link DQConformanceResultType }
     *
     */
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final DQConformanceResultPropertyType that = ((DQConformanceResultPropertyType) object);
        {
        ...
        {
            boolean lhsFieldIsSet = this.isSetDQConformanceResult();
            boolean rhsFieldIsSet = that.isSetDQConformanceResult();
            DQConformanceResultType lhsField;
            lhsField = this.getDQConformanceResult();
            DQConformanceResultType rhsField;
            rhsField = that.getDQConformanceResult();
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "dqConformanceResult", lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "dqConformanceResult", rhsField);
            if (!strategy.equals(lhsFieldLocator, rhsFieldLocator, lhsField, rhsField, lhsFieldIsSet, rhsFieldIsSet)) {
                return false;
            }
        }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetDQConformanceResult();
            DQConformanceResultType theField;
            theField = this.getDQConformanceResult();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "dqConformanceResult", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            DQConformanceResultType theField;
            theField = this.getDQConformanceResult();
            strategy.appendField(locator, this, "dqConformanceResult", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetNilReason();
            String theField;
