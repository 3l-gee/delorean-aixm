 ...
 *   <complexContent>
 *     <extension base=
"{http://www.opengis.net/gml/3.2}AbstractTimeGeometricPrimitiveType">
 *       <sequence>
 *         <choice>
 *           <element name="beginPosition" type=
"{http://www.opengis.net/gml/3.2}TimePositionType"/>
 *           <element name="begin" type=
...
"{http://www.opengis.net/gml/3.2}TimeInstantPropertyType"/>
 *         </choice>
 *         <group ref="{http://www.opengis.net/gml/3.2}timeLength" minOccurs=
"0"/>
 *       </sequence>
 *     </extension>
 *   </complexContent>
...
@XmlType(name = "TimePeriodType", propOrder = {"beginPosition", "begin", "endPosition", "end", "duration",
        "timeInterval"})
public class TimePeriodType extends AbstractTimeGeometricPrimitiveType implements Serializable {
     ...
     * values for temporal length. ISO 11404 syntax specifies the use of a
     * positiveInteger together with appropriate values for radix and factor. The
     * resolution of the time interval is to one radix ^(-factor) of the specified
     * time unit. The value of the unit is either selected from the units for time
     * intervals from ISO 31-1:1992, or is another suitable unit. The encoding is
     * defined for GML in gml:TimeUnitType. The second component of this union type
     * provides a method for indicating time units other than the six standard units
     * given in the enumeration.
     *
     */
