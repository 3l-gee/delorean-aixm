...
import com.aixm.delorean.core.org.gml.v_3_2.AbstractCRSType;
import com.aixm.delorean.core.org.gml.v_3_2.AbstractGeneralDerivedCRSType;
import com.aixm.delorean.core.org.gml.v_3_2.CompoundCRSType;
import com.aixm.delorean.core.org.gml.v_3_2.DerivedCRSType;
import com.aixm.delorean.core.org.gml.v_3_2.EngineeringCRSType;
import com.aixm.delorean.core.org.gml.v_3_2.GeocentricCRSType;
import com.aixm.delorean.core.org.gml.v_3_2.GeodeticCRSType;
import com.aixm.delorean.core.org.gml.v_3_2.GeographicCRSType;
import com.aixm.delorean.core.org.gml.v_3_2.ImageCRSType;
import com.aixm.delorean.core.org.gml.v_3_2.ProjectedCRSType;
import com.aixm.delorean.core.org.gml.v_3_2.TemporalCRSType;
import com.aixm.delorean.core.org.gml.v_3_2.VerticalCRSType;
...
/**
 * <p>
 * Java class for SC_CRS_PropertyType complex type
 * </p>
 * .
 *
 * <p>
...
@XmlType(name = "SC_CRS_PropertyType", propOrder = {"abstractCRS"})
public class SCCRSPropertyType implements Serializable, Equals, HashCode, ToString {

    private static final long serialVersionUID = 20251104L;
    /**
     * gml:AbstractCRS specifies a coordinate reference system which is usually
     * single but may be compound. This abstract complex type shall not be used,
     * extended, or restricted, in a GML Application Schema, to define a concrete
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final SCCRSPropertyType that = ((SCCRSPropertyType) object);
        {
        ...
        {
            boolean lhsFieldIsSet = this.isSetAbstractCRS();
            boolean rhsFieldIsSet = that.isSetAbstractCRS();
            JAXBElement<? extends AbstractCRSType> lhsField;
            lhsField = this.getAbstractCRS();
            JAXBElement<? extends AbstractCRSType> rhsField;
            rhsField = that.getAbstractCRS();
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "abstractCRS", lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "abstractCRS", rhsField);
            if (!strategy.equals(lhsFieldLocator, rhsFieldLocator, lhsField, rhsField, lhsFieldIsSet, rhsFieldIsSet)) {
                return false;
            }
        }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetAbstractCRS();
            JAXBElement<? extends AbstractCRSType> theField;
            theField = this.getAbstractCRS();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "abstractCRS", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            JAXBElement<? extends AbstractCRSType> theField;
            theField = this.getAbstractCRS();
            strategy.appendField(locator, this, "abstractCRS", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetNilReason();
            String theField;
