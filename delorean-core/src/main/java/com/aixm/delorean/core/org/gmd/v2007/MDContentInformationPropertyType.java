...
/**
 * <p>
 * Java class for MD_ContentInformation_PropertyType complex type
 * </p>
 * .
 *
 * <p>
 ...
 *         <element ref=
"{http://www.isotc211.org/2005/gmd}AbstractMD_ContentInformation"/>
 *       </sequence>
...
@XmlType(name = "MD_ContentInformation_PropertyType", propOrder = {"abstractMDContentInformation"})
public class MDContentInformationPropertyType implements Serializable, Equals, HashCode, ToString {
     ...
     *         {@link JAXBElement }{@code <}{@link MDCoverageDescriptionType
     ...
     *            }{@code >} {@link JAXBElement
     *            }{@code <}{@link MDFeatureCatalogueDescriptionType }{@code >}
     *            {@link JAXBElement }{@code <}{@link MDImageDescriptionType
     *            }{@code >}
     *
     */
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final MDContentInformationPropertyType that = ((MDContentInformationPropertyType) object);
        {
        ...
        {
            boolean lhsFieldIsSet = this.isSetAbstractMDContentInformation();
            boolean rhsFieldIsSet = that.isSetAbstractMDContentInformation();
            JAXBElement<? extends AbstractMDContentInformationType> lhsField;
            lhsField = this.getAbstractMDContentInformation();
            JAXBElement<? extends AbstractMDContentInformationType> rhsField;
            rhsField = that.getAbstractMDContentInformation();
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "abstractMDContentInformation",
                    lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "abstractMDContentInformation",
                    rhsField);
            if (!strategy.equals(lhsFieldLocator, rhsFieldLocator, lhsField, rhsField, lhsFieldIsSet, rhsFieldIsSet)) {
                return false;
            }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetAbstractMDContentInformation();
            JAXBElement<? extends AbstractMDContentInformationType> theField;
            theField = this.getAbstractMDContentInformation();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "abstractMDContentInformation", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            JAXBElement<? extends AbstractMDContentInformationType> theField;
            theField = this.getAbstractMDContentInformation();
            strategy.appendField(locator, this, "abstractMDContentInformation", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetNilReason();
            String theField;
