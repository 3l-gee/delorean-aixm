...
public class MultiPointPropertyType implements Serializable, Equals, HashCode, ToString {
     ...
     * (gml:pointMember) or the array property (gml:pointMembers). It is also valid
     ...
     * to use both the "standard" and the array properties in the same collection.
     *
     * @return possible object is {@link MultiPointType }
     *
     */
     ...
     *
     * @param value
     *            allowed object is {@link MultiPointType }
     *
     * @see #getMultiPoint()
     */
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        {
            boolean lhsFieldIsSet = this.isSetMultiPoint();
            boolean rhsFieldIsSet = that.isSetMultiPoint();
            MultiPointType lhsField;
            lhsField = this.getMultiPoint();
            MultiPointType rhsField;
            rhsField = that.getMultiPoint();
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "multiPoint", lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "multiPoint", rhsField);
            if (!strategy.equals(lhsFieldLocator, rhsFieldLocator, lhsField, rhsField, lhsFieldIsSet, rhsFieldIsSet)) {
                return false;
            }
        }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetMultiPoint();
            MultiPointType theField;
            theField = this.getMultiPoint();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "multiPoint", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            MultiPointType theField;
            theField = this.getMultiPoint();
            strategy.appendField(locator, this, "multiPoint", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetOwns();
            boolean theField;
