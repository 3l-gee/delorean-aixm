...
public class DQConceptualConsistencyPropertyType implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        {
            boolean lhsFieldIsSet = (this.dqConceptualConsistency!= null);
            boolean rhsFieldIsSet = (that.dqConceptualConsistency!= null);
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = (this.dqConceptualConsistency!= null);
