...
/**
 * The base type for coverages is gml:AbstractCoverageType. The basic elements
 * of a coverage can be seen in this content model: the coverage contains
 * gml:domainSet and gml:rangeSet properties. The gml:domainSet property
 * describes the domain of the coverage and the gml:rangeSet property describes
...
public abstract class AbstractCoverageType extends AbstractFeatureType implements Serializable {
     ...
     * gml:DomainSetType. The value of the domain is thus a choice between a
     * gml:AbstractGeometry and a gml:AbstractTimeObject. In the instance these
     * abstract elements will normally be substituted by a geometry complex or
     * temporal complex, to represent spatial coverages and time-series,
     * respectively. The presence of the gml:AssociationAttributeGroup means that
     * domainSet follows the usual GML property model and may use the xlink:href
     * attribute to point to the domain, as an alternative to describing the domain
     * inline. Ownership semantics may be provided using the
     ...
     * (sometimes called the attribute values). Its content model is given by
     * gml:RangeSetType. This content model supports a structural description of the
     * range. The semantic information describing the range set is embedded using a
     * uniform method, as part of the explicit values, or as a template value
     * accompanying the representation using gml:DataBlock and gml:File. The values
     * from each component (or "band") in the range may be encoded within a
     * gml:ValueArray element or a concrete member of the
     * gml:AbstractScalarValueList substitution group . Use of these elements
     ...
     * gml:OwnershipAttributeGroup.
     *
     * @return possible object is {@link JAXBElement }{@code <}{@link DomainSetType
     *         }{@code >} {@link JAXBElement }{@code <}{@link DomainSetType
     *         }{@code >} {@link JAXBElement }{@code <}{@link DomainSetType
     *         }{@code >} {@link JAXBElement }{@code <}{@link DomainSetType
     *         }{@code >} {@link JAXBElement }{@code <}{@link DomainSetType
     *         }{@code >} {@link JAXBElement }{@code <}{@link DomainSetType
     ...
     *
     * @param value
     *            allowed object is {@link RangeSetType }
     *
     * @see #getRangeSet()
     */
