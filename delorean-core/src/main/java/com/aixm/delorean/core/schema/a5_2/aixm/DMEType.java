...
/**
 * <p>Java class for DMEType complex type</p>.
 * 
 ...
 *       <sequence>
 *         <element name="timeSlice" type="{http://www.aixm.aero/schema/5.2}DMETimeSlicePropertyType" maxOccurs="unbounded"/>
 *       </sequence>
 *     </extension>
 *   </complexContent>
 * </complexType>
...
@XmlType(name = "DMEType", propOrder = {
    "timeSlice"
})
@Entity(name = "DMEType")
@Table(name = "dme", schema = "navaids_points")
    ...
    implements Serializable
{
     ...
     * {@link DMETimeSlicePropertyType }
     * 
     * 
     */
    @OneToMany(targetEntity = DMETimeSlicePropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinColumn(name = "TIME_SLICE_DMETYPE_HJID")
     ...
     * 
     */
    public void setTimeSlice(List<DMETimeSlicePropertyType> timeSlice) {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = super.hashCode(locator, strategy);
        {
            ...
            List<DMETimeSlicePropertyType> theField;
