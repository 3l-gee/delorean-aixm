...
/**
 * <p>
 * Java class for MD_ServiceIdentification_PropertyType complex type
 * </p>
 * .
 *
 * <p>
 ...
 *         <element ref=
"{http://www.isotc211.org/2005/gmd}MD_ServiceIdentification"/>
 *       </sequence>
...
@XmlType(name = "MD_ServiceIdentification_PropertyType", propOrder = {"mdServiceIdentification"})
public class MDServiceIdentificationPropertyType implements Serializable, Equals, HashCode, ToString {
     ...
     *
     * @return possible object is {@link MDServiceIdentificationType }
     *
     */
     ...
     *
     * @param value
     *            allowed object is {@link MDServiceIdentificationType }
     *
     */
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        {
            boolean lhsFieldIsSet = this.isSetMDServiceIdentification();
            boolean rhsFieldIsSet = that.isSetMDServiceIdentification();
            MDServiceIdentificationType lhsField;
            lhsField = this.getMDServiceIdentification();
            MDServiceIdentificationType rhsField;
            rhsField = that.getMDServiceIdentification();
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "mdServiceIdentification", lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "mdServiceIdentification", rhsField);
            if (!strategy.equals(lhsFieldLocator, rhsFieldLocator, lhsField, rhsField, lhsFieldIsSet, rhsFieldIsSet)) {
                return false;
            }
        }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetMDServiceIdentification();
            MDServiceIdentificationType theField;
            theField = this.getMDServiceIdentification();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "mdServiceIdentification", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            MDServiceIdentificationType theField;
            theField = this.getMDServiceIdentification();
            strategy.appendField(locator, this, "mdServiceIdentification", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetNilReason();
            String theField;
