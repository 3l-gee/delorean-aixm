...
/**
 * <p>
 * Java class for RS_ReferenceSystem_PropertyType complex type
 * </p>
 * .
 *
 * <p>
 ...
 *         <element ref=
"{http://www.isotc211.org/2005/gmd}AbstractRS_ReferenceSystem"/>
 *       </sequence>
...
@XmlType(name = "RS_ReferenceSystem_PropertyType", propOrder = {"abstractRSReferenceSystem"})
public class RSReferenceSystemPropertyType implements Serializable, Equals, HashCode, ToString {
     ...
     *
     * @return possible object is {@link AbstractRSReferenceSystemType }
     *
     */
     ...
     *
     * @param value
     *            allowed object is {@link AbstractRSReferenceSystemType }
     *
     */
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final RSReferenceSystemPropertyType that = ((RSReferenceSystemPropertyType) object);
        {
        ...
        {
            boolean lhsFieldIsSet = this.isSetAbstractRSReferenceSystem();
            boolean rhsFieldIsSet = that.isSetAbstractRSReferenceSystem();
            AbstractRSReferenceSystemType lhsField;
            lhsField = this.getAbstractRSReferenceSystem();
            AbstractRSReferenceSystemType rhsField;
            rhsField = that.getAbstractRSReferenceSystem();
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "abstractRSReferenceSystem", lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "abstractRSReferenceSystem", rhsField);
            if (!strategy.equals(lhsFieldLocator, rhsFieldLocator, lhsField, rhsField, lhsFieldIsSet, rhsFieldIsSet)) {
                return false;
            }
        }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetAbstractRSReferenceSystem();
            AbstractRSReferenceSystemType theField;
            theField = this.getAbstractRSReferenceSystem();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "abstractRSReferenceSystem", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            AbstractRSReferenceSystemType theField;
            theField = this.getAbstractRSReferenceSystem();
            strategy.appendField(locator, this, "abstractRSReferenceSystem", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetNilReason();
            String theField;
