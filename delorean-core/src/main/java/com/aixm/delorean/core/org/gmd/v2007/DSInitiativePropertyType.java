...
/**
 * <p>
 * Java class for DS_Initiative_PropertyType complex type
 * </p>
 * .
 *
 * <p>
...
@XmlType(name = "DS_Initiative_PropertyType", propOrder = {"dsInitiative"})
public class DSInitiativePropertyType implements Serializable, Equals, HashCode, ToString {
     ...
     *
     * @return possible object is {@link DSInitiativeType }
     *
     */
     ...
     *
     * @param value
     *            allowed object is {@link DSInitiativeType }
     *
     */
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final DSInitiativePropertyType that = ((DSInitiativePropertyType) object);
        {
        ...
        {
            boolean lhsFieldIsSet = this.isSetDSInitiative();
            boolean rhsFieldIsSet = that.isSetDSInitiative();
            DSInitiativeType lhsField;
            lhsField = this.getDSInitiative();
            DSInitiativeType rhsField;
            rhsField = that.getDSInitiative();
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "dsInitiative", lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "dsInitiative", rhsField);
            if (!strategy.equals(lhsFieldLocator, rhsFieldLocator, lhsField, rhsField, lhsFieldIsSet, rhsFieldIsSet)) {
                return false;
            }
        }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetDSInitiative();
            DSInitiativeType theField;
            theField = this.getDSInitiative();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "dsInitiative", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            DSInitiativeType theField;
            theField = this.getDSInitiative();
            strategy.appendField(locator, this, "dsInitiative", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetNilReason();
            String theField;
