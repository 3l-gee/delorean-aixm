...
/**
 * <p>
 * Java class for CI_Address_PropertyType complex type
 * </p>
 * .
 *
 * <p>
...
@XmlType(name = "CI_Address_PropertyType", propOrder = {"ciAddress"})
public class CIAddressPropertyType implements Serializable, Equals, HashCode, ToString {
     ...
     *
     * @return possible object is {@link CIAddressType }
     *
     */
     ...
     *
     * @param value
     *            allowed object is {@link CIAddressType }
     *
     */
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final CIAddressPropertyType that = ((CIAddressPropertyType) object);
        {
        ...
        {
            boolean lhsFieldIsSet = this.isSetCIAddress();
            boolean rhsFieldIsSet = that.isSetCIAddress();
            CIAddressType lhsField;
            lhsField = this.getCIAddress();
            CIAddressType rhsField;
            rhsField = that.getCIAddress();
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "ciAddress", lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "ciAddress", rhsField);
            if (!strategy.equals(lhsFieldLocator, rhsFieldLocator, lhsField, rhsField, lhsFieldIsSet, rhsFieldIsSet)) {
                return false;
            }
        }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetCIAddress();
            CIAddressType theField;
            theField = this.getCIAddress();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "ciAddress", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            CIAddressType theField;
            theField = this.getCIAddress();
            strategy.appendField(locator, this, "ciAddress", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetNilReason();
            String theField;
