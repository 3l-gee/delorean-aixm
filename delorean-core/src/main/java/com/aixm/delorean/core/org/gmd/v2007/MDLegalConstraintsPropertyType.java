...
/**
 * <p>
 * Java class for MD_LegalConstraints_PropertyType complex type
 * </p>
 * .
 *
 * <p>
...
@XmlType(name = "MD_LegalConstraints_PropertyType", propOrder = {"mdLegalConstraints"})
public class MDLegalConstraintsPropertyType implements Serializable, Equals, HashCode, ToString {
     ...
     *
     * @return possible object is {@link MDLegalConstraintsType }
     *
     */
     ...
     *
     * @param value
     *            allowed object is {@link MDLegalConstraintsType }
     *
     */
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final MDLegalConstraintsPropertyType that = ((MDLegalConstraintsPropertyType) object);
        {
        ...
        {
            boolean lhsFieldIsSet = this.isSetMDLegalConstraints();
            boolean rhsFieldIsSet = that.isSetMDLegalConstraints();
            MDLegalConstraintsType lhsField;
            lhsField = this.getMDLegalConstraints();
            MDLegalConstraintsType rhsField;
            rhsField = that.getMDLegalConstraints();
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "mdLegalConstraints", lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "mdLegalConstraints", rhsField);
            if (!strategy.equals(lhsFieldLocator, rhsFieldLocator, lhsField, rhsField, lhsFieldIsSet, rhsFieldIsSet)) {
                return false;
            }
        }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetMDLegalConstraints();
            MDLegalConstraintsType theField;
            theField = this.getMDLegalConstraints();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "mdLegalConstraints", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            MDLegalConstraintsType theField;
            theField = this.getMDLegalConstraints();
            strategy.appendField(locator, this, "mdLegalConstraints", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetNilReason();
            String theField;
