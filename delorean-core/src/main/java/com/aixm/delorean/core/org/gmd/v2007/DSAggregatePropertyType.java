...
/**
 * <p>
 * Java class for DS_Aggregate_PropertyType complex type
 * </p>
 * .
 *
 * <p>
 ...
 *         <element ref=
"{http://www.isotc211.org/2005/gmd}AbstractDS_Aggregate"/>
 *       </sequence>
...
@XmlType(name = "DS_Aggregate_PropertyType", propOrder = {"abstractDSAggregate"})
public class DSAggregatePropertyType implements Serializable, Equals, HashCode, ToString {
     ...
     *            }{@code <}{@link AbstractDSAggregateType }{@code >}
     *            {@link JAXBElement }{@code <}{@link DSInitiativeType }{@code >}
     *            {@link JAXBElement }{@code <}{@link DSOtherAggregateType
     *            }{@code >} {@link JAXBElement }{@code <}{@link DSPlatformType
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final DSAggregatePropertyType that = ((DSAggregatePropertyType) object);
        {
        ...
        {
            boolean lhsFieldIsSet = this.isSetAbstractDSAggregate();
            boolean rhsFieldIsSet = that.isSetAbstractDSAggregate();
            JAXBElement<? extends AbstractDSAggregateType> lhsField;
            lhsField = this.getAbstractDSAggregate();
            JAXBElement<? extends AbstractDSAggregateType> rhsField;
            rhsField = that.getAbstractDSAggregate();
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "abstractDSAggregate", lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "abstractDSAggregate", rhsField);
            if (!strategy.equals(lhsFieldLocator, rhsFieldLocator, lhsField, rhsField, lhsFieldIsSet, rhsFieldIsSet)) {
                return false;
            }
        }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetAbstractDSAggregate();
            JAXBElement<? extends AbstractDSAggregateType> theField;
            theField = this.getAbstractDSAggregate();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "abstractDSAggregate", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            JAXBElement<? extends AbstractDSAggregateType> theField;
            theField = this.getAbstractDSAggregate();
            strategy.appendField(locator, this, "abstractDSAggregate", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetNilReason();
            String theField;
