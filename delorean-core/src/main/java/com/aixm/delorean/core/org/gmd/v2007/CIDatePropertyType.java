...
/**
 * <p>
 * Java class for CI_Date_PropertyType complex type
 * </p>
 * .
 *
 * <p>
...
@XmlType(name = "CI_Date_PropertyType", propOrder = {"ciDate"})
public class CIDatePropertyType implements Serializable, Equals, HashCode, ToString {
     ...
     *
     * @return possible object is {@link CIDateType }
     *
     */
     ...
     *
     * @param value
     *            allowed object is {@link CIDateType }
     *
     */
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final CIDatePropertyType that = ((CIDatePropertyType) object);
        {
        ...
        {
            boolean lhsFieldIsSet = this.isSetCIDate();
            boolean rhsFieldIsSet = that.isSetCIDate();
            CIDateType lhsField;
            lhsField = this.getCIDate();
            CIDateType rhsField;
            rhsField = that.getCIDate();
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "ciDate", lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "ciDate", rhsField);
            if (!strategy.equals(lhsFieldLocator, rhsFieldLocator, lhsField, rhsField, lhsFieldIsSet, rhsFieldIsSet)) {
                return false;
            }
        }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetCIDate();
            CIDateType theField;
            theField = this.getCIDate();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "ciDate", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            CIDateType theField;
            theField = this.getCIDate();
            strategy.appendField(locator, this, "ciDate", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetNilReason();
            String theField;
