...
/**
 * <p>
 * Java class for DQ_CompletenessOmission_PropertyType complex type
 * </p>
 * .
 *
 * <p>
 ...
 *         <element ref=
"{http://www.isotc211.org/2005/gmd}DQ_CompletenessOmission"/>
 *       </sequence>
...
@XmlType(name = "DQ_CompletenessOmission_PropertyType", propOrder = {"dqCompletenessOmission"})
public class DQCompletenessOmissionPropertyType implements Serializable, Equals, HashCode, ToString {
     ...
     *
     * @return possible object is {@link DQCompletenessOmissionType }
     *
     */
     ...
     *
     * @param value
     *            allowed object is {@link DQCompletenessOmissionType }
     *
     */
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final DQCompletenessOmissionPropertyType that = ((DQCompletenessOmissionPropertyType) object);
        {
        ...
        {
            boolean lhsFieldIsSet = this.isSetDQCompletenessOmission();
            boolean rhsFieldIsSet = that.isSetDQCompletenessOmission();
            DQCompletenessOmissionType lhsField;
            lhsField = this.getDQCompletenessOmission();
            DQCompletenessOmissionType rhsField;
            rhsField = that.getDQCompletenessOmission();
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "dqCompletenessOmission", lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "dqCompletenessOmission", rhsField);
            if (!strategy.equals(lhsFieldLocator, rhsFieldLocator, lhsField, rhsField, lhsFieldIsSet, rhsFieldIsSet)) {
                return false;
            }
        }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetDQCompletenessOmission();
            DQCompletenessOmissionType theField;
            theField = this.getDQCompletenessOmission();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "dqCompletenessOmission", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            DQCompletenessOmissionType theField;
            theField = this.getDQCompletenessOmission();
            strategy.appendField(locator, this, "dqCompletenessOmission", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetNilReason();
            String theField;
