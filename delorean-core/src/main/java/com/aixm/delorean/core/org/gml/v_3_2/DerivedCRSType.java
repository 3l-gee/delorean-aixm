...
public class DerivedCRSType extends AbstractGeneralDerivedCRSType implements Serializable {
     ...
     * reference system. The required codeSpace attribute shall reference a source
     * of information specifying the values and meanings of all the allowed string
     ...
     * this derived CRS.
     *
     * @return possible object is {@link SingleCRSPropertyType }
     *
     */
     ...
     *
     * @param value
     *            allowed object is {@link SingleCRSPropertyType }
     *
     * @see #getBaseCRS()
     */
