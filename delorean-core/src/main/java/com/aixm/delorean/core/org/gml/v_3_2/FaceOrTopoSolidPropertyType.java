...
/**
 * <p>
 * Java class for FaceOrTopoSolidPropertyType complex type
 * </p>
 * .
 *
 * <p>
...
@XmlType(name = "FaceOrTopoSolidPropertyType", propOrder = {"face", "topoSolid"})
public class FaceOrTopoSolidPropertyType implements Serializable, Equals, HashCode, ToString {
    ...
    /**
     * gml:TopoSolid represents the 3-dimensional topology primitive. The
     * topological boundary of a solid (gml:directedFace) consists of a set of
     * directed faces. A solid may optionally be realised by a 3-dimensional
     * geometric primitive (gml:solidProperty).
     *
     */
     ...
     *
     * @param value
     *            allowed object is {@link TopoSolidType }
     *
     * @see #getTopoSolid()
     */
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        {
            boolean lhsFieldIsSet = this.isSetFace();
            boolean rhsFieldIsSet = that.isSetFace();
            FaceType lhsField;
            lhsField = this.getFace();
            FaceType rhsField;
            rhsField = that.getFace();
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "face", lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "face", rhsField);
            if (!strategy.equals(lhsFieldLocator, rhsFieldLocator, lhsField, rhsField, lhsFieldIsSet, rhsFieldIsSet)) {
                return false;
            }
        }
        {
            boolean lhsFieldIsSet = this.isSetTopoSolid();
            boolean rhsFieldIsSet = that.isSetTopoSolid();
            TopoSolidType lhsField;
            lhsField = this.getTopoSolid();
            TopoSolidType rhsField;
            rhsField = that.getTopoSolid();
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "topoSolid", lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "topoSolid", rhsField);
            if (!strategy.equals(lhsFieldLocator, rhsFieldLocator, lhsField, rhsField, lhsFieldIsSet, rhsFieldIsSet)) {
                return false;
            }
        }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetFace();
            FaceType theField;
            theField = this.getFace();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "face", theField);
            currentHashCode = strategy.hashCode(theFieldLocator, currentHashCode, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetTopoSolid();
            TopoSolidType theField;
            theField = this.getTopoSolid();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "topoSolid", theField);
            currentHashCode = strategy.hashCode(theFieldLocator, currentHashCode, theField, theFieldIsSet);
        }
        {
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            FaceType theField;
            theField = this.getFace();
            strategy.appendField(locator, this, "face", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetTopoSolid();
            TopoSolidType theField;
            theField = this.getTopoSolid();
            strategy.appendField(locator, this, "topoSolid", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetNilReason();
            String theField;
