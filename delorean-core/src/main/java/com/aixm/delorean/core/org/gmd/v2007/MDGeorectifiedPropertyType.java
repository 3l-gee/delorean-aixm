...
/**
 * <p>
 * Java class for MD_Georectified_PropertyType complex type
 * </p>
 * .
 *
 * <p>
...
@XmlType(name = "MD_Georectified_PropertyType", propOrder = {"mdGeorectified"})
public class MDGeorectifiedPropertyType implements Serializable, Equals, HashCode, ToString {
     ...
     *
     * @return possible object is {@link MDGeorectifiedType }
     *
     */
     ...
     *
     * @param value
     *            allowed object is {@link MDGeorectifiedType }
     *
     */
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final MDGeorectifiedPropertyType that = ((MDGeorectifiedPropertyType) object);
        {
        ...
        {
            boolean lhsFieldIsSet = this.isSetMDGeorectified();
            boolean rhsFieldIsSet = that.isSetMDGeorectified();
            MDGeorectifiedType lhsField;
            lhsField = this.getMDGeorectified();
            MDGeorectifiedType rhsField;
            rhsField = that.getMDGeorectified();
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "mdGeorectified", lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "mdGeorectified", rhsField);
            if (!strategy.equals(lhsFieldLocator, rhsFieldLocator, lhsField, rhsField, lhsFieldIsSet, rhsFieldIsSet)) {
                return false;
            }
        }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetMDGeorectified();
            MDGeorectifiedType theField;
            theField = this.getMDGeorectified();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "mdGeorectified", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            MDGeorectifiedType theField;
            theField = this.getMDGeorectified();
            strategy.appendField(locator, this, "mdGeorectified", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetNilReason();
            String theField;
