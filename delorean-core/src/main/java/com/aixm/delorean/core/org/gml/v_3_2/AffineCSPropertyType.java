 ...
 * affine coordinate system, either referencing or containing the definition of
 * that coordinate system.
 *
 * <p>
 * Java class for AffineCSPropertyType complex type
 * </p>
 * .
 *
 * <p>
...
@XmlType(name = "AffineCSPropertyType", propOrder = {"affineCS"})
public class AffineCSPropertyType implements Serializable, Equals, HashCode, ToString {

    private static final long serialVersionUID = 20251104L;
    /**
     * gml:AffineCS is a two- or three-dimensional coordinate system with straight
     * axes that are not necessarily orthogonal. An AffineCS shall have two or three
     ...
     * dimension of the CS.
     *
     * @return possible object is {@link AffineCSType }
     *
     */
     ...
     *
     * @param value
     *            allowed object is {@link AffineCSType }
     *
     * @see #getAffineCS()
     */
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        }
        {
            ...
            AffineCSType lhsField;
            lhsField = this.getAffineCS();
            AffineCSType rhsField;
