...
/**
 * <p>
 * Java class for EX_Extent_PropertyType complex type
 * </p>
 * .
 *
 * <p>
...
@XmlType(name = "EX_Extent_PropertyType", propOrder = {"exExtent"})
public class EXExtentPropertyType implements Serializable, Equals, HashCode, ToString {
     ...
     *
     * @return possible object is {@link EXExtentType }
     *
     */
     ...
     *
     * @param value
     *            allowed object is {@link EXExtentType }
     *
     */
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final EXExtentPropertyType that = ((EXExtentPropertyType) object);
        {
        ...
        {
            boolean lhsFieldIsSet = this.isSetEXExtent();
            boolean rhsFieldIsSet = that.isSetEXExtent();
            EXExtentType lhsField;
            lhsField = this.getEXExtent();
            EXExtentType rhsField;
            rhsField = that.getEXExtent();
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "exExtent", lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "exExtent", rhsField);
            if (!strategy.equals(lhsFieldLocator, rhsFieldLocator, lhsField, rhsField, lhsFieldIsSet, rhsFieldIsSet)) {
                return false;
            }
        }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetEXExtent();
            EXExtentType theField;
            theField = this.getEXExtent();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "exExtent", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            EXExtentType theField;
            theField = this.getEXExtent();
            strategy.appendField(locator, this, "exExtent", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetNilReason();
            String theField;
