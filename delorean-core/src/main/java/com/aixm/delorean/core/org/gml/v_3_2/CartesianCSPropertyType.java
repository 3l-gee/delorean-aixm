 ...
 * Cartesian coordinate system, either referencing or containing the definition
 * of that coordinate system.
 *
 * <p>
 * Java class for CartesianCSPropertyType complex type
 * </p>
 * .
 *
 * <p>
...
@XmlType(name = "CartesianCSPropertyType", propOrder = {"cartesianCS"})
public class CartesianCSPropertyType implements Serializable, Equals, HashCode, ToString {

    private static final long serialVersionUID = 20251104L;
    /**
     * gml:CartesianCS is a 1-, 2-, or 3-dimensional coordinate system. In the
     * 1-dimensional case, it contains a single straight coordinate axis. In the 2-
     * and 3-dimensional cases gives the position of points relative to orthogonal
     * straight axes. In the multi-dimensional case, all axes shall have the same
     * length unit of measure. A CartesianCS shall have one, two, or three gml:axis
     * property elements.
     *
     */
     ...
     * property elements.
     *
     * @return possible object is {@link CartesianCSType }
     *
     */
     ...
     *
     * @param value
     *            allowed object is {@link CartesianCSType }
     *
     * @see #getCartesianCS()
     */
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        }
        {
            ...
            CartesianCSType lhsField;
            lhsField = this.getCartesianCS();
            CartesianCSType rhsField;
