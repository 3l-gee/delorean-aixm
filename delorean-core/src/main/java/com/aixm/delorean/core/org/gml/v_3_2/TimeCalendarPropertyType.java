 ...
 *
 * <p>
 * Java class for TimeCalendarPropertyType complex type
 * </p>
 * .
 *
 * <p>
...
@XmlType(name = "TimeCalendarPropertyType", propOrder = {"timeCalendar"})
public class TimeCalendarPropertyType implements Serializable, Equals, HashCode, ToString {

    private static final long serialVersionUID = 20251104L;
    /**
     * A calendar is a discrete temporal reference system that provides a basis for
     * defining temporal position to a resolution of one day. gml:TimeCalendar adds
     * one property to those inherited from gml:TimeReferenceSystem. A
     * gml:referenceFrame provides a link to a gml:TimeCalendarEra that it uses. A
     * gml:TimeCalendar may reference more than one calendar era. The referenceFrame
     * element follows the standard GML property model, allowing the association to
     * be instantiated either using an inline description using the
     * gml:TimeCalendarEra element, or a link to a gml:TimeCalendarEra which is
     * explicit elsewhere.
     *
     */
     ...
     * explicit elsewhere.
     *
     * @return possible object is {@link TimeCalendarType }
     *
     */
     ...
     *
     * @param value
     *            allowed object is {@link TimeCalendarType }
     *
     * @see #getTimeCalendar()
     */
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        {
            boolean lhsFieldIsSet = this.isSetTimeCalendar();
            boolean rhsFieldIsSet = that.isSetTimeCalendar();
            TimeCalendarType lhsField;
            lhsField = this.getTimeCalendar();
            TimeCalendarType rhsField;
            rhsField = that.getTimeCalendar();
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "timeCalendar", lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "timeCalendar", rhsField);
            if (!strategy.equals(lhsFieldLocator, rhsFieldLocator, lhsField, rhsField, lhsFieldIsSet, rhsFieldIsSet)) {
                return false;
            }
        }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetTimeCalendar();
            TimeCalendarType theField;
            theField = this.getTimeCalendar();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "timeCalendar", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            TimeCalendarType theField;
            theField = this.getTimeCalendar();
            strategy.appendField(locator, this, "timeCalendar", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetNilReason();
            String theField;
