...
/**
 * <p>
 * Java class for OperationPropertyType complex type
 * </p>
 * .
 *
 * <p>
...
@XmlType(name = "OperationPropertyType", propOrder = {"abstractOperation"})
public class OperationPropertyType implements Serializable, Equals, HashCode, ToString {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        {
            boolean lhsFieldIsSet = this.isSetAbstractOperation();
            boolean rhsFieldIsSet = that.isSetAbstractOperation();
            JAXBElement<? extends AbstractCoordinateOperationType> lhsField;
            lhsField = this.getAbstractOperation();
            JAXBElement<? extends AbstractCoordinateOperationType> rhsField;
            rhsField = that.getAbstractOperation();
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "abstractOperation", lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "abstractOperation", rhsField);
            if (!strategy.equals(lhsFieldLocator, rhsFieldLocator, lhsField, rhsField, lhsFieldIsSet, rhsFieldIsSet)) {
                return false;
            }
        }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetAbstractOperation();
            JAXBElement<? extends AbstractCoordinateOperationType> theField;
            theField = this.getAbstractOperation();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "abstractOperation", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            JAXBElement<? extends AbstractCoordinateOperationType> theField;
            theField = this.getAbstractOperation();
            strategy.appendField(locator, this, "abstractOperation", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetNilReason();
            String theField;
