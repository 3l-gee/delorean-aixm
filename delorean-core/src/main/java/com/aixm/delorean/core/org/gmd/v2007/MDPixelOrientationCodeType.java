 ...
 *
 * <p>
 * Java class for MD_PixelOrientationCode_Type
 * </p>
 * .
 *
 * <p>
...
public enum MDPixelOrientationCodeType {
    ...
    @XmlEnumValue("center")
    CENTER("center"), @XmlEnumValue("lowerLeft")
    LOWER_LEFT("lowerLeft"), @XmlEnumValue("lowerRight")
    LOWER_RIGHT("lowerRight"), @XmlEnumValue("upperRight")
    UPPER_RIGHT("upperRight"), @XmlEnumValue("upperLeft")
