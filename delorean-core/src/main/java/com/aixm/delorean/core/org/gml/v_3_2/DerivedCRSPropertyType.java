 ...
 *
 * <p>
 * Java class for DerivedCRSPropertyType complex type
 * </p>
 * .
 *
 * <p>
...
@XmlType(name = "DerivedCRSPropertyType", propOrder = {"derivedCRS"})
public class DerivedCRSPropertyType implements Serializable, Equals, HashCode, ToString {

    private static final long serialVersionUID = 20251104L;
    /**
     * gml:DerivedCRS is a single coordinate reference system that is defined by its
     * coordinate conversion from another single coordinate reference system known
     * as the base CRS. The base CRS can be a projected coordinate reference system,
     * if this DerivedCRS is used for a georectified grid coverage as described in
     * ISO 19123, Clause 8.
     *
     */
     ...
     * ISO 19123, Clause 8.
     *
     * @return possible object is {@link DerivedCRSType }
     *
     */
     ...
     *
     * @param value
     *            allowed object is {@link DerivedCRSType }
     *
     * @see #getDerivedCRS()
     */
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        {
            boolean lhsFieldIsSet = this.isSetDerivedCRS();
            boolean rhsFieldIsSet = that.isSetDerivedCRS();
            DerivedCRSType lhsField;
            lhsField = this.getDerivedCRS();
            DerivedCRSType rhsField;
            rhsField = that.getDerivedCRS();
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "derivedCRS", lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "derivedCRS", rhsField);
            if (!strategy.equals(lhsFieldLocator, rhsFieldLocator, lhsField, rhsField, lhsFieldIsSet, rhsFieldIsSet)) {
                return false;
            }
        }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetDerivedCRS();
            DerivedCRSType theField;
            theField = this.getDerivedCRS();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "derivedCRS", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            DerivedCRSType theField;
            theField = this.getDerivedCRS();
            strategy.appendField(locator, this, "derivedCRS", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetNilReason();
            String theField;
