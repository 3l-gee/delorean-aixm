...
/**
 * <p>
 * Java class for DQ_CompletenessCommission_PropertyType complex type
 * </p>
 * .
 *
 * <p>
 ...
 *         <element ref=
"{http://www.isotc211.org/2005/gmd}DQ_CompletenessCommission"/>
 *       </sequence>
...
@XmlType(name = "DQ_CompletenessCommission_PropertyType", propOrder = {"dqCompletenessCommission"})
public class DQCompletenessCommissionPropertyType implements Serializable, Equals, HashCode, ToString {
     ...
     *
     * @return possible object is {@link DQCompletenessCommissionType }
     *
     */
     ...
     *
     * @param value
     *            allowed object is {@link DQCompletenessCommissionType }
     *
     */
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final DQCompletenessCommissionPropertyType that = ((DQCompletenessCommissionPropertyType) object);
        {
        ...
        {
            boolean lhsFieldIsSet = this.isSetDQCompletenessCommission();
            boolean rhsFieldIsSet = that.isSetDQCompletenessCommission();
            DQCompletenessCommissionType lhsField;
            lhsField = this.getDQCompletenessCommission();
            DQCompletenessCommissionType rhsField;
            rhsField = that.getDQCompletenessCommission();
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "dqCompletenessCommission", lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "dqCompletenessCommission", rhsField);
            if (!strategy.equals(lhsFieldLocator, rhsFieldLocator, lhsField, rhsField, lhsFieldIsSet, rhsFieldIsSet)) {
                return false;
            }
        }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetDQCompletenessCommission();
            DQCompletenessCommissionType theField;
            theField = this.getDQCompletenessCommission();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "dqCompletenessCommission", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            DQCompletenessCommissionType theField;
            theField = this.getDQCompletenessCommission();
            strategy.appendField(locator, this, "dqCompletenessCommission", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetNilReason();
            String theField;
