...
"{http://www.opengis.net/gml/3.2}PointPropertyType"/>
 *         <element name="offsetVector" type=
...
public class RectifiedGridType extends GridType implements Serializable {
