 ...
 * primitives. A geometric primitive is a geometric object that is not
 * decomposed further into other primitives in the system. All primitives are
...
@XmlSeeAlso({PointType.class, AbstractCurveType.class, AbstractSurfaceType.class, AbstractSolidType.class})
public abstract class AbstractGeometricPrimitiveType extends AbstractGeometryType implements Serializable {
