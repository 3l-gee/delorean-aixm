 ...
 *
 * <p>
 * Java class for MultiCurvePropertyType complex type
 * </p>
 * .
 *
 * <p>
...
public class MultiCurvePropertyType implements Serializable, Equals, HashCode, ToString {
     ...
     * (gml:curveMember) or the array property (gml:curveMembers). It is also valid
     ...
     * to use both the "standard" and the array properties in the same collection.
     *
     * @return possible object is {@link MultiCurveType }
     *
     */
     ...
     *
     * @param value
     *            allowed object is {@link MultiCurveType }
     *
     * @see #getMultiCurve()
     */
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        {
            boolean lhsFieldIsSet = this.isSetMultiCurve();
            boolean rhsFieldIsSet = that.isSetMultiCurve();
            MultiCurveType lhsField;
            lhsField = this.getMultiCurve();
            MultiCurveType rhsField;
            rhsField = that.getMultiCurve();
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "multiCurve", lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "multiCurve", rhsField);
            if (!strategy.equals(lhsFieldLocator, rhsFieldLocator, lhsField, rhsField, lhsFieldIsSet, rhsFieldIsSet)) {
                return false;
            }
        }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetMultiCurve();
            MultiCurveType theField;
            theField = this.getMultiCurve();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "multiCurve", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            MultiCurveType theField;
            theField = this.getMultiCurve();
            strategy.appendField(locator, this, "multiCurve", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetNilReason();
            String theField;
