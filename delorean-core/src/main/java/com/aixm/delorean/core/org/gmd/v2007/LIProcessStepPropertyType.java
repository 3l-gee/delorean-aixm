...
/**
 * <p>
 * Java class for LI_ProcessStep_PropertyType complex type
 * </p>
 * .
 *
 * <p>
...
@XmlType(name = "LI_ProcessStep_PropertyType", propOrder = {"liProcessStep"})
public class LIProcessStepPropertyType implements Serializable, Equals, HashCode, ToString {
     ...
     *
     * @return possible object is {@link LIProcessStepType }
     *
     */
     ...
     *
     * @param value
     *            allowed object is {@link LIProcessStepType }
     *
     */
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final LIProcessStepPropertyType that = ((LIProcessStepPropertyType) object);
        {
        ...
        {
            boolean lhsFieldIsSet = this.isSetLIProcessStep();
            boolean rhsFieldIsSet = that.isSetLIProcessStep();
            LIProcessStepType lhsField;
            lhsField = this.getLIProcessStep();
            LIProcessStepType rhsField;
            rhsField = that.getLIProcessStep();
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "liProcessStep", lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "liProcessStep", rhsField);
            if (!strategy.equals(lhsFieldLocator, rhsFieldLocator, lhsField, rhsField, lhsFieldIsSet, rhsFieldIsSet)) {
                return false;
            }
        }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetLIProcessStep();
            LIProcessStepType theField;
            theField = this.getLIProcessStep();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "liProcessStep", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            LIProcessStepType theField;
            theField = this.getLIProcessStep();
            strategy.appendField(locator, this, "liProcessStep", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetNilReason();
            String theField;
