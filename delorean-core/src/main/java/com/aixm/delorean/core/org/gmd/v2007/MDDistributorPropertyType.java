...
/**
 * <p>
 * Java class for MD_Distributor_PropertyType complex type
 * </p>
 * .
 *
 * <p>
...
@XmlType(name = "MD_Distributor_PropertyType", propOrder = {"mdDistributor"})
public class MDDistributorPropertyType implements Serializable, Equals, HashCode, ToString {
     ...
     *
     * @return possible object is {@link MDDistributorType }
     *
     */
     ...
     *
     * @param value
     *            allowed object is {@link MDDistributorType }
     *
     */
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final MDDistributorPropertyType that = ((MDDistributorPropertyType) object);
        {
            boolean lhsFieldIsSet = this.isSetMDDistributor();
            boolean rhsFieldIsSet = that.isSetMDDistributor();
            MDDistributorType lhsField;
            lhsField = this.getMDDistributor();
            MDDistributorType rhsField;
            rhsField = that.getMDDistributor();
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "mdDistributor", lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "mdDistributor", rhsField);
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetMDDistributor();
            MDDistributorType theField;
            theField = this.getMDDistributor();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "mdDistributor", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            MDDistributorType theField;
            theField = this.getMDDistributor();
            strategy.appendField(locator, this, "mdDistributor", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetNilReason();
            String theField;
