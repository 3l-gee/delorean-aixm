...
/**
 * <p>
 * Java class for MD_ImagingConditionCode_PropertyType complex type
 * </p>
 * .
 *
 * <p>
 ...
 *         <element ref=
"{http://www.isotc211.org/2005/gmd}MD_ImagingConditionCode"/>
 *       </sequence>
...
@XmlType(name = "MD_ImagingConditionCode_PropertyType", propOrder = {"mdImagingConditionCode"})
public class MDImagingConditionCodePropertyType implements Serializable, Equals, HashCode, ToString {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetMDImagingConditionCode();
            CodeListValueType theField;
            theField = this.getMDImagingConditionCode();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "mdImagingConditionCode", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            CodeListValueType theField;
            theField = this.getMDImagingConditionCode();
            strategy.appendField(locator, this, "mdImagingConditionCode", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetNilReason();
            String theField;
