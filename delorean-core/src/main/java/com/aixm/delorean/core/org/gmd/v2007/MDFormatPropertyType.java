...
/**
 * <p>
 * Java class for MD_Format_PropertyType complex type
 * </p>
 * .
 *
 * <p>
...
@XmlType(name = "MD_Format_PropertyType", propOrder = {"mdFormat"})
public class MDFormatPropertyType implements Serializable, Equals, HashCode, ToString {
     ...
     *
     * @return possible object is {@link MDFormatType }
     *
     */
     ...
     *
     * @param value
     *            allowed object is {@link MDFormatType }
     *
     */
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final MDFormatPropertyType that = ((MDFormatPropertyType) object);
        {
        ...
        {
            boolean lhsFieldIsSet = this.isSetMDFormat();
            boolean rhsFieldIsSet = that.isSetMDFormat();
            MDFormatType lhsField;
            lhsField = this.getMDFormat();
            MDFormatType rhsField;
            rhsField = that.getMDFormat();
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "mdFormat", lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "mdFormat", rhsField);
            if (!strategy.equals(lhsFieldLocator, rhsFieldLocator, lhsField, rhsField, lhsFieldIsSet, rhsFieldIsSet)) {
                return false;
            }
        }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetMDFormat();
            MDFormatType theField;
            theField = this.getMDFormat();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "mdFormat", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            MDFormatType theField;
            theField = this.getMDFormat();
            strategy.appendField(locator, this, "mdFormat", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetNilReason();
            String theField;
