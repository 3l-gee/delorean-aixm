...
/**
 * <p>
 * Java class for CI_Contact_PropertyType complex type
 * </p>
 * .
 *
 * <p>
...
@XmlType(name = "CI_Contact_PropertyType", propOrder = {"ciContact"})
public class CIContactPropertyType implements Serializable, Equals, HashCode, ToString {
     ...
     *
     * @return possible object is {@link CIContactType }
     *
     */
     ...
     *
     * @param value
     *            allowed object is {@link CIContactType }
     *
     */
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final CIContactPropertyType that = ((CIContactPropertyType) object);
        {
        ...
        {
            boolean lhsFieldIsSet = this.isSetCIContact();
            boolean rhsFieldIsSet = that.isSetCIContact();
            CIContactType lhsField;
            lhsField = this.getCIContact();
            CIContactType rhsField;
            rhsField = that.getCIContact();
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "ciContact", lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "ciContact", rhsField);
            if (!strategy.equals(lhsFieldLocator, rhsFieldLocator, lhsField, rhsField, lhsFieldIsSet, rhsFieldIsSet)) {
                return false;
            }
        }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetCIContact();
            CIContactType theField;
            theField = this.getCIContact();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "ciContact", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            CIContactType theField;
            theField = this.getCIContact();
            strategy.appendField(locator, this, "ciContact", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetNilReason();
            String theField;
