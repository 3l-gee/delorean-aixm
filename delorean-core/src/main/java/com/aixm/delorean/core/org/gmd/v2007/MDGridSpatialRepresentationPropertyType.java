...
/**
 * <p>
 * Java class for MD_GridSpatialRepresentation_PropertyType complex type
 * </p>
 * .
 *
 * <p>
...
@XmlType(name = "MD_GridSpatialRepresentation_PropertyType", propOrder = {"mdGridSpatialRepresentation"})
public class MDGridSpatialRepresentationPropertyType implements Serializable, Equals, HashCode, ToString {
     ...
     *         }{@code <}{@link MDGeorectifiedType }{@code >} {@link JAXBElement
     *         }{@code <}{@link MDGeoreferenceableType }{@code >} {@link JAXBElement
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final MDGridSpatialRepresentationPropertyType that = ((MDGridSpatialRepresentationPropertyType) object);
        {
        ...
        {
            boolean lhsFieldIsSet = this.isSetMDGridSpatialRepresentation();
            boolean rhsFieldIsSet = that.isSetMDGridSpatialRepresentation();
            JAXBElement<? extends MDGridSpatialRepresentationType> lhsField;
            lhsField = this.getMDGridSpatialRepresentation();
            JAXBElement<? extends MDGridSpatialRepresentationType> rhsField;
            rhsField = that.getMDGridSpatialRepresentation();
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "mdGridSpatialRepresentation", lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "mdGridSpatialRepresentation", rhsField);
            if (!strategy.equals(lhsFieldLocator, rhsFieldLocator, lhsField, rhsField, lhsFieldIsSet, rhsFieldIsSet)) {
                return false;
            }
        }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetMDGridSpatialRepresentation();
            JAXBElement<? extends MDGridSpatialRepresentationType> theField;
            theField = this.getMDGridSpatialRepresentation();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "mdGridSpatialRepresentation", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            JAXBElement<? extends MDGridSpatialRepresentationType> theField;
            theField = this.getMDGridSpatialRepresentation();
            strategy.appendField(locator, this, "mdGridSpatialRepresentation", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetNilReason();
            String theField;
