...
/**
 * <p>
 * Java class for DS_Platform_PropertyType complex type
 * </p>
 * .
 *
 * <p>
...
@XmlType(name = "DS_Platform_PropertyType", propOrder = {"dsPlatform"})
public class DSPlatformPropertyType implements Serializable, Equals, HashCode, ToString {
     ...
     *
     * @return possible object is {@link DSPlatformType }
     *
     */
     ...
     *
     * @param value
     *            allowed object is {@link DSPlatformType }
     *
     */
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final DSPlatformPropertyType that = ((DSPlatformPropertyType) object);
        {
        ...
        {
            boolean lhsFieldIsSet = this.isSetDSPlatform();
            boolean rhsFieldIsSet = that.isSetDSPlatform();
            DSPlatformType lhsField;
            lhsField = this.getDSPlatform();
            DSPlatformType rhsField;
            rhsField = that.getDSPlatform();
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "dsPlatform", lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "dsPlatform", rhsField);
            if (!strategy.equals(lhsFieldLocator, rhsFieldLocator, lhsField, rhsField, lhsFieldIsSet, rhsFieldIsSet)) {
                return false;
            }
        }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetDSPlatform();
            DSPlatformType theField;
            theField = this.getDSPlatform();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "dsPlatform", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            DSPlatformType theField;
            theField = this.getDSPlatform();
            strategy.appendField(locator, this, "dsPlatform", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetNilReason();
            String theField;
