 ...
 *         </choice>
 *         <element name="vectorAtStart" type=
"{http://www.opengis.net/gml/3.2}VectorType"/>
 *         <element name="vectorAtEnd" type=
"{http://www.opengis.net/gml/3.2}VectorType"/>
 *       </sequence>
 *       <attribute name="interpolation" type=
"{http://www.opengis.net/gml/3.2}CurveInterpolationType" fixed="cubicSpline" />
 *       <attribute name="degree" type=
"{http://www.w3.org/2001/XMLSchema}integer" fixed="3" />
 *     </extension>
 *   </complexContent>
 * </complexType>
 * }</pre>
...
@XmlType(name = "CubicSplineType", propOrder = {"posOrPointPropertyOrPointRep", "posList", "coordinates",
        "vectorAtStart", "vectorAtEnd"})
public class CubicSplineType extends AbstractCurveSegmentType implements Serializable {
