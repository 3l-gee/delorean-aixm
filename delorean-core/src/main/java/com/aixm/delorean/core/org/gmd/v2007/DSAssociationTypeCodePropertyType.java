...
public class DSAssociationTypeCodePropertyType implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        {
            boolean lhsFieldIsSet = (this.dsAssociationTypeCode!= null);
            boolean rhsFieldIsSet = (that.dsAssociationTypeCode!= null);
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = (this.dsAssociationTypeCode!= null);
            CodeListValueType theField;
            theField = this.getDSAssociationTypeCode();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "dsAssociationTypeCode", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            CodeListValueType theField;
            theField = this.getDSAssociationTypeCode();
            strategy.appendField(locator, this, "dsAssociationTypeCode", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = (this.nilReason!= null);
            String theField;
