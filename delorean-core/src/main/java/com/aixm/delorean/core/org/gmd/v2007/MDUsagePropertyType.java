...
/**
 * <p>
 * Java class for MD_Usage_PropertyType complex type
 * </p>
 * .
 *
 * <p>
...
@XmlType(name = "MD_Usage_PropertyType", propOrder = {"mdUsage"})
public class MDUsagePropertyType implements Serializable, Equals, HashCode, ToString {
     ...
     *
     * @return possible object is {@link MDUsageType }
     *
     */
     ...
     *
     * @param value
     *            allowed object is {@link MDUsageType }
     *
     */
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final MDUsagePropertyType that = ((MDUsagePropertyType) object);
        {
        ...
        {
            boolean lhsFieldIsSet = this.isSetMDUsage();
            boolean rhsFieldIsSet = that.isSetMDUsage();
            MDUsageType lhsField;
            lhsField = this.getMDUsage();
            MDUsageType rhsField;
            rhsField = that.getMDUsage();
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "mdUsage", lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "mdUsage", rhsField);
            if (!strategy.equals(lhsFieldLocator, rhsFieldLocator, lhsField, rhsField, lhsFieldIsSet, rhsFieldIsSet)) {
                return false;
            }
        }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetMDUsage();
            MDUsageType theField;
            theField = this.getMDUsage();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "mdUsage", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            MDUsageType theField;
            theField = this.getMDUsage();
            strategy.appendField(locator, this, "mdUsage", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetNilReason();
            String theField;
