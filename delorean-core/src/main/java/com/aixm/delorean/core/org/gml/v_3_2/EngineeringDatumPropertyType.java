...
/**
 * gml:EngineeringDatumPropertyType is a property type for association roles to
 * an engineering datum, either referencing or containing the definition of that
 * datum.
 *
 * <p>
 * Java class for EngineeringDatumPropertyType complex type
 * </p>
 * .
 *
 * <p>
...
@XmlType(name = "EngineeringDatumPropertyType", propOrder = {"engineeringDatum"})
public class EngineeringDatumPropertyType implements Serializable, Equals, HashCode, ToString {
     ...
     * reference system, and is used in a region around that origin. This origin may
     ...
     * satellite).
     *
     * @return possible object is {@link EngineeringDatumType }
     *
     */
     ...
     *
     * @param value
     *            allowed object is {@link EngineeringDatumType }
     *
