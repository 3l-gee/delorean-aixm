...
/**
 * <p>
 * Java class for MD_Dimension_PropertyType complex type
 * </p>
 * .
 *
 * <p>
...
@XmlType(name = "MD_Dimension_PropertyType", propOrder = {"mdDimension"})
public class MDDimensionPropertyType implements Serializable, Equals, HashCode, ToString {
     ...
     *
     * @return possible object is {@link MDDimensionType }
     *
     */
     ...
     *
     * @param value
     *            allowed object is {@link MDDimensionType }
     *
     */
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final MDDimensionPropertyType that = ((MDDimensionPropertyType) object);
        {
            boolean lhsFieldIsSet = this.isSetMDDimension();
            boolean rhsFieldIsSet = that.isSetMDDimension();
            MDDimensionType lhsField;
            lhsField = this.getMDDimension();
            MDDimensionType rhsField;
            rhsField = that.getMDDimension();
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "mdDimension", lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "mdDimension", rhsField);
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetMDDimension();
            MDDimensionType theField;
            theField = this.getMDDimension();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "mdDimension", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            MDDimensionType theField;
            theField = this.getMDDimension();
            strategy.appendField(locator, this, "mdDimension", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetNilReason();
            String theField;
