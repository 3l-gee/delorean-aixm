...
/**
 * <p>
 * Java class for EX_BoundingPolygon_PropertyType complex type
 * </p>
 * .
 *
 * <p>
...
@XmlType(name = "EX_BoundingPolygon_PropertyType", propOrder = {"exBoundingPolygon"})
public class EXBoundingPolygonPropertyType implements Serializable, Equals, HashCode, ToString {
     ...
     *
     * @return possible object is {@link EXBoundingPolygonType }
     *
     */
     ...
     *
     * @param value
     *            allowed object is {@link EXBoundingPolygonType }
     *
     */
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final EXBoundingPolygonPropertyType that = ((EXBoundingPolygonPropertyType) object);
        {
        ...
        {
            boolean lhsFieldIsSet = this.isSetEXBoundingPolygon();
            boolean rhsFieldIsSet = that.isSetEXBoundingPolygon();
            EXBoundingPolygonType lhsField;
            lhsField = this.getEXBoundingPolygon();
            EXBoundingPolygonType rhsField;
            rhsField = that.getEXBoundingPolygon();
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "exBoundingPolygon", lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "exBoundingPolygon", rhsField);
            if (!strategy.equals(lhsFieldLocator, rhsFieldLocator, lhsField, rhsField, lhsFieldIsSet, rhsFieldIsSet)) {
                return false;
            }
        }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetEXBoundingPolygon();
            EXBoundingPolygonType theField;
            theField = this.getEXBoundingPolygon();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "exBoundingPolygon", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            EXBoundingPolygonType theField;
            theField = this.getEXBoundingPolygon();
            strategy.appendField(locator, this, "exBoundingPolygon", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetNilReason();
            String theField;
