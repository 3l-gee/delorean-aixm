...
public class EXBoundingPolygonPropertyType implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        {
            boolean lhsFieldIsSet = (this.exBoundingPolygon!= null);
            boolean rhsFieldIsSet = (that.exBoundingPolygon!= null);
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = (this.exBoundingPolygon!= null);
