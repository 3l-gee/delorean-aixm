 ...
 *       <choice minOccurs="0">
 *         <element name="DirectionVector" type=
"{http://www.opengis.net/gml/3.2}DirectionVectorType"/>
 *         <element name="DirectionDescription" type=
"{http://www.opengis.net/gml/3.2}DirectionDescriptionType"/>
 *         <element name="CompassPoint" type=
"{http://www.opengis.net/gml/3.2}CompassPointEnumeration"/>
 *         <element name="DirectionKeyword" type=
"{http://www.opengis.net/gml/3.2}CodeType"/>
 *         <element name="DirectionString" type=
...
@XmlType(name = "DirectionPropertyType", propOrder = {"directionVector", "directionDescription", "compassPoint",
        "directionKeyword", "directionString"})
public class DirectionPropertyType implements Serializable, Equals, HashCode, ToString {
     ...
     *
     * @param value
     *            allowed object is {@link DirectionVectorType }
     *
     */
     ...
     *
     * @return possible object is {@link DirectionDescriptionType }
     *
     */
     ...
     *
     * @param value
     *            allowed object is {@link DirectionDescriptionType }
     *
     */
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        {
            boolean lhsFieldIsSet = this.isSetDirectionDescription();
            boolean rhsFieldIsSet = that.isSetDirectionDescription();
            DirectionDescriptionType lhsField;
            lhsField = this.getDirectionDescription();
            DirectionDescriptionType rhsField;
            rhsField = that.getDirectionDescription();
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "directionDescription", lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "directionDescription", rhsField);
            if (!strategy.equals(lhsFieldLocator, rhsFieldLocator, lhsField, rhsField, lhsFieldIsSet, rhsFieldIsSet)) {
                return false;
            }
        }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetDirectionVector();
            DirectionVectorType theField;
            theField = this.getDirectionVector();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "directionVector", theField);
            currentHashCode = strategy.hashCode(theFieldLocator, currentHashCode, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetDirectionDescription();
            DirectionDescriptionType theField;
            theField = this.getDirectionDescription();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "directionDescription", theField);
            currentHashCode = strategy.hashCode(theFieldLocator, currentHashCode, theField, theFieldIsSet);
        }
        {
        ...
        {
            boolean theFieldIsSet = this.isSetDirectionKeyword();
            CodeType theField;
            theField = this.getDirectionKeyword();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "directionKeyword", theField);
            currentHashCode = strategy.hashCode(theFieldLocator, currentHashCode, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetDirectionString();
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            DirectionVectorType theField;
            theField = this.getDirectionVector();
            strategy.appendField(locator, this, "directionVector", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetDirectionDescription();
            DirectionDescriptionType theField;
            theField = this.getDirectionDescription();
            strategy.appendField(locator, this, "directionDescription", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetCompassPoint();
            CompassPointEnumeration theField;
        ...
        }
        {
            ...
            CodeType theField;
            theField = this.getDirectionKeyword();
            strategy.appendField(locator, this, "directionKeyword", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetDirectionString();
            StringOrRefType theField;
