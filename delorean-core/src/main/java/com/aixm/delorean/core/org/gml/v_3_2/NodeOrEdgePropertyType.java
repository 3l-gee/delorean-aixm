...
public class NodeOrEdgePropertyType implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        {
            boolean lhsFieldIsSet = (this.edge!= null);
            boolean rhsFieldIsSet = (that.edge!= null);
            EdgeType lhsField;
        ...
        {
            boolean lhsFieldIsSet = (this.node!= null);
            boolean rhsFieldIsSet = (that.node!= null);
            NodeType lhsField;
            lhsField = this.getNode();
            NodeType rhsField;
            rhsField = that.getNode();
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "node", lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "node", rhsField);
            if (!strategy.equals(lhsFieldLocator, rhsFieldLocator, lhsField, rhsField, lhsFieldIsSet, rhsFieldIsSet)) {
                return false;
            }
        }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = (this.node!= null);
            NodeType theField;
            theField = this.getNode();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "node", theField);
            currentHashCode = strategy.hashCode(theFieldLocator, currentHashCode, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = (this.edge!= null);
            EdgeType theField;
            theField = this.getEdge();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "edge", theField);
            currentHashCode = strategy.hashCode(theFieldLocator, currentHashCode, theField, theFieldIsSet);
        }
        {
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            NodeType theField;
            theField = this.getNode();
            strategy.appendField(locator, this, "node", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = (this.edge!= null);
            EdgeType theField;
            theField = this.getEdge();
            strategy.appendField(locator, this, "edge", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = (this.owns!= null);
            java.lang.Boolean theField;
