 ...
 *
 * <p>
 * Java class for GeodeticCRSPropertyType complex type
 * </p>
 * .
 *
 * <p>
...
@XmlType(name = "GeodeticCRSPropertyType", propOrder = {"geodeticCRS"})
public class GeodeticCRSPropertyType implements Serializable, Equals, HashCode, ToString {
     ...
     *
     * @return possible object is {@link GeodeticCRSType }
     *
     */
     ...
     *
     * @param value
     *            allowed object is {@link GeodeticCRSType }
     *
     */
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        {
            boolean lhsFieldIsSet = this.isSetGeodeticCRS();
            boolean rhsFieldIsSet = that.isSetGeodeticCRS();
            GeodeticCRSType lhsField;
            lhsField = this.getGeodeticCRS();
            GeodeticCRSType rhsField;
            rhsField = that.getGeodeticCRS();
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "geodeticCRS", lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "geodeticCRS", rhsField);
            if (!strategy.equals(lhsFieldLocator, rhsFieldLocator, lhsField, rhsField, lhsFieldIsSet, rhsFieldIsSet)) {
                return false;
            }
        }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetGeodeticCRS();
            GeodeticCRSType theField;
            theField = this.getGeodeticCRS();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "geodeticCRS", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            GeodeticCRSType theField;
            theField = this.getGeodeticCRS();
            strategy.appendField(locator, this, "geodeticCRS", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetNilReason();
            String theField;
