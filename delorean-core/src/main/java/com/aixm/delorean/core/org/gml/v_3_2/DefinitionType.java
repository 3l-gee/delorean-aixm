...
@XmlType(name = "DefinitionType", propOrder = {"remarks"})
@XmlSeeAlso({DictionaryType.class, UnitDefinitionType.class, TimeCalendarEraType.class, TimeReferenceSystemType.class,
        TimeOrdinalEraType.class, DefinitionProxyType.class, IdentifiedObjectType.class})
public class DefinitionType extends DefinitionBaseType implements Serializable {
