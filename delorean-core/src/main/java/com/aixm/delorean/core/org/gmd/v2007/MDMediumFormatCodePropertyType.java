...
/**
 * <p>
 * Java class for MD_MediumFormatCode_PropertyType complex type
 * </p>
 * .
 *
 * <p>
 ...
 *         <element ref=
"{http://www.isotc211.org/2005/gmd}MD_MediumFormatCode"/>
 *       </sequence>
...
@XmlType(name = "MD_MediumFormatCode_PropertyType", propOrder = {"mdMediumFormatCode"})
public class MDMediumFormatCodePropertyType implements Serializable, Equals, HashCode, ToString {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetMDMediumFormatCode();
            CodeListValueType theField;
            theField = this.getMDMediumFormatCode();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "mdMediumFormatCode", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            CodeListValueType theField;
            theField = this.getMDMediumFormatCode();
            strategy.appendField(locator, this, "mdMediumFormatCode", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetNilReason();
            String theField;
