...
/**
 * <p>
 * Java class for MD_BrowseGraphic_PropertyType complex type
 * </p>
 * .
 *
 * <p>
...
@XmlType(name = "MD_BrowseGraphic_PropertyType", propOrder = {"mdBrowseGraphic"})
public class MDBrowseGraphicPropertyType implements Serializable, Equals, HashCode, ToString {
     ...
     *
     * @return possible object is {@link MDBrowseGraphicType }
     *
     */
     ...
     *
     * @param value
     *            allowed object is {@link MDBrowseGraphicType }
     *
     */
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final MDBrowseGraphicPropertyType that = ((MDBrowseGraphicPropertyType) object);
        {
        ...
        {
            boolean lhsFieldIsSet = this.isSetMDBrowseGraphic();
            boolean rhsFieldIsSet = that.isSetMDBrowseGraphic();
            MDBrowseGraphicType lhsField;
            lhsField = this.getMDBrowseGraphic();
            MDBrowseGraphicType rhsField;
            rhsField = that.getMDBrowseGraphic();
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "mdBrowseGraphic", lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "mdBrowseGraphic", rhsField);
            if (!strategy.equals(lhsFieldLocator, rhsFieldLocator, lhsField, rhsField, lhsFieldIsSet, rhsFieldIsSet)) {
                return false;
            }
        }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetMDBrowseGraphic();
            MDBrowseGraphicType theField;
            theField = this.getMDBrowseGraphic();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "mdBrowseGraphic", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            MDBrowseGraphicType theField;
            theField = this.getMDBrowseGraphic();
            strategy.appendField(locator, this, "mdBrowseGraphic", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetNilReason();
            String theField;
