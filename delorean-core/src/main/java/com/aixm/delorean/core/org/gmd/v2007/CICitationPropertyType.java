...
/**
 * <p>
 * Java class for CI_Citation_PropertyType complex type
 * </p>
 * .
 *
 * <p>
...
@XmlType(name = "CI_Citation_PropertyType", propOrder = {"ciCitation"})
public class CICitationPropertyType implements Serializable, Equals, HashCode, ToString {
     ...
     *
     * @return possible object is {@link CICitationType }
     *
     */
     ...
     *
     * @param value
     *            allowed object is {@link CICitationType }
     *
     */
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final CICitationPropertyType that = ((CICitationPropertyType) object);
        {
        ...
        }
        {
            ...
            CICitationType lhsField;
            lhsField = this.getCICitation();
            CICitationType rhsField;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetCICitation();
            CICitationType theField;
            theField = this.getCICitation();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "ciCitation", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            CICitationType theField;
            theField = this.getCICitation();
            strategy.appendField(locator, this, "ciCitation", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetNilReason();
            String theField;
