 ...
 *
 * <p>
 * Java class for ConversionPropertyType complex type
 * </p>
 * .
 *
 * <p>
...
@XmlType(name = "ConversionPropertyType", propOrder = {"conversion"})
public class ConversionPropertyType implements Serializable, Equals, HashCode, ToString {

    private static final long serialVersionUID = 20251104L;
    /**
     * gml:Conversion is a concrete operation on coordinates that does not include
     * any change of Datum. The best-known example of a coordinate conversion is a
     * map projection. The parameters describing coordinate conversions are defined
     * rather than empirically derived. Note that some conversions have no
     * parameters. This concrete complex type can be used without using a GML
     * Application Schema that defines operation-method-specialized element names
     * and contents, especially for methods with only one Conversion instance. The
     * usesValue property elements are an unordered list of composition associations
     * to the set of parameter values used by this conversion operation.
     *
     */
     ...
     * to the set of parameter values used by this conversion operation.
     *
     * @return possible object is {@link ConversionType }
     *
     */
     ...
     *
     * @param value
     *            allowed object is {@link ConversionType }
     *
     * @see #getConversion()
     */
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        }
        {
            ...
            ConversionType lhsField;
            lhsField = this.getConversion();
            ConversionType rhsField;
            rhsField = that.getConversion();
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "conversion", lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "conversion", rhsField);
            if (!strategy.equals(lhsFieldLocator, rhsFieldLocator, lhsField, rhsField, lhsFieldIsSet, rhsFieldIsSet)) {
                return false;
            }
        }
