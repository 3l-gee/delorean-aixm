...
public class DQTopologicalConsistencyPropertyType implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        {
            boolean lhsFieldIsSet = (this.dqTopologicalConsistency!= null);
            boolean rhsFieldIsSet = (that.dqTopologicalConsistency!= null);
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = (this.dqTopologicalConsistency!= null);
