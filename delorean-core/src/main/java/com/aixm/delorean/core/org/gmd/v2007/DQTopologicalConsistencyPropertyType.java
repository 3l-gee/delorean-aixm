...
/**
 * <p>
 * Java class for DQ_TopologicalConsistency_PropertyType complex type
 * </p>
 * .
 *
 * <p>
 ...
 *         <element ref=
"{http://www.isotc211.org/2005/gmd}DQ_TopologicalConsistency"/>
 *       </sequence>
...
@XmlType(name = "DQ_TopologicalConsistency_PropertyType", propOrder = {"dqTopologicalConsistency"})
public class DQTopologicalConsistencyPropertyType implements Serializable, Equals, HashCode, ToString {
     ...
     *
     * @return possible object is {@link DQTopologicalConsistencyType }
     *
     */
     ...
     *
     * @param value
     *            allowed object is {@link DQTopologicalConsistencyType }
     *
     */
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final DQTopologicalConsistencyPropertyType that = ((DQTopologicalConsistencyPropertyType) object);
        {
        ...
        {
            boolean lhsFieldIsSet = this.isSetDQTopologicalConsistency();
            boolean rhsFieldIsSet = that.isSetDQTopologicalConsistency();
            DQTopologicalConsistencyType lhsField;
            lhsField = this.getDQTopologicalConsistency();
            DQTopologicalConsistencyType rhsField;
            rhsField = that.getDQTopologicalConsistency();
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "dqTopologicalConsistency", lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "dqTopologicalConsistency", rhsField);
            if (!strategy.equals(lhsFieldLocator, rhsFieldLocator, lhsField, rhsField, lhsFieldIsSet, rhsFieldIsSet)) {
                return false;
            }
        }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetDQTopologicalConsistency();
            DQTopologicalConsistencyType theField;
            theField = this.getDQTopologicalConsistency();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "dqTopologicalConsistency", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            DQTopologicalConsistencyType theField;
            theField = this.getDQTopologicalConsistency();
            strategy.appendField(locator, this, "dqTopologicalConsistency", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetNilReason();
            String theField;
