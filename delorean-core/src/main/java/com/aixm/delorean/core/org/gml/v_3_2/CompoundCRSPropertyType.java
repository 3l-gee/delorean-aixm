 ...
 *
 * <p>
 * Java class for CompoundCRSPropertyType complex type
 * </p>
 * .
 *
 * <p>
...
@XmlType(name = "CompoundCRSPropertyType", propOrder = {"compoundCRS"})
public class CompoundCRSPropertyType implements Serializable, Equals, HashCode, ToString {

    private static final long serialVersionUID = 20251104L;
    /**
     * gml:CompundCRS is a coordinate reference system describing the position of
     * points through two or more independent coordinate reference systems. It is
     * associated with a non-repeating sequence of two or more instances of
     * SingleCRS.
     *
     */
     ...
     * SingleCRS.
     *
     * @return possible object is {@link CompoundCRSType }
     *
     */
     ...
     *
     * @param value
     *            allowed object is {@link CompoundCRSType }
     *
     * @see #getCompoundCRS()
     */
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        {
            boolean lhsFieldIsSet = this.isSetCompoundCRS();
            boolean rhsFieldIsSet = that.isSetCompoundCRS();
            CompoundCRSType lhsField;
            lhsField = this.getCompoundCRS();
            CompoundCRSType rhsField;
            rhsField = that.getCompoundCRS();
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "compoundCRS", lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "compoundCRS", rhsField);
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetCompoundCRS();
            CompoundCRSType theField;
            theField = this.getCompoundCRS();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "compoundCRS", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            CompoundCRSType theField;
            theField = this.getCompoundCRS();
            strategy.appendField(locator, this, "compoundCRS", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetNilReason();
            String theField;
