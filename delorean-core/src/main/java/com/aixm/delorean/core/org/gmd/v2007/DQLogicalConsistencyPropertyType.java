...
/**
 * <p>
 * Java class for DQ_LogicalConsistency_PropertyType complex type
 * </p>
 * .
 *
 * <p>
 ...
 *         <element ref=
"{http://www.isotc211.org/2005/gmd}AbstractDQ_LogicalConsistency"/>
 *       </sequence>
...
@XmlType(name = "DQ_LogicalConsistency_PropertyType", propOrder = {"abstractDQLogicalConsistency"})
public class DQLogicalConsistencyPropertyType implements Serializable, Equals, HashCode, ToString {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final DQLogicalConsistencyPropertyType that = ((DQLogicalConsistencyPropertyType) object);
        {
        ...
        {
            boolean lhsFieldIsSet = this.isSetAbstractDQLogicalConsistency();
            boolean rhsFieldIsSet = that.isSetAbstractDQLogicalConsistency();
            JAXBElement<? extends AbstractDQLogicalConsistencyType> lhsField;
            lhsField = this.getAbstractDQLogicalConsistency();
            JAXBElement<? extends AbstractDQLogicalConsistencyType> rhsField;
            rhsField = that.getAbstractDQLogicalConsistency();
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "abstractDQLogicalConsistency",
                    lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "abstractDQLogicalConsistency",
                    rhsField);
            if (!strategy.equals(lhsFieldLocator, rhsFieldLocator, lhsField, rhsField, lhsFieldIsSet, rhsFieldIsSet)) {
                return false;
            }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetAbstractDQLogicalConsistency();
            JAXBElement<? extends AbstractDQLogicalConsistencyType> theField;
            theField = this.getAbstractDQLogicalConsistency();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "abstractDQLogicalConsistency", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            JAXBElement<? extends AbstractDQLogicalConsistencyType> theField;
            theField = this.getAbstractDQLogicalConsistency();
            strategy.appendField(locator, this, "abstractDQLogicalConsistency", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetNilReason();
            String theField;
