 ...
 *
 * <p>
 * Java class for ImageCRSPropertyType complex type
 * </p>
 * .
 *
 * <p>
...
@XmlType(name = "ImageCRSPropertyType", propOrder = {"imageCRS"})
public class ImageCRSPropertyType implements Serializable, Equals, HashCode, ToString {

    private static final long serialVersionUID = 20251104L;
    /**
     * gml:ImageCRS is an engineering coordinate reference system applied to
     * locations in images. Image coordinate reference systems are treated as a
     * separate sub-type because the definition of the associated image datum
     ...
     * contains two attributes not relevant to other engineering datums.
     *
     * @return possible object is {@link ImageCRSType }
     *
     */
     ...
     *
     * @param value
     *            allowed object is {@link ImageCRSType }
     *
     * @see #getImageCRS()
     */
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        {
            boolean lhsFieldIsSet = this.isSetImageCRS();
            boolean rhsFieldIsSet = that.isSetImageCRS();
            ImageCRSType lhsField;
            lhsField = this.getImageCRS();
            ImageCRSType rhsField;
            rhsField = that.getImageCRS();
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "imageCRS", lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "imageCRS", rhsField);
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetImageCRS();
            ImageCRSType theField;
            theField = this.getImageCRS();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "imageCRS", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            ImageCRSType theField;
            theField = this.getImageCRS();
            strategy.appendField(locator, this, "imageCRS", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetNilReason();
            String theField;
