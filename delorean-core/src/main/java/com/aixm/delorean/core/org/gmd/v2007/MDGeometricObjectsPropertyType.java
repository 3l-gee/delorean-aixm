...
/**
 * <p>
 * Java class for MD_GeometricObjects_PropertyType complex type
 * </p>
 * .
 *
 * <p>
 ...
 *         <element ref=
"{http://www.isotc211.org/2005/gmd}MD_GeometricObjects"/>
 *       </sequence>
...
@XmlType(name = "MD_GeometricObjects_PropertyType", propOrder = {"mdGeometricObjects"})
public class MDGeometricObjectsPropertyType implements Serializable, Equals, HashCode, ToString {
     ...
     *
     * @return possible object is {@link MDGeometricObjectsType }
     *
     */
     ...
     *
     * @param value
     *            allowed object is {@link MDGeometricObjectsType }
     *
     */
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final MDGeometricObjectsPropertyType that = ((MDGeometricObjectsPropertyType) object);
        {
        ...
        {
            boolean lhsFieldIsSet = this.isSetMDGeometricObjects();
            boolean rhsFieldIsSet = that.isSetMDGeometricObjects();
            MDGeometricObjectsType lhsField;
            lhsField = this.getMDGeometricObjects();
            MDGeometricObjectsType rhsField;
            rhsField = that.getMDGeometricObjects();
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "mdGeometricObjects", lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "mdGeometricObjects", rhsField);
            if (!strategy.equals(lhsFieldLocator, rhsFieldLocator, lhsField, rhsField, lhsFieldIsSet, rhsFieldIsSet)) {
                return false;
            }
        }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetMDGeometricObjects();
            MDGeometricObjectsType theField;
            theField = this.getMDGeometricObjects();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "mdGeometricObjects", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            MDGeometricObjectsType theField;
            theField = this.getMDGeometricObjects();
            strategy.appendField(locator, this, "mdGeometricObjects", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetNilReason();
            String theField;
