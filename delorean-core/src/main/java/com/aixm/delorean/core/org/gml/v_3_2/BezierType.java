...
"{http://www.opengis.net/gml/3.2}KnotPropertyType" maxOccurs="2" minOccurs="2"/>
 *       </sequence>
...
"{http://www.w3.org/2001/XMLSchema}boolean" fixed="true" />
 *     </restriction>
 *   </complexContent>
 * </complexType>
 * }</pre>
...
public class BezierType extends BSplineType implements Serializable {
