...
/**
 * <p>
 * Java class for MD_Medium_PropertyType complex type
 * </p>
 * .
 *
 * <p>
...
@XmlType(name = "MD_Medium_PropertyType", propOrder = {"mdMedium"})
public class MDMediumPropertyType implements Serializable, Equals, HashCode, ToString {
     ...
     *
     * @return possible object is {@link MDMediumType }
     *
     */
     ...
     *
     * @param value
     *            allowed object is {@link MDMediumType }
     *
     */
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final MDMediumPropertyType that = ((MDMediumPropertyType) object);
        {
        ...
        {
            boolean lhsFieldIsSet = this.isSetMDMedium();
            boolean rhsFieldIsSet = that.isSetMDMedium();
            MDMediumType lhsField;
            lhsField = this.getMDMedium();
            MDMediumType rhsField;
            rhsField = that.getMDMedium();
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "mdMedium", lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "mdMedium", rhsField);
            if (!strategy.equals(lhsFieldLocator, rhsFieldLocator, lhsField, rhsField, lhsFieldIsSet, rhsFieldIsSet)) {
                return false;
            }
        }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetMDMedium();
            MDMediumType theField;
            theField = this.getMDMedium();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "mdMedium", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            MDMediumType theField;
            theField = this.getMDMedium();
            strategy.appendField(locator, this, "mdMedium", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetNilReason();
            String theField;
