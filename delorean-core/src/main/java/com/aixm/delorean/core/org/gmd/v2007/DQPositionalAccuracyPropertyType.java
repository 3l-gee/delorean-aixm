...
/**
 * <p>
 * Java class for DQ_PositionalAccuracy_PropertyType complex type
 * </p>
 * .
 *
 * <p>
 ...
 *         <element ref=
"{http://www.isotc211.org/2005/gmd}AbstractDQ_PositionalAccuracy"/>
 *       </sequence>
...
@XmlType(name = "DQ_PositionalAccuracy_PropertyType", propOrder = {"abstractDQPositionalAccuracy"})
public class DQPositionalAccuracyPropertyType implements Serializable, Equals, HashCode, ToString {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final DQPositionalAccuracyPropertyType that = ((DQPositionalAccuracyPropertyType) object);
        {
        ...
        {
            boolean lhsFieldIsSet = this.isSetAbstractDQPositionalAccuracy();
            boolean rhsFieldIsSet = that.isSetAbstractDQPositionalAccuracy();
            JAXBElement<? extends AbstractDQPositionalAccuracyType> lhsField;
            lhsField = this.getAbstractDQPositionalAccuracy();
            JAXBElement<? extends AbstractDQPositionalAccuracyType> rhsField;
            rhsField = that.getAbstractDQPositionalAccuracy();
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "abstractDQPositionalAccuracy",
                    lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "abstractDQPositionalAccuracy",
                    rhsField);
            if (!strategy.equals(lhsFieldLocator, rhsFieldLocator, lhsField, rhsField, lhsFieldIsSet, rhsFieldIsSet)) {
                return false;
            }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetAbstractDQPositionalAccuracy();
            JAXBElement<? extends AbstractDQPositionalAccuracyType> theField;
            theField = this.getAbstractDQPositionalAccuracy();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "abstractDQPositionalAccuracy", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            JAXBElement<? extends AbstractDQPositionalAccuracyType> theField;
            theField = this.getAbstractDQPositionalAccuracy();
            strategy.appendField(locator, this, "abstractDQPositionalAccuracy", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetNilReason();
            String theField;
