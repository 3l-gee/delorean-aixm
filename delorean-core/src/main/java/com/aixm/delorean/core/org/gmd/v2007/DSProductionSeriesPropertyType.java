...
/**
 * <p>
 * Java class for DS_ProductionSeries_PropertyType complex type
 * </p>
 * .
 *
 * <p>
 ...
 *         <element ref=
"{http://www.isotc211.org/2005/gmd}DS_ProductionSeries"/>
 *       </sequence>
...
@XmlType(name = "DS_ProductionSeries_PropertyType", propOrder = {"dsProductionSeries"})
public class DSProductionSeriesPropertyType implements Serializable, Equals, HashCode, ToString {
     ...
     *
     * @return possible object is {@link DSProductionSeriesType }
     *
     */
     ...
     *
     * @param value
     *            allowed object is {@link DSProductionSeriesType }
     *
     */
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final DSProductionSeriesPropertyType that = ((DSProductionSeriesPropertyType) object);
        {
        ...
        {
            boolean lhsFieldIsSet = this.isSetDSProductionSeries();
            boolean rhsFieldIsSet = that.isSetDSProductionSeries();
            DSProductionSeriesType lhsField;
            lhsField = this.getDSProductionSeries();
            DSProductionSeriesType rhsField;
            rhsField = that.getDSProductionSeries();
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "dsProductionSeries", lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "dsProductionSeries", rhsField);
            if (!strategy.equals(lhsFieldLocator, rhsFieldLocator, lhsField, rhsField, lhsFieldIsSet, rhsFieldIsSet)) {
                return false;
            }
        }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetDSProductionSeries();
            DSProductionSeriesType theField;
            theField = this.getDSProductionSeries();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "dsProductionSeries", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            DSProductionSeriesType theField;
            theField = this.getDSProductionSeries();
            strategy.appendField(locator, this, "dsProductionSeries", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetNilReason();
            String theField;
