...
/**
 * <p>
 * Java class for GeocentricCRSPropertyType complex type
 * </p>
 * .
 *
 * <p>
...
@XmlType(name = "GeocentricCRSPropertyType", propOrder = {"geocentricCRS"})
public class GeocentricCRSPropertyType implements Serializable, Equals, HashCode, ToString {
     ...
     *
     * @return possible object is {@link GeocentricCRSType }
     *
     */
     ...
     *
     * @param value
     *            allowed object is {@link GeocentricCRSType }
     *
     */
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        {
            boolean lhsFieldIsSet = this.isSetGeocentricCRS();
            boolean rhsFieldIsSet = that.isSetGeocentricCRS();
            GeocentricCRSType lhsField;
            lhsField = this.getGeocentricCRS();
            GeocentricCRSType rhsField;
            rhsField = that.getGeocentricCRS();
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "geocentricCRS", lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "geocentricCRS", rhsField);
            if (!strategy.equals(lhsFieldLocator, rhsFieldLocator, lhsField, rhsField, lhsFieldIsSet, rhsFieldIsSet)) {
                return false;
            }
        }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetGeocentricCRS();
            GeocentricCRSType theField;
            theField = this.getGeocentricCRS();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "geocentricCRS", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            GeocentricCRSType theField;
            theField = this.getGeocentricCRS();
            strategy.appendField(locator, this, "geocentricCRS", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetNilReason();
            String theField;
