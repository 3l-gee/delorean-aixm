...
/**
 * <p>
 * Java class for DS_Sensor_PropertyType complex type
 * </p>
 * .
 *
 * <p>
...
@XmlType(name = "DS_Sensor_PropertyType", propOrder = {"dsSensor"})
public class DSSensorPropertyType implements Serializable, Equals, HashCode, ToString {
     ...
     *
     * @return possible object is {@link DSSensorType }
     *
     */
     ...
     *
     * @param value
     *            allowed object is {@link DSSensorType }
     *
     */
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final DSSensorPropertyType that = ((DSSensorPropertyType) object);
        {
        ...
        {
            boolean lhsFieldIsSet = this.isSetDSSensor();
            boolean rhsFieldIsSet = that.isSetDSSensor();
            DSSensorType lhsField;
            lhsField = this.getDSSensor();
            DSSensorType rhsField;
            rhsField = that.getDSSensor();
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "dsSensor", lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "dsSensor", rhsField);
            if (!strategy.equals(lhsFieldLocator, rhsFieldLocator, lhsField, rhsField, lhsFieldIsSet, rhsFieldIsSet)) {
                return false;
            }
        }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetDSSensor();
            DSSensorType theField;
            theField = this.getDSSensor();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "dsSensor", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            DSSensorType theField;
            theField = this.getDSSensor();
            strategy.appendField(locator, this, "dsSensor", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetNilReason();
            String theField;
