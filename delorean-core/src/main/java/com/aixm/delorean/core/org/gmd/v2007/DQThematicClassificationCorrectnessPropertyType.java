...
public class DQThematicClassificationCorrectnessPropertyType implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        {
            boolean lhsFieldIsSet = (this.dqThematicClassificationCorrectness!= null);
            boolean rhsFieldIsSet = (that.dqThematicClassificationCorrectness!= null);
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = (this.dqThematicClassificationCorrectness!= null);
