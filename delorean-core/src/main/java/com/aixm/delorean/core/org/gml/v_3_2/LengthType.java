 ...
 * vacuous extension (i.e. aliases) of gml:MeasureType. In this case, the
 * content model supports the description of a length (or distance) quantity,
 * with its units. The unit of measure referenced by uom shall be suitable for a
...
public class LengthType extends MeasureType implements Serializable {
