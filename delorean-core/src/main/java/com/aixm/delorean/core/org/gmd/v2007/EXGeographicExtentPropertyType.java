...
/**
 * <p>Java class for EX_GeographicExtent_PropertyType complex type</p>.
 * 
...
public class EXGeographicExtentPropertyType implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        {
            boolean lhsFieldIsSet = (this.abstractEXGeographicExtent!= null);
            boolean rhsFieldIsSet = (that.abstractEXGeographicExtent!= null);
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = (this.abstractEXGeographicExtent!= null);
