...
/**
 * <p>
 * Java class for DS_Association_PropertyType complex type
 * </p>
 * .
 *
 * <p>
...
@XmlType(name = "DS_Association_PropertyType", propOrder = {"dsAssociation"})
public class DSAssociationPropertyType implements Serializable, Equals, HashCode, ToString {
     ...
     *
     * @return possible object is {@link DSAssociationType }
     *
     */
     ...
     *
     * @param value
     *            allowed object is {@link DSAssociationType }
     *
     */
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final DSAssociationPropertyType that = ((DSAssociationPropertyType) object);
        {
        ...
        {
            boolean lhsFieldIsSet = this.isSetDSAssociation();
            boolean rhsFieldIsSet = that.isSetDSAssociation();
            DSAssociationType lhsField;
            lhsField = this.getDSAssociation();
            DSAssociationType rhsField;
            rhsField = that.getDSAssociation();
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "dsAssociation", lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "dsAssociation", rhsField);
            if (!strategy.equals(lhsFieldLocator, rhsFieldLocator, lhsField, rhsField, lhsFieldIsSet, rhsFieldIsSet)) {
                return false;
            }
        }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetDSAssociation();
            DSAssociationType theField;
            theField = this.getDSAssociation();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "dsAssociation", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            DSAssociationType theField;
            theField = this.getDSAssociation();
            strategy.appendField(locator, this, "dsAssociation", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetNilReason();
            String theField;
