 ...
 *       <sequence>
 *         <element ref=
"{http://www.opengis.net/gml/3.2}AbstractTimeSlice" maxOccurs="unbounded"/>
 *       </sequence>
 *       <attGroup ref=
...
@XmlType(name = "HistoryPropertyType", propOrder = {"abstractTimeSlice"})
public class HistoryPropertyType implements Serializable, Equals, HashCode, ToString {
     ...
     * interval of time — GML provides the gml:AbtractTimeSlice element. A timeslice
     * encapsulates the time-varying properties of a dynamic feature -- it shall be
     * extended to represent a time stamped projection of a specific feature. The
     * gml:dataSource property describes how the temporal data was acquired. A
     * gml:AbstractTimeSlice instance is a GML object that encapsulates updates of
     * the dynamic—or volatile—properties that reflect some change event; it thus
     * includes only those feature properties that have actually changed due to some
     * process. gml:AbstractTimeSlice basically provides a facility for
     * attribute-level time stamping, in contrast to the object-level time stamping
     * of dynamic feature instances. The time slice can thus be viewed as event or
     * process-oriented, whereas a snapshot is more state or structure-oriented. A
     * timeslice has richer causality, whereas a snapshot merely portrays the status
     * of the whole.Gets the value of the abstractTimeSlice property.
     *
     * <p>
     * This accessor method returns a reference to the live list, not a snapshot.
     * Therefore any modification you make to the returned list will be present
     * inside the JAXB object. This is why there is not a <CODE>set</CODE> method
     * for the abstractTimeSlice property.
     *
     * <p>
     ...
     * }{@code <}{@link MovingObjectStatusType }{@code >} {@link JAXBElement
