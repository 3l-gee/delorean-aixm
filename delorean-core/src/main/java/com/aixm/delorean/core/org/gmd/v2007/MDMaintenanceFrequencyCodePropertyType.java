...
/**
 * <p>
 * Java class for MD_MaintenanceFrequencyCode_PropertyType complex type
 * </p>
 * .
 *
 * <p>
...
@XmlType(name = "MD_MaintenanceFrequencyCode_PropertyType", propOrder = {"mdMaintenanceFrequencyCode"})
public class MDMaintenanceFrequencyCodePropertyType implements Serializable, Equals, HashCode, ToString {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetMDMaintenanceFrequencyCode();
