...
/**
 * <p>
 * Java class for DQ_TemporalValidity_PropertyType complex type
 * </p>
 * .
 *
 * <p>
 ...
 *         <element ref=
"{http://www.isotc211.org/2005/gmd}DQ_TemporalValidity"/>
 *       </sequence>
...
@XmlType(name = "DQ_TemporalValidity_PropertyType", propOrder = {"dqTemporalValidity"})
public class DQTemporalValidityPropertyType implements Serializable, Equals, HashCode, ToString {
     ...
     *
     * @return possible object is {@link DQTemporalValidityType }
     *
     */
     ...
     *
     * @param value
     *            allowed object is {@link DQTemporalValidityType }
     *
     */
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetDQTemporalValidity();
            DQTemporalValidityType theField;
            theField = this.getDQTemporalValidity();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "dqTemporalValidity", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            DQTemporalValidityType theField;
            theField = this.getDQTemporalValidity();
            strategy.appendField(locator, this, "dqTemporalValidity", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetNilReason();
            String theField;
