...
/**
 * <p>
 * Java class for CI_Series_PropertyType complex type
 * </p>
 * .
 *
 * <p>
...
@XmlType(name = "CI_Series_PropertyType", propOrder = {"ciSeries"})
public class CISeriesPropertyType implements Serializable, Equals, HashCode, ToString {
     ...
     *
     * @return possible object is {@link CISeriesType }
     *
     */
     ...
     *
     * @param value
     *            allowed object is {@link CISeriesType }
     *
     */
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final CISeriesPropertyType that = ((CISeriesPropertyType) object);
        {
        ...
        {
            boolean lhsFieldIsSet = this.isSetCISeries();
            boolean rhsFieldIsSet = that.isSetCISeries();
            CISeriesType lhsField;
            lhsField = this.getCISeries();
            CISeriesType rhsField;
            rhsField = that.getCISeries();
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "ciSeries", lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "ciSeries", rhsField);
            if (!strategy.equals(lhsFieldLocator, rhsFieldLocator, lhsField, rhsField, lhsFieldIsSet, rhsFieldIsSet)) {
                return false;
            }
        }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetCISeries();
            CISeriesType theField;
            theField = this.getCISeries();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "ciSeries", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            CISeriesType theField;
            theField = this.getCISeries();
            strategy.appendField(locator, this, "ciSeries", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetNilReason();
            String theField;
