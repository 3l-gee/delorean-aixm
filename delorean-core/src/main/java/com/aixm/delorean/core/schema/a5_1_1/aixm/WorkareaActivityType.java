...
/**
 * <p>Java class for WorkareaActivityType complex type</p>.
 * 
 ...
 *         <group ref="{http://www.aixm.aero/schema/5.1.1}WorkareaActivityPropertyGroup"/>
 ...
 *                   <element ref="{http://www.aixm.aero/schema/5.1.1}AbstractWorkareaActivityExtension"/>
 *                 </choice>
    ...
    implements Serializable
{
    ...
    public void setIsActiveItem(CodeYesNoType target) {
        setIsActive(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.1.1", "isActive"), WorkareaActivityType.class, target));
    }
