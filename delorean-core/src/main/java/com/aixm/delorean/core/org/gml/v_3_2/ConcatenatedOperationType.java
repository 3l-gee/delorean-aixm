 ...
 * operations. This sequence of operations is constrained by the requirement
 * that the source coordinate reference system of step (n+1) must be the same as
 * the target coordinate reference system of step (n). The source coordinate
 * reference system of the first step and the target coordinate reference system
 * of the last step are the source and target coordinate reference system
 * associated with the concatenated operation. Instead of a forward operation,
 * an inverse operation may be used for one or more of the operation steps
 * mentioned above, if the inverse operation is uniquely defined by the forward
 * operation. The gml:coordOperation property elements are an ordered sequence
 * of associations to the two or more operations used by this concatenated
 * operation. The AggregationAttributeGroup should be used to specify that the
 ...
 *       <sequence>
 *         <element ref=
"{http://www.opengis.net/gml/3.2}coordOperation" maxOccurs="unbounded" minOccurs
="2"/>
 *       </sequence>
 *       <attGroup ref=
...
@XmlType(name = "ConcatenatedOperationType", propOrder = {"coordOperation"})
public class ConcatenatedOperationType extends AbstractCoordinateOperationType implements Serializable {
    ...
    /**
     * gml:coordOperation is an association role to a coordinate operation.Gets the
     * value of the coordOperation property.
     *
     * <p>
     * This accessor method returns a reference to the live list, not a snapshot.
     * Therefore any modification you make to the returned list will be present
     * inside the JAXB object. This is why there is not a <CODE>set</CODE> method
     * for the coordOperation property.
     *
     * <p>
