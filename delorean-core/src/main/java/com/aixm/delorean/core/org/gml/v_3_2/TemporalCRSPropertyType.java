 ...
 *
 * <p>
 * Java class for TemporalCRSPropertyType complex type
 * </p>
 * .
 *
 * <p>
...
@XmlType(name = "TemporalCRSPropertyType", propOrder = {"temporalCRS"})
public class TemporalCRSPropertyType implements Serializable, Equals, HashCode, ToString {
     ...
     * time.
     *
     * @return possible object is {@link TemporalCRSType }
     *
     */
     ...
     *
     * @param value
     *            allowed object is {@link TemporalCRSType }
     *
     * @see #getTemporalCRS()
     */
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        {
            boolean lhsFieldIsSet = this.isSetTemporalCRS();
            boolean rhsFieldIsSet = that.isSetTemporalCRS();
            TemporalCRSType lhsField;
            lhsField = this.getTemporalCRS();
            TemporalCRSType rhsField;
            rhsField = that.getTemporalCRS();
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "temporalCRS", lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "temporalCRS", rhsField);
            if (!strategy.equals(lhsFieldLocator, rhsFieldLocator, lhsField, rhsField, lhsFieldIsSet, rhsFieldIsSet)) {
                return false;
            }
        }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetTemporalCRS();
            TemporalCRSType theField;
            theField = this.getTemporalCRS();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "temporalCRS", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            TemporalCRSType theField;
            theField = this.getTemporalCRS();
            strategy.appendField(locator, this, "temporalCRS", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetNilReason();
            String theField;
