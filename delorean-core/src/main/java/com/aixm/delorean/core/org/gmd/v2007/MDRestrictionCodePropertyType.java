...
/**
 * <p>Java class for MD_RestrictionCode_PropertyType complex type</p>.
 * 
...
public class MDRestrictionCodePropertyType implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        {
            boolean lhsFieldIsSet = (this.mdRestrictionCode!= null);
            boolean rhsFieldIsSet = (that.mdRestrictionCode!= null);
            CodeListValueType lhsField;
            lhsField = this.getMDRestrictionCode();
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = (this.mdRestrictionCode!= null);
            CodeListValueType theField;
            theField = this.getMDRestrictionCode();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "mdRestrictionCode", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            CodeListValueType theField;
            theField = this.getMDRestrictionCode();
            strategy.appendField(locator, this, "mdRestrictionCode", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = (this.nilReason!= null);
            String theField;
