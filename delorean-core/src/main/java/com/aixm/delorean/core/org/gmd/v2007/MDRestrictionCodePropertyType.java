...
/**
 * <p>
 * Java class for MD_RestrictionCode_PropertyType complex type
 * </p>
 * .
 *
 * <p>
...
@XmlType(name = "MD_RestrictionCode_PropertyType", propOrder = {"mdRestrictionCode"})
public class MDRestrictionCodePropertyType implements Serializable, Equals, HashCode, ToString {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetMDRestrictionCode();
