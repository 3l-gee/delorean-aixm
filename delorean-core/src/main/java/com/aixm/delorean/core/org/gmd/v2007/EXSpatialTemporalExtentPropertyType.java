...
/**
 * <p>
 * Java class for EX_SpatialTemporalExtent_PropertyType complex type
 * </p>
 * .
 *
 * <p>
 ...
 *         <element ref=
"{http://www.isotc211.org/2005/gmd}EX_SpatialTemporalExtent"/>
 *       </sequence>
...
@XmlType(name = "EX_SpatialTemporalExtent_PropertyType", propOrder = {"exSpatialTemporalExtent"})
public class EXSpatialTemporalExtentPropertyType implements Serializable, Equals, HashCode, ToString {
     ...
     *
     * @return possible object is {@link EXSpatialTemporalExtentType }
     *
     */
     ...
     *
     * @param value
     *            allowed object is {@link EXSpatialTemporalExtentType }
     *
     */
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final EXSpatialTemporalExtentPropertyType that = ((EXSpatialTemporalExtentPropertyType) object);
        {
        ...
        {
            boolean lhsFieldIsSet = this.isSetEXSpatialTemporalExtent();
            boolean rhsFieldIsSet = that.isSetEXSpatialTemporalExtent();
            EXSpatialTemporalExtentType lhsField;
            lhsField = this.getEXSpatialTemporalExtent();
            EXSpatialTemporalExtentType rhsField;
            rhsField = that.getEXSpatialTemporalExtent();
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "exSpatialTemporalExtent", lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "exSpatialTemporalExtent", rhsField);
            if (!strategy.equals(lhsFieldLocator, rhsFieldLocator, lhsField, rhsField, lhsFieldIsSet, rhsFieldIsSet)) {
                return false;
            }
        }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetEXSpatialTemporalExtent();
            EXSpatialTemporalExtentType theField;
            theField = this.getEXSpatialTemporalExtent();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "exSpatialTemporalExtent", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            EXSpatialTemporalExtentType theField;
            theField = this.getEXSpatialTemporalExtent();
            strategy.appendField(locator, this, "exSpatialTemporalExtent", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetNilReason();
            String theField;
