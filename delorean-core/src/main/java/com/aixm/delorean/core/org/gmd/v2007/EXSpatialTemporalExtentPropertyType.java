...
public class EXSpatialTemporalExtentPropertyType implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        {
            boolean lhsFieldIsSet = (this.exSpatialTemporalExtent!= null);
            boolean rhsFieldIsSet = (that.exSpatialTemporalExtent!= null);
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = (this.exSpatialTemporalExtent!= null);
