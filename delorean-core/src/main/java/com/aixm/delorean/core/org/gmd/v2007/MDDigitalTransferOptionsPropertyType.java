...
public class MDDigitalTransferOptionsPropertyType implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        {
            boolean lhsFieldIsSet = (this.mdDigitalTransferOptions!= null);
            boolean rhsFieldIsSet = (that.mdDigitalTransferOptions!= null);
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = (this.mdDigitalTransferOptions!= null);
