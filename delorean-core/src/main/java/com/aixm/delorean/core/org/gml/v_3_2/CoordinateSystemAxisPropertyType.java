 ...
 * to a coordinate system axis, either referencing or containing the definition
 * of that axis.
 *
 * <p>
 * Java class for CoordinateSystemAxisPropertyType complex type
 * </p>
 * .
 *
 * <p>
...
@XmlType(name = "CoordinateSystemAxisPropertyType", propOrder = {"coordinateSystemAxis"})
public class CoordinateSystemAxisPropertyType implements Serializable, Equals, HashCode, ToString {
     ...
     * gml:CoordinateSystemAxis is a definition of a coordinate system axis.
     *
     * @return possible object is {@link CoordinateSystemAxisType }
     *
     */
     ...
     *
     * @param value
     *            allowed object is {@link CoordinateSystemAxisType }
     *
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        {
            boolean lhsFieldIsSet = this.isSetCoordinateSystemAxis();
            boolean rhsFieldIsSet = that.isSetCoordinateSystemAxis();
            CoordinateSystemAxisType lhsField;
            lhsField = this.getCoordinateSystemAxis();
            CoordinateSystemAxisType rhsField;
            rhsField = that.getCoordinateSystemAxis();
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "coordinateSystemAxis", lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "coordinateSystemAxis", rhsField);
            if (!strategy.equals(lhsFieldLocator, rhsFieldLocator, lhsField, rhsField, lhsFieldIsSet, rhsFieldIsSet)) {
                return false;
            }
        }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetCoordinateSystemAxis();
            CoordinateSystemAxisType theField;
            theField = this.getCoordinateSystemAxis();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "coordinateSystemAxis", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            CoordinateSystemAxisType theField;
            theField = this.getCoordinateSystemAxis();
            strategy.appendField(locator, this, "coordinateSystemAxis", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetNilReason();
            String theField;
