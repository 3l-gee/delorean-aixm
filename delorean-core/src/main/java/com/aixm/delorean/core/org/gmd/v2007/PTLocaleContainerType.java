...
"{http://www.isotc211.org/2005/gmd}PT_Locale_PropertyType"/>
 *         <element name="date" type=
"{http://www.isotc211.org/2005/gmd}CI_Date_PropertyType" maxOccurs="unbounded"/>
 *         <element name="responsibleParty" type=
"{http://www.isotc211.org/2005/gmd}CI_ResponsibleParty_PropertyType" maxOccurs=
"unbounded"/>
 *         <element name="localisedString" type=
"{http://www.isotc211.org/2005/gmd}LocalisedCharacterString_PropertyType" maxOccurs
="unbounded"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
...
@XmlType(name = "PT_LocaleContainer_Type", propOrder = {"description", "locale", "date", "responsibleParty",
        "localisedString"})
public class PTLocaleContainerType implements Serializable, Equals, HashCode, ToString {
     ...
     *
     * @return possible object is {@link PTLocalePropertyType }
     *
     */
     ...
     *
     * @param value
     *            allowed object is {@link PTLocalePropertyType }
     *
     */
     ...
     * Therefore any modification you make to the returned list will be present
     * inside the JAXB object. This is why there is not a <CODE>set</CODE> method
     * for the responsibleParty property.
     *
     * <p>
     * For example, to add a new item, do as follows:
     *
     ...
     * Therefore any modification you make to the returned list will be present
     * inside the JAXB object. This is why there is not a <CODE>set</CODE> method
     * for the localisedString property.
     *
     * <p>
     * For example, to add a new item, do as follows:
     *
