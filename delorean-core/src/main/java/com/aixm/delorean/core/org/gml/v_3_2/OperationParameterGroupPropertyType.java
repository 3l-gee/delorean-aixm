 ...
 *
 * <p>
 * Java class for OperationParameterGroupPropertyType complex type
 * </p>
 * .
 *
 * <p>
 ...
 *         <element ref=
"{http://www.opengis.net/gml/3.2}OperationParameterGroup"/>
 *       </sequence>
 *       <attGroup ref=
...
@XmlType(name = "OperationParameterGroupPropertyType", propOrder = {"operationParameterGroup"})
public class OperationParameterGroupPropertyType implements Serializable, Equals, HashCode, ToString {

    private static final long serialVersionUID = 20251104L;
    /**
     * gml:OperationParameterGroup is the definition of a group of parameters used
     * by an operation method. This complex type is expected to be used or extended
     * for all applicable operation methods, without defining
     * operation-method-specialized element names. The generalOperationParameter
     * elements are an unordered list of associations to the set of operation
     ...
     * parameters that are members of this group.
     *
     * @return possible object is {@link OperationParameterGroupType }
     *
     */
     ...
     *
     * @param value
     *            allowed object is {@link OperationParameterGroupType }
     *
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        {
            boolean lhsFieldIsSet = this.isSetOperationParameterGroup();
            boolean rhsFieldIsSet = that.isSetOperationParameterGroup();
            OperationParameterGroupType lhsField;
            lhsField = this.getOperationParameterGroup();
            OperationParameterGroupType rhsField;
            rhsField = that.getOperationParameterGroup();
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "operationParameterGroup", lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "operationParameterGroup", rhsField);
            if (!strategy.equals(lhsFieldLocator, rhsFieldLocator, lhsField, rhsField, lhsFieldIsSet, rhsFieldIsSet)) {
                return false;
            }
        }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetOperationParameterGroup();
            OperationParameterGroupType theField;
            theField = this.getOperationParameterGroup();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "operationParameterGroup", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            OperationParameterGroupType theField;
            theField = this.getOperationParameterGroup();
            strategy.appendField(locator, this, "operationParameterGroup", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetNilReason();
            String theField;
