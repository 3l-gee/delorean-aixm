...
/**
 * <p>
 * Java class for RS_Identifier_PropertyType complex type
 * </p>
 * .
 *
 * <p>
...
@XmlType(name = "RS_Identifier_PropertyType", propOrder = {"rsIdentifier"})
public class RSIdentifierPropertyType implements Serializable, Equals, HashCode, ToString {
     ...
     *
     * @return possible object is {@link RSIdentifierType }
     *
     */
     ...
     *
     * @param value
     *            allowed object is {@link RSIdentifierType }
     *
     */
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final RSIdentifierPropertyType that = ((RSIdentifierPropertyType) object);
        {
        ...
        {
            boolean lhsFieldIsSet = this.isSetRSIdentifier();
            boolean rhsFieldIsSet = that.isSetRSIdentifier();
            RSIdentifierType lhsField;
            lhsField = this.getRSIdentifier();
            RSIdentifierType rhsField;
            rhsField = that.getRSIdentifier();
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "rsIdentifier", lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "rsIdentifier", rhsField);
            if (!strategy.equals(lhsFieldLocator, rhsFieldLocator, lhsField, rhsField, lhsFieldIsSet, rhsFieldIsSet)) {
                return false;
            }
        }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetRSIdentifier();
            RSIdentifierType theField;
            theField = this.getRSIdentifier();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "rsIdentifier", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            RSIdentifierType theField;
            theField = this.getRSIdentifier();
            strategy.appendField(locator, this, "rsIdentifier", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetNilReason();
            String theField;
