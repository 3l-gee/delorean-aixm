 ...
 *
 * <p>
 * Java class for ImageDatumPropertyType complex type
 * </p>
 * .
 *
 * <p>
...
@XmlType(name = "ImageDatumPropertyType", propOrder = {"imageDatum"})
public class ImageDatumPropertyType implements Serializable, Equals, HashCode, ToString {

    private static final long serialVersionUID = 20251104L;
    /**
     * gml:ImageDatum defines the origin of an image coordinate reference system,
     * and is used in a local context only. For an image datum, the anchor
     * definition is usually either the centre of the image or the corner of the
     * image. For more information, see ISO 19111 B.3.5.
     *
     */
     ...
     * image. For more information, see ISO 19111 B.3.5.
     *
     * @return possible object is {@link ImageDatumType }
     *
     */
     ...
     *
     * @param value
     *            allowed object is {@link ImageDatumType }
     *
     * @see #getImageDatum()
     */
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        }
        {
            ...
            ImageDatumType lhsField;
            lhsField = this.getImageDatum();
            ImageDatumType rhsField;
