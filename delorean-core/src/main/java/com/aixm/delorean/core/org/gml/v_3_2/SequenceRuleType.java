 ...
 * through the addition of an axisOrder attribute. The
 * gml:SequenceRuleEnumeration is an enumerated type. The rule names are defined
 * in ISO 19123. If no rule name is specified the default is "Linear".
 *
 * <p>
 ...
 *   <simpleContent>
 *     <extension base=
"<http://www.opengis.net/gml/3.2>SequenceRuleEnumeration">
 *       <attribute name="order" type=
"{http://www.opengis.net/gml/3.2}IncrementOrder" />
 *       <attribute name="axisOrder" type=
"{http://www.opengis.net/gml/3.2}AxisDirectionList" />
 *     </extension>
 *   </simpleContent>
 * </complexType>
 * }</pre>
...
public class SequenceRuleType implements Serializable, Equals, HashCode, ToString {
     ...
     *
     * @return possible object is {@link SequenceRuleEnumeration }
     *
     */
     ...
     *
     * @param value
     *            allowed object is {@link SequenceRuleEnumeration }
     *
     */
     ...
     *
     * @param value
     *            allowed object is {@link IncrementOrder }
     *
     */
