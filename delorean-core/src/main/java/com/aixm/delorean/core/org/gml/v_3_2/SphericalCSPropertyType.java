 ...
 * spherical coordinate system, either referencing or containing the definition
 * of that coordinate system.
 *
 * <p>
 * Java class for SphericalCSPropertyType complex type
 * </p>
 * .
 *
 * <p>
...
@XmlType(name = "SphericalCSPropertyType", propOrder = {"sphericalCS"})
public class SphericalCSPropertyType implements Serializable, Equals, HashCode, ToString {

    private static final long serialVersionUID = 20251104L;
    /**
     * gml:SphericalCS is a three-dimensional coordinate system with one distance
     * measured from the origin and two angular coordinates. A SphericalCS shall
     ...
     * have three gml:axis property elements.
     *
     * @return possible object is {@link SphericalCSType }
     *
     */
     ...
     *
     * @param value
     *            allowed object is {@link SphericalCSType }
     *
     * @see #getSphericalCS()
     */
