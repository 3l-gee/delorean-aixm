...
/**
 * <p>
 * Java class for MD_Identifier_PropertyType complex type
 * </p>
 * .
 *
 * <p>
...
@XmlType(name = "MD_Identifier_PropertyType", propOrder = {"mdIdentifier"})
public class MDIdentifierPropertyType implements Serializable, Equals, HashCode, ToString {
     ...
     *         }{@code <}{@link MDIdentifierType }{@code >} {@link JAXBElement
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final MDIdentifierPropertyType that = ((MDIdentifierPropertyType) object);
        {
        ...
        {
            boolean lhsFieldIsSet = this.isSetMDIdentifier();
            boolean rhsFieldIsSet = that.isSetMDIdentifier();
            JAXBElement<? extends MDIdentifierType> lhsField;
            lhsField = this.getMDIdentifier();
            JAXBElement<? extends MDIdentifierType> rhsField;
            rhsField = that.getMDIdentifier();
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "mdIdentifier", lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "mdIdentifier", rhsField);
            if (!strategy.equals(lhsFieldLocator, rhsFieldLocator, lhsField, rhsField, lhsFieldIsSet, rhsFieldIsSet)) {
                return false;
            }
        }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetMDIdentifier();
            JAXBElement<? extends MDIdentifierType> theField;
            theField = this.getMDIdentifier();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "mdIdentifier", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            JAXBElement<? extends MDIdentifierType> theField;
            theField = this.getMDIdentifier();
            strategy.appendField(locator, this, "mdIdentifier", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetNilReason();
            String theField;
