...
/**
 * <p>
 * Java class for MD_PortrayalCatalogueReference_PropertyType complex type
 * </p>
 * .
 *
 * <p>
 ...
 *         <element ref=
"{http://www.isotc211.org/2005/gmd}MD_PortrayalCatalogueReference"/>
 *       </sequence>
...
@XmlType(name = "MD_PortrayalCatalogueReference_PropertyType", propOrder = {"mdPortrayalCatalogueReference"})
public class MDPortrayalCatalogueReferencePropertyType implements Serializable, Equals, HashCode, ToString {
     ...
     *
     * @return possible object is {@link MDPortrayalCatalogueReferenceType }
     *
     */
     ...
     *
     * @param value
     *            allowed object is {@link MDPortrayalCatalogueReferenceType }
     *
     */
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final MDPortrayalCatalogueReferencePropertyType that = ((MDPortrayalCatalogueReferencePropertyType) object);
        {
        ...
        {
            boolean lhsFieldIsSet = this.isSetMDPortrayalCatalogueReference();
            boolean rhsFieldIsSet = that.isSetMDPortrayalCatalogueReference();
            MDPortrayalCatalogueReferenceType lhsField;
            lhsField = this.getMDPortrayalCatalogueReference();
            MDPortrayalCatalogueReferenceType rhsField;
            rhsField = that.getMDPortrayalCatalogueReference();
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "mdPortrayalCatalogueReference",
                    lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "mdPortrayalCatalogueReference",
                    rhsField);
            if (!strategy.equals(lhsFieldLocator, rhsFieldLocator, lhsField, rhsField, lhsFieldIsSet, rhsFieldIsSet)) {
                return false;
            }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetMDPortrayalCatalogueReference();
            MDPortrayalCatalogueReferenceType theField;
            theField = this.getMDPortrayalCatalogueReference();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "mdPortrayalCatalogueReference", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            MDPortrayalCatalogueReferenceType theField;
            theField = this.getMDPortrayalCatalogueReference();
            strategy.appendField(locator, this, "mdPortrayalCatalogueReference", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetNilReason();
            String theField;
