...
import com.aixm.delorean.core.org.gml.v_3_2.BaseUnitType;
import com.aixm.delorean.core.org.gml.v_3_2.ConventionalUnitType;
import com.aixm.delorean.core.org.gml.v_3_2.DerivedUnitType;
import com.aixm.delorean.core.org.gml.v_3_2.UnitDefinitionType;
...
/**
 * <p>
 * Java class for UnitOfMeasure_PropertyType complex type
 * </p>
 * .
 *
 * <p>
...
@XmlType(name = "UnitOfMeasure_PropertyType", propOrder = {"unitDefinition"})
public class UnitOfMeasurePropertyType implements Serializable, Equals, HashCode, ToString {

    private static final long serialVersionUID = 20251104L;
    /**
     * A gml:UnitDefinition is a general definition of a unit of measure. This
     * generic element is used only for units for which no relationship with other
     * units or units systems is known. The content model of gml:UnitDefinition adds
     * three additional properties to gml:Definition, gml:quantityType,
     * gml:quantityTypeReference and gml:catalogSymbol. The gml:catalogSymbol
     * property optionally gives the short symbol used for this unit. This element
     * is usually used when the relationship of this unit to other units or units
     * systems is unknown.
     *
     */
     ...
     * systems is unknown.
     *
     * @return possible object is {@link JAXBElement }{@code <}{@link BaseUnitType
     ...
     *
     * @param value
     *            allowed object is {@link JAXBElement }{@code <}{@link BaseUnitType
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final UnitOfMeasurePropertyType that = ((UnitOfMeasurePropertyType) object);
        {
        ...
        {
            boolean lhsFieldIsSet = this.isSetUnitDefinition();
            boolean rhsFieldIsSet = that.isSetUnitDefinition();
            JAXBElement<? extends UnitDefinitionType> lhsField;
            lhsField = this.getUnitDefinition();
            JAXBElement<? extends UnitDefinitionType> rhsField;
            rhsField = that.getUnitDefinition();
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "unitDefinition", lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "unitDefinition", rhsField);
            if (!strategy.equals(lhsFieldLocator, rhsFieldLocator, lhsField, rhsField, lhsFieldIsSet, rhsFieldIsSet)) {
                return false;
            }
        }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetUnitDefinition();
            JAXBElement<? extends UnitDefinitionType> theField;
            theField = this.getUnitDefinition();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "unitDefinition", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            JAXBElement<? extends UnitDefinitionType> theField;
            theField = this.getUnitDefinition();
            strategy.appendField(locator, this, "unitDefinition", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetNilReason();
            String theField;
