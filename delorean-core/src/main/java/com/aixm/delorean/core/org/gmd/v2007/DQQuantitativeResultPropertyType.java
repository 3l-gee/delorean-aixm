...
/**
 * <p>
 * Java class for DQ_QuantitativeResult_PropertyType complex type
 * </p>
 * .
 *
 * <p>
 ...
 *         <element ref=
"{http://www.isotc211.org/2005/gmd}DQ_QuantitativeResult"/>
 *       </sequence>
...
@XmlType(name = "DQ_QuantitativeResult_PropertyType", propOrder = {"dqQuantitativeResult"})
public class DQQuantitativeResultPropertyType implements Serializable, Equals, HashCode, ToString {
     ...
     *
     * @return possible object is {@link DQQuantitativeResultType }
     *
     */
     ...
     *
     * @param value
     *            allowed object is {@link DQQuantitativeResultType }
     *
     */
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final DQQuantitativeResultPropertyType that = ((DQQuantitativeResultPropertyType) object);
        {
            boolean lhsFieldIsSet = this.isSetDQQuantitativeResult();
            boolean rhsFieldIsSet = that.isSetDQQuantitativeResult();
            DQQuantitativeResultType lhsField;
            lhsField = this.getDQQuantitativeResult();
            DQQuantitativeResultType rhsField;
            rhsField = that.getDQQuantitativeResult();
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "dqQuantitativeResult", lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "dqQuantitativeResult", rhsField);
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetDQQuantitativeResult();
            DQQuantitativeResultType theField;
            theField = this.getDQQuantitativeResult();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "dqQuantitativeResult", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            DQQuantitativeResultType theField;
            theField = this.getDQQuantitativeResult();
            strategy.appendField(locator, this, "dqQuantitativeResult", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetNilReason();
            String theField;
