...
/**
 * <p>
 * Java class for MD_VectorSpatialRepresentation_PropertyType complex type
 * </p>
 * .
 *
 * <p>
...
@XmlType(name = "MD_VectorSpatialRepresentation_PropertyType", propOrder = {"mdVectorSpatialRepresentation"})
public class MDVectorSpatialRepresentationPropertyType implements Serializable, Equals, HashCode, ToString {
     ...
     *
     * @return possible object is {@link MDVectorSpatialRepresentationType }
     *
     */
     ...
     *
     * @param value
     *            allowed object is {@link MDVectorSpatialRepresentationType }
     *
     */
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final MDVectorSpatialRepresentationPropertyType that = ((MDVectorSpatialRepresentationPropertyType) object);
        {
            boolean lhsFieldIsSet = this.isSetMDVectorSpatialRepresentation();
            boolean rhsFieldIsSet = that.isSetMDVectorSpatialRepresentation();
            MDVectorSpatialRepresentationType lhsField;
            lhsField = this.getMDVectorSpatialRepresentation();
            MDVectorSpatialRepresentationType rhsField;
            rhsField = that.getMDVectorSpatialRepresentation();
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "mdVectorSpatialRepresentation",
                    lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "mdVectorSpatialRepresentation",
                    rhsField);
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetMDVectorSpatialRepresentation();
            MDVectorSpatialRepresentationType theField;
            theField = this.getMDVectorSpatialRepresentation();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "mdVectorSpatialRepresentation", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            MDVectorSpatialRepresentationType theField;
            theField = this.getMDVectorSpatialRepresentation();
            strategy.appendField(locator, this, "mdVectorSpatialRepresentation", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetNilReason();
            String theField;
