 ...
 *
 * <p>
 * Java class for ConcatenatedOperationPropertyType complex type
 * </p>
 * .
 *
 * <p>
 ...
 *         <element ref=
"{http://www.opengis.net/gml/3.2}ConcatenatedOperation"/>
 *       </sequence>
 *       <attGroup ref=
...
@XmlType(name = "ConcatenatedOperationPropertyType", propOrder = {"concatenatedOperation"})
public class ConcatenatedOperationPropertyType implements Serializable, Equals, HashCode, ToString {
     ...
     *
     * @return possible object is {@link ConcatenatedOperationType }
     *
     */
     ...
     *
     * @param value
     *            allowed object is {@link ConcatenatedOperationType }
     *
     */
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        {
            boolean lhsFieldIsSet = this.isSetConcatenatedOperation();
            boolean rhsFieldIsSet = that.isSetConcatenatedOperation();
            ConcatenatedOperationType lhsField;
            lhsField = this.getConcatenatedOperation();
            ConcatenatedOperationType rhsField;
            rhsField = that.getConcatenatedOperation();
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "concatenatedOperation", lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "concatenatedOperation", rhsField);
            if (!strategy.equals(lhsFieldLocator, rhsFieldLocator, lhsField, rhsField, lhsFieldIsSet, rhsFieldIsSet)) {
                return false;
            }
        }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetConcatenatedOperation();
            ConcatenatedOperationType theField;
            theField = this.getConcatenatedOperation();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "concatenatedOperation", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            ConcatenatedOperationType theField;
            theField = this.getConcatenatedOperation();
            strategy.appendField(locator, this, "concatenatedOperation", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetNilReason();
            String theField;
