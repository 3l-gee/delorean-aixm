...
@XmlType(name = "TopoPrimitiveArrayAssociationType", propOrder = {"abstractTopoPrimitive"})
public class TopoPrimitiveArrayAssociationType implements Serializable, Equals, HashCode, ToString {
     ...
     * for the abstractTopoPrimitive property.
     *
     * <p>
     ...
     * }{@code <}{@link NodeType }{@code >} {@link JAXBElement
     ...
     *
     */
    public void setAbstractTopoPrimitive(List<JAXBElement<? extends AbstractTopoPrimitiveType>> abstractTopoPrimitive) {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = 1;
        {
            ...
            List<JAXBElement<? extends AbstractTopoPrimitiveType>> theField;
            theField = (this.isSetAbstractTopoPrimitive() ? this.getAbstractTopoPrimitive() : null);
