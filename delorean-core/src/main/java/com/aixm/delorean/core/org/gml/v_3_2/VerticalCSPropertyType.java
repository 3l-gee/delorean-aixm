 ...
 *
 * <p>
 * Java class for VerticalCSPropertyType complex type
 * </p>
 * .
 *
 * <p>
...
@XmlType(name = "VerticalCSPropertyType", propOrder = {"verticalCS"})
public class VerticalCSPropertyType implements Serializable, Equals, HashCode, ToString {

    private static final long serialVersionUID = 20251104L;
    /**
     * gml:VerticalCS is a one-dimensional coordinate system used to record the
     * heights or depths of points. Such a coordinate system is usually dependent on
     * the Earth's gravity field, perhaps loosely as when atmospheric pressure is
     * the basis for the vertical coordinate system axis. A VerticalCS shall have
     ...
     * one gml:axis property element.
     *
     * @return possible object is {@link VerticalCSType }
     *
     */
     ...
     *
     * @param value
     *            allowed object is {@link VerticalCSType }
     *
     * @see #getVerticalCS()
     */
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        }
        {
            ...
            VerticalCSType lhsField;
            lhsField = this.getVerticalCS();
            VerticalCSType rhsField;
