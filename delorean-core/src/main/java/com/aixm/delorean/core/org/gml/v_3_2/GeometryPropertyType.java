 ...
 * another document). Note that either the reference or the contained element
 * shall be given, but not both or none. If a feature has a property that takes
 * a geometry element as its value, this is called a geometry property. A
...
@XmlType(name = "GeometryPropertyType", propOrder = {"abstractGeometry"})
