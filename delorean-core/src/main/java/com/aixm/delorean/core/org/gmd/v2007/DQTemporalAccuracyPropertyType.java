...
public class DQTemporalAccuracyPropertyType implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        {
            boolean lhsFieldIsSet = (this.abstractDQTemporalAccuracy!= null);
            boolean rhsFieldIsSet = (that.abstractDQTemporalAccuracy!= null);
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = (this.abstractDQTemporalAccuracy!= null);
