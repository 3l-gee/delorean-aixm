...
/**
 * <p>
 * Java class for LI_Lineage_PropertyType complex type
 * </p>
 * .
 *
 * <p>
...
@XmlType(name = "LI_Lineage_PropertyType", propOrder = {"liLineage"})
public class LILineagePropertyType implements Serializable, Equals, HashCode, ToString {
     ...
     *
     * @return possible object is {@link LILineageType }
     *
     */
     ...
     *
     * @param value
     *            allowed object is {@link LILineageType }
     *
     */
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final LILineagePropertyType that = ((LILineagePropertyType) object);
        {
        ...
        {
            boolean lhsFieldIsSet = this.isSetLILineage();
            boolean rhsFieldIsSet = that.isSetLILineage();
            LILineageType lhsField;
            lhsField = this.getLILineage();
            LILineageType rhsField;
            rhsField = that.getLILineage();
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "liLineage", lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "liLineage", rhsField);
            if (!strategy.equals(lhsFieldLocator, rhsFieldLocator, lhsField, rhsField, lhsFieldIsSet, rhsFieldIsSet)) {
                return false;
            }
        }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetLILineage();
            LILineageType theField;
            theField = this.getLILineage();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "liLineage", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            LILineageType theField;
            theField = this.getLILineage();
            strategy.appendField(locator, this, "liLineage", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetNilReason();
            String theField;
