...
/**
 * <p>
 * Java class for CI_Telephone_PropertyType complex type
 * </p>
 * .
 *
 * <p>
...
@XmlType(name = "CI_Telephone_PropertyType", propOrder = {"ciTelephone"})
public class CITelephonePropertyType implements Serializable, Equals, HashCode, ToString {
     ...
     *
     * @return possible object is {@link CITelephoneType }
     *
     */
     ...
     *
     * @param value
     *            allowed object is {@link CITelephoneType }
     *
     */
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final CITelephonePropertyType that = ((CITelephonePropertyType) object);
        {
            boolean lhsFieldIsSet = this.isSetCITelephone();
            boolean rhsFieldIsSet = that.isSetCITelephone();
            CITelephoneType lhsField;
            lhsField = this.getCITelephone();
            CITelephoneType rhsField;
            rhsField = that.getCITelephone();
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "ciTelephone", lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "ciTelephone", rhsField);
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetCITelephone();
            CITelephoneType theField;
            theField = this.getCITelephone();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "ciTelephone", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            CITelephoneType theField;
            theField = this.getCITelephone();
            strategy.appendField(locator, this, "ciTelephone", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetNilReason();
            String theField;
