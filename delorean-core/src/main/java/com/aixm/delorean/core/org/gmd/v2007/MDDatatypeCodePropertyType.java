...
public class MDDatatypeCodePropertyType implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        {
            boolean lhsFieldIsSet = (this.mdDatatypeCode!= null);
            boolean rhsFieldIsSet = (that.mdDatatypeCode!= null);
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = (this.mdDatatypeCode!= null);
            CodeListValueType theField;
            theField = this.getMDDatatypeCode();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "mdDatatypeCode", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            CodeListValueType theField;
            theField = this.getMDDatatypeCode();
            strategy.appendField(locator, this, "mdDatatypeCode", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = (this.nilReason!= null);
            String theField;
