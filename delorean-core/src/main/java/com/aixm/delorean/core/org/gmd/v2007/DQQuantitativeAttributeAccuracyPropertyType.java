...
/**
 * <p>
 * Java class for DQ_QuantitativeAttributeAccuracy_PropertyType complex type
 * </p>
 * .
 *
 * <p>
 ...
 *         <element ref=
"{http://www.isotc211.org/2005/gmd}DQ_QuantitativeAttributeAccuracy"/>
 *       </sequence>
...
@XmlType(name = "DQ_QuantitativeAttributeAccuracy_PropertyType", propOrder = {"dqQuantitativeAttributeAccuracy"})
public class DQQuantitativeAttributeAccuracyPropertyType implements Serializable, Equals, HashCode, ToString {
     ...
     *
     * @return possible object is {@link DQQuantitativeAttributeAccuracyType }
     *
     */
     ...
     *
     * @param value
     *            allowed object is {@link DQQuantitativeAttributeAccuracyType }
     *
     */
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final DQQuantitativeAttributeAccuracyPropertyType that = ((DQQuantitativeAttributeAccuracyPropertyType) object);
        {
        ...
        {
            boolean lhsFieldIsSet = this.isSetDQQuantitativeAttributeAccuracy();
            boolean rhsFieldIsSet = that.isSetDQQuantitativeAttributeAccuracy();
            DQQuantitativeAttributeAccuracyType lhsField;
            lhsField = this.getDQQuantitativeAttributeAccuracy();
            DQQuantitativeAttributeAccuracyType rhsField;
            rhsField = that.getDQQuantitativeAttributeAccuracy();
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "dqQuantitativeAttributeAccuracy",
                    lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "dqQuantitativeAttributeAccuracy",
                    rhsField);
            if (!strategy.equals(lhsFieldLocator, rhsFieldLocator, lhsField, rhsField, lhsFieldIsSet, rhsFieldIsSet)) {
                return false;
            }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetDQQuantitativeAttributeAccuracy();
            DQQuantitativeAttributeAccuracyType theField;
            theField = this.getDQQuantitativeAttributeAccuracy();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "dqQuantitativeAttributeAccuracy", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            DQQuantitativeAttributeAccuracyType theField;
            theField = this.getDQQuantitativeAttributeAccuracy();
            strategy.appendField(locator, this, "dqQuantitativeAttributeAccuracy", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetNilReason();
            String theField;
