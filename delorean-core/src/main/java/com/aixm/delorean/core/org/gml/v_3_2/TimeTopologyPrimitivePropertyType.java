 ...
 *
 * <p>
 * Java class for TimeTopologyPrimitivePropertyType complex type
 * </p>
 * .
 *
 * <p>
 ...
 *         <element ref=
"{http://www.opengis.net/gml/3.2}AbstractTimeTopologyPrimitive"/>
 *       </sequence>
 *       <attGroup ref=
...
@XmlType(name = "TimeTopologyPrimitivePropertyType", propOrder = {"abstractTimeTopologyPrimitive"})
public class TimeTopologyPrimitivePropertyType implements Serializable, Equals, HashCode, ToString {

    private static final long serialVersionUID = 20251104L;
    /**
     * gml:TimeTopologyPrimitive acts as the head of a substitution group for
     * topological temporal primitives. Temporal topology primitives shall imply the
     * ordering information between features or feature properties. The temporal
     * connection of features can be examined if they have temporal topology
     * primitives as values of their properties. Usually, an instantaneous feature
     * associates with a time node, and a static feature associates with a time
     * edge. A feature with both modes associates with the temporal topology
     * primitive: a supertype of time nodes and time edges. A topological primitive
     * is always connected to one or more other topological primitives, and is,
     * therefore, always a member of a topological complex. In a GML instance, this
     * will often be indicated by the primitives being described by elements that
     * are descendents of an element describing a complex. However, in order to
     * support the case where a temporal topological primitive is described in
     * another context, the optional complex property is provided, which carries a
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        {
            boolean lhsFieldIsSet = this.isSetAbstractTimeTopologyPrimitive();
            boolean rhsFieldIsSet = that.isSetAbstractTimeTopologyPrimitive();
            JAXBElement<? extends AbstractTimeTopologyPrimitiveType> lhsField;
            lhsField = this.getAbstractTimeTopologyPrimitive();
            JAXBElement<? extends AbstractTimeTopologyPrimitiveType> rhsField;
            rhsField = that.getAbstractTimeTopologyPrimitive();
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "abstractTimeTopologyPrimitive",
                    lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "abstractTimeTopologyPrimitive",
                    rhsField);
            if (!strategy.equals(lhsFieldLocator, rhsFieldLocator, lhsField, rhsField, lhsFieldIsSet, rhsFieldIsSet)) {
                return false;
            }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetAbstractTimeTopologyPrimitive();
            JAXBElement<? extends AbstractTimeTopologyPrimitiveType> theField;
            theField = this.getAbstractTimeTopologyPrimitive();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "abstractTimeTopologyPrimitive", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            JAXBElement<? extends AbstractTimeTopologyPrimitiveType> theField;
            theField = this.getAbstractTimeTopologyPrimitive();
            strategy.appendField(locator, this, "abstractTimeTopologyPrimitive", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetNilReason();
            String theField;
