...
/**
 * <p>
 * Java class for MD_CoverageDescription_PropertyType complex type
 * </p>
 * .
 *
 * <p>
...
@XmlType(name = "MD_CoverageDescription_PropertyType", propOrder = {"mdCoverageDescription"})
public class MDCoverageDescriptionPropertyType implements Serializable, Equals, HashCode, ToString {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final MDCoverageDescriptionPropertyType that = ((MDCoverageDescriptionPropertyType) object);
        {
        ...
        {
            boolean lhsFieldIsSet = this.isSetMDCoverageDescription();
            boolean rhsFieldIsSet = that.isSetMDCoverageDescription();
            JAXBElement<? extends MDCoverageDescriptionType> lhsField;
            lhsField = this.getMDCoverageDescription();
            JAXBElement<? extends MDCoverageDescriptionType> rhsField;
            rhsField = that.getMDCoverageDescription();
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "mdCoverageDescription", lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "mdCoverageDescription", rhsField);
            if (!strategy.equals(lhsFieldLocator, rhsFieldLocator, lhsField, rhsField, lhsFieldIsSet, rhsFieldIsSet)) {
                return false;
            }
        }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetMDCoverageDescription();
            JAXBElement<? extends MDCoverageDescriptionType> theField;
            theField = this.getMDCoverageDescription();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "mdCoverageDescription", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            JAXBElement<? extends MDCoverageDescriptionType> theField;
            theField = this.getMDCoverageDescription();
            strategy.appendField(locator, this, "mdCoverageDescription", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetNilReason();
            String theField;
