 ...
 *
 * <p>
 * Java class for DatumPropertyType complex type
 * </p>
 * .
 *
 * <p>
...
@XmlType(name = "DatumPropertyType", propOrder = {"abstractDatum"})
public class DatumPropertyType implements Serializable, Equals, HashCode, ToString {

    private static final long serialVersionUID = 20251104L;
    /**
     * A gml:AbstractDatum specifies the relationship of a coordinate system to the
     * earth, thus creating a coordinate reference system. A datum uses a parameter
     * or set of parameters that determine the location of the origin of the
     * coordinate reference system. Each datum subtype may be associated with only
     * specific types of coordinate systems. This abstract complex type shall not be
     * used, extended, or restricted, in a GML Application Schema, to define a
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetAbstractDatum();
            JAXBElement<? extends AbstractDatumType> theField;
            theField = this.getAbstractDatum();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "abstractDatum", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            JAXBElement<? extends AbstractDatumType> theField;
            theField = this.getAbstractDatum();
            strategy.appendField(locator, this, "abstractDatum", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetNilReason();
            String theField;
