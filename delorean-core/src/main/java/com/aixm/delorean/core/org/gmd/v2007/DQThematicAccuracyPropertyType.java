...
/**
 * <p>
 * Java class for DQ_ThematicAccuracy_PropertyType complex type
 * </p>
 * .
 *
 * <p>
...
@XmlType(name = "DQ_ThematicAccuracy_PropertyType", propOrder = {"abstractDQThematicAccuracy"})
public class DQThematicAccuracyPropertyType implements Serializable, Equals, HashCode, ToString {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetAbstractDQThematicAccuracy();
            JAXBElement<? extends AbstractDQThematicAccuracyType> theField;
            theField = this.getAbstractDQThematicAccuracy();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "abstractDQThematicAccuracy", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            JAXBElement<? extends AbstractDQThematicAccuracyType> theField;
            theField = this.getAbstractDQThematicAccuracy();
            strategy.appendField(locator, this, "abstractDQThematicAccuracy", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetNilReason();
            String theField;
