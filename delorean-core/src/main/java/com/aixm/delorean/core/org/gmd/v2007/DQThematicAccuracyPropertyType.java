...
public class DQThematicAccuracyPropertyType implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        {
            boolean lhsFieldIsSet = (this.abstractDQThematicAccuracy!= null);
            boolean rhsFieldIsSet = (that.abstractDQThematicAccuracy!= null);
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = (this.abstractDQThematicAccuracy!= null);
