...
/**
 * <p>
 * Java class for MD_Band_PropertyType complex type
 * </p>
 * .
 *
 * <p>
...
@XmlType(name = "MD_Band_PropertyType", propOrder = {"mdBand"})
public class MDBandPropertyType implements Serializable, Equals, HashCode, ToString {
     ...
     *
     * @return possible object is {@link MDBandType }
     *
     */
     ...
     *
     * @param value
     *            allowed object is {@link MDBandType }
     *
     */
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final MDBandPropertyType that = ((MDBandPropertyType) object);
        {
        ...
        {
            boolean lhsFieldIsSet = this.isSetMDBand();
            boolean rhsFieldIsSet = that.isSetMDBand();
            MDBandType lhsField;
            lhsField = this.getMDBand();
            MDBandType rhsField;
            rhsField = that.getMDBand();
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "mdBand", lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "mdBand", rhsField);
            if (!strategy.equals(lhsFieldLocator, rhsFieldLocator, lhsField, rhsField, lhsFieldIsSet, rhsFieldIsSet)) {
                return false;
            }
        }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetMDBand();
            MDBandType theField;
            theField = this.getMDBand();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "mdBand", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            MDBandType theField;
            theField = this.getMDBand();
            strategy.appendField(locator, this, "mdBand", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetNilReason();
            String theField;
