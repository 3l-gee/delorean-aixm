...
public class MDCoverageContentTypeCodePropertyType implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        final MDCoverageContentTypeCodePropertyType that = ((MDCoverageContentTypeCodePropertyType) object);
        {
            boolean lhsFieldIsSet = (this.mdCoverageContentTypeCode!= null);
            boolean rhsFieldIsSet = (that.mdCoverageContentTypeCode!= null);
            CodeListValueType lhsField;
            lhsField = this.getMDCoverageContentTypeCode();
            CodeListValueType rhsField;
            rhsField = that.getMDCoverageContentTypeCode();
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "mdCoverageContentTypeCode", lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "mdCoverageContentTypeCode", rhsField);
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = (this.mdCoverageContentTypeCode!= null);
            CodeListValueType theField;
            theField = this.getMDCoverageContentTypeCode();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "mdCoverageContentTypeCode", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            CodeListValueType theField;
            theField = this.getMDCoverageContentTypeCode();
            strategy.appendField(locator, this, "mdCoverageContentTypeCode", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = (this.nilReason!= null);
            String theField;
