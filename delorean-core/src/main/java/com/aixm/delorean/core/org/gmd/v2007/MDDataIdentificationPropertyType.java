...
/**
 * <p>
 * Java class for MD_DataIdentification_PropertyType complex type
 * </p>
 * .
 *
 * <p>
...
@XmlType(name = "MD_DataIdentification_PropertyType", propOrder = {"mdDataIdentification"})
public class MDDataIdentificationPropertyType implements Serializable, Equals, HashCode, ToString {
     ...
     *
     * @return possible object is {@link MDDataIdentificationType }
     *
     */
     ...
     *
     * @param value
     *            allowed object is {@link MDDataIdentificationType }
     *
     */
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final MDDataIdentificationPropertyType that = ((MDDataIdentificationPropertyType) object);
        {
        ...
        {
            boolean lhsFieldIsSet = this.isSetMDDataIdentification();
            boolean rhsFieldIsSet = that.isSetMDDataIdentification();
            MDDataIdentificationType lhsField;
            lhsField = this.getMDDataIdentification();
            MDDataIdentificationType rhsField;
            rhsField = that.getMDDataIdentification();
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "mdDataIdentification", lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "mdDataIdentification", rhsField);
            if (!strategy.equals(lhsFieldLocator, rhsFieldLocator, lhsField, rhsField, lhsFieldIsSet, rhsFieldIsSet)) {
                return false;
            }
        }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetMDDataIdentification();
            MDDataIdentificationType theField;
            theField = this.getMDDataIdentification();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "mdDataIdentification", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            MDDataIdentificationType theField;
            theField = this.getMDDataIdentification();
            strategy.appendField(locator, this, "mdDataIdentification", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetNilReason();
            String theField;
