...
/**
 * <p>Java class for EX_GeographicBoundingBox_PropertyType complex type</p>.
 * 
...
public class EXGeographicBoundingBoxPropertyType implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        {
            boolean lhsFieldIsSet = (this.exGeographicBoundingBox!= null);
            boolean rhsFieldIsSet = (that.exGeographicBoundingBox!= null);
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = (this.exGeographicBoundingBox!= null);
