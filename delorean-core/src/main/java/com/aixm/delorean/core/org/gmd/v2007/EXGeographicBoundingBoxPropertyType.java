...
/**
 * <p>
 * Java class for EX_GeographicBoundingBox_PropertyType complex type
 * </p>
 * .
 *
 * <p>
...
@XmlType(name = "EX_GeographicBoundingBox_PropertyType", propOrder = {"exGeographicBoundingBox"})
public class EXGeographicBoundingBoxPropertyType implements Serializable, Equals, HashCode, ToString {
     ...
     *
     * @return possible object is {@link EXGeographicBoundingBoxType }
     *
     */
     ...
     *
     * @param value
     *            allowed object is {@link EXGeographicBoundingBoxType }
     *
     */
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetEXGeographicBoundingBox();
            EXGeographicBoundingBoxType theField;
            theField = this.getEXGeographicBoundingBox();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "exGeographicBoundingBox", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            EXGeographicBoundingBoxType theField;
            theField = this.getEXGeographicBoundingBox();
            strategy.appendField(locator, this, "exGeographicBoundingBox", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetNilReason();
            String theField;
