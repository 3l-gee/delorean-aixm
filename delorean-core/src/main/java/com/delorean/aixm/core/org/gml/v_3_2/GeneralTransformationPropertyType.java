 ...
 *
 * <p>
 * Java class for GeneralTransformationPropertyType complex type
 * </p>
 * .
 *
 * <p>
 ...
 *         <element ref=
"{http://www.opengis.net/gml/3.2}AbstractGeneralTransformation"/>
 *       </sequence>
 *       <attGroup ref=
...
@XmlType(name = "GeneralTransformationPropertyType", propOrder = {"abstractGeneralTransformation"})
public class GeneralTransformationPropertyType implements Serializable, Equals, HashCode, ToString {

    private static final long serialVersionUID = 20251104L;
    /**
     * gml:AbstractGeneralTransformation is an abstract operation on coordinates
     * that usually includes a change of Datum. The parameters of a coordinate
     ...
     * same coordinate transformation. The operationVersion, sourceCRS, and
     * targetCRS proeprty elements are mandatory in a coordinate transformation.
     * This abstract complex type is expected to be extended for well-known
     * operation methods with many Transformation instances, in Application Schemas
     * that define operation-method-specialized value element names and contents.
     * This transformation uses an operation method with associated parameter
     * values. However, operation methods and parameter values are directly
     * associated with concrete subtypes, not with this abstract type. All concrete
     * types derived from this type shall extend this type to include a "usesMethod"
     * element that references one "OperationMethod" element. Similarly, all
     * concrete types derived from this type shall extend this type to include one
     * or more elements each named "uses...Value" that each use the type of an
     * element substitutable for the "AbstractGeneralParameterValue" element.
     *
     */
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        {
            boolean lhsFieldIsSet = this.isSetAbstractGeneralTransformation();
            boolean rhsFieldIsSet = that.isSetAbstractGeneralTransformation();
            JAXBElement<? extends AbstractGeneralTransformationType> lhsField;
            lhsField = this.getAbstractGeneralTransformation();
            JAXBElement<? extends AbstractGeneralTransformationType> rhsField;
            rhsField = that.getAbstractGeneralTransformation();
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "abstractGeneralTransformation",
                    lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "abstractGeneralTransformation",
                    rhsField);
            if (!strategy.equals(lhsFieldLocator, rhsFieldLocator, lhsField, rhsField, lhsFieldIsSet, rhsFieldIsSet)) {
                return false;
            }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetAbstractGeneralTransformation();
            JAXBElement<? extends AbstractGeneralTransformationType> theField;
            theField = this.getAbstractGeneralTransformation();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "abstractGeneralTransformation", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            JAXBElement<? extends AbstractGeneralTransformationType> theField;
            theField = this.getAbstractGeneralTransformation();
            strategy.appendField(locator, this, "abstractGeneralTransformation", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetNilReason();
            String theField;
