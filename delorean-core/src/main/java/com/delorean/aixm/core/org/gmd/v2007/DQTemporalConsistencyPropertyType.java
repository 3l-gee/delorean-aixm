...
/**
 * <p>
 * Java class for DQ_TemporalConsistency_PropertyType complex type
 * </p>
 * .
 *
 * <p>
 ...
 *         <element ref=
"{http://www.isotc211.org/2005/gmd}DQ_TemporalConsistency"/>
 *       </sequence>
...
@XmlType(name = "DQ_TemporalConsistency_PropertyType", propOrder = {"dqTemporalConsistency"})
public class DQTemporalConsistencyPropertyType implements Serializable, Equals, HashCode, ToString {
     ...
     *
     * @return possible object is {@link DQTemporalConsistencyType }
     *
     */
     ...
     *
     * @param value
     *            allowed object is {@link DQTemporalConsistencyType }
     *
     */
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final DQTemporalConsistencyPropertyType that = ((DQTemporalConsistencyPropertyType) object);
        {
            boolean lhsFieldIsSet = this.isSetDQTemporalConsistency();
            boolean rhsFieldIsSet = that.isSetDQTemporalConsistency();
            DQTemporalConsistencyType lhsField;
            lhsField = this.getDQTemporalConsistency();
            DQTemporalConsistencyType rhsField;
            rhsField = that.getDQTemporalConsistency();
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "dqTemporalConsistency", lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "dqTemporalConsistency", rhsField);
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetDQTemporalConsistency();
            DQTemporalConsistencyType theField;
            theField = this.getDQTemporalConsistency();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "dqTemporalConsistency", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            DQTemporalConsistencyType theField;
            theField = this.getDQTemporalConsistency();
            strategy.appendField(locator, this, "dqTemporalConsistency", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetNilReason();
            String theField;
