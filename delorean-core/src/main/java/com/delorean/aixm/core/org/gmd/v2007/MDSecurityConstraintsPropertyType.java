...
/**
 * <p>
 * Java class for MD_SecurityConstraints_PropertyType complex type
 * </p>
 * .
 *
 * <p>
 ...
 *         <element ref=
"{http://www.isotc211.org/2005/gmd}MD_SecurityConstraints"/>
 *       </sequence>
...
@XmlType(name = "MD_SecurityConstraints_PropertyType", propOrder = {"mdSecurityConstraints"})
public class MDSecurityConstraintsPropertyType implements Serializable, Equals, HashCode, ToString {
     ...
     *
     * @return possible object is {@link MDSecurityConstraintsType }
     *
     */
     ...
     *
     * @param value
     *            allowed object is {@link MDSecurityConstraintsType }
     *
     */
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final MDSecurityConstraintsPropertyType that = ((MDSecurityConstraintsPropertyType) object);
        {
        ...
        {
            boolean lhsFieldIsSet = this.isSetMDSecurityConstraints();
            boolean rhsFieldIsSet = that.isSetMDSecurityConstraints();
            MDSecurityConstraintsType lhsField;
            lhsField = this.getMDSecurityConstraints();
            MDSecurityConstraintsType rhsField;
            rhsField = that.getMDSecurityConstraints();
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "mdSecurityConstraints", lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "mdSecurityConstraints", rhsField);
            if (!strategy.equals(lhsFieldLocator, rhsFieldLocator, lhsField, rhsField, lhsFieldIsSet, rhsFieldIsSet)) {
                return false;
            }
        }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetMDSecurityConstraints();
            MDSecurityConstraintsType theField;
            theField = this.getMDSecurityConstraints();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "mdSecurityConstraints", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            MDSecurityConstraintsType theField;
            theField = this.getMDSecurityConstraints();
            strategy.appendField(locator, this, "mdSecurityConstraints", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetNilReason();
            String theField;
