...
/**
 * <p>
 * Java class for TemporalCSPropertyType complex type
 * </p>
 * .
 *
 * <p>
...
@XmlType(name = "TemporalCSPropertyType", propOrder = {"temporalCS"})
public class TemporalCSPropertyType implements Serializable, Equals, HashCode, ToString {
     ...
     *
     * @return possible object is {@link TemporalCSType }
     *
     */
     ...
     *
     * @param value
     *            allowed object is {@link TemporalCSType }
     *
     */
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        {
            boolean lhsFieldIsSet = this.isSetTemporalCS();
            boolean rhsFieldIsSet = that.isSetTemporalCS();
            TemporalCSType lhsField;
            lhsField = this.getTemporalCS();
            TemporalCSType rhsField;
            rhsField = that.getTemporalCS();
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "temporalCS", lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "temporalCS", rhsField);
            if (!strategy.equals(lhsFieldLocator, rhsFieldLocator, lhsField, rhsField, lhsFieldIsSet, rhsFieldIsSet)) {
                return false;
            }
        }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetTemporalCS();
            TemporalCSType theField;
            theField = this.getTemporalCS();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "temporalCS", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            TemporalCSType theField;
            theField = this.getTemporalCS();
            strategy.appendField(locator, this, "temporalCS", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetNilReason();
            String theField;
