...
// import com.delorean.aixm.core.schema.a5_2.aixm.AbstractAIXMTimeSliceType;
...
//     public static <T extends AbstractAIXMTimeSliceType> T integrate(Class<T> type, T oldObj, T newObj) {
//         T result;
//         try {
