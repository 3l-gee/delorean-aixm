...
/**
 * <p>
 * Java class for DS_StereoMate_PropertyType complex type
 * </p>
 * .
 *
 * <p>
...
@XmlType(name = "DS_StereoMate_PropertyType", propOrder = {"dsStereoMate"})
public class DSStereoMatePropertyType implements Serializable, Equals, HashCode, ToString {
     ...
     *
     * @return possible object is {@link DSStereoMateType }
     *
     */
     ...
     *
     * @param value
     *            allowed object is {@link DSStereoMateType }
     *
     */
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final DSStereoMatePropertyType that = ((DSStereoMatePropertyType) object);
        {
        ...
        {
            boolean lhsFieldIsSet = this.isSetDSStereoMate();
            boolean rhsFieldIsSet = that.isSetDSStereoMate();
            DSStereoMateType lhsField;
            lhsField = this.getDSStereoMate();
            DSStereoMateType rhsField;
            rhsField = that.getDSStereoMate();
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "dsStereoMate", lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "dsStereoMate", rhsField);
            if (!strategy.equals(lhsFieldLocator, rhsFieldLocator, lhsField, rhsField, lhsFieldIsSet, rhsFieldIsSet)) {
                return false;
            }
        }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetDSStereoMate();
            DSStereoMateType theField;
            theField = this.getDSStereoMate();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "dsStereoMate", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            DSStereoMateType theField;
            theField = this.getDSStereoMate();
            strategy.appendField(locator, this, "dsStereoMate", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetNilReason();
            String theField;
