...
/**
 * <p>
 * Java class for MD_MaintenanceInformation_PropertyType complex type
 * </p>
 * .
 *
 * <p>
...
@XmlType(name = "MD_MaintenanceInformation_PropertyType", propOrder = {"mdMaintenanceInformation"})
public class MDMaintenanceInformationPropertyType implements Serializable, Equals, HashCode, ToString {
     ...
     *
     * @return possible object is {@link MDMaintenanceInformationType }
     *
     */
     ...
     *
     * @param value
     *            allowed object is {@link MDMaintenanceInformationType }
     *
     */
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final MDMaintenanceInformationPropertyType that = ((MDMaintenanceInformationPropertyType) object);
        {
            boolean lhsFieldIsSet = this.isSetMDMaintenanceInformation();
            boolean rhsFieldIsSet = that.isSetMDMaintenanceInformation();
            MDMaintenanceInformationType lhsField;
            lhsField = this.getMDMaintenanceInformation();
            MDMaintenanceInformationType rhsField;
            rhsField = that.getMDMaintenanceInformation();
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "mdMaintenanceInformation", lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "mdMaintenanceInformation", rhsField);
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetMDMaintenanceInformation();
            MDMaintenanceInformationType theField;
            theField = this.getMDMaintenanceInformation();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "mdMaintenanceInformation", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            MDMaintenanceInformationType theField;
            theField = this.getMDMaintenanceInformation();
            strategy.appendField(locator, this, "mdMaintenanceInformation", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetNilReason();
            String theField;
