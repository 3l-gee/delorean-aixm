 ...
 *       <sequence>
 *         <element ref="{http://www.opengis.net/gml/3.2}axis" maxOccurs=
"unbounded"/>
 *       </sequence>
 *       <attGroup ref=
...
@XmlType(name = "AbstractCoordinateSystemType", propOrder = {"axis"})
@XmlSeeAlso({EllipsoidalCSType.class, CartesianCSType.class, VerticalCSType.class, TimeCSType.class, LinearCSType.class,
        UserDefinedCSType.class, SphericalCSType.class, PolarCSType.class, CylindricalCSType.class, AffineCSType.class,
        TemporalCSType.class, ObliqueCartesianCSType.class})
public abstract class AbstractCoordinateSystemType extends IdentifiedObjectType implements Serializable {
     ...
     * coordinate system axes included in this coordinate system. The coordinate
     * values in a coordinate tuple shall be recorded in the order in which the
     * coordinate system axes associations are recorded, whenever those coordinates
     * use a coordinate reference system that uses this coordinate system. The
     * gml:AggregationAttributeGroup should be used to specify that the axis objects
     * are ordered.Gets the value of the axis property.
     *
     * <p>
     * This accessor method returns a reference to the live list, not a snapshot.
     * Therefore any modification you make to the returned list will be present
     * inside the JAXB object. This is why there is not a <CODE>set</CODE> method
     * for the axis property.
     *
     * <p>
     ...
     * {@link JAXBElement }{@code <}{@link CoordinateSystemAxisPropertyType
     * }{@code >}
     *
     *
     */
