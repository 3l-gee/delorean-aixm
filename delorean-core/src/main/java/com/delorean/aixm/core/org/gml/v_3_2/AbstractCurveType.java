 ...
 * levels of complexity. The curve may always be viewed as a geometric
...
@XmlSeeAlso({LineStringType.class, CurveType.class, OrientableCurveType.class, CompositeCurveType.class})
