...
/**
 * <p>
 * Java class for DQ_FormatConsistency_PropertyType complex type
 * </p>
 * .
 *
 * <p>
 ...
 *         <element ref=
"{http://www.isotc211.org/2005/gmd}DQ_FormatConsistency"/>
 *       </sequence>
...
@XmlType(name = "DQ_FormatConsistency_PropertyType", propOrder = {"dqFormatConsistency"})
public class DQFormatConsistencyPropertyType implements Serializable, Equals, HashCode, ToString {
     ...
     *
     * @return possible object is {@link DQFormatConsistencyType }
     *
     */
     ...
     *
     * @param value
     *            allowed object is {@link DQFormatConsistencyType }
     *
     */
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        {
            boolean lhsFieldIsSet = this.isSetDQFormatConsistency();
            boolean rhsFieldIsSet = that.isSetDQFormatConsistency();
            DQFormatConsistencyType lhsField;
            lhsField = this.getDQFormatConsistency();
            DQFormatConsistencyType rhsField;
            rhsField = that.getDQFormatConsistency();
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "dqFormatConsistency", lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "dqFormatConsistency", rhsField);
            if (!strategy.equals(lhsFieldLocator, rhsFieldLocator, lhsField, rhsField, lhsFieldIsSet, rhsFieldIsSet)) {
                return false;
            }
        }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetDQFormatConsistency();
            DQFormatConsistencyType theField;
            theField = this.getDQFormatConsistency();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "dqFormatConsistency", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            DQFormatConsistencyType theField;
            theField = this.getDQFormatConsistency();
            strategy.appendField(locator, this, "dqFormatConsistency", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetNilReason();
            String theField;
