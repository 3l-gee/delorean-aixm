package com.delorean.aixm.core.gis.type;
...
@Entity(name = "LinearSegment")
@Table(name = "linear_segment", schema = "gml")
public class LinearSegment extends Segment implements java.io.Serializable {
