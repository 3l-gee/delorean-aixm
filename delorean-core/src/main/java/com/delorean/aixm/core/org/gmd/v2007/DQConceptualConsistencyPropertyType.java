...
/**
 * <p>
 * Java class for DQ_ConceptualConsistency_PropertyType complex type
 * </p>
 * .
 *
 * <p>
 ...
 *         <element ref=
"{http://www.isotc211.org/2005/gmd}DQ_ConceptualConsistency"/>
 *       </sequence>
...
@XmlType(name = "DQ_ConceptualConsistency_PropertyType", propOrder = {"dqConceptualConsistency"})
public class DQConceptualConsistencyPropertyType implements Serializable, Equals, HashCode, ToString {
     ...
     *
     * @return possible object is {@link DQConceptualConsistencyType }
     *
     */
     ...
     *
     * @param value
     *            allowed object is {@link DQConceptualConsistencyType }
     *
     */
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final DQConceptualConsistencyPropertyType that = ((DQConceptualConsistencyPropertyType) object);
        {
        ...
        {
            boolean lhsFieldIsSet = this.isSetDQConceptualConsistency();
            boolean rhsFieldIsSet = that.isSetDQConceptualConsistency();
            DQConceptualConsistencyType lhsField;
            lhsField = this.getDQConceptualConsistency();
            DQConceptualConsistencyType rhsField;
            rhsField = that.getDQConceptualConsistency();
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "dqConceptualConsistency", lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "dqConceptualConsistency", rhsField);
            if (!strategy.equals(lhsFieldLocator, rhsFieldLocator, lhsField, rhsField, lhsFieldIsSet, rhsFieldIsSet)) {
                return false;
            }
        }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetDQConceptualConsistency();
            DQConceptualConsistencyType theField;
            theField = this.getDQConceptualConsistency();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "dqConceptualConsistency", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            DQConceptualConsistencyType theField;
            theField = this.getDQConceptualConsistency();
            strategy.appendField(locator, this, "dqConceptualConsistency", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetNilReason();
            String theField;
