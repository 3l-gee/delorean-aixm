...
public class MDRangeDimensionPropertyType implements Serializable, Equals, HashCode, ToString {
     ...
     *
     * @return possible object is {@link JAXBElement }{@code <}{@link MDBandType
     *         }{@code >} {@link JAXBElement }{@code <}{@link MDRangeDimensionType
     *         }{@code >}
     *
     */
     ...
     *
     * @param value
     *            allowed object is {@link JAXBElement }{@code <}{@link MDBandType
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final MDRangeDimensionPropertyType that = ((MDRangeDimensionPropertyType) object);
        {
            boolean lhsFieldIsSet = this.isSetMDRangeDimension();
            boolean rhsFieldIsSet = that.isSetMDRangeDimension();
            JAXBElement<? extends MDRangeDimensionType> lhsField;
            lhsField = this.getMDRangeDimension();
            JAXBElement<? extends MDRangeDimensionType> rhsField;
            rhsField = that.getMDRangeDimension();
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "mdRangeDimension", lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "mdRangeDimension", rhsField);
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetMDRangeDimension();
            JAXBElement<? extends MDRangeDimensionType> theField;
            theField = this.getMDRangeDimension();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "mdRangeDimension", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            JAXBElement<? extends MDRangeDimensionType> theField;
            theField = this.getMDRangeDimension();
            strategy.appendField(locator, this, "mdRangeDimension", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetNilReason();
            String theField;
