...
/**
 * <p>
 * Java class for MD_FeatureCatalogueDescription_PropertyType complex type
 * </p>
 * .
 *
 * <p>
 ...
 *         <element ref=
"{http://www.isotc211.org/2005/gmd}MD_FeatureCatalogueDescription"/>
 *       </sequence>
...
@XmlType(name = "MD_FeatureCatalogueDescription_PropertyType", propOrder = {"mdFeatureCatalogueDescription"})
public class MDFeatureCatalogueDescriptionPropertyType implements Serializable, Equals, HashCode, ToString {
     ...
     *
     * @return possible object is {@link MDFeatureCatalogueDescriptionType }
     *
     */
     ...
     *
     * @param value
     *            allowed object is {@link MDFeatureCatalogueDescriptionType }
     *
     */
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final MDFeatureCatalogueDescriptionPropertyType that = ((MDFeatureCatalogueDescriptionPropertyType) object);
        {
        ...
        {
            boolean lhsFieldIsSet = this.isSetMDFeatureCatalogueDescription();
            boolean rhsFieldIsSet = that.isSetMDFeatureCatalogueDescription();
            MDFeatureCatalogueDescriptionType lhsField;
            lhsField = this.getMDFeatureCatalogueDescription();
            MDFeatureCatalogueDescriptionType rhsField;
            rhsField = that.getMDFeatureCatalogueDescription();
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "mdFeatureCatalogueDescription",
                    lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "mdFeatureCatalogueDescription",
                    rhsField);
            if (!strategy.equals(lhsFieldLocator, rhsFieldLocator, lhsField, rhsField, lhsFieldIsSet, rhsFieldIsSet)) {
                return false;
            }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetMDFeatureCatalogueDescription();
            MDFeatureCatalogueDescriptionType theField;
            theField = this.getMDFeatureCatalogueDescription();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "mdFeatureCatalogueDescription", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            MDFeatureCatalogueDescriptionType theField;
            theField = this.getMDFeatureCatalogueDescription();
            strategy.appendField(locator, this, "mdFeatureCatalogueDescription", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetNilReason();
            String theField;
