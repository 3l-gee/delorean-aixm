...
/**
 * <p>
 * Java class for DQ_Completeness_PropertyType complex type
 * </p>
 * .
 *
 * <p>
 ...
 *         <element ref=
"{http://www.isotc211.org/2005/gmd}AbstractDQ_Completeness"/>
 *       </sequence>
...
@XmlType(name = "DQ_Completeness_PropertyType", propOrder = {"abstractDQCompleteness"})
public class DQCompletenessPropertyType implements Serializable, Equals, HashCode, ToString {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final DQCompletenessPropertyType that = ((DQCompletenessPropertyType) object);
        {
        ...
        {
            boolean lhsFieldIsSet = this.isSetAbstractDQCompleteness();
            boolean rhsFieldIsSet = that.isSetAbstractDQCompleteness();
            JAXBElement<? extends AbstractDQCompletenessType> lhsField;
            lhsField = this.getAbstractDQCompleteness();
            JAXBElement<? extends AbstractDQCompletenessType> rhsField;
            rhsField = that.getAbstractDQCompleteness();
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "abstractDQCompleteness", lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "abstractDQCompleteness", rhsField);
            if (!strategy.equals(lhsFieldLocator, rhsFieldLocator, lhsField, rhsField, lhsFieldIsSet, rhsFieldIsSet)) {
                return false;
            }
        }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetAbstractDQCompleteness();
            JAXBElement<? extends AbstractDQCompletenessType> theField;
            theField = this.getAbstractDQCompleteness();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "abstractDQCompleteness", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            JAXBElement<? extends AbstractDQCompletenessType> theField;
            theField = this.getAbstractDQCompleteness();
            strategy.appendField(locator, this, "abstractDQCompleteness", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetNilReason();
            String theField;
