...
/**
 * <p>
 * Java class for Record_PropertyType complex type
 * </p>
 * .
 *
 * <p>
...
@XmlType(name = "Record_PropertyType", propOrder = {"record"})
public class RecordPropertyType implements Serializable, Equals, HashCode, ToString {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        {
            boolean lhsFieldIsSet = this.isSetRecord();
            boolean rhsFieldIsSet = that.isSetRecord();
            Object lhsField;
            lhsField = this.getRecord();
            Object rhsField;
            rhsField = that.getRecord();
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "record", lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "record", rhsField);
            if (!strategy.equals(lhsFieldLocator, rhsFieldLocator, lhsField, rhsField, lhsFieldIsSet, rhsFieldIsSet)) {
                return false;
            }
        }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetRecord();
            Object theField;
            theField = this.getRecord();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "record", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            Object theField;
            theField = this.getRecord();
            strategy.appendField(locator, this, "record", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetNilReason();
            String theField;
