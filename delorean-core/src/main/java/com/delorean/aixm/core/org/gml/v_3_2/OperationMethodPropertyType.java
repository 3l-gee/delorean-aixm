 ...
 * concrete general-purpose operation method, either referencing or containing
 * the definition of that method.
 *
 * <p>
 * Java class for OperationMethodPropertyType complex type
 * </p>
 * .
 *
 * <p>
...
@XmlType(name = "OperationMethodPropertyType", propOrder = {"operationMethod"})
public class OperationMethodPropertyType implements Serializable, Equals, HashCode, ToString {
     ...
     * parameters, although some coordinate conversions use none. Each coordinate
     * operation using the method assigns values to these parameters. The parameter
     * elements are an unordered list of associations to the set of operation
     * parameters and parameter groups used by this operation method.
     *
     */
     ...
     * parameters and parameter groups used by this operation method.
     *
     * @return possible object is {@link OperationMethodType }
     *
     */
     ...
     *
     * @param value
     *            allowed object is {@link OperationMethodType }
     *
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        {
            boolean lhsFieldIsSet = this.isSetOperationMethod();
            boolean rhsFieldIsSet = that.isSetOperationMethod();
            OperationMethodType lhsField;
            lhsField = this.getOperationMethod();
            OperationMethodType rhsField;
            rhsField = that.getOperationMethod();
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "operationMethod", lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "operationMethod", rhsField);
            if (!strategy.equals(lhsFieldLocator, rhsFieldLocator, lhsField, rhsField, lhsFieldIsSet, rhsFieldIsSet)) {
                return false;
            }
        }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetOperationMethod();
            OperationMethodType theField;
            theField = this.getOperationMethod();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "operationMethod", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            OperationMethodType theField;
            theField = this.getOperationMethod();
            strategy.appendField(locator, this, "operationMethod", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetNilReason();
            String theField;
