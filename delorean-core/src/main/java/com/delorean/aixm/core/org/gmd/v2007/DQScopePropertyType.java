...
/**
 * <p>
 * Java class for DQ_Scope_PropertyType complex type
 * </p>
 * .
 *
 * <p>
...
@XmlType(name = "DQ_Scope_PropertyType", propOrder = {"dqScope"})
public class DQScopePropertyType implements Serializable, Equals, HashCode, ToString {
     ...
     *
     * @return possible object is {@link DQScopeType }
     *
     */
     ...
     *
     * @param value
     *            allowed object is {@link DQScopeType }
     *
     */
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final DQScopePropertyType that = ((DQScopePropertyType) object);
        {
        ...
        {
            boolean lhsFieldIsSet = this.isSetDQScope();
            boolean rhsFieldIsSet = that.isSetDQScope();
            DQScopeType lhsField;
            lhsField = this.getDQScope();
            DQScopeType rhsField;
            rhsField = that.getDQScope();
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "dqScope", lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "dqScope", rhsField);
            if (!strategy.equals(lhsFieldLocator, rhsFieldLocator, lhsField, rhsField, lhsFieldIsSet, rhsFieldIsSet)) {
                return false;
            }
        }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetDQScope();
            DQScopeType theField;
            theField = this.getDQScope();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "dqScope", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            DQScopeType theField;
            theField = this.getDQScope();
            strategy.appendField(locator, this, "dqScope", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetNilReason();
            String theField;
