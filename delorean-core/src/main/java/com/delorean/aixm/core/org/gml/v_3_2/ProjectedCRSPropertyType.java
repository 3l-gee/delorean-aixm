 ...
 *
 * <p>
 * Java class for ProjectedCRSPropertyType complex type
 * </p>
 * .
 *
 * <p>
...
@XmlType(name = "ProjectedCRSPropertyType", propOrder = {"projectedCRS"})
public class ProjectedCRSPropertyType implements Serializable, Equals, HashCode, ToString {
     ...
     * distances to produce values that are a close match to actual field values.
     *
     * @return possible object is {@link ProjectedCRSType }
     *
     */
     ...
     *
     * @param value
     *            allowed object is {@link ProjectedCRSType }
     *
     * @see #getProjectedCRS()
     */
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        {
            boolean lhsFieldIsSet = this.isSetProjectedCRS();
            boolean rhsFieldIsSet = that.isSetProjectedCRS();
            ProjectedCRSType lhsField;
            lhsField = this.getProjectedCRS();
            ProjectedCRSType rhsField;
            rhsField = that.getProjectedCRS();
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "projectedCRS", lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "projectedCRS", rhsField);
            if (!strategy.equals(lhsFieldLocator, rhsFieldLocator, lhsField, rhsField, lhsFieldIsSet, rhsFieldIsSet)) {
                return false;
            }
        }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetProjectedCRS();
            ProjectedCRSType theField;
            theField = this.getProjectedCRS();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "projectedCRS", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            ProjectedCRSType theField;
            theField = this.getProjectedCRS();
            strategy.appendField(locator, this, "projectedCRS", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetNilReason();
            String theField;
