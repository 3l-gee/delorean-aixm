...
/**
 * <p>
 * Java class for DQ_AccuracyOfATimeMeasurement_PropertyType complex type
 * </p>
 * .
 *
 * <p>
 ...
 *         <element ref=
"{http://www.isotc211.org/2005/gmd}DQ_AccuracyOfATimeMeasurement"/>
 *       </sequence>
...
@XmlType(name = "DQ_AccuracyOfATimeMeasurement_PropertyType", propOrder = {"dqAccuracyOfATimeMeasurement"})
public class DQAccuracyOfATimeMeasurementPropertyType implements Serializable, Equals, HashCode, ToString {
     ...
     *
     * @return possible object is {@link DQAccuracyOfATimeMeasurementType }
     *
     */
     ...
     *
     * @param value
     *            allowed object is {@link DQAccuracyOfATimeMeasurementType }
     *
     */
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final DQAccuracyOfATimeMeasurementPropertyType that = ((DQAccuracyOfATimeMeasurementPropertyType) object);
        {
        ...
        {
            boolean lhsFieldIsSet = this.isSetDQAccuracyOfATimeMeasurement();
            boolean rhsFieldIsSet = that.isSetDQAccuracyOfATimeMeasurement();
            DQAccuracyOfATimeMeasurementType lhsField;
            lhsField = this.getDQAccuracyOfATimeMeasurement();
            DQAccuracyOfATimeMeasurementType rhsField;
            rhsField = that.getDQAccuracyOfATimeMeasurement();
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "dqAccuracyOfATimeMeasurement",
                    lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "dqAccuracyOfATimeMeasurement",
                    rhsField);
            if (!strategy.equals(lhsFieldLocator, rhsFieldLocator, lhsField, rhsField, lhsFieldIsSet, rhsFieldIsSet)) {
                return false;
            }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetDQAccuracyOfATimeMeasurement();
            DQAccuracyOfATimeMeasurementType theField;
            theField = this.getDQAccuracyOfATimeMeasurement();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "dqAccuracyOfATimeMeasurement", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            DQAccuracyOfATimeMeasurementType theField;
            theField = this.getDQAccuracyOfATimeMeasurement();
            strategy.appendField(locator, this, "dqAccuracyOfATimeMeasurement", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetNilReason();
            String theField;
