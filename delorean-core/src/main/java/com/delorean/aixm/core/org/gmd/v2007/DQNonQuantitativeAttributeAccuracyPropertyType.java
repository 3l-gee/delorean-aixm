...
/**
 * <p>
 * Java class for DQ_NonQuantitativeAttributeAccuracy_PropertyType complex type
 * </p>
 * .
 *
 * <p>
 ...
 *         <element ref=
"{http://www.isotc211.org/2005/gmd}DQ_NonQuantitativeAttributeAccuracy"/>
 *       </sequence>
...
@XmlType(name = "DQ_NonQuantitativeAttributeAccuracy_PropertyType", propOrder = {"dqNonQuantitativeAttributeAccuracy"})
public class DQNonQuantitativeAttributeAccuracyPropertyType implements Serializable, Equals, HashCode, ToString {
     ...
     *
     * @return possible object is {@link DQNonQuantitativeAttributeAccuracyType }
     *
     */
     ...
     *
     * @param value
     *            allowed object is {@link DQNonQuantitativeAttributeAccuracyType }
     *
     */
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final DQNonQuantitativeAttributeAccuracyPropertyType that = ((DQNonQuantitativeAttributeAccuracyPropertyType) object);
        {
        ...
        {
            boolean lhsFieldIsSet = this.isSetDQNonQuantitativeAttributeAccuracy();
            boolean rhsFieldIsSet = that.isSetDQNonQuantitativeAttributeAccuracy();
            DQNonQuantitativeAttributeAccuracyType lhsField;
            lhsField = this.getDQNonQuantitativeAttributeAccuracy();
            DQNonQuantitativeAttributeAccuracyType rhsField;
            rhsField = that.getDQNonQuantitativeAttributeAccuracy();
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "dqNonQuantitativeAttributeAccuracy",
                    lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "dqNonQuantitativeAttributeAccuracy",
                    rhsField);
            if (!strategy.equals(lhsFieldLocator, rhsFieldLocator, lhsField, rhsField, lhsFieldIsSet, rhsFieldIsSet)) {
                return false;
            }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetDQNonQuantitativeAttributeAccuracy();
            DQNonQuantitativeAttributeAccuracyType theField;
            theField = this.getDQNonQuantitativeAttributeAccuracy();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "dqNonQuantitativeAttributeAccuracy",
                    theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            DQNonQuantitativeAttributeAccuracyType theField;
            theField = this.getDQNonQuantitativeAttributeAccuracy();
            strategy.appendField(locator, this, "dqNonQuantitativeAttributeAccuracy", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetNilReason();
            String theField;
