...
import com.delorean.aixm.core.org.gml.v_3_2.AbstractCurveSegmentType;
import com.delorean.aixm.core.org.gml.v_3_2.AngleType;
import com.delorean.aixm.core.org.gml.v_3_2.ArcByBulgeType;
import com.delorean.aixm.core.org.gml.v_3_2.ArcByCenterPointType;
import com.delorean.aixm.core.org.gml.v_3_2.ArcStringByBulgeType;
import com.delorean.aixm.core.org.gml.v_3_2.ArcStringType;
import com.delorean.aixm.core.org.gml.v_3_2.BSplineType;
import com.delorean.aixm.core.org.gml.v_3_2.BezierType;
import com.delorean.aixm.core.org.gml.v_3_2.ArcType;
import com.delorean.aixm.core.org.gml.v_3_2.CircleByCenterPointType;
import com.delorean.aixm.core.org.gml.v_3_2.CircleType;
import com.delorean.aixm.core.org.gml.v_3_2.ClothoidType;
import com.delorean.aixm.core.org.gml.v_3_2.CubicSplineType;
import com.delorean.aixm.core.org.gml.v_3_2.CurveType;
import com.delorean.aixm.core.org.gml.v_3_2.DirectPositionType;
import com.delorean.aixm.core.org.gml.v_3_2.GeodesicStringType;
import com.delorean.aixm.core.org.gml.v_3_2.GeodesicType;
import com.delorean.aixm.core.org.gml.v_3_2.LengthType;
import com.delorean.aixm.core.org.gml.v_3_2.LineStringSegmentType;
import com.delorean.aixm.core.org.gml.v_3_2.OffsetCurveType;
import com.delorean.aixm.core.org.gml.v_3_2.PointPropertyType;
...
import com.delorean.aixm.core.org.gml.v_3_2.CurvePropertyType;

import com.delorean.aixm.core.org.gml.v_3_2.CurveSegmentArrayPropertyType;
...
public class CurveGmlHelper {
    ...
    public static Circle parseCircleByCenterPoint(CircleByCenterPointType value, String geometrySrsName) {
        ...
        if (value.getPos() != null) {
            ...
            } else if (value.getPointProperty().getPoint().getValue().getClass() == com.delorean.aixm.core.org.gml.v_3_2.PointType.class) {
                com.delorean.aixm.core.org.gml.v_3_2.PointType point = (com.delorean.aixm.core.org.gml.v_3_2.PointType) value.getPointProperty().getPoint().getValue();
            ...
            } else if (com.delorean.aixm.core.org.gml.v_3_2.PointType.class.isAssignableFrom(value.getPointProperty().getPoint().getValue().getClass())) {
                com.delorean.aixm.core.org.gml.v_3_2.PointType point = (com.delorean.aixm.core.org.gml.v_3_2.PointType) value.getPointProperty().getPoint().getValue();
                GmlPointType resultPoint = PointGmlHelper.parseGMLPoint(point, GmlPointType.class, geometrySrsName);
                InspectionBindingService.recordEvent(InspectionSource.GEOMETRY, ValidationSeverity.WARNING, "Geometry parsing", "Delorean does not support <" + value.getPointProperty().getPoint().getClass().getName() + "> in <gml:ArcByCenterPointType>. It will be converted to <gml:PointType>.", point.getId());
                resultPoint.setGeometricType(GeometricType.GML);
                result.setGmlPoint(resultPoint);
    ...
    public static Arc parseArcByCenterPoint(ArcByCenterPointType value, String geometrySrsName) {
        ...
        com.delorean.aixm.core.gis.type.components.AngleType angleType = new com.delorean.aixm.core.gis.type.components.AngleType();
        ...
        com.delorean.aixm.core.gis.type.components.AngleType endAngleType = new com.delorean.aixm.core.gis.type.components.AngleType();
        ...
        if (value.getPosList() != null) {
            ...
            for (JAXBElement<?> obj : geometricPositionGroup) {
                if (obj.getValue().getClass() == DirectPositionType.class) {
                    ...
                    } else if (pointPropertyObj.getPoint().getValue().getClass() == com.delorean.aixm.core.org.gml.v_3_2.PointType.class) {
                        com.delorean.aixm.core.org.gml.v_3_2.PointType point = (com.delorean.aixm.core.org.gml.v_3_2.PointType) pointPropertyObj.getPoint().getValue();
                        GmlPointType resultPoint = PointGmlHelper.parseGMLPoint(point, GmlPointType.class, geometrySrsName);
                        resultPoint.setGeometricType(GeometricType.GML);
                        resultPoint.setIndex(index);
                        result.getGmlPoint().add(resultPoint);
                    ...
                    } else if (com.delorean.aixm.core.org.gml.v_3_2.PointType.class.isAssignableFrom(pointPropertyObj.getPoint().getValue().getClass())) {
                        com.delorean.aixm.core.org.gml.v_3_2.PointType point = (com.delorean.aixm.core.org.gml.v_3_2.PointType) pointPropertyObj.getPoint().getValue();
                        InspectionBindingService.recordEvent(InspectionSource.GEOMETRY, ValidationSeverity.WARNING, "Geometry parsing", "Delorean does not support <" + pointPropertyObj.getPoint().getClass().getName() + "> in <gml:ArcByCenterPointType>. It will be converted to <gml:PointType>.", point.getId());
                        GmlPointType resultPoint = PointGmlHelper.parseGMLPoint(point, GmlPointType.class, geometrySrsName);
                        resultPoint.setGeometricType(GeometricType.GML);
                        resultPoint.setIndex(index);
                        result.getGmlPoint().add(resultPoint);
