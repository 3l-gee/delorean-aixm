...
/**
 * <p>
 * Java class for DQ_DataQuality_PropertyType complex type
 * </p>
 * .
 *
 * <p>
...
@XmlType(name = "DQ_DataQuality_PropertyType", propOrder = {"dqDataQuality"})
public class DQDataQualityPropertyType implements Serializable, Equals, HashCode, ToString {
     ...
     *
     * @return possible object is {@link DQDataQualityType }
     *
     */
     ...
     *
     * @param value
     *            allowed object is {@link DQDataQualityType }
     *
     */
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetDQDataQuality();
            DQDataQualityType theField;
            theField = this.getDQDataQuality();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "dqDataQuality", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            DQDataQualityType theField;
            theField = this.getDQDataQuality();
            strategy.appendField(locator, this, "dqDataQuality", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetNilReason();
            String theField;
