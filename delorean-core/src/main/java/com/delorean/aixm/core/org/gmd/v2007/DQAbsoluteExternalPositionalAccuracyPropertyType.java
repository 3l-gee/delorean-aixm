...
/**
 * <p>
 * Java class for DQ_AbsoluteExternalPositionalAccuracy_PropertyType complex
 * type
 * </p>
 * .
 *
...
public class DQAbsoluteExternalPositionalAccuracyPropertyType implements Serializable, Equals, HashCode, ToString {
     ...
     *
     * @return possible object is {@link DQAbsoluteExternalPositionalAccuracyType }
     *
     */
     ...
     *
     * @param value
     *            allowed object is {@link DQAbsoluteExternalPositionalAccuracyType
     *            }
     *
     */
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final DQAbsoluteExternalPositionalAccuracyPropertyType that = ((DQAbsoluteExternalPositionalAccuracyPropertyType) object);
        {
        ...
        {
            boolean lhsFieldIsSet = this.isSetDQAbsoluteExternalPositionalAccuracy();
            boolean rhsFieldIsSet = that.isSetDQAbsoluteExternalPositionalAccuracy();
            DQAbsoluteExternalPositionalAccuracyType lhsField;
            lhsField = this.getDQAbsoluteExternalPositionalAccuracy();
            DQAbsoluteExternalPositionalAccuracyType rhsField;
            rhsField = that.getDQAbsoluteExternalPositionalAccuracy();
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "dqAbsoluteExternalPositionalAccuracy",
                    lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "dqAbsoluteExternalPositionalAccuracy",
                    rhsField);
            if (!strategy.equals(lhsFieldLocator, rhsFieldLocator, lhsField, rhsField, lhsFieldIsSet, rhsFieldIsSet)) {
                return false;
            }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetDQAbsoluteExternalPositionalAccuracy();
            DQAbsoluteExternalPositionalAccuracyType theField;
            theField = this.getDQAbsoluteExternalPositionalAccuracy();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "dqAbsoluteExternalPositionalAccuracy",
                    theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            DQAbsoluteExternalPositionalAccuracyType theField;
            theField = this.getDQAbsoluteExternalPositionalAccuracy();
            strategy.appendField(locator, this, "dqAbsoluteExternalPositionalAccuracy", buffer, theField,
                    theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetNilReason();
