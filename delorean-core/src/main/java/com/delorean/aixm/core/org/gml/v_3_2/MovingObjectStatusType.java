...
"{http://www.opengis.net/gml/3.2}GeometryPropertyType"/>
...
"{http://www.opengis.net/gml/3.2}MeasureType" minOccurs="0"/>
 *         <element name="bearing" type=
"{http://www.opengis.net/gml/3.2}DirectionPropertyType" minOccurs="0"/>
 *         <element name="acceleration" type=
"{http://www.opengis.net/gml/3.2}MeasureType" minOccurs="0"/>
 *         <element name="elevation" type=
"{http://www.opengis.net/gml/3.2}MeasureType" minOccurs="0"/>
 *         <element ref="{http://www.opengis.net/gml/3.2}status" minOccurs="0"/>
 *         <element ref=
"{http://www.opengis.net/gml/3.2}statusReference" minOccurs="0"/>
 *       </sequence>
 *     </extension>
 *   </complexContent>
 * </complexType>
...
@XmlType(name = "MovingObjectStatusType", propOrder = {"position", "pos", "locationName", "locationReference",
        "location", "speed", "bearing", "acceleration", "elevation", "status", "statusReference"})
public class MovingObjectStatusType extends AbstractTimeSliceType implements Serializable {
     ...
     * text value describes the location of the feature. If the location names are
     * selected from a controlled list, then the list shall be identified in the
     * codeSpace attribute.
     *
     */
     ...
     * the text value referenced by the xlink:href attribute describes the location
     * of the feature.
     *
     */
     ...
     *
     * @param value
     *            allowed object is {@link GeometryPropertyType }
     *
     */
