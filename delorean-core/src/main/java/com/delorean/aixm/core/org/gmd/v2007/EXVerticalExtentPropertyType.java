...
/**
 * <p>
 * Java class for EX_VerticalExtent_PropertyType complex type
 * </p>
 * .
 *
 * <p>
...
@XmlType(name = "EX_VerticalExtent_PropertyType", propOrder = {"exVerticalExtent"})
public class EXVerticalExtentPropertyType implements Serializable, Equals, HashCode, ToString {
     ...
     *
     * @return possible object is {@link EXVerticalExtentType }
     *
     */
     ...
     *
     * @param value
     *            allowed object is {@link EXVerticalExtentType }
     *
     */
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final EXVerticalExtentPropertyType that = ((EXVerticalExtentPropertyType) object);
        {
        ...
        {
            boolean lhsFieldIsSet = this.isSetEXVerticalExtent();
            boolean rhsFieldIsSet = that.isSetEXVerticalExtent();
            EXVerticalExtentType lhsField;
            lhsField = this.getEXVerticalExtent();
            EXVerticalExtentType rhsField;
            rhsField = that.getEXVerticalExtent();
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "exVerticalExtent", lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "exVerticalExtent", rhsField);
            if (!strategy.equals(lhsFieldLocator, rhsFieldLocator, lhsField, rhsField, lhsFieldIsSet, rhsFieldIsSet)) {
                return false;
            }
        }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetEXVerticalExtent();
            EXVerticalExtentType theField;
            theField = this.getEXVerticalExtent();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "exVerticalExtent", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            EXVerticalExtentType theField;
            theField = this.getEXVerticalExtent();
            strategy.appendField(locator, this, "exVerticalExtent", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetNilReason();
            String theField;
