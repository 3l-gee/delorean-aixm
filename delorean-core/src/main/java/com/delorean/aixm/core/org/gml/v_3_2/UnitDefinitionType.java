 ...
 *       <sequence>
 *         <element ref="{http://www.opengis.net/gml/3.2}quantityType" minOccurs
="0"/>
 *         <element ref=
"{http://www.opengis.net/gml/3.2}quantityTypeReference" minOccurs="0"/>
 *         <element ref=
"{http://www.opengis.net/gml/3.2}catalogSymbol" minOccurs="0"/>
 *       </sequence>
 *     </extension>
 *   </complexContent>
 * </complexType>
...
@XmlSeeAlso({BaseUnitType.class, DerivedUnitType.class, ConventionalUnitType.class})
public class UnitDefinitionType extends DefinitionType implements Serializable {

    private static final long serialVersionUID = 20251104L;
    /**
     * The gml:quantityType property indicates the phenomenon to which the units
     * apply. This element contains an informal description of the phenomenon or
     * type of physical quantity that is measured or observed. When the physical
     * quantity is the result of an observation or measurement, this term is known
     * as observable type or measurand. The use of gml:quantityType for references
     * to remote values is deprecated.
     *
     */
     ...
     * measure. The codeSpace attribute in gml:CodeType identifies a namespace for
     * the catalog symbol value, and might reference the external catalog. The
     * string value in gml:CodeType contains the value of a symbol that should be
     * unique within this catalog namespace. This symbol often appears explicitly in
     * the catalog, but it could be a combination of symbols using a specified
     * algebra of units.
     *
     */
