...
/**
 * <p>
 * Java class for MD_StandardOrderProcess_PropertyType complex type
 * </p>
 * .
 *
 * <p>
 ...
 *         <element ref=
"{http://www.isotc211.org/2005/gmd}MD_StandardOrderProcess"/>
 *       </sequence>
...
@XmlType(name = "MD_StandardOrderProcess_PropertyType", propOrder = {"mdStandardOrderProcess"})
public class MDStandardOrderProcessPropertyType implements Serializable, Equals, HashCode, ToString {
     ...
     *
     * @return possible object is {@link MDStandardOrderProcessType }
     *
     */
     ...
     *
     * @param value
     *            allowed object is {@link MDStandardOrderProcessType }
     *
     */
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final MDStandardOrderProcessPropertyType that = ((MDStandardOrderProcessPropertyType) object);
        {
        ...
        {
            boolean lhsFieldIsSet = this.isSetMDStandardOrderProcess();
            boolean rhsFieldIsSet = that.isSetMDStandardOrderProcess();
            MDStandardOrderProcessType lhsField;
            lhsField = this.getMDStandardOrderProcess();
            MDStandardOrderProcessType rhsField;
            rhsField = that.getMDStandardOrderProcess();
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "mdStandardOrderProcess", lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "mdStandardOrderProcess", rhsField);
            if (!strategy.equals(lhsFieldLocator, rhsFieldLocator, lhsField, rhsField, lhsFieldIsSet, rhsFieldIsSet)) {
                return false;
            }
        }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetMDStandardOrderProcess();
            MDStandardOrderProcessType theField;
            theField = this.getMDStandardOrderProcess();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "mdStandardOrderProcess", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            MDStandardOrderProcessType theField;
            theField = this.getMDStandardOrderProcess();
            strategy.appendField(locator, this, "mdStandardOrderProcess", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetNilReason();
            String theField;
