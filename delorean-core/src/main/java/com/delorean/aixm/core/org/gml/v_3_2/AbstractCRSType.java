 ...
 *       <sequence>
 *         <element ref=
"{http://www.opengis.net/gml/3.2}domainOfValidity" maxOccurs=
...
@XmlSeeAlso({CompoundCRSType.class, GeodeticCRSType.class, VerticalCRSType.class, AbstractGeneralDerivedCRSType.class,
        EngineeringCRSType.class, ImageCRSType.class, TemporalCRSType.class, GeographicCRSType.class,
        GeocentricCRSType.class})
public abstract class AbstractCRSType extends IdentifiedObjectType implements Serializable {
     ...
     * the definition of that extent.Gets the value of the domainOfValidity
     * property.
     *
     * <p>
