...
public class MultiSurfacePropertyType implements Serializable, Equals, HashCode, ToString {

    private static final long serialVersionUID = 20251104L;
    /**
     * A gml:MultiSurface is defined by one or more gml:AbstractSurfaces. The
     * members of the geometric aggregate may be specified either using the
     * "standard" property (gml:surfaceMember) or the array property
     * (gml:surfaceMembers). It is also valid to use both the "standard" and the
     * array properties in the same collection.
     *
     */
     ...
     * array properties in the same collection.
     *
     * @return possible object is {@link MultiSurfaceType }
     *
     */
     ...
     *
     * @param value
     *            allowed object is {@link MultiSurfaceType }
     *
     * @see #getMultiSurface()
     */
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        {
            boolean lhsFieldIsSet = this.isSetMultiSurface();
            boolean rhsFieldIsSet = that.isSetMultiSurface();
            MultiSurfaceType lhsField;
            lhsField = this.getMultiSurface();
            MultiSurfaceType rhsField;
            rhsField = that.getMultiSurface();
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "multiSurface", lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "multiSurface", rhsField);
            if (!strategy.equals(lhsFieldLocator, rhsFieldLocator, lhsField, rhsField, lhsFieldIsSet, rhsFieldIsSet)) {
                return false;
            }
        }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetMultiSurface();
            MultiSurfaceType theField;
            theField = this.getMultiSurface();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "multiSurface", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            MultiSurfaceType theField;
            theField = this.getMultiSurface();
            strategy.appendField(locator, this, "multiSurface", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetNilReason();
            String theField;
