...
/**
 * <p>
 * Java class for MD_ExtendedElementInformation_PropertyType complex type
 * </p>
 * .
 *
 * <p>
 ...
 *         <element ref=
"{http://www.isotc211.org/2005/gmd}MD_ExtendedElementInformation"/>
 *       </sequence>
...
@XmlType(name = "MD_ExtendedElementInformation_PropertyType", propOrder = {"mdExtendedElementInformation"})
public class MDExtendedElementInformationPropertyType implements Serializable, Equals, HashCode, ToString {
     ...
     *
     * @return possible object is {@link MDExtendedElementInformationType }
     *
     */
     ...
     *
     * @param value
     *            allowed object is {@link MDExtendedElementInformationType }
     *
     */
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final MDExtendedElementInformationPropertyType that = ((MDExtendedElementInformationPropertyType) object);
        {
        ...
        {
            boolean lhsFieldIsSet = this.isSetMDExtendedElementInformation();
            boolean rhsFieldIsSet = that.isSetMDExtendedElementInformation();
            MDExtendedElementInformationType lhsField;
            lhsField = this.getMDExtendedElementInformation();
            MDExtendedElementInformationType rhsField;
            rhsField = that.getMDExtendedElementInformation();
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "mdExtendedElementInformation",
                    lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "mdExtendedElementInformation",
                    rhsField);
            if (!strategy.equals(lhsFieldLocator, rhsFieldLocator, lhsField, rhsField, lhsFieldIsSet, rhsFieldIsSet)) {
                return false;
            }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetMDExtendedElementInformation();
            MDExtendedElementInformationType theField;
            theField = this.getMDExtendedElementInformation();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "mdExtendedElementInformation", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            MDExtendedElementInformationType theField;
            theField = this.getMDExtendedElementInformation();
            strategy.appendField(locator, this, "mdExtendedElementInformation", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetNilReason();
            String theField;
