...
<qlr>
	<layer-tree-group expanded="1"
		...
		<layer-tree-layer patch_size="-1,-1"
		                  expanded="1"
		                  checked="Qt::Checked"
		                  providerKey="postgres"
		                  id="designatedpoint_publisher_view_a4fdffff_ecc7_46f4_b5b0_ba172bb0abf9"
		                  legend_split_behavior="0"
		                  source="dbname='demo' port=5432 key='row' srid=4326 type=Point checkPrimaryKeyUnicity='1' table=&quot;navaids_points&quot;.&quot;designatedpoint_publisher_view&quot; (geom)"
		                  legend_exp=""
		                  name="designatedpoint_publisher_view">
			<customproperties>
				<Option/>
			</customproperties>
		</layer-tree-layer>
	...
	<maplayers>
		<maplayer styleCategories="AllStyleCategories"
		          ...
		          type="vector"
		          wkbType="Point">
			<id>designatedpoint_publisher_view_a4fdffff_ecc7_46f4_b5b0_ba172bb0abf9</id>
			<datasource>dbname='demo' port=5432 key='row' srid=4326 type=Point checkPrimaryKeyUnicity='1' table="navaids_points"."designatedpoint_publisher_view" (geom)</datasource>
			<keywordList>
				<value/>
			</keywordList>
			<layername>designatedpoint_publisher_view</layername>
			<srs>
			...
			<elevation symbology="Line"
			           binding="Centroid"
			           zoffset="0"
			           type="IndividualFeatures"
			           showMarkerSymbolInSurfacePlots="0"
			           zscale="1"
			           extrusionEnabled="0"
			           clamping="Terrain"
			           extrusion="0"
			           respectLayerSymbol="1">
				...
				<profileLineSymbol>
					<symbol clip_to_extent="1"
						...
						<layer enabled="1"
						       locked="0"
						       pass="0"
						       id="{907ae549-7318-4227-82db-e31c5bf687da}"
						       class="SimpleLine">
							<Option type="Map">
								<Option type="QString"
				...
				<profileFillSymbol>
					<symbol clip_to_extent="1"
						...
						<layer enabled="1"
						       locked="0"
						       pass="0"
						       id="{6c13d704-cb39-4a40-a2d7-d9c840acae5c}"
						       class="SimpleFill">
							<Option type="Map">
								<Option type="QString"
				...
				<profileMarkerSymbol>
					<symbol clip_to_extent="1"
						...
						<layer enabled="1"
						       locked="0"
						       pass="0"
						       id="{9b68d35e-f7ee-4d99-b3a5-f8f3f6c54f7a}"
						       class="SimpleMarker">
							<Option type="Map">
								<Option type="QString"
								        name="angle"
