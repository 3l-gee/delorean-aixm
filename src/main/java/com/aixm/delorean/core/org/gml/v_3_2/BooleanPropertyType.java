...
/**
 * <p>Java class for BooleanPropertyType complex type</p>.
 * 
...
public class BooleanPropertyType implements Serializable, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        {
            boolean lhsFieldIsSet = this.isSetBoolean();
            boolean rhsFieldIsSet = that.isSetBoolean();
            Boolean lhsField;
            lhsField = this.getBoolean();
            Boolean rhsField;
            rhsField = that.getBoolean();
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "_boolean", lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "_boolean", rhsField);
            if (!strategy.equals(lhsFieldLocator, rhsFieldLocator, lhsField, rhsField, lhsFieldIsSet, rhsFieldIsSet)) {
                return false;
            }
        }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetBoolean();
            Boolean theField;
            theField = this.getBoolean();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "_boolean", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            Boolean theField;
            theField = this.getBoolean();
            strategy.appendField(locator, this, "_boolean", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetNilReason();
            String theField;
