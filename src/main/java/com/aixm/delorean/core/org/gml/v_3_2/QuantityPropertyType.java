...
/**
 * <p>Java class for QuantityPropertyType complex type</p>.
 * 
...
public class QuantityPropertyType implements Serializable, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        {
            boolean lhsFieldIsSet = this.isSetQuantity();
            boolean rhsFieldIsSet = that.isSetQuantity();
            Quantity lhsField;
            lhsField = this.getQuantity();
            Quantity rhsField;
            rhsField = that.getQuantity();
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "quantity", lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "quantity", rhsField);
            if (!strategy.equals(lhsFieldLocator, rhsFieldLocator, lhsField, rhsField, lhsFieldIsSet, rhsFieldIsSet)) {
                return false;
            }
        }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetQuantity();
            Quantity theField;
            theField = this.getQuantity();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "quantity", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            Quantity theField;
            theField = this.getQuantity();
            strategy.appendField(locator, this, "quantity", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetNilReason();
            String theField;
