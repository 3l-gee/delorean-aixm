...
public class TopoComplexPropertyType implements Serializable, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        {
            boolean lhsFieldIsSet = this.isSetTopoComplex();
            boolean rhsFieldIsSet = that.isSetTopoComplex();
            TopoComplexType lhsField;
            lhsField = this.getTopoComplex();
            TopoComplexType rhsField;
            rhsField = that.getTopoComplex();
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "topoComplex", lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "topoComplex", rhsField);
            if (!strategy.equals(lhsFieldLocator, rhsFieldLocator, lhsField, rhsField, lhsFieldIsSet, rhsFieldIsSet)) {
                return false;
            }
        }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetTopoComplex();
            TopoComplexType theField;
            theField = this.getTopoComplex();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "topoComplex", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            TopoComplexType theField;
            theField = this.getTopoComplex();
            strategy.appendField(locator, this, "topoComplex", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetNilReason();
            String theField;
