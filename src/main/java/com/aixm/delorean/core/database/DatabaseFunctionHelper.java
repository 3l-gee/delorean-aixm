...
public class DatabaseFunctionHelper {
    ...
    public static <T extends AbstractAIXMFeatureType> MutationFeatureTimeslice A5_2HandelTimeSlice(
            com.aixm.delorean.core.schema.a5_2.aixm.message.BasicMessageMemberAIXMPropertyType basicMessageMember, 
            MutationFeatureTimeslice existing, 
            Session session) {
        com.aixm.delorean.core.schema.a5_2.aixm.AbstractAIXMFeatureType abstractFeature = basicMessageMember.getAbstractAIXMFeatureValue(); 
