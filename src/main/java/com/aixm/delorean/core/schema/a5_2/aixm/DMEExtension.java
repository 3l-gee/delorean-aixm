...
@Entity(name = "DMEExtension")
@Table(name = "dme_ext", schema = "navaids_points")
public class DMEExtension implements Serializable, Equals, HashCode, ToString
{
    ...
    @JoinColumn(name = "ABSTRACT_DMEEXTENSION_DMEEXT_0")
    ...
    @JoinColumn(name = "ABSTRACT_NAVAID_EQUIPMENT_EX_1")
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        final DMEExtension that = ((DMEExtension) object);
        {
