...
class SimpleCLIE2E {
    ...
    Path OutDir = Paths.get("target", "test_output", "aixm52", "simple_cli_e2e");
    ...
    void testFormatActionAgainstDockerDatabase() {
        ...
        DeloreanCLIAIXM52 cli = new DeloreanCLIAIXM52();
    ...
    void testPersistActionAgainstDockerDatabase() {
        ...
        String[] args = new String[] {
            ...
            "-W", postgres.getPassword(),
            "-a", "persist",
            "-f", "src/test/resources/donlon-aixm-52.xml"
        };
    ...
    void testMergeActionAgainstDockerDatabase() {
        ...
        String[] args = new String[] {
            ...
            "-W", postgres.getPassword(),
            "-a", "merge",
            "-f", "src/test/resources/donlon-aixm-52-merge.xml",
            "--id", "1"
        };
