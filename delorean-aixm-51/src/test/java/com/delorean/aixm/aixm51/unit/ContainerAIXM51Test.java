package com.delorean.aixm.aixm51.unit;
...
public class ContainerAIXM51Test {
    ...
    void configDeloreanCore() {
        ...
        assertThat(firstContainer.getRootClass()).isEqualTo(com.delorean.aixm.aixm51.schema.message.AIXMBasicMessageType.class);
        assertThat(firstContainer.getFeatureClass()).isEqualTo(com.delorean.aixm.aixm51.schema.AbstractAIXMFeatureType.class);
        assertThat(firstContainer.getTimeSliceClass()).isEqualTo(com.delorean.aixm.aixm51.schema.AbstractAIXMTimeSliceType.class);
        assertThat(firstContainer.getObjectClass()).isEqualTo(com.delorean.aixm.aixm51.schema.AbstractAIXMObjectType.class);
    ...
    void addNewContainer() {
        ...
        // container is correctly configured
        assertThat(secondContainer.getRootClass()).isEqualTo(com.delorean.aixm.aixm51.schema.message.AIXMBasicMessageType.class);
        assertThat(secondContainer.getFeatureClass()).isEqualTo(com.delorean.aixm.aixm51.schema.AbstractAIXMFeatureType.class);
        assertThat(secondContainer.getTimeSliceClass()).isEqualTo(com.delorean.aixm.aixm51.schema.AbstractAIXMTimeSliceType.class);
        assertThat(secondContainer.getObjectClass()).isEqualTo(com.delorean.aixm.aixm51.schema.AbstractAIXMObjectType.class);
