...
/**
 * <p>
 * Java class for AuthorityForSpecialNavigationSystemType complex type
 * </p>
 * .
 *
 * <p>
...
"{http://www.aixm.aero/schema/5.1}CodeAuthorityRoleType" minOccurs="0"/>
...
@XmlType(name = "AuthorityForSpecialNavigationSystemType", propOrder = {"type", "annotation",
...
public class AuthorityForSpecialNavigationSystemType extends AbstractAIXMObjectType implements Serializable {
    ...
    @JoinTable(name = "athrtfrspclnvgtnsstmtp_annttn_link", schema = "navaids_point", joinColumns = {
            @JoinColumn(name = "authorityforspecialnavigationsystem_o_hjid", referencedColumnName = "hjid")}, inverseJoinColumns = {
    ...
    public void setTypeItem(CodeAuthorityRoleType target) {
        setType(XmlAdapterUtils.marshallJAXBElement(CodeAuthorityRoleType.class,
                new QName("http://www.aixm.aero/schema/5.1", "type"), AuthorityForSpecialNavigationSystemType.class,
                target));
    }
