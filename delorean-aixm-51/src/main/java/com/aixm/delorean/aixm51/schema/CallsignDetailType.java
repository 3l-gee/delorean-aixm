...
/**
 * <p>
 * Java class for CallsignDetailType complex type
 * </p>
 * .
 *
 * <p>
 ...
 *       <sequence>
 *         <element name="callSign" type=
"{http://www.aixm.aero/schema/5.1}TextNameType" minOccurs="0"/>
 *         <element name="language" type=
"{http://www.aixm.aero/schema/5.1}CodeLanguageType" minOccurs="0"/>
 ...
 *                 <sequence>
 *                   <element ref=
"{http://www.aixm.aero/schema/5.1}AbstractCallsignDetailExtension"/>
 *                 </sequence>
 *                 <attGroup ref=
...
@XmlType(name = "CallsignDetailType", propOrder = {"callSign", "language", "annotation", "extension"})
@Entity(name = "CallsignDetailType")
@Table(name = "callsigndetail_o", schema = "service")
public class CallsignDetailType extends AbstractAIXMObjectType implements Serializable {

    private static final long serialVersionUID = 20251104L;
    @XmlElementRef(name = "callSign", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class, required = false)
    protected JAXBElement<TextNameType> callSign;
    @XmlElementRef(name = "language", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class, required = false)
    protected JAXBElement<CodeLanguageType> language;
    @XmlElement(nillable = true)
    protected List<NotePropertyType> annotation;
    protected List<CallsignDetailExtensionType> extension;
     ...
     *         }{@code <}{@link CodeLanguageType }{@code >}
     *
     */
    @Transient
    ...
    @JoinTable(name = "cllsgndtltp_annttn_link", schema = "service", joinColumns = {
            @JoinColumn(name = "callsigndetail_o_hjid", referencedColumnName = "hjid")}, inverseJoinColumns = {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link CallsignDetailExtensionType }
     *
     *
     */
    @OneToMany(targetEntity = CallsignDetailExtensionType.class, cascade = {CascadeType.ALL}, fetch = FetchType.EAGER)
    @JoinColumn(name = "callsigndetail_oe_hjid", referencedColumnName = "hjid")
    public List<CallsignDetailExtensionType> getExtension() {
        if (extension == null) {
     ...
     *
     */
    public void setExtension(List<CallsignDetailExtensionType> extension) {
    ...
    @AttributeOverrides({
            ...
            @AttributeOverride(name = "nilReason", column = @Column(name = "callsignnilreason"))})
    ...
    public void setCallSignItem(TextNameType target) {
        setCallSign(XmlAdapterUtils.marshallJAXBElement(TextNameType.class,
                new QName("http://www.aixm.aero/schema/5.1", "callSign"), CallsignDetailType.class, target));
    }

    @Embedded
    @AttributeOverrides({
            @AttributeOverride(name = "value", column = @Column(name = "language", columnDefinition = "VARCHAR", length = 256)),
            @AttributeOverride(name = "nilReason", column = @Column(name = "languagenilreason"))})
    ...
    public void setLanguageItem(CodeLanguageType target) {
        setLanguage(XmlAdapterUtils.marshallJAXBElement(CodeLanguageType.class,
                new QName("http://www.aixm.aero/schema/5.1", "language"), CallsignDetailType.class, target));
    }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        }
        {
            ...
            List<CallsignDetailExtensionType> lhsField;
            lhsField = (this.isSetExtension() ? this.getExtension() : null);
            List<CallsignDetailExtensionType> rhsField;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        }
        {
            ...
            List<CallsignDetailExtensionType> theField;
