 ...
 *                 <sequence>
 *                   <element ref=
"{http://www.aixm.aero/schema/5.1}AbstractStandardLevelExtension"/>
 *                 </sequence>
 *                 <attGroup ref=
...
public class StandardLevelType extends AbstractAIXMObjectType implements Serializable {
    ...
    @XmlElementRef(name = "verticalDistance", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class, required = false)
    ...
    public void setVerticalDistanceItem(ValDistanceVerticalType target) {
        setVerticalDistance(XmlAdapterUtils.marshallJAXBElement(ValDistanceVerticalType.class,
                new QName("http://www.aixm.aero/schema/5.1", "verticalDistance"), StandardLevelType.class, target));
    }
