...
@XmlType(name = "", propOrder = {"abstractAirspaceVolumeExtension"})
@Entity(name = "AirspaceVolumeExtensionType")
@Table(name = "airspacevolume_oe", schema = "airspace")
public class AirspaceVolumeExtensionType implements Serializable, Equals, HashCode, ToString {
    ...
    @JoinColumn(name = "abstractairspacevolumeextension_hjid", referencedColumnName = "hjid")
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final AirspaceVolumeExtensionType that = ((AirspaceVolumeExtensionType) object);
        {
            ...
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "abstractAirspaceVolumeExtension",
                    lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "abstractAirspaceVolumeExtension",
                    rhsField);
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetAbstractAirspaceVolumeExtension();
            AbstractExtensionType theField;
            theField = this.getAbstractAirspaceVolumeExtension();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "abstractAirspaceVolumeExtension", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            AbstractExtensionType theField;
            theField = this.getAbstractAirspaceVolumeExtension();
            strategy.appendField(locator, this, "abstractAirspaceVolumeExtension", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetOwns();
            boolean theField;
