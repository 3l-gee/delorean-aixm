...
@XmlType(name = "", propOrder = {"abstractAltitudeAdjustmentExtension"})
@Entity(name = "AltitudeAdjustmentExtensionType")
@Table(name = "altitudeadjustment_oe", schema = "shared")
public class AltitudeAdjustmentExtensionType implements Serializable, Equals, HashCode, ToString {
    ...
    @JoinColumn(name = "abstractaltitudeadjustmentextension_hjid", referencedColumnName = "hjid")
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final AltitudeAdjustmentExtensionType that = ((AltitudeAdjustmentExtensionType) object);
        {
            ...
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "abstractAltitudeAdjustmentExtension",
                    lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "abstractAltitudeAdjustmentExtension",
                    rhsField);
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = 1;
        {
            ...
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "abstractAltitudeAdjustmentExtension",
                    theField);
