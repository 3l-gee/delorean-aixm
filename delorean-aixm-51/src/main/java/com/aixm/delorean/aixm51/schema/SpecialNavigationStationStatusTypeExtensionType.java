 ...
 *         <element ref=
"{http://www.aixm.aero/schema/5.1}AbstractSpecialNavigationStationStatusExtension"/>
 *       </choice>
 *       <attGroup ref=
...
@Table(name = "specialnavigationstationstatuse", schema = "navaids_point")
public class SpecialNavigationStationStatusTypeExtensionType implements Serializable, Equals, HashCode, ToString {
    ...
    /**
     * Gets the value of the abstractSpecialNavigationStationStatusExtension
     * property.
     *
     * @return possible object is {@link AbstractExtensionType }
     *
    ...
    /**
     * Sets the value of the abstractSpecialNavigationStationStatusExtension
     * property.
     *
     * @param value
     *            allowed object is {@link AbstractExtensionType }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        }
        {
            ...
            ObjectLocator theFieldLocator = LocatorUtils.property(locator,
                    "abstractSpecialNavigationStationStatusExtension", theField);
            currentHashCode = strategy.hashCode(theFieldLocator, currentHashCode, theField, theFieldIsSet);
        }
        {
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        }
        {
            ...
            AbstractExtensionType theField;
            theField = this.getAbstractSpecialNavigationStationStatusExtension();
            strategy.appendField(locator, this, "abstractSpecialNavigationStationStatusExtension", buffer, theField,
                    theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetOwns();
