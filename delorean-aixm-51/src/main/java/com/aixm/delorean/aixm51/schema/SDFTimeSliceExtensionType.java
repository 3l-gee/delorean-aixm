...
@XmlType(name = "", propOrder = {"abstractSDFExtension", "abstractNavaidEquipmentExtension"})
@Entity(name = "SDFTimeSliceExtensionType")
@Table(name = "sdf_te", schema = "navaids_point")
public class SDFTimeSliceExtensionType implements Serializable, Equals, HashCode, ToString {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final SDFTimeSliceExtensionType that = ((SDFTimeSliceExtensionType) object);
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetAbstractSDFExtension();
            AbstractExtensionType theField;
            theField = this.getAbstractSDFExtension();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "abstractSDFExtension", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            AbstractExtensionType theField;
            theField = this.getAbstractSDFExtension();
            strategy.appendField(locator, this, "abstractSDFExtension", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetAbstractNavaidEquipmentExtension();
            AbstractExtensionType theField;
