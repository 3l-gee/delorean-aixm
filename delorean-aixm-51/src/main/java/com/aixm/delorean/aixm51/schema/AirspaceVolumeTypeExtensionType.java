...
@Entity(name = "AirspaceVolumeTypeExtensionType")
@Table(name = "airspacevolumee", schema = "airspace")
public class AirspaceVolumeTypeExtensionType implements Serializable, Equals, HashCode, ToString {
