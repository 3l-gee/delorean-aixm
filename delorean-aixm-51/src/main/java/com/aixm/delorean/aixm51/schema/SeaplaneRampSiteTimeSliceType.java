 ...
 *                 <sequence>
 *                   <element ref=
"{http://www.aixm.aero/schema/5.1}AbstractSeaplaneRampSiteExtension"/>
 *                 </sequence>
 *                 <attGroup ref=
...
public class SeaplaneRampSiteTimeSliceType extends AbstractAIXMTimeSliceType implements Serializable {
    ...
    public void setExtentItem(AIXMElevatedSurfacePropertyType target) {
        setExtent(XmlAdapterUtils.marshallJAXBElement(AIXMElevatedSurfacePropertyType.class,
                new QName("http://www.aixm.aero/schema/5.1", "extent"), SeaplaneRampSiteTimeSliceType.class, target));
    }
    ...
    public void setCentrelineItem(AIXMElevatedCurvePropertyType target) {
        setCentreline(XmlAdapterUtils.marshallJAXBElement(AIXMElevatedCurvePropertyType.class,
                new QName("http://www.aixm.aero/schema/5.1", "centreline"), SeaplaneRampSiteTimeSliceType.class,
                target));
    }
