...
"{http://www.aixm.aero/schema/5.1}CodeNavigationAreaType" minOccurs="0"/>
...
"{http://www.aixm.aero/schema/5.1}NavigationAreaSectorPropertyType" maxOccurs=
 ...
 *                 <sequence>
 *                   <element ref=
"{http://www.aixm.aero/schema/5.1}AbstractNavigationAreaExtension"/>
 *                 </sequence>
 *                 <attGroup ref=
...
@XmlType(name = "NavigationAreaTimeSliceType", propOrder = {"navigationAreaType", "minimumCeiling", "minimumVisibility",
        "departure", "sector", "centrePointFixDesignatedPoint", "centrePointNavaidSystem", "centrePointAimingPoint",
        "centrePointRunwayPoint", "centrePointAirportReferencePoint", "centrePointPosition", "annotation", "extension"})
...
public class NavigationAreaTimeSliceType extends AbstractAIXMTimeSliceType implements Serializable {
    ...
    public void setNavigationAreaTypeItem(CodeNavigationAreaType target) {
        setNavigationAreaType(XmlAdapterUtils.marshallJAXBElement(CodeNavigationAreaType.class,
                new QName("http://www.aixm.aero/schema/5.1", "navigationAreaType"), NavigationAreaTimeSliceType.class,
                target));
    }
    ...
    public void setMinimumCeilingItem(ValDistanceVerticalType target) {
        setMinimumCeiling(XmlAdapterUtils.marshallJAXBElement(ValDistanceVerticalType.class,
                new QName("http://www.aixm.aero/schema/5.1", "minimumCeiling"), NavigationAreaTimeSliceType.class,
                target));
    }
    ...
    public void setMinimumVisibilityItem(ValDistanceType target) {
        setMinimumVisibility(XmlAdapterUtils.marshallJAXBElement(ValDistanceType.class,
                new QName("http://www.aixm.aero/schema/5.1", "minimumVisibility"), NavigationAreaTimeSliceType.class,
                target));
    }
    ...
    public void setDepartureItem(StandardInstrumentDeparturePropertyType target) {
        setDeparture(XmlAdapterUtils.marshallJAXBElement(StandardInstrumentDeparturePropertyType.class,
                new QName("http://www.aixm.aero/schema/5.1", "departure"), NavigationAreaTimeSliceType.class, target));
    }
    ...
    public void setCentrePointFixDesignatedPointItem(DesignatedPointPropertyType target) {
        setCentrePointFixDesignatedPoint(XmlAdapterUtils.marshallJAXBElement(DesignatedPointPropertyType.class,
                new QName("http://www.aixm.aero/schema/5.1", "centrePoint_fixDesignatedPoint"),
    ...
    public void setCentrePointNavaidSystemItem(NavaidPropertyType target) {
        setCentrePointNavaidSystem(XmlAdapterUtils.marshallJAXBElement(NavaidPropertyType.class,
                new QName("http://www.aixm.aero/schema/5.1", "centrePoint_navaidSystem"),
                NavigationAreaTimeSliceType.class, target));
    }
    ...
    public void setCentrePointAimingPointItem(TouchDownLiftOffPropertyType target) {
        setCentrePointAimingPoint(XmlAdapterUtils.marshallJAXBElement(TouchDownLiftOffPropertyType.class,
                new QName("http://www.aixm.aero/schema/5.1", "centrePoint_aimingPoint"),
                NavigationAreaTimeSliceType.class, target));
    }
    ...
    public void setCentrePointRunwayPointItem(RunwayCentrelinePointPropertyType target) {
        setCentrePointRunwayPoint(XmlAdapterUtils.marshallJAXBElement(RunwayCentrelinePointPropertyType.class,
                new QName("http://www.aixm.aero/schema/5.1", "centrePoint_runwayPoint"),
                NavigationAreaTimeSliceType.class, target));
    }
    ...
    public void setCentrePointAirportReferencePointItem(AirportHeliportPropertyType target) {
        setCentrePointAirportReferencePoint(XmlAdapterUtils.marshallJAXBElement(AirportHeliportPropertyType.class,
                new QName("http://www.aixm.aero/schema/5.1", "centrePoint_airportReferencePoint"),
                NavigationAreaTimeSliceType.class, target));
    }
    ...
    public void setCentrePointPositionItem(AIXMPointPropertyType target) {
        setCentrePointPosition(XmlAdapterUtils.marshallJAXBElement(AIXMPointPropertyType.class,
                new QName("http://www.aixm.aero/schema/5.1", "centrePoint_position"), NavigationAreaTimeSliceType.class,
                target));
    }
