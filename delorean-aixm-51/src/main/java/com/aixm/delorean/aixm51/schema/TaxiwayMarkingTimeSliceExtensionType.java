...
@XmlType(name = "", propOrder = {"abstractTaxiwayMarkingExtension", "abstractMarkingExtension"})
@Entity(name = "TaxiwayMarkingTimeSliceExtensionType")
@Table(name = "taxiwaymarking_te", schema = "airport_heliport")
public class TaxiwayMarkingTimeSliceExtensionType implements Serializable, Equals, HashCode, ToString {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final TaxiwayMarkingTimeSliceExtensionType that = ((TaxiwayMarkingTimeSliceExtensionType) object);
        {
            ...
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "abstractTaxiwayMarkingExtension",
                    lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "abstractTaxiwayMarkingExtension",
                    rhsField);
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetAbstractTaxiwayMarkingExtension();
            AbstractExtensionType theField;
            theField = this.getAbstractTaxiwayMarkingExtension();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "abstractTaxiwayMarkingExtension", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            AbstractExtensionType theField;
            theField = this.getAbstractTaxiwayMarkingExtension();
            strategy.appendField(locator, this, "abstractTaxiwayMarkingExtension", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetAbstractMarkingExtension();
            AbstractExtensionType theField;
