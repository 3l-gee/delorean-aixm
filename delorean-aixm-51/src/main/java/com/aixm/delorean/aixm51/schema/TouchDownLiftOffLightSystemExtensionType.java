...
@XmlType(name = "", propOrder = {"abstractTouchDownLiftOffLightSystemExtension", "abstractGroundLightSystemExtension"})
@Entity(name = "TouchDownLiftOffLightSystemExtensionType")
@Table(name = "touchdownliftofflightsysteme", schema = "airport_heliport")
public class TouchDownLiftOffLightSystemExtensionType implements Serializable, Equals, HashCode, ToString {
    ...
    @JoinColumn(name = "abstracttouchdownliftofflightsystemextension_hjid", referencedColumnName = "hjid")
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final TouchDownLiftOffLightSystemExtensionType that = ((TouchDownLiftOffLightSystemExtensionType) object);
        {
        ...
        }
        {
            ...
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator,
                    "abstractTouchDownLiftOffLightSystemExtension", lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator,
                    "abstractTouchDownLiftOffLightSystemExtension", rhsField);
            if (!strategy.equals(lhsFieldLocator, rhsFieldLocator, lhsField, rhsField, lhsFieldIsSet, rhsFieldIsSet)) {
                return false;
            }
        }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetAbstractTouchDownLiftOffLightSystemExtension();
            AbstractExtensionType theField;
            theField = this.getAbstractTouchDownLiftOffLightSystemExtension();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator,
                    "abstractTouchDownLiftOffLightSystemExtension", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            AbstractExtensionType theField;
            theField = this.getAbstractTouchDownLiftOffLightSystemExtension();
            strategy.appendField(locator, this, "abstractTouchDownLiftOffLightSystemExtension", buffer, theField,
                    theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetAbstractGroundLightSystemExtension();
