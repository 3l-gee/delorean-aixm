...
@XmlType(name = "", propOrder = {"abstractPropertiesWithScheduleExtension", "abstractAltimeterSourceStatusExtension"})
@Entity(name = "AltimeterSourceStatusTypeExtensionType")
@Table(name = "altimetersourcestatuse", schema = "airport_heliport")
public class AltimeterSourceStatusTypeExtensionType implements Serializable, Equals, HashCode, ToString {
     ...
     */
    @OneToOne(targetEntity = AbstractExtensionType.class, cascade = {CascadeType.ALL}, fetch = FetchType.EAGER)
    @JoinColumn(name = "abstractaltimetersourcestatusextension_hjid", referencedColumnName = "hjid")
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final AltimeterSourceStatusTypeExtensionType that = ((AltimeterSourceStatusTypeExtensionType) object);
        {
        ...
        }
        {
            ...
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "abstractAltimeterSourceStatusExtension",
                    lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "abstractAltimeterSourceStatusExtension",
                    rhsField);
            if (!strategy.equals(lhsFieldLocator, rhsFieldLocator, lhsField, rhsField, lhsFieldIsSet, rhsFieldIsSet)) {
                return false;
            }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetAbstractAltimeterSourceStatusExtension();
            AbstractExtensionType theField;
            theField = this.getAbstractAltimeterSourceStatusExtension();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "abstractAltimeterSourceStatusExtension",
                    theField);
            currentHashCode = strategy.hashCode(theFieldLocator, currentHashCode, theField, theFieldIsSet);
        }
        {
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        }
        {
            ...
            AbstractExtensionType theField;
            theField = this.getAbstractAltimeterSourceStatusExtension();
            strategy.appendField(locator, this, "abstractAltimeterSourceStatusExtension", buffer, theField,
                    theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetOwns();
