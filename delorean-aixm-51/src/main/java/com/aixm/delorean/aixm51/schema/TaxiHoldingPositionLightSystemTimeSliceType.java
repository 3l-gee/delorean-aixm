...
/**
 * <p>
 * Java class for TaxiHoldingPositionLightSystemTimeSliceType complex type
 * </p>
 * .
 *
 * <p>
...
"{http://www.aixm.aero/schema/5.1}CodeLightHoldingPositionType" minOccurs="0"/>
 *         <element name="taxiHolding" type=
 ...
 *                 <choice>
 *                   <element ref=
"{http://www.aixm.aero/schema/5.1}AbstractTaxiHoldingPositionLightSystemExtension"/>
 *                   <element ref=
...
@XmlType(name = "TaxiHoldingPositionLightSystemTimeSliceType", propOrder = {"emergencyLighting", "intensityLevel",
        "colour", "element", "availability", "annotation", "type", "taxiHolding", "extension"})
...
public class TaxiHoldingPositionLightSystemTimeSliceType extends AbstractAIXMTimeSliceType implements Serializable {
    ...
    @JoinTable(name = "txhldngpstnlghtsstmtmslctp_elmnt_link", schema = "airport_heliport", joinColumns = {
            @JoinColumn(name = "taxiholdingpositionlightsystem_t_hjid", referencedColumnName = "hjid")}, inverseJoinColumns = {
     ...
     *
     * @return possible object is {@link JAXBElement
     *         }{@code <}{@link CodeLightHoldingPositionType }{@code >}
     *
     */
    @Transient
    ...
    public void setEmergencyLightingItem(CodeYesNoType target) {
        setEmergencyLighting(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class,
                ...
                TaxiHoldingPositionLightSystemTimeSliceType.class, target));
    }
    ...
    public void setColourItem(CodeColourType target) {
        setColour(XmlAdapterUtils.marshallJAXBElement(CodeColourType.class,
                new QName("http://www.aixm.aero/schema/5.1", "colour"),
                TaxiHoldingPositionLightSystemTimeSliceType.class, target));
    }
    ...
    public void setTypeItem(CodeLightHoldingPositionType target) {
        setType(XmlAdapterUtils.marshallJAXBElement(CodeLightHoldingPositionType.class,
                new QName("http://www.aixm.aero/schema/5.1", "type"), TaxiHoldingPositionLightSystemTimeSliceType.class,
                target));
    }
    ...
    public void setTaxiHoldingItem(TaxiHoldingPositionPropertyType target) {
        setTaxiHolding(XmlAdapterUtils.marshallJAXBElement(TaxiHoldingPositionPropertyType.class,
                new QName("http://www.aixm.aero/schema/5.1", "taxiHolding"),
                TaxiHoldingPositionLightSystemTimeSliceType.class, target));
    }
