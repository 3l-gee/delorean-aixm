...
@XmlType(name = "", propOrder = {"abstractPointReferenceExtension"})
@Entity(name = "PointReferenceExtensionType")
@Table(name = "pointreference_oe", schema = "navaids_point")
public class PointReferenceExtensionType implements Serializable, Equals, HashCode, ToString {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final PointReferenceExtensionType that = ((PointReferenceExtensionType) object);
        {
        ...
        }
        {
            ...
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "abstractPointReferenceExtension",
                    lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "abstractPointReferenceExtension",
                    rhsField);
            if (!strategy.equals(lhsFieldLocator, rhsFieldLocator, lhsField, rhsField, lhsFieldIsSet, rhsFieldIsSet)) {
                return false;
            }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetAbstractPointReferenceExtension();
            AbstractExtensionType theField;
            theField = this.getAbstractPointReferenceExtension();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "abstractPointReferenceExtension", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            AbstractExtensionType theField;
            theField = this.getAbstractPointReferenceExtension();
            strategy.appendField(locator, this, "abstractPointReferenceExtension", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetOwns();
            boolean theField;
