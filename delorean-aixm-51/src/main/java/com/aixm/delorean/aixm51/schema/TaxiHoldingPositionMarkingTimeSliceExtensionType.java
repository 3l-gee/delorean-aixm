...
@XmlType(name = "", propOrder = {"abstractTaxiHoldingPositionMarkingExtension", "abstractMarkingExtension"})
@Entity(name = "TaxiHoldingPositionMarkingTimeSliceExtensionType")
@Table(name = "taxiholdingpositionmarking_te", schema = "airport_heliport")
public class TaxiHoldingPositionMarkingTimeSliceExtensionType implements Serializable, Equals, HashCode, ToString {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final TaxiHoldingPositionMarkingTimeSliceExtensionType that = ((TaxiHoldingPositionMarkingTimeSliceExtensionType) object);
        {
        ...
        }
        {
            ...
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator,
                    "abstractTaxiHoldingPositionMarkingExtension", lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator,
                    "abstractTaxiHoldingPositionMarkingExtension", rhsField);
            if (!strategy.equals(lhsFieldLocator, rhsFieldLocator, lhsField, rhsField, lhsFieldIsSet, rhsFieldIsSet)) {
                return false;
            }
        }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = 1;
        {
            ...
            ObjectLocator theFieldLocator = LocatorUtils.property(locator,
                    "abstractTaxiHoldingPositionMarkingExtension", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            AbstractExtensionType theField;
            theField = this.getAbstractTaxiHoldingPositionMarkingExtension();
            strategy.appendField(locator, this, "abstractTaxiHoldingPositionMarkingExtension", buffer, theField,
                    theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetAbstractMarkingExtension();
