...
@Entity(name = "HoldingUseExtensionType")
@Table(name = "holdinguse_oe", schema = "procedure")
public class HoldingUseExtensionType implements Serializable, Equals, HashCode, ToString {
