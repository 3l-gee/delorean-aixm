...
"{http://www.aixm.aero/schema/5.1}CodeServiceGroundControlType" minOccurs="0"/>
...
public class GroundTrafficControlServiceTimeSliceType extends AbstractAIXMTimeSliceType implements Serializable {
    ...
    public void setRankItem(CodeFacilityRankingType target) {
        setRank(XmlAdapterUtils.marshallJAXBElement(CodeFacilityRankingType.class,
                new QName("http://www.aixm.aero/schema/5.1", "rank"), GroundTrafficControlServiceTimeSliceType.class,
                target));
    }
    ...
    public void setAixmNameItem(TextNameType target) {
        setAixmName(XmlAdapterUtils.marshallJAXBElement(TextNameType.class,
                new QName("http://www.aixm.aero/schema/5.1", "name"), GroundTrafficControlServiceTimeSliceType.class,
                target));
    }
    ...
    public void setLocationItem(AIXMElevatedPointPropertyType target) {
        setLocation(XmlAdapterUtils.marshallJAXBElement(AIXMElevatedPointPropertyType.class,
                new QName("http://www.aixm.aero/schema/5.1", "location"),
                GroundTrafficControlServiceTimeSliceType.class, target));
    }
    ...
    public void setTypeItem(CodeServiceGroundControlType target) {
        setType(XmlAdapterUtils.marshallJAXBElement(CodeServiceGroundControlType.class,
                new QName("http://www.aixm.aero/schema/5.1", "type"), GroundTrafficControlServiceTimeSliceType.class,
                target));
    }
    ...
    public void setClientAirportItem(AirportHeliportPropertyType target) {
        setClientAirport(XmlAdapterUtils.marshallJAXBElement(AirportHeliportPropertyType.class,
                new QName("http://www.aixm.aero/schema/5.1", "clientAirport"),
                GroundTrafficControlServiceTimeSliceType.class, target));
    }
