...
@Entity(name = "GuidanceLineMarkingExtensionType")
@Table(name = "guidancelinemarkinge", schema = "airport_heliport")
public class GuidanceLineMarkingExtensionType implements Serializable, Equals, HashCode, ToString {
