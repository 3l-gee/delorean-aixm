...
@Entity(name = "SurfaceCharacteristicsTypeExtensionType")
@Table(name = "surfacecharacteristicse", schema = "airport_heliport")
public class SurfaceCharacteristicsTypeExtensionType implements Serializable, Equals, HashCode, ToString {
