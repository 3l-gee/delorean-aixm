...
"{http://www.aixm.aero/schema/5.1}DateYearType" minOccurs="0"/>
...
"{http://www.aixm.aero/schema/5.1}AuthorityForNavaidEquipmentPropertyType" maxOccurs
="unbounded" minOccurs="0"/>
 *         <element name="monitoring" type=
"{http://www.aixm.aero/schema/5.1}NavaidEquipmentMonitoringPropertyType" maxOccurs
="unbounded" minOccurs="0"/>
 *         <element name="availability" type=
"{http://www.aixm.aero/schema/5.1}NavaidOperationalStatusPropertyType" maxOccurs
="unbounded" minOccurs="0"/>
 *         <element name="annotation" type=
"{http://www.aixm.aero/schema/5.1}NotePropertyType" maxOccurs=
"unbounded" minOccurs="0"/>
 *         <element name="frequency" type=
"{http://www.aixm.aero/schema/5.1}ValFrequencyType" minOccurs="0"/>
 *         <element name="magneticBearing" type=
"{http://www.aixm.aero/schema/5.1}ValBearingType" minOccurs="0"/>
 *         <element name="magneticBearingAccuracy" type=
"{http://www.aixm.aero/schema/5.1}ValAngleType" minOccurs="0"/>
...
"{http://www.aixm.aero/schema/5.1}ValAngleType" minOccurs="0"/>
 *         <element name="widthCourseAccuracy" type=
"{http://www.aixm.aero/schema/5.1}ValAngleType" minOccurs="0"/>
 *         <element name="backCourseUsable" type=
"{http://www.aixm.aero/schema/5.1}CodeILSBackCourseType" minOccurs="0"/>
 ...
 *                 <choice>
 *                   <element ref=
"{http://www.aixm.aero/schema/5.1}AbstractLocalizerExtension"/>
 *                   <element ref=
"{http://www.aixm.aero/schema/5.1}AbstractNavaidEquipmentExtension"/>
 *                 </choice>
 *                 <attGroup ref=
...
@XmlType(name = "LocalizerTimeSliceType", propOrder = {"designator", "aixmName", "emissionClass", "mobile",
        ...
        "authority", "monitoring", "availability", "annotation", "frequency", "magneticBearing",
        "magneticBearingAccuracy", "trueBearing", "trueBearingAccuracy", "declination", "widthCourse",
        "widthCourseAccuracy", "backCourseUsable", "extension"})
...
public class LocalizerTimeSliceType extends AbstractAIXMTimeSliceType implements Serializable {
    ...
    public void setDesignatorItem(CodeNavaidDesignatorType target) {
        setDesignator(XmlAdapterUtils.marshallJAXBElement(CodeNavaidDesignatorType.class,
                new QName("http://www.aixm.aero/schema/5.1", "designator"), LocalizerTimeSliceType.class, target));
    }
    ...
    public void setAixmNameItem(TextNameType target) {
        setAixmName(XmlAdapterUtils.marshallJAXBElement(TextNameType.class,
                new QName("http://www.aixm.aero/schema/5.1", "name"), LocalizerTimeSliceType.class, target));
    }
    ...
    public void setEmissionClassItem(CodeRadioEmissionType target) {
        setEmissionClass(XmlAdapterUtils.marshallJAXBElement(CodeRadioEmissionType.class,
                new QName("http://www.aixm.aero/schema/5.1", "emissionClass"), LocalizerTimeSliceType.class, target));
    }
    ...
    public void setMobileItem(CodeYesNoType target) {
        setMobile(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class,
                new QName("http://www.aixm.aero/schema/5.1", "mobile"), LocalizerTimeSliceType.class, target));
    }
    ...
    public void setMagneticVariationItem(ValMagneticVariationType target) {
        setMagneticVariation(XmlAdapterUtils.marshallJAXBElement(ValMagneticVariationType.class,
                new QName("http://www.aixm.aero/schema/5.1", "magneticVariation"), LocalizerTimeSliceType.class,
                target));
    }
    ...
    public void setMagneticVariationAccuracyItem(ValAngleType target) {
        setMagneticVariationAccuracy(XmlAdapterUtils.marshallJAXBElement(ValAngleType.class,
                new QName("http://www.aixm.aero/schema/5.1", "magneticVariationAccuracy"), LocalizerTimeSliceType.class,
                target));
    }
    ...
    public void setDateMagneticVariationItem(DateYearType target) {
        setDateMagneticVariation(XmlAdapterUtils.marshallJAXBElement(DateYearType.class,
                new QName("http://www.aixm.aero/schema/5.1", "dateMagneticVariation"), LocalizerTimeSliceType.class,
                target));
    }
    ...
    public void setFlightCheckedItem(CodeYesNoType target) {
        setFlightChecked(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class,
                new QName("http://www.aixm.aero/schema/5.1", "flightChecked"), LocalizerTimeSliceType.class, target));
    }
    ...
    public void setLocationItem(AIXMElevatedPointPropertyType target) {
        setLocation(XmlAdapterUtils.marshallJAXBElement(AIXMElevatedPointPropertyType.class,
                new QName("http://www.aixm.aero/schema/5.1", "location"), LocalizerTimeSliceType.class, target));
    }
    ...
    public void setFrequencyItem(ValFrequencyType target) {
        setFrequency(XmlAdapterUtils.marshallJAXBElement(ValFrequencyType.class,
                new QName("http://www.aixm.aero/schema/5.1", "frequency"), LocalizerTimeSliceType.class, target));
    }
    ...
    public void setMagneticBearingItem(ValBearingType target) {
        setMagneticBearing(XmlAdapterUtils.marshallJAXBElement(ValBearingType.class,
                new QName("http://www.aixm.aero/schema/5.1", "magneticBearing"), LocalizerTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
            @AttributeOverride(name = "value", column = @Column(name = "magneticbearingaccuracy", columnDefinition = "NUMERIC")),
            @AttributeOverride(name = "nilReason", column = @Column(name = "magneticbearingaccuracynilreason"))})
    ...
    public void setMagneticBearingAccuracyItem(ValAngleType target) {
        setMagneticBearingAccuracy(XmlAdapterUtils.marshallJAXBElement(ValAngleType.class,
                new QName("http://www.aixm.aero/schema/5.1", "magneticBearingAccuracy"), LocalizerTimeSliceType.class,
                target));
    }
    ...
    public void setTrueBearingItem(ValBearingType target) {
        setTrueBearing(XmlAdapterUtils.marshallJAXBElement(ValBearingType.class,
                new QName("http://www.aixm.aero/schema/5.1", "trueBearing"), LocalizerTimeSliceType.class, target));
    }
    ...
    public void setTrueBearingAccuracyItem(ValAngleType target) {
        setTrueBearingAccuracy(XmlAdapterUtils.marshallJAXBElement(ValAngleType.class,
                new QName("http://www.aixm.aero/schema/5.1", "trueBearingAccuracy"), LocalizerTimeSliceType.class,
                target));
    }
    ...
    public void setDeclinationItem(ValMagneticVariationType target) {
        setDeclination(XmlAdapterUtils.marshallJAXBElement(ValMagneticVariationType.class,
                new QName("http://www.aixm.aero/schema/5.1", "declination"), LocalizerTimeSliceType.class, target));
    }
    ...
    public void setWidthCourseItem(ValAngleType target) {
        setWidthCourse(XmlAdapterUtils.marshallJAXBElement(ValAngleType.class,
                new QName("http://www.aixm.aero/schema/5.1", "widthCourse"), LocalizerTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
            @AttributeOverride(name = "value", column = @Column(name = "widthcourseaccuracy", columnDefinition = "NUMERIC")),
            @AttributeOverride(name = "nilReason", column = @Column(name = "widthcourseaccuracynilreason"))})
    ...
    public void setWidthCourseAccuracyItem(ValAngleType target) {
        setWidthCourseAccuracy(XmlAdapterUtils.marshallJAXBElement(ValAngleType.class,
                new QName("http://www.aixm.aero/schema/5.1", "widthCourseAccuracy"), LocalizerTimeSliceType.class,
                target));
    }
    ...
    public void setBackCourseUsableItem(CodeILSBackCourseType target) {
        setBackCourseUsable(XmlAdapterUtils.marshallJAXBElement(CodeILSBackCourseType.class,
                new QName("http://www.aixm.aero/schema/5.1", "backCourseUsable"), LocalizerTimeSliceType.class,
                target));
    }
