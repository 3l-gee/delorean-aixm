...
/**
 * <p>
 * Java class for GuidanceLineLightSystemTimeSliceType complex type
 * </p>
 * .
 *
 * <p>
...
"unbounded" minOccurs="0"/>
 *         <element name="lightedGuidanceLine" type=
"{http://www.aixm.aero/schema/5.1}GuidanceLinePropertyType" minOccurs="0"/>
 ...
 *                 <choice>
 *                   <element ref=
"{http://www.aixm.aero/schema/5.1}AbstractGuidanceLineLightSystemExtension"/>
 *                   <element ref=
...
@XmlType(name = "GuidanceLineLightSystemTimeSliceType", propOrder = {"emergencyLighting", "intensityLevel", "colour",
        "element", "availability", "annotation", "lightedGuidanceLine", "extension"})
@Entity(name = "GuidanceLineLightSystemTimeSliceType")
@Table(name = "guidancelinelightsystem_t", schema = "airport_heliport")
public class GuidanceLineLightSystemTimeSliceType extends AbstractAIXMTimeSliceType implements Serializable {
    ...
    @JoinTable(name = "gdnclnlghtsstmtmslctp_elmnt_link", schema = "airport_heliport", joinColumns = {
            @JoinColumn(name = "guidancelinelightsystem_t_hjid", referencedColumnName = "hjid")}, inverseJoinColumns = {
    ...
    public void setEmergencyLightingItem(CodeYesNoType target) {
        setEmergencyLighting(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class,
                ...
                GuidanceLineLightSystemTimeSliceType.class, target));
    }
    ...
    public void setColourItem(CodeColourType target) {
        setColour(XmlAdapterUtils.marshallJAXBElement(CodeColourType.class,
                new QName("http://www.aixm.aero/schema/5.1", "colour"), GuidanceLineLightSystemTimeSliceType.class,
                target));
    }
    ...
    public void setLightedGuidanceLineItem(GuidanceLinePropertyType target) {
        setLightedGuidanceLine(XmlAdapterUtils.marshallJAXBElement(GuidanceLinePropertyType.class,
                new QName("http://www.aixm.aero/schema/5.1", "lightedGuidanceLine"),
                GuidanceLineLightSystemTimeSliceType.class, target));
    }
