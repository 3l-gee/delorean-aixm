...
@Entity(name = "LightElementStatusExtensionType")
@Table(name = "lightelementstatus_oe", schema = "shared")
public class LightElementStatusExtensionType implements Serializable, Equals, HashCode, ToString {

    private static final long serialVersionUID = 20251104L;
    @XmlElement(name = "AbstractPropertiesWithScheduleExtension")
    protected AbstractExtensionType abstractPropertiesWithScheduleExtension;
    @XmlElement(name = "AbstractLightElementStatusExtension")
    protected AbstractExtensionType abstractLightElementStatusExtension;
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        }
        {
            ...
            AbstractExtensionType theField;
            theField = this.getAbstractLightElementStatusExtension();
            strategy.appendField(locator, this, "abstractLightElementStatusExtension", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetOwns();
            boolean theField;
