...
@XmlType(name = "", propOrder = {"abstractPropertiesWithScheduleExtension", "abstractPostalAddressExtension"})
@Entity(name = "PostalAddressExtensionType")
@Table(name = "postaladdress_oe", schema = "shared")
public class PostalAddressExtensionType implements Serializable, Equals, HashCode, ToString {
     ...
     */
    @OneToOne(targetEntity = AbstractExtensionType.class, cascade = {CascadeType.ALL}, fetch = FetchType.EAGER)
    @JoinColumn(name = "abstractpostaladdressextension_hjid", referencedColumnName = "hjid")
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final PostalAddressExtensionType that = ((PostalAddressExtensionType) object);
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetAbstractPostalAddressExtension();
            AbstractExtensionType theField;
            theField = this.getAbstractPostalAddressExtension();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "abstractPostalAddressExtension", theField);
            currentHashCode = strategy.hashCode(theFieldLocator, currentHashCode, theField, theFieldIsSet);
        }
        {
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        }
        {
            ...
            AbstractExtensionType theField;
            theField = this.getAbstractPostalAddressExtension();
            strategy.appendField(locator, this, "abstractPostalAddressExtension", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetOwns();
            boolean theField;
