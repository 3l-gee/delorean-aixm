...
@XmlType(name = "", propOrder = {"abstractFASDataBlockExtension"})
@Entity(name = "FASDataBlockExtensionType")
@Table(name = "fasdatablock_oe", schema = "procedure")
public class FASDataBlockExtensionType implements Serializable, Equals, HashCode, ToString {
    ...
    @JoinColumn(name = "abstractfasdatablockextension_hjid", referencedColumnName = "hjid")
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final FASDataBlockExtensionType that = ((FASDataBlockExtensionType) object);
        {
        ...
        }
        {
            ...
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "abstractFASDataBlockExtension",
                    lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "abstractFASDataBlockExtension",
                    rhsField);
            if (!strategy.equals(lhsFieldLocator, rhsFieldLocator, lhsField, rhsField, lhsFieldIsSet, rhsFieldIsSet)) {
                return false;
            }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetAbstractFASDataBlockExtension();
            AbstractExtensionType theField;
            theField = this.getAbstractFASDataBlockExtension();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "abstractFASDataBlockExtension", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            AbstractExtensionType theField;
            theField = this.getAbstractFASDataBlockExtension();
            strategy.appendField(locator, this, "abstractFASDataBlockExtension", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetOwns();
            boolean theField;
