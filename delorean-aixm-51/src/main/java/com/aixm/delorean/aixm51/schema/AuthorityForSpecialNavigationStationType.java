 ...
 *                 <sequence>
 *                   <element ref=
"{http://www.aixm.aero/schema/5.1}AbstractAuthorityForSpecialNavigationStationExtension"/>
 *                 </sequence>
 *                 <attGroup ref=
...
public class AuthorityForSpecialNavigationStationType extends AbstractAIXMObjectType implements Serializable {
    ...
    @OneToMany(targetEntity = AuthorityForSpecialNavigationStationTypeExtensionType.class, cascade = {
            CascadeType.ALL}, fetch = FetchType.EAGER)
    @JoinColumn(name = "authorityforspecialnavigationstatione_hjid", referencedColumnName = "hjid")
    ...
    public void setTypeItem(CodeAuthorityRoleType target) {
        setType(XmlAdapterUtils.marshallJAXBElement(CodeAuthorityRoleType.class,
                new QName("http://www.aixm.aero/schema/5.1", "type"), AuthorityForSpecialNavigationStationType.class,
                target));
    }
