...
@XmlType(name = "", propOrder = {"abstractPropertiesWithScheduleExtension", "abstractConditionCombinationExtension"})
@Entity(name = "ConditionCombinationExtensionType")
@Table(name = "conditioncombination_oe", schema = "airport_heliport")
public class ConditionCombinationExtensionType implements Serializable, Equals, HashCode, ToString {
     ...
     */
    @OneToOne(targetEntity = AbstractExtensionType.class, cascade = {CascadeType.ALL}, fetch = FetchType.EAGER)
    @JoinColumn(name = "abstractconditioncombinationextension_hjid", referencedColumnName = "hjid")
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final ConditionCombinationExtensionType that = ((ConditionCombinationExtensionType) object);
        {
            ...
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "abstractConditionCombinationExtension",
                    lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "abstractConditionCombinationExtension",
                    rhsField);
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetAbstractConditionCombinationExtension();
            AbstractExtensionType theField;
            theField = this.getAbstractConditionCombinationExtension();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "abstractConditionCombinationExtension",
                    theField);
            currentHashCode = strategy.hashCode(theFieldLocator, currentHashCode, theField, theFieldIsSet);
        }
        {
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        }
        {
            ...
            AbstractExtensionType theField;
            theField = this.getAbstractConditionCombinationExtension();
            strategy.appendField(locator, this, "abstractConditionCombinationExtension", buffer, theField,
                    theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetOwns();
