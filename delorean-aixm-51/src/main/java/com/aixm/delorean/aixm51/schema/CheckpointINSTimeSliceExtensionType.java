...
@XmlType(name = "", propOrder = {"abstractCheckpointINSExtension", "abstractNavigationSystemCheckpointExtension"})
@Entity(name = "CheckpointINSTimeSliceExtensionType")
@Table(name = "checkpointins_te", schema = "navaids_point")
public class CheckpointINSTimeSliceExtensionType implements Serializable, Equals, HashCode, ToString {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final CheckpointINSTimeSliceExtensionType that = ((CheckpointINSTimeSliceExtensionType) object);
        {
            ...
            lhsField = this.getAbstractCheckpointINSExtension();
            AbstractExtensionType rhsField;
            rhsField = that.getAbstractCheckpointINSExtension();
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "abstractCheckpointINSExtension",
                    lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "abstractCheckpointINSExtension",
                    rhsField);
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetAbstractCheckpointINSExtension();
            AbstractExtensionType theField;
            theField = this.getAbstractCheckpointINSExtension();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "abstractCheckpointINSExtension", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            AbstractExtensionType theField;
            theField = this.getAbstractCheckpointINSExtension();
            strategy.appendField(locator, this, "abstractCheckpointINSExtension", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetAbstractNavigationSystemCheckpointExtension();
            AbstractExtensionType theField;
