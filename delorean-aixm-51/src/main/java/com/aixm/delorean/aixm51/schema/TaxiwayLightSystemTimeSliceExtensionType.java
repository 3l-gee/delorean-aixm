...
@XmlType(name = "", propOrder = {"abstractTaxiwayLightSystemExtension", "abstractGroundLightSystemExtension"})
...
public class TaxiwayLightSystemTimeSliceExtensionType implements Serializable, Equals, HashCode, ToString {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = 1;
        {
            ...
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "abstractTaxiwayLightSystemExtension",
                    theField);
