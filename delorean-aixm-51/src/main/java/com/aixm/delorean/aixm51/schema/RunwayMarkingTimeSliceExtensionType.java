...
@XmlType(name = "", propOrder = {"abstractRunwayMarkingExtension", "abstractMarkingExtension"})
@Entity(name = "RunwayMarkingTimeSliceExtensionType")
@Table(name = "runwaymarking_te", schema = "airport_heliport")
public class RunwayMarkingTimeSliceExtensionType implements Serializable, Equals, HashCode, ToString {
    ...
    @JoinColumn(name = "abstractrunwaymarkingextension_hjid", referencedColumnName = "hjid")
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final RunwayMarkingTimeSliceExtensionType that = ((RunwayMarkingTimeSliceExtensionType) object);
        {
            boolean lhsFieldIsSet = this.isSetAbstractRunwayMarkingExtension();
            boolean rhsFieldIsSet = that.isSetAbstractRunwayMarkingExtension();
            AbstractExtensionType lhsField;
            lhsField = this.getAbstractRunwayMarkingExtension();
            AbstractExtensionType rhsField;
            rhsField = that.getAbstractRunwayMarkingExtension();
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "abstractRunwayMarkingExtension",
                    lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "abstractRunwayMarkingExtension",
                    rhsField);
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetAbstractRunwayMarkingExtension();
            AbstractExtensionType theField;
            theField = this.getAbstractRunwayMarkingExtension();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "abstractRunwayMarkingExtension", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            AbstractExtensionType theField;
            theField = this.getAbstractRunwayMarkingExtension();
            strategy.appendField(locator, this, "abstractRunwayMarkingExtension", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetAbstractMarkingExtension();
            AbstractExtensionType theField;
