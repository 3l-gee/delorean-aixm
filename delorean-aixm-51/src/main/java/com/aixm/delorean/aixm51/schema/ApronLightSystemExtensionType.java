...
@Entity(name = "ApronLightSystemExtensionType")
@Table(name = "apronlightsysteme", schema = "airport_heliport")
public class ApronLightSystemExtensionType implements Serializable, Equals, HashCode, ToString {
