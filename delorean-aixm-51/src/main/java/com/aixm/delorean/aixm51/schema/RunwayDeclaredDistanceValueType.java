 ...
 *                   <element ref=
"{http://www.aixm.aero/schema/5.1}AbstractRunwayDeclaredDistanceValueExtension"/>
 *                 </choice>
 *                 <attGroup ref=
...
@XmlType(name = "RunwayDeclaredDistanceValueType", propOrder = {"timeInterval", "annotation", "specialDateAuthority",
        "distance", "distanceAccuracy", "extension"})
@Entity(name = "RunwayDeclaredDistanceValueType")
@Table(name = "runwaydeclareddistancevaluetype", schema = "airport_heliport")
public class RunwayDeclaredDistanceValueType extends AbstractPropertiesWithScheduleType implements Serializable {
    ...
    @JoinTable(name = "rnwdclrddstncvltp_tmintrvl_link", schema = "airport_heliport", joinColumns = {
            @JoinColumn(name = "runwaydeclareddistancevaluetype_hjid", referencedColumnName = "hjid")}, inverseJoinColumns = {
    ...
    public void setDistanceItem(ValDistanceType target) {
        setDistance(XmlAdapterUtils.marshallJAXBElement(ValDistanceType.class,
                new QName("http://www.aixm.aero/schema/5.1", "distance"), RunwayDeclaredDistanceValueType.class,
                target));
    }
    ...
    public void setDistanceAccuracyItem(ValDistanceType target) {
        setDistanceAccuracy(XmlAdapterUtils.marshallJAXBElement(ValDistanceType.class,
                new QName("http://www.aixm.aero/schema/5.1", "distanceAccuracy"), RunwayDeclaredDistanceValueType.class,
                target));
    }
