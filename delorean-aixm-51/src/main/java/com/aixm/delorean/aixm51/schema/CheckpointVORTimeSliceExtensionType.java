...
@XmlType(name = "", propOrder = {"abstractCheckpointVORExtension", "abstractNavigationSystemCheckpointExtension"})
@Entity(name = "CheckpointVORTimeSliceExtensionType")
@Table(name = "checkpointvor_te", schema = "navaids_point")
public class CheckpointVORTimeSliceExtensionType implements Serializable, Equals, HashCode, ToString {
    ...
    @JoinColumn(name = "abstractcheckpointvorextension_hjid", referencedColumnName = "hjid")
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        }
        {
            ...
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "abstractCheckpointVORExtension",
                    lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "abstractCheckpointVORExtension",
                    rhsField);
            if (!strategy.equals(lhsFieldLocator, rhsFieldLocator, lhsField, rhsField, lhsFieldIsSet, rhsFieldIsSet)) {
                return false;
            }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetAbstractCheckpointVORExtension();
            AbstractExtensionType theField;
            theField = this.getAbstractCheckpointVORExtension();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "abstractCheckpointVORExtension", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            AbstractExtensionType theField;
            theField = this.getAbstractCheckpointVORExtension();
            strategy.appendField(locator, this, "abstractCheckpointVORExtension", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetAbstractNavigationSystemCheckpointExtension();
            AbstractExtensionType theField;
