 ...
 *       <sequence>
 *         <element ref=
"{http://www.aixm.aero/schema/5.1}AbstractAerialRefuellingTrackExtension"/>
 *       </sequence>
 *       <attGroup ref=
...
@XmlType(name = "", propOrder = {"abstractAerialRefuellingTrackExtension"})
@Entity(name = "AerialRefuellingTrackExtensionType")
@Table(name = "aerialrefuellingtrack_oe", schema = "aerial_refuelling")
public class AerialRefuellingTrackExtensionType implements Serializable, Equals, HashCode, ToString {

    private static final long serialVersionUID = 20251104L;
    @XmlElement(name = "AbstractAerialRefuellingTrackExtension", required = true)
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final AerialRefuellingTrackExtensionType that = ((AerialRefuellingTrackExtensionType) object);
        {
        ...
        }
        {
            ...
            lhsField = this.getAbstractAerialRefuellingTrackExtension();
            AbstractExtensionType rhsField;
            rhsField = that.getAbstractAerialRefuellingTrackExtension();
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "abstractAerialRefuellingTrackExtension",
                    lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "abstractAerialRefuellingTrackExtension",
                    rhsField);
            if (!strategy.equals(lhsFieldLocator, rhsFieldLocator, lhsField, rhsField, lhsFieldIsSet, rhsFieldIsSet)) {
                return false;
            }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetAbstractAerialRefuellingTrackExtension();
            AbstractExtensionType theField;
            theField = this.getAbstractAerialRefuellingTrackExtension();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "abstractAerialRefuellingTrackExtension",
                    theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            AbstractExtensionType theField;
            theField = this.getAbstractAerialRefuellingTrackExtension();
            strategy.appendField(locator, this, "abstractAerialRefuellingTrackExtension", buffer, theField,
                    theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetOwns();
