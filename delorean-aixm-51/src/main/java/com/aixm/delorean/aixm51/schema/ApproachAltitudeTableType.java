...
public class ApproachAltitudeTableType extends AbstractAIXMObjectType implements Serializable {
    ...
    public void setMeasurementPointItem(CodeProcedureDistanceType target) {
        setMeasurementPoint(XmlAdapterUtils.marshallJAXBElement(CodeProcedureDistanceType.class,
                new QName("http://www.aixm.aero/schema/5.1", "measurementPoint"), ApproachAltitudeTableType.class,
                target));
    }
    ...
    public void setAltitudeItem(ValDistanceVerticalType target) {
        setAltitude(XmlAdapterUtils.marshallJAXBElement(ValDistanceVerticalType.class,
                new QName("http://www.aixm.aero/schema/5.1", "altitude"), ApproachAltitudeTableType.class, target));
    }
    ...
    public void setAltitudeReferenceItem(CodeVerticalReferenceType target) {
        setAltitudeReference(XmlAdapterUtils.marshallJAXBElement(CodeVerticalReferenceType.class,
                new QName("http://www.aixm.aero/schema/5.1", "altitudeReference"), ApproachAltitudeTableType.class,
                target));
    }
