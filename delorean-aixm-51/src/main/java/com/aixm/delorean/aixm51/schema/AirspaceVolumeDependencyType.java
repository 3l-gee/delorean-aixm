...
"{http://www.aixm.aero/schema/5.1}CodeAirspaceDependencyType" minOccurs="0"/>
 ...
 *                 <sequence>
 *                   <element ref=
"{http://www.aixm.aero/schema/5.1}AbstractAirspaceVolumeDependencyExtension"/>
 *                 </sequence>
 *                 <attGroup ref=
...
public class AirspaceVolumeDependencyType extends AbstractAIXMObjectType implements Serializable {
    ...
    @XmlElementRef(name = "dependency", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class, required = false)
     ...
     *
     * @return possible object is {@link AirspacePropertyType }
     *
     */
     ...
     *
     * @param value
     *            allowed object is {@link AirspacePropertyType }
     *
     */
    ...
    public void setDependencyItem(CodeAirspaceDependencyType target) {
        setDependency(XmlAdapterUtils.marshallJAXBElement(CodeAirspaceDependencyType.class,
                new QName("http://www.aixm.aero/schema/5.1", "dependency"), AirspaceVolumeDependencyType.class,
                target));
    }
