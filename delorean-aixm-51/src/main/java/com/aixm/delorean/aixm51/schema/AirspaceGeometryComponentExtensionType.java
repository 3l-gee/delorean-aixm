...
@XmlType(name = "", propOrder = {"abstractAirspaceGeometryComponentExtension"})
@Entity(name = "AirspaceGeometryComponentExtensionType")
@Table(name = "airspacegeometrycomponent_oe", schema = "airspace")
public class AirspaceGeometryComponentExtensionType implements Serializable, Equals, HashCode, ToString {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final AirspaceGeometryComponentExtensionType that = ((AirspaceGeometryComponentExtensionType) object);
        {
            ...
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator,
                    "abstractAirspaceGeometryComponentExtension", lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator,
                    "abstractAirspaceGeometryComponentExtension", rhsField);
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetAbstractAirspaceGeometryComponentExtension();
            AbstractExtensionType theField;
            theField = this.getAbstractAirspaceGeometryComponentExtension();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "abstractAirspaceGeometryComponentExtension",
                    theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            AbstractExtensionType theField;
            theField = this.getAbstractAirspaceGeometryComponentExtension();
            strategy.appendField(locator, this, "abstractAirspaceGeometryComponentExtension", buffer, theField,
                    theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetOwns();
