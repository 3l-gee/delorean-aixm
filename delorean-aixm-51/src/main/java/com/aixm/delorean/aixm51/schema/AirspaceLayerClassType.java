...
/**
 * <p>
 * Java class for AirspaceLayerClassType complex type
 * </p>
 * .
 *
 * <p>
...
"{http://www.aixm.aero/schema/5.1}CodeAirspaceClassificationType" minOccurs=
"0"/>
 *         <element name="associatedLevels" type=
...
public class AirspaceLayerClassType extends AbstractPropertiesWithScheduleType implements Serializable {
     ...
     *         }{@code <}{@link CodeAirspaceClassificationType }{@code >}
     *
     */
    @Transient
     ...
     * Therefore any modification you make to the returned list will be present
     * inside the JAXB object. This is why there is not a <CODE>set</CODE> method
     * for the associatedLevels property.
     *
     * <p>
     * For example, to add a new item, do as follows:
     *
    ...
    @Embedded
    @AttributeOverrides({@AttributeOverride(name = "value", column = @Column(name = "classification")),
            @AttributeOverride(name = "nilReason", column = @Column(name = "classificationnilreason"))})
    ...
    public void setClassificationItem(CodeAirspaceClassificationType target) {
        setClassification(XmlAdapterUtils.marshallJAXBElement(CodeAirspaceClassificationType.class,
                new QName("http://www.aixm.aero/schema/5.1", "classification"), AirspaceLayerClassType.class, target));
    }
