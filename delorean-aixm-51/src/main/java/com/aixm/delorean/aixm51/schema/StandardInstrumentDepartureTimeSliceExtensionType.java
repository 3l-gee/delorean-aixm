...
@XmlType(name = "", propOrder = {"abstractStandardInstrumentDepartureExtension", "abstractProcedureExtension"})
@Entity(name = "StandardInstrumentDepartureTimeSliceExtensionType")
@Table(name = "standardinstrumentdeparture_te", schema = "procedure")
public class StandardInstrumentDepartureTimeSliceExtensionType implements Serializable, Equals, HashCode, ToString {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetAbstractStandardInstrumentDepartureExtension();
            AbstractExtensionType theField;
            theField = this.getAbstractStandardInstrumentDepartureExtension();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator,
                    "abstractStandardInstrumentDepartureExtension", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            AbstractExtensionType theField;
            theField = this.getAbstractStandardInstrumentDepartureExtension();
            strategy.appendField(locator, this, "abstractStandardInstrumentDepartureExtension", buffer, theField,
                    theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetAbstractProcedureExtension();
