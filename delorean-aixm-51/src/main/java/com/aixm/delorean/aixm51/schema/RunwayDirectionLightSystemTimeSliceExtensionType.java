...
@Entity(name = "RunwayDirectionLightSystemTimeSliceExtensionType")
@Table(name = "runwaydirectionlightsystem_te", schema = "airport_heliport")
public class RunwayDirectionLightSystemTimeSliceExtensionType implements Serializable, Equals, HashCode, ToString {
