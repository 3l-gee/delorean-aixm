 ...
 *                 <choice>
 *                   <element ref=
"{http://www.aixm.aero/schema/5.1}AbstractRunwayDirectionLightSystemExtension"/>
 *                   <element ref=
...
@XmlType(name = "RunwayDirectionLightSystemTimeSliceType", propOrder = {"emergencyLighting", "intensityLevel", "colour",
        "element", "availability", "annotation", "position", "associatedRunwayDirection", "extension"})
...
public class RunwayDirectionLightSystemTimeSliceType extends AbstractAIXMTimeSliceType implements Serializable {
    ...
    protected List<RunwayDirectionLightSystemExtensionType> extension;
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link RunwayDirectionLightSystemExtensionType }
     *
     *
     */
    @OneToMany(targetEntity = RunwayDirectionLightSystemExtensionType.class, cascade = {
            CascadeType.ALL}, fetch = FetchType.EAGER)
    @JoinColumn(name = "runwaydirectionlightsysteme_hjid", referencedColumnName = "hjid")
     ...
     *
     */
    public void setExtension(List<RunwayDirectionLightSystemExtensionType> extension) {
    ...
    public void setColourItem(CodeColourType target) {
        setColour(XmlAdapterUtils.marshallJAXBElement(CodeColourType.class,
                new QName("http://www.aixm.aero/schema/5.1", "colour"), RunwayDirectionLightSystemTimeSliceType.class,
                target));
    }
    ...
    public void setPositionItem(CodeRunwaySectionType target) {
        setPosition(XmlAdapterUtils.marshallJAXBElement(CodeRunwaySectionType.class,
                new QName("http://www.aixm.aero/schema/5.1", "position"), RunwayDirectionLightSystemTimeSliceType.class,
                target));
    }
    ...
    public void setAssociatedRunwayDirectionItem(RunwayDirectionPropertyType target) {
        setAssociatedRunwayDirection(XmlAdapterUtils.marshallJAXBElement(RunwayDirectionPropertyType.class,
                new QName("http://www.aixm.aero/schema/5.1", "associatedRunwayDirection"),
                RunwayDirectionLightSystemTimeSliceType.class, target));
    }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        }
        {
            ...
            List<RunwayDirectionLightSystemExtensionType> lhsField;
            lhsField = (this.isSetExtension() ? this.getExtension() : null);
            List<RunwayDirectionLightSystemExtensionType> rhsField;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        }
        {
            ...
            List<RunwayDirectionLightSystemExtensionType> theField;
