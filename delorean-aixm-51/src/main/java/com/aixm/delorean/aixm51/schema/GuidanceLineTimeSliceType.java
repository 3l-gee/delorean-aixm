...
"{http://www.aixm.aero/schema/5.1}CodeGuidanceLineType" minOccurs="0"/>
 *         <element name="maxSpeed" type=
"{http://www.aixm.aero/schema/5.1}ValSpeedType" minOccurs="0"/>
 *         <element name="usageDirection" type=
"{http://www.aixm.aero/schema/5.1}CodeDirectionType" minOccurs="0"/>
...
"{http://www.aixm.aero/schema/5.1}RunwayCentrelinePointPropertyType" maxOccurs=
"unbounded" minOccurs="0"/>
 *         <element name="connectedApron" type=
"{http://www.aixm.aero/schema/5.1}ApronPropertyType" maxOccurs=
"unbounded" minOccurs="0"/>
 *         <element name="connectedStand" type=
"{http://www.aixm.aero/schema/5.1}AircraftStandPropertyType" maxOccurs=
"unbounded" minOccurs="0"/>
...
"{http://www.aixm.aero/schema/5.1}TaxiwayPropertyType" maxOccurs=
"unbounded" minOccurs="0"/>
 ...
 *                 <sequence>
 *                   <element ref=
"{http://www.aixm.aero/schema/5.1}AbstractGuidanceLineExtension"/>
 *                 </sequence>
 *                 <attGroup ref=
...
public class GuidanceLineTimeSliceType extends AbstractAIXMTimeSliceType implements Serializable {
    ...
    public void setDesignatorItem(TextNameType target) {
        setDesignator(XmlAdapterUtils.marshallJAXBElement(TextNameType.class,
                new QName("http://www.aixm.aero/schema/5.1", "designator"), GuidanceLineTimeSliceType.class, target));
    }
    ...
    public void setTypeItem(CodeGuidanceLineType target) {
        setType(XmlAdapterUtils.marshallJAXBElement(CodeGuidanceLineType.class,
                new QName("http://www.aixm.aero/schema/5.1", "type"), GuidanceLineTimeSliceType.class, target));
    }
    ...
    public void setMaxSpeedItem(ValSpeedType target) {
        setMaxSpeed(XmlAdapterUtils.marshallJAXBElement(ValSpeedType.class,
                new QName("http://www.aixm.aero/schema/5.1", "maxSpeed"), GuidanceLineTimeSliceType.class, target));
    }
    ...
    public void setUsageDirectionItem(CodeDirectionType target) {
        setUsageDirection(XmlAdapterUtils.marshallJAXBElement(CodeDirectionType.class,
                new QName("http://www.aixm.aero/schema/5.1", "usageDirection"), GuidanceLineTimeSliceType.class,
                target));
    }
    ...
    public void setExtentItem(AIXMElevatedCurvePropertyType target) {
        setExtent(XmlAdapterUtils.marshallJAXBElement(AIXMElevatedCurvePropertyType.class,
                new QName("http://www.aixm.aero/schema/5.1", "extent"), GuidanceLineTimeSliceType.class, target));
    }
