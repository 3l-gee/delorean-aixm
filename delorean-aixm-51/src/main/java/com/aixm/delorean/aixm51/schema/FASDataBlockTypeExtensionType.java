...
@Entity(name = "FASDataBlockTypeExtensionType")
@Table(name = "fasdatablocke", schema = "procedure")
public class FASDataBlockTypeExtensionType implements Serializable, Equals, HashCode, ToString {
