...
@XmlType(name = "", propOrder = {"abstractPropertiesWithScheduleExtension", "abstractAirspaceActivationExtension"})
@Entity(name = "AirspaceActivationTypeExtensionType")
@Table(name = "airspaceactivatione", schema = "airspace")
public class AirspaceActivationTypeExtensionType implements Serializable, Equals, HashCode, ToString {
     ...
     */
    @OneToOne(targetEntity = AbstractExtensionType.class, cascade = {CascadeType.ALL}, fetch = FetchType.EAGER)
    @JoinColumn(name = "abstractairspaceactivationextension_hjid", referencedColumnName = "hjid")
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final AirspaceActivationTypeExtensionType that = ((AirspaceActivationTypeExtensionType) object);
        {
        ...
        {
            boolean lhsFieldIsSet = this.isSetAbstractAirspaceActivationExtension();
            boolean rhsFieldIsSet = that.isSetAbstractAirspaceActivationExtension();
            AbstractExtensionType lhsField;
            lhsField = this.getAbstractAirspaceActivationExtension();
            AbstractExtensionType rhsField;
            rhsField = that.getAbstractAirspaceActivationExtension();
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "abstractAirspaceActivationExtension",
                    lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "abstractAirspaceActivationExtension",
                    rhsField);
            if (!strategy.equals(lhsFieldLocator, rhsFieldLocator, lhsField, rhsField, lhsFieldIsSet, rhsFieldIsSet)) {
                return false;
            }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetAbstractAirspaceActivationExtension();
            AbstractExtensionType theField;
            theField = this.getAbstractAirspaceActivationExtension();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "abstractAirspaceActivationExtension",
                    theField);
            currentHashCode = strategy.hashCode(theFieldLocator, currentHashCode, theField, theFieldIsSet);
        }
        {
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        }
        {
            ...
            AbstractExtensionType theField;
            theField = this.getAbstractAirspaceActivationExtension();
            strategy.appendField(locator, this, "abstractAirspaceActivationExtension", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetOwns();
            boolean theField;
