...
"unbounded" minOccurs="0"/>
 *         <element name="logicalOperator" type=
"{http://www.aixm.aero/schema/5.1}CodeLogicalOperatorType" minOccurs="0"/>
 *         <element name="weather" type=
"{http://www.aixm.aero/schema/5.1}MeteorologyPropertyType" maxOccurs=
"unbounded" minOccurs="0"/>
...
"{http://www.aixm.aero/schema/5.1}FlightCharacteristicPropertyType" maxOccurs=
"unbounded" minOccurs="0"/>
 *         <element name="subCondition" type=
"{http://www.aixm.aero/schema/5.1}ConditionCombinationPropertyType" maxOccurs=
"unbounded" minOccurs="0"/>
 ...
 *                   <element ref=
"{http://www.aixm.aero/schema/5.1}AbstractConditionCombinationExtension"/>
 *                 </choice>
 *                 <attGroup ref=
...
public class ConditionCombinationType extends AbstractPropertiesWithScheduleType implements Serializable {
    ...
    @AttributeOverrides({@AttributeOverride(name = "value", column = @Column(name = "logicaloperator")),
            @AttributeOverride(name = "nilReason", column = @Column(name = "logicaloperatornilreason"))})
    ...
    public void setLogicalOperatorItem(CodeLogicalOperatorType target) {
        setLogicalOperator(XmlAdapterUtils.marshallJAXBElement(CodeLogicalOperatorType.class,
                new QName("http://www.aixm.aero/schema/5.1", "logicalOperator"), ConditionCombinationType.class,
                target));
    }
