...
@Entity(name = "TouchDownLiftOffMarkingTimeSliceExtensionType")
@Table(name = "touchdownliftoffmarking_te", schema = "airport_heliport")
public class TouchDownLiftOffMarkingTimeSliceExtensionType implements Serializable, Equals, HashCode, ToString {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final TouchDownLiftOffMarkingTimeSliceExtensionType that = ((TouchDownLiftOffMarkingTimeSliceExtensionType) object);
        {
