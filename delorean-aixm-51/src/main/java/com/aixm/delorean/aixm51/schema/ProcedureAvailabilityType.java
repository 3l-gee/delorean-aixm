...
/**
 * <p>
 * Java class for ProcedureAvailabilityType complex type
 * </p>
 * .
 *
 * <p>
...
"{http://www.aixm.aero/schema/5.1}CodeProcedureAvailabilityType" minOccurs="0"/>
...
@XmlType(name = "ProcedureAvailabilityType", propOrder = {"timeInterval", "annotation", "specialDateAuthority",
        "status", "extension"})
@Entity(name = "ProcedureAvailabilityType")
@Table(name = "procedureavailabilitytype", schema = "procedure")
public class ProcedureAvailabilityType extends AbstractPropertiesWithScheduleType implements Serializable {
    ...
    @JoinTable(name = "prcdravlblttp_tmintrvl_link", schema = "procedure", joinColumns = {
            @JoinColumn(name = "procedureavailabilitytype_hjid", referencedColumnName = "hjid")}, inverseJoinColumns = {
    ...
    @JoinTable(name = "prcdravlblttp_annttn_link", schema = "procedure", joinColumns = {
            @JoinColumn(name = "procedureavailabilitytype_hjid", referencedColumnName = "hjid")}, inverseJoinColumns = {
    ...
    @JoinTable(name = "prcdravlblttp_spcldtathrt_link", schema = "procedure", joinColumns = {
            @JoinColumn(name = "procedureavailabilitytype_hjid", referencedColumnName = "hjid")}, inverseJoinColumns = {
     ...
     *         }{@code <}{@link CodeProcedureAvailabilityType }{@code >}
     *
     */
    @Transient
    ...
    public CodeProcedureAvailabilityType getStatusItem() {
        return XmlAdapterUtils.unmarshallSource(CodeProcedureAvailabilityType.class, this.getStatus());
    }

    public void setStatusItem(CodeProcedureAvailabilityType target) {
        setStatus(XmlAdapterUtils.marshallJAXBElement(CodeProcedureAvailabilityType.class,
                new QName("http://www.aixm.aero/schema/5.1", "status"), ProcedureAvailabilityType.class, target));
    }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        }
        {
            ...
            JAXBElement<CodeProcedureAvailabilityType> theField;
