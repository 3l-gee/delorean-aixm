...
"{http://www.aixm.aero/schema/5.1}CodeMinimaFinalApproachPathType" minOccurs=
"0"/>
...
"{http://www.aixm.aero/schema/5.1}MinimaPropertyType" minOccurs="0"/>
 *         <element name="circlingRestriction" type=
"{http://www.aixm.aero/schema/5.1}CirclingRestrictionPropertyType" maxOccurs=
...
"{http://www.aixm.aero/schema/5.1}LandingTakeoffAreaCollectionPropertyType" maxOccurs
="unbounded" minOccurs="0"/>
 *         <element name="altimeter" type=
"{http://www.aixm.aero/schema/5.1}AltimeterSourcePropertyType" minOccurs="0"/>
 ...
 *                 <sequence>
 *                   <element ref=
"{http://www.aixm.aero/schema/5.1}AbstractApproachConditionExtension"/>
 *                 </sequence>
 *                 <attGroup ref=
...
public class ApproachConditionType extends AbstractAIXMObjectType implements Serializable {
    ...
    public void setFinalApproachPathItem(CodeMinimaFinalApproachPathType target) {
        setFinalApproachPath(XmlAdapterUtils.marshallJAXBElement(CodeMinimaFinalApproachPathType.class,
                new QName("http://www.aixm.aero/schema/5.1", "finalApproachPath"), ApproachConditionType.class,
                target));
    }
    ...
    public void setClimbGradientItem(ValSlopeType target) {
        setClimbGradient(XmlAdapterUtils.marshallJAXBElement(ValSlopeType.class,
                new QName("http://www.aixm.aero/schema/5.1", "climbGradient"), ApproachConditionType.class, target));
    }
    ...
    public void setMinimumSetItem(MinimaPropertyType target) {
        setMinimumSet(XmlAdapterUtils.marshallJAXBElement(MinimaPropertyType.class,
                new QName("http://www.aixm.aero/schema/5.1", "minimumSet"), ApproachConditionType.class, target));
    }
    ...
    public void setAltimeterItem(AltimeterSourcePropertyType target) {
        setAltimeter(XmlAdapterUtils.marshallJAXBElement(AltimeterSourcePropertyType.class,
                new QName("http://www.aixm.aero/schema/5.1", "altimeter"), ApproachConditionType.class, target));
    }
