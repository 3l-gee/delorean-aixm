 ...
 *       <sequence>
 *         <element ref="{http://www.aixm.aero/schema/5.1}UnitTimeSlice"/>
 *       </sequence>
 *       <attGroup ref=
...
public class UnitTimeSlicePropertyType implements Serializable, Equals, HashCode, ToString {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetUnitTimeSlice();
            UnitTimeSliceType theField;
            theField = this.getUnitTimeSlice();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "unitTimeSlice", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            UnitTimeSliceType theField;
            theField = this.getUnitTimeSlice();
            strategy.appendField(locator, this, "unitTimeSlice", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetOwns();
            boolean theField;
