...
@Entity(name = "CheckpointVORExtensionType")
@Table(name = "checkpointvore", schema = "navaids_point")
public class CheckpointVORExtensionType implements Serializable, Equals, HashCode, ToString {
