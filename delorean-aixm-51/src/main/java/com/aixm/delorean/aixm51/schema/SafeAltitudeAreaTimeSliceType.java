...
"{http://www.aixm.aero/schema/5.1}CodeSafeAltitudeType" minOccurs="0"/>
 *         <choice>
...
"{http://www.aixm.aero/schema/5.1}SafeAltitudeAreaSectorPropertyType" maxOccurs=
 ...
 *                 <sequence>
 *                   <element ref=
"{http://www.aixm.aero/schema/5.1}AbstractSafeAltitudeAreaExtension"/>
 *                 </sequence>
 *                 <attGroup ref=
...
@XmlType(name = "SafeAltitudeAreaTimeSliceType", propOrder = {"safeAreaType", "centrePointFixDesignatedPoint",
        "centrePointNavaidSystem", "centrePointAimingPoint", "centrePointRunwayPoint",
        "centrePointAirportReferencePoint", "centrePointPosition", "sector", "location", "annotation", "extension"})
...
public class SafeAltitudeAreaTimeSliceType extends AbstractAIXMTimeSliceType implements Serializable {
     ...
     *
     */
    @OneToMany(targetEntity = SafeAltitudeAreaExtensionType.class, cascade = {CascadeType.ALL}, fetch = FetchType.EAGER)
    @JoinColumn(name = "safealtitudeareae_hjid", referencedColumnName = "hjid")
    ...
    public void setSafeAreaTypeItem(CodeSafeAltitudeType target) {
        setSafeAreaType(XmlAdapterUtils.marshallJAXBElement(CodeSafeAltitudeType.class,
                new QName("http://www.aixm.aero/schema/5.1", "safeAreaType"), SafeAltitudeAreaTimeSliceType.class,
                target));
    }
    ...
    public void setCentrePointPositionItem(AIXMPointPropertyType target) {
        setCentrePointPosition(XmlAdapterUtils.marshallJAXBElement(AIXMPointPropertyType.class,
                new QName("http://www.aixm.aero/schema/5.1", "centrePoint_position"),
                SafeAltitudeAreaTimeSliceType.class, target));
    }
