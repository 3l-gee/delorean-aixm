 ...
 *         <element ref=
"{http://www.aixm.aero/schema/5.1}AbstractAirportHeliportResponsibilityOrganisationExtension"/>
 *       </choice>
 *       <attGroup ref=
...
@Entity(name = "AirportHeliportResponsibilityOrganisationExtensionType")
@Table(name = "airportheliportresponsibilityorganisation_oe", schema = "airport_heliport")
public class AirportHeliportResponsibilityOrganisationExtensionType
        implements
            Serializable,
            Equals,
            HashCode,
     ...
     */
    @OneToOne(targetEntity = AbstractExtensionType.class, cascade = {CascadeType.ALL}, fetch = FetchType.EAGER)
    @JoinColumn(name = "abstractairportheliportresponsibilityorganisationextension_hjid", referencedColumnName = "hjid")
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final AirportHeliportResponsibilityOrganisationExtensionType that = ((AirportHeliportResponsibilityOrganisationExtensionType) object);
        {
        ...
        {
            boolean lhsFieldIsSet = this.isSetAbstractAirportHeliportResponsibilityOrganisationExtension();
            boolean rhsFieldIsSet = that.isSetAbstractAirportHeliportResponsibilityOrganisationExtension();
            AbstractExtensionType lhsField;
