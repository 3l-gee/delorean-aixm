 ...
 *         <element ref=
"{http://www.aixm.aero/schema/5.1}AbstractProcedureAvailabilityExtension"/>
 *       </choice>
 *       <attGroup ref=
...
@XmlType(name = "", propOrder = {"abstractPropertiesWithScheduleExtension", "abstractProcedureAvailabilityExtension"})
@Entity(name = "ProcedureAvailabilityTypeExtensionType")
@Table(name = "procedureavailabilitye", schema = "procedure")
public class ProcedureAvailabilityTypeExtensionType implements Serializable, Equals, HashCode, ToString {
    ...
    /**
     * Gets the value of the abstractProcedureAvailabilityExtension property.
     *
     * @return possible object is {@link AbstractExtensionType }
     *
     */
    @OneToOne(targetEntity = AbstractExtensionType.class, cascade = {CascadeType.ALL}, fetch = FetchType.EAGER)
    @JoinColumn(name = "abstractprocedureavailabilityextension_hjid", referencedColumnName = "hjid")
    public AbstractExtensionType getAbstractProcedureAvailabilityExtension() {
        return abstractProcedureAvailabilityExtension;
    }

    /**
     * Sets the value of the abstractProcedureAvailabilityExtension property.
     *
     * @param value
     *            allowed object is {@link AbstractExtensionType }
     *
    ...
    @Transient
    public boolean isSetAbstractProcedureAvailabilityExtension() {
        return (this.abstractProcedureAvailabilityExtension != null);
    }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final ProcedureAvailabilityTypeExtensionType that = ((ProcedureAvailabilityTypeExtensionType) object);
        {
        ...
        {
            boolean lhsFieldIsSet = this.isSetAbstractProcedureAvailabilityExtension();
            boolean rhsFieldIsSet = that.isSetAbstractProcedureAvailabilityExtension();
            AbstractExtensionType lhsField;
            lhsField = this.getAbstractProcedureAvailabilityExtension();
            AbstractExtensionType rhsField;
            rhsField = that.getAbstractProcedureAvailabilityExtension();
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "abstractProcedureAvailabilityExtension",
                    lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "abstractProcedureAvailabilityExtension",
                    rhsField);
            if (!strategy.equals(lhsFieldLocator, rhsFieldLocator, lhsField, rhsField, lhsFieldIsSet, rhsFieldIsSet)) {
                return false;
            }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetAbstractProcedureAvailabilityExtension();
            AbstractExtensionType theField;
            theField = this.getAbstractProcedureAvailabilityExtension();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "abstractProcedureAvailabilityExtension",
                    theField);
            currentHashCode = strategy.hashCode(theFieldLocator, currentHashCode, theField, theFieldIsSet);
        }
        {
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        }
        {
            ...
            AbstractExtensionType theField;
            theField = this.getAbstractProcedureAvailabilityExtension();
            strategy.appendField(locator, this, "abstractProcedureAvailabilityExtension", buffer, theField,
                    theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetOwns();
