 ...
 *       <sequence>
 *         <element ref=
"{http://www.aixm.aero/schema/5.1}AbstractAuthorityForNavaidEquipmentExtension"/>
 *       </sequence>
 *       <attGroup ref=
...
@XmlType(name = "", propOrder = {"abstractAuthorityForNavaidEquipmentExtension"})
@Entity(name = "AuthorityForNavaidEquipmentExtensionType")
@Table(name = "authorityfornavaidequipment_oe", schema = "navaids_point")
public class AuthorityForNavaidEquipmentExtensionType implements Serializable, Equals, HashCode, ToString {

    private static final long serialVersionUID = 20251104L;
    @XmlElement(name = "AbstractAuthorityForNavaidEquipmentExtension", required = true)
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final AuthorityForNavaidEquipmentExtensionType that = ((AuthorityForNavaidEquipmentExtensionType) object);
        {
        ...
        }
        {
            ...
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator,
                    "abstractAuthorityForNavaidEquipmentExtension", lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator,
                    "abstractAuthorityForNavaidEquipmentExtension", rhsField);
            if (!strategy.equals(lhsFieldLocator, rhsFieldLocator, lhsField, rhsField, lhsFieldIsSet, rhsFieldIsSet)) {
                return false;
            }
        }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = 1;
        {
            ...
            ObjectLocator theFieldLocator = LocatorUtils.property(locator,
                    "abstractAuthorityForNavaidEquipmentExtension", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            AbstractExtensionType theField;
            theField = this.getAbstractAuthorityForNavaidEquipmentExtension();
            strategy.appendField(locator, this, "abstractAuthorityForNavaidEquipmentExtension", buffer, theField,
                    theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetOwns();
