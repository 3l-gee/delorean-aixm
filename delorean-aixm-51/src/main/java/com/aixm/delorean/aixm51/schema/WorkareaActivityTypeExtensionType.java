...
@Entity(name = "WorkareaActivityTypeExtensionType")
@Table(name = "workareaactivitye", schema = "airport_heliport")
public class WorkareaActivityTypeExtensionType implements Serializable, Equals, HashCode, ToString {
