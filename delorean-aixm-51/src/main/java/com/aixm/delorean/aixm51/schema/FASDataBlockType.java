...
"{http://www.aixm.aero/schema/5.1}ValAlarmLimitType" minOccurs="0"/>
...
"{http://www.aixm.aero/schema/5.1}ValHexType" minOccurs="0"/>
 ...
 *                 <sequence>
 *                   <element ref=
"{http://www.aixm.aero/schema/5.1}AbstractFASDataBlockExtension"/>
 *                 </sequence>
 *                 <attGroup ref=
...
public class FASDataBlockType extends AbstractAIXMObjectType implements Serializable {
     ...
     *
     */
    @OneToMany(targetEntity = FASDataBlockTypeExtensionType.class, cascade = {CascadeType.ALL}, fetch = FetchType.EAGER)
    @JoinColumn(name = "fasdatablocke_hjid", referencedColumnName = "hjid")
    ...
    public void setHorizontalAlarmLimitItem(ValAlarmLimitType target) {
        setHorizontalAlarmLimit(XmlAdapterUtils.marshallJAXBElement(ValAlarmLimitType.class,
                new QName("http://www.aixm.aero/schema/5.1", "horizontalAlarmLimit"), FASDataBlockType.class, target));
    }
    ...
    public void setVerticalAlarmLimitItem(ValAlarmLimitType target) {
        setVerticalAlarmLimit(XmlAdapterUtils.marshallJAXBElement(ValAlarmLimitType.class,
                new QName("http://www.aixm.aero/schema/5.1", "verticalAlarmLimit"), FASDataBlockType.class, target));
    }
    ...
    public void setThresholdCourseWidthItem(ValDistanceType target) {
        setThresholdCourseWidth(XmlAdapterUtils.marshallJAXBElement(ValDistanceType.class,
                new QName("http://www.aixm.aero/schema/5.1", "thresholdCourseWidth"), FASDataBlockType.class, target));
    }
    ...
    public void setLengthOffsetItem(ValDistanceType target) {
        setLengthOffset(XmlAdapterUtils.marshallJAXBElement(ValDistanceType.class,
                new QName("http://www.aixm.aero/schema/5.1", "lengthOffset"), FASDataBlockType.class, target));
    }
    ...
    public void setCRCRemainderItem(ValHexType target) {
        setCRCRemainder(XmlAdapterUtils.marshallJAXBElement(ValHexType.class,
                new QName("http://www.aixm.aero/schema/5.1", "CRCRemainder"), FASDataBlockType.class, target));
    }
    ...
    public void setOperationTypeItem(NoSequenceType target) {
        setOperationType(XmlAdapterUtils.marshallJAXBElement(NoSequenceType.class,
                new QName("http://www.aixm.aero/schema/5.1", "operationType"), FASDataBlockType.class, target));
    }
    ...
    public void setServiceProviderSBASItem(NoSequenceType target) {
        setServiceProviderSBAS(XmlAdapterUtils.marshallJAXBElement(NoSequenceType.class,
                new QName("http://www.aixm.aero/schema/5.1", "serviceProviderSBAS"), FASDataBlockType.class, target));
    }
    ...
    public void setApproachPerformanceDesignatorItem(NoSequenceType target) {
        setApproachPerformanceDesignator(XmlAdapterUtils.marshallJAXBElement(NoSequenceType.class,
                new QName("http://www.aixm.aero/schema/5.1", "approachPerformanceDesignator"), FASDataBlockType.class,
                target));
    }
    ...
    public void setRouteIndicatorItem(String target) {
        setRouteIndicator(XmlAdapterUtils.marshallJAXBElement(String.class,
                new QName("http://www.aixm.aero/schema/5.1", "routeIndicator"), FASDataBlockType.class, target));
    }
    ...
    public void setReferencePathDataSelectorItem(NoSequenceType target) {
        setReferencePathDataSelector(XmlAdapterUtils.marshallJAXBElement(NoSequenceType.class,
                new QName("http://www.aixm.aero/schema/5.1", "referencePathDataSelector"), FASDataBlockType.class,
                target));
    }
    ...
    public void setReferencePathIdentifierItem(String target) {
        setReferencePathIdentifier(XmlAdapterUtils.marshallJAXBElement(String.class,
                new QName("http://www.aixm.aero/schema/5.1", "referencePathIdentifier"), FASDataBlockType.class,
                target));
    }
    ...
    public void setCodeICAOItem(String target) {
        setCodeICAO(XmlAdapterUtils.marshallJAXBElement(String.class,
                new QName("http://www.aixm.aero/schema/5.1", "codeICAO"), FASDataBlockType.class, target));
    }
