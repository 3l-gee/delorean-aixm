...
@Entity(name = "MarkerBeaconTimeSliceExtensionType")
@Table(name = "markerbeacon_te", schema = "navaids_point")
public class MarkerBeaconTimeSliceExtensionType implements Serializable, Equals, HashCode, ToString {
