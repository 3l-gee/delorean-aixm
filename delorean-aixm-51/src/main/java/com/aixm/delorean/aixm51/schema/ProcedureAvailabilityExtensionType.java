...
@Entity(name = "ProcedureAvailabilityExtensionType")
@Table(name = "procedureavailability_oe", schema = "procedure")
public class ProcedureAvailabilityExtensionType implements Serializable, Equals, HashCode, ToString {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final ProcedureAvailabilityExtensionType that = ((ProcedureAvailabilityExtensionType) object);
        {
