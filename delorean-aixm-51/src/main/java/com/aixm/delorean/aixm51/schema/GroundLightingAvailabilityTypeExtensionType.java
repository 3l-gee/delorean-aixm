...
@Entity(name = "GroundLightingAvailabilityTypeExtensionType")
@Table(name = "groundlightingavailabilitye", schema = "airport_heliport")
public class GroundLightingAvailabilityTypeExtensionType implements Serializable, Equals, HashCode, ToString {
