...
@Entity(name = "StandMarkingExtensionType")
@Table(name = "standmarkinge", schema = "airport_heliport")
public class StandMarkingExtensionType implements Serializable, Equals, HashCode, ToString {
