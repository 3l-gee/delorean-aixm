...
@Entity(name = "RadioCommunicationOperationalStatusExtensionType")
@Table(name = "radiocommunicationoperationalstatus_oe", schema = "service")
public class RadioCommunicationOperationalStatusExtensionType implements Serializable, Equals, HashCode, ToString {
    ...
    /**
     * Gets the value of the abstractRadioCommunicationOperationalStatusExtension
     * property.
     *
     * @return possible object is {@link AbstractExtensionType }
     *
     */
    @OneToOne(targetEntity = AbstractExtensionType.class, cascade = {CascadeType.ALL}, fetch = FetchType.EAGER)
    @JoinColumn(name = "abstractradiocommunicationoperationalstatusextension_hjid", referencedColumnName = "hjid")
    ...
    /**
     * Sets the value of the abstractRadioCommunicationOperationalStatusExtension
     * property.
     *
     * @param value
     *            allowed object is {@link AbstractExtensionType }
     *
     */
    public void setAbstractRadioCommunicationOperationalStatusExtension(AbstractExtensionType value) {
        this.abstractRadioCommunicationOperationalStatusExtension = value;
    }

    @Transient
    public boolean isSetAbstractRadioCommunicationOperationalStatusExtension() {
        return (this.abstractRadioCommunicationOperationalStatusExtension != null);
    }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final RadioCommunicationOperationalStatusExtensionType that = ((RadioCommunicationOperationalStatusExtensionType) object);
        {
            ...
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator,
                    "abstractRadioCommunicationOperationalStatusExtension", lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator,
                    "abstractRadioCommunicationOperationalStatusExtension", rhsField);
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetAbstractRadioCommunicationOperationalStatusExtension();
            AbstractExtensionType theField;
            theField = this.getAbstractRadioCommunicationOperationalStatusExtension();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator,
                    "abstractRadioCommunicationOperationalStatusExtension", theField);
            currentHashCode = strategy.hashCode(theFieldLocator, currentHashCode, theField, theFieldIsSet);
        }
        {
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        }
        {
            ...
            AbstractExtensionType theField;
            theField = this.getAbstractRadioCommunicationOperationalStatusExtension();
            strategy.appendField(locator, this, "abstractRadioCommunicationOperationalStatusExtension", buffer,
