...
/**
 * <p>
 * Java class for NDBTimeSliceType complex type
 * </p>
 * .
 *
 * <p>
...
"{http://www.aixm.aero/schema/5.1}CodeNDBUsageType" minOccurs="0"/>
 *         <element name="emissionBand" type=
"{http://www.aixm.aero/schema/5.1}CodeEmissionBandType" minOccurs="0"/>
 ...
 *                 <choice>
 *                   <element ref=
"{http://www.aixm.aero/schema/5.1}AbstractNDBExtension"/>
 *                   <element ref=
...
@XmlType(name = "NDBTimeSliceType", propOrder = {"designator", "aixmName", "emissionClass", "mobile",
        "magneticVariation", "magneticVariationAccuracy", "dateMagneticVariation", "flightChecked", "location",
        "authority", "monitoring", "availability", "annotation", "frequency", "clazz", "emissionBand", "extension"})
@Entity(name = "NDBTimeSliceType")
@Table(name = "ndb_t", schema = "navaids_point")
public class NDBTimeSliceType extends AbstractAIXMTimeSliceType implements Serializable {
    ...
    @JoinTable(name = "ndbtmslctp_athrt_link", schema = "navaids_point", joinColumns = {
            @JoinColumn(name = "ndb_t_hjid", referencedColumnName = "hjid")}, inverseJoinColumns = {
     ...
     *
     * @return possible object is {@link JAXBElement
     *         }{@code <}{@link CodeNDBUsageType }{@code >}
     *
     */
    @Transient
     ...
     *
     * @return possible object is {@link JAXBElement
     *         }{@code <}{@link CodeEmissionBandType }{@code >}
     *
     */
    @Transient
     ...
     *
     */
    @OneToMany(targetEntity = NDBTimeSliceExtensionType.class, cascade = {CascadeType.ALL}, fetch = FetchType.EAGER)
    ...
    public void setDesignatorItem(CodeNavaidDesignatorType target) {
        setDesignator(XmlAdapterUtils.marshallJAXBElement(CodeNavaidDesignatorType.class,
                new QName("http://www.aixm.aero/schema/5.1", "designator"), NDBTimeSliceType.class, target));
    }
    ...
    public void setAixmNameItem(TextNameType target) {
        setAixmName(XmlAdapterUtils.marshallJAXBElement(TextNameType.class,
                new QName("http://www.aixm.aero/schema/5.1", "name"), NDBTimeSliceType.class, target));
    }
    ...
    public void setEmissionClassItem(CodeRadioEmissionType target) {
        setEmissionClass(XmlAdapterUtils.marshallJAXBElement(CodeRadioEmissionType.class,
                new QName("http://www.aixm.aero/schema/5.1", "emissionClass"), NDBTimeSliceType.class, target));
    }
    ...
    public void setMobileItem(CodeYesNoType target) {
        setMobile(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class,
                new QName("http://www.aixm.aero/schema/5.1", "mobile"), NDBTimeSliceType.class, target));
    }
    ...
    public void setMagneticVariationItem(ValMagneticVariationType target) {
        setMagneticVariation(XmlAdapterUtils.marshallJAXBElement(ValMagneticVariationType.class,
                new QName("http://www.aixm.aero/schema/5.1", "magneticVariation"), NDBTimeSliceType.class, target));
    }
    ...
    public void setMagneticVariationAccuracyItem(ValAngleType target) {
        setMagneticVariationAccuracy(XmlAdapterUtils.marshallJAXBElement(ValAngleType.class,
                new QName("http://www.aixm.aero/schema/5.1", "magneticVariationAccuracy"), NDBTimeSliceType.class,
                target));
    }
    ...
    public void setDateMagneticVariationItem(DateYearType target) {
        setDateMagneticVariation(XmlAdapterUtils.marshallJAXBElement(DateYearType.class,
                new QName("http://www.aixm.aero/schema/5.1", "dateMagneticVariation"), NDBTimeSliceType.class, target));
    }
    ...
    public void setFlightCheckedItem(CodeYesNoType target) {
        setFlightChecked(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class,
                new QName("http://www.aixm.aero/schema/5.1", "flightChecked"), NDBTimeSliceType.class, target));
    }
    ...
    public void setLocationItem(AIXMElevatedPointPropertyType target) {
        setLocation(XmlAdapterUtils.marshallJAXBElement(AIXMElevatedPointPropertyType.class,
                new QName("http://www.aixm.aero/schema/5.1", "location"), NDBTimeSliceType.class, target));
    }
    ...
    public void setFrequencyItem(ValFrequencyType target) {
        setFrequency(XmlAdapterUtils.marshallJAXBElement(ValFrequencyType.class,
                new QName("http://www.aixm.aero/schema/5.1", "frequency"), NDBTimeSliceType.class, target));
    }
    ...
    public void setClazzItem(CodeNDBUsageType target) {
        setClazz(XmlAdapterUtils.marshallJAXBElement(CodeNDBUsageType.class,
                new QName("http://www.aixm.aero/schema/5.1", "class"), NDBTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({@AttributeOverride(name = "value", column = @Column(name = "emissionband")),
            @AttributeOverride(name = "nilReason", column = @Column(name = "emissionbandnilreason"))})
    ...
    public void setEmissionBandItem(CodeEmissionBandType target) {
        setEmissionBand(XmlAdapterUtils.marshallJAXBElement(CodeEmissionBandType.class,
                new QName("http://www.aixm.aero/schema/5.1", "emissionBand"), NDBTimeSliceType.class, target));
    }
