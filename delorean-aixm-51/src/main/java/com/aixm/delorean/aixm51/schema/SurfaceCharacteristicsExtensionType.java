...
@XmlType(name = "", propOrder = {"abstractSurfaceCharacteristicsExtension"})
@Entity(name = "SurfaceCharacteristicsExtensionType")
@Table(name = "surfacecharacteristics_oe", schema = "airport_heliport")
public class SurfaceCharacteristicsExtensionType implements Serializable, Equals, HashCode, ToString {
    ...
    @JoinColumn(name = "abstractsurfacecharacteristicsextension_hjid", referencedColumnName = "hjid")
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final SurfaceCharacteristicsExtensionType that = ((SurfaceCharacteristicsExtensionType) object);
        {
            ...
            lhsField = this.getAbstractSurfaceCharacteristicsExtension();
            ...
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator,
                    "abstractSurfaceCharacteristicsExtension", lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator,
                    "abstractSurfaceCharacteristicsExtension", rhsField);
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetAbstractSurfaceCharacteristicsExtension();
            AbstractExtensionType theField;
            theField = this.getAbstractSurfaceCharacteristicsExtension();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "abstractSurfaceCharacteristicsExtension",
                    theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            AbstractExtensionType theField;
            theField = this.getAbstractSurfaceCharacteristicsExtension();
            strategy.appendField(locator, this, "abstractSurfaceCharacteristicsExtension", buffer, theField,
                    theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetOwns();
