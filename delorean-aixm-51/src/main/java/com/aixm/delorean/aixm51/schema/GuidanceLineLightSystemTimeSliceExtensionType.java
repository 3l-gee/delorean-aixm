...
@XmlType(name = "", propOrder = {"abstractGuidanceLineLightSystemExtension", "abstractGroundLightSystemExtension"})
@Entity(name = "GuidanceLineLightSystemTimeSliceExtensionType")
@Table(name = "guidancelinelightsystem_te", schema = "airport_heliport")
public class GuidanceLineLightSystemTimeSliceExtensionType implements Serializable, Equals, HashCode, ToString {
     ...
     *
     */
    public void setAbstractGuidanceLineLightSystemExtension(AbstractExtensionType value) {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final GuidanceLineLightSystemTimeSliceExtensionType that = ((GuidanceLineLightSystemTimeSliceExtensionType) object);
        {
        ...
        }
        {
            ...
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator,
                    "abstractGuidanceLineLightSystemExtension", lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator,
                    "abstractGuidanceLineLightSystemExtension", rhsField);
            if (!strategy.equals(lhsFieldLocator, rhsFieldLocator, lhsField, rhsField, lhsFieldIsSet, rhsFieldIsSet)) {
                return false;
            }
        }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetAbstractGuidanceLineLightSystemExtension();
            AbstractExtensionType theField;
            theField = this.getAbstractGuidanceLineLightSystemExtension();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "abstractGuidanceLineLightSystemExtension",
                    theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            AbstractExtensionType theField;
            theField = this.getAbstractGuidanceLineLightSystemExtension();
            strategy.appendField(locator, this, "abstractGuidanceLineLightSystemExtension", buffer, theField,
                    theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetAbstractGroundLightSystemExtension();
