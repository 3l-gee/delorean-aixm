...
"{http://www.aixm.aero/schema/5.1}CodeUnitDependencyType" minOccurs="0"/>
 ...
 *                 <sequence>
 *                   <element ref=
"{http://www.aixm.aero/schema/5.1}AbstractUnitDependencyExtension"/>
 *                 </sequence>
 *                 <attGroup ref=
...
public class UnitDependencyType extends AbstractAIXMObjectType implements Serializable {
    ...
    public void setTypeItem(CodeUnitDependencyType target) {
        setType(XmlAdapterUtils.marshallJAXBElement(CodeUnitDependencyType.class,
                new QName("http://www.aixm.aero/schema/5.1", "type"), UnitDependencyType.class, target));
    }
