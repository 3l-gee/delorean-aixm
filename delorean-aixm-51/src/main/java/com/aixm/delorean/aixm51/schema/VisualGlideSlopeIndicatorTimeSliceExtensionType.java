...
@Entity(name = "VisualGlideSlopeIndicatorTimeSliceExtensionType")
@Table(name = "visualglideslopeindicator_te", schema = "airport_heliport")
public class VisualGlideSlopeIndicatorTimeSliceExtensionType implements Serializable, Equals, HashCode, ToString {
    ...
    @JoinColumn(name = "abstractvisualglideslopeindicatorextension_hjid", referencedColumnName = "hjid")
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final VisualGlideSlopeIndicatorTimeSliceExtensionType that = ((VisualGlideSlopeIndicatorTimeSliceExtensionType) object);
        {
