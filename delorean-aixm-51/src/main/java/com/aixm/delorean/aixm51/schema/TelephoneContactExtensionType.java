...
@Entity(name = "TelephoneContactExtensionType")
@Table(name = "telephonecontact_oe", schema = "shared")
public class TelephoneContactExtensionType implements Serializable, Equals, HashCode, ToString {
     ...
     */
    @OneToOne(targetEntity = AbstractExtensionType.class, cascade = {CascadeType.ALL}, fetch = FetchType.EAGER)
    @JoinColumn(name = "abstracttelephonecontactextension_hjid", referencedColumnName = "hjid")
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        }
        {
            ...
            AbstractExtensionType theField;
            theField = this.getAbstractTelephoneContactExtension();
            strategy.appendField(locator, this, "abstractTelephoneContactExtension", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetOwns();
            boolean theField;
