...
@Entity(name = "DeicingAreaMarkingExtensionType")
@Table(name = "deicingareamarkinge", schema = "airport_heliport")
public class DeicingAreaMarkingExtensionType implements Serializable, Equals, HashCode, ToString {
