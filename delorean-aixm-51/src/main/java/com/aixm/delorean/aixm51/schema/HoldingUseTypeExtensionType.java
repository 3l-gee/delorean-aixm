...
@XmlType(name = "", propOrder = {"abstractHoldingUseExtension"})
@Entity(name = "HoldingUseTypeExtensionType")
@Table(name = "holdingusee", schema = "procedure")
public class HoldingUseTypeExtensionType implements Serializable, Equals, HashCode, ToString {
    ...
    @JoinColumn(name = "abstractholdinguseextension_hjid", referencedColumnName = "hjid")
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final HoldingUseTypeExtensionType that = ((HoldingUseTypeExtensionType) object);
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetAbstractHoldingUseExtension();
            AbstractExtensionType theField;
            theField = this.getAbstractHoldingUseExtension();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "abstractHoldingUseExtension", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            AbstractExtensionType theField;
            theField = this.getAbstractHoldingUseExtension();
            strategy.appendField(locator, this, "abstractHoldingUseExtension", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetOwns();
            boolean theField;
