...
/**
 * <p>
 * Java class for DMETimeSliceType complex type
 * </p>
 * .
 *
 * <p>
...
"{http://www.aixm.aero/schema/5.1}CodeDMEType" minOccurs="0"/>
 *         <element name="channel" type=
"{http://www.aixm.aero/schema/5.1}CodeDMEChannelType" minOccurs="0"/>
 *         <element name="ghostFrequency" type=
"{http://www.aixm.aero/schema/5.1}ValFrequencyType" minOccurs="0"/>
 *         <element name="displace" type=
 ...
 *                 <choice>
 *                   <element ref=
"{http://www.aixm.aero/schema/5.1}AbstractDMEExtension"/>
 *                   <element ref=
...
@XmlType(name = "DMETimeSliceType", propOrder = {"designator", "aixmName", "emissionClass", "mobile",
        "magneticVariation", "magneticVariationAccuracy", "dateMagneticVariation", "flightChecked", "location",
        "authority", "monitoring", "availability", "annotation", "type", "channel", "ghostFrequency", "displace",
        "extension"})
@Entity(name = "DMETimeSliceType")
@Table(name = "dme_t", schema = "navaids_point")
public class DMETimeSliceType extends AbstractAIXMTimeSliceType implements Serializable {
    ...
    @JoinTable(name = "dmetmslctp_athrt_link", schema = "navaids_point", joinColumns = {
            @JoinColumn(name = "dme_t_hjid", referencedColumnName = "hjid")}, inverseJoinColumns = {
     ...
     *
     * @return possible object is {@link JAXBElement }{@code <}{@link CodeDMEType
     *         }{@code >}
     *
     */
    @Transient
     ...
     *
     * @param value
     *            allowed object is {@link JAXBElement }{@code <}{@link CodeDMEType
     *            }{@code >}
     *
     */
     ...
     *
     * @return possible object is {@link JAXBElement
     *         }{@code <}{@link CodeDMEChannelType }{@code >}
     *
     */
    @Transient
     ...
     *
     */
    @OneToMany(targetEntity = DMETimeSliceExtensionType.class, cascade = {CascadeType.ALL}, fetch = FetchType.EAGER)
    ...
    public void setDesignatorItem(CodeNavaidDesignatorType target) {
        setDesignator(XmlAdapterUtils.marshallJAXBElement(CodeNavaidDesignatorType.class,
                new QName("http://www.aixm.aero/schema/5.1", "designator"), DMETimeSliceType.class, target));
    }
    ...
    public void setAixmNameItem(TextNameType target) {
        setAixmName(XmlAdapterUtils.marshallJAXBElement(TextNameType.class,
                new QName("http://www.aixm.aero/schema/5.1", "name"), DMETimeSliceType.class, target));
    }
    ...
    public void setEmissionClassItem(CodeRadioEmissionType target) {
        setEmissionClass(XmlAdapterUtils.marshallJAXBElement(CodeRadioEmissionType.class,
                new QName("http://www.aixm.aero/schema/5.1", "emissionClass"), DMETimeSliceType.class, target));
    }
    ...
    public void setMobileItem(CodeYesNoType target) {
        setMobile(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class,
                new QName("http://www.aixm.aero/schema/5.1", "mobile"), DMETimeSliceType.class, target));
    }
    ...
    public void setMagneticVariationItem(ValMagneticVariationType target) {
        setMagneticVariation(XmlAdapterUtils.marshallJAXBElement(ValMagneticVariationType.class,
                new QName("http://www.aixm.aero/schema/5.1", "magneticVariation"), DMETimeSliceType.class, target));
    }
    ...
    public void setMagneticVariationAccuracyItem(ValAngleType target) {
        setMagneticVariationAccuracy(XmlAdapterUtils.marshallJAXBElement(ValAngleType.class,
                new QName("http://www.aixm.aero/schema/5.1", "magneticVariationAccuracy"), DMETimeSliceType.class,
                target));
    }
    ...
    public void setDateMagneticVariationItem(DateYearType target) {
        setDateMagneticVariation(XmlAdapterUtils.marshallJAXBElement(DateYearType.class,
                new QName("http://www.aixm.aero/schema/5.1", "dateMagneticVariation"), DMETimeSliceType.class, target));
    }
    ...
    public void setFlightCheckedItem(CodeYesNoType target) {
        setFlightChecked(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class,
                new QName("http://www.aixm.aero/schema/5.1", "flightChecked"), DMETimeSliceType.class, target));
    }
    ...
    public void setLocationItem(AIXMElevatedPointPropertyType target) {
        setLocation(XmlAdapterUtils.marshallJAXBElement(AIXMElevatedPointPropertyType.class,
                new QName("http://www.aixm.aero/schema/5.1", "location"), DMETimeSliceType.class, target));
    }
    ...
    public void setTypeItem(CodeDMEType target) {
        setType(XmlAdapterUtils.marshallJAXBElement(CodeDMEType.class,
                new QName("http://www.aixm.aero/schema/5.1", "type"), DMETimeSliceType.class, target));
    }
    ...
    public void setChannelItem(CodeDMEChannelType target) {
        setChannel(XmlAdapterUtils.marshallJAXBElement(CodeDMEChannelType.class,
                new QName("http://www.aixm.aero/schema/5.1", "channel"), DMETimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
            @AttributeOverride(name = "value", column = @Column(name = "ghostfrequency", columnDefinition = "NUMERIC")),
            @AttributeOverride(name = "uom", column = @Column(name = "ghostfrequencyuom")),
            @AttributeOverride(name = "nilReason", column = @Column(name = "ghostfrequencynilreason"))})
    ...
    public void setGhostFrequencyItem(ValFrequencyType target) {
        setGhostFrequency(XmlAdapterUtils.marshallJAXBElement(ValFrequencyType.class,
                new QName("http://www.aixm.aero/schema/5.1", "ghostFrequency"), DMETimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
            @AttributeOverride(name = "value", column = @Column(name = "displace", columnDefinition = "NUMERIC")),
            @AttributeOverride(name = "uom", column = @Column(name = "displaceuom")),
            @AttributeOverride(name = "nilReason", column = @Column(name = "displacenilreason"))})
    ...
    public void setDisplaceItem(ValDistanceType target) {
        setDisplace(XmlAdapterUtils.marshallJAXBElement(ValDistanceType.class,
                new QName("http://www.aixm.aero/schema/5.1", "displace"), DMETimeSliceType.class, target));
    }
