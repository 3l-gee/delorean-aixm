...
@XmlType(name = "", propOrder = {"abstractSafeAltitudeAreaSectorExtension"})
@Entity(name = "SafeAltitudeAreaSectorExtensionType")
@Table(name = "safealtitudeareasector_oe", schema = "procedure")
public class SafeAltitudeAreaSectorExtensionType implements Serializable, Equals, HashCode, ToString {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final SafeAltitudeAreaSectorExtensionType that = ((SafeAltitudeAreaSectorExtensionType) object);
        {
            ...
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator,
                    "abstractSafeAltitudeAreaSectorExtension", lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator,
                    "abstractSafeAltitudeAreaSectorExtension", rhsField);
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetAbstractSafeAltitudeAreaSectorExtension();
            AbstractExtensionType theField;
            theField = this.getAbstractSafeAltitudeAreaSectorExtension();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "abstractSafeAltitudeAreaSectorExtension",
                    theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            AbstractExtensionType theField;
            theField = this.getAbstractSafeAltitudeAreaSectorExtension();
            strategy.appendField(locator, this, "abstractSafeAltitudeAreaSectorExtension", buffer, theField,
                    theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetOwns();
