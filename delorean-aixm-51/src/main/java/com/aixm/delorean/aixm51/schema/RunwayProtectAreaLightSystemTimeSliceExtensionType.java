...
@XmlType(name = "", propOrder = {"abstractRunwayProtectAreaLightSystemExtension", "abstractGroundLightSystemExtension"})
@Entity(name = "RunwayProtectAreaLightSystemTimeSliceExtensionType")
@Table(name = "runwayprotectarealightsystem_te", schema = "airport_heliport")
public class RunwayProtectAreaLightSystemTimeSliceExtensionType implements Serializable, Equals, HashCode, ToString {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final RunwayProtectAreaLightSystemTimeSliceExtensionType that = ((RunwayProtectAreaLightSystemTimeSliceExtensionType) object);
        {
            ...
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator,
                    "abstractRunwayProtectAreaLightSystemExtension", lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator,
                    "abstractRunwayProtectAreaLightSystemExtension", rhsField);
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetAbstractRunwayProtectAreaLightSystemExtension();
            AbstractExtensionType theField;
            theField = this.getAbstractRunwayProtectAreaLightSystemExtension();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator,
                    "abstractRunwayProtectAreaLightSystemExtension", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            AbstractExtensionType theField;
            theField = this.getAbstractRunwayProtectAreaLightSystemExtension();
            strategy.appendField(locator, this, "abstractRunwayProtectAreaLightSystemExtension", buffer, theField,
                    theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetAbstractGroundLightSystemExtension();
