...
@XmlType(name = "", propOrder = {"abstractAzimuthExtension", "abstractNavaidEquipmentExtension"})
@Entity(name = "AzimuthTimeSliceExtensionType")
@Table(name = "azimuth_te", schema = "navaids_point")
public class AzimuthTimeSliceExtensionType implements Serializable, Equals, HashCode, ToString {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final AzimuthTimeSliceExtensionType that = ((AzimuthTimeSliceExtensionType) object);
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetAbstractAzimuthExtension();
            AbstractExtensionType theField;
            theField = this.getAbstractAzimuthExtension();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "abstractAzimuthExtension", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            AbstractExtensionType theField;
            theField = this.getAbstractAzimuthExtension();
            strategy.appendField(locator, this, "abstractAzimuthExtension", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetAbstractNavaidEquipmentExtension();
            AbstractExtensionType theField;
