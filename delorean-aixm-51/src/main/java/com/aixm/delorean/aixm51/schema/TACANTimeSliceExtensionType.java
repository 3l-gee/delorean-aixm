...
@XmlType(name = "", propOrder = {"abstractTACANExtension", "abstractNavaidEquipmentExtension"})
@Entity(name = "TACANTimeSliceExtensionType")
@Table(name = "tacan_te", schema = "navaids_point")
public class TACANTimeSliceExtensionType implements Serializable, Equals, HashCode, ToString {
    ...
    /**
     * Gets the value of the abstractTACANExtension property.
     *
    ...
    @JoinColumn(name = "abstracttacanextension_hjid", referencedColumnName = "hjid")
    public AbstractExtensionType getAbstractTACANExtension() {
        return abstractTACANExtension;
    }

    /**
     * Sets the value of the abstractTACANExtension property.
     *
     * @param value
     *            allowed object is {@link AbstractExtensionType }
     *
     */
    public void setAbstractTACANExtension(AbstractExtensionType value) {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetAbstractTACANExtension();
            AbstractExtensionType theField;
            theField = this.getAbstractTACANExtension();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "abstractTACANExtension", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            AbstractExtensionType theField;
            theField = this.getAbstractTACANExtension();
            strategy.appendField(locator, this, "abstractTACANExtension", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetAbstractNavaidEquipmentExtension();
            AbstractExtensionType theField;
