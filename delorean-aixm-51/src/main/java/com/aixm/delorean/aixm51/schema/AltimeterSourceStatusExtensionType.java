...
@Entity(name = "AltimeterSourceStatusExtensionType")
@Table(name = "altimetersourcestatus_oe", schema = "airport_heliport")
public class AltimeterSourceStatusExtensionType implements Serializable, Equals, HashCode, ToString {
