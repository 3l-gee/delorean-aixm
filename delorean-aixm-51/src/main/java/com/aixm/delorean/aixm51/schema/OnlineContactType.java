...
"{http://www.aixm.aero/schema/5.1}CodeTelecomNetworkType" minOccurs="0"/>
 ...
 *                   <element ref=
"{http://www.aixm.aero/schema/5.1}AbstractOnlineContactExtension"/>
 *                 </choice>
 *                 <attGroup ref=
...
public class OnlineContactType extends AbstractPropertiesWithScheduleType implements Serializable {
    ...
    @JoinTable(name = "onlncntcttp_tmintrvl_link", schema = "shared", joinColumns = {
            @JoinColumn(name = "onlinecontacttype_hjid", referencedColumnName = "hjid")}, inverseJoinColumns = {
    ...
    @OneToMany(targetEntity = OnlineContactTypeExtensionType.class, cascade = {
            CascadeType.ALL}, fetch = FetchType.EAGER)
    @JoinColumn(name = "onlinecontacte_hjid", referencedColumnName = "hjid")
    ...
    public void setNetworkItem(CodeTelecomNetworkType target) {
        setNetwork(XmlAdapterUtils.marshallJAXBElement(CodeTelecomNetworkType.class,
                new QName("http://www.aixm.aero/schema/5.1", "network"), OnlineContactType.class, target));
    }
    ...
    public void setLinkageItem(TextAddressType target) {
        setLinkage(XmlAdapterUtils.marshallJAXBElement(TextAddressType.class,
                new QName("http://www.aixm.aero/schema/5.1", "linkage"), OnlineContactType.class, target));
    }
    ...
    public void setProtocolItem(TextNameType target) {
        setProtocol(XmlAdapterUtils.marshallJAXBElement(TextNameType.class,
                new QName("http://www.aixm.aero/schema/5.1", "protocol"), OnlineContactType.class, target));
    }
    ...
    public void setEMailItem(TextAddressType target) {
        setEMail(XmlAdapterUtils.marshallJAXBElement(TextAddressType.class,
                new QName("http://www.aixm.aero/schema/5.1", "eMail"), OnlineContactType.class, target));
    }
