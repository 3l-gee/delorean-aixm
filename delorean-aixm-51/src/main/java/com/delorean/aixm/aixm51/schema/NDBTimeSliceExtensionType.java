...
@XmlType(name = "", propOrder = {"abstractNDBExtension", "abstractNavaidEquipmentExtension"})
@Entity(name = "NDBTimeSliceExtensionType")
@Table(name = "ndb_te", schema = "navaids_point")
public class NDBTimeSliceExtensionType implements Serializable, Equals, HashCode, ToString {
    ...
    @JoinColumn(name = "abstractndbextension_hjid", referencedColumnName = "hjid")
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final NDBTimeSliceExtensionType that = ((NDBTimeSliceExtensionType) object);
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetAbstractNDBExtension();
            AbstractExtensionType theField;
            theField = this.getAbstractNDBExtension();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "abstractNDBExtension", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            AbstractExtensionType theField;
            theField = this.getAbstractNDBExtension();
            strategy.appendField(locator, this, "abstractNDBExtension", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetAbstractNavaidEquipmentExtension();
            AbstractExtensionType theField;
