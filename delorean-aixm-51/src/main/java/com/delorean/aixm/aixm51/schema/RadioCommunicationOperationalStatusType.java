...
/**
 * <p>Java class for RadioCommunicationOperationalStatusType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="RadioCommunicationOperationalStatusType">
 *   <complexContent>
 ...
 *                   <element ref="{http://www.aixm.aero/schema/5.1}AbstractRadioCommunicationOperationalStatusExtension"/>
 *                 </choice>
...
@XmlType(name = "RadioCommunicationOperationalStatusType", propOrder = {
    "timeInterval",
    "annotation",
...
@Entity(name = "RadioCommunicationOperationalStatusType")
@Table(name = "radiocommunicationoperationalstatus_o", schema = "service")
    ...
    implements Serializable
{
    ...
    @JoinTable(name = "rdcmmnctnoprtnlsttstp_tmintrvl_link", schema = "service", joinColumns = {
        @JoinColumn(name = "radiocommunicationoperationalstatus_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "rdcmmnctnoprtnlsttstp_annttn_link", schema = "service", joinColumns = {
        @JoinColumn(name = "radiocommunicationoperationalstatus_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "rdcmmnctnoprtnlsttstp_spcldtathrt_link", schema = "service", joinColumns = {
        @JoinColumn(name = "radiocommunicationoperationalstatus_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setOperationalStatusItem(CodeStatusServiceType target) {
        setOperationalStatus(XmlAdapterUtils.marshallJAXBElement(CodeStatusServiceType.class, new QName("http://www.aixm.aero/schema/5.1", "operationalStatus"), RadioCommunicationOperationalStatusType.class, target));
    }
