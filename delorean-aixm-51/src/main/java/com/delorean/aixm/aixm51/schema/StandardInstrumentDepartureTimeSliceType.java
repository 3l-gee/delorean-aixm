 ...
 *         <element name="contingencyRoute" type="{http://www.aixm.aero/schema/5.1}CodeYesNoType" minOccurs="0"/>
 *         <element name="takeoff" type="{http://www.aixm.aero/schema/5.1}LandingTakeoffAreaCollectionPropertyType" minOccurs="0"/>
    ...
    implements Serializable
{
    ...
    @JoinTable(name = "stndrdinstrmntdprtrtmslctp_avlblt_l", schema = "procedure", joinColumns = {
        @JoinColumn(name = "standardinstrumentdeparture_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "stndrdinstrmntdprtrtmslctp_arprthlprt_l", schema = "procedure", joinColumns = {
        @JoinColumn(name = "standardinstrumentdeparture_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "stndrdinstrmntdprtrtmslctp_arcrftchrctrstc_l", schema = "procedure", joinColumns = {
        @JoinColumn(name = "standardinstrumentdeparture_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "stndrdinstrmntdprtrtmslctp_flghttrnstn_l", schema = "procedure", joinColumns = {
        @JoinColumn(name = "standardinstrumentdeparture_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "stndrdinstrmntdprtrtmslctp_annttn_l", schema = "procedure", joinColumns = {
        @JoinColumn(name = "standardinstrumentdeparture_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setCommunicationFailureInstructionItem(TextInstructionType target) {
        setCommunicationFailureInstruction(XmlAdapterUtils.marshallJAXBElement(TextInstructionType.class, new QName("http://www.aixm.aero/schema/5.1", "communicationFailureInstruction"), StandardInstrumentDepartureTimeSliceType.class, target));
    }
    ...
    public void setInstructionItem(TextInstructionType target) {
        setInstruction(XmlAdapterUtils.marshallJAXBElement(TextInstructionType.class, new QName("http://www.aixm.aero/schema/5.1", "instruction"), StandardInstrumentDepartureTimeSliceType.class, target));
    }
    ...
    public void setDesignCriteriaItem(CodeDesignStandardType target) {
        setDesignCriteria(XmlAdapterUtils.marshallJAXBElement(CodeDesignStandardType.class, new QName("http://www.aixm.aero/schema/5.1", "designCriteria"), StandardInstrumentDepartureTimeSliceType.class, target));
    }
    ...
    public void setCodingStandardItem(CodeProcedureCodingStandardType target) {
        setCodingStandard(XmlAdapterUtils.marshallJAXBElement(CodeProcedureCodingStandardType.class, new QName("http://www.aixm.aero/schema/5.1", "codingStandard"), StandardInstrumentDepartureTimeSliceType.class, target));
    }
    ...
    public void setFlightCheckedItem(CodeYesNoType target) {
        setFlightChecked(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.1", "flightChecked"), StandardInstrumentDepartureTimeSliceType.class, target));
    }
    ...
    public void setAixmNameItem(TextNameType target) {
        setAixmName(XmlAdapterUtils.marshallJAXBElement(TextNameType.class, new QName("http://www.aixm.aero/schema/5.1", "name"), StandardInstrumentDepartureTimeSliceType.class, target));
    }
    ...
    public void setRNAVItem(CodeYesNoType target) {
        setRNAV(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.1", "RNAV"), StandardInstrumentDepartureTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = NavaidPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "stndrdinstrmntdprtrtmslctp_gdncfcltnvd_l", schema = "procedure", joinColumns = {
        @JoinColumn(name = "standardinstrumentdeparture_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setGuidanceFacilityNavaidItem(NavaidPropertyType target) {
        setGuidanceFacilityNavaid(XmlAdapterUtils.marshallJAXBElement(NavaidPropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "guidanceFacility_navaid"), StandardInstrumentDepartureTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = SpecialNavigationSystemPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "stndrdinstrmntdprtrtmslctp_gdncfcltspclnvgtnsstm_l", schema = "procedure", joinColumns = {
        @JoinColumn(name = "standardinstrumentdeparture_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setGuidanceFacilitySpecialNavigationSystemItem(SpecialNavigationSystemPropertyType target) {
        setGuidanceFacilitySpecialNavigationSystem(XmlAdapterUtils.marshallJAXBElement(SpecialNavigationSystemPropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "guidanceFacility_specialNavigationSystem"), StandardInstrumentDepartureTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = RadarSystemPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "stndrdinstrmntdprtrtmslctp_gdncfcltrdr_l", schema = "procedure", joinColumns = {
        @JoinColumn(name = "standardinstrumentdeparture_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setGuidanceFacilityRadarItem(RadarSystemPropertyType target) {
        setGuidanceFacilityRadar(XmlAdapterUtils.marshallJAXBElement(RadarSystemPropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "guidanceFacility_radar"), StandardInstrumentDepartureTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = SafeAltitudeAreaPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "stndrdinstrmntdprtrtmslctp_sfalttd_l", schema = "procedure", joinColumns = {
        @JoinColumn(name = "standardinstrumentdeparture_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setSafeAltitudeItem(SafeAltitudeAreaPropertyType target) {
        setSafeAltitude(XmlAdapterUtils.marshallJAXBElement(SafeAltitudeAreaPropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "safeAltitude"), StandardInstrumentDepartureTimeSliceType.class, target));
    }
    ...
    public void setDesignatorItem(TextSIDSTARDesignatorType target) {
        setDesignator(XmlAdapterUtils.marshallJAXBElement(TextSIDSTARDesignatorType.class, new QName("http://www.aixm.aero/schema/5.1", "designator"), StandardInstrumentDepartureTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "contingencyroute", columnDefinition = "codeyesnobase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "contingencyroutenilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setContingencyRouteItem(CodeYesNoType target) {
        setContingencyRoute(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.1", "contingencyRoute"), StandardInstrumentDepartureTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = LandingTakeoffAreaCollectionPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "stndrdinstrmntdprtrtmslctp_tkff_l", schema = "procedure", joinColumns = {
        @JoinColumn(name = "standardinstrumentdeparture_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setTakeoffItem(LandingTakeoffAreaCollectionPropertyType target) {
        setTakeoff(XmlAdapterUtils.marshallJAXBElement(LandingTakeoffAreaCollectionPropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "takeoff"), StandardInstrumentDepartureTimeSliceType.class, target));
    }
