...
@Entity(name = "AirTrafficManagementServiceTimeSliceExtensionType")
@Table(name = "airtrafficmanagementservice_te", schema = "service")
public class AirTrafficManagementServiceTimeSliceExtensionType implements Serializable, Equals, HashCode, ToString {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final AirTrafficManagementServiceTimeSliceExtensionType that = ((AirTrafficManagementServiceTimeSliceExtensionType) object);
        {
