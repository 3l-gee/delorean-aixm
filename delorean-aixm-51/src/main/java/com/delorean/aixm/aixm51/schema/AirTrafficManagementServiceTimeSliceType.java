 ...
 *         <element name="type" type="{http://www.aixm.aero/schema/5.1}CodeServiceATFMType" minOccurs="0"/>
    ...
    implements Serializable
{
    ...
    public void setFlightOperationsItem(CodeFlightDestinationType target) {
        setFlightOperations(XmlAdapterUtils.marshallJAXBElement(CodeFlightDestinationType.class, new QName("http://www.aixm.aero/schema/5.1", "flightOperations"), AirTrafficManagementServiceTimeSliceType.class, target));
    }
    ...
    public void setRankItem(CodeFacilityRankingType target) {
        setRank(XmlAdapterUtils.marshallJAXBElement(CodeFacilityRankingType.class, new QName("http://www.aixm.aero/schema/5.1", "rank"), AirTrafficManagementServiceTimeSliceType.class, target));
    }
    ...
    public void setCompliantICAOItem(CodeYesNoType target) {
        setCompliantICAO(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.1", "compliantICAO"), AirTrafficManagementServiceTimeSliceType.class, target));
    }
    ...
    public void setAixmNameItem(TextNameType target) {
        setAixmName(XmlAdapterUtils.marshallJAXBElement(TextNameType.class, new QName("http://www.aixm.aero/schema/5.1", "name"), AirTrafficManagementServiceTimeSliceType.class, target));
    }
    ...
    public void setLocationItem(AIXMElevatedPointPropertyType target) {
        setLocation(XmlAdapterUtils.marshallJAXBElement(AIXMElevatedPointPropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "location"), AirTrafficManagementServiceTimeSliceType.class, target));
    }
    ...
    public void setServiceProviderItem(UnitPropertyType target) {
        setServiceProvider(XmlAdapterUtils.marshallJAXBElement(UnitPropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "serviceProvider"), AirTrafficManagementServiceTimeSliceType.class, target));
    }
    ...
    public void setTypeItem(CodeServiceATFMType target) {
        setType(XmlAdapterUtils.marshallJAXBElement(CodeServiceATFMType.class, new QName("http://www.aixm.aero/schema/5.1", "type"), AirTrafficManagementServiceTimeSliceType.class, target));
    }
