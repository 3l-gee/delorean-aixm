 ...
 *       <sequence>
 *         <element name="designator" type="{http://www.aixm.aero/schema/5.1}CodeDesignatedPointDesignatorType" minOccurs="0"/>
 *         <element name="type" type="{http://www.aixm.aero/schema/5.1}CodeDesignatedPointType" minOccurs="0"/>
 *         <element name="name" type="{http://www.aixm.aero/schema/5.1}TextNameType" minOccurs="0"/>
 *         <element name="location" type="{http://www.aixm.aero/schema/5.1}PointPropertyType" minOccurs="0"/>
 *         <element name="aimingPoint" type="{http://www.aixm.aero/schema/5.1}TouchDownLiftOffPropertyType" minOccurs="0"/>
 *         <element name="airportHeliport" type="{http://www.aixm.aero/schema/5.1}AirportHeliportPropertyType" minOccurs="0"/>
 *         <element name="runwayPoint" type="{http://www.aixm.aero/schema/5.1}RunwayCentrelinePointPropertyType" minOccurs="0"/>
    ...
    implements Serializable
{
    ...
    public void setDesignatorItem(CodeDesignatedPointDesignatorType target) {
        setDesignator(XmlAdapterUtils.marshallJAXBElement(CodeDesignatedPointDesignatorType.class, new QName("http://www.aixm.aero/schema/5.1", "designator"), DesignatedPointTimeSliceType.class, target));
    }
    ...
    public void setTypeItem(CodeDesignatedPointType target) {
        setType(XmlAdapterUtils.marshallJAXBElement(CodeDesignatedPointType.class, new QName("http://www.aixm.aero/schema/5.1", "type"), DesignatedPointTimeSliceType.class, target));
    }
    ...
    public void setAixmNameItem(TextNameType target) {
        setAixmName(XmlAdapterUtils.marshallJAXBElement(TextNameType.class, new QName("http://www.aixm.aero/schema/5.1", "name"), DesignatedPointTimeSliceType.class, target));
    }
    ...
    public void setLocationItem(AIXMPointPropertyType target) {
        setLocation(XmlAdapterUtils.marshallJAXBElement(AIXMPointPropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "location"), DesignatedPointTimeSliceType.class, target));
    }
    ...
    public void setAimingPointItem(TouchDownLiftOffPropertyType target) {
        setAimingPoint(XmlAdapterUtils.marshallJAXBElement(TouchDownLiftOffPropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "aimingPoint"), DesignatedPointTimeSliceType.class, target));
    }
    ...
    public void setAirportHeliportItem(AirportHeliportPropertyType target) {
        setAirportHeliport(XmlAdapterUtils.marshallJAXBElement(AirportHeliportPropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "airportHeliport"), DesignatedPointTimeSliceType.class, target));
    }
    ...
    public void setRunwayPointItem(RunwayCentrelinePointPropertyType target) {
        setRunwayPoint(XmlAdapterUtils.marshallJAXBElement(RunwayCentrelinePointPropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "runwayPoint"), DesignatedPointTimeSliceType.class, target));
    }
