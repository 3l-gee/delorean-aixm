...
"{http://www.aixm.aero/schema/5.1}StandardInstrumentArrivalTimeSlicePropertyType" maxOccurs
="unbounded"/>
 *       </sequence>
 *     </extension>
 *   </complexContent>
...
@Table(name = "standardinstrumentarrival_f", schema = "procedure")
public class StandardInstrumentArrivalType extends AbstractProcedureType implements Serializable {
    ...
    @OneToMany(targetEntity = StandardInstrumentArrivalTimeSlicePropertyType.class, cascade = {
