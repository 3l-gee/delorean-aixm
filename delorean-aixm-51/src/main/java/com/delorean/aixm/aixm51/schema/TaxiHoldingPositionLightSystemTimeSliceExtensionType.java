...
@Entity(name = "TaxiHoldingPositionLightSystemTimeSliceExtensionType")
@Table(name = "taxiholdingpositionlightsystem_te", schema = "airport_heliport")
public class TaxiHoldingPositionLightSystemTimeSliceExtensionType implements Serializable, Equals, HashCode, ToString {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final TaxiHoldingPositionLightSystemTimeSliceExtensionType that = ((TaxiHoldingPositionLightSystemTimeSliceExtensionType) object);
        {
