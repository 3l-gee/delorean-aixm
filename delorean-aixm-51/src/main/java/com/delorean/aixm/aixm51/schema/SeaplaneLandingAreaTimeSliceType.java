 ...
 *       <sequence>
 *         <element name="rampSite" type="{http://www.aixm.aero/schema/5.1}SeaplaneRampSitePropertyType" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="dockSite" type="{http://www.aixm.aero/schema/5.1}FloatingDockSitePropertyType" maxOccurs="unbounded" minOccurs="0"/>
    ...
    implements Serializable
{
    ...
    public void setExtentItem(AIXMElevatedSurfacePropertyType target) {
        setExtent(XmlAdapterUtils.marshallJAXBElement(AIXMElevatedSurfacePropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "extent"), SeaplaneLandingAreaTimeSliceType.class, target));
    }
