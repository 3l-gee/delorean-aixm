 ...
 *       <sequence>
 *         <element name="transitionId" type="{http://www.aixm.aero/schema/5.1}CodeDesignatedPointDesignatorType" minOccurs="0"/>
 *         <element name="type" type="{http://www.aixm.aero/schema/5.1}CodeProcedurePhaseType" minOccurs="0"/>
 *         <element name="instruction" type="{http://www.aixm.aero/schema/5.1}TextInstructionType" minOccurs="0"/>
 *         <element name="vectorHeading" type="{http://www.aixm.aero/schema/5.1}ValBearingType" minOccurs="0"/>
 *         <element name="departureRunwayTransition" type="{http://www.aixm.aero/schema/5.1}LandingTakeoffAreaCollectionPropertyType" minOccurs="0"/>
 *         <element name="trajectory" type="{http://www.aixm.aero/schema/5.1}CurvePropertyType" minOccurs="0"/>
 *         <element name="transitionLeg" type="{http://www.aixm.aero/schema/5.1}ProcedureTransitionLegPropertyType" maxOccurs="unbounded" minOccurs="0"/>
    ...
    implements Serializable
{
    ...
    public void setTransitionIdItem(CodeDesignatedPointDesignatorType target) {
        setTransitionId(XmlAdapterUtils.marshallJAXBElement(CodeDesignatedPointDesignatorType.class, new QName("http://www.aixm.aero/schema/5.1", "transitionId"), ProcedureTransitionType.class, target));
    }
    ...
    public void setTypeItem(CodeProcedurePhaseType target) {
        setType(XmlAdapterUtils.marshallJAXBElement(CodeProcedurePhaseType.class, new QName("http://www.aixm.aero/schema/5.1", "type"), ProcedureTransitionType.class, target));
    }
    ...
    public void setInstructionItem(TextInstructionType target) {
        setInstruction(XmlAdapterUtils.marshallJAXBElement(TextInstructionType.class, new QName("http://www.aixm.aero/schema/5.1", "instruction"), ProcedureTransitionType.class, target));
    }
    ...
    public void setVectorHeadingItem(ValBearingType target) {
        setVectorHeading(XmlAdapterUtils.marshallJAXBElement(ValBearingType.class, new QName("http://www.aixm.aero/schema/5.1", "vectorHeading"), ProcedureTransitionType.class, target));
    }
    ...
    public void setDepartureRunwayTransitionItem(LandingTakeoffAreaCollectionPropertyType target) {
        setDepartureRunwayTransition(XmlAdapterUtils.marshallJAXBElement(LandingTakeoffAreaCollectionPropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "departureRunwayTransition"), ProcedureTransitionType.class, target));
    }
    ...
    public void setTrajectoryItem(AIXMCurvePropertyType target) {
        setTrajectory(XmlAdapterUtils.marshallJAXBElement(AIXMCurvePropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "trajectory"), ProcedureTransitionType.class, target));
    }
