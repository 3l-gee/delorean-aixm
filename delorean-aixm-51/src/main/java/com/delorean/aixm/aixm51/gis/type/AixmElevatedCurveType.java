...
import com.delorean.aixm.aixm51.schema.ElevatedCurveType;
import com.delorean.aixm.aixm51.schema.CurveType;
import com.delorean.aixm.aixm51.schema.ElevatedCurveTypeExtension;
...
public class AixmElevatedCurveType extends com.delorean.aixm.core.gis.type.Curve implements java.io.Serializable {
    ...
    public void setVerticalAccuracyItem(ValDistanceType target) {
        setVerticalAccuracy(XmlAdapterUtils.marshallJAXBElement(ValDistanceType.class, new QName("http://www.aixm.aero/schema/5.1.1", "verticalAccuracy"), ElevatedCurveType.class, target));
    }
