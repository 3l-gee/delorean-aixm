 ...
 *       <sequence>
 *         <element name="timeSlice" type="{http://www.aixm.aero/schema/5.1}AirTrafficManagementServiceTimeSlicePropertyType" maxOccurs="unbounded"/>
 *       </sequence>
 *     </extension>
 *   </complexContent>
 * </complexType>
...
@Table(name = "airtrafficmanagementservice_f", schema = "service")
    ...
    implements Serializable
{
    ...
    @OneToMany(targetEntity = AirTrafficManagementServiceTimeSlicePropertyType.class, cascade = {
        CascadeType.ALL
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        final AirTrafficManagementServiceType that = ((AirTrafficManagementServiceType) object);
        {
