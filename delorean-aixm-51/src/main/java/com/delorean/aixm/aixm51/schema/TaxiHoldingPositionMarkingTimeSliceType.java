...
/**
 * <p>
 * Java class for TaxiHoldingPositionMarkingTimeSliceType complex type
 * </p>
 * .
 *
 * <p>
...
"{http://www.aixm.aero/schema/5.1}MarkingElementPropertyType" maxOccurs=
"unbounded" minOccurs="0"/>
 *         <element name="annotation" type=
"{http://www.aixm.aero/schema/5.1}NotePropertyType" maxOccurs=
"unbounded" minOccurs="0"/>
 *         <element name="markedTaxiHold" type=
"{http://www.aixm.aero/schema/5.1}TaxiHoldingPositionPropertyType" minOccurs=
"0"/>
 ...
 *                 <choice>
 *                   <element ref=
"{http://www.aixm.aero/schema/5.1}AbstractTaxiHoldingPositionMarkingExtension"/>
 *                   <element ref=
"{http://www.aixm.aero/schema/5.1}AbstractMarkingExtension"/>
 *                 </choice>
 *                 <attGroup ref=
...
@XmlType(name = "TaxiHoldingPositionMarkingTimeSliceType", propOrder = {"markingICAOStandard", "condition", "element",
        "annotation", "markedTaxiHold", "extension"})
@Entity(name = "TaxiHoldingPositionMarkingTimeSliceType")
@Table(name = "taxiholdingpositionmarking_t", schema = "airport_heliport")
public class TaxiHoldingPositionMarkingTimeSliceType extends AbstractAIXMTimeSliceType implements Serializable {
    ...
    protected List<TaxiHoldingPositionMarkingTimeSliceExtensionType> extension;
    ...
    @JoinTable(name = "txhldngpstnmrkngtmslctp_elmnt_link", schema = "airport_heliport", joinColumns = {
            @JoinColumn(name = "taxiholdingpositionmarking_t_hjid", referencedColumnName = "hjid")}, inverseJoinColumns = {
    ...
    @JoinTable(name = "txhldngpstnmrkngtmslctp_annttn_link", schema = "airport_heliport", joinColumns = {
            @JoinColumn(name = "taxiholdingpositionmarking_t_hjid", referencedColumnName = "hjid")}, inverseJoinColumns = {
     ...
     *
     * @return possible object is {@link JAXBElement
     *         }{@code <}{@link TaxiHoldingPositionPropertyType }{@code >}
     *
     */
    @Transient
     ...
     *
     */
    @OneToMany(targetEntity = TaxiHoldingPositionMarkingTimeSliceExtensionType.class, cascade = {
            CascadeType.ALL}, fetch = FetchType.EAGER)
    @JoinColumn(name = "taxiholdingpositionmarking_te_hjid", referencedColumnName = "hjid")
    public List<TaxiHoldingPositionMarkingTimeSliceExtensionType> getExtension() {
        if (extension == null) {
     ...
     *
     */
    public void setExtension(List<TaxiHoldingPositionMarkingTimeSliceExtensionType> extension) {
    ...
    public void setMarkingICAOStandardItem(CodeYesNoType target) {
        setMarkingICAOStandard(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class,
                new QName("http://www.aixm.aero/schema/5.1", "markingICAOStandard"),
                TaxiHoldingPositionMarkingTimeSliceType.class, target));
    }
    ...
    public void setConditionItem(CodeMarkingConditionType target) {
        setCondition(XmlAdapterUtils.marshallJAXBElement(CodeMarkingConditionType.class,
                new QName("http://www.aixm.aero/schema/5.1", "condition"),
                TaxiHoldingPositionMarkingTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = TaxiHoldingPositionPropertyType.class, cascade = {
            CascadeType.ALL}, fetch = FetchType.EAGER)
    @JoinTable(name = "txhldngpstnmrkngtmslctp_mrkdtxhld_link", schema = "airport_heliport", joinColumns = {
            @JoinColumn(name = "taxiholdingpositionmarking_t_hjid", referencedColumnName = "hjid")}, inverseJoinColumns = {
                    @JoinColumn(name = "markedtaxihold_hjid", referencedColumnName = "hjid")})
    public TaxiHoldingPositionPropertyType getMarkedTaxiHoldItem() {
        return XmlAdapterUtils.unmarshallSource(TaxiHoldingPositionPropertyType.class, this.getMarkedTaxiHold());
    }

    public void setMarkedTaxiHoldItem(TaxiHoldingPositionPropertyType target) {
        setMarkedTaxiHold(XmlAdapterUtils.marshallJAXBElement(TaxiHoldingPositionPropertyType.class,
                new QName("http://www.aixm.aero/schema/5.1", "markedTaxiHold"),
                TaxiHoldingPositionMarkingTimeSliceType.class, target));
    }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final TaxiHoldingPositionMarkingTimeSliceType that = ((TaxiHoldingPositionMarkingTimeSliceType) object);
        {
        ...
        }
        {
            ...
            List<TaxiHoldingPositionMarkingTimeSliceExtensionType> lhsField;
            lhsField = (this.isSetExtension() ? this.getExtension() : null);
            List<TaxiHoldingPositionMarkingTimeSliceExtensionType> rhsField;
        ...
        {
            boolean lhsFieldIsSet = this.isSetMarkedTaxiHold();
            boolean rhsFieldIsSet = that.isSetMarkedTaxiHold();
            JAXBElement<TaxiHoldingPositionPropertyType> lhsField;
            lhsField = this.getMarkedTaxiHold();
            JAXBElement<TaxiHoldingPositionPropertyType> rhsField;
            rhsField = that.getMarkedTaxiHold();
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "markedTaxiHold", lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "markedTaxiHold", rhsField);
            if (!strategy.equals(lhsFieldLocator, rhsFieldLocator, lhsField, rhsField, lhsFieldIsSet, rhsFieldIsSet)) {
                return false;
            }
        }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetMarkedTaxiHold();
            JAXBElement<TaxiHoldingPositionPropertyType> theField;
            theField = this.getMarkedTaxiHold();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "markedTaxiHold", theField);
            currentHashCode = strategy.hashCode(theFieldLocator, currentHashCode, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetExtension();
            List<TaxiHoldingPositionMarkingTimeSliceExtensionType> theField;
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        }
        {
            ...
            JAXBElement<TaxiHoldingPositionPropertyType> theField;
            theField = this.getMarkedTaxiHold();
            strategy.appendField(locator, this, "markedTaxiHold", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetExtension();
            List<TaxiHoldingPositionMarkingTimeSliceExtensionType> theField;
