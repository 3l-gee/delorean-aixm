 ...
 *       <sequence>
 *         <element name="timeReference" type="{http://www.aixm.aero/schema/5.1}CodeTimeReferenceType" minOccurs="0"/>
 *         <element name="startDate" type="{http://www.aixm.aero/schema/5.1}DateMonthDayType" minOccurs="0"/>
 *         <element name="endDate" type="{http://www.aixm.aero/schema/5.1}DateMonthDayType" minOccurs="0"/>
 *         <element name="day" type="{http://www.aixm.aero/schema/5.1}CodeDayType" minOccurs="0"/>
 *         <element name="dayTil" type="{http://www.aixm.aero/schema/5.1}CodeDayType" minOccurs="0"/>
 *         <element name="startTime" type="{http://www.aixm.aero/schema/5.1}TimeType" minOccurs="0"/>
 *         <element name="startEvent" type="{http://www.aixm.aero/schema/5.1}CodeTimeEventType" minOccurs="0"/>
 *         <element name="startTimeRelativeEvent" type="{http://www.aixm.aero/schema/5.1}ValDurationType" minOccurs="0"/>
 *         <element name="startEventInterpretation" type="{http://www.aixm.aero/schema/5.1}CodeTimeEventCombinationType" minOccurs="0"/>
 *         <element name="endTime" type="{http://www.aixm.aero/schema/5.1}TimeType" minOccurs="0"/>
 *         <element name="endEvent" type="{http://www.aixm.aero/schema/5.1}CodeTimeEventType" minOccurs="0"/>
 *         <element name="endTimeRelativeEvent" type="{http://www.aixm.aero/schema/5.1}ValDurationType" minOccurs="0"/>
 *         <element name="endEventInterpretation" type="{http://www.aixm.aero/schema/5.1}CodeTimeEventCombinationType" minOccurs="0"/>
 *         <element name="daylightSavingAdjust" type="{http://www.aixm.aero/schema/5.1}CodeYesNoType" minOccurs="0"/>
 *         <element name="excluded" type="{http://www.aixm.aero/schema/5.1}CodeYesNoType" minOccurs="0"/>
    ...
    implements Serializable
{
    ...
    public void setTimeReferenceItem(CodeTimeReferenceType target) {
        setTimeReference(XmlAdapterUtils.marshallJAXBElement(CodeTimeReferenceType.class, new QName("http://www.aixm.aero/schema/5.1", "timeReference"), TimesheetType.class, target));
    }
    ...
    public void setStartDateItem(DateMonthDayType target) {
        setStartDate(XmlAdapterUtils.marshallJAXBElement(DateMonthDayType.class, new QName("http://www.aixm.aero/schema/5.1", "startDate"), TimesheetType.class, target));
    }
    ...
    public void setEndDateItem(DateMonthDayType target) {
        setEndDate(XmlAdapterUtils.marshallJAXBElement(DateMonthDayType.class, new QName("http://www.aixm.aero/schema/5.1", "endDate"), TimesheetType.class, target));
    }
    ...
    public void setDayItem(CodeDayType target) {
        setDay(XmlAdapterUtils.marshallJAXBElement(CodeDayType.class, new QName("http://www.aixm.aero/schema/5.1", "day"), TimesheetType.class, target));
    }
    ...
    public void setDayTilItem(CodeDayType target) {
        setDayTil(XmlAdapterUtils.marshallJAXBElement(CodeDayType.class, new QName("http://www.aixm.aero/schema/5.1", "dayTil"), TimesheetType.class, target));
    }
    ...
    public void setStartTimeItem(TimeType target) {
        setStartTime(XmlAdapterUtils.marshallJAXBElement(TimeType.class, new QName("http://www.aixm.aero/schema/5.1", "startTime"), TimesheetType.class, target));
    }
    ...
    public void setStartEventItem(CodeTimeEventType target) {
        setStartEvent(XmlAdapterUtils.marshallJAXBElement(CodeTimeEventType.class, new QName("http://www.aixm.aero/schema/5.1", "startEvent"), TimesheetType.class, target));
    }
    ...
    public void setStartTimeRelativeEventItem(ValDurationType target) {
        setStartTimeRelativeEvent(XmlAdapterUtils.marshallJAXBElement(ValDurationType.class, new QName("http://www.aixm.aero/schema/5.1", "startTimeRelativeEvent"), TimesheetType.class, target));
    }
    ...
    public void setStartEventInterpretationItem(CodeTimeEventCombinationType target) {
        setStartEventInterpretation(XmlAdapterUtils.marshallJAXBElement(CodeTimeEventCombinationType.class, new QName("http://www.aixm.aero/schema/5.1", "startEventInterpretation"), TimesheetType.class, target));
    }
    ...
    public void setEndTimeItem(TimeType target) {
        setEndTime(XmlAdapterUtils.marshallJAXBElement(TimeType.class, new QName("http://www.aixm.aero/schema/5.1", "endTime"), TimesheetType.class, target));
    }
    ...
    public void setEndEventItem(CodeTimeEventType target) {
        setEndEvent(XmlAdapterUtils.marshallJAXBElement(CodeTimeEventType.class, new QName("http://www.aixm.aero/schema/5.1", "endEvent"), TimesheetType.class, target));
    }
    ...
    public void setEndTimeRelativeEventItem(ValDurationType target) {
        setEndTimeRelativeEvent(XmlAdapterUtils.marshallJAXBElement(ValDurationType.class, new QName("http://www.aixm.aero/schema/5.1", "endTimeRelativeEvent"), TimesheetType.class, target));
    }
    ...
    public void setEndEventInterpretationItem(CodeTimeEventCombinationType target) {
        setEndEventInterpretation(XmlAdapterUtils.marshallJAXBElement(CodeTimeEventCombinationType.class, new QName("http://www.aixm.aero/schema/5.1", "endEventInterpretation"), TimesheetType.class, target));
    }
    ...
    public void setDaylightSavingAdjustItem(CodeYesNoType target) {
        setDaylightSavingAdjust(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.1", "daylightSavingAdjust"), TimesheetType.class, target));
    }
    ...
    public void setExcludedItem(CodeYesNoType target) {
        setExcluded(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.1", "excluded"), TimesheetType.class, target));
    }
