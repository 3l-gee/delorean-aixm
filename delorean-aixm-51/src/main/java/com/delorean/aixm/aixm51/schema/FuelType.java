 ...
 *       <sequence>
 *         <element name="category" type="{http://www.aixm.aero/schema/5.1}CodeFuelType" minOccurs="0"/>
    ...
    implements Serializable
{
    ...
    public void setCategoryItem(CodeFuelType target) {
        setCategory(XmlAdapterUtils.marshallJAXBElement(CodeFuelType.class, new QName("http://www.aixm.aero/schema/5.1", "category"), FuelType.class, target));
    }
