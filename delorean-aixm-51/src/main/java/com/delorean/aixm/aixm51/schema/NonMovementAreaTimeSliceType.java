 ...
 *                 <sequence>
 *                   <element ref="{http://www.aixm.aero/schema/5.1}AbstractNonMovementAreaExtension"/>
 *                 </sequence>
...
@Entity(name = "NonMovementAreaTimeSliceType")
@Table(name = "nonmovementarea_t", schema = "airport_heliport")
    ...
    implements Serializable
{
    ...
    protected List<NonMovementAreaTimeSliceExtensionType> extension;
    ...
    @JoinTable(name = "nnmvmntartmslctp_annttn_link", schema = "airport_heliport", joinColumns = {
        @JoinColumn(name = "nonmovementarea_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link NonMovementAreaTimeSliceExtensionType }
     * 
     * 
     */
    @OneToMany(targetEntity = NonMovementAreaTimeSliceExtensionType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinColumn(name = "nonmovementarea_te_hjid", referencedColumnName = "hjid")
    public List<NonMovementAreaTimeSliceExtensionType> getExtension() {
        if (extension == null) {
     ...
     * 
     */
    public void setExtension(List<NonMovementAreaTimeSliceExtensionType> extension) {
    ...
    @JoinTable(name = "nnmvmntartmslctp_assctdarprthlprt_link", schema = "airport_heliport", joinColumns = {
        @JoinColumn(name = "nonmovementarea_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setAssociatedAirportHeliportItem(AirportHeliportPropertyType target) {
        setAssociatedAirportHeliport(XmlAdapterUtils.marshallJAXBElement(AirportHeliportPropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "associatedAirportHeliport"), NonMovementAreaTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = AIXMElevatedSurfacePropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "nnmvmntartmslctp_extnt_link", schema = "airport_heliport", joinColumns = {
        @JoinColumn(name = "nonmovementarea_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setExtentItem(AIXMElevatedSurfacePropertyType target) {
        setExtent(XmlAdapterUtils.marshallJAXBElement(AIXMElevatedSurfacePropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "extent"), NonMovementAreaTimeSliceType.class, target));
    }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        final NonMovementAreaTimeSliceType that = ((NonMovementAreaTimeSliceType) object);
        {
        ...
        }
        {
            ...
            List<NonMovementAreaTimeSliceExtensionType> lhsField;
            lhsField = (this.isSetExtension()?this.getExtension():null);
            List<NonMovementAreaTimeSliceExtensionType> rhsField;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        }
        {
            ...
            List<NonMovementAreaTimeSliceExtensionType> theField;
