 ...
 *       <sequence>
 *         <element name="arrivalAreaType" type="{http://www.aixm.aero/schema/5.1}CodeTAAType" minOccurs="0"/>
 *         <element name="outerBufferWidth" type="{http://www.aixm.aero/schema/5.1}ValDistanceType" minOccurs="0"/>
 *         <element name="lateralBufferWidth" type="{http://www.aixm.aero/schema/5.1}ValDistanceType" minOccurs="0"/>
 *         <choice>
 *           <element name="IF_fixDesignatedPoint" type="{http://www.aixm.aero/schema/5.1}DesignatedPointPropertyType" minOccurs="0"/>
 *           <element name="IF_navaidSystem" type="{http://www.aixm.aero/schema/5.1}NavaidPropertyType" minOccurs="0"/>
 *           <element name="IF_aimingPoint" type="{http://www.aixm.aero/schema/5.1}TouchDownLiftOffPropertyType" minOccurs="0"/>
 *           <element name="IF_runwayPoint" type="{http://www.aixm.aero/schema/5.1}RunwayCentrelinePointPropertyType" minOccurs="0"/>
 *           <element name="IF_airportReferencePoint" type="{http://www.aixm.aero/schema/5.1}AirportHeliportPropertyType" minOccurs="0"/>
 *           <element name="IF_position" type="{http://www.aixm.aero/schema/5.1}PointPropertyType" minOccurs="0"/>
 *         </choice>
 *         <choice>
 *           <element name="IAF_fixDesignatedPoint" type="{http://www.aixm.aero/schema/5.1}DesignatedPointPropertyType" minOccurs="0"/>
 *           <element name="IAF_navaidSystem" type="{http://www.aixm.aero/schema/5.1}NavaidPropertyType" minOccurs="0"/>
 *           <element name="IAF_aimingPoint" type="{http://www.aixm.aero/schema/5.1}TouchDownLiftOffPropertyType" minOccurs="0"/>
 *           <element name="IAF_runwayPoint" type="{http://www.aixm.aero/schema/5.1}RunwayCentrelinePointPropertyType" minOccurs="0"/>
 *           <element name="IAF_airportReferencePoint" type="{http://www.aixm.aero/schema/5.1}AirportHeliportPropertyType" minOccurs="0"/>
 *           <element name="IAF_position" type="{http://www.aixm.aero/schema/5.1}PointPropertyType" minOccurs="0"/>
 *         </choice>
 *         <element name="buffer" type="{http://www.aixm.aero/schema/5.1}SurfacePropertyType" minOccurs="0"/>
 *         <element name="sector" type="{http://www.aixm.aero/schema/5.1}TerminalArrivalAreaSectorPropertyType" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="approachRNAV" type="{http://www.aixm.aero/schema/5.1}InstrumentApproachProcedurePropertyType" minOccurs="0"/>
    ...
    implements Serializable
{
    ...
    protected List<TerminalArrivalAreaTimeSliceExtensionType> extension;
    ...
    public void setArrivalAreaTypeItem(CodeTAAType target) {
        setArrivalAreaType(XmlAdapterUtils.marshallJAXBElement(CodeTAAType.class, new QName("http://www.aixm.aero/schema/5.1", "arrivalAreaType"), TerminalArrivalAreaTimeSliceType.class, target));
    }
    ...
    public void setOuterBufferWidthItem(ValDistanceType target) {
        setOuterBufferWidth(XmlAdapterUtils.marshallJAXBElement(ValDistanceType.class, new QName("http://www.aixm.aero/schema/5.1", "outerBufferWidth"), TerminalArrivalAreaTimeSliceType.class, target));
    }
    ...
    public void setLateralBufferWidthItem(ValDistanceType target) {
        setLateralBufferWidth(XmlAdapterUtils.marshallJAXBElement(ValDistanceType.class, new QName("http://www.aixm.aero/schema/5.1", "lateralBufferWidth"), TerminalArrivalAreaTimeSliceType.class, target));
    }
    ...
    public void setIFFixDesignatedPointItem(DesignatedPointPropertyType target) {
        setIFFixDesignatedPoint(XmlAdapterUtils.marshallJAXBElement(DesignatedPointPropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "IF_fixDesignatedPoint"), TerminalArrivalAreaTimeSliceType.class, target));
    }
    ...
    public void setIFNavaidSystemItem(NavaidPropertyType target) {
        setIFNavaidSystem(XmlAdapterUtils.marshallJAXBElement(NavaidPropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "IF_navaidSystem"), TerminalArrivalAreaTimeSliceType.class, target));
    }
    ...
    public void setIFAimingPointItem(TouchDownLiftOffPropertyType target) {
        setIFAimingPoint(XmlAdapterUtils.marshallJAXBElement(TouchDownLiftOffPropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "IF_aimingPoint"), TerminalArrivalAreaTimeSliceType.class, target));
    }
    ...
    public void setIFRunwayPointItem(RunwayCentrelinePointPropertyType target) {
        setIFRunwayPoint(XmlAdapterUtils.marshallJAXBElement(RunwayCentrelinePointPropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "IF_runwayPoint"), TerminalArrivalAreaTimeSliceType.class, target));
    }
    ...
    public void setIFAirportReferencePointItem(AirportHeliportPropertyType target) {
        setIFAirportReferencePoint(XmlAdapterUtils.marshallJAXBElement(AirportHeliportPropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "IF_airportReferencePoint"), TerminalArrivalAreaTimeSliceType.class, target));
    }
    ...
    public void setIFPositionItem(AIXMPointPropertyType target) {
        setIFPosition(XmlAdapterUtils.marshallJAXBElement(AIXMPointPropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "IF_position"), TerminalArrivalAreaTimeSliceType.class, target));
    }
    ...
    public void setIAFFixDesignatedPointItem(DesignatedPointPropertyType target) {
        setIAFFixDesignatedPoint(XmlAdapterUtils.marshallJAXBElement(DesignatedPointPropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "IAF_fixDesignatedPoint"), TerminalArrivalAreaTimeSliceType.class, target));
    }
    ...
    public void setIAFNavaidSystemItem(NavaidPropertyType target) {
        setIAFNavaidSystem(XmlAdapterUtils.marshallJAXBElement(NavaidPropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "IAF_navaidSystem"), TerminalArrivalAreaTimeSliceType.class, target));
    }
    ...
    public void setIAFAimingPointItem(TouchDownLiftOffPropertyType target) {
        setIAFAimingPoint(XmlAdapterUtils.marshallJAXBElement(TouchDownLiftOffPropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "IAF_aimingPoint"), TerminalArrivalAreaTimeSliceType.class, target));
    }
    ...
    public void setIAFRunwayPointItem(RunwayCentrelinePointPropertyType target) {
        setIAFRunwayPoint(XmlAdapterUtils.marshallJAXBElement(RunwayCentrelinePointPropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "IAF_runwayPoint"), TerminalArrivalAreaTimeSliceType.class, target));
    }
    ...
    public void setIAFAirportReferencePointItem(AirportHeliportPropertyType target) {
        setIAFAirportReferencePoint(XmlAdapterUtils.marshallJAXBElement(AirportHeliportPropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "IAF_airportReferencePoint"), TerminalArrivalAreaTimeSliceType.class, target));
    }
    ...
    public void setIAFPositionItem(AIXMPointPropertyType target) {
        setIAFPosition(XmlAdapterUtils.marshallJAXBElement(AIXMPointPropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "IAF_position"), TerminalArrivalAreaTimeSliceType.class, target));
    }
    ...
    public void setBufferItem(AIXMSurfacePropertyType target) {
        setBuffer(XmlAdapterUtils.marshallJAXBElement(AIXMSurfacePropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "buffer"), TerminalArrivalAreaTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = InstrumentApproachProcedurePropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "trmnlarrvlartmslctp_apprchrnav_link", schema = "procedure", joinColumns = {
        @JoinColumn(name = "terminalarrivalarea_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
        @JoinColumn(name = "approachrnav_hjid", referencedColumnName = "hjid")
    })
    ...
    public void setApproachRNAVItem(InstrumentApproachProcedurePropertyType target) {
        setApproachRNAV(XmlAdapterUtils.marshallJAXBElement(InstrumentApproachProcedurePropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "approachRNAV"), TerminalArrivalAreaTimeSliceType.class, target));
    }
