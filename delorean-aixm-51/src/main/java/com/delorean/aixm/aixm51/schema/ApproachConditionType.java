 ...
 *       <sequence>
 *         <element name="finalApproachPath" type="{http://www.aixm.aero/schema/5.1}CodeMinimaFinalApproachPathType" minOccurs="0"/>
 *         <element name="requiredNavigationPerformance" type="{http://www.aixm.aero/schema/5.1}CodeRNPType" minOccurs="0"/>
 *         <element name="climbGradient" type="{http://www.aixm.aero/schema/5.1}ValSlopeType" minOccurs="0"/>
 *         <element name="minimumSet" type="{http://www.aixm.aero/schema/5.1}MinimaPropertyType" minOccurs="0"/>
 *         <element name="circlingRestriction" type="{http://www.aixm.aero/schema/5.1}CirclingRestrictionPropertyType" maxOccurs="unbounded" minOccurs="0"/>
 ...
 *         <element name="landingArea" type="{http://www.aixm.aero/schema/5.1}LandingTakeoffAreaCollectionPropertyType" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="altimeter" type="{http://www.aixm.aero/schema/5.1}AltimeterSourcePropertyType" minOccurs="0"/>
    ...
    implements Serializable
{
    ...
    @JoinTable(name = "apprchcndtntp_crclngrstrctn_l", schema = "procedure", joinColumns = {
    ...
    @JoinTable(name = "apprchcndtntp_arcrftctgr_l", schema = "procedure", joinColumns = {
        @JoinColumn(name = "approachcondition_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "apprchcndtntp_lndngar_l", schema = "procedure", joinColumns = {
        @JoinColumn(name = "approachcondition_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "apprchcndtntp_dsgnsrfc_l", schema = "procedure", joinColumns = {
        @JoinColumn(name = "approachcondition_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "apprchcndtntp_annttn_l", schema = "procedure", joinColumns = {
        @JoinColumn(name = "approachcondition_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setFinalApproachPathItem(CodeMinimaFinalApproachPathType target) {
        setFinalApproachPath(XmlAdapterUtils.marshallJAXBElement(CodeMinimaFinalApproachPathType.class, new QName("http://www.aixm.aero/schema/5.1", "finalApproachPath"), ApproachConditionType.class, target));
    }
    ...
    public void setRequiredNavigationPerformanceItem(CodeRNPType target) {
        setRequiredNavigationPerformance(XmlAdapterUtils.marshallJAXBElement(CodeRNPType.class, new QName("http://www.aixm.aero/schema/5.1", "requiredNavigationPerformance"), ApproachConditionType.class, target));
    }
    ...
    public void setClimbGradientItem(ValSlopeType target) {
        setClimbGradient(XmlAdapterUtils.marshallJAXBElement(ValSlopeType.class, new QName("http://www.aixm.aero/schema/5.1", "climbGradient"), ApproachConditionType.class, target));
    }

    @OneToOne(targetEntity = MinimaPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "apprchcndtntp_mnmmst_l", schema = "procedure", joinColumns = {
        @JoinColumn(name = "approachcondition_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setMinimumSetItem(MinimaPropertyType target) {
        setMinimumSet(XmlAdapterUtils.marshallJAXBElement(MinimaPropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "minimumSet"), ApproachConditionType.class, target));
    }

    @OneToOne(targetEntity = AltimeterSourcePropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "apprchcndtntp_altmtr_l", schema = "procedure", joinColumns = {
        @JoinColumn(name = "approachcondition_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setAltimeterItem(AltimeterSourcePropertyType target) {
        setAltimeter(XmlAdapterUtils.marshallJAXBElement(AltimeterSourcePropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "altimeter"), ApproachConditionType.class, target));
    }
