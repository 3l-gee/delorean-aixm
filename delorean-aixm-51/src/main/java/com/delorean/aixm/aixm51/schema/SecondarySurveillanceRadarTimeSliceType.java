 ...
 *         <element name="serialNumber" type="{http://www.aixm.aero/schema/5.1}TextDesignatorType" minOccurs="0"/>
 *         <element name="range" type="{http://www.aixm.aero/schema/5.1}ValDistanceType" minOccurs="0"/>
 *         <element name="rangeAccuracy" type="{http://www.aixm.aero/schema/5.1}ValDistanceType" minOccurs="0"/>
 *         <element name="dualChannel" type="{http://www.aixm.aero/schema/5.1}CodeYesNoType" minOccurs="0"/>
 *         <element name="movingTargetIndicator" type="{http://www.aixm.aero/schema/5.1}CodeYesNoType" minOccurs="0"/>
 *         <element name="standbyPower" type="{http://www.aixm.aero/schema/5.1}CodeStandbyPowerType" minOccurs="0"/>
 *         <element name="digital" type="{http://www.aixm.aero/schema/5.1}CodeYesNoType" minOccurs="0"/>
 *         <element name="militaryUseOnly" type="{http://www.aixm.aero/schema/5.1}CodeYesNoType" minOccurs="0"/>
 *         <element name="specialUseOnly" type="{http://www.aixm.aero/schema/5.1}CodeYesNoType" minOccurs="0"/>
 *         <element name="specialAircraftOnly" type="{http://www.aixm.aero/schema/5.1}CodeYesNoType" minOccurs="0"/>
 *         <element name="magneticVariation" type="{http://www.aixm.aero/schema/5.1}ValMagneticVariationType" minOccurs="0"/>
 *         <element name="magneticVariationAccuracy" type="{http://www.aixm.aero/schema/5.1}ValAngleType" minOccurs="0"/>
 *         <element name="dateMagneticVariation" type="{http://www.aixm.aero/schema/5.1}DateYearType" minOccurs="0"/>
 *         <element name="contact" type="{http://www.aixm.aero/schema/5.1}ContactInformationPropertyType" maxOccurs="unbounded" minOccurs="0"/>
 ...
 *         <element name="verticalCoverageAltitude" type="{http://www.aixm.aero/schema/5.1}ValDistanceVerticalType" minOccurs="0"/>
 *         <element name="verticalCoverageDistance" type="{http://www.aixm.aero/schema/5.1}ValDistanceType" minOccurs="0"/>
 *         <element name="verticalCoverageAzimuth" type="{http://www.aixm.aero/schema/5.1}ValBearingType" minOccurs="0"/>
 *         <element name="antennaTiltFixed" type="{http://www.aixm.aero/schema/5.1}CodeYesNoType" minOccurs="0"/>
 *         <element name="tiltAngle" type="{http://www.aixm.aero/schema/5.1}ValAngleType" minOccurs="0"/>
 *         <element name="automatedRadarTerminalSystem" type="{http://www.aixm.aero/schema/5.1}TextDesignatorType" minOccurs="0"/>
 *         <element name="groundStation" type="{http://www.aixm.aero/schema/5.1}SurveillanceGroundStationPropertyType" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="transponder" type="{http://www.aixm.aero/schema/5.1}CodeTransponderType" minOccurs="0"/>
 *         <element name="autonomous" type="{http://www.aixm.aero/schema/5.1}CodeYesNoType" minOccurs="0"/>
 *         <element name="monopulse" type="{http://www.aixm.aero/schema/5.1}CodeYesNoType" minOccurs="0"/>
...
@Table(name = "secondarysurveillanceradar_t", schema = "surveillance")
    ...
    implements Serializable
{
    ...
    protected List<SecondarySurveillanceRadarTimeSliceExtensionType> extension;
    ...
    @JoinTable(name = "scndrsrvllncrdrtmslctp_cntct_link", schema = "surveillance", joinColumns = {
        @JoinColumn(name = "secondarysurveillanceradar_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "scndrsrvllncrdrtmslctp_annttn_link", schema = "surveillance", joinColumns = {
        @JoinColumn(name = "secondarysurveillanceradar_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "scndrsrvllncrdrtmslctp_grndsttn_link", schema = "surveillance", joinColumns = {
        @JoinColumn(name = "secondarysurveillanceradar_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
     ...
     * 
     */
    @OneToMany(targetEntity = SecondarySurveillanceRadarTimeSliceExtensionType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinColumn(name = "secondarysurveillanceradar_te_hjid", referencedColumnName = "hjid")
    public List<SecondarySurveillanceRadarTimeSliceExtensionType> getExtension() {
        if (extension == null) {
     ...
     * 
     */
    public void setExtension(List<SecondarySurveillanceRadarTimeSliceExtensionType> extension) {
    ...
    public void setAixmNameItem(TextNameType target) {
        setAixmName(XmlAdapterUtils.marshallJAXBElement(TextNameType.class, new QName("http://www.aixm.aero/schema/5.1", "name"), SecondarySurveillanceRadarTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "serialnumber", columnDefinition = "character3")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "serialnumbernilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setSerialNumberItem(TextDesignatorType target) {
        setSerialNumber(XmlAdapterUtils.marshallJAXBElement(TextDesignatorType.class, new QName("http://www.aixm.aero/schema/5.1", "serialNumber"), SecondarySurveillanceRadarTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "range", columnDefinition = "valdistancebase")),
        @AttributeOverride(name = "uom", column = @Column(name = "rangeuom", columnDefinition = "uomdistance")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "rangenilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setRangeItem(ValDistanceType target) {
        setRange(XmlAdapterUtils.marshallJAXBElement(ValDistanceType.class, new QName("http://www.aixm.aero/schema/5.1", "range"), SecondarySurveillanceRadarTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "rangeaccuracy", columnDefinition = "valdistancebase")),
        @AttributeOverride(name = "uom", column = @Column(name = "rangeaccuracyuom", columnDefinition = "uomdistance")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "rangeaccuracynilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setRangeAccuracyItem(ValDistanceType target) {
        setRangeAccuracy(XmlAdapterUtils.marshallJAXBElement(ValDistanceType.class, new QName("http://www.aixm.aero/schema/5.1", "rangeAccuracy"), SecondarySurveillanceRadarTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "dualchannel", columnDefinition = "codeyesnobase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "dualchannelnilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setDualChannelItem(CodeYesNoType target) {
        setDualChannel(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.1", "dualChannel"), SecondarySurveillanceRadarTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "movingtargetindicator", columnDefinition = "codeyesnobase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "movingtargetindicatornilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setMovingTargetIndicatorItem(CodeYesNoType target) {
        setMovingTargetIndicator(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.1", "movingTargetIndicator"), SecondarySurveillanceRadarTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "standbypower", columnDefinition = "codestandbypowerbase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "standbypowernilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setStandbyPowerItem(CodeStandbyPowerType target) {
        setStandbyPower(XmlAdapterUtils.marshallJAXBElement(CodeStandbyPowerType.class, new QName("http://www.aixm.aero/schema/5.1", "standbyPower"), SecondarySurveillanceRadarTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "digital", columnDefinition = "codeyesnobase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "digitalnilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setDigitalItem(CodeYesNoType target) {
        setDigital(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.1", "digital"), SecondarySurveillanceRadarTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "militaryuseonly", columnDefinition = "codeyesnobase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "militaryuseonlynilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setMilitaryUseOnlyItem(CodeYesNoType target) {
        setMilitaryUseOnly(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.1", "militaryUseOnly"), SecondarySurveillanceRadarTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "specialuseonly", columnDefinition = "codeyesnobase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "specialuseonlynilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setSpecialUseOnlyItem(CodeYesNoType target) {
        setSpecialUseOnly(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.1", "specialUseOnly"), SecondarySurveillanceRadarTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "specialaircraftonly", columnDefinition = "codeyesnobase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "specialaircraftonlynilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setSpecialAircraftOnlyItem(CodeYesNoType target) {
        setSpecialAircraftOnly(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.1", "specialAircraftOnly"), SecondarySurveillanceRadarTimeSliceType.class, target));
    }
    ...
    public void setMagneticVariationItem(ValMagneticVariationType target) {
        setMagneticVariation(XmlAdapterUtils.marshallJAXBElement(ValMagneticVariationType.class, new QName("http://www.aixm.aero/schema/5.1", "magneticVariation"), SecondarySurveillanceRadarTimeSliceType.class, target));
    }
    ...
    public void setMagneticVariationAccuracyItem(ValAngleType target) {
        setMagneticVariationAccuracy(XmlAdapterUtils.marshallJAXBElement(ValAngleType.class, new QName("http://www.aixm.aero/schema/5.1", "magneticVariationAccuracy"), SecondarySurveillanceRadarTimeSliceType.class, target));
    }
    ...
    public void setDateMagneticVariationItem(DateYearType target) {
        setDateMagneticVariation(XmlAdapterUtils.marshallJAXBElement(DateYearType.class, new QName("http://www.aixm.aero/schema/5.1", "dateMagneticVariation"), SecondarySurveillanceRadarTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = AIXMElevatedPointPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "scndrsrvllncrdrtmslctp_lctn_link", schema = "surveillance", joinColumns = {
        @JoinColumn(name = "secondarysurveillanceradar_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setLocationItem(AIXMElevatedPointPropertyType target) {
        setLocation(XmlAdapterUtils.marshallJAXBElement(AIXMElevatedPointPropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "location"), SecondarySurveillanceRadarTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "verticalcoveragealtitude", columnDefinition = "valdistanceverticalbase")),
        @AttributeOverride(name = "uom", column = @Column(name = "verticalcoveragealtitudeuom", columnDefinition = "uomdistancevertical")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "verticalcoveragealtitudenilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setVerticalCoverageAltitudeItem(ValDistanceVerticalType target) {
        setVerticalCoverageAltitude(XmlAdapterUtils.marshallJAXBElement(ValDistanceVerticalType.class, new QName("http://www.aixm.aero/schema/5.1", "verticalCoverageAltitude"), SecondarySurveillanceRadarTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "verticalcoveragedistance", columnDefinition = "valdistancebase")),
        @AttributeOverride(name = "uom", column = @Column(name = "verticalcoveragedistanceuom", columnDefinition = "uomdistance")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "verticalcoveragedistancenilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setVerticalCoverageDistanceItem(ValDistanceType target) {
        setVerticalCoverageDistance(XmlAdapterUtils.marshallJAXBElement(ValDistanceType.class, new QName("http://www.aixm.aero/schema/5.1", "verticalCoverageDistance"), SecondarySurveillanceRadarTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "verticalcoverageazimuth", columnDefinition = "valbearingbase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "verticalcoverageazimuthnilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setVerticalCoverageAzimuthItem(ValBearingType target) {
        setVerticalCoverageAzimuth(XmlAdapterUtils.marshallJAXBElement(ValBearingType.class, new QName("http://www.aixm.aero/schema/5.1", "verticalCoverageAzimuth"), SecondarySurveillanceRadarTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "antennatiltfixed", columnDefinition = "codeyesnobase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "antennatiltfixednilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setAntennaTiltFixedItem(CodeYesNoType target) {
        setAntennaTiltFixed(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.1", "antennaTiltFixed"), SecondarySurveillanceRadarTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "tiltangle", columnDefinition = "valanglebase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "tiltanglenilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setTiltAngleItem(ValAngleType target) {
        setTiltAngle(XmlAdapterUtils.marshallJAXBElement(ValAngleType.class, new QName("http://www.aixm.aero/schema/5.1", "tiltAngle"), SecondarySurveillanceRadarTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "automatedradarterminalsystem", columnDefinition = "character3")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "automatedradarterminalsystemnilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setAutomatedRadarTerminalSystemItem(TextDesignatorType target) {
        setAutomatedRadarTerminalSystem(XmlAdapterUtils.marshallJAXBElement(TextDesignatorType.class, new QName("http://www.aixm.aero/schema/5.1", "automatedRadarTerminalSystem"), SecondarySurveillanceRadarTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "transponder", columnDefinition = "codetransponderbase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "transpondernilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setTransponderItem(CodeTransponderType target) {
        setTransponder(XmlAdapterUtils.marshallJAXBElement(CodeTransponderType.class, new QName("http://www.aixm.aero/schema/5.1", "transponder"), SecondarySurveillanceRadarTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "autonomous", columnDefinition = "codeyesnobase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "autonomousnilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setAutonomousItem(CodeYesNoType target) {
        setAutonomous(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.1", "autonomous"), SecondarySurveillanceRadarTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "monopulse", columnDefinition = "codeyesnobase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "monopulsenilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setMonopulseItem(CodeYesNoType target) {
        setMonopulse(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.1", "monopulse"), SecondarySurveillanceRadarTimeSliceType.class, target));
    }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        }
        {
            ...
            List<SecondarySurveillanceRadarTimeSliceExtensionType> lhsField;
            lhsField = (this.isSetExtension()?this.getExtension():null);
            List<SecondarySurveillanceRadarTimeSliceExtensionType> rhsField;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        }
        {
            ...
            List<SecondarySurveillanceRadarTimeSliceExtensionType> theField;
