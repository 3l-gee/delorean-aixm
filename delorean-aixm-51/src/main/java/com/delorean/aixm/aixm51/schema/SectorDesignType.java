 ...
 *         <element name="designGradient" type="{http://www.aixm.aero/schema/5.1}ValSlopeType" minOccurs="0"/>
 *         <element name="terminationAltitude" type="{http://www.aixm.aero/schema/5.1}ValDistanceVerticalType" minOccurs="0"/>
 *         <element name="turnPermitted" type="{http://www.aixm.aero/schema/5.1}CodeYesNoType" minOccurs="0"/>
    ...
    implements Serializable
{
    ...
    public void setTurnDirectionItem(CodeDirectionTurnType target) {
        setTurnDirection(XmlAdapterUtils.marshallJAXBElement(CodeDirectionTurnType.class, new QName("http://www.aixm.aero/schema/5.1", "turnDirection"), SectorDesignType.class, target));
    }
    ...
    public void setDesignGradientItem(ValSlopeType target) {
        setDesignGradient(XmlAdapterUtils.marshallJAXBElement(ValSlopeType.class, new QName("http://www.aixm.aero/schema/5.1", "designGradient"), SectorDesignType.class, target));
    }
    ...
    public void setTerminationAltitudeItem(ValDistanceVerticalType target) {
        setTerminationAltitude(XmlAdapterUtils.marshallJAXBElement(ValDistanceVerticalType.class, new QName("http://www.aixm.aero/schema/5.1", "terminationAltitude"), SectorDesignType.class, target));
    }
    ...
    public void setTurnPermittedItem(CodeYesNoType target) {
        setTurnPermitted(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.1", "turnPermitted"), SectorDesignType.class, target));
    }
