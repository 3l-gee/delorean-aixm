 ...
 *       <sequence>
 *         <element name="videoMap" type="{http://www.aixm.aero/schema/5.1}CodeYesNoType" minOccurs="0"/>
    ...
    implements Serializable
{
    ...
    public void setVideoMapItem(CodeYesNoType target) {
        setVideoMap(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.1", "videoMap"), SurveillanceGroundStationType.class, target));
    }
