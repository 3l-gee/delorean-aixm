 ...
 *         <element name="doppler" type="{http://www.aixm.aero/schema/5.1}CodeYesNoType" minOccurs="0"/>
 *         <element name="informationProvision" type="{http://www.aixm.aero/schema/5.1}InformationServicePropertyType" maxOccurs="unbounded" minOccurs="0"/>
...
@Table(name = "directionfinder_t", schema = "navaids_point")
    ...
    implements Serializable
{
    ...
    protected List<DirectionFinderTimeSliceExtensionType> extension;
    ...
    @JoinTable(name = "drctnfndrtmslctp_athrt_link", schema = "navaids_point", joinColumns = {
        @JoinColumn(name = "directionfinder_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "drctnfndrtmslctp_mntrng_link", schema = "navaids_point", joinColumns = {
        @JoinColumn(name = "directionfinder_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "drctnfndrtmslctp_avlblt_link", schema = "navaids_point", joinColumns = {
        @JoinColumn(name = "directionfinder_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "drctnfndrtmslctp_annttn_link", schema = "navaids_point", joinColumns = {
        @JoinColumn(name = "directionfinder_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
     ...
     * 
     */
    @OneToMany(targetEntity = InformationServicePropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "drctnfndrtmslctp_infrmtnprvsn_link", schema = "navaids_point", joinColumns = {
        @JoinColumn(name = "directionfinder_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
        @JoinColumn(name = "informationprovision_hjid", referencedColumnName = "hjid")
    })
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link DirectionFinderTimeSliceExtensionType }
     * 
     * 
     */
    @OneToMany(targetEntity = DirectionFinderTimeSliceExtensionType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinColumn(name = "directionfinder_te_hjid", referencedColumnName = "hjid")
    public List<DirectionFinderTimeSliceExtensionType> getExtension() {
        if (extension == null) {
     ...
     * 
     */
    public void setExtension(List<DirectionFinderTimeSliceExtensionType> extension) {
    ...
    public void setDesignatorItem(CodeNavaidDesignatorType target) {
        setDesignator(XmlAdapterUtils.marshallJAXBElement(CodeNavaidDesignatorType.class, new QName("http://www.aixm.aero/schema/5.1", "designator"), DirectionFinderTimeSliceType.class, target));
    }
    ...
    public void setAixmNameItem(TextNameType target) {
        setAixmName(XmlAdapterUtils.marshallJAXBElement(TextNameType.class, new QName("http://www.aixm.aero/schema/5.1", "name"), DirectionFinderTimeSliceType.class, target));
    }
    ...
    public void setEmissionClassItem(CodeRadioEmissionType target) {
        setEmissionClass(XmlAdapterUtils.marshallJAXBElement(CodeRadioEmissionType.class, new QName("http://www.aixm.aero/schema/5.1", "emissionClass"), DirectionFinderTimeSliceType.class, target));
    }
    ...
    public void setMobileItem(CodeYesNoType target) {
        setMobile(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.1", "mobile"), DirectionFinderTimeSliceType.class, target));
    }
    ...
    public void setMagneticVariationItem(ValMagneticVariationType target) {
        setMagneticVariation(XmlAdapterUtils.marshallJAXBElement(ValMagneticVariationType.class, new QName("http://www.aixm.aero/schema/5.1", "magneticVariation"), DirectionFinderTimeSliceType.class, target));
    }
    ...
    public void setMagneticVariationAccuracyItem(ValAngleType target) {
        setMagneticVariationAccuracy(XmlAdapterUtils.marshallJAXBElement(ValAngleType.class, new QName("http://www.aixm.aero/schema/5.1", "magneticVariationAccuracy"), DirectionFinderTimeSliceType.class, target));
    }
    ...
    public void setDateMagneticVariationItem(DateYearType target) {
        setDateMagneticVariation(XmlAdapterUtils.marshallJAXBElement(DateYearType.class, new QName("http://www.aixm.aero/schema/5.1", "dateMagneticVariation"), DirectionFinderTimeSliceType.class, target));
    }
    ...
    public void setFlightCheckedItem(CodeYesNoType target) {
        setFlightChecked(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.1", "flightChecked"), DirectionFinderTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = AIXMElevatedPointPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "drctnfndrtmslctp_lctn_link", schema = "navaids_point", joinColumns = {
        @JoinColumn(name = "directionfinder_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setLocationItem(AIXMElevatedPointPropertyType target) {
        setLocation(XmlAdapterUtils.marshallJAXBElement(AIXMElevatedPointPropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "location"), DirectionFinderTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "doppler", columnDefinition = "codeyesnobase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "dopplernilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setDopplerItem(CodeYesNoType target) {
        setDoppler(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.1", "doppler"), DirectionFinderTimeSliceType.class, target));
    }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        }
        {
            ...
            List<DirectionFinderTimeSliceExtensionType> lhsField;
            lhsField = (this.isSetExtension()?this.getExtension():null);
            List<DirectionFinderTimeSliceExtensionType> rhsField;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        }
        {
            ...
            List<DirectionFinderTimeSliceExtensionType> theField;
