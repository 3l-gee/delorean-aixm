    ...
    implements Serializable
{
    ...
    public void setDurationItem(ValDurationType target) {
        setDuration(XmlAdapterUtils.marshallJAXBElement(ValDurationType.class, new QName("http://www.aixm.aero/schema/5.1", "duration"), HoldingPatternDurationType.class, target));
    }
