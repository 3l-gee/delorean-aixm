 ...
 *       <sequence>
 *         <element name="observationTime" type="{http://www.aixm.aero/schema/5.1}DateTimeType" minOccurs="0"/>
 *         <element name="depth" type="{http://www.aixm.aero/schema/5.1}ValDepthType" minOccurs="0"/>
 *         <element name="frictionCoefficient" type="{http://www.aixm.aero/schema/5.1}ValFrictionType" minOccurs="0"/>
 *         <element name="frictionEstimation" type="{http://www.aixm.aero/schema/5.1}CodeFrictionEstimateType" minOccurs="0"/>
 *         <element name="frictionDevice" type="{http://www.aixm.aero/schema/5.1}CodeFrictionDeviceType" minOccurs="0"/>
 *         <element name="obscuredLights" type="{http://www.aixm.aero/schema/5.1}CodeYesNoType" minOccurs="0"/>
 *         <element name="furtherClearanceTime" type="{http://www.aixm.aero/schema/5.1}TimeType" minOccurs="0"/>
 *         <element name="furtherTotalClearance" type="{http://www.aixm.aero/schema/5.1}CodeYesNoType" minOccurs="0"/>
 *         <element name="nextObservationTime" type="{http://www.aixm.aero/schema/5.1}DateTimeType" minOccurs="0"/>
 *         <element name="proportion" type="{http://www.aixm.aero/schema/5.1}ValPercentType" minOccurs="0"/>
 *         <element name="criticalRidge" type="{http://www.aixm.aero/schema/5.1}RidgePropertyType" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="layer" type="{http://www.aixm.aero/schema/5.1}SurfaceContaminationLayerPropertyType" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="annotation" type="{http://www.aixm.aero/schema/5.1}NotePropertyType" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="clearedLength" type="{http://www.aixm.aero/schema/5.1}ValDistanceType" minOccurs="0"/>
 *         <element name="clearedWidth" type="{http://www.aixm.aero/schema/5.1}ValDistanceType" minOccurs="0"/>
 *         <element name="clearedSide" type="{http://www.aixm.aero/schema/5.1}CodeSideType" minOccurs="0"/>
 *         <element name="furtherClearanceLength" type="{http://www.aixm.aero/schema/5.1}ValDistanceType" minOccurs="0"/>
 *         <element name="furtherClearanceWidth" type="{http://www.aixm.aero/schema/5.1}ValDistanceType" minOccurs="0"/>
 *         <element name="obscuredLightsSide" type="{http://www.aixm.aero/schema/5.1}CodeSideType" minOccurs="0"/>
 *         <element name="clearedLengthBegin" type="{http://www.aixm.aero/schema/5.1}ValDistanceType" minOccurs="0"/>
 *         <element name="taxiwayAvailable" type="{http://www.aixm.aero/schema/5.1}CodeYesNoType" minOccurs="0"/>
 *         <element name="apronAvailable" type="{http://www.aixm.aero/schema/5.1}CodeYesNoType" minOccurs="0"/>
    ...
    implements Serializable
{
    ...
    public void setObservationTimeItem(DateTimeType target) {
        setObservationTime(XmlAdapterUtils.marshallJAXBElement(DateTimeType.class, new QName("http://www.aixm.aero/schema/5.1", "observationTime"), RunwayContaminationType.class, target));
    }
    ...
    public void setDepthItem(ValDepthType target) {
        setDepth(XmlAdapterUtils.marshallJAXBElement(ValDepthType.class, new QName("http://www.aixm.aero/schema/5.1", "depth"), RunwayContaminationType.class, target));
    }
    ...
    public void setFrictionCoefficientItem(ValFrictionType target) {
        setFrictionCoefficient(XmlAdapterUtils.marshallJAXBElement(ValFrictionType.class, new QName("http://www.aixm.aero/schema/5.1", "frictionCoefficient"), RunwayContaminationType.class, target));
    }
    ...
    public void setFrictionEstimationItem(CodeFrictionEstimateType target) {
        setFrictionEstimation(XmlAdapterUtils.marshallJAXBElement(CodeFrictionEstimateType.class, new QName("http://www.aixm.aero/schema/5.1", "frictionEstimation"), RunwayContaminationType.class, target));
    }
    ...
    public void setFrictionDeviceItem(CodeFrictionDeviceType target) {
        setFrictionDevice(XmlAdapterUtils.marshallJAXBElement(CodeFrictionDeviceType.class, new QName("http://www.aixm.aero/schema/5.1", "frictionDevice"), RunwayContaminationType.class, target));
    }
    ...
    public void setObscuredLightsItem(CodeYesNoType target) {
        setObscuredLights(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.1", "obscuredLights"), RunwayContaminationType.class, target));
    }
    ...
    public void setFurtherClearanceTimeItem(TimeType target) {
        setFurtherClearanceTime(XmlAdapterUtils.marshallJAXBElement(TimeType.class, new QName("http://www.aixm.aero/schema/5.1", "furtherClearanceTime"), RunwayContaminationType.class, target));
    }
    ...
    public void setFurtherTotalClearanceItem(CodeYesNoType target) {
        setFurtherTotalClearance(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.1", "furtherTotalClearance"), RunwayContaminationType.class, target));
    }
    ...
    public void setNextObservationTimeItem(DateTimeType target) {
        setNextObservationTime(XmlAdapterUtils.marshallJAXBElement(DateTimeType.class, new QName("http://www.aixm.aero/schema/5.1", "nextObservationTime"), RunwayContaminationType.class, target));
    }
    ...
    public void setProportionItem(ValPercentType target) {
        setProportion(XmlAdapterUtils.marshallJAXBElement(ValPercentType.class, new QName("http://www.aixm.aero/schema/5.1", "proportion"), RunwayContaminationType.class, target));
    }
    ...
    public void setClearedLengthItem(ValDistanceType target) {
        setClearedLength(XmlAdapterUtils.marshallJAXBElement(ValDistanceType.class, new QName("http://www.aixm.aero/schema/5.1", "clearedLength"), RunwayContaminationType.class, target));
    }
    ...
    public void setClearedWidthItem(ValDistanceType target) {
        setClearedWidth(XmlAdapterUtils.marshallJAXBElement(ValDistanceType.class, new QName("http://www.aixm.aero/schema/5.1", "clearedWidth"), RunwayContaminationType.class, target));
    }
    ...
    public void setClearedSideItem(CodeSideType target) {
        setClearedSide(XmlAdapterUtils.marshallJAXBElement(CodeSideType.class, new QName("http://www.aixm.aero/schema/5.1", "clearedSide"), RunwayContaminationType.class, target));
    }
    ...
    public void setFurtherClearanceLengthItem(ValDistanceType target) {
        setFurtherClearanceLength(XmlAdapterUtils.marshallJAXBElement(ValDistanceType.class, new QName("http://www.aixm.aero/schema/5.1", "furtherClearanceLength"), RunwayContaminationType.class, target));
    }
    ...
    public void setFurtherClearanceWidthItem(ValDistanceType target) {
        setFurtherClearanceWidth(XmlAdapterUtils.marshallJAXBElement(ValDistanceType.class, new QName("http://www.aixm.aero/schema/5.1", "furtherClearanceWidth"), RunwayContaminationType.class, target));
    }
    ...
    public void setObscuredLightsSideItem(CodeSideType target) {
        setObscuredLightsSide(XmlAdapterUtils.marshallJAXBElement(CodeSideType.class, new QName("http://www.aixm.aero/schema/5.1", "obscuredLightsSide"), RunwayContaminationType.class, target));
    }
    ...
    public void setClearedLengthBeginItem(ValDistanceType target) {
        setClearedLengthBegin(XmlAdapterUtils.marshallJAXBElement(ValDistanceType.class, new QName("http://www.aixm.aero/schema/5.1", "clearedLengthBegin"), RunwayContaminationType.class, target));
    }
    ...
    public void setTaxiwayAvailableItem(CodeYesNoType target) {
        setTaxiwayAvailable(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.1", "taxiwayAvailable"), RunwayContaminationType.class, target));
    }
    ...
    public void setApronAvailableItem(CodeYesNoType target) {
        setApronAvailable(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.1", "apronAvailable"), RunwayContaminationType.class, target));
    }
