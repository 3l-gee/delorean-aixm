 ...
 *         <element name="markingLocation" type="{http://www.aixm.aero/schema/5.1}CodeTLOFSectionType" minOccurs="0"/>
 *         <element name="markedTouchDownLiftOff" type="{http://www.aixm.aero/schema/5.1}TouchDownLiftOffPropertyType" minOccurs="0"/>
    ...
    implements Serializable
{
    ...
    public void setMarkingICAOStandardItem(CodeYesNoType target) {
        setMarkingICAOStandard(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.1", "markingICAOStandard"), TouchDownLiftOffMarkingTimeSliceType.class, target));
    }
    ...
    public void setConditionItem(CodeMarkingConditionType target) {
        setCondition(XmlAdapterUtils.marshallJAXBElement(CodeMarkingConditionType.class, new QName("http://www.aixm.aero/schema/5.1", "condition"), TouchDownLiftOffMarkingTimeSliceType.class, target));
    }
    ...
    public void setMarkingLocationItem(CodeTLOFSectionType target) {
        setMarkingLocation(XmlAdapterUtils.marshallJAXBElement(CodeTLOFSectionType.class, new QName("http://www.aixm.aero/schema/5.1", "markingLocation"), TouchDownLiftOffMarkingTimeSliceType.class, target));
    }
    ...
    public void setMarkedTouchDownLiftOffItem(TouchDownLiftOffPropertyType target) {
        setMarkedTouchDownLiftOff(XmlAdapterUtils.marshallJAXBElement(TouchDownLiftOffPropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "markedTouchDownLiftOff"), TouchDownLiftOffMarkingTimeSliceType.class, target));
    }
