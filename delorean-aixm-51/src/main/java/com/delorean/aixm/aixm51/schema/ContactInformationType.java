 ...
 *         <element name="title" type="{http://www.aixm.aero/schema/5.1}TextNameType" minOccurs="0"/>
 *         <element name="address" type="{http://www.aixm.aero/schema/5.1}PostalAddressPropertyType" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="networkNode" type="{http://www.aixm.aero/schema/5.1}OnlineContactPropertyType" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="phoneFax" type="{http://www.aixm.aero/schema/5.1}TelephoneContactPropertyType" maxOccurs="unbounded" minOccurs="0"/>
    ...
    implements Serializable
{
    ...
    public void setAixmNameItem(TextNameType target) {
        setAixmName(XmlAdapterUtils.marshallJAXBElement(TextNameType.class, new QName("http://www.aixm.aero/schema/5.1", "name"), ContactInformationType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "title", columnDefinition = "character3")),
    ...
    public void setTitleItem(TextNameType target) {
        setTitle(XmlAdapterUtils.marshallJAXBElement(TextNameType.class, new QName("http://www.aixm.aero/schema/5.1", "title"), ContactInformationType.class, target));
    }
