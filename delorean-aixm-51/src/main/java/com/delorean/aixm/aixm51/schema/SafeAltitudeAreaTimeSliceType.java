 ...
 *       <sequence>
 *         <element name="safeAreaType" type="{http://www.aixm.aero/schema/5.1}CodeSafeAltitudeType" minOccurs="0"/>
 *         <choice>
 ...
 *         </choice>
 *         <element name="sector" type="{http://www.aixm.aero/schema/5.1}SafeAltitudeAreaSectorPropertyType" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="location" type="{http://www.aixm.aero/schema/5.1}AirportHeliportPropertyType" maxOccurs="unbounded" minOccurs="0"/>
    ...
    implements Serializable
{
    ...
    protected List<SafeAltitudeAreaTimeSliceExtensionType> extension;
    ...
    public void setSafeAreaTypeItem(CodeSafeAltitudeType target) {
        setSafeAreaType(XmlAdapterUtils.marshallJAXBElement(CodeSafeAltitudeType.class, new QName("http://www.aixm.aero/schema/5.1", "safeAreaType"), SafeAltitudeAreaTimeSliceType.class, target));
    }
    ...
    public void setCentrePointFixDesignatedPointItem(DesignatedPointPropertyType target) {
        setCentrePointFixDesignatedPoint(XmlAdapterUtils.marshallJAXBElement(DesignatedPointPropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "centrePoint_fixDesignatedPoint"), SafeAltitudeAreaTimeSliceType.class, target));
    }
    ...
    public void setCentrePointNavaidSystemItem(NavaidPropertyType target) {
        setCentrePointNavaidSystem(XmlAdapterUtils.marshallJAXBElement(NavaidPropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "centrePoint_navaidSystem"), SafeAltitudeAreaTimeSliceType.class, target));
    }
    ...
    public void setCentrePointAimingPointItem(TouchDownLiftOffPropertyType target) {
        setCentrePointAimingPoint(XmlAdapterUtils.marshallJAXBElement(TouchDownLiftOffPropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "centrePoint_aimingPoint"), SafeAltitudeAreaTimeSliceType.class, target));
    }
    ...
    public void setCentrePointRunwayPointItem(RunwayCentrelinePointPropertyType target) {
        setCentrePointRunwayPoint(XmlAdapterUtils.marshallJAXBElement(RunwayCentrelinePointPropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "centrePoint_runwayPoint"), SafeAltitudeAreaTimeSliceType.class, target));
    }
    ...
    public void setCentrePointAirportReferencePointItem(AirportHeliportPropertyType target) {
        setCentrePointAirportReferencePoint(XmlAdapterUtils.marshallJAXBElement(AirportHeliportPropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "centrePoint_airportReferencePoint"), SafeAltitudeAreaTimeSliceType.class, target));
    }
    ...
    public void setCentrePointPositionItem(AIXMPointPropertyType target) {
        setCentrePointPosition(XmlAdapterUtils.marshallJAXBElement(AIXMPointPropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "centrePoint_position"), SafeAltitudeAreaTimeSliceType.class, target));
    }
