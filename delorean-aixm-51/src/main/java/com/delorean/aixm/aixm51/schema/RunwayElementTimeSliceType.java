 ...
 *       <sequence>
 *         <element name="type" type="{http://www.aixm.aero/schema/5.1}CodeRunwayElementType" minOccurs="0"/>
 ...
 *         <element name="associatedRunway" type="{http://www.aixm.aero/schema/5.1}RunwayPropertyType" maxOccurs="unbounded" minOccurs="0"/>
...
@Table(name = "runwayelement_t", schema = "airport_heliport")
    ...
    implements Serializable
{
    ...
    protected List<RunwayElementTimeSliceExtensionType> extension;
    ...
    @JoinTable(name = "rnwelmnttmslctp_assctdrnw_link", schema = "airport_heliport", joinColumns = {
        @JoinColumn(name = "runwayelement_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
        @JoinColumn(name = "associatedrunway_hjid", referencedColumnName = "hjid")
    })
    ...
    @JoinTable(name = "rnwelmnttmslctp_annttn_link", schema = "airport_heliport", joinColumns = {
        @JoinColumn(name = "runwayelement_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "rnwelmnttmslctp_avlblt_link", schema = "airport_heliport", joinColumns = {
        @JoinColumn(name = "runwayelement_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link RunwayElementTimeSliceExtensionType }
     * 
     * 
     */
    @OneToMany(targetEntity = RunwayElementTimeSliceExtensionType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinColumn(name = "runwayelement_te_hjid", referencedColumnName = "hjid")
    public List<RunwayElementTimeSliceExtensionType> getExtension() {
        if (extension == null) {
     ...
     * 
     */
    public void setExtension(List<RunwayElementTimeSliceExtensionType> extension) {
    ...
    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "type", columnDefinition = "coderunwayelementbase")),
    ...
    public void setTypeItem(CodeRunwayElementType target) {
        setType(XmlAdapterUtils.marshallJAXBElement(CodeRunwayElementType.class, new QName("http://www.aixm.aero/schema/5.1", "type"), RunwayElementTimeSliceType.class, target));
    }
    ...
    public void setLengthItem(ValDistanceType target) {
        setLength(XmlAdapterUtils.marshallJAXBElement(ValDistanceType.class, new QName("http://www.aixm.aero/schema/5.1", "length"), RunwayElementTimeSliceType.class, target));
    }
    ...
    public void setWidthItem(ValDistanceType target) {
        setWidth(XmlAdapterUtils.marshallJAXBElement(ValDistanceType.class, new QName("http://www.aixm.aero/schema/5.1", "width"), RunwayElementTimeSliceType.class, target));
    }
    ...
    public void setGradeSeparationItem(CodeGradeSeparationType target) {
        setGradeSeparation(XmlAdapterUtils.marshallJAXBElement(CodeGradeSeparationType.class, new QName("http://www.aixm.aero/schema/5.1", "gradeSeparation"), RunwayElementTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = SurfaceCharacteristicsPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "rnwelmnttmslctp_srfcprprts_link", schema = "airport_heliport", joinColumns = {
        @JoinColumn(name = "runwayelement_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setSurfacePropertiesItem(SurfaceCharacteristicsPropertyType target) {
        setSurfaceProperties(XmlAdapterUtils.marshallJAXBElement(SurfaceCharacteristicsPropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "surfaceProperties"), RunwayElementTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = AIXMElevatedSurfacePropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "rnwelmnttmslctp_extnt_link", schema = "airport_heliport", joinColumns = {
        @JoinColumn(name = "runwayelement_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setExtentItem(AIXMElevatedSurfacePropertyType target) {
        setExtent(XmlAdapterUtils.marshallJAXBElement(AIXMElevatedSurfacePropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "extent"), RunwayElementTimeSliceType.class, target));
    }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        }
        {
            ...
            List<RunwayElementTimeSliceExtensionType> lhsField;
            lhsField = (this.isSetExtension()?this.getExtension():null);
            List<RunwayElementTimeSliceExtensionType> rhsField;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        }
        {
            ...
            List<RunwayElementTimeSliceExtensionType> theField;
