 ...
 *       <sequence>
 *         <element name="guidanceEquipment" type="{http://www.aixm.aero/schema/5.1}CodeApproachType" minOccurs="0"/>
 *         <element name="landingSystemLights" type="{http://www.aixm.aero/schema/5.1}CodeYesNoType" minOccurs="0"/>
 *         <element name="equipmentRVR" type="{http://www.aixm.aero/schema/5.1}CodeYesNoType" minOccurs="0"/>
 *         <element name="visibilityAdjustment" type="{http://www.aixm.aero/schema/5.1}ValDistanceVerticalType" minOccurs="0"/>
    ...
    implements Serializable
{
    ...
    public void setGuidanceEquipmentItem(CodeApproachType target) {
        setGuidanceEquipment(XmlAdapterUtils.marshallJAXBElement(CodeApproachType.class, new QName("http://www.aixm.aero/schema/5.1", "guidanceEquipment"), EquipmentUnavailableAdjustmentColumnType.class, target));
    }
    ...
    public void setLandingSystemLightsItem(CodeYesNoType target) {
        setLandingSystemLights(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.1", "landingSystemLights"), EquipmentUnavailableAdjustmentColumnType.class, target));
    }
    ...
    public void setEquipmentRVRItem(CodeYesNoType target) {
        setEquipmentRVR(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.1", "equipmentRVR"), EquipmentUnavailableAdjustmentColumnType.class, target));
    }
    ...
    public void setVisibilityAdjustmentItem(ValDistanceVerticalType target) {
        setVisibilityAdjustment(XmlAdapterUtils.marshallJAXBElement(ValDistanceVerticalType.class, new QName("http://www.aixm.aero/schema/5.1", "visibilityAdjustment"), EquipmentUnavailableAdjustmentColumnType.class, target));
    }
    ...
    public void setApproachLightingInoperativeItem(CodeYesNoType target) {
        setApproachLightingInoperative(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.1", "approachLightingInoperative"), EquipmentUnavailableAdjustmentColumnType.class, target));
    }
