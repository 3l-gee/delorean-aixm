 ...
 *       <sequence>
 *         <element name="type" type="{http://www.aixm.aero/schema/5.1}CodeFlightType" minOccurs="0"/>
 *         <element name="rule" type="{http://www.aixm.aero/schema/5.1}CodeFlightRuleType" minOccurs="0"/>
 *         <element name="status" type="{http://www.aixm.aero/schema/5.1}CodeFlightStatusType" minOccurs="0"/>
 *         <element name="military" type="{http://www.aixm.aero/schema/5.1}CodeMilitaryStatusType" minOccurs="0"/>
 *         <element name="origin" type="{http://www.aixm.aero/schema/5.1}CodeFlightOriginType" minOccurs="0"/>
 *         <element name="purpose" type="{http://www.aixm.aero/schema/5.1}CodeFlightPurposeType" minOccurs="0"/>
    ...
    implements Serializable
{
    ...
    public void setTypeItem(CodeFlightType target) {
        setType(XmlAdapterUtils.marshallJAXBElement(CodeFlightType.class, new QName("http://www.aixm.aero/schema/5.1", "type"), FlightCharacteristicType.class, target));
    }
    ...
    public void setRuleItem(CodeFlightRuleType target) {
        setRule(XmlAdapterUtils.marshallJAXBElement(CodeFlightRuleType.class, new QName("http://www.aixm.aero/schema/5.1", "rule"), FlightCharacteristicType.class, target));
    }
    ...
    public void setStatusItem(CodeFlightStatusType target) {
        setStatus(XmlAdapterUtils.marshallJAXBElement(CodeFlightStatusType.class, new QName("http://www.aixm.aero/schema/5.1", "status"), FlightCharacteristicType.class, target));
    }
    ...
    public void setMilitaryItem(CodeMilitaryStatusType target) {
        setMilitary(XmlAdapterUtils.marshallJAXBElement(CodeMilitaryStatusType.class, new QName("http://www.aixm.aero/schema/5.1", "military"), FlightCharacteristicType.class, target));
    }
    ...
    public void setOriginItem(CodeFlightOriginType target) {
        setOrigin(XmlAdapterUtils.marshallJAXBElement(CodeFlightOriginType.class, new QName("http://www.aixm.aero/schema/5.1", "origin"), FlightCharacteristicType.class, target));
    }
    ...
    public void setPurposeItem(CodeFlightPurposeType target) {
        setPurpose(XmlAdapterUtils.marshallJAXBElement(CodeFlightPurposeType.class, new QName("http://www.aixm.aero/schema/5.1", "purpose"), FlightCharacteristicType.class, target));
    }
