 ...
 *       <sequence>
 *         <element name="designator" type="{http://www.aixm.aero/schema/5.1}AlphanumericType" minOccurs="0"/>
 *         <element name="type" type="{http://www.aixm.aero/schema/5.1}CodeBuoyType" minOccurs="0"/>
 *         <element name="colour" type="{http://www.aixm.aero/schema/5.1}CodeColourType" minOccurs="0"/>
 *         <element name="theSeaplaneLandingArea" type="{http://www.aixm.aero/schema/5.1}SeaplaneLandingAreaPropertyType" minOccurs="0"/>
    ...
    implements Serializable
{
    ...
    public void setDesignatorItem(String target) {
        setDesignator(XmlAdapterUtils.marshallJAXBElement(String.class, new QName("http://www.aixm.aero/schema/5.1", "designator"), MarkingBuoyTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "type", columnDefinition = "codebuoybase")),
    ...
    public void setTypeItem(CodeBuoyType target) {
        setType(XmlAdapterUtils.marshallJAXBElement(CodeBuoyType.class, new QName("http://www.aixm.aero/schema/5.1", "type"), MarkingBuoyTimeSliceType.class, target));
    }
    ...
    public void setColourItem(CodeColourType target) {
        setColour(XmlAdapterUtils.marshallJAXBElement(CodeColourType.class, new QName("http://www.aixm.aero/schema/5.1", "colour"), MarkingBuoyTimeSliceType.class, target));
    }
    ...
    public void setTheSeaplaneLandingAreaItem(SeaplaneLandingAreaPropertyType target) {
        setTheSeaplaneLandingArea(XmlAdapterUtils.marshallJAXBElement(SeaplaneLandingAreaPropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "theSeaplaneLandingArea"), MarkingBuoyTimeSliceType.class, target));
    }
    ...
    public void setLocationItem(AIXMElevatedPointPropertyType target) {
        setLocation(XmlAdapterUtils.marshallJAXBElement(AIXMElevatedPointPropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "location"), MarkingBuoyTimeSliceType.class, target));
    }
