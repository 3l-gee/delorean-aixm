 ...
 *       <sequence>
 *         <element name="collocationGroup" type="{http://www.aixm.aero/schema/5.1}NoSequenceType" minOccurs="0"/>
 *         <element name="markerPosition" type="{http://www.aixm.aero/schema/5.1}CodePositionInILSType" minOccurs="0"/>
 *         <element name="providesNavigableLocation" type="{http://www.aixm.aero/schema/5.1}CodeYesNoType" minOccurs="0"/>
 *         <element name="annotation" type="{http://www.aixm.aero/schema/5.1}NotePropertyType" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="theNavaidEquipment" type="{http://www.aixm.aero/schema/5.1}NavaidEquipmentPropertyType" minOccurs="0"/>
    ...
    implements Serializable
{
    ...
    public void setCollocationGroupItem(NoSequenceType target) {
        setCollocationGroup(XmlAdapterUtils.marshallJAXBElement(NoSequenceType.class, new QName("http://www.aixm.aero/schema/5.1", "collocationGroup"), NavaidComponentType.class, target));
    }
    ...
    public void setMarkerPositionItem(CodePositionInILSType target) {
        setMarkerPosition(XmlAdapterUtils.marshallJAXBElement(CodePositionInILSType.class, new QName("http://www.aixm.aero/schema/5.1", "markerPosition"), NavaidComponentType.class, target));
    }
    ...
    public void setProvidesNavigableLocationItem(CodeYesNoType target) {
        setProvidesNavigableLocation(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.1", "providesNavigableLocation"), NavaidComponentType.class, target));
    }
