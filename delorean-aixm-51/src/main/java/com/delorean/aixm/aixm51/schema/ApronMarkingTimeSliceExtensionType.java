...
@Entity(name = "ApronMarkingTimeSliceExtensionType")
@Table(name = "apronmarking_te", schema = "airport_heliport")
public class ApronMarkingTimeSliceExtensionType implements Serializable, Equals, HashCode, ToString
{
    ...
    @JoinColumn(name = "abstractapronmarkingextension_hjid", referencedColumnName = "hjid")
