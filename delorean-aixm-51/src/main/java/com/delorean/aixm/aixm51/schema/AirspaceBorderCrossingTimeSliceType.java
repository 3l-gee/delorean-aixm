 ...
 *       <sequence>
 *         <element name="exitedAirspace" type="{http://www.aixm.aero/schema/5.1}AirspacePropertyType" minOccurs="0"/>
 *         <element name="enteredAirspace" type="{http://www.aixm.aero/schema/5.1}AirspacePropertyType" minOccurs="0"/>
    ...
    implements Serializable
{
    ...
    public void setExitedAirspaceItem(AirspacePropertyType target) {
        setExitedAirspace(XmlAdapterUtils.marshallJAXBElement(AirspacePropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "exitedAirspace"), AirspaceBorderCrossingTimeSliceType.class, target));
    }
    ...
    public void setEnteredAirspaceItem(AirspacePropertyType target) {
        setEnteredAirspace(XmlAdapterUtils.marshallJAXBElement(AirspacePropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "enteredAirspace"), AirspaceBorderCrossingTimeSliceType.class, target));
    }
