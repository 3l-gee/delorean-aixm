 ...
 *         <element name="isActive" type="{http://www.aixm.aero/schema/5.1}CodeYesNoType" minOccurs="0"/>
    ...
    implements Serializable
{
     ...
     * 
     */
    @OneToMany(targetEntity = WorkareaActivityExtensionType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    ...
    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "isactive", columnDefinition = "codeyesnobase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "isactivenilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setIsActiveItem(CodeYesNoType target) {
        setIsActive(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.1", "isActive"), WorkareaActivityType.class, target));
    }
