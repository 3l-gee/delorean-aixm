 ...
 *         <element name="type" type="{http://www.aixm.aero/schema/5.1}CodeGroundLightingType" minOccurs="0"/>
 *         <element name="colour" type="{http://www.aixm.aero/schema/5.1}CodeColourType" minOccurs="0"/>
 *         <element name="flashing" type="{http://www.aixm.aero/schema/5.1}CodeYesNoType" minOccurs="0"/>
 *         <element name="structureBeacon" type="{http://www.aixm.aero/schema/5.1}VerticalStructurePropertyType" minOccurs="0"/>
 *         <element name="aerodromeBeacon" type="{http://www.aixm.aero/schema/5.1}AirportHeliportPropertyType" minOccurs="0"/>
    ...
    implements Serializable
{
    ...
    public void setAixmNameItem(TextNameType target) {
        setAixmName(XmlAdapterUtils.marshallJAXBElement(TextNameType.class, new QName("http://www.aixm.aero/schema/5.1", "name"), AeronauticalGroundLightTimeSliceType.class, target));
    }
    ...
    public void setTypeItem(CodeGroundLightingType target) {
        setType(XmlAdapterUtils.marshallJAXBElement(CodeGroundLightingType.class, new QName("http://www.aixm.aero/schema/5.1", "type"), AeronauticalGroundLightTimeSliceType.class, target));
    }
    ...
    public void setColourItem(CodeColourType target) {
        setColour(XmlAdapterUtils.marshallJAXBElement(CodeColourType.class, new QName("http://www.aixm.aero/schema/5.1", "colour"), AeronauticalGroundLightTimeSliceType.class, target));
    }
    ...
    public void setFlashingItem(CodeYesNoType target) {
        setFlashing(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.1", "flashing"), AeronauticalGroundLightTimeSliceType.class, target));
    }
    ...
    public void setStructureBeaconItem(VerticalStructurePropertyType target) {
        setStructureBeacon(XmlAdapterUtils.marshallJAXBElement(VerticalStructurePropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "structureBeacon"), AeronauticalGroundLightTimeSliceType.class, target));
    }
    ...
    public void setAerodromeBeaconItem(AirportHeliportPropertyType target) {
        setAerodromeBeacon(XmlAdapterUtils.marshallJAXBElement(AirportHeliportPropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "aerodromeBeacon"), AeronauticalGroundLightTimeSliceType.class, target));
    }
    ...
    public void setLocationItem(AIXMElevatedPointPropertyType target) {
        setLocation(XmlAdapterUtils.marshallJAXBElement(AIXMElevatedPointPropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "location"), AeronauticalGroundLightTimeSliceType.class, target));
    }
