 ...
 *         <element ref=
"{http://www.aixm.aero/schema/5.1}AbstractCirclingRestrictionExtension"/>
 *       </choice>
 *       <attGroup ref=
...
@XmlType(name = "", propOrder = {"abstractPropertiesWithScheduleExtension", "abstractCirclingRestrictionExtension"})
@Entity(name = "CirclingRestrictionExtensionType")
@Table(name = "circlingrestriction_oe", schema = "procedure")
public class CirclingRestrictionExtensionType implements Serializable, Equals, HashCode, ToString {
     ...
     */
    @OneToOne(targetEntity = AbstractExtensionType.class, cascade = {CascadeType.ALL}, fetch = FetchType.EAGER)
    @JoinColumn(name = "abstractcirclingrestrictionextension_hjid", referencedColumnName = "hjid")
    public AbstractExtensionType getAbstractCirclingRestrictionExtension() {
        return abstractCirclingRestrictionExtension;
    }

    /**
     * Sets the value of the abstractCirclingRestrictionExtension property.
     *
     * @param value
     *            allowed object is {@link AbstractExtensionType }
     *
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final CirclingRestrictionExtensionType that = ((CirclingRestrictionExtensionType) object);
        {
            ...
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "abstractCirclingRestrictionExtension",
                    lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "abstractCirclingRestrictionExtension",
                    rhsField);
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetAbstractCirclingRestrictionExtension();
            AbstractExtensionType theField;
            theField = this.getAbstractCirclingRestrictionExtension();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "abstractCirclingRestrictionExtension",
                    theField);
            currentHashCode = strategy.hashCode(theFieldLocator, currentHashCode, theField, theFieldIsSet);
        }
        {
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        }
        {
            ...
            AbstractExtensionType theField;
            theField = this.getAbstractCirclingRestrictionExtension();
            strategy.appendField(locator, this, "abstractCirclingRestrictionExtension", buffer, theField,
                    theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetOwns();
