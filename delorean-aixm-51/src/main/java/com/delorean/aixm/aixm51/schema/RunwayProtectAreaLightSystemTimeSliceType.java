 ...
 *         <element name="position" type="{http://www.aixm.aero/schema/5.1}CodeProtectAreaSectionType" minOccurs="0"/>
 *         <element name="lightedArea" type="{http://www.aixm.aero/schema/5.1}RunwayProtectAreaPropertyType" minOccurs="0"/>
...
@Table(name = "runwayprotectarealightsystem_t", schema = "airport_heliport")
    ...
    implements Serializable
{
    ...
    protected List<RunwayProtectAreaLightSystemTimeSliceExtensionType> extension;
    ...
    @JoinTable(name = "rnwprtctarlghtsstmtmslctp_elmnt_link", schema = "airport_heliport", joinColumns = {
        @JoinColumn(name = "runwayprotectarealightsystem_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "rnwprtctarlghtsstmtmslctp_avlblt_link", schema = "airport_heliport", joinColumns = {
        @JoinColumn(name = "runwayprotectarealightsystem_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "rnwprtctarlghtsstmtmslctp_annttn_link", schema = "airport_heliport", joinColumns = {
        @JoinColumn(name = "runwayprotectarealightsystem_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
     ...
     * 
     */
    @OneToMany(targetEntity = RunwayProtectAreaLightSystemTimeSliceExtensionType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinColumn(name = "runwayprotectarealightsystem_te_hjid", referencedColumnName = "hjid")
    public List<RunwayProtectAreaLightSystemTimeSliceExtensionType> getExtension() {
        if (extension == null) {
     ...
     * 
     */
    public void setExtension(List<RunwayProtectAreaLightSystemTimeSliceExtensionType> extension) {
    ...
    public void setEmergencyLightingItem(CodeYesNoType target) {
        setEmergencyLighting(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.1", "emergencyLighting"), RunwayProtectAreaLightSystemTimeSliceType.class, target));
    }
    ...
    public void setIntensityLevelItem(CodeLightIntensityType target) {
        setIntensityLevel(XmlAdapterUtils.marshallJAXBElement(CodeLightIntensityType.class, new QName("http://www.aixm.aero/schema/5.1", "intensityLevel"), RunwayProtectAreaLightSystemTimeSliceType.class, target));
    }
    ...
    public void setColourItem(CodeColourType target) {
        setColour(XmlAdapterUtils.marshallJAXBElement(CodeColourType.class, new QName("http://www.aixm.aero/schema/5.1", "colour"), RunwayProtectAreaLightSystemTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "position", columnDefinition = "codeprotectareasectionbase")),
    ...
    public void setPositionItem(CodeProtectAreaSectionType target) {
        setPosition(XmlAdapterUtils.marshallJAXBElement(CodeProtectAreaSectionType.class, new QName("http://www.aixm.aero/schema/5.1", "position"), RunwayProtectAreaLightSystemTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = RunwayProtectAreaPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "rnwprtctarlghtsstmtmslctp_lghtdar_link", schema = "airport_heliport", joinColumns = {
        @JoinColumn(name = "runwayprotectarealightsystem_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
        @JoinColumn(name = "lightedarea_hjid", referencedColumnName = "hjid")
    })
    ...
    public void setLightedAreaItem(RunwayProtectAreaPropertyType target) {
        setLightedArea(XmlAdapterUtils.marshallJAXBElement(RunwayProtectAreaPropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "lightedArea"), RunwayProtectAreaLightSystemTimeSliceType.class, target));
    }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        }
        {
            ...
            List<RunwayProtectAreaLightSystemTimeSliceExtensionType> lhsField;
            lhsField = (this.isSetExtension()?this.getExtension():null);
            List<RunwayProtectAreaLightSystemTimeSliceExtensionType> rhsField;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        }
        {
            ...
            List<RunwayProtectAreaLightSystemTimeSliceExtensionType> theField;
