 ...
 *       <sequence>
 *         <element name="callSign" type="{http://www.aixm.aero/schema/5.1}TextNameType" minOccurs="0"/>
 *         <element name="language" type="{http://www.aixm.aero/schema/5.1}CodeLanguageType" minOccurs="0"/>
 ...
 *                 <sequence>
 *                   <element ref="{http://www.aixm.aero/schema/5.1}AbstractCallsignDetailExtension"/>
 *                 </sequence>
    ...
    implements Serializable
{
    ...
    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "callsign", columnDefinition = "character3")),
    ...
    public void setCallSignItem(TextNameType target) {
        setCallSign(XmlAdapterUtils.marshallJAXBElement(TextNameType.class, new QName("http://www.aixm.aero/schema/5.1", "callSign"), CallsignDetailType.class, target));
    }
    ...
    public void setLanguageItem(CodeLanguageType target) {
        setLanguage(XmlAdapterUtils.marshallJAXBElement(CodeLanguageType.class, new QName("http://www.aixm.aero/schema/5.1", "language"), CallsignDetailType.class, target));
    }
