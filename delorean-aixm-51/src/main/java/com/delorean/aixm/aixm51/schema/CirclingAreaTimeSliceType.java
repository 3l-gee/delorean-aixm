 ...
 *         <element name="aircraftCategory" type="{http://www.aixm.aero/schema/5.1}AircraftCharacteristicPropertyType" minOccurs="0"/>
    ...
    implements Serializable
{
    ...
    public void setExtentItem(AIXMSurfacePropertyType target) {
        setExtent(XmlAdapterUtils.marshallJAXBElement(AIXMSurfacePropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "extent"), CirclingAreaTimeSliceType.class, target));
    }
    ...
    public void setApproachItem(InstrumentApproachProcedurePropertyType target) {
        setApproach(XmlAdapterUtils.marshallJAXBElement(InstrumentApproachProcedurePropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "approach"), CirclingAreaTimeSliceType.class, target));
    }
    ...
    public void setAircraftCategoryItem(AircraftCharacteristicPropertyType target) {
        setAircraftCategory(XmlAdapterUtils.marshallJAXBElement(AircraftCharacteristicPropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "aircraftCategory"), CirclingAreaTimeSliceType.class, target));
    }
