...
/**
 * <p>Java class for WorkAreaPropertyType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="WorkAreaPropertyType">
 *   <complexContent>
...
@XmlType(name = "WorkAreaPropertyType")
@Entity(name = "WorkAreaPropertyType")
@Table(name = "workareapropertytype", schema = "airport_heliport")
public class WorkAreaPropertyType implements Serializable, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        final WorkAreaPropertyType that = ((WorkAreaPropertyType) object);
        {
