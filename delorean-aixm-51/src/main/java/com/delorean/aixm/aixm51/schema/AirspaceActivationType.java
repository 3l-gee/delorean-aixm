 ...
 *         <element name="activity" type="{http://www.aixm.aero/schema/5.1}CodeAirspaceActivityType" minOccurs="0"/>
 *         <element name="status" type="{http://www.aixm.aero/schema/5.1}CodeStatusAirspaceType" minOccurs="0"/>
 *         <element name="levels" type="{http://www.aixm.aero/schema/5.1}AirspaceLayerPropertyType" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="user" type="{http://www.aixm.aero/schema/5.1}OrganisationAuthorityPropertyType" maxOccurs="unbounded" minOccurs="0"/>
    ...
    implements Serializable
{
    ...
    @JoinTable(name = "arspcactvtntp_tmintrvl_link", schema = "airspace", joinColumns = {
        @JoinColumn(name = "airspaceactivation_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "activity", columnDefinition = "codeairspaceactivitybase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "activitynilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setActivityItem(CodeAirspaceActivityType target) {
        setActivity(XmlAdapterUtils.marshallJAXBElement(CodeAirspaceActivityType.class, new QName("http://www.aixm.aero/schema/5.1", "activity"), AirspaceActivationType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "status", columnDefinition = "codestatusairspacebase")),
    ...
    public void setStatusItem(CodeStatusAirspaceType target) {
        setStatus(XmlAdapterUtils.marshallJAXBElement(CodeStatusAirspaceType.class, new QName("http://www.aixm.aero/schema/5.1", "status"), AirspaceActivationType.class, target));
    }
