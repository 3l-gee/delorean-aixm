 ...
 *         <element name="usedRunwayDirection" type="{http://www.aixm.aero/schema/5.1}RunwayDirectionPropertyType" minOccurs="0"/>
    ...
    implements Serializable
{
    ...
    protected List<RunwayBlastPadTimeSliceExtensionType> extension;
    ...
    @JoinTable(name = "rnwblstpdtmslctp_annttn_l", schema = "airport_heliport", joinColumns = {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link RunwayBlastPadTimeSliceExtensionType }
     * 
     * 
     */
    @OneToMany(targetEntity = RunwayBlastPadTimeSliceExtensionType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinColumn(name = "runwayblastpad_te_hjid", referencedColumnName = "hjid")
    public List<RunwayBlastPadTimeSliceExtensionType> getExtension() {
        if (extension == null) {
     ...
     * 
     */
    public void setExtension(List<RunwayBlastPadTimeSliceExtensionType> extension) {
    ...
    public void setLengthItem(ValDistanceType target) {
        setLength(XmlAdapterUtils.marshallJAXBElement(ValDistanceType.class, new QName("http://www.aixm.aero/schema/5.1", "length"), RunwayBlastPadTimeSliceType.class, target));
    }
    ...
    public void setStatusItem(CodeStatusOperationsType target) {
        setStatus(XmlAdapterUtils.marshallJAXBElement(CodeStatusOperationsType.class, new QName("http://www.aixm.aero/schema/5.1", "status"), RunwayBlastPadTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = RunwayDirectionPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "rnwblstpdtmslctp_usdrnwdrctn_l", schema = "airport_heliport", joinColumns = {
        @JoinColumn(name = "runwayblastpad_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setUsedRunwayDirectionItem(RunwayDirectionPropertyType target) {
        setUsedRunwayDirection(XmlAdapterUtils.marshallJAXBElement(RunwayDirectionPropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "usedRunwayDirection"), RunwayBlastPadTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = AIXMElevatedSurfacePropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "rnwblstpdtmslctp_extnt_l", schema = "airport_heliport", joinColumns = {
        @JoinColumn(name = "runwayblastpad_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setExtentItem(AIXMElevatedSurfacePropertyType target) {
        setExtent(XmlAdapterUtils.marshallJAXBElement(AIXMElevatedSurfacePropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "extent"), RunwayBlastPadTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = SurfaceCharacteristicsPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "rnwblstpdtmslctp_srfcprprts_l", schema = "airport_heliport", joinColumns = {
        @JoinColumn(name = "runwayblastpad_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setSurfacePropertiesItem(SurfaceCharacteristicsPropertyType target) {
        setSurfaceProperties(XmlAdapterUtils.marshallJAXBElement(SurfaceCharacteristicsPropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "surfaceProperties"), RunwayBlastPadTimeSliceType.class, target));
    }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        }
        {
            ...
            List<RunwayBlastPadTimeSliceExtensionType> lhsField;
            lhsField = (this.isSetExtension()?this.getExtension():null);
            List<RunwayBlastPadTimeSliceExtensionType> rhsField;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        }
        {
            ...
            List<RunwayBlastPadTimeSliceExtensionType> theField;
