 ...
 *       <sequence>
 *         <element name="designator" type="{http://www.aixm.aero/schema/5.1}CodeAirportHeliportDesignatorType" minOccurs="0"/>
 *         <element name="name" type="{http://www.aixm.aero/schema/5.1}TextNameType" minOccurs="0"/>
 *         <element name="locationIndicatorICAO" type="{http://www.aixm.aero/schema/5.1}CodeICAOType" minOccurs="0"/>
 *         <element name="designatorIATA" type="{http://www.aixm.aero/schema/5.1}CodeIATAType" minOccurs="0"/>
 *         <element name="type" type="{http://www.aixm.aero/schema/5.1}CodeAirportHeliportType" minOccurs="0"/>
 *         <element name="certifiedICAO" type="{http://www.aixm.aero/schema/5.1}CodeYesNoType" minOccurs="0"/>
 *         <element name="privateUse" type="{http://www.aixm.aero/schema/5.1}CodeYesNoType" minOccurs="0"/>
 *         <element name="controlType" type="{http://www.aixm.aero/schema/5.1}CodeMilitaryOperationsType" minOccurs="0"/>
 *         <element name="fieldElevation" type="{http://www.aixm.aero/schema/5.1}ValDistanceVerticalType" minOccurs="0"/>
 *         <element name="fieldElevationAccuracy" type="{http://www.aixm.aero/schema/5.1}ValDistanceVerticalType" minOccurs="0"/>
 *         <element name="verticalDatum" type="{http://www.aixm.aero/schema/5.1}CodeVerticalDatumType" minOccurs="0"/>
 ...
 *         <element name="magneticVariationChange" type="{http://www.aixm.aero/schema/5.1}ValMagneticVariationChangeType" minOccurs="0"/>
 *         <element name="referenceTemperature" type="{http://www.aixm.aero/schema/5.1}ValTemperatureType" minOccurs="0"/>
 *         <element name="altimeterCheckLocation" type="{http://www.aixm.aero/schema/5.1}CodeYesNoType" minOccurs="0"/>
 *         <element name="secondaryPowerSupply" type="{http://www.aixm.aero/schema/5.1}CodeYesNoType" minOccurs="0"/>
 *         <element name="windDirectionIndicator" type="{http://www.aixm.aero/schema/5.1}CodeYesNoType" minOccurs="0"/>
 *         <element name="landingDirectionIndicator" type="{http://www.aixm.aero/schema/5.1}CodeYesNoType" minOccurs="0"/>
 *         <element name="transitionAltitude" type="{http://www.aixm.aero/schema/5.1}ValDistanceVerticalType" minOccurs="0"/>
 *         <element name="transitionLevel" type="{http://www.aixm.aero/schema/5.1}ValFLType" minOccurs="0"/>
 *         <element name="lowestTemperature" type="{http://www.aixm.aero/schema/5.1}ValTemperatureType" minOccurs="0"/>
 *         <element name="abandoned" type="{http://www.aixm.aero/schema/5.1}CodeYesNoType" minOccurs="0"/>
 *         <element name="certificationDate" type="{http://www.aixm.aero/schema/5.1}DateType" minOccurs="0"/>
 *         <element name="certificationExpirationDate" type="{http://www.aixm.aero/schema/5.1}DateType" minOccurs="0"/>
 *         <element name="contaminant" type="{http://www.aixm.aero/schema/5.1}AirportHeliportContaminationPropertyType" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="servedCity" type="{http://www.aixm.aero/schema/5.1}CityPropertyType" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="responsibleOrganisation" type="{http://www.aixm.aero/schema/5.1}AirportHeliportResponsibilityOrganisationPropertyType" minOccurs="0"/>
 *         <element name="ARP" type="{http://www.aixm.aero/schema/5.1}ElevatedPointPropertyType" minOccurs="0"/>
 *         <element name="aviationBoundary" type="{http://www.aixm.aero/schema/5.1}ElevatedSurfacePropertyType" minOccurs="0"/>
 *         <element name="altimeterSource" type="{http://www.aixm.aero/schema/5.1}AltimeterSourcePropertyType" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="contact" type="{http://www.aixm.aero/schema/5.1}ContactInformationPropertyType" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="availability" type="{http://www.aixm.aero/schema/5.1}AirportHeliportAvailabilityPropertyType" maxOccurs="unbounded" minOccurs="0"/>
    ...
    implements Serializable
{
    ...
    protected List<AirportHeliportTimeSliceExtensionType> extension;
    ...
    public void setDesignatorItem(CodeAirportHeliportDesignatorType target) {
        setDesignator(XmlAdapterUtils.marshallJAXBElement(CodeAirportHeliportDesignatorType.class, new QName("http://www.aixm.aero/schema/5.1", "designator"), AirportHeliportTimeSliceType.class, target));
    }
    ...
    public void setAixmNameItem(TextNameType target) {
        setAixmName(XmlAdapterUtils.marshallJAXBElement(TextNameType.class, new QName("http://www.aixm.aero/schema/5.1", "name"), AirportHeliportTimeSliceType.class, target));
    }
    ...
    public void setLocationIndicatorICAOItem(CodeICAOType target) {
        setLocationIndicatorICAO(XmlAdapterUtils.marshallJAXBElement(CodeICAOType.class, new QName("http://www.aixm.aero/schema/5.1", "locationIndicatorICAO"), AirportHeliportTimeSliceType.class, target));
    }
    ...
    public void setDesignatorIATAItem(CodeIATAType target) {
        setDesignatorIATA(XmlAdapterUtils.marshallJAXBElement(CodeIATAType.class, new QName("http://www.aixm.aero/schema/5.1", "designatorIATA"), AirportHeliportTimeSliceType.class, target));
    }
    ...
    public void setTypeItem(CodeAirportHeliportType target) {
        setType(XmlAdapterUtils.marshallJAXBElement(CodeAirportHeliportType.class, new QName("http://www.aixm.aero/schema/5.1", "type"), AirportHeliportTimeSliceType.class, target));
    }
    ...
    public void setCertifiedICAOItem(CodeYesNoType target) {
        setCertifiedICAO(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.1", "certifiedICAO"), AirportHeliportTimeSliceType.class, target));
    }
    ...
    public void setPrivateUseItem(CodeYesNoType target) {
        setPrivateUse(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.1", "privateUse"), AirportHeliportTimeSliceType.class, target));
    }
    ...
    public void setControlTypeItem(CodeMilitaryOperationsType target) {
        setControlType(XmlAdapterUtils.marshallJAXBElement(CodeMilitaryOperationsType.class, new QName("http://www.aixm.aero/schema/5.1", "controlType"), AirportHeliportTimeSliceType.class, target));
    }
    ...
    public void setFieldElevationItem(ValDistanceVerticalType target) {
        setFieldElevation(XmlAdapterUtils.marshallJAXBElement(ValDistanceVerticalType.class, new QName("http://www.aixm.aero/schema/5.1", "fieldElevation"), AirportHeliportTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "fieldelevationaccuracy", columnDefinition = "valdistanceverticalbase")),
        @AttributeOverride(name = "uom", column = @Column(name = "fieldelevationaccuracyuom", columnDefinition = "uomdistancevertical")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "fieldelevationaccuracynilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setFieldElevationAccuracyItem(ValDistanceVerticalType target) {
        setFieldElevationAccuracy(XmlAdapterUtils.marshallJAXBElement(ValDistanceVerticalType.class, new QName("http://www.aixm.aero/schema/5.1", "fieldElevationAccuracy"), AirportHeliportTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "verticaldatum", columnDefinition = "codeverticaldatumbase")),
    ...
    public void setVerticalDatumItem(CodeVerticalDatumType target) {
        setVerticalDatum(XmlAdapterUtils.marshallJAXBElement(CodeVerticalDatumType.class, new QName("http://www.aixm.aero/schema/5.1", "verticalDatum"), AirportHeliportTimeSliceType.class, target));
    }
    ...
    public void setMagneticVariationItem(ValMagneticVariationType target) {
        setMagneticVariation(XmlAdapterUtils.marshallJAXBElement(ValMagneticVariationType.class, new QName("http://www.aixm.aero/schema/5.1", "magneticVariation"), AirportHeliportTimeSliceType.class, target));
    }
    ...
    public void setMagneticVariationAccuracyItem(ValAngleType target) {
        setMagneticVariationAccuracy(XmlAdapterUtils.marshallJAXBElement(ValAngleType.class, new QName("http://www.aixm.aero/schema/5.1", "magneticVariationAccuracy"), AirportHeliportTimeSliceType.class, target));
    }
    ...
    public void setDateMagneticVariationItem(DateYearType target) {
        setDateMagneticVariation(XmlAdapterUtils.marshallJAXBElement(DateYearType.class, new QName("http://www.aixm.aero/schema/5.1", "dateMagneticVariation"), AirportHeliportTimeSliceType.class, target));
    }
    ...
    public void setMagneticVariationChangeItem(ValMagneticVariationChangeType target) {
        setMagneticVariationChange(XmlAdapterUtils.marshallJAXBElement(ValMagneticVariationChangeType.class, new QName("http://www.aixm.aero/schema/5.1", "magneticVariationChange"), AirportHeliportTimeSliceType.class, target));
    }
    ...
    public void setReferenceTemperatureItem(ValTemperatureType target) {
        setReferenceTemperature(XmlAdapterUtils.marshallJAXBElement(ValTemperatureType.class, new QName("http://www.aixm.aero/schema/5.1", "referenceTemperature"), AirportHeliportTimeSliceType.class, target));
    }
    ...
    public void setAltimeterCheckLocationItem(CodeYesNoType target) {
        setAltimeterCheckLocation(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.1", "altimeterCheckLocation"), AirportHeliportTimeSliceType.class, target));
    }
    ...
    public void setSecondaryPowerSupplyItem(CodeYesNoType target) {
        setSecondaryPowerSupply(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.1", "secondaryPowerSupply"), AirportHeliportTimeSliceType.class, target));
    }
    ...
    public void setWindDirectionIndicatorItem(CodeYesNoType target) {
        setWindDirectionIndicator(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.1", "windDirectionIndicator"), AirportHeliportTimeSliceType.class, target));
    }
    ...
    public void setLandingDirectionIndicatorItem(CodeYesNoType target) {
        setLandingDirectionIndicator(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.1", "landingDirectionIndicator"), AirportHeliportTimeSliceType.class, target));
    }
    ...
    public void setTransitionAltitudeItem(ValDistanceVerticalType target) {
        setTransitionAltitude(XmlAdapterUtils.marshallJAXBElement(ValDistanceVerticalType.class, new QName("http://www.aixm.aero/schema/5.1", "transitionAltitude"), AirportHeliportTimeSliceType.class, target));
    }
    ...
    public void setTransitionLevelItem(ValFLType target) {
        setTransitionLevel(XmlAdapterUtils.marshallJAXBElement(ValFLType.class, new QName("http://www.aixm.aero/schema/5.1", "transitionLevel"), AirportHeliportTimeSliceType.class, target));
    }
    ...
    public void setLowestTemperatureItem(ValTemperatureType target) {
        setLowestTemperature(XmlAdapterUtils.marshallJAXBElement(ValTemperatureType.class, new QName("http://www.aixm.aero/schema/5.1", "lowestTemperature"), AirportHeliportTimeSliceType.class, target));
    }
    ...
    public void setAbandonedItem(CodeYesNoType target) {
        setAbandoned(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.1", "abandoned"), AirportHeliportTimeSliceType.class, target));
    }
    ...
    public void setCertificationDateItem(DateType target) {
        setCertificationDate(XmlAdapterUtils.marshallJAXBElement(DateType.class, new QName("http://www.aixm.aero/schema/5.1", "certificationDate"), AirportHeliportTimeSliceType.class, target));
    }
    ...
    public void setCertificationExpirationDateItem(DateType target) {
        setCertificationExpirationDate(XmlAdapterUtils.marshallJAXBElement(DateType.class, new QName("http://www.aixm.aero/schema/5.1", "certificationExpirationDate"), AirportHeliportTimeSliceType.class, target));
    }
    ...
    public void setResponsibleOrganisationItem(AirportHeliportResponsibilityOrganisationPropertyType target) {
        setResponsibleOrganisation(XmlAdapterUtils.marshallJAXBElement(AirportHeliportResponsibilityOrganisationPropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "responsibleOrganisation"), AirportHeliportTimeSliceType.class, target));
    }
    ...
    public void setARPItem(AIXMElevatedPointPropertyType target) {
        setARP(XmlAdapterUtils.marshallJAXBElement(AIXMElevatedPointPropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "ARP"), AirportHeliportTimeSliceType.class, target));
    }
    ...
    public void setAviationBoundaryItem(AIXMElevatedSurfacePropertyType target) {
        setAviationBoundary(XmlAdapterUtils.marshallJAXBElement(AIXMElevatedSurfacePropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "aviationBoundary"), AirportHeliportTimeSliceType.class, target));
    }
