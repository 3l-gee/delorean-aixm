 ...
 *         <element ref=
"{http://www.aixm.aero/schema/5.1}AbstractWorkareaActivityExtension"/>
 *       </choice>
 *       <attGroup ref=
...
@XmlType(name = "", propOrder = {"abstractPropertiesWithScheduleExtension", "abstractWorkareaActivityExtension"})
@Entity(name = "WorkareaActivityExtensionType")
@Table(name = "workareaactivity_oe", schema = "airport_heliport")
public class WorkareaActivityExtensionType implements Serializable, Equals, HashCode, ToString {
    ...
    /**
     * Gets the value of the abstractWorkareaActivityExtension property.
     *
     * @return possible object is {@link AbstractExtensionType }
     *
     */
    @OneToOne(targetEntity = AbstractExtensionType.class, cascade = {CascadeType.ALL}, fetch = FetchType.EAGER)
    @JoinColumn(name = "abstractworkareaactivityextension_hjid", referencedColumnName = "hjid")
    public AbstractExtensionType getAbstractWorkareaActivityExtension() {
        return abstractWorkareaActivityExtension;
    }

    /**
     * Sets the value of the abstractWorkareaActivityExtension property.
     *
     * @param value
     *            allowed object is {@link AbstractExtensionType }
     *
    ...
    @Transient
    public boolean isSetAbstractWorkareaActivityExtension() {
        return (this.abstractWorkareaActivityExtension != null);
    }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final WorkareaActivityExtensionType that = ((WorkareaActivityExtensionType) object);
        {
            ...
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "abstractWorkareaActivityExtension",
                    lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "abstractWorkareaActivityExtension",
                    rhsField);
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetAbstractWorkareaActivityExtension();
            AbstractExtensionType theField;
            theField = this.getAbstractWorkareaActivityExtension();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "abstractWorkareaActivityExtension",
                    theField);
            currentHashCode = strategy.hashCode(theFieldLocator, currentHashCode, theField, theFieldIsSet);
        }
        {
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        }
        {
            ...
            AbstractExtensionType theField;
            theField = this.getAbstractWorkareaActivityExtension();
            strategy.appendField(locator, this, "abstractWorkareaActivityExtension", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetOwns();
            boolean theField;
