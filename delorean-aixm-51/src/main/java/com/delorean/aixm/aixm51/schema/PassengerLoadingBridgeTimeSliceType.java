 ...
 *       <sequence>
 *         <element name="type" type="{http://www.aixm.aero/schema/5.1}CodeLoadingBridgeType" minOccurs="0"/>
 *         <element name="extent" type="{http://www.aixm.aero/schema/5.1}ElevatedSurfacePropertyType" minOccurs="0"/>
 *         <element name="associatedStand" type="{http://www.aixm.aero/schema/5.1}AircraftStandPropertyType" maxOccurs="unbounded" minOccurs="0"/>
    ...
    implements Serializable
{
    ...
    protected List<PassengerLoadingBridgeTimeSliceExtensionType> extension;
    ...
    public void setTypeItem(CodeLoadingBridgeType target) {
        setType(XmlAdapterUtils.marshallJAXBElement(CodeLoadingBridgeType.class, new QName("http://www.aixm.aero/schema/5.1", "type"), PassengerLoadingBridgeTimeSliceType.class, target));
    }
    ...
    public void setExtentItem(AIXMElevatedSurfacePropertyType target) {
        setExtent(XmlAdapterUtils.marshallJAXBElement(AIXMElevatedSurfacePropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "extent"), PassengerLoadingBridgeTimeSliceType.class, target));
    }
