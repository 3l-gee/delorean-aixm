...
@XmlType(name = "", propOrder = {"abstractIntermediateLegExtension", "abstractApproachLegExtension",
        "abstractSegmentLegExtension"})
@Entity(name = "IntermediateLegTimeSliceExtensionType")
@Table(name = "intermediateleg_te", schema = "procedure")
public class IntermediateLegTimeSliceExtensionType implements Serializable, Equals, HashCode, ToString {

    private static final long serialVersionUID = 20251104L;
    @XmlElement(name = "AbstractIntermediateLegExtension")
    protected AbstractExtensionType abstractIntermediateLegExtension;
    ...
    /**
     * Gets the value of the abstractIntermediateLegExtension property.
     *
    ...
    /**
     * Sets the value of the abstractIntermediateLegExtension property.
     *
     * @param value
     *            allowed object is {@link AbstractExtensionType }
     *
     */
    public void setAbstractIntermediateLegExtension(AbstractExtensionType value) {
        this.abstractIntermediateLegExtension = value;
    }

    @Transient
    public boolean isSetAbstractIntermediateLegExtension() {
        return (this.abstractIntermediateLegExtension != null);
    }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final IntermediateLegTimeSliceExtensionType that = ((IntermediateLegTimeSliceExtensionType) object);
        {
        ...
        }
        {
            ...
            lhsField = this.getAbstractIntermediateLegExtension();
            AbstractExtensionType rhsField;
            rhsField = that.getAbstractIntermediateLegExtension();
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "abstractIntermediateLegExtension",
                    lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "abstractIntermediateLegExtension",
                    rhsField);
            if (!strategy.equals(lhsFieldLocator, rhsFieldLocator, lhsField, rhsField, lhsFieldIsSet, rhsFieldIsSet)) {
                return false;
            }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetAbstractIntermediateLegExtension();
            AbstractExtensionType theField;
            theField = this.getAbstractIntermediateLegExtension();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "abstractIntermediateLegExtension",
                    theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            AbstractExtensionType theField;
            theField = this.getAbstractIntermediateLegExtension();
            strategy.appendField(locator, this, "abstractIntermediateLegExtension", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetAbstractApproachLegExtension();
            AbstractExtensionType theField;
