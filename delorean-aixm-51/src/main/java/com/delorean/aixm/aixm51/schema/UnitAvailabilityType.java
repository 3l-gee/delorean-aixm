...
/**
 * <p>Java class for UnitAvailabilityType complex type</p>.
 * 
 ...
 *                   <element ref="{http://www.aixm.aero/schema/5.1}AbstractUnitAvailabilityExtension"/>
 *                 </choice>
    ...
    implements Serializable
{
    ...
    @JoinTable(name = "untavlblttp_tmintrvl_l", schema = "organisation", joinColumns = {
        @JoinColumn(name = "unitavailability_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "untavlblttp_annttn_l", schema = "organisation", joinColumns = {
        @JoinColumn(name = "unitavailability_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "untavlblttp_spcldtathrt_l", schema = "organisation", joinColumns = {
        @JoinColumn(name = "unitavailability_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
     ...
     * 
     */
    @OneToMany(targetEntity = UnitAvailabilityExtensionType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    ...
    public void setOperationalStatusItem(CodeStatusOperationsType target) {
        setOperationalStatus(XmlAdapterUtils.marshallJAXBElement(CodeStatusOperationsType.class, new QName("http://www.aixm.aero/schema/5.1", "operationalStatus"), UnitAvailabilityType.class, target));
    }
