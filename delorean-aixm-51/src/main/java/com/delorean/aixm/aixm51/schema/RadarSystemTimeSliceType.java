 ...
 *       <sequence>
 *         <element name="type" type="{http://www.aixm.aero/schema/5.1}CodeRadarServiceType" minOccurs="0"/>
 *         <element name="model" type="{http://www.aixm.aero/schema/5.1}TextNameType" minOccurs="0"/>
 *         <element name="generalTerrainMonitor" type="{http://www.aixm.aero/schema/5.1}CodeYesNoType" minOccurs="0"/>
 *         <element name="broadcastIdentifier" type="{http://www.aixm.aero/schema/5.1}TextDesignatorType" minOccurs="0"/>
 *         <element name="radarEquipment" type="{http://www.aixm.aero/schema/5.1}RadarComponentPropertyType" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="office" type="{http://www.aixm.aero/schema/5.1}OrganisationAuthorityPropertyType" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="airportHeliport" type="{http://www.aixm.aero/schema/5.1}AirportHeliportPropertyType" minOccurs="0"/>
 *         <element name="PARRunway" type="{http://www.aixm.aero/schema/5.1}RunwayPropertyType" maxOccurs="unbounded" minOccurs="0"/>
    ...
    implements Serializable
{
    ...
    public void setTypeItem(CodeRadarServiceType target) {
        setType(XmlAdapterUtils.marshallJAXBElement(CodeRadarServiceType.class, new QName("http://www.aixm.aero/schema/5.1", "type"), RadarSystemTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "model", columnDefinition = "character3")),
    ...
    public void setModelItem(TextNameType target) {
        setModel(XmlAdapterUtils.marshallJAXBElement(TextNameType.class, new QName("http://www.aixm.aero/schema/5.1", "model"), RadarSystemTimeSliceType.class, target));
    }
    ...
    public void setGeneralTerrainMonitorItem(CodeYesNoType target) {
        setGeneralTerrainMonitor(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.1", "generalTerrainMonitor"), RadarSystemTimeSliceType.class, target));
    }
    ...
    public void setBroadcastIdentifierItem(TextDesignatorType target) {
        setBroadcastIdentifier(XmlAdapterUtils.marshallJAXBElement(TextDesignatorType.class, new QName("http://www.aixm.aero/schema/5.1", "broadcastIdentifier"), RadarSystemTimeSliceType.class, target));
    }
    ...
    public void setAirportHeliportItem(AirportHeliportPropertyType target) {
        setAirportHeliport(XmlAdapterUtils.marshallJAXBElement(AirportHeliportPropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "airportHeliport"), RadarSystemTimeSliceType.class, target));
    }
    ...
    public void setLocationItem(AIXMElevatedPointPropertyType target) {
        setLocation(XmlAdapterUtils.marshallJAXBElement(AIXMElevatedPointPropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "location"), RadarSystemTimeSliceType.class, target));
    }
