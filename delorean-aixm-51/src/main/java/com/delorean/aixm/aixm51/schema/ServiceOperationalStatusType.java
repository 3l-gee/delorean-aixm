...
/**
 * <p>Java class for ServiceOperationalStatusType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="ServiceOperationalStatusType">
 *   <complexContent>
 ...
 *         <element name="operationalStatus" type="{http://www.aixm.aero/schema/5.1}CodeStatusServiceType" minOccurs="0"/>
 ...
 *                   <element ref="{http://www.aixm.aero/schema/5.1}AbstractServiceOperationalStatusExtension"/>
 *                 </choice>
...
@XmlType(name = "ServiceOperationalStatusType", propOrder = {
    "timeInterval",
    "annotation",
...
@Entity(name = "ServiceOperationalStatusType")
@Table(name = "serviceoperationalstatus_o", schema = "service")
public class ServiceOperationalStatusType
    ...
    implements Serializable
{
    ...
    protected List<ServiceOperationalStatusExtensionType> extension;
    ...
    @JoinTable(name = "srvcoprtnlsttstp_tmintrvl_link", schema = "service", joinColumns = {
        @JoinColumn(name = "serviceoperationalstatus_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "srvcoprtnlsttstp_annttn_link", schema = "service", joinColumns = {
        @JoinColumn(name = "serviceoperationalstatus_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "srvcoprtnlsttstp_spcldtathrt_link", schema = "service", joinColumns = {
        @JoinColumn(name = "serviceoperationalstatus_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link ServiceOperationalStatusExtensionType }
     * 
     * 
     */
    @OneToMany(targetEntity = ServiceOperationalStatusExtensionType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinColumn(name = "serviceoperationalstatus_oe_hjid", referencedColumnName = "hjid")
    public List<ServiceOperationalStatusExtensionType> getExtension() {
        if (extension == null) {
     ...
     * 
     */
    public void setExtension(List<ServiceOperationalStatusExtensionType> extension) {
    ...
    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "operationalstatus", columnDefinition = "codestatusservicebase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "operationalstatusnilreason", columnDefinition = "nilreason"))
    })
    public CodeStatusServiceType getOperationalStatusItem() {
        return XmlAdapterUtils.unmarshallSource(CodeStatusServiceType.class, this.getOperationalStatus());
    }

    public void setOperationalStatusItem(CodeStatusServiceType target) {
        setOperationalStatus(XmlAdapterUtils.marshallJAXBElement(CodeStatusServiceType.class, new QName("http://www.aixm.aero/schema/5.1", "operationalStatus"), ServiceOperationalStatusType.class, target));
    }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        final ServiceOperationalStatusType that = ((ServiceOperationalStatusType) object);
        {
            ...
            List<ServiceOperationalStatusExtensionType> lhsField;
            lhsField = (this.isSetExtension()?this.getExtension():null);
            List<ServiceOperationalStatusExtensionType> rhsField;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        }
        {
            ...
            JAXBElement<CodeStatusServiceType> theField;
        ...
        }
        {
            ...
            List<ServiceOperationalStatusExtensionType> theField;
