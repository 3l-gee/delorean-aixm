 ...
 *       <sequence>
 *         <element name="designator" type="{http://www.aixm.aero/schema/5.1}TextNameType" minOccurs="0"/>
 *         <element name="status" type="{http://www.aixm.aero/schema/5.1}CodeStatusOperationsType" minOccurs="0"/>
 *         <element name="type" type="{http://www.aixm.aero/schema/5.1}CodeRoadType" minOccurs="0"/>
 *         <element name="abandoned" type="{http://www.aixm.aero/schema/5.1}CodeYesNoType" minOccurs="0"/>
 *         <element name="associatedAirport" type="{http://www.aixm.aero/schema/5.1}AirportHeliportPropertyType" minOccurs="0"/>
 *         <element name="surfaceProperties" type="{http://www.aixm.aero/schema/5.1}SurfaceCharacteristicsPropertyType" minOccurs="0"/>
 *         <element name="accessibleStand" type="{http://www.aixm.aero/schema/5.1}AircraftStandPropertyType" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="surfaceExtent" type="{http://www.aixm.aero/schema/5.1}ElevatedSurfacePropertyType" minOccurs="0"/>
...
@Table(name = "road_t", schema = "airport_heliport")
    ...
    implements Serializable
{
    ...
    protected List<RoadTimeSliceExtensionType> extension;
    ...
    @JoinTable(name = "rdtmslctp_accssblstnd_link", schema = "airport_heliport", joinColumns = {
        @JoinColumn(name = "road_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
        @JoinColumn(name = "accessiblestand_hjid", referencedColumnName = "hjid")
    })
    ...
    @JoinTable(name = "rdtmslctp_annttn_link", schema = "airport_heliport", joinColumns = {
        @JoinColumn(name = "road_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link RoadTimeSliceExtensionType }
     * 
     * 
     */
    @OneToMany(targetEntity = RoadTimeSliceExtensionType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinColumn(name = "road_te_hjid", referencedColumnName = "hjid")
    public List<RoadTimeSliceExtensionType> getExtension() {
        if (extension == null) {
     ...
     * 
     */
    public void setExtension(List<RoadTimeSliceExtensionType> extension) {
    ...
    public void setDesignatorItem(TextNameType target) {
        setDesignator(XmlAdapterUtils.marshallJAXBElement(TextNameType.class, new QName("http://www.aixm.aero/schema/5.1", "designator"), RoadTimeSliceType.class, target));
    }
    ...
    public void setStatusItem(CodeStatusOperationsType target) {
        setStatus(XmlAdapterUtils.marshallJAXBElement(CodeStatusOperationsType.class, new QName("http://www.aixm.aero/schema/5.1", "status"), RoadTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "type", columnDefinition = "coderoadbase")),
    ...
    public void setTypeItem(CodeRoadType target) {
        setType(XmlAdapterUtils.marshallJAXBElement(CodeRoadType.class, new QName("http://www.aixm.aero/schema/5.1", "type"), RoadTimeSliceType.class, target));
    }
    ...
    public void setAbandonedItem(CodeYesNoType target) {
        setAbandoned(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.1", "abandoned"), RoadTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = AirportHeliportPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "rdtmslctp_assctdarprt_link", schema = "airport_heliport", joinColumns = {
        @JoinColumn(name = "road_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setAssociatedAirportItem(AirportHeliportPropertyType target) {
        setAssociatedAirport(XmlAdapterUtils.marshallJAXBElement(AirportHeliportPropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "associatedAirport"), RoadTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = SurfaceCharacteristicsPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "rdtmslctp_srfcprprts_link", schema = "airport_heliport", joinColumns = {
        @JoinColumn(name = "road_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setSurfacePropertiesItem(SurfaceCharacteristicsPropertyType target) {
        setSurfaceProperties(XmlAdapterUtils.marshallJAXBElement(SurfaceCharacteristicsPropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "surfaceProperties"), RoadTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = AIXMElevatedSurfacePropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "rdtmslctp_srfcextnt_link", schema = "airport_heliport", joinColumns = {
        @JoinColumn(name = "road_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setSurfaceExtentItem(AIXMElevatedSurfacePropertyType target) {
        setSurfaceExtent(XmlAdapterUtils.marshallJAXBElement(AIXMElevatedSurfacePropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "surfaceExtent"), RoadTimeSliceType.class, target));
    }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        }
        {
            ...
            List<RoadTimeSliceExtensionType> lhsField;
            lhsField = (this.isSetExtension()?this.getExtension():null);
            List<RoadTimeSliceExtensionType> rhsField;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        }
        {
            ...
            List<RoadTimeSliceExtensionType> theField;
