...
/**
 * <p>
 * Java class for NavaidEquipmentDistanceType complex type
 * </p>
 * .
 *
 * <p>
 ...
 *         <element name="distanceAccuracy" type=
"{http://www.aixm.aero/schema/5.1}ValDistanceType" minOccurs="0"/>
 ...
 *                 <sequence>
 *                   <element ref=
"{http://www.aixm.aero/schema/5.1}AbstractNavaidEquipmentDistanceExtension"/>
 *                 </sequence>
 *                 <attGroup ref=
...
@XmlType(name = "NavaidEquipmentDistanceType", propOrder = {"distance", "distanceAccuracy", "annotation",
        "theNavaidEquipment", "extension"})
@Entity(name = "NavaidEquipmentDistanceType")
@Table(name = "navaidequipmentdistance_o", schema = "airport_heliport")
public class NavaidEquipmentDistanceType extends AbstractAIXMObjectType implements Serializable {
    ...
    @JoinTable(name = "nvdeqpmntdstnctp_annttn_link", schema = "airport_heliport", joinColumns = {
            @JoinColumn(name = "navaidequipmentdistance_o_hjid", referencedColumnName = "hjid")}, inverseJoinColumns = {
    ...
    @JoinTable(name = "nvdeqpmntdstnctp_thnvdeqpmnt_link", schema = "airport_heliport", joinColumns = {
            @JoinColumn(name = "navaidequipmentdistance_o_hjid", referencedColumnName = "hjid")}, inverseJoinColumns = {
    ...
    public void setDistanceItem(ValDistanceType target) {
        setDistance(XmlAdapterUtils.marshallJAXBElement(ValDistanceType.class,
                new QName("http://www.aixm.aero/schema/5.1", "distance"), NavaidEquipmentDistanceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
            @AttributeOverride(name = "value", column = @Column(name = "distanceaccuracy", columnDefinition = "NUMERIC")),
            @AttributeOverride(name = "uom", column = @Column(name = "distanceaccuracyuom")),
            @AttributeOverride(name = "nilReason", column = @Column(name = "distanceaccuracynilreason"))})
    ...
    public void setDistanceAccuracyItem(ValDistanceType target) {
        setDistanceAccuracy(XmlAdapterUtils.marshallJAXBElement(ValDistanceType.class,
                new QName("http://www.aixm.aero/schema/5.1", "distanceAccuracy"), NavaidEquipmentDistanceType.class,
                target));
    }
