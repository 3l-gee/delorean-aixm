 ...
 *         <element name="type" type="{http://www.aixm.aero/schema/5.1}CodeDMEType" minOccurs="0"/>
 *         <element name="channel" type="{http://www.aixm.aero/schema/5.1}CodeDMEChannelType" minOccurs="0"/>
 *         <element name="ghostFrequency" type="{http://www.aixm.aero/schema/5.1}ValFrequencyType" minOccurs="0"/>
 *         <element name="displace" type="{http://www.aixm.aero/schema/5.1}ValDistanceType" minOccurs="0"/>
    ...
    implements Serializable
{
    ...
    protected List<DMETimeSliceExtensionType> extension;
    ...
    @JoinTable(name = "dmetmslctp_athrt_link", schema = "navaids_point", joinColumns = {
    ...
    @JoinTable(name = "dmetmslctp_mntrng_link", schema = "navaids_point", joinColumns = {
        @JoinColumn(name = "dme_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "dmetmslctp_avlblt_link", schema = "navaids_point", joinColumns = {
        @JoinColumn(name = "dme_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "dmetmslctp_annttn_link", schema = "navaids_point", joinColumns = {
        @JoinColumn(name = "dme_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link DMETimeSliceExtensionType }
     * 
     * 
     */
    @OneToMany(targetEntity = DMETimeSliceExtensionType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinColumn(name = "dme_te_hjid", referencedColumnName = "hjid")
    public List<DMETimeSliceExtensionType> getExtension() {
        if (extension == null) {
     ...
     * 
     */
    public void setExtension(List<DMETimeSliceExtensionType> extension) {
    ...
    public void setDesignatorItem(CodeNavaidDesignatorType target) {
        setDesignator(XmlAdapterUtils.marshallJAXBElement(CodeNavaidDesignatorType.class, new QName("http://www.aixm.aero/schema/5.1", "designator"), DMETimeSliceType.class, target));
    }
    ...
    public void setAixmNameItem(TextNameType target) {
        setAixmName(XmlAdapterUtils.marshallJAXBElement(TextNameType.class, new QName("http://www.aixm.aero/schema/5.1", "name"), DMETimeSliceType.class, target));
    }
    ...
    public void setEmissionClassItem(CodeRadioEmissionType target) {
        setEmissionClass(XmlAdapterUtils.marshallJAXBElement(CodeRadioEmissionType.class, new QName("http://www.aixm.aero/schema/5.1", "emissionClass"), DMETimeSliceType.class, target));
    }
    ...
    public void setMobileItem(CodeYesNoType target) {
        setMobile(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.1", "mobile"), DMETimeSliceType.class, target));
    }
    ...
    public void setMagneticVariationItem(ValMagneticVariationType target) {
        setMagneticVariation(XmlAdapterUtils.marshallJAXBElement(ValMagneticVariationType.class, new QName("http://www.aixm.aero/schema/5.1", "magneticVariation"), DMETimeSliceType.class, target));
    }
    ...
    public void setMagneticVariationAccuracyItem(ValAngleType target) {
        setMagneticVariationAccuracy(XmlAdapterUtils.marshallJAXBElement(ValAngleType.class, new QName("http://www.aixm.aero/schema/5.1", "magneticVariationAccuracy"), DMETimeSliceType.class, target));
    }
    ...
    public void setDateMagneticVariationItem(DateYearType target) {
        setDateMagneticVariation(XmlAdapterUtils.marshallJAXBElement(DateYearType.class, new QName("http://www.aixm.aero/schema/5.1", "dateMagneticVariation"), DMETimeSliceType.class, target));
    }
    ...
    public void setFlightCheckedItem(CodeYesNoType target) {
        setFlightChecked(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.1", "flightChecked"), DMETimeSliceType.class, target));
    }

    @OneToOne(targetEntity = AIXMElevatedPointPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "dmetmslctp_lctn_link", schema = "navaids_point", joinColumns = {
        @JoinColumn(name = "dme_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setLocationItem(AIXMElevatedPointPropertyType target) {
        setLocation(XmlAdapterUtils.marshallJAXBElement(AIXMElevatedPointPropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "location"), DMETimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "type", columnDefinition = "codedmebase")),
    ...
    public void setTypeItem(CodeDMEType target) {
        setType(XmlAdapterUtils.marshallJAXBElement(CodeDMEType.class, new QName("http://www.aixm.aero/schema/5.1", "type"), DMETimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "channel", columnDefinition = "codedmechannelbase")),
    ...
    public void setChannelItem(CodeDMEChannelType target) {
        setChannel(XmlAdapterUtils.marshallJAXBElement(CodeDMEChannelType.class, new QName("http://www.aixm.aero/schema/5.1", "channel"), DMETimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "ghostfrequency", columnDefinition = "valfrequencybase")),
        @AttributeOverride(name = "uom", column = @Column(name = "ghostfrequencyuom", columnDefinition = "uomfrequency")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "ghostfrequencynilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setGhostFrequencyItem(ValFrequencyType target) {
        setGhostFrequency(XmlAdapterUtils.marshallJAXBElement(ValFrequencyType.class, new QName("http://www.aixm.aero/schema/5.1", "ghostFrequency"), DMETimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "displace", columnDefinition = "valdistancebase")),
        @AttributeOverride(name = "uom", column = @Column(name = "displaceuom", columnDefinition = "uomdistance")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "displacenilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setDisplaceItem(ValDistanceType target) {
        setDisplace(XmlAdapterUtils.marshallJAXBElement(ValDistanceType.class, new QName("http://www.aixm.aero/schema/5.1", "displace"), DMETimeSliceType.class, target));
    }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        }
        {
            ...
            List<DMETimeSliceExtensionType> lhsField;
            lhsField = (this.isSetExtension()?this.getExtension():null);
            List<DMETimeSliceExtensionType> rhsField;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        }
        {
            ...
            List<DMETimeSliceExtensionType> theField;
