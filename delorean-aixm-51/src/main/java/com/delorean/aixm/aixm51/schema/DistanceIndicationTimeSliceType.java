 ...
 *         <element name="type" type="{http://www.aixm.aero/schema/5.1}CodeDistanceIndicationType" minOccurs="0"/>
...
@Table(name = "distanceindication_t", schema = "navaids_point")
    ...
    implements Serializable
{
    ...
    protected List<DistanceIndicationTimeSliceExtensionType> extension;
    ...
    @JoinTable(name = "dstncindctntmslctp_annttn_link", schema = "navaids_point", joinColumns = {
        @JoinColumn(name = "distanceindication_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link DistanceIndicationTimeSliceExtensionType }
     * 
     * 
     */
    @OneToMany(targetEntity = DistanceIndicationTimeSliceExtensionType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinColumn(name = "distanceindication_te_hjid", referencedColumnName = "hjid")
    public List<DistanceIndicationTimeSliceExtensionType> getExtension() {
        if (extension == null) {
     ...
     * 
     */
    public void setExtension(List<DistanceIndicationTimeSliceExtensionType> extension) {
    ...
    public void setDistanceItem(ValDistanceType target) {
        setDistance(XmlAdapterUtils.marshallJAXBElement(ValDistanceType.class, new QName("http://www.aixm.aero/schema/5.1", "distance"), DistanceIndicationTimeSliceType.class, target));
    }
    ...
    public void setMinimumReceptionAltitudeItem(ValDistanceVerticalType target) {
        setMinimumReceptionAltitude(XmlAdapterUtils.marshallJAXBElement(ValDistanceVerticalType.class, new QName("http://www.aixm.aero/schema/5.1", "minimumReceptionAltitude"), DistanceIndicationTimeSliceType.class, target));
    }
    ...
    public void setTypeItem(CodeDistanceIndicationType target) {
        setType(XmlAdapterUtils.marshallJAXBElement(CodeDistanceIndicationType.class, new QName("http://www.aixm.aero/schema/5.1", "type"), DistanceIndicationTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = DesignatedPointPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "dstncindctntmslctp_fx_link", schema = "navaids_point", joinColumns = {
        @JoinColumn(name = "distanceindication_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setFixItem(DesignatedPointPropertyType target) {
        setFix(XmlAdapterUtils.marshallJAXBElement(DesignatedPointPropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "fix"), DistanceIndicationTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = DesignatedPointPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "dstncindctntmslctp_pntchcfxdsgntdpnt_link", schema = "navaids_point", joinColumns = {
        @JoinColumn(name = "distanceindication_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setPointChoiceFixDesignatedPointItem(DesignatedPointPropertyType target) {
        setPointChoiceFixDesignatedPoint(XmlAdapterUtils.marshallJAXBElement(DesignatedPointPropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "pointChoice_fixDesignatedPoint"), DistanceIndicationTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = NavaidPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "dstncindctntmslctp_pntchcnvdsstm_link", schema = "navaids_point", joinColumns = {
        @JoinColumn(name = "distanceindication_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setPointChoiceNavaidSystemItem(NavaidPropertyType target) {
        setPointChoiceNavaidSystem(XmlAdapterUtils.marshallJAXBElement(NavaidPropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "pointChoice_navaidSystem"), DistanceIndicationTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = TouchDownLiftOffPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "dstncindctntmslctp_pntchcamngpnt_link", schema = "navaids_point", joinColumns = {
        @JoinColumn(name = "distanceindication_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setPointChoiceAimingPointItem(TouchDownLiftOffPropertyType target) {
        setPointChoiceAimingPoint(XmlAdapterUtils.marshallJAXBElement(TouchDownLiftOffPropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "pointChoice_aimingPoint"), DistanceIndicationTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = RunwayCentrelinePointPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "dstncindctntmslctp_pntchcrnwpnt_link", schema = "navaids_point", joinColumns = {
        @JoinColumn(name = "distanceindication_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setPointChoiceRunwayPointItem(RunwayCentrelinePointPropertyType target) {
        setPointChoiceRunwayPoint(XmlAdapterUtils.marshallJAXBElement(RunwayCentrelinePointPropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "pointChoice_runwayPoint"), DistanceIndicationTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = AirportHeliportPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "dstncindctntmslctp_pntchcarprtrfrncpnt_link", schema = "navaids_point", joinColumns = {
        @JoinColumn(name = "distanceindication_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setPointChoiceAirportReferencePointItem(AirportHeliportPropertyType target) {
        setPointChoiceAirportReferencePoint(XmlAdapterUtils.marshallJAXBElement(AirportHeliportPropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "pointChoice_airportReferencePoint"), DistanceIndicationTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = AIXMPointPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "dstncindctntmslctp_pntchcpstn_link", schema = "navaids_point", joinColumns = {
        @JoinColumn(name = "distanceindication_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setPointChoicePositionItem(AIXMPointPropertyType target) {
        setPointChoicePosition(XmlAdapterUtils.marshallJAXBElement(AIXMPointPropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "pointChoice_position"), DistanceIndicationTimeSliceType.class, target));
    }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        }
        {
            ...
            List<DistanceIndicationTimeSliceExtensionType> lhsField;
            lhsField = (this.isSetExtension()?this.getExtension():null);
            List<DistanceIndicationTimeSliceExtensionType> rhsField;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        }
        {
            ...
            List<DistanceIndicationTimeSliceExtensionType> theField;
