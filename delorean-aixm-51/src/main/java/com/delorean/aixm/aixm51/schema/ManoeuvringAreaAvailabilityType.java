...
/**
 * <p>Java class for ManoeuvringAreaAvailabilityType complex type</p>.
 * 
 ...
 *         <element name="usage" type="{http://www.aixm.aero/schema/5.1}ManoeuvringAreaUsagePropertyType" maxOccurs="unbounded" minOccurs="0"/>
 ...
 *                   <element ref="{http://www.aixm.aero/schema/5.1}AbstractManoeuvringAreaAvailabilityExtension"/>
 *                 </choice>
    ...
    implements Serializable
{
    ...
    @JoinTable(name = "mnvrngaravlblttp_tmintrvl_l", schema = "airport_heliport", joinColumns = {
        @JoinColumn(name = "manoeuvringareaavailability_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "mnvrngaravlblttp_annttn_l", schema = "airport_heliport", joinColumns = {
        @JoinColumn(name = "manoeuvringareaavailability_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "mnvrngaravlblttp_spcldtathrt_l", schema = "airport_heliport", joinColumns = {
        @JoinColumn(name = "manoeuvringareaavailability_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "mnvrngaravlblttp_usg_l", schema = "airport_heliport", joinColumns = {
        @JoinColumn(name = "manoeuvringareaavailability_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
     ...
     * 
     */
    public void setUsage(List<ManoeuvringAreaUsagePropertyType> usage) {
        this.usage = usage;
    }
    ...
    public void setOperationalStatusItem(CodeStatusAirportType target) {
        setOperationalStatus(XmlAdapterUtils.marshallJAXBElement(CodeStatusAirportType.class, new QName("http://www.aixm.aero/schema/5.1", "operationalStatus"), ManoeuvringAreaAvailabilityType.class, target));
    }
    ...
    public void setWarningItem(CodeAirportWarningType target) {
        setWarning(XmlAdapterUtils.marshallJAXBElement(CodeAirportWarningType.class, new QName("http://www.aixm.aero/schema/5.1", "warning"), ManoeuvringAreaAvailabilityType.class, target));
    }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        }
        {
            ...
            List<ManoeuvringAreaUsagePropertyType> theField;
