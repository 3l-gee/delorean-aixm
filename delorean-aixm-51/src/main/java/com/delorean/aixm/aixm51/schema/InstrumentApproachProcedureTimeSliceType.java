    ...
    implements Serializable
{
    ...
    @JoinTable(name = "instrmntapprchprcdrtmslctp_arcrftchrctrstc_l", schema = "procedure", joinColumns = {
        @JoinColumn(name = "instrumentapproachprocedure_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "instrmntapprchprcdrtmslctp_fnlprfl_l", schema = "procedure", joinColumns = {
        @JoinColumn(name = "instrumentapproachprocedure_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
