 ...
 *       <sequence>
 *         <element name="communicationFailureInstruction" type="{http://www.aixm.aero/schema/5.1}TextInstructionType" minOccurs="0"/>
 *         <element name="instruction" type="{http://www.aixm.aero/schema/5.1}TextInstructionType" minOccurs="0"/>
 *         <element name="designCriteria" type="{http://www.aixm.aero/schema/5.1}CodeDesignStandardType" minOccurs="0"/>
 *         <element name="codingStandard" type="{http://www.aixm.aero/schema/5.1}CodeProcedureCodingStandardType" minOccurs="0"/>
 ...
 *         <element name="RNAV" type="{http://www.aixm.aero/schema/5.1}CodeYesNoType" minOccurs="0"/>
 *         <element name="availability" type="{http://www.aixm.aero/schema/5.1}ProcedureAvailabilityPropertyType" maxOccurs="unbounded" minOccurs="0"/>
 ...
 *         <element name="aircraftCharacteristic" type="{http://www.aixm.aero/schema/5.1}AircraftCharacteristicPropertyType" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="flightTransition" type="{http://www.aixm.aero/schema/5.1}ProcedureTransitionPropertyType" maxOccurs="unbounded" minOccurs="0"/>
 *         <choice>
 *           <element name="guidanceFacility_navaid" type="{http://www.aixm.aero/schema/5.1}NavaidPropertyType" minOccurs="0"/>
 *           <element name="guidanceFacility_specialNavigationSystem" type="{http://www.aixm.aero/schema/5.1}SpecialNavigationSystemPropertyType" minOccurs="0"/>
 *           <element name="guidanceFacility_radar" type="{http://www.aixm.aero/schema/5.1}RadarSystemPropertyType" minOccurs="0"/>
 *         </choice>
 *         <element name="annotation" type="{http://www.aixm.aero/schema/5.1}NotePropertyType" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="safeAltitude" type="{http://www.aixm.aero/schema/5.1}SafeAltitudeAreaPropertyType" minOccurs="0"/>
 *         <element name="approachPrefix" type="{http://www.aixm.aero/schema/5.1}CodeApproachPrefixType" minOccurs="0"/>
 *         <element name="approachType" type="{http://www.aixm.aero/schema/5.1}CodeApproachType" minOccurs="0"/>
 *         <element name="multipleIdentification" type="{http://www.aixm.aero/schema/5.1}CodeUpperAlphaType" minOccurs="0"/>
 *         <element name="copterTrack" type="{http://www.aixm.aero/schema/5.1}ValBearingType" minOccurs="0"/>
 *         <element name="circlingIdentification" type="{http://www.aixm.aero/schema/5.1}CodeUpperAlphaType" minOccurs="0"/>
 *         <element name="courseReversalInstruction" type="{http://www.aixm.aero/schema/5.1}TextInstructionType" minOccurs="0"/>
 *         <element name="additionalEquipment" type="{http://www.aixm.aero/schema/5.1}CodeApproachEquipmentAdditionalType" minOccurs="0"/>
 *         <element name="channelGNSS" type="{http://www.aixm.aero/schema/5.1}ValChannelNumberType" minOccurs="0"/>
 *         <element name="WAASReliable" type="{http://www.aixm.aero/schema/5.1}CodeYesNoType" minOccurs="0"/>
 *         <element name="landing" type="{http://www.aixm.aero/schema/5.1}LandingTakeoffAreaCollectionPropertyType" minOccurs="0"/>
 *         <element name="missedInstruction" type="{http://www.aixm.aero/schema/5.1}MissedApproachGroupPropertyType" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="finalProfile" type="{http://www.aixm.aero/schema/5.1}FinalProfilePropertyType" minOccurs="0"/>
    ...
    implements Serializable
{
    ...
    protected List<InstrumentApproachProcedureTimeSliceExtensionType> extension;
    ...
    @JoinTable(name = "instrmntapprchprcdrtmslctp_arcrftchrctrstc_link", schema = "procedure", joinColumns = {
        @JoinColumn(name = "instrumentapproachprocedure_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setCommunicationFailureInstructionItem(TextInstructionType target) {
        setCommunicationFailureInstruction(XmlAdapterUtils.marshallJAXBElement(TextInstructionType.class, new QName("http://www.aixm.aero/schema/5.1", "communicationFailureInstruction"), InstrumentApproachProcedureTimeSliceType.class, target));
    }
    ...
    public void setInstructionItem(TextInstructionType target) {
        setInstruction(XmlAdapterUtils.marshallJAXBElement(TextInstructionType.class, new QName("http://www.aixm.aero/schema/5.1", "instruction"), InstrumentApproachProcedureTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "designcriteria", columnDefinition = "codedesignstandardbase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "designcriterianilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setDesignCriteriaItem(CodeDesignStandardType target) {
        setDesignCriteria(XmlAdapterUtils.marshallJAXBElement(CodeDesignStandardType.class, new QName("http://www.aixm.aero/schema/5.1", "designCriteria"), InstrumentApproachProcedureTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "codingstandard", columnDefinition = "codeprocedurecodingstandardbase")),
    ...
    public void setCodingStandardItem(CodeProcedureCodingStandardType target) {
        setCodingStandard(XmlAdapterUtils.marshallJAXBElement(CodeProcedureCodingStandardType.class, new QName("http://www.aixm.aero/schema/5.1", "codingStandard"), InstrumentApproachProcedureTimeSliceType.class, target));
    }
    ...
    public void setFlightCheckedItem(CodeYesNoType target) {
        setFlightChecked(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.1", "flightChecked"), InstrumentApproachProcedureTimeSliceType.class, target));
    }
    ...
    public void setAixmNameItem(TextNameType target) {
        setAixmName(XmlAdapterUtils.marshallJAXBElement(TextNameType.class, new QName("http://www.aixm.aero/schema/5.1", "name"), InstrumentApproachProcedureTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "rnav", columnDefinition = "codeyesnobase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "rnavnilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setRNAVItem(CodeYesNoType target) {
        setRNAV(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.1", "RNAV"), InstrumentApproachProcedureTimeSliceType.class, target));
    }
    ...
    public void setGuidanceFacilityNavaidItem(NavaidPropertyType target) {
        setGuidanceFacilityNavaid(XmlAdapterUtils.marshallJAXBElement(NavaidPropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "guidanceFacility_navaid"), InstrumentApproachProcedureTimeSliceType.class, target));
    }
    ...
    public void setGuidanceFacilitySpecialNavigationSystemItem(SpecialNavigationSystemPropertyType target) {
        setGuidanceFacilitySpecialNavigationSystem(XmlAdapterUtils.marshallJAXBElement(SpecialNavigationSystemPropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "guidanceFacility_specialNavigationSystem"), InstrumentApproachProcedureTimeSliceType.class, target));
    }
    ...
    public void setGuidanceFacilityRadarItem(RadarSystemPropertyType target) {
        setGuidanceFacilityRadar(XmlAdapterUtils.marshallJAXBElement(RadarSystemPropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "guidanceFacility_radar"), InstrumentApproachProcedureTimeSliceType.class, target));
    }
    ...
    public void setSafeAltitudeItem(SafeAltitudeAreaPropertyType target) {
        setSafeAltitude(XmlAdapterUtils.marshallJAXBElement(SafeAltitudeAreaPropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "safeAltitude"), InstrumentApproachProcedureTimeSliceType.class, target));
    }
    ...
    public void setApproachPrefixItem(CodeApproachPrefixType target) {
        setApproachPrefix(XmlAdapterUtils.marshallJAXBElement(CodeApproachPrefixType.class, new QName("http://www.aixm.aero/schema/5.1", "approachPrefix"), InstrumentApproachProcedureTimeSliceType.class, target));
    }
    ...
    public void setApproachTypeItem(CodeApproachType target) {
        setApproachType(XmlAdapterUtils.marshallJAXBElement(CodeApproachType.class, new QName("http://www.aixm.aero/schema/5.1", "approachType"), InstrumentApproachProcedureTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "multipleidentification", columnDefinition = "codeupperalphabase")),
    ...
    public void setMultipleIdentificationItem(CodeUpperAlphaType target) {
        setMultipleIdentification(XmlAdapterUtils.marshallJAXBElement(CodeUpperAlphaType.class, new QName("http://www.aixm.aero/schema/5.1", "multipleIdentification"), InstrumentApproachProcedureTimeSliceType.class, target));
    }
    ...
    public void setCopterTrackItem(ValBearingType target) {
        setCopterTrack(XmlAdapterUtils.marshallJAXBElement(ValBearingType.class, new QName("http://www.aixm.aero/schema/5.1", "copterTrack"), InstrumentApproachProcedureTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "circlingidentification", columnDefinition = "codeupperalphabase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "circlingidentificationnilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setCirclingIdentificationItem(CodeUpperAlphaType target) {
        setCirclingIdentification(XmlAdapterUtils.marshallJAXBElement(CodeUpperAlphaType.class, new QName("http://www.aixm.aero/schema/5.1", "circlingIdentification"), InstrumentApproachProcedureTimeSliceType.class, target));
    }
    ...
    public void setCourseReversalInstructionItem(TextInstructionType target) {
        setCourseReversalInstruction(XmlAdapterUtils.marshallJAXBElement(TextInstructionType.class, new QName("http://www.aixm.aero/schema/5.1", "courseReversalInstruction"), InstrumentApproachProcedureTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "additionalequipment", columnDefinition = "codeapproachequipmentadditionalbase")),
    ...
    public void setAdditionalEquipmentItem(CodeApproachEquipmentAdditionalType target) {
        setAdditionalEquipment(XmlAdapterUtils.marshallJAXBElement(CodeApproachEquipmentAdditionalType.class, new QName("http://www.aixm.aero/schema/5.1", "additionalEquipment"), InstrumentApproachProcedureTimeSliceType.class, target));
    }
    ...
    public void setChannelGNSSItem(ValChannelNumberType target) {
        setChannelGNSS(XmlAdapterUtils.marshallJAXBElement(ValChannelNumberType.class, new QName("http://www.aixm.aero/schema/5.1", "channelGNSS"), InstrumentApproachProcedureTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "waasreliable", columnDefinition = "codeyesnobase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "waasreliablenilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setWAASReliableItem(CodeYesNoType target) {
        setWAASReliable(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.1", "WAASReliable"), InstrumentApproachProcedureTimeSliceType.class, target));
    }
    ...
    public void setLandingItem(LandingTakeoffAreaCollectionPropertyType target) {
        setLanding(XmlAdapterUtils.marshallJAXBElement(LandingTakeoffAreaCollectionPropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "landing"), InstrumentApproachProcedureTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = FinalProfilePropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "instrmntapprchprcdrtmslctp_fnlprfl_link", schema = "procedure", joinColumns = {
        @JoinColumn(name = "instrumentapproachprocedure_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
        @JoinColumn(name = "finalprofile_hjid", referencedColumnName = "hjid")
    })
    ...
    public void setFinalProfileItem(FinalProfilePropertyType target) {
        setFinalProfile(XmlAdapterUtils.marshallJAXBElement(FinalProfilePropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "finalProfile"), InstrumentApproachProcedureTimeSliceType.class, target));
    }
