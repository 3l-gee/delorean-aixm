 ...
 *       <sequence>
 *         <element name="measurementPoint" type="{http://www.aixm.aero/schema/5.1}CodeProcedureDistanceType" minOccurs="0"/>
...
@Table(name = "approachaltitudetable_o", schema = "procedure")
    ...
    implements Serializable
{
    ...
    @JoinTable(name = "apprchalttdtbltp_annttn_link", schema = "procedure", joinColumns = {
        @JoinColumn(name = "approachaltitudetable_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "measurementpoint", columnDefinition = "codeproceduredistancebase")),
    ...
    public void setMeasurementPointItem(CodeProcedureDistanceType target) {
        setMeasurementPoint(XmlAdapterUtils.marshallJAXBElement(CodeProcedureDistanceType.class, new QName("http://www.aixm.aero/schema/5.1", "measurementPoint"), ApproachAltitudeTableType.class, target));
    }
    ...
    public void setAltitudeItem(ValDistanceVerticalType target) {
        setAltitude(XmlAdapterUtils.marshallJAXBElement(ValDistanceVerticalType.class, new QName("http://www.aixm.aero/schema/5.1", "altitude"), ApproachAltitudeTableType.class, target));
    }
    ...
    public void setAltitudeReferenceItem(CodeVerticalReferenceType target) {
        setAltitudeReference(XmlAdapterUtils.marshallJAXBElement(CodeVerticalReferenceType.class, new QName("http://www.aixm.aero/schema/5.1", "altitudeReference"), ApproachAltitudeTableType.class, target));
    }
