 ...
 *         <element name="taxiwayLocation" type="{http://www.aixm.aero/schema/5.1}TaxiwayPropertyType" minOccurs="0"/>
 *         <element name="standLocation" type="{http://www.aixm.aero/schema/5.1}AircraftStandPropertyType" minOccurs="0"/>
    ...
    implements Serializable
{
    ...
    public void setAssociatedApronItem(ApronPropertyType target) {
        setAssociatedApron(XmlAdapterUtils.marshallJAXBElement(ApronPropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "associatedApron"), DeicingAreaTimeSliceType.class, target));
    }
    ...
    public void setTaxiwayLocationItem(TaxiwayPropertyType target) {
        setTaxiwayLocation(XmlAdapterUtils.marshallJAXBElement(TaxiwayPropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "taxiwayLocation"), DeicingAreaTimeSliceType.class, target));
    }
    ...
    public void setStandLocationItem(AircraftStandPropertyType target) {
        setStandLocation(XmlAdapterUtils.marshallJAXBElement(AircraftStandPropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "standLocation"), DeicingAreaTimeSliceType.class, target));
    }
    ...
    public void setSurfacePropertiesItem(SurfaceCharacteristicsPropertyType target) {
        setSurfaceProperties(XmlAdapterUtils.marshallJAXBElement(SurfaceCharacteristicsPropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "surfaceProperties"), DeicingAreaTimeSliceType.class, target));
    }
    ...
    public void setExtentItem(AIXMElevatedSurfacePropertyType target) {
        setExtent(XmlAdapterUtils.marshallJAXBElement(AIXMElevatedSurfacePropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "extent"), DeicingAreaTimeSliceType.class, target));
    }
