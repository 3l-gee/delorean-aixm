package com.delorean.aixm.aixm51.engine;
...
@Slf4j
public class Aixm51Engine extends com.delorean.aixm.core.engine.AbstractEngine<AIXMBasicMessageType, BasicMessageMemberAIXMPropertyType, AbstractAIXMFeatureType, AbstractAIXMTimeSliceType, AbstractAIXMObjectType, Aixm51FilterConfig> {
    ...
    public <FTYPE extends AbstractAIXMFeatureType> FTYPE diffAixmFeature(Class<FTYPE> featureType, AbstractAIXMFeatureType feature) {
        ...
        List<AbstractAIXMTimeSliceType> listFullTimeSlice = Aixm51TimeSliceEngine.invokeTimeSlice(feature);
        ...
        for (int i = 1; i < listFullTimeSlice.size(); i++) {
            ...
            Aixm51TimeSliceEngine.injectTimeSlice((AbstractAIXMFeatureType) diffFeature, diffTimeSlice);
        }
