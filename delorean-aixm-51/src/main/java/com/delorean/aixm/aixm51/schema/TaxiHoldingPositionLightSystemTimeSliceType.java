 ...
 *         <element name="type" type="{http://www.aixm.aero/schema/5.1}CodeLightHoldingPositionType" minOccurs="0"/>
 *         <element name="taxiHolding" type="{http://www.aixm.aero/schema/5.1}TaxiHoldingPositionPropertyType" minOccurs="0"/>
    ...
    implements Serializable
{
    ...
    @JoinTable(name = "txhldngpstnlghtsstmtmslctp_elmnt_link", schema = "airport_heliport", joinColumns = {
    ...
    @JoinTable(name = "txhldngpstnlghtsstmtmslctp_avlblt_link", schema = "airport_heliport", joinColumns = {
        @JoinColumn(name = "taxiholdingpositionlightsystem_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "txhldngpstnlghtsstmtmslctp_annttn_link", schema = "airport_heliport", joinColumns = {
        @JoinColumn(name = "taxiholdingpositionlightsystem_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setEmergencyLightingItem(CodeYesNoType target) {
        setEmergencyLighting(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.1", "emergencyLighting"), TaxiHoldingPositionLightSystemTimeSliceType.class, target));
    }
    ...
    public void setIntensityLevelItem(CodeLightIntensityType target) {
        setIntensityLevel(XmlAdapterUtils.marshallJAXBElement(CodeLightIntensityType.class, new QName("http://www.aixm.aero/schema/5.1", "intensityLevel"), TaxiHoldingPositionLightSystemTimeSliceType.class, target));
    }
    ...
    public void setColourItem(CodeColourType target) {
        setColour(XmlAdapterUtils.marshallJAXBElement(CodeColourType.class, new QName("http://www.aixm.aero/schema/5.1", "colour"), TaxiHoldingPositionLightSystemTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "type", columnDefinition = "codelightholdingpositionbase")),
    ...
    public void setTypeItem(CodeLightHoldingPositionType target) {
        setType(XmlAdapterUtils.marshallJAXBElement(CodeLightHoldingPositionType.class, new QName("http://www.aixm.aero/schema/5.1", "type"), TaxiHoldingPositionLightSystemTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = TaxiHoldingPositionPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "txhldngpstnlghtsstmtmslctp_txhldng_link", schema = "airport_heliport", joinColumns = {
        @JoinColumn(name = "taxiholdingpositionlightsystem_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setTaxiHoldingItem(TaxiHoldingPositionPropertyType target) {
        setTaxiHolding(XmlAdapterUtils.marshallJAXBElement(TaxiHoldingPositionPropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "taxiHolding"), TaxiHoldingPositionLightSystemTimeSliceType.class, target));
    }
