 ...
 *         <element name="position" type="{http://www.aixm.aero/schema/5.1}CodeTLOFSectionType" minOccurs="0"/>
 *         <element name="lightedTouchDownLiftOff" type="{http://www.aixm.aero/schema/5.1}TouchDownLiftOffPropertyType" minOccurs="0"/>
    ...
    implements Serializable
{
    ...
    protected List<TouchDownLiftOffLightSystemTimeSliceExtensionType> extension;
    ...
    public void setEmergencyLightingItem(CodeYesNoType target) {
        setEmergencyLighting(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.1", "emergencyLighting"), TouchDownLiftOffLightSystemTimeSliceType.class, target));
    }
    ...
    public void setIntensityLevelItem(CodeLightIntensityType target) {
        setIntensityLevel(XmlAdapterUtils.marshallJAXBElement(CodeLightIntensityType.class, new QName("http://www.aixm.aero/schema/5.1", "intensityLevel"), TouchDownLiftOffLightSystemTimeSliceType.class, target));
    }
    ...
    public void setColourItem(CodeColourType target) {
        setColour(XmlAdapterUtils.marshallJAXBElement(CodeColourType.class, new QName("http://www.aixm.aero/schema/5.1", "colour"), TouchDownLiftOffLightSystemTimeSliceType.class, target));
    }
    ...
    public void setPositionItem(CodeTLOFSectionType target) {
        setPosition(XmlAdapterUtils.marshallJAXBElement(CodeTLOFSectionType.class, new QName("http://www.aixm.aero/schema/5.1", "position"), TouchDownLiftOffLightSystemTimeSliceType.class, target));
    }
    ...
    public void setLightedTouchDownLiftOffItem(TouchDownLiftOffPropertyType target) {
        setLightedTouchDownLiftOff(XmlAdapterUtils.marshallJAXBElement(TouchDownLiftOffPropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "lightedTouchDownLiftOff"), TouchDownLiftOffLightSystemTimeSliceType.class, target));
    }
