...
/**
 * <p>
 * Java class for AuthorityForNavaidEquipmentType complex type
 * </p>
 * .
 *
 * <p>
...
@XmlType(name = "AuthorityForNavaidEquipmentType", propOrder = {"type", "annotation", "theOrganisationAuthority",
        "extension"})
@Entity(name = "AuthorityForNavaidEquipmentType")
@Table(name = "authorityfornavaidequipment_o", schema = "navaids_point")
public class AuthorityForNavaidEquipmentType extends AbstractAIXMObjectType implements Serializable {
    ...
    @JoinTable(name = "athrtfrnvdeqpmnttp_annttn_link", schema = "navaids_point", joinColumns = {
            @JoinColumn(name = "authorityfornavaidequipment_o_hjid", referencedColumnName = "hjid")}, inverseJoinColumns = {
    ...
    public void setTypeItem(CodeAuthorityRoleType target) {
        setType(XmlAdapterUtils.marshallJAXBElement(CodeAuthorityRoleType.class,
                new QName("http://www.aixm.aero/schema/5.1", "type"), AuthorityForNavaidEquipmentType.class, target));
    }
