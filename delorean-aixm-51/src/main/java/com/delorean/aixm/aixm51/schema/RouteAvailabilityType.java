 ...
 *         <element name="direction" type="{http://www.aixm.aero/schema/5.1}CodeDirectionType" minOccurs="0"/>
 *         <element name="cardinalDirection" type="{http://www.aixm.aero/schema/5.1}CodeCardinalDirectionType" minOccurs="0"/>
 *         <element name="status" type="{http://www.aixm.aero/schema/5.1}CodeRouteAvailabilityType" minOccurs="0"/>
 ...
 *                   <element ref="{http://www.aixm.aero/schema/5.1}AbstractRouteAvailabilityExtension"/>
 *                 </choice>
    ...
    implements Serializable
{
    ...
    @XmlElementRef(name = "direction", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class, required = false)
    ...
    @JoinTable(name = "rtavlblttp_tmintrvl_l", schema = "route", joinColumns = {
        @JoinColumn(name = "routeavailability_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "rtavlblttp_annttn_l", schema = "route", joinColumns = {
        @JoinColumn(name = "routeavailability_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "rtavlblttp_spcldtathrt_l", schema = "route", joinColumns = {
        @JoinColumn(name = "routeavailability_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "rtavlblttp_lvls_l", schema = "route", joinColumns = {
        @JoinColumn(name = "routeavailability_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "direction", columnDefinition = "codedirectionbase")),
    ...
    public void setDirectionItem(CodeDirectionType target) {
        setDirection(XmlAdapterUtils.marshallJAXBElement(CodeDirectionType.class, new QName("http://www.aixm.aero/schema/5.1", "direction"), RouteAvailabilityType.class, target));
    }
    ...
    public void setCardinalDirectionItem(CodeCardinalDirectionType target) {
        setCardinalDirection(XmlAdapterUtils.marshallJAXBElement(CodeCardinalDirectionType.class, new QName("http://www.aixm.aero/schema/5.1", "cardinalDirection"), RouteAvailabilityType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "status", columnDefinition = "coderouteavailabilitybase")),
    ...
    public void setStatusItem(CodeRouteAvailabilityType target) {
        setStatus(XmlAdapterUtils.marshallJAXBElement(CodeRouteAvailabilityType.class, new QName("http://www.aixm.aero/schema/5.1", "status"), RouteAvailabilityType.class, target));
    }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        }
        {
            ...
            JAXBElement<CodeRouteAvailabilityType> theField;
