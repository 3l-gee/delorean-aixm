 ...
 *       <sequence>
 *         <element name="flightConditions" type="{http://www.aixm.aero/schema/5.1}CodeMeteoConditionsType" minOccurs="0"/>
 *         <element name="visibility" type="{http://www.aixm.aero/schema/5.1}ValDistanceType" minOccurs="0"/>
 *         <element name="visibilityInterpretation" type="{http://www.aixm.aero/schema/5.1}CodeValueInterpretationType" minOccurs="0"/>
 *         <element name="runwayVisualRange" type="{http://www.aixm.aero/schema/5.1}ValDistanceType" minOccurs="0"/>
 *         <element name="runwayVisualRangeInterpretation" type="{http://www.aixm.aero/schema/5.1}CodeValueInterpretationType" minOccurs="0"/>
    ...
    implements Serializable
{
    ...
    public void setFlightConditionsItem(CodeMeteoConditionsType target) {
        setFlightConditions(XmlAdapterUtils.marshallJAXBElement(CodeMeteoConditionsType.class, new QName("http://www.aixm.aero/schema/5.1", "flightConditions"), MeteorologyType.class, target));
    }
    ...
    public void setVisibilityItem(ValDistanceType target) {
        setVisibility(XmlAdapterUtils.marshallJAXBElement(ValDistanceType.class, new QName("http://www.aixm.aero/schema/5.1", "visibility"), MeteorologyType.class, target));
    }
    ...
    public void setVisibilityInterpretationItem(CodeValueInterpretationType target) {
        setVisibilityInterpretation(XmlAdapterUtils.marshallJAXBElement(CodeValueInterpretationType.class, new QName("http://www.aixm.aero/schema/5.1", "visibilityInterpretation"), MeteorologyType.class, target));
    }
    ...
    public void setRunwayVisualRangeItem(ValDistanceType target) {
        setRunwayVisualRange(XmlAdapterUtils.marshallJAXBElement(ValDistanceType.class, new QName("http://www.aixm.aero/schema/5.1", "runwayVisualRange"), MeteorologyType.class, target));
    }
    ...
    public void setRunwayVisualRangeInterpretationItem(CodeValueInterpretationType target) {
        setRunwayVisualRangeInterpretation(XmlAdapterUtils.marshallJAXBElement(CodeValueInterpretationType.class, new QName("http://www.aixm.aero/schema/5.1", "runwayVisualRangeInterpretation"), MeteorologyType.class, target));
    }
