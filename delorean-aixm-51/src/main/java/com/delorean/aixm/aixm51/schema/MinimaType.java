 ...
 *       <sequence>
 *         <element name="altitude" type="{http://www.aixm.aero/schema/5.1}ValDistanceVerticalType" minOccurs="0"/>
 *         <element name="altitudeCode" type="{http://www.aixm.aero/schema/5.1}CodeMinimumAltitudeType" minOccurs="0"/>
 *         <element name="altitudeReference" type="{http://www.aixm.aero/schema/5.1}CodeVerticalReferenceType" minOccurs="0"/>
 *         <element name="height" type="{http://www.aixm.aero/schema/5.1}ValDistanceVerticalType" minOccurs="0"/>
 *         <element name="militaryHeight" type="{http://www.aixm.aero/schema/5.1}ValDistanceVerticalType" minOccurs="0"/>
 *         <element name="radioHeight" type="{http://www.aixm.aero/schema/5.1}ValDistanceVerticalType" minOccurs="0"/>
 *         <element name="heightCode" type="{http://www.aixm.aero/schema/5.1}CodeMinimumHeightType" minOccurs="0"/>
 *         <element name="heightReference" type="{http://www.aixm.aero/schema/5.1}CodeHeightReferenceType" minOccurs="0"/>
 *         <element name="visibility" type="{http://www.aixm.aero/schema/5.1}ValDistanceType" minOccurs="0"/>
 *         <element name="militaryVisibility" type="{http://www.aixm.aero/schema/5.1}ValDistanceType" minOccurs="0"/>
 *         <element name="mandatoryRVR" type="{http://www.aixm.aero/schema/5.1}CodeYesNoType" minOccurs="0"/>
 *         <element name="remoteAltimeterMinima" type="{http://www.aixm.aero/schema/5.1}CodeYesNoType" minOccurs="0"/>
 *         <element name="adjustmentINOP" type="{http://www.aixm.aero/schema/5.1}EquipmentUnavailableAdjustmentPropertyType" maxOccurs="unbounded" minOccurs="0"/>
    ...
    implements Serializable
{
    ...
    public void setAltitudeItem(ValDistanceVerticalType target) {
        setAltitude(XmlAdapterUtils.marshallJAXBElement(ValDistanceVerticalType.class, new QName("http://www.aixm.aero/schema/5.1", "altitude"), MinimaType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "altitudecode", columnDefinition = "codeminimumaltitudebase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "altitudecodenilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setAltitudeCodeItem(CodeMinimumAltitudeType target) {
        setAltitudeCode(XmlAdapterUtils.marshallJAXBElement(CodeMinimumAltitudeType.class, new QName("http://www.aixm.aero/schema/5.1", "altitudeCode"), MinimaType.class, target));
    }
    ...
    public void setAltitudeReferenceItem(CodeVerticalReferenceType target) {
        setAltitudeReference(XmlAdapterUtils.marshallJAXBElement(CodeVerticalReferenceType.class, new QName("http://www.aixm.aero/schema/5.1", "altitudeReference"), MinimaType.class, target));
    }
    ...
    public void setHeightItem(ValDistanceVerticalType target) {
        setHeight(XmlAdapterUtils.marshallJAXBElement(ValDistanceVerticalType.class, new QName("http://www.aixm.aero/schema/5.1", "height"), MinimaType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "militaryheight", columnDefinition = "valdistanceverticalbase")),
        @AttributeOverride(name = "uom", column = @Column(name = "militaryheightuom", columnDefinition = "uomdistancevertical")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "militaryheightnilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setMilitaryHeightItem(ValDistanceVerticalType target) {
        setMilitaryHeight(XmlAdapterUtils.marshallJAXBElement(ValDistanceVerticalType.class, new QName("http://www.aixm.aero/schema/5.1", "militaryHeight"), MinimaType.class, target));
    }
    ...
    public void setRadioHeightItem(ValDistanceVerticalType target) {
        setRadioHeight(XmlAdapterUtils.marshallJAXBElement(ValDistanceVerticalType.class, new QName("http://www.aixm.aero/schema/5.1", "radioHeight"), MinimaType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "heightcode", columnDefinition = "codeminimumheightbase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "heightcodenilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setHeightCodeItem(CodeMinimumHeightType target) {
        setHeightCode(XmlAdapterUtils.marshallJAXBElement(CodeMinimumHeightType.class, new QName("http://www.aixm.aero/schema/5.1", "heightCode"), MinimaType.class, target));
    }
    ...
    public void setHeightReferenceItem(CodeHeightReferenceType target) {
        setHeightReference(XmlAdapterUtils.marshallJAXBElement(CodeHeightReferenceType.class, new QName("http://www.aixm.aero/schema/5.1", "heightReference"), MinimaType.class, target));
    }
    ...
    public void setVisibilityItem(ValDistanceType target) {
        setVisibility(XmlAdapterUtils.marshallJAXBElement(ValDistanceType.class, new QName("http://www.aixm.aero/schema/5.1", "visibility"), MinimaType.class, target));
    }
    ...
    public void setMilitaryVisibilityItem(ValDistanceType target) {
        setMilitaryVisibility(XmlAdapterUtils.marshallJAXBElement(ValDistanceType.class, new QName("http://www.aixm.aero/schema/5.1", "militaryVisibility"), MinimaType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "mandatoryrvr", columnDefinition = "codeyesnobase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "mandatoryrvrnilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setMandatoryRVRItem(CodeYesNoType target) {
        setMandatoryRVR(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.1", "mandatoryRVR"), MinimaType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "remotealtimeterminima", columnDefinition = "codeyesnobase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "remotealtimeterminimanilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setRemoteAltimeterMinimaItem(CodeYesNoType target) {
        setRemoteAltimeterMinima(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.1", "remoteAltimeterMinima"), MinimaType.class, target));
    }
