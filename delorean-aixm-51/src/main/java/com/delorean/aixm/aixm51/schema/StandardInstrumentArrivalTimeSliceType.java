 ...
 *         <element name="designator" type="{http://www.aixm.aero/schema/5.1}TextSIDSTARDesignatorType" minOccurs="0"/>
 *         <element name="arrival" type="{http://www.aixm.aero/schema/5.1}LandingTakeoffAreaCollectionPropertyType" minOccurs="0"/>
    ...
    implements Serializable
{
    ...
    protected List<StandardInstrumentArrivalTimeSliceExtensionType> extension;
    ...
    @JoinTable(name = "stndrdinstrmntarrvltmslctp_avlblt_link", schema = "procedure", joinColumns = {
    ...
    @JoinTable(name = "stndrdinstrmntarrvltmslctp_arprthlprt_link", schema = "procedure", joinColumns = {
        @JoinColumn(name = "standardinstrumentarrival_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "stndrdinstrmntarrvltmslctp_arcrftchrctrstc_link", schema = "procedure", joinColumns = {
        @JoinColumn(name = "standardinstrumentarrival_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "stndrdinstrmntarrvltmslctp_flghttrnstn_link", schema = "procedure", joinColumns = {
        @JoinColumn(name = "standardinstrumentarrival_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "stndrdinstrmntarrvltmslctp_annttn_link", schema = "procedure", joinColumns = {
        @JoinColumn(name = "standardinstrumentarrival_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
     ...
     * 
     */
    @OneToMany(targetEntity = StandardInstrumentArrivalTimeSliceExtensionType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinColumn(name = "standardinstrumentarrival_te_hjid", referencedColumnName = "hjid")
    public List<StandardInstrumentArrivalTimeSliceExtensionType> getExtension() {
        if (extension == null) {
     ...
     * 
     */
    public void setExtension(List<StandardInstrumentArrivalTimeSliceExtensionType> extension) {
    ...
    public void setCommunicationFailureInstructionItem(TextInstructionType target) {
        setCommunicationFailureInstruction(XmlAdapterUtils.marshallJAXBElement(TextInstructionType.class, new QName("http://www.aixm.aero/schema/5.1", "communicationFailureInstruction"), StandardInstrumentArrivalTimeSliceType.class, target));
    }
    ...
    public void setInstructionItem(TextInstructionType target) {
        setInstruction(XmlAdapterUtils.marshallJAXBElement(TextInstructionType.class, new QName("http://www.aixm.aero/schema/5.1", "instruction"), StandardInstrumentArrivalTimeSliceType.class, target));
    }
    ...
    public void setDesignCriteriaItem(CodeDesignStandardType target) {
        setDesignCriteria(XmlAdapterUtils.marshallJAXBElement(CodeDesignStandardType.class, new QName("http://www.aixm.aero/schema/5.1", "designCriteria"), StandardInstrumentArrivalTimeSliceType.class, target));
    }
    ...
    public void setCodingStandardItem(CodeProcedureCodingStandardType target) {
        setCodingStandard(XmlAdapterUtils.marshallJAXBElement(CodeProcedureCodingStandardType.class, new QName("http://www.aixm.aero/schema/5.1", "codingStandard"), StandardInstrumentArrivalTimeSliceType.class, target));
    }
    ...
    public void setFlightCheckedItem(CodeYesNoType target) {
        setFlightChecked(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.1", "flightChecked"), StandardInstrumentArrivalTimeSliceType.class, target));
    }
    ...
    public void setAixmNameItem(TextNameType target) {
        setAixmName(XmlAdapterUtils.marshallJAXBElement(TextNameType.class, new QName("http://www.aixm.aero/schema/5.1", "name"), StandardInstrumentArrivalTimeSliceType.class, target));
    }
    ...
    public void setRNAVItem(CodeYesNoType target) {
        setRNAV(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.1", "RNAV"), StandardInstrumentArrivalTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = NavaidPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "stndrdinstrmntarrvltmslctp_gdncfcltnvd_link", schema = "procedure", joinColumns = {
        @JoinColumn(name = "standardinstrumentarrival_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setGuidanceFacilityNavaidItem(NavaidPropertyType target) {
        setGuidanceFacilityNavaid(XmlAdapterUtils.marshallJAXBElement(NavaidPropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "guidanceFacility_navaid"), StandardInstrumentArrivalTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = SpecialNavigationSystemPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "stndrdinstrmntarrvltmslctp_gdncfcltspclnvgtnsstm_link", schema = "procedure", joinColumns = {
        @JoinColumn(name = "standardinstrumentarrival_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setGuidanceFacilitySpecialNavigationSystemItem(SpecialNavigationSystemPropertyType target) {
        setGuidanceFacilitySpecialNavigationSystem(XmlAdapterUtils.marshallJAXBElement(SpecialNavigationSystemPropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "guidanceFacility_specialNavigationSystem"), StandardInstrumentArrivalTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = RadarSystemPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "stndrdinstrmntarrvltmslctp_gdncfcltrdr_link", schema = "procedure", joinColumns = {
        @JoinColumn(name = "standardinstrumentarrival_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setGuidanceFacilityRadarItem(RadarSystemPropertyType target) {
        setGuidanceFacilityRadar(XmlAdapterUtils.marshallJAXBElement(RadarSystemPropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "guidanceFacility_radar"), StandardInstrumentArrivalTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = SafeAltitudeAreaPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "stndrdinstrmntarrvltmslctp_sfalttd_link", schema = "procedure", joinColumns = {
        @JoinColumn(name = "standardinstrumentarrival_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setSafeAltitudeItem(SafeAltitudeAreaPropertyType target) {
        setSafeAltitude(XmlAdapterUtils.marshallJAXBElement(SafeAltitudeAreaPropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "safeAltitude"), StandardInstrumentArrivalTimeSliceType.class, target));
    }
    ...
    public void setDesignatorItem(TextSIDSTARDesignatorType target) {
        setDesignator(XmlAdapterUtils.marshallJAXBElement(TextSIDSTARDesignatorType.class, new QName("http://www.aixm.aero/schema/5.1", "designator"), StandardInstrumentArrivalTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = LandingTakeoffAreaCollectionPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "stndrdinstrmntarrvltmslctp_arrvl_link", schema = "procedure", joinColumns = {
        @JoinColumn(name = "standardinstrumentarrival_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setArrivalItem(LandingTakeoffAreaCollectionPropertyType target) {
        setArrival(XmlAdapterUtils.marshallJAXBElement(LandingTakeoffAreaCollectionPropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "arrival"), StandardInstrumentArrivalTimeSliceType.class, target));
    }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        }
        {
            ...
            List<StandardInstrumentArrivalTimeSliceExtensionType> lhsField;
            lhsField = (this.isSetExtension()?this.getExtension():null);
            List<StandardInstrumentArrivalTimeSliceExtensionType> rhsField;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        }
        {
            ...
            List<StandardInstrumentArrivalTimeSliceExtensionType> theField;
