 ...
 *         <element name="angleNominal" type="{http://www.aixm.aero/schema/5.1}ValAngleType" minOccurs="0"/>
 *         <element name="angleMinimum" type="{http://www.aixm.aero/schema/5.1}ValAngleType" minOccurs="0"/>
 *         <element name="angleSpan" type="{http://www.aixm.aero/schema/5.1}ValAngleType" minOccurs="0"/>
...
@Table(name = "elevation_t", schema = "navaids_point")
    ...
    implements Serializable
{
    ...
    protected List<ElevationTimeSliceExtensionType> extension;
    ...
    @JoinTable(name = "elvtntmslctp_athrt_link", schema = "navaids_point", joinColumns = {
        @JoinColumn(name = "elevation_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "elvtntmslctp_mntrng_link", schema = "navaids_point", joinColumns = {
        @JoinColumn(name = "elevation_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "elvtntmslctp_avlblt_link", schema = "navaids_point", joinColumns = {
        @JoinColumn(name = "elevation_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "elvtntmslctp_annttn_link", schema = "navaids_point", joinColumns = {
        @JoinColumn(name = "elevation_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link ElevationTimeSliceExtensionType }
     * 
     * 
     */
    @OneToMany(targetEntity = ElevationTimeSliceExtensionType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinColumn(name = "elevation_te_hjid", referencedColumnName = "hjid")
    public List<ElevationTimeSliceExtensionType> getExtension() {
        if (extension == null) {
     ...
     * 
     */
    public void setExtension(List<ElevationTimeSliceExtensionType> extension) {
    ...
    public void setDesignatorItem(CodeNavaidDesignatorType target) {
        setDesignator(XmlAdapterUtils.marshallJAXBElement(CodeNavaidDesignatorType.class, new QName("http://www.aixm.aero/schema/5.1", "designator"), ElevationTimeSliceType.class, target));
    }
    ...
    public void setAixmNameItem(TextNameType target) {
        setAixmName(XmlAdapterUtils.marshallJAXBElement(TextNameType.class, new QName("http://www.aixm.aero/schema/5.1", "name"), ElevationTimeSliceType.class, target));
    }
    ...
    public void setEmissionClassItem(CodeRadioEmissionType target) {
        setEmissionClass(XmlAdapterUtils.marshallJAXBElement(CodeRadioEmissionType.class, new QName("http://www.aixm.aero/schema/5.1", "emissionClass"), ElevationTimeSliceType.class, target));
    }
    ...
    public void setMobileItem(CodeYesNoType target) {
        setMobile(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.1", "mobile"), ElevationTimeSliceType.class, target));
    }
    ...
    public void setMagneticVariationItem(ValMagneticVariationType target) {
        setMagneticVariation(XmlAdapterUtils.marshallJAXBElement(ValMagneticVariationType.class, new QName("http://www.aixm.aero/schema/5.1", "magneticVariation"), ElevationTimeSliceType.class, target));
    }
    ...
    public void setMagneticVariationAccuracyItem(ValAngleType target) {
        setMagneticVariationAccuracy(XmlAdapterUtils.marshallJAXBElement(ValAngleType.class, new QName("http://www.aixm.aero/schema/5.1", "magneticVariationAccuracy"), ElevationTimeSliceType.class, target));
    }
    ...
    public void setDateMagneticVariationItem(DateYearType target) {
        setDateMagneticVariation(XmlAdapterUtils.marshallJAXBElement(DateYearType.class, new QName("http://www.aixm.aero/schema/5.1", "dateMagneticVariation"), ElevationTimeSliceType.class, target));
    }
    ...
    public void setFlightCheckedItem(CodeYesNoType target) {
        setFlightChecked(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.1", "flightChecked"), ElevationTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = AIXMElevatedPointPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "elvtntmslctp_lctn_link", schema = "navaids_point", joinColumns = {
        @JoinColumn(name = "elevation_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setLocationItem(AIXMElevatedPointPropertyType target) {
        setLocation(XmlAdapterUtils.marshallJAXBElement(AIXMElevatedPointPropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "location"), ElevationTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "anglenominal", columnDefinition = "valanglebase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "anglenominalnilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setAngleNominalItem(ValAngleType target) {
        setAngleNominal(XmlAdapterUtils.marshallJAXBElement(ValAngleType.class, new QName("http://www.aixm.aero/schema/5.1", "angleNominal"), ElevationTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "angleminimum", columnDefinition = "valanglebase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "angleminimumnilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setAngleMinimumItem(ValAngleType target) {
        setAngleMinimum(XmlAdapterUtils.marshallJAXBElement(ValAngleType.class, new QName("http://www.aixm.aero/schema/5.1", "angleMinimum"), ElevationTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "anglespan", columnDefinition = "valanglebase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "anglespannilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setAngleSpanItem(ValAngleType target) {
        setAngleSpan(XmlAdapterUtils.marshallJAXBElement(ValAngleType.class, new QName("http://www.aixm.aero/schema/5.1", "angleSpan"), ElevationTimeSliceType.class, target));
    }
    ...
    public void setAngleAccuracyItem(ValAngleType target) {
        setAngleAccuracy(XmlAdapterUtils.marshallJAXBElement(ValAngleType.class, new QName("http://www.aixm.aero/schema/5.1", "angleAccuracy"), ElevationTimeSliceType.class, target));
    }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        }
        {
            ...
            List<ElevationTimeSliceExtensionType> lhsField;
            lhsField = (this.isSetExtension()?this.getExtension():null);
            List<ElevationTimeSliceExtensionType> rhsField;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        }
        {
            ...
            List<ElevationTimeSliceExtensionType> theField;
