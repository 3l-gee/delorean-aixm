 ...
 *         <element name="time" type="{http://www.aixm.aero/schema/5.1}ValDurationType" minOccurs="0"/>
...
@Table(name = "approachtimingtable_o", schema = "procedure")
    ...
    implements Serializable
{
    ...
    @JoinTable(name = "apprchtmngtbltp_annttn_link", schema = "procedure", joinColumns = {
        @JoinColumn(name = "approachtimingtable_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setStartingMeasurementPointItem(CodeProcedureDistanceType target) {
        setStartingMeasurementPoint(XmlAdapterUtils.marshallJAXBElement(CodeProcedureDistanceType.class, new QName("http://www.aixm.aero/schema/5.1", "startingMeasurementPoint"), ApproachTimingTableType.class, target));
    }
    ...
    public void setEndingMeasurementPointItem(CodeProcedureDistanceType target) {
        setEndingMeasurementPoint(XmlAdapterUtils.marshallJAXBElement(CodeProcedureDistanceType.class, new QName("http://www.aixm.aero/schema/5.1", "endingMeasurementPoint"), ApproachTimingTableType.class, target));
    }
    ...
    public void setTimeItem(ValDurationType target) {
        setTime(XmlAdapterUtils.marshallJAXBElement(ValDurationType.class, new QName("http://www.aixm.aero/schema/5.1", "time"), ApproachTimingTableType.class, target));
    }
    ...
    public void setSpeedItem(ValSpeedType target) {
        setSpeed(XmlAdapterUtils.marshallJAXBElement(ValSpeedType.class, new QName("http://www.aixm.aero/schema/5.1", "speed"), ApproachTimingTableType.class, target));
    }
