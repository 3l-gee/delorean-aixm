 ...
 *         <element name="class" type="{http://www.aixm.aero/schema/5.1}CodeNDBUsageType" minOccurs="0"/>
 *         <element name="emissionBand" type="{http://www.aixm.aero/schema/5.1}CodeEmissionBandType" minOccurs="0"/>
...
@Entity(name = "NDBTimeSliceType")
@Table(name = "ndb_t", schema = "navaids_point")
    ...
    implements Serializable
{
    ...
    @XmlElementRef(name = "emissionBand", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class, required = false)
    protected JAXBElement<CodeEmissionBandType> emissionBand;
    protected List<NDBTimeSliceExtensionType> extension;
    ...
    @JoinTable(name = "ndbtmslctp_athrt_link", schema = "navaids_point", joinColumns = {
        @JoinColumn(name = "ndb_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "ndbtmslctp_mntrng_link", schema = "navaids_point", joinColumns = {
        @JoinColumn(name = "ndb_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "ndbtmslctp_avlblt_link", schema = "navaids_point", joinColumns = {
        @JoinColumn(name = "ndb_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "ndbtmslctp_annttn_link", schema = "navaids_point", joinColumns = {
        @JoinColumn(name = "ndb_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link CodeNDBUsageType }{@code >}
     *     
     */
    @Transient
    public JAXBElement<CodeNDBUsageType> getClazz() {
        return clazz;
    }
     ...
     *     
     */
    public void setClazz(JAXBElement<CodeNDBUsageType> value) {
        this.clazz = value;
    }
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link CodeEmissionBandType }{@code >}
     *     
     */
    @Transient
    public JAXBElement<CodeEmissionBandType> getEmissionBand() {
        return emissionBand;
    }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link NDBTimeSliceExtensionType }
     * 
     * 
     */
    @OneToMany(targetEntity = NDBTimeSliceExtensionType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinColumn(name = "ndb_te_hjid", referencedColumnName = "hjid")
    public List<NDBTimeSliceExtensionType> getExtension() {
        if (extension == null) {
     ...
     * 
     */
    public void setExtension(List<NDBTimeSliceExtensionType> extension) {
    ...
    public void setDesignatorItem(CodeNavaidDesignatorType target) {
        setDesignator(XmlAdapterUtils.marshallJAXBElement(CodeNavaidDesignatorType.class, new QName("http://www.aixm.aero/schema/5.1", "designator"), NDBTimeSliceType.class, target));
    }
    ...
    public void setAixmNameItem(TextNameType target) {
        setAixmName(XmlAdapterUtils.marshallJAXBElement(TextNameType.class, new QName("http://www.aixm.aero/schema/5.1", "name"), NDBTimeSliceType.class, target));
    }
    ...
    public void setEmissionClassItem(CodeRadioEmissionType target) {
        setEmissionClass(XmlAdapterUtils.marshallJAXBElement(CodeRadioEmissionType.class, new QName("http://www.aixm.aero/schema/5.1", "emissionClass"), NDBTimeSliceType.class, target));
    }
    ...
    public void setMobileItem(CodeYesNoType target) {
        setMobile(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.1", "mobile"), NDBTimeSliceType.class, target));
    }
    ...
    public void setMagneticVariationItem(ValMagneticVariationType target) {
        setMagneticVariation(XmlAdapterUtils.marshallJAXBElement(ValMagneticVariationType.class, new QName("http://www.aixm.aero/schema/5.1", "magneticVariation"), NDBTimeSliceType.class, target));
    }
    ...
    public void setMagneticVariationAccuracyItem(ValAngleType target) {
        setMagneticVariationAccuracy(XmlAdapterUtils.marshallJAXBElement(ValAngleType.class, new QName("http://www.aixm.aero/schema/5.1", "magneticVariationAccuracy"), NDBTimeSliceType.class, target));
    }
    ...
    public void setDateMagneticVariationItem(DateYearType target) {
        setDateMagneticVariation(XmlAdapterUtils.marshallJAXBElement(DateYearType.class, new QName("http://www.aixm.aero/schema/5.1", "dateMagneticVariation"), NDBTimeSliceType.class, target));
    }
    ...
    public void setFlightCheckedItem(CodeYesNoType target) {
        setFlightChecked(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.1", "flightChecked"), NDBTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = AIXMElevatedPointPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "ndbtmslctp_lctn_link", schema = "navaids_point", joinColumns = {
        @JoinColumn(name = "ndb_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setLocationItem(AIXMElevatedPointPropertyType target) {
        setLocation(XmlAdapterUtils.marshallJAXBElement(AIXMElevatedPointPropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "location"), NDBTimeSliceType.class, target));
    }
    ...
    public void setFrequencyItem(ValFrequencyType target) {
        setFrequency(XmlAdapterUtils.marshallJAXBElement(ValFrequencyType.class, new QName("http://www.aixm.aero/schema/5.1", "frequency"), NDBTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "class", columnDefinition = "codendbusagebase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "classnilreason", columnDefinition = "nilreason"))
    })
    public CodeNDBUsageType getClazzItem() {
        return XmlAdapterUtils.unmarshallSource(CodeNDBUsageType.class, this.getClazz());
    }

    public void setClazzItem(CodeNDBUsageType target) {
        setClazz(XmlAdapterUtils.marshallJAXBElement(CodeNDBUsageType.class, new QName("http://www.aixm.aero/schema/5.1", "class"), NDBTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "emissionband", columnDefinition = "codeemissionbandbase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "emissionbandnilreason", columnDefinition = "nilreason"))
    })
    public CodeEmissionBandType getEmissionBandItem() {
        return XmlAdapterUtils.unmarshallSource(CodeEmissionBandType.class, this.getEmissionBand());
    }

    public void setEmissionBandItem(CodeEmissionBandType target) {
        setEmissionBand(XmlAdapterUtils.marshallJAXBElement(CodeEmissionBandType.class, new QName("http://www.aixm.aero/schema/5.1", "emissionBand"), NDBTimeSliceType.class, target));
    }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        }
        {
            ...
            List<NDBTimeSliceExtensionType> lhsField;
            lhsField = (this.isSetExtension()?this.getExtension():null);
            List<NDBTimeSliceExtensionType> rhsField;
        ...
        }
        {
            ...
            lhsField = this.getEmissionBand();
            JAXBElement<CodeEmissionBandType> rhsField;
            rhsField = that.getEmissionBand();
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "emissionBand", lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "emissionBand", rhsField);
            if (!strategy.equals(lhsFieldLocator, rhsFieldLocator, lhsField, rhsField, lhsFieldIsSet, rhsFieldIsSet)) {
                return false;
            }
        }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        }
        {
            ...
            JAXBElement<CodeNDBUsageType> theField;
            theField = this.getClazz();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "clazz", theField);
            currentHashCode = strategy.hashCode(theFieldLocator, currentHashCode, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetEmissionBand();
            JAXBElement<CodeEmissionBandType> theField;
            theField = this.getEmissionBand();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "emissionBand", theField);
            currentHashCode = strategy.hashCode(theFieldLocator, currentHashCode, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetExtension();
            List<NDBTimeSliceExtensionType> theField;
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        }
        {
            ...
            JAXBElement<CodeEmissionBandType> theField;
            theField = this.getEmissionBand();
            strategy.appendField(locator, this, "emissionBand", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetExtension();
            List<NDBTimeSliceExtensionType> theField;
