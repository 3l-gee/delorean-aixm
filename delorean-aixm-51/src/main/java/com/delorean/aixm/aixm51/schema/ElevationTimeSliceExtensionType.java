...
@XmlType(name = "", propOrder = {"abstractElevationExtension", "abstractNavaidEquipmentExtension"})
@Entity(name = "ElevationTimeSliceExtensionType")
@Table(name = "elevation_te", schema = "navaids_point")
public class ElevationTimeSliceExtensionType implements Serializable, Equals, HashCode, ToString {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final ElevationTimeSliceExtensionType that = ((ElevationTimeSliceExtensionType) object);
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetAbstractElevationExtension();
            AbstractExtensionType theField;
            theField = this.getAbstractElevationExtension();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "abstractElevationExtension", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            AbstractExtensionType theField;
            theField = this.getAbstractElevationExtension();
            strategy.appendField(locator, this, "abstractElevationExtension", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetAbstractNavaidEquipmentExtension();
            AbstractExtensionType theField;
