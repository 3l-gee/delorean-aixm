 ...
 *         <element name="theRadarEquipment" type="{http://www.aixm.aero/schema/5.1}RadarEquipmentPropertyType" minOccurs="0"/>
    ...
    implements Serializable
{
    ...
    public void setCollocationGroupItem(NoSequenceType target) {
        setCollocationGroup(XmlAdapterUtils.marshallJAXBElement(NoSequenceType.class, new QName("http://www.aixm.aero/schema/5.1", "collocationGroup"), RadarComponentType.class, target));
    }
