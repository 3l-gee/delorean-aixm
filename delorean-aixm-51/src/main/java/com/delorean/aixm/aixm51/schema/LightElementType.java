 ...
 *         <element name="intensity" type="{http://www.aixm.aero/schema/5.1}ValLightIntensityType" minOccurs="0"/>
 *         <element name="type" type="{http://www.aixm.aero/schema/5.1}CodeLightSourceType" minOccurs="0"/>
 ...
 *         <element name="availability" type="{http://www.aixm.aero/schema/5.1}LightElementStatusPropertyType" maxOccurs="unbounded" minOccurs="0"/>
    ...
    implements Serializable
{
    ...
    public void setColourItem(CodeColourType target) {
        setColour(XmlAdapterUtils.marshallJAXBElement(CodeColourType.class, new QName("http://www.aixm.aero/schema/5.1", "colour"), LightElementType.class, target));
    }
    ...
    public void setIntensityLevelItem(CodeLightIntensityType target) {
        setIntensityLevel(XmlAdapterUtils.marshallJAXBElement(CodeLightIntensityType.class, new QName("http://www.aixm.aero/schema/5.1", "intensityLevel"), LightElementType.class, target));
    }
    ...
    public void setIntensityItem(ValLightIntensityType target) {
        setIntensity(XmlAdapterUtils.marshallJAXBElement(ValLightIntensityType.class, new QName("http://www.aixm.aero/schema/5.1", "intensity"), LightElementType.class, target));
    }
    ...
    public void setTypeItem(CodeLightSourceType target) {
        setType(XmlAdapterUtils.marshallJAXBElement(CodeLightSourceType.class, new QName("http://www.aixm.aero/schema/5.1", "type"), LightElementType.class, target));
    }
    ...
    public void setLocationItem(AIXMElevatedPointPropertyType target) {
        setLocation(XmlAdapterUtils.marshallJAXBElement(AIXMElevatedPointPropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "location"), LightElementType.class, target));
    }
