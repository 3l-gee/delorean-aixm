 ...
 *         <element name="type" type="{http://www.aixm.aero/schema/5.1}CodeMLSAzimuthType" minOccurs="0"/>
 ...
 *         <element name="angleProportionalLeft" type="{http://www.aixm.aero/schema/5.1}ValAngleType" minOccurs="0"/>
 *         <element name="angleProportionalRight" type="{http://www.aixm.aero/schema/5.1}ValAngleType" minOccurs="0"/>
 *         <element name="angleCoverLeft" type="{http://www.aixm.aero/schema/5.1}ValAngleType" minOccurs="0"/>
 *         <element name="angleCoverRight" type="{http://www.aixm.aero/schema/5.1}ValAngleType" minOccurs="0"/>
 *         <element name="channel" type="{http://www.aixm.aero/schema/5.1}CodeMLSChannelType" minOccurs="0"/>
    ...
    implements Serializable
{
    ...
    protected List<AzimuthTimeSliceExtensionType> extension;
    ...
    @JoinTable(name = "azmthtmslctp_athrt_l", schema = "navaids_point", joinColumns = {
    ...
    @JoinTable(name = "azmthtmslctp_mntrng_l", schema = "navaids_point", joinColumns = {
        @JoinColumn(name = "azimuth_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "azmthtmslctp_avlblt_l", schema = "navaids_point", joinColumns = {
        @JoinColumn(name = "azimuth_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "azmthtmslctp_annttn_l", schema = "navaids_point", joinColumns = {
        @JoinColumn(name = "azimuth_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link AzimuthTimeSliceExtensionType }
     * 
     * 
     */
    @OneToMany(targetEntity = AzimuthTimeSliceExtensionType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinColumn(name = "azimuth_te_hjid", referencedColumnName = "hjid")
    public List<AzimuthTimeSliceExtensionType> getExtension() {
        if (extension == null) {
     ...
     * 
     */
    public void setExtension(List<AzimuthTimeSliceExtensionType> extension) {
    ...
    public void setDesignatorItem(CodeNavaidDesignatorType target) {
        setDesignator(XmlAdapterUtils.marshallJAXBElement(CodeNavaidDesignatorType.class, new QName("http://www.aixm.aero/schema/5.1", "designator"), AzimuthTimeSliceType.class, target));
    }
    ...
    public void setAixmNameItem(TextNameType target) {
        setAixmName(XmlAdapterUtils.marshallJAXBElement(TextNameType.class, new QName("http://www.aixm.aero/schema/5.1", "name"), AzimuthTimeSliceType.class, target));
    }
    ...
    public void setEmissionClassItem(CodeRadioEmissionType target) {
        setEmissionClass(XmlAdapterUtils.marshallJAXBElement(CodeRadioEmissionType.class, new QName("http://www.aixm.aero/schema/5.1", "emissionClass"), AzimuthTimeSliceType.class, target));
    }
    ...
    public void setMobileItem(CodeYesNoType target) {
        setMobile(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.1", "mobile"), AzimuthTimeSliceType.class, target));
    }
    ...
    public void setMagneticVariationItem(ValMagneticVariationType target) {
        setMagneticVariation(XmlAdapterUtils.marshallJAXBElement(ValMagneticVariationType.class, new QName("http://www.aixm.aero/schema/5.1", "magneticVariation"), AzimuthTimeSliceType.class, target));
    }
    ...
    public void setMagneticVariationAccuracyItem(ValAngleType target) {
        setMagneticVariationAccuracy(XmlAdapterUtils.marshallJAXBElement(ValAngleType.class, new QName("http://www.aixm.aero/schema/5.1", "magneticVariationAccuracy"), AzimuthTimeSliceType.class, target));
    }
    ...
    public void setDateMagneticVariationItem(DateYearType target) {
        setDateMagneticVariation(XmlAdapterUtils.marshallJAXBElement(DateYearType.class, new QName("http://www.aixm.aero/schema/5.1", "dateMagneticVariation"), AzimuthTimeSliceType.class, target));
    }
    ...
    public void setFlightCheckedItem(CodeYesNoType target) {
        setFlightChecked(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.1", "flightChecked"), AzimuthTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = AIXMElevatedPointPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "azmthtmslctp_lctn_l", schema = "navaids_point", joinColumns = {
        @JoinColumn(name = "azimuth_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setLocationItem(AIXMElevatedPointPropertyType target) {
        setLocation(XmlAdapterUtils.marshallJAXBElement(AIXMElevatedPointPropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "location"), AzimuthTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "type", columnDefinition = "codemlsazimuthbase")),
    ...
    public void setTypeItem(CodeMLSAzimuthType target) {
        setType(XmlAdapterUtils.marshallJAXBElement(CodeMLSAzimuthType.class, new QName("http://www.aixm.aero/schema/5.1", "type"), AzimuthTimeSliceType.class, target));
    }
    ...
    public void setTrueBearingItem(ValBearingType target) {
        setTrueBearing(XmlAdapterUtils.marshallJAXBElement(ValBearingType.class, new QName("http://www.aixm.aero/schema/5.1", "trueBearing"), AzimuthTimeSliceType.class, target));
    }
    ...
    public void setTrueBearingAccuracyItem(ValAngleType target) {
        setTrueBearingAccuracy(XmlAdapterUtils.marshallJAXBElement(ValAngleType.class, new QName("http://www.aixm.aero/schema/5.1", "trueBearingAccuracy"), AzimuthTimeSliceType.class, target));
    }
    ...
    public void setMagneticBearingItem(ValBearingType target) {
        setMagneticBearing(XmlAdapterUtils.marshallJAXBElement(ValBearingType.class, new QName("http://www.aixm.aero/schema/5.1", "magneticBearing"), AzimuthTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "angleproportionalleft", columnDefinition = "valanglebase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "angleproportionalleftnilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setAngleProportionalLeftItem(ValAngleType target) {
        setAngleProportionalLeft(XmlAdapterUtils.marshallJAXBElement(ValAngleType.class, new QName("http://www.aixm.aero/schema/5.1", "angleProportionalLeft"), AzimuthTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "angleproportionalright", columnDefinition = "valanglebase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "angleproportionalrightnilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setAngleProportionalRightItem(ValAngleType target) {
        setAngleProportionalRight(XmlAdapterUtils.marshallJAXBElement(ValAngleType.class, new QName("http://www.aixm.aero/schema/5.1", "angleProportionalRight"), AzimuthTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "anglecoverleft", columnDefinition = "valanglebase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "anglecoverleftnilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setAngleCoverLeftItem(ValAngleType target) {
        setAngleCoverLeft(XmlAdapterUtils.marshallJAXBElement(ValAngleType.class, new QName("http://www.aixm.aero/schema/5.1", "angleCoverLeft"), AzimuthTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "anglecoverright", columnDefinition = "valanglebase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "anglecoverrightnilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setAngleCoverRightItem(ValAngleType target) {
        setAngleCoverRight(XmlAdapterUtils.marshallJAXBElement(ValAngleType.class, new QName("http://www.aixm.aero/schema/5.1", "angleCoverRight"), AzimuthTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "channel", columnDefinition = "codemlschannelbase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "channelnilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setChannelItem(CodeMLSChannelType target) {
        setChannel(XmlAdapterUtils.marshallJAXBElement(CodeMLSChannelType.class, new QName("http://www.aixm.aero/schema/5.1", "channel"), AzimuthTimeSliceType.class, target));
    }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        }
        {
            ...
            List<AzimuthTimeSliceExtensionType> lhsField;
            lhsField = (this.isSetExtension()?this.getExtension():null);
            List<AzimuthTimeSliceExtensionType> rhsField;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        }
        {
            ...
            List<AzimuthTimeSliceExtensionType> theField;
