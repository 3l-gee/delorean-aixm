 ...
 *       <sequence>
 *         <element name="flyByCode" type="{http://www.aixm.aero/schema/5.1}CodeYesNoType" minOccurs="0"/>
 *         <element name="procedureTurnRequired" type="{http://www.aixm.aero/schema/5.1}CodeYesNoType" minOccurs="0"/>
 *         <element name="altitudeDescription" type="{http://www.aixm.aero/schema/5.1}CodeAltitudeUseType" minOccurs="0"/>
 *         <element name="sectorDefinition" type="{http://www.aixm.aero/schema/5.1}CircleSectorPropertyType" minOccurs="0"/>
    ...
    implements Serializable
{
    ...
    public void setFlyByCodeItem(CodeYesNoType target) {
        setFlyByCode(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.1", "flyByCode"), TerminalArrivalAreaSectorType.class, target));
    }
    ...
    public void setProcedureTurnRequiredItem(CodeYesNoType target) {
        setProcedureTurnRequired(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.1", "procedureTurnRequired"), TerminalArrivalAreaSectorType.class, target));
    }
    ...
    public void setAltitudeDescriptionItem(CodeAltitudeUseType target) {
        setAltitudeDescription(XmlAdapterUtils.marshallJAXBElement(CodeAltitudeUseType.class, new QName("http://www.aixm.aero/schema/5.1", "altitudeDescription"), TerminalArrivalAreaSectorType.class, target));
    }
    ...
    public void setSectorDefinitionItem(CircleSectorPropertyType target) {
        setSectorDefinition(XmlAdapterUtils.marshallJAXBElement(CircleSectorPropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "sectorDefinition"), TerminalArrivalAreaSectorType.class, target));
    }
    ...
    public void setExtentItem(AIXMSurfacePropertyType target) {
        setExtent(XmlAdapterUtils.marshallJAXBElement(AIXMSurfacePropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "extent"), TerminalArrivalAreaSectorType.class, target));
    }
