...
@XmlType(name = "", propOrder = {"abstractApronLightSystemExtension", "abstractGroundLightSystemExtension"})
@Entity(name = "ApronLightSystemTimeSliceExtensionType")
@Table(name = "apronlightsystem_te", schema = "airport_heliport")
public class ApronLightSystemTimeSliceExtensionType implements Serializable, Equals, HashCode, ToString {
    ...
    @JoinColumn(name = "abstractapronlightsystemextension_hjid", referencedColumnName = "hjid")
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final ApronLightSystemTimeSliceExtensionType that = ((ApronLightSystemTimeSliceExtensionType) object);
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetAbstractApronLightSystemExtension();
            AbstractExtensionType theField;
            theField = this.getAbstractApronLightSystemExtension();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "abstractApronLightSystemExtension",
                    theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            AbstractExtensionType theField;
            theField = this.getAbstractApronLightSystemExtension();
            strategy.appendField(locator, this, "abstractApronLightSystemExtension", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetAbstractGroundLightSystemExtension();
            AbstractExtensionType theField;
