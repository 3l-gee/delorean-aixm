 ...
 *       <sequence>
 *         <element name="reportingATC" type="{http://www.aixm.aero/schema/5.1}CodeATCReportingType" minOccurs="0"/>
 *         <element name="flyOver" type="{http://www.aixm.aero/schema/5.1}CodeYesNoType" minOccurs="0"/>
 *         <element name="waypoint" type="{http://www.aixm.aero/schema/5.1}CodeYesNoType" minOccurs="0"/>
 *         <element name="radarGuidance" type="{http://www.aixm.aero/schema/5.1}CodeYesNoType" minOccurs="0"/>
 *         <element name="facilityMakeup" type="{http://www.aixm.aero/schema/5.1}PointReferencePropertyType" maxOccurs="unbounded" minOccurs="0"/>
 *         <choice>
 *           <element name="pointChoice_fixDesignatedPoint" type="{http://www.aixm.aero/schema/5.1}DesignatedPointPropertyType" minOccurs="0"/>
 *           <element name="pointChoice_navaidSystem" type="{http://www.aixm.aero/schema/5.1}NavaidPropertyType" minOccurs="0"/>
 *           <element name="pointChoice_aimingPoint" type="{http://www.aixm.aero/schema/5.1}TouchDownLiftOffPropertyType" minOccurs="0"/>
 *           <element name="pointChoice_runwayPoint" type="{http://www.aixm.aero/schema/5.1}RunwayCentrelinePointPropertyType" minOccurs="0"/>
 *           <element name="pointChoice_airportReferencePoint" type="{http://www.aixm.aero/schema/5.1}AirportHeliportPropertyType" minOccurs="0"/>
 *           <element name="pointChoice_position" type="{http://www.aixm.aero/schema/5.1}PointPropertyType" minOccurs="0"/>
 *         </choice>
 *         <element name="extendedServiceVolume" type="{http://www.aixm.aero/schema/5.1}RadioFrequencyAreaPropertyType" minOccurs="0"/>
 *         <element name="annotation" type="{http://www.aixm.aero/schema/5.1}NotePropertyType" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="roleFreeFlight" type="{http://www.aixm.aero/schema/5.1}CodeFreeFlightType" minOccurs="0"/>
 *         <element name="roleRVSM" type="{http://www.aixm.aero/schema/5.1}CodeRVSMPointRoleType" minOccurs="0"/>
 *         <element name="turnRadius" type="{http://www.aixm.aero/schema/5.1}ValDistanceType" minOccurs="0"/>
 *         <element name="roleMilitaryTraining" type="{http://www.aixm.aero/schema/5.1}CodeMilitaryRoutePointType" minOccurs="0"/>
    ...
    implements Serializable
{
    ...
    public void setReportingATCItem(CodeATCReportingType target) {
        setReportingATC(XmlAdapterUtils.marshallJAXBElement(CodeATCReportingType.class, new QName("http://www.aixm.aero/schema/5.1", "reportingATC"), EnRouteSegmentPointType.class, target));
    }
    ...
    public void setFlyOverItem(CodeYesNoType target) {
        setFlyOver(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.1", "flyOver"), EnRouteSegmentPointType.class, target));
    }
    ...
    public void setWaypointItem(CodeYesNoType target) {
        setWaypoint(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.1", "waypoint"), EnRouteSegmentPointType.class, target));
    }
    ...
    public void setRadarGuidanceItem(CodeYesNoType target) {
        setRadarGuidance(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.1", "radarGuidance"), EnRouteSegmentPointType.class, target));
    }
    ...
    public void setPointChoiceFixDesignatedPointItem(DesignatedPointPropertyType target) {
        setPointChoiceFixDesignatedPoint(XmlAdapterUtils.marshallJAXBElement(DesignatedPointPropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "pointChoice_fixDesignatedPoint"), EnRouteSegmentPointType.class, target));
    }
    ...
    public void setPointChoiceNavaidSystemItem(NavaidPropertyType target) {
        setPointChoiceNavaidSystem(XmlAdapterUtils.marshallJAXBElement(NavaidPropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "pointChoice_navaidSystem"), EnRouteSegmentPointType.class, target));
    }
    ...
    public void setPointChoiceAimingPointItem(TouchDownLiftOffPropertyType target) {
        setPointChoiceAimingPoint(XmlAdapterUtils.marshallJAXBElement(TouchDownLiftOffPropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "pointChoice_aimingPoint"), EnRouteSegmentPointType.class, target));
    }
    ...
    public void setPointChoiceRunwayPointItem(RunwayCentrelinePointPropertyType target) {
        setPointChoiceRunwayPoint(XmlAdapterUtils.marshallJAXBElement(RunwayCentrelinePointPropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "pointChoice_runwayPoint"), EnRouteSegmentPointType.class, target));
    }
    ...
    public void setPointChoiceAirportReferencePointItem(AirportHeliportPropertyType target) {
        setPointChoiceAirportReferencePoint(XmlAdapterUtils.marshallJAXBElement(AirportHeliportPropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "pointChoice_airportReferencePoint"), EnRouteSegmentPointType.class, target));
    }
    ...
    public void setPointChoicePositionItem(AIXMPointPropertyType target) {
        setPointChoicePosition(XmlAdapterUtils.marshallJAXBElement(AIXMPointPropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "pointChoice_position"), EnRouteSegmentPointType.class, target));
    }
    ...
    public void setExtendedServiceVolumeItem(RadioFrequencyAreaPropertyType target) {
        setExtendedServiceVolume(XmlAdapterUtils.marshallJAXBElement(RadioFrequencyAreaPropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "extendedServiceVolume"), EnRouteSegmentPointType.class, target));
    }
    ...
    public void setRoleFreeFlightItem(CodeFreeFlightType target) {
        setRoleFreeFlight(XmlAdapterUtils.marshallJAXBElement(CodeFreeFlightType.class, new QName("http://www.aixm.aero/schema/5.1", "roleFreeFlight"), EnRouteSegmentPointType.class, target));
    }
    ...
    public void setRoleRVSMItem(CodeRVSMPointRoleType target) {
        setRoleRVSM(XmlAdapterUtils.marshallJAXBElement(CodeRVSMPointRoleType.class, new QName("http://www.aixm.aero/schema/5.1", "roleRVSM"), EnRouteSegmentPointType.class, target));
    }
    ...
    public void setTurnRadiusItem(ValDistanceType target) {
        setTurnRadius(XmlAdapterUtils.marshallJAXBElement(ValDistanceType.class, new QName("http://www.aixm.aero/schema/5.1", "turnRadius"), EnRouteSegmentPointType.class, target));
    }
    ...
    public void setRoleMilitaryTrainingItem(CodeMilitaryRoutePointType target) {
        setRoleMilitaryTraining(XmlAdapterUtils.marshallJAXBElement(CodeMilitaryRoutePointType.class, new QName("http://www.aixm.aero/schema/5.1", "roleMilitaryTraining"), EnRouteSegmentPointType.class, target));
    }
