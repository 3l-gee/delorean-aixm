    ...
    implements Serializable
{
    ...
    @JoinTable(name = "fltngdcksttmslctp_annttn_l", schema = "airport_heliport", joinColumns = {
        @JoinColumn(name = "floatingdocksite_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "fltngdcksttmslctp_extnt_l", schema = "airport_heliport", joinColumns = {
        @JoinColumn(name = "floatingdocksite_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setExtentItem(AIXMElevatedSurfacePropertyType target) {
        setExtent(XmlAdapterUtils.marshallJAXBElement(AIXMElevatedSurfacePropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "extent"), FloatingDockSiteTimeSliceType.class, target));
    }
