 ...
 *       <sequence>
 *         <element name="designator" type="{http://www.aixm.aero/schema/5.1}CodeNavaidDesignatorType" minOccurs="0"/>
 *         <element name="name" type="{http://www.aixm.aero/schema/5.1}TextNameType" minOccurs="0"/>
 *         <element name="emissionClass" type="{http://www.aixm.aero/schema/5.1}CodeRadioEmissionType" minOccurs="0"/>
 *         <element name="mobile" type="{http://www.aixm.aero/schema/5.1}CodeYesNoType" minOccurs="0"/>
 ...
 *         <element name="flightChecked" type="{http://www.aixm.aero/schema/5.1}CodeYesNoType" minOccurs="0"/>
 *         <element name="location" type="{http://www.aixm.aero/schema/5.1}ElevatedPointPropertyType" minOccurs="0"/>
 *         <element name="authority" type="{http://www.aixm.aero/schema/5.1}AuthorityForNavaidEquipmentPropertyType" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="monitoring" type="{http://www.aixm.aero/schema/5.1}NavaidEquipmentMonitoringPropertyType" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="availability" type="{http://www.aixm.aero/schema/5.1}NavaidOperationalStatusPropertyType" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="annotation" type="{http://www.aixm.aero/schema/5.1}NotePropertyType" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="frequency" type="{http://www.aixm.aero/schema/5.1}ValFrequencyType" minOccurs="0"/>
 *         <element name="magneticBearing" type="{http://www.aixm.aero/schema/5.1}ValBearingType" minOccurs="0"/>
 *         <element name="magneticBearingAccuracy" type="{http://www.aixm.aero/schema/5.1}ValAngleType" minOccurs="0"/>
 *         <element name="trueBearing" type="{http://www.aixm.aero/schema/5.1}ValBearingType" minOccurs="0"/>
 *         <element name="trueBearingAccuracy" type="{http://www.aixm.aero/schema/5.1}ValAngleType" minOccurs="0"/>
 *         <element name="declination" type="{http://www.aixm.aero/schema/5.1}ValMagneticVariationType" minOccurs="0"/>
 *         <element name="widthCourse" type="{http://www.aixm.aero/schema/5.1}ValAngleType" minOccurs="0"/>
 *         <element name="widthCourseAccuracy" type="{http://www.aixm.aero/schema/5.1}ValAngleType" minOccurs="0"/>
 *         <element name="backCourseUsable" type="{http://www.aixm.aero/schema/5.1}CodeILSBackCourseType" minOccurs="0"/>
    ...
    implements Serializable
{
    ...
    protected List<LocalizerTimeSliceExtensionType> extension;
    ...
    @JoinTable(name = "lclzrtmslctp_athrt_link", schema = "navaids_point", joinColumns = {
    ...
    @JoinTable(name = "lclzrtmslctp_mntrng_link", schema = "navaids_point", joinColumns = {
        @JoinColumn(name = "localizer_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "lclzrtmslctp_avlblt_link", schema = "navaids_point", joinColumns = {
        @JoinColumn(name = "localizer_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "lclzrtmslctp_annttn_link", schema = "navaids_point", joinColumns = {
        @JoinColumn(name = "localizer_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link LocalizerTimeSliceExtensionType }
     * 
     * 
     */
    @OneToMany(targetEntity = LocalizerTimeSliceExtensionType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinColumn(name = "localizer_te_hjid", referencedColumnName = "hjid")
    public List<LocalizerTimeSliceExtensionType> getExtension() {
        if (extension == null) {
     ...
     * 
     */
    public void setExtension(List<LocalizerTimeSliceExtensionType> extension) {
    ...
    public void setDesignatorItem(CodeNavaidDesignatorType target) {
        setDesignator(XmlAdapterUtils.marshallJAXBElement(CodeNavaidDesignatorType.class, new QName("http://www.aixm.aero/schema/5.1", "designator"), LocalizerTimeSliceType.class, target));
    }
    ...
    public void setAixmNameItem(TextNameType target) {
        setAixmName(XmlAdapterUtils.marshallJAXBElement(TextNameType.class, new QName("http://www.aixm.aero/schema/5.1", "name"), LocalizerTimeSliceType.class, target));
    }
    ...
    public void setEmissionClassItem(CodeRadioEmissionType target) {
        setEmissionClass(XmlAdapterUtils.marshallJAXBElement(CodeRadioEmissionType.class, new QName("http://www.aixm.aero/schema/5.1", "emissionClass"), LocalizerTimeSliceType.class, target));
    }
    ...
    public void setMobileItem(CodeYesNoType target) {
        setMobile(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.1", "mobile"), LocalizerTimeSliceType.class, target));
    }
    ...
    public void setMagneticVariationItem(ValMagneticVariationType target) {
        setMagneticVariation(XmlAdapterUtils.marshallJAXBElement(ValMagneticVariationType.class, new QName("http://www.aixm.aero/schema/5.1", "magneticVariation"), LocalizerTimeSliceType.class, target));
    }
    ...
    public void setMagneticVariationAccuracyItem(ValAngleType target) {
        setMagneticVariationAccuracy(XmlAdapterUtils.marshallJAXBElement(ValAngleType.class, new QName("http://www.aixm.aero/schema/5.1", "magneticVariationAccuracy"), LocalizerTimeSliceType.class, target));
    }
    ...
    public void setDateMagneticVariationItem(DateYearType target) {
        setDateMagneticVariation(XmlAdapterUtils.marshallJAXBElement(DateYearType.class, new QName("http://www.aixm.aero/schema/5.1", "dateMagneticVariation"), LocalizerTimeSliceType.class, target));
    }
    ...
    public void setFlightCheckedItem(CodeYesNoType target) {
        setFlightChecked(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.1", "flightChecked"), LocalizerTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = AIXMElevatedPointPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "lclzrtmslctp_lctn_link", schema = "navaids_point", joinColumns = {
        @JoinColumn(name = "localizer_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setLocationItem(AIXMElevatedPointPropertyType target) {
        setLocation(XmlAdapterUtils.marshallJAXBElement(AIXMElevatedPointPropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "location"), LocalizerTimeSliceType.class, target));
    }
    ...
    public void setFrequencyItem(ValFrequencyType target) {
        setFrequency(XmlAdapterUtils.marshallJAXBElement(ValFrequencyType.class, new QName("http://www.aixm.aero/schema/5.1", "frequency"), LocalizerTimeSliceType.class, target));
    }
    ...
    public void setMagneticBearingItem(ValBearingType target) {
        setMagneticBearing(XmlAdapterUtils.marshallJAXBElement(ValBearingType.class, new QName("http://www.aixm.aero/schema/5.1", "magneticBearing"), LocalizerTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "magneticbearingaccuracy", columnDefinition = "valanglebase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "magneticbearingaccuracynilreason", columnDefinition = "nilreason"))
    })
    public ValAngleType getMagneticBearingAccuracyItem() {
        return XmlAdapterUtils.unmarshallSource(ValAngleType.class, this.getMagneticBearingAccuracy());
    }

    public void setMagneticBearingAccuracyItem(ValAngleType target) {
        setMagneticBearingAccuracy(XmlAdapterUtils.marshallJAXBElement(ValAngleType.class, new QName("http://www.aixm.aero/schema/5.1", "magneticBearingAccuracy"), LocalizerTimeSliceType.class, target));
    }
    ...
    public void setTrueBearingItem(ValBearingType target) {
        setTrueBearing(XmlAdapterUtils.marshallJAXBElement(ValBearingType.class, new QName("http://www.aixm.aero/schema/5.1", "trueBearing"), LocalizerTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "truebearingaccuracy", columnDefinition = "valanglebase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "truebearingaccuracynilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setTrueBearingAccuracyItem(ValAngleType target) {
        setTrueBearingAccuracy(XmlAdapterUtils.marshallJAXBElement(ValAngleType.class, new QName("http://www.aixm.aero/schema/5.1", "trueBearingAccuracy"), LocalizerTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "declination", columnDefinition = "valmagneticvariationbase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "declinationnilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setDeclinationItem(ValMagneticVariationType target) {
        setDeclination(XmlAdapterUtils.marshallJAXBElement(ValMagneticVariationType.class, new QName("http://www.aixm.aero/schema/5.1", "declination"), LocalizerTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "widthcourse", columnDefinition = "valanglebase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "widthcoursenilreason", columnDefinition = "nilreason"))
    })
    public ValAngleType getWidthCourseItem() {
        return XmlAdapterUtils.unmarshallSource(ValAngleType.class, this.getWidthCourse());
    }

    public void setWidthCourseItem(ValAngleType target) {
        setWidthCourse(XmlAdapterUtils.marshallJAXBElement(ValAngleType.class, new QName("http://www.aixm.aero/schema/5.1", "widthCourse"), LocalizerTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "widthcourseaccuracy", columnDefinition = "valanglebase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "widthcourseaccuracynilreason", columnDefinition = "nilreason"))
    })
    public ValAngleType getWidthCourseAccuracyItem() {
        return XmlAdapterUtils.unmarshallSource(ValAngleType.class, this.getWidthCourseAccuracy());
    }

    public void setWidthCourseAccuracyItem(ValAngleType target) {
        setWidthCourseAccuracy(XmlAdapterUtils.marshallJAXBElement(ValAngleType.class, new QName("http://www.aixm.aero/schema/5.1", "widthCourseAccuracy"), LocalizerTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "backcourseusable", columnDefinition = "codeilsbackcoursebase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "backcourseusablenilreason", columnDefinition = "nilreason"))
    })
    public CodeILSBackCourseType getBackCourseUsableItem() {
        return XmlAdapterUtils.unmarshallSource(CodeILSBackCourseType.class, this.getBackCourseUsable());
    }

    public void setBackCourseUsableItem(CodeILSBackCourseType target) {
        setBackCourseUsable(XmlAdapterUtils.marshallJAXBElement(CodeILSBackCourseType.class, new QName("http://www.aixm.aero/schema/5.1", "backCourseUsable"), LocalizerTimeSliceType.class, target));
    }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        final LocalizerTimeSliceType that = ((LocalizerTimeSliceType) object);
        {
        ...
        }
        {
            ...
            List<LocalizerTimeSliceExtensionType> lhsField;
            lhsField = (this.isSetExtension()?this.getExtension():null);
            List<LocalizerTimeSliceExtensionType> rhsField;
        ...
        {
            boolean lhsFieldIsSet = this.isSetWidthCourseAccuracy();
            boolean rhsFieldIsSet = that.isSetWidthCourseAccuracy();
            JAXBElement<ValAngleType> lhsField;
            lhsField = this.getWidthCourseAccuracy();
            JAXBElement<ValAngleType> rhsField;
            rhsField = that.getWidthCourseAccuracy();
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "widthCourseAccuracy", lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "widthCourseAccuracy", rhsField);
            if (!strategy.equals(lhsFieldLocator, rhsFieldLocator, lhsField, rhsField, lhsFieldIsSet, rhsFieldIsSet)) {
                return false;
            }
        }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetMagneticBearingAccuracy();
            JAXBElement<ValAngleType> theField;
            theField = this.getMagneticBearingAccuracy();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "magneticBearingAccuracy", theField);
            currentHashCode = strategy.hashCode(theFieldLocator, currentHashCode, theField, theFieldIsSet);
        }
        {
        ...
        {
            boolean theFieldIsSet = this.isSetDeclination();
            JAXBElement<ValMagneticVariationType> theField;
            theField = this.getDeclination();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "declination", theField);
            currentHashCode = strategy.hashCode(theFieldLocator, currentHashCode, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetWidthCourse();
            JAXBElement<ValAngleType> theField;
            theField = this.getWidthCourse();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "widthCourse", theField);
            currentHashCode = strategy.hashCode(theFieldLocator, currentHashCode, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetWidthCourseAccuracy();
            JAXBElement<ValAngleType> theField;
            theField = this.getWidthCourseAccuracy();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "widthCourseAccuracy", theField);
            currentHashCode = strategy.hashCode(theFieldLocator, currentHashCode, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetBackCourseUsable();
            JAXBElement<CodeILSBackCourseType> theField;
            theField = this.getBackCourseUsable();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "backCourseUsable", theField);
            currentHashCode = strategy.hashCode(theFieldLocator, currentHashCode, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetExtension();
            List<LocalizerTimeSliceExtensionType> theField;
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        }
        {
            ...
            JAXBElement<ValAngleType> theField;
            theField = this.getMagneticBearingAccuracy();
            strategy.appendField(locator, this, "magneticBearingAccuracy", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetTrueBearing();
            JAXBElement<ValBearingType> theField;
        ...
        }
        {
            ...
            JAXBElement<ValMagneticVariationType> theField;
            theField = this.getDeclination();
            strategy.appendField(locator, this, "declination", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetWidthCourse();
            JAXBElement<ValAngleType> theField;
            theField = this.getWidthCourse();
            strategy.appendField(locator, this, "widthCourse", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetWidthCourseAccuracy();
            JAXBElement<ValAngleType> theField;
            theField = this.getWidthCourseAccuracy();
            strategy.appendField(locator, this, "widthCourseAccuracy", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetBackCourseUsable();
            JAXBElement<CodeILSBackCourseType> theField;
            theField = this.getBackCourseUsable();
            strategy.appendField(locator, this, "backCourseUsable", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetExtension();
            List<LocalizerTimeSliceExtensionType> theField;
