 ...
 *       <sequence>
 *         <element name="landingCategory" type="{http://www.aixm.aero/schema/5.1}CodeHoldingCategoryType" minOccurs="0"/>
 *         <element name="status" type="{http://www.aixm.aero/schema/5.1}CodeStatusOperationsType" minOccurs="0"/>
 *         <element name="associatedGuidanceLine" type="{http://www.aixm.aero/schema/5.1}GuidanceLinePropertyType" minOccurs="0"/>
 *         <element name="protectedRunway" type="{http://www.aixm.aero/schema/5.1}RunwayPropertyType" maxOccurs="unbounded" minOccurs="0"/>
    ...
    implements Serializable
{
    ...
    protected List<TaxiHoldingPositionTimeSliceExtensionType> extension;
    ...
    public void setLandingCategoryItem(CodeHoldingCategoryType target) {
        setLandingCategory(XmlAdapterUtils.marshallJAXBElement(CodeHoldingCategoryType.class, new QName("http://www.aixm.aero/schema/5.1", "landingCategory"), TaxiHoldingPositionTimeSliceType.class, target));
    }
    ...
    public void setStatusItem(CodeStatusOperationsType target) {
        setStatus(XmlAdapterUtils.marshallJAXBElement(CodeStatusOperationsType.class, new QName("http://www.aixm.aero/schema/5.1", "status"), TaxiHoldingPositionTimeSliceType.class, target));
    }
    ...
    public void setAssociatedGuidanceLineItem(GuidanceLinePropertyType target) {
        setAssociatedGuidanceLine(XmlAdapterUtils.marshallJAXBElement(GuidanceLinePropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "associatedGuidanceLine"), TaxiHoldingPositionTimeSliceType.class, target));
    }
    ...
    public void setLocationItem(AIXMElevatedPointPropertyType target) {
        setLocation(XmlAdapterUtils.marshallJAXBElement(AIXMElevatedPointPropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "location"), TaxiHoldingPositionTimeSliceType.class, target));
    }
