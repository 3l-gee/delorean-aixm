 ...
 *         <element name="operationalStatus" type="{http://www.aixm.aero/schema/5.1}CodeStatusNavaidType" minOccurs="0"/>
 ...
 *                   <element ref="{http://www.aixm.aero/schema/5.1}AbstractNavaidOperationalStatusExtension"/>
 *                 </choice>
    ...
    implements Serializable
{
    ...
    @JoinTable(name = "nvdoprtnlsttstp_tmintrvl_l", schema = "navaids_point", joinColumns = {
        @JoinColumn(name = "navaidoperationalstatus_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "nvdoprtnlsttstp_annttn_l", schema = "navaids_point", joinColumns = {
        @JoinColumn(name = "navaidoperationalstatus_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "nvdoprtnlsttstp_spcldtathrt_l", schema = "navaids_point", joinColumns = {
        @JoinColumn(name = "navaidoperationalstatus_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setOperationalStatusItem(CodeStatusNavaidType target) {
        setOperationalStatus(XmlAdapterUtils.marshallJAXBElement(CodeStatusNavaidType.class, new QName("http://www.aixm.aero/schema/5.1", "operationalStatus"), NavaidOperationalStatusType.class, target));
    }
    ...
    public void setSignalTypeItem(CodeRadioSignalType target) {
        setSignalType(XmlAdapterUtils.marshallJAXBElement(CodeRadioSignalType.class, new QName("http://www.aixm.aero/schema/5.1", "signalType"), NavaidOperationalStatusType.class, target));
    }
