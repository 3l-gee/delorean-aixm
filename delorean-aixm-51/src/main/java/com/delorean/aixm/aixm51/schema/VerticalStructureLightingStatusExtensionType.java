...
@Entity(name = "VerticalStructureLightingStatusExtensionType")
@Table(name = "verticalstructurelightingstatus_oe", schema = "obstacle")
public class VerticalStructureLightingStatusExtensionType implements Serializable, Equals, HashCode, ToString {
    ...
    /**
     * Gets the value of the abstractVerticalStructureLightingStatusExtension
     * property.
     *
     * @return possible object is {@link AbstractExtensionType }
     *
     */
    @OneToOne(targetEntity = AbstractExtensionType.class, cascade = {CascadeType.ALL}, fetch = FetchType.EAGER)
    @JoinColumn(name = "abstractverticalstructurelightingstatusextension_hjid", referencedColumnName = "hjid")
    public AbstractExtensionType getAbstractVerticalStructureLightingStatusExtension() {
        return abstractVerticalStructureLightingStatusExtension;
    }

    /**
     * Sets the value of the abstractVerticalStructureLightingStatusExtension
     * property.
     *
     * @param value
     *            allowed object is {@link AbstractExtensionType }
     *
     */
    public void setAbstractVerticalStructureLightingStatusExtension(AbstractExtensionType value) {
        this.abstractVerticalStructureLightingStatusExtension = value;
    }

    @Transient
    public boolean isSetAbstractVerticalStructureLightingStatusExtension() {
        return (this.abstractVerticalStructureLightingStatusExtension != null);
    }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final VerticalStructureLightingStatusExtensionType that = ((VerticalStructureLightingStatusExtensionType) object);
        {
        ...
        }
        {
            ...
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator,
                    "abstractVerticalStructureLightingStatusExtension", lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator,
                    "abstractVerticalStructureLightingStatusExtension", rhsField);
            if (!strategy.equals(lhsFieldLocator, rhsFieldLocator, lhsField, rhsField, lhsFieldIsSet, rhsFieldIsSet)) {
                return false;
            }
        }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetAbstractVerticalStructureLightingStatusExtension();
            AbstractExtensionType theField;
            theField = this.getAbstractVerticalStructureLightingStatusExtension();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator,
                    "abstractVerticalStructureLightingStatusExtension", theField);
            currentHashCode = strategy.hashCode(theFieldLocator, currentHashCode, theField, theFieldIsSet);
        }
        {
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        }
        {
            ...
            AbstractExtensionType theField;
            theField = this.getAbstractVerticalStructureLightingStatusExtension();
            strategy.appendField(locator, this, "abstractVerticalStructureLightingStatusExtension", buffer, theField,
                    theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetOwns();
