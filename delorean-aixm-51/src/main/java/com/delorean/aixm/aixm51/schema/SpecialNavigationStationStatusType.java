 ...
 *                   <element ref="{http://www.aixm.aero/schema/5.1}AbstractSpecialNavigationStationStatusExtension"/>
 *                 </choice>
    ...
    implements Serializable
{
    ...
    @JoinTable(name = "spclnvgtnsttnsttstp_tmintrvl_l", schema = "navaids_point", joinColumns = {
        @JoinColumn(name = "specialnavigationstationstatus_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "spclnvgtnsttnsttstp_annttn_l", schema = "navaids_point", joinColumns = {
        @JoinColumn(name = "specialnavigationstationstatus_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "spclnvgtnsttnsttstp_spcldtathrt_l", schema = "navaids_point", joinColumns = {
        @JoinColumn(name = "specialnavigationstationstatus_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setOperationalStatusItem(CodeStatusNavaidType target) {
        setOperationalStatus(XmlAdapterUtils.marshallJAXBElement(CodeStatusNavaidType.class, new QName("http://www.aixm.aero/schema/5.1", "operationalStatus"), SpecialNavigationStationStatusType.class, target));
    }
