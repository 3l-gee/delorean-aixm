 ...
 *         <element name="lightedGuidanceLine" type="{http://www.aixm.aero/schema/5.1}GuidanceLinePropertyType" minOccurs="0"/>
 *         <element name="extension" maxOccurs="unbounded" minOccurs="0">
 *           <complexType>
 *             <complexContent>
 *               <restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 <choice>
 *                   <element ref="{http://www.aixm.aero/schema/5.1}AbstractGuidanceLineLightSystemExtension"/>
...
@Table(name = "guidancelinelightsystem_t", schema = "airport_heliport")
    ...
    implements Serializable
{
    ...
    @XmlElementRef(name = "lightedGuidanceLine", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class, required = false)
    protected JAXBElement<GuidanceLinePropertyType> lightedGuidanceLine;
    protected List<GuidanceLineLightSystemTimeSliceExtensionType> extension;
    ...
    @JoinTable(name = "gdnclnlghtsstmtmslctp_elmnt_link", schema = "airport_heliport", joinColumns = {
        @JoinColumn(name = "guidancelinelightsystem_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "gdnclnlghtsstmtmslctp_avlblt_link", schema = "airport_heliport", joinColumns = {
        @JoinColumn(name = "guidancelinelightsystem_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "gdnclnlghtsstmtmslctp_annttn_link", schema = "airport_heliport", joinColumns = {
        @JoinColumn(name = "guidancelinelightsystem_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
     ...
     * 
     */
    @OneToMany(targetEntity = GuidanceLineLightSystemTimeSliceExtensionType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinColumn(name = "guidancelinelightsystem_te_hjid", referencedColumnName = "hjid")
    public List<GuidanceLineLightSystemTimeSliceExtensionType> getExtension() {
        if (extension == null) {
     ...
     * 
     */
    public void setExtension(List<GuidanceLineLightSystemTimeSliceExtensionType> extension) {
    ...
    public void setEmergencyLightingItem(CodeYesNoType target) {
        setEmergencyLighting(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.1", "emergencyLighting"), GuidanceLineLightSystemTimeSliceType.class, target));
    }
    ...
    public void setIntensityLevelItem(CodeLightIntensityType target) {
        setIntensityLevel(XmlAdapterUtils.marshallJAXBElement(CodeLightIntensityType.class, new QName("http://www.aixm.aero/schema/5.1", "intensityLevel"), GuidanceLineLightSystemTimeSliceType.class, target));
    }
    ...
    public void setColourItem(CodeColourType target) {
        setColour(XmlAdapterUtils.marshallJAXBElement(CodeColourType.class, new QName("http://www.aixm.aero/schema/5.1", "colour"), GuidanceLineLightSystemTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = GuidanceLinePropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "gdnclnlghtsstmtmslctp_lghtdgdncln_link", schema = "airport_heliport", joinColumns = {
        @JoinColumn(name = "guidancelinelightsystem_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
        @JoinColumn(name = "lightedguidanceline_hjid", referencedColumnName = "hjid")
    })
    ...
    public void setLightedGuidanceLineItem(GuidanceLinePropertyType target) {
        setLightedGuidanceLine(XmlAdapterUtils.marshallJAXBElement(GuidanceLinePropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "lightedGuidanceLine"), GuidanceLineLightSystemTimeSliceType.class, target));
    }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        final GuidanceLineLightSystemTimeSliceType that = ((GuidanceLineLightSystemTimeSliceType) object);
        {
            ...
            List<GuidanceLineLightSystemTimeSliceExtensionType> lhsField;
            lhsField = (this.isSetExtension()?this.getExtension():null);
            List<GuidanceLineLightSystemTimeSliceExtensionType> rhsField;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        }
        {
            ...
            List<GuidanceLineLightSystemTimeSliceExtensionType> theField;
