 ...
 *         <element name="centreline" type="{http://www.aixm.aero/schema/5.1}ElevatedCurvePropertyType" minOccurs="0"/>
    ...
    implements Serializable
{
    ...
    public void setExtentItem(AIXMElevatedSurfacePropertyType target) {
        setExtent(XmlAdapterUtils.marshallJAXBElement(AIXMElevatedSurfacePropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "extent"), SeaplaneRampSiteTimeSliceType.class, target));
    }
    ...
    public void setCentrelineItem(AIXMElevatedCurvePropertyType target) {
        setCentreline(XmlAdapterUtils.marshallJAXBElement(AIXMElevatedCurvePropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "centreline"), SeaplaneRampSiteTimeSliceType.class, target));
    }
