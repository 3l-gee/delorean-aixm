 ...
 *         <element name="engineType" type="{http://www.aixm.aero/schema/5.1}AircraftCharacteristicPropertyType" minOccurs="0"/>
    ...
    implements Serializable
{
    ...
    @JoinTable(name = "dprtrarrvlcndtntp_annttn_link", schema = "procedure", joinColumns = {
    ...
    public void setMinimumEnrouteAltitudeItem(ValDistanceVerticalType target) {
        setMinimumEnrouteAltitude(XmlAdapterUtils.marshallJAXBElement(ValDistanceVerticalType.class, new QName("http://www.aixm.aero/schema/5.1", "minimumEnrouteAltitude"), DepartureArrivalConditionType.class, target));
    }
    ...
    public void setMinimumCrossingAtEndItem(ValDistanceVerticalType target) {
        setMinimumCrossingAtEnd(XmlAdapterUtils.marshallJAXBElement(ValDistanceVerticalType.class, new QName("http://www.aixm.aero/schema/5.1", "minimumCrossingAtEnd"), DepartureArrivalConditionType.class, target));
    }
    ...
    public void setMinimumCrossingAtEndReferenceItem(CodeVerticalReferenceType target) {
        setMinimumCrossingAtEndReference(XmlAdapterUtils.marshallJAXBElement(CodeVerticalReferenceType.class, new QName("http://www.aixm.aero/schema/5.1", "minimumCrossingAtEndReference"), DepartureArrivalConditionType.class, target));
    }
    ...
    public void setMaximumCrossingAtEndItem(ValDistanceVerticalType target) {
        setMaximumCrossingAtEnd(XmlAdapterUtils.marshallJAXBElement(ValDistanceVerticalType.class, new QName("http://www.aixm.aero/schema/5.1", "maximumCrossingAtEnd"), DepartureArrivalConditionType.class, target));
    }
    ...
    public void setMaximumCrossingAtEndReferenceItem(CodeVerticalReferenceType target) {
        setMaximumCrossingAtEndReference(XmlAdapterUtils.marshallJAXBElement(CodeVerticalReferenceType.class, new QName("http://www.aixm.aero/schema/5.1", "maximumCrossingAtEndReference"), DepartureArrivalConditionType.class, target));
    }

    @OneToOne(targetEntity = AircraftCharacteristicPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "dprtrarrvlcndtntp_engntp_link", schema = "procedure", joinColumns = {
        @JoinColumn(name = "departurearrivalcondition_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setEngineTypeItem(AircraftCharacteristicPropertyType target) {
        setEngineType(XmlAdapterUtils.marshallJAXBElement(AircraftCharacteristicPropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "engineType"), DepartureArrivalConditionType.class, target));
    }
