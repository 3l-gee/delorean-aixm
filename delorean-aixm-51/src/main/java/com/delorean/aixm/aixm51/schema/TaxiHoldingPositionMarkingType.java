 ...
 *       <sequence>
 *         <element name="timeSlice" type="{http://www.aixm.aero/schema/5.1}TaxiHoldingPositionMarkingTimeSlicePropertyType" maxOccurs="unbounded"/>
 *       </sequence>
 *     </extension>
 *   </complexContent>
 * </complexType>
...
@Table(name = "taxiholdingpositionmarking_f", schema = "airport_heliport")
    ...
    implements Serializable
{
    ...
    @OneToMany(targetEntity = TaxiHoldingPositionMarkingTimeSlicePropertyType.class, cascade = {
        CascadeType.ALL
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        final TaxiHoldingPositionMarkingType that = ((TaxiHoldingPositionMarkingType) object);
        {
