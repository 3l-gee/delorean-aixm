 ...
 *       <sequence>
 *         <element ref="{http://www.aixm.aero/schema/5.1}AbstractAerialRefuellingTrackExtension"/>
 *       </sequence>
...
public class AerialRefuellingTrackExtensionType implements Serializable, Equals, HashCode, ToString
{
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = 1;
        {
            ...
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "abstractAerialRefuellingTrackExtension", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            AbstractExtensionType theField;
            theField = this.getAbstractAerialRefuellingTrackExtension();
            strategy.appendField(locator, this, "abstractAerialRefuellingTrackExtension", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetOwns();
            boolean theField;
