 ...
 *         <element name="class" type="{http://www.aixm.aero/schema/5.1}CodeMarkerBeaconSignalType" minOccurs="0"/>
 *         <element name="frequency" type="{http://www.aixm.aero/schema/5.1}ValFrequencyType" minOccurs="0"/>
 *         <element name="axisBearing" type="{http://www.aixm.aero/schema/5.1}ValBearingType" minOccurs="0"/>
 *         <element name="auralMorseCode" type="{http://www.aixm.aero/schema/5.1}CodeAuralMorseType" minOccurs="0"/>
    ...
    implements Serializable
{
    ...
    protected List<MarkerBeaconTimeSliceExtensionType> extension;
    ...
    public void setDesignatorItem(CodeNavaidDesignatorType target) {
        setDesignator(XmlAdapterUtils.marshallJAXBElement(CodeNavaidDesignatorType.class, new QName("http://www.aixm.aero/schema/5.1", "designator"), MarkerBeaconTimeSliceType.class, target));
    }
    ...
    public void setAixmNameItem(TextNameType target) {
        setAixmName(XmlAdapterUtils.marshallJAXBElement(TextNameType.class, new QName("http://www.aixm.aero/schema/5.1", "name"), MarkerBeaconTimeSliceType.class, target));
    }
    ...
    public void setEmissionClassItem(CodeRadioEmissionType target) {
        setEmissionClass(XmlAdapterUtils.marshallJAXBElement(CodeRadioEmissionType.class, new QName("http://www.aixm.aero/schema/5.1", "emissionClass"), MarkerBeaconTimeSliceType.class, target));
    }
    ...
    public void setMobileItem(CodeYesNoType target) {
        setMobile(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.1", "mobile"), MarkerBeaconTimeSliceType.class, target));
    }
    ...
    public void setMagneticVariationItem(ValMagneticVariationType target) {
        setMagneticVariation(XmlAdapterUtils.marshallJAXBElement(ValMagneticVariationType.class, new QName("http://www.aixm.aero/schema/5.1", "magneticVariation"), MarkerBeaconTimeSliceType.class, target));
    }
    ...
    public void setMagneticVariationAccuracyItem(ValAngleType target) {
        setMagneticVariationAccuracy(XmlAdapterUtils.marshallJAXBElement(ValAngleType.class, new QName("http://www.aixm.aero/schema/5.1", "magneticVariationAccuracy"), MarkerBeaconTimeSliceType.class, target));
    }
    ...
    public void setDateMagneticVariationItem(DateYearType target) {
        setDateMagneticVariation(XmlAdapterUtils.marshallJAXBElement(DateYearType.class, new QName("http://www.aixm.aero/schema/5.1", "dateMagneticVariation"), MarkerBeaconTimeSliceType.class, target));
    }
    ...
    public void setFlightCheckedItem(CodeYesNoType target) {
        setFlightChecked(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.1", "flightChecked"), MarkerBeaconTimeSliceType.class, target));
    }
    ...
    public void setLocationItem(AIXMElevatedPointPropertyType target) {
        setLocation(XmlAdapterUtils.marshallJAXBElement(AIXMElevatedPointPropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "location"), MarkerBeaconTimeSliceType.class, target));
    }
    ...
    public void setClazzItem(CodeMarkerBeaconSignalType target) {
        setClazz(XmlAdapterUtils.marshallJAXBElement(CodeMarkerBeaconSignalType.class, new QName("http://www.aixm.aero/schema/5.1", "class"), MarkerBeaconTimeSliceType.class, target));
    }
    ...
    public void setFrequencyItem(ValFrequencyType target) {
        setFrequency(XmlAdapterUtils.marshallJAXBElement(ValFrequencyType.class, new QName("http://www.aixm.aero/schema/5.1", "frequency"), MarkerBeaconTimeSliceType.class, target));
    }
    ...
    public void setAxisBearingItem(ValBearingType target) {
        setAxisBearing(XmlAdapterUtils.marshallJAXBElement(ValBearingType.class, new QName("http://www.aixm.aero/schema/5.1", "axisBearing"), MarkerBeaconTimeSliceType.class, target));
    }
    ...
    public void setAuralMorseCodeItem(CodeAuralMorseType target) {
        setAuralMorseCode(XmlAdapterUtils.marshallJAXBElement(CodeAuralMorseType.class, new QName("http://www.aixm.aero/schema/5.1", "auralMorseCode"), MarkerBeaconTimeSliceType.class, target));
    }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        }
        {
            ...
            JAXBElement<CodeMarkerBeaconSignalType> lhsField;
            lhsField = this.getClazz();
            JAXBElement<CodeMarkerBeaconSignalType> rhsField;
        ...
        }
        {
            ...
            lhsField = this.getAuralMorseCode();
            JAXBElement<CodeAuralMorseType> rhsField;
            rhsField = that.getAuralMorseCode();
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "auralMorseCode", lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "auralMorseCode", rhsField);
            if (!strategy.equals(lhsFieldLocator, rhsFieldLocator, lhsField, rhsField, lhsFieldIsSet, rhsFieldIsSet)) {
                return false;
            }
        }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        }
        {
            ...
            JAXBElement<CodeMarkerBeaconSignalType> theField;
        ...
        {
            boolean theFieldIsSet = this.isSetAxisBearing();
            JAXBElement<ValBearingType> theField;
            theField = this.getAxisBearing();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "axisBearing", theField);
            currentHashCode = strategy.hashCode(theFieldLocator, currentHashCode, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetAuralMorseCode();
            JAXBElement<CodeAuralMorseType> theField;
            theField = this.getAuralMorseCode();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "auralMorseCode", theField);
            currentHashCode = strategy.hashCode(theFieldLocator, currentHashCode, theField, theFieldIsSet);
        }
        {
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        }
        {
            ...
            JAXBElement<ValBearingType> theField;
            theField = this.getAxisBearing();
            strategy.appendField(locator, this, "axisBearing", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetAuralMorseCode();
            JAXBElement<CodeAuralMorseType> theField;
            theField = this.getAuralMorseCode();
            strategy.appendField(locator, this, "auralMorseCode", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetExtension();
            List<MarkerBeaconTimeSliceExtensionType> theField;
