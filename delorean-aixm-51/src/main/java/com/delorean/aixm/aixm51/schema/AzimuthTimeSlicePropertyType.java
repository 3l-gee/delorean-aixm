 ...
 *       <sequence>
 *         <element ref="{http://www.aixm.aero/schema/5.1}AzimuthTimeSlice"/>
 *       </sequence>
...
public class AzimuthTimeSlicePropertyType implements Serializable, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        final AzimuthTimeSlicePropertyType that = ((AzimuthTimeSlicePropertyType) object);
        {
            ...
            AzimuthTimeSliceType lhsField;
            lhsField = this.getAzimuthTimeSlice();
            AzimuthTimeSliceType rhsField;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetAzimuthTimeSlice();
            AzimuthTimeSliceType theField;
            theField = this.getAzimuthTimeSlice();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "azimuthTimeSlice", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            AzimuthTimeSliceType theField;
            theField = this.getAzimuthTimeSlice();
            strategy.appendField(locator, this, "azimuthTimeSlice", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetOwns();
            boolean theField;
