 ...
 *       <sequence>
 *         <element name="upperLevel" type="{http://www.aixm.aero/schema/5.1}ValDistanceVerticalType" minOccurs="0"/>
 *         <element name="upperLevelReference" type="{http://www.aixm.aero/schema/5.1}CodeVerticalReferenceType" minOccurs="0"/>
 *         <element name="lowerLevel" type="{http://www.aixm.aero/schema/5.1}ValDistanceVerticalType" minOccurs="0"/>
 *         <element name="lowerLevelReference" type="{http://www.aixm.aero/schema/5.1}CodeVerticalReferenceType" minOccurs="0"/>
    ...
    implements Serializable
{
    ...
    public void setUpperLevelItem(ValDistanceVerticalType target) {
        setUpperLevel(XmlAdapterUtils.marshallJAXBElement(ValDistanceVerticalType.class, new QName("http://www.aixm.aero/schema/5.1", "upperLevel"), FlightRestrictionLevelType.class, target));
    }
    ...
    public void setUpperLevelReferenceItem(CodeVerticalReferenceType target) {
        setUpperLevelReference(XmlAdapterUtils.marshallJAXBElement(CodeVerticalReferenceType.class, new QName("http://www.aixm.aero/schema/5.1", "upperLevelReference"), FlightRestrictionLevelType.class, target));
    }
    ...
    public void setLowerLevelItem(ValDistanceVerticalType target) {
        setLowerLevel(XmlAdapterUtils.marshallJAXBElement(ValDistanceVerticalType.class, new QName("http://www.aixm.aero/schema/5.1", "lowerLevel"), FlightRestrictionLevelType.class, target));
    }
    ...
    public void setLowerLevelReferenceItem(CodeVerticalReferenceType target) {
        setLowerLevelReference(XmlAdapterUtils.marshallJAXBElement(CodeVerticalReferenceType.class, new QName("http://www.aixm.aero/schema/5.1", "lowerLevelReference"), FlightRestrictionLevelType.class, target));
    }
