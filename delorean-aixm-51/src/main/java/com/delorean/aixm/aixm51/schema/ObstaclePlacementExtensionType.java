 ...
 *       <sequence>
 *         <element ref=
"{http://www.aixm.aero/schema/5.1}AbstractObstaclePlacementExtension"/>
 *       </sequence>
 *       <attGroup ref=
...
@XmlType(name = "", propOrder = {"abstractObstaclePlacementExtension"})
@Entity(name = "ObstaclePlacementExtensionType")
@Table(name = "obstacleplacement_oe", schema = "shared")
public class ObstaclePlacementExtensionType implements Serializable, Equals, HashCode, ToString {
    ...
    @JoinColumn(name = "abstractobstacleplacementextension_hjid", referencedColumnName = "hjid")
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final ObstaclePlacementExtensionType that = ((ObstaclePlacementExtensionType) object);
        {
        ...
        }
        {
            ...
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "abstractObstaclePlacementExtension",
                    lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "abstractObstaclePlacementExtension",
                    rhsField);
            if (!strategy.equals(lhsFieldLocator, rhsFieldLocator, lhsField, rhsField, lhsFieldIsSet, rhsFieldIsSet)) {
                return false;
            }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetAbstractObstaclePlacementExtension();
            AbstractExtensionType theField;
            theField = this.getAbstractObstaclePlacementExtension();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "abstractObstaclePlacementExtension",
                    theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            AbstractExtensionType theField;
            theField = this.getAbstractObstaclePlacementExtension();
            strategy.appendField(locator, this, "abstractObstaclePlacementExtension", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetOwns();
            boolean theField;
