 ...
 *         <element name="monitored" type="{http://www.aixm.aero/schema/5.1}CodeYesNoType" minOccurs="0"/>
 ...
 *                   <element ref="{http://www.aixm.aero/schema/5.1}AbstractNavaidEquipmentMonitoringExtension"/>
 *                 </choice>
    ...
    implements Serializable
{
    ...
    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "monitored", columnDefinition = "codeyesnobase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "monitorednilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setMonitoredItem(CodeYesNoType target) {
        setMonitored(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.1", "monitored"), NavaidEquipmentMonitoringType.class, target));
    }
