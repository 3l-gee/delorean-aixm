 ...
 *         <element name="style" type="{http://www.aixm.aero/schema/5.1}CodeMarkingStyleType" minOccurs="0"/>
 *         <choice>
 ...
 *           <element name="extent_location" type="{http://www.aixm.aero/schema/5.1}ElevatedPointPropertyType" minOccurs="0"/>
 *         </choice>
    ...
    implements Serializable
{
    ...
    public void setColourItem(CodeColourType target) {
        setColour(XmlAdapterUtils.marshallJAXBElement(CodeColourType.class, new QName("http://www.aixm.aero/schema/5.1", "colour"), MarkingElementType.class, target));
    }
    ...
    public void setStyleItem(CodeMarkingStyleType target) {
        setStyle(XmlAdapterUtils.marshallJAXBElement(CodeMarkingStyleType.class, new QName("http://www.aixm.aero/schema/5.1", "style"), MarkingElementType.class, target));
    }
    ...
    public void setExtentSurfaceExtentItem(AIXMElevatedSurfacePropertyType target) {
        setExtentSurfaceExtent(XmlAdapterUtils.marshallJAXBElement(AIXMElevatedSurfacePropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "extent_surfaceExtent"), MarkingElementType.class, target));
    }
    ...
    public void setExtentCurveExtentItem(AIXMElevatedCurvePropertyType target) {
        setExtentCurveExtent(XmlAdapterUtils.marshallJAXBElement(AIXMElevatedCurvePropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "extent_curveExtent"), MarkingElementType.class, target));
    }
    ...
    public void setExtentLocationItem(AIXMElevatedPointPropertyType target) {
        setExtentLocation(XmlAdapterUtils.marshallJAXBElement(AIXMElevatedPointPropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "extent_location"), MarkingElementType.class, target));
    }
