 ...
 *         <element name="sectorDescription" type="{http://www.aixm.aero/schema/5.1}CircleSectorPropertyType" minOccurs="0"/>
 *         <element name="restrictionArea" type="{http://www.aixm.aero/schema/5.1}SurfacePropertyType" minOccurs="0"/>
    ...
    implements Serializable
{
    ...
    @JoinTable(name = "crclngrstrctntp_tmintrvl_l", schema = "procedure", joinColumns = {
        @JoinColumn(name = "circlingrestriction_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "crclngrstrctntp_annttn_l", schema = "procedure", joinColumns = {
        @JoinColumn(name = "circlingrestriction_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "crclngrstrctntp_spcldtathrt_l", schema = "procedure", joinColumns = {
        @JoinColumn(name = "circlingrestriction_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "crclngrstrctntp_sctrdscrptn_l", schema = "procedure", joinColumns = {
        @JoinColumn(name = "circlingrestriction_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setSectorDescriptionItem(CircleSectorPropertyType target) {
        setSectorDescription(XmlAdapterUtils.marshallJAXBElement(CircleSectorPropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "sectorDescription"), CirclingRestrictionType.class, target));
    }

    @OneToOne(targetEntity = AIXMSurfacePropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "crclngrstrctntp_rstrctnar_l", schema = "procedure", joinColumns = {
        @JoinColumn(name = "circlingrestriction_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setRestrictionAreaItem(AIXMSurfacePropertyType target) {
        setRestrictionArea(XmlAdapterUtils.marshallJAXBElement(AIXMSurfacePropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "restrictionArea"), CirclingRestrictionType.class, target));
    }
