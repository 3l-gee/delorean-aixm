 ...
 *       <sequence>
 *         <element name="type" type="{http://www.aixm.aero/schema/5.1}CodeWorkAreaType" minOccurs="0"/>
 *         <element name="plannedOperational" type="{http://www.aixm.aero/schema/5.1}DateType" minOccurs="0"/>
 ...
 *         <element name="activation" type="{http://www.aixm.aero/schema/5.1}WorkareaActivityPropertyType" maxOccurs="unbounded" minOccurs="0"/>
    ...
    implements Serializable
{
    ...
    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "type", columnDefinition = "codeworkareabase")),
    ...
    public void setTypeItem(CodeWorkAreaType target) {
        setType(XmlAdapterUtils.marshallJAXBElement(CodeWorkAreaType.class, new QName("http://www.aixm.aero/schema/5.1", "type"), WorkAreaTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "plannedoperational", columnDefinition = "datebase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "plannedoperationalnilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setPlannedOperationalItem(DateType target) {
        setPlannedOperational(XmlAdapterUtils.marshallJAXBElement(DateType.class, new QName("http://www.aixm.aero/schema/5.1", "plannedOperational"), WorkAreaTimeSliceType.class, target));
    }
    ...
    public void setAssociatedAirportHeliportItem(AirportHeliportPropertyType target) {
        setAssociatedAirportHeliport(XmlAdapterUtils.marshallJAXBElement(AirportHeliportPropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "associatedAirportHeliport"), WorkAreaTimeSliceType.class, target));
    }
    ...
    public void setExtentItem(AIXMElevatedSurfacePropertyType target) {
        setExtent(XmlAdapterUtils.marshallJAXBElement(AIXMElevatedSurfacePropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "extent"), WorkAreaTimeSliceType.class, target));
    }
