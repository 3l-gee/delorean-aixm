...
"{http://www.aixm.aero/schema/5.1}CodeOilType" minOccurs="0"/>
 ...
 *                 <sequence>
 *                   <element ref=
"{http://www.aixm.aero/schema/5.1}AbstractOilExtension"/>
 *                 </sequence>
 *                 <attGroup ref=
...
public class OilType extends AbstractAIXMObjectType implements Serializable {
    ...
    public void setCategoryItem(CodeOilType target) {
        setCategory(XmlAdapterUtils.marshallJAXBElement(CodeOilType.class,
                new QName("http://www.aixm.aero/schema/5.1", "category"), OilType.class, target));
    }
