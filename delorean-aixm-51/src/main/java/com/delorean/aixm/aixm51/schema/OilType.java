 ...
 *       <sequence>
 *         <element name="category" type="{http://www.aixm.aero/schema/5.1}CodeOilType" minOccurs="0"/>
    ...
    implements Serializable
{
    ...
    public void setCategoryItem(CodeOilType target) {
        setCategory(XmlAdapterUtils.marshallJAXBElement(CodeOilType.class, new QName("http://www.aixm.aero/schema/5.1", "category"), OilType.class, target));
    }
