 ...
 *         <element name="type" type="{http://www.aixm.aero/schema/5.1}CodeTaxiwayType" minOccurs="0"/>
 ...
 *         <element name="contaminant" type="{http://www.aixm.aero/schema/5.1}TaxiwayContaminationPropertyType" maxOccurs="unbounded" minOccurs="0"/>
    ...
    implements Serializable
{
    ...
    public void setDesignatorItem(TextDesignatorType target) {
        setDesignator(XmlAdapterUtils.marshallJAXBElement(TextDesignatorType.class, new QName("http://www.aixm.aero/schema/5.1", "designator"), TaxiwayTimeSliceType.class, target));
    }
    ...
    public void setTypeItem(CodeTaxiwayType target) {
        setType(XmlAdapterUtils.marshallJAXBElement(CodeTaxiwayType.class, new QName("http://www.aixm.aero/schema/5.1", "type"), TaxiwayTimeSliceType.class, target));
    }
    ...
    public void setWidthItem(ValDistanceType target) {
        setWidth(XmlAdapterUtils.marshallJAXBElement(ValDistanceType.class, new QName("http://www.aixm.aero/schema/5.1", "width"), TaxiwayTimeSliceType.class, target));
    }
    ...
    public void setWidthShoulderItem(ValDistanceType target) {
        setWidthShoulder(XmlAdapterUtils.marshallJAXBElement(ValDistanceType.class, new QName("http://www.aixm.aero/schema/5.1", "widthShoulder"), TaxiwayTimeSliceType.class, target));
    }
    ...
    public void setLengthItem(ValDistanceType target) {
        setLength(XmlAdapterUtils.marshallJAXBElement(ValDistanceType.class, new QName("http://www.aixm.aero/schema/5.1", "length"), TaxiwayTimeSliceType.class, target));
    }
    ...
    public void setAbandonedItem(CodeYesNoType target) {
        setAbandoned(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.1", "abandoned"), TaxiwayTimeSliceType.class, target));
    }
    ...
    public void setSurfacePropertiesItem(SurfaceCharacteristicsPropertyType target) {
        setSurfaceProperties(XmlAdapterUtils.marshallJAXBElement(SurfaceCharacteristicsPropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "surfaceProperties"), TaxiwayTimeSliceType.class, target));
    }
    ...
    public void setAssociatedAirportHeliportItem(AirportHeliportPropertyType target) {
        setAssociatedAirportHeliport(XmlAdapterUtils.marshallJAXBElement(AirportHeliportPropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "associatedAirportHeliport"), TaxiwayTimeSliceType.class, target));
    }
