 ...
 *       <sequence>
 *         <element name="type" type="{http://www.aixm.aero/schema/5.1}CodeOrganisationHierarchyType" minOccurs="0"/>
    ...
    implements Serializable
{
    ...
    public void setTypeItem(CodeOrganisationHierarchyType target) {
        setType(XmlAdapterUtils.marshallJAXBElement(CodeOrganisationHierarchyType.class, new QName("http://www.aixm.aero/schema/5.1", "type"), OrganisationAuthorityAssociationType.class, target));
    }
