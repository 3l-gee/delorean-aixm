 ...
 *       <sequence>
 *         <element ref=
"{http://www.aixm.aero/schema/5.1}AbstractMeteorologyExtension"/>
 *       </sequence>
 *       <attGroup ref=
...
@XmlType(name = "", propOrder = {"abstractMeteorologyExtension"})
@Entity(name = "MeteorologyExtensionType")
@Table(name = "meteorology_oe", schema = "shared")
public class MeteorologyExtensionType implements Serializable, Equals, HashCode, ToString {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final MeteorologyExtensionType that = ((MeteorologyExtensionType) object);
        {
            ...
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "abstractMeteorologyExtension",
                    lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "abstractMeteorologyExtension",
                    rhsField);
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetAbstractMeteorologyExtension();
            AbstractExtensionType theField;
            theField = this.getAbstractMeteorologyExtension();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "abstractMeteorologyExtension", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            AbstractExtensionType theField;
            theField = this.getAbstractMeteorologyExtension();
            strategy.appendField(locator, this, "abstractMeteorologyExtension", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetOwns();
            boolean theField;
