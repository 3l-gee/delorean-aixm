 ...
 *       <sequence>
 *         <element name="timeSlice" type="{http://www.aixm.aero/schema/5.1}CheckpointVORTimeSlicePropertyType" maxOccurs="unbounded"/>
 *       </sequence>
 *     </extension>
 *   </complexContent>
 * </complexType>
...
@Table(name = "checkpointvor_f", schema = "navaids_point")
    ...
    implements Serializable
{
    ...
    @OneToMany(targetEntity = CheckpointVORTimeSlicePropertyType.class, cascade = {
        CascadeType.ALL
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        final CheckpointVORType that = ((CheckpointVORType) object);
        {
