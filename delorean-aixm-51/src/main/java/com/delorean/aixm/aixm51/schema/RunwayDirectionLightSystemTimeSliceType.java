 ...
 *         <element name="position" type="{http://www.aixm.aero/schema/5.1}CodeRunwaySectionType" minOccurs="0"/>
 *         <element name="associatedRunwayDirection" type="{http://www.aixm.aero/schema/5.1}RunwayDirectionPropertyType" minOccurs="0"/>
    ...
    implements Serializable
{
    ...
    public void setEmergencyLightingItem(CodeYesNoType target) {
        setEmergencyLighting(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.1", "emergencyLighting"), RunwayDirectionLightSystemTimeSliceType.class, target));
    }
    ...
    public void setIntensityLevelItem(CodeLightIntensityType target) {
        setIntensityLevel(XmlAdapterUtils.marshallJAXBElement(CodeLightIntensityType.class, new QName("http://www.aixm.aero/schema/5.1", "intensityLevel"), RunwayDirectionLightSystemTimeSliceType.class, target));
    }
    ...
    public void setColourItem(CodeColourType target) {
        setColour(XmlAdapterUtils.marshallJAXBElement(CodeColourType.class, new QName("http://www.aixm.aero/schema/5.1", "colour"), RunwayDirectionLightSystemTimeSliceType.class, target));
    }
    ...
    public void setPositionItem(CodeRunwaySectionType target) {
        setPosition(XmlAdapterUtils.marshallJAXBElement(CodeRunwaySectionType.class, new QName("http://www.aixm.aero/schema/5.1", "position"), RunwayDirectionLightSystemTimeSliceType.class, target));
    }
    ...
    public void setAssociatedRunwayDirectionItem(RunwayDirectionPropertyType target) {
        setAssociatedRunwayDirection(XmlAdapterUtils.marshallJAXBElement(RunwayDirectionPropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "associatedRunwayDirection"), RunwayDirectionLightSystemTimeSliceType.class, target));
    }
