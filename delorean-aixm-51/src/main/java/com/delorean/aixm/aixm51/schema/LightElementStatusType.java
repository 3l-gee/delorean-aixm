...
/**
 * <p>Java class for LightElementStatusType complex type</p>.
 * 
 ...
 *                   <element ref="{http://www.aixm.aero/schema/5.1}AbstractLightElementStatusExtension"/>
 *                 </choice>
...
@XmlType(name = "LightElementStatusType", propOrder = {
    "timeInterval",
    "annotation",
    ...
    implements Serializable
{
    ...
    @JoinTable(name = "lghtelmntsttstp_tmintrvl_link", schema = "shared", joinColumns = {
        @JoinColumn(name = "lightelementstatus_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setStatusItem(CodeStatusOperationsType target) {
        setStatus(XmlAdapterUtils.marshallJAXBElement(CodeStatusOperationsType.class, new QName("http://www.aixm.aero/schema/5.1", "status"), LightElementStatusType.class, target));
    }
