 ...
 *       <sequence>
 *         <element name="status" type="{http://www.aixm.aero/schema/5.1}CodeStatusOperationsType" minOccurs="0"/>
 *         <element name="length" type="{http://www.aixm.aero/schema/5.1}ValDistanceType" minOccurs="0"/>
 *         <element name="width" type="{http://www.aixm.aero/schema/5.1}ValDistanceType" minOccurs="0"/>
 *         <element name="engageDevice" type="{http://www.aixm.aero/schema/5.1}CodeArrestingGearEngageDeviceType" minOccurs="0"/>
 *         <element name="absorbType" type="{http://www.aixm.aero/schema/5.1}CodeArrestingGearEnergyAbsorbType" minOccurs="0"/>
 *         <element name="bidirectional" type="{http://www.aixm.aero/schema/5.1}CodeYesNoType" minOccurs="0"/>
 *         <element name="location" type="{http://www.aixm.aero/schema/5.1}ValDistanceType" minOccurs="0"/>
 *         <element name="runwayDirection" type="{http://www.aixm.aero/schema/5.1}RunwayDirectionPropertyType" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="surfaceProperties" type="{http://www.aixm.aero/schema/5.1}SurfaceCharacteristicsPropertyType" minOccurs="0"/>
 *         <choice>
 *           <element name="extent_curveExtent" type="{http://www.aixm.aero/schema/5.1}ElevatedCurvePropertyType" minOccurs="0"/>
 *           <element name="extent_surfaceExtent" type="{http://www.aixm.aero/schema/5.1}ElevatedSurfacePropertyType" minOccurs="0"/>
 *           <element name="extent_pointExtent" type="{http://www.aixm.aero/schema/5.1}ElevatedPointPropertyType" minOccurs="0"/>
 *         </choice>
    ...
    implements Serializable
{
    ...
    public void setStatusItem(CodeStatusOperationsType target) {
        setStatus(XmlAdapterUtils.marshallJAXBElement(CodeStatusOperationsType.class, new QName("http://www.aixm.aero/schema/5.1", "status"), ArrestingGearTimeSliceType.class, target));
    }
    ...
    public void setLengthItem(ValDistanceType target) {
        setLength(XmlAdapterUtils.marshallJAXBElement(ValDistanceType.class, new QName("http://www.aixm.aero/schema/5.1", "length"), ArrestingGearTimeSliceType.class, target));
    }
    ...
    public void setWidthItem(ValDistanceType target) {
        setWidth(XmlAdapterUtils.marshallJAXBElement(ValDistanceType.class, new QName("http://www.aixm.aero/schema/5.1", "width"), ArrestingGearTimeSliceType.class, target));
    }
    ...
    public void setEngageDeviceItem(CodeArrestingGearEngageDeviceType target) {
        setEngageDevice(XmlAdapterUtils.marshallJAXBElement(CodeArrestingGearEngageDeviceType.class, new QName("http://www.aixm.aero/schema/5.1", "engageDevice"), ArrestingGearTimeSliceType.class, target));
    }
    ...
    public void setAbsorbTypeItem(CodeArrestingGearEnergyAbsorbType target) {
        setAbsorbType(XmlAdapterUtils.marshallJAXBElement(CodeArrestingGearEnergyAbsorbType.class, new QName("http://www.aixm.aero/schema/5.1", "absorbType"), ArrestingGearTimeSliceType.class, target));
    }
    ...
    public void setBidirectionalItem(CodeYesNoType target) {
        setBidirectional(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.1", "bidirectional"), ArrestingGearTimeSliceType.class, target));
    }
    ...
    public void setLocationItem(ValDistanceType target) {
        setLocation(XmlAdapterUtils.marshallJAXBElement(ValDistanceType.class, new QName("http://www.aixm.aero/schema/5.1", "location"), ArrestingGearTimeSliceType.class, target));
    }
    ...
    public void setSurfacePropertiesItem(SurfaceCharacteristicsPropertyType target) {
        setSurfaceProperties(XmlAdapterUtils.marshallJAXBElement(SurfaceCharacteristicsPropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "surfaceProperties"), ArrestingGearTimeSliceType.class, target));
    }
    ...
    public void setExtentCurveExtentItem(AIXMElevatedCurvePropertyType target) {
        setExtentCurveExtent(XmlAdapterUtils.marshallJAXBElement(AIXMElevatedCurvePropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "extent_curveExtent"), ArrestingGearTimeSliceType.class, target));
    }
    ...
    public void setExtentSurfaceExtentItem(AIXMElevatedSurfacePropertyType target) {
        setExtentSurfaceExtent(XmlAdapterUtils.marshallJAXBElement(AIXMElevatedSurfacePropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "extent_surfaceExtent"), ArrestingGearTimeSliceType.class, target));
    }
    ...
    public void setExtentPointExtentItem(AIXMElevatedPointPropertyType target) {
        setExtentPointExtent(XmlAdapterUtils.marshallJAXBElement(AIXMElevatedPointPropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "extent_pointExtent"), ArrestingGearTimeSliceType.class, target));
    }
