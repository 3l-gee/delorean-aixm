 ...
 *         <element name="classification" type="{http://www.aixm.aero/schema/5.1}CodeAirspaceClassificationType" minOccurs="0"/>
 *         <element name="associatedLevels" type="{http://www.aixm.aero/schema/5.1}AirspaceLayerPropertyType" maxOccurs="unbounded" minOccurs="0"/>
    ...
    implements Serializable
{
    ...
    @JoinTable(name = "arspclrclsstp_tmintrvl_l", schema = "airspace", joinColumns = {
        @JoinColumn(name = "airspacelayerclass_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "arspclrclsstp_annttn_l", schema = "airspace", joinColumns = {
        @JoinColumn(name = "airspacelayerclass_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "arspclrclsstp_spcldtathrt_l", schema = "airspace", joinColumns = {
        @JoinColumn(name = "airspacelayerclass_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "arspclrclsstp_assctdlvls_l", schema = "airspace", joinColumns = {
        @JoinColumn(name = "airspacelayerclass_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "classification", columnDefinition = "codeairspaceclassificationbase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "classificationnilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setClassificationItem(CodeAirspaceClassificationType target) {
        setClassification(XmlAdapterUtils.marshallJAXBElement(CodeAirspaceClassificationType.class, new QName("http://www.aixm.aero/schema/5.1", "classification"), AirspaceLayerClassType.class, target));
    }
