 ...
 *         <element name="discreteLevelSeries" type="{http://www.aixm.aero/schema/5.1}StandardLevelColumnPropertyType" minOccurs="0"/>
    ...
    implements Serializable
{
    ...
    public void setUpperLimitItem(ValDistanceVerticalType target) {
        setUpperLimit(XmlAdapterUtils.marshallJAXBElement(ValDistanceVerticalType.class, new QName("http://www.aixm.aero/schema/5.1", "upperLimit"), AirspaceLayerType.class, target));
    }
    ...
    public void setUpperLimitReferenceItem(CodeVerticalReferenceType target) {
        setUpperLimitReference(XmlAdapterUtils.marshallJAXBElement(CodeVerticalReferenceType.class, new QName("http://www.aixm.aero/schema/5.1", "upperLimitReference"), AirspaceLayerType.class, target));
    }
    ...
    public void setLowerLimitItem(ValDistanceVerticalType target) {
        setLowerLimit(XmlAdapterUtils.marshallJAXBElement(ValDistanceVerticalType.class, new QName("http://www.aixm.aero/schema/5.1", "lowerLimit"), AirspaceLayerType.class, target));
    }
    ...
    public void setLowerLimitReferenceItem(CodeVerticalReferenceType target) {
        setLowerLimitReference(XmlAdapterUtils.marshallJAXBElement(CodeVerticalReferenceType.class, new QName("http://www.aixm.aero/schema/5.1", "lowerLimitReference"), AirspaceLayerType.class, target));
    }
    ...
    public void setAltitudeInterpretationItem(CodeAltitudeUseType target) {
        setAltitudeInterpretation(XmlAdapterUtils.marshallJAXBElement(CodeAltitudeUseType.class, new QName("http://www.aixm.aero/schema/5.1", "altitudeInterpretation"), AirspaceLayerType.class, target));
    }
    ...
    public void setDiscreteLevelSeriesItem(StandardLevelColumnPropertyType target) {
        setDiscreteLevelSeries(XmlAdapterUtils.marshallJAXBElement(StandardLevelColumnPropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "discreteLevelSeries"), AirspaceLayerType.class, target));
    }
