 ...
 *       <sequence>
 *         <element name="type" type="{http://www.aixm.aero/schema/5.1}CodeUsageLimitationType" minOccurs="0"/>
 *         <element name="priorPermission" type="{http://www.aixm.aero/schema/5.1}ValDurationType" minOccurs="0"/>
 *         <element name="contact" type="{http://www.aixm.aero/schema/5.1}ContactInformationPropertyType" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="selection" type="{http://www.aixm.aero/schema/5.1}ConditionCombinationPropertyType" minOccurs="0"/>
 *         <element name="annotation" type="{http://www.aixm.aero/schema/5.1}NotePropertyType" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="operation" type="{http://www.aixm.aero/schema/5.1}CodeOperationAirportHeliportType" minOccurs="0"/>
    ...
    implements Serializable
{
    ...
    public void setTypeItem(CodeUsageLimitationType target) {
        setType(XmlAdapterUtils.marshallJAXBElement(CodeUsageLimitationType.class, new QName("http://www.aixm.aero/schema/5.1", "type"), AirportHeliportUsageType.class, target));
    }
    ...
    public void setPriorPermissionItem(ValDurationType target) {
        setPriorPermission(XmlAdapterUtils.marshallJAXBElement(ValDurationType.class, new QName("http://www.aixm.aero/schema/5.1", "priorPermission"), AirportHeliportUsageType.class, target));
    }
    ...
    public void setSelectionItem(ConditionCombinationPropertyType target) {
        setSelection(XmlAdapterUtils.marshallJAXBElement(ConditionCombinationPropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "selection"), AirportHeliportUsageType.class, target));
    }
    ...
    public void setOperationItem(CodeOperationAirportHeliportType target) {
        setOperation(XmlAdapterUtils.marshallJAXBElement(CodeOperationAirportHeliportType.class, new QName("http://www.aixm.aero/schema/5.1", "operation"), AirportHeliportUsageType.class, target));
    }
