 ...
 *       <sequence>
 *         <element name="horizontalAlarmLimit" type="{http://www.aixm.aero/schema/5.1}ValAlarmLimitType" minOccurs="0"/>
 *         <element name="verticalAlarmLimit" type="{http://www.aixm.aero/schema/5.1}ValAlarmLimitType" minOccurs="0"/>
 *         <element name="thresholdCourseWidth" type="{http://www.aixm.aero/schema/5.1}ValDistanceType" minOccurs="0"/>
 *         <element name="lengthOffset" type="{http://www.aixm.aero/schema/5.1}ValDistanceType" minOccurs="0"/>
 *         <element name="CRCRemainder" type="{http://www.aixm.aero/schema/5.1}ValHexType" minOccurs="0"/>
 *         <element name="operationType" type="{http://www.aixm.aero/schema/5.1}NoSequenceType" minOccurs="0"/>
 *         <element name="serviceProviderSBAS" type="{http://www.aixm.aero/schema/5.1}NoSequenceType" minOccurs="0"/>
 *         <element name="approachPerformanceDesignator" type="{http://www.aixm.aero/schema/5.1}NoSequenceType" minOccurs="0"/>
 *         <element name="routeIndicator" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
 *         <element name="referencePathDataSelector" type="{http://www.aixm.aero/schema/5.1}NoSequenceType" minOccurs="0"/>
 *         <element name="referencePathIdentifier" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
 *         <element name="codeICAO" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
    ...
    implements Serializable
{
    ...
    protected List<FASDataBlockExtensionType> extension;
    ...
    public void setHorizontalAlarmLimitItem(ValAlarmLimitType target) {
        setHorizontalAlarmLimit(XmlAdapterUtils.marshallJAXBElement(ValAlarmLimitType.class, new QName("http://www.aixm.aero/schema/5.1", "horizontalAlarmLimit"), FASDataBlockType.class, target));
    }
    ...
    public void setVerticalAlarmLimitItem(ValAlarmLimitType target) {
        setVerticalAlarmLimit(XmlAdapterUtils.marshallJAXBElement(ValAlarmLimitType.class, new QName("http://www.aixm.aero/schema/5.1", "verticalAlarmLimit"), FASDataBlockType.class, target));
    }
    ...
    public void setThresholdCourseWidthItem(ValDistanceType target) {
        setThresholdCourseWidth(XmlAdapterUtils.marshallJAXBElement(ValDistanceType.class, new QName("http://www.aixm.aero/schema/5.1", "thresholdCourseWidth"), FASDataBlockType.class, target));
    }
    ...
    public void setLengthOffsetItem(ValDistanceType target) {
        setLengthOffset(XmlAdapterUtils.marshallJAXBElement(ValDistanceType.class, new QName("http://www.aixm.aero/schema/5.1", "lengthOffset"), FASDataBlockType.class, target));
    }
    ...
    public void setCRCRemainderItem(ValHexType target) {
        setCRCRemainder(XmlAdapterUtils.marshallJAXBElement(ValHexType.class, new QName("http://www.aixm.aero/schema/5.1", "CRCRemainder"), FASDataBlockType.class, target));
    }
    ...
    public void setOperationTypeItem(NoSequenceType target) {
        setOperationType(XmlAdapterUtils.marshallJAXBElement(NoSequenceType.class, new QName("http://www.aixm.aero/schema/5.1", "operationType"), FASDataBlockType.class, target));
    }
    ...
    public void setServiceProviderSBASItem(NoSequenceType target) {
        setServiceProviderSBAS(XmlAdapterUtils.marshallJAXBElement(NoSequenceType.class, new QName("http://www.aixm.aero/schema/5.1", "serviceProviderSBAS"), FASDataBlockType.class, target));
    }
    ...
    public void setApproachPerformanceDesignatorItem(NoSequenceType target) {
        setApproachPerformanceDesignator(XmlAdapterUtils.marshallJAXBElement(NoSequenceType.class, new QName("http://www.aixm.aero/schema/5.1", "approachPerformanceDesignator"), FASDataBlockType.class, target));
    }

    @Basic
    @Column(name = "routeindicator", nullable = true, length = 255)
    public String getRouteIndicatorItem() {
        return XmlAdapterUtils.unmarshallSource(String.class, this.getRouteIndicator());
    }

    public void setRouteIndicatorItem(String target) {
        setRouteIndicator(XmlAdapterUtils.marshallJAXBElement(String.class, new QName("http://www.aixm.aero/schema/5.1", "routeIndicator"), FASDataBlockType.class, target));
    }
    ...
    public void setReferencePathDataSelectorItem(NoSequenceType target) {
        setReferencePathDataSelector(XmlAdapterUtils.marshallJAXBElement(NoSequenceType.class, new QName("http://www.aixm.aero/schema/5.1", "referencePathDataSelector"), FASDataBlockType.class, target));
    }

    @Basic
    @Column(name = "referencepathidentifier", nullable = true, length = 255)
    public String getReferencePathIdentifierItem() {
        return XmlAdapterUtils.unmarshallSource(String.class, this.getReferencePathIdentifier());
    }

    public void setReferencePathIdentifierItem(String target) {
        setReferencePathIdentifier(XmlAdapterUtils.marshallJAXBElement(String.class, new QName("http://www.aixm.aero/schema/5.1", "referencePathIdentifier"), FASDataBlockType.class, target));
    }

    @Basic
    @Column(name = "codeicao", nullable = true, length = 255)
    public String getCodeICAOItem() {
        return XmlAdapterUtils.unmarshallSource(String.class, this.getCodeICAO());
    }

    public void setCodeICAOItem(String target) {
        setCodeICAO(XmlAdapterUtils.marshallJAXBElement(String.class, new QName("http://www.aixm.aero/schema/5.1", "codeICAO"), FASDataBlockType.class, target));
    }
