 ...
 *         <element name="operationalStatus" type="{http://www.aixm.aero/schema/5.1}CodeStatusOperationsType" minOccurs="0"/>
 ...
 *                   <element ref="{http://www.aixm.aero/schema/5.1}AbstractAltimeterSourceStatusExtension"/>
 *                 </choice>
    ...
    implements Serializable
{
    ...
    @JoinTable(name = "altmtrsrcsttstp_tmintrvl_link", schema = "airport_heliport", joinColumns = {
        @JoinColumn(name = "altimetersourcestatus_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "operationalstatus", columnDefinition = "codestatusoperationsbase")),
    ...
    public void setOperationalStatusItem(CodeStatusOperationsType target) {
        setOperationalStatus(XmlAdapterUtils.marshallJAXBElement(CodeStatusOperationsType.class, new QName("http://www.aixm.aero/schema/5.1", "operationalStatus"), AltimeterSourceStatusType.class, target));
    }
