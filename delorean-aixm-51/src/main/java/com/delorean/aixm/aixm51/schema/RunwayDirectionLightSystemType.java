...
/**
 * <p>
 * Java class for RunwayDirectionLightSystemType complex type
 * </p>
 * .
 *
 * <p>
 ...
 *
 * <pre>{@code
 * <complexType name="RunwayDirectionLightSystemType">
 *   <complexContent>
 *     <extension base=
"{http://www.aixm.aero/schema/5.1}AbstractGroundLightSystemType">
 *       <sequence>
 *         <element name="timeSlice" type=
"{http://www.aixm.aero/schema/5.1}RunwayDirectionLightSystemTimeSlicePropertyType" maxOccurs
="unbounded"/>
 *       </sequence>
 *     </extension>
 *   </complexContent>
...
@XmlType(name = "RunwayDirectionLightSystemType", propOrder = {"timeSlice"})
@Entity(name = "RunwayDirectionLightSystemType")
@Table(name = "runwaydirectionlightsystem_f", schema = "airport_heliport")
public class RunwayDirectionLightSystemType extends AbstractGroundLightSystemType implements Serializable {

    private static final long serialVersionUID = 20251104L;
    @XmlElement(required = true)
    protected List<RunwayDirectionLightSystemTimeSlicePropertyType> timeSlice;
     ...
     * {@link RunwayDirectionLightSystemTimeSlicePropertyType }
     *
     *
     */
     ...
     *
     */
    public void setTimeSlice(List<RunwayDirectionLightSystemTimeSlicePropertyType> timeSlice) {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final RunwayDirectionLightSystemType that = ((RunwayDirectionLightSystemType) object);
        {
            boolean lhsFieldIsSet = this.isSetTimeSlice();
            boolean rhsFieldIsSet = that.isSetTimeSlice();
            List<RunwayDirectionLightSystemTimeSlicePropertyType> lhsField;
            lhsField = (this.isSetTimeSlice() ? this.getTimeSlice() : null);
            List<RunwayDirectionLightSystemTimeSlicePropertyType> rhsField;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = super.hashCode(locator, strategy);
        {
            ...
            List<RunwayDirectionLightSystemTimeSlicePropertyType> theField;
