 ...
 *       <sequence>
 *         <element ref="{http://www.aixm.aero/schema/5.1}SpecialNavigationSystemTimeSlice"/>
 *       </sequence>
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            SpecialNavigationSystemTimeSliceType theField;
            theField = this.getSpecialNavigationSystemTimeSlice();
            strategy.appendField(locator, this, "specialNavigationSystemTimeSlice", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetOwns();
            boolean theField;
