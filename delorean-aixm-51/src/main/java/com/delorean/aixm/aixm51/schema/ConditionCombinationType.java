 ...
 *         <element name="logicalOperator" type="{http://www.aixm.aero/schema/5.1}CodeLogicalOperatorType" minOccurs="0"/>
 *         <element name="weather" type="{http://www.aixm.aero/schema/5.1}MeteorologyPropertyType" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="aircraft" type="{http://www.aixm.aero/schema/5.1}AircraftCharacteristicPropertyType" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="flight" type="{http://www.aixm.aero/schema/5.1}FlightCharacteristicPropertyType" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="subCondition" type="{http://www.aixm.aero/schema/5.1}ConditionCombinationPropertyType" maxOccurs="unbounded" minOccurs="0"/>
    ...
    implements Serializable
{
    ...
    @JoinTable(name = "cndtncmbntntp_tmintrvl_l", schema = "airport_heliport", joinColumns = {
        @JoinColumn(name = "conditioncombination_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "cndtncmbntntp_annttn_l", schema = "airport_heliport", joinColumns = {
        @JoinColumn(name = "conditioncombination_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "cndtncmbntntp_spcldtathrt_l", schema = "airport_heliport", joinColumns = {
        @JoinColumn(name = "conditioncombination_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
     ...
     * 
     */
    @OneToMany(targetEntity = MeteorologyPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "cndtncmbntntp_wthr_l", schema = "airport_heliport", joinColumns = {
        @JoinColumn(name = "conditioncombination_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "cndtncmbntntp_arcrft_l", schema = "airport_heliport", joinColumns = {
        @JoinColumn(name = "conditioncombination_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "cndtncmbntntp_flght_l", schema = "airport_heliport", joinColumns = {
        @JoinColumn(name = "conditioncombination_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "cndtncmbntntp_sbcndtn_l", schema = "airport_heliport", joinColumns = {
        @JoinColumn(name = "conditioncombination_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "logicaloperator", columnDefinition = "codelogicaloperatorbase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "logicaloperatornilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setLogicalOperatorItem(CodeLogicalOperatorType target) {
        setLogicalOperator(XmlAdapterUtils.marshallJAXBElement(CodeLogicalOperatorType.class, new QName("http://www.aixm.aero/schema/5.1", "logicalOperator"), ConditionCombinationType.class, target));
    }
