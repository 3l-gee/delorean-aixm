...
"{http://www.aixm.aero/schema/5.1}TextAddressType" minOccurs="0"/>
 ...
 *                   <element ref=
"{http://www.aixm.aero/schema/5.1}AbstractPostalAddressExtension"/>
 *                 </choice>
 *                 <attGroup ref=
...
@XmlType(name = "PostalAddressType", propOrder = {"timeInterval", "annotation", "specialDateAuthority", "deliveryPoint",
        "city", "administrativeArea", "postalCode", "country", "extension"})
@Entity(name = "PostalAddressType")
@Table(name = "postaladdress_o", schema = "shared")
public class PostalAddressType extends AbstractPropertiesWithScheduleType implements Serializable {
    ...
    @JoinTable(name = "pstladdrsstp_tmintrvl_link", schema = "shared", joinColumns = {
            @JoinColumn(name = "postaladdress_o_hjid", referencedColumnName = "hjid")}, inverseJoinColumns = {
     ...
     *
     */
    @OneToMany(targetEntity = PostalAddressExtensionType.class, cascade = {CascadeType.ALL}, fetch = FetchType.EAGER)
    ...
    @Embedded
    @AttributeOverrides({
            @AttributeOverride(name = "value", column = @Column(name = "deliverypoint", columnDefinition = "VARCHAR", length = 500)),
            @AttributeOverride(name = "nilReason", column = @Column(name = "deliverypointnilreason"))})
    ...
    public void setDeliveryPointItem(TextAddressType target) {
        setDeliveryPoint(XmlAdapterUtils.marshallJAXBElement(TextAddressType.class,
                new QName("http://www.aixm.aero/schema/5.1", "deliveryPoint"), PostalAddressType.class, target));
    }

    @Embedded
    @AttributeOverrides({
            @AttributeOverride(name = "value", column = @Column(name = "city", columnDefinition = "VARCHAR", length = 60)),
            @AttributeOverride(name = "nilReason", column = @Column(name = "citynilreason"))})
    ...
    public void setCityItem(TextNameType target) {
        setCity(XmlAdapterUtils.marshallJAXBElement(TextNameType.class,
                new QName("http://www.aixm.aero/schema/5.1", "city"), PostalAddressType.class, target));
    }

    @Embedded
    @AttributeOverrides({
            @AttributeOverride(name = "value", column = @Column(name = "administrativearea", columnDefinition = "VARCHAR", length = 60)),
            @AttributeOverride(name = "nilReason", column = @Column(name = "administrativeareanilreason"))})
    ...
    public void setAdministrativeAreaItem(TextNameType target) {
        setAdministrativeArea(XmlAdapterUtils.marshallJAXBElement(TextNameType.class,
                new QName("http://www.aixm.aero/schema/5.1", "administrativeArea"), PostalAddressType.class, target));
    }

    @Embedded
    @AttributeOverrides({
            @AttributeOverride(name = "value", column = @Column(name = "postalcode", columnDefinition = "VARCHAR", length = 60)),
            @AttributeOverride(name = "nilReason", column = @Column(name = "postalcodenilreason"))})
    ...
    public void setPostalCodeItem(TextNameType target) {
        setPostalCode(XmlAdapterUtils.marshallJAXBElement(TextNameType.class,
                new QName("http://www.aixm.aero/schema/5.1", "postalCode"), PostalAddressType.class, target));
    }

    @Embedded
    @AttributeOverrides({
            @AttributeOverride(name = "value", column = @Column(name = "country", columnDefinition = "VARCHAR", length = 60)),
            @AttributeOverride(name = "nilReason", column = @Column(name = "countrynilreason"))})
    ...
    public void setCountryItem(TextNameType target) {
        setCountry(XmlAdapterUtils.marshallJAXBElement(TextNameType.class,
                new QName("http://www.aixm.aero/schema/5.1", "country"), PostalAddressType.class, target));
    }
