    ...
    implements Serializable
{
    ...
    @JoinTable(name = "pstladdrsstp_tmintrvl_l", schema = "shared", joinColumns = {
    ...
    @JoinTable(name = "pstladdrsstp_annttn_l", schema = "shared", joinColumns = {
        @JoinColumn(name = "postaladdress_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "pstladdrsstp_spcldtathrt_l", schema = "shared", joinColumns = {
        @JoinColumn(name = "postaladdress_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
