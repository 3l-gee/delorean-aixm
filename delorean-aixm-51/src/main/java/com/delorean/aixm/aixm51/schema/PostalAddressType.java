 ...
 *         <element name="deliveryPoint" type="{http://www.aixm.aero/schema/5.1}TextAddressType" minOccurs="0"/>
 *         <element name="city" type="{http://www.aixm.aero/schema/5.1}TextNameType" minOccurs="0"/>
 *         <element name="administrativeArea" type="{http://www.aixm.aero/schema/5.1}TextNameType" minOccurs="0"/>
 *         <element name="postalCode" type="{http://www.aixm.aero/schema/5.1}TextNameType" minOccurs="0"/>
 *         <element name="country" type="{http://www.aixm.aero/schema/5.1}TextNameType" minOccurs="0"/>
 ...
 *                   <element ref="{http://www.aixm.aero/schema/5.1}AbstractPostalAddressExtension"/>
 *                 </choice>
...
@Table(name = "postaladdress_o", schema = "shared")
    ...
    implements Serializable
{
    ...
    @XmlElementRef(name = "deliveryPoint", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class, required = false)
    protected JAXBElement<TextAddressType> deliveryPoint;
    @XmlElementRef(name = "city", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class, required = false)
    protected JAXBElement<TextNameType> city;
    @XmlElementRef(name = "administrativeArea", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class, required = false)
    protected JAXBElement<TextNameType> administrativeArea;
    @XmlElementRef(name = "postalCode", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class, required = false)
    protected JAXBElement<TextNameType> postalCode;
    @XmlElementRef(name = "country", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class, required = false)
    ...
    @JoinTable(name = "pstladdrsstp_tmintrvl_link", schema = "shared", joinColumns = {
        @JoinColumn(name = "postaladdress_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "pstladdrsstp_annttn_link", schema = "shared", joinColumns = {
        @JoinColumn(name = "postaladdress_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "pstladdrsstp_spcldtathrt_link", schema = "shared", joinColumns = {
        @JoinColumn(name = "postaladdress_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
     ...
     * 
     */
    @OneToMany(targetEntity = PostalAddressExtensionType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinColumn(name = "postaladdress_oe_hjid", referencedColumnName = "hjid")
     ...
     * 
     */
    public void setExtension(List<PostalAddressExtensionType> extension) {
    ...
    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "deliverypoint", columnDefinition = "character2")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "deliverypointnilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setDeliveryPointItem(TextAddressType target) {
        setDeliveryPoint(XmlAdapterUtils.marshallJAXBElement(TextAddressType.class, new QName("http://www.aixm.aero/schema/5.1", "deliveryPoint"), PostalAddressType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "city", columnDefinition = "character3")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "citynilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setCityItem(TextNameType target) {
        setCity(XmlAdapterUtils.marshallJAXBElement(TextNameType.class, new QName("http://www.aixm.aero/schema/5.1", "city"), PostalAddressType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "administrativearea", columnDefinition = "character3")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "administrativeareanilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setAdministrativeAreaItem(TextNameType target) {
        setAdministrativeArea(XmlAdapterUtils.marshallJAXBElement(TextNameType.class, new QName("http://www.aixm.aero/schema/5.1", "administrativeArea"), PostalAddressType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "postalcode", columnDefinition = "character3")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "postalcodenilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setPostalCodeItem(TextNameType target) {
        setPostalCode(XmlAdapterUtils.marshallJAXBElement(TextNameType.class, new QName("http://www.aixm.aero/schema/5.1", "postalCode"), PostalAddressType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "country", columnDefinition = "character3")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "countrynilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setCountryItem(TextNameType target) {
        setCountry(XmlAdapterUtils.marshallJAXBElement(TextNameType.class, new QName("http://www.aixm.aero/schema/5.1", "country"), PostalAddressType.class, target));
    }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        }
        {
            ...
            List<PostalAddressExtensionType> lhsField;
            lhsField = (this.isSetExtension()?this.getExtension():null);
            List<PostalAddressExtensionType> rhsField;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        }
        {
            ...
            List<PostalAddressExtensionType> theField;
