 ...
 *         <element name="approach" type="{http://www.aixm.aero/schema/5.1}InstrumentApproachProcedurePropertyType" minOccurs="0"/>
 *         <element name="guidanceSystem" type="{http://www.aixm.aero/schema/5.1}CodeFinalGuidanceType" minOccurs="0"/>
 *         <element name="landingSystemCategory" type="{http://www.aixm.aero/schema/5.1}CodeApproachGuidanceType" minOccurs="0"/>
 *         <element name="minimumBaroVnavTemperature" type="{http://www.aixm.aero/schema/5.1}ValTemperatureType" minOccurs="0"/>
 *         <element name="rnpDMEAuthorized" type="{http://www.aixm.aero/schema/5.1}CodeYesNoType" minOccurs="0"/>
 *         <element name="courseOffsetAngle" type="{http://www.aixm.aero/schema/5.1}ValBearingType" minOccurs="0"/>
 *         <element name="courseOffsetSide" type="{http://www.aixm.aero/schema/5.1}CodeSideType" minOccurs="0"/>
 *         <element name="courseCentrelineDistance" type="{http://www.aixm.aero/schema/5.1}ValDistanceType" minOccurs="0"/>
 *         <element name="courseOffsetDistance" type="{http://www.aixm.aero/schema/5.1}ValDistanceType" minOccurs="0"/>
 *         <element name="courseCentrelineIntersect" type="{http://www.aixm.aero/schema/5.1}CodeRelativePositionType" minOccurs="0"/>
 *         <element name="condition" type="{http://www.aixm.aero/schema/5.1}ApproachConditionPropertyType" maxOccurs="unbounded" minOccurs="0"/>
 *         <choice>
 *           <element name="finalPathAlignmentPoint_fixDesignatedPoint" type="{http://www.aixm.aero/schema/5.1}DesignatedPointPropertyType" minOccurs="0"/>
 *           <element name="finalPathAlignmentPoint_navaidSystem" type="{http://www.aixm.aero/schema/5.1}NavaidPropertyType" minOccurs="0"/>
 *           <element name="finalPathAlignmentPoint_aimingPoint" type="{http://www.aixm.aero/schema/5.1}TouchDownLiftOffPropertyType" minOccurs="0"/>
 *           <element name="finalPathAlignmentPoint_runwayPoint" type="{http://www.aixm.aero/schema/5.1}RunwayCentrelinePointPropertyType" minOccurs="0"/>
 *           <element name="finalPathAlignmentPoint_airportReferencePoint" type="{http://www.aixm.aero/schema/5.1}AirportHeliportPropertyType" minOccurs="0"/>
 *           <element name="finalPathAlignmentPoint_position" type="{http://www.aixm.aero/schema/5.1}PointPropertyType" minOccurs="0"/>
 *         </choice>
 *         <element name="visualDescentPoint" type="{http://www.aixm.aero/schema/5.1}TerminalSegmentPointPropertyType" minOccurs="0"/>
 *         <element name="FASData" type="{http://www.aixm.aero/schema/5.1}FASDataBlockPropertyType" minOccurs="0"/>
    ...
    implements Serializable
{
    ...
    @JoinTable(name = "fnllgtmslctp_arcrftctgr_link", schema = "procedure", joinColumns = {
    ...
    public void setEndConditionDesignatorItem(CodeSegmentTerminationType target) {
        setEndConditionDesignator(XmlAdapterUtils.marshallJAXBElement(CodeSegmentTerminationType.class, new QName("http://www.aixm.aero/schema/5.1", "endConditionDesignator"), FinalLegTimeSliceType.class, target));
    }
    ...
    public void setLegPathItem(CodeTrajectoryType target) {
        setLegPath(XmlAdapterUtils.marshallJAXBElement(CodeTrajectoryType.class, new QName("http://www.aixm.aero/schema/5.1", "legPath"), FinalLegTimeSliceType.class, target));
    }
    ...
    public void setLegTypeARINCItem(CodeSegmentPathType target) {
        setLegTypeARINC(XmlAdapterUtils.marshallJAXBElement(CodeSegmentPathType.class, new QName("http://www.aixm.aero/schema/5.1", "legTypeARINC"), FinalLegTimeSliceType.class, target));
    }
    ...
    public void setCourseItem(ValBearingType target) {
        setCourse(XmlAdapterUtils.marshallJAXBElement(ValBearingType.class, new QName("http://www.aixm.aero/schema/5.1", "course"), FinalLegTimeSliceType.class, target));
    }
    ...
    public void setCourseTypeItem(CodeCourseType target) {
        setCourseType(XmlAdapterUtils.marshallJAXBElement(CodeCourseType.class, new QName("http://www.aixm.aero/schema/5.1", "courseType"), FinalLegTimeSliceType.class, target));
    }
    ...
    public void setCourseDirectionItem(CodeDirectionReferenceType target) {
        setCourseDirection(XmlAdapterUtils.marshallJAXBElement(CodeDirectionReferenceType.class, new QName("http://www.aixm.aero/schema/5.1", "courseDirection"), FinalLegTimeSliceType.class, target));
    }
    ...
    public void setTurnDirectionItem(CodeDirectionTurnType target) {
        setTurnDirection(XmlAdapterUtils.marshallJAXBElement(CodeDirectionTurnType.class, new QName("http://www.aixm.aero/schema/5.1", "turnDirection"), FinalLegTimeSliceType.class, target));
    }
    ...
    public void setSpeedLimitItem(ValSpeedType target) {
        setSpeedLimit(XmlAdapterUtils.marshallJAXBElement(ValSpeedType.class, new QName("http://www.aixm.aero/schema/5.1", "speedLimit"), FinalLegTimeSliceType.class, target));
    }
    ...
    public void setSpeedReferenceItem(CodeSpeedReferenceType target) {
        setSpeedReference(XmlAdapterUtils.marshallJAXBElement(CodeSpeedReferenceType.class, new QName("http://www.aixm.aero/schema/5.1", "speedReference"), FinalLegTimeSliceType.class, target));
    }
    ...
    public void setSpeedInterpretationItem(CodeAltitudeUseType target) {
        setSpeedInterpretation(XmlAdapterUtils.marshallJAXBElement(CodeAltitudeUseType.class, new QName("http://www.aixm.aero/schema/5.1", "speedInterpretation"), FinalLegTimeSliceType.class, target));
    }
    ...
    public void setBankAngleItem(ValAngleType target) {
        setBankAngle(XmlAdapterUtils.marshallJAXBElement(ValAngleType.class, new QName("http://www.aixm.aero/schema/5.1", "bankAngle"), FinalLegTimeSliceType.class, target));
    }
    ...
    public void setLengthItem(ValDistanceType target) {
        setLength(XmlAdapterUtils.marshallJAXBElement(ValDistanceType.class, new QName("http://www.aixm.aero/schema/5.1", "length"), FinalLegTimeSliceType.class, target));
    }
    ...
    public void setDurationItem(ValDurationType target) {
        setDuration(XmlAdapterUtils.marshallJAXBElement(ValDurationType.class, new QName("http://www.aixm.aero/schema/5.1", "duration"), FinalLegTimeSliceType.class, target));
    }
    ...
    public void setProcedureTurnRequiredItem(CodeYesNoType target) {
        setProcedureTurnRequired(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.1", "procedureTurnRequired"), FinalLegTimeSliceType.class, target));
    }
    ...
    public void setUpperLimitAltitudeItem(ValDistanceVerticalType target) {
        setUpperLimitAltitude(XmlAdapterUtils.marshallJAXBElement(ValDistanceVerticalType.class, new QName("http://www.aixm.aero/schema/5.1", "upperLimitAltitude"), FinalLegTimeSliceType.class, target));
    }
    ...
    public void setUpperLimitReferenceItem(CodeVerticalReferenceType target) {
        setUpperLimitReference(XmlAdapterUtils.marshallJAXBElement(CodeVerticalReferenceType.class, new QName("http://www.aixm.aero/schema/5.1", "upperLimitReference"), FinalLegTimeSliceType.class, target));
    }
    ...
    public void setLowerLimitAltitudeItem(ValDistanceVerticalType target) {
        setLowerLimitAltitude(XmlAdapterUtils.marshallJAXBElement(ValDistanceVerticalType.class, new QName("http://www.aixm.aero/schema/5.1", "lowerLimitAltitude"), FinalLegTimeSliceType.class, target));
    }
    ...
    public void setLowerLimitReferenceItem(CodeVerticalReferenceType target) {
        setLowerLimitReference(XmlAdapterUtils.marshallJAXBElement(CodeVerticalReferenceType.class, new QName("http://www.aixm.aero/schema/5.1", "lowerLimitReference"), FinalLegTimeSliceType.class, target));
    }
    ...
    public void setAltitudeInterpretationItem(CodeAltitudeUseType target) {
        setAltitudeInterpretation(XmlAdapterUtils.marshallJAXBElement(CodeAltitudeUseType.class, new QName("http://www.aixm.aero/schema/5.1", "altitudeInterpretation"), FinalLegTimeSliceType.class, target));
    }
    ...
    public void setAltitudeOverrideATCItem(ValDistanceVerticalType target) {
        setAltitudeOverrideATC(XmlAdapterUtils.marshallJAXBElement(ValDistanceVerticalType.class, new QName("http://www.aixm.aero/schema/5.1", "altitudeOverrideATC"), FinalLegTimeSliceType.class, target));
    }
    ...
    public void setAltitudeOverrideReferenceItem(CodeVerticalReferenceType target) {
        setAltitudeOverrideReference(XmlAdapterUtils.marshallJAXBElement(CodeVerticalReferenceType.class, new QName("http://www.aixm.aero/schema/5.1", "altitudeOverrideReference"), FinalLegTimeSliceType.class, target));
    }
    ...
    public void setVerticalAngleItem(ValAngleType target) {
        setVerticalAngle(XmlAdapterUtils.marshallJAXBElement(ValAngleType.class, new QName("http://www.aixm.aero/schema/5.1", "verticalAngle"), FinalLegTimeSliceType.class, target));
    }
    ...
    public void setStartPointItem(TerminalSegmentPointPropertyType target) {
        setStartPoint(XmlAdapterUtils.marshallJAXBElement(TerminalSegmentPointPropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "startPoint"), FinalLegTimeSliceType.class, target));
    }
    ...
    public void setEndPointItem(TerminalSegmentPointPropertyType target) {
        setEndPoint(XmlAdapterUtils.marshallJAXBElement(TerminalSegmentPointPropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "endPoint"), FinalLegTimeSliceType.class, target));
    }
    ...
    public void setTrajectoryItem(AIXMCurvePropertyType target) {
        setTrajectory(XmlAdapterUtils.marshallJAXBElement(AIXMCurvePropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "trajectory"), FinalLegTimeSliceType.class, target));
    }
    ...
    public void setArcCentreItem(TerminalSegmentPointPropertyType target) {
        setArcCentre(XmlAdapterUtils.marshallJAXBElement(TerminalSegmentPointPropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "arcCentre"), FinalLegTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = AngleIndicationPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "fnllgtmslctp_angl_link", schema = "procedure", joinColumns = {
        @JoinColumn(name = "finalleg_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setAngleItem(AngleIndicationPropertyType target) {
        setAngle(XmlAdapterUtils.marshallJAXBElement(AngleIndicationPropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "angle"), FinalLegTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = DistanceIndicationPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "fnllgtmslctp_dstnc_link", schema = "procedure", joinColumns = {
        @JoinColumn(name = "finalleg_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setDistanceItem(DistanceIndicationPropertyType target) {
        setDistance(XmlAdapterUtils.marshallJAXBElement(DistanceIndicationPropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "distance"), FinalLegTimeSliceType.class, target));
    }
    ...
    public void setHoldingItem(HoldingUsePropertyType target) {
        setHolding(XmlAdapterUtils.marshallJAXBElement(HoldingUsePropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "holding"), FinalLegTimeSliceType.class, target));
    }
    ...
    public void setApproachItem(InstrumentApproachProcedurePropertyType target) {
        setApproach(XmlAdapterUtils.marshallJAXBElement(InstrumentApproachProcedurePropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "approach"), FinalLegTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "guidancesystem", columnDefinition = "codefinalguidancebase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "guidancesystemnilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setGuidanceSystemItem(CodeFinalGuidanceType target) {
        setGuidanceSystem(XmlAdapterUtils.marshallJAXBElement(CodeFinalGuidanceType.class, new QName("http://www.aixm.aero/schema/5.1", "guidanceSystem"), FinalLegTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "landingsystemcategory", columnDefinition = "codeapproachguidancebase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "landingsystemcategorynilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setLandingSystemCategoryItem(CodeApproachGuidanceType target) {
        setLandingSystemCategory(XmlAdapterUtils.marshallJAXBElement(CodeApproachGuidanceType.class, new QName("http://www.aixm.aero/schema/5.1", "landingSystemCategory"), FinalLegTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "minimumbarovnavtemperature", columnDefinition = "valtemperaturebase")),
        @AttributeOverride(name = "uom", column = @Column(name = "minimumbarovnavtemperatureuom", columnDefinition = "uomtemperature")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "minimumbarovnavtemperaturenilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setMinimumBaroVnavTemperatureItem(ValTemperatureType target) {
        setMinimumBaroVnavTemperature(XmlAdapterUtils.marshallJAXBElement(ValTemperatureType.class, new QName("http://www.aixm.aero/schema/5.1", "minimumBaroVnavTemperature"), FinalLegTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "rnpdmeauthorized", columnDefinition = "codeyesnobase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "rnpdmeauthorizednilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setRnpDMEAuthorizedItem(CodeYesNoType target) {
        setRnpDMEAuthorized(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.1", "rnpDMEAuthorized"), FinalLegTimeSliceType.class, target));
    }
    ...
    public void setCourseOffsetAngleItem(ValBearingType target) {
        setCourseOffsetAngle(XmlAdapterUtils.marshallJAXBElement(ValBearingType.class, new QName("http://www.aixm.aero/schema/5.1", "courseOffsetAngle"), FinalLegTimeSliceType.class, target));
    }
    ...
    public void setCourseOffsetSideItem(CodeSideType target) {
        setCourseOffsetSide(XmlAdapterUtils.marshallJAXBElement(CodeSideType.class, new QName("http://www.aixm.aero/schema/5.1", "courseOffsetSide"), FinalLegTimeSliceType.class, target));
    }
    ...
    public void setCourseCentrelineDistanceItem(ValDistanceType target) {
        setCourseCentrelineDistance(XmlAdapterUtils.marshallJAXBElement(ValDistanceType.class, new QName("http://www.aixm.aero/schema/5.1", "courseCentrelineDistance"), FinalLegTimeSliceType.class, target));
    }
    ...
    public void setCourseOffsetDistanceItem(ValDistanceType target) {
        setCourseOffsetDistance(XmlAdapterUtils.marshallJAXBElement(ValDistanceType.class, new QName("http://www.aixm.aero/schema/5.1", "courseOffsetDistance"), FinalLegTimeSliceType.class, target));
    }
    ...
    public void setCourseCentrelineIntersectItem(CodeRelativePositionType target) {
        setCourseCentrelineIntersect(XmlAdapterUtils.marshallJAXBElement(CodeRelativePositionType.class, new QName("http://www.aixm.aero/schema/5.1", "courseCentrelineIntersect"), FinalLegTimeSliceType.class, target));
    }
    ...
    public void setFinalPathAlignmentPointFixDesignatedPointItem(DesignatedPointPropertyType target) {
        setFinalPathAlignmentPointFixDesignatedPoint(XmlAdapterUtils.marshallJAXBElement(DesignatedPointPropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "finalPathAlignmentPoint_fixDesignatedPoint"), FinalLegTimeSliceType.class, target));
    }
    ...
    public void setFinalPathAlignmentPointNavaidSystemItem(NavaidPropertyType target) {
        setFinalPathAlignmentPointNavaidSystem(XmlAdapterUtils.marshallJAXBElement(NavaidPropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "finalPathAlignmentPoint_navaidSystem"), FinalLegTimeSliceType.class, target));
    }
    ...
    public void setFinalPathAlignmentPointAimingPointItem(TouchDownLiftOffPropertyType target) {
        setFinalPathAlignmentPointAimingPoint(XmlAdapterUtils.marshallJAXBElement(TouchDownLiftOffPropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "finalPathAlignmentPoint_aimingPoint"), FinalLegTimeSliceType.class, target));
    }
    ...
    public void setFinalPathAlignmentPointRunwayPointItem(RunwayCentrelinePointPropertyType target) {
        setFinalPathAlignmentPointRunwayPoint(XmlAdapterUtils.marshallJAXBElement(RunwayCentrelinePointPropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "finalPathAlignmentPoint_runwayPoint"), FinalLegTimeSliceType.class, target));
    }
    ...
    public void setFinalPathAlignmentPointAirportReferencePointItem(AirportHeliportPropertyType target) {
        setFinalPathAlignmentPointAirportReferencePoint(XmlAdapterUtils.marshallJAXBElement(AirportHeliportPropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "finalPathAlignmentPoint_airportReferencePoint"), FinalLegTimeSliceType.class, target));
    }
    ...
    public void setFinalPathAlignmentPointPositionItem(AIXMPointPropertyType target) {
        setFinalPathAlignmentPointPosition(XmlAdapterUtils.marshallJAXBElement(AIXMPointPropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "finalPathAlignmentPoint_position"), FinalLegTimeSliceType.class, target));
    }
    ...
    public void setVisualDescentPointItem(TerminalSegmentPointPropertyType target) {
        setVisualDescentPoint(XmlAdapterUtils.marshallJAXBElement(TerminalSegmentPointPropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "visualDescentPoint"), FinalLegTimeSliceType.class, target));
    }
    ...
    public void setFASDataItem(FASDataBlockPropertyType target) {
        setFASData(XmlAdapterUtils.marshallJAXBElement(FASDataBlockPropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "FASData"), FinalLegTimeSliceType.class, target));
    }
