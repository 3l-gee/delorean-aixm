    ...
    implements Serializable
{
    ...
    @JoinTable(name = "fnllgtmslctp_arcrftctgr_l", schema = "procedure", joinColumns = {
    ...
    @JoinTable(name = "fnllgtmslctp_angl_l", schema = "procedure", joinColumns = {
        @JoinColumn(name = "finalleg_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "fnllgtmslctp_dstnc_l", schema = "procedure", joinColumns = {
        @JoinColumn(name = "finalleg_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
