 ...
 *       <sequence>
 *         <element ref="{http://www.aixm.aero/schema/5.1}InstrumentApproachProcedureTimeSlice"/>
 *       </sequence>
...
@Table(name = "instrumentapproachprocedure_tp", schema = "procedure")
public class InstrumentApproachProcedureTimeSlicePropertyType implements Serializable, Equals, HashCode, ToString
{
    ...
    @JoinColumn(name = "instrumentapproachproceduretimeslice_hjid", referencedColumnName = "hjid")
