 ...
 *         <element name="logicalOperator" type="{http://www.aixm.aero/schema/5.1}CodeFlowConditionOperationType" minOccurs="0"/>
 *         <element name="element" type="{http://www.aixm.aero/schema/5.1}FlightConditionElementPropertyType" maxOccurs="unbounded" minOccurs="0"/>
 ...
 *                   <element ref="{http://www.aixm.aero/schema/5.1}AbstractFlightConditionCombinationExtension"/>
 *                 </choice>
    ...
    implements Serializable
{
    ...
    @JoinTable(name = "flghtcndtncmbntntp_tmintrvl_link", schema = "route", joinColumns = {
        @JoinColumn(name = "flightconditioncombination_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "logicaloperator", columnDefinition = "codeflowconditionoperationbase")),
    ...
    public void setLogicalOperatorItem(CodeFlowConditionOperationType target) {
        setLogicalOperator(XmlAdapterUtils.marshallJAXBElement(CodeFlowConditionOperationType.class, new QName("http://www.aixm.aero/schema/5.1", "logicalOperator"), FlightConditionCombinationType.class, target));
    }
