    ...
    implements Serializable
{
    ...
    @JoinTable(name = "flghtcndtncmbntntp_tmintrvl_l", schema = "route", joinColumns = {
    ...
    @JoinTable(name = "flghtcndtncmbntntp_annttn_l", schema = "route", joinColumns = {
        @JoinColumn(name = "flightconditioncombination_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "flghtcndtncmbntntp_spcldtathrt_l", schema = "route", joinColumns = {
        @JoinColumn(name = "flightconditioncombination_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "flghtcndtncmbntntp_elmnt_l", schema = "route", joinColumns = {
        @JoinColumn(name = "flightconditioncombination_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
