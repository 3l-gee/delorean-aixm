 ...
 *         <element name="markingLocation" type="{http://www.aixm.aero/schema/5.1}CodeProtectAreaSectionType" minOccurs="0"/>
 *         <element name="markedProtectionArea" type="{http://www.aixm.aero/schema/5.1}AirportHeliportProtectionAreaPropertyType" minOccurs="0"/>
    ...
    implements Serializable
{
    ...
    public void setMarkingICAOStandardItem(CodeYesNoType target) {
        setMarkingICAOStandard(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.1", "markingICAOStandard"), AirportProtectionAreaMarkingTimeSliceType.class, target));
    }
    ...
    public void setConditionItem(CodeMarkingConditionType target) {
        setCondition(XmlAdapterUtils.marshallJAXBElement(CodeMarkingConditionType.class, new QName("http://www.aixm.aero/schema/5.1", "condition"), AirportProtectionAreaMarkingTimeSliceType.class, target));
    }
    ...
    public void setMarkingLocationItem(CodeProtectAreaSectionType target) {
        setMarkingLocation(XmlAdapterUtils.marshallJAXBElement(CodeProtectAreaSectionType.class, new QName("http://www.aixm.aero/schema/5.1", "markingLocation"), AirportProtectionAreaMarkingTimeSliceType.class, target));
    }
    ...
    public void setMarkedProtectionAreaItem(AirportHeliportProtectionAreaPropertyType target) {
        setMarkedProtectionArea(XmlAdapterUtils.marshallJAXBElement(AirportHeliportProtectionAreaPropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "markedProtectionArea"), AirportProtectionAreaMarkingTimeSliceType.class, target));
    }
