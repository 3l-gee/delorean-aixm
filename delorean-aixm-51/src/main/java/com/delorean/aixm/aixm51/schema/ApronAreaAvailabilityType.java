 ...
 *         <element name="usage" type="{http://www.aixm.aero/schema/5.1}ApronAreaUsagePropertyType" maxOccurs="unbounded" minOccurs="0"/>
    ...
    implements Serializable
{
    ...
    @JoinTable(name = "aprnaravlblttp_tmintrvl_l", schema = "airport_heliport", joinColumns = {
        @JoinColumn(name = "apronareaavailability_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "aprnaravlblttp_annttn_l", schema = "airport_heliport", joinColumns = {
        @JoinColumn(name = "apronareaavailability_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "aprnaravlblttp_spcldtathrt_l", schema = "airport_heliport", joinColumns = {
        @JoinColumn(name = "apronareaavailability_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
     ...
     * 
     */
    @OneToMany(targetEntity = ApronAreaUsagePropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "aprnaravlblttp_usg_l", schema = "airport_heliport", joinColumns = {
        @JoinColumn(name = "apronareaavailability_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setOperationalStatusItem(CodeStatusAirportType target) {
        setOperationalStatus(XmlAdapterUtils.marshallJAXBElement(CodeStatusAirportType.class, new QName("http://www.aixm.aero/schema/5.1", "operationalStatus"), ApronAreaAvailabilityType.class, target));
    }
    ...
    public void setWarningItem(CodeAirportWarningType target) {
        setWarning(XmlAdapterUtils.marshallJAXBElement(CodeAirportWarningType.class, new QName("http://www.aixm.aero/schema/5.1", "warning"), ApronAreaAvailabilityType.class, target));
    }
