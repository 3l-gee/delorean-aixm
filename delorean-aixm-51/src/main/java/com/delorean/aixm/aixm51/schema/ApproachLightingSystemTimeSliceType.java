 ...
 *         <element name="classICAO" type="{http://www.aixm.aero/schema/5.1}CodeApproachLightingICAOType" minOccurs="0"/>
 *         <element name="type" type="{http://www.aixm.aero/schema/5.1}CodeApproachLightingType" minOccurs="0"/>
 *         <element name="length" type="{http://www.aixm.aero/schema/5.1}ValDistanceType" minOccurs="0"/>
 *         <element name="sequencedFlashing" type="{http://www.aixm.aero/schema/5.1}CodeYesNoType" minOccurs="0"/>
 *         <element name="alignmentIndicator" type="{http://www.aixm.aero/schema/5.1}CodeYesNoType" minOccurs="0"/>
 *         <element name="servedRunwayDirection" type="{http://www.aixm.aero/schema/5.1}RunwayDirectionPropertyType" minOccurs="0"/>
    ...
    implements Serializable
{
    ...
    @XmlElementRef(name = "classICAO", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "sequencedFlashing", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class, required = false)
    protected JAXBElement<CodeYesNoType> sequencedFlashing;
    @XmlElementRef(name = "alignmentIndicator", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class, required = false)
    protected JAXBElement<CodeYesNoType> alignmentIndicator;
    @XmlElementRef(name = "servedRunwayDirection", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class, required = false)
    protected JAXBElement<RunwayDirectionPropertyType> servedRunwayDirection;
    protected List<ApproachLightingSystemTimeSliceExtensionType> extension;
    ...
    public void setEmergencyLightingItem(CodeYesNoType target) {
        setEmergencyLighting(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.1", "emergencyLighting"), ApproachLightingSystemTimeSliceType.class, target));
    }
    ...
    public void setIntensityLevelItem(CodeLightIntensityType target) {
        setIntensityLevel(XmlAdapterUtils.marshallJAXBElement(CodeLightIntensityType.class, new QName("http://www.aixm.aero/schema/5.1", "intensityLevel"), ApproachLightingSystemTimeSliceType.class, target));
    }
    ...
    public void setColourItem(CodeColourType target) {
        setColour(XmlAdapterUtils.marshallJAXBElement(CodeColourType.class, new QName("http://www.aixm.aero/schema/5.1", "colour"), ApproachLightingSystemTimeSliceType.class, target));
    }
    ...
    public void setClassICAOItem(CodeApproachLightingICAOType target) {
        setClassICAO(XmlAdapterUtils.marshallJAXBElement(CodeApproachLightingICAOType.class, new QName("http://www.aixm.aero/schema/5.1", "classICAO"), ApproachLightingSystemTimeSliceType.class, target));
    }
    ...
    public void setTypeItem(CodeApproachLightingType target) {
        setType(XmlAdapterUtils.marshallJAXBElement(CodeApproachLightingType.class, new QName("http://www.aixm.aero/schema/5.1", "type"), ApproachLightingSystemTimeSliceType.class, target));
    }
    ...
    public void setLengthItem(ValDistanceType target) {
        setLength(XmlAdapterUtils.marshallJAXBElement(ValDistanceType.class, new QName("http://www.aixm.aero/schema/5.1", "length"), ApproachLightingSystemTimeSliceType.class, target));
    }
    ...
    public void setSequencedFlashingItem(CodeYesNoType target) {
        setSequencedFlashing(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.1", "sequencedFlashing"), ApproachLightingSystemTimeSliceType.class, target));
    }
    ...
    public void setAlignmentIndicatorItem(CodeYesNoType target) {
        setAlignmentIndicator(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.1", "alignmentIndicator"), ApproachLightingSystemTimeSliceType.class, target));
    }
    ...
    public void setServedRunwayDirectionItem(RunwayDirectionPropertyType target) {
        setServedRunwayDirection(XmlAdapterUtils.marshallJAXBElement(RunwayDirectionPropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "servedRunwayDirection"), ApproachLightingSystemTimeSliceType.class, target));
    }
