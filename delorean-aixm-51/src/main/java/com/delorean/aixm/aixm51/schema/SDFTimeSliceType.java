    ...
    implements Serializable
{
    ...
    @JoinTable(name = "sdftmslctp_athrt_l", schema = "navaids_point", joinColumns = {
    ...
    @JoinTable(name = "sdftmslctp_mntrng_l", schema = "navaids_point", joinColumns = {
        @JoinColumn(name = "sdf_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "sdftmslctp_avlblt_l", schema = "navaids_point", joinColumns = {
        @JoinColumn(name = "sdf_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "sdftmslctp_annttn_l", schema = "navaids_point", joinColumns = {
        @JoinColumn(name = "sdf_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "sdftmslctp_lctn_l", schema = "navaids_point", joinColumns = {
        @JoinColumn(name = "sdf_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
