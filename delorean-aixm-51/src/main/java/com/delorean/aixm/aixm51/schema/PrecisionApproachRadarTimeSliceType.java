 ...
 *         <element name="precisionApproachRadarType" type="{http://www.aixm.aero/schema/5.1}CodePARType" minOccurs="0"/>
 *         <element name="slope" type="{http://www.aixm.aero/schema/5.1}ValAngleType" minOccurs="0"/>
 *         <element name="slopeAccuracy" type="{http://www.aixm.aero/schema/5.1}ValAngleType" minOccurs="0"/>
 *         <element name="reflector" type="{http://www.aixm.aero/schema/5.1}ReflectorPropertyType" maxOccurs="unbounded" minOccurs="0"/>
...
@Table(name = "precisionapproachradar_t", schema = "surveillance")
    ...
    implements Serializable
{
    ...
    protected List<PrecisionApproachRadarTimeSliceExtensionType> extension;
    ...
    @JoinTable(name = "prcsnapprchrdrtmslctp_cntct_link", schema = "surveillance", joinColumns = {
        @JoinColumn(name = "precisionapproachradar_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "prcsnapprchrdrtmslctp_annttn_link", schema = "surveillance", joinColumns = {
        @JoinColumn(name = "precisionapproachradar_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
     ...
     * 
     */
    @OneToMany(targetEntity = ReflectorPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "prcsnapprchrdrtmslctp_rflctr_link", schema = "surveillance", joinColumns = {
        @JoinColumn(name = "precisionapproachradar_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
     ...
     * 
     */
    @OneToMany(targetEntity = PrecisionApproachRadarTimeSliceExtensionType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinColumn(name = "precisionapproachradar_te_hjid", referencedColumnName = "hjid")
    public List<PrecisionApproachRadarTimeSliceExtensionType> getExtension() {
        if (extension == null) {
     ...
     * 
     */
    public void setExtension(List<PrecisionApproachRadarTimeSliceExtensionType> extension) {
    ...
    public void setAixmNameItem(TextNameType target) {
        setAixmName(XmlAdapterUtils.marshallJAXBElement(TextNameType.class, new QName("http://www.aixm.aero/schema/5.1", "name"), PrecisionApproachRadarTimeSliceType.class, target));
    }
    ...
    public void setSerialNumberItem(TextDesignatorType target) {
        setSerialNumber(XmlAdapterUtils.marshallJAXBElement(TextDesignatorType.class, new QName("http://www.aixm.aero/schema/5.1", "serialNumber"), PrecisionApproachRadarTimeSliceType.class, target));
    }
    ...
    public void setRangeItem(ValDistanceType target) {
        setRange(XmlAdapterUtils.marshallJAXBElement(ValDistanceType.class, new QName("http://www.aixm.aero/schema/5.1", "range"), PrecisionApproachRadarTimeSliceType.class, target));
    }
    ...
    public void setRangeAccuracyItem(ValDistanceType target) {
        setRangeAccuracy(XmlAdapterUtils.marshallJAXBElement(ValDistanceType.class, new QName("http://www.aixm.aero/schema/5.1", "rangeAccuracy"), PrecisionApproachRadarTimeSliceType.class, target));
    }
    ...
    public void setDualChannelItem(CodeYesNoType target) {
        setDualChannel(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.1", "dualChannel"), PrecisionApproachRadarTimeSliceType.class, target));
    }
    ...
    public void setMovingTargetIndicatorItem(CodeYesNoType target) {
        setMovingTargetIndicator(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.1", "movingTargetIndicator"), PrecisionApproachRadarTimeSliceType.class, target));
    }
    ...
    public void setStandbyPowerItem(CodeStandbyPowerType target) {
        setStandbyPower(XmlAdapterUtils.marshallJAXBElement(CodeStandbyPowerType.class, new QName("http://www.aixm.aero/schema/5.1", "standbyPower"), PrecisionApproachRadarTimeSliceType.class, target));
    }
    ...
    public void setDigitalItem(CodeYesNoType target) {
        setDigital(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.1", "digital"), PrecisionApproachRadarTimeSliceType.class, target));
    }
    ...
    public void setMilitaryUseOnlyItem(CodeYesNoType target) {
        setMilitaryUseOnly(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.1", "militaryUseOnly"), PrecisionApproachRadarTimeSliceType.class, target));
    }
    ...
    public void setSpecialUseOnlyItem(CodeYesNoType target) {
        setSpecialUseOnly(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.1", "specialUseOnly"), PrecisionApproachRadarTimeSliceType.class, target));
    }
    ...
    public void setSpecialAircraftOnlyItem(CodeYesNoType target) {
        setSpecialAircraftOnly(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.1", "specialAircraftOnly"), PrecisionApproachRadarTimeSliceType.class, target));
    }
    ...
    public void setMagneticVariationItem(ValMagneticVariationType target) {
        setMagneticVariation(XmlAdapterUtils.marshallJAXBElement(ValMagneticVariationType.class, new QName("http://www.aixm.aero/schema/5.1", "magneticVariation"), PrecisionApproachRadarTimeSliceType.class, target));
    }
    ...
    public void setMagneticVariationAccuracyItem(ValAngleType target) {
        setMagneticVariationAccuracy(XmlAdapterUtils.marshallJAXBElement(ValAngleType.class, new QName("http://www.aixm.aero/schema/5.1", "magneticVariationAccuracy"), PrecisionApproachRadarTimeSliceType.class, target));
    }
    ...
    public void setDateMagneticVariationItem(DateYearType target) {
        setDateMagneticVariation(XmlAdapterUtils.marshallJAXBElement(DateYearType.class, new QName("http://www.aixm.aero/schema/5.1", "dateMagneticVariation"), PrecisionApproachRadarTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = AIXMElevatedPointPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "prcsnapprchrdrtmslctp_lctn_link", schema = "surveillance", joinColumns = {
        @JoinColumn(name = "precisionapproachradar_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setLocationItem(AIXMElevatedPointPropertyType target) {
        setLocation(XmlAdapterUtils.marshallJAXBElement(AIXMElevatedPointPropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "location"), PrecisionApproachRadarTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "precisionapproachradartype", columnDefinition = "codeparbase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "precisionapproachradartypenilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setPrecisionApproachRadarTypeItem(CodePARType target) {
        setPrecisionApproachRadarType(XmlAdapterUtils.marshallJAXBElement(CodePARType.class, new QName("http://www.aixm.aero/schema/5.1", "precisionApproachRadarType"), PrecisionApproachRadarTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "slope", columnDefinition = "valanglebase")),
    ...
    public void setSlopeItem(ValAngleType target) {
        setSlope(XmlAdapterUtils.marshallJAXBElement(ValAngleType.class, new QName("http://www.aixm.aero/schema/5.1", "slope"), PrecisionApproachRadarTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "slopeaccuracy", columnDefinition = "valanglebase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "slopeaccuracynilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setSlopeAccuracyItem(ValAngleType target) {
        setSlopeAccuracy(XmlAdapterUtils.marshallJAXBElement(ValAngleType.class, new QName("http://www.aixm.aero/schema/5.1", "slopeAccuracy"), PrecisionApproachRadarTimeSliceType.class, target));
    }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        }
        {
            ...
            List<PrecisionApproachRadarTimeSliceExtensionType> lhsField;
            lhsField = (this.isSetExtension()?this.getExtension():null);
            List<PrecisionApproachRadarTimeSliceExtensionType> rhsField;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        }
        {
            ...
            List<PrecisionApproachRadarTimeSliceExtensionType> theField;
