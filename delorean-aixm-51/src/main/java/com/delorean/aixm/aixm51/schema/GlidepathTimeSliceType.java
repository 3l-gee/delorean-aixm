 ...
 *         <element name="angleAccuracy" type="{http://www.aixm.aero/schema/5.1}ValAngleType" minOccurs="0"/>
 *         <element name="rdh" type="{http://www.aixm.aero/schema/5.1}ValDistanceVerticalType" minOccurs="0"/>
 *         <element name="rdhAccuracy" type="{http://www.aixm.aero/schema/5.1}ValDistanceVerticalType" minOccurs="0"/>
    ...
    implements Serializable
{
    ...
    public void setDesignatorItem(CodeNavaidDesignatorType target) {
        setDesignator(XmlAdapterUtils.marshallJAXBElement(CodeNavaidDesignatorType.class, new QName("http://www.aixm.aero/schema/5.1", "designator"), GlidepathTimeSliceType.class, target));
    }
    ...
    public void setAixmNameItem(TextNameType target) {
        setAixmName(XmlAdapterUtils.marshallJAXBElement(TextNameType.class, new QName("http://www.aixm.aero/schema/5.1", "name"), GlidepathTimeSliceType.class, target));
    }
    ...
    public void setEmissionClassItem(CodeRadioEmissionType target) {
        setEmissionClass(XmlAdapterUtils.marshallJAXBElement(CodeRadioEmissionType.class, new QName("http://www.aixm.aero/schema/5.1", "emissionClass"), GlidepathTimeSliceType.class, target));
    }
    ...
    public void setMobileItem(CodeYesNoType target) {
        setMobile(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.1", "mobile"), GlidepathTimeSliceType.class, target));
    }
    ...
    public void setMagneticVariationItem(ValMagneticVariationType target) {
        setMagneticVariation(XmlAdapterUtils.marshallJAXBElement(ValMagneticVariationType.class, new QName("http://www.aixm.aero/schema/5.1", "magneticVariation"), GlidepathTimeSliceType.class, target));
    }
    ...
    public void setMagneticVariationAccuracyItem(ValAngleType target) {
        setMagneticVariationAccuracy(XmlAdapterUtils.marshallJAXBElement(ValAngleType.class, new QName("http://www.aixm.aero/schema/5.1", "magneticVariationAccuracy"), GlidepathTimeSliceType.class, target));
    }
    ...
    public void setDateMagneticVariationItem(DateYearType target) {
        setDateMagneticVariation(XmlAdapterUtils.marshallJAXBElement(DateYearType.class, new QName("http://www.aixm.aero/schema/5.1", "dateMagneticVariation"), GlidepathTimeSliceType.class, target));
    }
    ...
    public void setFlightCheckedItem(CodeYesNoType target) {
        setFlightChecked(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.1", "flightChecked"), GlidepathTimeSliceType.class, target));
    }
    ...
    public void setLocationItem(AIXMElevatedPointPropertyType target) {
        setLocation(XmlAdapterUtils.marshallJAXBElement(AIXMElevatedPointPropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "location"), GlidepathTimeSliceType.class, target));
    }
    ...
    public void setFrequencyItem(ValFrequencyType target) {
        setFrequency(XmlAdapterUtils.marshallJAXBElement(ValFrequencyType.class, new QName("http://www.aixm.aero/schema/5.1", "frequency"), GlidepathTimeSliceType.class, target));
    }
    ...
    public void setSlopeItem(ValAngleType target) {
        setSlope(XmlAdapterUtils.marshallJAXBElement(ValAngleType.class, new QName("http://www.aixm.aero/schema/5.1", "slope"), GlidepathTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "angleaccuracy", columnDefinition = "valanglebase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "angleaccuracynilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setAngleAccuracyItem(ValAngleType target) {
        setAngleAccuracy(XmlAdapterUtils.marshallJAXBElement(ValAngleType.class, new QName("http://www.aixm.aero/schema/5.1", "angleAccuracy"), GlidepathTimeSliceType.class, target));
    }
    ...
    public void setRdhItem(ValDistanceVerticalType target) {
        setRdh(XmlAdapterUtils.marshallJAXBElement(ValDistanceVerticalType.class, new QName("http://www.aixm.aero/schema/5.1", "rdh"), GlidepathTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "rdhaccuracy", columnDefinition = "valdistanceverticalbase")),
        @AttributeOverride(name = "uom", column = @Column(name = "rdhaccuracyuom", columnDefinition = "uomdistancevertical")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "rdhaccuracynilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setRdhAccuracyItem(ValDistanceVerticalType target) {
        setRdhAccuracy(XmlAdapterUtils.marshallJAXBElement(ValDistanceVerticalType.class, new QName("http://www.aixm.aero/schema/5.1", "rdhAccuracy"), GlidepathTimeSliceType.class, target));
    }
