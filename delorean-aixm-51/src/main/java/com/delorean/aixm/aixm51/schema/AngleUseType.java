...
/**
 * <p>
 * Java class for AngleUseType complex type
 * </p>
 * .
 *
 * <p>
 ...
 *                 <sequence>
 *                   <element ref=
"{http://www.aixm.aero/schema/5.1}AbstractAngleUseExtension"/>
 *                 </sequence>
 *                 <attGroup ref=
...
@XmlType(name = "AngleUseType", propOrder = {"alongCourseGuidance", "annotation", "theAngleIndication", "extension"})
@Entity(name = "AngleUseType")
@Table(name = "angleuse_o", schema = "navaids_point")
public class AngleUseType extends AbstractAIXMObjectType implements Serializable {

    private static final long serialVersionUID = 20251104L;
    @XmlElementRef(name = "alongCourseGuidance", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class, required = false)
    ...
    @JoinTable(name = "anglustp_annttn_link", schema = "navaids_point", joinColumns = {
            @JoinColumn(name = "angleuse_o_hjid", referencedColumnName = "hjid")}, inverseJoinColumns = {
     ...
     *
     * @return possible object is {@link AngleIndicationPropertyType }
     *
     */
    @OneToOne(targetEntity = AngleIndicationPropertyType.class, cascade = {CascadeType.ALL}, fetch = FetchType.EAGER)
    @JoinTable(name = "anglustp_thanglindctn_link", schema = "navaids_point", joinColumns = {
            @JoinColumn(name = "angleuse_o_hjid", referencedColumnName = "hjid")}, inverseJoinColumns = {
                    @JoinColumn(name = "theangleindication_hjid", referencedColumnName = "hjid")})
     ...
     *
     * @param value
     *            allowed object is {@link AngleIndicationPropertyType }
     *
     */
    ...
    @Embedded
    @AttributeOverrides({@AttributeOverride(name = "value", column = @Column(name = "alongcourseguidance")),
            @AttributeOverride(name = "nilReason", column = @Column(name = "alongcourseguidancenilreason"))})
    ...
    public void setAlongCourseGuidanceItem(CodeYesNoType target) {
        setAlongCourseGuidance(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class,
                new QName("http://www.aixm.aero/schema/5.1", "alongCourseGuidance"), AngleUseType.class, target));
    }
