...
/**
 * <p>Java class for StandMarkingTimeSliceType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="StandMarkingTimeSliceType">
 *   <complexContent>
 *     <extension base="{http://www.aixm.aero/schema/5.1}AbstractAIXMTimeSliceType">
 *       <sequence>
 *         <element name="markingICAOStandard" type="{http://www.aixm.aero/schema/5.1}CodeYesNoType" minOccurs="0"/>
 *         <element name="condition" type="{http://www.aixm.aero/schema/5.1}CodeMarkingConditionType" minOccurs="0"/>
 *         <element name="element" type="{http://www.aixm.aero/schema/5.1}MarkingElementPropertyType" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="annotation" type="{http://www.aixm.aero/schema/5.1}NotePropertyType" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="markedStand" type="{http://www.aixm.aero/schema/5.1}AircraftStandPropertyType" minOccurs="0"/>
 *         <element name="extension" maxOccurs="unbounded" minOccurs="0">
 *           <complexType>
 *             <complexContent>
 *               <restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 <choice>
 *                   <element ref="{http://www.aixm.aero/schema/5.1}AbstractStandMarkingExtension"/>
...
@XmlType(name = "StandMarkingTimeSliceType", propOrder = {
    "markingICAOStandard",
    "condition",
    "element",
    "annotation",
...
@Entity(name = "StandMarkingTimeSliceType")
@Table(name = "standmarking_t", schema = "airport_heliport")
    ...
    implements Serializable
{
    ...
    @XmlElementRef(name = "markedStand", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class, required = false)
    protected JAXBElement<AircraftStandPropertyType> markedStand;
    protected List<StandMarkingTimeSliceExtensionType> extension;
    ...
    @JoinTable(name = "stndmrkngtmslctp_elmnt_link", schema = "airport_heliport", joinColumns = {
        @JoinColumn(name = "standmarking_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "stndmrkngtmslctp_annttn_link", schema = "airport_heliport", joinColumns = {
        @JoinColumn(name = "standmarking_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    /**
     * Gets the value of the markedStand property.
     * 
     * @return
     *     possible object is
    ...
    /**
     * Sets the value of the markedStand property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link AircraftStandPropertyType }{@code >}
    ...
    @Transient
    public boolean isSetMarkedStand() {
        return (this.markedStand!= null);
    }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link StandMarkingTimeSliceExtensionType }
     * 
     * 
     */
    @OneToMany(targetEntity = StandMarkingTimeSliceExtensionType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinColumn(name = "standmarking_te_hjid", referencedColumnName = "hjid")
    public List<StandMarkingTimeSliceExtensionType> getExtension() {
        if (extension == null) {
     ...
     * 
     */
    public void setExtension(List<StandMarkingTimeSliceExtensionType> extension) {
    ...
    public void setMarkingICAOStandardItem(CodeYesNoType target) {
        setMarkingICAOStandard(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.1", "markingICAOStandard"), StandMarkingTimeSliceType.class, target));
    }
    ...
    public void setConditionItem(CodeMarkingConditionType target) {
        setCondition(XmlAdapterUtils.marshallJAXBElement(CodeMarkingConditionType.class, new QName("http://www.aixm.aero/schema/5.1", "condition"), StandMarkingTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = AircraftStandPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "stndmrkngtmslctp_mrkdstnd_link", schema = "airport_heliport", joinColumns = {
        @JoinColumn(name = "standmarking_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
        @JoinColumn(name = "markedstand_hjid", referencedColumnName = "hjid")
    })
    public AircraftStandPropertyType getMarkedStandItem() {
        return XmlAdapterUtils.unmarshallSource(AircraftStandPropertyType.class, this.getMarkedStand());
    }

    public void setMarkedStandItem(AircraftStandPropertyType target) {
        setMarkedStand(XmlAdapterUtils.marshallJAXBElement(AircraftStandPropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "markedStand"), StandMarkingTimeSliceType.class, target));
    }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        final StandMarkingTimeSliceType that = ((StandMarkingTimeSliceType) object);
        {
        ...
        }
        {
            ...
            List<StandMarkingTimeSliceExtensionType> lhsField;
            lhsField = (this.isSetExtension()?this.getExtension():null);
            List<StandMarkingTimeSliceExtensionType> rhsField;
        ...
        {
            boolean lhsFieldIsSet = this.isSetMarkedStand();
            boolean rhsFieldIsSet = that.isSetMarkedStand();
            JAXBElement<AircraftStandPropertyType> lhsField;
            lhsField = this.getMarkedStand();
            JAXBElement<AircraftStandPropertyType> rhsField;
            rhsField = that.getMarkedStand();
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "markedStand", lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "markedStand", rhsField);
            if (!strategy.equals(lhsFieldLocator, rhsFieldLocator, lhsField, rhsField, lhsFieldIsSet, rhsFieldIsSet)) {
                return false;
            }
        }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetMarkedStand();
            JAXBElement<AircraftStandPropertyType> theField;
            theField = this.getMarkedStand();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "markedStand", theField);
            currentHashCode = strategy.hashCode(theFieldLocator, currentHashCode, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetExtension();
            List<StandMarkingTimeSliceExtensionType> theField;
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        }
        {
            ...
            JAXBElement<AircraftStandPropertyType> theField;
            theField = this.getMarkedStand();
            strategy.appendField(locator, this, "markedStand", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetExtension();
            List<StandMarkingTimeSliceExtensionType> theField;
