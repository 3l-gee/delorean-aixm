...
/**
 * <p>
 * Java class for StandMarkingTimeSliceType complex type
 * </p>
 * .
 *
 * <p>
 ...
 *                 <choice>
 *                   <element ref=
"{http://www.aixm.aero/schema/5.1}AbstractStandMarkingExtension"/>
 *                   <element ref=
...
@XmlType(name = "StandMarkingTimeSliceType", propOrder = {"markingICAOStandard", "condition", "element", "annotation",
        "markedStand", "extension"})
@Entity(name = "StandMarkingTimeSliceType")
@Table(name = "standmarking_t", schema = "airport_heliport")
public class StandMarkingTimeSliceType extends AbstractAIXMTimeSliceType implements Serializable {
    ...
    @JoinTable(name = "stndmrkngtmslctp_elmnt_link", schema = "airport_heliport", joinColumns = {
            @JoinColumn(name = "standmarking_t_hjid", referencedColumnName = "hjid")}, inverseJoinColumns = {
    ...
    public void setMarkingICAOStandardItem(CodeYesNoType target) {
        setMarkingICAOStandard(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class,
                new QName("http://www.aixm.aero/schema/5.1", "markingICAOStandard"), StandMarkingTimeSliceType.class,
                target));
    }
    ...
    public void setConditionItem(CodeMarkingConditionType target) {
        setCondition(XmlAdapterUtils.marshallJAXBElement(CodeMarkingConditionType.class,
                new QName("http://www.aixm.aero/schema/5.1", "condition"), StandMarkingTimeSliceType.class, target));
    }
    ...
    public void setMarkedStandItem(AircraftStandPropertyType target) {
        setMarkedStand(XmlAdapterUtils.marshallJAXBElement(AircraftStandPropertyType.class,
                new QName("http://www.aixm.aero/schema/5.1", "markedStand"), StandMarkingTimeSliceType.class, target));
    }
