 ...
 *         <element name="DME" type="{http://www.aixm.aero/schema/5.1}DMEPropertyType" minOccurs="0"/>
 *         <element name="segmentLeg" type="{http://www.aixm.aero/schema/5.1}SegmentLegPropertyType" minOccurs="0"/>
    ...
    implements Serializable
{
    ...
    public void setCriticalDMEItem(CodeYesNoType target) {
        setCriticalDME(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.1", "criticalDME"), ProcedureDMETimeSliceType.class, target));
    }
    ...
    public void setSatisfactoryItem(CodeYesNoType target) {
        setSatisfactory(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.1", "satisfactory"), ProcedureDMETimeSliceType.class, target));
    }
    ...
    public void setDMEItem(DMEPropertyType target) {
        setDME(XmlAdapterUtils.marshallJAXBElement(DMEPropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "DME"), ProcedureDMETimeSliceType.class, target));
    }
    ...
    public void setSegmentLegItem(SegmentLegPropertyType target) {
        setSegmentLeg(XmlAdapterUtils.marshallJAXBElement(SegmentLegPropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "segmentLeg"), ProcedureDMETimeSliceType.class, target));
    }
