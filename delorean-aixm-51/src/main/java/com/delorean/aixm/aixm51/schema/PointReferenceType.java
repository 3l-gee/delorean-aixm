 ...
 *       <sequence>
 *         <element name="role" type="{http://www.aixm.aero/schema/5.1}CodeReferenceRoleType" minOccurs="0"/>
 *         <element name="priorFixTolerance" type="{http://www.aixm.aero/schema/5.1}ValDistanceSignedType" minOccurs="0"/>
 *         <element name="postFixTolerance" type="{http://www.aixm.aero/schema/5.1}ValDistanceSignedType" minOccurs="0"/>
 *         <element name="point" type="{http://www.aixm.aero/schema/5.1}DesignatedPointPropertyType" minOccurs="0"/>
 *         <element name="facilityAngle" type="{http://www.aixm.aero/schema/5.1}AngleUsePropertyType" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="facilityDistance" type="{http://www.aixm.aero/schema/5.1}DistanceIndicationPropertyType" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="fixToleranceArea" type="{http://www.aixm.aero/schema/5.1}SurfacePropertyType" minOccurs="0"/>
    ...
    implements Serializable
{
    ...
    @JoinTable(name = "pntrfrnctp_fcltangl_l", schema = "navaids_point", joinColumns = {
    ...
    @JoinTable(name = "pntrfrnctp_fcltdstnc_l", schema = "navaids_point", joinColumns = {
        @JoinColumn(name = "pointreference_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setRoleItem(CodeReferenceRoleType target) {
        setRole(XmlAdapterUtils.marshallJAXBElement(CodeReferenceRoleType.class, new QName("http://www.aixm.aero/schema/5.1", "role"), PointReferenceType.class, target));
    }
    ...
    public void setPriorFixToleranceItem(ValDistanceSignedType target) {
        setPriorFixTolerance(XmlAdapterUtils.marshallJAXBElement(ValDistanceSignedType.class, new QName("http://www.aixm.aero/schema/5.1", "priorFixTolerance"), PointReferenceType.class, target));
    }
    ...
    public void setPostFixToleranceItem(ValDistanceSignedType target) {
        setPostFixTolerance(XmlAdapterUtils.marshallJAXBElement(ValDistanceSignedType.class, new QName("http://www.aixm.aero/schema/5.1", "postFixTolerance"), PointReferenceType.class, target));
    }

    @OneToOne(targetEntity = DesignatedPointPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "pntrfrnctp_pnt_l", schema = "navaids_point", joinColumns = {
        @JoinColumn(name = "pointreference_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setPointItem(DesignatedPointPropertyType target) {
        setPoint(XmlAdapterUtils.marshallJAXBElement(DesignatedPointPropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "point"), PointReferenceType.class, target));
    }
    ...
    public void setFixToleranceAreaItem(AIXMSurfacePropertyType target) {
        setFixToleranceArea(XmlAdapterUtils.marshallJAXBElement(AIXMSurfacePropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "fixToleranceArea"), PointReferenceType.class, target));
    }
