 ...
 *         <element name="lighted" type="{http://www.aixm.aero/schema/5.1}CodeYesNoType" minOccurs="0"/>
 *         <element name="markingICAOStandard" type="{http://www.aixm.aero/schema/5.1}CodeYesNoType" minOccurs="0"/>
 *         <element name="group" type="{http://www.aixm.aero/schema/5.1}CodeYesNoType" minOccurs="0"/>
 ...
 *         <element name="radius" type="{http://www.aixm.aero/schema/5.1}ValDistanceType" minOccurs="0"/>
 *         <element name="lightingICAOStandard" type="{http://www.aixm.aero/schema/5.1}CodeYesNoType" minOccurs="0"/>
 *         <element name="synchronisedLighting" type="{http://www.aixm.aero/schema/5.1}CodeYesNoType" minOccurs="0"/>
 *         <element name="marker" type="{http://www.aixm.aero/schema/5.1}MarkerBeaconPropertyType" minOccurs="0"/>
 *         <element name="part" type="{http://www.aixm.aero/schema/5.1}VerticalStructurePartPropertyType" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="hostedPassengerService" type="{http://www.aixm.aero/schema/5.1}PassengerServicePropertyType" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="supportedGroundLight" type="{http://www.aixm.aero/schema/5.1}GroundLightSystemPropertyType" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="hostedNavaidEquipment" type="{http://www.aixm.aero/schema/5.1}NavaidEquipmentPropertyType" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="hostedSpecialNavStation" type="{http://www.aixm.aero/schema/5.1}SpecialNavigationStationPropertyType" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="hostedUnit" type="{http://www.aixm.aero/schema/5.1}UnitPropertyType" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="hostedOrganisation" type="{http://www.aixm.aero/schema/5.1}OrganisationAuthorityPropertyType" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="supportedService" type="{http://www.aixm.aero/schema/5.1}ServicePropertyType" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="annotation" type="{http://www.aixm.aero/schema/5.1}NotePropertyType" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="lightingAvailability" type="{http://www.aixm.aero/schema/5.1}VerticalStructureLightingStatusPropertyType" maxOccurs="unbounded" minOccurs="0"/>
    ...
    implements Serializable
{
    ...
    protected List<VerticalStructureTimeSliceExtensionType> extension;
    ...
    public void setAixmNameItem(TextNameType target) {
        setAixmName(XmlAdapterUtils.marshallJAXBElement(TextNameType.class, new QName("http://www.aixm.aero/schema/5.1", "name"), VerticalStructureTimeSliceType.class, target));
    }
    ...
    public void setTypeItem(CodeVerticalStructureType target) {
        setType(XmlAdapterUtils.marshallJAXBElement(CodeVerticalStructureType.class, new QName("http://www.aixm.aero/schema/5.1", "type"), VerticalStructureTimeSliceType.class, target));
    }
    ...
    public void setLightedItem(CodeYesNoType target) {
        setLighted(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.1", "lighted"), VerticalStructureTimeSliceType.class, target));
    }
    ...
    public void setMarkingICAOStandardItem(CodeYesNoType target) {
        setMarkingICAOStandard(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.1", "markingICAOStandard"), VerticalStructureTimeSliceType.class, target));
    }
    ...
    public void setGroupItem(CodeYesNoType target) {
        setGroup(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.1", "group"), VerticalStructureTimeSliceType.class, target));
    }
    ...
    public void setLengthItem(ValDistanceType target) {
        setLength(XmlAdapterUtils.marshallJAXBElement(ValDistanceType.class, new QName("http://www.aixm.aero/schema/5.1", "length"), VerticalStructureTimeSliceType.class, target));
    }
    ...
    public void setWidthItem(ValDistanceType target) {
        setWidth(XmlAdapterUtils.marshallJAXBElement(ValDistanceType.class, new QName("http://www.aixm.aero/schema/5.1", "width"), VerticalStructureTimeSliceType.class, target));
    }
    ...
    public void setRadiusItem(ValDistanceType target) {
        setRadius(XmlAdapterUtils.marshallJAXBElement(ValDistanceType.class, new QName("http://www.aixm.aero/schema/5.1", "radius"), VerticalStructureTimeSliceType.class, target));
    }
    ...
    public void setLightingICAOStandardItem(CodeYesNoType target) {
        setLightingICAOStandard(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.1", "lightingICAOStandard"), VerticalStructureTimeSliceType.class, target));
    }
    ...
    public void setSynchronisedLightingItem(CodeYesNoType target) {
        setSynchronisedLighting(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.1", "synchronisedLighting"), VerticalStructureTimeSliceType.class, target));
    }
    ...
    public void setMarkerItem(MarkerBeaconPropertyType target) {
        setMarker(XmlAdapterUtils.marshallJAXBElement(MarkerBeaconPropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "marker"), VerticalStructureTimeSliceType.class, target));
    }
