...
@Entity(name = "TouchDownLiftOffLightSystemTimeSliceExtensionType")
@Table(name = "touchdownliftofflightsystem_te", schema = "airport_heliport")
public class TouchDownLiftOffLightSystemTimeSliceExtensionType implements Serializable, Equals, HashCode, ToString {
