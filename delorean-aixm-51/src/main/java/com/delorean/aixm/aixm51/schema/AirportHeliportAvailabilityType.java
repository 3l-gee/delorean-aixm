 ...
 *         <element name="operationalStatus" type="{http://www.aixm.aero/schema/5.1}CodeStatusAirportType" minOccurs="0"/>
 *         <element name="warning" type="{http://www.aixm.aero/schema/5.1}CodeAirportWarningType" minOccurs="0"/>
 *         <element name="usage" type="{http://www.aixm.aero/schema/5.1}AirportHeliportUsagePropertyType" maxOccurs="unbounded" minOccurs="0"/>
 ...
 *                   <element ref="{http://www.aixm.aero/schema/5.1}AbstractAirportHeliportAvailabilityExtension"/>
 *                 </choice>
    ...
    implements Serializable
{
    ...
    @JoinTable(name = "arprthlprtavlblttp_tmintrvl_link", schema = "airport_heliport", joinColumns = {
        @JoinColumn(name = "airportheliportavailability_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "operationalstatus", columnDefinition = "codestatusairportbase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "operationalstatusnilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setOperationalStatusItem(CodeStatusAirportType target) {
        setOperationalStatus(XmlAdapterUtils.marshallJAXBElement(CodeStatusAirportType.class, new QName("http://www.aixm.aero/schema/5.1", "operationalStatus"), AirportHeliportAvailabilityType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "warning", columnDefinition = "codeairportwarningbase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "warningnilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setWarningItem(CodeAirportWarningType target) {
        setWarning(XmlAdapterUtils.marshallJAXBElement(CodeAirportWarningType.class, new QName("http://www.aixm.aero/schema/5.1", "warning"), AirportHeliportAvailabilityType.class, target));
    }
