 ...
 *       <sequence>
 *         <element name="type" type="{http://www.aixm.aero/schema/5.1}CodeAuthorityType" minOccurs="0"/>
 *         <element name="responsibleOrganisation" type="{http://www.aixm.aero/schema/5.1}OrganisationAuthorityPropertyType" minOccurs="0"/>
 *         <element name="assignedAirspace" type="{http://www.aixm.aero/schema/5.1}AirspacePropertyType" minOccurs="0"/>
    ...
    implements Serializable
{
    ...
    public void setTypeItem(CodeAuthorityType target) {
        setType(XmlAdapterUtils.marshallJAXBElement(CodeAuthorityType.class, new QName("http://www.aixm.aero/schema/5.1", "type"), AuthorityForAirspaceTimeSliceType.class, target));
    }
    ...
    public void setResponsibleOrganisationItem(OrganisationAuthorityPropertyType target) {
        setResponsibleOrganisation(XmlAdapterUtils.marshallJAXBElement(OrganisationAuthorityPropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "responsibleOrganisation"), AuthorityForAirspaceTimeSliceType.class, target));
    }
    ...
    public void setAssignedAirspaceItem(AirspacePropertyType target) {
        setAssignedAirspace(XmlAdapterUtils.marshallJAXBElement(AirspacePropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "assignedAirspace"), AuthorityForAirspaceTimeSliceType.class, target));
    }
