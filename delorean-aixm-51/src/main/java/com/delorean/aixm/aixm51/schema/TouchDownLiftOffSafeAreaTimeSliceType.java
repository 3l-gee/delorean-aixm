 ...
 *         <element name="lighting" type="{http://www.aixm.aero/schema/5.1}CodeYesNoType" minOccurs="0"/>
 *         <element name="obstacleFree" type="{http://www.aixm.aero/schema/5.1}CodeYesNoType" minOccurs="0"/>
 ...
 *         <element name="protectedTouchDownLiftOff" type="{http://www.aixm.aero/schema/5.1}TouchDownLiftOffPropertyType" minOccurs="0"/>
...
@Table(name = "touchdownliftoffsafearea_t", schema = "airport_heliport")
    ...
    implements Serializable
{
    ...
    protected List<TouchDownLiftOffSafeAreaTimeSliceExtensionType> extension;
    ...
    @JoinTable(name = "tchdwnlftoffsfartmslctp_annttn_link", schema = "airport_heliport", joinColumns = {
        @JoinColumn(name = "touchdownliftoffsafearea_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
     ...
     * 
     */
    @OneToMany(targetEntity = TouchDownLiftOffSafeAreaTimeSliceExtensionType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinColumn(name = "touchdownliftoffsafearea_te_hjid", referencedColumnName = "hjid")
    public List<TouchDownLiftOffSafeAreaTimeSliceExtensionType> getExtension() {
        if (extension == null) {
     ...
     * 
     */
    public void setExtension(List<TouchDownLiftOffSafeAreaTimeSliceExtensionType> extension) {
    ...
    public void setWidthItem(ValDistanceType target) {
        setWidth(XmlAdapterUtils.marshallJAXBElement(ValDistanceType.class, new QName("http://www.aixm.aero/schema/5.1", "width"), TouchDownLiftOffSafeAreaTimeSliceType.class, target));
    }
    ...
    public void setLengthItem(ValDistanceType target) {
        setLength(XmlAdapterUtils.marshallJAXBElement(ValDistanceType.class, new QName("http://www.aixm.aero/schema/5.1", "length"), TouchDownLiftOffSafeAreaTimeSliceType.class, target));
    }
    ...
    public void setLightingItem(CodeYesNoType target) {
        setLighting(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.1", "lighting"), TouchDownLiftOffSafeAreaTimeSliceType.class, target));
    }
    ...
    public void setObstacleFreeItem(CodeYesNoType target) {
        setObstacleFree(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.1", "obstacleFree"), TouchDownLiftOffSafeAreaTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = SurfaceCharacteristicsPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "tchdwnlftoffsfartmslctp_srfcprprts_link", schema = "airport_heliport", joinColumns = {
        @JoinColumn(name = "touchdownliftoffsafearea_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setSurfacePropertiesItem(SurfaceCharacteristicsPropertyType target) {
        setSurfaceProperties(XmlAdapterUtils.marshallJAXBElement(SurfaceCharacteristicsPropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "surfaceProperties"), TouchDownLiftOffSafeAreaTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = AIXMElevatedSurfacePropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "tchdwnlftoffsfartmslctp_extnt_link", schema = "airport_heliport", joinColumns = {
        @JoinColumn(name = "touchdownliftoffsafearea_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setExtentItem(AIXMElevatedSurfacePropertyType target) {
        setExtent(XmlAdapterUtils.marshallJAXBElement(AIXMElevatedSurfacePropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "extent"), TouchDownLiftOffSafeAreaTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = TouchDownLiftOffPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "tchdwnlftoffsfartmslctp_prtctdtchdwnlftoff_link", schema = "airport_heliport", joinColumns = {
        @JoinColumn(name = "touchdownliftoffsafearea_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
        @JoinColumn(name = "protectedtouchdownliftoff_hjid", referencedColumnName = "hjid")
    })
    ...
    public void setProtectedTouchDownLiftOffItem(TouchDownLiftOffPropertyType target) {
        setProtectedTouchDownLiftOff(XmlAdapterUtils.marshallJAXBElement(TouchDownLiftOffPropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "protectedTouchDownLiftOff"), TouchDownLiftOffSafeAreaTimeSliceType.class, target));
    }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        }
        {
            ...
            List<TouchDownLiftOffSafeAreaTimeSliceExtensionType> lhsField;
            lhsField = (this.isSetExtension()?this.getExtension():null);
            List<TouchDownLiftOffSafeAreaTimeSliceExtensionType> rhsField;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        }
        {
            ...
            List<TouchDownLiftOffSafeAreaTimeSliceExtensionType> theField;
