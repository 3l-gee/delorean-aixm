 ...
 *       <sequence>
 *         <element name="altitude" type="{http://www.aixm.aero/schema/5.1}ApproachAltitudeTablePropertyType" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="distance" type="{http://www.aixm.aero/schema/5.1}ApproachDistanceTablePropertyType" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="timing" type="{http://www.aixm.aero/schema/5.1}ApproachTimingTablePropertyType" maxOccurs="unbounded" minOccurs="0"/>
    ...
    implements Serializable
{
     ...
     * 
     */
    @OneToMany(targetEntity = FinalProfileExtensionType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
