 ...
 *       <sequence>
 *         <element name="type" type="{http://www.aixm.aero/schema/5.1}CodeNavigationAreaRestrictionType" minOccurs="0"/>
 *         <element name="procedure" type="{http://www.aixm.aero/schema/5.1}ProcedurePropertyType" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="designSurface" type="{http://www.aixm.aero/schema/5.1}ObstacleAssessmentAreaPropertyType" minOccurs="0"/>
    ...
    implements Serializable
{
    ...
    public void setTypeItem(CodeNavigationAreaRestrictionType target) {
        setType(XmlAdapterUtils.marshallJAXBElement(CodeNavigationAreaRestrictionType.class, new QName("http://www.aixm.aero/schema/5.1", "type"), NavigationAreaRestrictionTimeSliceType.class, target));
    }
    ...
    public void setDesignSurfaceItem(ObstacleAssessmentAreaPropertyType target) {
        setDesignSurface(XmlAdapterUtils.marshallJAXBElement(ObstacleAssessmentAreaPropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "designSurface"), NavigationAreaRestrictionTimeSliceType.class, target));
    }
    ...
    public void setSectorDefinitionItem(CircleSectorPropertyType target) {
        setSectorDefinition(XmlAdapterUtils.marshallJAXBElement(CircleSectorPropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "sectorDefinition"), NavigationAreaRestrictionTimeSliceType.class, target));
    }
