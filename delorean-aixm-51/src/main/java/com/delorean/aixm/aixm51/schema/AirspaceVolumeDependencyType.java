 ...
 *       <sequence>
 *         <element name="dependency" type="{http://www.aixm.aero/schema/5.1}CodeAirspaceDependencyType" minOccurs="0"/>
 *         <element name="annotation" type="{http://www.aixm.aero/schema/5.1}NotePropertyType" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="theAirspace" type="{http://www.aixm.aero/schema/5.1}AirspacePropertyType" minOccurs="0"/>
    ...
    implements Serializable
{
    ...
    public void setDependencyItem(CodeAirspaceDependencyType target) {
        setDependency(XmlAdapterUtils.marshallJAXBElement(CodeAirspaceDependencyType.class, new QName("http://www.aixm.aero/schema/5.1", "dependency"), AirspaceVolumeDependencyType.class, target));
    }
