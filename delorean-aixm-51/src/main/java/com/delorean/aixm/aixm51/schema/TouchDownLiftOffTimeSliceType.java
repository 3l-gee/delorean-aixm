 ...
 *         <element name="helicopterClass" type="{http://www.aixm.aero/schema/5.1}CodeHelicopterPerformanceType" minOccurs="0"/>
 *         <element name="abandoned" type="{http://www.aixm.aero/schema/5.1}CodeYesNoType" minOccurs="0"/>
 *         <element name="aimingPoint" type="{http://www.aixm.aero/schema/5.1}ElevatedPointPropertyType" minOccurs="0"/>
 ...
 *         <element name="approachTakeOffArea" type="{http://www.aixm.aero/schema/5.1}RunwayPropertyType" minOccurs="0"/>
 *         <element name="contaminant" type="{http://www.aixm.aero/schema/5.1}TouchDownLiftOffContaminationPropertyType" maxOccurs="unbounded" minOccurs="0"/>
    ...
    implements Serializable
{
    ...
    public void setDesignatorItem(TextDesignatorType target) {
        setDesignator(XmlAdapterUtils.marshallJAXBElement(TextDesignatorType.class, new QName("http://www.aixm.aero/schema/5.1", "designator"), TouchDownLiftOffTimeSliceType.class, target));
    }
    ...
    public void setLengthItem(ValDistanceType target) {
        setLength(XmlAdapterUtils.marshallJAXBElement(ValDistanceType.class, new QName("http://www.aixm.aero/schema/5.1", "length"), TouchDownLiftOffTimeSliceType.class, target));
    }
    ...
    public void setWidthItem(ValDistanceType target) {
        setWidth(XmlAdapterUtils.marshallJAXBElement(ValDistanceType.class, new QName("http://www.aixm.aero/schema/5.1", "width"), TouchDownLiftOffTimeSliceType.class, target));
    }
    ...
    public void setSlopeItem(ValSlopeType target) {
        setSlope(XmlAdapterUtils.marshallJAXBElement(ValSlopeType.class, new QName("http://www.aixm.aero/schema/5.1", "slope"), TouchDownLiftOffTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "helicopterclass", columnDefinition = "codehelicopterperformancebase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "helicopterclassnilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setHelicopterClassItem(CodeHelicopterPerformanceType target) {
        setHelicopterClass(XmlAdapterUtils.marshallJAXBElement(CodeHelicopterPerformanceType.class, new QName("http://www.aixm.aero/schema/5.1", "helicopterClass"), TouchDownLiftOffTimeSliceType.class, target));
    }
    ...
    public void setAbandonedItem(CodeYesNoType target) {
        setAbandoned(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.1", "abandoned"), TouchDownLiftOffTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = AIXMElevatedPointPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "tchdwnlftofftmslctp_amngpnt_l", schema = "airport_heliport", joinColumns = {
        @JoinColumn(name = "touchdownliftoff_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setAimingPointItem(AIXMElevatedPointPropertyType target) {
        setAimingPoint(XmlAdapterUtils.marshallJAXBElement(AIXMElevatedPointPropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "aimingPoint"), TouchDownLiftOffTimeSliceType.class, target));
    }
    ...
    public void setExtentItem(AIXMElevatedSurfacePropertyType target) {
        setExtent(XmlAdapterUtils.marshallJAXBElement(AIXMElevatedSurfacePropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "extent"), TouchDownLiftOffTimeSliceType.class, target));
    }
    ...
    public void setSurfacePropertiesItem(SurfaceCharacteristicsPropertyType target) {
        setSurfaceProperties(XmlAdapterUtils.marshallJAXBElement(SurfaceCharacteristicsPropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "surfaceProperties"), TouchDownLiftOffTimeSliceType.class, target));
    }
    ...
    public void setAssociatedAirportHeliportItem(AirportHeliportPropertyType target) {
        setAssociatedAirportHeliport(XmlAdapterUtils.marshallJAXBElement(AirportHeliportPropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "associatedAirportHeliport"), TouchDownLiftOffTimeSliceType.class, target));
    }
    ...
    public void setApproachTakeOffAreaItem(RunwayPropertyType target) {
        setApproachTakeOffArea(XmlAdapterUtils.marshallJAXBElement(RunwayPropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "approachTakeOffArea"), TouchDownLiftOffTimeSliceType.class, target));
    }
