 ...
 *       <sequence>
 *         <element name="priorPermission" type="{http://www.aixm.aero/schema/5.1}CodeYesNoType" minOccurs="0"/>
 *         <element name="routeElement" type="{http://www.aixm.aero/schema/5.1}FlightRoutingElementPropertyType" maxOccurs="unbounded" minOccurs="0"/>
    ...
    implements Serializable
{
    ...
    public void setPriorPermissionItem(CodeYesNoType target) {
        setPriorPermission(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.1", "priorPermission"), FlightRestrictionRouteType.class, target));
    }
