...
"{http://www.aixm.aero/schema/5.1}FlightRoutingElementPropertyType" maxOccurs=
 ...
 *                 <sequence>
 *                   <element ref=
"{http://www.aixm.aero/schema/5.1}AbstractFlightRestrictionRouteExtension"/>
 *                 </sequence>
 *                 <attGroup ref=
...
public class FlightRestrictionRouteType extends AbstractAIXMObjectType implements Serializable {
    ...
    public void setPriorPermissionItem(CodeYesNoType target) {
        setPriorPermission(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class,
                new QName("http://www.aixm.aero/schema/5.1", "priorPermission"), FlightRestrictionRouteType.class,
                target));
    }
