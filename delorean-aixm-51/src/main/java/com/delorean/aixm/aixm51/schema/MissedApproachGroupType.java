 ...
 *         <element name="alternateClimbInstruction" type="{http://www.aixm.aero/schema/5.1}TextInstructionType" minOccurs="0"/>
 *         <element name="alternateClimbAltitude" type="{http://www.aixm.aero/schema/5.1}ValDistanceVerticalType" minOccurs="0"/>
 *         <element name="altimeter" type="{http://www.aixm.aero/schema/5.1}AltimeterSourcePropertyType" maxOccurs="unbounded" minOccurs="0"/>
    ...
    implements Serializable
{
    ...
    public void setInstructionItem(TextInstructionType target) {
        setInstruction(XmlAdapterUtils.marshallJAXBElement(TextInstructionType.class, new QName("http://www.aixm.aero/schema/5.1", "instruction"), MissedApproachGroupType.class, target));
    }
    ...
    public void setAlternateClimbInstructionItem(TextInstructionType target) {
        setAlternateClimbInstruction(XmlAdapterUtils.marshallJAXBElement(TextInstructionType.class, new QName("http://www.aixm.aero/schema/5.1", "alternateClimbInstruction"), MissedApproachGroupType.class, target));
    }
    ...
    public void setAlternateClimbAltitudeItem(ValDistanceVerticalType target) {
        setAlternateClimbAltitude(XmlAdapterUtils.marshallJAXBElement(ValDistanceVerticalType.class, new QName("http://www.aixm.aero/schema/5.1", "alternateClimbAltitude"), MissedApproachGroupType.class, target));
    }
