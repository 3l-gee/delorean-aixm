...
@Entity(name = "AirspaceActivationExtensionType")
@Table(name = "airspaceactivation_oe", schema = "airspace")
public class AirspaceActivationExtensionType implements Serializable, Equals, HashCode, ToString {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final AirspaceActivationExtensionType that = ((AirspaceActivationExtensionType) object);
        {
