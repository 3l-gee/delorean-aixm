    ...
    implements Serializable
{
    ...
    public void setTypeItem(CodeAuthorityType target) {
        setType(XmlAdapterUtils.marshallJAXBElement(CodeAuthorityType.class, new QName("http://www.aixm.aero/schema/5.1", "type"), AuthorityForAerialRefuellingType.class, target));
    }
