...
/**
 * <p>Java class for RunwayDeclaredDistanceType complex type</p>.
 * 
 ...
 *       <sequence>
 *         <element name="type" type="{http://www.aixm.aero/schema/5.1}CodeDeclaredDistanceType" minOccurs="0"/>
 *         <element name="declaredValue" type="{http://www.aixm.aero/schema/5.1}RunwayDeclaredDistanceValuePropertyType" maxOccurs="unbounded" minOccurs="0"/>
 ...
 *                 <sequence>
 *                   <element ref="{http://www.aixm.aero/schema/5.1}AbstractRunwayDeclaredDistanceExtension"/>
 *                 </sequence>
    ...
    implements Serializable
{
    ...
    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "type", columnDefinition = "codedeclareddistancebase")),
    ...
    public void setTypeItem(CodeDeclaredDistanceType target) {
        setType(XmlAdapterUtils.marshallJAXBElement(CodeDeclaredDistanceType.class, new QName("http://www.aixm.aero/schema/5.1", "type"), RunwayDeclaredDistanceType.class, target));
    }
