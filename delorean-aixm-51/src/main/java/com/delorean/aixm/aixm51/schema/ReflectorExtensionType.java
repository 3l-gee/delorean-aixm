...
@XmlType(name = "", propOrder = {"abstractReflectorExtension"})
@Entity(name = "ReflectorExtensionType")
@Table(name = "reflector_oe", schema = "surveillance")
public class ReflectorExtensionType implements Serializable, Equals, HashCode, ToString {

    private static final long serialVersionUID = 20251104L;
    @XmlElement(name = "AbstractReflectorExtension", required = true)
