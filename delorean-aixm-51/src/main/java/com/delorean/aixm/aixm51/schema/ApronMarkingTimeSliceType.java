 ...
 *         <element name="markingLocation" type="{http://www.aixm.aero/schema/5.1}CodeApronSectionType" minOccurs="0"/>
 *         <element name="markedApron" type="{http://www.aixm.aero/schema/5.1}ApronPropertyType" minOccurs="0"/>
 *         <element name="extension" maxOccurs="unbounded" minOccurs="0">
 *           <complexType>
 *             <complexContent>
 *               <restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 <choice>
 *                   <element ref="{http://www.aixm.aero/schema/5.1}AbstractApronMarkingExtension"/>
...
@Table(name = "apronmarking_t", schema = "airport_heliport")
    ...
    implements Serializable
{
    ...
    @XmlElementRef(name = "markedApron", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class, required = false)
    protected JAXBElement<ApronPropertyType> markedApron;
    protected List<ApronMarkingTimeSliceExtensionType> extension;
    ...
    @JoinTable(name = "aprnmrkngtmslctp_elmnt_link", schema = "airport_heliport", joinColumns = {
        @JoinColumn(name = "apronmarking_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "aprnmrkngtmslctp_annttn_link", schema = "airport_heliport", joinColumns = {
        @JoinColumn(name = "apronmarking_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link ApronMarkingTimeSliceExtensionType }
     * 
     * 
     */
    @OneToMany(targetEntity = ApronMarkingTimeSliceExtensionType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinColumn(name = "apronmarking_te_hjid", referencedColumnName = "hjid")
    public List<ApronMarkingTimeSliceExtensionType> getExtension() {
        if (extension == null) {
     ...
     * 
     */
    public void setExtension(List<ApronMarkingTimeSliceExtensionType> extension) {
    ...
    public void setMarkingICAOStandardItem(CodeYesNoType target) {
        setMarkingICAOStandard(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.1", "markingICAOStandard"), ApronMarkingTimeSliceType.class, target));
    }
    ...
    public void setConditionItem(CodeMarkingConditionType target) {
        setCondition(XmlAdapterUtils.marshallJAXBElement(CodeMarkingConditionType.class, new QName("http://www.aixm.aero/schema/5.1", "condition"), ApronMarkingTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "markinglocation", columnDefinition = "codeapronsectionbase")),
    ...
    public void setMarkingLocationItem(CodeApronSectionType target) {
        setMarkingLocation(XmlAdapterUtils.marshallJAXBElement(CodeApronSectionType.class, new QName("http://www.aixm.aero/schema/5.1", "markingLocation"), ApronMarkingTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = ApronPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "aprnmrkngtmslctp_mrkdaprn_link", schema = "airport_heliport", joinColumns = {
        @JoinColumn(name = "apronmarking_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
        @JoinColumn(name = "markedapron_hjid", referencedColumnName = "hjid")
    })
    ...
    public void setMarkedApronItem(ApronPropertyType target) {
        setMarkedApron(XmlAdapterUtils.marshallJAXBElement(ApronPropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "markedApron"), ApronMarkingTimeSliceType.class, target));
    }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        }
        {
            ...
            List<ApronMarkingTimeSliceExtensionType> lhsField;
            lhsField = (this.isSetExtension()?this.getExtension():null);
            List<ApronMarkingTimeSliceExtensionType> rhsField;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetMarkedApron();
            JAXBElement<ApronPropertyType> theField;
            theField = this.getMarkedApron();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "markedApron", theField);
            currentHashCode = strategy.hashCode(theFieldLocator, currentHashCode, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetExtension();
            List<ApronMarkingTimeSliceExtensionType> theField;
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        }
        {
            ...
            JAXBElement<ApronPropertyType> theField;
            theField = this.getMarkedApron();
            strategy.appendField(locator, this, "markedApron", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetExtension();
            List<ApronMarkingTimeSliceExtensionType> theField;
