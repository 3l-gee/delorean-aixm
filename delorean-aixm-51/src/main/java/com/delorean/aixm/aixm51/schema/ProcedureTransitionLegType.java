 ...
 *       <sequence>
 *         <element name="seqNumberARINC" type="{http://www.aixm.aero/schema/5.1}NoSequenceType" minOccurs="0"/>
 *         <element name="annotation" type="{http://www.aixm.aero/schema/5.1}NotePropertyType" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="theSegmentLeg" type="{http://www.aixm.aero/schema/5.1}SegmentLegPropertyType" minOccurs="0"/>
    ...
    implements Serializable
{
    ...
    public void setSeqNumberARINCItem(NoSequenceType target) {
        setSeqNumberARINC(XmlAdapterUtils.marshallJAXBElement(NoSequenceType.class, new QName("http://www.aixm.aero/schema/5.1", "seqNumberARINC"), ProcedureTransitionLegType.class, target));
    }
