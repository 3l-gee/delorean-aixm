...
"{http://www.aixm.aero/schema/5.1}SegmentLegPropertyType" minOccurs="0"/>
 ...
 *                 <sequence>
 *                   <element ref=
"{http://www.aixm.aero/schema/5.1}AbstractProcedureTransitionLegExtension"/>
 *                 </sequence>
 *                 <attGroup ref=
...
public class ProcedureTransitionLegType extends AbstractAIXMObjectType implements Serializable {
    ...
    public void setSeqNumberARINCItem(NoSequenceType target) {
        setSeqNumberARINC(XmlAdapterUtils.marshallJAXBElement(NoSequenceType.class,
                new QName("http://www.aixm.aero/schema/5.1", "seqNumberARINC"), ProcedureTransitionLegType.class,
                target));
    }
