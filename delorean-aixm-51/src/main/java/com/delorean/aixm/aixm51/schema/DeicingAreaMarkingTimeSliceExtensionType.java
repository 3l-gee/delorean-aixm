...
@XmlType(name = "", propOrder = {"abstractDeicingAreaMarkingExtension", "abstractMarkingExtension"})
@Entity(name = "DeicingAreaMarkingTimeSliceExtensionType")
@Table(name = "deicingareamarking_te", schema = "airport_heliport")
public class DeicingAreaMarkingTimeSliceExtensionType implements Serializable, Equals, HashCode, ToString {
    ...
    @JoinColumn(name = "abstractdeicingareamarkingextension_hjid", referencedColumnName = "hjid")
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetAbstractDeicingAreaMarkingExtension();
            AbstractExtensionType theField;
            theField = this.getAbstractDeicingAreaMarkingExtension();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "abstractDeicingAreaMarkingExtension",
                    theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            AbstractExtensionType theField;
            theField = this.getAbstractDeicingAreaMarkingExtension();
            strategy.appendField(locator, this, "abstractDeicingAreaMarkingExtension", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetAbstractMarkingExtension();
            AbstractExtensionType theField;
