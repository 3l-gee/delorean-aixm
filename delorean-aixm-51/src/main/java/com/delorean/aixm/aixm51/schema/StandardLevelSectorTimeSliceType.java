 ...
 *         <element name="fromTrack" type="{http://www.aixm.aero/schema/5.1}ValBearingType" minOccurs="0"/>
 *         <element name="toTrack" type="{http://www.aixm.aero/schema/5.1}ValBearingType" minOccurs="0"/>
 *         <element name="angleType" type="{http://www.aixm.aero/schema/5.1}CodeNorthReferenceType" minOccurs="0"/>
 *         <element name="applicableAirspace" type="{http://www.aixm.aero/schema/5.1}AirspacePropertyType" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="applicableLevelColumn" type="{http://www.aixm.aero/schema/5.1}StandardLevelColumnPropertyType" minOccurs="0"/>
    ...
    implements Serializable
{
    ...
    public void setFlightRuleItem(CodeFlightRuleType target) {
        setFlightRule(XmlAdapterUtils.marshallJAXBElement(CodeFlightRuleType.class, new QName("http://www.aixm.aero/schema/5.1", "flightRule"), StandardLevelSectorTimeSliceType.class, target));
    }
    ...
    public void setFromTrackItem(ValBearingType target) {
        setFromTrack(XmlAdapterUtils.marshallJAXBElement(ValBearingType.class, new QName("http://www.aixm.aero/schema/5.1", "fromTrack"), StandardLevelSectorTimeSliceType.class, target));
    }
    ...
    public void setToTrackItem(ValBearingType target) {
        setToTrack(XmlAdapterUtils.marshallJAXBElement(ValBearingType.class, new QName("http://www.aixm.aero/schema/5.1", "toTrack"), StandardLevelSectorTimeSliceType.class, target));
    }
    ...
    public void setAngleTypeItem(CodeNorthReferenceType target) {
        setAngleType(XmlAdapterUtils.marshallJAXBElement(CodeNorthReferenceType.class, new QName("http://www.aixm.aero/schema/5.1", "angleType"), StandardLevelSectorTimeSliceType.class, target));
    }
    ...
    public void setApplicableLevelColumnItem(StandardLevelColumnPropertyType target) {
        setApplicableLevelColumn(XmlAdapterUtils.marshallJAXBElement(StandardLevelColumnPropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "applicableLevelColumn"), StandardLevelSectorTimeSliceType.class, target));
    }
