    ...
    implements Serializable
{
    ...
    public void setExtentItem(AIXMCurvePropertyType target) {
        setExtent(XmlAdapterUtils.marshallJAXBElement(AIXMCurvePropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "extent"), AerialRefuellingTrackType.class, target));
    }
