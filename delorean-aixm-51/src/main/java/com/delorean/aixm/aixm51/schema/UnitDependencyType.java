 ...
 *       <sequence>
 *         <element name="type" type="{http://www.aixm.aero/schema/5.1}CodeUnitDependencyType" minOccurs="0"/>
 *         <element name="annotation" type="{http://www.aixm.aero/schema/5.1}NotePropertyType" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="theUnit" type="{http://www.aixm.aero/schema/5.1}UnitPropertyType" minOccurs="0"/>
    ...
    implements Serializable
{
    ...
    public void setTypeItem(CodeUnitDependencyType target) {
        setType(XmlAdapterUtils.marshallJAXBElement(CodeUnitDependencyType.class, new QName("http://www.aixm.aero/schema/5.1", "type"), UnitDependencyType.class, target));
    }
