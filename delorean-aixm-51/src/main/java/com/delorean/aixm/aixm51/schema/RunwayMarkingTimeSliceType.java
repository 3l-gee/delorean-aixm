 ...
 *         <element name="markingLocation" type="{http://www.aixm.aero/schema/5.1}CodeRunwaySectionType" minOccurs="0"/>
 *         <element name="markedRunway" type="{http://www.aixm.aero/schema/5.1}RunwayPropertyType" minOccurs="0"/>
    ...
    implements Serializable
{
    ...
    public void setMarkingICAOStandardItem(CodeYesNoType target) {
        setMarkingICAOStandard(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.1", "markingICAOStandard"), RunwayMarkingTimeSliceType.class, target));
    }
    ...
    public void setConditionItem(CodeMarkingConditionType target) {
        setCondition(XmlAdapterUtils.marshallJAXBElement(CodeMarkingConditionType.class, new QName("http://www.aixm.aero/schema/5.1", "condition"), RunwayMarkingTimeSliceType.class, target));
    }
    ...
    public void setMarkingLocationItem(CodeRunwaySectionType target) {
        setMarkingLocation(XmlAdapterUtils.marshallJAXBElement(CodeRunwaySectionType.class, new QName("http://www.aixm.aero/schema/5.1", "markingLocation"), RunwayMarkingTimeSliceType.class, target));
    }
    ...
    public void setMarkedRunwayItem(RunwayPropertyType target) {
        setMarkedRunway(XmlAdapterUtils.marshallJAXBElement(RunwayPropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "markedRunway"), RunwayMarkingTimeSliceType.class, target));
    }
