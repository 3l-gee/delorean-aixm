 ...
 *       <sequence>
 *         <element name="role" type="{http://www.aixm.aero/schema/5.1}CodeRunwayPointRoleType" minOccurs="0"/>
 ...
 *         <element name="onRunway" type="{http://www.aixm.aero/schema/5.1}RunwayDirectionPropertyType" minOccurs="0"/>
 *         <element name="associatedDeclaredDistance" type="{http://www.aixm.aero/schema/5.1}RunwayDeclaredDistancePropertyType" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="navaidEquipment" type="{http://www.aixm.aero/schema/5.1}NavaidEquipmentDistancePropertyType" maxOccurs="unbounded" minOccurs="0"/>
    ...
    implements Serializable
{
    ...
    public void setRoleItem(CodeRunwayPointRoleType target) {
        setRole(XmlAdapterUtils.marshallJAXBElement(CodeRunwayPointRoleType.class, new QName("http://www.aixm.aero/schema/5.1", "role"), RunwayCentrelinePointTimeSliceType.class, target));
    }
    ...
    public void setDesignatorItem(TextDesignatorType target) {
        setDesignator(XmlAdapterUtils.marshallJAXBElement(TextDesignatorType.class, new QName("http://www.aixm.aero/schema/5.1", "designator"), RunwayCentrelinePointTimeSliceType.class, target));
    }
    ...
    public void setLocationItem(AIXMElevatedPointPropertyType target) {
        setLocation(XmlAdapterUtils.marshallJAXBElement(AIXMElevatedPointPropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "location"), RunwayCentrelinePointTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = RunwayDirectionPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "rnwcntrlnpnttmslctp_onrnw_l", schema = "airport_heliport", joinColumns = {
        @JoinColumn(name = "runwaycentrelinepoint_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setOnRunwayItem(RunwayDirectionPropertyType target) {
        setOnRunway(XmlAdapterUtils.marshallJAXBElement(RunwayDirectionPropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "onRunway"), RunwayCentrelinePointTimeSliceType.class, target));
    }
