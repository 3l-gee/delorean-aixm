 ...
 *       <sequence>
 *         <element name="type" type="{http://www.aixm.aero/schema/5.1}CodeObstacleAssessmentSurfaceType" minOccurs="0"/>
 *         <element name="sectionNumber" type="{http://www.aixm.aero/schema/5.1}NoNumberType" minOccurs="0"/>
 *         <element name="slope" type="{http://www.aixm.aero/schema/5.1}ValSlopeType" minOccurs="0"/>
 *         <element name="assessedAltitude" type="{http://www.aixm.aero/schema/5.1}ValDistanceVerticalType" minOccurs="0"/>
 *         <element name="slopeLowerAltitude" type="{http://www.aixm.aero/schema/5.1}ValDistanceVerticalType" minOccurs="0"/>
 *         <element name="gradientLowHigh" type="{http://www.aixm.aero/schema/5.1}ValSlopeType" minOccurs="0"/>
 *         <element name="surfaceZone" type="{http://www.aixm.aero/schema/5.1}CodeObstructionIdSurfaceZoneType" minOccurs="0"/>
 *         <element name="safetyRegulation" type="{http://www.aixm.aero/schema/5.1}TextNameType" minOccurs="0"/>
 ...
 *         <element name="significantObstacle" type="{http://www.aixm.aero/schema/5.1}ObstructionPropertyType" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="surface" type="{http://www.aixm.aero/schema/5.1}SurfacePropertyType" minOccurs="0"/>
 *         <element name="startingCurve" type="{http://www.aixm.aero/schema/5.1}CurvePropertyType" minOccurs="0"/>
...
@Table(name = "obstacleassessmentarea_o", schema = "shared")
    ...
    implements Serializable
{
    ...
    protected List<ObstacleAssessmentAreaExtensionType> extension;
    ...
    @JoinTable(name = "obstclassssmntartp_arcrftctgr_link", schema = "shared", joinColumns = {
        @JoinColumn(name = "obstacleassessmentarea_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "obstclassssmntartp_sgnfcntobstcl_link", schema = "shared", joinColumns = {
        @JoinColumn(name = "obstacleassessmentarea_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "obstclassssmntartp_annttn_link", schema = "shared", joinColumns = {
        @JoinColumn(name = "obstacleassessmentarea_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link ObstacleAssessmentAreaExtensionType }
     * 
     * 
     */
    @OneToMany(targetEntity = ObstacleAssessmentAreaExtensionType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinColumn(name = "obstacleassessmentarea_oe_hjid", referencedColumnName = "hjid")
    public List<ObstacleAssessmentAreaExtensionType> getExtension() {
        if (extension == null) {
     ...
     * 
     */
    public void setExtension(List<ObstacleAssessmentAreaExtensionType> extension) {
    ...
    public void setTypeItem(CodeObstacleAssessmentSurfaceType target) {
        setType(XmlAdapterUtils.marshallJAXBElement(CodeObstacleAssessmentSurfaceType.class, new QName("http://www.aixm.aero/schema/5.1", "type"), ObstacleAssessmentAreaType.class, target));
    }
    ...
    public void setSectionNumberItem(NoNumberType target) {
        setSectionNumber(XmlAdapterUtils.marshallJAXBElement(NoNumberType.class, new QName("http://www.aixm.aero/schema/5.1", "sectionNumber"), ObstacleAssessmentAreaType.class, target));
    }
    ...
    public void setSlopeItem(ValSlopeType target) {
        setSlope(XmlAdapterUtils.marshallJAXBElement(ValSlopeType.class, new QName("http://www.aixm.aero/schema/5.1", "slope"), ObstacleAssessmentAreaType.class, target));
    }
    ...
    public void setAssessedAltitudeItem(ValDistanceVerticalType target) {
        setAssessedAltitude(XmlAdapterUtils.marshallJAXBElement(ValDistanceVerticalType.class, new QName("http://www.aixm.aero/schema/5.1", "assessedAltitude"), ObstacleAssessmentAreaType.class, target));
    }
    ...
    public void setSlopeLowerAltitudeItem(ValDistanceVerticalType target) {
        setSlopeLowerAltitude(XmlAdapterUtils.marshallJAXBElement(ValDistanceVerticalType.class, new QName("http://www.aixm.aero/schema/5.1", "slopeLowerAltitude"), ObstacleAssessmentAreaType.class, target));
    }
    ...
    public void setGradientLowHighItem(ValSlopeType target) {
        setGradientLowHigh(XmlAdapterUtils.marshallJAXBElement(ValSlopeType.class, new QName("http://www.aixm.aero/schema/5.1", "gradientLowHigh"), ObstacleAssessmentAreaType.class, target));
    }
    ...
    public void setSurfaceZoneItem(CodeObstructionIdSurfaceZoneType target) {
        setSurfaceZone(XmlAdapterUtils.marshallJAXBElement(CodeObstructionIdSurfaceZoneType.class, new QName("http://www.aixm.aero/schema/5.1", "surfaceZone"), ObstacleAssessmentAreaType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "safetyregulation", columnDefinition = "character3")),
    ...
    public void setSafetyRegulationItem(TextNameType target) {
        setSafetyRegulation(XmlAdapterUtils.marshallJAXBElement(TextNameType.class, new QName("http://www.aixm.aero/schema/5.1", "safetyRegulation"), ObstacleAssessmentAreaType.class, target));
    }

    @OneToOne(targetEntity = AIXMSurfacePropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "obstclassssmntartp_srfc_link", schema = "shared", joinColumns = {
        @JoinColumn(name = "obstacleassessmentarea_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setSurfaceItem(AIXMSurfacePropertyType target) {
        setSurface(XmlAdapterUtils.marshallJAXBElement(AIXMSurfacePropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "surface"), ObstacleAssessmentAreaType.class, target));
    }

    @OneToOne(targetEntity = AIXMCurvePropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "obstclassssmntartp_strtngcrv_link", schema = "shared", joinColumns = {
        @JoinColumn(name = "obstacleassessmentarea_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setStartingCurveItem(AIXMCurvePropertyType target) {
        setStartingCurve(XmlAdapterUtils.marshallJAXBElement(AIXMCurvePropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "startingCurve"), ObstacleAssessmentAreaType.class, target));
    }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        }
        {
            ...
            List<ObstacleAssessmentAreaExtensionType> lhsField;
            lhsField = (this.isSetExtension()?this.getExtension():null);
            List<ObstacleAssessmentAreaExtensionType> rhsField;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        }
        {
            ...
            List<ObstacleAssessmentAreaExtensionType> theField;
