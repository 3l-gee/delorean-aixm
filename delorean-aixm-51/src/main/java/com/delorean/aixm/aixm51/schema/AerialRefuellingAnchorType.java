 ...
 *         <element name="legSeparation" type="{http://www.aixm.aero/schema/5.1}ValDistanceType" minOccurs="0"/>
 *         <element name="legLength" type="{http://www.aixm.aero/schema/5.1}ValDistanceType" minOccurs="0"/>
 *         <element name="refuellingBaseLevel" type="{http://www.aixm.aero/schema/5.1}ValDistanceVerticalType" minOccurs="0"/>
 *         <element name="refuellingBaseLevelReference" type="{http://www.aixm.aero/schema/5.1}CodeVerticalReferenceType" minOccurs="0"/>
 *         <element name="extent" type="{http://www.aixm.aero/schema/5.1}SurfacePropertyType" minOccurs="0"/>
 *         <element name="verticalExtent" type="{http://www.aixm.aero/schema/5.1}AirspaceLayerPropertyType" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="point" type="{http://www.aixm.aero/schema/5.1}AerialRefuellingPointPropertyType" maxOccurs="unbounded" minOccurs="0"/>
    ...
    implements Serializable
{
    ...
    @JoinTable(name = "arlrfllnganchrtp_vrtclextnt_l", schema = "aerial_refuelling", joinColumns = {
    ...
    @JoinTable(name = "arlrfllnganchrtp_pnt_l", schema = "aerial_refuelling", joinColumns = {
        @JoinColumn(name = "aerialrefuellinganchor_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "arlrfllnganchrtp_annttn_l", schema = "aerial_refuelling", joinColumns = {
        @JoinColumn(name = "aerialrefuellinganchor_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setOutboundCourseItem(ValBearingType target) {
        setOutboundCourse(XmlAdapterUtils.marshallJAXBElement(ValBearingType.class, new QName("http://www.aixm.aero/schema/5.1", "outboundCourse"), AerialRefuellingAnchorType.class, target));
    }
    ...
    public void setOutboundCourseTypeItem(CodeCourseType target) {
        setOutboundCourseType(XmlAdapterUtils.marshallJAXBElement(CodeCourseType.class, new QName("http://www.aixm.aero/schema/5.1", "outboundCourseType"), AerialRefuellingAnchorType.class, target));
    }
    ...
    public void setInboundCourseItem(ValBearingType target) {
        setInboundCourse(XmlAdapterUtils.marshallJAXBElement(ValBearingType.class, new QName("http://www.aixm.aero/schema/5.1", "inboundCourse"), AerialRefuellingAnchorType.class, target));
    }
    ...
    public void setTurnDirectionItem(CodeDirectionTurnType target) {
        setTurnDirection(XmlAdapterUtils.marshallJAXBElement(CodeDirectionTurnType.class, new QName("http://www.aixm.aero/schema/5.1", "turnDirection"), AerialRefuellingAnchorType.class, target));
    }
    ...
    public void setSpeedLimitItem(ValSpeedType target) {
        setSpeedLimit(XmlAdapterUtils.marshallJAXBElement(ValSpeedType.class, new QName("http://www.aixm.aero/schema/5.1", "speedLimit"), AerialRefuellingAnchorType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "legseparation", columnDefinition = "valdistancebase")),
        @AttributeOverride(name = "uom", column = @Column(name = "legseparationuom", columnDefinition = "uomdistance")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "legseparationnilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setLegSeparationItem(ValDistanceType target) {
        setLegSeparation(XmlAdapterUtils.marshallJAXBElement(ValDistanceType.class, new QName("http://www.aixm.aero/schema/5.1", "legSeparation"), AerialRefuellingAnchorType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "leglength", columnDefinition = "valdistancebase")),
        @AttributeOverride(name = "uom", column = @Column(name = "leglengthuom", columnDefinition = "uomdistance")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "leglengthnilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setLegLengthItem(ValDistanceType target) {
        setLegLength(XmlAdapterUtils.marshallJAXBElement(ValDistanceType.class, new QName("http://www.aixm.aero/schema/5.1", "legLength"), AerialRefuellingAnchorType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "refuellingbaselevel", columnDefinition = "valdistanceverticalbase")),
        @AttributeOverride(name = "uom", column = @Column(name = "refuellingbaseleveluom", columnDefinition = "uomdistancevertical")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "refuellingbaselevelnilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setRefuellingBaseLevelItem(ValDistanceVerticalType target) {
        setRefuellingBaseLevel(XmlAdapterUtils.marshallJAXBElement(ValDistanceVerticalType.class, new QName("http://www.aixm.aero/schema/5.1", "refuellingBaseLevel"), AerialRefuellingAnchorType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "refuellingbaselevelreference", columnDefinition = "codeverticalreferencebase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "refuellingbaselevelreferencenilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setRefuellingBaseLevelReferenceItem(CodeVerticalReferenceType target) {
        setRefuellingBaseLevelReference(XmlAdapterUtils.marshallJAXBElement(CodeVerticalReferenceType.class, new QName("http://www.aixm.aero/schema/5.1", "refuellingBaseLevelReference"), AerialRefuellingAnchorType.class, target));
    }

    @OneToOne(targetEntity = AIXMSurfacePropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "arlrfllnganchrtp_extnt_l", schema = "aerial_refuelling", joinColumns = {
        @JoinColumn(name = "aerialrefuellinganchor_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setExtentItem(AIXMSurfacePropertyType target) {
        setExtent(XmlAdapterUtils.marshallJAXBElement(AIXMSurfacePropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "extent"), AerialRefuellingAnchorType.class, target));
    }
