 ...
 *       <sequence>
 *         <element name="isRemote" type="{http://www.aixm.aero/schema/5.1}CodeYesNoType" minOccurs="0"/>
 *         <element name="isPrimary" type="{http://www.aixm.aero/schema/5.1}CodeYesNoType" minOccurs="0"/>
 *         <element name="availability" type="{http://www.aixm.aero/schema/5.1}AltimeterSourceStatusPropertyType" maxOccurs="unbounded" minOccurs="0"/>
    ...
    implements Serializable
{
    ...
    protected List<AltimeterSourceTimeSliceExtensionType> extension;
    ...
    public void setIsRemoteItem(CodeYesNoType target) {
        setIsRemote(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.1", "isRemote"), AltimeterSourceTimeSliceType.class, target));
    }
    ...
    public void setIsPrimaryItem(CodeYesNoType target) {
        setIsPrimary(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.1", "isPrimary"), AltimeterSourceTimeSliceType.class, target));
    }
