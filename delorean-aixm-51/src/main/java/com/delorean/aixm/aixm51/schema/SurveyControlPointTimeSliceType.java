...
/**
 * <p>
 * Java class for SurveyControlPointTimeSliceType complex type
 * </p>
 * .
 *
 * <p>
 ...
 *                 <sequence>
 *                   <element ref=
"{http://www.aixm.aero/schema/5.1}AbstractSurveyControlPointExtension"/>
 *                 </sequence>
 *                 <attGroup ref=
...
@XmlType(name = "SurveyControlPointTimeSliceType", propOrder = {"designator", "associatedAirportHeliport", "location",
        "annotation", "extension"})
@Entity(name = "SurveyControlPointTimeSliceType")
@Table(name = "surveycontrolpoint_t", schema = "airport_heliport")
public class SurveyControlPointTimeSliceType extends AbstractAIXMTimeSliceType implements Serializable {
    ...
    @JoinTable(name = "srvcntrlpnttmslctp_annttn_link", schema = "airport_heliport", joinColumns = {
            @JoinColumn(name = "surveycontrolpoint_t_hjid", referencedColumnName = "hjid")}, inverseJoinColumns = {
    ...
    public void setDesignatorItem(TextNameType target) {
        setDesignator(XmlAdapterUtils.marshallJAXBElement(TextNameType.class,
                new QName("http://www.aixm.aero/schema/5.1", "designator"), SurveyControlPointTimeSliceType.class,
                target));
    }
    ...
    public void setAssociatedAirportHeliportItem(AirportHeliportPropertyType target) {
        setAssociatedAirportHeliport(XmlAdapterUtils.marshallJAXBElement(AirportHeliportPropertyType.class,
                ...
                SurveyControlPointTimeSliceType.class, target));
    }
    ...
    public void setLocationItem(AIXMElevatedPointPropertyType target) {
        setLocation(XmlAdapterUtils.marshallJAXBElement(AIXMElevatedPointPropertyType.class,
                new QName("http://www.aixm.aero/schema/5.1", "location"), SurveyControlPointTimeSliceType.class,
                target));
    }
