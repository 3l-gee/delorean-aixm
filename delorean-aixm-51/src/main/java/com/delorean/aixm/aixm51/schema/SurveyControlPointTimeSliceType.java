 ...
 *                 <sequence>
 *                   <element ref="{http://www.aixm.aero/schema/5.1}AbstractSurveyControlPointExtension"/>
 *                 </sequence>
...
@Entity(name = "SurveyControlPointTimeSliceType")
@Table(name = "surveycontrolpoint_t", schema = "airport_heliport")
    ...
    implements Serializable
{
    ...
    protected List<SurveyControlPointTimeSliceExtensionType> extension;
    ...
    @JoinTable(name = "srvcntrlpnttmslctp_annttn_link", schema = "airport_heliport", joinColumns = {
        @JoinColumn(name = "surveycontrolpoint_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link SurveyControlPointTimeSliceExtensionType }
     * 
     * 
     */
    @OneToMany(targetEntity = SurveyControlPointTimeSliceExtensionType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinColumn(name = "surveycontrolpoint_te_hjid", referencedColumnName = "hjid")
    public List<SurveyControlPointTimeSliceExtensionType> getExtension() {
        if (extension == null) {
     ...
     * 
     */
    public void setExtension(List<SurveyControlPointTimeSliceExtensionType> extension) {
    ...
    public void setDesignatorItem(TextNameType target) {
        setDesignator(XmlAdapterUtils.marshallJAXBElement(TextNameType.class, new QName("http://www.aixm.aero/schema/5.1", "designator"), SurveyControlPointTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = AirportHeliportPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "srvcntrlpnttmslctp_assctdarprthlprt_link", schema = "airport_heliport", joinColumns = {
        @JoinColumn(name = "surveycontrolpoint_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setAssociatedAirportHeliportItem(AirportHeliportPropertyType target) {
        setAssociatedAirportHeliport(XmlAdapterUtils.marshallJAXBElement(AirportHeliportPropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "associatedAirportHeliport"), SurveyControlPointTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = AIXMElevatedPointPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "srvcntrlpnttmslctp_lctn_link", schema = "airport_heliport", joinColumns = {
        @JoinColumn(name = "surveycontrolpoint_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setLocationItem(AIXMElevatedPointPropertyType target) {
        setLocation(XmlAdapterUtils.marshallJAXBElement(AIXMElevatedPointPropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "location"), SurveyControlPointTimeSliceType.class, target));
    }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        final SurveyControlPointTimeSliceType that = ((SurveyControlPointTimeSliceType) object);
        {
        ...
        }
        {
            ...
            List<SurveyControlPointTimeSliceExtensionType> lhsField;
            lhsField = (this.isSetExtension()?this.getExtension():null);
            List<SurveyControlPointTimeSliceExtensionType> rhsField;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        }
        {
            ...
            List<SurveyControlPointTimeSliceExtensionType> theField;
