 ...
 *       <sequence>
 *         <element name="category" type="{http://www.aixm.aero/schema/5.1}CodeRuleProcedureType" minOccurs="0"/>
 *         <element name="title" type="{http://www.aixm.aero/schema/5.1}CodeRuleProcedureTitleType" minOccurs="0"/>
 *         <element name="content" type="{http://www.aixm.aero/schema/5.1}XHTMLType" minOccurs="0"/>
 *         <element name="affectedLocation" type="{http://www.aixm.aero/schema/5.1}AirportHeliportPropertyType" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="affectedArea" type="{http://www.aixm.aero/schema/5.1}AirspacePropertyType" maxOccurs="unbounded" minOccurs="0"/>
    ...
    implements Serializable
{
    ...
    public void setCategoryItem(CodeRuleProcedureType target) {
        setCategory(XmlAdapterUtils.marshallJAXBElement(CodeRuleProcedureType.class, new QName("http://www.aixm.aero/schema/5.1", "category"), RulesProceduresTimeSliceType.class, target));
    }
    ...
    public void setTitleItem(CodeRuleProcedureTitleType target) {
        setTitle(XmlAdapterUtils.marshallJAXBElement(CodeRuleProcedureTitleType.class, new QName("http://www.aixm.aero/schema/5.1", "title"), RulesProceduresTimeSliceType.class, target));
    }
    ...
    public void setContentItem(XHTMLType target) {
        setContent(XmlAdapterUtils.marshallJAXBElement(XHTMLType.class, new QName("http://www.aixm.aero/schema/5.1", "content"), RulesProceduresTimeSliceType.class, target));
    }
