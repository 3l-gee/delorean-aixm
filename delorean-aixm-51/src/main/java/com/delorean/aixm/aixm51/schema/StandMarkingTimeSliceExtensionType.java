...
@XmlType(name = "", propOrder = {"abstractStandMarkingExtension", "abstractMarkingExtension"})
@Entity(name = "StandMarkingTimeSliceExtensionType")
@Table(name = "standmarking_te", schema = "airport_heliport")
public class StandMarkingTimeSliceExtensionType implements Serializable, Equals, HashCode, ToString {
    ...
    /**
     * Gets the value of the abstractStandMarkingExtension property.
     *
    ...
    @JoinColumn(name = "abstractstandmarkingextension_hjid", referencedColumnName = "hjid")
    public AbstractExtensionType getAbstractStandMarkingExtension() {
        return abstractStandMarkingExtension;
    }

    /**
     * Sets the value of the abstractStandMarkingExtension property.
     *
     * @param value
     *            allowed object is {@link AbstractExtensionType }
     *
     */
    public void setAbstractStandMarkingExtension(AbstractExtensionType value) {
        this.abstractStandMarkingExtension = value;
    }

    @Transient
    public boolean isSetAbstractStandMarkingExtension() {
        return (this.abstractStandMarkingExtension != null);
    }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final StandMarkingTimeSliceExtensionType that = ((StandMarkingTimeSliceExtensionType) object);
        {
            ...
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "abstractStandMarkingExtension",
                    lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "abstractStandMarkingExtension",
                    rhsField);
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetAbstractStandMarkingExtension();
            AbstractExtensionType theField;
            theField = this.getAbstractStandMarkingExtension();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "abstractStandMarkingExtension", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            AbstractExtensionType theField;
            theField = this.getAbstractStandMarkingExtension();
            strategy.appendField(locator, this, "abstractStandMarkingExtension", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetAbstractMarkingExtension();
            AbstractExtensionType theField;
