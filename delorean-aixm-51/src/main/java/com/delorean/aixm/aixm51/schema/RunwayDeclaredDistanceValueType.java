...
/**
 * <p>Java class for RunwayDeclaredDistanceValueType complex type</p>.
 * 
 ...
 *         <element name="distanceAccuracy" type="{http://www.aixm.aero/schema/5.1}ValDistanceType" minOccurs="0"/>
 ...
 *                   <element ref="{http://www.aixm.aero/schema/5.1}AbstractRunwayDeclaredDistanceValueExtension"/>
 *                 </choice>
    ...
    implements Serializable
{
    ...
    public void setDistanceItem(ValDistanceType target) {
        setDistance(XmlAdapterUtils.marshallJAXBElement(ValDistanceType.class, new QName("http://www.aixm.aero/schema/5.1", "distance"), RunwayDeclaredDistanceValueType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "distanceaccuracy", columnDefinition = "valdistancebase")),
        @AttributeOverride(name = "uom", column = @Column(name = "distanceaccuracyuom", columnDefinition = "uomdistance")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "distanceaccuracynilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setDistanceAccuracyItem(ValDistanceType target) {
        setDistanceAccuracy(XmlAdapterUtils.marshallJAXBElement(ValDistanceType.class, new QName("http://www.aixm.aero/schema/5.1", "distanceAccuracy"), RunwayDeclaredDistanceValueType.class, target));
    }
