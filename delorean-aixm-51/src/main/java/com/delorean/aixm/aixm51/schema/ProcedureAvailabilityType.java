...
/**
 * <p>Java class for ProcedureAvailabilityType complex type</p>.
 * 
 ...
 *         <element name="status" type="{http://www.aixm.aero/schema/5.1}CodeProcedureAvailabilityType" minOccurs="0"/>
    ...
    implements Serializable
{
    ...
    @JoinTable(name = "prcdravlblttp_tmintrvl_link", schema = "procedure", joinColumns = {
        @JoinColumn(name = "procedureavailability_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "status", columnDefinition = "codeprocedureavailabilitybase")),
    ...
    public void setStatusItem(CodeProcedureAvailabilityType target) {
        setStatus(XmlAdapterUtils.marshallJAXBElement(CodeProcedureAvailabilityType.class, new QName("http://www.aixm.aero/schema/5.1", "status"), ProcedureAvailabilityType.class, target));
    }
