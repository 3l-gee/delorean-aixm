 ...
 * generated in the com.delorean.aixm.aixm51.schema.message package. 
...
public class ObjectFactory {
    ...
    private static final QName _AIXMBasicMessage_QNAME = new QName("http://www.aixm.aero/schema/5.1/message", "AIXMBasicMessage");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.delorean.aixm.aixm51.schema.message
     * 
     */
