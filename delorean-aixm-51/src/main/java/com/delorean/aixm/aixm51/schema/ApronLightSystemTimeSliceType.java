...
"{http://www.aixm.aero/schema/5.1}CodeApronSectionType" minOccurs="0"/>
 *         <element name="lightedApron" type=
 ...
 *                 <choice>
 *                   <element ref=
"{http://www.aixm.aero/schema/5.1}AbstractApronLightSystemExtension"/>
 *                   <element ref=
...
public class ApronLightSystemTimeSliceType extends AbstractAIXMTimeSliceType implements Serializable {
    ...
    @JoinTable(name = "aprnlghtsstmtmslctp_elmnt_link", schema = "airport_heliport", joinColumns = {
            @JoinColumn(name = "apronlightsystem_t_hjid", referencedColumnName = "hjid")}, inverseJoinColumns = {
    ...
    public void setEmergencyLightingItem(CodeYesNoType target) {
        setEmergencyLighting(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class,
                new QName("http://www.aixm.aero/schema/5.1", "emergencyLighting"), ApronLightSystemTimeSliceType.class,
                target));
    }
    ...
    public void setIntensityLevelItem(CodeLightIntensityType target) {
        setIntensityLevel(XmlAdapterUtils.marshallJAXBElement(CodeLightIntensityType.class,
                new QName("http://www.aixm.aero/schema/5.1", "intensityLevel"), ApronLightSystemTimeSliceType.class,
                target));
    }
    ...
    public void setColourItem(CodeColourType target) {
        setColour(XmlAdapterUtils.marshallJAXBElement(CodeColourType.class,
                new QName("http://www.aixm.aero/schema/5.1", "colour"), ApronLightSystemTimeSliceType.class, target));
    }
    ...
    public void setPositionItem(CodeApronSectionType target) {
        setPosition(XmlAdapterUtils.marshallJAXBElement(CodeApronSectionType.class,
                new QName("http://www.aixm.aero/schema/5.1", "position"), ApronLightSystemTimeSliceType.class, target));
    }
    ...
    public void setLightedApronItem(ApronPropertyType target) {
        setLightedApron(XmlAdapterUtils.marshallJAXBElement(ApronPropertyType.class,
                new QName("http://www.aixm.aero/schema/5.1", "lightedApron"), ApronLightSystemTimeSliceType.class,
                target));
    }
