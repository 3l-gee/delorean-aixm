 ...
 *         <element name="position" type="{http://www.aixm.aero/schema/5.1}CodeApronSectionType" minOccurs="0"/>
 *         <element name="lightedApron" type="{http://www.aixm.aero/schema/5.1}ApronPropertyType" minOccurs="0"/>
...
@Table(name = "apronlightsystem_t", schema = "airport_heliport")
    ...
    implements Serializable
{
    ...
    protected List<ApronLightSystemTimeSliceExtensionType> extension;
    ...
    @JoinTable(name = "aprnlghtsstmtmslctp_elmnt_link", schema = "airport_heliport", joinColumns = {
        @JoinColumn(name = "apronlightsystem_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "aprnlghtsstmtmslctp_avlblt_link", schema = "airport_heliport", joinColumns = {
        @JoinColumn(name = "apronlightsystem_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "aprnlghtsstmtmslctp_annttn_link", schema = "airport_heliport", joinColumns = {
        @JoinColumn(name = "apronlightsystem_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link ApronLightSystemTimeSliceExtensionType }
     * 
     * 
     */
    @OneToMany(targetEntity = ApronLightSystemTimeSliceExtensionType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinColumn(name = "apronlightsystem_te_hjid", referencedColumnName = "hjid")
    public List<ApronLightSystemTimeSliceExtensionType> getExtension() {
        if (extension == null) {
     ...
     * 
     */
    public void setExtension(List<ApronLightSystemTimeSliceExtensionType> extension) {
    ...
    public void setEmergencyLightingItem(CodeYesNoType target) {
        setEmergencyLighting(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.1", "emergencyLighting"), ApronLightSystemTimeSliceType.class, target));
    }
    ...
    public void setIntensityLevelItem(CodeLightIntensityType target) {
        setIntensityLevel(XmlAdapterUtils.marshallJAXBElement(CodeLightIntensityType.class, new QName("http://www.aixm.aero/schema/5.1", "intensityLevel"), ApronLightSystemTimeSliceType.class, target));
    }
    ...
    public void setColourItem(CodeColourType target) {
        setColour(XmlAdapterUtils.marshallJAXBElement(CodeColourType.class, new QName("http://www.aixm.aero/schema/5.1", "colour"), ApronLightSystemTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "position", columnDefinition = "codeapronsectionbase")),
    ...
    public void setPositionItem(CodeApronSectionType target) {
        setPosition(XmlAdapterUtils.marshallJAXBElement(CodeApronSectionType.class, new QName("http://www.aixm.aero/schema/5.1", "position"), ApronLightSystemTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = ApronPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "aprnlghtsstmtmslctp_lghtdaprn_link", schema = "airport_heliport", joinColumns = {
        @JoinColumn(name = "apronlightsystem_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
        @JoinColumn(name = "lightedapron_hjid", referencedColumnName = "hjid")
    })
    ...
    public void setLightedApronItem(ApronPropertyType target) {
        setLightedApron(XmlAdapterUtils.marshallJAXBElement(ApronPropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "lightedApron"), ApronLightSystemTimeSliceType.class, target));
    }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        }
        {
            ...
            List<ApronLightSystemTimeSliceExtensionType> lhsField;
            lhsField = (this.isSetExtension()?this.getExtension():null);
            List<ApronLightSystemTimeSliceExtensionType> rhsField;
        ...
        {
            boolean lhsFieldIsSet = this.isSetLightedApron();
            boolean rhsFieldIsSet = that.isSetLightedApron();
            JAXBElement<ApronPropertyType> lhsField;
            lhsField = this.getLightedApron();
            JAXBElement<ApronPropertyType> rhsField;
            rhsField = that.getLightedApron();
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "lightedApron", lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "lightedApron", rhsField);
            if (!strategy.equals(lhsFieldLocator, rhsFieldLocator, lhsField, rhsField, lhsFieldIsSet, rhsFieldIsSet)) {
                return false;
            }
        }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        }
        {
            ...
            JAXBElement<CodeApronSectionType> theField;
            theField = this.getPosition();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "position", theField);
            currentHashCode = strategy.hashCode(theFieldLocator, currentHashCode, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetLightedApron();
            JAXBElement<ApronPropertyType> theField;
            theField = this.getLightedApron();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "lightedApron", theField);
            currentHashCode = strategy.hashCode(theFieldLocator, currentHashCode, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetExtension();
            List<ApronLightSystemTimeSliceExtensionType> theField;
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        }
        {
            ...
            JAXBElement<ApronPropertyType> theField;
            theField = this.getLightedApron();
            strategy.appendField(locator, this, "lightedApron", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetExtension();
            List<ApronLightSystemTimeSliceExtensionType> theField;
