...
@Entity(name = "ApproachConditionExtensionType")
@Table(name = "approachcondition_oe", schema = "procedure")
public class ApproachConditionExtensionType implements Serializable, Equals, HashCode, ToString {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final ApproachConditionExtensionType that = ((ApproachConditionExtensionType) object);
        {
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            AbstractExtensionType theField;
            theField = this.getAbstractApproachConditionExtension();
            strategy.appendField(locator, this, "abstractApproachConditionExtension", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetOwns();
            boolean theField;
