...
/**
 * <p>Java class for GroundLightingAvailabilityType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="GroundLightingAvailabilityType">
 *   <complexContent>
 ...
 *                   <element ref="{http://www.aixm.aero/schema/5.1}AbstractGroundLightingAvailabilityExtension"/>
 *                 </choice>
...
@XmlType(name = "GroundLightingAvailabilityType", propOrder = {
    "timeInterval",
    "annotation",
...
@Entity(name = "GroundLightingAvailabilityType")
@Table(name = "groundlightingavailability_o", schema = "airport_heliport")
    ...
    implements Serializable
{
    ...
    @JoinTable(name = "grndlghtngavlblttp_tmintrvl_link", schema = "airport_heliport", joinColumns = {
        @JoinColumn(name = "groundlightingavailability_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "grndlghtngavlblttp_annttn_link", schema = "airport_heliport", joinColumns = {
        @JoinColumn(name = "groundlightingavailability_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "grndlghtngavlblttp_spcldtathrt_link", schema = "airport_heliport", joinColumns = {
        @JoinColumn(name = "groundlightingavailability_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setOperationalStatusItem(CodeStatusOperationsType target) {
        setOperationalStatus(XmlAdapterUtils.marshallJAXBElement(CodeStatusOperationsType.class, new QName("http://www.aixm.aero/schema/5.1", "operationalStatus"), GroundLightingAvailabilityType.class, target));
    }
