 ...
 *         <element name="exceedLength" type="{http://www.aixm.aero/schema/5.1}ValDistanceType" minOccurs="0"/>
    ...
    implements Serializable
{
    ...
    public void setExceedLengthItem(ValDistanceType target) {
        setExceedLength(XmlAdapterUtils.marshallJAXBElement(ValDistanceType.class, new QName("http://www.aixm.aero/schema/5.1", "exceedLength"), DirectFlightClassType.class, target));
    }
