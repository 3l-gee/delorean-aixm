 ...
 *         <element name="type" type="{http://www.aixm.aero/schema/5.1}CodeGuidanceLineType" minOccurs="0"/>
 *         <element name="maxSpeed" type="{http://www.aixm.aero/schema/5.1}ValSpeedType" minOccurs="0"/>
 *         <element name="usageDirection" type="{http://www.aixm.aero/schema/5.1}CodeDirectionType" minOccurs="0"/>
 *         <element name="connectedTouchDownLiftOff" type="{http://www.aixm.aero/schema/5.1}TouchDownLiftOffPropertyType" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="connectedRunwayCentrelinePoint" type="{http://www.aixm.aero/schema/5.1}RunwayCentrelinePointPropertyType" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="connectedApron" type="{http://www.aixm.aero/schema/5.1}ApronPropertyType" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="connectedStand" type="{http://www.aixm.aero/schema/5.1}AircraftStandPropertyType" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="extent" type="{http://www.aixm.aero/schema/5.1}ElevatedCurvePropertyType" minOccurs="0"/>
 *         <element name="connectedTaxiway" type="{http://www.aixm.aero/schema/5.1}TaxiwayPropertyType" maxOccurs="unbounded" minOccurs="0"/>
    ...
    implements Serializable
{
    ...
    public void setDesignatorItem(TextNameType target) {
        setDesignator(XmlAdapterUtils.marshallJAXBElement(TextNameType.class, new QName("http://www.aixm.aero/schema/5.1", "designator"), GuidanceLineTimeSliceType.class, target));
    }
    ...
    public void setTypeItem(CodeGuidanceLineType target) {
        setType(XmlAdapterUtils.marshallJAXBElement(CodeGuidanceLineType.class, new QName("http://www.aixm.aero/schema/5.1", "type"), GuidanceLineTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "maxspeed", columnDefinition = "valspeedbase")),
        @AttributeOverride(name = "uom", column = @Column(name = "maxspeeduom", columnDefinition = "uomspeed")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "maxspeednilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setMaxSpeedItem(ValSpeedType target) {
        setMaxSpeed(XmlAdapterUtils.marshallJAXBElement(ValSpeedType.class, new QName("http://www.aixm.aero/schema/5.1", "maxSpeed"), GuidanceLineTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "usagedirection", columnDefinition = "codedirectionbase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "usagedirectionnilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setUsageDirectionItem(CodeDirectionType target) {
        setUsageDirection(XmlAdapterUtils.marshallJAXBElement(CodeDirectionType.class, new QName("http://www.aixm.aero/schema/5.1", "usageDirection"), GuidanceLineTimeSliceType.class, target));
    }
    ...
    public void setExtentItem(AIXMElevatedCurvePropertyType target) {
        setExtent(XmlAdapterUtils.marshallJAXBElement(AIXMElevatedCurvePropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "extent"), GuidanceLineTimeSliceType.class, target));
    }
