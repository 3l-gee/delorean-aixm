 ...
 *       <sequence>
 *         <element name="type" type="{http://www.aixm.aero/schema/5.1}CodeObstacleAreaType" minOccurs="0"/>
 *         <element name="obstructionIdSurfaceCondition" type="{http://www.aixm.aero/schema/5.1}CodeObstacleAssessmentSurfaceType" minOccurs="0"/>
 *         <choice>
 *           <element name="reference_ownerAirport" type="{http://www.aixm.aero/schema/5.1}AirportHeliportPropertyType" minOccurs="0"/>
 *           <element name="reference_ownerRunway" type="{http://www.aixm.aero/schema/5.1}RunwayDirectionPropertyType" minOccurs="0"/>
 *           <element name="reference_ownerOrganisation" type="{http://www.aixm.aero/schema/5.1}OrganisationAuthorityPropertyType" minOccurs="0"/>
 *         </choice>
 *         <element name="surfaceExtent" type="{http://www.aixm.aero/schema/5.1}SurfacePropertyType" minOccurs="0"/>
 *         <element name="obstacle" type="{http://www.aixm.aero/schema/5.1}VerticalStructurePropertyType" maxOccurs="unbounded" minOccurs="0"/>
    ...
    implements Serializable
{
    ...
    public void setTypeItem(CodeObstacleAreaType target) {
        setType(XmlAdapterUtils.marshallJAXBElement(CodeObstacleAreaType.class, new QName("http://www.aixm.aero/schema/5.1", "type"), ObstacleAreaTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "obstructionidsurfacecondition", columnDefinition = "codeobstacleassessmentsurfacebase")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "obstructionidsurfaceconditionnilreason", columnDefinition = "nilreason"))
    })
    ...
    public void setObstructionIdSurfaceConditionItem(CodeObstacleAssessmentSurfaceType target) {
        setObstructionIdSurfaceCondition(XmlAdapterUtils.marshallJAXBElement(CodeObstacleAssessmentSurfaceType.class, new QName("http://www.aixm.aero/schema/5.1", "obstructionIdSurfaceCondition"), ObstacleAreaTimeSliceType.class, target));
    }
    ...
    public void setReferenceOwnerAirportItem(AirportHeliportPropertyType target) {
        setReferenceOwnerAirport(XmlAdapterUtils.marshallJAXBElement(AirportHeliportPropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "reference_ownerAirport"), ObstacleAreaTimeSliceType.class, target));
    }
    ...
    public void setReferenceOwnerRunwayItem(RunwayDirectionPropertyType target) {
        setReferenceOwnerRunway(XmlAdapterUtils.marshallJAXBElement(RunwayDirectionPropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "reference_ownerRunway"), ObstacleAreaTimeSliceType.class, target));
    }
    ...
    public void setReferenceOwnerOrganisationItem(OrganisationAuthorityPropertyType target) {
        setReferenceOwnerOrganisation(XmlAdapterUtils.marshallJAXBElement(OrganisationAuthorityPropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "reference_ownerOrganisation"), ObstacleAreaTimeSliceType.class, target));
    }
    ...
    public void setSurfaceExtentItem(AIXMSurfacePropertyType target) {
        setSurfaceExtent(XmlAdapterUtils.marshallJAXBElement(AIXMSurfacePropertyType.class, new QName("http://www.aixm.aero/schema/5.1", "surfaceExtent"), ObstacleAreaTimeSliceType.class, target));
    }
