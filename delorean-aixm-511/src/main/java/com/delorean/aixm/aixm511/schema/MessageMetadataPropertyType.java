...
import com.delorean.aixm.aixm511.metadata.adapter.MDMetadataTypeAdapter;
...
/**
 * <p>
 * Java class for MessageMetadataPropertyType complex type
 * </p>
 * .
 *
 * <p>
...
@XmlType(name = "MessageMetadataPropertyType", propOrder = {"mdMetadata"})
@Entity(name = "MessageMetadataPropertyType")
@Table(name = "message_metadata", schema = "aixm")
public class MessageMetadataPropertyType extends AbstractMetadataPropertyType implements Serializable {
