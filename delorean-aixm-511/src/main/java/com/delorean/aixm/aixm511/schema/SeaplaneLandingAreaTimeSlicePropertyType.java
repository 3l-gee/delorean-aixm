...
/**
 * <p>
 * Java class for SeaplaneLandingAreaTimeSlicePropertyType complex type
 * </p>
 * .
 *
 * <p>
 ...
 *       <sequence>
 *         <element ref=
"{http://www.aixm.aero/schema/5.1.1}SeaplaneLandingAreaTimeSlice"/>
 *       </sequence>
 *       <attGroup ref=
...
@XmlType(name = "SeaplaneLandingAreaTimeSlicePropertyType", propOrder = {"seaplaneLandingAreaTimeSlice"})
...
public class SeaplaneLandingAreaTimeSlicePropertyType implements Serializable, Equals, HashCode, ToString {
     ...
     *
     * @return possible object is {@link SeaplaneLandingAreaTimeSliceType }
     *
     */
     ...
     *
     * @param value
     *            allowed object is {@link SeaplaneLandingAreaTimeSliceType }
     *
     */
    ...
    @Transient
    public boolean isSetSeaplaneLandingAreaTimeSlice() {
        return (this.seaplaneLandingAreaTimeSlice != null);
    }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        }
        {
            ...
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "seaplaneLandingAreaTimeSlice",
                    lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "seaplaneLandingAreaTimeSlice",
                    rhsField);
            if (!strategy.equals(lhsFieldLocator, rhsFieldLocator, lhsField, rhsField, lhsFieldIsSet, rhsFieldIsSet)) {
                return false;
            }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetSeaplaneLandingAreaTimeSlice();
            SeaplaneLandingAreaTimeSliceType theField;
            theField = this.getSeaplaneLandingAreaTimeSlice();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "seaplaneLandingAreaTimeSlice", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            SeaplaneLandingAreaTimeSliceType theField;
            theField = this.getSeaplaneLandingAreaTimeSlice();
            strategy.appendField(locator, this, "seaplaneLandingAreaTimeSlice", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetOwns();
            boolean theField;
