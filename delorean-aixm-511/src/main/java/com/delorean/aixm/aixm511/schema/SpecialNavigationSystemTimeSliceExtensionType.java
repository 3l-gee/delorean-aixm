...
@XmlType(name = "", propOrder = {"abstractSpecialNavigationSystemExtension"})
@Entity(name = "SpecialNavigationSystemTimeSliceExtensionType")
@Table(name = "specialnavigationsystem_te", schema = "navaids_point")
public class SpecialNavigationSystemTimeSliceExtensionType implements Serializable, Equals, HashCode, ToString {
    ...
    @JoinColumn(name = "abstractspecialnavigationsystemextension_hjid", referencedColumnName = "hjid")
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final SpecialNavigationSystemTimeSliceExtensionType that = ((SpecialNavigationSystemTimeSliceExtensionType) object);
        {
            ...
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator,
                    "abstractSpecialNavigationSystemExtension", lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator,
                    "abstractSpecialNavigationSystemExtension", rhsField);
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetAbstractSpecialNavigationSystemExtension();
            AbstractExtensionType theField;
            theField = this.getAbstractSpecialNavigationSystemExtension();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "abstractSpecialNavigationSystemExtension",
                    theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            AbstractExtensionType theField;
            theField = this.getAbstractSpecialNavigationSystemExtension();
            strategy.appendField(locator, this, "abstractSpecialNavigationSystemExtension", buffer, theField,
                    theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetOwns();
