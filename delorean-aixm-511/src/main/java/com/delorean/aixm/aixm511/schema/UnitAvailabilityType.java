    ...
    implements Serializable
{
    ...
    public void setOperationalStatusItem(CodeStatusOperationsType target) {
        setOperationalStatus(XmlAdapterUtils.marshallJAXBElement(CodeStatusOperationsType.class, new QName("http://www.aixm.aero/schema/5.1.1", "operationalStatus"), UnitAvailabilityType.class, target));
    }
