...
/**
 * <p>
 * Java class for ProcedureTransitionLegPropertyType complex type
 * </p>
 * .
 *
 * <p>
 ...
 *       <sequence>
 *         <element ref=
"{http://www.aixm.aero/schema/5.1.1}ProcedureTransitionLeg"/>
 *       </sequence>
 *     </extension>
 *   </complexContent>
 * </complexType>
...
@XmlType(name = "ProcedureTransitionLegPropertyType", propOrder = {"procedureTransitionLeg"})
@Entity(name = "ProcedureTransitionLegPropertyType")
@Table(name = "proceduretransitionleg_p", schema = "procedure")
public class ProcedureTransitionLegPropertyType extends AbstractAIXMPropertyType implements Serializable {
     ...
     *
     * @return possible object is {@link ProcedureTransitionLegType }
     *
     */
    @OneToOne(targetEntity = ProcedureTransitionLegType.class, cascade = {CascadeType.ALL}, fetch = FetchType.EAGER)
     ...
     *
     * @param value
     *            allowed object is {@link ProcedureTransitionLegType }
     *
     */
