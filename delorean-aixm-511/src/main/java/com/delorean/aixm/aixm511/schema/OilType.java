...
/**
 * <p>
 * Java class for OilType complex type
 * </p>
 * .
 *
 * <p>
...
"{http://www.aixm.aero/schema/5.1.1}CodeOilType" minOccurs="0"/>
 ...
 *                 <choice>
 *                   <element ref=
"{http://www.aixm.aero/schema/5.1.1}AbstractOilExtension"/>
 *                 </choice>
 *                 <attGroup ref=
...
@XmlType(name = "OilType", propOrder = {"category", "annotation", "extension"})
@Entity(name = "OilType")
@Table(name = "oil_o", schema = "service")
public class OilType extends AbstractAIXMObjectType implements Serializable {
     ...
     *
     * @return possible object is {@link JAXBElement }{@code <}{@link CodeOilType
     *         }{@code >}
     *
     */
    @Transient
     ...
     *
     * @param value
     *            allowed object is {@link JAXBElement }{@code <}{@link CodeOilType
     *            }{@code >}
     *
     */
    ...
    @JoinTable(name = "oltp_annttn_link", schema = "service", joinColumns = {
            @JoinColumn(name = "oil_o_hjid", referencedColumnName = "hjid")}, inverseJoinColumns = {
    ...
    public void setCategoryItem(CodeOilType target) {
        setCategory(XmlAdapterUtils.marshallJAXBElement(CodeOilType.class,
                new QName("http://www.aixm.aero/schema/5.1.1", "category"), OilType.class, target));
    }
