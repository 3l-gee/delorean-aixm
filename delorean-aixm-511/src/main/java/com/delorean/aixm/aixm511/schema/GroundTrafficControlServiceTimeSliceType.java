 ...
 *         <element name="type" type="{http://www.aixm.aero/schema/5.1.1}CodeServiceGroundControlType" minOccurs="0"/>
 *         <element name="clientAirport" type="{http://www.aixm.aero/schema/5.1.1}AirportHeliportPropertyType" minOccurs="0"/>
    ...
    implements Serializable
{
    ...
    public void setFlightOperationsItem(CodeFlightDestinationType target) {
        setFlightOperations(XmlAdapterUtils.marshallJAXBElement(CodeFlightDestinationType.class, new QName("http://www.aixm.aero/schema/5.1.1", "flightOperations"), GroundTrafficControlServiceTimeSliceType.class, target));
    }
    ...
    public void setRankItem(CodeFacilityRankingType target) {
        setRank(XmlAdapterUtils.marshallJAXBElement(CodeFacilityRankingType.class, new QName("http://www.aixm.aero/schema/5.1.1", "rank"), GroundTrafficControlServiceTimeSliceType.class, target));
    }
    ...
    public void setCompliantICAOItem(CodeYesNoType target) {
        setCompliantICAO(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.1.1", "compliantICAO"), GroundTrafficControlServiceTimeSliceType.class, target));
    }
    ...
    public void setAixmNameItem(TextNameType target) {
        setAixmName(XmlAdapterUtils.marshallJAXBElement(TextNameType.class, new QName("http://www.aixm.aero/schema/5.1.1", "name"), GroundTrafficControlServiceTimeSliceType.class, target));
    }
    ...
    public void setLocationItem(AIXMElevatedPointPropertyType target) {
        setLocation(XmlAdapterUtils.marshallJAXBElement(AIXMElevatedPointPropertyType.class, new QName("http://www.aixm.aero/schema/5.1.1", "location"), GroundTrafficControlServiceTimeSliceType.class, target));
    }
    ...
    public void setServiceProviderItem(UnitPropertyType target) {
        setServiceProvider(XmlAdapterUtils.marshallJAXBElement(UnitPropertyType.class, new QName("http://www.aixm.aero/schema/5.1.1", "serviceProvider"), GroundTrafficControlServiceTimeSliceType.class, target));
    }
    ...
    public void setRadarAssistedItem(CodeYesNoType target) {
        setRadarAssisted(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.1.1", "radarAssisted"), GroundTrafficControlServiceTimeSliceType.class, target));
    }
    ...
    public void setDataLinkEnabledItem(CodeYesNoType target) {
        setDataLinkEnabled(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.1.1", "dataLinkEnabled"), GroundTrafficControlServiceTimeSliceType.class, target));
    }
    ...
    public void setDataLinkChannelItem(CodeCommunicationChannelType target) {
        setDataLinkChannel(XmlAdapterUtils.marshallJAXBElement(CodeCommunicationChannelType.class, new QName("http://www.aixm.aero/schema/5.1.1", "dataLinkChannel"), GroundTrafficControlServiceTimeSliceType.class, target));
    }
    ...
    public void setTypeItem(CodeServiceGroundControlType target) {
        setType(XmlAdapterUtils.marshallJAXBElement(CodeServiceGroundControlType.class, new QName("http://www.aixm.aero/schema/5.1.1", "type"), GroundTrafficControlServiceTimeSliceType.class, target));
    }
    ...
    public void setClientAirportItem(AirportHeliportPropertyType target) {
        setClientAirport(XmlAdapterUtils.marshallJAXBElement(AirportHeliportPropertyType.class, new QName("http://www.aixm.aero/schema/5.1.1", "clientAirport"), GroundTrafficControlServiceTimeSliceType.class, target));
    }
