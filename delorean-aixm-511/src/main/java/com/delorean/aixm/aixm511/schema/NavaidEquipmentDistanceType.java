 ...
 *                 <choice>
 *                   <element ref=
"{http://www.aixm.aero/schema/5.1.1}AbstractNavaidEquipmentDistanceExtension"/>
 *                 </choice>
 *                 <attGroup ref=
...
public class NavaidEquipmentDistanceType extends AbstractAIXMObjectType implements Serializable {
    ...
    public void setDistanceItem(ValDistanceType target) {
        setDistance(XmlAdapterUtils.marshallJAXBElement(ValDistanceType.class,
                new QName("http://www.aixm.aero/schema/5.1.1", "distance"), NavaidEquipmentDistanceType.class, target));
    }
    ...
    public void setDistanceAccuracyItem(ValDistanceType target) {
        setDistanceAccuracy(XmlAdapterUtils.marshallJAXBElement(ValDistanceType.class,
                new QName("http://www.aixm.aero/schema/5.1.1", "distanceAccuracy"), NavaidEquipmentDistanceType.class,
                target));
    }
