 ...
 *         <element name="markedTaxiHold" type="{http://www.aixm.aero/schema/5.1.1}TaxiHoldingPositionPropertyType" minOccurs="0"/>
    ...
    implements Serializable
{
    ...
    public void setMarkingICAOStandardItem(CodeYesNoType target) {
        setMarkingICAOStandard(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.1.1", "markingICAOStandard"), TaxiHoldingPositionMarkingTimeSliceType.class, target));
    }
    ...
    public void setConditionItem(CodeMarkingConditionType target) {
        setCondition(XmlAdapterUtils.marshallJAXBElement(CodeMarkingConditionType.class, new QName("http://www.aixm.aero/schema/5.1.1", "condition"), TaxiHoldingPositionMarkingTimeSliceType.class, target));
    }
    ...
    public void setMarkedTaxiHoldItem(TaxiHoldingPositionPropertyType target) {
        setMarkedTaxiHold(XmlAdapterUtils.marshallJAXBElement(TaxiHoldingPositionPropertyType.class, new QName("http://www.aixm.aero/schema/5.1.1", "markedTaxiHold"), TaxiHoldingPositionMarkingTimeSliceType.class, target));
    }
