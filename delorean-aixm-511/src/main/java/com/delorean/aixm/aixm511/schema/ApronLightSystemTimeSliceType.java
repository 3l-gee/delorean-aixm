 ...
 *         <element name="position" type="{http://www.aixm.aero/schema/5.1.1}CodeApronSectionType" minOccurs="0"/>
 *         <element name="lightedApron" type="{http://www.aixm.aero/schema/5.1.1}ApronPropertyType" minOccurs="0"/>
