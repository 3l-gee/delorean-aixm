    ...
    implements Serializable
{
    ...
    @JoinTable(name = "intllgtmslctp_arcrftctgr_link", schema = "procedure", joinColumns = {
    ...
    @JoinTable(name = "intllgtmslctp_angl_link", schema = "procedure", joinColumns = {
        @JoinColumn(name = "initialleg_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "intllgtmslctp_dstnc_link", schema = "procedure", joinColumns = {
        @JoinColumn(name = "initialleg_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
