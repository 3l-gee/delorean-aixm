    ...
    implements Serializable
{
    ...
    @JoinTable(name = "mssdapprchlgtmslctp_arcrftctgr_l", schema = "procedure", joinColumns = {
    ...
    @JoinTable(name = "mssdapprchlgtmslctp_angl_l", schema = "procedure", joinColumns = {
        @JoinColumn(name = "missedapproachleg_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "mssdapprchlgtmslctp_dstnc_l", schema = "procedure", joinColumns = {
        @JoinColumn(name = "missedapproachleg_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
