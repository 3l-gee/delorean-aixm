 ...
 *   <simpleContent>
 *     <extension base="<http://www.aixm.aero/schema/5.1.1>DateTimeBaseType">
...
@Embeddable
public class DateTimeType implements Serializable, Equals, HashCode, ToString
{

    private static final long serialVersionUID = 20251104L;
 @jakarta.xml.bind.annotation.XmlValue @jakarta.xml.bind.annotation.adapters.XmlJavaTypeAdapter(com.delorean.aixm.core.time.adapter.XMLGregorianCalendarAdapter.class)
   protected
