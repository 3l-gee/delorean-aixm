...
import com.delorean.aixm.aixm511.xhtml.adapter.XHTMLTypeAdapter;
...
'http://www.w3.org/1999/xhtml' maxOccurs="unbounded"/>
 *       </sequence>
...
@XmlType(name = "XHTMLType", propOrder = {"any"})
@Embeddable
public class XHTMLType implements Serializable, Equals, HashCode, ToString {

    private static final long serialVersionUID = 20251104L;
    @XmlAnyElement
    @jakarta.xml.bind.annotation.adapters.XmlJavaTypeAdapter(XHTMLTypeAdapter.class)
    ...
    @Column(name = "ANY_ITEMS", length = 10485760)
    public String getAnyItems() {
        return this.any;
    }

    public void setAnyItems(String value) {
        this.any = value;
    }
