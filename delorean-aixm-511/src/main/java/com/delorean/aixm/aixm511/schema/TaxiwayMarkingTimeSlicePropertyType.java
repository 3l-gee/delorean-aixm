...
/**
 * <p>
 * Java class for TaxiwayMarkingTimeSlicePropertyType complex type
 * </p>
 * .
 *
 * <p>
 ...
 *       <sequence>
 *         <element ref=
"{http://www.aixm.aero/schema/5.1.1}TaxiwayMarkingTimeSlice"/>
 *       </sequence>
 *       <attGroup ref=
...
@XmlType(name = "TaxiwayMarkingTimeSlicePropertyType", propOrder = {"taxiwayMarkingTimeSlice"})
@FilterDef(name = "TPHjidFilter", parameters = {@ParamDef(name = "ids", type = Long.class)})
@Filter(name = "TPHjidFilter", condition = "hjid IN (:ids)")
@Entity(name = "TaxiwayMarkingTimeSlicePropertyType")
@Table(name = "taxiwaymarking_tp", schema = "airport_heliport")
public class TaxiwayMarkingTimeSlicePropertyType implements Serializable, Equals, HashCode, ToString {
     ...
     *
     * @return possible object is {@link TaxiwayMarkingTimeSliceType }
     *
     */
    @OneToOne(targetEntity = TaxiwayMarkingTimeSliceType.class, cascade = {CascadeType.ALL}, fetch = FetchType.EAGER)
    @JoinColumn(name = "taxiwaymarkingtimeslice_hjid", referencedColumnName = "hjid")
     ...
     *
     * @param value
     *            allowed object is {@link TaxiwayMarkingTimeSliceType }
     *
     */
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetTaxiwayMarkingTimeSlice();
            TaxiwayMarkingTimeSliceType theField;
            theField = this.getTaxiwayMarkingTimeSlice();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "taxiwayMarkingTimeSlice", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            TaxiwayMarkingTimeSliceType theField;
            theField = this.getTaxiwayMarkingTimeSlice();
            strategy.appendField(locator, this, "taxiwayMarkingTimeSlice", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetOwns();
            boolean theField;
