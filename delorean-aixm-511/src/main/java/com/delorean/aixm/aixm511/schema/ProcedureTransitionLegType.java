    ...
    implements Serializable
{
    ...
    public void setSeqNumberARINCItem(NoSequenceType target) {
        setSeqNumberARINC(XmlAdapterUtils.marshallJAXBElement(NoSequenceType.class, new QName("http://www.aixm.aero/schema/5.1.1", "seqNumberARINC"), ProcedureTransitionLegType.class, target));
    }
