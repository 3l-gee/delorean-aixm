...
@XmlType(name = "", propOrder = {"abstractUnitExtension"})
@Entity(name = "UnitTimeSliceExtensionType")
@Table(name = "unit_te", schema = "organisation")
public class UnitTimeSliceExtensionType implements Serializable, Equals, HashCode, ToString {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetAbstractUnitExtension();
            AbstractExtensionType theField;
            theField = this.getAbstractUnitExtension();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "abstractUnitExtension", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            AbstractExtensionType theField;
            theField = this.getAbstractUnitExtension();
            strategy.appendField(locator, this, "abstractUnitExtension", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetOwns();
            boolean theField;
