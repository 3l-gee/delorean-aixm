...
@XmlType(name = "", propOrder = {"abstractAerialRefuellingAnchorExtension"})
@Entity(name = "AerialRefuellingAnchorExtensionType")
@Table(name = "aerialrefuellinganchor_oe", schema = "aerial_refuelling")
public class AerialRefuellingAnchorExtensionType implements Serializable, Equals, HashCode, ToString {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final AerialRefuellingAnchorExtensionType that = ((AerialRefuellingAnchorExtensionType) object);
        {
        ...
        }
        {
            ...
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator,
                    "abstractAerialRefuellingAnchorExtension", lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator,
                    "abstractAerialRefuellingAnchorExtension", rhsField);
            if (!strategy.equals(lhsFieldLocator, rhsFieldLocator, lhsField, rhsField, lhsFieldIsSet, rhsFieldIsSet)) {
                return false;
            }
        }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetAbstractAerialRefuellingAnchorExtension();
            AbstractExtensionType theField;
            theField = this.getAbstractAerialRefuellingAnchorExtension();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "abstractAerialRefuellingAnchorExtension",
                    theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            AbstractExtensionType theField;
            theField = this.getAbstractAerialRefuellingAnchorExtension();
            strategy.appendField(locator, this, "abstractAerialRefuellingAnchorExtension", buffer, theField,
                    theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetOwns();
