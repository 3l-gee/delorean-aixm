    ...
    implements Serializable
{
    ...
    public void setTypeItem(CodeDeclaredDistanceType target) {
        setType(XmlAdapterUtils.marshallJAXBElement(CodeDeclaredDistanceType.class, new QName("http://www.aixm.aero/schema/5.1.1", "type"), RunwayDeclaredDistanceType.class, target));
    }
