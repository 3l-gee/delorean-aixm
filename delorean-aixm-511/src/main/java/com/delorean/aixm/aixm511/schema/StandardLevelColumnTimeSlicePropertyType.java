...
/**
 * <p>
 * Java class for StandardLevelColumnTimeSlicePropertyType complex type
 * </p>
 * .
 *
 * <p>
 ...
 *       <sequence>
 *         <element ref=
"{http://www.aixm.aero/schema/5.1.1}StandardLevelColumnTimeSlice"/>
 *       </sequence>
 *       <attGroup ref=
...
@XmlType(name = "StandardLevelColumnTimeSlicePropertyType", propOrder = {"standardLevelColumnTimeSlice"})
...
public class StandardLevelColumnTimeSlicePropertyType implements Serializable, Equals, HashCode, ToString {
    ...
    /**
     * Gets the value of the standardLevelColumnTimeSlice property.
     *
     * @return possible object is {@link StandardLevelColumnTimeSliceType }
     *
     */
    ...
    /**
     * Sets the value of the standardLevelColumnTimeSlice property.
     *
     * @param value
     *            allowed object is {@link StandardLevelColumnTimeSliceType }
     *
     */
    ...
    @Transient
    public boolean isSetStandardLevelColumnTimeSlice() {
        return (this.standardLevelColumnTimeSlice != null);
    }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        }
        {
            ...
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "standardLevelColumnTimeSlice",
                    lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "standardLevelColumnTimeSlice",
                    rhsField);
            if (!strategy.equals(lhsFieldLocator, rhsFieldLocator, lhsField, rhsField, lhsFieldIsSet, rhsFieldIsSet)) {
                return false;
            }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetStandardLevelColumnTimeSlice();
            StandardLevelColumnTimeSliceType theField;
            theField = this.getStandardLevelColumnTimeSlice();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "standardLevelColumnTimeSlice", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            StandardLevelColumnTimeSliceType theField;
            theField = this.getStandardLevelColumnTimeSlice();
            strategy.appendField(locator, this, "standardLevelColumnTimeSlice", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetOwns();
            boolean theField;
