 ...
 *       <sequence>
 *         <element ref=
"{http://www.aixm.aero/schema/5.1.1}AbstractRouteDMEExtension"/>
 *       </sequence>
 *       <attGroup ref=
...
@XmlType(name = "", propOrder = {"abstractRouteDMEExtension"})
@Entity(name = "RouteDMETimeSliceExtensionType")
@Table(name = "routedme_te", schema = "route")
public class RouteDMETimeSliceExtensionType implements Serializable, Equals, HashCode, ToString {
    ...
    @JoinColumn(name = "abstractroutedmeextension_hjid", referencedColumnName = "hjid")
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final RouteDMETimeSliceExtensionType that = ((RouteDMETimeSliceExtensionType) object);
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetAbstractRouteDMEExtension();
            AbstractExtensionType theField;
            theField = this.getAbstractRouteDMEExtension();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "abstractRouteDMEExtension", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            AbstractExtensionType theField;
            theField = this.getAbstractRouteDMEExtension();
            strategy.appendField(locator, this, "abstractRouteDMEExtension", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetOwns();
            boolean theField;
