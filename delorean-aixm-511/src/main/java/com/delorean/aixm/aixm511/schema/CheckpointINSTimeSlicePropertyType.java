...
/**
 * <p>
 * Java class for CheckpointINSTimeSlicePropertyType complex type
 * </p>
 * .
 *
 * <p>
 ...
 *       <sequence>
 *         <element ref=
"{http://www.aixm.aero/schema/5.1.1}CheckpointINSTimeSlice"/>
 *       </sequence>
 *       <attGroup ref=
...
@XmlType(name = "CheckpointINSTimeSlicePropertyType", propOrder = {"checkpointINSTimeSlice"})
...
public class CheckpointINSTimeSlicePropertyType implements Serializable, Equals, HashCode, ToString {
     ...
     *
     * @return possible object is {@link CheckpointINSTimeSliceType }
     *
     */
    @OneToOne(targetEntity = CheckpointINSTimeSliceType.class, cascade = {CascadeType.ALL}, fetch = FetchType.EAGER)
     ...
     *
     * @param value
     *            allowed object is {@link CheckpointINSTimeSliceType }
     *
     */
    ...
    @Transient
    public boolean isSetCheckpointINSTimeSlice() {
        return (this.checkpointINSTimeSlice != null);
    }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetCheckpointINSTimeSlice();
            CheckpointINSTimeSliceType theField;
            theField = this.getCheckpointINSTimeSlice();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "checkpointINSTimeSlice", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            CheckpointINSTimeSliceType theField;
            theField = this.getCheckpointINSTimeSlice();
            strategy.appendField(locator, this, "checkpointINSTimeSlice", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetOwns();
            boolean theField;
