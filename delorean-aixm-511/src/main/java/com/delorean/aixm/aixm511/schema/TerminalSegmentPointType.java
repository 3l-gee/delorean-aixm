 ...
 *         <element name="role" type="{http://www.aixm.aero/schema/5.1.1}CodeProcedureFixRoleType" minOccurs="0"/>
 *         <element name="leadRadial" type="{http://www.aixm.aero/schema/5.1.1}ValBearingType" minOccurs="0"/>
 *         <element name="leadDME" type="{http://www.aixm.aero/schema/5.1.1}ValDistanceType" minOccurs="0"/>
 *         <element name="indicatorFACF" type="{http://www.aixm.aero/schema/5.1.1}CodeYesNoType" minOccurs="0"/>
