...
@XmlType(name = "", propOrder = {"abstractNonMovementAreaExtension"})
@Entity(name = "NonMovementAreaTimeSliceExtensionType")
@Table(name = "nonmovementarea_te", schema = "airport_heliport")
public class NonMovementAreaTimeSliceExtensionType implements Serializable, Equals, HashCode, ToString {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final NonMovementAreaTimeSliceExtensionType that = ((NonMovementAreaTimeSliceExtensionType) object);
        {
            ...
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "abstractNonMovementAreaExtension",
                    lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "abstractNonMovementAreaExtension",
                    rhsField);
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetAbstractNonMovementAreaExtension();
            AbstractExtensionType theField;
            theField = this.getAbstractNonMovementAreaExtension();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "abstractNonMovementAreaExtension",
                    theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            AbstractExtensionType theField;
            theField = this.getAbstractNonMovementAreaExtension();
            strategy.appendField(locator, this, "abstractNonMovementAreaExtension", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetOwns();
            boolean theField;
