...
/**
 * <p>
 * Java class for FlightConditionCombinationPropertyType complex type
 * </p>
 * .
 *
 * <p>
 ...
 *       <sequence>
 *         <element ref=
"{http://www.aixm.aero/schema/5.1.1}FlightConditionCombination"/>
 *       </sequence>
 *     </extension>
 *   </complexContent>
 * </complexType>
...
@XmlType(name = "FlightConditionCombinationPropertyType", propOrder = {"flightConditionCombination"})
@Entity(name = "FlightConditionCombinationPropertyType")
@Table(name = "flightconditioncombination_p", schema = "route")
public class FlightConditionCombinationPropertyType extends AbstractAIXMPropertyType implements Serializable {
     ...
     *
     * @return possible object is {@link FlightConditionCombinationType }
     *
     */
    @OneToOne(targetEntity = FlightConditionCombinationType.class, cascade = {CascadeType.ALL}, fetch = FetchType.EAGER)
    @JoinColumn(name = "flightconditioncombination_hjid", referencedColumnName = "hjid")
     ...
     *
     * @param value
     *            allowed object is {@link FlightConditionCombinationType }
     *
     */
