...
@XmlType(name = "", propOrder = {"abstractFlightConditionElementExtension"})
@Entity(name = "FlightConditionElementExtensionType")
@Table(name = "flightconditionelement_oe", schema = "route")
public class FlightConditionElementExtensionType implements Serializable, Equals, HashCode, ToString {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final FlightConditionElementExtensionType that = ((FlightConditionElementExtensionType) object);
        {
            ...
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator,
                    "abstractFlightConditionElementExtension", lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator,
                    "abstractFlightConditionElementExtension", rhsField);
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetAbstractFlightConditionElementExtension();
            AbstractExtensionType theField;
            theField = this.getAbstractFlightConditionElementExtension();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "abstractFlightConditionElementExtension",
                    theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            AbstractExtensionType theField;
            theField = this.getAbstractFlightConditionElementExtension();
            strategy.appendField(locator, this, "abstractFlightConditionElementExtension", buffer, theField,
                    theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetOwns();
