 ...
 *       <sequence>
 *         <element name="type" type="{http://www.aixm.aero/schema/5.1.1}CodeReflectorType" minOccurs="0"/>
 *         <element name="touchdownReflector" type="{http://www.aixm.aero/schema/5.1.1}ElevatedPointPropertyType" minOccurs="0"/>
    ...
    implements Serializable
{
    ...
    public void setTouchdownReflectorItem(AIXMElevatedPointPropertyType target) {
        setTouchdownReflector(XmlAdapterUtils.marshallJAXBElement(AIXMElevatedPointPropertyType.class, new QName("http://www.aixm.aero/schema/5.1.1", "touchdownReflector"), ReflectorType.class, target));
    }
