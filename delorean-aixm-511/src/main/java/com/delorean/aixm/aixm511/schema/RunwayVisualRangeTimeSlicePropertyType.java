...
/**
 * <p>
 * Java class for RunwayVisualRangeTimeSlicePropertyType complex type
 * </p>
 * .
 *
 * <p>
 ...
 *       <sequence>
 *         <element ref=
"{http://www.aixm.aero/schema/5.1.1}RunwayVisualRangeTimeSlice"/>
 *       </sequence>
 *       <attGroup ref=
...
@XmlType(name = "RunwayVisualRangeTimeSlicePropertyType", propOrder = {"runwayVisualRangeTimeSlice"})
...
public class RunwayVisualRangeTimeSlicePropertyType implements Serializable, Equals, HashCode, ToString {
    ...
    /**
     * Gets the value of the runwayVisualRangeTimeSlice property.
     *
     * @return possible object is {@link RunwayVisualRangeTimeSliceType }
     *
     */
    @OneToOne(targetEntity = RunwayVisualRangeTimeSliceType.class, cascade = {CascadeType.ALL}, fetch = FetchType.EAGER)
    ...
    /**
     * Sets the value of the runwayVisualRangeTimeSlice property.
     *
     * @param value
     *            allowed object is {@link RunwayVisualRangeTimeSliceType }
     *
     */
    ...
    @Transient
    public boolean isSetRunwayVisualRangeTimeSlice() {
        return (this.runwayVisualRangeTimeSlice != null);
    }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final RunwayVisualRangeTimeSlicePropertyType that = ((RunwayVisualRangeTimeSlicePropertyType) object);
        {
            ...
            lhsField = this.getRunwayVisualRangeTimeSlice();
            RunwayVisualRangeTimeSliceType rhsField;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetRunwayVisualRangeTimeSlice();
            RunwayVisualRangeTimeSliceType theField;
            theField = this.getRunwayVisualRangeTimeSlice();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "runwayVisualRangeTimeSlice", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            RunwayVisualRangeTimeSliceType theField;
            theField = this.getRunwayVisualRangeTimeSlice();
            strategy.appendField(locator, this, "runwayVisualRangeTimeSlice", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetOwns();
            boolean theField;
