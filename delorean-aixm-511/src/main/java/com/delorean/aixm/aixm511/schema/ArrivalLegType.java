...
/**
 * <p>
 * Java class for ArrivalLegType complex type
 * </p>
 * .
 *
 * <p>
...
"{http://www.aixm.aero/schema/5.1.1}ArrivalLegTimeSlicePropertyType" maxOccurs=
"unbounded"/>
 *       </sequence>
 *     </extension>
 *   </complexContent>
...
@XmlType(name = "ArrivalLegType", propOrder = {"timeSlice"})
@Entity(name = "ArrivalLegType")
@Table(name = "arrivalleg_f", schema = "procedure")
public class ArrivalLegType extends AbstractSegmentLegType implements Serializable {
    ...
    @OneToMany(targetEntity = ArrivalLegTimeSlicePropertyType.class, cascade = {
