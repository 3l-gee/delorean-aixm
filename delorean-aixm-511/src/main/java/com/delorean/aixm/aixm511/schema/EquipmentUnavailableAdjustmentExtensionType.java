 ...
 *       <choice>
 *         <element ref=
"{http://www.aixm.aero/schema/5.1.1}AbstractEquipmentUnavailableAdjustmentExtension"/>
 *       </choice>
 *       <attGroup ref=
...
@XmlType(name = "", propOrder = {"abstractEquipmentUnavailableAdjustmentExtension"})
@Entity(name = "EquipmentUnavailableAdjustmentExtensionType")
@Table(name = "equipmentunavailableadjustment_oe", schema = "procedure")
public class EquipmentUnavailableAdjustmentExtensionType implements Serializable, Equals, HashCode, ToString {
    ...
    /**
     * Gets the value of the abstractEquipmentUnavailableAdjustmentExtension
     * property.
     *
    ...
    /**
     * Sets the value of the abstractEquipmentUnavailableAdjustmentExtension
     * property.
     *
     * @param value
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final EquipmentUnavailableAdjustmentExtensionType that = ((EquipmentUnavailableAdjustmentExtensionType) object);
        {
            ...
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator,
                    "abstractEquipmentUnavailableAdjustmentExtension", lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator,
                    "abstractEquipmentUnavailableAdjustmentExtension", rhsField);
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetAbstractEquipmentUnavailableAdjustmentExtension();
            AbstractExtensionType theField;
            theField = this.getAbstractEquipmentUnavailableAdjustmentExtension();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator,
                    "abstractEquipmentUnavailableAdjustmentExtension", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            AbstractExtensionType theField;
            theField = this.getAbstractEquipmentUnavailableAdjustmentExtension();
            strategy.appendField(locator, this, "abstractEquipmentUnavailableAdjustmentExtension", buffer, theField,
                    theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetOwns();
