...
/**
 * <p>
 * Java class for GuidanceLineMarkingType complex type
 * </p>
 * .
 *
 * <p>
 ...
 *
 * <pre>{@code
 * <complexType name="GuidanceLineMarkingType">
 *   <complexContent>
 *     <extension base="{http://www.aixm.aero/schema/5.1.1}AbstractMarkingType">
 *       <sequence>
 *         <element name="timeSlice" type=
"{http://www.aixm.aero/schema/5.1.1}GuidanceLineMarkingTimeSlicePropertyType" maxOccurs
="unbounded"/>
 *       </sequence>
 *     </extension>
 *   </complexContent>
...
@XmlType(name = "GuidanceLineMarkingType", propOrder = {"timeSlice"})
@Entity(name = "GuidanceLineMarkingType")
@Table(name = "guidancelinemarking_f", schema = "airport_heliport")
public class GuidanceLineMarkingType extends AbstractMarkingType implements Serializable {
     ...
     * {@link GuidanceLineMarkingTimeSlicePropertyType }
     *
     *
     */
     ...
     *
     */
    public void setTimeSlice(List<GuidanceLineMarkingTimeSlicePropertyType> timeSlice) {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final GuidanceLineMarkingType that = ((GuidanceLineMarkingType) object);
        {
            boolean lhsFieldIsSet = this.isSetTimeSlice();
            boolean rhsFieldIsSet = that.isSetTimeSlice();
            List<GuidanceLineMarkingTimeSlicePropertyType> lhsField;
            lhsField = (this.isSetTimeSlice() ? this.getTimeSlice() : null);
            List<GuidanceLineMarkingTimeSlicePropertyType> rhsField;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = super.hashCode(locator, strategy);
        {
            ...
            List<GuidanceLineMarkingTimeSlicePropertyType> theField;
