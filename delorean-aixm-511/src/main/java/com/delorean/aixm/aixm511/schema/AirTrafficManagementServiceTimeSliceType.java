 ...
 *         <element name="type" type="{http://www.aixm.aero/schema/5.1.1}CodeServiceATFMType" minOccurs="0"/>
...
@Entity(name = "AirTrafficManagementServiceTimeSliceType")
@Table(name = "airtrafficmanagementservice_t", schema = "service")
    ...
    implements Serializable
{
    ...
    protected List<AirTrafficManagementServiceTimeSliceExtensionType> extension;
    ...
    @JoinTable(name = "artrffcmngmntsrvctmslctp_cll-sgn_link", schema = "service", joinColumns = {
        @JoinColumn(name = "airtrafficmanagementservice_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "artrffcmngmntsrvctmslctp_rdcmmnctn_link", schema = "service", joinColumns = {
        @JoinColumn(name = "airtrafficmanagementservice_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "artrffcmngmntsrvctmslctp_grndcmmnctn_link", schema = "service", joinColumns = {
        @JoinColumn(name = "airtrafficmanagementservice_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "artrffcmngmntsrvctmslctp_avlblt_link", schema = "service", joinColumns = {
        @JoinColumn(name = "airtrafficmanagementservice_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "artrffcmngmntsrvctmslctp_annttn_link", schema = "service", joinColumns = {
        @JoinColumn(name = "airtrafficmanagementservice_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "artrffcmngmntsrvctmslctp_clntarspc_link", schema = "service", joinColumns = {
        @JoinColumn(name = "airtrafficmanagementservice_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "artrffcmngmntsrvctmslctp_clntarlrfllng_link", schema = "service", joinColumns = {
        @JoinColumn(name = "airtrafficmanagementservice_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "artrffcmngmntsrvctmslctp_clntrt_link", schema = "service", joinColumns = {
        @JoinColumn(name = "airtrafficmanagementservice_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
     ...
     * 
     */
    @OneToMany(targetEntity = AirTrafficManagementServiceTimeSliceExtensionType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinColumn(name = "airtrafficmanagementservice_te_hjid", referencedColumnName = "hjid")
    public List<AirTrafficManagementServiceTimeSliceExtensionType> getExtension() {
        if (extension == null) {
     ...
     * 
     */
    public void setExtension(List<AirTrafficManagementServiceTimeSliceExtensionType> extension) {
    ...
    public void setFlightOperationsItem(CodeFlightDestinationType target) {
        setFlightOperations(XmlAdapterUtils.marshallJAXBElement(CodeFlightDestinationType.class, new QName("http://www.aixm.aero/schema/5.1.1", "flightOperations"), AirTrafficManagementServiceTimeSliceType.class, target));
    }
    ...
    public void setRankItem(CodeFacilityRankingType target) {
        setRank(XmlAdapterUtils.marshallJAXBElement(CodeFacilityRankingType.class, new QName("http://www.aixm.aero/schema/5.1.1", "rank"), AirTrafficManagementServiceTimeSliceType.class, target));
    }
    ...
    public void setCompliantICAOItem(CodeYesNoType target) {
        setCompliantICAO(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.1.1", "compliantICAO"), AirTrafficManagementServiceTimeSliceType.class, target));
    }
    ...
    public void setAixmNameItem(TextNameType target) {
        setAixmName(XmlAdapterUtils.marshallJAXBElement(TextNameType.class, new QName("http://www.aixm.aero/schema/5.1.1", "name"), AirTrafficManagementServiceTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = AIXMElevatedPointPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "artrffcmngmntsrvctmslctp_lctn_link", schema = "service", joinColumns = {
        @JoinColumn(name = "airtrafficmanagementservice_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setLocationItem(AIXMElevatedPointPropertyType target) {
        setLocation(XmlAdapterUtils.marshallJAXBElement(AIXMElevatedPointPropertyType.class, new QName("http://www.aixm.aero/schema/5.1.1", "location"), AirTrafficManagementServiceTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = UnitPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "artrffcmngmntsrvctmslctp_srvcprvdr_link", schema = "service", joinColumns = {
        @JoinColumn(name = "airtrafficmanagementservice_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setServiceProviderItem(UnitPropertyType target) {
        setServiceProvider(XmlAdapterUtils.marshallJAXBElement(UnitPropertyType.class, new QName("http://www.aixm.aero/schema/5.1.1", "serviceProvider"), AirTrafficManagementServiceTimeSliceType.class, target));
    }
    ...
    public void setTypeItem(CodeServiceATFMType target) {
        setType(XmlAdapterUtils.marshallJAXBElement(CodeServiceATFMType.class, new QName("http://www.aixm.aero/schema/5.1.1", "type"), AirTrafficManagementServiceTimeSliceType.class, target));
    }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        final AirTrafficManagementServiceTimeSliceType that = ((AirTrafficManagementServiceTimeSliceType) object);
        {
        ...
        }
        {
            ...
            List<AirTrafficManagementServiceTimeSliceExtensionType> lhsField;
            lhsField = (this.isSetExtension()?this.getExtension():null);
            List<AirTrafficManagementServiceTimeSliceExtensionType> rhsField;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        }
        {
            ...
            List<AirTrafficManagementServiceTimeSliceExtensionType> theField;
