...
/**
 * <p>
 * Java class for RouteSegmentTimeSlicePropertyType complex type
 * </p>
 * .
 *
 * <p>
 ...
 *       <sequence>
 *         <element ref=
"{http://www.aixm.aero/schema/5.1.1}RouteSegmentTimeSlice"/>
 *       </sequence>
 *       <attGroup ref=
...
@XmlType(name = "RouteSegmentTimeSlicePropertyType", propOrder = {"routeSegmentTimeSlice"})
@FilterDef(name = "TPHjidFilter", parameters = {@ParamDef(name = "ids", type = Long.class)})
@Filter(name = "TPHjidFilter", condition = "hjid IN (:ids)")
@Entity(name = "RouteSegmentTimeSlicePropertyType")
@Table(name = "routesegment_tp", schema = "route")
public class RouteSegmentTimeSlicePropertyType implements Serializable, Equals, HashCode, ToString {
     ...
     *
     * @return possible object is {@link RouteSegmentTimeSliceType }
     *
     */
    @OneToOne(targetEntity = RouteSegmentTimeSliceType.class, cascade = {CascadeType.ALL}, fetch = FetchType.EAGER)
    @JoinColumn(name = "routesegmenttimeslice_hjid", referencedColumnName = "hjid")
     ...
     *
     * @param value
     *            allowed object is {@link RouteSegmentTimeSliceType }
     *
     */
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetRouteSegmentTimeSlice();
            RouteSegmentTimeSliceType theField;
            theField = this.getRouteSegmentTimeSlice();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "routeSegmentTimeSlice", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            RouteSegmentTimeSliceType theField;
            theField = this.getRouteSegmentTimeSlice();
            strategy.appendField(locator, this, "routeSegmentTimeSlice", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetOwns();
            boolean theField;
