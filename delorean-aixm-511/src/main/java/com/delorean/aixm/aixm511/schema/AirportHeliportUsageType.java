    ...
    implements Serializable
{
    ...
    public void setTypeItem(CodeUsageLimitationType target) {
        setType(XmlAdapterUtils.marshallJAXBElement(CodeUsageLimitationType.class, new QName("http://www.aixm.aero/schema/5.1.1", "type"), AirportHeliportUsageType.class, target));
    }
    ...
    public void setSelectionItem(ConditionCombinationPropertyType target) {
        setSelection(XmlAdapterUtils.marshallJAXBElement(ConditionCombinationPropertyType.class, new QName("http://www.aixm.aero/schema/5.1.1", "selection"), AirportHeliportUsageType.class, target));
    }
    ...
    public void setOperationItem(CodeOperationAirportHeliportType target) {
        setOperation(XmlAdapterUtils.marshallJAXBElement(CodeOperationAirportHeliportType.class, new QName("http://www.aixm.aero/schema/5.1.1", "operation"), AirportHeliportUsageType.class, target));
    }
