 ...
 *       <sequence>
 *         <element ref=
"{http://www.aixm.aero/schema/5.1.1}AbstractFlightRestrictionExtension"/>
 *       </sequence>
 *       <attGroup ref=
...
@XmlType(name = "", propOrder = {"abstractFlightRestrictionExtension"})
@Entity(name = "FlightRestrictionTimeSliceExtensionType")
@Table(name = "flightrestriction_te", schema = "route")
public class FlightRestrictionTimeSliceExtensionType implements Serializable, Equals, HashCode, ToString {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final FlightRestrictionTimeSliceExtensionType that = ((FlightRestrictionTimeSliceExtensionType) object);
        {
            ...
            lhsField = this.getAbstractFlightRestrictionExtension();
            AbstractExtensionType rhsField;
            rhsField = that.getAbstractFlightRestrictionExtension();
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "abstractFlightRestrictionExtension",
                    lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "abstractFlightRestrictionExtension",
                    rhsField);
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetAbstractFlightRestrictionExtension();
            AbstractExtensionType theField;
            theField = this.getAbstractFlightRestrictionExtension();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "abstractFlightRestrictionExtension",
                    theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            AbstractExtensionType theField;
            theField = this.getAbstractFlightRestrictionExtension();
            strategy.appendField(locator, this, "abstractFlightRestrictionExtension", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetOwns();
            boolean theField;
