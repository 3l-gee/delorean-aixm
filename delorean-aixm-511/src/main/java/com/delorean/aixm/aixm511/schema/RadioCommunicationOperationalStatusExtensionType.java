...
public class RadioCommunicationOperationalStatusExtensionType implements Serializable, Equals, HashCode, ToString
{
    ...
    /**
     * Gets the value of the abstractRadioCommunicationOperationalStatusExtension property.
     * 
     * @return
     *     possible object is
     *     {@link AbstractExtensionType }
    ...
    /**
     * Sets the value of the abstractRadioCommunicationOperationalStatusExtension property.
     * 
     * @param value
     *     allowed object is
     *     {@link AbstractExtensionType }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        }
        {
            ...
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "abstractRadioCommunicationOperationalStatusExtension", theField);
            currentHashCode = strategy.hashCode(theFieldLocator, currentHashCode, theField, theFieldIsSet);
        }
        {
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        }
        {
            ...
            AbstractExtensionType theField;
            theField = this.getAbstractRadioCommunicationOperationalStatusExtension();
            strategy.appendField(locator, this, "abstractRadioCommunicationOperationalStatusExtension", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetOwns();
            boolean theField;
