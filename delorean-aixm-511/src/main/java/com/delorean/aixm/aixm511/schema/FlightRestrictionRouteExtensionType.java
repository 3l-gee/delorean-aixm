...
@XmlType(name = "", propOrder = {"abstractFlightRestrictionRouteExtension"})
@Entity(name = "FlightRestrictionRouteExtensionType")
@Table(name = "flightrestrictionroute_oe", schema = "route")
public class FlightRestrictionRouteExtensionType implements Serializable, Equals, HashCode, ToString {
    ...
    @JoinColumn(name = "abstractflightrestrictionrouteextension_hjid", referencedColumnName = "hjid")
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final FlightRestrictionRouteExtensionType that = ((FlightRestrictionRouteExtensionType) object);
        {
        ...
        }
        {
            ...
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator,
                    "abstractFlightRestrictionRouteExtension", lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator,
                    "abstractFlightRestrictionRouteExtension", rhsField);
            if (!strategy.equals(lhsFieldLocator, rhsFieldLocator, lhsField, rhsField, lhsFieldIsSet, rhsFieldIsSet)) {
                return false;
            }
        }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetAbstractFlightRestrictionRouteExtension();
            AbstractExtensionType theField;
            theField = this.getAbstractFlightRestrictionRouteExtension();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "abstractFlightRestrictionRouteExtension",
                    theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            AbstractExtensionType theField;
            theField = this.getAbstractFlightRestrictionRouteExtension();
            strategy.appendField(locator, this, "abstractFlightRestrictionRouteExtension", buffer, theField,
                    theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetOwns();
