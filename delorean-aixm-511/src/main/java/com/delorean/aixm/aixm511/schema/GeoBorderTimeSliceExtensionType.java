...
@XmlType(name = "", propOrder = {"abstractGeoBorderExtension"})
@Entity(name = "GeoBorderTimeSliceExtensionType")
@Table(name = "geoborder_te", schema = "airspace")
public class GeoBorderTimeSliceExtensionType implements Serializable, Equals, HashCode, ToString {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetAbstractGeoBorderExtension();
            AbstractExtensionType theField;
            theField = this.getAbstractGeoBorderExtension();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "abstractGeoBorderExtension", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            AbstractExtensionType theField;
            theField = this.getAbstractGeoBorderExtension();
            strategy.appendField(locator, this, "abstractGeoBorderExtension", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetOwns();
            boolean theField;
