 ...
 *       <sequence>
 *         <element name="type" type="{http://www.aixm.aero/schema/5.1.1}CodeUnitDependencyType" minOccurs="0"/>
    ...
    implements Serializable
{
    ...
    public void setTypeItem(CodeUnitDependencyType target) {
        setType(XmlAdapterUtils.marshallJAXBElement(CodeUnitDependencyType.class, new QName("http://www.aixm.aero/schema/5.1.1", "type"), UnitDependencyType.class, target));
    }
