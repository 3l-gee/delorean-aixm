 ...
 *         <element name="position" type="{http://www.aixm.aero/schema/5.1.1}CodeTaxiwaySectionType" minOccurs="0"/>
 *         <element name="lightedTaxiway" type="{http://www.aixm.aero/schema/5.1.1}TaxiwayPropertyType" minOccurs="0"/>
