...
/**
 * <p>Java class for ArrivalLegTimeSlicePropertyType complex type</p>.
 * 
 ...
 *       <sequence>
 *         <element ref="{http://www.aixm.aero/schema/5.1.1}ArrivalLegTimeSlice"/>
 *       </sequence>
...
public class ArrivalLegTimeSlicePropertyType implements Serializable, Equals, HashCode, ToString
{
     ...
     *     
     */
    @OneToOne(targetEntity = ArrivalLegTimeSliceType.class, cascade = {
        CascadeType.ALL
