...
@XmlType(name = "", propOrder = {"abstractApproachAltitudeTableExtension"})
@Entity(name = "ApproachAltitudeTableExtensionType")
@Table(name = "approachaltitudetable_oe", schema = "procedure")
public class ApproachAltitudeTableExtensionType implements Serializable, Equals, HashCode, ToString {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final ApproachAltitudeTableExtensionType that = ((ApproachAltitudeTableExtensionType) object);
        {
        ...
        }
        {
            ...
            lhsField = this.getAbstractApproachAltitudeTableExtension();
            AbstractExtensionType rhsField;
            rhsField = that.getAbstractApproachAltitudeTableExtension();
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "abstractApproachAltitudeTableExtension",
                    lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "abstractApproachAltitudeTableExtension",
                    rhsField);
            if (!strategy.equals(lhsFieldLocator, rhsFieldLocator, lhsField, rhsField, lhsFieldIsSet, rhsFieldIsSet)) {
                return false;
            }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetAbstractApproachAltitudeTableExtension();
            AbstractExtensionType theField;
            theField = this.getAbstractApproachAltitudeTableExtension();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "abstractApproachAltitudeTableExtension",
                    theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            AbstractExtensionType theField;
            theField = this.getAbstractApproachAltitudeTableExtension();
            strategy.appendField(locator, this, "abstractApproachAltitudeTableExtension", buffer, theField,
                    theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetOwns();
