 ...
 *         <element name="category" type="{http://www.aixm.aero/schema/5.1.1}CodeFireFightingType" minOccurs="0"/>
 *         <element name="standard" type="{http://www.aixm.aero/schema/5.1.1}CodeAviationStandardsType" minOccurs="0"/>
    ...
    implements Serializable
{
    ...
    public void setFlightOperationsItem(CodeFlightDestinationType target) {
        setFlightOperations(XmlAdapterUtils.marshallJAXBElement(CodeFlightDestinationType.class, new QName("http://www.aixm.aero/schema/5.1.1", "flightOperations"), FireFightingServiceTimeSliceType.class, target));
    }
    ...
    public void setRankItem(CodeFacilityRankingType target) {
        setRank(XmlAdapterUtils.marshallJAXBElement(CodeFacilityRankingType.class, new QName("http://www.aixm.aero/schema/5.1.1", "rank"), FireFightingServiceTimeSliceType.class, target));
    }
    ...
    public void setCompliantICAOItem(CodeYesNoType target) {
        setCompliantICAO(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.1.1", "compliantICAO"), FireFightingServiceTimeSliceType.class, target));
    }
    ...
    public void setAixmNameItem(TextNameType target) {
        setAixmName(XmlAdapterUtils.marshallJAXBElement(TextNameType.class, new QName("http://www.aixm.aero/schema/5.1.1", "name"), FireFightingServiceTimeSliceType.class, target));
    }
    ...
    public void setLocationItem(AIXMElevatedPointPropertyType target) {
        setLocation(XmlAdapterUtils.marshallJAXBElement(AIXMElevatedPointPropertyType.class, new QName("http://www.aixm.aero/schema/5.1.1", "location"), FireFightingServiceTimeSliceType.class, target));
    }
    ...
    public void setServiceProviderItem(UnitPropertyType target) {
        setServiceProvider(XmlAdapterUtils.marshallJAXBElement(UnitPropertyType.class, new QName("http://www.aixm.aero/schema/5.1.1", "serviceProvider"), FireFightingServiceTimeSliceType.class, target));
    }
    ...
    public void setCategoryItem(CodeFireFightingType target) {
        setCategory(XmlAdapterUtils.marshallJAXBElement(CodeFireFightingType.class, new QName("http://www.aixm.aero/schema/5.1.1", "category"), FireFightingServiceTimeSliceType.class, target));
    }
    ...
    public void setStandardItem(CodeAviationStandardsType target) {
        setStandard(XmlAdapterUtils.marshallJAXBElement(CodeAviationStandardsType.class, new QName("http://www.aixm.aero/schema/5.1.1", "standard"), FireFightingServiceTimeSliceType.class, target));
    }
