 ...
 *         <element name="type" type="{http://www.aixm.aero/schema/5.1.1}CodeServiceInformationType" minOccurs="0"/>
 *         <element name="voice" type="{http://www.aixm.aero/schema/5.1.1}CodeYesNoType" minOccurs="0"/>
 *         <element name="dataLink" type="{http://www.aixm.aero/schema/5.1.1}CodeYesNoType" minOccurs="0"/>
 *         <element name="recorded" type="{http://www.aixm.aero/schema/5.1.1}CodeYesNoType" minOccurs="0"/>
 *         <element name="navaidBroadcast" type="{http://www.aixm.aero/schema/5.1.1}VORPropertyType" maxOccurs="unbounded" minOccurs="0"/>
