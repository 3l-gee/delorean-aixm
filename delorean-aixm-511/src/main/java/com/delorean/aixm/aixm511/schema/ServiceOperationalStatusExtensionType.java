...
@Entity(name = "ServiceOperationalStatusExtensionType")
@Table(name = "serviceoperationalstatus_oe", schema = "service")
public class ServiceOperationalStatusExtensionType implements Serializable, Equals, HashCode, ToString
{
