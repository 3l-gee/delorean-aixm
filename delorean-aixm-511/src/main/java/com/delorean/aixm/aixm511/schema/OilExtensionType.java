...
@XmlType(name = "", propOrder = {"abstractOilExtension"})
@Entity(name = "OilExtensionType")
@Table(name = "oil_oe", schema = "service")
public class OilExtensionType implements Serializable, Equals, HashCode, ToString {
    ...
    @JoinColumn(name = "abstractoilextension_hjid", referencedColumnName = "hjid")
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final OilExtensionType that = ((OilExtensionType) object);
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetAbstractOilExtension();
            AbstractExtensionType theField;
            theField = this.getAbstractOilExtension();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "abstractOilExtension", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            AbstractExtensionType theField;
            theField = this.getAbstractOilExtension();
            strategy.appendField(locator, this, "abstractOilExtension", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetOwns();
            boolean theField;
