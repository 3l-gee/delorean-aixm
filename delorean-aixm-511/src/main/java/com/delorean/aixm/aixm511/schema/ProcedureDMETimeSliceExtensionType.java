...
@XmlType(name = "", propOrder = {"abstractProcedureDMEExtension"})
@Entity(name = "ProcedureDMETimeSliceExtensionType")
@Table(name = "proceduredme_te", schema = "procedure")
public class ProcedureDMETimeSliceExtensionType implements Serializable, Equals, HashCode, ToString {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final ProcedureDMETimeSliceExtensionType that = ((ProcedureDMETimeSliceExtensionType) object);
        {
        ...
        }
        {
            ...
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "abstractProcedureDMEExtension",
                    lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "abstractProcedureDMEExtension",
                    rhsField);
            if (!strategy.equals(lhsFieldLocator, rhsFieldLocator, lhsField, rhsField, lhsFieldIsSet, rhsFieldIsSet)) {
                return false;
            }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetAbstractProcedureDMEExtension();
            AbstractExtensionType theField;
            theField = this.getAbstractProcedureDMEExtension();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "abstractProcedureDMEExtension", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            AbstractExtensionType theField;
            theField = this.getAbstractProcedureDMEExtension();
            strategy.appendField(locator, this, "abstractProcedureDMEExtension", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetOwns();
            boolean theField;
