...
/**
 * <p>
 * Java class for FinalLegType complex type
 * </p>
 * .
 *
 * <p>
...
"{http://www.aixm.aero/schema/5.1.1}FinalLegTimeSlicePropertyType" maxOccurs=
"unbounded"/>
 *       </sequence>
 *     </extension>
 *   </complexContent>
...
@XmlType(name = "FinalLegType", propOrder = {"timeSlice"})
@Entity(name = "FinalLegType")
@Table(name = "finalleg_f", schema = "procedure")
public class FinalLegType extends AbstractApproachLegType implements Serializable {
    ...
    @OneToMany(targetEntity = FinalLegTimeSlicePropertyType.class, cascade = {CascadeType.ALL}, fetch = FetchType.EAGER)
     ...
     *
     */
    public void setTimeSlice(List<FinalLegTimeSlicePropertyType> timeSlice) {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = super.hashCode(locator, strategy);
        {
            ...
            List<FinalLegTimeSlicePropertyType> theField;
