 ...
 *       <choice>
 *         <element ref=
"{http://www.aixm.aero/schema/5.1.1}AbstractLandingTakeoffAreaCollectionExtension"/>
 *       </choice>
 *       <attGroup ref=
...
@XmlType(name = "", propOrder = {"abstractLandingTakeoffAreaCollectionExtension"})
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final LandingTakeoffAreaCollectionExtensionType that = ((LandingTakeoffAreaCollectionExtensionType) object);
        {
            ...
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator,
                    "abstractLandingTakeoffAreaCollectionExtension", lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator,
                    "abstractLandingTakeoffAreaCollectionExtension", rhsField);
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = 1;
        {
            ...
            ObjectLocator theFieldLocator = LocatorUtils.property(locator,
                    "abstractLandingTakeoffAreaCollectionExtension", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            AbstractExtensionType theField;
            theField = this.getAbstractLandingTakeoffAreaCollectionExtension();
            strategy.appendField(locator, this, "abstractLandingTakeoffAreaCollectionExtension", buffer, theField,
                    theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetOwns();
