...
@XmlType(name = "", propOrder = {"abstractNavaidEquipmentDistanceExtension"})
@Entity(name = "NavaidEquipmentDistanceExtensionType")
@Table(name = "navaidequipmentdistance_oe", schema = "airport_heliport")
public class NavaidEquipmentDistanceExtensionType implements Serializable, Equals, HashCode, ToString {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final NavaidEquipmentDistanceExtensionType that = ((NavaidEquipmentDistanceExtensionType) object);
        {
            ...
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator,
                    "abstractNavaidEquipmentDistanceExtension", lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator,
                    "abstractNavaidEquipmentDistanceExtension", rhsField);
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetAbstractNavaidEquipmentDistanceExtension();
            AbstractExtensionType theField;
            theField = this.getAbstractNavaidEquipmentDistanceExtension();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "abstractNavaidEquipmentDistanceExtension",
                    theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            AbstractExtensionType theField;
            theField = this.getAbstractNavaidEquipmentDistanceExtension();
            strategy.appendField(locator, this, "abstractNavaidEquipmentDistanceExtension", buffer, theField,
                    theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetOwns();
