 ...
 *         <element ref="{http://www.aixm.aero/schema/5.1.1}AbstractVerticalStructureLightingStatusExtension"/>
 *       </choice>
...
public class VerticalStructureLightingStatusExtensionType implements Serializable, Equals, HashCode, ToString
{
    ...
    /**
     * Gets the value of the abstractVerticalStructureLightingStatusExtension property.
     * 
     * @return
     *     possible object is
     *     {@link AbstractExtensionType }
    ...
    /**
     * Sets the value of the abstractVerticalStructureLightingStatusExtension property.
     * 
     * @param value
     *     allowed object is
     *     {@link AbstractExtensionType }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        }
        {
            ...
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "abstractVerticalStructureLightingStatusExtension", theField);
            currentHashCode = strategy.hashCode(theFieldLocator, currentHashCode, theField, theFieldIsSet);
        }
        {
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        }
        {
            ...
            AbstractExtensionType theField;
            theField = this.getAbstractVerticalStructureLightingStatusExtension();
            strategy.appendField(locator, this, "abstractVerticalStructureLightingStatusExtension", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetOwns();
            boolean theField;
