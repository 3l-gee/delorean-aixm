 ...
 *                   <element ref=
"{http://www.aixm.aero/schema/5.1.1}AbstractPostalAddressExtension"/>
 *                 </choice>
 *                 <attGroup ref=
...
public class PostalAddressType extends AbstractPropertiesWithScheduleType implements Serializable {
    ...
    public void setDeliveryPointItem(TextAddressType target) {
        setDeliveryPoint(XmlAdapterUtils.marshallJAXBElement(TextAddressType.class,
                new QName("http://www.aixm.aero/schema/5.1.1", "deliveryPoint"), PostalAddressType.class, target));
    }
    ...
    public void setCityItem(TextNameType target) {
        setCity(XmlAdapterUtils.marshallJAXBElement(TextNameType.class,
                new QName("http://www.aixm.aero/schema/5.1.1", "city"), PostalAddressType.class, target));
    }
    ...
    public void setAdministrativeAreaItem(TextNameType target) {
        setAdministrativeArea(XmlAdapterUtils.marshallJAXBElement(TextNameType.class,
                new QName("http://www.aixm.aero/schema/5.1.1", "administrativeArea"), PostalAddressType.class, target));
    }
    ...
    public void setPostalCodeItem(TextNameType target) {
        setPostalCode(XmlAdapterUtils.marshallJAXBElement(TextNameType.class,
                new QName("http://www.aixm.aero/schema/5.1.1", "postalCode"), PostalAddressType.class, target));
    }
    ...
    public void setCountryItem(TextNameType target) {
        setCountry(XmlAdapterUtils.marshallJAXBElement(TextNameType.class,
                new QName("http://www.aixm.aero/schema/5.1.1", "country"), PostalAddressType.class, target));
    }
