...
"{http://www.aixm.aero/schema/5.1.1}FuelPropertyType" maxOccurs=
"unbounded" minOccurs="0"/>
 *         <element name="oilSupply" type=
"{http://www.aixm.aero/schema/5.1.1}OilPropertyType" maxOccurs=
"unbounded" minOccurs="0"/>
 *         <element name="nitrogenSupply" type=
"{http://www.aixm.aero/schema/5.1.1}NitrogenPropertyType" maxOccurs=
"unbounded" minOccurs="0"/>
 *         <element name="oxygenSupply" type=
"{http://www.aixm.aero/schema/5.1.1}OxygenPropertyType" maxOccurs=
"unbounded" minOccurs="0"/>
 ...
 *                 <choice>
 *                   <element ref=
"{http://www.aixm.aero/schema/5.1.1}AbstractAirportSuppliesServiceExtension"/>
 *                   <element ref=
...
public class AirportSuppliesServiceTimeSliceType extends AbstractAIXMTimeSliceType implements Serializable {
    ...
    public void setRankItem(CodeFacilityRankingType target) {
        setRank(XmlAdapterUtils.marshallJAXBElement(CodeFacilityRankingType.class,
                new QName("http://www.aixm.aero/schema/5.1.1", "rank"), AirportSuppliesServiceTimeSliceType.class,
                target));
    }
    ...
    public void setAixmNameItem(TextNameType target) {
        setAixmName(XmlAdapterUtils.marshallJAXBElement(TextNameType.class,
                new QName("http://www.aixm.aero/schema/5.1.1", "name"), AirportSuppliesServiceTimeSliceType.class,
                target));
    }
    ...
    public void setLocationItem(AIXMElevatedPointPropertyType target) {
        setLocation(XmlAdapterUtils.marshallJAXBElement(AIXMElevatedPointPropertyType.class,
                new QName("http://www.aixm.aero/schema/5.1.1", "location"), AirportSuppliesServiceTimeSliceType.class,
                target));
    }
