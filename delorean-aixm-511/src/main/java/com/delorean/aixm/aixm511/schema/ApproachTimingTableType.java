...
/**
 * <p>
 * Java class for ApproachTimingTableType complex type
 * </p>
 * .
 *
 * <p>
...
"{http://www.aixm.aero/schema/5.1.1}CodeProcedureDistanceType" minOccurs="0"/>
...
@XmlType(name = "ApproachTimingTableType", propOrder = {"startingMeasurementPoint", "endingMeasurementPoint", "time",
        "speed", "annotation", "extension"})
@Entity(name = "ApproachTimingTableType")
@Table(name = "approachtimingtable_o", schema = "procedure")
public class ApproachTimingTableType extends AbstractAIXMObjectType implements Serializable {
    ...
    @JoinTable(name = "apprchtmngtbltp_annttn_link", schema = "procedure", joinColumns = {
            @JoinColumn(name = "approachtimingtable_o_hjid", referencedColumnName = "hjid")}, inverseJoinColumns = {
    ...
    public void setStartingMeasurementPointItem(CodeProcedureDistanceType target) {
        setStartingMeasurementPoint(XmlAdapterUtils.marshallJAXBElement(CodeProcedureDistanceType.class,
                new QName("http://www.aixm.aero/schema/5.1.1", "startingMeasurementPoint"),
                ApproachTimingTableType.class, target));
    }
    ...
    public void setEndingMeasurementPointItem(CodeProcedureDistanceType target) {
        setEndingMeasurementPoint(XmlAdapterUtils.marshallJAXBElement(CodeProcedureDistanceType.class,
                new QName("http://www.aixm.aero/schema/5.1.1", "endingMeasurementPoint"), ApproachTimingTableType.class,
                target));
    }
    ...
    public void setTimeItem(ValDurationType target) {
        setTime(XmlAdapterUtils.marshallJAXBElement(ValDurationType.class,
                new QName("http://www.aixm.aero/schema/5.1.1", "time"), ApproachTimingTableType.class, target));
    }
    ...
    public void setSpeedItem(ValSpeedType target) {
        setSpeed(XmlAdapterUtils.marshallJAXBElement(ValSpeedType.class,
                new QName("http://www.aixm.aero/schema/5.1.1", "speed"), ApproachTimingTableType.class, target));
    }
