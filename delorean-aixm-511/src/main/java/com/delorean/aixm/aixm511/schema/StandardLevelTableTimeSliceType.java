    ...
    implements Serializable
{
    ...
    public void setAixmNameItem(CodeLevelTableDesignatorType target) {
        setAixmName(XmlAdapterUtils.marshallJAXBElement(CodeLevelTableDesignatorType.class, new QName("http://www.aixm.aero/schema/5.1.1", "name"), StandardLevelTableTimeSliceType.class, target));
    }
    ...
    public void setStandardICAOItem(CodeYesNoType target) {
        setStandardICAO(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.1.1", "standardICAO"), StandardLevelTableTimeSliceType.class, target));
    }
