...
@XmlType(name = "", propOrder = {"abstractMinimaExtension"})
@Entity(name = "MinimaExtensionType")
@Table(name = "minima_oe", schema = "procedure")
public class MinimaExtensionType implements Serializable, Equals, HashCode, ToString {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final MinimaExtensionType that = ((MinimaExtensionType) object);
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetAbstractMinimaExtension();
            AbstractExtensionType theField;
            theField = this.getAbstractMinimaExtension();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "abstractMinimaExtension", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            AbstractExtensionType theField;
            theField = this.getAbstractMinimaExtension();
            strategy.appendField(locator, this, "abstractMinimaExtension", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetOwns();
            boolean theField;
