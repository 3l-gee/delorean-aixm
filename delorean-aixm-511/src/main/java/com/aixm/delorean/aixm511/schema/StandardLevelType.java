 ...
 *       <sequence>
 *         <group ref=
"{http://www.aixm.aero/schema/5.1.1}StandardLevelPropertyGroup"/>
...
@Table(name = "standardlevel", schema = "shared")
public class StandardLevelType extends AbstractAIXMObjectType implements Serializable {
    ...
    @JoinTable(name = "annotation_standardlevel_link", schema = "shared", joinColumns = {
            @JoinColumn(name = "annotation", referencedColumnName = "hjid")}, inverseJoinColumns = {
                    @JoinColumn(name = "standardlevelpropertygroup", referencedColumnName = "hjid")})
