...
/**
 * <p>
 * Java class for SafeAltitudeAreaType complex type
 * </p>
 * .
 *
 * <p>
 ...
 *
 * <pre>{@code
 * <complexType name="SafeAltitudeAreaType">
 *   <complexContent>
 *     <extension base=
"{http://www.aixm.aero/schema/5.1.1}AbstractAIXMFeatureType">
 *       <sequence>
 *         <element name="timeSlice" type=
"{http://www.aixm.aero/schema/5.1.1}SafeAltitudeAreaTimeSlicePropertyType" maxOccurs
="unbounded"/>
 *       </sequence>
 *     </extension>
 *   </complexContent>
...
@XmlType(name = "SafeAltitudeAreaType", propOrder = {"timeSlice"})
@Entity(name = "SafeAltitudeAreaType")
@Table(name = "safealtitudearea", schema = "procedure")
public class SafeAltitudeAreaType extends AbstractAIXMFeatureType implements Serializable {
     ...
     * {@link SafeAltitudeAreaTimeSlicePropertyType }
     *
     *
     */
    @ManyToMany(targetEntity = SafeAltitudeAreaTimeSlicePropertyType.class, cascade = {
            CascadeType.ALL}, fetch = FetchType.EAGER)
    @JoinTable(name = "timeslice_safealtitudearea_link", schema = "procedure", joinColumns = {
            @JoinColumn(name = "timeslice", referencedColumnName = "hjid")}, inverseJoinColumns = {
                    @JoinColumn(name = "safealtitudeareatype", referencedColumnName = "hjid")})
    public List<SafeAltitudeAreaTimeSlicePropertyType> getTimeSlice() {
        if (timeSlice == null) {
     ...
     *
     */
    public void setTimeSlice(List<SafeAltitudeAreaTimeSlicePropertyType> timeSlice) {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final SafeAltitudeAreaType that = ((SafeAltitudeAreaType) object);
        {
            boolean lhsFieldIsSet = this.isSetTimeSlice();
            boolean rhsFieldIsSet = that.isSetTimeSlice();
            List<SafeAltitudeAreaTimeSlicePropertyType> lhsField;
            lhsField = (this.isSetTimeSlice() ? this.getTimeSlice() : null);
            List<SafeAltitudeAreaTimeSlicePropertyType> rhsField;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = super.hashCode(locator, strategy);
        {
            ...
            List<SafeAltitudeAreaTimeSlicePropertyType> theField;
