    ...
    implements Serializable
{
    ...
    @JoinTable(name = "airportheliportcontaminationtype_criticalridge_link", schema = "public", joinColumns = {
        @JoinColumn(name = "airportheliportcontaminationtype_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "airportheliportcontaminationtype_layer_link", schema = "public", joinColumns = {
        @JoinColumn(name = "airportheliportcontaminationtype_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "airportheliportcontaminationtype_annotation_link", schema = "public", joinColumns = {
        @JoinColumn(name = "airportheliportcontaminationtype_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinColumn(name = "airportheliportcontamination_e_hjid", referencedColumnName = "hjid")
