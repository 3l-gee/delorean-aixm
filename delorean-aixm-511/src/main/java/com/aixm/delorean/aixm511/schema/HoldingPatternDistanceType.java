    ...
    implements Serializable
{
    ...
    @JoinTable(name = "holdingpatterndistance_o_annotation_link", schema = "public", joinColumns = {
    ...
    @JoinColumn(name = "holdingpatterndistance_e_hjid", referencedColumnName = "hjid")
