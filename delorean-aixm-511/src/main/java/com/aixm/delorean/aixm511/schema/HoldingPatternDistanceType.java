...
/**
 * <p>
 * Java class for HoldingPatternDistanceType complex type
 * </p>
 * .
 *
 * <p>
 ...
 *       <sequence>
 *         <group ref=
"{http://www.aixm.aero/schema/5.1.1}HoldingPatternDistancePropertyGroup"/>
...
@XmlType(name = "HoldingPatternDistanceType", propOrder = {"length", "annotation", "extension"})
@Entity(name = "HoldingPatternDistanceType")
@Table(name = "holdingpatterndistance", schema = "holding")
public class HoldingPatternDistanceType extends AbstractAIXMObjectType implements Serializable {
    ...
    @JoinTable(name = "annotation_holdingpatterndistance_link", schema = "holding", joinColumns = {
            @JoinColumn(name = "annotation", referencedColumnName = "hjid")}, inverseJoinColumns = {
                    @JoinColumn(name = "holdingpatterndistancepropertygroup", referencedColumnName = "hjid")})
    ...
    @JoinColumn(name = "EXTENSION_HOLDING_PATTERN_DI_0")
    ...
    public void setLengthItem(ValDistanceType target) {
        setLength(XmlAdapterUtils.marshallJAXBElement(ValDistanceType.class,
                new QName("http://www.aixm.aero/schema/5.1.1", "length"), HoldingPatternDistanceType.class, target));
    }
