 ...
 *       <sequence>
 *         <group ref=
"{http://www.aixm.aero/schema/5.1.1}SearchRescueServicePropertyGroup"/>
...
@Table(name = "searchrescueservice_ts", schema = "service")
public class SearchRescueServiceTimeSliceType extends AbstractAIXMTimeSliceType implements Serializable {
    ...
    @JoinTable(name = "call_sign_searchrescueservice_link", schema = "service", joinColumns = {
            @JoinColumn(name = "call-sign", referencedColumnName = "hjid")}, inverseJoinColumns = {
                    @JoinColumn(name = "searchrescueservicepropertygroup", referencedColumnName = "hjid")})
    ...
    @JoinTable(name = "radiocommunication_searchrescueservice_link", schema = "service", joinColumns = {
    ...
    @ManyToMany(targetEntity = ContactInformationPropertyType.class, cascade = {
            CascadeType.ALL}, fetch = FetchType.EAGER)
    @JoinTable(name = "groundcommunication_searchrescueservice_link", schema = "service", joinColumns = {
    ...
    @ManyToMany(targetEntity = ServiceOperationalStatusPropertyType.class, cascade = {
            CascadeType.ALL}, fetch = FetchType.EAGER)
    @JoinTable(name = "availability_searchrescueservice_link", schema = "service", joinColumns = {
    ...
    @JoinTable(name = "annotation_searchrescueservice_link", schema = "service", joinColumns = {
    ...
    @JoinTable(name = "clientairspace_searchrescueservice_link", schema = "service", joinColumns = {
    ...
    @JoinTable(name = "clientroute_searchrescueservice_link", schema = "service", joinColumns = {
    ...
    @OneToMany(targetEntity = SearchRescueServiceExtensionType.class, cascade = {
            CascadeType.ALL}, fetch = FetchType.EAGER)
    @JoinColumn(name = "EXTENSION_SEARCH_RESCUE_SERV_0")
