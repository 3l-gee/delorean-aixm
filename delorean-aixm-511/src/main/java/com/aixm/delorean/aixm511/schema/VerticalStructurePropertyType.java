...
/**
 * <p>Java class for VerticalStructurePropertyType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="VerticalStructurePropertyType">
 *   <complexContent>
...
@XmlType(name = "VerticalStructurePropertyType")
@Entity(name = "VerticalStructurePropertyType")
@Table(name = "verticalstructurepropertytype", schema = "obstacle")
public class VerticalStructurePropertyType implements Serializable, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        final VerticalStructurePropertyType that = ((VerticalStructurePropertyType) object);
        {
