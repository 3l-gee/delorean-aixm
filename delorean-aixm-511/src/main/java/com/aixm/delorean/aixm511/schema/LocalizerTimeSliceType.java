 ...
 *       <sequence>
 *         <group ref=
"{http://www.aixm.aero/schema/5.1.1}LocalizerPropertyGroup"/>
...
public class LocalizerTimeSliceType extends AbstractAIXMTimeSliceType implements Serializable {
    ...
    @JoinTable(name = "authority_localizer_link", schema = "navaids_point", joinColumns = {
            @JoinColumn(name = "authority", referencedColumnName = "hjid")}, inverseJoinColumns = {
    ...
    @JoinTable(name = "monitoring_localizer_link", schema = "navaids_point", joinColumns = {
            @JoinColumn(name = "monitoring", referencedColumnName = "hjid")}, inverseJoinColumns = {
                    @JoinColumn(name = "localizerpropertygroup", referencedColumnName = "hjid")})
