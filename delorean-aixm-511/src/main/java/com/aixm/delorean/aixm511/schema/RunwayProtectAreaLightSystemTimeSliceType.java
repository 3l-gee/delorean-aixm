 ...
 *       <sequence>
 *         <group ref=
"{http://www.aixm.aero/schema/5.1.1}RunwayProtectAreaLightSystemPropertyGroup"/>
...
public class RunwayProtectAreaLightSystemTimeSliceType extends AbstractAIXMTimeSliceType implements Serializable {
    ...
    @ManyToOne(targetEntity = RunwayProtectAreaPropertyType.class, cascade = {CascadeType.ALL}, fetch = FetchType.EAGER)
