 ...
 *       <sequence>
 *         <group ref=
"{http://www.aixm.aero/schema/5.1.1}FinalLegPropertyGroup"/>
...
public class FinalLegTimeSliceType extends AbstractAIXMTimeSliceType implements Serializable {
    ...
    @JoinTable(name = "aircraftcategory_finalleg_link", schema = "procedure", joinColumns = {
            @JoinColumn(name = "aircraftcategory", referencedColumnName = "hjid")}, inverseJoinColumns = {
                    @JoinColumn(name = "finallegpropertygroup", referencedColumnName = "hjid")})
    ...
    @ManyToMany(targetEntity = ObstacleAssessmentAreaPropertyType.class, cascade = {
            CascadeType.ALL}, fetch = FetchType.EAGER)
    @JoinTable(name = "designsurface_finalleg_link", schema = "procedure", joinColumns = {
            @JoinColumn(name = "designsurface", referencedColumnName = "hjid")}, inverseJoinColumns = {
                    @JoinColumn(name = "finallegpropertygroup", referencedColumnName = "hjid")})
    ...
    @JoinTable(name = "annotation_finalleg_link", schema = "procedure", joinColumns = {
    ...
    @ManyToMany(targetEntity = ApproachConditionPropertyType.class, cascade = {
            CascadeType.ALL}, fetch = FetchType.EAGER)
    @JoinTable(name = "condition_finalleg_link", schema = "procedure", joinColumns = {
            @JoinColumn(name = "condition", referencedColumnName = "hjid")}, inverseJoinColumns = {
                    @JoinColumn(name = "finallegpropertygroup", referencedColumnName = "hjid")})
    ...
    @ManyToOne(targetEntity = AngleIndicationPropertyType.class, cascade = {CascadeType.ALL}, fetch = FetchType.EAGER)
    ...
    @ManyToOne(targetEntity = HoldingUsePropertyType.class, cascade = {CascadeType.ALL}, fetch = FetchType.EAGER)
    ...
    @ManyToOne(targetEntity = FASDataBlockPropertyType.class, cascade = {CascadeType.ALL}, fetch = FetchType.EAGER)
