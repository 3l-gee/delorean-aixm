...
/**
 * <p>Java class for ServicePropertyType complex type</p>.
 * 
...
@XmlType(name = "ServicePropertyType")
@Entity(name = "ServicePropertyType")
@Table(name = "servicepropertytype", schema = "service")
public class ServicePropertyType implements Serializable, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        final ServicePropertyType that = ((ServicePropertyType) object);
        {
