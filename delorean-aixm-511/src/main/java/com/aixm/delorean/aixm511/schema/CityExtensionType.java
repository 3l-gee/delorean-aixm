 ...
 *       <choice>
 *         <element ref=
"{http://www.aixm.aero/schema/5.1.1}AbstractCityExtension"/>
 *       </choice>
 *       <attGroup ref=
...
@XmlType(name = "", propOrder = {"abstractCityExtension"})
@Entity(name = "CityExtensionType")
@Table(name = "city_oe", schema = "airport_heliport")
public class CityExtensionType implements Serializable, Equals, HashCode, ToString {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final CityExtensionType that = ((CityExtensionType) object);
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetAbstractCityExtension();
            AbstractExtensionType theField;
            theField = this.getAbstractCityExtension();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "abstractCityExtension", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            AbstractExtensionType theField;
            theField = this.getAbstractCityExtension();
            strategy.appendField(locator, this, "abstractCityExtension", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetOwns();
            boolean theField;
