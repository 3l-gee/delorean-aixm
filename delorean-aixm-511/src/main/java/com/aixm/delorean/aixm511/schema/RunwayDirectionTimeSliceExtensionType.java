...
@XmlType(name = "", propOrder = {"abstractRunwayDirectionExtension"})
@Entity(name = "RunwayDirectionTimeSliceExtensionType")
@Table(name = "runwaydirection_te", schema = "airport_heliport")
public class RunwayDirectionTimeSliceExtensionType implements Serializable, Equals, HashCode, ToString {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final RunwayDirectionTimeSliceExtensionType that = ((RunwayDirectionTimeSliceExtensionType) object);
        {
        ...
        }
        {
            ...
            lhsField = this.getAbstractRunwayDirectionExtension();
            AbstractExtensionType rhsField;
            rhsField = that.getAbstractRunwayDirectionExtension();
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "abstractRunwayDirectionExtension",
                    lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "abstractRunwayDirectionExtension",
                    rhsField);
            if (!strategy.equals(lhsFieldLocator, rhsFieldLocator, lhsField, rhsField, lhsFieldIsSet, rhsFieldIsSet)) {
                return false;
            }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetAbstractRunwayDirectionExtension();
            AbstractExtensionType theField;
            theField = this.getAbstractRunwayDirectionExtension();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "abstractRunwayDirectionExtension",
                    theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            AbstractExtensionType theField;
            theField = this.getAbstractRunwayDirectionExtension();
            strategy.appendField(locator, this, "abstractRunwayDirectionExtension", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetOwns();
            boolean theField;
