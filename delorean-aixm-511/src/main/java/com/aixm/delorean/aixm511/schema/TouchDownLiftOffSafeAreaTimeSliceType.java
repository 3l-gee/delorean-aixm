 ...
 *       <sequence>
 *         <group ref=
"{http://www.aixm.aero/schema/5.1.1}TouchDownLiftOffSafeAreaPropertyGroup"/>
...
public class TouchDownLiftOffSafeAreaTimeSliceType extends AbstractAIXMTimeSliceType implements Serializable {
    ...
    @JoinTable(name = "annotation_touchdownliftoffsafearea_link", schema = "airport_heliport", joinColumns = {
            @JoinColumn(name = "annotation", referencedColumnName = "hjid")}, inverseJoinColumns = {
                    @JoinColumn(name = "touchdownliftoffsafeareapropertygroup", referencedColumnName = "hjid")})
