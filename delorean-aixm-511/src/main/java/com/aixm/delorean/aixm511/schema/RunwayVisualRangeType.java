...
/**
 * <p>
 * Java class for RunwayVisualRangeType complex type
 * </p>
 * .
 *
 * <p>
...
"{http://www.aixm.aero/schema/5.1.1}RunwayVisualRangeTimeSlicePropertyType" maxOccurs
="unbounded"/>
 *       </sequence>
 *     </extension>
 *   </complexContent>
...
@XmlType(name = "RunwayVisualRangeType", propOrder = {"timeSlice"})
@Entity(name = "RunwayVisualRangeType")
@Table(name = "runwayvisualrange_f", schema = "airport_heliport")
public class RunwayVisualRangeType extends AbstractAIXMFeatureType implements Serializable {
    ...
    @OneToMany(targetEntity = RunwayVisualRangeTimeSlicePropertyType.class, cascade = {
