...
"{http://www.aixm.aero/schema/5.1.1}AltimeterSourceTimeSlicePropertyType" maxOccurs
="unbounded"/>
 *       </sequence>
 *     </extension>
 *   </complexContent>
...
@XmlType(name = "AltimeterSourceType", propOrder = {"timeSlice"})
@Entity(name = "AltimeterSourceType")
@Table(name = "altimetersource", schema = "airport_heliport")
public class AltimeterSourceType extends AbstractAIXMFeatureType implements Serializable {
     ...
     *
     */
    @ManyToMany(targetEntity = AltimeterSourceTimeSlicePropertyType.class, cascade = {
            CascadeType.ALL}, fetch = FetchType.EAGER)
    @JoinTable(name = "timeslice_altimetersource_link", schema = "airport_heliport", joinColumns = {
            @JoinColumn(name = "timeslice", referencedColumnName = "hjid")}, inverseJoinColumns = {
                    @JoinColumn(name = "altimetersourcetype", referencedColumnName = "hjid")})
     ...
     *
     */
    public void setTimeSlice(List<AltimeterSourceTimeSlicePropertyType> timeSlice) {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final AltimeterSourceType that = ((AltimeterSourceType) object);
        {
            ...
            List<AltimeterSourceTimeSlicePropertyType> lhsField;
            lhsField = (this.isSetTimeSlice() ? this.getTimeSlice() : null);
            List<AltimeterSourceTimeSlicePropertyType> rhsField;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = super.hashCode(locator, strategy);
        {
            ...
            List<AltimeterSourceTimeSlicePropertyType> theField;
