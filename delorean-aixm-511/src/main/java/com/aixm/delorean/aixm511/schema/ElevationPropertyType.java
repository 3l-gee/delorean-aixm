...
/**
 * <p>Java class for ElevationPropertyType complex type</p>.
 * 
...
@XmlType(name = "ElevationPropertyType")
@Entity(name = "ElevationPropertyType")
@Table(name = "elevationpropertytype", schema = "navaids_point")
public class ElevationPropertyType implements Serializable, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        final ElevationPropertyType that = ((ElevationPropertyType) object);
        {
