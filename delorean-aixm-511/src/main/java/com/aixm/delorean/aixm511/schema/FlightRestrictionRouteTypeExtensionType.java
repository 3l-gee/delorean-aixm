...
@Entity(name = "FlightRestrictionRouteTypeExtensionType")
@Table(name = "flightrestrictionroutee", schema = "route")
public class FlightRestrictionRouteTypeExtensionType implements Serializable, Equals, HashCode, ToString {
