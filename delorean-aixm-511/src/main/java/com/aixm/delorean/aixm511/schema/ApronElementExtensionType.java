...
@Entity(name = "ApronElementExtensionType")
@Table(name = "apronelemente", schema = "airport_heliport")
public class ApronElementExtensionType implements Serializable, Equals, HashCode, ToString {
