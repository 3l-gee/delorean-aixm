...
/**
 * <p>
 * Java class for GroundTrafficControlServiceType complex type
 * </p>
 * .
 *
 * <p>
 ...
 *   <complexContent>
 *     <extension base=
"{http://www.aixm.aero/schema/5.1.1}AbstractTrafficSeparationServiceType">
 *       <sequence>
 *         <element name="timeSlice" type=
"{http://www.aixm.aero/schema/5.1.1}GroundTrafficControlServiceTimeSlicePropertyType" maxOccurs
="unbounded"/>
 *       </sequence>
 *     </extension>
 *   </complexContent>
...
@XmlType(name = "GroundTrafficControlServiceType", propOrder = {"timeSlice"})
@Entity(name = "GroundTrafficControlServiceType")
@Table(name = "groundtrafficcontrolservice", schema = "service")
public class GroundTrafficControlServiceType extends AbstractTrafficSeparationServiceType implements Serializable {
     ...
     *
     */
    @ManyToMany(targetEntity = GroundTrafficControlServiceTimeSlicePropertyType.class, cascade = {
            CascadeType.ALL}, fetch = FetchType.EAGER)
    @JoinTable(name = "timeslice_groundtrafficcontrolservice_link", schema = "service", joinColumns = {
            @JoinColumn(name = "timeslice", referencedColumnName = "hjid")}, inverseJoinColumns = {
                    @JoinColumn(name = "groundtrafficcontrolservicetype", referencedColumnName = "hjid")})
     ...
     *
     */
    public void setTimeSlice(List<GroundTrafficControlServiceTimeSlicePropertyType> timeSlice) {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final GroundTrafficControlServiceType that = ((GroundTrafficControlServiceType) object);
        {
            boolean lhsFieldIsSet = this.isSetTimeSlice();
            boolean rhsFieldIsSet = that.isSetTimeSlice();
            List<GroundTrafficControlServiceTimeSlicePropertyType> lhsField;
            lhsField = (this.isSetTimeSlice() ? this.getTimeSlice() : null);
            List<GroundTrafficControlServiceTimeSlicePropertyType> rhsField;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = super.hashCode(locator, strategy);
        {
            ...
            List<GroundTrafficControlServiceTimeSlicePropertyType> theField;
