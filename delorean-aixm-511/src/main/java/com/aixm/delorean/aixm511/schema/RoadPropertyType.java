...
/**
 * <p>Java class for RoadPropertyType complex type</p>.
 * 
...
@XmlType(name = "RoadPropertyType")
@Entity(name = "RoadPropertyType")
@Table(name = "roadpropertytype", schema = "airport_heliport")
public class RoadPropertyType implements Serializable, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        final RoadPropertyType that = ((RoadPropertyType) object);
        {
