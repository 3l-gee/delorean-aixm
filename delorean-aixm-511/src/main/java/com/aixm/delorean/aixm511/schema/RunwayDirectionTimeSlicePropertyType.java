...
/**
 * <p>
 * Java class for RunwayDirectionTimeSlicePropertyType complex type
 * </p>
 * .
 *
 * <p>
 ...
 *       <sequence>
 *         <element ref=
"{http://www.aixm.aero/schema/5.1.1}RunwayDirectionTimeSlice"/>
 *       </sequence>
 *       <attGroup ref=
...
@XmlType(name = "RunwayDirectionTimeSlicePropertyType", propOrder = {"runwayDirectionTimeSlice"})
@FilterDef(name = "TPHjidFilter", parameters = {@ParamDef(name = "ids", type = Long.class)})
@Filter(name = "TPHjidFilter", condition = "hjid IN (:ids)")
@Entity(name = "RunwayDirectionTimeSlicePropertyType")
@Table(name = "runwaydirection_tp", schema = "airport_heliport")
public class RunwayDirectionTimeSlicePropertyType implements Serializable, Equals, HashCode, ToString {
     ...
     *
     * @return possible object is {@link RunwayDirectionTimeSliceType }
     *
     */
    @OneToOne(targetEntity = RunwayDirectionTimeSliceType.class, cascade = {CascadeType.ALL}, fetch = FetchType.EAGER)
    @JoinColumn(name = "runwaydirectiontimeslice_hjid", referencedColumnName = "hjid")
     ...
     *
     * @param value
     *            allowed object is {@link RunwayDirectionTimeSliceType }
     *
     */
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetRunwayDirectionTimeSlice();
            RunwayDirectionTimeSliceType theField;
            theField = this.getRunwayDirectionTimeSlice();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "runwayDirectionTimeSlice", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            RunwayDirectionTimeSliceType theField;
            theField = this.getRunwayDirectionTimeSlice();
            strategy.appendField(locator, this, "runwayDirectionTimeSlice", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetOwns();
            boolean theField;
