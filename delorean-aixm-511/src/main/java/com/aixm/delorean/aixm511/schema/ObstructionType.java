 ...
 *       <sequence>
 *         <group ref=
"{http://www.aixm.aero/schema/5.1.1}ObstructionPropertyGroup"/>
 ...
 *                 <choice>
 *                   <element ref=
"{http://www.aixm.aero/schema/5.1.1}AbstractObstructionExtension"/>
 *                 </choice>
 *                 <attGroup ref=
...
public class ObstructionType extends AbstractAIXMObjectType implements Serializable {
    ...
    @JoinTable(name = "adjustment_obstruction_link", schema = "shared", joinColumns = {
            @JoinColumn(name = "adjustment", referencedColumnName = "hjid")}, inverseJoinColumns = {
    ...
    @JoinTable(name = "obstacleplacement_obstruction_link", schema = "shared", joinColumns = {
            @JoinColumn(name = "obstacleplacement", referencedColumnName = "hjid")}, inverseJoinColumns = {
                    @JoinColumn(name = "obstructionpropertygroup", referencedColumnName = "hjid")})
     ...
     *
     */
    @OneToMany(targetEntity = ObstructionTypeExtensionType.class, cascade = {CascadeType.ALL}, fetch = FetchType.EAGER)
    ...
    public void setRequiredClearanceItem(ValDistanceType target) {
        setRequiredClearance(XmlAdapterUtils.marshallJAXBElement(ValDistanceType.class,
                new QName("http://www.aixm.aero/schema/5.1.1", "requiredClearance"), ObstructionType.class, target));
    }
    ...
    public void setMinimumAltitudeItem(ValDistanceVerticalType target) {
        setMinimumAltitude(XmlAdapterUtils.marshallJAXBElement(ValDistanceVerticalType.class,
                new QName("http://www.aixm.aero/schema/5.1.1", "minimumAltitude"), ObstructionType.class, target));
    }
    ...
    public void setSurfacePenetrationItem(CodeYesNoType target) {
        setSurfacePenetration(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class,
                new QName("http://www.aixm.aero/schema/5.1.1", "surfacePenetration"), ObstructionType.class, target));
    }
    ...
    public void setSlopePenetrationItem(ValAngleType target) {
        setSlopePenetration(XmlAdapterUtils.marshallJAXBElement(ValAngleType.class,
                new QName("http://www.aixm.aero/schema/5.1.1", "slopePenetration"), ObstructionType.class, target));
    }
    ...
    public void setControllingItem(CodeYesNoType target) {
        setControlling(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class,
                new QName("http://www.aixm.aero/schema/5.1.1", "controlling"), ObstructionType.class, target));
    }
    ...
    public void setCloseInItem(CodeYesNoType target) {
        setCloseIn(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class,
                new QName("http://www.aixm.aero/schema/5.1.1", "closeIn"), ObstructionType.class, target));
    }
    ...
    public void setTheVerticalStructureItem(VerticalStructurePropertyType target) {
        setTheVerticalStructure(XmlAdapterUtils.marshallJAXBElement(VerticalStructurePropertyType.class,
                new QName("http://www.aixm.aero/schema/5.1.1", "theVerticalStructure"), ObstructionType.class, target));
    }
