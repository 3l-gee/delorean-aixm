...
/**
 * <p>Java class for StandardInstrumentArrivalPropertyType complex type</p>.
 * 
...
@XmlType(name = "StandardInstrumentArrivalPropertyType")
@Entity(name = "StandardInstrumentArrivalPropertyType")
@Table(name = "standardinstrumentarrivalpropertytype", schema = "procedure")
public class StandardInstrumentArrivalPropertyType implements Serializable, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        final StandardInstrumentArrivalPropertyType that = ((StandardInstrumentArrivalPropertyType) object);
        {
