...
"{http://www.aixm.aero/schema/5.1.1}CodeFlowConditionOperationType" minOccurs=
"0"/>
 *         <element name="element" type=
"{http://www.aixm.aero/schema/5.1.1}FlightConditionElementPropertyType" maxOccurs
="unbounded" minOccurs="0"/>
 ...
 *                   <element ref=
"{http://www.aixm.aero/schema/5.1.1}AbstractFlightConditionCombinationExtension"/>
 *                 </choice>
 *                 <attGroup ref=
...
public class FlightConditionCombinationType extends AbstractPropertiesWithScheduleType implements Serializable {
    ...
    public void setLogicalOperatorItem(CodeFlowConditionOperationType target) {
        setLogicalOperator(XmlAdapterUtils.marshallJAXBElement(CodeFlowConditionOperationType.class,
                new QName("http://www.aixm.aero/schema/5.1.1", "logicalOperator"), FlightConditionCombinationType.class,
                target));
    }
