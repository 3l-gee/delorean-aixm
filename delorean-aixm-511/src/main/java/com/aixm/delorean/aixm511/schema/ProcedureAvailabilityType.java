...
="unbounded" minOccurs="0"/>
 *         <group ref=
"{http://www.aixm.aero/schema/5.1.1}ProcedureAvailabilityPropertyGroup"/>
...
public class ProcedureAvailabilityType extends AbstractPropertiesWithScheduleType implements Serializable {
    ...
    @JoinTable(name = "timeinterval_procedureavailability_link", schema = "procedure", joinColumns = {
            @JoinColumn(name = "timeinterval", referencedColumnName = "hjid")}, inverseJoinColumns = {
                    @JoinColumn(name = "procedureavailabilitytype", referencedColumnName = "hjid")})
    ...
    @JoinTable(name = "annotation_procedureavailability_link", schema = "procedure", joinColumns = {
    ...
    @JoinTable(name = "specialdateauthority_procedureavailability_link", schema = "procedure", joinColumns = {
    ...
    @OneToMany(targetEntity = ProcedureAvailabilityTypeExtensionType.class, cascade = {
            CascadeType.ALL}, fetch = FetchType.EAGER)
    @JoinColumn(name = "EXTENSION_PROCEDURE_AVAILABI_0")
    ...
    public void setStatusItem(CodeProcedureAvailabilityType target) {
        setStatus(XmlAdapterUtils.marshallJAXBElement(CodeProcedureAvailabilityType.class,
                new QName("http://www.aixm.aero/schema/5.1.1", "status"), ProcedureAvailabilityType.class, target));
    }
