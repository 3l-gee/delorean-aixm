...
/**
 * <p>
 * Java class for PrimarySurveillanceRadarType complex type
 * </p>
 * .
 *
 * <p>
...
"{http://www.aixm.aero/schema/5.1.1}PrimarySurveillanceRadarTimeSlicePropertyType" maxOccurs
="unbounded"/>
 *       </sequence>
 *     </extension>
 *   </complexContent>
...
@XmlType(name = "PrimarySurveillanceRadarType", propOrder = {"timeSlice"})
@Entity(name = "PrimarySurveillanceRadarType")
@Table(name = "primarysurveillanceradar", schema = "surveillance")
public class PrimarySurveillanceRadarType extends AbstractSurveillanceRadarType implements Serializable {
    ...
    @ManyToMany(targetEntity = PrimarySurveillanceRadarTimeSlicePropertyType.class, cascade = {
            CascadeType.ALL}, fetch = FetchType.EAGER)
    @JoinTable(name = "timeslice_primarysurveillanceradar_link", schema = "surveillance", joinColumns = {
            @JoinColumn(name = "timeslice", referencedColumnName = "hjid")}, inverseJoinColumns = {
                    @JoinColumn(name = "primarysurveillanceradartype", referencedColumnName = "hjid")})
     ...
     *
     */
    public void setTimeSlice(List<PrimarySurveillanceRadarTimeSlicePropertyType> timeSlice) {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final PrimarySurveillanceRadarType that = ((PrimarySurveillanceRadarType) object);
        {
            boolean lhsFieldIsSet = this.isSetTimeSlice();
            boolean rhsFieldIsSet = that.isSetTimeSlice();
            List<PrimarySurveillanceRadarTimeSlicePropertyType> lhsField;
            lhsField = (this.isSetTimeSlice() ? this.getTimeSlice() : null);
            List<PrimarySurveillanceRadarTimeSlicePropertyType> rhsField;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = super.hashCode(locator, strategy);
        {
            ...
            List<PrimarySurveillanceRadarTimeSlicePropertyType> theField;
