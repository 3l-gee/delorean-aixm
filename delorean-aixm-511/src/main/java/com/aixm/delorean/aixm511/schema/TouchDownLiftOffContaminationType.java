    ...
    implements Serializable
{
    ...
    @JoinTable(name = "touchdownliftoffcontaminationtype_criticalridge_link", schema = "public", joinColumns = {
        @JoinColumn(name = "touchdownliftoffcontaminationtype_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "touchdownliftoffcontaminationtype_layer_link", schema = "public", joinColumns = {
        @JoinColumn(name = "touchdownliftoffcontaminationtype_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "touchdownliftoffcontaminationtype_annotation_link", schema = "public", joinColumns = {
        @JoinColumn(name = "touchdownliftoffcontaminationtype_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinColumn(name = "touchdownliftoffcontamination_e_hjid", referencedColumnName = "hjid")
