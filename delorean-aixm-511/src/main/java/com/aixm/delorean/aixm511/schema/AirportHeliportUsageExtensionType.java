...
@XmlType(name = "", propOrder = {"abstractUsageConditionExtension", "abstractAirportHeliportUsageExtension"})
@Entity(name = "AirportHeliportUsageExtensionType")
@Table(name = "airportheliportusage_oe", schema = "airport_heliport")
public class AirportHeliportUsageExtensionType implements Serializable, Equals, HashCode, ToString {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final AirportHeliportUsageExtensionType that = ((AirportHeliportUsageExtensionType) object);
        {
            ...
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "abstractAirportHeliportUsageExtension",
                    lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "abstractAirportHeliportUsageExtension",
                    rhsField);
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetAbstractAirportHeliportUsageExtension();
            AbstractExtensionType theField;
            theField = this.getAbstractAirportHeliportUsageExtension();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "abstractAirportHeliportUsageExtension",
                    theField);
            currentHashCode = strategy.hashCode(theFieldLocator, currentHashCode, theField, theFieldIsSet);
        }
        {
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        }
        {
            ...
            AbstractExtensionType theField;
            theField = this.getAbstractAirportHeliportUsageExtension();
            strategy.appendField(locator, this, "abstractAirportHeliportUsageExtension", buffer, theField,
                    theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetOwns();
