...
/**
 * <p>
 * Java class for VisualGlideSlopeIndicatorType complex type
 * </p>
 * .
 *
 * <p>
...
"{http://www.aixm.aero/schema/5.1.1}VisualGlideSlopeIndicatorTimeSlicePropertyType" maxOccurs
="unbounded"/>
 *       </sequence>
 *     </extension>
 *   </complexContent>
...
@XmlType(name = "VisualGlideSlopeIndicatorType", propOrder = {"timeSlice"})
@Entity(name = "VisualGlideSlopeIndicatorType")
@Table(name = "visualglideslopeindicator", schema = "airport_heliport")
public class VisualGlideSlopeIndicatorType extends AbstractGroundLightSystemType implements Serializable {
     ...
     *
     */
    @ManyToMany(targetEntity = VisualGlideSlopeIndicatorTimeSlicePropertyType.class, cascade = {
            CascadeType.ALL}, fetch = FetchType.EAGER)
    @JoinTable(name = "timeslice_visualglideslopeindicator_link", schema = "airport_heliport", joinColumns = {
            @JoinColumn(name = "timeslice", referencedColumnName = "hjid")}, inverseJoinColumns = {
                    @JoinColumn(name = "visualglideslopeindicatortype", referencedColumnName = "hjid")})
     ...
     *
     */
    public void setTimeSlice(List<VisualGlideSlopeIndicatorTimeSlicePropertyType> timeSlice) {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final VisualGlideSlopeIndicatorType that = ((VisualGlideSlopeIndicatorType) object);
        {
            boolean lhsFieldIsSet = this.isSetTimeSlice();
            boolean rhsFieldIsSet = that.isSetTimeSlice();
            List<VisualGlideSlopeIndicatorTimeSlicePropertyType> lhsField;
            lhsField = (this.isSetTimeSlice() ? this.getTimeSlice() : null);
            List<VisualGlideSlopeIndicatorTimeSlicePropertyType> rhsField;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = super.hashCode(locator, strategy);
        {
            ...
            List<VisualGlideSlopeIndicatorTimeSlicePropertyType> theField;
