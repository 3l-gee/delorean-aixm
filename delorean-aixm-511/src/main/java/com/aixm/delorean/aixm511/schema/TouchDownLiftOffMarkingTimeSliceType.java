    ...
    implements Serializable
{
    ...
    @JoinTable(name = "touchdownliftoffmarking_t_element_link", schema = "public", joinColumns = {
    ...
    @JoinTable(name = "touchdownliftoffmarking_t_annotation_link", schema = "public", joinColumns = {
        @JoinColumn(name = "touchdownliftoffmarking_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinColumn(name = "touchdownliftoffmarking_e_hjid", referencedColumnName = "hjid")
    ...
    @JoinTable(name = "touchdownliftoffmarking_t_markedtouchdownliftoff_link", schema = "public", joinColumns = {
        @JoinColumn(name = "touchdownliftoffmarking_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
