...
/**
 * <p>
 * Java class for DeicingAreaMarkingType complex type
 * </p>
 * .
 *
 * <p>
...
"{http://www.aixm.aero/schema/5.1.1}DeicingAreaMarkingTimeSlicePropertyType" maxOccurs
="unbounded"/>
 *       </sequence>
 *     </extension>
 *   </complexContent>
...
@XmlType(name = "DeicingAreaMarkingType", propOrder = {"timeSlice"})
@Entity(name = "DeicingAreaMarkingType")
@Table(name = "deicingareamarking_f", schema = "airport_heliport")
public class DeicingAreaMarkingType extends AbstractMarkingType implements Serializable {
    ...
    @OneToMany(targetEntity = DeicingAreaMarkingTimeSlicePropertyType.class, cascade = {
     ...
     *
     */
    public void setTimeSlice(List<DeicingAreaMarkingTimeSlicePropertyType> timeSlice) {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final DeicingAreaMarkingType that = ((DeicingAreaMarkingType) object);
        {
            boolean lhsFieldIsSet = this.isSetTimeSlice();
            boolean rhsFieldIsSet = that.isSetTimeSlice();
            List<DeicingAreaMarkingTimeSlicePropertyType> lhsField;
            lhsField = (this.isSetTimeSlice() ? this.getTimeSlice() : null);
            List<DeicingAreaMarkingTimeSlicePropertyType> rhsField;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = super.hashCode(locator, strategy);
        {
            ...
            List<DeicingAreaMarkingTimeSlicePropertyType> theField;
