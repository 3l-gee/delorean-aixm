...
/**
 * <p>
 * Java class for ArrivalFeederLegType complex type
 * </p>
 * .
 *
 * <p>
...
"{http://www.aixm.aero/schema/5.1.1}ArrivalFeederLegTimeSlicePropertyType" maxOccurs
="unbounded"/>
 *       </sequence>
 *     </extension>
 *   </complexContent>
...
@XmlType(name = "ArrivalFeederLegType", propOrder = {"timeSlice"})
@Entity(name = "ArrivalFeederLegType")
@Table(name = "arrivalfeederleg", schema = "procedure")
public class ArrivalFeederLegType extends AbstractApproachLegType implements Serializable {
     ...
     *
     */
    @ManyToMany(targetEntity = ArrivalFeederLegTimeSlicePropertyType.class, cascade = {
            CascadeType.ALL}, fetch = FetchType.EAGER)
    @JoinTable(name = "timeslice_arrivalfeederleg_link", schema = "procedure", joinColumns = {
            @JoinColumn(name = "timeslice", referencedColumnName = "hjid")}, inverseJoinColumns = {
                    @JoinColumn(name = "arrivalfeederlegtype", referencedColumnName = "hjid")})
     ...
     *
     */
    public void setTimeSlice(List<ArrivalFeederLegTimeSlicePropertyType> timeSlice) {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final ArrivalFeederLegType that = ((ArrivalFeederLegType) object);
        {
            boolean lhsFieldIsSet = this.isSetTimeSlice();
            boolean rhsFieldIsSet = that.isSetTimeSlice();
            List<ArrivalFeederLegTimeSlicePropertyType> lhsField;
            lhsField = (this.isSetTimeSlice() ? this.getTimeSlice() : null);
            List<ArrivalFeederLegTimeSlicePropertyType> rhsField;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = super.hashCode(locator, strategy);
        {
            ...
            List<ArrivalFeederLegTimeSlicePropertyType> theField;
