 ...
 *       <sequence>
 *         <group ref=
"{http://www.aixm.aero/schema/5.1.1}AirportSuppliesServicePropertyGroup"/>
...
public class AirportSuppliesServiceTimeSliceType extends AbstractAIXMTimeSliceType implements Serializable {
     ...
     *
     */
    @ManyToMany(targetEntity = FuelPropertyType.class, cascade = {CascadeType.ALL}, fetch = FetchType.EAGER)
    @JoinTable(name = "fuelsupply_airportsuppliesservice_link", schema = "service", joinColumns = {
            @JoinColumn(name = "fuelsupply", referencedColumnName = "hjid")}, inverseJoinColumns = {
                    @JoinColumn(name = "airportsuppliesservicepropertygroup", referencedColumnName = "hjid")})
     ...
     *
     */
    @ManyToMany(targetEntity = OilPropertyType.class, cascade = {CascadeType.ALL}, fetch = FetchType.EAGER)
    @JoinTable(name = "oilsupply_airportsuppliesservice_link", schema = "service", joinColumns = {
            @JoinColumn(name = "oilsupply", referencedColumnName = "hjid")}, inverseJoinColumns = {
                    @JoinColumn(name = "airportsuppliesservicepropertygroup", referencedColumnName = "hjid")})
     ...
     *
     */
    @ManyToMany(targetEntity = NitrogenPropertyType.class, cascade = {CascadeType.ALL}, fetch = FetchType.EAGER)
    @JoinTable(name = "nitrogensupply_airportsuppliesservice_link", schema = "service", joinColumns = {
            @JoinColumn(name = "nitrogensupply", referencedColumnName = "hjid")}, inverseJoinColumns = {
                    @JoinColumn(name = "airportsuppliesservicepropertygroup", referencedColumnName = "hjid")})
     ...
     *
     */
    @ManyToMany(targetEntity = OxygenPropertyType.class, cascade = {CascadeType.ALL}, fetch = FetchType.EAGER)
    @JoinTable(name = "oxygensupply_airportsuppliesservice_link", schema = "service", joinColumns = {
            @JoinColumn(name = "oxygensupply", referencedColumnName = "hjid")}, inverseJoinColumns = {
                    @JoinColumn(name = "airportsuppliesservicepropertygroup", referencedColumnName = "hjid")})
