 ...
 *       <sequence>
 *         <group ref=
"{http://www.aixm.aero/schema/5.1.1}ProcedureTransitionLegPropertyGroup"/>
...
public class ProcedureTransitionLegType extends AbstractAIXMObjectType implements Serializable {
     ...
     *
     */
    @ManyToOne(targetEntity = SegmentLegPropertyType.class, cascade = {CascadeType.ALL}, fetch = FetchType.EAGER)
    ...
    @AttributeOverrides({@AttributeOverride(name = "value", column = @Column(name = "seqnumberarinc")),
            @AttributeOverride(name = "nilReason", column = @Column(name = "seqnumberarinc_nilreason"))})
