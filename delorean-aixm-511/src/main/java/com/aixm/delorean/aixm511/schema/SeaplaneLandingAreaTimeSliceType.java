 ...
 *       <sequence>
 *         <group ref=
"{http://www.aixm.aero/schema/5.1.1}SeaplaneLandingAreaPropertyGroup"/>
...
public class SeaplaneLandingAreaTimeSliceType extends AbstractAIXMTimeSliceType implements Serializable {
     ...
     *
     */
    @ManyToMany(targetEntity = SeaplaneRampSitePropertyType.class, cascade = {CascadeType.ALL}, fetch = FetchType.EAGER)
    @JoinTable(name = "rampsite_seaplanelandingarea_link", schema = "airport_heliport", joinColumns = {
            @JoinColumn(name = "rampsite", referencedColumnName = "hjid")}, inverseJoinColumns = {
     ...
     *
     */
    @ManyToMany(targetEntity = FloatingDockSitePropertyType.class, cascade = {CascadeType.ALL}, fetch = FetchType.EAGER)
    @JoinTable(name = "docksite_seaplanelandingarea_link", schema = "airport_heliport", joinColumns = {
            @JoinColumn(name = "docksite", referencedColumnName = "hjid")}, inverseJoinColumns = {
                    @JoinColumn(name = "seaplanelandingareapropertygroup", referencedColumnName = "hjid")})
