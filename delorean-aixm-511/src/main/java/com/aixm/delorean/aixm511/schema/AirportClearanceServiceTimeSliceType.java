 ...
 *         <element name="snowPlan" type="{http://www.aixm.aero/schema/5.1.1}TextInstructionType" minOccurs="0"/>
 *         <element name="extension" maxOccurs="unbounded" minOccurs="0">
 *           <complexType>
 *             <complexContent>
 *               <restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 <choice>
 *                   <element ref="{http://www.aixm.aero/schema/5.1.1}AbstractAirportClearanceServiceExtension"/>
    ...
    implements Serializable
{
    ...
    @JoinTable(name = "airportclearanceservice_t_call-sign_link", schema = "public", joinColumns = {
    ...
    @JoinTable(name = "airportclearanceservice_t_radiocommunication_link", schema = "public", joinColumns = {
        @JoinColumn(name = "airportclearanceservice_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "airportclearanceservice_t_groundcommunication_link", schema = "public", joinColumns = {
        @JoinColumn(name = "airportclearanceservice_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "airportclearanceservice_t_availability_link", schema = "public", joinColumns = {
        @JoinColumn(name = "airportclearanceservice_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "airportclearanceservice_t_annotation_link", schema = "public", joinColumns = {
        @JoinColumn(name = "airportclearanceservice_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "airportclearanceservice_t_airportheliport_link", schema = "public", joinColumns = {
        @JoinColumn(name = "airportclearanceservice_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinColumn(name = "airportclearanceservice_e_hjid", referencedColumnName = "hjid")
    ...
    public void setFlightOperationsItem(CodeFlightDestinationType target) {
        setFlightOperations(XmlAdapterUtils.marshallJAXBElement(CodeFlightDestinationType.class, new QName("http://www.aixm.aero/schema/5.1.1", "flightOperations"), AirportClearanceServiceTimeSliceType.class, target));
    }
    ...
    public void setRankItem(CodeFacilityRankingType target) {
        setRank(XmlAdapterUtils.marshallJAXBElement(CodeFacilityRankingType.class, new QName("http://www.aixm.aero/schema/5.1.1", "rank"), AirportClearanceServiceTimeSliceType.class, target));
    }
    ...
    public void setCompliantICAOItem(CodeYesNoType target) {
        setCompliantICAO(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class, new QName("http://www.aixm.aero/schema/5.1.1", "compliantICAO"), AirportClearanceServiceTimeSliceType.class, target));
    }
    ...
    public void setAixmNameItem(TextNameType target) {
        setAixmName(XmlAdapterUtils.marshallJAXBElement(TextNameType.class, new QName("http://www.aixm.aero/schema/5.1.1", "name"), AirportClearanceServiceTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = AIXMElevatedPointPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "airportclearanceservice_t_location_link", schema = "public", joinColumns = {
        @JoinColumn(name = "airportclearanceservice_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setLocationItem(AIXMElevatedPointPropertyType target) {
        setLocation(XmlAdapterUtils.marshallJAXBElement(AIXMElevatedPointPropertyType.class, new QName("http://www.aixm.aero/schema/5.1.1", "location"), AirportClearanceServiceTimeSliceType.class, target));
    }

    @OneToOne(targetEntity = UnitPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "airportclearanceservice_t_serviceprovider_link", schema = "public", joinColumns = {
        @JoinColumn(name = "airportclearanceservice_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setServiceProviderItem(UnitPropertyType target) {
        setServiceProvider(XmlAdapterUtils.marshallJAXBElement(UnitPropertyType.class, new QName("http://www.aixm.aero/schema/5.1.1", "serviceProvider"), AirportClearanceServiceTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "snowplan")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "snowplan_nilreason"))
    })
    ...
    public void setSnowPlanItem(TextInstructionType target) {
        setSnowPlan(XmlAdapterUtils.marshallJAXBElement(TextInstructionType.class, new QName("http://www.aixm.aero/schema/5.1.1", "snowPlan"), AirportClearanceServiceTimeSliceType.class, target));
    }
