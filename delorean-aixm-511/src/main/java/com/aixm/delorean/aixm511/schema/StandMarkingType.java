...
/**
 * <p>
 * Java class for StandMarkingType complex type
 * </p>
 * .
 *
 * <p>
 ...
 *
 * <pre>{@code
 * <complexType name="StandMarkingType">
 *   <complexContent>
 *     <extension base="{http://www.aixm.aero/schema/5.1.1}AbstractMarkingType">
 *       <sequence>
 *         <element name="timeSlice" type=
"{http://www.aixm.aero/schema/5.1.1}StandMarkingTimeSlicePropertyType" maxOccurs
="unbounded"/>
 *       </sequence>
 *     </extension>
 *   </complexContent>
...
@XmlType(name = "StandMarkingType", propOrder = {"timeSlice"})
@Entity(name = "StandMarkingType")
@Table(name = "standmarking", schema = "airport_heliport")
public class StandMarkingType extends AbstractMarkingType implements Serializable {
     ...
     * {@link StandMarkingTimeSlicePropertyType }
     *
     *
     */
    @Filter(name = "TSPHjidFilter", condition = "hjid IN (:ids)")
    @ManyToMany(targetEntity = StandMarkingTimeSlicePropertyType.class, cascade = {
            CascadeType.ALL}, fetch = FetchType.EAGER)
    @JoinTable(name = "timeslice_standmarking_link", schema = "airport_heliport", joinColumns = {
            @JoinColumn(name = "timeslice", referencedColumnName = "hjid")}, inverseJoinColumns = {
                    @JoinColumn(name = "standmarkingtype", referencedColumnName = "hjid")})
    public List<StandMarkingTimeSlicePropertyType> getTimeSlice() {
        if (timeSlice == null) {
     ...
     *
     */
    public void setTimeSlice(List<StandMarkingTimeSlicePropertyType> timeSlice) {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final StandMarkingType that = ((StandMarkingType) object);
        {
            boolean lhsFieldIsSet = this.isSetTimeSlice();
            boolean rhsFieldIsSet = that.isSetTimeSlice();
            List<StandMarkingTimeSlicePropertyType> lhsField;
            lhsField = (this.isSetTimeSlice() ? this.getTimeSlice() : null);
            List<StandMarkingTimeSlicePropertyType> rhsField;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = super.hashCode(locator, strategy);
        {
            ...
            List<StandMarkingTimeSlicePropertyType> theField;
