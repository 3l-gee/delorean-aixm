...
/**
 * <p>
 * Java class for ConditionCombinationPropertyType complex type
 * </p>
 * .
 *
 * <p>
 ...
 *       <sequence>
 *         <element ref=
"{http://www.aixm.aero/schema/5.1.1}ConditionCombination"/>
 *       </sequence>
 *     </extension>
 *   </complexContent>
 * </complexType>
...
@XmlType(name = "ConditionCombinationPropertyType", propOrder = {"conditionCombination"})
@Entity(name = "ConditionCombinationPropertyType")
@Table(name = "conditioncombination_pt", schema = "airport_heliport")
public class ConditionCombinationPropertyType extends AbstractAIXMPropertyType implements Serializable {
     ...
     *
     * @return possible object is {@link ConditionCombinationType }
     *
     */
    @OneToOne(targetEntity = ConditionCombinationType.class, cascade = {CascadeType.ALL}, fetch = FetchType.EAGER)
     ...
     *
     * @param value
     *            allowed object is {@link ConditionCombinationType }
     *
     */
