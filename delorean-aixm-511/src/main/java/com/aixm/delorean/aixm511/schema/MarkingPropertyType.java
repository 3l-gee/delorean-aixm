...
/**
 * <p>Java class for MarkingPropertyType complex type</p>.
 * 
...
@XmlType(name = "MarkingPropertyType")
@Entity(name = "MarkingPropertyType")
@Table(name = "markingpropertytype", schema = "airport_heliport")
public class MarkingPropertyType implements Serializable, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        final MarkingPropertyType that = ((MarkingPropertyType) object);
        {
