...
/**
 * <p>
 * Java class for ArrestingGearType complex type
 * </p>
 * .
 *
 * <p>
...
"{http://www.aixm.aero/schema/5.1.1}ArrestingGearTimeSlicePropertyType" maxOccurs
="unbounded"/>
 *       </sequence>
 *     </extension>
 *   </complexContent>
...
@XmlType(name = "ArrestingGearType", propOrder = {"timeSlice"})
@Entity(name = "ArrestingGearType")
@Table(name = "arrestinggear", schema = "airport_heliport")
public class ArrestingGearType extends AbstractAIXMFeatureType implements Serializable {
    ...
    @ManyToMany(targetEntity = ArrestingGearTimeSlicePropertyType.class, cascade = {
            CascadeType.ALL}, fetch = FetchType.EAGER)
    @JoinTable(name = "timeslice_arrestinggear_link", schema = "airport_heliport", joinColumns = {
            @JoinColumn(name = "timeslice", referencedColumnName = "hjid")}, inverseJoinColumns = {
                    @JoinColumn(name = "arrestinggeartype", referencedColumnName = "hjid")})
