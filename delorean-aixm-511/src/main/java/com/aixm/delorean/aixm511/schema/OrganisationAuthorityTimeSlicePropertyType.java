...
/**
 * <p>
 * Java class for OrganisationAuthorityTimeSlicePropertyType complex type
 * </p>
 * .
 *
 * <p>
 ...
 *       <sequence>
 *         <element ref=
"{http://www.aixm.aero/schema/5.1.1}OrganisationAuthorityTimeSlice"/>
 *       </sequence>
 *       <attGroup ref=
...
@XmlType(name = "OrganisationAuthorityTimeSlicePropertyType", propOrder = {"organisationAuthorityTimeSlice"})
...
public class OrganisationAuthorityTimeSlicePropertyType implements Serializable, Equals, HashCode, ToString {
     ...
     *
     * @return possible object is {@link OrganisationAuthorityTimeSliceType }
     *
     */
     ...
     *
     * @param value
     *            allowed object is {@link OrganisationAuthorityTimeSliceType }
     *
     */
    ...
    @Transient
    public boolean isSetOrganisationAuthorityTimeSlice() {
        return (this.organisationAuthorityTimeSlice != null);
    }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        }
        {
            ...
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "organisationAuthorityTimeSlice",
                    lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "organisationAuthorityTimeSlice",
                    rhsField);
            if (!strategy.equals(lhsFieldLocator, rhsFieldLocator, lhsField, rhsField, lhsFieldIsSet, rhsFieldIsSet)) {
                return false;
            }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetOrganisationAuthorityTimeSlice();
            OrganisationAuthorityTimeSliceType theField;
            theField = this.getOrganisationAuthorityTimeSlice();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "organisationAuthorityTimeSlice", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            OrganisationAuthorityTimeSliceType theField;
            theField = this.getOrganisationAuthorityTimeSlice();
            strategy.appendField(locator, this, "organisationAuthorityTimeSlice", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetOwns();
            boolean theField;
