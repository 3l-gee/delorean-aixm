...
/**
 * <p>Java class for DQ_ThematicClassificationCorrectness_PropertyType complex type</p>.
 * 
...
public class DQThematicClassificationCorrectnessPropertyType implements Serializable, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        }
        {
            ...
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "dqThematicClassificationCorrectness", lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "dqThematicClassificationCorrectness", rhsField);
            if (!strategy.equals(lhsFieldLocator, rhsFieldLocator, lhsField, rhsField, lhsFieldIsSet, rhsFieldIsSet)) {
                return false;
            }
        }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = 1;
        {
            ...
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "dqThematicClassificationCorrectness", theField);
