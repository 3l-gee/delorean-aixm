...
@XmlType(name = "", propOrder = {"abstractRulesProceduresExtension"})
@Entity(name = "RulesProceduresTimeSliceExtensionType")
@Table(name = "rulesprocedures_te", schema = "rules_procedure")
public class RulesProceduresTimeSliceExtensionType implements Serializable, Equals, HashCode, ToString {
    ...
    @JoinColumn(name = "abstractrulesproceduresextension_hjid", referencedColumnName = "hjid")
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final RulesProceduresTimeSliceExtensionType that = ((RulesProceduresTimeSliceExtensionType) object);
        {
            ...
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "abstractRulesProceduresExtension",
                    lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "abstractRulesProceduresExtension",
                    rhsField);
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetAbstractRulesProceduresExtension();
            AbstractExtensionType theField;
            theField = this.getAbstractRulesProceduresExtension();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "abstractRulesProceduresExtension",
                    theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            AbstractExtensionType theField;
            theField = this.getAbstractRulesProceduresExtension();
            strategy.appendField(locator, this, "abstractRulesProceduresExtension", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetOwns();
            boolean theField;
