 ...
 *       <sequence>
 *         <element ref=
"{http://www.aixm.aero/schema/5.1.1}AbstractRunwayVisualRangeExtension"/>
 *       </sequence>
 *       <attGroup ref=
...
@XmlType(name = "", propOrder = {"abstractRunwayVisualRangeExtension"})
@Entity(name = "RunwayVisualRangeTimeSliceExtensionType")
@Table(name = "runwayvisualrange_te", schema = "airport_heliport")
public class RunwayVisualRangeTimeSliceExtensionType implements Serializable, Equals, HashCode, ToString {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final RunwayVisualRangeTimeSliceExtensionType that = ((RunwayVisualRangeTimeSliceExtensionType) object);
        {
        ...
        }
        {
            ...
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "abstractRunwayVisualRangeExtension",
                    lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "abstractRunwayVisualRangeExtension",
                    rhsField);
            if (!strategy.equals(lhsFieldLocator, rhsFieldLocator, lhsField, rhsField, lhsFieldIsSet, rhsFieldIsSet)) {
                return false;
            }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetAbstractRunwayVisualRangeExtension();
            AbstractExtensionType theField;
            theField = this.getAbstractRunwayVisualRangeExtension();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "abstractRunwayVisualRangeExtension",
                    theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            AbstractExtensionType theField;
            theField = this.getAbstractRunwayVisualRangeExtension();
            strategy.appendField(locator, this, "abstractRunwayVisualRangeExtension", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetOwns();
            boolean theField;
