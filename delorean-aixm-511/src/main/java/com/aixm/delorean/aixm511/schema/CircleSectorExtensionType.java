...
@XmlType(name = "", propOrder = {"abstractCircleSectorExtension"})
@Entity(name = "CircleSectorExtensionType")
@Table(name = "circlesector_oe", schema = "shared")
public class CircleSectorExtensionType implements Serializable, Equals, HashCode, ToString {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final CircleSectorExtensionType that = ((CircleSectorExtensionType) object);
        {
            ...
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "abstractCircleSectorExtension",
                    lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "abstractCircleSectorExtension",
                    rhsField);
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetAbstractCircleSectorExtension();
            AbstractExtensionType theField;
            theField = this.getAbstractCircleSectorExtension();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "abstractCircleSectorExtension", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            AbstractExtensionType theField;
            theField = this.getAbstractCircleSectorExtension();
            strategy.appendField(locator, this, "abstractCircleSectorExtension", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetOwns();
            boolean theField;
