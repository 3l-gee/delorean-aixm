...
/**
 * <p>Java class for ApronPropertyType complex type</p>.
 * 
...
@XmlType(name = "ApronPropertyType")
@Entity(name = "ApronPropertyType")
@Table(name = "apronpropertytype", schema = "airport_heliport")
public class ApronPropertyType implements Serializable, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        final ApronPropertyType that = ((ApronPropertyType) object);
        {
