...
/**
 * <p>
 * Java class for RadioFrequencyAreaType complex type
 * </p>
 * .
 *
 * <p>
 ...
 *
 * <pre>{@code
 * <complexType name="RadioFrequencyAreaType">
 *   <complexContent>
 *     <extension base=
"{http://www.aixm.aero/schema/5.1.1}AbstractAIXMFeatureType">
 *       <sequence>
 *         <element name="timeSlice" type=
"{http://www.aixm.aero/schema/5.1.1}RadioFrequencyAreaTimeSlicePropertyType" maxOccurs
="unbounded"/>
 *       </sequence>
 *     </extension>
 *   </complexContent>
...
@XmlType(name = "RadioFrequencyAreaType", propOrder = {"timeSlice"})
@Entity(name = "RadioFrequencyAreaType")
@Table(name = "radiofrequencyarea", schema = "shared")
public class RadioFrequencyAreaType extends AbstractAIXMFeatureType implements Serializable {
     ...
     * {@link RadioFrequencyAreaTimeSlicePropertyType }
     *
     *
     */
    @ManyToMany(targetEntity = RadioFrequencyAreaTimeSlicePropertyType.class, cascade = {
            CascadeType.ALL}, fetch = FetchType.EAGER)
    @JoinTable(name = "timeslice_radiofrequencyarea_link", schema = "shared", joinColumns = {
            @JoinColumn(name = "timeslice", referencedColumnName = "hjid")}, inverseJoinColumns = {
                    @JoinColumn(name = "radiofrequencyareatype", referencedColumnName = "hjid")})
    public List<RadioFrequencyAreaTimeSlicePropertyType> getTimeSlice() {
        if (timeSlice == null) {
     ...
     *
     */
    public void setTimeSlice(List<RadioFrequencyAreaTimeSlicePropertyType> timeSlice) {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final RadioFrequencyAreaType that = ((RadioFrequencyAreaType) object);
        {
            boolean lhsFieldIsSet = this.isSetTimeSlice();
            boolean rhsFieldIsSet = that.isSetTimeSlice();
            List<RadioFrequencyAreaTimeSlicePropertyType> lhsField;
            lhsField = (this.isSetTimeSlice() ? this.getTimeSlice() : null);
            List<RadioFrequencyAreaTimeSlicePropertyType> rhsField;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = super.hashCode(locator, strategy);
        {
            ...
            List<RadioFrequencyAreaTimeSlicePropertyType> theField;
