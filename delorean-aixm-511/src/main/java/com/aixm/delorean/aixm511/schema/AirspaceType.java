...
/**
 * <p>
 * Java class for AirspaceType complex type
 * </p>
 * .
 *
 * <p>
...
"{http://www.aixm.aero/schema/5.1.1}AirspaceTimeSlicePropertyType" maxOccurs=
"unbounded"/>
 *       </sequence>
 *     </extension>
 *   </complexContent>
...
@XmlType(name = "AirspaceType", propOrder = {"timeSlice"})
@Entity(name = "AirspaceType")
@Table(name = "airspace", schema = "airspace")
public class AirspaceType extends AbstractAIXMFeatureType implements Serializable {
    ...
    @ManyToMany(targetEntity = AirspaceTimeSlicePropertyType.class, cascade = {
            CascadeType.ALL}, fetch = FetchType.EAGER)
    @JoinTable(name = "timeslice_airspace_link", schema = "airspace", joinColumns = {
            @JoinColumn(name = "timeslice", referencedColumnName = "hjid")}, inverseJoinColumns = {
                    @JoinColumn(name = "airspacetype", referencedColumnName = "hjid")})
     ...
     *
     */
    public void setTimeSlice(List<AirspaceTimeSlicePropertyType> timeSlice) {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = super.hashCode(locator, strategy);
        {
            ...
            List<AirspaceTimeSlicePropertyType> theField;
