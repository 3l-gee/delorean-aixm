 ...
 *       <sequence>
 *         <group ref=
"{http://www.aixm.aero/schema/5.1.1}RunwayCentrelinePointPropertyGroup"/>
...
public class RunwayCentrelinePointTimeSliceType extends AbstractAIXMTimeSliceType implements Serializable {
    ...
    @JoinTable(name = "associateddeclareddistance_runwaycentrelinepoint_link", schema = "airport_heliport", joinColumns = {
            @JoinColumn(name = "associateddeclareddistance", referencedColumnName = "hjid")}, inverseJoinColumns = {
