 ...
 *       <sequence>
 *         <group ref=
"{http://www.aixm.aero/schema/5.1.1}NavaidComponentPropertyGroup"/>
...
public class NavaidComponentType extends AbstractAIXMObjectType implements Serializable {
     ...
     *
     */
    @ManyToOne(targetEntity = NavaidEquipmentPropertyType.class, cascade = {CascadeType.ALL}, fetch = FetchType.EAGER)
