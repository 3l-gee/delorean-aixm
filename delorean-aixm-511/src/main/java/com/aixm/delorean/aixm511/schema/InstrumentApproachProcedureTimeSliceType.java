...
"{http://www.aixm.aero/schema/5.1.1}CodeDesignStandardType" minOccurs="0"/>
 *         <element name="codingStandard" type=
"{http://www.aixm.aero/schema/5.1.1}CodeProcedureCodingStandardType" minOccurs=
"0"/>
...
"{http://www.aixm.aero/schema/5.1.1}ProcedureAvailabilityPropertyType" maxOccurs
...
"{http://www.aixm.aero/schema/5.1.1}ProcedureTransitionPropertyType" maxOccurs=
"unbounded" minOccurs="0"/>
 *         <choice>
 *           <element name="guidanceFacility_specialNavigationSystem" type=
"{http://www.aixm.aero/schema/5.1.1}SpecialNavigationSystemPropertyType" minOccurs
="0"/>
 *           <element name="guidanceFacility_radar" type=
"{http://www.aixm.aero/schema/5.1.1}RadarSystemPropertyType" minOccurs="0"/>
...
"{http://www.aixm.aero/schema/5.1.1}SafeAltitudeAreaPropertyType" minOccurs=
"0"/>
 *         <element name="approachPrefix" type=
"{http://www.aixm.aero/schema/5.1.1}CodeApproachPrefixType" minOccurs="0"/>
 *         <element name="approachType" type=
"{http://www.aixm.aero/schema/5.1.1}CodeApproachType" minOccurs="0"/>
...
"{http://www.aixm.aero/schema/5.1.1}CodeApproachEquipmentAdditionalType" minOccurs
="0"/>
 *         <element name="channelGNSS" type=
"{http://www.aixm.aero/schema/5.1.1}ValChannelNumberType" minOccurs="0"/>
 *         <element name="WAASReliable" type=
"{http://www.aixm.aero/schema/5.1.1}CodeYesNoType" minOccurs="0"/>
 *         <element name="landing" type=
"{http://www.aixm.aero/schema/5.1.1}LandingTakeoffAreaCollectionPropertyType" minOccurs
="0"/>
 *         <element name="missedInstruction" type=
"{http://www.aixm.aero/schema/5.1.1}MissedApproachGroupPropertyType" maxOccurs=
"unbounded" minOccurs="0"/>
 *         <element name="finalProfile" type=
"{http://www.aixm.aero/schema/5.1.1}FinalProfilePropertyType" minOccurs="0"/>
 ...
 *                 <choice>
 *                   <element ref=
"{http://www.aixm.aero/schema/5.1.1}AbstractInstrumentApproachProcedureExtension"/>
 *                   <element ref=
...
@XmlType(name = "InstrumentApproachProcedureTimeSliceType", propOrder = {"communicationFailureInstruction",
        ...
        "airportHeliport", "aircraftCharacteristic", "flightTransition", "guidanceFacilitySpecialNavigationSystem",
        "guidanceFacilityRadar", "guidanceFacilityNavaid", "annotation", "safeAltitude", "approachPrefix",
        "approachType", "multipleIdentification", "copterTrack", "circlingIdentification", "courseReversalInstruction",
        "additionalEquipment", "channelGNSS", "waasReliable", "landing", "missedInstruction", "finalProfile",
        "extension"})
...
public class InstrumentApproachProcedureTimeSliceType extends AbstractAIXMTimeSliceType implements Serializable {
    ...
    public void setCommunicationFailureInstructionItem(TextInstructionType target) {
        setCommunicationFailureInstruction(XmlAdapterUtils.marshallJAXBElement(TextInstructionType.class,
                new QName("http://www.aixm.aero/schema/5.1.1", "communicationFailureInstruction"),
    ...
    public void setInstructionItem(TextInstructionType target) {
        setInstruction(XmlAdapterUtils.marshallJAXBElement(TextInstructionType.class,
                new QName("http://www.aixm.aero/schema/5.1.1", "instruction"),
                InstrumentApproachProcedureTimeSliceType.class, target));
    }
    ...
    public void setDesignCriteriaItem(CodeDesignStandardType target) {
        setDesignCriteria(XmlAdapterUtils.marshallJAXBElement(CodeDesignStandardType.class,
                new QName("http://www.aixm.aero/schema/5.1.1", "designCriteria"),
                InstrumentApproachProcedureTimeSliceType.class, target));
    }
    ...
    public void setCodingStandardItem(CodeProcedureCodingStandardType target) {
        setCodingStandard(XmlAdapterUtils.marshallJAXBElement(CodeProcedureCodingStandardType.class,
                new QName("http://www.aixm.aero/schema/5.1.1", "codingStandard"),
                InstrumentApproachProcedureTimeSliceType.class, target));
    }
    ...
    public void setAixmNameItem(TextNameType target) {
        setAixmName(XmlAdapterUtils.marshallJAXBElement(TextNameType.class,
                new QName("http://www.aixm.aero/schema/5.1.1", "name"), InstrumentApproachProcedureTimeSliceType.class,
                target));
    }
    ...
    public void setRNAVItem(CodeYesNoType target) {
        setRNAV(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class,
                new QName("http://www.aixm.aero/schema/5.1.1", "RNAV"), InstrumentApproachProcedureTimeSliceType.class,
                target));
    }
    ...
    public void setGuidanceFacilitySpecialNavigationSystemItem(SpecialNavigationSystemPropertyType target) {
        setGuidanceFacilitySpecialNavigationSystem(
                XmlAdapterUtils.marshallJAXBElement(SpecialNavigationSystemPropertyType.class,
                        new QName("http://www.aixm.aero/schema/5.1.1", "guidanceFacility_specialNavigationSystem"),
                        InstrumentApproachProcedureTimeSliceType.class, target));
    }
    ...
    public void setGuidanceFacilityRadarItem(RadarSystemPropertyType target) {
        setGuidanceFacilityRadar(XmlAdapterUtils.marshallJAXBElement(RadarSystemPropertyType.class,
                new QName("http://www.aixm.aero/schema/5.1.1", "guidanceFacility_radar"),
                InstrumentApproachProcedureTimeSliceType.class, target));
    }
    ...
    public void setGuidanceFacilityNavaidItem(NavaidPropertyType target) {
        setGuidanceFacilityNavaid(XmlAdapterUtils.marshallJAXBElement(NavaidPropertyType.class,
                new QName("http://www.aixm.aero/schema/5.1.1", "guidanceFacility_navaid"),
                InstrumentApproachProcedureTimeSliceType.class, target));
    }
    ...
    public void setSafeAltitudeItem(SafeAltitudeAreaPropertyType target) {
        setSafeAltitude(XmlAdapterUtils.marshallJAXBElement(SafeAltitudeAreaPropertyType.class,
                new QName("http://www.aixm.aero/schema/5.1.1", "safeAltitude"),
                InstrumentApproachProcedureTimeSliceType.class, target));
    }
    ...
    public void setApproachPrefixItem(CodeApproachPrefixType target) {
        setApproachPrefix(XmlAdapterUtils.marshallJAXBElement(CodeApproachPrefixType.class,
                new QName("http://www.aixm.aero/schema/5.1.1", "approachPrefix"),
                InstrumentApproachProcedureTimeSliceType.class, target));
    }
    ...
    public void setApproachTypeItem(CodeApproachType target) {
        setApproachType(XmlAdapterUtils.marshallJAXBElement(CodeApproachType.class,
                new QName("http://www.aixm.aero/schema/5.1.1", "approachType"),
                InstrumentApproachProcedureTimeSliceType.class, target));
    }
    ...
    public void setMultipleIdentificationItem(CodeUpperAlphaType target) {
        setMultipleIdentification(XmlAdapterUtils.marshallJAXBElement(CodeUpperAlphaType.class,
                new QName("http://www.aixm.aero/schema/5.1.1", "multipleIdentification"),
                InstrumentApproachProcedureTimeSliceType.class, target));
    }
    ...
    public void setCopterTrackItem(ValBearingType target) {
        setCopterTrack(XmlAdapterUtils.marshallJAXBElement(ValBearingType.class,
                new QName("http://www.aixm.aero/schema/5.1.1", "copterTrack"),
                InstrumentApproachProcedureTimeSliceType.class, target));
    }
    ...
    public void setCirclingIdentificationItem(CodeUpperAlphaType target) {
        setCirclingIdentification(XmlAdapterUtils.marshallJAXBElement(CodeUpperAlphaType.class,
                new QName("http://www.aixm.aero/schema/5.1.1", "circlingIdentification"),
                InstrumentApproachProcedureTimeSliceType.class, target));
    }
    ...
    public void setCourseReversalInstructionItem(TextInstructionType target) {
        setCourseReversalInstruction(XmlAdapterUtils.marshallJAXBElement(TextInstructionType.class,
                new QName("http://www.aixm.aero/schema/5.1.1", "courseReversalInstruction"),
                InstrumentApproachProcedureTimeSliceType.class, target));
    }
    ...
    public void setAdditionalEquipmentItem(CodeApproachEquipmentAdditionalType target) {
        setAdditionalEquipment(XmlAdapterUtils.marshallJAXBElement(CodeApproachEquipmentAdditionalType.class,
                new QName("http://www.aixm.aero/schema/5.1.1", "additionalEquipment"),
                InstrumentApproachProcedureTimeSliceType.class, target));
    }
    ...
    public void setChannelGNSSItem(ValChannelNumberType target) {
        setChannelGNSS(XmlAdapterUtils.marshallJAXBElement(ValChannelNumberType.class,
                new QName("http://www.aixm.aero/schema/5.1.1", "channelGNSS"),
                InstrumentApproachProcedureTimeSliceType.class, target));
    }
    ...
    public void setWAASReliableItem(CodeYesNoType target) {
        setWAASReliable(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class,
                new QName("http://www.aixm.aero/schema/5.1.1", "WAASReliable"),
                InstrumentApproachProcedureTimeSliceType.class, target));
    }
    ...
    public void setLandingItem(LandingTakeoffAreaCollectionPropertyType target) {
        setLanding(XmlAdapterUtils.marshallJAXBElement(LandingTakeoffAreaCollectionPropertyType.class,
                new QName("http://www.aixm.aero/schema/5.1.1", "landing"),
                InstrumentApproachProcedureTimeSliceType.class, target));
    }
    ...
    public void setFinalProfileItem(FinalProfilePropertyType target) {
        setFinalProfile(XmlAdapterUtils.marshallJAXBElement(FinalProfilePropertyType.class,
                new QName("http://www.aixm.aero/schema/5.1.1", "finalProfile"),
                InstrumentApproachProcedureTimeSliceType.class, target));
    }
