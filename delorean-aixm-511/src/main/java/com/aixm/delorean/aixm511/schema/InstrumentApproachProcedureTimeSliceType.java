 ...
 *       <sequence>
 *         <group ref=
"{http://www.aixm.aero/schema/5.1.1}InstrumentApproachProcedurePropertyGroup"/>
...
public class InstrumentApproachProcedureTimeSliceType extends AbstractAIXMTimeSliceType implements Serializable {
    ...
    @JoinTable(name = "aircraftcharacteristic_instrumentapproachprocedure_link", schema = "procedure", joinColumns = {
            @JoinColumn(name = "aircraftcharacteristic", referencedColumnName = "hjid")}, inverseJoinColumns = {
                    @JoinColumn(name = "instrumentapproachprocedurepropertygroup", referencedColumnName = "hjid")})
    ...
    @JoinTable(name = "flighttransition_instrumentapproachprocedure_link", schema = "procedure", joinColumns = {
            @JoinColumn(name = "flighttransition", referencedColumnName = "hjid")}, inverseJoinColumns = {
                    @JoinColumn(name = "instrumentapproachprocedurepropertygroup", referencedColumnName = "hjid")})
    ...
    @JoinTable(name = "missedinstruction_instrumentapproachprocedure_link", schema = "procedure", joinColumns = {
            @JoinColumn(name = "missedinstruction", referencedColumnName = "hjid")}, inverseJoinColumns = {
                    @JoinColumn(name = "instrumentapproachprocedurepropertygroup", referencedColumnName = "hjid")})
    ...
    @OneToMany(targetEntity = InstrumentApproachProcedureExtensionType.class, cascade = {
            CascadeType.ALL}, fetch = FetchType.EAGER)
    @JoinColumn(name = "EXTENSION_INSTRUMENT_APPROAC_0")
    ...
    @ManyToOne(targetEntity = RadarSystemPropertyType.class, cascade = {CascadeType.ALL}, fetch = FetchType.EAGER)
    ...
    @ManyToOne(targetEntity = SafeAltitudeAreaPropertyType.class, cascade = {CascadeType.ALL}, fetch = FetchType.EAGER)
    ...
    @ManyToOne(targetEntity = FinalProfilePropertyType.class, cascade = {CascadeType.ALL}, fetch = FetchType.EAGER)
