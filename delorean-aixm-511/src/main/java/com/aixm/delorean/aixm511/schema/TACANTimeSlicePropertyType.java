...
@Table(name = "tacan_tsp", schema = "navaids_point")
public class TACANTimeSlicePropertyType implements Serializable, Equals, HashCode, ToString
{
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetTACANTimeSlice();
            TACANTimeSliceType theField;
            theField = this.getTACANTimeSlice();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "tacanTimeSlice", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            TACANTimeSliceType theField;
            theField = this.getTACANTimeSlice();
            strategy.appendField(locator, this, "tacanTimeSlice", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetOwns();
            boolean theField;
