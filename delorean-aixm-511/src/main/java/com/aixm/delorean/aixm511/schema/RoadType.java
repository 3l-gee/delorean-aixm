...
"{http://www.aixm.aero/schema/5.1.1}RoadTimeSlicePropertyType" maxOccurs=
"unbounded"/>
 *       </sequence>
 *     </extension>
 *   </complexContent>
...
@XmlType(name = "RoadType", propOrder = {"timeSlice"})
@Entity(name = "RoadType")
@Table(name = "road", schema = "airport_heliport")
public class RoadType extends AbstractAIXMFeatureType implements Serializable {
     ...
     * {@link RoadTimeSlicePropertyType }
     *
     *
     */
    @ManyToMany(targetEntity = RoadTimeSlicePropertyType.class, cascade = {CascadeType.ALL}, fetch = FetchType.EAGER)
    @JoinTable(name = "timeslice_road_link", schema = "airport_heliport", joinColumns = {
            @JoinColumn(name = "timeslice", referencedColumnName = "hjid")}, inverseJoinColumns = {
                    @JoinColumn(name = "roadtype", referencedColumnName = "hjid")})
    public List<RoadTimeSlicePropertyType> getTimeSlice() {
        if (timeSlice == null) {
     ...
     *
     */
    public void setTimeSlice(List<RoadTimeSlicePropertyType> timeSlice) {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final RoadType that = ((RoadType) object);
        {
            ...
            List<RoadTimeSlicePropertyType> lhsField;
            lhsField = (this.isSetTimeSlice() ? this.getTimeSlice() : null);
            List<RoadTimeSlicePropertyType> rhsField;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = super.hashCode(locator, strategy);
        {
            ...
            List<RoadTimeSlicePropertyType> theField;
