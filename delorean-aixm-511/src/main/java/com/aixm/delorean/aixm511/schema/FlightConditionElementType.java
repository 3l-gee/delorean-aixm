 ...
 *       <sequence>
 *         <group ref=
"{http://www.aixm.aero/schema/5.1.1}FlightConditionElementPropertyGroup"/>
...
public class FlightConditionElementType extends AbstractAIXMObjectType implements Serializable {
    ...
    @ManyToOne(targetEntity = MeteorologyPropertyType.class, cascade = {CascadeType.ALL}, fetch = FetchType.EAGER)
    ...
    @ManyToOne(targetEntity = DirectFlightPropertyType.class, cascade = {CascadeType.ALL}, fetch = FetchType.EAGER)
