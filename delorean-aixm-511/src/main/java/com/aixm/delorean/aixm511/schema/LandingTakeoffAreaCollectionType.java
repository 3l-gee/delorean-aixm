 ...
 *       <sequence>
 *         <group ref=
"{http://www.aixm.aero/schema/5.1.1}LandingTakeoffAreaCollectionPropertyGroup"/>
...
@XmlType(name = "LandingTakeoffAreaCollectionType", propOrder = {"runway", "tlof", "annotation", "extension"})
...
public class LandingTakeoffAreaCollectionType extends AbstractAIXMObjectType implements Serializable {
    ...
    @JoinTable(name = "runway_landingtakeoffareacollection_link", schema = "procedure", joinColumns = {
            @JoinColumn(name = "runway", referencedColumnName = "hjid")}, inverseJoinColumns = {
    ...
    @JoinTable(name = "tlof_landingtakeoffareacollection_link", schema = "procedure", joinColumns = {
            @JoinColumn(name = "tlof", referencedColumnName = "hjid")}, inverseJoinColumns = {
                    @JoinColumn(name = "landingtakeoffareacollectionpropertygroup", referencedColumnName = "hjid")})
