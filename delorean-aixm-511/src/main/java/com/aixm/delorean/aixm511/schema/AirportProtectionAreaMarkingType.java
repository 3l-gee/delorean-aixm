...
/**
 * <p>
 * Java class for AirportProtectionAreaMarkingType complex type
 * </p>
 * .
 *
 * <p>
...
"{http://www.aixm.aero/schema/5.1.1}AirportProtectionAreaMarkingTimeSlicePropertyType" maxOccurs
="unbounded"/>
 *       </sequence>
 *     </extension>
 *   </complexContent>
...
@XmlType(name = "AirportProtectionAreaMarkingType", propOrder = {"timeSlice"})
@Entity(name = "AirportProtectionAreaMarkingType")
@Table(name = "airportprotectionareamarking_f", schema = "airport_heliport")
public class AirportProtectionAreaMarkingType extends AbstractMarkingType implements Serializable {
    ...
    @OneToMany(targetEntity = AirportProtectionAreaMarkingTimeSlicePropertyType.class, cascade = {
     ...
     *
     */
    public void setTimeSlice(List<AirportProtectionAreaMarkingTimeSlicePropertyType> timeSlice) {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final AirportProtectionAreaMarkingType that = ((AirportProtectionAreaMarkingType) object);
        {
            boolean lhsFieldIsSet = this.isSetTimeSlice();
            boolean rhsFieldIsSet = that.isSetTimeSlice();
            List<AirportProtectionAreaMarkingTimeSlicePropertyType> lhsField;
            lhsField = (this.isSetTimeSlice() ? this.getTimeSlice() : null);
            List<AirportProtectionAreaMarkingTimeSlicePropertyType> rhsField;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = super.hashCode(locator, strategy);
        {
            ...
            List<AirportProtectionAreaMarkingTimeSlicePropertyType> theField;
