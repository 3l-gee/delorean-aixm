 ...
 *       <sequence>
 *         <group ref=
"{http://www.aixm.aero/schema/5.1.1}PassengerLoadingBridgePropertyGroup"/>
...
public class PassengerLoadingBridgeTimeSliceType extends AbstractAIXMTimeSliceType implements Serializable {
    ...
    @JoinTable(name = "associatedstand_passengerloadingbridge_link", schema = "airport_heliport", joinColumns = {
            @JoinColumn(name = "associatedstand", referencedColumnName = "hjid")}, inverseJoinColumns = {
    ...
    @JoinColumn(name = "EXTENSION_PASSENGER_LOADING__0")
