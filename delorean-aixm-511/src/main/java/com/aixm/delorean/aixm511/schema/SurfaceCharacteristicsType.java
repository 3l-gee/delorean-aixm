    ...
    implements Serializable
{
    ...
    @JoinTable(name = "surfacecharacteristics_o_annotation_link", schema = "public", joinColumns = {
    ...
    @JoinColumn(name = "surfacecharacteristics_e_hjid", referencedColumnName = "hjid")
