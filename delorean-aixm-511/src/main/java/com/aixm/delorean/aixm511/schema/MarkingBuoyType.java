...
/**
 * <p>
 * Java class for MarkingBuoyType complex type
 * </p>
 * .
 *
 * <p>
 ...
 *
 * <pre>{@code
 * <complexType name="MarkingBuoyType">
 *   <complexContent>
 *     <extension base=
"{http://www.aixm.aero/schema/5.1.1}AbstractAIXMFeatureType">
 *       <sequence>
 *         <element name="timeSlice" type=
"{http://www.aixm.aero/schema/5.1.1}MarkingBuoyTimeSlicePropertyType" maxOccurs=
"unbounded"/>
 *       </sequence>
 *     </extension>
 *   </complexContent>
...
@XmlType(name = "MarkingBuoyType", propOrder = {"timeSlice"})
@Entity(name = "MarkingBuoyType")
@Table(name = "markingbuoy", schema = "airport_heliport")
public class MarkingBuoyType extends AbstractAIXMFeatureType implements Serializable {
     ...
     * {@link MarkingBuoyTimeSlicePropertyType }
     *
     *
     */
    @Filter(name = "TSPHjidFilter", condition = "hjid IN (:ids)")
    @ManyToMany(targetEntity = MarkingBuoyTimeSlicePropertyType.class, cascade = {
            CascadeType.ALL}, fetch = FetchType.EAGER)
    @JoinTable(name = "timeslice_markingbuoy_link", schema = "airport_heliport", joinColumns = {
            @JoinColumn(name = "timeslice", referencedColumnName = "hjid")}, inverseJoinColumns = {
                    @JoinColumn(name = "markingbuoytype", referencedColumnName = "hjid")})
    public List<MarkingBuoyTimeSlicePropertyType> getTimeSlice() {
        if (timeSlice == null) {
     ...
     *
     */
    public void setTimeSlice(List<MarkingBuoyTimeSlicePropertyType> timeSlice) {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final MarkingBuoyType that = ((MarkingBuoyType) object);
        {
            boolean lhsFieldIsSet = this.isSetTimeSlice();
            boolean rhsFieldIsSet = that.isSetTimeSlice();
            List<MarkingBuoyTimeSlicePropertyType> lhsField;
            lhsField = (this.isSetTimeSlice() ? this.getTimeSlice() : null);
            List<MarkingBuoyTimeSlicePropertyType> rhsField;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = super.hashCode(locator, strategy);
        {
            ...
            List<MarkingBuoyTimeSlicePropertyType> theField;
