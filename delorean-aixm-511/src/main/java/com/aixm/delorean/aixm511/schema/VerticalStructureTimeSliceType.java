 ...
 *       <sequence>
 *         <group ref=
"{http://www.aixm.aero/schema/5.1.1}VerticalStructurePropertyGroup"/>
 ...
 *                 <sequence>
 *                   <element ref=
"{http://www.aixm.aero/schema/5.1.1}AbstractVerticalStructureExtension"/>
 *                 </sequence>
 *                 <attGroup ref=
...
@XmlType(name = "VerticalStructureTimeSliceType", propOrder = {"aixmName", "type", "lighted", "markingICAOStandard",
        ...
        "hostedUnit", "hostedOrganisation", "supportedService", "annotation", "lightingAvailability", "extension"})
...
public class VerticalStructureTimeSliceType extends AbstractAIXMTimeSliceType implements Serializable {
    ...
    @JoinTable(name = "part_verticalstructure_link", schema = "obstacle", joinColumns = {
            @JoinColumn(name = "part", referencedColumnName = "hjid")}, inverseJoinColumns = {
     ...
     *
     */
    @ManyToMany(targetEntity = PassengerServicePropertyType.class, cascade = {CascadeType.ALL}, fetch = FetchType.EAGER)
    @JoinTable(name = "hostedpassengerservice_verticalstructure_link", schema = "obstacle", joinColumns = {
            @JoinColumn(name = "hostedpassengerservice", referencedColumnName = "hjid")}, inverseJoinColumns = {
                    @JoinColumn(name = "verticalstructurepropertygroup", referencedColumnName = "hjid")})
    ...
    @JoinTable(name = "supportedgroundlight_verticalstructure_link", schema = "obstacle", joinColumns = {
            @JoinColumn(name = "supportedgroundlight", referencedColumnName = "hjid")}, inverseJoinColumns = {
                    @JoinColumn(name = "verticalstructurepropertygroup", referencedColumnName = "hjid")})
     ...
     *
     */
    @ManyToMany(targetEntity = NavaidEquipmentPropertyType.class, cascade = {CascadeType.ALL}, fetch = FetchType.EAGER)
    @JoinTable(name = "hostednavaidequipment_verticalstructure_link", schema = "obstacle", joinColumns = {
            @JoinColumn(name = "hostednavaidequipment", referencedColumnName = "hjid")}, inverseJoinColumns = {
                    @JoinColumn(name = "verticalstructurepropertygroup", referencedColumnName = "hjid")})
    ...
    @JoinTable(name = "hostedspecialnavstation_verticalstructure_link", schema = "obstacle", joinColumns = {
            @JoinColumn(name = "hostedspecialnavstation", referencedColumnName = "hjid")}, inverseJoinColumns = {
                    @JoinColumn(name = "verticalstructurepropertygroup", referencedColumnName = "hjid")})
     ...
     *
     */
    @ManyToMany(targetEntity = UnitPropertyType.class, cascade = {CascadeType.ALL}, fetch = FetchType.EAGER)
    @JoinTable(name = "hostedunit_verticalstructure_link", schema = "obstacle", joinColumns = {
            @JoinColumn(name = "hostedunit", referencedColumnName = "hjid")}, inverseJoinColumns = {
                    @JoinColumn(name = "verticalstructurepropertygroup", referencedColumnName = "hjid")})
    ...
    @JoinTable(name = "hostedorganisation_verticalstructure_link", schema = "obstacle", joinColumns = {
            @JoinColumn(name = "hostedorganisation", referencedColumnName = "hjid")}, inverseJoinColumns = {
                    @JoinColumn(name = "verticalstructurepropertygroup", referencedColumnName = "hjid")})
     ...
     *
     */
    @ManyToMany(targetEntity = ServicePropertyType.class, cascade = {CascadeType.ALL}, fetch = FetchType.EAGER)
    @JoinTable(name = "supportedservice_verticalstructure_link", schema = "obstacle", joinColumns = {
            @JoinColumn(name = "supportedservice", referencedColumnName = "hjid")}, inverseJoinColumns = {
                    @JoinColumn(name = "verticalstructurepropertygroup", referencedColumnName = "hjid")})
    ...
    @JoinTable(name = "lightingavailability_verticalstructure_link", schema = "obstacle", joinColumns = {
            @JoinColumn(name = "lightingavailability", referencedColumnName = "hjid")}, inverseJoinColumns = {
                    @JoinColumn(name = "verticalstructurepropertygroup", referencedColumnName = "hjid")})
    ...
    @OneToMany(targetEntity = VerticalStructureExtensionType.class, cascade = {
            CascadeType.ALL}, fetch = FetchType.EAGER)
    @JoinColumn(name = "EXTENSION_VERTICAL_STRUCTURE_0")
    ...
    public void setAixmNameItem(TextNameType target) {
        setAixmName(XmlAdapterUtils.marshallJAXBElement(TextNameType.class,
                new QName("http://www.aixm.aero/schema/5.1.1", "name"), VerticalStructureTimeSliceType.class, target));
    }
    ...
    public void setTypeItem(CodeVerticalStructureType target) {
        setType(XmlAdapterUtils.marshallJAXBElement(CodeVerticalStructureType.class,
                new QName("http://www.aixm.aero/schema/5.1.1", "type"), VerticalStructureTimeSliceType.class, target));
    }
    ...
    public void setLightedItem(CodeYesNoType target) {
        setLighted(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class,
                new QName("http://www.aixm.aero/schema/5.1.1", "lighted"), VerticalStructureTimeSliceType.class,
                target));
    }
    ...
    public void setGroupItem(CodeYesNoType target) {
        setGroup(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class,
                new QName("http://www.aixm.aero/schema/5.1.1", "group"), VerticalStructureTimeSliceType.class, target));
    }
    ...
    public void setLengthItem(ValDistanceType target) {
        setLength(XmlAdapterUtils.marshallJAXBElement(ValDistanceType.class,
                new QName("http://www.aixm.aero/schema/5.1.1", "length"), VerticalStructureTimeSliceType.class,
                target));
    }
    ...
    public void setWidthItem(ValDistanceType target) {
        setWidth(XmlAdapterUtils.marshallJAXBElement(ValDistanceType.class,
                new QName("http://www.aixm.aero/schema/5.1.1", "width"), VerticalStructureTimeSliceType.class, target));
    }
    ...
    public void setRadiusItem(ValDistanceType target) {
        setRadius(XmlAdapterUtils.marshallJAXBElement(ValDistanceType.class,
                new QName("http://www.aixm.aero/schema/5.1.1", "radius"), VerticalStructureTimeSliceType.class,
                target));
    }
    ...
    public void setLightingICAOStandardItem(CodeYesNoType target) {
        setLightingICAOStandard(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class,
                new QName("http://www.aixm.aero/schema/5.1.1", "lightingICAOStandard"),
                VerticalStructureTimeSliceType.class, target));
    }
    ...
    public void setSynchronisedLightingItem(CodeYesNoType target) {
        setSynchronisedLighting(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class,
                new QName("http://www.aixm.aero/schema/5.1.1", "synchronisedLighting"),
                VerticalStructureTimeSliceType.class, target));
    }

    @ManyToOne(targetEntity = MarkerBeaconPropertyType.class, cascade = {CascadeType.ALL}, fetch = FetchType.EAGER)
    ...
    public void setMarkerItem(MarkerBeaconPropertyType target) {
        setMarker(XmlAdapterUtils.marshallJAXBElement(MarkerBeaconPropertyType.class,
                new QName("http://www.aixm.aero/schema/5.1.1", "marker"), VerticalStructureTimeSliceType.class,
                target));
    }
