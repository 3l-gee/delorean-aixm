...
/**
 * <p>Java class for TouchDownLiftOffPropertyType complex type</p>.
 * 
...
@XmlType(name = "TouchDownLiftOffPropertyType")
@Entity(name = "TouchDownLiftOffPropertyType")
@Table(name = "touchdownliftoffpropertytype", schema = "airport_heliport")
public class TouchDownLiftOffPropertyType implements Serializable, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        final TouchDownLiftOffPropertyType that = ((TouchDownLiftOffPropertyType) object);
        {
