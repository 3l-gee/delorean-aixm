...
="unbounded" minOccurs="0"/>
 *         <group ref=
"{http://www.aixm.aero/schema/5.1.1}ApronAreaAvailabilityPropertyGroup"/>
...
public class ApronAreaAvailabilityType extends AbstractPropertiesWithScheduleType implements Serializable {
     ...
     *
     */
    @ManyToMany(targetEntity = ApronAreaUsagePropertyType.class, cascade = {CascadeType.ALL}, fetch = FetchType.EAGER)
