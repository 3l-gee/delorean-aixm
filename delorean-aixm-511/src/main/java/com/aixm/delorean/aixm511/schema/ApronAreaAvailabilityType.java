...
"{http://www.aixm.aero/schema/5.1.1}ApronAreaUsagePropertyType" maxOccurs=
"unbounded" minOccurs="0"/>
 ...
 *                   <element ref=
"{http://www.aixm.aero/schema/5.1.1}AbstractApronAreaAvailabilityExtension"/>
 *                 </choice>
 *                 <attGroup ref=
...
public class ApronAreaAvailabilityType extends AbstractPropertiesWithScheduleType implements Serializable {
    ...
    public void setOperationalStatusItem(CodeStatusAirportType target) {
        setOperationalStatus(XmlAdapterUtils.marshallJAXBElement(CodeStatusAirportType.class,
                new QName("http://www.aixm.aero/schema/5.1.1", "operationalStatus"), ApronAreaAvailabilityType.class,
                target));
    }
    ...
    public void setWarningItem(CodeAirportWarningType target) {
        setWarning(XmlAdapterUtils.marshallJAXBElement(CodeAirportWarningType.class,
                new QName("http://www.aixm.aero/schema/5.1.1", "warning"), ApronAreaAvailabilityType.class, target));
    }
