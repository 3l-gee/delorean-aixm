...
/**
 * <p>
 * Java class for PassengerLoadingBridgeType complex type
 * </p>
 * .
 *
 * <p>
...
"{http://www.aixm.aero/schema/5.1.1}PassengerLoadingBridgeTimeSlicePropertyType" maxOccurs
="unbounded"/>
 *       </sequence>
 *     </extension>
 *   </complexContent>
...
@XmlType(name = "PassengerLoadingBridgeType", propOrder = {"timeSlice"})
@Entity(name = "PassengerLoadingBridgeType")
@Table(name = "passengerloadingbridge", schema = "airport_heliport")
public class PassengerLoadingBridgeType extends AbstractAIXMFeatureType implements Serializable {
     ...
     *
     */
    @ManyToMany(targetEntity = PassengerLoadingBridgeTimeSlicePropertyType.class, cascade = {
            CascadeType.ALL}, fetch = FetchType.EAGER)
    @JoinTable(name = "timeslice_passengerloadingbridge_link", schema = "airport_heliport", joinColumns = {
            @JoinColumn(name = "timeslice", referencedColumnName = "hjid")}, inverseJoinColumns = {
                    @JoinColumn(name = "passengerloadingbridgetype", referencedColumnName = "hjid")})
     ...
     *
     */
    public void setTimeSlice(List<PassengerLoadingBridgeTimeSlicePropertyType> timeSlice) {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final PassengerLoadingBridgeType that = ((PassengerLoadingBridgeType) object);
        {
            boolean lhsFieldIsSet = this.isSetTimeSlice();
            boolean rhsFieldIsSet = that.isSetTimeSlice();
            List<PassengerLoadingBridgeTimeSlicePropertyType> lhsField;
            lhsField = (this.isSetTimeSlice() ? this.getTimeSlice() : null);
            List<PassengerLoadingBridgeTimeSlicePropertyType> rhsField;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = super.hashCode(locator, strategy);
        {
            ...
            List<PassengerLoadingBridgeTimeSlicePropertyType> theField;
