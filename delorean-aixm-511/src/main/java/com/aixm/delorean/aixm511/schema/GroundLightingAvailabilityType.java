...
="unbounded" minOccurs="0"/>
 *         <group ref=
"{http://www.aixm.aero/schema/5.1.1}GroundLightingAvailabilityPropertyGroup"/>
 ...
 *                   <element ref=
"{http://www.aixm.aero/schema/5.1.1}AbstractGroundLightingAvailabilityExtension"/>
 *                 </choice>
 *                 <attGroup ref=
...
@Table(name = "groundlightingavailability", schema = "airport_heliport")
public class GroundLightingAvailabilityType extends AbstractPropertiesWithScheduleType implements Serializable {
    ...
    @JoinTable(name = "timeinterval_groundlightingavailability_link", schema = "airport_heliport", joinColumns = {
            @JoinColumn(name = "timeinterval", referencedColumnName = "hjid")}, inverseJoinColumns = {
                    @JoinColumn(name = "groundlightingavailabilitytype", referencedColumnName = "hjid")})
    ...
    @JoinTable(name = "annotation_groundlightingavailability_link", schema = "airport_heliport", joinColumns = {
    ...
    @JoinTable(name = "specialdateauthority_groundlightingavailability_link", schema = "airport_heliport", joinColumns = {
    ...
    @OneToMany(targetEntity = GroundLightingAvailabilityTypeExtensionType.class, cascade = {
            CascadeType.ALL}, fetch = FetchType.EAGER)
    @JoinColumn(name = "EXTENSION_GROUND_LIGHTING_AV_0")
    ...
    public void setOperationalStatusItem(CodeStatusOperationsType target) {
        setOperationalStatus(XmlAdapterUtils.marshallJAXBElement(CodeStatusOperationsType.class,
                ...
                GroundLightingAvailabilityType.class, target));
    }
