...
"{http://www.aixm.aero/schema/5.1.1}RouteTimeSlicePropertyType" maxOccurs=
"unbounded"/>
 *       </sequence>
 *     </extension>
 *   </complexContent>
...
@XmlType(name = "RouteType", propOrder = {"timeSlice"})
@Entity(name = "RouteType")
@Table(name = "route", schema = "route")
public class RouteType extends AbstractAIXMFeatureType implements Serializable {

    private static final long serialVersionUID = 20251104L;
    @XmlElement(required = true)
    protected List<RouteTimeSlicePropertyType> timeSlice;
     ...
     * {@link RouteTimeSlicePropertyType }
     *
     *
     */
    @ManyToMany(targetEntity = RouteTimeSlicePropertyType.class, cascade = {CascadeType.ALL}, fetch = FetchType.EAGER)
    @JoinTable(name = "timeslice_route_link", schema = "route", joinColumns = {
            @JoinColumn(name = "timeslice", referencedColumnName = "hjid")}, inverseJoinColumns = {
                    @JoinColumn(name = "routetype", referencedColumnName = "hjid")})
    public List<RouteTimeSlicePropertyType> getTimeSlice() {
        if (timeSlice == null) {
     ...
     *
     */
    public void setTimeSlice(List<RouteTimeSlicePropertyType> timeSlice) {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final RouteType that = ((RouteType) object);
        {
            ...
            List<RouteTimeSlicePropertyType> lhsField;
            lhsField = (this.isSetTimeSlice() ? this.getTimeSlice() : null);
            List<RouteTimeSlicePropertyType> rhsField;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = super.hashCode(locator, strategy);
        {
            ...
            List<RouteTimeSlicePropertyType> theField;
