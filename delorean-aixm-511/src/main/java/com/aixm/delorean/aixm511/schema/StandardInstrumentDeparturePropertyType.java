...
/**
 * <p>Java class for StandardInstrumentDeparturePropertyType complex type</p>.
 * 
...
@XmlType(name = "StandardInstrumentDeparturePropertyType")
@Entity(name = "StandardInstrumentDeparturePropertyType")
@Table(name = "standardinstrumentdeparturepropertytype", schema = "procedure")
public class StandardInstrumentDeparturePropertyType implements Serializable, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        final StandardInstrumentDeparturePropertyType that = ((StandardInstrumentDeparturePropertyType) object);
        {
