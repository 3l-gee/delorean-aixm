...
/**
 * <p>
 * Java class for NavaidType complex type
 * </p>
 * .
 *
 * <p>
...
"{http://www.aixm.aero/schema/5.1.1}NavaidTimeSlicePropertyType" maxOccurs=
"unbounded"/>
 *       </sequence>
 *     </extension>
 *   </complexContent>
...
@XmlType(name = "NavaidType", propOrder = {"timeSlice"})
@Entity(name = "NavaidType")
@Table(name = "navaid", schema = "navaids_point")
public class NavaidType extends AbstractAIXMFeatureType implements Serializable {
    ...
    @ManyToMany(targetEntity = NavaidTimeSlicePropertyType.class, cascade = {CascadeType.ALL}, fetch = FetchType.EAGER)
    @JoinTable(name = "timeslice_navaid_link", schema = "navaids_point", joinColumns = {
            @JoinColumn(name = "timeslice", referencedColumnName = "hjid")}, inverseJoinColumns = {
                    @JoinColumn(name = "navaidtype", referencedColumnName = "hjid")})
     ...
     *
     */
    public void setTimeSlice(List<NavaidTimeSlicePropertyType> timeSlice) {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = super.hashCode(locator, strategy);
        {
            ...
            List<NavaidTimeSlicePropertyType> theField;
