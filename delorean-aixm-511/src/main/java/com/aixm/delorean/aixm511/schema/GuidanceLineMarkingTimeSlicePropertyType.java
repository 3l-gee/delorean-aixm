...
/**
 * <p>
 * Java class for GuidanceLineMarkingTimeSlicePropertyType complex type
 * </p>
 * .
 *
 * <p>
 ...
 *       <sequence>
 *         <element ref=
"{http://www.aixm.aero/schema/5.1.1}GuidanceLineMarkingTimeSlice"/>
 *       </sequence>
 *       <attGroup ref=
...
@XmlType(name = "GuidanceLineMarkingTimeSlicePropertyType", propOrder = {"guidanceLineMarkingTimeSlice"})
...
public class GuidanceLineMarkingTimeSlicePropertyType implements Serializable, Equals, HashCode, ToString {
     ...
     *
     * @return possible object is {@link GuidanceLineMarkingTimeSliceType }
     *
     */
     ...
     *
     * @param value
     *            allowed object is {@link GuidanceLineMarkingTimeSliceType }
     *
     */
    ...
    @Transient
    public boolean isSetGuidanceLineMarkingTimeSlice() {
        return (this.guidanceLineMarkingTimeSlice != null);
    }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        }
        {
            ...
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "guidanceLineMarkingTimeSlice",
                    lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "guidanceLineMarkingTimeSlice",
                    rhsField);
            if (!strategy.equals(lhsFieldLocator, rhsFieldLocator, lhsField, rhsField, lhsFieldIsSet, rhsFieldIsSet)) {
                return false;
            }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetGuidanceLineMarkingTimeSlice();
            GuidanceLineMarkingTimeSliceType theField;
            theField = this.getGuidanceLineMarkingTimeSlice();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "guidanceLineMarkingTimeSlice", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            GuidanceLineMarkingTimeSliceType theField;
            theField = this.getGuidanceLineMarkingTimeSlice();
            strategy.appendField(locator, this, "guidanceLineMarkingTimeSlice", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetOwns();
            boolean theField;
