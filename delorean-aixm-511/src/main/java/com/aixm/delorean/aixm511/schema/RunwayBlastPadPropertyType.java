...
/**
 * <p>Java class for RunwayBlastPadPropertyType complex type</p>.
 * 
...
@XmlType(name = "RunwayBlastPadPropertyType")
@Entity(name = "RunwayBlastPadPropertyType")
@Table(name = "runwayblastpadpropertytype", schema = "airport_heliport")
public class RunwayBlastPadPropertyType implements Serializable, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        final RunwayBlastPadPropertyType that = ((RunwayBlastPadPropertyType) object);
        {
