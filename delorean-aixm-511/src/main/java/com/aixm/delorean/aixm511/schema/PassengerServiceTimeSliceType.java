    ...
    implements Serializable
{
    ...
    protected List<PassengerServiceExtensionType> extension;
    ...
    @JoinTable(name = "passengerservice_t_call-sign_link", schema = "public", joinColumns = {
    ...
    @JoinTable(name = "passengerservice_t_radiocommunication_link", schema = "public", joinColumns = {
        @JoinColumn(name = "passengerservice_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "passengerservice_t_groundcommunication_link", schema = "public", joinColumns = {
        @JoinColumn(name = "passengerservice_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "passengerservice_t_availability_link", schema = "public", joinColumns = {
        @JoinColumn(name = "passengerservice_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "passengerservice_t_annotation_link", schema = "public", joinColumns = {
        @JoinColumn(name = "passengerservice_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "passengerservice_t_airportheliport_link", schema = "public", joinColumns = {
        @JoinColumn(name = "passengerservice_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link PassengerServiceExtensionType }
     * 
     * 
     */
    @OneToMany(targetEntity = PassengerServiceExtensionType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinColumn(name = "passengerservice_e_hjid", referencedColumnName = "hjid")
    public List<PassengerServiceExtensionType> getExtension() {
        if (extension == null) {
     ...
     * 
     */
    public void setExtension(List<PassengerServiceExtensionType> extension) {
    ...
    @JoinTable(name = "passengerservice_t_location_link", schema = "public", joinColumns = {
        @JoinColumn(name = "passengerservice_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "passengerservice_t_serviceprovider_link", schema = "public", joinColumns = {
        @JoinColumn(name = "passengerservice_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        final PassengerServiceTimeSliceType that = ((PassengerServiceTimeSliceType) object);
        {
            ...
            List<PassengerServiceExtensionType> lhsField;
            lhsField = (this.isSetExtension()?this.getExtension():null);
            List<PassengerServiceExtensionType> rhsField;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        }
        {
            ...
            List<PassengerServiceExtensionType> theField;
