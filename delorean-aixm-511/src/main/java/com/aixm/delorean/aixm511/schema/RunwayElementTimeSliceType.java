 ...
 *       <sequence>
 *         <group ref=
"{http://www.aixm.aero/schema/5.1.1}RunwayElementPropertyGroup"/>
...
public class RunwayElementTimeSliceType extends AbstractAIXMTimeSliceType implements Serializable {
     ...
     *
     */
    @ManyToMany(targetEntity = RunwayPropertyType.class, cascade = {CascadeType.ALL}, fetch = FetchType.EAGER)
    @JoinTable(name = "associatedrunway_runwayelement_link", schema = "airport_heliport", joinColumns = {
            @JoinColumn(name = "associatedrunway", referencedColumnName = "hjid")}, inverseJoinColumns = {
