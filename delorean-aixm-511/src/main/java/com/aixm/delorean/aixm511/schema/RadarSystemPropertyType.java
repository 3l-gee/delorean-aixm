...
/**
 * <p>Java class for RadarSystemPropertyType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="RadarSystemPropertyType">
 *   <complexContent>
...
@XmlType(name = "RadarSystemPropertyType")
@Entity(name = "RadarSystemPropertyType")
@Table(name = "radarsystempropertytype", schema = "surveillance")
public class RadarSystemPropertyType implements Serializable, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        final RadarSystemPropertyType that = ((RadarSystemPropertyType) object);
        {
