...
@XmlType(name = "CityType", propOrder = {"aixmName", "annotation", "extension"})
@Entity(name = "CityType")
@Table(name = "city", schema = "airport_heliport")
public class CityType extends AbstractAIXMObjectType implements Serializable {
    ...
    @JoinTable(name = "annotation_city_link", schema = "airport_heliport", joinColumns = {
            @JoinColumn(name = "annotation", referencedColumnName = "hjid")}, inverseJoinColumns = {
                    @JoinColumn(name = "citypropertygroup", referencedColumnName = "hjid")})
    ...
    @JoinColumn(name = "EXTENSION_CITY_TYPE_HJID")
    ...
    public void setAixmNameItem(TextNameType target) {
        setAixmName(XmlAdapterUtils.marshallJAXBElement(TextNameType.class,
                new QName("http://www.aixm.aero/schema/5.1.1", "name"), CityType.class, target));
    }
