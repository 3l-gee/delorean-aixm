...
/**
 * <p>Java class for PilotControlledLightingPropertyType complex type</p>.
 * 
...
@XmlType(name = "PilotControlledLightingPropertyType")
@Entity(name = "PilotControlledLightingPropertyType")
@Table(name = "pilotcontrolledlightingpropertytype", schema = "service")
public class PilotControlledLightingPropertyType implements Serializable, Equals, HashCode, ToString
{
