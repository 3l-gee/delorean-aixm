...
@Entity(name = "RulesProceduresExtensionType")
@Table(name = "rulesprocedurese", schema = "rules_procedure")
public class RulesProceduresExtensionType implements Serializable, Equals, HashCode, ToString {
