...
@Entity(name = "ObstacleAreaExtensionType")
@Table(name = "obstacleareae", schema = "obstacle")
public class ObstacleAreaExtensionType implements Serializable, Equals, HashCode, ToString {
