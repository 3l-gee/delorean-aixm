...
@Table(name = "airportheliportcontamination_e", schema = "airport_heliport")
public class AirportHeliportContaminationTypeExtensionType implements Serializable, Equals, HashCode, ToString
{
    ...
    @JoinColumn(name = "abstractairportheliportcontaminationextension_hjid", referencedColumnName = "hjid")
