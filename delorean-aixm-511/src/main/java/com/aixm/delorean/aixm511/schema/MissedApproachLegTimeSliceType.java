...
/**
 * <p>
 * Java class for MissedApproachLegTimeSliceType complex type
 * </p>
 * .
 *
 * <p>
...
"{http://www.aixm.aero/schema/5.1.1}CodeMissedApproachType" minOccurs="0"/>
 *         <element name="thresholdAfterMAPT" type=
"{http://www.aixm.aero/schema/5.1.1}CodeYesNoType" minOccurs="0"/>
 *         <element name="heightMAPT" type=
"{http://www.aixm.aero/schema/5.1.1}ValDistanceVerticalType" minOccurs="0"/>
...
@XmlType(name = "MissedApproachLegTimeSliceType", propOrder = {"endConditionDesignator", "legPath", "legTypeARINC",
        "course", "courseType", "courseDirection", "turnDirection", "speedLimit", "speedReference",
        "speedInterpretation", "bankAngle", "length", "duration", "procedureTurnRequired", "upperLimitAltitude",
        "upperLimitReference", "lowerLimitAltitude", "lowerLimitReference", "altitudeInterpretation",
        "altitudeOverrideATC", "altitudeOverrideReference", "verticalAngle", "startPoint", "endPoint", "trajectory",
        "arcCentre", "angle", "distance", "aircraftCategory", "holding", "designSurface", "annotation", "approach",
        "type", "thresholdAfterMAPT", "heightMAPT", "requiredNavigationPerformance", "condition", "extension"})
@Entity(name = "MissedApproachLegTimeSliceType")
@Table(name = "missedapproachleg_t", schema = "procedure")
public class MissedApproachLegTimeSliceType extends AbstractAIXMTimeSliceType implements Serializable {
    ...
    @JoinTable(name = "mssdapprchlgtmslctp_arcrftctgr_link", schema = "procedure", joinColumns = {
            @JoinColumn(name = "missedapproachleg_t_hjid", referencedColumnName = "hjid")}, inverseJoinColumns = {
     ...
     *
     * @return possible object is {@link JAXBElement
     *         }{@code <}{@link CodeMissedApproachType }{@code >}
     *
     */
    @Transient
    ...
    public void setEndConditionDesignatorItem(CodeSegmentTerminationType target) {
        setEndConditionDesignator(XmlAdapterUtils.marshallJAXBElement(CodeSegmentTerminationType.class,
                new QName("http://www.aixm.aero/schema/5.1.1", "endConditionDesignator"),
                MissedApproachLegTimeSliceType.class, target));
    }
    ...
    public void setLegPathItem(CodeTrajectoryType target) {
        setLegPath(XmlAdapterUtils.marshallJAXBElement(CodeTrajectoryType.class,
                new QName("http://www.aixm.aero/schema/5.1.1", "legPath"), MissedApproachLegTimeSliceType.class,
                target));
    }
    ...
    public void setLegTypeARINCItem(CodeSegmentPathType target) {
        setLegTypeARINC(XmlAdapterUtils.marshallJAXBElement(CodeSegmentPathType.class,
                new QName("http://www.aixm.aero/schema/5.1.1", "legTypeARINC"), MissedApproachLegTimeSliceType.class,
                target));
    }
    ...
    public void setCourseItem(ValBearingType target) {
        setCourse(XmlAdapterUtils.marshallJAXBElement(ValBearingType.class,
                new QName("http://www.aixm.aero/schema/5.1.1", "course"), MissedApproachLegTimeSliceType.class,
                target));
    }
    ...
    public void setCourseTypeItem(CodeCourseType target) {
        setCourseType(XmlAdapterUtils.marshallJAXBElement(CodeCourseType.class,
                new QName("http://www.aixm.aero/schema/5.1.1", "courseType"), MissedApproachLegTimeSliceType.class,
                target));
    }
    ...
    public void setCourseDirectionItem(CodeDirectionReferenceType target) {
        setCourseDirection(XmlAdapterUtils.marshallJAXBElement(CodeDirectionReferenceType.class,
                new QName("http://www.aixm.aero/schema/5.1.1", "courseDirection"), MissedApproachLegTimeSliceType.class,
                target));
    }
    ...
    public void setTurnDirectionItem(CodeDirectionTurnType target) {
        setTurnDirection(XmlAdapterUtils.marshallJAXBElement(CodeDirectionTurnType.class,
                new QName("http://www.aixm.aero/schema/5.1.1", "turnDirection"), MissedApproachLegTimeSliceType.class,
                target));
    }
    ...
    public void setSpeedLimitItem(ValSpeedType target) {
        setSpeedLimit(XmlAdapterUtils.marshallJAXBElement(ValSpeedType.class,
                new QName("http://www.aixm.aero/schema/5.1.1", "speedLimit"), MissedApproachLegTimeSliceType.class,
                target));
    }
    ...
    public void setSpeedReferenceItem(CodeSpeedReferenceType target) {
        setSpeedReference(XmlAdapterUtils.marshallJAXBElement(CodeSpeedReferenceType.class,
                new QName("http://www.aixm.aero/schema/5.1.1", "speedReference"), MissedApproachLegTimeSliceType.class,
                target));
    }
    ...
    public void setSpeedInterpretationItem(CodeAltitudeUseType target) {
        setSpeedInterpretation(XmlAdapterUtils.marshallJAXBElement(CodeAltitudeUseType.class,
                new QName("http://www.aixm.aero/schema/5.1.1", "speedInterpretation"),
                MissedApproachLegTimeSliceType.class, target));
    }
    ...
    public void setBankAngleItem(ValAngleType target) {
        setBankAngle(XmlAdapterUtils.marshallJAXBElement(ValAngleType.class,
                new QName("http://www.aixm.aero/schema/5.1.1", "bankAngle"), MissedApproachLegTimeSliceType.class,
                target));
    }
    ...
    public void setLengthItem(ValDistanceType target) {
        setLength(XmlAdapterUtils.marshallJAXBElement(ValDistanceType.class,
                new QName("http://www.aixm.aero/schema/5.1.1", "length"), MissedApproachLegTimeSliceType.class,
                target));
    }
    ...
    public void setDurationItem(ValDurationType target) {
        setDuration(XmlAdapterUtils.marshallJAXBElement(ValDurationType.class,
                new QName("http://www.aixm.aero/schema/5.1.1", "duration"), MissedApproachLegTimeSliceType.class,
                target));
    }
    ...
    public void setProcedureTurnRequiredItem(CodeYesNoType target) {
        setProcedureTurnRequired(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class,
                new QName("http://www.aixm.aero/schema/5.1.1", "procedureTurnRequired"),
                MissedApproachLegTimeSliceType.class, target));
    }
    ...
    public void setUpperLimitAltitudeItem(ValDistanceVerticalType target) {
        setUpperLimitAltitude(XmlAdapterUtils.marshallJAXBElement(ValDistanceVerticalType.class,
                new QName("http://www.aixm.aero/schema/5.1.1", "upperLimitAltitude"),
                MissedApproachLegTimeSliceType.class, target));
    }
    ...
    public void setUpperLimitReferenceItem(CodeVerticalReferenceType target) {
        setUpperLimitReference(XmlAdapterUtils.marshallJAXBElement(CodeVerticalReferenceType.class,
                new QName("http://www.aixm.aero/schema/5.1.1", "upperLimitReference"),
                MissedApproachLegTimeSliceType.class, target));
    }
    ...
    public void setLowerLimitAltitudeItem(ValDistanceVerticalType target) {
        setLowerLimitAltitude(XmlAdapterUtils.marshallJAXBElement(ValDistanceVerticalType.class,
                new QName("http://www.aixm.aero/schema/5.1.1", "lowerLimitAltitude"),
                MissedApproachLegTimeSliceType.class, target));
    }
    ...
    public void setLowerLimitReferenceItem(CodeVerticalReferenceType target) {
        setLowerLimitReference(XmlAdapterUtils.marshallJAXBElement(CodeVerticalReferenceType.class,
                new QName("http://www.aixm.aero/schema/5.1.1", "lowerLimitReference"),
                MissedApproachLegTimeSliceType.class, target));
    }
    ...
    public void setAltitudeOverrideATCItem(ValDistanceVerticalType target) {
        setAltitudeOverrideATC(XmlAdapterUtils.marshallJAXBElement(ValDistanceVerticalType.class,
                new QName("http://www.aixm.aero/schema/5.1.1", "altitudeOverrideATC"),
                MissedApproachLegTimeSliceType.class, target));
    }
    ...
    public void setVerticalAngleItem(ValAngleType target) {
        setVerticalAngle(XmlAdapterUtils.marshallJAXBElement(ValAngleType.class,
                new QName("http://www.aixm.aero/schema/5.1.1", "verticalAngle"), MissedApproachLegTimeSliceType.class,
                target));
    }
    ...
    public void setStartPointItem(TerminalSegmentPointPropertyType target) {
        setStartPoint(XmlAdapterUtils.marshallJAXBElement(TerminalSegmentPointPropertyType.class,
                new QName("http://www.aixm.aero/schema/5.1.1", "startPoint"), MissedApproachLegTimeSliceType.class,
                target));
    }
    ...
    public void setEndPointItem(TerminalSegmentPointPropertyType target) {
        setEndPoint(XmlAdapterUtils.marshallJAXBElement(TerminalSegmentPointPropertyType.class,
                new QName("http://www.aixm.aero/schema/5.1.1", "endPoint"), MissedApproachLegTimeSliceType.class,
                target));
    }
    ...
    public void setTrajectoryItem(AIXMCurvePropertyType target) {
        setTrajectory(XmlAdapterUtils.marshallJAXBElement(AIXMCurvePropertyType.class,
                new QName("http://www.aixm.aero/schema/5.1.1", "trajectory"), MissedApproachLegTimeSliceType.class,
                target));
    }
    ...
    public void setArcCentreItem(TerminalSegmentPointPropertyType target) {
        setArcCentre(XmlAdapterUtils.marshallJAXBElement(TerminalSegmentPointPropertyType.class,
                new QName("http://www.aixm.aero/schema/5.1.1", "arcCentre"), MissedApproachLegTimeSliceType.class,
                target));
    }
    ...
    public void setAngleItem(AngleIndicationPropertyType target) {
        setAngle(XmlAdapterUtils.marshallJAXBElement(AngleIndicationPropertyType.class,
                new QName("http://www.aixm.aero/schema/5.1.1", "angle"), MissedApproachLegTimeSliceType.class, target));
    }
    ...
    public void setDistanceItem(DistanceIndicationPropertyType target) {
        setDistance(XmlAdapterUtils.marshallJAXBElement(DistanceIndicationPropertyType.class,
                new QName("http://www.aixm.aero/schema/5.1.1", "distance"), MissedApproachLegTimeSliceType.class,
                target));
    }
    ...
    public void setHoldingItem(HoldingUsePropertyType target) {
        setHolding(XmlAdapterUtils.marshallJAXBElement(HoldingUsePropertyType.class,
                new QName("http://www.aixm.aero/schema/5.1.1", "holding"), MissedApproachLegTimeSliceType.class,
                target));
    }
    ...
    public void setApproachItem(InstrumentApproachProcedurePropertyType target) {
        setApproach(XmlAdapterUtils.marshallJAXBElement(InstrumentApproachProcedurePropertyType.class,
                new QName("http://www.aixm.aero/schema/5.1.1", "approach"), MissedApproachLegTimeSliceType.class,
                target));
    }
    ...
    public void setTypeItem(CodeMissedApproachType target) {
        setType(XmlAdapterUtils.marshallJAXBElement(CodeMissedApproachType.class,
                new QName("http://www.aixm.aero/schema/5.1.1", "type"), MissedApproachLegTimeSliceType.class, target));
    }

    @Embedded
    @AttributeOverrides({@AttributeOverride(name = "value", column = @Column(name = "thresholdaftermapt")),
            @AttributeOverride(name = "nilReason", column = @Column(name = "thresholdaftermaptnilreason"))})
    ...
    public void setThresholdAfterMAPTItem(CodeYesNoType target) {
        setThresholdAfterMAPT(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class,
                new QName("http://www.aixm.aero/schema/5.1.1", "thresholdAfterMAPT"),
                MissedApproachLegTimeSliceType.class, target));
    }
    ...
    @AttributeOverrides({
            ...
            @AttributeOverride(name = "uom", column = @Column(name = "heightmaptuom")),
            @AttributeOverride(name = "nilReason", column = @Column(name = "heightmaptnilreason"))})
    ...
    public void setHeightMAPTItem(ValDistanceVerticalType target) {
        setHeightMAPT(XmlAdapterUtils.marshallJAXBElement(ValDistanceVerticalType.class,
                new QName("http://www.aixm.aero/schema/5.1.1", "heightMAPT"), MissedApproachLegTimeSliceType.class,
                target));
    }
