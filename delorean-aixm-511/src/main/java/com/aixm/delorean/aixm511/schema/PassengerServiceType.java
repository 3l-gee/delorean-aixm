...
/**
 * <p>
 * Java class for PassengerServiceType complex type
 * </p>
 * .
 *
 * <p>
...
"{http://www.aixm.aero/schema/5.1.1}PassengerServiceTimeSlicePropertyType" maxOccurs
="unbounded"/>
 *       </sequence>
 *     </extension>
 *   </complexContent>
...
@XmlType(name = "PassengerServiceType", propOrder = {"timeSlice"})
@Entity(name = "PassengerServiceType")
@Table(name = "passengerservice", schema = "service")
public class PassengerServiceType extends AbstractAirportGroundServiceType implements Serializable {
     ...
     *
     */
    @ManyToMany(targetEntity = PassengerServiceTimeSlicePropertyType.class, cascade = {
            CascadeType.ALL}, fetch = FetchType.EAGER)
    @JoinTable(name = "timeslice_passengerservice_link", schema = "service", joinColumns = {
            @JoinColumn(name = "timeslice", referencedColumnName = "hjid")}, inverseJoinColumns = {
                    @JoinColumn(name = "passengerservicetype", referencedColumnName = "hjid")})
     ...
     *
     */
    public void setTimeSlice(List<PassengerServiceTimeSlicePropertyType> timeSlice) {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final PassengerServiceType that = ((PassengerServiceType) object);
        {
            boolean lhsFieldIsSet = this.isSetTimeSlice();
            boolean rhsFieldIsSet = that.isSetTimeSlice();
            List<PassengerServiceTimeSlicePropertyType> lhsField;
            lhsField = (this.isSetTimeSlice() ? this.getTimeSlice() : null);
            List<PassengerServiceTimeSlicePropertyType> rhsField;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = super.hashCode(locator, strategy);
        {
            ...
            List<PassengerServiceTimeSlicePropertyType> theField;
