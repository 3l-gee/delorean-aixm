    ...
    implements Serializable
{
    ...
    @JoinTable(name = "terminalsegmentpointtype_facilitymakeup_link", schema = "public", joinColumns = {
        @JoinColumn(name = "terminalsegmentpointtype_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "terminalsegmentpointtype_annotation_link", schema = "public", joinColumns = {
        @JoinColumn(name = "terminalsegmentpointtype_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinColumn(name = "terminalsegmentpoint_e_hjid", referencedColumnName = "hjid")
    ...
    @JoinTable(name = "terminalsegmentpointtype_pointchoice_fixdesignatedpoint_link", schema = "public", joinColumns = {
        @JoinColumn(name = "terminalsegmentpointtype_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "terminalsegmentpointtype_pointchoice_navaidsystem_link", schema = "public", joinColumns = {
        @JoinColumn(name = "terminalsegmentpointtype_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "terminalsegmentpointtype_pointchoice_position_link", schema = "public", joinColumns = {
        @JoinColumn(name = "terminalsegmentpointtype_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "terminalsegmentpointtype_pointchoice_runwaypoint_link", schema = "public", joinColumns = {
        @JoinColumn(name = "terminalsegmentpointtype_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "terminalsegmentpointtype_pointchoice_aimingpoint_link", schema = "public", joinColumns = {
        @JoinColumn(name = "terminalsegmentpointtype_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "terminalsegmentpointtype_pointchoice_airportreferencepoint_link", schema = "public", joinColumns = {
        @JoinColumn(name = "terminalsegmentpointtype_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "terminalsegmentpointtype_extendedservicevolume_link", schema = "public", joinColumns = {
        @JoinColumn(name = "terminalsegmentpointtype_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
