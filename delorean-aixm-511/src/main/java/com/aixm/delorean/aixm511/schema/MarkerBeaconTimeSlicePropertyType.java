...
/**
 * <p>
 * Java class for MarkerBeaconTimeSlicePropertyType complex type
 * </p>
 * .
 *
 * <p>
 ...
 *       <sequence>
 *         <element ref=
"{http://www.aixm.aero/schema/5.1.1}MarkerBeaconTimeSlice"/>
 *       </sequence>
 *       <attGroup ref=
...
@XmlType(name = "MarkerBeaconTimeSlicePropertyType", propOrder = {"markerBeaconTimeSlice"})
...
public class MarkerBeaconTimeSlicePropertyType implements Serializable, Equals, HashCode, ToString {
     ...
     *
     * @return possible object is {@link MarkerBeaconTimeSliceType }
     *
     */
    @OneToOne(targetEntity = MarkerBeaconTimeSliceType.class, cascade = {CascadeType.ALL}, fetch = FetchType.EAGER)
     ...
     *
     * @param value
     *            allowed object is {@link MarkerBeaconTimeSliceType }
     *
     */
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetMarkerBeaconTimeSlice();
            MarkerBeaconTimeSliceType theField;
            theField = this.getMarkerBeaconTimeSlice();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "markerBeaconTimeSlice", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            MarkerBeaconTimeSliceType theField;
            theField = this.getMarkerBeaconTimeSlice();
            strategy.appendField(locator, this, "markerBeaconTimeSlice", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetOwns();
            boolean theField;
