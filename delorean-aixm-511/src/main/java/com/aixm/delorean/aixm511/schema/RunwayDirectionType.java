...
/**
 * <p>
 * Java class for RunwayDirectionType complex type
 * </p>
 * .
 *
 * <p>
...
"{http://www.aixm.aero/schema/5.1.1}RunwayDirectionTimeSlicePropertyType" maxOccurs
="unbounded"/>
 *       </sequence>
 *     </extension>
 *   </complexContent>
...
@XmlType(name = "RunwayDirectionType", propOrder = {"timeSlice"})
@Entity(name = "RunwayDirectionType")
@Table(name = "runwaydirection", schema = "airport_heliport")
public class RunwayDirectionType extends AbstractAIXMFeatureType implements Serializable {
    ...
    @ManyToMany(targetEntity = RunwayDirectionTimeSlicePropertyType.class, cascade = {
            CascadeType.ALL}, fetch = FetchType.EAGER)
    @JoinTable(name = "timeslice_runwaydirection_link", schema = "airport_heliport", joinColumns = {
            @JoinColumn(name = "timeslice", referencedColumnName = "hjid")}, inverseJoinColumns = {
                    @JoinColumn(name = "runwaydirectiontype", referencedColumnName = "hjid")})
     ...
     *
     */
    public void setTimeSlice(List<RunwayDirectionTimeSlicePropertyType> timeSlice) {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final RunwayDirectionType that = ((RunwayDirectionType) object);
        {
            boolean lhsFieldIsSet = this.isSetTimeSlice();
            boolean rhsFieldIsSet = that.isSetTimeSlice();
            List<RunwayDirectionTimeSlicePropertyType> lhsField;
            lhsField = (this.isSetTimeSlice() ? this.getTimeSlice() : null);
            List<RunwayDirectionTimeSlicePropertyType> rhsField;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = super.hashCode(locator, strategy);
        {
            ...
            List<RunwayDirectionTimeSlicePropertyType> theField;
