...
/**
 * <p>
 * Java class for ManoeuvringAreaAvailabilityType complex type
 * </p>
 * .
 *
 * <p>
...
="unbounded" minOccurs="0"/>
 *         <group ref=
"{http://www.aixm.aero/schema/5.1.1}ManoeuvringAreaAvailabilityPropertyGroup"/>
 ...
 *                   <element ref=
"{http://www.aixm.aero/schema/5.1.1}AbstractManoeuvringAreaAvailabilityExtension"/>
 *                 </choice>
 *                 <attGroup ref=
...
@Table(name = "manoeuvringareaavailability", schema = "airport_heliport")
public class ManoeuvringAreaAvailabilityType extends AbstractPropertiesWithScheduleType implements Serializable {
    ...
    @JoinTable(name = "timeinterval_manoeuvringareaavailability_link", schema = "airport_heliport", joinColumns = {
            @JoinColumn(name = "timeinterval", referencedColumnName = "hjid")}, inverseJoinColumns = {
                    @JoinColumn(name = "manoeuvringareaavailabilitytype", referencedColumnName = "hjid")})
    ...
    @JoinTable(name = "annotation_manoeuvringareaavailability_link", schema = "airport_heliport", joinColumns = {
    ...
    @JoinTable(name = "specialdateauthority_manoeuvringareaavailability_link", schema = "airport_heliport", joinColumns = {
     ...
     *
     */
    @ManyToMany(targetEntity = ManoeuvringAreaUsagePropertyType.class, cascade = {
            CascadeType.ALL}, fetch = FetchType.EAGER)
    @JoinTable(name = "usage_manoeuvringareaavailability_link", schema = "airport_heliport", joinColumns = {
            @JoinColumn(name = "usage", referencedColumnName = "hjid")}, inverseJoinColumns = {
                    @JoinColumn(name = "manoeuvringareaavailabilitypropertygroup", referencedColumnName = "hjid")})
    ...
    @OneToMany(targetEntity = ManoeuvringAreaAvailabilityTypeExtensionType.class, cascade = {
            CascadeType.ALL}, fetch = FetchType.EAGER)
    @JoinColumn(name = "EXTENSION_MANOEUVRING_AREA_A_0")
    ...
    public void setOperationalStatusItem(CodeStatusAirportType target) {
        setOperationalStatus(XmlAdapterUtils.marshallJAXBElement(CodeStatusAirportType.class,
                ...
                ManoeuvringAreaAvailabilityType.class, target));
    }
    ...
    public void setWarningItem(CodeAirportWarningType target) {
        setWarning(XmlAdapterUtils.marshallJAXBElement(CodeAirportWarningType.class,
                new QName("http://www.aixm.aero/schema/5.1.1", "warning"), ManoeuvringAreaAvailabilityType.class,
                target));
    }
