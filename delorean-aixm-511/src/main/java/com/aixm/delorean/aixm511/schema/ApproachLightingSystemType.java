...
/**
 * <p>
 * Java class for ApproachLightingSystemType complex type
 * </p>
 * .
 *
 * <p>
...
"{http://www.aixm.aero/schema/5.1.1}ApproachLightingSystemTimeSlicePropertyType" maxOccurs
="unbounded"/>
 *       </sequence>
 *     </extension>
 *   </complexContent>
...
@XmlType(name = "ApproachLightingSystemType", propOrder = {"timeSlice"})
@Entity(name = "ApproachLightingSystemType")
@Table(name = "approachlightingsystem", schema = "airport_heliport")
public class ApproachLightingSystemType extends AbstractGroundLightSystemType implements Serializable {
    ...
    @JoinTable(name = "timeslice_approachlightingsystem_link", schema = "airport_heliport", joinColumns = {
            @JoinColumn(name = "timeslice", referencedColumnName = "hjid")}, inverseJoinColumns = {
                    @JoinColumn(name = "approachlightingsystemtype", referencedColumnName = "hjid")})
     ...
     *
     */
    public void setTimeSlice(List<ApproachLightingSystemTimeSlicePropertyType> timeSlice) {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final ApproachLightingSystemType that = ((ApproachLightingSystemType) object);
        {
            boolean lhsFieldIsSet = this.isSetTimeSlice();
            boolean rhsFieldIsSet = that.isSetTimeSlice();
            List<ApproachLightingSystemTimeSlicePropertyType> lhsField;
            lhsField = (this.isSetTimeSlice() ? this.getTimeSlice() : null);
            List<ApproachLightingSystemTimeSlicePropertyType> rhsField;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = super.hashCode(locator, strategy);
        {
            ...
            List<ApproachLightingSystemTimeSlicePropertyType> theField;
