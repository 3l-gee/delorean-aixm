 ...
 *       <sequence>
 *         <element name="category" type="{http://www.aixm.aero/schema/5.1.1}CodeFuelType" minOccurs="0"/>
    ...
    implements Serializable
{
    ...
    @JoinTable(name = "fuel_o_annotation_link", schema = "public", joinColumns = {
     ...
     * 
     */
    @OneToMany(targetEntity = FuelTypeExtensionType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinColumn(name = "fuel_e_hjid", referencedColumnName = "hjid")
    ...
    public void setCategoryItem(CodeFuelType target) {
        setCategory(XmlAdapterUtils.marshallJAXBElement(CodeFuelType.class, new QName("http://www.aixm.aero/schema/5.1.1", "category"), FuelType.class, target));
    }
