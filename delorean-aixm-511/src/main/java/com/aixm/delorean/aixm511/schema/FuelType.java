...
/**
 * <p>
 * Java class for FuelType complex type
 * </p>
 * .
 *
 * <p>
...
@XmlType(name = "FuelType", propOrder = {"category", "annotation", "extension"})
@Entity(name = "FuelType")
@Table(name = "fuel", schema = "service")
public class FuelType extends AbstractAIXMObjectType implements Serializable {
     ...
     *
     * @return possible object is {@link JAXBElement }{@code <}{@link CodeFuelType
     *         }{@code >}
     *
     */
    @Transient
     ...
     *
     * @param value
     *            allowed object is {@link JAXBElement }{@code <}{@link CodeFuelType
     *            }{@code >}
     *
     */
    ...
    @JoinTable(name = "annotation_fuel_link", schema = "service", joinColumns = {
            @JoinColumn(name = "annotation", referencedColumnName = "hjid")}, inverseJoinColumns = {
                    @JoinColumn(name = "fuelpropertygroup", referencedColumnName = "hjid")})
    ...
    @JoinColumn(name = "EXTENSION_FUEL_TYPE_HJID")
    ...
    public CodeFuelType getCategoryItem() {
        return XmlAdapterUtils.unmarshallSource(CodeFuelType.class, this.getCategory());
    }

    public void setCategoryItem(CodeFuelType target) {
        setCategory(XmlAdapterUtils.marshallJAXBElement(CodeFuelType.class,
                new QName("http://www.aixm.aero/schema/5.1.1", "category"), FuelType.class, target));
    }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        }
        {
            ...
            JAXBElement<CodeFuelType> rhsField;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = super.hashCode(locator, strategy);
        {
            ...
            JAXBElement<CodeFuelType> theField;
