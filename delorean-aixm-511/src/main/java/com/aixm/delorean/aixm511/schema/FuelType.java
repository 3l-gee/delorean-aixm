...
"{http://www.aixm.aero/schema/5.1.1}CodeFuelType" minOccurs="0"/>
...
@Table(name = "fuel_o", schema = "service")
public class FuelType extends AbstractAIXMObjectType implements Serializable {
    ...
    @JoinTable(name = "fltp_annttn_link", schema = "service", joinColumns = {
            @JoinColumn(name = "fuel_o_hjid", referencedColumnName = "hjid")}, inverseJoinColumns = {
