...
/**
 * <p>Java class for SpecialDatePropertyType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="SpecialDatePropertyType">
 *   <complexContent>
...
@XmlType(name = "SpecialDatePropertyType")
@Entity(name = "SpecialDatePropertyType")
@Table(name = "specialdatepropertytype", schema = "shared")
public class SpecialDatePropertyType implements Serializable, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        final SpecialDatePropertyType that = ((SpecialDatePropertyType) object);
        {
