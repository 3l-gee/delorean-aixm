...
/**
 * <p>Java class for SDFPropertyType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="SDFPropertyType">
 *   <complexContent>
...
@XmlType(name = "SDFPropertyType")
@Entity(name = "SDFPropertyType")
@Table(name = "sdfpropertytype", schema = "navaids_point")
public class SDFPropertyType implements Serializable, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        final SDFPropertyType that = ((SDFPropertyType) object);
        {
