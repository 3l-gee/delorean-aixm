...
/**
 * <p>
 * Java class for FireFightingServiceType complex type
 * </p>
 * .
 *
 * <p>
...
"{http://www.aixm.aero/schema/5.1.1}FireFightingServiceTimeSlicePropertyType" maxOccurs
="unbounded"/>
 *       </sequence>
 *     </extension>
 *   </complexContent>
...
@XmlType(name = "FireFightingServiceType", propOrder = {"timeSlice"})
@Entity(name = "FireFightingServiceType")
@Table(name = "firefightingservice", schema = "service")
public class FireFightingServiceType extends AbstractAirportGroundServiceType implements Serializable {
    ...
    @ManyToMany(targetEntity = FireFightingServiceTimeSlicePropertyType.class, cascade = {
            CascadeType.ALL}, fetch = FetchType.EAGER)
    @JoinTable(name = "timeslice_firefightingservice_link", schema = "service", joinColumns = {
            @JoinColumn(name = "timeslice", referencedColumnName = "hjid")}, inverseJoinColumns = {
                    @JoinColumn(name = "firefightingservicetype", referencedColumnName = "hjid")})
     ...
     *
     */
    public void setTimeSlice(List<FireFightingServiceTimeSlicePropertyType> timeSlice) {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final FireFightingServiceType that = ((FireFightingServiceType) object);
        {
            boolean lhsFieldIsSet = this.isSetTimeSlice();
            boolean rhsFieldIsSet = that.isSetTimeSlice();
            List<FireFightingServiceTimeSlicePropertyType> lhsField;
            lhsField = (this.isSetTimeSlice() ? this.getTimeSlice() : null);
            List<FireFightingServiceTimeSlicePropertyType> rhsField;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = super.hashCode(locator, strategy);
        {
            ...
            List<FireFightingServiceTimeSlicePropertyType> theField;
