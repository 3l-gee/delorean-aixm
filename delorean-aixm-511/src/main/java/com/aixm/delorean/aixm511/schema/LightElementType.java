 ...
 *         <element name="intensity" type="{http://www.aixm.aero/schema/5.1.1}ValLightIntensityType" minOccurs="0"/>
 *         <element name="type" type="{http://www.aixm.aero/schema/5.1.1}CodeLightSourceType" minOccurs="0"/>
 *         <element name="location" type="{http://www.aixm.aero/schema/5.1.1}ElevatedPointPropertyType" minOccurs="0"/>
 *         <element name="annotation" type="{http://www.aixm.aero/schema/5.1.1}NotePropertyType" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="availability" type="{http://www.aixm.aero/schema/5.1.1}LightElementStatusPropertyType" maxOccurs="unbounded" minOccurs="0"/>
    ...
    implements Serializable
{
    ...
    protected List<LightElementTypeExtensionType> extension;
    ...
    @JoinTable(name = "lightelement_o_annotation_link", schema = "public", joinColumns = {
    ...
    @JoinTable(name = "lightelement_o_availability_link", schema = "public", joinColumns = {
        @JoinColumn(name = "lightelement_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link LightElementTypeExtensionType }
     * 
     * 
     */
    @OneToMany(targetEntity = LightElementTypeExtensionType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinColumn(name = "lightelement_e_hjid", referencedColumnName = "hjid")
    public List<LightElementTypeExtensionType> getExtension() {
        if (extension == null) {
     ...
     * 
     */
    public void setExtension(List<LightElementTypeExtensionType> extension) {
    ...
    public void setColourItem(CodeColourType target) {
        setColour(XmlAdapterUtils.marshallJAXBElement(CodeColourType.class, new QName("http://www.aixm.aero/schema/5.1.1", "colour"), LightElementType.class, target));
    }
    ...
    public void setIntensityLevelItem(CodeLightIntensityType target) {
        setIntensityLevel(XmlAdapterUtils.marshallJAXBElement(CodeLightIntensityType.class, new QName("http://www.aixm.aero/schema/5.1.1", "intensityLevel"), LightElementType.class, target));
    }
    ...
    public void setIntensityItem(ValLightIntensityType target) {
        setIntensity(XmlAdapterUtils.marshallJAXBElement(ValLightIntensityType.class, new QName("http://www.aixm.aero/schema/5.1.1", "intensity"), LightElementType.class, target));
    }
    ...
    public void setTypeItem(CodeLightSourceType target) {
        setType(XmlAdapterUtils.marshallJAXBElement(CodeLightSourceType.class, new QName("http://www.aixm.aero/schema/5.1.1", "type"), LightElementType.class, target));
    }

    @OneToOne(targetEntity = AIXMElevatedPointPropertyType.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "lightelement_o_location_link", schema = "public", joinColumns = {
        @JoinColumn(name = "lightelement_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    public void setLocationItem(AIXMElevatedPointPropertyType target) {
        setLocation(XmlAdapterUtils.marshallJAXBElement(AIXMElevatedPointPropertyType.class, new QName("http://www.aixm.aero/schema/5.1.1", "location"), LightElementType.class, target));
    }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        }
        {
            ...
            List<LightElementTypeExtensionType> rhsField;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        }
        {
            ...
            List<LightElementTypeExtensionType> theField;
