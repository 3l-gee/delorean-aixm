 ...
 *       <sequence>
 *         <group ref=
"{http://www.aixm.aero/schema/5.1.1}WorkAreaPropertyGroup"/>
...
public class WorkAreaTimeSliceType extends AbstractAIXMTimeSliceType implements Serializable {
     ...
     *
     */
    @ManyToMany(targetEntity = WorkareaActivityPropertyType.class, cascade = {CascadeType.ALL}, fetch = FetchType.EAGER)
