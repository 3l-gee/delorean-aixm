 ...
 *       <sequence>
 *         <group ref=
"{http://www.aixm.aero/schema/5.1.1}OrganisationAuthorityPropertyGroup"/>
...
public class OrganisationAuthorityTimeSliceType extends AbstractAIXMTimeSliceType implements Serializable {
    ...
    @JoinTable(name = "relatedorganisationauthority_organisationauthority_link", schema = "organisation", joinColumns = {
            @JoinColumn(name = "relatedorganisationauthority", referencedColumnName = "hjid")}, inverseJoinColumns = {
                    @JoinColumn(name = "organisationauthoritypropertygroup", referencedColumnName = "hjid")})
