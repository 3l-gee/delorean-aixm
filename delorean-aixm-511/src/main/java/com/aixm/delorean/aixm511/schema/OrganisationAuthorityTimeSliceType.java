...
/**
 * <p>
 * Java class for OrganisationAuthorityTimeSliceType complex type
 * </p>
 * .
 *
 * <p>
...
"{http://www.aixm.aero/schema/5.1.1}CodeOrganisationType" minOccurs="0"/>
 ...
 *         <element name="relatedOrganisationAuthority" type=
"{http://www.aixm.aero/schema/5.1.1}OrganisationAuthorityAssociationPropertyType" maxOccurs
="unbounded" minOccurs="0"/>
 ...
 *                 <sequence>
 *                   <element ref=
"{http://www.aixm.aero/schema/5.1.1}AbstractOrganisationAuthorityExtension"/>
 *                 </sequence>
 *                 <attGroup ref=
...
@XmlType(name = "OrganisationAuthorityTimeSliceType", propOrder = {"aixmName", "designator", "type", "military",
        "contact", "relatedOrganisationAuthority", "annotation", "extension"})
@Entity(name = "OrganisationAuthorityTimeSliceType")
@Table(name = "organisationauthority_t", schema = "organisation")
public class OrganisationAuthorityTimeSliceType extends AbstractAIXMTimeSliceType implements Serializable {
    ...
    protected List<OrganisationAuthorityTimeSliceExtensionType> extension;
     ...
     *
     * @return possible object is {@link JAXBElement
     *         }{@code <}{@link CodeOrganisationType }{@code >}
     *
     */
    @Transient
    ...
    @JoinTable(name = "orgnstnathrttmslctp_cntct_link", schema = "organisation", joinColumns = {
            @JoinColumn(name = "organisationauthority_t_hjid", referencedColumnName = "hjid")}, inverseJoinColumns = {
     ...
     * Therefore any modification you make to the returned list will be present
     * inside the JAXB object. This is why there is not a <CODE>set</CODE> method
     * for the relatedOrganisationAuthority property.
     *
     * <p>
     * For example, to add a new item, do as follows:
     *
    ...
    @OneToMany(targetEntity = OrganisationAuthorityAssociationPropertyType.class, cascade = {
            CascadeType.ALL}, fetch = FetchType.EAGER)
    @JoinTable(name = "orgnstnathrttmslctp_rltdorgnstnathrt_link", schema = "organisation", joinColumns = {
            @JoinColumn(name = "organisationauthority_t_hjid", referencedColumnName = "hjid")}, inverseJoinColumns = {
     ...
     *
     */
    public void setRelatedOrganisationAuthority(
            List<OrganisationAuthorityAssociationPropertyType> relatedOrganisationAuthority) {
    ...
    @JoinTable(name = "orgnstnathrttmslctp_annttn_link", schema = "organisation", joinColumns = {
            @JoinColumn(name = "organisationauthority_t_hjid", referencedColumnName = "hjid")}, inverseJoinColumns = {
     ...
     *
     */
    @OneToMany(targetEntity = OrganisationAuthorityTimeSliceExtensionType.class, cascade = {
            CascadeType.ALL}, fetch = FetchType.EAGER)
    @JoinColumn(name = "organisationauthority_te_hjid", referencedColumnName = "hjid")
    public List<OrganisationAuthorityTimeSliceExtensionType> getExtension() {
        if (extension == null) {
     ...
     *
     */
    public void setExtension(List<OrganisationAuthorityTimeSliceExtensionType> extension) {
    ...
    public void setAixmNameItem(TextNameType target) {
        setAixmName(XmlAdapterUtils.marshallJAXBElement(TextNameType.class,
                new QName("http://www.aixm.aero/schema/5.1.1", "name"), OrganisationAuthorityTimeSliceType.class,
                target));
    }
    ...
    public void setDesignatorItem(CodeOrganisationDesignatorType target) {
        setDesignator(XmlAdapterUtils.marshallJAXBElement(CodeOrganisationDesignatorType.class,
                new QName("http://www.aixm.aero/schema/5.1.1", "designator"), OrganisationAuthorityTimeSliceType.class,
                target));
    }
    ...
    public void setTypeItem(CodeOrganisationType target) {
        setType(XmlAdapterUtils.marshallJAXBElement(CodeOrganisationType.class,
                new QName("http://www.aixm.aero/schema/5.1.1", "type"), OrganisationAuthorityTimeSliceType.class,
                target));
    }
    ...
    public void setMilitaryItem(CodeMilitaryOperationsType target) {
        setMilitary(XmlAdapterUtils.marshallJAXBElement(CodeMilitaryOperationsType.class,
                new QName("http://www.aixm.aero/schema/5.1.1", "military"), OrganisationAuthorityTimeSliceType.class,
                target));
    }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        }
        {
            ...
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "relatedOrganisationAuthority",
                    lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "relatedOrganisationAuthority",
                    rhsField);
            if (!strategy.equals(lhsFieldLocator, rhsFieldLocator, lhsField, rhsField, lhsFieldIsSet, rhsFieldIsSet)) {
                return false;
            }
        ...
        }
        {
            ...
            List<OrganisationAuthorityTimeSliceExtensionType> lhsField;
            lhsField = (this.isSetExtension() ? this.getExtension() : null);
            List<OrganisationAuthorityTimeSliceExtensionType> rhsField;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        }
        {
            ...
            List<OrganisationAuthorityTimeSliceExtensionType> theField;
