...
@Entity(name = "RidgeExtensionType")
@Table(name = "ridge_oe", schema = "airport_heliport")
public class RidgeExtensionType implements Serializable, Equals, HashCode, ToString {
