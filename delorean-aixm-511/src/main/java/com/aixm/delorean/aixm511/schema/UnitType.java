...
"{http://www.aixm.aero/schema/5.1.1}UnitTimeSlicePropertyType" maxOccurs=
"unbounded"/>
 *       </sequence>
 *     </extension>
 *   </complexContent>
...
@XmlType(name = "UnitType", propOrder = {"timeSlice"})
@Entity(name = "UnitType")
@Table(name = "unit", schema = "organisation")
public class UnitType extends AbstractAIXMFeatureType implements Serializable {
    ...
    @ManyToMany(targetEntity = UnitTimeSlicePropertyType.class, cascade = {CascadeType.ALL}, fetch = FetchType.EAGER)
    @JoinTable(name = "timeslice_unit_link", schema = "organisation", joinColumns = {
            @JoinColumn(name = "timeslice", referencedColumnName = "hjid")}, inverseJoinColumns = {
                    @JoinColumn(name = "unittype", referencedColumnName = "hjid")})
     ...
     *
     */
    public void setTimeSlice(List<UnitTimeSlicePropertyType> timeSlice) {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final UnitType that = ((UnitType) object);
        {
            ...
            List<UnitTimeSlicePropertyType> lhsField;
            lhsField = (this.isSetTimeSlice() ? this.getTimeSlice() : null);
            List<UnitTimeSlicePropertyType> rhsField;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = super.hashCode(locator, strategy);
        {
            ...
            List<UnitTimeSlicePropertyType> theField;
