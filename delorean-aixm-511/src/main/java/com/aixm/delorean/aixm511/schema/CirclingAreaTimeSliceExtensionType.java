 ...
 *       <sequence>
 *         <element ref=
"{http://www.aixm.aero/schema/5.1.1}AbstractCirclingAreaExtension"/>
 *       </sequence>
 *       <attGroup ref=
...
@XmlType(name = "", propOrder = {"abstractCirclingAreaExtension"})
@Entity(name = "CirclingAreaTimeSliceExtensionType")
@Table(name = "circlingarea_te", schema = "procedure")
public class CirclingAreaTimeSliceExtensionType implements Serializable, Equals, HashCode, ToString {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final CirclingAreaTimeSliceExtensionType that = ((CirclingAreaTimeSliceExtensionType) object);
        {
        ...
        }
        {
            ...
            lhsField = this.getAbstractCirclingAreaExtension();
            AbstractExtensionType rhsField;
            rhsField = that.getAbstractCirclingAreaExtension();
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "abstractCirclingAreaExtension",
                    lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "abstractCirclingAreaExtension",
                    rhsField);
            if (!strategy.equals(lhsFieldLocator, rhsFieldLocator, lhsField, rhsField, lhsFieldIsSet, rhsFieldIsSet)) {
                return false;
            }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetAbstractCirclingAreaExtension();
            AbstractExtensionType theField;
            theField = this.getAbstractCirclingAreaExtension();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "abstractCirclingAreaExtension", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            AbstractExtensionType theField;
            theField = this.getAbstractCirclingAreaExtension();
            strategy.appendField(locator, this, "abstractCirclingAreaExtension", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetOwns();
            boolean theField;
