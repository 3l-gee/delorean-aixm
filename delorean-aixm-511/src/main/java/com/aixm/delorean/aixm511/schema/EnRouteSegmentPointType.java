...
"unbounded" minOccurs="0"/>
 *         <group ref=
"{http://www.aixm.aero/schema/5.1.1}EnRouteSegmentPointPropertyGroup"/>
...
public class EnRouteSegmentPointType extends AbstractSegmentPointType implements Serializable {
    ...
    @JoinTable(name = "facilitymakeup_enroutesegmentpoint_link", schema = "navaids_point", joinColumns = {
            @JoinColumn(name = "facilitymakeup", referencedColumnName = "hjid")}, inverseJoinColumns = {
                    @JoinColumn(name = "enroutesegmentpointtype", referencedColumnName = "hjid")})
    ...
    @JoinTable(name = "annotation_enroutesegmentpoint_link", schema = "navaids_point", joinColumns = {
