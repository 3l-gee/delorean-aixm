...
/**
 * <p>
 * Java class for NDBType complex type
 * </p>
 * .
 *
 * <p>
...
"{http://www.aixm.aero/schema/5.1.1}NDBTimeSlicePropertyType" maxOccurs=
"unbounded"/>
 *       </sequence>
 *     </extension>
 *   </complexContent>
...
@XmlType(name = "NDBType", propOrder = {"timeSlice"})
@Entity(name = "NDBType")
@Table(name = "ndb", schema = "navaids_point")
public class NDBType extends AbstractNavaidEquipmentType implements Serializable {
     ...
     *
     */
    @ManyToMany(targetEntity = NDBTimeSlicePropertyType.class, cascade = {CascadeType.ALL}, fetch = FetchType.EAGER)
    @JoinTable(name = "timeslice_ndb_link", schema = "navaids_point", joinColumns = {
            @JoinColumn(name = "timeslice", referencedColumnName = "hjid")}, inverseJoinColumns = {
                    @JoinColumn(name = "ndbtype", referencedColumnName = "hjid")})
     ...
     *
     */
    public void setTimeSlice(List<NDBTimeSlicePropertyType> timeSlice) {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = super.hashCode(locator, strategy);
        {
            ...
            List<NDBTimeSlicePropertyType> theField;
