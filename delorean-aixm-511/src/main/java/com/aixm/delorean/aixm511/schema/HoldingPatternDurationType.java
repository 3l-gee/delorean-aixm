...
@Table(name = "holdingpatternduration_o", schema = "holding")
public class HoldingPatternDurationType extends AbstractAIXMObjectType implements Serializable {
    ...
    @JoinTable(name = "hldngpttrndrtntp_annttn_link", schema = "holding", joinColumns = {
            @JoinColumn(name = "holdingpatternduration_o_hjid", referencedColumnName = "hjid")}, inverseJoinColumns = {
