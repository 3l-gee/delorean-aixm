...
/**
 * <p>
 * Java class for HoldingPatternDurationType complex type
 * </p>
 * .
 *
 * <p>
 ...
 *       <sequence>
 *         <group ref=
"{http://www.aixm.aero/schema/5.1.1}HoldingPatternDurationPropertyGroup"/>
...
@XmlType(name = "HoldingPatternDurationType", propOrder = {"duration", "annotation", "extension"})
@Entity(name = "HoldingPatternDurationType")
@Table(name = "holdingpatternduration", schema = "holding")
public class HoldingPatternDurationType extends AbstractAIXMObjectType implements Serializable {
    ...
    @JoinTable(name = "annotation_holdingpatternduration_link", schema = "holding", joinColumns = {
            @JoinColumn(name = "annotation", referencedColumnName = "hjid")}, inverseJoinColumns = {
                    @JoinColumn(name = "holdingpatterndurationpropertygroup", referencedColumnName = "hjid")})
    ...
    @JoinColumn(name = "EXTENSION_HOLDING_PATTERN_DU_0")
    ...
    public void setDurationItem(ValDurationType target) {
        setDuration(XmlAdapterUtils.marshallJAXBElement(ValDurationType.class,
                new QName("http://www.aixm.aero/schema/5.1.1", "duration"), HoldingPatternDurationType.class, target));
    }
