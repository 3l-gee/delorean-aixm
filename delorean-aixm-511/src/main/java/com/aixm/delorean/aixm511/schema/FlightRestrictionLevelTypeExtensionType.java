...
@Entity(name = "FlightRestrictionLevelTypeExtensionType")
@Table(name = "flightrestrictionlevele", schema = "route")
public class FlightRestrictionLevelTypeExtensionType implements Serializable, Equals, HashCode, ToString {
