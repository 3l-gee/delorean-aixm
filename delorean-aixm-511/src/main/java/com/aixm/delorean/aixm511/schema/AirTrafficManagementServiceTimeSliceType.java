...
/**
 * <p>
 * Java class for AirTrafficManagementServiceTimeSliceType complex type
 * </p>
 * .
 *
 * <p>
...
"{http://www.aixm.aero/schema/5.1.1}CodeServiceATFMType" minOccurs="0"/>
...
@XmlType(name = "AirTrafficManagementServiceTimeSliceType", propOrder = {"flightOperations", "rank", "compliantICAO",
        "aixmName", "location", "serviceProvider", "callSign", "radioCommunication", "groundCommunication",
        "availability", "annotation", "type", "clientAirspace", "clientAerialRefuelling", "clientRoute", "extension"})
@Entity(name = "AirTrafficManagementServiceTimeSliceType")
@Table(name = "airtrafficmanagementservice_t", schema = "service")
public class AirTrafficManagementServiceTimeSliceType extends AbstractAIXMTimeSliceType implements Serializable {
    ...
    @JoinTable(name = "artrffcmngmntsrvctmslctp_cll-sgn_link", schema = "service", joinColumns = {
            @JoinColumn(name = "airtrafficmanagementservice_t_hjid", referencedColumnName = "hjid")}, inverseJoinColumns = {
    ...
    public void setFlightOperationsItem(CodeFlightDestinationType target) {
        setFlightOperations(XmlAdapterUtils.marshallJAXBElement(CodeFlightDestinationType.class,
                ...
                AirTrafficManagementServiceTimeSliceType.class, target));
    }
    ...
    public void setRankItem(CodeFacilityRankingType target) {
        setRank(XmlAdapterUtils.marshallJAXBElement(CodeFacilityRankingType.class,
                new QName("http://www.aixm.aero/schema/5.1.1", "rank"), AirTrafficManagementServiceTimeSliceType.class,
                target));
    }
    ...
    public void setAixmNameItem(TextNameType target) {
        setAixmName(XmlAdapterUtils.marshallJAXBElement(TextNameType.class,
                new QName("http://www.aixm.aero/schema/5.1.1", "name"), AirTrafficManagementServiceTimeSliceType.class,
                target));
    }
    ...
    public void setTypeItem(CodeServiceATFMType target) {
        setType(XmlAdapterUtils.marshallJAXBElement(CodeServiceATFMType.class,
                new QName("http://www.aixm.aero/schema/5.1.1", "type"), AirTrafficManagementServiceTimeSliceType.class,
                target));
    }
