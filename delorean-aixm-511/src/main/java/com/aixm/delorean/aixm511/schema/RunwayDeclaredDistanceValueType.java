...
="unbounded" minOccurs="0"/>
 *         <group ref=
"{http://www.aixm.aero/schema/5.1.1}RunwayDeclaredDistanceValuePropertyGroup"/>
 ...
 *                   <element ref=
"{http://www.aixm.aero/schema/5.1.1}AbstractRunwayDeclaredDistanceValueExtension"/>
 *                 </choice>
 *                 <attGroup ref=
...
public class RunwayDeclaredDistanceValueType extends AbstractPropertiesWithScheduleType implements Serializable {
    ...
    @JoinTable(name = "timeinterval_runwaydeclareddistancevalue_link", schema = "airport_heliport", joinColumns = {
            @JoinColumn(name = "timeinterval", referencedColumnName = "hjid")}, inverseJoinColumns = {
                    @JoinColumn(name = "runwaydeclareddistancevaluetype", referencedColumnName = "hjid")})
    ...
    @JoinTable(name = "annotation_runwaydeclareddistancevalue_link", schema = "airport_heliport", joinColumns = {
    ...
    @JoinTable(name = "specialdateauthority_runwaydeclareddistancevalue_link", schema = "airport_heliport", joinColumns = {
    ...
    @OneToMany(targetEntity = RunwayDeclaredDistanceValueTypeExtensionType.class, cascade = {
            CascadeType.ALL}, fetch = FetchType.EAGER)
    @JoinColumn(name = "EXTENSION_RUNWAY_DECLARED_DI_1")
    ...
    public void setDistanceItem(ValDistanceType target) {
        setDistance(XmlAdapterUtils.marshallJAXBElement(ValDistanceType.class,
                new QName("http://www.aixm.aero/schema/5.1.1", "distance"), RunwayDeclaredDistanceValueType.class,
                target));
    }
    ...
    public void setDistanceAccuracyItem(ValDistanceType target) {
        setDistanceAccuracy(XmlAdapterUtils.marshallJAXBElement(ValDistanceType.class,
                new QName("http://www.aixm.aero/schema/5.1.1", "distanceAccuracy"),
                RunwayDeclaredDistanceValueType.class, target));
    }
