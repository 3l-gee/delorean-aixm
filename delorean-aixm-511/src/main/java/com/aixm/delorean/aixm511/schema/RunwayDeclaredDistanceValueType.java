    ...
    implements Serializable
{
    ...
    @JoinTable(name = "runwaydeclareddistancevaluetype_timeinterval_link", schema = "public", joinColumns = {
        @JoinColumn(name = "runwaydeclareddistancevaluetype_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "runwaydeclareddistancevaluetype_annotation_link", schema = "public", joinColumns = {
        @JoinColumn(name = "runwaydeclareddistancevaluetype_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "runwaydeclareddistancevaluetype_specialdateauthority_link", schema = "public", joinColumns = {
        @JoinColumn(name = "runwaydeclareddistancevaluetype_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinColumn(name = "runwaydeclareddistancevalue_e_hjid", referencedColumnName = "hjid")
    ...
    public void setDistanceItem(ValDistanceType target) {
        setDistance(XmlAdapterUtils.marshallJAXBElement(ValDistanceType.class, new QName("http://www.aixm.aero/schema/5.1.1", "distance"), RunwayDeclaredDistanceValueType.class, target));
    }
    ...
    public void setDistanceAccuracyItem(ValDistanceType target) {
        setDistanceAccuracy(XmlAdapterUtils.marshallJAXBElement(ValDistanceType.class, new QName("http://www.aixm.aero/schema/5.1.1", "distanceAccuracy"), RunwayDeclaredDistanceValueType.class, target));
    }
