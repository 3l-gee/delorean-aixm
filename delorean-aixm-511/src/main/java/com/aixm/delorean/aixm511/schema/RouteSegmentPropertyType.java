...
/**
 * <p>Java class for RouteSegmentPropertyType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="RouteSegmentPropertyType">
 *   <complexContent>
...
@XmlType(name = "RouteSegmentPropertyType")
@Entity(name = "RouteSegmentPropertyType")
@Table(name = "routesegmentpropertytype", schema = "route")
public class RouteSegmentPropertyType implements Serializable, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        final RouteSegmentPropertyType that = ((RouteSegmentPropertyType) object);
        {
