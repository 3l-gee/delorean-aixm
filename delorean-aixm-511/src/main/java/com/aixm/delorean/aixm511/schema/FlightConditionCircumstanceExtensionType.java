...
@XmlType(name = "", propOrder = {"abstractFlightConditionCircumstanceExtension"})
@Entity(name = "FlightConditionCircumstanceExtensionType")
@Table(name = "flightconditioncircumstance_oe", schema = "route")
public class FlightConditionCircumstanceExtensionType implements Serializable, Equals, HashCode, ToString {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final FlightConditionCircumstanceExtensionType that = ((FlightConditionCircumstanceExtensionType) object);
        {
            ...
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator,
                    "abstractFlightConditionCircumstanceExtension", lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator,
                    "abstractFlightConditionCircumstanceExtension", rhsField);
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetAbstractFlightConditionCircumstanceExtension();
            AbstractExtensionType theField;
            theField = this.getAbstractFlightConditionCircumstanceExtension();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator,
                    "abstractFlightConditionCircumstanceExtension", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            AbstractExtensionType theField;
            theField = this.getAbstractFlightConditionCircumstanceExtension();
            strategy.appendField(locator, this, "abstractFlightConditionCircumstanceExtension", buffer, theField,
                    theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetOwns();
