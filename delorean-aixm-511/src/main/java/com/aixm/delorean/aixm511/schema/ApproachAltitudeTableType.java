...
/**
 * <p>
 * Java class for ApproachAltitudeTableType complex type
 * </p>
 * .
 *
 * <p>
 ...
 *                 <choice>
 *                   <element ref=
"{http://www.aixm.aero/schema/5.1.1}AbstractApproachAltitudeTableExtension"/>
 *                 </choice>
 *                 <attGroup ref=
...
@XmlType(name = "ApproachAltitudeTableType", propOrder = {"measurementPoint", "altitude", "altitudeReference",
        "annotation", "extension"})
@Entity(name = "ApproachAltitudeTableType")
@Table(name = "approachaltitudetable_o", schema = "procedure")
public class ApproachAltitudeTableType extends AbstractAIXMObjectType implements Serializable {
    ...
    @JoinTable(name = "apprchalttdtbltp_annttn_link", schema = "procedure", joinColumns = {
            @JoinColumn(name = "approachaltitudetable_o_hjid", referencedColumnName = "hjid")}, inverseJoinColumns = {
    ...
    public void setMeasurementPointItem(CodeProcedureDistanceType target) {
        setMeasurementPoint(XmlAdapterUtils.marshallJAXBElement(CodeProcedureDistanceType.class,
                new QName("http://www.aixm.aero/schema/5.1.1", "measurementPoint"), ApproachAltitudeTableType.class,
                target));
    }
    ...
    public void setAltitudeItem(ValDistanceVerticalType target) {
        setAltitude(XmlAdapterUtils.marshallJAXBElement(ValDistanceVerticalType.class,
                new QName("http://www.aixm.aero/schema/5.1.1", "altitude"), ApproachAltitudeTableType.class, target));
    }
    ...
    public void setAltitudeReferenceItem(CodeVerticalReferenceType target) {
        setAltitudeReference(XmlAdapterUtils.marshallJAXBElement(CodeVerticalReferenceType.class,
                new QName("http://www.aixm.aero/schema/5.1.1", "altitudeReference"), ApproachAltitudeTableType.class,
                target));
    }
