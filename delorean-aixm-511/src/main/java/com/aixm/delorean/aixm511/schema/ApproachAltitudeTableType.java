    ...
    implements Serializable
{
    ...
    @JoinTable(name = "approachaltitudetable_o_annotation_link", schema = "public", joinColumns = {
    ...
    @JoinColumn(name = "approachaltitudetable_e_hjid", referencedColumnName = "hjid")
