...
/**
 * <p>Java class for FlightRestrictionPropertyType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="FlightRestrictionPropertyType">
 *   <complexContent>
...
@XmlType(name = "FlightRestrictionPropertyType")
@Entity(name = "FlightRestrictionPropertyType")
@Table(name = "flightrestrictionpropertytype", schema = "route")
public class FlightRestrictionPropertyType implements Serializable, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        final FlightRestrictionPropertyType that = ((FlightRestrictionPropertyType) object);
        {
