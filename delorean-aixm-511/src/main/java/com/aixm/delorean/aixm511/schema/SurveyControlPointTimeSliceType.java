 ...
 *       <sequence>
 *         <group ref=
"{http://www.aixm.aero/schema/5.1.1}SurveyControlPointPropertyGroup"/>
...
public class SurveyControlPointTimeSliceType extends AbstractAIXMTimeSliceType implements Serializable {
    ...
    @JoinTable(name = "annotation_surveycontrolpoint_link", schema = "airport_heliport", joinColumns = {
            @JoinColumn(name = "annotation", referencedColumnName = "hjid")}, inverseJoinColumns = {
                    @JoinColumn(name = "surveycontrolpointpropertygroup", referencedColumnName = "hjid")})
    ...
    @JoinColumn(name = "EXTENSION_SURVEY_CONTROL_POI_0")
