...
"{http://www.aixm.aero/schema/5.1.1}RunwayElementTimeSlicePropertyType" maxOccurs
="unbounded"/>
 *       </sequence>
 *     </extension>
 *   </complexContent>
...
@XmlType(name = "RunwayElementType", propOrder = {"timeSlice"})
@Entity(name = "RunwayElementType")
@Table(name = "runwayelement", schema = "airport_heliport")
public class RunwayElementType extends AbstractAIXMFeatureType implements Serializable {
    ...
    @ManyToMany(targetEntity = RunwayElementTimeSlicePropertyType.class, cascade = {
            CascadeType.ALL}, fetch = FetchType.EAGER)
    @JoinTable(name = "timeslice_runwayelement_link", schema = "airport_heliport", joinColumns = {
            @JoinColumn(name = "timeslice", referencedColumnName = "hjid")}, inverseJoinColumns = {
                    @JoinColumn(name = "runwayelementtype", referencedColumnName = "hjid")})
     ...
     *
     */
    public void setTimeSlice(List<RunwayElementTimeSlicePropertyType> timeSlice) {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final RunwayElementType that = ((RunwayElementType) object);
        {
            boolean lhsFieldIsSet = this.isSetTimeSlice();
            boolean rhsFieldIsSet = that.isSetTimeSlice();
            List<RunwayElementTimeSlicePropertyType> lhsField;
            lhsField = (this.isSetTimeSlice() ? this.getTimeSlice() : null);
            List<RunwayElementTimeSlicePropertyType> rhsField;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = super.hashCode(locator, strategy);
        {
            ...
            List<RunwayElementTimeSlicePropertyType> theField;
