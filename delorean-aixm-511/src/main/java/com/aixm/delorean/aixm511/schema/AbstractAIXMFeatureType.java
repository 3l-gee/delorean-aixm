 ...
 *   <complexContent>
 *     <extension base=
"{http://www.aixm.aero/schema/5.1.1}AbstractAIXMFeatureBaseType">
 *       <sequence>
 *         <element name="featureMetadata" type=
"{http://www.aixm.aero/schema/5.1.1}FeatureMetadataPropertyType" minOccurs="0"/>
...
@XmlSeeAlso({AerialRefuellingType.class, AirportHeliportType.class, AirportHeliportCollocationType.class,
        AirportHotSpotType.class, AltimeterSourceType.class, NonMovementAreaType.class, SurveyControlPointType.class,
        WorkAreaType.class, AircraftStandType.class, ApronType.class, ApronElementType.class, DeicingAreaType.class,
        PassengerLoadingBridgeType.class, RoadType.class, TouchDownLiftOffType.class, AbstractMarkingType.class,
        ArrestingGearType.class, RunwayType.class, RunwayBlastPadType.class, RunwayCentrelinePointType.class,
        RunwayDirectionType.class, RunwayElementType.class, AbstractAirportHeliportProtectionAreaType.class,
        RunwayVisualRangeType.class, AbstractGroundLightSystemType.class, FloatingDockSiteType.class,
        MarkingBuoyType.class, SeaplaneLandingAreaType.class, SeaplaneRampSiteType.class, GuidanceLineType.class,
        ...
        SpecialNavigationSystemType.class, AbstractNavaidEquipmentType.class, AngleIndicationType.class,
        DistanceIndicationType.class, DesignatedPointType.class, SignificantPointInAirspaceType.class,
        AeronauticalGroundLightType.class, ObstacleAreaType.class, VerticalStructureType.class,
        OrganisationAuthorityType.class, UnitType.class, TerminalArrivalAreaType.class, CirclingAreaType.class,
        NavigationAreaType.class, AbstractProcedureType.class, SafeAltitudeAreaType.class, AbstractSegmentLegType.class,
        NavigationAreaRestrictionType.class, ProcedureDMEType.class, ChangeOverPointType.class, RouteType.class,
        RouteDMEType.class, RouteSegmentType.class, AirspaceBorderCrossingType.class, FlightRestrictionType.class,
        RulesProceduresType.class, PilotControlledLightingType.class, RadioCommunicationChannelType.class,
        AbstractServiceType.class, RadioFrequencyAreaType.class, SpecialDateType.class, StandardLevelColumnType.class,
        StandardLevelSectorType.class, StandardLevelTableType.class, HoldingAssessmentType.class, RadarSystemType.class,
