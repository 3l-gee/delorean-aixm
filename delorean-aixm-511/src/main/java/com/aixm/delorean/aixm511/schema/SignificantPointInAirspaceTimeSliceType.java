 ...
 *       <sequence>
 *         <group ref=
"{http://www.aixm.aero/schema/5.1.1}SignificantPointInAirspacePropertyGroup"/>
...
public class SignificantPointInAirspaceTimeSliceType extends AbstractAIXMTimeSliceType implements Serializable {
    ...
    @JoinTable(name = "annotation_significantpointinairspace_link", schema = "navaids_point", joinColumns = {
            @JoinColumn(name = "annotation", referencedColumnName = "hjid")}, inverseJoinColumns = {
                    @JoinColumn(name = "significantpointinairspacepropertygroup", referencedColumnName = "hjid")})
