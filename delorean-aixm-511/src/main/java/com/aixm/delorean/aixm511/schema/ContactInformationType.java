 ...
 *       <sequence>
 *         <group ref=
"{http://www.aixm.aero/schema/5.1.1}ContactInformationPropertyGroup"/>
...
public class ContactInformationType extends AbstractAIXMObjectType implements Serializable {
     ...
     *
     */
    @ManyToMany(targetEntity = PostalAddressPropertyType.class, cascade = {CascadeType.ALL}, fetch = FetchType.EAGER)
    @JoinTable(name = "address_contactinformation_link", schema = "shared", joinColumns = {
            @JoinColumn(name = "address", referencedColumnName = "hjid")}, inverseJoinColumns = {
     ...
     *
     */
    @ManyToMany(targetEntity = OnlineContactPropertyType.class, cascade = {CascadeType.ALL}, fetch = FetchType.EAGER)
    @JoinTable(name = "networknode_contactinformation_link", schema = "shared", joinColumns = {
            @JoinColumn(name = "networknode", referencedColumnName = "hjid")}, inverseJoinColumns = {
                    @JoinColumn(name = "contactinformationpropertygroup", referencedColumnName = "hjid")})
     ...
     *
     */
    @ManyToMany(targetEntity = TelephoneContactPropertyType.class, cascade = {CascadeType.ALL}, fetch = FetchType.EAGER)
    @JoinTable(name = "phonefax_contactinformation_link", schema = "shared", joinColumns = {
            @JoinColumn(name = "phonefax", referencedColumnName = "hjid")}, inverseJoinColumns = {
                    @JoinColumn(name = "contactinformationpropertygroup", referencedColumnName = "hjid")})
