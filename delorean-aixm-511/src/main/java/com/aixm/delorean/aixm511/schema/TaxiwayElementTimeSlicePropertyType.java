...
/**
 * <p>
 * Java class for TaxiwayElementTimeSlicePropertyType complex type
 * </p>
 * .
 *
 * <p>
 ...
 *       <sequence>
 *         <element ref=
"{http://www.aixm.aero/schema/5.1.1}TaxiwayElementTimeSlice"/>
 *       </sequence>
 *       <attGroup ref=
...
@XmlType(name = "TaxiwayElementTimeSlicePropertyType", propOrder = {"taxiwayElementTimeSlice"})
...
public class TaxiwayElementTimeSlicePropertyType implements Serializable, Equals, HashCode, ToString {
    ...
    /**
     * Gets the value of the taxiwayElementTimeSlice property.
     *
     * @return possible object is {@link TaxiwayElementTimeSliceType }
     *
     */
    @OneToOne(targetEntity = TaxiwayElementTimeSliceType.class, cascade = {CascadeType.ALL}, fetch = FetchType.EAGER)
    ...
    /**
     * Sets the value of the taxiwayElementTimeSlice property.
     *
     * @param value
     *            allowed object is {@link TaxiwayElementTimeSliceType }
     *
     */
    ...
    @Transient
    public boolean isSetTaxiwayElementTimeSlice() {
        return (this.taxiwayElementTimeSlice != null);
    }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetTaxiwayElementTimeSlice();
            TaxiwayElementTimeSliceType theField;
            theField = this.getTaxiwayElementTimeSlice();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "taxiwayElementTimeSlice", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            TaxiwayElementTimeSliceType theField;
            theField = this.getTaxiwayElementTimeSlice();
            strategy.appendField(locator, this, "taxiwayElementTimeSlice", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetOwns();
            boolean theField;
