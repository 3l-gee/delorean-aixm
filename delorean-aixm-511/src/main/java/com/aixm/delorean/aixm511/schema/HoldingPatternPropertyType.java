...
/**
 * <p>Java class for HoldingPatternPropertyType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="HoldingPatternPropertyType">
 *   <complexContent>
...
@XmlType(name = "HoldingPatternPropertyType")
@Entity(name = "HoldingPatternPropertyType")
@Table(name = "holdingpatternpropertytype", schema = "holding")
public class HoldingPatternPropertyType implements Serializable, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        final HoldingPatternPropertyType that = ((HoldingPatternPropertyType) object);
        {
