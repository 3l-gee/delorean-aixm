 ...
 *       <sequence>
 *         <group ref=
"{http://www.aixm.aero/schema/5.1.1}SecondarySurveillanceRadarPropertyGroup"/>
...
public class SecondarySurveillanceRadarTimeSliceType extends AbstractAIXMTimeSliceType implements Serializable {
    ...
    @JoinTable(name = "contact_secondarysurveillanceradar_link", schema = "surveillance", joinColumns = {
            @JoinColumn(name = "contact", referencedColumnName = "hjid")}, inverseJoinColumns = {
                    @JoinColumn(name = "secondarysurveillanceradarpropertygroup", referencedColumnName = "hjid")})
    ...
    @JoinTable(name = "annotation_secondarysurveillanceradar_link", schema = "surveillance", joinColumns = {
    ...
    @ManyToMany(targetEntity = SurveillanceGroundStationPropertyType.class, cascade = {
            CascadeType.ALL}, fetch = FetchType.EAGER)
    @JoinTable(name = "groundstation_secondarysurveillanceradar_link", schema = "surveillance", joinColumns = {
            @JoinColumn(name = "groundstation", referencedColumnName = "hjid")}, inverseJoinColumns = {
                    @JoinColumn(name = "secondarysurveillanceradarpropertygroup", referencedColumnName = "hjid")})
