...
"{http://www.aixm.aero/schema/5.1.1}CodeEquipmentUnavailableType" minOccurs=
"0"/>
...
"{http://www.aixm.aero/schema/5.1.1}EquipmentUnavailableAdjustmentColumnPropertyType" maxOccurs
...
public class EquipmentUnavailableAdjustmentType extends AbstractAIXMObjectType implements Serializable {
    ...
    public void setTypeItem(CodeEquipmentUnavailableType target) {
        setType(XmlAdapterUtils.marshallJAXBElement(CodeEquipmentUnavailableType.class,
                new QName("http://www.aixm.aero/schema/5.1.1", "type"), EquipmentUnavailableAdjustmentType.class,
                target));
    }
