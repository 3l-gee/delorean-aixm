 ...
 *       <sequence>
 *         <group ref=
"{http://www.aixm.aero/schema/5.1.1}EquipmentUnavailableAdjustmentPropertyGroup"/>
...
public class EquipmentUnavailableAdjustmentType extends AbstractAIXMObjectType implements Serializable {
    ...
    @JoinTable(name = "adjustmentinopcol_equipmentunavailableadjustment_link", schema = "procedure", joinColumns = {
            @JoinColumn(name = "adjustmentinopcol", referencedColumnName = "hjid")}, inverseJoinColumns = {
