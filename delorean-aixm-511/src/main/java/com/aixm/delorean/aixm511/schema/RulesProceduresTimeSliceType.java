 ...
 *       <sequence>
 *         <group ref=
"{http://www.aixm.aero/schema/5.1.1}RulesProceduresPropertyGroup"/>
...
public class RulesProceduresTimeSliceType extends AbstractAIXMTimeSliceType implements Serializable {
    ...
    @JoinTable(name = "affectedlocation_rulesprocedures_link", schema = "rules_procedure", joinColumns = {
            @JoinColumn(name = "affectedlocation", referencedColumnName = "hjid")}, inverseJoinColumns = {
    ...
    @JoinTable(name = "affectedarea_rulesprocedures_link", schema = "rules_procedure", joinColumns = {
            @JoinColumn(name = "affectedarea", referencedColumnName = "hjid")}, inverseJoinColumns = {
                    @JoinColumn(name = "rulesprocedurespropertygroup", referencedColumnName = "hjid")})
    ...
    @JoinColumn(name = "EXTENSION_RULES_PROCEDURES_T_0")
