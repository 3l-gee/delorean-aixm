...
"{http://www.aixm.aero/schema/5.1.1}CodeRuleProcedureType" minOccurs="0"/>
 *         <element name="title" type=
"{http://www.aixm.aero/schema/5.1.1}CodeRuleProcedureTitleType" minOccurs="0"/>
 *         <element name="content" type=
"{http://www.aixm.aero/schema/5.1.1}XHTMLType" minOccurs="0"/>
 ...
 *                 <sequence>
 *                   <element ref=
"{http://www.aixm.aero/schema/5.1.1}AbstractRulesProceduresExtension"/>
 *                 </sequence>
 *                 <attGroup ref=
...
public class RulesProceduresTimeSliceType extends AbstractAIXMTimeSliceType implements Serializable {
    ...
    public void setCategoryItem(CodeRuleProcedureType target) {
        setCategory(XmlAdapterUtils.marshallJAXBElement(CodeRuleProcedureType.class,
                new QName("http://www.aixm.aero/schema/5.1.1", "category"), RulesProceduresTimeSliceType.class,
                target));
    }
    ...
    public void setTitleItem(CodeRuleProcedureTitleType target) {
        setTitle(XmlAdapterUtils.marshallJAXBElement(CodeRuleProcedureTitleType.class,
                new QName("http://www.aixm.aero/schema/5.1.1", "title"), RulesProceduresTimeSliceType.class, target));
    }
    ...
    public void setContentItem(XHTMLType target) {
        setContent(XmlAdapterUtils.marshallJAXBElement(XHTMLType.class,
                new QName("http://www.aixm.aero/schema/5.1.1", "content"), RulesProceduresTimeSliceType.class, target));
    }
