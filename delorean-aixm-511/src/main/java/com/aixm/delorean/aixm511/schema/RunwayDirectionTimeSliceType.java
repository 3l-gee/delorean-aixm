 ...
 *       <sequence>
 *         <group ref=
"{http://www.aixm.aero/schema/5.1.1}RunwayDirectionPropertyGroup"/>
...
public class RunwayDirectionTimeSliceType extends AbstractAIXMTimeSliceType implements Serializable {
    ...
    @ManyToOne(targetEntity = RunwayPropertyType.class, cascade = {CascadeType.ALL}, fetch = FetchType.EAGER)
    ...
    @ManyToOne(targetEntity = RunwayElementPropertyType.class, cascade = {CascadeType.ALL}, fetch = FetchType.EAGER)
