    ...
    implements Serializable
{
    ...
    @JoinTable(name = "flightrestrictionlevel_o_annotation_link", schema = "public", joinColumns = {
    ...
    @JoinColumn(name = "flightrestrictionlevel_e_hjid", referencedColumnName = "hjid")
