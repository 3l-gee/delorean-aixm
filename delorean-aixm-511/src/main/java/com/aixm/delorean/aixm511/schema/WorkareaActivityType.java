...
/**
 * <p>
 * Java class for WorkareaActivityType complex type
 * </p>
 * .
 *
 * <p>
...
="unbounded" minOccurs="0"/>
 *         <group ref=
"{http://www.aixm.aero/schema/5.1.1}WorkareaActivityPropertyGroup"/>
 ...
 *                   <element ref=
"{http://www.aixm.aero/schema/5.1.1}AbstractWorkareaActivityExtension"/>
 *                 </choice>
 *                 <attGroup ref=
...
@Table(name = "workareaactivity", schema = "airport_heliport")
public class WorkareaActivityType extends AbstractPropertiesWithScheduleType implements Serializable {
    ...
    @XmlElementRef(name = "isActive", namespace = "http://www.aixm.aero/schema/5.1.1", type = JAXBElement.class, required = false)
    ...
    @JoinTable(name = "timeinterval_workareaactivity_link", schema = "airport_heliport", joinColumns = {
            @JoinColumn(name = "timeinterval", referencedColumnName = "hjid")}, inverseJoinColumns = {
                    @JoinColumn(name = "workareaactivitytype", referencedColumnName = "hjid")})
    ...
    @JoinTable(name = "annotation_workareaactivity_link", schema = "airport_heliport", joinColumns = {
    ...
    @JoinTable(name = "specialdateauthority_workareaactivity_link", schema = "airport_heliport", joinColumns = {
    ...
    @OneToMany(targetEntity = WorkareaActivityTypeExtensionType.class, cascade = {
            CascadeType.ALL}, fetch = FetchType.EAGER)
    @JoinColumn(name = "EXTENSION_WORKAREA_ACTIVITY__0")
    ...
    @Embedded
    @AttributeOverrides({@AttributeOverride(name = "value", column = @Column(name = "isactive")),
            @AttributeOverride(name = "nilReason", column = @Column(name = "isactive_nilreason"))})
    public CodeYesNoType getIsActiveItem() {
        return XmlAdapterUtils.unmarshallSource(CodeYesNoType.class, this.getIsActive());
    }

    public void setIsActiveItem(CodeYesNoType target) {
        setIsActive(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class,
                new QName("http://www.aixm.aero/schema/5.1.1", "isActive"), WorkareaActivityType.class, target));
    }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetIsActive();
            JAXBElement<CodeYesNoType> theField;
            theField = this.getIsActive();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "isActive", theField);
            currentHashCode = strategy.hashCode(theFieldLocator, currentHashCode, theField, theFieldIsSet);
        }
        {
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        }
        {
            ...
            JAXBElement<CodeYesNoType> theField;
            theField = this.getIsActive();
            strategy.appendField(locator, this, "isActive", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetExtension();
            List<WorkareaActivityTypeExtensionType> theField;
