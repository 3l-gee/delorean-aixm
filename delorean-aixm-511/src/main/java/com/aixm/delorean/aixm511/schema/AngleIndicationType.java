...
/**
 * <p>
 * Java class for AngleIndicationType complex type
 * </p>
 * .
 *
 * <p>
 ...
 *
 * <pre>{@code
 * <complexType name="AngleIndicationType">
 *   <complexContent>
 *     <extension base=
"{http://www.aixm.aero/schema/5.1.1}AbstractAIXMFeatureType">
 *       <sequence>
 *         <element name="timeSlice" type=
"{http://www.aixm.aero/schema/5.1.1}AngleIndicationTimeSlicePropertyType" maxOccurs
="unbounded"/>
 *       </sequence>
 *     </extension>
 *   </complexContent>
...
@XmlType(name = "AngleIndicationType", propOrder = {"timeSlice"})
@Entity(name = "AngleIndicationType")
@Table(name = "angleindication", schema = "navaids_point")
public class AngleIndicationType extends AbstractAIXMFeatureType implements Serializable {
     ...
     * {@link AngleIndicationTimeSlicePropertyType }
     *
     *
     */
    @ManyToMany(targetEntity = AngleIndicationTimeSlicePropertyType.class, cascade = {
            CascadeType.ALL}, fetch = FetchType.EAGER)
    @JoinTable(name = "timeslice_angleindication_link", schema = "navaids_point", joinColumns = {
            @JoinColumn(name = "timeslice", referencedColumnName = "hjid")}, inverseJoinColumns = {
                    @JoinColumn(name = "angleindicationtype", referencedColumnName = "hjid")})
    public List<AngleIndicationTimeSlicePropertyType> getTimeSlice() {
        if (timeSlice == null) {
     ...
     *
     */
    public void setTimeSlice(List<AngleIndicationTimeSlicePropertyType> timeSlice) {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final AngleIndicationType that = ((AngleIndicationType) object);
        {
            boolean lhsFieldIsSet = this.isSetTimeSlice();
            boolean rhsFieldIsSet = that.isSetTimeSlice();
            List<AngleIndicationTimeSlicePropertyType> lhsField;
            lhsField = (this.isSetTimeSlice() ? this.getTimeSlice() : null);
            List<AngleIndicationTimeSlicePropertyType> rhsField;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = super.hashCode(locator, strategy);
        {
            ...
            List<AngleIndicationTimeSlicePropertyType> theField;
