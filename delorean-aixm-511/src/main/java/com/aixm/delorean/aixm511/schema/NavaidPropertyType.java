...
/**
 * <p>Java class for NavaidPropertyType complex type</p>.
 * 
...
@XmlType(name = "NavaidPropertyType")
@Entity(name = "NavaidPropertyType")
@Table(name = "navaidpropertytype", schema = "navaids_point")
public class NavaidPropertyType implements Serializable, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        final NavaidPropertyType that = ((NavaidPropertyType) object);
        {
