...
"{http://www.aixm.aero/schema/5.1.1}TextSIDSTARDesignatorType" minOccurs="0"/>
...
@XmlType(name = "StandardInstrumentArrivalTimeSliceType", propOrder = {"communicationFailureInstruction", "instruction",
        ...
        "aircraftCharacteristic", "flightTransition", "guidanceFacilitySpecialNavigationSystem",
        "guidanceFacilityRadar", "guidanceFacilityNavaid", "annotation", "safeAltitude", "designator", "arrival",
        "extension"})
...
public class StandardInstrumentArrivalTimeSliceType extends AbstractAIXMTimeSliceType implements Serializable {
    ...
    public void setAixmNameItem(TextNameType target) {
        setAixmName(XmlAdapterUtils.marshallJAXBElement(TextNameType.class,
                new QName("http://www.aixm.aero/schema/5.1.1", "name"), StandardInstrumentArrivalTimeSliceType.class,
                target));
    }
    ...
    public void setRNAVItem(CodeYesNoType target) {
        setRNAV(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class,
                new QName("http://www.aixm.aero/schema/5.1.1", "RNAV"), StandardInstrumentArrivalTimeSliceType.class,
                target));
    }
    ...
    public void setArrivalItem(LandingTakeoffAreaCollectionPropertyType target) {
        setArrival(XmlAdapterUtils.marshallJAXBElement(LandingTakeoffAreaCollectionPropertyType.class,
                new QName("http://www.aixm.aero/schema/5.1.1", "arrival"), StandardInstrumentArrivalTimeSliceType.class,
                target));
    }
