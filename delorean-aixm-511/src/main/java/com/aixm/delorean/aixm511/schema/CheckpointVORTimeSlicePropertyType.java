...
/**
 * <p>
 * Java class for CheckpointVORTimeSlicePropertyType complex type
 * </p>
 * .
 *
 * <p>
 ...
 *       <sequence>
 *         <element ref=
"{http://www.aixm.aero/schema/5.1.1}CheckpointVORTimeSlice"/>
 *       </sequence>
 *       <attGroup ref=
...
@XmlType(name = "CheckpointVORTimeSlicePropertyType", propOrder = {"checkpointVORTimeSlice"})
...
public class CheckpointVORTimeSlicePropertyType implements Serializable, Equals, HashCode, ToString {
     ...
     *
     * @return possible object is {@link CheckpointVORTimeSliceType }
     *
     */
    @OneToOne(targetEntity = CheckpointVORTimeSliceType.class, cascade = {CascadeType.ALL}, fetch = FetchType.EAGER)
     ...
     *
     * @param value
     *            allowed object is {@link CheckpointVORTimeSliceType }
     *
     */
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final CheckpointVORTimeSlicePropertyType that = ((CheckpointVORTimeSlicePropertyType) object);
        {
            ...
            lhsField = this.getCheckpointVORTimeSlice();
            CheckpointVORTimeSliceType rhsField;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetCheckpointVORTimeSlice();
            CheckpointVORTimeSliceType theField;
            theField = this.getCheckpointVORTimeSlice();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "checkpointVORTimeSlice", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            CheckpointVORTimeSliceType theField;
            theField = this.getCheckpointVORTimeSlice();
            strategy.appendField(locator, this, "checkpointVORTimeSlice", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetOwns();
            boolean theField;
