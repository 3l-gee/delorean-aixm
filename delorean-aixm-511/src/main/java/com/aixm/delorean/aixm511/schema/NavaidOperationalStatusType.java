...
="unbounded" minOccurs="0"/>
 *         <group ref=
"{http://www.aixm.aero/schema/5.1.1}NavaidOperationalStatusPropertyGroup"/>
...
public class NavaidOperationalStatusType extends AbstractPropertiesWithScheduleType implements Serializable {
    ...
    public void setOperationalStatusItem(CodeStatusNavaidType target) {
        setOperationalStatus(XmlAdapterUtils.marshallJAXBElement(CodeStatusNavaidType.class,
                new QName("http://www.aixm.aero/schema/5.1.1", "operationalStatus"), NavaidOperationalStatusType.class,
                target));
    }
    ...
    public void setSignalTypeItem(CodeRadioSignalType target) {
        setSignalType(XmlAdapterUtils.marshallJAXBElement(CodeRadioSignalType.class,
                new QName("http://www.aixm.aero/schema/5.1.1", "signalType"), NavaidOperationalStatusType.class,
                target));
    }
