...
@XmlType(name = "", propOrder = {"abstractDepartureLegExtension", "abstractSegmentLegExtension"})
@Entity(name = "DepartureLegTimeSliceExtensionType")
@Table(name = "departureleg_te", schema = "procedure")
public class DepartureLegTimeSliceExtensionType implements Serializable, Equals, HashCode, ToString {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final DepartureLegTimeSliceExtensionType that = ((DepartureLegTimeSliceExtensionType) object);
        {
            ...
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "abstractDepartureLegExtension",
                    lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "abstractDepartureLegExtension",
                    rhsField);
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetAbstractDepartureLegExtension();
            AbstractExtensionType theField;
            theField = this.getAbstractDepartureLegExtension();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "abstractDepartureLegExtension", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            AbstractExtensionType theField;
            theField = this.getAbstractDepartureLegExtension();
            strategy.appendField(locator, this, "abstractDepartureLegExtension", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetAbstractSegmentLegExtension();
            AbstractExtensionType theField;
