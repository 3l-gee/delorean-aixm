...
/**
 * <p>
 * Java class for DeicingAreaMarkingTimeSlicePropertyType complex type
 * </p>
 * .
 *
 * <p>
 ...
 *       <sequence>
 *         <element ref=
"{http://www.aixm.aero/schema/5.1.1}DeicingAreaMarkingTimeSlice"/>
 *       </sequence>
 *       <attGroup ref=
...
@XmlType(name = "DeicingAreaMarkingTimeSlicePropertyType", propOrder = {"deicingAreaMarkingTimeSlice"})
...
public class DeicingAreaMarkingTimeSlicePropertyType implements Serializable, Equals, HashCode, ToString {
     ...
     *
     * @return possible object is {@link DeicingAreaMarkingTimeSliceType }
     *
     */
    @OneToOne(targetEntity = DeicingAreaMarkingTimeSliceType.class, cascade = {
            CascadeType.ALL}, fetch = FetchType.EAGER)
    @JoinColumn(name = "deicingareamarkingtimeslice_hjid", referencedColumnName = "hjid")
     ...
     *
     * @param value
     *            allowed object is {@link DeicingAreaMarkingTimeSliceType }
     *
     */
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetDeicingAreaMarkingTimeSlice();
            DeicingAreaMarkingTimeSliceType theField;
            theField = this.getDeicingAreaMarkingTimeSlice();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "deicingAreaMarkingTimeSlice", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            DeicingAreaMarkingTimeSliceType theField;
            theField = this.getDeicingAreaMarkingTimeSlice();
            strategy.appendField(locator, this, "deicingAreaMarkingTimeSlice", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetOwns();
            boolean theField;
