...
/**
 * <p>
 * Java class for HoldingPatternTimeSlicePropertyType complex type
 * </p>
 * .
 *
 * <p>
 ...
 *       <sequence>
 *         <element ref=
"{http://www.aixm.aero/schema/5.1.1}HoldingPatternTimeSlice"/>
 *       </sequence>
 *       <attGroup ref=
...
@XmlType(name = "HoldingPatternTimeSlicePropertyType", propOrder = {"holdingPatternTimeSlice"})
...
public class HoldingPatternTimeSlicePropertyType implements Serializable, Equals, HashCode, ToString {
     ...
     *
     * @return possible object is {@link HoldingPatternTimeSliceType }
     *
     */
    @OneToOne(targetEntity = HoldingPatternTimeSliceType.class, cascade = {CascadeType.ALL}, fetch = FetchType.EAGER)
     ...
     *
     * @param value
     *            allowed object is {@link HoldingPatternTimeSliceType }
     *
     */
    ...
    @Transient
    public boolean isSetHoldingPatternTimeSlice() {
        return (this.holdingPatternTimeSlice != null);
    }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetHoldingPatternTimeSlice();
            HoldingPatternTimeSliceType theField;
            theField = this.getHoldingPatternTimeSlice();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "holdingPatternTimeSlice", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            HoldingPatternTimeSliceType theField;
            theField = this.getHoldingPatternTimeSlice();
            strategy.appendField(locator, this, "holdingPatternTimeSlice", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetOwns();
            boolean theField;
