...
"{http://www.aixm.aero/schema/5.1.1}CodeLanguageType" minOccurs="0"/>
 ...
 *                 <choice>
 *                   <element ref=
"{http://www.aixm.aero/schema/5.1.1}AbstractCallsignDetailExtension"/>
 *                 </choice>
 *                 <attGroup ref=
...
public class CallsignDetailType extends AbstractAIXMObjectType implements Serializable {
    ...
    public void setCallSignItem(TextNameType target) {
        setCallSign(XmlAdapterUtils.marshallJAXBElement(TextNameType.class,
                new QName("http://www.aixm.aero/schema/5.1.1", "callSign"), CallsignDetailType.class, target));
    }
    ...
    public void setLanguageItem(CodeLanguageType target) {
        setLanguage(XmlAdapterUtils.marshallJAXBElement(CodeLanguageType.class,
                new QName("http://www.aixm.aero/schema/5.1.1", "language"), CallsignDetailType.class, target));
    }
