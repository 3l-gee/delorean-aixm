...
/**
 * <p>
 * Java class for UnitAvailabilityType complex type
 * </p>
 * .
 *
 * <p>
...
="unbounded" minOccurs="0"/>
 *         <group ref=
"{http://www.aixm.aero/schema/5.1.1}UnitAvailabilityPropertyGroup"/>
 ...
 *                   <element ref=
"{http://www.aixm.aero/schema/5.1.1}AbstractUnitAvailabilityExtension"/>
 *                 </choice>
 *                 <attGroup ref=
...
@Table(name = "unitavailability", schema = "organisation")
public class UnitAvailabilityType extends AbstractPropertiesWithScheduleType implements Serializable {
    ...
    @JoinTable(name = "timeinterval_unitavailability_link", schema = "organisation", joinColumns = {
            @JoinColumn(name = "timeinterval", referencedColumnName = "hjid")}, inverseJoinColumns = {
                    @JoinColumn(name = "unitavailabilitytype", referencedColumnName = "hjid")})
    ...
    @JoinTable(name = "annotation_unitavailability_link", schema = "organisation", joinColumns = {
    ...
    @JoinTable(name = "specialdateauthority_unitavailability_link", schema = "organisation", joinColumns = {
    ...
    @OneToMany(targetEntity = UnitAvailabilityTypeExtensionType.class, cascade = {
            CascadeType.ALL}, fetch = FetchType.EAGER)
    @JoinColumn(name = "EXTENSION_UNIT_AVAILABILITY__0")
    ...
    public void setOperationalStatusItem(CodeStatusOperationsType target) {
        setOperationalStatus(XmlAdapterUtils.marshallJAXBElement(CodeStatusOperationsType.class,
                new QName("http://www.aixm.aero/schema/5.1.1", "operationalStatus"), UnitAvailabilityType.class,
                target));
    }
