...
/**
 * <p>Java class for RunwayPropertyType complex type</p>.
 * 
...
@XmlType(name = "RunwayPropertyType")
@Entity(name = "RunwayPropertyType")
@Table(name = "runwaypropertytype", schema = "airport_heliport")
public class RunwayPropertyType implements Serializable, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        final RunwayPropertyType that = ((RunwayPropertyType) object);
        {
