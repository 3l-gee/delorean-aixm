...
/**
 * <p>Java class for RoutePropertyType complex type</p>.
 * 
...
@XmlType(name = "RoutePropertyType")
@Entity(name = "RoutePropertyType")
@Table(name = "routepropertytype", schema = "route")
public class RoutePropertyType implements Serializable, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        final RoutePropertyType that = ((RoutePropertyType) object);
        {
