 ...
 *       <sequence>
 *         <group ref=
"{http://www.aixm.aero/schema/5.1.1}AirportHeliportPropertyGroup"/>
...
public class AirportHeliportTimeSliceType extends AbstractAIXMTimeSliceType implements Serializable {
    ...
    @JoinTable(name = "contaminant_airportheliport_link", schema = "airport_heliport", joinColumns = {
            @JoinColumn(name = "contaminant", referencedColumnName = "hjid")}, inverseJoinColumns = {
     ...
     *
     */
    @ManyToMany(targetEntity = CityPropertyType.class, cascade = {CascadeType.ALL}, fetch = FetchType.EAGER)
    @JoinTable(name = "servedcity_airportheliport_link", schema = "airport_heliport", joinColumns = {
            @JoinColumn(name = "servedcity", referencedColumnName = "hjid")}, inverseJoinColumns = {
                    @JoinColumn(name = "airportheliportpropertygroup", referencedColumnName = "hjid")})
     ...
     *
     */
    @ManyToMany(targetEntity = AltimeterSourcePropertyType.class, cascade = {CascadeType.ALL}, fetch = FetchType.EAGER)
    @JoinTable(name = "altimetersource_airportheliport_link", schema = "airport_heliport", joinColumns = {
            @JoinColumn(name = "altimetersource", referencedColumnName = "hjid")}, inverseJoinColumns = {
                    @JoinColumn(name = "airportheliportpropertygroup", referencedColumnName = "hjid")})
    ...
    @JoinTable(name = "contact_airportheliport_link", schema = "airport_heliport", joinColumns = {
            @JoinColumn(name = "contact", referencedColumnName = "hjid")}, inverseJoinColumns = {
                    @JoinColumn(name = "airportheliportpropertygroup", referencedColumnName = "hjid")})
