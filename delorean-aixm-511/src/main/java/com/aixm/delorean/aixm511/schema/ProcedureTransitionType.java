...
"{http://www.aixm.aero/schema/5.1.1}CodeDesignatedPointDesignatorType" minOccurs
="0"/>
 *         <element name="type" type=
"{http://www.aixm.aero/schema/5.1.1}CodeProcedurePhaseType" minOccurs="0"/>
 ...
 *         <element name="departureRunwayTransition" type=
...
"{http://www.aixm.aero/schema/5.1.1}ProcedureTransitionLegPropertyType" maxOccurs
 ...
 *                 <choice>
 *                   <element ref=
"{http://www.aixm.aero/schema/5.1.1}AbstractProcedureTransitionExtension"/>
 *                 </choice>
 *                 <attGroup ref=
...
@XmlType(name = "ProcedureTransitionType", propOrder = {"transitionId", "type", "instruction", "vectorHeading",
        "departureRunwayTransition", "trajectory", "transitionLeg", "annotation", "extension"})
...
public class ProcedureTransitionType extends AbstractAIXMObjectType implements Serializable {
    ...
    public void setTransitionIdItem(CodeDesignatedPointDesignatorType target) {
        setTransitionId(XmlAdapterUtils.marshallJAXBElement(CodeDesignatedPointDesignatorType.class,
                new QName("http://www.aixm.aero/schema/5.1.1", "transitionId"), ProcedureTransitionType.class, target));
    }
    ...
    public void setTypeItem(CodeProcedurePhaseType target) {
        setType(XmlAdapterUtils.marshallJAXBElement(CodeProcedurePhaseType.class,
                new QName("http://www.aixm.aero/schema/5.1.1", "type"), ProcedureTransitionType.class, target));
    }
    ...
    public void setInstructionItem(TextInstructionType target) {
        setInstruction(XmlAdapterUtils.marshallJAXBElement(TextInstructionType.class,
                new QName("http://www.aixm.aero/schema/5.1.1", "instruction"), ProcedureTransitionType.class, target));
    }
    ...
    public void setVectorHeadingItem(ValBearingType target) {
        setVectorHeading(XmlAdapterUtils.marshallJAXBElement(ValBearingType.class,
                new QName("http://www.aixm.aero/schema/5.1.1", "vectorHeading"), ProcedureTransitionType.class,
                target));
    }

    @OneToOne(targetEntity = LandingTakeoffAreaCollectionPropertyType.class, cascade = {
            CascadeType.ALL}, fetch = FetchType.EAGER)
    @JoinTable(name = "prcdrtrnstntp_dprtrrnwtrnstn_link", schema = "procedure", joinColumns = {
            @JoinColumn(name = "proceduretransition_o_hjid", referencedColumnName = "hjid")}, inverseJoinColumns = {
    ...
    public LandingTakeoffAreaCollectionPropertyType getDepartureRunwayTransitionItem() {
        return XmlAdapterUtils.unmarshallSource(LandingTakeoffAreaCollectionPropertyType.class,
                this.getDepartureRunwayTransition());
    }

    public void setDepartureRunwayTransitionItem(LandingTakeoffAreaCollectionPropertyType target) {
        setDepartureRunwayTransition(XmlAdapterUtils.marshallJAXBElement(LandingTakeoffAreaCollectionPropertyType.class,
                new QName("http://www.aixm.aero/schema/5.1.1", "departureRunwayTransition"),
                ProcedureTransitionType.class, target));
    }
    ...
    public void setTrajectoryItem(AIXMCurvePropertyType target) {
        setTrajectory(XmlAdapterUtils.marshallJAXBElement(AIXMCurvePropertyType.class,
                new QName("http://www.aixm.aero/schema/5.1.1", "trajectory"), ProcedureTransitionType.class, target));
    }
