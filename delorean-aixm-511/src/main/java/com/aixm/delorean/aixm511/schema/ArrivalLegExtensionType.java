...
@Entity(name = "ArrivalLegExtensionType")
@Table(name = "arrivallege", schema = "procedure")
public class ArrivalLegExtensionType implements Serializable, Equals, HashCode, ToString {
