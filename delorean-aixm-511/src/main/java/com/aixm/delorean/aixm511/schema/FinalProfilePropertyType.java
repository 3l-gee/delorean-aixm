...
/**
 * <p>
 * Java class for FinalProfilePropertyType complex type
 * </p>
 * .
 *
 * <p>
...
@XmlType(name = "FinalProfilePropertyType", propOrder = {"finalProfile"})
@Entity(name = "FinalProfilePropertyType")
@Table(name = "finalprofile_p", schema = "procedure")
public class FinalProfilePropertyType extends AbstractAIXMPropertyType implements Serializable {
     ...
     *
     * @return possible object is {@link FinalProfileType }
     *
     */
    @OneToOne(targetEntity = FinalProfileType.class, cascade = {CascadeType.ALL}, fetch = FetchType.EAGER)
     ...
     *
     * @param value
     *            allowed object is {@link FinalProfileType }
     *
     */
