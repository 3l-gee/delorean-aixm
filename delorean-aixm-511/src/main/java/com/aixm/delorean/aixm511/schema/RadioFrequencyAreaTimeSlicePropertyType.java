 ...
 *       <sequence>
 *         <element ref=
"{http://www.aixm.aero/schema/5.1.1}RadioFrequencyAreaTimeSlice"/>
 *       </sequence>
 *       <attGroup ref=
...
public class RadioFrequencyAreaTimeSlicePropertyType implements Serializable, Equals, HashCode, ToString {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final RadioFrequencyAreaTimeSlicePropertyType that = ((RadioFrequencyAreaTimeSlicePropertyType) object);
        {
            boolean lhsFieldIsSet = this.isSetRadioFrequencyAreaTimeSlice();
            boolean rhsFieldIsSet = that.isSetRadioFrequencyAreaTimeSlice();
            RadioFrequencyAreaTimeSliceType lhsField;
            lhsField = this.getRadioFrequencyAreaTimeSlice();
            RadioFrequencyAreaTimeSliceType rhsField;
            rhsField = that.getRadioFrequencyAreaTimeSlice();
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "radioFrequencyAreaTimeSlice", lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "radioFrequencyAreaTimeSlice", rhsField);
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetRadioFrequencyAreaTimeSlice();
            RadioFrequencyAreaTimeSliceType theField;
            theField = this.getRadioFrequencyAreaTimeSlice();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "radioFrequencyAreaTimeSlice", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            RadioFrequencyAreaTimeSliceType theField;
            theField = this.getRadioFrequencyAreaTimeSlice();
            strategy.appendField(locator, this, "radioFrequencyAreaTimeSlice", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetOwns();
            boolean theField;
