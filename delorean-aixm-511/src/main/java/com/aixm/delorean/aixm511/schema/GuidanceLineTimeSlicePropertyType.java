...
/**
 * <p>
 * Java class for GuidanceLineTimeSlicePropertyType complex type
 * </p>
 * .
 *
 * <p>
 ...
 *       <sequence>
 *         <element ref=
"{http://www.aixm.aero/schema/5.1.1}GuidanceLineTimeSlice"/>
 *       </sequence>
 *       <attGroup ref=
...
@XmlType(name = "GuidanceLineTimeSlicePropertyType", propOrder = {"guidanceLineTimeSlice"})
@FilterDef(name = "TPHjidFilter", parameters = {@ParamDef(name = "ids", type = Long.class)})
@Filter(name = "TPHjidFilter", condition = "hjid IN (:ids)")
@Entity(name = "GuidanceLineTimeSlicePropertyType")
@Table(name = "guidanceline_tp", schema = "airport_heliport")
public class GuidanceLineTimeSlicePropertyType implements Serializable, Equals, HashCode, ToString {
     ...
     *
     * @return possible object is {@link GuidanceLineTimeSliceType }
     *
     */
    @OneToOne(targetEntity = GuidanceLineTimeSliceType.class, cascade = {CascadeType.ALL}, fetch = FetchType.EAGER)
    @JoinColumn(name = "guidancelinetimeslice_hjid", referencedColumnName = "hjid")
     ...
     *
     * @param value
     *            allowed object is {@link GuidanceLineTimeSliceType }
     *
     */
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetGuidanceLineTimeSlice();
            GuidanceLineTimeSliceType theField;
            theField = this.getGuidanceLineTimeSlice();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "guidanceLineTimeSlice", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            GuidanceLineTimeSliceType theField;
            theField = this.getGuidanceLineTimeSlice();
            strategy.appendField(locator, this, "guidanceLineTimeSlice", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetOwns();
            boolean theField;
