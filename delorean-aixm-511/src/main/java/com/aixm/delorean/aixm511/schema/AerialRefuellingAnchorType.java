 ...
 *       <sequence>
 *         <group ref=
"{http://www.aixm.aero/schema/5.1.1}AerialRefuellingAnchorPropertyGroup"/>
...
public class AerialRefuellingAnchorType extends AbstractAIXMObjectType implements Serializable {
    ...
    @JoinTable(name = "verticalextent_aerialrefuellinganchor_link", schema = "aerial_refuelling", joinColumns = {
            @JoinColumn(name = "verticalextent", referencedColumnName = "hjid")}, inverseJoinColumns = {
    ...
    @JoinTable(name = "point_aerialrefuellinganchor_link", schema = "aerial_refuelling", joinColumns = {
            @JoinColumn(name = "point", referencedColumnName = "hjid")}, inverseJoinColumns = {
                    @JoinColumn(name = "aerialrefuellinganchorpropertygroup", referencedColumnName = "hjid")})
