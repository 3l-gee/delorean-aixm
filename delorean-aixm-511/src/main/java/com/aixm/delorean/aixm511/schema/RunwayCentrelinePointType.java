...
/**
 * <p>
 * Java class for RunwayCentrelinePointType complex type
 * </p>
 * .
 *
 * <p>
...
"{http://www.aixm.aero/schema/5.1.1}RunwayCentrelinePointTimeSlicePropertyType" maxOccurs
="unbounded"/>
 *       </sequence>
 *     </extension>
 *   </complexContent>
...
@XmlType(name = "RunwayCentrelinePointType", propOrder = {"timeSlice"})
@Entity(name = "RunwayCentrelinePointType")
@Table(name = "runwaycentrelinepoint", schema = "airport_heliport")
public class RunwayCentrelinePointType extends AbstractAIXMFeatureType implements Serializable {
     ...
     *
     */
    @ManyToMany(targetEntity = RunwayCentrelinePointTimeSlicePropertyType.class, cascade = {
            CascadeType.ALL}, fetch = FetchType.EAGER)
    @JoinTable(name = "timeslice_runwaycentrelinepoint_link", schema = "airport_heliport", joinColumns = {
            @JoinColumn(name = "timeslice", referencedColumnName = "hjid")}, inverseJoinColumns = {
                    @JoinColumn(name = "runwaycentrelinepointtype", referencedColumnName = "hjid")})
     ...
     *
     */
    public void setTimeSlice(List<RunwayCentrelinePointTimeSlicePropertyType> timeSlice) {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final RunwayCentrelinePointType that = ((RunwayCentrelinePointType) object);
        {
            boolean lhsFieldIsSet = this.isSetTimeSlice();
            boolean rhsFieldIsSet = that.isSetTimeSlice();
            List<RunwayCentrelinePointTimeSlicePropertyType> lhsField;
            lhsField = (this.isSetTimeSlice() ? this.getTimeSlice() : null);
            List<RunwayCentrelinePointTimeSlicePropertyType> rhsField;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = super.hashCode(locator, strategy);
        {
            ...
            List<RunwayCentrelinePointTimeSlicePropertyType> theField;
