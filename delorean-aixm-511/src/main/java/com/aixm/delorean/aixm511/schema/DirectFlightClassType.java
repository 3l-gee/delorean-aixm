 ...
 *         <group ref=
"{http://www.aixm.aero/schema/5.1.1}DirectFlightClassPropertyGroup"/>
...
@Table(name = "directflightclass", schema = "route")
public class DirectFlightClassType extends AbstractDirectFlightType implements Serializable {
    ...
    @JoinTable(name = "annotation_directflightclass_link", schema = "route", joinColumns = {
            @JoinColumn(name = "annotation", referencedColumnName = "hjid")}, inverseJoinColumns = {
                    @JoinColumn(name = "directflightclasstype", referencedColumnName = "hjid")})
    ...
    public void setExceedLengthItem(ValDistanceType target) {
        setExceedLength(XmlAdapterUtils.marshallJAXBElement(ValDistanceType.class,
                new QName("http://www.aixm.aero/schema/5.1.1", "exceedLength"), DirectFlightClassType.class, target));
    }
