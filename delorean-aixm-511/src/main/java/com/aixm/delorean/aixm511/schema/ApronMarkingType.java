...
/**
 * <p>
 * Java class for ApronMarkingType complex type
 * </p>
 * .
 *
 * <p>
 ...
 *
 * <pre>{@code
 * <complexType name="ApronMarkingType">
 *   <complexContent>
 *     <extension base="{http://www.aixm.aero/schema/5.1.1}AbstractMarkingType">
 *       <sequence>
 *         <element name="timeSlice" type=
"{http://www.aixm.aero/schema/5.1.1}ApronMarkingTimeSlicePropertyType" maxOccurs
="unbounded"/>
 *       </sequence>
 *     </extension>
 *   </complexContent>
...
@XmlType(name = "ApronMarkingType", propOrder = {"timeSlice"})
@Entity(name = "ApronMarkingType")
@Table(name = "apronmarking", schema = "airport_heliport")
public class ApronMarkingType extends AbstractMarkingType implements Serializable {
     ...
     * {@link ApronMarkingTimeSlicePropertyType }
     *
     *
     */
    @Filter(name = "TSPHjidFilter", condition = "hjid IN (:ids)")
    @ManyToMany(targetEntity = ApronMarkingTimeSlicePropertyType.class, cascade = {
            CascadeType.ALL}, fetch = FetchType.EAGER)
    @JoinTable(name = "timeslice_apronmarking_link", schema = "airport_heliport", joinColumns = {
            @JoinColumn(name = "timeslice", referencedColumnName = "hjid")}, inverseJoinColumns = {
                    @JoinColumn(name = "apronmarkingtype", referencedColumnName = "hjid")})
    public List<ApronMarkingTimeSlicePropertyType> getTimeSlice() {
        if (timeSlice == null) {
     ...
     *
     */
    public void setTimeSlice(List<ApronMarkingTimeSlicePropertyType> timeSlice) {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final ApronMarkingType that = ((ApronMarkingType) object);
        {
            boolean lhsFieldIsSet = this.isSetTimeSlice();
            boolean rhsFieldIsSet = that.isSetTimeSlice();
            List<ApronMarkingTimeSlicePropertyType> lhsField;
            lhsField = (this.isSetTimeSlice() ? this.getTimeSlice() : null);
            List<ApronMarkingTimeSlicePropertyType> rhsField;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = super.hashCode(locator, strategy);
        {
            ...
            List<ApronMarkingTimeSlicePropertyType> theField;
