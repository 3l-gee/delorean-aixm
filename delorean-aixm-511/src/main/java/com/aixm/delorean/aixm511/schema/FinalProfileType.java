 ...
 *       <sequence>
 *         <group ref=
"{http://www.aixm.aero/schema/5.1.1}FinalProfilePropertyGroup"/>
...
public class FinalProfileType extends AbstractAIXMObjectType implements Serializable {
    ...
    @JoinTable(name = "altitude_finalprofile_link", schema = "procedure", joinColumns = {
            @JoinColumn(name = "altitude", referencedColumnName = "hjid")}, inverseJoinColumns = {
    ...
    @JoinTable(name = "distance_finalprofile_link", schema = "procedure", joinColumns = {
            @JoinColumn(name = "distance", referencedColumnName = "hjid")}, inverseJoinColumns = {
                    @JoinColumn(name = "finalprofilepropertygroup", referencedColumnName = "hjid")})
    ...
    @JoinTable(name = "timing_finalprofile_link", schema = "procedure", joinColumns = {
            @JoinColumn(name = "timing", referencedColumnName = "hjid")}, inverseJoinColumns = {
                    @JoinColumn(name = "finalprofilepropertygroup", referencedColumnName = "hjid")})
