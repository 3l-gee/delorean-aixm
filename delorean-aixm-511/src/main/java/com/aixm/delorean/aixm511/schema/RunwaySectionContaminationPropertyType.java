...
/**
 * <p>
 * Java class for RunwaySectionContaminationPropertyType complex type
 * </p>
 * .
 *
 * <p>
 ...
 *       <sequence>
 *         <element ref=
"{http://www.aixm.aero/schema/5.1.1}RunwaySectionContamination"/>
 *       </sequence>
 *     </extension>
 *   </complexContent>
 * </complexType>
...
@XmlType(name = "RunwaySectionContaminationPropertyType", propOrder = {"runwaySectionContamination"})
@Entity(name = "RunwaySectionContaminationPropertyType")
@Table(name = "runwaysectioncontamination_p", schema = "airport_heliport")
public class RunwaySectionContaminationPropertyType extends AbstractAIXMPropertyType implements Serializable {
     ...
     *
     * @return possible object is {@link RunwaySectionContaminationType }
     *
     */
    @OneToOne(targetEntity = RunwaySectionContaminationType.class, cascade = {CascadeType.ALL}, fetch = FetchType.EAGER)
    @JoinColumn(name = "runwaysectioncontamination_hjid", referencedColumnName = "hjid")
     ...
     *
     * @param value
     *            allowed object is {@link RunwaySectionContaminationType }
     *
     */
