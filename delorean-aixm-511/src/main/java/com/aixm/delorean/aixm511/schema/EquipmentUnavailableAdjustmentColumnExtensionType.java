...
@XmlType(name = "", propOrder = {"abstractEquipmentUnavailableAdjustmentColumnExtension"})
@Entity(name = "EquipmentUnavailableAdjustmentColumnExtensionType")
@Table(name = "equipmentunavailableadjustmentcolumn_oe", schema = "procedure")
public class EquipmentUnavailableAdjustmentColumnExtensionType implements Serializable, Equals, HashCode, ToString {
    ...
    /**
     * Gets the value of the abstractEquipmentUnavailableAdjustmentColumnExtension
     * property.
     *
    ...
    /**
     * Sets the value of the abstractEquipmentUnavailableAdjustmentColumnExtension
     * property.
     *
     * @param value
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final EquipmentUnavailableAdjustmentColumnExtensionType that = ((EquipmentUnavailableAdjustmentColumnExtensionType) object);
        {
        ...
        }
        {
            ...
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator,
                    "abstractEquipmentUnavailableAdjustmentColumnExtension", lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator,
                    "abstractEquipmentUnavailableAdjustmentColumnExtension", rhsField);
            if (!strategy.equals(lhsFieldLocator, rhsFieldLocator, lhsField, rhsField, lhsFieldIsSet, rhsFieldIsSet)) {
                return false;
            }
        }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetAbstractEquipmentUnavailableAdjustmentColumnExtension();
            AbstractExtensionType theField;
            theField = this.getAbstractEquipmentUnavailableAdjustmentColumnExtension();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator,
                    "abstractEquipmentUnavailableAdjustmentColumnExtension", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            AbstractExtensionType theField;
            theField = this.getAbstractEquipmentUnavailableAdjustmentColumnExtension();
            strategy.appendField(locator, this, "abstractEquipmentUnavailableAdjustmentColumnExtension", buffer,
