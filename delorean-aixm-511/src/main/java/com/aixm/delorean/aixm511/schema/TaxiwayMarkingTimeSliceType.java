 ...
 *       <sequence>
 *         <group ref=
"{http://www.aixm.aero/schema/5.1.1}TaxiwayMarkingPropertyGroup"/>
...
public class TaxiwayMarkingTimeSliceType extends AbstractAIXMTimeSliceType implements Serializable {
    ...
    @ManyToOne(targetEntity = TaxiwayElementPropertyType.class, cascade = {CascadeType.ALL}, fetch = FetchType.EAGER)
