 ...
 *         <element name="markingLocation" type="{http://www.aixm.aero/schema/5.1.1}CodeTaxiwaySectionType" minOccurs="0"/>
 *         <element name="markedTaxiway" type="{http://www.aixm.aero/schema/5.1.1}TaxiwayPropertyType" minOccurs="0"/>
 *         <element name="markedElement" type="{http://www.aixm.aero/schema/5.1.1}TaxiwayElementPropertyType" minOccurs="0"/>
    ...
    implements Serializable
{
    ...
    @JoinTable(name = "taxiwaymarking_t_element_link", schema = "public", joinColumns = {
    ...
    @JoinTable(name = "taxiwaymarking_t_annotation_link", schema = "public", joinColumns = {
        @JoinColumn(name = "taxiwaymarking_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinColumn(name = "taxiwaymarking_e_hjid", referencedColumnName = "hjid")
    ...
    @JoinTable(name = "taxiwaymarking_t_markedtaxiway_link", schema = "public", joinColumns = {
        @JoinColumn(name = "taxiwaymarking_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "taxiwaymarking_t_markedelement_link", schema = "public", joinColumns = {
        @JoinColumn(name = "taxiwaymarking_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
