...
@XmlType(name = "", propOrder = {"abstractFinalProfileExtension"})
@Entity(name = "FinalProfileExtensionType")
@Table(name = "finalprofile_oe", schema = "procedure")
public class FinalProfileExtensionType implements Serializable, Equals, HashCode, ToString {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final FinalProfileExtensionType that = ((FinalProfileExtensionType) object);
        {
            ...
            lhsField = this.getAbstractFinalProfileExtension();
            AbstractExtensionType rhsField;
            rhsField = that.getAbstractFinalProfileExtension();
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "abstractFinalProfileExtension",
                    lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "abstractFinalProfileExtension",
                    rhsField);
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetAbstractFinalProfileExtension();
            AbstractExtensionType theField;
            theField = this.getAbstractFinalProfileExtension();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "abstractFinalProfileExtension", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            AbstractExtensionType theField;
            theField = this.getAbstractFinalProfileExtension();
            strategy.appendField(locator, this, "abstractFinalProfileExtension", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetOwns();
            boolean theField;
