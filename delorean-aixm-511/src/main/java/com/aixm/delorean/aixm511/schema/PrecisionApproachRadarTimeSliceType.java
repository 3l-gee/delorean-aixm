 ...
 *       <sequence>
 *         <group ref=
"{http://www.aixm.aero/schema/5.1.1}PrecisionApproachRadarPropertyGroup"/>
...
public class PrecisionApproachRadarTimeSliceType extends AbstractAIXMTimeSliceType implements Serializable {
     ...
     *
     */
    @ManyToMany(targetEntity = ReflectorPropertyType.class, cascade = {CascadeType.ALL}, fetch = FetchType.EAGER)
    @JoinTable(name = "reflector_precisionapproachradar_link", schema = "surveillance", joinColumns = {
            @JoinColumn(name = "reflector", referencedColumnName = "hjid")}, inverseJoinColumns = {
                    @JoinColumn(name = "precisionapproachradarpropertygroup", referencedColumnName = "hjid")})
    ...
    @OneToMany(targetEntity = PrecisionApproachRadarExtensionType.class, cascade = {
            CascadeType.ALL}, fetch = FetchType.EAGER)
    @JoinColumn(name = "EXTENSION_PRECISION_APPROACH_0")
