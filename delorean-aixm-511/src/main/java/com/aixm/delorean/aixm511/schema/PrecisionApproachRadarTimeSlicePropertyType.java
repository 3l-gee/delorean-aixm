 ...
 *       <sequence>
 *         <element ref="{http://www.aixm.aero/schema/5.1.1}PrecisionApproachRadarTimeSlice"/>
 *       </sequence>
...
public class PrecisionApproachRadarTimeSlicePropertyType implements Serializable, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        final PrecisionApproachRadarTimeSlicePropertyType that = ((PrecisionApproachRadarTimeSlicePropertyType) object);
        {
        ...
        {
            boolean lhsFieldIsSet = this.isSetPrecisionApproachRadarTimeSlice();
            boolean rhsFieldIsSet = that.isSetPrecisionApproachRadarTimeSlice();
            PrecisionApproachRadarTimeSliceType lhsField;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetPrecisionApproachRadarTimeSlice();
            PrecisionApproachRadarTimeSliceType theField;
            theField = this.getPrecisionApproachRadarTimeSlice();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "precisionApproachRadarTimeSlice", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            PrecisionApproachRadarTimeSliceType theField;
            theField = this.getPrecisionApproachRadarTimeSlice();
            strategy.appendField(locator, this, "precisionApproachRadarTimeSlice", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetOwns();
            boolean theField;
