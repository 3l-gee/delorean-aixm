...
/**
 * <p>Java class for AuthorityForSpecialNavigationStationType complex type</p>.
 * 
 ...
 *       <sequence>
 *         <group ref="{http://www.aixm.aero/schema/5.1.1}AuthorityForSpecialNavigationStationPropertyGroup"/>
...
@Table(name = "authorityforspecialnavigationstation", schema = "navaids_point")
    ...
    implements Serializable
{
    ...
    protected List<AuthorityForSpecialNavigationStationTypeExtensionType> extension;
    ...
    @JoinTable(name = "annotation_authorityforspecialnavigationstation_link", schema = "navaids_point", joinColumns = {
        @JoinColumn(name = "annotation", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
        @JoinColumn(name = "authorityforspecialnavigationstationpropertygroup", referencedColumnName = "hjid")
    })
     ...
     * 
     */
    public void setExtension(List<AuthorityForSpecialNavigationStationTypeExtensionType> extension) {
    ...
    public void setTypeItem(CodeAuthorityRoleType target) {
        setType(XmlAdapterUtils.marshallJAXBElement(CodeAuthorityRoleType.class, new QName("http://www.aixm.aero/schema/5.1.1", "type"), AuthorityForSpecialNavigationStationType.class, target));
    }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        }
        {
            ...
            List<AuthorityForSpecialNavigationStationTypeExtensionType> lhsField;
            lhsField = (this.isSetExtension()?this.getExtension():null);
            List<AuthorityForSpecialNavigationStationTypeExtensionType> rhsField;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        }
        {
            ...
            List<AuthorityForSpecialNavigationStationTypeExtensionType> theField;
