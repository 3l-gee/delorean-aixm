    ...
    implements Serializable
{
    ...
    @JoinTable(name = "authorityforspecialnavigationstation_o_annotation_link", schema = "public", joinColumns = {
    ...
    @JoinTable(name = "authorityforspecialnavigationstation_o_theorganisationauthority_link", schema = "public", joinColumns = {
        @JoinColumn(name = "authorityforspecialnavigationstation_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinColumn(name = "authorityforspecialnavigationstation_e_hjid", referencedColumnName = "hjid")
