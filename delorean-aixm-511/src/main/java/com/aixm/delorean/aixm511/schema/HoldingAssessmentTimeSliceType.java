 ...
 *       <sequence>
 *         <group ref=
"{http://www.aixm.aero/schema/5.1.1}HoldingAssessmentPropertyGroup"/>
...
public class HoldingAssessmentTimeSliceType extends AbstractAIXMTimeSliceType implements Serializable {
    ...
    @JoinTable(name = "obstacleassessment_holdingassessment_link", schema = "shared", joinColumns = {
            @JoinColumn(name = "obstacleassessment", referencedColumnName = "hjid")}, inverseJoinColumns = {
    ...
    @ManyToOne(targetEntity = SegmentPointPropertyType.class, cascade = {CascadeType.ALL}, fetch = FetchType.EAGER)
    ...
    @ManyToOne(targetEntity = UnplannedHoldingPropertyType.class, cascade = {CascadeType.ALL}, fetch = FetchType.EAGER)
