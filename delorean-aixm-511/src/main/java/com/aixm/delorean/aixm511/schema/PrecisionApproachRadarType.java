...
/**
 * <p>
 * Java class for PrecisionApproachRadarType complex type
 * </p>
 * .
 *
 * <p>
 ...
 *   <complexContent>
 *     <extension base=
"{http://www.aixm.aero/schema/5.1.1}AbstractRadarEquipmentType">
 *       <sequence>
 *         <element name="timeSlice" type=
"{http://www.aixm.aero/schema/5.1.1}PrecisionApproachRadarTimeSlicePropertyType" maxOccurs
="unbounded"/>
 *       </sequence>
 *     </extension>
 *   </complexContent>
...
@XmlType(name = "PrecisionApproachRadarType", propOrder = {"timeSlice"})
@Entity(name = "PrecisionApproachRadarType")
@Table(name = "precisionapproachradar_f", schema = "surveillance")
public class PrecisionApproachRadarType extends AbstractRadarEquipmentType implements Serializable {
    ...
    @OneToMany(targetEntity = PrecisionApproachRadarTimeSlicePropertyType.class, cascade = {
     ...
     *
     */
    public void setTimeSlice(List<PrecisionApproachRadarTimeSlicePropertyType> timeSlice) {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final PrecisionApproachRadarType that = ((PrecisionApproachRadarType) object);
        {
            boolean lhsFieldIsSet = this.isSetTimeSlice();
            boolean rhsFieldIsSet = that.isSetTimeSlice();
            List<PrecisionApproachRadarTimeSlicePropertyType> lhsField;
            lhsField = (this.isSetTimeSlice() ? this.getTimeSlice() : null);
            List<PrecisionApproachRadarTimeSlicePropertyType> rhsField;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = super.hashCode(locator, strategy);
        {
            ...
            List<PrecisionApproachRadarTimeSlicePropertyType> theField;
