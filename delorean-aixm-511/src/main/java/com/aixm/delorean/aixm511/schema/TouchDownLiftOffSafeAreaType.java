...
/**
 * <p>
 * Java class for TouchDownLiftOffSafeAreaType complex type
 * </p>
 * .
 *
 * <p>
...
"{http://www.aixm.aero/schema/5.1.1}TouchDownLiftOffSafeAreaTimeSlicePropertyType" maxOccurs
="unbounded"/>
 *       </sequence>
 *     </extension>
 *   </complexContent>
...
@XmlType(name = "TouchDownLiftOffSafeAreaType", propOrder = {"timeSlice"})
@Entity(name = "TouchDownLiftOffSafeAreaType")
@Table(name = "touchdownliftoffsafearea_f", schema = "airport_heliport")
public class TouchDownLiftOffSafeAreaType extends AbstractAirportHeliportProtectionAreaType implements Serializable {
    ...
    @OneToMany(targetEntity = TouchDownLiftOffSafeAreaTimeSlicePropertyType.class, cascade = {
     ...
     *
     */
    public void setTimeSlice(List<TouchDownLiftOffSafeAreaTimeSlicePropertyType> timeSlice) {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final TouchDownLiftOffSafeAreaType that = ((TouchDownLiftOffSafeAreaType) object);
        {
            boolean lhsFieldIsSet = this.isSetTimeSlice();
            boolean rhsFieldIsSet = that.isSetTimeSlice();
            List<TouchDownLiftOffSafeAreaTimeSlicePropertyType> lhsField;
            lhsField = (this.isSetTimeSlice() ? this.getTimeSlice() : null);
            List<TouchDownLiftOffSafeAreaTimeSlicePropertyType> rhsField;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = super.hashCode(locator, strategy);
        {
            ...
            List<TouchDownLiftOffSafeAreaTimeSlicePropertyType> theField;
