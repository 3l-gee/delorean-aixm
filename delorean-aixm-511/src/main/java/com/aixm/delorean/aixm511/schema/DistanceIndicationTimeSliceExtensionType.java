...
@XmlType(name = "", propOrder = {"abstractDistanceIndicationExtension"})
@Entity(name = "DistanceIndicationTimeSliceExtensionType")
@Table(name = "distanceindication_te", schema = "navaids_point")
public class DistanceIndicationTimeSliceExtensionType implements Serializable, Equals, HashCode, ToString {
    ...
    @JoinColumn(name = "abstractdistanceindicationextension_hjid", referencedColumnName = "hjid")
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final DistanceIndicationTimeSliceExtensionType that = ((DistanceIndicationTimeSliceExtensionType) object);
        {
        ...
        }
        {
            ...
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "abstractDistanceIndicationExtension",
                    lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "abstractDistanceIndicationExtension",
                    rhsField);
            if (!strategy.equals(lhsFieldLocator, rhsFieldLocator, lhsField, rhsField, lhsFieldIsSet, rhsFieldIsSet)) {
                return false;
            }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetAbstractDistanceIndicationExtension();
            AbstractExtensionType theField;
            theField = this.getAbstractDistanceIndicationExtension();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "abstractDistanceIndicationExtension",
                    theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            AbstractExtensionType theField;
            theField = this.getAbstractDistanceIndicationExtension();
            strategy.appendField(locator, this, "abstractDistanceIndicationExtension", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetOwns();
            boolean theField;
