...
/**
 * <p>
 * Java class for AirspaceGeometryComponentPropertyType complex type
 * </p>
 * .
 *
 * <p>
 ...
 *       <sequence>
 *         <element ref=
"{http://www.aixm.aero/schema/5.1.1}AirspaceGeometryComponent"/>
 *       </sequence>
 *     </extension>
 *   </complexContent>
 * </complexType>
...
@XmlType(name = "AirspaceGeometryComponentPropertyType", propOrder = {"airspaceGeometryComponent"})
@Entity(name = "AirspaceGeometryComponentPropertyType")
@Table(name = "airspacegeometrycomponent_pt", schema = "airspace")
public class AirspaceGeometryComponentPropertyType extends AbstractAIXMPropertyType implements Serializable {
     ...
     *
     * @return possible object is {@link AirspaceGeometryComponentType }
     *
     */
    @OneToOne(targetEntity = AirspaceGeometryComponentType.class, cascade = {CascadeType.ALL}, fetch = FetchType.EAGER)
     ...
     *
     * @param value
     *            allowed object is {@link AirspaceGeometryComponentType }
     *
     */
