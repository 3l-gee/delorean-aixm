...
/**
 * <p>
 * Java class for NitrogenType complex type
 * </p>
 * .
 *
 * <p>
...
"{http://www.aixm.aero/schema/5.1.1}CodeNitrogenType" minOccurs="0"/>
...
@XmlType(name = "NitrogenType", propOrder = {"type", "annotation", "extension"})
@Entity(name = "NitrogenType")
@Table(name = "nitrogen_o", schema = "service")
public class NitrogenType extends AbstractAIXMObjectType implements Serializable {
     ...
     *         }{@code <}{@link CodeNitrogenType }{@code >}
     *
     */
    @Transient
    ...
    @JoinTable(name = "ntrgntp_annttn_link", schema = "service", joinColumns = {
            @JoinColumn(name = "nitrogen_o_hjid", referencedColumnName = "hjid")}, inverseJoinColumns = {
    ...
    public void setTypeItem(CodeNitrogenType target) {
        setType(XmlAdapterUtils.marshallJAXBElement(CodeNitrogenType.class,
                new QName("http://www.aixm.aero/schema/5.1.1", "type"), NitrogenType.class, target));
    }
