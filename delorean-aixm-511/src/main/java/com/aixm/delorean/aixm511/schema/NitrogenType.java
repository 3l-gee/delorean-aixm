 ...
 *       <sequence>
 *         <group ref=
"{http://www.aixm.aero/schema/5.1.1}NitrogenPropertyGroup"/>
...
@Table(name = "nitrogen", schema = "service")
public class NitrogenType extends AbstractAIXMObjectType implements Serializable {
    ...
    @JoinTable(name = "annotation_nitrogen_link", schema = "service", joinColumns = {
            @JoinColumn(name = "annotation", referencedColumnName = "hjid")}, inverseJoinColumns = {
                    @JoinColumn(name = "nitrogenpropertygroup", referencedColumnName = "hjid")})
