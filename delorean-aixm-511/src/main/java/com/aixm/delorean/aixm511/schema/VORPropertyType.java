...
/**
 * <p>Java class for VORPropertyType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="VORPropertyType">
 *   <complexContent>
...
@XmlType(name = "VORPropertyType")
@Entity(name = "VORPropertyType")
@Table(name = "vorpropertytype", schema = "navaids_point")
public class VORPropertyType implements Serializable, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        final VORPropertyType that = ((VORPropertyType) object);
        {
