...
/**
 * <p>Java class for InstrumentApproachProcedurePropertyType complex type</p>.
 * 
...
@XmlType(name = "InstrumentApproachProcedurePropertyType")
@Entity(name = "InstrumentApproachProcedurePropertyType")
@Table(name = "instrumentapproachprocedurepropertytype", schema = "procedure")
public class InstrumentApproachProcedurePropertyType implements Serializable, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        final InstrumentApproachProcedurePropertyType that = ((InstrumentApproachProcedurePropertyType) object);
        {
