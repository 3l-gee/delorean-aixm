...
@XmlType(name = "", propOrder = {"abstractArrestingGearExtension"})
@Entity(name = "ArrestingGearTimeSliceExtensionType")
@Table(name = "arrestinggear_te", schema = "airport_heliport")
public class ArrestingGearTimeSliceExtensionType implements Serializable, Equals, HashCode, ToString {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final ArrestingGearTimeSliceExtensionType that = ((ArrestingGearTimeSliceExtensionType) object);
        {
            ...
            lhsField = this.getAbstractArrestingGearExtension();
            AbstractExtensionType rhsField;
            rhsField = that.getAbstractArrestingGearExtension();
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "abstractArrestingGearExtension",
                    lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "abstractArrestingGearExtension",
                    rhsField);
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetAbstractArrestingGearExtension();
            AbstractExtensionType theField;
            theField = this.getAbstractArrestingGearExtension();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "abstractArrestingGearExtension", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            AbstractExtensionType theField;
            theField = this.getAbstractArrestingGearExtension();
            strategy.appendField(locator, this, "abstractArrestingGearExtension", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetOwns();
            boolean theField;
