...
/**
 * <p>
 * Java class for DesignatedPointType complex type
 * </p>
 * .
 *
 * <p>
...
"{http://www.aixm.aero/schema/5.1.1}DesignatedPointTimeSlicePropertyType" maxOccurs
="unbounded"/>
 *       </sequence>
 *     </extension>
 *   </complexContent>
...
@XmlType(name = "DesignatedPointType", propOrder = {"timeSlice"})
@Entity(name = "DesignatedPointType")
@Table(name = "designatedpoint", schema = "navaids_point")
public class DesignatedPointType extends AbstractAIXMFeatureType implements Serializable {
    ...
    @JoinTable(name = "timeslice_designatedpoint_link", schema = "navaids_point", joinColumns = {
            @JoinColumn(name = "timeslice", referencedColumnName = "hjid")}, inverseJoinColumns = {
                    @JoinColumn(name = "designatedpointtype", referencedColumnName = "hjid")})
     ...
     *
     */
    public void setTimeSlice(List<DesignatedPointTimeSlicePropertyType> timeSlice) {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final DesignatedPointType that = ((DesignatedPointType) object);
        {
            boolean lhsFieldIsSet = this.isSetTimeSlice();
            boolean rhsFieldIsSet = that.isSetTimeSlice();
            List<DesignatedPointTimeSlicePropertyType> lhsField;
            lhsField = (this.isSetTimeSlice() ? this.getTimeSlice() : null);
            List<DesignatedPointTimeSlicePropertyType> rhsField;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = super.hashCode(locator, strategy);
        {
            ...
            List<DesignatedPointTimeSlicePropertyType> theField;
