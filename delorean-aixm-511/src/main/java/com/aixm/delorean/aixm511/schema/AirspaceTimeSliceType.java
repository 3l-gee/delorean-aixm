 ...
 *       <sequence>
 *         <group ref=
"{http://www.aixm.aero/schema/5.1.1}AirspacePropertyGroup"/>
...
public class AirspaceTimeSliceType extends AbstractAIXMTimeSliceType implements Serializable {
    ...
    @JoinTable(name = "class_airspace_link", schema = "airspace", joinColumns = {
            @JoinColumn(name = "class", referencedColumnName = "hjid")}, inverseJoinColumns = {
    ...
    @JoinTable(name = "geometrycomponent_airspace_link", schema = "airspace", joinColumns = {
            @JoinColumn(name = "geometrycomponent", referencedColumnName = "hjid")}, inverseJoinColumns = {
                    @JoinColumn(name = "airspacepropertygroup", referencedColumnName = "hjid")})
    ...
    @JoinTable(name = "activation_airspace_link", schema = "airspace", joinColumns = {
            @JoinColumn(name = "activation", referencedColumnName = "hjid")}, inverseJoinColumns = {
                    @JoinColumn(name = "airspacepropertygroup", referencedColumnName = "hjid")})
