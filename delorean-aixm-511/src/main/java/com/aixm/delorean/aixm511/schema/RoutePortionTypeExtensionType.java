...
@Entity(name = "RoutePortionTypeExtensionType")
@Table(name = "routeportione", schema = "route")
public class RoutePortionTypeExtensionType implements Serializable, Equals, HashCode, ToString {
