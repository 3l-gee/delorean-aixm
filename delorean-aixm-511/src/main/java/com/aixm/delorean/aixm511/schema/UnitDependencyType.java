    ...
    implements Serializable
{
    ...
    @JoinTable(name = "unitdependency_o_annotation_link", schema = "public", joinColumns = {
    ...
    @JoinTable(name = "unitdependency_o_theunit_link", schema = "public", joinColumns = {
        @JoinColumn(name = "unitdependency_o_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinColumn(name = "unitdependency_e_hjid", referencedColumnName = "hjid")
