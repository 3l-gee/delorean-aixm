 ...
 *       <sequence>
 *         <group ref=
"{http://www.aixm.aero/schema/5.1.1}UnitDependencyPropertyGroup"/>
...
public class UnitDependencyType extends AbstractAIXMObjectType implements Serializable {
    ...
    @JoinTable(name = "annotation_unitdependency_link", schema = "organisation", joinColumns = {
            @JoinColumn(name = "annotation", referencedColumnName = "hjid")}, inverseJoinColumns = {
                    @JoinColumn(name = "unitdependencypropertygroup", referencedColumnName = "hjid")})
    ...
    @JoinColumn(name = "EXTENSION_UNIT_DEPENDENCY_TY_0")
