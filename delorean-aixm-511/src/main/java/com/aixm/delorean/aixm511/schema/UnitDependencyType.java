...
/**
 * <p>
 * Java class for UnitDependencyType complex type
 * </p>
 * .
 *
 * <p>
...
"{http://www.aixm.aero/schema/5.1.1}CodeUnitDependencyType" minOccurs="0"/>
 ...
 *                 <choice>
 *                   <element ref=
"{http://www.aixm.aero/schema/5.1.1}AbstractUnitDependencyExtension"/>
 *                 </choice>
 *                 <attGroup ref=
...
@XmlType(name = "UnitDependencyType", propOrder = {"type", "annotation", "theUnit", "extension"})
@Entity(name = "UnitDependencyType")
@Table(name = "unitdependency_o", schema = "organisation")
public class UnitDependencyType extends AbstractAIXMObjectType implements Serializable {
     ...
     *         }{@code <}{@link CodeUnitDependencyType }{@code >}
     *
     */
    @Transient
    ...
    @JoinTable(name = "untdpndnctp_annttn_link", schema = "organisation", joinColumns = {
            @JoinColumn(name = "unitdependency_o_hjid", referencedColumnName = "hjid")}, inverseJoinColumns = {
     ...
     *
     * @return possible object is {@link UnitPropertyType }
     *
     */
    @OneToOne(targetEntity = UnitPropertyType.class, cascade = {CascadeType.ALL}, fetch = FetchType.EAGER)
    @JoinTable(name = "untdpndnctp_thunt_link", schema = "organisation", joinColumns = {
            @JoinColumn(name = "unitdependency_o_hjid", referencedColumnName = "hjid")}, inverseJoinColumns = {
     ...
     *
     * @param value
     *            allowed object is {@link UnitPropertyType }
     *
     */
    ...
    public CodeUnitDependencyType getTypeItem() {
        return XmlAdapterUtils.unmarshallSource(CodeUnitDependencyType.class, this.getType());
    }

    public void setTypeItem(CodeUnitDependencyType target) {
        setType(XmlAdapterUtils.marshallJAXBElement(CodeUnitDependencyType.class,
                new QName("http://www.aixm.aero/schema/5.1.1", "type"), UnitDependencyType.class, target));
    }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = super.hashCode(locator, strategy);
        {
            ...
            JAXBElement<CodeUnitDependencyType> theField;
