 ...
 *       <choice>
 *         <element ref=
"{http://www.aixm.aero/schema/5.1.1}AbstractApproachDistanceTableExtension"/>
 *       </choice>
 *       <attGroup ref=
...
@XmlType(name = "", propOrder = {"abstractApproachDistanceTableExtension"})
@Entity(name = "ApproachDistanceTableExtensionType")
@Table(name = "approachdistancetable_oe", schema = "procedure")
public class ApproachDistanceTableExtensionType implements Serializable, Equals, HashCode, ToString {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final ApproachDistanceTableExtensionType that = ((ApproachDistanceTableExtensionType) object);
        {
            ...
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "abstractApproachDistanceTableExtension",
                    lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "abstractApproachDistanceTableExtension",
                    rhsField);
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetAbstractApproachDistanceTableExtension();
            AbstractExtensionType theField;
            theField = this.getAbstractApproachDistanceTableExtension();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "abstractApproachDistanceTableExtension",
                    theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            AbstractExtensionType theField;
            theField = this.getAbstractApproachDistanceTableExtension();
            strategy.appendField(locator, this, "abstractApproachDistanceTableExtension", buffer, theField,
                    theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetOwns();
