 ...
 *       <sequence>
 *         <group ref=
"{http://www.aixm.aero/schema/5.1.1}GuidanceLineLightSystemPropertyGroup"/>
...
public class GuidanceLineLightSystemTimeSliceType extends AbstractAIXMTimeSliceType implements Serializable {
    ...
    @OneToMany(targetEntity = GuidanceLineLightSystemExtensionType.class, cascade = {
            CascadeType.ALL}, fetch = FetchType.EAGER)
    @JoinColumn(name = "EXTENSION_GUIDANCE_LINE_LIGH_0")
    ...
    @ManyToOne(targetEntity = GuidanceLinePropertyType.class, cascade = {CascadeType.ALL}, fetch = FetchType.EAGER)
