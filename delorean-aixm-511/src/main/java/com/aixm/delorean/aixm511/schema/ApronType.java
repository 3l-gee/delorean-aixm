...
/**
 * <p>
 * Java class for ApronType complex type
 * </p>
 * .
 *
 * <p>
...
"{http://www.aixm.aero/schema/5.1.1}ApronTimeSlicePropertyType" maxOccurs=
"unbounded"/>
 *       </sequence>
 *     </extension>
 *   </complexContent>
...
@XmlType(name = "ApronType", propOrder = {"timeSlice"})
@Entity(name = "ApronType")
@Table(name = "apron", schema = "airport_heliport")
public class ApronType extends AbstractAIXMFeatureType implements Serializable {

    private static final long serialVersionUID = 20251104L;
    @XmlElement(required = true)
    protected List<ApronTimeSlicePropertyType> timeSlice;
     ...
     * {@link ApronTimeSlicePropertyType }
     *
     *
     */
    @Filter(name = "TSPHjidFilter", condition = "hjid IN (:ids)")
    @ManyToMany(targetEntity = ApronTimeSlicePropertyType.class, cascade = {CascadeType.ALL}, fetch = FetchType.EAGER)
    @JoinTable(name = "timeslice_apron_link", schema = "airport_heliport", joinColumns = {
            @JoinColumn(name = "timeslice", referencedColumnName = "hjid")}, inverseJoinColumns = {
                    @JoinColumn(name = "aprontype", referencedColumnName = "hjid")})
    public List<ApronTimeSlicePropertyType> getTimeSlice() {
        if (timeSlice == null) {
     ...
     *
     */
    public void setTimeSlice(List<ApronTimeSlicePropertyType> timeSlice) {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = super.hashCode(locator, strategy);
        {
            ...
            List<ApronTimeSlicePropertyType> theField;
