...
"{http://www.aixm.aero/schema/5.1.1}SurveyControlPointTimeSlicePropertyType" maxOccurs
="unbounded"/>
 *       </sequence>
 *     </extension>
 *   </complexContent>
...
@XmlType(name = "SurveyControlPointType", propOrder = {"timeSlice"})
@Entity(name = "SurveyControlPointType")
@Table(name = "surveycontrolpoint", schema = "airport_heliport")
public class SurveyControlPointType extends AbstractAIXMFeatureType implements Serializable {
     ...
     * {@link SurveyControlPointTimeSlicePropertyType }
     *
     *
     */
    @ManyToMany(targetEntity = SurveyControlPointTimeSlicePropertyType.class, cascade = {
            CascadeType.ALL}, fetch = FetchType.EAGER)
    @JoinTable(name = "timeslice_surveycontrolpoint_link", schema = "airport_heliport", joinColumns = {
            @JoinColumn(name = "timeslice", referencedColumnName = "hjid")}, inverseJoinColumns = {
                    @JoinColumn(name = "surveycontrolpointtype", referencedColumnName = "hjid")})
    public List<SurveyControlPointTimeSlicePropertyType> getTimeSlice() {
        if (timeSlice == null) {
     ...
     *
     */
    public void setTimeSlice(List<SurveyControlPointTimeSlicePropertyType> timeSlice) {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final SurveyControlPointType that = ((SurveyControlPointType) object);
        {
            boolean lhsFieldIsSet = this.isSetTimeSlice();
            boolean rhsFieldIsSet = that.isSetTimeSlice();
            List<SurveyControlPointTimeSlicePropertyType> lhsField;
            lhsField = (this.isSetTimeSlice() ? this.getTimeSlice() : null);
            List<SurveyControlPointTimeSlicePropertyType> rhsField;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = super.hashCode(locator, strategy);
        {
            ...
            List<SurveyControlPointTimeSlicePropertyType> theField;
