 ...
 *       <sequence>
 *         <group ref=
"{http://www.aixm.aero/schema/5.1.1}AuthorityForSpecialNavigationSystemPropertyGroup"/>
...
@Table(name = "authorityforspecialnavigationsystem", schema = "navaids_point")
public class AuthorityForSpecialNavigationSystemType extends AbstractAIXMObjectType implements Serializable {
    ...
    @JoinTable(name = "annotation_authorityforspecialnavigationsystem_link", schema = "navaids_point", joinColumns = {
            @JoinColumn(name = "annotation", referencedColumnName = "hjid")}, inverseJoinColumns = {
                    @JoinColumn(name = "authorityforspecialnavigationsystempropertygroup", referencedColumnName = "hjid")})
    ...
    @OneToMany(targetEntity = AuthorityForSpecialNavigationSystemTypeExtensionType.class, cascade = {
            CascadeType.ALL}, fetch = FetchType.EAGER)
    @JoinColumn(name = "EXTENSION_AUTHORITY_FOR_SPEC_1")
    ...
    public void setTypeItem(CodeAuthorityRoleType target) {
        setType(XmlAdapterUtils.marshallJAXBElement(CodeAuthorityRoleType.class,
                new QName("http://www.aixm.aero/schema/5.1.1", "type"), AuthorityForSpecialNavigationSystemType.class,
                target));
    }
