...
@Table(name = "specialnavigationstationstatus_e", schema = "navaids_point")
public class SpecialNavigationStationStatusTypeExtensionType implements Serializable, Equals, HashCode, ToString
{
    ...
    @JoinColumn(name = "abstractspecialnavigationstationstatusextension_hjid", referencedColumnName = "hjid")
