...
/**
 * <p>
 * Java class for ManoeuvringAreaUsagePropertyType complex type
 * </p>
 * .
 *
 * <p>
 ...
 *       <sequence>
 *         <element ref=
"{http://www.aixm.aero/schema/5.1.1}ManoeuvringAreaUsage"/>
 *       </sequence>
 *     </extension>
 *   </complexContent>
 * </complexType>
...
@XmlType(name = "ManoeuvringAreaUsagePropertyType", propOrder = {"manoeuvringAreaUsage"})
@Entity(name = "ManoeuvringAreaUsagePropertyType")
@Table(name = "manoeuvringareausage_pt", schema = "airport_heliport")
public class ManoeuvringAreaUsagePropertyType extends AbstractAIXMPropertyType implements Serializable {
     ...
     *
     * @return possible object is {@link ManoeuvringAreaUsageType }
     *
     */
    @OneToOne(targetEntity = ManoeuvringAreaUsageType.class, cascade = {CascadeType.ALL}, fetch = FetchType.EAGER)
     ...
     *
     * @param value
     *            allowed object is {@link ManoeuvringAreaUsageType }
     *
     */
