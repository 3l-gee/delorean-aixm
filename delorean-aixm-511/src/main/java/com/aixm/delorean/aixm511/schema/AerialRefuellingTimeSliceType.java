 ...
 *       <sequence>
 *         <group ref=
"{http://www.aixm.aero/schema/5.1.1}AerialRefuellingPropertyGroup"/>
...
public class AerialRefuellingTimeSliceType extends AbstractAIXMTimeSliceType implements Serializable {
    ...
    @JoinTable(name = "protectingairspace_aerialrefuelling_link", schema = "aerial_refuelling", joinColumns = {
            @JoinColumn(name = "protectingairspace", referencedColumnName = "hjid")}, inverseJoinColumns = {
                    @JoinColumn(name = "aerialrefuellingpropertygroup", referencedColumnName = "hjid")})
    ...
    @JoinTable(name = "track_aerialrefuelling_link", schema = "aerial_refuelling", joinColumns = {
            @JoinColumn(name = "track", referencedColumnName = "hjid")}, inverseJoinColumns = {
                    @JoinColumn(name = "aerialrefuellingpropertygroup", referencedColumnName = "hjid")})
    ...
    @JoinTable(name = "anchor_aerialrefuelling_link", schema = "aerial_refuelling", joinColumns = {
            @JoinColumn(name = "anchor", referencedColumnName = "hjid")}, inverseJoinColumns = {
                    @JoinColumn(name = "aerialrefuellingpropertygroup", referencedColumnName = "hjid")})
    ...
    @JoinTable(name = "managingorganisation_aerialrefuelling_link", schema = "aerial_refuelling", joinColumns = {
            @JoinColumn(name = "managingorganisation", referencedColumnName = "hjid")}, inverseJoinColumns = {
                    @JoinColumn(name = "aerialrefuellingpropertygroup", referencedColumnName = "hjid")})
    ...
    @JoinColumn(name = "EXTENSION_AERIAL_REFUELLING__0")
