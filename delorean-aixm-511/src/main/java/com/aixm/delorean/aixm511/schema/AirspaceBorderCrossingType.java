...
"{http://www.aixm.aero/schema/5.1.1}AirspaceBorderCrossingTimeSlicePropertyType" maxOccurs
="unbounded"/>
 *       </sequence>
 *     </extension>
 *   </complexContent>
...
@XmlType(name = "AirspaceBorderCrossingType", propOrder = {"timeSlice"})
@Entity(name = "AirspaceBorderCrossingType")
@Table(name = "airspacebordercrossing", schema = "route")
public class AirspaceBorderCrossingType extends AbstractAIXMFeatureType implements Serializable {
     ...
     * {@link AirspaceBorderCrossingTimeSlicePropertyType }
     *
     *
     */
    @ManyToMany(targetEntity = AirspaceBorderCrossingTimeSlicePropertyType.class, cascade = {
            CascadeType.ALL}, fetch = FetchType.EAGER)
    @JoinTable(name = "timeslice_airspacebordercrossing_link", schema = "route", joinColumns = {
            @JoinColumn(name = "timeslice", referencedColumnName = "hjid")}, inverseJoinColumns = {
                    @JoinColumn(name = "airspacebordercrossingtype", referencedColumnName = "hjid")})
    public List<AirspaceBorderCrossingTimeSlicePropertyType> getTimeSlice() {
        if (timeSlice == null) {
     ...
     *
     */
    public void setTimeSlice(List<AirspaceBorderCrossingTimeSlicePropertyType> timeSlice) {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final AirspaceBorderCrossingType that = ((AirspaceBorderCrossingType) object);
        {
            ...
            List<AirspaceBorderCrossingTimeSlicePropertyType> lhsField;
            lhsField = (this.isSetTimeSlice() ? this.getTimeSlice() : null);
            List<AirspaceBorderCrossingTimeSlicePropertyType> rhsField;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = super.hashCode(locator, strategy);
        {
            ...
            List<AirspaceBorderCrossingTimeSlicePropertyType> theField;
