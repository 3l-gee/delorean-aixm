...
@Entity(name = "OilTypeExtensionType")
@Table(name = "oil_ext", schema = "service")
public class OilTypeExtensionType implements Serializable, Equals, HashCode, ToString {
    ...
    @JoinColumn(name = "abstractoilextension_id", referencedColumnName = "hjid")
