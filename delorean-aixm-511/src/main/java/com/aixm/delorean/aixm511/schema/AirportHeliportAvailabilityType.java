...
"{http://www.aixm.aero/schema/5.1.1}CodeStatusAirportType" minOccurs="0"/>
 *         <element name="warning" type=
"{http://www.aixm.aero/schema/5.1.1}CodeAirportWarningType" minOccurs="0"/>
 *         <element name="usage" type=
"{http://www.aixm.aero/schema/5.1.1}AirportHeliportUsagePropertyType" maxOccurs=
"unbounded" minOccurs="0"/>
 ...
 *                   <element ref=
"{http://www.aixm.aero/schema/5.1.1}AbstractAirportHeliportAvailabilityExtension"/>
 *                 </choice>
 *                 <attGroup ref=
...
public class AirportHeliportAvailabilityType extends AbstractPropertiesWithScheduleType implements Serializable {
    ...
    public void setWarningItem(CodeAirportWarningType target) {
        setWarning(XmlAdapterUtils.marshallJAXBElement(CodeAirportWarningType.class,
                new QName("http://www.aixm.aero/schema/5.1.1", "warning"), AirportHeliportAvailabilityType.class,
                target));
    }
