 ...
 *       <choice>
 *         <element ref=
"{http://www.aixm.aero/schema/5.1.1}AbstractRidgeExtension"/>
 *       </choice>
 *       <attGroup ref=
...
@XmlType(name = "", propOrder = {"abstractRidgeExtension"})
@Entity(name = "RidgeTypeExtensionType")
@Table(name = "ridge_ext", schema = "airport_heliport")
public class RidgeTypeExtensionType implements Serializable, Equals, HashCode, ToString {
    ...
    @JoinColumn(name = "abstractridgeextension_id", referencedColumnName = "hjid")
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final RidgeTypeExtensionType that = ((RidgeTypeExtensionType) object);
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetAbstractRidgeExtension();
            AbstractExtensionType theField;
            theField = this.getAbstractRidgeExtension();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "abstractRidgeExtension", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            AbstractExtensionType theField;
            theField = this.getAbstractRidgeExtension();
            strategy.appendField(locator, this, "abstractRidgeExtension", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetOwns();
            boolean theField;
