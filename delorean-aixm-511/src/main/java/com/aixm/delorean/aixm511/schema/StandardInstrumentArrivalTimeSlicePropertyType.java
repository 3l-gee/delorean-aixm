...
/**
 * <p>
 * Java class for StandardInstrumentArrivalTimeSlicePropertyType complex type
 * </p>
 * .
 *
 * <p>
 ...
 *       <sequence>
 *         <element ref=
"{http://www.aixm.aero/schema/5.1.1}StandardInstrumentArrivalTimeSlice"/>
 *       </sequence>
 *       <attGroup ref=
...
@XmlType(name = "StandardInstrumentArrivalTimeSlicePropertyType", propOrder = {"standardInstrumentArrivalTimeSlice"})
...
public class StandardInstrumentArrivalTimeSlicePropertyType implements Serializable, Equals, HashCode, ToString {
     ...
     *
     * @return possible object is {@link StandardInstrumentArrivalTimeSliceType }
     *
     */
     ...
     *
     * @param value
     *            allowed object is {@link StandardInstrumentArrivalTimeSliceType }
     *
     */
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        }
        {
            ...
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "standardInstrumentArrivalTimeSlice",
                    lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "standardInstrumentArrivalTimeSlice",
                    rhsField);
            if (!strategy.equals(lhsFieldLocator, rhsFieldLocator, lhsField, rhsField, lhsFieldIsSet, rhsFieldIsSet)) {
                return false;
            }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetStandardInstrumentArrivalTimeSlice();
            StandardInstrumentArrivalTimeSliceType theField;
            theField = this.getStandardInstrumentArrivalTimeSlice();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "standardInstrumentArrivalTimeSlice",
                    theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            StandardInstrumentArrivalTimeSliceType theField;
            theField = this.getStandardInstrumentArrivalTimeSlice();
            strategy.appendField(locator, this, "standardInstrumentArrivalTimeSlice", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetOwns();
            boolean theField;
