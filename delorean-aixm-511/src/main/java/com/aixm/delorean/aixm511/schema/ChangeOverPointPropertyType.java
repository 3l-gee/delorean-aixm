...
/**
 * <p>Java class for ChangeOverPointPropertyType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="ChangeOverPointPropertyType">
 *   <complexContent>
...
@XmlType(name = "ChangeOverPointPropertyType")
@Entity(name = "ChangeOverPointPropertyType")
@Table(name = "changeoverpointpropertytype", schema = "route")
public class ChangeOverPointPropertyType implements Serializable, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        final ChangeOverPointPropertyType that = ((ChangeOverPointPropertyType) object);
        {
