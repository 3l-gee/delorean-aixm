...
="unbounded" minOccurs="0"/>
 *         <group ref=
"{http://www.aixm.aero/schema/5.1.1}LightElementStatusPropertyGroup"/>
...
public class LightElementStatusType extends AbstractPropertiesWithScheduleType implements Serializable {
    ...
    @JoinTable(name = "timeinterval_lightelementstatus_link", schema = "shared", joinColumns = {
            @JoinColumn(name = "timeinterval", referencedColumnName = "hjid")}, inverseJoinColumns = {
                    @JoinColumn(name = "lightelementstatustype", referencedColumnName = "hjid")})
    ...
    @JoinTable(name = "annotation_lightelementstatus_link", schema = "shared", joinColumns = {
    ...
    @JoinTable(name = "specialdateauthority_lightelementstatus_link", schema = "shared", joinColumns = {
    ...
    @OneToMany(targetEntity = LightElementStatusTypeExtensionType.class, cascade = {
            CascadeType.ALL}, fetch = FetchType.EAGER)
    @JoinColumn(name = "EXTENSION_LIGHT_ELEMENT_STAT_0")
