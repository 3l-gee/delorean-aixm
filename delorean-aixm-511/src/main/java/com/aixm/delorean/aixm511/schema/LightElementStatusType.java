    ...
    implements Serializable
{
    ...
    @JoinTable(name = "lightelementstatustype_timeinterval_link", schema = "public", joinColumns = {
        @JoinColumn(name = "lightelementstatustype_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "lightelementstatustype_annotation_link", schema = "public", joinColumns = {
        @JoinColumn(name = "lightelementstatustype_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "lightelementstatustype_specialdateauthority_link", schema = "public", joinColumns = {
        @JoinColumn(name = "lightelementstatustype_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinColumn(name = "lightelementstatus_e_hjid", referencedColumnName = "hjid")
    ...
    public void setStatusItem(CodeStatusOperationsType target) {
        setStatus(XmlAdapterUtils.marshallJAXBElement(CodeStatusOperationsType.class, new QName("http://www.aixm.aero/schema/5.1.1", "status"), LightElementStatusType.class, target));
    }
