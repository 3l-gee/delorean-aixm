...
@XmlType(name = "", propOrder = {"abstractWorkAreaExtension"})
@Entity(name = "WorkAreaTimeSliceExtensionType")
@Table(name = "workarea_te", schema = "airport_heliport")
public class WorkAreaTimeSliceExtensionType implements Serializable, Equals, HashCode, ToString {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetAbstractWorkAreaExtension();
            AbstractExtensionType theField;
            theField = this.getAbstractWorkAreaExtension();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "abstractWorkAreaExtension", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            AbstractExtensionType theField;
            theField = this.getAbstractWorkAreaExtension();
            strategy.appendField(locator, this, "abstractWorkAreaExtension", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetOwns();
            boolean theField;
