    ...
    implements Serializable
{
    ...
    @JoinTable(name = "markerbeacon_t_authority_link", schema = "public", joinColumns = {
    ...
    @JoinTable(name = "markerbeacon_t_monitoring_link", schema = "public", joinColumns = {
        @JoinColumn(name = "markerbeacon_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "markerbeacon_t_availability_link", schema = "public", joinColumns = {
        @JoinColumn(name = "markerbeacon_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "markerbeacon_t_annotation_link", schema = "public", joinColumns = {
        @JoinColumn(name = "markerbeacon_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
    ...
    @JoinColumn(name = "markerbeacon_e_hjid", referencedColumnName = "hjid")
    ...
    @JoinTable(name = "markerbeacon_t_location_link", schema = "public", joinColumns = {
        @JoinColumn(name = "markerbeacon_t_hjid", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
