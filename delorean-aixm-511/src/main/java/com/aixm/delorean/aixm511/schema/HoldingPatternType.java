...
/**
 * <p>
 * Java class for HoldingPatternType complex type
 * </p>
 * .
 *
 * <p>
 ...
 *
 * <pre>{@code
 * <complexType name="HoldingPatternType">
 *   <complexContent>
 *     <extension base=
"{http://www.aixm.aero/schema/5.1.1}AbstractAIXMFeatureType">
 *       <sequence>
 *         <element name="timeSlice" type=
"{http://www.aixm.aero/schema/5.1.1}HoldingPatternTimeSlicePropertyType" maxOccurs
="unbounded"/>
 *       </sequence>
 *     </extension>
 *   </complexContent>
...
@XmlType(name = "HoldingPatternType", propOrder = {"timeSlice"})
@Entity(name = "HoldingPatternType")
@Table(name = "holdingpattern", schema = "holding")
public class HoldingPatternType extends AbstractAIXMFeatureType implements Serializable {
     ...
     * {@link HoldingPatternTimeSlicePropertyType }
     *
     *
     */
    @ManyToMany(targetEntity = HoldingPatternTimeSlicePropertyType.class, cascade = {
            CascadeType.ALL}, fetch = FetchType.EAGER)
    @JoinTable(name = "timeslice_holdingpattern_link", schema = "holding", joinColumns = {
            @JoinColumn(name = "timeslice", referencedColumnName = "hjid")}, inverseJoinColumns = {
                    @JoinColumn(name = "holdingpatterntype", referencedColumnName = "hjid")})
    public List<HoldingPatternTimeSlicePropertyType> getTimeSlice() {
        if (timeSlice == null) {
     ...
     *
     */
    public void setTimeSlice(List<HoldingPatternTimeSlicePropertyType> timeSlice) {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final HoldingPatternType that = ((HoldingPatternType) object);
        {
            boolean lhsFieldIsSet = this.isSetTimeSlice();
            boolean rhsFieldIsSet = that.isSetTimeSlice();
            List<HoldingPatternTimeSlicePropertyType> lhsField;
            lhsField = (this.isSetTimeSlice() ? this.getTimeSlice() : null);
            List<HoldingPatternTimeSlicePropertyType> rhsField;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = super.hashCode(locator, strategy);
        {
            ...
            List<HoldingPatternTimeSlicePropertyType> theField;
