...
/**
 * <p>Java class for AzimuthType complex type</p>.
 * 
 ...
 *       <sequence>
 *         <element name="timeSlice" type="{http://www.aixm.aero/schema/5.1.1}AzimuthTimeSlicePropertyType" maxOccurs="unbounded"/>
 *       </sequence>
 *     </extension>
 *   </complexContent>
 * </complexType>
...
@XmlType(name = "AzimuthType", propOrder = {
    "timeSlice"
})
    ...
    implements Serializable
{
     ...
     * 
     */
    @ManyToMany(targetEntity = AzimuthTimeSlicePropertyType.class, cascade = {
        CascadeType.ALL
