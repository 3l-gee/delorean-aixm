...
/**
 * <p>
 * Java class for AzimuthType complex type
 * </p>
 * .
 *
 * <p>
...
"{http://www.aixm.aero/schema/5.1.1}AzimuthTimeSlicePropertyType" maxOccurs=
"unbounded"/>
 *       </sequence>
 *     </extension>
 *   </complexContent>
...
@XmlType(name = "AzimuthType", propOrder = {"timeSlice"})
@Entity(name = "AzimuthType")
@Table(name = "azimuth", schema = "navaids_point")
public class AzimuthType extends AbstractNavaidEquipmentType implements Serializable {
     ...
     * {@link AzimuthTimeSlicePropertyType }
     *
     *
     */
    @ManyToMany(targetEntity = AzimuthTimeSlicePropertyType.class, cascade = {CascadeType.ALL}, fetch = FetchType.EAGER)
    @JoinTable(name = "timeslice_azimuth_link", schema = "navaids_point", joinColumns = {
            @JoinColumn(name = "timeslice", referencedColumnName = "hjid")}, inverseJoinColumns = {
                    @JoinColumn(name = "azimuthtype", referencedColumnName = "hjid")})
    public List<AzimuthTimeSlicePropertyType> getTimeSlice() {
        if (timeSlice == null) {
     ...
     *
     */
    public void setTimeSlice(List<AzimuthTimeSlicePropertyType> timeSlice) {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = super.hashCode(locator, strategy);
        {
            ...
            List<AzimuthTimeSlicePropertyType> theField;
