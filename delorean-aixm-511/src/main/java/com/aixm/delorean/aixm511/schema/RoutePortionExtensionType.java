...
@XmlType(name = "", propOrder = {"abstractRoutePortionExtension"})
@Entity(name = "RoutePortionExtensionType")
@Table(name = "routeportion_oe", schema = "route")
public class RoutePortionExtensionType implements Serializable, Equals, HashCode, ToString {
    ...
    @JoinColumn(name = "abstractrouteportionextension_hjid", referencedColumnName = "hjid")
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final RoutePortionExtensionType that = ((RoutePortionExtensionType) object);
        {
            ...
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "abstractRoutePortionExtension",
                    lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "abstractRoutePortionExtension",
                    rhsField);
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetAbstractRoutePortionExtension();
            AbstractExtensionType theField;
            theField = this.getAbstractRoutePortionExtension();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "abstractRoutePortionExtension", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            AbstractExtensionType theField;
            theField = this.getAbstractRoutePortionExtension();
            strategy.appendField(locator, this, "abstractRoutePortionExtension", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetOwns();
            boolean theField;
