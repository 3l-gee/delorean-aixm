...
/**
 * <p>Java class for DesignatedPointPropertyType complex type</p>.
 * 
...
@Entity(name = "DesignatedPointPropertyType")
@Table(name = "designatedpointpropertytype", schema = "navaids_point")
public class DesignatedPointPropertyType implements Serializable, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        final DesignatedPointPropertyType that = ((DesignatedPointPropertyType) object);
        {
