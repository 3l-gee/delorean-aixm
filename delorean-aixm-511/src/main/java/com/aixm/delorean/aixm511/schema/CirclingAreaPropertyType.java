...
/**
 * <p>Java class for CirclingAreaPropertyType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="CirclingAreaPropertyType">
 *   <complexContent>
...
@XmlType(name = "CirclingAreaPropertyType")
@Entity(name = "CirclingAreaPropertyType")
@Table(name = "circlingareapropertytype", schema = "procedure")
public class CirclingAreaPropertyType implements Serializable, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        final CirclingAreaPropertyType that = ((CirclingAreaPropertyType) object);
        {
