 ...
 *       <sequence>
 *         <group ref=
"{http://www.aixm.aero/schema/5.1.1}AngleUsePropertyGroup"/>
...
public class AngleUseType extends AbstractAIXMObjectType implements Serializable {
    ...
    @JoinTable(name = "annotation_angleuse_link", schema = "navaids_point", joinColumns = {
            @JoinColumn(name = "annotation", referencedColumnName = "hjid")}, inverseJoinColumns = {
                    @JoinColumn(name = "angleusepropertygroup", referencedColumnName = "hjid")})
