...
"{http://www.aixm.aero/schema/5.1.1}CodeStatusServiceType" minOccurs="0"/>
 ...
 *                   <element ref=
"{http://www.aixm.aero/schema/5.1.1}AbstractServiceOperationalStatusExtension"/>
 *                 </choice>
 *                 <attGroup ref=
...
public class ServiceOperationalStatusType extends AbstractPropertiesWithScheduleType implements Serializable {
    ...
    public void setOperationalStatusItem(CodeStatusServiceType target) {
        setOperationalStatus(XmlAdapterUtils.marshallJAXBElement(CodeStatusServiceType.class,
                new QName("http://www.aixm.aero/schema/5.1.1", "operationalStatus"), ServiceOperationalStatusType.class,
                target));
    }
