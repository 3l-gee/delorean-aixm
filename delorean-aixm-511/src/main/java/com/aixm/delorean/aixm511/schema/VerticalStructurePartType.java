...
="unbounded" minOccurs="0"/>
 *         <group ref=
"{http://www.aixm.aero/schema/5.1.1}VerticalStructurePartPropertyGroup"/>
...
public class VerticalStructurePartType extends AbstractPropertiesWithScheduleType implements Serializable {
    ...
    @JoinTable(name = "lighting_verticalstructurepart_link", schema = "obstacle", joinColumns = {
            @JoinColumn(name = "lighting", referencedColumnName = "hjid")}, inverseJoinColumns = {
    ...
    @ManyToOne(targetEntity = AIXMElevatedCurvePropertyType.class, cascade = {CascadeType.ALL}, fetch = FetchType.EAGER)
