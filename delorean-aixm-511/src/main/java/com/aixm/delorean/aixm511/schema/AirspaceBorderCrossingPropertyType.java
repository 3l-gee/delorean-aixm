...
@XmlType(name = "AirspaceBorderCrossingPropertyType")
@Entity(name = "AirspaceBorderCrossingPropertyType")
@Table(name = "airspacebordercrossing_pt", schema = "route")
public class AirspaceBorderCrossingPropertyType implements Serializable, Equals, HashCode, ToString {
