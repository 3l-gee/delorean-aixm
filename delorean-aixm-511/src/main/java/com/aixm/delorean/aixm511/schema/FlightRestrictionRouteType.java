...
"{http://www.aixm.aero/schema/5.1.1}FlightRoutingElementPropertyType" maxOccurs=
 ...
 *                 <choice>
 *                   <element ref=
"{http://www.aixm.aero/schema/5.1.1}AbstractFlightRestrictionRouteExtension"/>
 *                 </choice>
 *                 <attGroup ref=
...
public class FlightRestrictionRouteType extends AbstractAIXMObjectType implements Serializable {
    ...
    public void setPriorPermissionItem(CodeYesNoType target) {
        setPriorPermission(XmlAdapterUtils.marshallJAXBElement(CodeYesNoType.class,
                new QName("http://www.aixm.aero/schema/5.1.1", "priorPermission"), FlightRestrictionRouteType.class,
                target));
    }
