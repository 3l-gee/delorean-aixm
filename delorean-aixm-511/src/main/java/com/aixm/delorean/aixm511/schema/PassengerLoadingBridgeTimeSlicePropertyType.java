 ...
 *       <sequence>
 *         <element ref=
"{http://www.aixm.aero/schema/5.1.1}PassengerLoadingBridgeTimeSlice"/>
 *       </sequence>
 *       <attGroup ref=
...
@Table(name = "passengerloadingbridge_tsp", schema = "airport_heliport")
public class PassengerLoadingBridgeTimeSlicePropertyType implements Serializable, Equals, HashCode, ToString {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetPassengerLoadingBridgeTimeSlice();
            PassengerLoadingBridgeTimeSliceType theField;
            theField = this.getPassengerLoadingBridgeTimeSlice();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "passengerLoadingBridgeTimeSlice", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            PassengerLoadingBridgeTimeSliceType theField;
            theField = this.getPassengerLoadingBridgeTimeSlice();
            strategy.appendField(locator, this, "passengerLoadingBridgeTimeSlice", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetOwns();
            boolean theField;
