...
@XmlType(name = "", propOrder = {"abstractNavigationAreaExtension"})
@Entity(name = "NavigationAreaTimeSliceExtensionType")
@Table(name = "navigationarea_te", schema = "procedure")
public class NavigationAreaTimeSliceExtensionType implements Serializable, Equals, HashCode, ToString {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final NavigationAreaTimeSliceExtensionType that = ((NavigationAreaTimeSliceExtensionType) object);
        {
        ...
        }
        {
            ...
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "abstractNavigationAreaExtension",
                    lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "abstractNavigationAreaExtension",
                    rhsField);
            if (!strategy.equals(lhsFieldLocator, rhsFieldLocator, lhsField, rhsField, lhsFieldIsSet, rhsFieldIsSet)) {
                return false;
            }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetAbstractNavigationAreaExtension();
            AbstractExtensionType theField;
            theField = this.getAbstractNavigationAreaExtension();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "abstractNavigationAreaExtension", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            AbstractExtensionType theField;
            theField = this.getAbstractNavigationAreaExtension();
            strategy.appendField(locator, this, "abstractNavigationAreaExtension", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetOwns();
            boolean theField;
