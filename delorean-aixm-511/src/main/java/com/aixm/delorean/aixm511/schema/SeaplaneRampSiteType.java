...
/**
 * <p>
 * Java class for SeaplaneRampSiteType complex type
 * </p>
 * .
 *
 * <p>
 ...
 *
 * <pre>{@code
 * <complexType name="SeaplaneRampSiteType">
 *   <complexContent>
 *     <extension base=
"{http://www.aixm.aero/schema/5.1.1}AbstractAIXMFeatureType">
 *       <sequence>
 *         <element name="timeSlice" type=
"{http://www.aixm.aero/schema/5.1.1}SeaplaneRampSiteTimeSlicePropertyType" maxOccurs
="unbounded"/>
 *       </sequence>
 *     </extension>
 *   </complexContent>
...
@XmlType(name = "SeaplaneRampSiteType", propOrder = {"timeSlice"})
@Entity(name = "SeaplaneRampSiteType")
@Table(name = "seaplanerampsite", schema = "airport_heliport")
public class SeaplaneRampSiteType extends AbstractAIXMFeatureType implements Serializable {
     ...
     * {@link SeaplaneRampSiteTimeSlicePropertyType }
     *
     *
     */
    @ManyToMany(targetEntity = SeaplaneRampSiteTimeSlicePropertyType.class, cascade = {
            CascadeType.ALL}, fetch = FetchType.EAGER)
    @JoinTable(name = "timeslice_seaplanerampsite_link", schema = "airport_heliport", joinColumns = {
            @JoinColumn(name = "timeslice", referencedColumnName = "hjid")}, inverseJoinColumns = {
                    @JoinColumn(name = "seaplanerampsitetype", referencedColumnName = "hjid")})
    public List<SeaplaneRampSiteTimeSlicePropertyType> getTimeSlice() {
        if (timeSlice == null) {
     ...
     *
     */
    public void setTimeSlice(List<SeaplaneRampSiteTimeSlicePropertyType> timeSlice) {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final SeaplaneRampSiteType that = ((SeaplaneRampSiteType) object);
        {
            boolean lhsFieldIsSet = this.isSetTimeSlice();
            boolean rhsFieldIsSet = that.isSetTimeSlice();
            List<SeaplaneRampSiteTimeSlicePropertyType> lhsField;
            lhsField = (this.isSetTimeSlice() ? this.getTimeSlice() : null);
            List<SeaplaneRampSiteTimeSlicePropertyType> rhsField;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = super.hashCode(locator, strategy);
        {
            ...
            List<SeaplaneRampSiteTimeSlicePropertyType> theField;
