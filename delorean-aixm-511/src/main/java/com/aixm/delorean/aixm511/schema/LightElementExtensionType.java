...
@XmlType(name = "", propOrder = {"abstractLightElementExtension"})
@Entity(name = "LightElementExtensionType")
@Table(name = "lightelement_oe", schema = "shared")
public class LightElementExtensionType implements Serializable, Equals, HashCode, ToString {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final LightElementExtensionType that = ((LightElementExtensionType) object);
        {
        ...
        }
        {
            ...
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "abstractLightElementExtension",
                    lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "abstractLightElementExtension",
                    rhsField);
            if (!strategy.equals(lhsFieldLocator, rhsFieldLocator, lhsField, rhsField, lhsFieldIsSet, rhsFieldIsSet)) {
                return false;
            }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetAbstractLightElementExtension();
            AbstractExtensionType theField;
            theField = this.getAbstractLightElementExtension();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "abstractLightElementExtension", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            AbstractExtensionType theField;
            theField = this.getAbstractLightElementExtension();
            strategy.appendField(locator, this, "abstractLightElementExtension", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetOwns();
            boolean theField;
