...
/**
 * <p>Java class for SDFType complex type</p>.
 * 
 ...
 *       <sequence>
 *         <element name="timeSlice" type="{http://www.aixm.aero/schema/5.1.1}SDFTimeSlicePropertyType" maxOccurs="unbounded"/>
 *       </sequence>
 *     </extension>
 *   </complexContent>
 * </complexType>
...
@XmlType(name = "SDFType", propOrder = {
    "timeSlice"
})
@Entity(name = "SDFType")
    ...
    implements Serializable
{
     ...
     * 
     */
    @ManyToMany(targetEntity = SDFTimeSlicePropertyType.class, cascade = {
        CascadeType.ALL
