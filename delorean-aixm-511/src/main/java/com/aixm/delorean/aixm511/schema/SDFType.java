...
/**
 * <p>
 * Java class for SDFType complex type
 * </p>
 * .
 *
 * <p>
 ...
 *
 * <pre>{@code
 * <complexType name="SDFType">
 *   <complexContent>
 *     <extension base=
"{http://www.aixm.aero/schema/5.1.1}AbstractNavaidEquipmentType">
 *       <sequence>
 *         <element name="timeSlice" type=
"{http://www.aixm.aero/schema/5.1.1}SDFTimeSlicePropertyType" maxOccurs=
"unbounded"/>
 *       </sequence>
 *     </extension>
 *   </complexContent>
...
@XmlType(name = "SDFType", propOrder = {"timeSlice"})
@Entity(name = "SDFType")
@Table(name = "sdf", schema = "navaids_point")
public class SDFType extends AbstractNavaidEquipmentType implements Serializable {
     ...
     * {@link SDFTimeSlicePropertyType }
     *
     *
     */
    @Filter(name = "TSPHjidFilter", condition = "hjid IN (:ids)")
    @ManyToMany(targetEntity = SDFTimeSlicePropertyType.class, cascade = {CascadeType.ALL}, fetch = FetchType.EAGER)
    @JoinTable(name = "timeslice_sdf_link", schema = "navaids_point", joinColumns = {
            @JoinColumn(name = "timeslice", referencedColumnName = "hjid")}, inverseJoinColumns = {
                    @JoinColumn(name = "sdftype", referencedColumnName = "hjid")})
    public List<SDFTimeSlicePropertyType> getTimeSlice() {
        if (timeSlice == null) {
     ...
     *
     */
    public void setTimeSlice(List<SDFTimeSlicePropertyType> timeSlice) {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = super.hashCode(locator, strategy);
        {
            ...
            List<SDFTimeSlicePropertyType> theField;
