...
/**
 * <p>
 * Java class for FlightRoutingElementPropertyType complex type
 * </p>
 * .
 *
 * <p>
 ...
 *       <sequence>
 *         <element ref=
"{http://www.aixm.aero/schema/5.1.1}FlightRoutingElement"/>
 *       </sequence>
 *     </extension>
 *   </complexContent>
 * </complexType>
...
@XmlType(name = "FlightRoutingElementPropertyType", propOrder = {"flightRoutingElement"})
@Entity(name = "FlightRoutingElementPropertyType")
@Table(name = "flightroutingelement_p", schema = "route")
public class FlightRoutingElementPropertyType extends AbstractAIXMPropertyType implements Serializable {
     ...
     *
     * @return possible object is {@link FlightRoutingElementType }
     *
     */
    @OneToOne(targetEntity = FlightRoutingElementType.class, cascade = {CascadeType.ALL}, fetch = FetchType.EAGER)
    @JoinColumn(name = "flightroutingelement_hjid", referencedColumnName = "hjid")
     ...
     *
     * @param value
     *            allowed object is {@link FlightRoutingElementType }
     *
     */
