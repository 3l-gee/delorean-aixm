 ...
 *       <sequence>
 *         <group ref=
"{http://www.aixm.aero/schema/5.1.1}AircraftStandPropertyGroup"/>
...
public class AircraftStandTimeSliceType extends AbstractAIXMTimeSliceType implements Serializable {
    ...
    @ManyToOne(targetEntity = ApronElementPropertyType.class, cascade = {CascadeType.ALL}, fetch = FetchType.EAGER)
