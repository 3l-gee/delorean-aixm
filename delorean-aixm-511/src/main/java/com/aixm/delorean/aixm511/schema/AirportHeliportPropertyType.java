...
/**
 * <p>Java class for AirportHeliportPropertyType complex type</p>.
 * 
...
@XmlType(name = "AirportHeliportPropertyType")
@Entity(name = "AirportHeliportPropertyType")
@Table(name = "airportheliportpropertytype", schema = "airport_heliport")
public class AirportHeliportPropertyType implements Serializable, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        final AirportHeliportPropertyType that = ((AirportHeliportPropertyType) object);
        {
