...
/**
 * <p>Java class for InitialLegTimeSlicePropertyType complex type</p>.
 * 
 ...
 *       <sequence>
 *         <element ref="{http://www.aixm.aero/schema/5.1.1}InitialLegTimeSlice"/>
 *       </sequence>
...
public class InitialLegTimeSlicePropertyType implements Serializable, Equals, HashCode, ToString
{
     ...
     *     
     */
    @OneToOne(targetEntity = InitialLegTimeSliceType.class, cascade = {
        CascadeType.ALL
