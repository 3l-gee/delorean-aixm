 ...
 *       <sequence>
 *         <group ref="{http://www.aixm.aero/schema/5.1.1}IntermediateLegPropertyGroup"/>
...
@Table(name = "intermediateleg_ts", schema = "procedure")
    ...
    implements Serializable
{
    ...
    @JoinTable(name = "aircraftcategory_intermediateleg_link", schema = "procedure", joinColumns = {
        @JoinColumn(name = "aircraftcategory", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
        @JoinColumn(name = "intermediatelegpropertygroup", referencedColumnName = "hjid")
    })
    ...
    @JoinTable(name = "designsurface_intermediateleg_link", schema = "procedure", joinColumns = {
    ...
    @JoinTable(name = "annotation_intermediateleg_link", schema = "procedure", joinColumns = {
    ...
    @JoinColumn(name = "EXTENSION_INTERMEDIATE_LEG_T_0")
