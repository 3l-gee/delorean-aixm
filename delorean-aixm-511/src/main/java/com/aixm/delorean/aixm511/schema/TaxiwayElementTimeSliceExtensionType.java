...
@XmlType(name = "", propOrder = {"abstractTaxiwayElementExtension"})
@Entity(name = "TaxiwayElementTimeSliceExtensionType")
@Table(name = "taxiwayelement_te", schema = "airport_heliport")
public class TaxiwayElementTimeSliceExtensionType implements Serializable, Equals, HashCode, ToString {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final TaxiwayElementTimeSliceExtensionType that = ((TaxiwayElementTimeSliceExtensionType) object);
        {
            ...
            lhsField = this.getAbstractTaxiwayElementExtension();
            AbstractExtensionType rhsField;
            rhsField = that.getAbstractTaxiwayElementExtension();
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "abstractTaxiwayElementExtension",
                    lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "abstractTaxiwayElementExtension",
                    rhsField);
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetAbstractTaxiwayElementExtension();
            AbstractExtensionType theField;
            theField = this.getAbstractTaxiwayElementExtension();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "abstractTaxiwayElementExtension", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            AbstractExtensionType theField;
            theField = this.getAbstractTaxiwayElementExtension();
            strategy.appendField(locator, this, "abstractTaxiwayElementExtension", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetOwns();
            boolean theField;
