...
/**
 * <p>
 * Java class for NavigationAreaTimeSlicePropertyType complex type
 * </p>
 * .
 *
 * <p>
 ...
 *       <sequence>
 *         <element ref=
"{http://www.aixm.aero/schema/5.1.1}NavigationAreaTimeSlice"/>
 *       </sequence>
 *       <attGroup ref=
...
@XmlType(name = "NavigationAreaTimeSlicePropertyType", propOrder = {"navigationAreaTimeSlice"})
...
public class NavigationAreaTimeSlicePropertyType implements Serializable, Equals, HashCode, ToString {
     ...
     *
     * @return possible object is {@link NavigationAreaTimeSliceType }
     *
     */
    @OneToOne(targetEntity = NavigationAreaTimeSliceType.class, cascade = {CascadeType.ALL}, fetch = FetchType.EAGER)
     ...
     *
     * @param value
     *            allowed object is {@link NavigationAreaTimeSliceType }
     *
     */
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetNavigationAreaTimeSlice();
            NavigationAreaTimeSliceType theField;
            theField = this.getNavigationAreaTimeSlice();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "navigationAreaTimeSlice", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            NavigationAreaTimeSliceType theField;
            theField = this.getNavigationAreaTimeSlice();
            strategy.appendField(locator, this, "navigationAreaTimeSlice", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetOwns();
            boolean theField;
