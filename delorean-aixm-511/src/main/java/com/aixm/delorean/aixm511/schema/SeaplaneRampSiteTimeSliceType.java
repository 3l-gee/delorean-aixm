...
/**
 * <p>
 * Java class for SeaplaneRampSiteTimeSliceType complex type
 * </p>
 * .
 *
 * <p>
 ...
 *       <sequence>
 *         <group ref=
"{http://www.aixm.aero/schema/5.1.1}SeaplaneRampSitePropertyGroup"/>
 ...
 *                 <sequence>
 *                   <element ref=
"{http://www.aixm.aero/schema/5.1.1}AbstractSeaplaneRampSiteExtension"/>
 *                 </sequence>
 *                 <attGroup ref=
...
@XmlType(name = "SeaplaneRampSiteTimeSliceType", propOrder = {"extent", "centreline", "annotation", "extension"})
@Entity(name = "SeaplaneRampSiteTimeSliceType")
@Table(name = "seaplanerampsite_ts", schema = "airport_heliport")
public class SeaplaneRampSiteTimeSliceType extends AbstractAIXMTimeSliceType implements Serializable {
    ...
    protected JAXBElement<AIXMElevatedCurvePropertyType> centreline;
    @XmlElement(nillable = true)
    protected List<NotePropertyType> annotation;
    protected List<SeaplaneRampSiteExtensionType> extension;
     ...
     */
    @Transient
    public JAXBElement<AIXMElevatedCurvePropertyType> getCentreline() {
        return centreline;
    }
     ...
     *
     */
    public void setCentreline(JAXBElement<AIXMElevatedCurvePropertyType> value) {
    ...
    @JoinTable(name = "annotation_seaplanerampsite_link", schema = "airport_heliport", joinColumns = {
            @JoinColumn(name = "annotation", referencedColumnName = "hjid")}, inverseJoinColumns = {
                    @JoinColumn(name = "seaplanerampsitepropertygroup", referencedColumnName = "hjid")})
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link SeaplaneRampSiteExtensionType }
     *
     *
     */
    @OneToMany(targetEntity = SeaplaneRampSiteExtensionType.class, cascade = {CascadeType.ALL}, fetch = FetchType.EAGER)
     ...
     *
     */
    public void setExtension(List<SeaplaneRampSiteExtensionType> extension) {
    ...
    public void setExtentItem(AIXMElevatedSurfacePropertyType target) {
        setExtent(XmlAdapterUtils.marshallJAXBElement(AIXMElevatedSurfacePropertyType.class,
                new QName("http://www.aixm.aero/schema/5.1.1", "extent"), SeaplaneRampSiteTimeSliceType.class, target));
    }
    ...
    public AIXMElevatedCurvePropertyType getCentrelineItem() {
        return XmlAdapterUtils.unmarshallSource(AIXMElevatedCurvePropertyType.class, this.getCentreline());
    }

    public void setCentrelineItem(AIXMElevatedCurvePropertyType target) {
        setCentreline(XmlAdapterUtils.marshallJAXBElement(AIXMElevatedCurvePropertyType.class,
                new QName("http://www.aixm.aero/schema/5.1.1", "centreline"), SeaplaneRampSiteTimeSliceType.class,
                target));
    }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        final SeaplaneRampSiteTimeSliceType that = ((SeaplaneRampSiteTimeSliceType) object);
        {
            ...
            List<SeaplaneRampSiteExtensionType> lhsField;
            lhsField = (this.isSetExtension() ? this.getExtension() : null);
            List<SeaplaneRampSiteExtensionType> rhsField;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        }
        {
            ...
            List<SeaplaneRampSiteExtensionType> theField;
