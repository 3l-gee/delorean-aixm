...
@Table(name = "seaplanerampsite_t", schema = "airport_heliport")
public class SeaplaneRampSiteTimeSliceType extends AbstractAIXMTimeSliceType implements Serializable {
    ...
    @JoinTable(name = "splnrmpsttmslctp_annttn_link", schema = "airport_heliport", joinColumns = {
            @JoinColumn(name = "seaplanerampsite_t_hjid", referencedColumnName = "hjid")}, inverseJoinColumns = {
    ...
    @JoinColumn(name = "seaplanerampsitee_hjid", referencedColumnName = "hjid")
