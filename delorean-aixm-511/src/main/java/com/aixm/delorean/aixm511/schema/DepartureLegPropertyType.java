...
/**
 * <p>Java class for DepartureLegPropertyType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="DepartureLegPropertyType">
 *   <complexContent>
...
@XmlType(name = "DepartureLegPropertyType")
@Entity(name = "DepartureLegPropertyType")
@Table(name = "departurelegpropertytype", schema = "procedure")
public class DepartureLegPropertyType implements Serializable, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        final DepartureLegPropertyType that = ((DepartureLegPropertyType) object);
        {
