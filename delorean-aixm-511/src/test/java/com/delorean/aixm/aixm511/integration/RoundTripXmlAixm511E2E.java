package com.delorean.aixm.aixm511.integration;
...
public class RoundTripXmlAixm511E2E {
    ...
    Path OutDir = Paths.get("target", "test_output", "aixm511", "round_trip_xml_aixm");
    ...
    void setContext() {
        ...
        assertThat(ContextWarehouse.getInstance().getActive().getDescription()).isEqualTo("RoundTripXmlAixm511E2E");
    ...
    void configDeloreanCore() {
        ...
        assertThat(container.getRootClass()).isEqualTo(com.delorean.aixm.aixm511.schema.message.AIXMBasicMessageType.class);
        assertThat(container.getFeatureClass()).isEqualTo(com.delorean.aixm.aixm511.schema.AbstractAIXMFeatureType.class);
        assertThat(container.getTimeSliceClass()).isEqualTo(com.delorean.aixm.aixm511.schema.AbstractAIXMTimeSliceType.class);
        assertThat(container.getObjectClass()).isEqualTo(com.delorean.aixm.aixm511.schema.AbstractAIXMObjectType.class);
    ...
    void loadXml(){
        ...
        // do
        container.unmarshal(xmlPath, "eadffe99");
    ...
    void extractExtractedXml() {
        ...
        // given
        String xmlPath = OutDir.resolve("donlon-aixm-511-predicated.xml.log").toString();
    ...
    void databaseExtractDescription() {
        ...
        // do
        container.predicate("2022-01-01T00:00:00Z", "deloreanDescription", "eadffe99");
