...
public class ContainerAIXM511Test {
    ...
    void configDeloreanCore() {
        ...
        assertThat(firstContainer.getRootClass()).isEqualTo(com.aixm.delorean.aixm511.schema.message.AIXMBasicMessageType.class);
        assertThat(firstContainer.getFeatureClass()).isEqualTo(com.aixm.delorean.aixm511.schema.AbstractAIXMFeatureType.class);
        assertThat(firstContainer.getTimeSliceClass()).isEqualTo(com.aixm.delorean.aixm511.schema.AbstractAIXMTimeSliceType.class);
        assertThat(firstContainer.getObjectClass()).isEqualTo(com.aixm.delorean.aixm511.schema.AbstractAIXMObjectType.class);
    ...
    void addNewContainer() {
        ...
        // container is correctly configured
        assertThat(secondContainer.getRootClass()).isEqualTo(com.aixm.delorean.aixm511.schema.message.AIXMBasicMessageType.class);
        assertThat(secondContainer.getFeatureClass()).isEqualTo(com.aixm.delorean.aixm511.schema.AbstractAIXMFeatureType.class);
        assertThat(secondContainer.getTimeSliceClass()).isEqualTo(com.aixm.delorean.aixm511.schema.AbstractAIXMTimeSliceType.class);
        assertThat(secondContainer.getObjectClass()).isEqualTo(com.aixm.delorean.aixm511.schema.AbstractAIXMObjectType.class);
