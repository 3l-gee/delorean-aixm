 ...
 *       <sequence>
 *         <element name="timeSlice" type="{http://www.aixm.aero/schema/5.1.1}TouchDownLiftOffMarkingTimeSlicePropertyType" maxOccurs="unbounded"/>
 *       </sequence>
 *     </extension>
 *   </complexContent>
 * </complexType>
    ...
    implements Serializable
{
    ...
    @JoinTable(name = "timeslice_touchdownliftoffmarking_link", schema = "airport_heliport", joinColumns = {
        ...
        @JoinColumn(name = "touchdownliftoffmarkingtype", referencedColumnName = "hjid")
    })
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        final TouchDownLiftOffMarkingType that = ((TouchDownLiftOffMarkingType) object);
        {
