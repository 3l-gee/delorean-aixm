...
@Entity(name = "TaxiwayLightSystemExtensionType")
@Table(name = "taxiwaylightsystem_ext", schema = "airport_heliport")
public class TaxiwayLightSystemExtensionType implements Serializable, Equals, HashCode, ToString
{
    ...
    @JoinTable(name = "TAXIWAY_LIGHT_SYSTEM_EXTENSI_1", joinColumns = {
        @JoinColumn(name = "PARENT_TAXIWAY_LIGHT_SYSTEM__0")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "TAXIWAY_LIGHT_SYSTEM_EXTENSI_2", joinColumns = {
        @JoinColumn(name = "PARENT_TAXIWAY_LIGHT_SYSTEM__0")
    }, inverseJoinColumns = {
        @JoinColumn(name = "CHILD_ABSTRACT_EXTENSION_TYP_0")
    })
