...
@Table(name = "deicingareamarking_ext", schema = "airport_heliport")
public class DeicingAreaMarkingExtensionType implements Serializable, Equals, HashCode, ToString
{
    ...
    @JoinTable(name = "DEICING_AREA_MARKING_EXTENSI_1", joinColumns = {
        @JoinColumn(name = "PARENT_DEICING_AREA_MARKING__0")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "DEICING_AREA_MARKING_EXTENSI_2", joinColumns = {
        @JoinColumn(name = "PARENT_DEICING_AREA_MARKING__0")
    }, inverseJoinColumns = {
        @JoinColumn(name = "CHILD_ABSTRACT_EXTENSION_TYP_0")
    })
