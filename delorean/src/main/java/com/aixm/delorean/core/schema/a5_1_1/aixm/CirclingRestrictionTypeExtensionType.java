...
public class CirclingRestrictionTypeExtensionType implements Serializable, Equals, HashCode, ToString
{
    ...
    @JoinTable(name = "CIRCLING_RESTRICTION_TYPE_EX_1", joinColumns = {
        @JoinColumn(name = "PARENT_CIRCLING_RESTRICTION__0")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "CIRCLING_RESTRICTION_TYPE_EX_2", joinColumns = {
        @JoinColumn(name = "PARENT_CIRCLING_RESTRICTION__0")
    }, inverseJoinColumns = {
        @JoinColumn(name = "CHILD_ABSTRACT_EXTENSION_TYP_0")
    })
