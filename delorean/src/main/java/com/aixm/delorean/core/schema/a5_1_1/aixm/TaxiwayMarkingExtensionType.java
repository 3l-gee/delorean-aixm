...
public class TaxiwayMarkingExtensionType implements Serializable, Equals, HashCode, ToString
{
    ...
    @JoinTable(name = "TAXIWAY_MARKING_EXTENSION_TY_1", joinColumns = {
        @JoinColumn(name = "PARENT_TAXIWAY_MARKING_EXTEN_0")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "TAXIWAY_MARKING_EXTENSION_TY_2", joinColumns = {
        @JoinColumn(name = "PARENT_TAXIWAY_MARKING_EXTEN_0")
    }, inverseJoinColumns = {
        @JoinColumn(name = "CHILD_ABSTRACT_EXTENSION_TYP_0")
    })
