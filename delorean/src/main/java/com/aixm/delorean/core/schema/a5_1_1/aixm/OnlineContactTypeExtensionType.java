...
public class OnlineContactTypeExtensionType implements Serializable, Equals, HashCode, ToString
{
    ...
    @JoinTable(name = "ONLINE_CONTACT_TYPE_EXTENSIO_1", joinColumns = {
        @JoinColumn(name = "PARENT_ONLINE_CONTACT_TYPE_E_0")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "ONLINE_CONTACT_TYPE_EXTENSIO_2", joinColumns = {
        @JoinColumn(name = "PARENT_ONLINE_CONTACT_TYPE_E_0")
    }, inverseJoinColumns = {
        @JoinColumn(name = "CHILD_ABSTRACT_EXTENSION_TYP_0")
    })
