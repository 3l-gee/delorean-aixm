 ...
 *       <sequence>
 *         <group ref="{http://www.aixm.aero/schema/5.1.1}AirportClearanceServicePropertyGroup"/>
    ...
    implements Serializable
{
    ...
    @JoinTable(name = "call_sign_airportclearanceservice_link", schema = "service", joinColumns = {
        @JoinColumn(name = "call-sign", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
        @JoinColumn(name = "airportclearanceservicepropertygroup", referencedColumnName = "hjid")
    })
    ...
    @JoinTable(name = "radiocommunication_airportclearanceservice_link", schema = "service", joinColumns = {
    ...
    @JoinTable(name = "groundcommunication_airportclearanceservice_link", schema = "service", joinColumns = {
    ...
    @JoinTable(name = "availability_airportclearanceservice_link", schema = "service", joinColumns = {
    ...
    @JoinTable(name = "annotation_airportclearanceservice_link", schema = "service", joinColumns = {
    ...
    @JoinTable(name = "airportheliport_airportclearanceservice_link", schema = "service", joinColumns = {
    ...
    @JoinColumn(name = "EXTENSION_AIRPORT_CLEARANCE__0")
