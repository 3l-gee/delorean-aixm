...
public class AirportProtectionAreaMarkingExtensionType implements Serializable, Equals, HashCode, ToString
{
    ...
    @JoinTable(name = "AIRPORT_PROTECTION_AREA_MARK_2", joinColumns = {
        @JoinColumn(name = "PARENT_AIRPORT_PROTECTION_AR_0")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "AIRPORT_PROTECTION_AREA_MARK_3", joinColumns = {
        @JoinColumn(name = "PARENT_AIRPORT_PROTECTION_AR_0")
    }, inverseJoinColumns = {
        @JoinColumn(name = "CHILD_ABSTRACT_EXTENSION_TYP_0")
    })
