...
public class DirectionFinderExtensionType implements Serializable, Equals, HashCode, ToString
{
    ...
    @JoinTable(name = "DIRECTION_FINDER_EXTENSION_T_1", joinColumns = {
        @JoinColumn(name = "PARENT_DIRECTION_FINDER_EXTE_0")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "DIRECTION_FINDER_EXTENSION_T_2", joinColumns = {
        @JoinColumn(name = "PARENT_DIRECTION_FINDER_EXTE_0")
    }, inverseJoinColumns = {
        @JoinColumn(name = "CHILD_ABSTRACT_EXTENSION_TYP_0")
    })
