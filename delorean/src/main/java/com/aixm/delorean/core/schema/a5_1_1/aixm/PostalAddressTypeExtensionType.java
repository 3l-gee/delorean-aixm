...
@Table(name = "postaladdress_ext", schema = "shared")
public class PostalAddressTypeExtensionType implements Serializable, Equals, HashCode, ToString
{
    ...
    @JoinTable(name = "POSTAL_ADDRESS_TYPE_EXTENSIO_1", joinColumns = {
        @JoinColumn(name = "PARENT_POSTAL_ADDRESS_TYPE_E_0")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "POSTAL_ADDRESS_TYPE_EXTENSIO_2", joinColumns = {
        @JoinColumn(name = "PARENT_POSTAL_ADDRESS_TYPE_E_0")
    }, inverseJoinColumns = {
        @JoinColumn(name = "CHILD_ABSTRACT_EXTENSION_TYP_0")
    })
