...
public class ApronContaminationTypeExtensionType implements Serializable, Equals, HashCode, ToString
{
    ...
    @JoinTable(name = "APRON_CONTAMINATION_TYPE_EXT_1", joinColumns = {
        @JoinColumn(name = "PARENT_APRON_CONTAMINATION_T_0")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "APRON_CONTAMINATION_TYPE_EXT_2", joinColumns = {
        @JoinColumn(name = "PARENT_APRON_CONTAMINATION_T_0")
    }, inverseJoinColumns = {
        @JoinColumn(name = "CHILD_ABSTRACT_EXTENSION_TYP_0")
    })
