 ...
 *       <sequence>
 *         <element ref="{http://www.aixm.aero/schema/5.1.1}AirportClearanceServiceTimeSlice"/>
 *       </sequence>
...
public class AirportClearanceServiceTimeSlicePropertyType implements Serializable, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        final AirportClearanceServiceTimeSlicePropertyType that = ((AirportClearanceServiceTimeSlicePropertyType) object);
        {
            boolean lhsFieldIsSet = this.isSetAirportClearanceServiceTimeSlice();
            boolean rhsFieldIsSet = that.isSetAirportClearanceServiceTimeSlice();
            AirportClearanceServiceTimeSliceType lhsField;
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            AirportClearanceServiceTimeSliceType theField;
            theField = this.getAirportClearanceServiceTimeSlice();
            strategy.appendField(locator, this, "airportClearanceServiceTimeSlice", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetOwns();
            boolean theField;
