...
public class UnitAvailabilityTypeExtensionType implements Serializable, Equals, HashCode, ToString
{
    ...
    @JoinTable(name = "UNIT_AVAILABILITY_TYPE_EXTEN_1", joinColumns = {
        @JoinColumn(name = "PARENT_UNIT_AVAILABILITY_TYP_0")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "UNIT_AVAILABILITY_TYPE_EXTEN_2", joinColumns = {
        @JoinColumn(name = "PARENT_UNIT_AVAILABILITY_TYP_0")
    }, inverseJoinColumns = {
        @JoinColumn(name = "CHILD_ABSTRACT_EXTENSION_TYP_0")
    })
