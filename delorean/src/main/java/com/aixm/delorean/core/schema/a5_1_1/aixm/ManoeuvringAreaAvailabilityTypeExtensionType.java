...
public class ManoeuvringAreaAvailabilityTypeExtensionType implements Serializable, Equals, HashCode, ToString
{
    ...
    @JoinTable(name = "MANOEUVRING_AREA_AVAILABILIT_2", joinColumns = {
        @JoinColumn(name = "PARENT_MANOEUVRING_AREA_AVAI_0")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "MANOEUVRING_AREA_AVAILABILIT_3", joinColumns = {
        @JoinColumn(name = "PARENT_MANOEUVRING_AREA_AVAI_0")
    }, inverseJoinColumns = {
        @JoinColumn(name = "CHILD_ABSTRACT_EXTENSION_TYP_0")
    })
