 ...
 *         <group ref="{http://www.aixm.aero/schema/5.1.1}AirportHeliportContaminationPropertyGroup"/>
...
@Table(name = "airportheliportcontamination", schema = "airport_heliport")
    ...
    implements Serializable
{
    ...
    @JoinTable(name = "criticalridge_airportheliportcontamination_link", schema = "airport_heliport", joinColumns = {
        @JoinColumn(name = "criticalridge", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
        @JoinColumn(name = "airportheliportcontaminationtype", referencedColumnName = "hjid")
    })
    ...
    @JoinTable(name = "layer_airportheliportcontamination_link", schema = "airport_heliport", joinColumns = {
    ...
    @JoinTable(name = "annotation_airportheliportcontamination_link", schema = "airport_heliport", joinColumns = {
    ...
    @JoinColumn(name = "EXTENSION_AIRPORT_HELIPORT_C_1")
