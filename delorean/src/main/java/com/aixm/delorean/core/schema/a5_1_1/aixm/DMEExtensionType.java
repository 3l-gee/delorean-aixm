...
public class DMEExtensionType implements Serializable, Equals, HashCode, ToString
{
    ...
    @JoinTable(name = "DMEEXTENSION_TYPE_ABSTRACT_D_0", joinColumns = {
        @JoinColumn(name = "PARENT_DMEEXTENSION_TYPE_HJID")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "DMEEXTENSION_TYPE_ABSTRACT_N_0", joinColumns = {
        @JoinColumn(name = "PARENT_DMEEXTENSION_TYPE_HJID")
    }, inverseJoinColumns = {
        @JoinColumn(name = "CHILD_ABSTRACT_EXTENSION_TYP_0")
    })
