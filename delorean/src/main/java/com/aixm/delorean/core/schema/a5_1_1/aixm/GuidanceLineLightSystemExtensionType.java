...
public class GuidanceLineLightSystemExtensionType implements Serializable, Equals, HashCode, ToString
{
    ...
    @JoinTable(name = "GUIDANCE_LINE_LIGHT_SYSTEM_E_1", joinColumns = {
        @JoinColumn(name = "PARENT_GUIDANCE_LINE_LIGHT_S_0")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "GUIDANCE_LINE_LIGHT_SYSTEM_E_2", joinColumns = {
        @JoinColumn(name = "PARENT_GUIDANCE_LINE_LIGHT_S_0")
    }, inverseJoinColumns = {
        @JoinColumn(name = "CHILD_ABSTRACT_EXTENSION_TYP_0")
    })
