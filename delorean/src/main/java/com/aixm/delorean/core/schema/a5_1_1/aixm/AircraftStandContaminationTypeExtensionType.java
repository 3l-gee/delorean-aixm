...
public class AircraftStandContaminationTypeExtensionType implements Serializable, Equals, HashCode, ToString
{
    ...
    @JoinTable(name = "AIRCRAFT_STAND_CONTAMINATION_2", joinColumns = {
        @JoinColumn(name = "PARENT_AIRCRAFT_STAND_CONTAM_0")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "AIRCRAFT_STAND_CONTAMINATION_3", joinColumns = {
        @JoinColumn(name = "PARENT_AIRCRAFT_STAND_CONTAM_0")
    }, inverseJoinColumns = {
        @JoinColumn(name = "CHILD_ABSTRACT_EXTENSION_TYP_0")
    })
