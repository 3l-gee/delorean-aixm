...
public class WorkareaActivityTypeExtensionType implements Serializable, Equals, HashCode, ToString
{
    ...
    @JoinTable(name = "WORKAREA_ACTIVITY_TYPE_EXTEN_1", joinColumns = {
        @JoinColumn(name = "PARENT_WORKAREA_ACTIVITY_TYP_0")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "WORKAREA_ACTIVITY_TYPE_EXTEN_2", joinColumns = {
        @JoinColumn(name = "PARENT_WORKAREA_ACTIVITY_TYP_0")
    }, inverseJoinColumns = {
        @JoinColumn(name = "CHILD_ABSTRACT_EXTENSION_TYP_0")
    })
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        }
        {
            ...
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "abstractWorkareaActivityExtension", theField);
            currentHashCode = strategy.hashCode(theFieldLocator, currentHashCode, theField, theFieldIsSet);
        }
        {
