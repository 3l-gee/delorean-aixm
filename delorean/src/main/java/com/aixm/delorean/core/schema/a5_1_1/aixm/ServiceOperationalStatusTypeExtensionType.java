...
@Entity(name = "ServiceOperationalStatusTypeExtensionType")
@Table(name = "serviceoperationalstatus_ext", schema = "service")
public class ServiceOperationalStatusTypeExtensionType implements Serializable, Equals, HashCode, ToString
{

    private static final long serialVersionUID = 20251104L;
    @XmlElement(name = "AbstractPropertiesWithScheduleExtension")
    protected AbstractExtensionType abstractPropertiesWithScheduleExtension;
    @XmlElement(name = "AbstractServiceOperationalStatusExtension")
    protected AbstractExtensionType abstractServiceOperationalStatusExtension;
    ...
    @JoinTable(name = "SERVICE_OPERATIONAL_STATUS_T_2", joinColumns = {
        @JoinColumn(name = "PARENT_SERVICE_OPERATIONAL_S_0")
    }, inverseJoinColumns = {
    ...
    /**
     * Gets the value of the abstractServiceOperationalStatusExtension property.
     * 
     * @return
     *     possible object is
     *     {@link AbstractExtensionType }
    ...
    @JoinTable(name = "SERVICE_OPERATIONAL_STATUS_T_3", joinColumns = {
        @JoinColumn(name = "PARENT_SERVICE_OPERATIONAL_S_0")
    }, inverseJoinColumns = {
        @JoinColumn(name = "CHILD_ABSTRACT_EXTENSION_TYP_0")
    })
    public AbstractExtensionType getAbstractServiceOperationalStatusExtension() {
        return abstractServiceOperationalStatusExtension;
    }

    /**
     * Sets the value of the abstractServiceOperationalStatusExtension property.
     * 
     * @param value
     *     allowed object is
     *     {@link AbstractExtensionType }
     *     
     */
    public void setAbstractServiceOperationalStatusExtension(AbstractExtensionType value) {
        this.abstractServiceOperationalStatusExtension = value;
    }

    @Transient
    public boolean isSetAbstractServiceOperationalStatusExtension() {
        return (this.abstractServiceOperationalStatusExtension!= null);
    }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        }
        {
            ...
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "abstractServiceOperationalStatusExtension", lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "abstractServiceOperationalStatusExtension", rhsField);
            if (!strategy.equals(lhsFieldLocator, rhsFieldLocator, lhsField, rhsField, lhsFieldIsSet, rhsFieldIsSet)) {
                return false;
            }
        }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetAbstractServiceOperationalStatusExtension();
            AbstractExtensionType theField;
            theField = this.getAbstractServiceOperationalStatusExtension();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "abstractServiceOperationalStatusExtension", theField);
            currentHashCode = strategy.hashCode(theFieldLocator, currentHashCode, theField, theFieldIsSet);
        }
        {
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        }
        {
            ...
            AbstractExtensionType theField;
            theField = this.getAbstractServiceOperationalStatusExtension();
            strategy.appendField(locator, this, "abstractServiceOperationalStatusExtension", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetOwns();
            boolean theField;
