...
@Entity(name = "ArrivalFeederLegExtensionType")
@Table(name = "arrivalfeederleg_ext", schema = "procedure")
public class ArrivalFeederLegExtensionType implements Serializable, Equals, HashCode, ToString
{
    ...
    @JoinTable(name = "ARRIVAL_FEEDER_LEG_EXTENSION_1", joinColumns = {
        @JoinColumn(name = "PARENT_ARRIVAL_FEEDER_LEG_EX_0")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "ARRIVAL_FEEDER_LEG_EXTENSION_2", joinColumns = {
        @JoinColumn(name = "PARENT_ARRIVAL_FEEDER_LEG_EX_0")
    }, inverseJoinColumns = {
        @JoinColumn(name = "CHILD_ABSTRACT_EXTENSION_TYP_0")
    })
    ...
    @JoinTable(name = "ARRIVAL_FEEDER_LEG_EXTENSION_3", joinColumns = {
        @JoinColumn(name = "PARENT_ARRIVAL_FEEDER_LEG_EX_0")
    }, inverseJoinColumns = {
        @JoinColumn(name = "CHILD_ABSTRACT_EXTENSION_TYP_0")
    })
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            AbstractExtensionType theField;
            theField = this.getAbstractArrivalFeederLegExtension();
            strategy.appendField(locator, this, "abstractArrivalFeederLegExtension", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetAbstractApproachLegExtension();
            AbstractExtensionType theField;
