...
@Entity(name = "AirportSuppliesServiceExtensionType")
@Table(name = "airportsuppliesservice_ext", schema = "service")
public class AirportSuppliesServiceExtensionType implements Serializable, Equals, HashCode, ToString
{
    ...
    @JoinTable(name = "AIRPORT_SUPPLIES_SERVICE_EXT_1", joinColumns = {
        @JoinColumn(name = "PARENT_AIRPORT_SUPPLIES_SERV_0")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "AIRPORT_SUPPLIES_SERVICE_EXT_2", joinColumns = {
        @JoinColumn(name = "PARENT_AIRPORT_SUPPLIES_SERV_0")
    }, inverseJoinColumns = {
        @JoinColumn(name = "CHILD_ABSTRACT_EXTENSION_TYP_0")
    })
    ...
    @JoinTable(name = "AIRPORT_SUPPLIES_SERVICE_EXT_3", joinColumns = {
        @JoinColumn(name = "PARENT_AIRPORT_SUPPLIES_SERV_0")
    }, inverseJoinColumns = {
        @JoinColumn(name = "CHILD_ABSTRACT_EXTENSION_TYP_0")
    })
