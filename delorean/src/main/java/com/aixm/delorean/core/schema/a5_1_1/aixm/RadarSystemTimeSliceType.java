    ...
    implements Serializable
{
    ...
    @JoinColumn(name = "radarequipment_id", referencedColumnName = "hjid")
    ...
    @JoinColumn(name = "office_id", referencedColumnName = "hjid")
    ...
    @JoinColumn(name = "parrunway_id", referencedColumnName = "hjid")
