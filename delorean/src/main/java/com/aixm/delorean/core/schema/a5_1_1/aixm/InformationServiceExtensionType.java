...
public class InformationServiceExtensionType implements Serializable, Equals, HashCode, ToString
{
    ...
    @JoinTable(name = "INFORMATION_SERVICE_EXTENSIO_1", joinColumns = {
        @JoinColumn(name = "PARENT_INFORMATION_SERVICE_E_0")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "INFORMATION_SERVICE_EXTENSIO_2", joinColumns = {
        @JoinColumn(name = "PARENT_INFORMATION_SERVICE_E_0")
    }, inverseJoinColumns = {
        @JoinColumn(name = "CHILD_ABSTRACT_EXTENSION_TYP_0")
    })
