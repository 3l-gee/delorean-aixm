...
public class MissedApproachLegExtensionType implements Serializable, Equals, HashCode, ToString
{
    ...
    @JoinTable(name = "MISSED_APPROACH_LEG_EXTENSIO_1", joinColumns = {
        @JoinColumn(name = "PARENT_MISSED_APPROACH_LEG_E_0")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "MISSED_APPROACH_LEG_EXTENSIO_2", joinColumns = {
        @JoinColumn(name = "PARENT_MISSED_APPROACH_LEG_E_0")
    }, inverseJoinColumns = {
        @JoinColumn(name = "CHILD_ABSTRACT_EXTENSION_TYP_0")
    })
    ...
    @JoinTable(name = "MISSED_APPROACH_LEG_EXTENSIO_3", joinColumns = {
        @JoinColumn(name = "PARENT_MISSED_APPROACH_LEG_E_0")
    }, inverseJoinColumns = {
        @JoinColumn(name = "CHILD_ABSTRACT_EXTENSION_TYP_0")
    })
