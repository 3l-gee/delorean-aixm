...
@Entity(name = "AirportHeliportContaminationTypeExtensionType")
@Table(name = "airportheliportcontamination_ext", schema = "airport_heliport")
public class AirportHeliportContaminationTypeExtensionType implements Serializable, Equals, HashCode, ToString
{
    ...
    @JoinTable(name = "AIRPORT_HELIPORT_CONTAMINATI_2", joinColumns = {
        @JoinColumn(name = "PARENT_AIRPORT_HELIPORT_CONT_0")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "AIRPORT_HELIPORT_CONTAMINATI_3", joinColumns = {
        @JoinColumn(name = "PARENT_AIRPORT_HELIPORT_CONT_0")
    }, inverseJoinColumns = {
        @JoinColumn(name = "CHILD_ABSTRACT_EXTENSION_TYP_0")
    })
    public AbstractExtensionType getAbstractAirportHeliportContaminationExtension() {
        return abstractAirportHeliportContaminationExtension;
    }

    /**
     * Sets the value of the abstractAirportHeliportContaminationExtension property.
     * 
     * @param value
     *     allowed object is
     *     {@link AbstractExtensionType }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        final AirportHeliportContaminationTypeExtensionType that = ((AirportHeliportContaminationTypeExtensionType) object);
        {
            ...
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "abstractAirportHeliportContaminationExtension", lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "abstractAirportHeliportContaminationExtension", rhsField);
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetAbstractAirportHeliportContaminationExtension();
            AbstractExtensionType theField;
            theField = this.getAbstractAirportHeliportContaminationExtension();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "abstractAirportHeliportContaminationExtension", theField);
            currentHashCode = strategy.hashCode(theFieldLocator, currentHashCode, theField, theFieldIsSet);
        }
        {
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        }
        {
            ...
            AbstractExtensionType theField;
            theField = this.getAbstractAirportHeliportContaminationExtension();
            strategy.appendField(locator, this, "abstractAirportHeliportContaminationExtension", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetOwns();
            boolean theField;
