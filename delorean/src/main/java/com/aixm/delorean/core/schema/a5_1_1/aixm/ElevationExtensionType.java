...
public class ElevationExtensionType implements Serializable, Equals, HashCode, ToString
{
    ...
    @JoinTable(name = "ELEVATION_EXTENSION_TYPE_ABS_0", joinColumns = {
        @JoinColumn(name = "PARENT_ELEVATION_EXTENSION_T_0")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "ELEVATION_EXTENSION_TYPE_ABS_1", joinColumns = {
        @JoinColumn(name = "PARENT_ELEVATION_EXTENSION_T_0")
    }, inverseJoinColumns = {
        @JoinColumn(name = "CHILD_ABSTRACT_EXTENSION_TYP_0")
    })
