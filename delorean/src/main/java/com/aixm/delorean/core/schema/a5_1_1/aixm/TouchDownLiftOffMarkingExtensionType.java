...
@Table(name = "touchdownliftoffmarking_ext", schema = "airport_heliport")
public class TouchDownLiftOffMarkingExtensionType implements Serializable, Equals, HashCode, ToString
{
    ...
    @JoinTable(name = "TOUCH_DOWN_LIFT_OFF_MARKING__2", joinColumns = {
        @JoinColumn(name = "PARENT_TOUCH_DOWN_LIFT_OFF_M_0")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "TOUCH_DOWN_LIFT_OFF_MARKING__3", joinColumns = {
        @JoinColumn(name = "PARENT_TOUCH_DOWN_LIFT_OFF_M_0")
    }, inverseJoinColumns = {
        @JoinColumn(name = "CHILD_ABSTRACT_EXTENSION_TYP_0")
    })
