...
public class DepartureArrivalConditionTypeExtensionType implements Serializable, Equals, HashCode, ToString
{
    ...
    @JoinTable(name = "DEPARTURE_ARRIVAL_CONDITION__2", joinColumns = {
        @JoinColumn(name = "PARENT_DEPARTURE_ARRIVAL_CON_0")
    }, inverseJoinColumns = {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        final DepartureArrivalConditionTypeExtensionType that = ((DepartureArrivalConditionTypeExtensionType) object);
        {
