...
public class TouchDownLiftOffLightSystemExtensionType implements Serializable, Equals, HashCode, ToString
{
    ...
    @JoinTable(name = "TOUCH_DOWN_LIFT_OFF_LIGHT_SY_2", joinColumns = {
        @JoinColumn(name = "PARENT_TOUCH_DOWN_LIFT_OFF_L_0")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "TOUCH_DOWN_LIFT_OFF_LIGHT_SY_3", joinColumns = {
        @JoinColumn(name = "PARENT_TOUCH_DOWN_LIFT_OFF_L_0")
    }, inverseJoinColumns = {
        @JoinColumn(name = "CHILD_ABSTRACT_EXTENSION_TYP_0")
    })
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = 1;
        {
            ...
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "abstractTouchDownLiftOffLightSystemExtension", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            AbstractExtensionType theField;
            theField = this.getAbstractTouchDownLiftOffLightSystemExtension();
            strategy.appendField(locator, this, "abstractTouchDownLiftOffLightSystemExtension", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetAbstractGroundLightSystemExtension();
            AbstractExtensionType theField;
