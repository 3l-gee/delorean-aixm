    ...
    implements Serializable
{
    ...
    @JoinTable(name = "aircraftcategory_arrivalfeederleg_link", schema = "procedure", joinColumns = {
        @JoinColumn(name = "aircraftcategory", referencedColumnName = "hjid")
    }, inverseJoinColumns = {
        @JoinColumn(name = "arrivalfeederlegpropertygroup", referencedColumnName = "hjid")
    })
    ...
    @JoinTable(name = "designsurface_arrivalfeederleg_link", schema = "procedure", joinColumns = {
    ...
    @JoinTable(name = "annotation_arrivalfeederleg_link", schema = "procedure", joinColumns = {
    ...
    @JoinColumn(name = "EXTENSION_ARRIVAL_FEEDER_LEG_0")
