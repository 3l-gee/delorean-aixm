...
public class AircraftGroundServiceExtensionType implements Serializable, Equals, HashCode, ToString
{
    ...
    @JoinTable(name = "AIRCRAFT_GROUND_SERVICE_EXTE_1", joinColumns = {
        @JoinColumn(name = "PARENT_AIRCRAFT_GROUND_SERVI_0")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "AIRCRAFT_GROUND_SERVICE_EXTE_2", joinColumns = {
        @JoinColumn(name = "PARENT_AIRCRAFT_GROUND_SERVI_0")
    }, inverseJoinColumns = {
        @JoinColumn(name = "CHILD_ABSTRACT_EXTENSION_TYP_0")
    })
    ...
    @JoinTable(name = "AIRCRAFT_GROUND_SERVICE_EXTE_3", joinColumns = {
        @JoinColumn(name = "PARENT_AIRCRAFT_GROUND_SERVI_0")
    }, inverseJoinColumns = {
        @JoinColumn(name = "CHILD_ABSTRACT_EXTENSION_TYP_0")
    })
