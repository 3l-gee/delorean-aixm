...
public class AirspaceActivationTypeExtensionType implements Serializable, Equals, HashCode, ToString
{
    ...
    @JoinTable(name = "AIRSPACE_ACTIVATION_TYPE_EXT_1", joinColumns = {
        @JoinColumn(name = "PARENT_AIRSPACE_ACTIVATION_T_0")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "AIRSPACE_ACTIVATION_TYPE_EXT_2", joinColumns = {
        @JoinColumn(name = "PARENT_AIRSPACE_ACTIVATION_T_0")
    }, inverseJoinColumns = {
        @JoinColumn(name = "CHILD_ABSTRACT_EXTENSION_TYP_0")
    })
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        final AirspaceActivationTypeExtensionType that = ((AirspaceActivationTypeExtensionType) object);
        {
            ...
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "abstractAirspaceActivationExtension", lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "abstractAirspaceActivationExtension", rhsField);
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        }
        {
            ...
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "abstractAirspaceActivationExtension", theField);
            currentHashCode = strategy.hashCode(theFieldLocator, currentHashCode, theField, theFieldIsSet);
        }
        {
