...
@Entity(name = "SpecialNavigationStationStatusTypeExtensionType")
@Table(name = "specialnavigationstationstatus_ext", schema = "navaids_point")
public class SpecialNavigationStationStatusTypeExtensionType implements Serializable, Equals, HashCode, ToString
{
    ...
    @JoinTable(name = "SPECIAL_NAVIGATION_STATION_S_2", joinColumns = {
        @JoinColumn(name = "PARENT_SPECIAL_NAVIGATION_ST_0")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "SPECIAL_NAVIGATION_STATION_S_3", joinColumns = {
        @JoinColumn(name = "PARENT_SPECIAL_NAVIGATION_ST_0")
    }, inverseJoinColumns = {
        @JoinColumn(name = "CHILD_ABSTRACT_EXTENSION_TYP_0")
    })
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        final SpecialNavigationStationStatusTypeExtensionType that = ((SpecialNavigationStationStatusTypeExtensionType) object);
        {
        ...
        }
        {
            ...
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "abstractSpecialNavigationStationStatusExtension", lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "abstractSpecialNavigationStationStatusExtension", rhsField);
            if (!strategy.equals(lhsFieldLocator, rhsFieldLocator, lhsField, rhsField, lhsFieldIsSet, rhsFieldIsSet)) {
                return false;
            }
        }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetAbstractSpecialNavigationStationStatusExtension();
            AbstractExtensionType theField;
            theField = this.getAbstractSpecialNavigationStationStatusExtension();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "abstractSpecialNavigationStationStatusExtension", theField);
            currentHashCode = strategy.hashCode(theFieldLocator, currentHashCode, theField, theFieldIsSet);
        }
        {
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        }
        {
            ...
            AbstractExtensionType theField;
            theField = this.getAbstractSpecialNavigationStationStatusExtension();
            strategy.appendField(locator, this, "abstractSpecialNavigationStationStatusExtension", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetOwns();
            boolean theField;
