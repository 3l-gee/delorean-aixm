...
@Entity(name = "ApronMarkingExtensionType")
@Table(name = "apronmarking_ext", schema = "airport_heliport")
public class ApronMarkingExtensionType implements Serializable, Equals, HashCode, ToString
{
    ...
    @JoinTable(name = "APRON_MARKING_EXTENSION_TYPE_0", joinColumns = {
        @JoinColumn(name = "PARENT_APRON_MARKING_EXTENSI_0")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "APRON_MARKING_EXTENSION_TYPE_1", joinColumns = {
        @JoinColumn(name = "PARENT_APRON_MARKING_EXTENSI_0")
    }, inverseJoinColumns = {
        @JoinColumn(name = "CHILD_ABSTRACT_EXTENSION_TYP_0")
    })
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        final ApronMarkingExtensionType that = ((ApronMarkingExtensionType) object);
        {
        ...
        }
        {
            ...
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "abstractApronMarkingExtension", lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "abstractApronMarkingExtension", rhsField);
            if (!strategy.equals(lhsFieldLocator, rhsFieldLocator, lhsField, rhsField, lhsFieldIsSet, rhsFieldIsSet)) {
                return false;
            }
        }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetAbstractApronMarkingExtension();
            AbstractExtensionType theField;
            theField = this.getAbstractApronMarkingExtension();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "abstractApronMarkingExtension", theField);
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            AbstractExtensionType theField;
            theField = this.getAbstractApronMarkingExtension();
            strategy.appendField(locator, this, "abstractApronMarkingExtension", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetAbstractMarkingExtension();
            AbstractExtensionType theField;
