...
public class AltimeterSourceStatusTypeExtensionType implements Serializable, Equals, HashCode, ToString
{
    ...
    @JoinTable(name = "ALTIMETER_SOURCE_STATUS_TYPE_1", joinColumns = {
        @JoinColumn(name = "PARENT_ALTIMETER_SOURCE_STAT_0")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "ALTIMETER_SOURCE_STATUS_TYPE_2", joinColumns = {
        @JoinColumn(name = "PARENT_ALTIMETER_SOURCE_STAT_0")
    }, inverseJoinColumns = {
        @JoinColumn(name = "CHILD_ABSTRACT_EXTENSION_TYP_0")
    })
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        }
        {
            ...
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "abstractAltimeterSourceStatusExtension", theField);
            currentHashCode = strategy.hashCode(theFieldLocator, currentHashCode, theField, theFieldIsSet);
        }
        {
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        }
        {
            ...
            AbstractExtensionType theField;
            theField = this.getAbstractAltimeterSourceStatusExtension();
            strategy.appendField(locator, this, "abstractAltimeterSourceStatusExtension", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetOwns();
            boolean theField;
