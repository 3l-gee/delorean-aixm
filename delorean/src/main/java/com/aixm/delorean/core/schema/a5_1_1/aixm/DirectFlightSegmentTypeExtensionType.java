...
public class DirectFlightSegmentTypeExtensionType implements Serializable, Equals, HashCode, ToString
{
    ...
    @JoinTable(name = "DIRECT_FLIGHT_SEGMENT_TYPE_E_1", joinColumns = {
        @JoinColumn(name = "PARENT_DIRECT_FLIGHT_SEGMENT_0")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "DIRECT_FLIGHT_SEGMENT_TYPE_E_2", joinColumns = {
        @JoinColumn(name = "PARENT_DIRECT_FLIGHT_SEGMENT_0")
    }, inverseJoinColumns = {
        @JoinColumn(name = "CHILD_ABSTRACT_EXTENSION_TYP_0")
    })
