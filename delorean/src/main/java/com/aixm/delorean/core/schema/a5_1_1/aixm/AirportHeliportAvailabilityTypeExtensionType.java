...
public class AirportHeliportAvailabilityTypeExtensionType implements Serializable, Equals, HashCode, ToString
{
    ...
    @JoinTable(name = "AIRPORT_HELIPORT_AVAILABILIT_2", joinColumns = {
        @JoinColumn(name = "PARENT_AIRPORT_HELIPORT_AVAI_0")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "AIRPORT_HELIPORT_AVAILABILIT_3", joinColumns = {
        @JoinColumn(name = "PARENT_AIRPORT_HELIPORT_AVAI_0")
    }, inverseJoinColumns = {
        @JoinColumn(name = "CHILD_ABSTRACT_EXTENSION_TYP_0")
    })
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        final AirportHeliportAvailabilityTypeExtensionType that = ((AirportHeliportAvailabilityTypeExtensionType) object);
        {
