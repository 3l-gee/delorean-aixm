...
@Table(name = "verticalstructurelightingstatus_ext", schema = "obstacle")
public class VerticalStructureLightingStatusTypeExtensionType implements Serializable, Equals, HashCode, ToString
{
    ...
    @JoinTable(name = "VERTICAL_STRUCTURE_LIGHTING__2", joinColumns = {
        @JoinColumn(name = "PARENT_VERTICAL_STRUCTURE_LI_0")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "VERTICAL_STRUCTURE_LIGHTING__3", joinColumns = {
        @JoinColumn(name = "PARENT_VERTICAL_STRUCTURE_LI_0")
    }, inverseJoinColumns = {
        @JoinColumn(name = "CHILD_ABSTRACT_EXTENSION_TYP_0")
    })
