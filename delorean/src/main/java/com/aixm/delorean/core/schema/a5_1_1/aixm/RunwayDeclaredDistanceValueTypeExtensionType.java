...
public class RunwayDeclaredDistanceValueTypeExtensionType implements Serializable, Equals, HashCode, ToString
{
    ...
    @JoinTable(name = "RUNWAY_DECLARED_DISTANCE_VAL_2", joinColumns = {
        @JoinColumn(name = "PARENT_RUNWAY_DECLARED_DISTA_0")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "RUNWAY_DECLARED_DISTANCE_VAL_3", joinColumns = {
        @JoinColumn(name = "PARENT_RUNWAY_DECLARED_DISTA_0")
    }, inverseJoinColumns = {
        @JoinColumn(name = "CHILD_ABSTRACT_EXTENSION_TYP_0")
    })
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        final RunwayDeclaredDistanceValueTypeExtensionType that = ((RunwayDeclaredDistanceValueTypeExtensionType) object);
        {
