 ...
 *         <element ref="{http://www.aixm.aero/schema/5.1.1}AbstractProcedureAvailabilityExtension"/>
 *       </choice>
...
@Table(name = "procedureavailability_ext", schema = "procedure")
public class ProcedureAvailabilityTypeExtensionType implements Serializable, Equals, HashCode, ToString
{
    ...
    @JoinTable(name = "PROCEDURE_AVAILABILITY_TYPE__1", joinColumns = {
        @JoinColumn(name = "PARENT_PROCEDURE_AVAILABILIT_0")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "PROCEDURE_AVAILABILITY_TYPE__2", joinColumns = {
        @JoinColumn(name = "PARENT_PROCEDURE_AVAILABILIT_0")
    }, inverseJoinColumns = {
        @JoinColumn(name = "CHILD_ABSTRACT_EXTENSION_TYP_0")
    })
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        }
        {
            ...
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "abstractProcedureAvailabilityExtension", lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "abstractProcedureAvailabilityExtension", rhsField);
            if (!strategy.equals(lhsFieldLocator, rhsFieldLocator, lhsField, rhsField, lhsFieldIsSet, rhsFieldIsSet)) {
                return false;
            }
        }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        }
        {
            ...
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "abstractProcedureAvailabilityExtension", theField);
            currentHashCode = strategy.hashCode(theFieldLocator, currentHashCode, theField, theFieldIsSet);
        }
        {
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        }
        {
            ...
            AbstractExtensionType theField;
            theField = this.getAbstractProcedureAvailabilityExtension();
            strategy.appendField(locator, this, "abstractProcedureAvailabilityExtension", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetOwns();
            boolean theField;
