...
public class ProcedureTransitionLegTypeExtensionType implements Serializable, Equals, HashCode, ToString
{
    ...
    @JoinTable(name = "PROCEDURE_TRANSITION_LEG_TYP_1", joinColumns = {
        @JoinColumn(name = "PARENT_PROCEDURE_TRANSITION__0")
    }, inverseJoinColumns = {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        final ProcedureTransitionLegTypeExtensionType that = ((ProcedureTransitionLegTypeExtensionType) object);
        {
