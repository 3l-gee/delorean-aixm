...
public class AirspaceLayerClassTypeExtensionType implements Serializable, Equals, HashCode, ToString
{
    ...
    @JoinTable(name = "AIRSPACE_LAYER_CLASS_TYPE_EX_1", joinColumns = {
        @JoinColumn(name = "PARENT_AIRSPACE_LAYER_CLASS__0")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "AIRSPACE_LAYER_CLASS_TYPE_EX_2", joinColumns = {
        @JoinColumn(name = "PARENT_AIRSPACE_LAYER_CLASS__0")
    }, inverseJoinColumns = {
        @JoinColumn(name = "CHILD_ABSTRACT_EXTENSION_TYP_0")
    })
