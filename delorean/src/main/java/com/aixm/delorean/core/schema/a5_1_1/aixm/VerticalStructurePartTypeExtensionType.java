...
public class VerticalStructurePartTypeExtensionType implements Serializable, Equals, HashCode, ToString
{
    ...
    @JoinTable(name = "VERTICAL_STRUCTURE_PART_TYPE_1", joinColumns = {
        @JoinColumn(name = "PARENT_VERTICAL_STRUCTURE_PA_0")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "VERTICAL_STRUCTURE_PART_TYPE_2", joinColumns = {
        @JoinColumn(name = "PARENT_VERTICAL_STRUCTURE_PA_0")
    }, inverseJoinColumns = {
        @JoinColumn(name = "CHILD_ABSTRACT_EXTENSION_TYP_0")
    })
