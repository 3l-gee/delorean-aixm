...
public class InitialLegExtensionType implements Serializable, Equals, HashCode, ToString
{
    ...
    @JoinTable(name = "INITIAL_LEG_EXTENSION_TYPE_A_0", joinColumns = {
        @JoinColumn(name = "PARENT_INITIAL_LEG_EXTENSION_0")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "INITIAL_LEG_EXTENSION_TYPE_A_1", joinColumns = {
        @JoinColumn(name = "PARENT_INITIAL_LEG_EXTENSION_0")
    }, inverseJoinColumns = {
        @JoinColumn(name = "CHILD_ABSTRACT_EXTENSION_TYP_0")
    })
    ...
    @JoinTable(name = "INITIAL_LEG_EXTENSION_TYPE_A_2", joinColumns = {
        @JoinColumn(name = "PARENT_INITIAL_LEG_EXTENSION_0")
    }, inverseJoinColumns = {
        @JoinColumn(name = "CHILD_ABSTRACT_EXTENSION_TYP_0")
    })
