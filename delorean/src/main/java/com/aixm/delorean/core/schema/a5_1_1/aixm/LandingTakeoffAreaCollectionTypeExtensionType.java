...
public class LandingTakeoffAreaCollectionTypeExtensionType implements Serializable, Equals, HashCode, ToString
{
    ...
    @JoinTable(name = "LANDING_TAKEOFF_AREA_COLLECT_2", joinColumns = {
        @JoinColumn(name = "PARENT_LANDING_TAKEOFF_AREA__0")
    }, inverseJoinColumns = {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        final LandingTakeoffAreaCollectionTypeExtensionType that = ((LandingTakeoffAreaCollectionTypeExtensionType) object);
        {
