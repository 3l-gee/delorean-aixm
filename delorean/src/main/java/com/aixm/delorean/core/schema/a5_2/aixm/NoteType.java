 ...
 *       <sequence>
 *         <group ref="{http://www.aixm.aero/schema/5.2}NotePropertyGroup"/>
    ...
    implements Serializable
{
    ...
    protected List<NoteTypeExtension> extension;
    ...
    @JoinColumn(name = "TRANSLATED_NOTE_NOTE_TYPE_HJ_0")
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link NoteTypeExtension }
     * 
     * 
     */
    @OneToMany(targetEntity = NoteTypeExtension.class, cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinColumn(name = "EXTENSION_NOTE_TYPE_HJID")
    public List<NoteTypeExtension> getExtension() {
        if (extension == null) {
     ...
     * 
     */
    public void setExtension(List<NoteTypeExtension> extension) {
    ...
    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "PROPERTY_NAME_ITEM_VALUE", length = 60)),
        @AttributeOverride(name = "nilReason", column = @Column(name = "PROPERTY_NAME_ITEM_NIL_REASON"))
    })
    ...
    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "PURPOSE_ITEM_VALUE")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "PURPOSE_ITEM_NIL_REASON"))
    })
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        final NoteType that = ((NoteType) object);
        {
            ...
            List<NoteTypeExtension> rhsField;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        }
        {
            ...
            List<NoteTypeExtension> theField;
