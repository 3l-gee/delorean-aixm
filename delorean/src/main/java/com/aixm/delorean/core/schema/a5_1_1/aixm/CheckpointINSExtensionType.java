...
public class CheckpointINSExtensionType implements Serializable, Equals, HashCode, ToString
{
    ...
    @JoinTable(name = "CHECKPOINT_INSEXTENSION_TYPE_0", joinColumns = {
        @JoinColumn(name = "PARENT_CHECKPOINT_INSEXTENSI_0")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "CHECKPOINT_INSEXTENSION_TYPE_1", joinColumns = {
        @JoinColumn(name = "PARENT_CHECKPOINT_INSEXTENSI_0")
    }, inverseJoinColumns = {
        @JoinColumn(name = "CHILD_ABSTRACT_EXTENSION_TYP_0")
    })
