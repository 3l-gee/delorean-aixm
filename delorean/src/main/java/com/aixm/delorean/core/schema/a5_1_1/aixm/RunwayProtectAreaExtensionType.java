...
public class RunwayProtectAreaExtensionType implements Serializable, Equals, HashCode, ToString
{
    ...
    @JoinTable(name = "RUNWAY_PROTECT_AREA_EXTENSIO_1", joinColumns = {
        @JoinColumn(name = "PARENT_RUNWAY_PROTECT_AREA_E_0")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "RUNWAY_PROTECT_AREA_EXTENSIO_2", joinColumns = {
        @JoinColumn(name = "PARENT_RUNWAY_PROTECT_AREA_E_0")
    }, inverseJoinColumns = {
        @JoinColumn(name = "CHILD_ABSTRACT_EXTENSION_TYP_0")
    })
