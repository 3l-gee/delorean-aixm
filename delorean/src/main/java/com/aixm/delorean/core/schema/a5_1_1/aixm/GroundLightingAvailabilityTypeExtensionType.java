...
@Table(name = "groundlightingavailability_ext", schema = "airport_heliport")
public class GroundLightingAvailabilityTypeExtensionType implements Serializable, Equals, HashCode, ToString
{
    ...
    @JoinTable(name = "GROUND_LIGHTING_AVAILABILITY_2", joinColumns = {
        @JoinColumn(name = "PARENT_GROUND_LIGHTING_AVAIL_0")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "GROUND_LIGHTING_AVAILABILITY_3", joinColumns = {
        @JoinColumn(name = "PARENT_GROUND_LIGHTING_AVAIL_0")
    }, inverseJoinColumns = {
        @JoinColumn(name = "CHILD_ABSTRACT_EXTENSION_TYP_0")
    })
