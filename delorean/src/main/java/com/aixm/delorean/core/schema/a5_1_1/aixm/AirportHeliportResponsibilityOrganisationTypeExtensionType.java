...
public class AirportHeliportResponsibilityOrganisationTypeExtensionType implements Serializable, Equals, HashCode, ToString
{
    ...
    @JoinTable(name = "AIRPORT_HELIPORT_RESPONSIBIL_2", joinColumns = {
        @JoinColumn(name = "PARENT_AIRPORT_HELIPORT_RESP_0")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "AIRPORT_HELIPORT_RESPONSIBIL_3", joinColumns = {
        @JoinColumn(name = "PARENT_AIRPORT_HELIPORT_RESP_0")
    }, inverseJoinColumns = {
        @JoinColumn(name = "CHILD_ABSTRACT_EXTENSION_TYP_0")
    })
