...
@Table(name = "lightelementstatus_ext", schema = "shared")
public class LightElementStatusTypeExtensionType implements Serializable, Equals, HashCode, ToString
{
    ...
    @JoinTable(name = "LIGHT_ELEMENT_STATUS_TYPE_EX_1", joinColumns = {
        @JoinColumn(name = "PARENT_LIGHT_ELEMENT_STATUS__0")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "LIGHT_ELEMENT_STATUS_TYPE_EX_2", joinColumns = {
        @JoinColumn(name = "PARENT_LIGHT_ELEMENT_STATUS__0")
    }, inverseJoinColumns = {
        @JoinColumn(name = "CHILD_ABSTRACT_EXTENSION_TYP_0")
    })
