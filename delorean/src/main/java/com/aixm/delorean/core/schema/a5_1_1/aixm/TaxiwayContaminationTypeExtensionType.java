...
public class TaxiwayContaminationTypeExtensionType implements Serializable, Equals, HashCode, ToString
{
    ...
    @JoinTable(name = "TAXIWAY_CONTAMINATION_TYPE_E_1", joinColumns = {
        @JoinColumn(name = "PARENT_TAXIWAY_CONTAMINATION_0")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "TAXIWAY_CONTAMINATION_TYPE_E_2", joinColumns = {
        @JoinColumn(name = "PARENT_TAXIWAY_CONTAMINATION_0")
    }, inverseJoinColumns = {
        @JoinColumn(name = "CHILD_ABSTRACT_EXTENSION_TYP_0")
    })
