...
@Entity(name = "ApronAreaAvailabilityTypeExtensionType")
@Table(name = "apronareaavailability_ext", schema = "airport_heliport")
public class ApronAreaAvailabilityTypeExtensionType implements Serializable, Equals, HashCode, ToString
{
    ...
    @JoinTable(name = "APRON_AREA_AVAILABILITY_TYPE_1", joinColumns = {
        @JoinColumn(name = "PARENT_APRON_AREA_AVAILABILI_0")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "APRON_AREA_AVAILABILITY_TYPE_2", joinColumns = {
        @JoinColumn(name = "PARENT_APRON_AREA_AVAILABILI_0")
    }, inverseJoinColumns = {
        @JoinColumn(name = "CHILD_ABSTRACT_EXTENSION_TYP_0")
    })
