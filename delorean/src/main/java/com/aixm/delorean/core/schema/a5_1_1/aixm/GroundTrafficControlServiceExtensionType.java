...
@Entity(name = "GroundTrafficControlServiceExtensionType")
@Table(name = "groundtrafficcontrolservice_ext", schema = "service")
public class GroundTrafficControlServiceExtensionType implements Serializable, Equals, HashCode, ToString
{
    ...
    @JoinTable(name = "GROUND_TRAFFIC_CONTROL_SERVI_2", joinColumns = {
        @JoinColumn(name = "PARENT_GROUND_TRAFFIC_CONTRO_0")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "GROUND_TRAFFIC_CONTROL_SERVI_3", joinColumns = {
        @JoinColumn(name = "PARENT_GROUND_TRAFFIC_CONTRO_0")
    }, inverseJoinColumns = {
        @JoinColumn(name = "CHILD_ABSTRACT_EXTENSION_TYP_0")
    })
    ...
    @JoinTable(name = "GROUND_TRAFFIC_CONTROL_SERVI_4", joinColumns = {
        @JoinColumn(name = "PARENT_GROUND_TRAFFIC_CONTRO_0")
    }, inverseJoinColumns = {
        @JoinColumn(name = "CHILD_ABSTRACT_EXTENSION_TYP_0")
    })
