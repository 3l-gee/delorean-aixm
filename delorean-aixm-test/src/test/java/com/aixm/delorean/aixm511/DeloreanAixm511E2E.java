...
public class DeloreanAixm511E2E {
    ...
    @Test
    @Order(1)
    void jaxblaodexport() throws Exception {
            JAXBContext context = JAXBContext.newInstance(com.aixm.delorean.aixm511.schema.message.AIXMBasicMessageType.class);

            Unmarshaller un= context.createUnmarshaller();
            JAXBElement<AIXMBasicMessageType> jaxbElement = (JAXBElement<AIXMBasicMessageType>) un.unmarshal(new File("src/test/resources/donlon-in.xml"));
            AIXMBasicMessageType message = jaxbElement.getValue();
